...
const WJEC_C2_SOURCE_A_1_REF = 'Dr Elena Kowalski, "The Invisible Hand: How Algorithms Shape Reality", 2024'
...
const WJEC_C2_SOURCE_B_1_REF = 'From an essay by Thomas Carlyle, "The Condition of England Question", 1847'
...
const WJEC_C2_SOURCE_A_2_REF = 'Dr James Chen, "The Fragmented Mind: Technology and Adolescent Development", 2023'
...
const WJEC_C2_SOURCE_B_2_REF = 'From a personal essay by Raymond Williams, "Culture and the Working Man", 1960'
...
const WJEC_C2_SOURCE_A_3_REF = 'Naomi Klein, "This Changes Everything: Capitalism vs. the Climate", 2014'
...
const WJEC_C2_SOURCE_B_3_REF = 'From an autobiography by Richard Hoggart, "The Uses of Literacy", 1957'
        ...
        questions: [
          {
            id: 'wjec-c1-m1-q1',
            questionNumber: 1,
            questionText: 'Read lines 1-10. List five things you learn about the shop and its owner from these lines.',
            marks: 5,
            ...
            modelAnswers: {
              'Grade 4-5': '1. It is raining heavily. 2. The shop is in a village. 3. The owner is a woman. 4. She has run the shop for forty years. 5. The high street is empty.',
            },
          ...
          },
          {
            ...
            extractSource: WJEC_C1_EXTRACT_1_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The writer creates isolation by showing the empty high street and the customers who have left. Words like "detritus" and "empty" emphasise loss. The list of what people used to do — "Mr Walsh bought," "Mrs Chen came" — shows what is gone. The rain intensifies the lonely mood. The sign swinging between "Open" and "Closed" symbolises her uncertainty.',
              'Grade 6-7': 'The writer constructs loss through systematic negation. Customers are defined by what they no longer do: "Now Mr Walsh shops online," "Mrs Chen had moved," "James had died." The present tense of the past ("bought," "came") is deliberately destabilising. The sensory knowledge ("hands knew every corner") becomes useless in a world that has moved beyond sensory knowledge — supermarkets eliminate touch, smell, human connection. The rain becomes an instrument of erasure, carrying "detritus" through the streets. The structural pivot to the office reveals the machinery of closure: unopened letters, unmaintained accounts, boxes "slowly collapsing under the weight of their own emptiness." The final image of the sign swinging "between two certainties" is brilliant because it reverses the apparent binary — both states (open and closed) are equally certain, equally inevitable. The woman is paralysed between a past that is dead and a future she cannot face.',
            },
            markScheme: [
          ...
          },
          {
            id: 'wjec-c1-m1-q3',
            questionNumber: 3,
            questionText: 'What impressions do you get of the shop owner\'s character and feelings throughout the extract?\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: WJEC_C1_EXTRACT_1,
        ...
        questions: [
          {
            id: 'wjec-c1-m2-q1',
            questionNumber: 1,
            questionText: 'Read lines 1-15. List five things you learn about Henry and the situation from these lines.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              'Grade 4-5': '1. A telegram has arrived. 2. Henry was in the garden. 3. He has sons in the war. 4. Mrs Webb brought the telegram. 5. Henry is shocked.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            id: 'wjec-c1-m2-q2',
            questionNumber: 2,
            questionText: 'How does the writer create a sense of dread and emotional impact in this extract?\n\nYou should comment on:\n- the use of physical details\n- the writer\'s control of pace and structure\n- the effects on the reader.\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: WJEC_C1_EXTRACT_2,
          ...
          },
          {
            id: 'wjec-c1-m2-q3',
            questionNumber: 3,
            questionText: 'What impressions do you get of Mrs Webb and how she handles this situation?\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: WJEC_C1_EXTRACT_2,
          ...
          },
          {
            id: 'wjec-c1-m2-q4',
            questionNumber: 4,
            questionText: '"The writer powerfully conveys Henry\'s emotional state through physical detail rather than direct statements about his feelings."\n\nTo what extent do you agree? Support your answer with references to the text.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: WJEC_C1_EXTRACT_2,
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear piece of creative prose with: recognisable narrative structure; effective descriptions; varied vocabulary; mostly accurate SPaG.',
              'Grade 6-7': 'A well-constructed piece with: engaging voice; vivid imagery; controlled structure; consistent accuracy.',
              'Grade 8-9': 'A sophisticated, original piece with: distinctive voice; precise language; complex structure; technical excellence.',
            },
            markScheme: [
        ...
        questions: [
          {
            id: 'wjec-c1-m3-q1',
            questionNumber: 1,
            questionText: 'Read the whole extract. List five things you learn about Sarah and her life from the text.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              'Grade 4-5': '1. She lives in a flat that she dislikes. 2. She works at a call centre. 3. She has been there for two years. 4. The flat smells bad. 5. She watches pigeons from her window.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            id: 'wjec-c1-m3-q2',
            questionNumber: 2,
            questionText: 'How does the writer create a sense of alienation and dissatisfaction in this extract?\n\nYou should comment on:\n- what the writing tells us about Sarah\'s environment\n- the writer\'s use of language and imagery\n- the effects on the reader.\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: WJEC_C1_EXTRACT_3,
          ...
          },
          {
            id: 'wjec-c1-m3-q3',
            questionNumber: 3,
            questionText: 'What can you infer about Sarah\'s character and state of mind from her response to the pigeon in her bedroom?\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: WJEC_C1_EXTRACT_3,
          ...
          },
          {
            id: 'wjec-c1-m3-q4',
            questionNumber: 4,
            questionText: '"The writer uses the pigeon as a symbol to comment on modern life and human existence."\n\nTo what extent do you agree? Support your evaluation with evidence from the text.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: WJEC_C1_EXTRACT_3,
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear, focused piece of prose with: coherent narrative structure; descriptive language; varied vocabulary; generally accurate SPaG.',
              'Grade 6-7': 'A compelling piece with: controlled voice; sophisticated imagery; effective structure; consistent technical accuracy.',
              'Grade 8-9': 'An assured, original piece with: distinctive authorial voice; precise, vivid language; masterful structural control; technical excellence.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': '1. Algorithms work while people sleep and in their daily lives. 2. They watch people with constant attention. 3. They optimise for engagement rather than truth. 4. They measure which information makes people feel most intensely. 5. They feed people content that creates outrage and confirms their beliefs.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            id: 'wjec-c2-m1-q2',
            questionNumber: 2,
            questionText: 'How does the 21st-century writer use language to persuade the reader to be concerned about algorithms and social media?\n\nYou should comment on specific words and phrases and their effects.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
          ...
          },
          {
            id: 'wjec-c2-m1-q4',
            questionNumber: 4,
            questionText: '"Carlyle\'s 19th-century concerns about technology are more valid than Kowalski\'s 21st-century concerns because they focus on human connection, which is more important than information control."\n\nTo what extent do you agree? You should refer to both texts.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: `Source A:\n${WJEC_C2_SOURCE_A_1}\n\nSource B:\n${WJEC_C2_SOURCE_B_1}`,
        ...
        questions: [
          {
            id: 'wjec-c2-m1-q5',
            questionNumber: 5,
            questionText: 'Your school is running a digital wellbeing campaign. The headteacher has asked students to write an article for the school website about the impact of social media on young people\'s mental health.\n\nWrite an article for the school website persuading young people to think carefully about their social media use.\n\n(20 marks for communication and organisation / 12 marks for writing accurately / 8 marks for SPaG)',
            marks: 40,
            suggestedTimeMinutes: 40,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear article with: appropriate tone for school audience; clear position on social media; generally accurate SPaG.',
              'Grade 6-7': 'A well-structured article with: engaging opening; persuasive techniques; consistent accuracy.',
              'Grade 8-9': 'An outstanding article with: sophisticated voice; compelling argument; technical excellence.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': '1. Young people build identity in public before an audience. 2. Social media makes them feel worse about their appearance. 3. Social media increases anxiety about social situations. 4. Young people measure their worth by likes and follower counts.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            id: 'wjec-c2-m2-q2',
            questionNumber: 2,
            questionText: 'How does Dr Chen use evidence and language to support her argument that social media harms young people\'s wellbeing?\n\nYou should comment on specific techniques and their effects.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
          ...
          },
          {
            id: 'wjec-c2-m2-q3',
            questionNumber: 3,
            questionText: 'Compare and contrast how the two writers approach the question of technology and modern life.\n\nYou should compare:\n- their main concerns and ideas\n- the tones they use\n- the assumptions they make about their readers.',
            marks: 10,
            suggestedTimeMinutes: 15,
            questionType: 'comparison',
            extract: `Source A:\n${WJEC_C2_SOURCE_A_2}\n\nSource B:\n${WJEC_C2_SOURCE_B_2}`,
          ...
          },
          {
            id: 'wjec-c2-m2-q4',
            questionNumber: 4,
            questionText: '"Williams\'s memory of Old Tom and traditional work is more persuasive than Chen\'s statistics because it connects emotionally with the reader."\n\nTo what extent do you agree? Support your evaluation with references to both texts.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: `Source A:\n${WJEC_C2_SOURCE_A_2}\n\nSource B:\n${WJEC_C2_SOURCE_B_2}`,
        ...
        questions: [
          {
            id: 'wjec-c2-m2-q5',
            questionNumber: 5,
            questionText: 'A local newspaper is looking for letters from readers about technology\'s impact on modern life.\n\nWrite a letter to the editor about whether technology has improved or diminished the quality of modern life.\n\nYou should aim to persuade readers of your point of view.\n\n(20 marks for communication and organisation / 12 marks for writing accurately / 8 marks for SPaG)',
            marks: 40,
            suggestedTimeMinutes: 40,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear letter with: appropriate letter format; clear point of view; relevant examples; generally accurate SPaG.',
              'Grade 6-7': 'A persuasive letter with: proper conventions; well-developed argument; sophisticated vocabulary.',
              'Grade 8-9': 'An outstanding letter with: impeccable conventions; compelling argument; technical excellence.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': '1. The climate crisis is happening now, not in the future. 2. Product prices do not reflect their true environmental costs. 3. The economic system externalises costs onto the planet and future generations. 4. Hidden costs do not appear in our moral thinking.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            id: 'wjec-c2-m3-q2',
            questionNumber: 2,
            questionText: 'How does Naomi Klein use evidence, language, and rhetorical techniques to support her argument about the climate crisis and economics?\n\nYou should comment on specific techniques and their effects.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
          ...
          },
          {
            id: 'wjec-c2-m3-q4',
            questionNumber: 4,
            questionText: '"Hoggart\'s personal testimony is more effective than Klein\'s abstract economic argument because it reveals the human impact of inequality."\n\nTo what extent do you agree? Support your evaluation with detailed references to both texts.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: `Source A:\n${WJEC_C2_SOURCE_A_3}\n\nSource B:\n${WJEC_C2_SOURCE_B_3}`,
        ...
        questions: [
          {
            id: 'wjec-c2-m3-q5',
            questionNumber: 5,
            questionText: 'Your school is running a sustainable living campaign. The campaign organisers have asked students to write a persuasive article for the school website explaining how young people can make more environmentally responsible choices.\n\nWrite an article persuading your fellow students to live more sustainably.\n\n(20 marks for communication and organisation / 12 marks for writing accurately / 8 marks for SPaG)',
            marks: 40,
            suggestedTimeMinutes: 40,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear, well-organised article with: appropriate tone for peers; clear examples of sustainable choices; generally accurate SPaG.',
              'Grade 6-7': 'A persuasive article with: engaging voice; concrete examples; strong use of persuasive language.',
              'Grade 8-9': 'An outstanding article with: compelling voice; sophisticated argument; technical excellence.',
            },
            markScheme: [
