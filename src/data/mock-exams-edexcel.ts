...
const EDEXCEL_P1_SET_B_SOURCE =
  'Adapted from academic article, Conservation Biology Quarterly, 2023'
...
// AUDIT NOTE (FC20, 2026-04-28): "Adapted from contemporary memoir 2024",
// "Adapted from local news feature, BBC Local 2023", "From collected essays
// by William Davies, 2022" - these and similar framing labels are FABRICATED
// for original practice compositions. William Davies is a real sociologist
// but the rendered text is not from his work. Treat as practice stimuli.
...
export const edexcelMockExams: MockExamPaper[] = [
  {
    ...
    sections: [
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText:
              'What do you understand from the extract about Mrs Patterson and her experience of the factory closure?',
            marks: 4,
            ...
            modelAnswers: {
              'Grade 4-5':
                'Mrs Patterson worked at the factory for thirty-eight years. She had a routine of clocking out at five past five every day. The closure meant she lost her job and her future was uncertain. The action of "clocking out" and "walking out" shows she expected to return but didn\'t.',
              'Grade 6-7':
                'Mrs Patterson\'s thirty-eight-year tenure establishes her complete institutional identity. The precision of "five past five" and the repetition "as she had every weekday for nearly four decades" emphasise the ritualistic nature of her employment - work has structured her entire adult life. Her exit is presented as simultaneously ordinary and catastrophic: she performs the familiar ritual unaware it is final. The closure severs not merely a job but a framework of meaning and temporal structure that has defined her existence.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'Analyse how the writer presents the factory building across the extract. Comment on the language choices and effects.',
            marks: 8,
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              'The writer contrasts what people "understood intellectually" with what they found it hard to "accept as real." Explain this contrast and why the writer makes it.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_SET_A_EXTRACT,
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              'To what extent do you agree that the writer presents the factory closure as a tragedy? Use evidence to support your judgement.',
            marks: 20,
      ...
      },
      {
        ...
        description:
          'You are advised to spend about 50 minutes on this section. You should write approximately 300-500 words.',
        totalMarks: 56,
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText:
              'According to the extract, what problems result from the feral cat population?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              'Grade 4-5':
                'The extract mentions that the feral cats spread disease, predate on native wildlife, and represent "organised chaos at the margins of urban life." They damage ecosystems and pose health risks.',
              'Grade 6-7':
                'The text identifies three problems: disease transmission, predation on native species (damaging biodiversity), and the creation of what the writer calls "organised chaos at the margins of urban life" - suggesting they represent disorder and ecological imbalance in urban ecosystems.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'Analyse how the writer uses language in the first paragraph to establish the scale and nature of the feral cat problem.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_SET_B_EXTRACT,
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              'The writer describes three different municipal responses to feral cat populations. Which response does the writer seem to favour? Explain your answer with reference to the text.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_SET_B_EXTRACT,
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              'To what extent do you agree that the feral cat problem is fundamentally about failure to take responsibility for domestic animals? Use evidence from the text to support your judgement.',
            marks: 20,
            suggestedTimeMinutes: 25,
            questionType: 'evaluation',
            extract: EDEXCEL_P1_SET_B_EXTRACT,
        ...
        questions: [
          {
            ...
            questionNumber: 5,
            questionText:
              'Your local council is considering implementing a Trap-Neuter-Return (TNR) programme for feral cat colonies in your area. Write a letter to your council representative arguing either for or against this initiative.\n\nYou should:\n- Take a clear position\n- Use evidence and reasoned argument\n- Anticipate and address counter-arguments\n- Adopt an appropriate formal tone\n\n(32 marks for content and organisation / 24 marks for technical accuracy and vocabulary)',
            marks: 56,
            suggestedTimeMinutes: 50,
            questionType: 'transactional-writing',
            modelAnswers: {
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText:
              'What does the writer mean by describing the green space as "underutilised" and "inefficient"? Why does the writer object to this language?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              ...
              'Grade 6-7':
                'These terms apply economic metrics to a public good, suggesting the green "fails" because it does not generate revenue or serve economic productivity. The writer objects because this language colonises the discussion, imposing financial logic onto spaces that should be evaluated by different criteria: social benefit, public health, democratic access, environmental function. By highlighting the "linguistic sleight of hand," the writer reveals how economic vocabulary naturalises particular values while rendering others invisible.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              "Analyse the writer's use of examples in the second paragraph. What is the effect of these examples?",
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_SET_C_EXTRACT,
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              "In the final paragraph, the writer lists several benefits of keeping the green space. How does this list contribute to the writer's overall argument?",
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_SET_C_EXTRACT,
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              "To what extent do you agree that the writer's arguments against developing the green space are compelling? Use evidence from the text to support your judgement.",
            marks: 20,
            suggestedTimeMinutes: 25,
            questionType: 'evaluation',
            extract: EDEXCEL_P1_SET_C_EXTRACT,
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'Analyse how the writer presents the group of women in Source 1. What qualities does the writer emphasise?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P2_SET_A_SOURCE_1,
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              'Now read Source 2. Compare how both sources present the theme of absence and loss.',
            marks: 8,
            suggestedTimeMinutes: 12,
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              'To what extent do both sources suggest that belonging requires loss? Use evidence from both texts to develop your answer.',
            marks: 20,
            suggestedTimeMinutes: 25,
            questionType: 'evaluation',
            extract: EDEXCEL_P2_SET_A_SOURCE_1,
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText:
              'What has happened to the library in Source 1? What does the text tell us about the impact of this closure?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'Analyse how the writer of Source 2 presents the contrast between his own childhood and contemporary life for young people.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              'Compare how both sources present loss of institutional connection. What different aspects of loss do they emphasise?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'comparison',
            extract: EDEXCEL_P2_SET_B_SOURCE_1,
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              'To what extent do both sources suggest that institutions (libraries, schools, spaces for connection) are essential for human wellbeing? Use evidence from both texts.',
            marks: 20,
            suggestedTimeMinutes: 25,
            questionType: 'evaluation',
            extract: EDEXCEL_P2_SET_B_SOURCE_1,
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText:
              'Read Source 1. What is the significance of the house having been "empty for three years"? What does this tell us about Emma and her situation?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'Analyse the writer\'s use of the extended metaphor of the house as a "museum" in Source 1. What effects does this comparison create?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P2_SET_C_SOURCE_1,
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              'Compare how both sources present the relationship between objects and memory. How do material things preserve or convey human connection?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'comparison',
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              'To what extent do both sources suggest that moving on from the past requires accepting loss rather than preserving it? Use evidence to support your answer.',
            marks: 20,
            suggestedTimeMinutes: 25,
            questionType: 'evaluation',
            extract: EDEXCEL_P2_SET_C_SOURCE_1,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '[Sample student response demonstrating Grade 4-5 competence with clear narrative, adequate detail, and developing emotional understanding]',
              'Grade 6-7':
                '[Sample student response demonstrating Grade 6-7 competence with compelling voice, crafted atmosphere, and sustained emotional exploration]',
              'Grade 8-9':
                '[Sample student response demonstrating Grade 8-9 competence with distinctive voice, precise imagery, structural sophistication, and philosophical depth]',
            },
            markScheme: [
