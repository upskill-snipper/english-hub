    ...
    slides: [
      {
        ...
        teacherNotes:
          'This is a high-stakes question. Emphasise that students must spend 40 minutes here and plan their response. The key is precision in identifying techniques and explaining their effects.',
      },
      {
        slideNumber: 2,
        ...
        teacherNotes:
          "These five are the most commonly used. Have students note them in their books with examples from texts they've recently studied.",
      },
      {
        slideNumber: 3,
        ...
        teacherNotes:
          "Remind students that imagery is powerful because it engages readers' senses. Ask them to identify which sense is being engaged in example texts.",
        activityInstructions:
          'Give students a short paragraph and ask them to highlight examples of each type of imagery they can find.',
      },
      {
        slideNumber: 4,
        ...
        teacherNotes:
          'Students often miss sentence structure. Emphasise that HOW ideas are presented matters as much as WHAT is said. Model analysing a sentence from a real text.',
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'Punctuation is easy to miss but creates powerful effects. Show how the same sentence reads differently with different punctuation.',
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          "These are more sophisticated techniques that elevate analysis. Focus on how they create emphasis or reveal writer's attitude.",
      },
      {
        slideNumber: 7,
        title: 'Tone & Register',
        ...
        teacherNotes:
          "Tone is often the answer to 'why did the writer choose these techniques?'. Help students move beyond basic descriptions to identifying and explaining tone.",
        activityInstructions:
          'Read aloud the same sentence with different tones (angry, sad, sarcastic, matter-of-fact) and discuss how it changes meaning.',
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          'This is the golden framework. Make it visual and reference it constantly. Students should use this structure in every answer.',
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          'Model complete analysis. Show how each step builds on the previous one. Emphasise that good analysis is about making connections.',
        activityInstructions:
          "Students analyse a given metaphor using the five-step framework. Circulate and check they're linking technique to effect to purpose.",
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          'These are the most common errors in student responses. Be explicit about what not to do.',
        activityInstructions:
          'Show examples of weak analysis and strong analysis side-by-side. Ask students to identify why the strong example is better.',
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          'Good planning prevents rambling. Students should spend 5 minutes planning to save time and stay focused.',
      },
      {
        slideNumber: 12,
        ...
        teacherNotes:
          'Emphasise the importance of structure in exam writing. A well-organised response is easier to mark and impresses examiners.',
      },
      {
        slideNumber: 13,
        ...
        teacherNotes:
          'Mark up student work showing where they lose marks by being imprecise. Encourage them to use technical language confidently.',
        activityInstructions:
          'Give students vague analysis sentences and ask them to rewrite using precise terminology.',
      },
      {
        slideNumber: 14,
        ...
        teacherNotes:
          'Use this as a timed practice. Circulate while students write and provide feedback as they work.',
        activityInstructions:
          "After 8 minutes, display a strong model answer and compare students' responses to it. Identify strengths and areas for improvement.",
      },
      {
        slideNumber: 15,
        ...
        teacherNotes:
          'End on a motivational note. Remind students that this is a skill they can absolutely master with practice.',
      },
    ],
  },
  {
    ...
    slides: [
      {
        ...
        teacherNotes:
          'This is worth double the marks of Q2. Emphasise that time management and planning are crucial. Spend 5 minutes reading and planning.',
      },
      {
        slideNumber: 2,
        ...
        teacherNotes:
          "Students often worry they're not following the prompt correctly. Reassure them that examiners reward engaging writing that responds to the prompt, even if adapted.",
      },
      {
        slideNumber: 3,
        ...
        teacherNotes:
          'Quick planning prevents waffling and dead ends. Show students how to write a 5-minute plan on a scrap of paper.',
      },
      {
        slideNumber: 4,
        ...
        teacherNotes:
          'Analyse published openings and discuss why they work. Have students write multiple opening lines and choose the strongest.',
        activityInstructions:
          'Read aloud three different openings to the same story. Ask students to vote on which is most engaging and explain why.',
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'This is where students often lose marks by over-describing. Emphasise that less is more - vivid detail beats lengthy description.',
        activityInstructions:
          'Give students a setting (an old house, a busy market, a hospital) and ask them to write 3 sentences using only sensory detail.',
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          'Students often rely on physical descriptions instead of showing personality through behaviour. Model how to reveal character through action.',
      },
      {
        slideNumber: 7,
        ...
        teacherNotes:
          'Read aloud good and bad dialogue examples. Show how variation in sentence length and style creates different voices.',
        activityInstructions:
          'Give students a tense situation (waiting for exam results, job interview) and ask them to write 10 lines of dialogue without explanation.',
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          "Many students write descriptive pieces without real conflict. Emphasise that stories need something at stake - what does the character want and what's preventing it?",
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          'Show how the same event reads differently when written with different pacing. Model editing for pacing.',
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          "Show how sophisticated vocabulary elevates writing. But warn against using words they don't fully understand - it shows in the writing.",
        activityInstructions:
          'Take a paragraph written with simple vocabulary and rewrite it with more sophisticated word choices. Discuss which version is more engaging.',
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          'Figurative language in creative writing shows sophistication. Have students identify clichés and replace them with fresh comparisons.',
      },
      {
        slideNumber: 12,
        ...
        teacherNotes:
          'Discuss how the same story reads differently from different perspectives. Have students write the same scene from two viewpoints.',
      },
      {
        slideNumber: 13,
        ...
        teacherNotes:
          'These are the most common reasons narratives lose marks. Show examples of each pitfall and how to fix them.',
      },
      {
        slideNumber: 14,
        ...
        teacherNotes:
          'Endings are disproportionately important. Show examples of strong and weak endings. Have students practise writing endings that linger.',
        activityInstructions:
          'Write several different endings for the same story (happy, sad, twist, open-ended) and discuss which feels most earned.',
      },
      {
        slideNumber: 15,
        ...
        teacherNotes:
          'Many students skip this step. Emphasise that careless errors lose marks that good planning and execution should have earned.',
      },
      {
        slideNumber: 16,
        ...
        teacherNotes:
          'Use this as a model for students to annotate what makes it effective. Have them replicate this structure in their own openings.',
      },
      {
        slideNumber: 17,
        ...
        teacherNotes:
          'Show a 200-word extract from a strong student response. Annotate techniques used and mark them against the criteria.',
      },
      {
        slideNumber: 18,
        ...
        teacherNotes:
          "Use this to show how a complete narrative comes together. Emphasise that this didn't happen by accident - it required planning.",
      },
      {
        slideNumber: 19,
        ...
        teacherNotes:
          'Do this regularly in class. Timed practice is the best preparation. Use real exam prompts so students get familiar with the style.',
        activityInstructions:
          "After writing, pair students up and have them mark each other's work using mark scheme. Discuss what was effective and what could improve.",
      },
      {
        slideNumber: 20,
        ...
        teacherNotes:
          'Give students this checklist to take home. They should ask themselves these questions before submitting.',
      },
    ],
  },
  {
    ...
    slides: [
      {
        ...
        teacherNotes:
          "Context matters. James I believed in divine right of kings, so regicide (Macbeth's crime) was considered unnatural and damaging to the state.",
      },
      {
        slideNumber: 2,
        ...
        teacherNotes:
          'This is a central question. Students should grapple with whether Macbeth is a bad man or a good man corrupted by ambition.',
      },
      {
        slideNumber: 3,
        ...
        teacherNotes:
          "The witches' role is ambiguous. Do they create the ambition or reveal it? This debate is valuable for analysis.",
        activityInstructions:
          "Read the prophecy scene aloud. Ask students: Would Macbeth have killed Duncan without the witches and Lady Macbeth's influence?",
      },
      {
        slideNumber: 4,
        ...
        bulletPoints: [
          ...
          "Quote: 'How tender 'tis to love the babe that milks me'",
          'She represents ambition without moral restraint - initially',
        ],
        teacherNotes:
          "Lady Macbeth is complex. She's not simply evil - she's shown as ambitious and manipulative but ultimately destroyed by conscience.",
      },
      {
        slideNumber: 5,
        title: "Guilt: Macbeth's Psychological Breakdown",
        bulletPoints: [
          "Before the murder Macbeth admits 'I have no spur / To prick the sides of my intent, but only / Vaulting ambition'",
          ...
          "Macbeth cannot wash away the guilt - 'Will all great Neptune's ocean wash this blood / Clean from my hand?'",
        ],
        teacherNotes:
          "Guilt is not just remorse - it's a physical, psychological torment that destroys Macbeth from within.",
        activityInstructions:
          "Trace Macbeth's language about guilt. Chart how it becomes more desperate and violent as the play progresses.",
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          "Show how ambition doesn't satisfy - it creates the need for more ambition. The crown is hollow without security.",
      },
      {
        slideNumber: 7,
        ...
        teacherNotes:
          "This scene shows ambition's cost - Macbeth cannot enjoy his success because he's tormented by guilt.",
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          "This is one of Shakespeare's most powerful explorations of guilt. It shows that even determined ambition cannot escape conscience.",
        activityInstructions:
          'Have students perform the sleepwalking scene with different interpretations - is she mad, or is her unconscious speaking truth?',
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          "The witches don't lie - they're just ambiguous. Macbeth's ambition blinds him to alternative interpretations.",
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          'This murder is the point of no return. It shows how ambition has corrupted Macbeth from a loyal soldier to a tyrant.',
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          'This is the ultimate statement about ambition - it promises fulfilment but delivers emptiness.',
      },
      {
        slideNumber: 12,
        ...
        teacherNotes:
          "This debate is essential. Help students see that Shakespeare complicates the question - it's both fate and choice.",
      },
      {
        slideNumber: 13,
        ...
        teacherNotes:
          'This is a sophisticated theme. Ambition is portrayed as a distortion of masculinity, not its natural expression.',
      },
      {
        slideNumber: 14,
        ...
        teacherNotes:
          "Trace these images through the play. Show how Shakespeare uses them to track Macbeth's moral deterioration.",
        activityInstructions:
          'Find 5 quotes using blood, sleep, or darkness. Chart how the meaning changes as the play progresses.',
      },
      {
        slideNumber: 15,
        ...
        teacherNotes:
          'This is the takeaway message. Macbeth is a warning about the cost of unchecked ambition.',
      },
    ],
  },
  {
    ...
    slides: [
      {
        ...
        teacherNotes:
          'This was a radical work. Dickens was arguing that the rich had a moral obligation to the poor - a controversial idea at the time.',
      },
      {
        slideNumber: 2,
        ...
        teacherNotes:
          "Scrooge is not just a character - he's a symbol of capitalism divorced from morality and human connection.",
      },
      {
        slideNumber: 3,
        ...
        teacherNotes:
          "Show contrast between Scrooge's wealth and Cratchit's poverty. They work in the same building but live in different worlds.",
      },
      {
        slideNumber: 4,
        ...
        teacherNotes:
          "The ghosts are not punishing Scrooge - they're trying to save him. This is crucial to understanding the message of redemption.",
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'This stave asks: How did Scrooge become like this? The answer is: through his own choices and losses that hardened him.',
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          'This is where the social critique is sharpest. Dickens shows that poor people have more genuine happiness than the wealthy.',
      },
      {
        slideNumber: 7,
        ...
        teacherNotes:
          "Tiny Tim is not a real person to Scrooge initially - he's a statistic. The ghost makes him real and sympathetic.",
      },
      {
        slideNumber: 8,
      ...
      },
      {
        ...
        teacherNotes:
          "This is Dickens' optimistic message: No matter how bad someone has been, redemption is possible if they choose it.",
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          "Emphasise that Scrooge doesn't become a saint. He becomes responsible - he acknowledges his connection to society.",
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          "This ending is sentimental, but it's also radical - Dickens is saying that wealth can be a moral responsibility, not just a possession.",
      },
      {
        slideNumber: 12,
        ...
        teacherNotes:
          'This was controversial in 1843. Dickens was arguing against laissez-faire economics. Help students see the radical nature of this message.',
      },
      {
        slideNumber: 13,
        ...
        teacherNotes:
          'Use these contrasts to show how Dickens structures the story around opposition between competing values.',
      },
      {
        slideNumber: 14,
        ...
        teacherNotes:
          'Dickens uses the supernatural not for horror, but for moral clarity. The ghosts make abstract ideas concrete and undeniable.',
      },
      {
        slideNumber: 15,
        ...
        teacherNotes:
          'Help students see this is not just a Victorian story - it speaks to contemporary issues about inequality and responsibility.',
      },
    ],
  },
  {
    ...
    slides: [
      {
        ...
        teacherNotes:
          'The setting is deliberate. By setting it in 1912, Priestley can show that the warnings about war and inequality were ignored.',
      },
      {
        slideNumber: 2,
        ...
        teacherNotes:
          "The Inspector is the moral centre of the play. Students should grapple with whether he's real or a symbol of conscience.",
      },
      {
        slideNumber: 3,
        ...
        teacherNotes:
          'The opening establishes the Birlings as comfortable, privileged, and self-interested. The Inspector will challenge everything they believe.',
      },
      {
        slideNumber: 4,
        ...
        teacherNotes:
          "Birling is not evil - he's typical of his class and time. But he's complicit in Eva's suffering through his indifference.",
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'Mrs. Birling shows how privilege can lead to moral blindness. She sees herself as charitable while being cruel.',
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          "Sheila's transformation is significant. She shows that young people are not trapped by their class - they can choose differently.",
      },
      {
        slideNumber: 7,
        ...
        teacherNotes:
          "Gerald's arc is tragic. He could have been different, but he chooses to retreat into privilege and denial.",
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          'Eric shows that conscience exists even in the young and privileged. His guilt is real and inescapable.',
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          "Eva's absence is crucial. She's not a full character - she's a victim whose humanity the privileged failed to recognize.",
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          'This is socialist philosophy - individuals are part of a society, and all share responsibility for its victims.',
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          'This twist is brilliant. It makes the audience question: Who was the Inspector? Does it matter?',
      },
      {
        slideNumber: 12,
        ...
        teacherNotes:
          "Encourage debate about the Inspector's identity. The point is that the play challenges us to believe in responsibility regardless.",
      },
      {
        slideNumber: 13,
        ...
        teacherNotes:
          'The ending is not neat. Priestley refuses to provide comfort or clear resolution. The audience, like the family, is left troubled.',
      },
      {
        slideNumber: 14,
        ...
        teacherNotes:
          'Use stage directions to show how Priestley uses lighting symbolically to represent moral clarity.',
      },
      {
        slideNumber: 15,
        ...
        teacherNotes:
          "End by connecting the play's message to contemporary debates about wealth inequality, social responsibility, and economic justice.",
      },
    ],
  },
]
    ...
    slides: [
      {
        ...
        teacherNotes:
          'This is a major unit. The key to success is deep knowledge of all poems and practice comparing them.',
      },
      {
        slideNumber: 2,
        ...
        bulletPoints: [
          ...
          'Bayonet Charge (Hughes) - Individual in warfare, shock of combat',
          "Storm on the Island (Heaney) - Nature's destructive power",
          "Poppies (Weir) - A mother's grief and the cost of war",
          ...
          'Tissue (Dharker) - Fragility of political power, globalisation',
          'The Émigrée (Rumens) - Memory, exile and idealised homeland',
        ],
        teacherNotes:
          'Print this list for students. They should know these poems well enough to reference them in essays without checking.',
      },
      {
        slideNumber: 3,
        ...
        teacherNotes:
          'This is often the first poem studied. Its message is clear - power is temporary. Use it as a baseline for comparing other power poems.',
      },
      {
        slideNumber: 4,
        title: 'Comparing Ozymandias & My Last Duchess',
        bulletPoints: [
          'Both explore the destructive nature of individual power',
          "Ozymandias: tyrant's legacy crumbles to ruin in the desert",
          "My Last Duchess: Duke's possessive control destroys his Duchess",
          'Both suggest: power abused leaves only emptiness or violence',
          "Different forms: Shelley's sonnet vs Browning's dramatic monologue",
        ],
        teacherNotes:
          'This is a common exam pairing. Students should understand how both poems explore the abuse of power through different speakers.',
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'These poems show different types of power - institutional and colonial. Both use the power of poetry to challenge oppressive power.',
      },
      {
        slideNumber: 6,
        ...
        bulletPoints: [
          ...
          "Hughes's Bayonet Charge: Individual soldier in chaos, questions why he's fighting",
        ...
        teacherNotes:
          'Have students compare these three war poems. Show how each uses different techniques to convey powerlessness.',
      },
      {
        slideNumber: 7,
        title: 'Personal Power & Control: My Last Duchess',
        bulletPoints: [
          "Browning's dramatic monologue exposes the Duke's possessive control",
          "The Duke's casual reference to commands stopping the Duchess's smiles implies murder",
          'His detachment shows power in relationships leading to harm and control',
          'Dramatic monologue: the speaker reveals his own culpability unwittingly',
          'Compare with Ozymandias: both expose individual abuses of power',
        ],
        teacherNotes:
          'This poem is disturbing but a brilliant critique of power. Help students see Browning is not celebrating the Duke - he is exposing him.',
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          'Teach students that form matters. The way a poem is structured contributes to its meaning about power.',
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          'Have students identify these techniques in poems. Show how language choices directly convey power relationships.',
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          "Teach students a comparison methodology. Give them sentence starters like 'Both poems explore...' and 'However, unlike X, Y...'.",
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          'Show how historical period shapes what poets write about and how they write. Context illuminates meaning.',
      },
      {
        slideNumber: 12,
        ...
        teacherNotes:
          'Model this comparison for students. Show how to structure an answer that identifies similarities and explores differences meaningfully.',
      },
      {
        slideNumber: 13,
        ...
        teacherNotes:
          "Don't let students think comparison means separate paragraphs about each poem. Show integrated comparison models.",
      },
      {
        slideNumber: 14,
        ...
        teacherNotes:
          'These mistakes are endemic in student work. Be explicit about what not to do.',
      },
      {
        slideNumber: 15,
        ...
        teacherNotes:
          'Systematic revision beats last-minute cramming. Encourage students to make their grid and update it regularly.',
        activityInstructions:
          'Have students make a study grid and fill it in over the unit. Use this as the basis for revision.',
      },
      {
        slideNumber: 16,
        ...
        teacherNotes:
          'Timed practice is essential. Do this regularly with different question prompts.',
      },
      {
        slideNumber: 17,
        ...
        teacherNotes:
          'Share the actual mark scheme with students. Show examples of responses at different levels.',
      },
      {
        slideNumber: 18,
        ...
        teacherNotes:
          'Demonstrate effective quotation use. Show the difference between embedding and blocking out quotes.',
      },
      {
        slideNumber: 19,
        ...
        teacherNotes:
          'Stress the importance of planning. Students who plan tend to write better-organised essays.',
      },
      {
        slideNumber: 20,
        ...
        teacherNotes:
          "Give students this checklist. If they can answer yes to all questions, they're ready.",
      },
    ],
  },
  {
    ...
    slides: [
      {
        ...
        teacherNotes:
          'Persuasion is not the same as coercion. Good persuasive writing makes an honest argument, not a dishonest one.',
      },
      {
        slideNumber: 2,
      ...
      },
      {
        ...
        teacherNotes:
          "Credibility is built through evidence, fairness, and transparency. Help students see they don't need false authority.",
      },
      {
        slideNumber: 4,
        ...
        teacherNotes:
          'Emotional appeal is powerful but can be seen as manipulation. Teach students the ethical use of pathos.',
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'Logic without emotion feels cold. But pathos without logos feels manipulative. Both matter.',
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          'These techniques should feel natural, not forced. Model how to use them authentically.',
      },
      {
        slideNumber: 7,
        ...
        teacherNotes:
          'Sentence variety is crucial to maintaining engagement while building persuasive force.',
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          'Show how word choice shapes perception. This is where persuasion becomes either honest advocacy or manipulation.',
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          'The most persuasive writing acknowledges the reader. Show how adjusting tone changes persuasive impact.',
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          'This is the basic structure. Students should be able to apply it to any persuasive task.',
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          'Teach students to ask: Where does this evidence come from? Is it reliable? Is it recent?',
      },
      {
        slideNumber: 12,
        ...
        teacherNotes:
          'The ability to fairly address opposition is a mark of sophisticated persuasion.',
      },
      {
        slideNumber: 13,
        ...
        teacherNotes:
          'Show examples of fallacies in real persuasive writing. Help students avoid them in their own work.',
      },
      {
        slideNumber: 14,
        ...
        teacherNotes:
          'Use a topic students can relate to. This exercise shows how perspective shapes argument.',
        activityInstructions:
          'Have students write opposing positions on the same topic. Compare them to see how perspective shapes evidence selection.',
      },
      {
        slideNumber: 15,
    ...
    slides: [
      {
        ...
        teacherNotes:
          'This is about reading comprehension and analytical skill. Speed and clarity matter.',
      },
      {
        slideNumber: 2,
        ...
        teacherNotes:
          "Non-fiction texts have different conventions. Help students understand each type's characteristics.",
      },
      {
        slideNumber: 3,
      ...
      },
      {
        ...
        teacherNotes:
          'Second reading should be more careful - maybe 10 minutes. Mark up the text as you read.',
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'Structure is not accidental. Show how structure shapes meaning and serves purpose.',
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          'Many students skip paragraph analysis. But understanding paragraph function is crucial to understanding how texts work.',
      },
      {
        slideNumber: 7,
        ...
        teacherNotes:
          'Show how the same idea can be expressed with different vocabulary, each conveying different meaning.',
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          'Ask students: Why did the writer choose this sentence length here? What effect does it create?',
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          'Tone and voice are often confused. Help students understand tone is more specific - attitude towards the subject matter.',
      },
      {
        slideNumber: 10,
      ...
      },
      {
        ...
        teacherNotes:
          "Comparison is not just 'both texts are about X'. It's about understanding how different writers approach the same topic.",
      },
      {
        slideNumber: 13,
        ...
        teacherNotes:
          'Most strong students use integrated comparison. Model this structure repeatedly.',
      },
      {
        slideNumber: 14,
        ...
        teacherNotes:
          'Do this regularly in class. Time pressure helps students develop fluency and confidence.',
        activityInstructions:
          'Use real Edexcel non-fiction texts if possible. Time students strictly - 5 minutes reading, 10 minutes writing.',
      },
      {
        slideNumber: 15,
        title: 'Exam Technique: Managing Time & Stress',
        ...
        teacherNotes:
          'Time management prevents panic. Students who stick to these timings tend to produce better essays.',
      },
    ],
  },
  {
    ...
    slides: [
      {
        ...
        teacherNotes:
          'Atmosphere is more subtle than plot or character. Help students learn to see and create it.',
      },
      {
        slideNumber: 2,
        ...
        teacherNotes:
          'Most students focus on visual detail. Push them to use all senses. It makes writing vivid and immersive.',
      },
      {
        slideNumber: 3,
        ...
        teacherNotes:
          "Read both versions aloud. The difference is striking. Emphasise 'show, don't tell'.",
      },
      {
        slideNumber: 4,
        ...
        teacherNotes:
          'Show how the same object described with different vocabulary creates different moods.',
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'Pacing is powerful. Show how the same scene reads differently with different pacing.',
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          'Help students understand tension is not the same as action. A quiet scene can be tense.',
      },
      {
        slideNumber: 7,
      ...
      },
      {
        ...
        teacherNotes:
          'Sustaining atmosphere over 400-500 words is a challenge. Show how to evolve without losing coherence.',
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          'Show stories where atmosphere shifts meaningfully. Explain what signals the shift.',
      },
      {
        slideNumber: 12,
        title: 'Avoiding Common Mistakes',
        ...
        teacherNotes:
          'These mistakes weaken atmospheric writing. Be explicit about what not to do.',
      },
      {
        slideNumber: 13,
      ...
      },
      {
        ...
        teacherNotes:
          "Do this exercise regularly. It's the best way to develop atmospheric writing skill.",
        activityInstructions:
          'Have students read their work aloud to a partner. Ask: Does the listener feel the atmosphere being created?',
      },
      {
        slideNumber: 15,
    ...
    slides: [
      {
        ...
        teacherNotes:
          "Help students understand comparison is not a checklist - it's an analytical process.",
      },
      {
        slideNumber: 2,
        ...
        teacherNotes:
          'Many students compare everything without focus. The question determines focus.',
      },
      {
        slideNumber: 3,
      ...
      },
      {
        ...
        teacherNotes:
          'Strong students spend more time on differences than similarities. Show why differences are more analytical.',
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          'Integrated comparison is more sophisticated. Model it explicitly and repeatedly.',
      },
      {
        slideNumber: 7,
      ...
      },
      {
        ...
        teacherNotes:
          'Model complete comparison. Show how to identify, explain, and evaluate differences.',
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          'Evaluation elevates comparison from list to analysis. Teach students to judge fairly.',
      },
      {
        slideNumber: 10,
      ...
      },
      {
        ...
        activityInstructions:
          "After writing, have students mark each other's work. Is the comparison integrated or separate? Is it focused on the question?",
      },
      {
        slideNumber: 12,
        ...
        teacherNotes:
          'Give this to students. Reviewing against it will improve their comparative writing.',
      },
    ],
  },
]
    ...
    slides: [
      {
        ...
        teacherNotes:
          "This is Shakespeare's most famous play. Help students see beyond the romance to the social and tragic dimensions.",
      },
      {
        slideNumber: 2,
        ...
        teacherNotes:
          "The speed of Romeo's transformation is important. This isn't gradual love - it's passionate, overwhelming, potentially foolish.",
      },
      {
        slideNumber: 3,
        ...
        teacherNotes:
          'Shakespeare presents love as beautiful and terrible - transformative but destructive.',
      },
      {
        slideNumber: 4,
        ...
        teacherNotes:
          "The feud is structural - it's the reason the tragedy unfolds. Without it, the couple could marry freely.",
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'The marriage is the point of no return. It commits them to each other against their families.',
      },
      {
        slideNumber: 6,
      ...
      },
      {
        ...
        teacherNotes:
          "Juliet is trapped. She must obey her father's marriage demand or reveal her secret. The potion is a desperate solution.",
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          'The tragedy is sealed by miscommunication. If Romeo had known about the potion, everyone would live.',
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          "This is a profound question. Don't expect a simple answer - help students explore the tension.",
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          'Show how Shakespeare complicates gender - Juliet shows courage while men show destructive aggression.',
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          'This is the core tragedy - not that love is bad, but that social structures make it impossible.',
      },
      {
        slideNumber: 12,
        ...
        teacherNotes:
          'Trace light/dark imagery through the play. Show how it reflects the tragedy of love in a violent world.',
      },
      {
        slideNumber: 13,
        ...
        teacherNotes:
          'Friar is a complex figure - trying to do good but making things worse. This adds another layer to the tragedy.',
      },
      {
        slideNumber: 14,
        ...
        teacherNotes:
          "The genius of the play is that it doesn't provide a clear moral. Help students sit with the ambiguity.",
      },
      {
        slideNumber: 15,
        ...
        teacherNotes:
          'End by connecting the play to contemporary issues of family conflict, social pressure, and love across divides.',
      },
    ],
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        teacherNotes:
          'This is a simple rule that helps students allocate time fairly. Practice applying it to different papers.',
      },
      {
        slideNumber: 3,
        ...
        teacherNotes:
          'Many students read multiple times. One strategic read beats three confused reads.',
      },
      {
        slideNumber: 4,
        ...
        teacherNotes:
          'Many students skip planning to save time. Actually, planning saves time because it prevents writing that goes nowhere.',
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          "Emphasise quality. Student essays don't need to be long if they're analytical.",
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          'Have students practise timed writing to build speed without losing legibility.',
      },
      {
        slideNumber: 7,
        ...
        teacherNotes:
          'Many students skip checking. Five minutes of checking typically recovers 3-5 marks.',
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          'Anxiety is normal. Teach students strategies to manage it - breathing, perspective, moving forward.',
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          'Mocks should be used for this purpose. Help students learn from their mock performance.',
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          "This checklist summarises the entire session. If students can answer yes to all, they're prepared.",
      },
    ],
  },
  {
    ...
    slides: [
      {
        ...
        teacherNotes:
          'This is a comprehensive revision session. Use it to consolidate student knowledge of all major techniques.',
      },
      {
        slideNumber: 2,
      ...
      },
      {
        ...
        teacherNotes:
          'Personification is everywhere in poetry. Help students identify and explain its effects.',
      },
      {
        slideNumber: 5,
      ...
      },
      {
        ...
        teacherNotes:
          'Hyperbole is often used for comic or emotional effect. Show how it differs from deliberate deception.',
      },
      {
        slideNumber: 9,
      ...
      },
      {
        ...
        teacherNotes:
          "Paradoxes reveal truth through contradiction. They're intellectually interesting.",
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          "Oxymora are vivid and striking. They're excellent for creating memorable language.",
      },
      {
        slideNumber: 12,
      ...
      },
      {
        ...
        teacherNotes:
          "Syntax is not separate from meaning - it's a major way writers create effects.",
      },
      {
        slideNumber: 15,
        ...
        teacherNotes:
          "Punctuation is not just correct/incorrect - it's a tool for creating specific effects.",
      },
      {
        slideNumber: 16,
        ...
        teacherNotes:
          'Word choice determines tone and reader response. Show how synonyms differ in their connotations.',
      },
      {
        slideNumber: 17,
        ...
        teacherNotes:
          'Tone is crucial but often underanalysed. Help students identify and explain tone.',
      },
      {
        slideNumber: 18,
        ...
        teacherNotes:
          'Repetition is powerful but must be purposeful. Show how it emphasises and reinforces ideas.',
      },
      {
        scoreNumber: 19,
        ...
        teacherNotes:
          'Allusions can be missed by readers unfamiliar with the reference. Explain their effect clearly.',
      },
      {
        slideNumber: 20,
        ...
        teacherNotes:
          'This summarises the entire approach. Students should use this framework for all analysis.',
      },
    ],
  },
  {
    ...
    slides: [
      {
        ...
        teacherNotes:
          "Sensory detail is the difference between showing and telling. It's essential for engaging writing.",
      },
      {
        slideNumber: 2,
      ...
      },
      {
        ...
        teacherNotes:
          'Many students neglect sound. Read examples aloud - the difference is striking.',
      },
      {
        slideNumber: 4,
        ...
        teacherNotes:
          'Tactile detail is often neglected but extremely powerful for creating immersion.',
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'Smell is underused but powerful. A few well-chosen olfactory details enhance vividness.',
      },
      {
        slideNumber: 6,
      ...
      },
      {
        ...
        teacherNotes:
          'Synesthesia is a technique used by sophisticated writers. Introduce it but use restraint.',
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          'This is a crucial lesson. Specific detail is always better than abstract description.',
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          'Figurative language elevates description. Show how it goes beyond literal description.',
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          "More description doesn't equal better writing. Teach selectivity and restraint.",
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          'Show how sensory detail is not neutral - it reveals the perspective of the narrator.',
      },
      {
        slideNumber: 12,
      ...
      },
      {
        ...
        teacherNotes:
          'Compare these directly. The difference is stark. Use this as a model for what works.',
      },
      {
        slideNumber: 14,
        ...
        teacherNotes:
          'This exercise forces students to think beyond visual detail and engage all senses.',
        activityInstructions:
          'After writing, peer-mark focusing on: Which senses are used? Are descriptions specific? Is there too much or too little?',
      },
      {
        slideNumber: 15,
    ...
    slides: [
      {
        ...
        teacherNotes:
          'The Victorian era is crucial context. Respectability, moral codes, and repression shaped society - and Stevenson critiques this.',
      },
      {
        slideNumber: 2,
        ...
        teacherNotes:
          'This is the central problem. Victorian society demanded repression - Jekyll tries to escape it through science.',
      },
      {
        slideNumber: 3,
        ...
        teacherNotes:
          "Jekyll is sympathetic - he's trapped by Victorian society's demands. But his solution is destructive.",
      },
      {
        slideNumber: 4,
        ...
        teacherNotes:
          "Hyde is not a separate person - he's part of Jekyll. The duality is internal, not external.",
      },
      {
        slideNumber: 5,
        ...
        teacherNotes:
          'The experiment is central. Stevenson critiques both scientific optimism and the belief that repression is healthy.',
      },
      {
        slideNumber: 6,
        ...
        teacherNotes:
          'The loss of control is the tragedy. Jekyll tries to master his nature and is mastered by it instead.',
      },
      {
        slideNumber: 7,
        ...
        teacherNotes:
          'The critique of Victorian society is subtle but clear. Respectability demands denial of human nature.',
      },
      {
        slideNumber: 8,
        ...
        teacherNotes:
          "The psychological effects of keeping secrets are explored through Lanyon's shock and death.",
      },
      {
        slideNumber: 9,
        ...
        teacherNotes:
          'Utterson is important because he represents us - the respectable reader trying to understand darker things.',
      },
      {
        slideNumber: 10,
        ...
        teacherNotes:
          "Help students see the complexity. The novella doesn't present simple morality.",
      },
      {
        slideNumber: 11,
        ...
        teacherNotes:
          'This is the psychological truth at the heart of the novella. Duality is universal.',
      },
      {
        slideNumber: 12,
        ...
        teacherNotes:
          "The Gothic elements are not incidental - they're central to the meaning about hidden darkness.",
      },
      {
        slideNumber: 13,
        ...
        teacherNotes:
          "The multiple perspectives prevent a single, definitive truth. This mirrors the novella's theme about hidden natures.",
      },
      {
        slideNumber: 14,
      ...
      },
      {
        ...
        teacherNotes:
          'End by connecting the text to contemporary issues - what do we still repress? What are the costs?',
      },
    ],
  },
]
...
export const allTeacherPowerpointsComplete = [
  ...teacherPowerpoints,
  ...teacherPowerpoints2,
  ...teacherPowerpoints3,
]
