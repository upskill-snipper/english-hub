...
<div class="common-mistake"><strong>Common Mistake:</strong> Writing about the whole text when the question says "lines 5-12." Stick to the lines specified. Going outside them wastes time and scores zero extra marks.</div>`,
        quiz: [
          {
            id: 'ks3r-m1-q1',
            question: 'What does the command word "analyse" require you to do?',
            options: [
              'List facts from the text',
              'Break something apart and examine how it works',
              'Give your personal opinion',
              'Retell the story in your own words',
            ],
            correct: 1,
            explanation:
              '"Analyse" means you need to examine the details closely - look at techniques, word choices, and their effects on the reader. It is more detailed than "explain."',
          },
          {
            id: 'ks3r-m1-q2',
            question:
              'A question is worth 8 marks. Roughly how many minutes should you spend on it?',
            options: ['4 minutes', '8 minutes', '15 minutes', '20 minutes'],
            correct: 1,
            explanation:
              'The rule of thumb is one minute per mark. An 8-mark question deserves about 8 minutes of focused writing.',
          },
          {
            id: 'ks3r-m1-q3',
            question:
              'If a question asks "How does the writer use language to create tension?", what must your answer focus on?',
            options: [
              'The plot of the story',
              "The writer's use of language techniques",
              'Your own feelings about the text',
              'The historical context',
            ],
            correct: 1,
            explanation:
              'The question specifically asks about language. You must discuss word choices, techniques like metaphor or short sentences, and explain how they create tension.',
          },
          {
            id: 'ks3r-m1-q4',
            question: 'What should you do FIRST when you read an exam question?',
            options: [
              'Start writing immediately',
              'Read the whole text again',
              'Underline the command word and check the marks',
              'Plan your conclusion',
            ],
            correct: 2,
            explanation:
              'Always identify the command word and marks first. This tells you exactly what to do and how long to spend. It takes 10 seconds and saves minutes of wasted effort.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Using quotations longer than one sentence. If your quotation is longer than about ten words, you are probably including unnecessary material. Cut it down to the key phrase.</div>`,
        quiz: [
          {
            id: 'ks3r-m2-q1',
            question: 'What does the "E" in PEEL stand for?',
            options: ['Example', 'Evidence and Explain', 'Evaluate', 'Engage'],
            correct: 1,
            explanation:
              "PEEL stands for Point, Evidence, Explain, Link. The two E's are Evidence (the quotation) and Explain (your analysis of what it means).",
          },
          {
            id: 'ks3r-m2-q2',
            question: 'Which is an example of an embedded quotation?',
            options: [
              'The writer says "the fog was cold." This shows the weather is bad.',
              'The fog is described as "cold" and threatening.',
              '"The fog was cold and damp" (line 3).',
              'In the text it says that the fog was cold.',
            ],
            correct: 1,
            explanation:
              'An embedded quotation is woven naturally into your own sentence. Option B does this by placing "cold" inside the writer\'s analysis sentence.',
          },
          {
            id: 'ks3r-m2-q3',
            question: 'How long should a quotation ideally be?',
            options: [
              'A full paragraph',
            ...
            correct: 2,
            explanation:
              'Short quotations (one word to one sentence) show you can select the most important words. Long quotations suggest you cannot identify what matters.',
          },
          {
            id: 'ks3r-m2-q4',
            question: 'What is the purpose of the "L" in PEEL?',
            options: [
              'To list more quotations',
              'To link back to the question or extend the point',
              'To end your essay',
              'To identify language techniques',
            ],
            correct: 1,
            explanation:
              'The Link step connects your analysis back to the original question, or develops your point by considering wider implications. It shows you are answering the question, not just describing the text.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> "Feature spotting" - just naming techniques without explaining their effect. Saying "The writer uses alliteration" earns zero marks unless you explain what the alliteration DOES.</div>`,
        quiz: [
          {
            id: 'ks3r-m3-q1',
            question: '"The stars danced in the midnight sky." What technique is this?',
            options: ['Simile', 'Metaphor', 'Personification', 'Alliteration'],
            correct: 2,
            explanation:
              'Stars cannot literally dance - this gives them a human action. Personification makes the sky feel alive and joyful.',
          },
          {
            id: 'ks3r-m3-q2',
            ...
            correct: 1,
            explanation:
              'Connotation is the emotional or cultural meaning beyond the literal definition. "Childish" and "childlike" have the same literal meaning but very different connotations.',
          },
          {
            id: 'ks3r-m3-q3',
            question:
              '"The bitter, brutal cold bit through his coat." What sound technique is used here?',
            options: ['Sibilance', 'Onomatopoeia', 'Plosive alliteration', 'Rhyme'],
            correct: 2,
            explanation:
              'The repeated hard "b" sounds are plosive consonants. The harsh, explosive sounds mirror the harsh, aggressive cold.',
          },
          {
            id: 'ks3r-m3-q4',
            question: 'Which is the BEST way to analyse language?',
            options: [
              'List every technique you can find',
              'Pick one word and explore its connotations in depth',
              'Describe what happens in the text',
              'Quote as much as possible',
            ],
            correct: 1,
            explanation:
              'Depth beats breadth. Zooming in on a single word and exploring what it suggests in context is more impressive than listing five techniques without explanation.',
          },
        ],
      },
      {
...
<div class="examiner-tip"><strong>Examiner Tip:</strong> When writing about structure, use phrases like "the writer shifts focus from... to..." or "the text moves from... towards..." This shows you are tracking how the writing develops, not just describing it.</div>`,
        quiz: [
          {
            id: 'ks3r-m4-q1',
            question: 'What effect does a very short sentence usually create?',
            options: [
              'A calm, peaceful mood',
              'Emphasis, tension, or impact',
              'Confusion',
              'Detailed description',
            ],
            correct: 1,
            explanation:
              'Short sentences create punch. They stand out against longer sentences and force the reader to pause, creating tension or emphasis.',
          },
          {
            id: 'ks3r-m4-q2',
            question: 'What does "narrative perspective" mean?',
            options: [
              'How the story ends',
              'Who is telling the story and what they can see',
              'The moral of the story',
              'The setting of the text',
            ],
            correct: 1,
            explanation:
              'Narrative perspective is the point of view from which the story is told. First person (I) gives personal intimacy; third person gives distance and a wider view.',
          },
          {
            id: 'ks3r-m4-q3',
            question: 'When analysing structure, what should you focus on?',
            options: [
              'Only the beginning of the text',
              'The order in which ideas are presented and why',
              'Rhyme and rhythm',
              'Spelling and grammar',
            ],
            correct: 1,
            explanation:
              'Structure analysis means examining how a text is organised - why certain things come first, how the focus shifts, and what effect the arrangement has on the reader.',
          },
          {
            id: 'ks3r-m4-q4',
            question:
              'A writer begins with a peaceful scene and gradually introduces threatening details. What structural technique is this?',
            options: [
              'Flashback',
              'A shift from calm to tension',
              'Repetition',
              'First person narration',
            ],
            correct: 1,
            explanation:
              'This is a structural shift - the writer deliberately moves from peace to threat to unsettle the reader. The contrast makes the danger feel more alarming.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Writing about Source A for half the answer and then Source B for the other half. This is not comparing - this is two mini-essays stapled together. Weave the texts together in every paragraph.</div>`,
        quiz: [
          {
            id: 'ks3r-m5-q1',
            question: 'Which is the best structure for a comparison answer?',
            options: [
              'All about Source A, then all about Source B',
              'Organised by theme, discussing both texts in each paragraph',
              'A summary of both texts',
              'Only discuss the differences',
            ],
            correct: 1,
            explanation:
              'Organising by theme and discussing both texts together in every paragraph is the strongest approach. It shows genuine comparison, not separate descriptions.',
          },
          {
            id: 'ks3r-m5-q2',
            question: 'Which word signals a difference between two texts?',
            options: ['Similarly', 'Furthermore', 'However', 'Also'],
            correct: 2,
            explanation:
              '"However" signals a contrast or difference. Using comparative connectives clearly shows the examiner you are comparing, not just describing.',
          },
          {
            id: 'ks3r-m5-q3',
            question: 'What is cross-referencing?',
            options: [
              'Checking your spelling',
              'Discussing both texts within the same paragraph',
              'Using footnotes',
              'Copying from the text',
            ],
            correct: 1,
            explanation:
              'Cross-referencing means bringing both texts together in the same paragraph. This is the hallmark of a strong comparison.',
          },
          {
            id: 'ks3r-m5-q4',
            question: 'What can you compare between two texts?',
            options: [
              'Only the language techniques',
              'Theme, tone, methods, and audience',
              'Only the plots',
              'Only the characters',
            ],
            correct: 1,
            explanation:
              'You can compare theme (what they are about), tone (the feeling), methods (techniques used), and audience (who they are written for). The best answers compare several of these.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Confusing inference with guessing. Inference must always be supported by evidence from the text. "I think she is nervous" is a guess. "The repeated action of checking her watch suggests nervousness" is an inference backed by evidence.</div>`,
        quiz: [
          {
            ...
            correct: 1,
            explanation:
              'Inference means working out what the writer is suggesting based on evidence, rather than relying on what is directly stated.',
          },
          {
            id: 'ks3r-m6-q2',
            question:
              '"He slammed the door and threw his bag on the floor." What can you infer about the character?',
            options: [
              'He is happy',
              'He is tired',
            ...
            correct: 2,
            explanation:
              'The violent actions of "slammed" and "threw" suggest strong negative emotion - most likely anger or frustration. The force behind these actions is the clue.',
          },
          {
            id: 'ks3r-m6-q3',
            question: 'What phrase is useful when writing about inference?',
            options: [
              '"The text says..."',
              '"This suggests that..."',
              '"In conclusion..."',
            ...
            correct: 1,
            explanation:
              '"This suggests that..." is the perfect phrase for inference. It shows you are interpreting evidence rather than just quoting it or guessing.',
          },
          {
            id: 'ks3r-m6-q4',
            question: 'What is the difference between inference and guessing?',
            options: [
              'There is no difference',
              'Inference is supported by evidence; guessing is not',
              'Guessing is more accurate',
              'Inference only works with poetry',
            ],
            correct: 1,
            explanation:
              'Inference is always grounded in evidence from the text. A guess has no support. Always show the evidence that leads to your inference.',
          },
        ],
      },
    ],
    assessmentQuestions: [
      {
        id: 'ks3r-a1',
        question: 'What does the command word "evaluate" require you to do?',
        options: [
          'List facts',
        ...
        correct: 1,
        explanation:
          '"Evaluate" means forming a judgement - do you agree or disagree? You must support your opinion with evidence from the text.',
      },
      {
        id: 'ks3r-a2',
        ...
        options: [
          ...
          'Plan, Edit, Evaluate, Learn',
          'Paragraph, Example, Effect, Language',
          'Point, Extract, Examine, List',
        ],
        correct: 0,
        explanation:
          'PEEL stands for Point, Evidence, Explain, Link - the structure for analytical paragraphs.',
      },
      {
        id: 'ks3r-a3',
        question: '"Her smile was like sunshine after rain." What technique is this?',
        options: ['Metaphor', 'Personification', 'Simile', 'Alliteration'],
        correct: 2,
        explanation: 'This uses "like" to compare her smile to sunshine - a simile.',
      },
      {
        id: 'ks3r-a4',
        question: 'What is an embedded quotation?',
        options: [
          'A very long quotation',
          'A quotation woven into your own sentence',
          'A quotation at the end of an essay',
          'A quotation from memory',
        ],
        correct: 1,
        explanation:
          'An embedded quotation is smoothly woven into your own sentence so it reads naturally.',
      },
      {
        id: 'ks3r-a5',
        question: '"The thunder growled in anger." What technique is used here?',
        options: ['Simile', 'Personification and pathetic fallacy', 'Onomatopoeia', 'Hyperbole'],
        correct: 1,
        explanation:
          'Thunder is given the human quality of "growling in anger" (personification), and the weather reflects mood (pathetic fallacy).',
      },
      {
        id: 'ks3r-a6',
        question: 'What is a connotation?',
        ...
        correct: 1,
        explanation:
          'Connotation is the emotional associations a word carries beyond its literal meaning.',
      },
      {
        id: 'ks3r-a7',
        question: 'What effect do short sentences create?',
        options: [
          'Detailed description',
          'Emphasis, tension, or impact',
          'A flowing rhythm',
        ...
        correct: 1,
        explanation:
          'Short sentences create punch and impact. They force the reader to pause and pay attention.',
      },
      {
        id: 'ks3r-a8',
        question: 'Which word would you use to signal a DIFFERENCE in a comparison?',
        options: ['Similarly', 'Furthermore', 'In contrast', 'Additionally'],
        correct: 2,
        explanation: '"In contrast" signals a difference between two texts or ideas.',
      },
      {
        id: 'ks3r-a9',
        ...
        options: [
          ...
          'Guessing what the writer means',
        ],
        correct: 1,
        explanation:
          'Inference means drawing conclusions based on clues and evidence, not explicit statements.',
      },
      {
        id: 'ks3r-a10',
        ...
        options: [
          ...
          'Repetition of "b" or "d" sounds',
          'A type of rhyme',
          'A narrative technique',
        ],
        correct: 0,
        explanation:
          'Sibilance is the repetition of soft "s" and "sh" sounds, often creating a sinister or soothing atmosphere.',
      },
      {
        id: 'ks3r-a11',
        question: 'Which is better: identifying three techniques or analysing one in depth?',
        options: [
          'Identifying three',
          'Analysing one in depth',
          'Neither matters',
          'Both are equally valued',
        ],
        correct: 1,
        explanation:
          'Depth always beats breadth. One technique analysed in detail scores higher than three techniques just named.',
      },
      {
        id: 'ks3r-a12',
        question: 'What is authorial intent?',
        options: [
          'What the writer had for breakfast',
          'Why the writer made specific choices',
          'The publication date',
          'The genre',
        ],
        correct: 1,
        explanation:
          "Authorial intent is the reason behind a writer's choices - why they selected specific words, structures, or techniques.",
      },
      {
        id: 'ks3r-a13',
        question: 'What does "narrative perspective" refer to?',
        options: [
        ...
        correct: 1,
        explanation:
          'Narrative perspective is the viewpoint from which the story is told - first person, third person, etc.',
      },
      {
        id: 'ks3r-a14',
        question:
          '"The bitter cold bit through his bones." What sound effect is created by the repeated "b"?',
        options: [
          'A soft, gentle feeling',
          'A harsh, aggressive quality',
          'A musical rhythm',
          'A whispering sound',
        ],
        correct: 1,
        explanation:
          'Plosive "b" sounds are hard and percussive, creating a harsh quality that mirrors the biting cold.',
      },
      {
        id: 'ks3r-a15',
        question: 'When comparing texts, what should every paragraph contain?',
        options: [
          'Only Source A',
          'Only Source B',
        ...
        correct: 2,
        explanation:
          'Every paragraph in a comparison should reference both texts to show genuine comparison.',
      },
      {
        id: 'ks3r-a16',
        question: 'A 4-mark question should take approximately how long?',
        options: ['1 minute', '4 minutes', '10 minutes', '20 minutes'],
        correct: 1,
        explanation:
          'The rule of thumb is one minute per mark, so a 4-mark question should take about 4 minutes.',
      },
      {
        id: 'ks3r-a17',
        question: 'What is the effect of a one-sentence paragraph?',
        options: [
          'It saves space',
          'It creates emphasis and draws attention',
          'It shows poor planning',
          'It has no particular effect',
        ],
        correct: 1,
        explanation:
          'A one-sentence paragraph stands out dramatically, creating emphasis and forcing the reader to pay attention.',
      },
      {
        id: 'ks3r-a18',
        question: '"All the world\'s a stage." What technique is this?',
        options: ['Simile', 'Metaphor', 'Personification', 'Hyperbole'],
        correct: 1,
        explanation:
          'This is a metaphor - it says the world IS a stage, not that it is LIKE a stage. It implies life is a performance.',
      },
      {
        id: 'ks3r-a19',
        question: 'What should you do BEFORE answering an exam question?',
        options: [
          'Start writing immediately',
          'Underline the command word and note the marks',
          'Read the whole text three times',
          'Write a full essay plan',
        ],
        correct: 1,
        explanation:
          'Always identify the command word and marks first - this tells you what to do and how long to spend.',
      },
      {
        id: 'ks3r-a20',
        question: 'Which phrase shows you are making an inference?',
        options: [
          '"The text says..."',
          '"This suggests that..."',
          '"I think..."',
        ...
        correct: 1,
        explanation:
          '"This suggests that..." shows you are interpreting evidence rather than just quoting or guessing.',
      },
    ],
  },
  {
        ...
        quiz: [
          {
            ...
            correct: 1,
            explanation:
              'Register means the level of formality. You adjust your register to match your audience - informal for friends, formal for business.',
          },
          {
            id: 'ks3w-m1-q2',
            question: 'If your audience is a headteacher, which style is most appropriate?',
            options: [
              'Slang and abbreviations',
              'Formal, polite, Standard English',
              'Casual and chatty',
              'Poetic and emotional',
            ],
            correct: 1,
            explanation:
              'A headteacher expects formal, professional writing. Use Standard English, full sentences, and a respectful tone.',
          },
          {
            id: 'ks3w-m1-q3',
            ...
            correct: 2,
            explanation:
              'Persuasive writing aims to convince. It uses rhetorical devices, evidence, and emotive language to sway the reader.',
          },
          {
            id: 'ks3w-m1-q4',
            question: 'What two things should you identify before starting any writing task?',
            options: [
            ...
            correct: 1,
            explanation:
              'Audience (who) and purpose (why) should guide every choice you make in your writing.',
          },
        ],
      },
      {
        ...
        quiz: [
          {
            ...
            options: ['0 minutes', '5 minutes', '15 minutes', '20 minutes'],
            correct: 1,
            explanation:
              '5 minutes of planning leaves 35 for writing and 5 for checking. This is the ideal split.',
          },
          {
            id: 'ks3w-m2-q2',
            question: 'What should you plan BEFORE you start writing the opening?',
            options: ['The title', 'The ending', 'The font', 'The word count'],
            correct: 1,
            explanation:
              'Knowing your ending before you begin gives your writing direction and purpose. A planned ending is always stronger.',
          },
          {
            id: 'ks3w-m2-q3',
            question: 'Which planning method works best for narrative writing?',
            options: [
              'Spider diagram',
              'Linear plan with numbered paragraphs',
              'Mind map',
              'No plan needed',
            ],
            correct: 1,
            explanation:
              'A linear plan with numbered paragraphs suits narrative writing because stories follow a sequence.',
          },
          {
            id: 'ks3w-m2-q4',
            question: 'Why does planning save time overall?',
            options: [
              'It makes you write faster',
              'It prevents rambling and repetition',
              'Plans count toward the word count',
              'It does not save time',
            ],
            correct: 1,
            explanation:
              'Planning stops you from going off-topic, repeating yourself, or getting stuck mid-paragraph. The time invested in planning pays off.',
          },
        ],
      },
      {
        ...
        quiz: [
          {
            ...
            options: [
              ...
              'Describe how something looks/sounds/feels rather than just naming the emotion',
              'Show your plan to the teacher',
              'Tell a story instead of describing',
            ],
            correct: 1,
            explanation:
              '"Show, don\'t tell" means using sensory details and actions to convey emotions rather than just labelling them.',
          },
          {
            id: 'ks3w-m3-q2',
            ...
            options: [
              'A logical error',
              "Using weather to reflect a character's mood",
              'A weak argument',
              'A type of metaphor',
            ],
            correct: 1,
            explanation:
              "Pathetic fallacy is when the environment mirrors a character's emotions - rain for sadness, storms for conflict, sunshine for joy.",
          },
          {
            id: 'ks3w-m3-q3',
            question: 'Which sense is often described as the most evocative?',
            options: ['Sight', 'Sound', 'Smell', 'Touch'],
            correct: 2,
            explanation:
              'Smell is strongly connected to memory and emotion, making it particularly powerful in descriptive writing.',
          },
          {
            id: 'ks3w-m3-q4',
            question: 'What creates the strongest descriptive writing?',
            options: [
              'Describing every single detail',
              'A few carefully chosen details described vividly',
              'Using as many adjectives as possible',
              'Long paragraphs with no breaks',
            ],
            correct: 1,
            explanation:
              'Quality beats quantity. Three vivid, specific details are more powerful than ten vague ones.',
          },
        ],
      },
      {
        ...
        quiz: [
          {
            ...
            correct: 1,
            explanation:
              'The climax is the peak of tension - the most intense, dramatic moment where everything changes.',
          },
          {
            id: 'ks3w-m4-q2',
            question: 'Which opening is strongest?',
            options: [
              '"One day, a girl went to school."',
              '"The letter arrived on a Tuesday."',
              '"This story is about a girl called Mira."',
              '"I am going to write about something that happened."',
            ],
            correct: 1,
            explanation:
              'This opening drops the reader into an unusual event immediately. It creates intrigue without explaining everything.',
          },
          {
            id: 'ks3w-m4-q3',
            question: 'How can short sentences create tension?',
            options: [
              'They make writing easier to read',
              'They force pauses that build suspense',
              'They save time',
              'They look neater',
            ],
            correct: 1,
            explanation:
              "Short sentences create pauses. Each pause builds anticipation. The reader slows down, mirroring the character's heightened awareness.",
          },
          {
            id: 'ks3w-m4-q4',
            question: 'In a 45-minute exam, how much plot should your story contain?',
            options: [
              'An entire adventure from start to finish',
              'One focused scene or moment',
              'At least three subplots',
              'As much as possible',
            ],
            correct: 1,
            explanation:
              'One well-told scene is always better than a rushed adventure. Focus on depth - description, emotion, tension - not breadth.',
          },
        ],
      },
      {
        ...
        quiz: [
          {
            ...
            correct: 1,
            explanation:
              'AFOREST is a toolkit of persuasive techniques: Alliteration, Facts, Opinion, Rhetorical question, Emotive language, Statistics, Tricolon (rule of three).',
          },
          {
            id: 'ks3w-m5-q2',
            ...
            options: [
              ...
              'To show you have considered both sides, making your argument stronger',
              'Because the question requires it',
              'To fill space',
            ],
            correct: 1,
            explanation:
              'Including a counter-argument shows maturity and balance. It actually strengthens your position because you demonstrate you can dismiss the opposition with evidence.',
          },
          {
            id: 'ks3w-m5-q3',
            question: '"How long must we tolerate this injustice?" What technique is this?',
            options: ['Statistic', 'Rhetorical question', 'Simile', 'Counter-argument'],
            correct: 1,
            explanation:
              'This is a rhetorical question - asked for effect, not expecting an answer. It makes the reader feel the answer is obvious.',
          },
          {
            id: 'ks3w-m5-q4',
            question: 'Which opening is best for persuasive writing?',
            options: [
              '"In this essay I will argue..."',
              '"A shocking statistic followed by a bold claim"',
              '"Dear Sir or Madam"',
              '"Once upon a time..."',
            ],
            correct: 1,
            explanation:
              'A punchy opening grabs attention immediately. Starting with a fact, bold claim, or rhetorical question is far more effective than announcing what you will argue.',
          },
        ],
      },
      {
        ...
        quiz: [
          {
            ...
            options: [
              'For plurals',
              'For possession and contractions only',
              'At the end of every sentence',
              'Before any "s"',
            ],
            correct: 1,
            explanation:
              "Apostrophes have exactly two uses: possession (the dog's bone) and contraction (don't). Never for plurals.",
          },
          {
            id: 'ks3w-m6-q2',
            ...
            correct: 1,
            explanation:
              'A semicolon joins two complete sentences that are closely related: "The rain stopped; the sun emerged."',
          },
          {
            id: 'ks3w-m6-q3',
            ...
            correct: 1,
            explanation:
              '"They\'re" = "they are." "Their" = belonging to them. "There" = a place. "They\'re going to the park" is correct.',
          },
          {
            id: 'ks3w-m6-q4',
            ...
            options: [
              ...
              'When you change time, place, topic, or speaker',
              'Only at the beginning and end',
              'Whenever you feel like it',
            ],
            correct: 1,
            explanation: 'The TTPS rule: new paragraph for new Time, Place, Topic, or Speaker.',
          },
        ],
      },
    ],
    assessmentQuestions: [
      {
        ...
        correct: 1,
        explanation:
          'Register is the level of formality you use, which should match your audience.',
      },
      {
        id: 'ks3w-a2',
        question: 'How long should you spend planning a 45-minute writing task?',
        options: ['0 minutes', '5 minutes', '15 minutes', '25 minutes'],
        correct: 1,
        explanation: '5 minutes planning, 35 writing, 5 checking is the ideal split.',
      },
      {
        id: 'ks3w-a3',
        question: 'What does "show, don\'t tell" mean?',
        options: [
          ...
          'Use sensory details instead of naming emotions directly',
          'Show your work to a partner',
          'Tell a story instead of an argument',
        ],
        correct: 1,
        explanation:
          'It means describing what something looks, sounds, and feels like rather than just labelling the emotion.',
      },
      {
        id: 'ks3w-a4',
        question: 'What is the climax of a story?',
        ...
        correct: 1,
        explanation: 'The climax is the peak moment of tension - the turning point.',
      },
      {
        id: 'ks3w-a5',
        question: 'What is a counter-argument?',
        options: [
          'An argument that supports your view',
          'Acknowledging the opposing viewpoint',
          'A fact you cannot prove',
          'The conclusion',
        ],
        correct: 1,
        explanation:
          'A counter-argument considers the other side before explaining why your position is stronger.',
      },
      {
        id: 'ks3w-a6',
        question: 'What does a colon introduce?',
        options: ['A new paragraph', 'A list or explanation', 'A question', 'A dialogue'],
        correct: 1,
        explanation: 'A colon introduces what follows: a list, an explanation, or an elaboration.',
      },
      {
        id: 'ks3w-a7',
        question: 'Which is the best opening for a narrative?',
        options: [
          '"One normal day..."',
        ...
        correct: 2,
        explanation: 'This opening creates immediate intrigue by presenting something unusual.',
      },
      {
        id: 'ks3w-a8',
        question: '"We need change. We need action. We need it now." What technique is this?',
        options: ['Alliteration', 'Tricolon and anaphora', 'Simile', 'Counter-argument'],
        correct: 1,
        explanation:
          'This uses both tricolon (three items) and anaphora (repeated "We need") for powerful emphasis.',
      },
      {
        id: 'ks3w-a9',
        question: 'Which sense is described as the most evocative in descriptive writing?',
        options: ['Sight', 'Hearing', 'Smell', 'Taste'],
        correct: 2,
        explanation:
          'Smell is strongly connected to memory and emotion, making it particularly powerful.',
      },
      {
        id: 'ks3w-a10',
        question: 'What are the two uses of apostrophes?',
        options: [
        ...
        correct: 1,
        explanation:
          "Apostrophes are for possession (the dog's bone) and contraction (don't). Never for plurals.",
      },
      {
        id: 'ks3w-a11',
        question: 'What is pathetic fallacy?',
        options: [
          'A weak argument',
          "Weather reflecting a character's mood",
          'A type of dialogue',
          'An unreliable narrator',
        ],
        correct: 1,
        explanation:
          'Pathetic fallacy uses weather/environment to mirror emotions - storms for anger, sunshine for happiness.',
      },
      {
        id: 'ks3w-a12',
        question: 'When should you start a new paragraph?',
        options: [
          'Every 100 words',
          'When changing time, place, topic, or speaker',
          'Only when the teacher tells you',
          'At the end of each page',
        ],
        correct: 1,
        explanation: 'TTPS: new paragraph for new Time, Place, Topic, or Speaker.',
      },
      {
        id: 'ks3w-a13',
        question: 'What is the purpose of the last 5 minutes of a writing exam?',
        options: [
        ...
        correct: 1,
        explanation:
          'The last 5 minutes should be spent checking for spelling, punctuation, and grammar errors.',
      },
      {
        id: 'ks3w-a14',
        question: '"Their," "there," and "they\'re" - which means "belonging to them"?',
        options: ['There', "They're", 'Their', 'All three'],
        correct: 2,
        explanation: '"Their" = belonging to them. "There" = a place. "They\'re" = they are.',
      },
      {
        id: 'ks3w-a15',
        question: 'What makes dialogue effective?',
        options: [
          'Long speeches',
          'Sounding natural and revealing character',
          'Using "said" every time',
          'Including every word characters say',
        ],
        correct: 1,
        explanation:
          'Good dialogue sounds natural, reveals something about the characters, and moves the story forward.',
      },
      {
        id: 'ks3w-a16',
        question: 'What is a rhetorical question?',
        options: [
          'A question on the exam paper',
        ...
        correct: 1,
        explanation:
          'Rhetorical questions are asked for impact - they make the reader think without expecting a direct answer.',
      },
      {
        id: 'ks3w-a17',
        question: 'Which sentence type shows sophistication?',
        options: ['Simple', 'Compound', 'Complex', 'Fragment'],
        correct: 2,
        explanation:
          'Complex sentences (with subordinate clauses) show sophistication: "Although it was raining, she walked to school."',
      },
      {
        id: 'ks3w-a18',
        question: 'What should your plan include?',
        options: [
          'Full sentences for every paragraph',
          'Audience, purpose, main points, and planned ending',
          'Only your opening line',
          'A list of techniques to use',
        ],
        correct: 1,
        explanation:
          'A good plan includes audience, purpose, main paragraph ideas, and your planned ending.',
      },
      {
        id: 'ks3w-a19',
        question: 'What is the AFOREST technique "E" for?',
        options: ['Evidence', 'Emotive language', 'Examples', 'Exaggeration'],
        correct: 1,
        explanation:
          'E in AFOREST stands for Emotive language - words chosen to provoke an emotional response.',
      },
      {
        id: 'ks3w-a20',
        question: 'How many events should a narrative cover in a 45-minute exam?',
        options: [
          'As many as possible',
          'One focused scene or moment',
          'At least five',
          'The entire story from birth to death',
        ],
        correct: 1,
        explanation:
          'One well-developed scene with rich description and tension is far better than a rushed adventure.',
      },
    ],
  },
  {
...
<li><strong>Pronoun confusion:</strong> "John and me went to the store" is wrong. Use "I" in the subject position. "John and I went to the store."</li>
        ...
        quiz: [
          {
            id: 'ks3g-m1-q1',
            question: '"Justice" is an example of what type of noun?',
            options: ['Proper noun', 'Common noun', 'Abstract noun', 'Collective noun'],
            correct: 2,
            explanation:
              '"Justice" is something you cannot physically touch - it is an idea, making it an abstract noun.',
          },
          {
            id: 'ks3g-m1-q2',
            ...
            correct: 1,
            explanation:
              'Adverbs modify verbs (ran quickly), adjectives (extremely cold), or other adverbs (very slowly).',
          },
          {
            id: 'ks3g-m1-q3',
            ...
            correct: 2,
            explanation:
              '"Because" is a subordinating conjunction - it introduces a subordinate clause that cannot stand alone.',
          },
          {
            id: 'ks3g-m1-q4',
            question: 'Why should you name word classes in your analysis?',
            options: [
              'It wastes time',
              'It shows grammatical knowledge and earns more marks',
              'It is only for grammar questions',
              'It is not necessary',
            ],
            correct: 1,
            explanation:
              'Using correct terminology like "the adjective..." or "the verb..." shows precision and grammatical understanding.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Writing only in simple sentences makes your work sound childish. Writing only in complex sentences makes it hard to follow. The best writing mixes all types deliberately.</div>`,
        quiz: [
          {
            id: 'ks3g-m2-q1',
            question: '"The door slammed." What type of sentence is this?',
            options: ['Compound', 'Complex', 'Simple', 'Compound-complex'],
            correct: 2,
            explanation:
              'This has one main clause with a subject (door) and verb (slammed) - a simple sentence.',
          },
          {
            id: 'ks3g-m2-q2',
            question: 'What joins the two parts of a compound sentence?',
            options: [
              'A full stop',
            ...
            correct: 2,
            explanation:
              'Compound sentences use coordinating conjunctions: and, but, or, so, yet (FANBOYS).',
          },
          {
            id: 'ks3g-m2-q3',
            question: '"Although she was tired, she kept running." What type of sentence is this?',
            options: ['Simple', 'Compound', 'Complex', 'Fragment'],
            correct: 2,
            explanation:
              'This has a main clause ("she kept running") and a subordinate clause ("Although she was tired") - a complex sentence.',
          },
          {
            id: 'ks3g-m2-q4',
            question: 'What is the effect of using simple sentences?',
            options: [
              'They sound childish',
              'They create impact, clarity, and emphasis',
              'They show sophistication',
              'They have no particular effect',
            ],
            correct: 1,
            explanation:
              'Simple sentences are direct and punchy. Used deliberately, they create emphasis and impact.',
          },
        ],
      },
      {
        ...
        quiz: [
          {
            ...
            options: [
              ...
              '"The dog\'s wagged its tails."',
            ],
            correct: 1,
            explanation:
              '"Its" (no apostrophe) means belonging to it. "It\'s" means "it is." The dog\'s tail belongs to the dog, so "its" is correct here.',
          },
          {
            id: 'ks3g-m3-q2',
            ...
            correct: 1,
            explanation:
              'A comma splice incorrectly joins two sentences with just a comma. Fix with a semicolon, conjunction, or full stop.',
          },
          {
            id: 'ks3g-m3-q3',
            ...
            options: [
              'Before a list',
              'To join two related complete sentences',
              'After every clause',
              'Instead of a full stop',
            ],
            correct: 1,
            explanation:
              'A semicolon joins two complete, closely related sentences: "It rained; we stayed inside."',
          },
          {
            id: 'ks3g-m3-q4',
            question: 'What does a colon introduce?',
            options: [
              'A new paragraph',
              'A list, explanation, or elaboration',
              'A question',
              'Dialogue',
            ],
            correct: 1,
            explanation:
              'A colon introduces what follows - a list, an explanation, or an elaboration of the preceding statement.',
          },
        ],
      },
      {
...
<div class="examiner-tip"><strong>Examiner Tip:</strong> You do not need to use complicated words everywhere. The mark for vocabulary is about choosing the RIGHT word, not the longest word. "The cold bit through his coat" is better than "The frigid temperature permeated his outerwear."</div>`,
        quiz: [
          {
            id: 'ks3g-m4-q1',
            question: 'What is a Tier 2 word?',
            options: [
              'An everyday word like "big"',
              'An academic word used across subjects like "analyse"',
              'A subject-specific word like "metaphor"',
              'A slang word',
            ],
            correct: 1,
            explanation:
              'Tier 2 words are academic vocabulary used across subjects - words like analyse, significant, demonstrate. They upgrade your writing.',
          },
          {
            id: 'ks3g-m4-q2',
            question: 'What is the difference between "childish" and "childlike"?',
            options: [
            ...
            correct: 1,
            explanation:
              '"Childish" connotes immaturity (negative). "Childlike" connotes innocence and wonder (positive). Same root, different connotations.',
          },
          {
            id: 'ks3g-m4-q3',
            ...
            options: [
              'Words that rhyme',
              'A group of words sharing the same root',
              'Synonyms',
              'Words in the same sentence',
            ],
            correct: 1,
            explanation:
              'A word family shares a root: terror → terrify → terrifying → terrified. Knowing the root helps you understand related words.',
          },
          {
            id: 'ks3g-m4-q4',
            question: 'Should you always use the longest, most complex word?',
            options: [
              'Yes, always',
              'No - use the RIGHT word, not the longest',
              'Only in conclusions',
              'Only in formal writing',
            ],
            correct: 1,
            explanation:
              'Precision matters more than complexity. The right word at the right moment is more effective than a long word that does not fit.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> "Should of" instead of "should have." This happens because "should've" sounds like "should of." But "of" is never correct after should/could/would. It is always "should HAVE."</div>`,
        quiz: [
          {
            ...
            correct: 2,
            explanation:
              '"Definitely" - think "definite" + "ly." The root word is "definite" with an "i," not an "a."',
          },
          {
            id: 'ks3g-m5-q2',
            ...
            options: [
              'A type of poem',
              'A memory trick for spelling',
              'A punctuation mark',
              'A word class',
            ],
            correct: 1,
            explanation:
              'A mnemonic is a memory aid - like "there is a LIE in beLIEve" or "Big Elephants Can Always Understand Small Elephants" for BECAUSE.',
          },
          {
            id: 'ks3g-m5-q3',
            question: 'Which is correct: "should of" or "should have"?',
            options: ['Should of', 'Should have', 'Both are correct', 'Neither is correct'],
            correct: 1,
            explanation:
              '"Should have" is always correct. "Should of" is a common error caused by the contraction "should\'ve" sounding like "should of."',
          },
          {
            id: 'ks3g-m5-q4',
            question: 'What should you do if you cannot spell a word in an exam?',
            options: [
            ...
            correct: 2,
            explanation:
              'If you are unsure, use a synonym you can spell. A simpler word spelled correctly is better than a complex word spelled wrong.',
          },
        ],
      },
    ],
    assessmentQuestions: [
      {
        id: 'ks3g-a1',
        question: '"Freedom" is an example of what type of noun?',
        options: ['Proper', 'Collective', 'Abstract', 'Common'],
        correct: 2,
        explanation: '"Freedom" is an abstract noun - you cannot physically touch it.',
      },
      {
        id: 'ks3g-a2',
        question: 'What does an adjective describe?',
        options: ['A verb', 'A noun', 'An adverb', 'A preposition'],
        correct: 1,
        explanation: 'Adjectives describe nouns: "the tall building," "a red car."',
      },
      {
        id: 'ks3g-a3',
        question: '"Although she was tired, she finished the race." What type of sentence?',
        options: ['Simple', 'Compound', 'Complex', 'Fragment'],
        correct: 2,
        explanation:
          'This has a subordinate clause ("Although she was tired") + main clause - complex sentence.',
      },
      {
        id: 'ks3g-a4',
        ...
        options: [
          'Before a list',
          'Joining two related complete sentences',
          'After a conjunction',
          'Replacing a comma',
        ],
        correct: 1,
      ...
      },
      {
        ...
        correct: 2,
        explanation: '"Although" introduces a subordinate clause that cannot stand alone.',
      },
      {
        id: 'ks3g-a6',
        question: '"It\'s" means...',
        options: ['Belonging to it', 'It is', 'A plural', 'It was'],
        correct: 1,
        explanation:
          '"It\'s" is a contraction of "it is." "Its" (no apostrophe) means belonging to it.',
      },
      {
        id: 'ks3g-a7',
        question: 'What is a Tier 2 word?',
        options: [
          'Slang',
          'An academic word used across subjects',
          'A very long word',
          'A word only used in English',
        ],
        correct: 1,
        explanation:
          'Tier 2 words are academic vocabulary (analyse, significant, demonstrate) used across all subjects.',
      },
      {
        id: 'ks3g-a8',
        question: '"Slender" and "skinny" differ in their...',
        options: ['Spelling', 'Connotations', 'Pronunciation', 'Length'],
        correct: 1,
        explanation:
          'Both describe thinness, but "slender" has positive connotations while "skinny" is negative.',
      },
      {
        id: 'ks3g-a9',
        question: 'How do you spell the word meaning "required"?',
        options: ['Neccesary', 'Neccessary', 'Necessary', 'Necesary'],
        correct: 2,
        explanation: '"Necessary" - one c, two s\'s. Remember: one collar, two socks.',
      },
      {
        id: 'ks3g-a10',
        question: 'What type of verb is "believe"?',
        options: ['Dynamic', 'Stative', 'Modal', 'Auxiliary'],
        correct: 1,
        explanation:
          '"Believe" is a stative verb - it describes a state of mind, not a physical action.',
      },
      {
        id: 'ks3g-a11',
        question: 'What is a comma splice?',
        options: [
          'A correctly used comma',
          'Joining two sentences with only a comma',
          'Using too few commas',
          'A comma before "and"',
        ],
        correct: 1,
        explanation: 'A comma splice incorrectly joins two complete sentences with just a comma.',
      },
      {
        id: 'ks3g-a12',
        question: 'When do you double the consonant before adding -ing?',
        options: [
          'Always',
          'When the word ends in a single consonant after a short vowel',
          'Never',
          'Only for long words',
        ],
        correct: 1,
        explanation:
          'Double the final consonant when a short word ends consonant-vowel-consonant: run → running, stop → stopping.',
      },
      {
        id: 'ks3g-a13',
        ...
        options: [
          'Time only',
          'The relationship between a noun and another word',
          'Action',
          'Emotion',
        ],
        correct: 1,
        explanation:
          'Prepositions show relationships of position, time, or direction: in, on, under, between, during.',
      },
      {
        id: 'ks3g-a14',
        question: 'Which is correct?',
        options: [
          ...
          '"There books are here."',
          '"Theyre books are here."',
        ],
        correct: 1,
        explanation:
          '"Their" = belonging to them. The books belong to them, so "their" is correct.',
      },
      {
        id: 'ks3g-a15',
        question: '"She ran quickly." What word class is "quickly"?',
        options: ['Adjective', 'Noun', 'Adverb', 'Verb'],
        correct: 2,
        explanation: '"Quickly" modifies the verb "ran," telling us how she ran - it is an adverb.',
      },
      {
        id: 'ks3g-a16',
        question: 'What does a colon do?',
        options: [
          'Ends a sentence',
        ...
        correct: 1,
        explanation: 'A colon introduces what follows: a list, explanation, or elaboration.',
      },
      {
        id: 'ks3g-a17',
        question: '"The dog barked and the cat hid." What type of sentence?',
        options: ['Simple', 'Compound', 'Complex', 'Fragment'],
        correct: 1,
        explanation:
          'Two main clauses joined by "and" (coordinating conjunction) - compound sentence.',
      },
      {
        id: 'ks3g-a18',
        ...
        correct: 1,
        explanation:
          'Reading widely exposes you to new words in context, which is the most effective way to build vocabulary.',
      },
      {
        id: 'ks3g-a19',
        question: '"Should of" is...',
        options: [
          'Correct',
          'Incorrect - it should be "should have"',
          'Only correct in informal writing',
          'An alternative spelling',
        ],
        correct: 1,
        explanation:
          '"Should of" is always wrong. The correct form is "should have" (contracted: "should\'ve").',
      },
      {
        id: 'ks3g-a20',
        question: 'In "i before e except after c," which word is an exception?',
        options: ['Believe', 'Receive', 'Weird', 'Achieve'],
        correct: 2,
        explanation:
          '"Weird" is an exception - it has "ei" without a preceding "c" and does not follow the pattern.',
      },
    ],
  },
]

const ks3CoursesExtra: CourseData[] = [
  {
    id: 'ks3-poetry',
        ...
        quiz: [
          {
            ...
            options: [
              ...
              'A group of lines in a poem separated by a blank line',
              'The title of a poem',
              'A poem with exactly four lines',
            ],
            correct: 1,
            explanation:
              'A stanza is a group of lines in a poem, separated from other stanzas by a gap. It functions like a paragraph in prose.',
          },
          {
            id: 'ks3p-m1-q2',
            ...
            options: [
              'When a poem rhymes',
              'When a sentence runs past the end of a line into the next',
              'When a poem has no punctuation',
              'When two words alliterate',
            ],
            correct: 1,
            explanation:
              'Enjambment occurs when a sentence or phrase continues beyond the end of a line without stopping. It can create momentum or surprise.',
          },
          {
            id: 'ks3p-m1-q3',
            question: 'Why is poetry described as "compressed"?',
            options: [
              'Because poems are printed in small font',
              'Because every word carries enormous weight and meaning',
              'Because poems must be shorter than 100 words',
              'Because poets write quickly',
            ],
            correct: 1,
            explanation:
              'Poetry is compressed because poets pack a great deal of meaning into very few words. Each word is carefully chosen for its sound, connotations, and effect.',
          },
        ],
      },
      {
        ...
        quiz: [
          {
            ...
            options: [
              ...
              'Five pairs of syllables with stress on the second beat',
              'A poem that rhymes in couplets',
              'A type of free verse',
            ],
            correct: 1,
            explanation:
              'Iambic pentameter consists of five iambic feet (pairs of syllables where the second is stressed). It is the most common metre in English poetry.',
          },
          {
            id: 'ks3p-m2-q2',
            question: 'What does an ABAB rhyme scheme mean?',
            options: [
              'Every line rhymes',
            ...
            correct: 1,
            explanation:
              'ABAB means alternate rhyme: the first line rhymes with the third, and the second line rhymes with the fourth.',
          },
          {
            id: 'ks3p-m2-q3',
            question: 'What effect can half-rhyme create?',
            options: [
              'A perfect musical quality',
            ...
            correct: 1,
            explanation:
              'Half-rhyme creates a feeling that something is slightly off - words almost match but do not, suggesting tension, unease, or things not fitting together.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Confusing metaphor and simile. A simile uses "like" or "as" to compare; a metaphor states that something IS something else. "He fought like a lion" is a simile; "He was a lion in battle" is a metaphor.</div>`,
        quiz: [
          {
            id: 'ks3p-m3-q1',
            question: '"The wind howled through the empty streets." What type of imagery is this?',
            options: [
              'Visual imagery',
              'Auditory imagery and personification',
              'Tactile imagery',
              'Gustatory imagery',
            ],
            correct: 1,
            explanation:
              'The wind "howling" appeals to the sense of hearing (auditory imagery) and gives the wind a human action (personification), suggesting something wild and mournful.',
          },
          {
            id: 'ks3p-m3-q2',
            ...
            options: [
              'A very long simile',
              'A metaphor sustained over several lines or a whole poem',
              'A metaphor using the word "like"',
              'A comparison between two poems',
            ],
            correct: 1,
            explanation:
              'An extended metaphor develops a single comparison across multiple lines or an entire poem, adding layers of detail and meaning.',
          },
          {
            id: 'ks3p-m3-q3',
            question: 'In poetry, what does symbolism involve?',
            options: [
              'Using punctuation marks as decorations',
              'An object or image representing something larger or deeper',
              'Writing in a foreign language',
              'Using only literal descriptions',
            ],
            correct: 1,
            explanation:
              'Symbolism is when a concrete object or image represents an abstract idea - for example, a storm symbolising conflict, or a rose symbolising love.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Writing about Poem A for half the essay and Poem B for the other half. This is two separate analyses stapled together, not a comparison. Weave the poems together throughout.</div>`,
        quiz: [
          {
            id: 'ks3p-m4-q1',
            question: 'What is the best way to structure a poetry comparison?',
            options: [
              'Write about Poem A, then Poem B',
              'Organise by theme, discussing both poems in each paragraph',
              'Only focus on the differences',
              'Write a summary of each poem',
            ],
            correct: 1,
            explanation:
              'The strongest comparisons are organised by theme or idea, with both poems discussed in each paragraph. This shows genuine comparison, not separate descriptions.',
          },
          {
            id: 'ks3p-m4-q2',
            question: 'Which of these is a useful comparison connective?',
            options: ['"Next"', '"In contrast"', '"Finally"', '"For instance"'],
            correct: 1,
            explanation:
              '"In contrast" signals a difference between two poems and shows the examiner you are actively comparing. Other useful connectives include "similarly," "whereas," and "however."',
          },
          {
            id: 'ks3p-m4-q3',
            question: 'What four areas should you compare when analysing two poems?',
            options: [
              'Plot, characters, setting, ending',
              'Theme, tone, form/structure, language/imagery',
              'Length, title, author, date',
              'Vocabulary, spelling, grammar, punctuation',
            ],
            correct: 1,
            explanation:
              'The four key areas for comparing poems are theme (what they are about), tone (how they feel), form and structure (how they are arranged), and language and imagery (the techniques used).',
          },
        ],
      },
      {
        ...
        quiz: [
          {
            ...
            correct: 1,
            explanation:
              'A caesura is a pause in the middle of a line, usually created by punctuation such as a full stop, comma, or dash. It can create emphasis or a sense of interruption.',
          },
          {
            id: 'ks3p-m5-q2',
            question: 'What is the most important part of a PEEL paragraph in poetry analysis?',
            options: ['The Point', 'The Evidence', 'The Explain section', 'The Link'],
            correct: 2,
            explanation:
              'The Explain section is where you analyse the language - exploring connotations, effects, and meaning. This is where the marks are earned, not in simply quoting or identifying techniques.',
          },
          {
            id: 'ks3p-m5-q3',
            question: 'Which phrase should you AVOID in poetry analysis?',
            options: [
              '"The poet suggests..."',
              '"This implies..."',
              '"The poet is trying to say..."',
              '"The connotations of this word include..."',
            ],
            correct: 2,
            explanation:
              'Avoid "trying to say" - it implies the poet has failed to communicate clearly. Use confident phrases like "the poet suggests" or "the poet conveys" instead.',
          },
        ],
      },
    ],
    assessmentQuestions: [
      {
        ...
        options: [
          ...
          'A simile is used in poetry; a metaphor in prose',
        ],
        correct: 1,
        explanation:
          'A simile compares using "like" or "as" ("brave as a lion"), while a metaphor directly states something IS something else ("he was a lion"). Both create comparisons but in different ways.',
      },
      {
        id: 'ks3p-a2',
        question: 'What is an ABAB rhyme scheme?',
        options: [
          'Every line rhymes with every other line',
          'Lines 1 and 3 rhyme; lines 2 and 4 rhyme',
          'Only the first and last lines rhyme',
          'There is no rhyme',
        ],
        correct: 1,
        explanation:
          'In ABAB, alternate lines rhyme: line 1 with line 3 (A), and line 2 with line 4 (B). This creates a flowing, musical quality.',
      },
      {
        id: 'ks3p-a3',
        question: 'What does enjambment do in a poem?',
        options: [
          'Ends the poem',
          'Carries a sentence past the end of a line into the next',
          'Creates a rhyme',
          'Adds punctuation',
        ],
        correct: 1,
        explanation:
          'Enjambment occurs when a thought runs on past the end of a line. It can create urgency, momentum, or a sense of overflow.',
      },
      {
        id: 'ks3p-a4',
        question:
          '"The moon was a ghostly galleon tossed upon cloudy seas." What technique is this?',
        options: ['Simile', 'Personification', 'Metaphor', 'Alliteration'],
        correct: 2,
        explanation:
          'This is a metaphor - the moon IS described as a galleon (ship). It also contains imagery of movement and mystery.',
      },
      {
        id: 'ks3p-a5',
        question: 'What is the effect of a regular, steady rhythm in a poem?',
        options: [
          'It always creates sadness',
          'It can create a calm, controlled, or song-like quality',
          'It makes the poem confusing',
          'It has no effect',
        ],
        correct: 1,
        explanation:
          'A regular rhythm creates a sense of order, control, or musicality. Breaking that rhythm then becomes a powerful way to signal disruption or emotion.',
      },
      {
        id: 'ks3p-a6',
        question: 'When comparing poems, what should every paragraph contain?',
        options: [
          'Only Poem A',
          'Only Poem B',
          'References to both poems',
          'A summary of the plot',
        ],
        correct: 2,
        explanation:
          'Every comparison paragraph should reference both poems, using connectives like "similarly," "in contrast," or "whereas" to link your points.',
      },
      {
        id: 'ks3p-a7',
        question: 'What is a caesura?',
        options: [
          ...
          'A pause in the middle of a line of poetry',
          'A type of stanza',
          'A rhyme at the start of a line',
        ],
        correct: 1,
        explanation:
          'A caesura is a pause within a line, usually created by punctuation. It can create emphasis, a moment of reflection, or a dramatic break.',
      },
      {
        id: 'ks3p-a8',
        question: 'Which is the best approach to analysing a single word in a poem?',
        options: [
          'Define it using a dictionary',
          'Explore its connotations, sounds, and effects in context',
          'Simply name the technique',
          'Ignore it and focus on the theme',
        ],
        correct: 1,
        explanation:
          'The best analysis zooms in on a single word and explores what it suggests (connotations), how it sounds, and what effect it creates in the context of the poem.',
      },
    ],
  },
  {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Judging Shakespeare's characters by modern standards alone. While modern perspectives are valid, you should also consider how Elizabethan audiences would have understood the actions and motivations of characters.</div>`,
        quiz: [
          {
            id: 'ks3s-m1-q1',
            question: 'What were "groundlings"?',
            options: [
              'Actors who performed on the ground',
              'Audience members who stood in the yard for a penny',
              'Stage managers at the Globe',
              'Musicians who played below the stage',
            ],
            correct: 1,
            explanation:
              'Groundlings were the cheapest ticket holders who stood in the open yard in front of the stage. They paid just one penny for admission.',
          },
          {
            id: 'ks3s-m1-q2',
            question: 'Why is the Divine Right of Kings important for understanding Macbeth?',
            options: [
              'It explains why Macbeth is set in Scotland',
              "Because killing a king was seen as a sin against God, making Macbeth's crime even more horrifying",
              "It explains Shakespeare's writing style",
              'It has no relevance to Macbeth',
            ],
            correct: 1,
            explanation:
              "The belief that kings were appointed by God meant that murdering a king was not just treason but an offence against the divine order - making Macbeth's actions truly monstrous in the eyes of the original audience.",
          },
          {
            id: 'ks3s-m1-q3',
            question: "Why were female roles played by boys in Shakespeare's time?",
            options: [
              'Women did not like acting',
              'Women were not allowed to perform on stage',
              'Boys were better actors',
              'There were no female characters in the plays',
            ],
            correct: 1,
            explanation:
              "Women were forbidden from performing on stage in Elizabethan England. All female roles were played by boy actors, which adds an interesting layer to Shakespeare's many cross-dressing plot devices.",
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Thinking "Wherefore art thou Romeo?" means "Where are you, Romeo?" It actually means "Why are you Romeo?" - Juliet is lamenting that the man she loves belongs to her family's enemy. This is one of the most commonly misquoted lines in all of Shakespeare.</div>`,
        quiz: [
          {
            id: 'ks3s-m2-q1',
            question: 'What does "wherefore" mean in Shakespeare?',
            options: ['Where', 'Why', 'When', 'How'],
            correct: 1,
            explanation:
              '"Wherefore" means "why." "Wherefore art thou Romeo?" means "Why are you Romeo?" - Juliet is asking why the man she loves has to be a Montague.',
          },
          {
            id: 'ks3s-m2-q2',
            question: 'Why does Shakespeare switch between verse and prose?',
            options: [
              'He could not decide which to use',
              'Verse signals nobility, emotion, or formality; prose signals lower status, comedy, or casualness',
              'There is no pattern to when he uses each',
              'Prose was easier to memorise',
            ],
            correct: 1,
            explanation:
              'The switch between verse and prose is deliberate. Verse is used for noble or emotional moments; prose for comic, casual, or lower-status scenes. Shifts between the two signal changes in mood or character.',
          },
          {
            id: 'ks3s-m2-q3',
            question:
            ...
            options: [
              ...
              'Read it aloud to hear the rhythm and meaning',
              'Skip it and move on',
              'Memorise a modern translation',
            ],
            correct: 1,
            explanation:
              'Reading aloud is the best first step because Shakespeare wrote for performance. Hearing the rhythm, stress, and flow of the language helps the meaning emerge naturally.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Spending too long retelling the plot in an essay. The examiner knows what happens - they want to see your analysis of HOW and WHY Shakespeare creates meaning through language, structure, and character.</div>`,
        quiz: [
          {
            id: 'ks3s-m3-q1',
            question: 'In Macbeth, who prophesies that Macbeth will become king?',
            options: ['Lady Macbeth', 'King Duncan', 'The three witches', 'Banquo'],
            correct: 2,
            explanation:
              "The three witches (also called the Weird Sisters) prophesy that Macbeth will become Thane of Cawdor and then King of Scotland. This prophecy triggers Macbeth's ambition.",
          },
          {
            id: 'ks3s-m3-q2',
            question: "Why do Romeo and Juliet's deaths end the feud?",
            options: [
              'Their parents agree to a truce before they die',
              'The families are so grief-stricken that they realise the cost of their hatred',
              'The Prince forces them to stop fighting',
              'The families run out of money',
            ],
            correct: 1,
            explanation:
              'The deaths of their children force both families to confront the terrible consequences of their feud. The shock and grief of losing Romeo and Juliet finally motivates the Montagues and Capulets to make peace.',
          },
          {
            id: 'ks3s-m3-q3',
            question: 'In The Tempest, what does Prospero ultimately choose to do?',
            options: [
              'Destroy his enemies',
              'Remain on the island forever',
              'Forgive his enemies and renounce his magic',
              'Give the island to Caliban',
            ],
            correct: 2,
            explanation:
              "Prospero chooses forgiveness over revenge. He forgives Antonio and the others, renounces his magic, and prepares to return to Milan. This choice is central to the play's themes.",
          },
        ],
      },
      {
        ...
        quiz: [
          {
            ...
            correct: 1,
            explanation:
              "A soliloquy is when a character speaks alone on stage, revealing their private thoughts to the audience. It is one of Shakespeare's most powerful dramatic techniques.",
          },
          {
            id: 'ks3s-m4-q2',
            question:
              'Why should you write "Shakespeare presents..." rather than "Macbeth decides..."?',
            options: [
              'It sounds more formal',
              'It reminds the reader that characters are constructs created by the playwright to explore ideas',
              'It is a rule of grammar',
              'The examiner prefers longer sentences',
            ],
            correct: 1,
            explanation:
              'Using "Shakespeare presents" shows you understand that characters are deliberate constructions, not real people. It signals analytical, author-focused thinking - which is what examiners reward.',
          },
          {
            id: 'ks3s-m4-q3',
            question: 'What does the theme "appearance vs reality" involve?',
            options: [
              'How characters look physically',
              'The difference between what things seem to be and what they truly are',
              'The stage set design',
              'The difference between poetry and prose',
            ],
            correct: 1,
            explanation:
              'Appearance vs reality is about deception, disguise, and the gap between surface impressions and deeper truth. Characters often hide their true intentions behind a false exterior.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Forgetting that plays are meant to be performed. If your essay only discusses the words on the page and never considers how they would sound, look, or feel on stage, you are missing a vital dimension of the text.</div>`,
        quiz: [
          {
            id: 'ks3s-m5-q1',
            question: 'Why is performance important when studying Shakespeare?',
            options: [
              'It is not important - only the text matters',
              'Because Shakespeare wrote plays for performance, and delivery choices change meaning',
              'Because acting is easier than reading',
              'Because Shakespeare gave very detailed stage directions',
            ],
            correct: 1,
            explanation:
              'Shakespeare wrote for the stage, not the page. Performance choices - tone, pace, gesture, staging - transform the meaning of the text and reveal character in ways that silent reading cannot.',
          },
          {
            id: 'ks3s-m5-q2',
            question: 'How can a pause in performance create effect?',
            options: [
              'It gives the actor time to remember their lines',
              'It builds tension and gives weight to the words that follow',
              'It has no real effect',
              'It makes the play longer',
            ],
            correct: 1,
            explanation:
              'A well-placed pause builds anticipation and tension. The audience waits for what comes next, and the silence makes the following words feel more significant and powerful.',
          },
          {
            id: 'ks3s-m5-q3',
            question: 'What does it mean that Shakespeare used very few stage directions?',
            options: [
              'He was lazy',
              'Much is left open to interpretation by actors and directors',
              'The plays were not meant to be performed',
              'Actors already knew what to do',
            ],
            correct: 1,
            explanation:
              "Shakespeare's minimal stage directions mean that actors and directors have enormous freedom to interpret the text. This is why the same play can feel completely different in different productions.",
          },
        ],
      },
    ],
    assessmentQuestions: [
      {
        id: 'ks3s-a1',
        question: 'What does "wherefore" mean in Shakespeare\'s language?',
        options: ['Where', 'Why', 'When', 'How'],
        correct: 1,
        explanation:
          '"Wherefore" means "why." "Wherefore art thou Romeo?" means "Why are you Romeo?" - not "Where are you?"',
      },
      {
        id: 'ks3s-a2',
        question: 'What is the Divine Right of Kings?',
        options: [
          "The king's right to write laws",
          'The belief that monarchs were chosen by God',
          "The king's right to act in plays",
          'A law about royal marriages',
        ],
        correct: 1,
        explanation:
          'The Divine Right of Kings was the belief that monarchs were appointed by God, making any rebellion or regicide a sin against the divine order.',
      },
      {
        id: 'ks3s-a3',
      ...
      },
      {
        ...
        correct: 1,
        explanation:
          'A soliloquy is delivered when a character is alone on stage. It lets the audience hear their private thoughts, creating intimacy and dramatic irony.',
      },
      {
        id: 'ks3s-a5',
        question: 'Why does Shakespeare switch between verse and prose?',
        options: [
          'He ran out of ideas',
          'To signal changes in character status, mood, or emotional state',
          'There is no reason',
          'Verse is for comedies, prose for tragedies',
        ],
        correct: 1,
        explanation:
          'Verse signals nobility, emotion, and formality. Prose signals lower status, comedy, or madness. A switch between the two marks a significant shift in mood or character.',
      },
      {
        id: 'ks3s-a6',
        question: 'In The Tempest, what does Prospero ultimately choose?',
        options: ['Revenge', 'Forgiveness', 'To stay on the island', 'To destroy Caliban'],
        correct: 1,
        explanation:
          'Prospero chooses forgiveness over revenge, renounces his magic, and frees Ariel. This choice is the moral heart of the play.',
      },
      {
        id: 'ks3s-a7',
        question: 'What does "appearance vs reality" mean as a theme?',
        options: [
          'How characters dress',
          'The gap between what things seem to be and what they truly are',
          'The stage set design',
          'The difference between comedy and tragedy',
        ],
        correct: 1,
        explanation:
          'Appearance vs reality explores deception, disguise, and hidden truths. Characters and situations are often not what they initially appear to be.',
      },
      {
        id: 'ks3s-a8',
        question: 'Why should you write "Shakespeare presents..." in essays?',
        options: [
          'Because it is grammatically correct',
          'Because it shows characters are deliberate constructions, not real people',
          'Because the examiner said so',
          'Because Shakespeare is more important than his characters',
        ],
        correct: 1,
        explanation:
          'Using "Shakespeare presents" demonstrates that you understand characters are crafted by the playwright to explore themes and ideas - a key sign of analytical writing.',
      },
    ],
  },
  {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Assuming media is neutral or objective. Every media text reflects the choices, values, and priorities of its creator. Even a "factual" news report involves decisions about what to cover, which quotes to use, and what headline to write.</div>`,
        quiz: [
          {
            id: 'ks3ml-m1-q1',
            question: 'What does media literacy enable you to do?',
            options: [
              'Watch more television',
              'Access, analyse, evaluate, and create media critically',
              'Memorise news headlines',
              'Use social media more often',
            ],
            correct: 1,
            explanation:
              'Media literacy is the ability to critically engage with media - not just consume it passively, but analyse how it is constructed and evaluate its messages.',
          },
          {
            id: 'ks3ml-m1-q2',
            question: 'Why is the question "What is missing?" important in media analysis?',
            options: [
              'Because media texts always have errors',
              'Because what is left out can be as revealing as what is included',
              'Because media texts are always incomplete',
              'Because you need to add your own content',
            ],
            correct: 1,
            explanation:
              "Asking what is missing reveals bias and perspective. If a news report only shows one side of a debate, the absence of the other side shapes the audience's understanding just as much as what is included.",
          },
          {
            id: 'ks3ml-m1-q3',
            question: 'What is a "media text"?',
            options: [
              'Only written documents',
              'Any piece of communication delivered through a media channel',
              'Only social media posts',
              'Only television programmes',
            ],
            correct: 1,
            explanation:
              'A media text is any form of communication through media - from a tweet to a billboard to a film trailer. The term encompasses all types of media, not just written text.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Describing what you can see in an advertisement without analysing WHY it is there. "There is a picture of a family" earns nothing. "The image of a happy family creates an emotional association between the product and domestic happiness, appealing to parents who want the best for their children" is analysis.</div>`,
        quiz: [
          {
            id: 'ks3ml-m2-q1',
            question: 'What is the primary purpose of an advertisement?',
            options: ['To inform', 'To entertain', 'To persuade', 'To educate'],
            correct: 2,
            explanation:
              'The primary purpose of advertising is to persuade - to convince you to buy, use, or believe something. While adverts may also inform or entertain, persuasion is always the core goal.',
          },
          {
            id: 'ks3ml-m2-q2',
            question: 'What is a "bandwagon" persuasion technique?',
            options: [
              'Using a celebrity endorsement',
              'Implying everyone is doing it so you should too',
              'Creating fear about not buying the product',
              'Using bright colours',
            ],
            correct: 1,
            explanation:
              'The bandwagon technique pressures you to join in because "everyone else" is already doing it. It exploits the human desire to belong and not miss out.',
          },
          {
            id: 'ks3ml-m2-q3',
            question: 'Why do advertisers use specific colours deliberately?',
            options: [
              'Because they look nice',
              'Because colours trigger specific emotions and associations',
              'Because they are cheaper to print',
              'Because the law requires it',
            ],
            correct: 1,
            explanation:
              'Colour psychology is a key tool in advertising. Red creates urgency, blue builds trust, gold implies luxury - every colour choice is calculated to influence how you feel about the product.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Assuming that a news source is automatically unbiased because it is well-known or popular. Every news outlet has a perspective, even if they strive for balance. Critical readers check multiple sources rather than trusting any single one absolutely.</div>`,
        quiz: [
          {
            id: 'ks3ml-m3-q1',
            question: 'What is "selection bias" in news?',
            options: [
              'Choosing attractive photographs',
              'Deciding which stories to cover and which to ignore',
              'Selecting the best journalists',
              'Choosing the right font for headlines',
            ],
            correct: 1,
            explanation:
              "Selection bias occurs when editors choose to cover certain stories while ignoring others. This shapes the audience's understanding of what is important and what is happening in the world.",
          },
          {
            id: 'ks3ml-m3-q2',
            question: 'How can a headline create bias?',
            options: [
              'Headlines cannot create bias',
              'By framing a story positively or negatively through word choice',
              'By being too long',
              'By using the wrong font',
            ],
            correct: 1,
            explanation:
              'Headlines frame stories. The same event can be presented positively or negatively depending on the words chosen. Since many people only read headlines, this framing has enormous influence.',
          },
          {
            id: 'ks3ml-m3-q3',
            question: 'What is the best way to identify bias in news?',
            options: [
              'Only read one source you trust',
            ...
            correct: 1,
            explanation:
              'Comparing multiple sources reveals how different outlets frame the same events differently. The differences between them expose bias that you would not notice if you only read one source.',
          },
        ],
      },
      {
        ...
        quiz: [
          {
            ...
            options: [
              ...
              'A personalised information environment that limits exposure to diverse perspectives',
              'A way to block unwanted content',
              'A social media privacy setting',
            ],
            correct: 1,
            explanation:
              'A filter bubble is created by algorithms that show you content similar to what you already engage with. Over time, this can limit your exposure to different viewpoints and create a narrow view of reality.',
          },
          {
            id: 'ks3ml-m4-q2',
            ...
            options: [
              ...
              'Misinformation is online; disinformation is in print',
              'Misinformation is harmless; disinformation is illegal',
            ],
            correct: 1,
            explanation:
              'Misinformation is false information shared by someone who believes it is true (accidental). Disinformation is false information created and spread deliberately to deceive. Both are harmful, but disinformation is intentionally malicious.',
          },
          {
            id: 'ks3ml-m4-q3',
            question: 'Why do social media algorithms favour emotional content?',
            options: [
              'Because it is more accurate',
              'Because emotional content gets more engagement, keeping users on the platform longer',
              'Because algorithms have emotions too',
              'Because calm content is boring',
            ],
            correct: 1,
            explanation:
              'Algorithms are designed to maximise engagement (and therefore advertising revenue). Content that triggers strong emotions - outrage, joy, surprise - gets more likes, comments, and shares, so the algorithm promotes it.',
          },
        ],
      },
      {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Cramming too much information into a media text. The most effective advertisements, posters, and social media posts communicate a single clear message. If you try to say everything, you end up saying nothing.</div>`,
        quiz: [
          {
            id: 'ks3ml-m5-q1',
            question: 'What should you decide FIRST when creating a media text?',
            options: [
              'The colour scheme',
            ...
            correct: 1,
            explanation:
              'Purpose and audience are the foundation of every media text. Your purpose (inform, persuade, entertain) and your audience (who you are targeting) determine every other choice you make.',
          },
          {
            id: 'ks3ml-m5-q2',
            ...
            options: [
              ...
              'A direct instruction telling the audience what to do next',
              'The title of a media text',
              'A persuasion technique used only in news',
            ],
            correct: 1,
            explanation:
              'A call to action is a clear, direct instruction - "Buy now," "Share this post," "Sign up today." It tells the audience exactly what step to take next and is a crucial element of persuasive media.',
          },
          {
            id: 'ks3ml-m5-q3',
            question: 'Why is reflecting on your choices important after creating a media text?',
            options: [
              'It is not important',
              'Because articulating WHY you made specific choices demonstrates genuine understanding of how media works',
              'Because you need to write a bibliography',
              'Because the teacher requires it',
            ],
            correct: 1,
            explanation:
              'Reflecting on your choices shows that you understand the relationship between technique and effect. Being able to explain WHY you chose specific words, images, or layouts demonstrates deep media literacy.',
          },
        ],
      },
    ],
    assessmentQuestions: [
      {
        id: 'ks3ml-a1',
        question: 'What are the five key questions of media literacy?',
        options: [
          'Who, what, when, where, why',
          'Who created it, what techniques are used, how might people interpret it differently, what is represented or missing, why was it sent',
          'Is it true, is it fair, is it legal, is it ethical, is it useful',
          'Who is the audience, what is the format, when was it published, where was it shown, how much did it cost',
        ],
        correct: 1,
        explanation:
          'The five key questions focus on authorship, techniques, interpretation, representation, and purpose. They provide a complete framework for analysing any media text.',
      },
      {
        id: 'ks3ml-a2',
        ...
        correct: 2,
        explanation:
          'While adverts may inform or entertain, their primary purpose is always to persuade - to convince you to buy, use, or believe something.',
      },
      {
        id: 'ks3ml-a3',
        question: 'What is "bias by omission"?',
        options: [
          'Writing biased headlines',
          'Leaving out information that would change how the audience understands a story',
          'Using biased photographs',
          'Interviewing only one source',
        ],
        correct: 1,
        explanation:
          'Bias by omission occurs when important information is left out. What is NOT reported can shape understanding just as powerfully as what IS reported.',
      },
      {
        id: 'ks3ml-a4',
        question: 'What is a filter bubble?',
        options: [
          ...
          'An algorithm-created environment that limits exposure to diverse perspectives',
          'A type of content filter for children',
          'A method of blocking advertisements',
        ],
        correct: 1,
        explanation:
          'A filter bubble is created when algorithms show you content similar to what you already engage with, gradually narrowing your information environment and potentially reinforcing existing beliefs.',
      },
      {
        id: 'ks3ml-a5',
        question: 'What is the difference between misinformation and disinformation?',
        options: [
          'They mean the same thing',
          'Misinformation is accidental; disinformation is deliberately deceptive',
          'Misinformation is online; disinformation is offline',
          'Misinformation is opinion; disinformation is fact',
        ],
        correct: 1,
        explanation:
          'Misinformation is false information shared without malicious intent. Disinformation is false information deliberately created and spread to deceive. The key difference is intent.',
      },
      {
        id: 'ks3ml-a6',
        question: 'Why do social media algorithms favour emotional content?',
        options: [
          'Because emotional content is more truthful',
          'Because emotional content generates more engagement, keeping users on the platform longer',
          'Because algorithms understand emotions',
          'Because emotional content is easier to create',
        ],
        correct: 1,
        explanation:
          'Algorithms prioritise engagement. Emotional content (outrage, joy, surprise) generates more likes, shares, and comments, which keeps users on the platform and increases advertising revenue.',
      },
      {
        id: 'ks3ml-a7',
        question: 'What is a "call to action" in a media text?',
        options: [
          'A dramatic scene in a film',
          'A direct instruction telling the audience what to do next',
          'A type of news headline',
          'A protest or demonstration',
        ],
        correct: 1,
        explanation:
          'A call to action directly instructs the audience: "Buy now," "Sign up," "Share this." It is a crucial element of persuasive media texts, turning passive viewers into active participants.',
      },
      {
        id: 'ks3ml-a8',
        question: 'When creating a media text, what should you decide first?',
        options: [
          'The images to use',
        ...
        correct: 1,
        explanation:
          'Purpose and audience are the foundation of any media text. Every other decision - language, images, layout, platform - flows from knowing why you are creating it and who it is for.',
      },
    ],
  },
]

export const ks3Courses: CourseData[] = [...ks3CoursesCore, ...ks3CoursesExtra]
