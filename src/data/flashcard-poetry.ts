  ...
  // ─── POWER & CONFLICT POETRY ───────────────────────────────────────
  {
    ...
    cards: [
      ...
      },
      {
        ...
        back: 'Poet: Ted Hughes\n\nTechnique: Bathos / list\n\nMeaning: Hughes writes "etcetera" once - cite exactly as printed; do not abbreviate to "etc.", and don\'t double the word. The single dismissive "etcetera" trails off the grand ideals that justify war, reducing them to meaningless filler. In the moment of battle, patriotism becomes irrelevant.\n\nTheme: Futility of war; questioning authority.\n\nComparison: Compare with "Charge of the Light Brigade" - Tennyson celebrates duty while Hughes mocks it as hollow.',
      },
      // 9. Remains - Simon Armitage
      {
        id: 'pc-17',
        front: '"his blood-shadow stays on the street" - Remains',
      ...
      {
        id: 'pc-24',
        front: '"turned into your skin." - Tissue (final isolated single-line stanza)',
        back: 'Poet: Imtiaz Dharker (Pakistani-born British, raised Glasgow)\n\nTechnique: Final isolated single-line stanza / metaphor / volta\n\nStructure: The poem is 10 quatrains followed by this final isolated single-line stanza ("turned into your skin."). The line stands ALONE - Dharker breaks the regularity of the quatrains to emphasise the volta from paper to flesh.\n\nMeaning: The poem shifts from paper to human skin - the most important "tissue." Humans are more important than the systems built on paper. Skin is both fragile and beautiful.\n\nTheme: Human identity vs. structures of power.\n\nComparison: Compare with "Ozymandias" - both show the impermanence of human structures.\n\nRights: From The terrorist at my table (Bloodaxe Books, 2006). bloodaxebooks.com.',
      },
      // 13. The Émigrée - Carol Rumens
      {
        id: 'pc-25',
        front: '"sunlight-clear" - The Émigrée',
        back: "Poet: Carol Rumens\n\nTechnique: Compound adjective / semantic field of light\n\nMeaning: The speaker's childhood memory of her homeland is bathed in light and positivity, despite the city now being a place of conflict. Memory resists the reality of oppression.\n\nTheme: Memory; identity; conflict between past and present.\n\nComparison: Compare with \"London\" - Blake sees a real city's suffering while The Émigrée's speaker preserves an idealised version through memory.",
      },
      {
        id: 'pc-26',
        front: '"They accuse me of being dark" - The Émigrée',
  ...
  // ─── POETRY ANALYSIS TECHNIQUES ────────────────────────────────────
  {
    ...
    cards: [
      ...
      },
      {
        ...
        back: 'Definition: The pattern of stressed and unstressed syllables in a line of poetry. Common metres include iambic (da-DUM), trochaic (DUM-da), anapaestic (da-da-DUM), and dactylic (DUM-da-da).\n\nExample: "The Charge of the Light Brigade" is predominantly anapaestic dimeter (da-da-DUM da-da-DUM) with a dactylic refrain ("Rode the six hundred") - together they mimic galloping horses.\n\nEffect on reader: Rhythm controls pace, mood, and emphasis. Regular metre feels controlled; disrupted metre feels unsettling.\n\nWhen to mention in essays: Tap out the rhythm and link it to content - e.g., "The galloping metre creates relentless forward momentum that mirrors the cavalry charge."',
      },
      {
        id: 'pt-16',
        front: 'Blank Verse',
      ...
      },
      {
        id: 'pt-42',
        front: 'Sonnet',
        back: '14-line poem with strict rhyme scheme and iambic pentameter, exploring love, beauty, or mortality',
      },
      {
        id: 'pt-43',
        front: 'Ballad',
        back: 'Narrative poem telling a story, often with repeating chorus, traditionally sung or recited',
      },
      {
        id: 'pt-44',
        front: 'Elegy',
        back: 'Mournful poem expressing sorrow, typically for someone who has died or loss of something precious',
      },
      {
        id: 'pt-45',
        front: 'Ode',
        back: 'Formal poem praising or celebrating something, with elevated tone and complex structure',
      },
      {
        id: 'pt-46',
        front: 'Villanelle',
        back: '19-line poem with two repeating rhymed refrains, creating circular, obsessive effect',
      },
      {
        id: 'pt-47',
        front: 'Haiku',
        back: 'Three-line poem (5-7-5 syllables) capturing a single moment, often nature-focused',
      },
      {
        id: 'pt-48',
        front: 'Limerick',
        back: 'Five-line humorous poem with AABBA rhyme scheme, often whimsical or absurd',
      },
      {
        id: 'pt-49',
        front: 'Free Verse',
        back: 'Poetry without regular meter or rhyme, emphasising natural speech and individual lines',
      },
      {
        id: 'pt-50',
        front: 'Acrostic',
        back: 'Poem where first letters of each line spell out a word or message',
      },
      {
        id: 'pt-51',
        front: 'Concrete Poetry',
        back: 'Visual poetry where arrangement of words creates picture or shape on page',
      },
      {
        id: 'pt-52',
        front: 'Metaphor in Poetry',
        back: 'Direct comparison suggesting one thing IS another, creating layers of meaning',
      },
      {
        id: 'pt-53',
        front: 'Simile in Poetry',
        back: "Comparison using 'like' or 'as', creating vivid imagery and accessible meaning",
      },
      {
        id: 'pt-54',
        front: 'Personification in Poetry',
        back: 'Giving human qualities to non-human things, creating emotional resonance',
      },
      {
        id: 'pt-55',
        front: 'Symbolism in Poetry',
        back: 'Objects or images representing larger concepts or abstract ideas',
      },
      {
        id: 'pt-56',
        front: 'Imagery in Poetry',
        back: 'Vivid, sensory language appealing to sight, sound, smell, taste, or touch',
      },
      {
        id: 'pt-57',
        front: 'Tone in Poetry',
        back: "The speaker's attitude toward subject and audience, conveyed through word choice",
      },
      {
        id: 'pt-58',
        front: 'Speaker in Poetry',
        back: 'The voice narrating the poem, not necessarily the poet themselves',
      },
      {
        id: 'pt-59',
        front: 'Meter in Poetry',
        back: 'Regular pattern of stressed and unstressed syllables creating rhythm',
      },
      {
        id: 'pt-60',
        front: 'Rhyme in Poetry',
        back: 'Repetition of sound at ends of words, creating musicality and connection',
      },
      {
        id: 'pt-61',
        front: 'Stanza in Poetry',
        back: 'Grouped lines functioning as paragraph; separates ideas and creates pacing',
      },
      {
        id: 'pt-62',
        front: 'Enjambment in Poetry',
        back: 'Continuation of sentence across line or stanza break, creating flow',
      },
      {
        id: 'pt-63',
        front: 'Caesura in Poetry',
        back: 'Pause within a line marked by punctuation, creating rhythm and emphasis',
      },
      {
        id: 'pt-64',
        front: 'Volta in Poetry',
        back: 'Shift in thought or tone, marking turning point in argument or emotion',
      },
      {
        id: 'pt-65',
        front: 'Allusion in Poetry',
        back: 'Indirect reference to another work, person, or idea, enriching meaning',
      },
      {
        id: 'pt-66',
        front: 'Paradox in Poetry',
        back: 'Statement seeming contradictory but revealing a truth about experience',
      },
      {
        id: 'pt-67',
        front: 'Oxymoron in Poetry',
        back: 'Combining contradictory terms for paradoxical effect and emphasis',
      },
      {
        id: 'pt-68',
        front: 'Irony in Poetry',
        back: 'Expression of meaning using language that normally signifies opposite meaning',
      },
      {
        id: 'pt-69',
        front: 'Understatement in Poetry',
        back: 'Deliberately minimising significance for ironic or emphatic effect',
      },
      {
        id: 'pt-70',
        front: 'Hyperbole in Poetry',
        back: 'Extreme exaggeration for emphasis, emotion, or comic effect',
      },
      {
        id: 'pt-71',
        front: 'Pun in Poetry',
        back: 'Play on words exploiting multiple meanings or similar sounds for wit',
      },
      {
        id: 'pt-72',
        front: "Shakespeare's Sonnet Structure",
        back: 'Shakespearean sonnets: ABABCDCDEFEFGG rhyme, iambic pentameter, turn at line 13',
      },
      {
        id: 'pt-73',
        front: 'Petrarchan Sonnet Form',
        back: 'Italian sonnet: ABBAABBACDECDE rhyme, octave poses problem, sestet resolves',
      },
      {
        id: 'pt-74',
        front: 'Metaphysical Poetry',
        back: '17th-century poetry combining intellectual complexity with emotional intensity, using conceits',
      },
      {
        id: 'pt-75',
        front: 'Romantic Poetry Themes',
        back: 'Nature, emotion, imagination, individualism, reaction against reason and industrialisation',
      },
      {
        id: 'pt-76',
        front: 'Victorian Poetry Concerns',
        back: 'Social issues, faith, doubt, technology, progress, love, and moral responsibility',
      },
      {
        id: 'pt-77',
        front: 'Modernist Poetry Techniques',
        back: 'Fragmentation, imagism, stream of consciousness, disrupted syntax, challenging form',
      },
      {
        id: 'pt-78',
        front: 'Beat Generation Poetry',
        back: 'Spontaneous composition, anti-establishment themes, oral performance, rejection of formalism',
      },
      {
        id: 'pt-79',
        front: 'Confessional Poetry',
        back: 'Autobiographical, intimate, exploring personal trauma, guilt, mental illness with raw honesty',
      },
      {
        id: 'pt-80',
        front: 'Harlem Renaissance Poetry',
        back: 'African-American poets celebrating Black culture, resisting racial oppression, blending forms',
      },
      {
        id: 'pt-81',
        front: 'Contemporary Poetry Trends',
        back: 'Spoken word, slam poetry, multimedia integration, diverse voices, experimental formats',
      },
      {
        id: 'pt-82',
        front: 'Nature Poetry Analysis',
        back: 'How poets use natural imagery to explore emotion, mortality, beauty, or spiritual truth',
      },
      {
        id: 'pt-83',
        front: 'Love Poetry Conventions',
        back: 'Courtship, desire, loss, devotion, seduction, using traditional metaphors and forms',
      },
      {
        id: 'pt-84',
        front: 'Elegy Tradition',
        back: 'How poets memorialize the dead, process grief, question mortality and meaning',
      },
      {
        id: 'pt-85',
        front: 'Political Poetry Function',
        back: 'How poetry critiques power, advocates change, gives voice to the silenced',
      },
      {
        id: 'pt-86',
        front: 'Narrative Poetry Techniques',
        back: 'Character development, plot progression, dialogue, setting in verse form',
      },
      {
        id: 'pt-87',
        front: 'Lyric Poetry Characteristics',
        back: 'Personal emotion, musicality, image-focused, first-person perspective or implied speaker',
      },
      {
        id: 'pt-88',
        front: 'Epic Poetry Elements',
        back: 'Grand scale, heroic characters, significant events, elevated language, mythic resonance',
      },
      {
        id: 'pt-89',
        front: 'Dramatic Monologue Form',
        back: 'Single speaker addressing implied listener, revealing character through speech',
      },
      {
        id: 'pt-90',
        front: 'Prose Poetry Hybridity',
        back: 'Poetic techniques in prose paragraphs, blurring genres, emphasising language musicality',
      },
      {
        id: 'pt-91',
        front: 'Visual Poetry Experimentation',
        back: 'Concrete poetry, calligrams, shaped text, where appearance conveys meaning',
      },
    ],
  },
]
