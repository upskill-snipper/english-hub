...
// AUDIT NOTE (FC20, 2026-04-28): Contemporary author/publication attributions
// below (Amira Patel/Independent, Sarah Okonkwo/Council, Daniel Hargreaves/Times,
// Dr Priya Sharma/New Statesman, Rebecca Thornton/Observer, etc.) are FABRICATED
// framing labels for original practice compositions in the relevant register.
// Pre-1928 attributions (Mayhew, Mee, Bevan speech, Whitfield 1897, etc.) name
// real figures or titles but the rendered text is paraphrased composition, not
// verbatim. Source attributions to "John Bighton, 'Whose Past Is It Anyway?'"
// (2023) are also fabricated. Treat all sources as practice stimuli only.
...
const OCR_P1_02_SOURCE_B_REF =
  'Thomas Ashworth, "Our New Free Library", The Blackburn Standard, 1862'
...
const OCR_P1_03_SOURCE_B_REF =
  'Elizabeth Gaskell, "The Children of the Mills", Household Words, 1851'
...
const OCR_P1_07_SOURCE_A_REF =
  'Michael O\'Brien, "The Immigration Conversation We Need", The New European, 2023'
...
const OCR_P1_08_SOURCE_B_REF =
  'Clementina Black, "Women\'s Work and Wages", The Fortnightly Review, 1889'
...
const OCR_P1_09_SOURCE_A_REF =
  'Hannah Brooks, "The Recycling Myth", Channel 4 News investigation, 2024'
...
const OCR_P1_09_SOURCE_B_REF =
  'Charles Dickens (ed.), "Dust; or Ugliness Redeemed", Household Words, 1850'
...
const OCR_P1_13_SOURCE_A_REF =
  'Professor Eleanor Shaw, "Democracy Under Threat", London Review of Books, 2024'
...
const OCR_P2_03_EXTRACT_SOURCE =
  "Adapted from Charles Dickens, Great Expectations (1861), reimagined from Estella's perspective"
...
const OCR_P2_09_EXTRACT_SOURCE =
  'Adapted from a literary non-fiction account of Brixton Market, 2019'
...
const OCR_P2_12_EXTRACT_SOURCE =
  'Adapted from literary fiction set during the Battle of the Somme, 1916'
...
const OCR_P1_16_SOURCE_A_REF =
  'Dr Marcus Webb, "Digging Deeper: An Accidental Discovery", Archaeology Today, 2024'
...
const OCR_P1_16_SOURCE_B_REF = 'Anishinaabe writer John Bighton, "Whose Past Is It Anyway?", 2023'
...
const OCR_P1_17_SOURCE_B_REF =
  'Kenneth Davies, "Time to Close the Books on Libraries", Policy Forum, 2024'
...
And yet here she was. The woman next to her was elderly, maybe sixty-five, holding a sign that said "Still Fighting After Fifty Years." To her other side was a boy who could not have been more than ten, sitting on his father's shoulders. There were teachers and nurses in their uniforms, office workers in business dress, students, elderly people, families with children. The demographic was unremarkable - it looked like the neighborhood itself, if the neighborhood had simply decided to stand up and speak at once.
...
export const ocrMockExams: MockExamPaper[] = [
  ...
  buildOcrP1(
    ...
    {
      'Grade 4-5':
        'The writer says the discovery began "not with ambition but with accident," which makes it seem like luck rather than planning. The pottery fragment is described as "so small it could fit in a child\'s palm," showing how something tiny became important. The phrase "listen to the wood" becomes "listen to the evidence." The word "meticulous" shows the careful scientific work. The writer emphasizes patience by saying the analysis will take "another ten years," showing that real archaeological work is slow and careful.',
      'Grade 6-7':
        'Webb establishes the discovery\'s significance through a narrative of accident transformed into meaning. The opening paradox - "not with ambition but with accident" - positions the discovery as one that escapes the motivational frameworks of professional ambition. The pottery fragment, though "so small it could fit in a child\'s palm," is the text\'s activating object; its smallness is precisely the inverse of its importance. The move from material scale to historical significance is enacted through language: a "fragment" becomes evidence of "a settlement," which becomes evidence of a "thriving community." The term "meticulous" applies not just to the method but to the ethical stance: three seasons of scrupulous work stands against the "temptation...to rush to conclusions." Webb\'s insistence on restraint - "I have resisted this impulse" - revalues patience as a virtue in an era of rapid discovery and rapid publication. The closing observation that understanding will take "another ten years at least" performs a form of professional humility.',
      'Grade 8-9':
    ...
    '"Archaeological knowledge is always worth the cost of excavation." How far do you agree? Evaluate this statement using both sources and your own understanding.',
    {
      ...
      'Grade 6-7':
        'I partially agree, but with significant qualification. Webb demonstrates that archaeological knowledge is rigorous and valuable - a medieval settlement that thrived, a community that engineered water management systems - this knowledge genuinely enriches our understanding of human history. However, Bighton\'s argument cannot be dismissed as merely sentimental. He identifies a real asymmetry: the knowledge that archaeology produces benefits archaeologists and museum-goers, while the cost - the removal of ancestral remains and sacred objects - falls on Indigenous communities. Webb\'s three-year excavation is justified by the promise of future knowledge, but this future knowledge is not shared with the descendants of the people who created these objects. The statement "Archaeological knowledge is always worth the cost" depends on who bears the cost and who reaps the benefit. For Webb, the calculation is clear: knowledge is worth patience and care. For Bighton, the calculation is not economic but ethical: some things are not negotiable, not available for trade-off against knowledge or profit.',
      'Grade 8-9':
        'The statement assumes a unified framework for evaluating "worth" that both sources fundamentally challenge. Webb constructs worth through the lens of epistemological productivity - the knowledge that emerges from careful analysis justifies the act of excavation and the temporal investment. His rhetoric of "meticulous" work and future understanding performs a familiar justification: the present cost yields future benefit. Bighton constructs worth through an ethical framework that challenges the commensurability implied by cost-benefit analysis. His key move is to reframe the "cost" not as an externality but as a direct harm: "spiritual violence," "theft." By doing so, he makes the calculation impossible - one cannot weigh knowledge against spiritual harm in a single calculus. The statement assumes its own conclusion by nominalizing knowledge as something that has "worth" in a universal sense. Bighton asks the more fundamental question: worth to whom, and at what price? A genuine evaluation requires acknowledging that Webb and Bighton are not disagreeing about facts but about the frame in which facts acquire meaning. Webb\'s final restraint - "another ten years" - positions patience as a virtue within archaeological practice. Bighton\'s final paradox - "not a call for ignorance" - distinguishes between knowledge (which is valuable) and the extraction required to obtain it (which may not be). The most honest evaluation concludes that archaeological knowledge may be epistemologically valuable while remaining ethically problematic.',
    },
