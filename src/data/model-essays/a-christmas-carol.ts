   ...
   * ============================================================= */
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        text: 'Scrooge\'s defence of indifference is delivered in the technical lexis of political economy. His questions "Are there no prisons?" and "Are there no workhouses?" are not genuine enquiries but a recitation of the institutional answers offered by the 1834 Poor Law Amendment Act, which forced the destitute into deliberately punitive workhouses. His chilling addendum that if the poor "would rather die" they had "better do it" and so reduce the "surplus population" ventriloquises Thomas Malthus, whose theories were widely cited to argue that charity merely prolonged misery. By placing Malthusian doctrine in the mouth of a man whose name becomes a byword for moral bankruptcy, Dickens performs a quiet ideological assassination: the philosophy is discredited not by counter-argument but by association with a character the reader is taught to despise.',
        annotation:
