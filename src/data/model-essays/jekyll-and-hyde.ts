    ...
    paragraphs: [
      {
        ...
        annotation: {
          ...
          AO3: "Frames the confession against Victorian faith in the unified moral subject, which Jekyll's testimony explicitly dismantles.",
        },
      },
      {
        ...
        annotation: {
          ...
          AO3: 'Connects to Victorian ideas of self-mastery and the fear that the lower self, once indulged, could not be re-mastered.',
        },
      },
      {
        ...
        annotation: {
          AO1: 'Widens the argument from Jekyll outwards, demonstrating the theme is structural rather than confined to the protagonist.',
          AO2: 'Reads minor characters and architectural detail as deliberate doublings; treats setting as character.',
          AO3: "Aligns Stevenson's structural doubling with the Victorian split between public propriety and private appetite.",
        },
      },
      {
        ...
        annotation: {
          AO1: 'Brings the argument to its terminus: duality is irreversible once acknowledged in action.',
          AO2: "Tracks structural movement from epistolary external narration to interior confession, mirroring Jekyll's collapse.",
          AO3: 'Echoes Victorian temperance and degeneration anxieties, where indulged appetite hardens into habit.',
        },
      },
    ],
    conclusion:
    ...
    paragraphs: [
      ...
      },
      {
        ...
        annotation: {
          ...
          AO3: "Anchors the analysis in Lombroso's criminal anthropology and inverts its class assumption.",
        },
      },
      {
        ...
        annotation: {
          ...
          AO3: 'Reads Carew, as MP, as a metonym for the social order whose repressions produced Hyde.',
        },
      },
      {
        ...
        annotation: {
          ...
          AO3: 'Engages with proto-Freudian models of the return of the repressed, available conceptually to a Victorian readership through degeneration discourse.',
        },
      },
    ],
    conclusion:
    ...
    paragraphs: [
      {
        ...
        annotation: {
          ...
          AO3: "Links to the actual London 'pea-soupers' of the 1880s and the cultural sense of a city literally and morally clouded.",
        },
      },
      {
        ...
        annotation: {
          ...
          AO3: 'Connects to the Victorian London of front-and-back houses, where servants, tradesmen and vice all entered respectable homes through different doors.',
        },
      },
      {
        ...
        annotation: {
          ...
          AO3: 'Engages with the late-Victorian sense of London as a city of contiguous moral zones (Mayfair adjoining Soho).',
        },
      },
      {
        ...
        annotation: {
          AO1: 'Brings the argument to its endpoint: the gothic chamber yields a domestic, human horror.',
          AO2: 'Reads the anti-climactic body as a deliberate generic subversion of the gothic reveal.',
          AO3: 'Frames the laboratory as a site where Victorian science replaces Catholic crypts as the gothic interior.',
        },
      },
    ],
    conclusion:
  ...
  },
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        annotation: {
          AO1: 'Strengthens the argument by showing reputation outranks even truth and self-preservation.',
          AO2: 'Reads the sealed envelope as a metonymic coffin, foregrounding structural symbolism.',
          AO3: "Connects to the Victorian medical profession's collective concern with public credibility, particularly post-1858 Medical Act.",
        },
      },
      {
        ...
        annotation: {
          AO1: "Closes the argument by reading the novella's structure itself as a critique of respectable silence.",
          AO2: 'Identifies withheld documents, broken chapters and deferred confession as deliberate formal choices.',
          AO3: 'Connects to the late-Victorian culture of professional discretion that protected powerful men from scrutiny.',
        },
      },
    ],
    conclusion:
  ...
  },
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        annotation: {
          AO1: 'Develops the argument: science can act on the self without explaining the self.',
          AO2: 'Reads irreproducibility and the moral asymmetry of the result as deliberate epistemic gaps.',
          AO3: 'Connects to late-Victorian unease about chemistry and physiology outpacing the philosophical frameworks that should contain them.',
        },
      },
      {
        ...
        annotation: {
          ...
          AO3: 'Engages with the Victorian crisis of faith and the difficulty of evicting religious vocabulary from moral discourse.',
        },
      },
      {
        ...
        annotation: {
          AO1: "Concludes the argument by reading the novella's withholding as a deliberate epistemological stance.",
          AO2: "Reads the title's appropriation of 'case' against the narrative's refusal to deliver case-study clarity.",
          AO3: 'Connects to William James and other late-Victorian thinkers beginning to argue for the legitimacy of the unanalysable in mental life.',
        },
      },
    ],
    conclusion:
