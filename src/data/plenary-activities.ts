...
export const plenaryActivities: PlenaryActivity[] = [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    instructions: 'Display 3–5 learning objectives. Students rate 1–5 (1=not confident, 5=very confident) for each. Collect responses. Use data to determine who needs intervention and what content needs reteaching. Create targeted small-group sessions for low-confidence areas.',
    variations: [
  ...
  },
  {
    ...
    duration: 5,
    suitableFor: ['Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Display success criteria. Students find and annotate one piece of evidence from today\'s work showing they\'ve met each criterion. Use highlighters or margin notes. Share examples. Discuss what "good" looks like—calibrate understanding of standards.',
    variations: [
  ...
  },
  {
    ...
    duration: 3,
    suitableFor: ['Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Students complete two statements: "I can now... [skill/concept]" and "I need to work on... [skill/concept]". Be specific. Use responses to guide homework and next lesson. Creates positive framing and clear priorities.',
    variations: [
  ...
  },
  {
    ...
    duration: 5,
    suitableFor: ['Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Pair students. Each shares one piece of work. Partner identifies one "glow" (strength) and one "grow" (area for improvement) using evidence. Use sentence stems: "I noticed you... [glow]", "Next time you could..." Partner then writes this feedback on a sticky note. Builds peer feedback culture.',
    variations: [
  ...
  },
  {
    ...
    duration: 3,
    suitableFor: ['Year 7', 'Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Students write 2–3 questions that emerged during the lesson. "I\'m wondering why...", "I want to know...", "How does... connect to...?" Collect these. Use them to plan next lesson or research projects. Shows curiosity and gaps.',
    variations: [
    ...
    differentiationNotes: 'Shifts mindset from having all answers to valuing inquiry. Personalized learning paths.\nLower ability: Model question-asking. Accept one-word prompts. Celebrate question quality over grammar.\nHigher ability: Push for deeper, more analytical questions. Link to prior knowledge.',
  },
  {
    id: 'afl-6',
    type: 'Concept Mapping',
    title: 'Misconception Diagnosis',
    description: 'Students create concept maps revealing gaps and false connections in understanding.',
    duration: 6,
    suitableFor: ['Year 9', 'Year 10', 'Year 11'],
    instructions: 'Display a central concept. Students create a quick concept map showing relationships. Review maps. Identify misunderstandings (e.g., "character" connected to "author" directly rather than through text). Address in real time. Invisible misunderstandings become visible.',
    variations: [
      'Venn diagram comparing two concepts.',
      'Timeline showing cause-and-effect relationships.',
      'Pros/cons or argument mapping.',
    ],
    differentiationNotes: 'Diagnostic tool that reveals thinking processes. Prevents misconceptions from persisting.\nLower ability: Provide a template or partial map. Reduce number of connections required.\nHigher ability: Require written explanations of each link. Challenge them to identify hierarchy (core vs. peripheral ideas).',
  },
  {
    id: 'afl-7',
    type: 'Think-Pair-Share',
    ...
    duration: 5,
    suitableFor: ['Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Think: Review success criteria silently. Pair: Discuss with partner—"Have we met this? What evidence do we have?" Share: Select pairs to share their conclusions. Teacher clarifies any confused understanding. Builds shared standards.',
    variations: [
  ...
  },
  {
    ...
    duration: 5,
    suitableFor: ['Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Create a 10-question quiz: 50% today\'s content, 50% from past lessons/units. No marking. Collect, review, and identify patterns: what\'s been forgotten? What\'s understood? Use data to target review and spacing strategy.',
    variations: [
  ...
  },
  {
    ...
    duration: 5,
    suitableFor: ['Year 9', 'Year 10', 'Year 11'],
    instructions: 'Central node: learning objective or text. Students branch out with: what I knew before, what I learned, what I still want to know, how I\'ll apply this. Add visuals, colors, symbols. Display. Celebrate diversity of thinking. Powerful memory aid.',
    variations: [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    duration: 6,
    suitableFor: ['Year 7', 'Year 8', 'Year 9', 'Year 10'],
    instructions: 'Central node: main character. Spider out with: physical description, key emotions, relationships to other characters, key actions, motivation, growth. Use colors for emotions, symbols for themes. Display on wall. Discuss differences in interpretation. Celebrates creative thinking while deepening understanding.',
    variations: [
  ...
  },
  {
    ...
    duration: 4,
    suitableFor: ['Year 7', 'Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Challenge: tell the story/idea in exactly six words. Forces economy of language and creative thinking. Examples from literature: "For sale: baby shoes, never worn" or create new ones. Share aloud. Vote on most impactful. Discuss how much can be conveyed with constraints.',
    variations: [
  ...
  },
  {
    ...
    duration: 8,
    suitableFor: ['Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Divide class into expert groups. Each teaches one aspect of today\'s lesson (e.g., one metaphor, one character, one historical context). Groups prepare a 2-minute explanation. Rotate: students visit each station, listen, ask questions. Reinforces learning through teaching. High engagement.',
    variations: [
    ...
    differentiationNotes: 'Peer teaching is powerful retention and clarification tool.\nLower ability: Provide script or key points to teaching stations. Pair with stronger peer as co-teacher.\nHigher ability: Require them to anticipate and answer follow-up questions. Push for deeper explanation of why, not just what.',
  },
  {
    id: 'creative-4',
    type: 'Reflection Journal',
    title: 'Artifact Reflection',
    description: 'Students select one artifact from today (quote, image, phrase) and explore its meaning.',
    duration: 4,
    suitableFor: ['Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Students choose one artifact: a powerful quote, vivid image, striking phrase, key concept. Write: What does this represent? Why did I choose it? How does it connect to my own life or understanding? Add to portfolio. Builds reflective practice and personal connection.',
    variations: [
  ...
  },
  {
    ...
    duration: 5,
    suitableFor: ['Year 7', 'Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Think: silently generate ideas for how today\'s concept/skill applies beyond English class. (Where else might you use inference? When would you need to structure an argument?) Pair: discuss ideas with partner. Share: select pairs to share wildest, most practical, most creative applications. Celebrates transfer and creative thinking.',
    variations: [
  ...
  },
  {
    ...
    duration: 6,
    suitableFor: ['Year 9', 'Year 10', 'Year 11'],
    instructions: 'Central node: theme (e.g., power, identity, conflict). Students spider out to: textual evidence (quotes, scenes), related themes, real-world connections, personal connections. Use different colors for different types of evidence. Display and discuss. Shows sophisticated understanding.',
    variations: [
  ...
  },
  {
    ...
    duration: 3,
    suitableFor: ['Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Prompt: "If today\'s learning were a [season/animal/journey/color/building], what would it be and why?" Students answer in 2–3 sentences. Share aloud. Discuss. Creative, non-threatening way to check understanding. Reveals how students are processing the material.',
    variations: [
    ...
    differentiationNotes: 'Right-brain thinking. Engages creative learners. Often reveals understanding in interesting ways.\nLower ability: Provide metaphor options. Accept simpler explanations. Celebrate all metaphors.\nHigher ability: Push for sophisticated, non-obvious comparisons. Require explanation of how metaphor holds.',
  },
  {
    id: 'creative-8',
    type: 'Peer Explanation',
    title: 'Technique Detective',
    description: 'Students identify and explain a literary technique, then become "detectives" in peer work.',
    duration: 5,
    suitableFor: ['Year 8', 'Year 9', 'Year 10', 'Year 11'],
    instructions: 'Model one technique. Students become detectives: find examples in today\'s text. Annotate. Explain effect. Then exchange work with peer. Peer marks their annotations (green for clear, yellow for good try, red for needs refinement). Discuss refinements. Builds technical vocabulary and peer feedback.',
    variations: [
  ...
  },
  {
    ...
    duration: 6,
    suitableFor: ['Year 7', 'Year 8', 'Year 9', 'Year 10'],
    instructions: 'Mind map with: words (key concepts), colors (emotions/themes), symbols (characters/actions), textures (rough/smooth paper for tone), sounds (onomatopoeia or music associations). Discuss: why these choices? What does multisensory representation reveal? Engages kinaesthetic and creative learners.',
    variations: [
  ...
  },
  {
    ...
    duration: 4,
    suitableFor: ['Year 9', 'Year 10', 'Year 11'],
    instructions: 'Students write a dialogue: "Me now" asking questions about today\'s content, "Me next week/month/year" answering from a perspective of deeper understanding. This metacognitive exercise reveals gaps and builds vision of growth. Powerful closure that looks forward.',
    variations: [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    duration: 8,
    suitableFor: ['Year 9', 'Year 10', 'Year 11'],
    instructions: 'Display a past exam question. Students answer individually (10 mins). Reveal mark scheme. Work through together: what made answers secure? What were common errors? Create an annotation of the model answer showing where marks come from. Store for revision reference.',
    variations: [
  ...
  },
  {
    ...
    duration: 3,
    suitableFor: ['Year 9', 'Year 10', 'Year 11'],
    instructions: 'Display exam-command words and technical vocabulary. Quick-fire: students define or use in sentence. Build confidence and fluency with language that appears in exam questions. Create a cumulative word bank students can take into revision.',
    variations: [
  ...
  },
  {
    ...
    duration: 5,
    suitableFor: ['Year 10', 'Year 11'],
    instructions: 'Track which past exam questions students consistently struggle with. Build a rotation of these into plenaries. Mix old content with new. Low-stakes retrieval practice strengthens retention and builds confidence on vulnerable content. Creates mastery over time.',
    variations: [
  ...
  },
  {
    ...
    duration: 7,
    suitableFor: ['Year 9', 'Year 10', 'Year 11'],
    instructions: 'Display essay question. Students have 5 minutes to write. Display criteria (introduction, evidence, analysis, conclusion). Students self-assess: ticks where they\'ve met each criterion, crosses where they\'re weak. Identify patterns. Practice against time reduces exam anxiety.',
    variations: [
  ...
  },
  {
    ...
    duration: 4,
    suitableFor: ['Year 10', 'Year 11'],
    instructions: 'Prompt: "Rate your exam readiness 1–5. What\'s going well? What\'s your biggest worry? What will you revise this week?" Collect responses. Address misconceptions. Offer targeted support strategies. Builds metacognition and shows you care.',
    variations: [
    ...
    differentiationNotes: 'Emotional dimension of exam prep. Powerful for identifying struggling students early.\nLower ability: Celebrate any progress. Offer targeted small-group revision. Build confidence incrementally.\nHigher ability: Push them to set stretch targets. Encourage them to support peers.',
  },
  {
    id: 'exam-16',
    type: 'Concept Mapping',
    title: 'Exam Structure and Demand Map',
    description: 'Students create visual maps of exam structure, question types, and command words.',
    duration: 5,
    suitableFor: ['Year 10', 'Year 11'],
    instructions: 'Central node: exam title. Spider out to: sections, question types, command words, mark allocations, time allocations, content domains. Create one class map together, then students annotate with revision priorities. Demystifies exam format. Creates strategic approach.',
    variations: [
    ...
    differentiationNotes: 'Builds exam literacy and strategic thinking.\nLower ability: Provide template or partially completed map. Simplify focus to one section.\nHigher ability: Push them to identify where marks are "easy" vs. "hard"; plan time allocation strategically.',
  },
  {
    id: 'exam-17',
    type: 'Peer Marking',
    title: 'Exam Marking Calibration',
    description: 'Students mark peer work against mark scheme; compare marking decisions with teacher.',
    duration: 6,
    suitableFor: ['Year 10', 'Year 11'],
    instructions: 'Students swap exam-style responses. Mark against provided mark scheme. Teacher marks same responses. Compare: where did students over/under-mark? Discuss discrepancies. Teach students what examiners are actually looking for. Powerful for understanding standards.',
    variations: [
    ...
    differentiationNotes: 'Teaches students to be fair evaluators. Demystifies marking.\nLower ability: Focus on marking one criterion at a time. Celebrate attempts to apply criteria fairly.\nHigher ability: Push them to justify marks. Explore borderline decisions. Teach distinguishing between grades.',
  },
  {
    id: 'exam-18',
    type: 'Think-Pair-Share',
    title: 'Command Word Strategy Session',
    description: 'Students discuss strategies for decoding and responding to different exam command words.',
    duration: 5,
    suitableFor: ['Year 9', 'Year 10', 'Year 11'],
    instructions: 'Assign each pair a command word (analyze, evaluate, compare, explain, discuss). Think: what does this word ask you to do? Pair: discuss strategies and exemplify with an example response. Share: each pair teaches the class their command word and strategy. Creates shared understanding of exam language.',
    variations: [
    ...
    differentiationNotes: 'Exam language clarity. Reduces anxiety from misunderstanding questions.\nLower ability: Provide definition and example for each word. Simplify explanation required.\nHigher ability: Push them to explain why authors use different command words. Explore nuances (e.g., compare vs. contrast).',
  },
  {
    id: 'exam-19',
    type: 'Reflection Journal',
    title: 'Exam Preparation Progress Journal',
    description: 'Students maintain a journal tracking revision progress, gaps, and breakthrough moments.',
    duration: 3,
    suitableFor: ['Year 10', 'Year 11'],
    instructions: 'Weekly entry: "Topics revised, gaps identified, aha! moments, next priority." Over time, students see progress. Entries become revision notes. Journaling reduces anxiety and builds agency. Review before exam for confidence boost.',
    variations: [
    ...
    differentiationNotes: 'Builds exam resilience and ownership of revision.\nLower ability: Shorter entries with sentence starters. Celebrate any revision done. Build confidence incrementally.\nHigher ability: Push them to analyze patterns. Require them to evaluate revision strategy effectiveness.',
  },
  {
    id: 'exam-20',
    type: 'Mind Map Review',
    title: 'Revision Roadmap',
    description: 'Students create a personal visual roadmap of all revision topics with priority indicators.',
    duration: 5,
    suitableFor: ['Year 10', 'Year 11'],
    instructions: 'Central node: subject/exam. Branches: major topics. Sub-branches: specific concepts. Color code: green (confident), amber (revision needed), red (urgent priority). Add timelines. Students use roadmaps to plan revision timetables. Visual and strategic.',
    variations: [
