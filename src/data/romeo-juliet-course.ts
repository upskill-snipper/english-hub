...
`,
      quiz: [
        ...
        {
          id: 'rj-m1-q2',
          question: 'What was the primary purpose of marriage in Elizabethan England?',
          options: [
            'Romantic fulfilment',
            'Religious devotion',
        ...
        {
          id: 'rj-m1-q3',
          question: "What is the effect of the Prologue revealing the lovers' deaths in advance?",
          options: [
        ...
        {
          id: 'rj-m1-q4',
          question: 'How did Shakespeare change the timeline from his source material?',
          options: [
...
`,
      quiz: [
        {
          id: 'rj-m2-q1',
          question: 'What poetic form do Romeo and Juliet speak when they first meet?',
          options: ['A ballad', 'A shared sonnet', 'Blank verse', 'A soliloquy'],
          correct: 1,
          explanation:
        ...
        {
          id: 'rj-m2-q3',
          question: 'Why does Shakespeare present Romeo as a Petrarchan lover in Act 1?',
          options: [
        ...
        {
          id: 'rj-m2-q4',
          question: 'What does Prince Escalus decree as punishment for further street fighting?',
...
`,
      quiz: [
        {
          id: 'rj-m3-q1',
          question: 'What does Romeo mean when he says "Juliet is the sun"?',
          options: [
        ...
        {
          id: 'rj-m3-q2',
          question: 'Why is it significant that Juliet is the one who proposes marriage?',
          options: [
        ...
        {
          id: 'rj-m3-q3',
          question: "What does the Friar's speech about herbs and plants foreshadow?",
          options: [
        ...
        {
          id: 'rj-m3-q4',
          question: 'What does "These violent delights have violent ends" mean?',
          options: [
        ...
        {
          id: 'rj-m3-q5',
          question: 'Why is the marriage scene (Act 2, Scene 6) so brief?',
          options: [
...
`,
      quiz: [
        {
          id: 'rj-m4-q1',
          question: 'Why does Romeo refuse to fight Tybalt at first?',
          options: [
        ...
        {
          id: 'rj-m4-q4',
          question: 'How does Lord Capulet react when Juliet refuses to marry Paris?',
          options: [
...
`,
      quiz: [
        {
          id: 'rj-m6-q1',
          question: "How does Shakespeare signal that Romeo's love for Rosaline is superficial?",
          options: [
        ...
        {
          id: 'rj-m6-q2',
          question: 'What does Romeo mean by "Thy beauty hath made me effeminate"?',
          options: [
        ...
        {
          id: 'rj-m6-q4',
          question: "Why is Romeo's death in the tomb particularly tragic?",
          options: [
            'He dies alone',
        ...
        {
          id: 'rj-m6-q5',
          question: 'What does the Friar mean by "They stumble that run fast"?',
          options: [
...
`,
      quiz: [
        {
          id: 'rj-m7-q1',
          question: "How does Shakespeare signal Juliet's independence even in her first speech?",
          options: [
        ...
        {
          id: 'rj-m7-q2',
          question: 'Why is Juliet arguably braver than Romeo?',
          options: [
            'She fights Tybalt',
        ...
        {
          id: 'rj-m7-q3',
          question: "What is the difference between Romeo's death and Juliet's death?",
          options: [
        ...
        {
          id: 'rj-m7-q4',
          question: 'Why does Shakespeare make Juliet only thirteen years old?',
          options: [
        ...
        {
          id: 'rj-m7-q5',
          question: 'What does Juliet mean by "Thou and my bosom henceforth shall be twain"?',
          options: [
...
`,
      quiz: [
        {
          id: 'rj-m8-q1',
          question: 'Which types of love does Shakespeare present in the play?',
          options: [
            'Only romantic love',
        ...
        {
          id: 'rj-m8-q2',
          question: 'Why does Shakespeare leave the role of fate deliberately ambiguous?',
          options: [
        ...
        {
          id: 'rj-m8-q3',
          question: "How does Lord Capulet's behaviour change between Act 1 and Act 3?",
          options: [
        ...
        {
          id: 'rj-m8-q4',
          question: "What is the play's central argument about conflict?",
          options: [
        ...
        {
          id: 'rj-m8-q5',
          question: "How does the theme of youth vs age function in the play's ending?",
          options: [
...
`,
      quiz: [
        {
          id: 'rj-m9-q1',
          question: 'What is the primary function of light/dark imagery in the play?',
          options: [
        ...
        {
          id: 'rj-m9-q3',
          question: 'What is the difference between blank verse and prose in the play?',
          options: [
        ...
        {
          id: 'rj-m9-q4',
          question: 'Why is the compressed timeline a significant structural choice?',
          options: [
...
`,
      quiz: [
        {
          id: 'rj-m10-q1',
          question: 'What is the most effective way to include context in an exam essay?',
          options: [
        ...
        {
          id: 'rj-m10-q4',
          question: 'How should you structure each paragraph of your essay?',
          options: [
  ...
  assessmentQuestions: [
    ...
    {
      id: 'rj-aq3',
      question: 'Which character says "A plague o\' both your houses"?',
    ...
    {
      id: 'rj-aq5',
      question: 'Why does Shakespeare make Juliet the one who proposes marriage?',
      options: [
    ...
    {
      id: 'rj-aq6',
      question: "What does Friar Lawrence's speech about herbs and plants foreshadow?",
      options: [
    ...
    },
    {
      id: 'rj-aq7',
      question: "What is Romeo's hamartia (tragic flaw)?",
      options: ['Arrogance', 'Greed', 'Impulsiveness', 'Cowardice'],
      correct: 2,
      explanation:
    ...
    {
      id: 'rj-aq8',
      question: "How does Lord Capulet's attitude to Juliet change between Act 1 and Act 3?",
      options: [
    ...
    {
      id: 'rj-aq11',
      question: "What is the effect of the play's compressed timeline?",
      options: [
    ...
    {
      id: 'rj-aq12',
      question: 'How does Shakespeare use the light/dark imagery pattern?',
      options: [
    ...
    {
      id: 'rj-aq13',
      question: "What type of love does Romeo's relationship with Rosaline represent?",
      options: [
    ...
    {
      id: 'rj-aq14',
      question: 'What role does the Nurse play in the tragedy?',
      options: [
    ...
    {
      id: 'rj-aq15',
      question: 'What does "Then I defy you, stars!" reveal about Romeo?',
      options: [
    ...
    {
      id: 'rj-aq16',
      question: 'What is the best way to embed context in an exam essay?',
      options: [
    ...
    {
      id: 'rj-aq17',
      question: 'What does the Prince mean by "All are punish\'d"?',
      options: [
    ...
    {
      id: 'rj-aq18',
      question: 'What is a "conceptualised response" in an AQA Literature essay?',
      options: [
    ...
    {
      id: 'rj-aq19',
      question: "Why is the Friar's sleeping potion plan significant thematically?",
      options: [
