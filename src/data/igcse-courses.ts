...
const igcseLangA: CourseData = {
  ...
  color: '#0ea5e9',
  description: 'The complete Edexcel International GCSE English Language Specification A course. Master non-fiction reading, transactional writing, poetry and prose analysis, and imaginative writing — with examiner-level strategies, worked examples, and model answers for every question type across both papers.',
