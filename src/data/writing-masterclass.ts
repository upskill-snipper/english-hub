...
const framework3: WritingFramework = {
  ...
  checklist: {
    Hook: [
      'State a striking fact or question',
      'Avoid clichés; make the reader care immediately',
      'Signal your position without being aggressive',
    ],
    'Each Pillar': [
      'Begin with topic sentence stating the argument clearly',
      'Provide concrete evidence-statistics, examples, expert quotes',
      'Explain why this evidence matters (the so-what)',
    ],
    Rebuttal: [
      'Acknowledge opposing view fairly',
      'Explain why that view is insufficient or flawed',
      'Show your argument addresses the concern better',
    ],
    Conclusion: [
      'Return to the hook with new understanding',
      "State what's at stake; what should happen next",
      'End with memorable, call-to-action statement',
    ],
  },
  commonMistakes: [
...
const framework5: WritingFramework = {
  ...
  checklist: {
    Introduction: [
      "State what you're comparing and why it's interesting",
      'Avoid vague comparisons ("both have characters")',
      'Signal your argument about what the comparison reveals',
    ],
    Similarities: [
      'Move beyond surface similarities to structural or thematic depth',
      'Explain why the similarity matters; what function does it serve',
      'Use evidence from both texts equally',
    ],
    Differences: [
      'Avoid listing differences; explain their significance',
      "Show how differences reflect different authors' purposes or historical contexts",
      'Avoid implying one text is "better" unless making that argument',
    ],
    Synthesis: [
      'Show how similarities and differences create a larger truth',
      'Avoid treating texts as equal; focus on what comparison reveals',
      'Connect to reader interests or larger themes',
    ],
  },
  commonMistakes: [
...
export const modelTexts: ModelText[] = [
  {
    ...
    annotations: [
      {
        ...
        effect:
          'Immediately immerses reader in the place and creates nostalgic, mysterious atmosphere',
      },
      {
        quote: 'each step creaking under her feet',
        technique: 'Onomatopoeia and sound imagery',
        effect:
          'Makes reader feel the physical reality of the action; creates tension and anticipation',
      },
      {
      ...
      {
        quote:
          "Everyone has stories they keep secret. Everyone has dreams, even if they don't share them.",
    ...
    prompt:
      'Write a story about discovering something unexpected. Your story should be between 400-500 words.',
  },
  {
    ...
    prompt:
      'Describe a place you know well when no one else is there. Use sensory details to help your reader see, hear, and feel what you experience.',
  },
  {
    ...
    annotations: [
      {
        quote:
          'Everything Marcus had tried to keep separate-school and home, the version of himself that functioned and the version that fell apart-had collided in a single moment.',
        technique: 'Extended metaphor and parallel structure',
        effect:
          "Shows internal conflict through structural language; reader understands Marcus's fragmentation",
      },
      {
      ...
      {
        quote:
          "He didn't feel brave. He felt terrified. But he also felt like something inside him had shifted.",
        technique: 'Honest emotional contradiction',
        effect: 'Avoids false resolution; shows real maturity is proceeding despite fear',
      },
      {
        quote:
          "It wasn't redemption-redemption was too big and too neat. It was just the small, difficult decision to keep trying.",
    ...
    prompt:
      "Write a story about a moment that changes someone's perspective. Your character should face a genuine dilemma with real consequences.",
  },
  {
    ...
    annotations: [
      {
        quote:
          'Every year, thousands of young people leave school and make their first major financial decisions without any preparation.',
      ...
      {
        quote:
          "If they don't understand compound interest, they might pay £5,000 more on a mortgage over its lifetime.",
      ...
      {
        quote:
          'They know how to identify a sketchy person on the street but not a sketchy financial product, because no one taught them the warning signs.',
        technique: 'Parallel structure revealing logical gap',
        effect: 'Demonstrates inconsistency in education; persuades through logic',
      },
      {
        quote:
          'The cost of teaching these skills is minimal. The cost of not teaching them is measured in ruined lives and preventable financial crisis.',
    ...
    prompt:
      'Write a persuasive piece arguing for or against a change you think schools should make. Support your argument with evidence and reasoning.',
  },
]
...
const model5: ModelText = {
  ...
  annotations: [
    {
      quote:
        "Through George, Lennie, and Curley's wife, Steinbeck argues that the American Dream itself is a trap",
    ...
    {
      quote:
        'the wages they earn will never accumulate to ownership. Other workers on the ranch share this dream',
      technique: 'Concrete detail supporting larger structural argument',
      effect: 'Grounds abstract theme in economic reality',
    },
    {
      quote:
        'the American Dream-the belief that individuals can create better lives through work and determination-is fundamentally flawed',
  ...
  prompt:
    "Choose a major theme in a text you've studied. Write an analysis explaining how the author develops this theme and what message the theme communicates.",
}
...
const model6: ModelText = {
  ...
  annotations: [
    {
      quote:
        'Where Orwell sees totalitarianism as ultimately victorious...Zamyatin suggests that authentic human consciousness inevitably rebels',
      technique: 'Clear thesis identifying the key disagreement between texts',
      effect:
        'Establishes comparison will explore philosophical difference, not just surface similarities',
    },
    {
      quote:
        'This fundamental divergence reveals different philosophical assumptions about human nature',
    ...
    },
    {
      ...
      effect:
        'Structure itself models comparative thinking: find common ground then explore divergence',
    },
    {
      quote:
        'totalitarianism succeeds not through brute force alone but through psychological penetration',
    ...
    {
      quote:
        'Orwell writes from disillusionment with revolutionary causes; Zamyatin, from idealistic hope that human nature transcends political systems.',
  ...
  prompt:
    'Compare how two texts you have studied explore the relationship between power and human freedom. Analyze both similarities and significant differences in how the authors present these themes.',
}
...
const model7: ModelText = {
  ...
  annotations: [
    {
      quote:
        'The fjord at twilight exists in a liminal space between day and night, between the solid earth and something more ethereal.',
      technique: 'Thematic opening establishing the space between states',
      effect:
        'Immediately signals that this description explores ambiguity and transition rather than fixed states',
    },
    {
      quote:
        'They are indifferent to human perception, their scale making human awe feel like an appropriate response to genuine insignificance.',
    ...
    },
    {
      ...
      effect:
        'Shows sophisticated observation; refuses simple adjectives in favour of precise analysis',
    },
    {
      quote:
        'What emerges is not emptiness but fullness-the presence of things that can no longer be clearly seen',
    ...
    {
      quote:
        'The viewer is no longer observing the landscape; instead, the viewer has become part of the landscape',
      technique: 'Shift from external observation to participant perspective',
      effect:
        'Demonstrates how deep attention to place dissolves boundaries between observer and observed',
    },
  ],
  prompt:
    'Write a detailed description of a landscape or natural place that reveals something profound about how humans experience the natural world. Use precise sensory language and structural choices to create meaning beyond mere description.',
}
    ...
    words: [
      {
        ...
        exampleSentence:
          'The oppressive heat of the summer made it difficult to concentrate on her studies.',
      ...
      },
      {
        ...
        exampleSentence:
          'The ominous clouds gathering on the horizon made the sailors nervous about the journey ahead.',
      ...
      },
      {
        ...
        exampleSentence:
          'The ethereal beauty of the moonlight through the clouds seemed almost magical.',
      ...
      },
      {
        ...
        exampleSentence:
          'The melancholic tone of the violin piece evoked a sense of longing and loss.',
      ...
      },
      {
        ...
        exampleSentence:
          'The vibrant market was alive with colour and the sounds of vendors calling out.',
      ...
      },
      {
        ...
        exampleSentence:
          'The austere monastery contained only the barest necessities for the monks.',
      ...
      },
      {
        ...
        exampleSentence:
          'The claustrophobic narrow corridors of the old castle made her feel anxious.',
      ...
      },
      {
        ...
        exampleSentence:
          'The luminous glow of the fireflies created a magical scene in the summer evening.',
  ...
  },
  {
    ...
    words: [
      ...
      },
      {
        ...
        exampleSentence:
          'His mercurial temperament meant that nobody knew whether he would be cheerful or angry.',
      ...
      },
      {
        ...
        exampleSentence:
          "The obsequious servant followed his master's every command without question.",
      ...
      },
      {
        ...
        exampleSentence:
          'Her impetuous decision to leave without saying goodbye caused regret later.',
      ...
      },
      {
        ...
        exampleSentence:
          'He took a circumspect approach to the business deal, examining every detail.',
  ...
  },
  {
    ...
    words: [
      ...
      },
      {
        ...
        exampleSentence:
          'The turbulent period after the revolution brought uncertainty to the nation.',
      ...
      },
      {
        ...
        exampleSentence:
          'His vindictive response to criticism showed his willingness to hold grudges.',
      ...
      },
      {
        ...
        exampleSentence:
          "The teacher's rebuke of the student's behaviour was delivered calmly but firmly.",
  ...
  },
  {
    ...
    words: [
      ...
      },
      {
        ...
        exampleSentence:
          "The consternation on the losing team's faces showed their disappointment.",
        synonyms: ['Dismay', 'Alarm', 'Anxiety', 'Shock'],
      },
      {
        word: 'Longing',
        definition:
          'A deep desire or yearning for something, often something absent or unattainable',
      ...
      },
      {
        ...
        exampleSentence:
          'The elation of receiving the acceptance letter made her forget all her worries.',
      ...
      },
      {
        ...
        exampleSentence:
          'She approached the interview with some trepidation, unsure how well she would perform.',
    ...
    words: [
      {
        ...
        exampleSentence:
          'The decrepit mansion stood abandoned, its windows broken and walls crumbling.',
      ...
      },
      {
        ...
        exampleSentence:
          'Her bedroom was immaculate, with everything organized in its proper place.',
      ...
      },
      {
        ...
        exampleSentence:
          'The derelict factory had been empty for decades, its machinery rusting away.',
