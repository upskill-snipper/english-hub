...
//
// AUDIT NOTE (FC20, 2026-04-28): Source attributions in this file naming
// specific contemporary journalists / publications (e.g. "Laura Chen, 'The
// Invisible Crisis', The Guardian, 2024"; "Dr Sarah Mitchell, 'The Digital
// Generation', BBC Education, 2024") are FABRICATED framing labels for
// original practice compositions — neither the named authors nor the cited
// articles are real. Pre-1928 attributions (Mayhew 1851, Arnold 1867) are real
// authors but the rendered text is original composition in the period style,
// not verbatim. Treat all sources as practice stimuli, not republication.
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A, C, F, H — These are the four true statements based on the first paragraph. A: "The morning fog crept across the marshes." C: "cold fingers" and "the chill." F: "like a living thing." H: "each one marking a life that had ended."',
              'Grade 6-7':
                'A, C, F, H — The correct answers are found by careful reference to the first paragraph only. B is false (his coat is "thin"), D is false (the setting is marshes, not a city), E is partially true but "grey half-light" refers to general light not specifically stones, G is false.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              "Look in detail at the extract from lines 5 to 12. How does the writer use language here to describe the marshland setting?\n\nYou could include the writer's choice of:\n- words and phrases\n- language features and techniques\n- sentence forms.",
            marks: 8,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A, B, D, E — A: she has "walked through the streets of every major city in Europe." B: "I counted fourteen people." D: "sleeping in doorways." E: "within a single mile of Westminster."',
            },
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              'Read lines 9-20 of the extract. Analyse how the writer uses language to present Elena as a powerful and controlled character.\n\nSupport your views with detailed reference to the text.',
            marks: 6,
            suggestedTimeMinutes: 10,
            questionType: 'analysis',
            extract: EDEXCEL_P1_EXTRACT,
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText:
              'Read lines 1-5. List five things you learn about the kitchen and what is happening from these lines.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              '"Both writers make the reader care about poverty, but the 19th-century writer is more effective because their personal witness account is more powerful than statistics."\n\nTo what extent do you agree? You should refer to both texts.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: `Source A:\n${AQA_P2_SOURCE_A}\n\nSource B:\n${AQA_P2_SOURCE_B}`,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. There was morning fog on the marshes. 2. The fog was cold. 3. The churchyard had gravestones. 4. The light was grey and dim.',
            },
