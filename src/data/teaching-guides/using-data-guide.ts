  ...
  sections: [
    {
      ...
      examples: [
        {
          scenario:
            'The dashboard shows that Year 10 students are spending significant time on poetry flashcards but their quiz scores are not improving',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'Data shows that boys in your Year 9 class are significantly underperforming girls on extended writing tasks, but performing equally on shorter analytical questions',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'A parent is concerned that their child "isn\'t making progress" despite the student\'s data showing steady improvement in specific skills',
          approach:
