  ...
  sections: [
    {
      ...
      examples: [
        {
          scenario:
            'A Year 11 class of 30 students has just completed a mock exam and results are disappointing overall',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'Five students in Year 10 consistently lose marks on AO2 (language analysis) despite knowing their texts well',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'A Year 9 class has significant variation in reading comprehension, with some students unable to access the class novel independently',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'Year 11 students are three months from their exams and many have not established any independent revision routine',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'A department has invested in after-school intervention sessions but is unsure whether they are making a difference',
          approach:
