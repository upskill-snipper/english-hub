  ...
  sections: [
    {
      ...
      examples: [
        {
          scenario:
            'A student writes: "The writer uses a simile to describe the storm. This makes the reader feel scared."',
          approach:
        ...
        {
          scenario:
            "A student writes: \"Dickens uses the adjective 'squeezing' to describe Scrooge, which has connotations of tightness and restriction, suggesting he is not only financially mean but emotionally constrained. The sibilance of 'squeezing, wrenching, grasping' creates an almost serpentine quality, aligning Scrooge with something predatory and cold-blooded.\"",
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            "A student begins their Inspector Calls response with a full paragraph about Priestley's socialist beliefs and the 1945 Labour landslide",
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'You are marking a set of 30 Year 11 mock papers and notice that your marks feel inconsistent by the end',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'A parent queries why their child received Grade 4 on the mock when they "only needed two more marks for Grade 5"',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'You want to show Year 11 the difference between a Grade 5 and Grade 7 response to an "Inspector Calls" question',
          approach:
