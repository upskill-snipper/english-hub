  ...
  sections: [
    {
      ...
      examples: [
        {
          scenario:
            'Year 10 students have just finished studying "Macbeth" and are moving on to poetry - you want to ensure they retain their Macbeth knowledge',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'Students consistently run out of time on the second question of a two-question exam paper',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'Mock exam data reveals that most students can identify language techniques but fail to analyse their effects',
          approach:
