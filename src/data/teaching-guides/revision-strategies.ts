  ...
  sections: [
    {
      ...
      examples: [
        {
          scenario:
            'Year 11 students revising "A Christmas Carol" struggle to remember quotations beyond the most obvious ones',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'Year 10 students have studied four poems from the anthology but have forgotten the first two by the time they reach the fourth',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'Year 11 students preparing for the English Literature paper want to revise one text per evening',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'Year 9 students find it difficult to remember how themes develop across "Romeo and Juliet"',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'Year 10 students can identify techniques in unseen poetry but cannot explain their effects',
          approach:
    ...
    },
    {
      ...
      examples: [
        {
          scenario:
            'A department wants to embed evidence-based revision across all year groups but staff feel overwhelmed by the options',
          approach:
