...
const TEMPEST_EXTRACT_01_SOURCE = 'William Shakespeare, The Tempest, Act 4, Scene 1'
...
Then to the sea goes she,
Well balm'd and high dried, with hey, the sea-salt and the sea-side.
...
const TEMPEST_EXTRACT_02_SOURCE = 'William Shakespeare, The Tempest, Act 3, Scene 2'

const TEMPEST_EXTRACT_03 = `PROSPERO
...
CALIBAN
I will comply with all thy oughts, for now
I aim even to thy fear. I prithee, let me bring thee
Where crabs grow,
And I with my long nails will dig thee pig-nuts;
Show thee a jay's nest and instruct thee how
To snare the nimble marmoset; I'll bring thee
To clustering filberts and sometimes I'll get thee
Young scamels from the rock. Wilt thou with me?`

const TEMPEST_EXTRACT_03_SOURCE = 'William Shakespeare, The Tempest, Act 4, Scene 1'
...
CLAUDIO
[To HERO.] And here the gentle Claudio turn'd to shame,
For Hero's beauty, though the world acclaim it,
Was but the surface that his eye beheld;
Thy beauty, Hero, is thy greatest treasure,
Yet beauty, too, doth fade and turn to dust.
But hold! That cheek which now doth glow so bright
With maiden's blush and innocence of youth
Shall not endure when thirty winters come,
When silver threads do tangle in thy hair,
And wrinkles trace a map upon thy brow.

HERO
Is he not approved in the height of heart?
Shall I the rest hear speak?

BEATRICE
Speak, countenance! What dost thou know
Of men's affections?

CLAUDIO
I think Benedick hath ta'en thee for his wife.

BEATRICE
I never drank with him in all my life;
Yet doth the news of this conjoin our names
In such a manner as to make me smile.

DON PEDRO
Come, come, we are friends:
Let us to the banquet then, and when the feast
Is finish'd, we will have more talk of this affair.`

const MUCH_ADO_EXTRACT_01_SOURCE = 'William Shakespeare, Much Ado About Nothing, Act 5, Scene 2'
...
of good discourse, an excellent musician and her hair shall be of what colour it please God.
Ha! the Prince and Monsieur Love! I will hide me in the arbour.

[BENEDICK hides.]

[Enter the PRINCE, LEONATO, and CLAUDIO.]
...
const MUCH_ADO_EXTRACT_02_SOURCE = 'William Shakespeare, Much Ado About Nothing, Act 2, Scene 3'

const MUCH_ADO_EXTRACT_03 = `HERO
Beshrew my heart,
But I do think the fair Claudio doth exceed her
As much in beauty as the first of May
Doth exceed the last of December. But I hope you have no intent
To turn him into jest. Leonato, go in before;
I'll follow straight. [Exit Leonato.]
...
const MUCH_ADO_EXTRACT_03_SOURCE = 'William Shakespeare, Much Ado About Nothing, Act 3, Scene 1'

// ─── The Merchant of Venice Extracts ──────────────────────────────────────

const MERCHANT_EXTRACT_01 = `SHYLOCK
...
const MERCHANT_EXTRACT_01_SOURCE = 'William Shakespeare, The Merchant of Venice, Act 3, Scene 1'
...
const MERCHANT_EXTRACT_02_SOURCE = 'William Shakespeare, The Merchant of Venice, Act 4, Scene 1'

const MERCHANT_EXTRACT_03 = `ANTONIO
In sooth, I know not why I am so sad:
But how I caught it, found it, or came by it,
What stuff 'tis made of, whereof it is born,
I am to learn; and such a want-wit sadness makes me,
...
Peering in maps for ports and roads; and every thought
Betray the fear my soul doth feel.`

const MERCHANT_EXTRACT_03_SOURCE = 'William Shakespeare, The Merchant of Venice, Act 1, Scene 1'
...
const PRIDE_AND_PREJUDICE_EXTRACT_01 = `It is a truth universally acknowledged, that a single man in possession of a good fortune, must be in want of a wife. However little known the feelings or views of such a man may be on his first entering a neighbourhood, this truth is so well fixed in the minds of the surrounding families, that he is considered as the rightful property of some one or other of their daughters.
...
"How so? how can it affect them?" "My dear Mr. Bennet," replied his wife, "how can you be so tiresome! You must know that when a gentleman comes into a neighbourhood, he must be in want of marrying; and therefore you must visit him very soon."

Mr. Bennet was so odd a mixture of quick parts, sarcasm, and reserve, that the extent of his abilities was misunderstood, and he was fancied himself to be deeper than he was.`

const PRIDE_AND_PREJUDICE_EXTRACT_01_SOURCE = 'Jane Austen, Pride and Prejudice (1813)'

const PRIDE_AND_PREJUDICE_EXTRACT_02 = `"I have been meditating on something, that for some time past has given me great uneasiness," said he at last. Elizabeth immediately fixed all her attention on him, and lay back in her chair in a state of anxious expectation. But his silence continued; she longed for the sound of his voice, and resolved to take courage and speak herself.

"Did you come to Rosings with the design of proposing to me, sir?" she cried out at last, in her vexation at such unnecessary delay, and looking him directly in the face.

"My dear Elizabeth, I have had the highest respect for your understanding. I hope you will be convinced of my attachment, and the constancy of my affections. In vain I have struggled. It will not do. My feelings will not be repressed. You must allow me to tell you how ardently I admire and love you."

Elizabeth's astonishment was beyond expression. She stared, coloured, doubted, and was silent. This he considered as sufficient encouragement, and the occasion calling forth all his powers, he proceeded to a more animated eloquence. But Elizabeth had not the smallest intention of accepting him.

"Sir, you could not have made me the offer of which you speak in any possible way that would have tempted me to accept it. When I saw you at Hunsford," continued Elizabeth, with her usual candour, "you appeared to me to be destitute of every quality that would make you a desirable companion. Your behaviour to me was always disgusting, but your letter gave me a picture of your heart which I could not overlook."

Mr. Darcy stood in silent anguish, unable to articulate a word.`

const PRIDE_AND_PREJUDICE_EXTRACT_02_SOURCE = 'Jane Austen, Pride and Prejudice (1813)'

const PRIDE_AND_PREJUDICE_EXTRACT_03 = `"You are too hasty, sir," she cried. "You forget that I have made no answer. Let me do it without further loss of time. Accept my thanks for the compliment you are paying yourself, and once more, I must decline the honour of your proposals."

"Is this the reply I am to have the honour of expecting!" "Indeed, sir, I do. You could not have addressed me in any possible way that would induce me to accept you."

Mr. Collins was astounded. For a few minutes he remained in absolute silence; and when at last words came to him, they were all protestations of disbelief. Elizabeth's steadiness had not changed, and she walked away, leaving him to digest his astonishment in solitude.

"Your refusal of my addresses is merely words," he cried after her, "a delicate female refusal, which I am sure you do not really mean. The ladies are fond of refusal, as a matter of delicacy; but that is only words."

Elizabeth could not help smiling at so convenient a construction of her words. She tried again, with more earnestness than before, to explain that her refusal was final; but Mr. Collins still remained unconvinced, and seemed to think that she had only spoken from diffidence, and had a very different meaning in her heart.`

const PRIDE_AND_PREJUDICE_EXTRACT_03_SOURCE = 'Jane Austen, Pride and Prejudice (1813)'

// ─── The Sign of Four Extracts ───────────────────────────────────────────────

const SIGN_OF_FOUR_EXTRACT_01 = `"You see, but you do not observe. The distinction is quite clear," said Holmes, lighting a cigarette, and throwing himself back in his chair. "For example, you have frequently seen the steps which lead up from the hall to this room."
...
"Quite so! You have not observed. And yet you have seen. That is just my point. Now, I know that there are seventeen steps, because I have both seen and observed. By-the-way, since you came into this room, you have uttered the remark 'It is a cold day' four times. Yet I have said nothing on the subject. Pray, what is the temperature in this room?"

"About 68 degrees Fahrenheit, I should say."

"No, it is 72. But come, Mr. Watson, we must not waste time upon such trifles. I hear that you had some little difficulty in the matter of the Speckled Band. I trust that the case may be of some interest to you. I may have need of your assistance."

"I shall be delighted," said I. "You know that I am always ready to help you in any of your undertakings."

"Your services have been very necessary," replied Holmes, with a cold smile. "There is a train to Waterloo at one o'clock. May I trouble you to have ready a bag packed? We have a small piece of business to transact before then, and it would be well to lose no time, as matters are somewhat pressing."

I had to confess that I had no idea of what he was hinting at, and that I could only trust to his guidance.`

const SIGN_OF_FOUR_EXTRACT_01_SOURCE = 'Sir Arthur Conan Doyle, The Sign of Four (1890)'

const SIGN_OF_FOUR_EXTRACT_02 = `"I have already explained to you that what at first appeared to be a case of a very simple kind has ended by involving us in some investigations of considerable complexity. It was now clear to me that the crime was of no ordinary character. Singular as were the facts which were submitted to my analysis, they all pointed to a very definite conclusion. I had, before examining the room, so clearly perceived the course of events, and possible outcome, that I never in any way was surprised by anything which I subsequently observed. And now I am quite ready to go into the details of the case if you would wish to hear them."
...
"Ah, the motive, Watson, the motive! There lay the crux of the whole matter. In this case, the motive was not far to seek. Greed, pure and simple, coupled with a spirit of revenge, and the desire to gain possession of a treasure which had been jealously guarded for many years."`
...
I could not but smile at the egotism which was so often displayed by my friend, even in matters of great importance. Yet I knew that his methods, though strange, had invariably led to success.`

const SIGN_OF_FOUR_EXTRACT_03_SOURCE = 'Sir Arthur Conan Doyle, The Sign of Four (1890)'
