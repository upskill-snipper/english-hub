        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'C, D, G, H — Textually supported. (A) false: "I don\'t remember," (B) false: "only earth," (E) false: knew her through fence, (F) false: upstairs.',
              'Grade 6-7': 'C, D, G, H — (C) "handwriting I recognise as my own," (D) "missing girl...Elspeth," (G) "You know you\'re not well," (H) "dates...seventeen years ago."',
              'Grade 8-9': 'C, D, G, H — Each statement has explicit textual validation. The passage establishes unreliable narrator through the wife\'s concern about basement and the narrator\'s inability to distinguish memory from imagination.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'Create a clear narrative with a specific discovery as the turning point. Use sensory details to make the moment vivid. Show the character\'s reaction to the discovery. The writing should have varied sentences and create an atmosphere of unease. Approximately 450-500 words with generally accurate grammar.',
              'Grade 6-7': 'Construct a narrative where the discovery reveals something about the character\'s psychology or history. Use precise sensory and emotional language. Vary sentence structures to create tension. Show internal conflict. Approximately 500 words with confident technical control.',
              'Grade 8-9': 'Create a sophisticated narrative where the discovery itself is ambiguous or disturbing. Show how perspective shapes interpretation. Use language precisely. Sustain psychological tension throughout. Word choice should be precise and sometimes unexpected. Spelling and grammar secure. The discovery itself should resist simple explanation.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'B, D, E, H — Direct textual support. (A) false: exactly 7:43, (C) false: "enforced," (F) false: filters installed, (G) false: "do not use...husband."',
              'Grade 6-7': 'B, D, E, H — (B) "distribution...12:00," (D) "work in Distribution Analysis," (E) "people...chaotic. They ate when hungry," (H) "At 9:13...an alarm sounds."',
              'Grade 8-9': 'B, D, E, H — Each validated with precision. The passage establishes the oppressive precision of the city through numerical regulation.',
            },
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'Create a clear picture of a controlled society with specific rules. Show how the rules affect daily life and relationships. Include details about what people have lost or given up. The writing should be vivid and engaging, with about 450-500 words of accurate writing.',
              'Grade 6-7': 'Develop a controlled environment with specific rules and consequences. Show the system through character action and dialogue. Vary sentence structures to create tone. Show both the logic of control and its human cost. Approximately 500 words with confident technical control.',
              'Grade 8-9': 'Create a sophisticated exploration of control that shows the system\'s internal logic while revealing its dehumanizing effects. Use precise language and varied sentence structures. Show how ideology is internalized. The piece should be approximately 500-600 words with sophisticated control and thematic depth.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'A, D, G, E (Note: A is not a true statement — others see the blue too). Correct answer: A, D, F, G — (B) false: beyond shoulders, (C) false: narrator is scientist, (E) false: never saw it.',
              'Grade 6-7': 'A, D, F, G — (A) false: "my mother saw it, my sister saw it," (D) "The blue is memory," (F) not explicitly stated but implied, (G) "lingered in her kitchen for months."',
              'Grade 8-9': 'The issue here is that statement A is false (others can see the blue). True statements are D, G, plus two of F/H. If forced to four: D (memory), G (lingered), and two others need careful reading.',
            },
            markScheme: ['1 mark per answer', 'Maximum 4 marks', 'Accept answers with textual justification'],
          },
          {
            id: 'set3-mock-03-q2',
            questionNumber: 2,
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'Create a world where something magical exists alongside normal things. Show characters accepting the magical element as ordinary. Use details to make both the magical and ordinary feel real. The writing should be clear and engaging, about 450-500 words.',
              'Grade 6-7': 'Develop a world where the magical element is embedded in daily life without shock or explanation. Use sensory detail and character perspective. Vary sentence structures. Show how the impossible affects characters\' choices and relationships. Approximately 500 words with secure control.',
              'Grade 8-9': 'Create a sophisticated magical realist piece where impossible and ordinary coexist seamlessly. Use precise language and careful perspective. Show how characters navigate the magical as routine. The piece should have thematic depth and sophisticated control of tone and voice. Approximately 500-600 words.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'A, C, F, G — Textually supported. (B) false: "David," (D) false: message not call, (E) false: timing unspecified in terms of predictability, (H) incomplete.',
              'Grade 6-7': 'A, C, F, G — (A) "wakes before...every day," (C) "working in Singapore," (F) "cottage in Dorset they looked at," (G) "mug with the chip."',
              'Grade 8-9': 'A, C, F, G — Each with precise textual validation. Statement E requires careful reading: the timing is predicted as "seven minutes" exactly, which is about total time, not shower/dress separately.',
            },
            markScheme: ['1 mark per answer', 'Maximum 4 marks'],
          },
          {
            ...
            extractSource: MOCK_SET3_04_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'Sarah receives a message that is only an emoji — a thumbs-up. The writer shows Sarah staring at the emoji for a full minute, which shows it has upset her. The writer asks "When did her daughter become someone who communicated in emojis?" This shows Sarah is confused and sad about how her daughter has changed. The phrase "communication became easier with strangers" shows that Sarah feels distant from her daughter now.',
              'Grade 6-7': 'The writer establishes emotional distance through the reduction of communication to a single emoji. Sarah\'s extended contemplation ("stared...for a full minute") suggests the message is insufficient, inadequate. The rhetorical question "When did her daughter become..." expresses incomprehension of change, implying Sarah has not adapted to new forms of intimacy. The contrast between "easier with strangers" and the parent-child relationship suggests a failure of the relationship that communication technology has revealed rather than caused. The emoji becomes a symbol of emotional distance: a positive gesture (thumbs-up) presented in a form that prevents intimacy.',
              'Grade 8-9': 'The writer performs generational miscommunication through the collision of different communicative registers. The emoji is technically positive (approval) yet phenomenologically empty for Sarah, who expects substance. The extended stare ("full minute") performs temporal expansion of an empty moment — the minute becomes a measure of emotional distance. The rhetorical question expresses Sarah\'s failure to understand her daughter\'s generation\'s communication norms, and by extension, her daughter\'s life. Crucially, "easier with strangers" suggests that communication technology enables emotional efficiency but prevents intimacy. The passage performs the paradox of modern relationships: more communication channels but less connection. Sarah\'s expectation of voice communication (or full language) collides with her daughter\'s emoji efficiency, and in that collision, their relationship appears unbridged.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'Write about a moment when people who love each other can\'t connect. Show what they do and don\'t say to each other. Use details to reveal their emotions. The writing should have about 450-500 words with varied sentences and generally accurate spelling and grammar.',
              'Grade 6-7': 'Create a detailed scene showing emotional distance within a close relationship. Use dialogue, action, and internal thought to show different perspectives. Vary sentence structures to create emotional effect. Show what prevents connection. Approximately 500 words with confident technical control.',
              'Grade 8-9': 'Develop a sophisticated exploration of how people can be physically present yet emotionally absent from each other. Use precise language and perspective carefully. Show the complexity of disconnection. The piece should explore what prevents intimacy and have thematic resonance. Approximately 500-600 words.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'A, B, D, F — (C) false: Kos, (E) false: Michael\'s mother, (G) false: "stopped paying attention," (H) false: honeymoon, not anniversary.',
              'Grade 6-7': 'A, B, D, F — (A) "40-foot catamaran," (B) narrator + Peter + three others, (D) "three hours," (F) "engine cut out."',
              'Grade 8-9': 'A, B, D, F — Each validated. Elena is specifically "Michael\'s mother," not narrator\'s.',
            },
            markScheme: ['1 mark per answer', 'Maximum 4 marks'],
          },
          {
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'Create a narrative with a clear crisis moment. Show how characters respond and what they feel. Include sensory details about the danger. Show what the experience reveals about the characters. About 450-500 words with varied sentences.',
              'Grade 6-7': 'Develop a crisis narrative with specific details about the threat and the response. Show internal states through action and thought. Vary sentence structures to create tension. Show how crisis reveals character. Approximately 500 words with confident control.',
              'Grade 8-9': 'Create a sophisticated crisis narrative exploring psychological responses to danger. Use precise language and varied structures. Show how uncertainty and fear affect decision-making. Explore what the experience reveals about human nature and relationship. Approximately 500-600 words.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'B is false (discovered not constructed), C not stated, D true, E true, F true, G true, H false. Correct answer: D, E, F, G — Clear textual support.',
              'Grade 6-7': 'D, E, F, G — (A) implies older brother, (B) "discovered not constructed," (C) age not stated, (H) daughter is "six."',
              'Grade 8-9': 'D, E, F, G — Precise textual citations: (D) "studying economics," (E) "dead for twelve years," (F) "eventually...cut it down," (G) "I have a daughter now."',
            },
            markScheme: ['1 mark per answer', 'Maximum 4 marks'],
          },
          {
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'Write about something you didn\'t appreciate at the time but now understand was important. Use concrete details to show the moment or period. Then show how your understanding has changed. The writing should be about 450-500 words with varied sentences and reflective tone.',
              'Grade 6-7': 'Create a piece that moves between the moment (without awareness of its significance) and present understanding. Use sensory detail and emotional language. Vary sentence structures to show the shift in perspective. Show what made you aware of the loss. Approximately 500 words with confident control.',
              'Grade 8-9': 'Develop a sophisticated piece where the temporal gap between experience and understanding is central to the meaning. Use precise language and careful perspective. Show how consciousness of loss changes the present. Explore what is gained and lost in gaining awareness. Approximately 500-600 words.',
            },
            markScheme: [
