    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The novel is set in the 1930s during the Great Depression, though it was published in 1960 during the Civil Rights Movement. This dual context is important for AO3.',
      },
      {
        id: 'tkam-m1-q2',
        question:
          "Which real-life legal case is widely considered to have inspired Tom Robinson's trial?",
        options: [
        ...
        correct: 1,
        explanation:
          'The Scottsboro Boys case (1931), in which nine Black teenagers were falsely accused and convicted by all-white juries in Alabama, is widely seen as a direct inspiration for the novel.',
      },
      {
        id: 'tkam-m1-q3',
        question:
          'What literary genre does To Kill a Mockingbird draw upon in its depiction of the Radley house and Boo Radley?',
        options: ['Realism', 'Romanticism', 'Southern Gothic', 'Naturalism'],
        correct: 2,
        explanation:
          'The novel draws on the Southern Gothic tradition, which uses grotesque characters, decayed settings and dark themes to explore social tensions in the American South.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The novel is divided into two parts: Part One focuses on childhood innocence and the Boo Radley subplot, while Part Two centres on Tom Robinson's trial and its aftermath.",
      },
      {
        id: 'tkam-m2-q2',
        question:
          "What structural technique does Lee use by beginning and ending the novel with references to Jem's broken arm?",
        options: ['Flashforward', 'Circular structure', 'In medias res', 'Dramatic irony'],
        correct: 1,
        explanation:
          'The novel uses a circular structure, framing the entire narrative within the retrospective account of how Jem broke his arm, which emphasises reflection and deepening understanding.',
      },
      {
        id: 'tkam-m2-q3',
        question:
          'What is the purpose of the dual plotline involving both Boo Radley and Tom Robinson?',
        options: [
        ...
        correct: 1,
        explanation:
          'Both plots involve outsiders misjudged by society. The structural parallel invites readers to see connections between racial prejudice and other forms of social exclusion.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          'Tom Robinson and Boo Radley are both "mockingbirds" - innocent people who do no harm but are destroyed or damaged by the cruelty and prejudice of society.',
      },
      {
        id: 'tkam-m3-q2',
        ...
        correct: 1,
        explanation:
          "This lesson about empathy - seeing the world from another person's perspective - is the novel's moral core and is fulfilled when Scout stands on Boo's porch in the final chapter.",
      },
      {
        id: 'tkam-m3-q3',
        ...
        correct: 1,
        explanation:
          "Jem is old enough to understand the trial intellectually and genuinely believes the evidence will lead to acquittal. The guilty verdict shatters his idealism in a way that is more consciously painful than Scout's experience.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          "Atticus defines courage as moral persistence in the face of certain defeat. This applies to his defence of Tom, Mrs Dubose's fight against addiction, and the novel's broader argument about justice.",
      },
      {
        id: 'tkam-m4-q2',
        question:
          'What does Lee suggest about the relationship between social class and racism in Maycomb?',
        options: [
        ...
        correct: 2,
        explanation:
          "Lee shows that Maycomb's social hierarchy places all Black citizens below all white citizens, regardless of moral worth. Bob Ewell's racism is partly driven by his need to feel superior to someone in a society that despises him.",
      },
      {
        id: 'tkam-m4-q3',
        ...
        correct: 1,
        explanation:
          "The novel contrasts Scout's narrow, inadequate formal schooling with the moral education she receives from Atticus, Calpurnia, and her experiences - arguing that empathy and conscience matter more than academic knowledge.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The dual voice - child experiencing events, adult reflecting on them - creates dramatic irony. The reader grasps the full horror of events that the young Scout describes with innocent confusion.',
      },
      {
        id: 'tkam-m5-q2',
        ...
        correct: 2,
        explanation:
          "The mad dog symbolises the sickness of racism infecting Maycomb. Atticus's shooting of the dog foreshadows his attempt to confront and destroy racial prejudice through Tom Robinson's defence.",
      },
      {
        id: 'tkam-m5-q3',
        ...
        correct: 1,
        explanation:
          "Dialect and vernacular create authenticity and serve as markers of class, race and education within Maycomb's social hierarchy. Calpurnia's code-switching, for example, reveals the social pressures on Black citizens.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Embedding short quotations into your own sentences allows you to analyse specific words and their effects. This demonstrates close textual knowledge and analytical skill.',
      },
      {
        id: 'tkam-m6-q2',
        ...
        correct: 2,
        explanation:
          "Context should be woven into your literary analysis, not presented as a separate history lesson. The strongest responses show how contextual factors shape the writer's choices and the text's meaning.",
      },
      {
        id: 'tkam-m6-q3',
        ...
        correct: 1,
        explanation:
          'Planning ensures your essay has a clear thesis, well-chosen evidence, and a logical structure. Five minutes of planning typically produces a significantly better essay than writing immediately.',
      },
    ],
  },
]
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The novella is set near Soledad, California. The name "Soledad" means "solitude" or "loneliness" in Spanish - a deliberate choice by Steinbeck that reinforces the theme of isolation.',
      },
      {
        id: 'omam-m1-q2',
        ...
        correct: 2,
        explanation:
          'The Great Depression (1929-1939) is the primary context. Mass unemployment forced thousands of men into itinerant labour, creating the rootless, lonely existence that Steinbeck depicts.',
      },
      {
        id: 'omam-m1-q3',
        ...
        correct: 1,
        explanation:
          "Steinbeck exposes the American Dream as an illusion for the working poor. George and Lennie's dream sustains them but is ultimately destroyed, reflecting the impossibility of upward mobility in Depression-era America.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The action takes place over just three days, creating a compressed timeframe that intensifies the sense of inevitability and makes the tragic ending feel inescapable.',
      },
      {
        id: 'omam-m2-q2',
        ...
        correct: 2,
        explanation:
          "Carlson's shooting of Candy's old dog - a \"mercy killing\" - directly foreshadows George's shooting of Lennie at the end. Both acts are presented as acts of compassion in the face of inevitable suffering.",
      },
      {
        id: 'omam-m2-q3',
        ...
        correct: 1,
        explanation:
          'Each chapter is set in a single location with characters entering and exiting like a stage play. This theatrical structure creates confinement and claustrophobia, and was designed for easy stage adaptation.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The surname "Small" is ironic: Lennie is physically huge but mentally childlike. This irony encapsulates the mismatch between his strength and his understanding that drives the novella\'s tragedy.',
      },
      {
        id: 'omam-m3-q2',
        ...
        correct: 2,
        explanation:
          'Her namelessness symbolises how women in 1930s America were defined through their relationships with men. She has no independent identity on the ranch - she is merely "Curley\'s wife."',
      },
      {
        id: 'omam-m3-q3',
        ...
        correct: 1,
        explanation:
          "Slim is the moral compass of the novella. His natural authority, his understanding of George and Lennie's bond, and his final consoling words make him the only source of moral clarity in the story.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          '"Soledad" means "solitude" or "loneliness" in Spanish. Steinbeck\'s choice of this real place name is deliberate - it signals the novella\'s dominant theme from the very first page.',
      },
      {
        id: 'omam-m4-q2',
        ...
        correct: 1,
        explanation:
          'The title comes from Burns\'s poem "To a Mouse": "The best laid schemes o\' mice an\' men / Gang aft agley." This establishes the theme of determinism - plans are subject to forces beyond individual control.',
      },
      {
        id: 'omam-m4-q3',
        question: 'How does Steinbeck present the American Dream in the novella?',
        ...
        correct: 2,
        explanation:
          "The dream sustains George and Lennie emotionally but is systematically undermined by the novella's events. Steinbeck presents it as beautiful but ultimately unattainable for the working poor.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The phonetically spelled dialect creates authenticity and locates the characters in a specific social class. It emphasises their lack of formal education and reinforces the novella's social realist aims.",
      },
      {
        id: 'omam-m5-q2',
        question:
          "What do Lennie's successive killings of the mouse, the puppy, and Curley's wife represent?",
        options: [
        ...
        correct: 1,
        explanation:
          'The escalating pattern (mouse → puppy → woman) symbolises innocence destroyed by uncontrolled power. Each killing foreshadows the next, creating a sense of tragic inevitability.',
      },
      {
        id: 'omam-m5-q3',
        question:
          'What is the effect of each chapter opening with a detailed description of the setting?',
        options: [
        ...
        correct: 1,
        explanation:
          "The opening descriptions juxtapose natural beauty with the bleakness of the characters' lives. Nature is indifferent to human suffering, reinforcing Steinbeck's deterministic vision.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Context should be integrated throughout your essay, connected to specific textual moments. A separate "context paragraph" reads as a history lesson rather than literary analysis.',
      },
      {
        id: 'omam-m6-q2',
        ...
        correct: 1,
        explanation:
          'An effective thesis presents a clear, arguable interpretation that unifies the entire essay. Each paragraph should connect back to this central argument.',
      },
      {
        id: 'omam-m6-q3',
        ...
        correct: 1,
        explanation:
          'Zooming in on individual words - their connotations, sounds, and effects - demonstrates the close analytical skill that examiners reward. A single word can sustain a full paragraph of insightful analysis.',
      },
    ],
  },
]
    ...
    quiz: [
      {
        ...
        options: [
          'The legend of Maui fishing up the North Island',
          'The legend of Paikea riding a whale to Aotearoa',
          'The legend of Tane separating earth and sky',
          'The legend of Hinemoa swimming to Mokoia Island',
        ],
        correct: 1,
        explanation:
          "The Paikea legend - in which an ancestor rode a whale across the ocean to New Zealand - is the founding myth that drives the novel's plot and symbolism.",
      },
      {
        id: 'wr-m1-q2',
        ...
        options: [
          ...
          'Genealogy and ancestral lineage',
          'A method of cooking',
          'A style of carving',
        ],
        correct: 1,
        explanation:
          "Whakapapa refers to genealogy and ancestral lineage. In Maori culture, identity is defined through one's ancestors. Kahu's claim to leadership rests on her whakapapa as a descendant of Paikea.",
      },
      {
        id: 'wr-m1-q3',
        ...
        correct: 2,
        explanation:
          "Ihimaera's work is part of the Maori Renaissance, a cultural revival from the 1970s onwards that sought to reclaim Maori language, art and traditions in the face of ongoing colonisation effects.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        options: [
          "Kahu's diary and newspaper reports",
          "Kahu's contemporary story and the ancient bull whale's mythological perspective",
          'Two parallel timelines set in different countries',
          'First-person and third-person accounts of the same events',
        ],
        correct: 1,
        explanation:
          "The novel alternates between Kahu's present-day story and mythological chapters told from the whale's perspective, bridging past and present to show that ancestral mythology is a living force.",
      },
      {
        id: 'wr-m2-q2',
        question: "What is the novel's climactic event?",
        options: [
          'Koro establishing the cultural school',
          'Kahu learning the taiaha',
          'Kahu riding the bull whale back into the sea',
          "The death of Kahu's mother",
        ],
        correct: 2,
        explanation:
          'Kahu riding the whale is the climax, re-enacting the Paikea legend, saving the whales, and proving her right to leadership - resolving both the family and ecological conflicts.',
      },
      {
        id: 'wr-m2-q3',
        question: "How does Kahu's story parallel the original Paikea legend?",
        options: [
          'Both Paikea and Kahu travel to New Zealand by boat',
          'Both ride a whale, but Kahu transforms the legend by being female',
          'Both are rejected by their communities',
          'Both are warriors who defeat enemies in battle',
        ],
        correct: 1,
        explanation:
          "Kahu re-enacts the founding myth of riding a whale, but as a girl - transforming the tradition rather than simply repeating it. This parallelism with difference is central to the novel's argument.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "Koro's rejection is rooted in his sincere but rigid interpretation of tradition - he believes the chief must be male. This is not simple misogyny but reflects genuine fear that deviating from tradition will destroy the culture.",
      },
      {
        id: 'wr-m3-q2',
        ...
        correct: 2,
        explanation:
          "Nani recognises Kahu's spiritual gifts and quietly nurtures them. She represents a form of cultural wisdom that includes women's knowledge and challenges Koro's narrow interpretation of tradition.",
      },
      {
        id: 'wr-m3-q3',
        ...
        correct: 1,
        explanation:
          'The bull whale is a mythological figure representing the living force of tradition and the deep connection between Maori people and the natural world. His acceptance of Kahu confirms her ancestral destiny.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          'Ihimaera argues that tradition survives by adapting. The essence of the Paikea legend is courage and spiritual connection, not maleness. Culture dies when rigid but thrives when responsive to change.',
      },
      {
        id: 'wr-m4-q2',
        ...
        correct: 1,
        explanation:
          "The whale stranding represents a breakdown in the spiritual connection between the Maori people and the natural world. Kahu's ride restores this connection, demonstrating the novel's ecological message.",
      },
      {
        id: 'wr-m4-q3',
        ...
        correct: 2,
        explanation:
          'The novel challenges the assumption that leadership must be male. Kahu proves that a girl can fulfil the whale rider prophecy through courage and spiritual connection, redefining what leadership means.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The integration of untranslated te reo Maori is a deliberate political and artistic choice. It asserts the vitality and equal status of the Maori language and immerses the reader in a bilingual world.',
      },
      {
        id: 'wr-m5-q2',
        ...
        correct: 1,
        explanation:
          "The whale chapters use an elevated, repetitive, ritualistic register that echoes Maori oral storytelling traditions. This contrasts with Rawiri's warm, conversational contemporary narrative.",
      },
      {
        id: 'wr-m5-q3',
        ...
        correct: 1,
        explanation:
          'The oral storytelling conventions - repetition, rhythm, direct address - connect the written novel to the Maori oral tradition, creating a sense of timelessness and ritual continuity.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The strongest responses explore Koro as a complex character whose resistance to Kahu comes from sincere love of his culture and genuine fear of its loss. This nuance demonstrates sophisticated understanding.',
      },
      {
        id: 'wr-m6-q2',
        ...
        correct: 1,
        explanation:
          'Using Maori terms like whakapapa and kaitiakitanga accurately demonstrates the cultural understanding and contextual engagement that examiners reward for AO3.',
      },
      {
        id: 'wr-m6-q3',
        ...
        correct: 1,
        explanation:
          "The dual narrative is Ihimaera's most important structural choice. Explaining why he alternates between contemporary and mythological perspectives - and what this achieves - demonstrates strong AO2 skills.",
      },
    ],
  },
]
    ...
    quiz: [
      {
        ...
        options: [
          'A university social society',
          'A mahjong club founded by the immigrant mothers as a space for solidarity and storytelling',
          'A Chinese restaurant in San Francisco',
          'A political organisation for Chinese-American rights',
        ],
        correct: 1,
        explanation:
          'The Joy Luck Club is a mahjong club founded by the mothers in San Francisco. It serves as a space for female solidarity, cultural preservation and storytelling - a way of maintaining Chinese identity in America.',
      },
      {
        id: 'jlc-m1-q2',
        ...
        options: [
          ...
          'The Opium Wars',
          'The Communist Revolution of 1949 and surrounding conflicts',
          'The Boxer Rebellion',
        ],
        correct: 2,
        explanation:
          'The mothers fled China during or after the Communist Revolution of 1949, a traumatic displacement that left them separated from families and former lives. This shared trauma shapes the novel.',
      },
      {
        id: 'jlc-m1-q3',
        question:
          "What personal experience most directly influenced Amy Tan's writing of the novel?",
        options: [
          'Her career as a journalist',
          'Her complex relationship with her immigrant mother',
          'Her travels across China',
          'Her study of Chinese literature at university',
        ],
        correct: 1,
        explanation:
          "Tan's relationship with her mother - shaped by cultural differences, language barriers and unspoken trauma - directly influenced the novel. She described writing it as an attempt to understand her mother's experiences.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          'The novel contains 16 interconnected stories divided into four sections, with each of the eight narrators (four mothers and four daughters) telling their own stories.',
      },
      {
        id: 'jlc-m2-q2',
        ...
        correct: 1,
        explanation:
          "Jing-mei narrates her deceased mother's stories as well as her own, bridging the generational divide. Her journey to China at the end provides the novel's emotional resolution.",
      },
      {
        id: 'jlc-m2-q3',
        ...
        correct: 1,
        explanation:
          'The non-linear chronology mirrors the immigrant experience - the past is never fully left behind, memories intrude on the present, and identity is constructed from fragments of two worlds.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "Suyuan dies before the novel begins, so Jing-mei must reconstruct her mother's story. This structural choice reflects the difficulty of recovering immigrant histories and the gap between generations.",
      },
      {
        id: 'jlc-m3-q2',
        ...
        correct: 1,
        explanation:
          "Tan creates deliberate parallels: each daughter unconsciously repeats aspects of her mother's experience, suggesting that unspoken trauma and cultural patterns are transmitted across generations.",
      },
      {
        id: 'jlc-m3-q3',
        ...
        correct: 1,
        explanation:
          'Ying-ying\'s "ghost" status symbolises how unspoken trauma can destroy a person\'s identity and agency. Her passivity is transmitted to her daughter Lena until Ying-ying finally acts to break the cycle.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          'Tan presents cultural identity as a negotiation between Chinese heritage and American identity. It is not fixed but requires active engagement with both cultures.',
      },
      {
        id: 'jlc-m4-q2',
        question:
          'How does the linguistic gap between mothers and daughters function thematically?',
        options: [
        ...
        correct: 1,
        explanation:
          "The mothers' limited English and the daughters' inability to speak Chinese creates a linguistic gap that symbolises the broader failure of communication between generations and cultures.",
      },
      {
        id: 'jlc-m4-q3',
        ...
        correct: 1,
        explanation:
          "Storytelling carries cultural wisdom, personal history and emotional truth across generations. The daughters must learn to listen to their mothers' stories to understand their own identities.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The mothers' Chinese-inflected English and the daughters' standard American English reflect their different cultural positions. This linguistic differentiation enacts the novel's central theme of cultural divide.",
      },
      {
        id: 'jlc-m5-q2',
        ...
        correct: 1,
        explanation:
          "The swan feather represents the mothers' hopes and the fragile cultural heritage they wish to transmit. It is light and easily dismissed, yet carries immense emotional and symbolic weight.",
      },
      {
        id: 'jlc-m5-q3',
        question:
          'What is the effect of the mothers delivering devastating stories in matter-of-fact tones?',
        options: [
        ...
        correct: 1,
        explanation:
          'The matter-of-fact tone reflects both Chinese cultural reserve and the numbing effect of trauma on emotional expression. The restraint makes the revelations even more powerful for the reader.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          'Drawing from multiple stories demonstrates comprehensive knowledge and shows how different mother-daughter pairs illuminate the same themes from different perspectives - a key strength in a multi-narrator novel.',
      },
      {
        id: 'jlc-m6-q2',
        question:
          "What is particularly effective about analysing Tan's rendering of Chinese idioms in English?",
        options: [
        ...
        correct: 1,
        explanation:
          'Analysing how Tan renders Chinese idioms in English demonstrates sophisticated understanding of how language choices reflect cultural gaps. It is an excellent AO2 point that also connects to AO3.',
      },
      {
        id: 'jlc-m6-q3',
        ...
        correct: 1,
        explanation:
          "The polyphonic structure means the reader hears both mothers' and daughters' perspectives, understanding what the characters themselves cannot communicate. This structural irony is a powerful AO2 point.",
      },
    ],
  },
]
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "Achebe was motivated by a desire to correct European misrepresentations of Africa - particularly the racist depictions in novels like Conrad's Heart of Darkness - and to assert the complexity of pre-colonial African culture.",
      },
      {
        id: 'tfa-m1-q2',
        ...
        options: [
          ...
          'Two years before independence in 1960',
          'During World War II',
          'In the 1970s',
        ],
        correct: 1,
        explanation:
          'Published in 1958, two years before Nigerian independence in 1960, the novel served as both a historical account and a political intervention in the decolonisation process.',
      },
      {
        id: 'tfa-m1-q3',
        ...
        correct: 2,
        explanation:
          'Achebe presents Igbo society as complex and sophisticated while also depicting its flaws. This balanced portrayal is more powerful than idealisation because it treats African culture with the same nuance given to any human society.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The three-part structure mirrors colonisation: Part One immerses the reader in pre-colonial Igbo culture, Part Two introduces the missionaries, and Part Three shows the destruction of traditional society.',
      },
      {
        id: 'tfa-m2-q2',
        ...
        correct: 1,
        explanation:
          "The final paragraph shifts to the Commissioner's perspective, showing how he plans to reduce Okonkwo's life to a paragraph in his colonial account. This enacts the erasure that Achebe wrote the novel to resist.",
      },
      {
        id: 'tfa-m2-q3',
        ...
        correct: 1,
        explanation:
          "Okonkwo participates in Ikemefuna's killing despite being advised not to, because he fears appearing weak. This reveals his hamartia - the rigid masculinity that drives his downfall.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "Okonkwo's hamartia is his deep-seated fear of being seen as weak like his father. This drives his relentless aggression and rigidity, making him unable to adapt when his world changes.",
      },
      {
        id: 'tfa-m3-q2',
        ...
        correct: 1,
        explanation:
          "Nwoye's conversion represents liberation from his father's demanding masculinity but also cultural loss. Christianity attracts those marginalised by traditional society, showing how colonialism exploits internal divisions.",
      },
      {
        id: 'tfa-m3-q3',
        ...
        correct: 1,
        explanation:
          "Obierika is Okonkwo's reflective, questioning friend who serves as a foil. Unlike Okonkwo, he can engage critically with his own culture, representing a more adaptive form of cultural engagement.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Achebe shows colonialism as a gradual process that exploits internal vulnerabilities - attracting converts among the marginalised, replacing institutions slowly, and eroding cultural confidence before imposing direct control.',
      },
      {
        id: 'tfa-m4-q2',
        question:
          'What does the proverb "proverbs are the palm-oil with which words are eaten" demonstrate?',
        options: [
        ...
        correct: 1,
        explanation:
          'This proverb demonstrates the sophistication of Igbo oral culture and the central role of language in social communication. Proverbs carry communal wisdom and are essential to respected speech.',
      },
      {
        id: 'tfa-m4-q3',
        ...
        correct: 2,
        explanation:
          "Okonkwo's rigid masculinity prevents him from adapting to change, showing tenderness, or accepting compromise. The very qualities that made him successful in the old order make him incapable of surviving the new one.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Leaving Igbo words untranslated is a deliberate choice that requires the reader to engage with Igbo culture on its own terms. It refuses to subordinate Igbo concepts to Western frameworks of understanding.',
      },
      {
        id: 'tfa-m5-q2',
        ...
        correct: 1,
        explanation:
          'The locusts are initially welcomed as food but arrive in overwhelming numbers. They foreshadow the colonisers, who are similarly welcomed at first but prove ultimately destructive to Igbo society.',
      },
      {
        id: 'tfa-m5-q3',
        ...
        correct: 2,
        explanation:
          'The decline of proverbial language from Part One to Part Three structurally mirrors the erosion of Igbo culture under colonialism. As the culture weakens, its linguistic richness fades.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The title "The Pacification of the Primitive Tribes of the Lower Niger" uses euphemism ("pacification") and dismissal ("primitive") to expose how colonial language rewrites history and erases cultural complexity.',
      },
      {
        id: 'tfa-m6-q2',
        ...
        correct: 1,
        explanation:
          'The three-part structure mirrors colonisation itself: Part One establishes what is at stake, Part Two shows the beginning of cultural erosion, and Part Three depicts destruction. Form mirrors content.',
      },
      {
        id: 'tfa-m6-q3',
        ...
        correct: 2,
        explanation:
          'Achebe is more nuanced than a simple binary. He depicts flaws within Igbo society alongside its strengths, and distinguishes between different colonial approaches. The best essays engage with this complexity.',
      },
    ],
  },
]
    ...
    quiz: [
      {
        ...
        options: [
          'A human child with special abilities',
          'An Artificial Friend - a solar-powered robot companion',
          "A teacher at Josie's school",
          'A scientist working on genetic engineering',
        ],
        correct: 1,
        explanation:
          'Klara is an Artificial Friend (AF), a solar-powered robot designed to be a companion for children. Her non-human perspective allows Ishiguro to explore questions about consciousness, love and humanity.',
      },
      {
        id: 'klara-m1-q2',
        ...
        options: [
          ...
          "Genetic enhancement that improves children's abilities but carries health risks",
          'A type of solar energy that powers AFs',
          'Moving to a wealthier neighbourhood',
        ],
        correct: 1,
        explanation:
          '"Lifting" refers to genetic enhancement of children - a process that improves cognitive abilities but carries serious health risks. It creates a social divide between "lifted" and "unlifted" children.',
      },
      {
        id: 'klara-m1-q3',
        ...
        correct: 2,
        explanation:
          'Never Let Me Go (2005), about human clones, shares thematic territory - both novels examine what it means to be human through beings who are not fully accepted as such.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The Capaldi plan - to have Klara inhabit a replica of Josie - raises the novel's central philosophical question: can a person be replicated? Does human identity reside in behaviour, or is there something irreplaceable?",
      },
      {
        id: 'klara-m2-q2',
        ...
        correct: 1,
        explanation:
          "Klara's story traces a declining arc - from the hopeful store window to the salvage yard. This inverted structure challenges traditional expectations and deepens the emotional impact.",
      },
      {
        id: 'klara-m2-q3',
        ...
        correct: 1,
        explanation:
          "Klara's understanding is shaped by her programming and her limited experience of the world. She may attribute magical properties to the Sun and misinterpret human behaviour, creating productive ambiguity.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Capaldi believes there is "nothing inside Josie that can\'t be continued" - a materialist view that human identity is reducible to behaviour and therefore replicable. The novel implicitly questions this position.',
      },
      {
        id: 'klara-m3-q2',
        ...
        correct: 1,
        explanation:
          "Rick's unlifted status limits his prospects despite his intelligence, exposing how genetic enhancement deepens social inequality rather than creating a meritocracy.",
      },
      {
        id: 'klara-m3-q3',
        ...
        correct: 1,
        explanation:
          'Ishiguro deliberately leaves ambiguous whether Klara\'s love is "real" emotion or a product of her programming. This unresolved question is central to the novel\'s exploration of consciousness and love.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The central question is whether there is an irreplaceable human essence - a "soul" or "heart" - that cannot be replicated, no matter how sophisticated the AI. Ishiguro leaves this question deliberately unresolved.',
      },
      {
        id: 'klara-m4-q2',
        question:
          'How does the novel present the division between "lifted" and "unlifted" children?',
        options: [
        ...
        correct: 1,
        explanation:
          'The lifted/unlifted divide creates a two-tier society where access to enhancement determines life chances. This reflects real concerns about technology deepening existing social inequalities.',
      },
      {
        id: 'klara-m4-q3',
        ...
        correct: 1,
        explanation:
          "Klara's acceptance is moving because it looks like grace, but unsettling because it might simply reflect her programming - she may be incapable of recognising the injustice of her disposability.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "Klara's AI perspective defamiliarises the human world, forcing the reader to see familiar emotions, relationships and social structures from a new angle. This is one of Ishiguro's most powerful stylistic techniques.",
      },
      {
        id: 'klara-m5-q2',
        ...
        correct: 1,
        explanation:
          "The visual fragmentation represents Klara's artificial perception - her processing breaks down under strain. It also mirrors the social fragmentation of the novel's divided world.",
      },
      {
        id: 'klara-m5-q3',
        ...
        correct: 1,
        explanation:
          "Ishiguro's restraint forces the reader to do emotional work - inferring feelings from what is not said. This indirection makes the novel's emotional moments more powerful because they are earned rather than stated.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          'The strongest approach is to sustain the ambiguity Ishiguro creates. Explore how Klara\'s behaviour looks indistinguishable from love without resolving whether it is "real" - this mirrors the novel\'s philosophical complexity.',
      },
      {
        id: 'klara-m6-q2',
        ...
        correct: 1,
        explanation:
          "Klara's distinctive narrative register - formal, literal, devoid of metaphor - is a key craft choice that defamiliarises the human world and creates the ambiguity that drives the novel's philosophical inquiry.",
      },
      {
        id: 'klara-m6-q3',
        ...
        correct: 1,
        explanation:
          "Context should be connected to specific textual moments. Contemporary debates about AI consciousness, genetic engineering and technological inequality are all relevant when linked to the novel's characters, themes and craft choices.",
      },
    ],
  },
]
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The novel is about Gopi, an eleven-year-old girl processing her mother's death through squash. The sport becomes a language for emotions that words cannot express.",
      },
      {
        id: 'wl-m1-q2',
        ...
        correct: 2,
        explanation:
          'Western Lane is a minimalist novel - spare, economical prose that relies on implication and understatement. Its power lies in what is not said as much as in what is.',
      },
      {
        id: 'wl-m1-q3',
        ...
        correct: 1,
        explanation:
          "Squash mirrors Gopi's interior state: contained, rhythmic, sometimes violent, and a way of being fully present in the body when overwhelmed by loss. The sport's qualities inform both the novel's subject and its style.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The novel is driven by Gopi's internal journey through grief rather than external plot events. The squash tournament provides a framework, but the real narrative is emotional.",
      },
      {
        id: 'wl-m2-q2',
        ...
        correct: 1,
        explanation:
          'Present tense narration creates immediacy - Gopi is living through grief in real time, without the comfort of distance or understanding. This mirrors the raw, unprocessed quality of her emotional experience.',
      },
      {
        id: 'wl-m2-q3',
        ...
        correct: 1,
        explanation:
          'Maroo builds meaning through the accumulation of small details rather than dramatic events. Each small moment - a squash stroke, a shared meal - carries weight because the reader is trained to pay attention to surfaces.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          'Gopi processes grief through her body - the discipline, exhaustion and focus of squash training become her language for emotions that she cannot articulate verbally.',
      },
      {
        id: 'wl-m3-q2',
        ...
        correct: 1,
        explanation:
          'Pa expresses love through action rather than words - coaching Gopi, taking her to courts, maintaining routine. This is not coldness but a culturally specific form of care that the novel respects.',
      },
      {
        id: 'wl-m3-q3',
        ...
        correct: 2,
        explanation:
          'In a minimalist novel where characters express themselves through action and silence rather than speech, the best analytical approach focuses on behaviour, gesture and physical presence.',
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Maroo presents grief as a persistent, physical reality rather than a dramatic event. It alters routines, changes the quality of silence, and is experienced through the body rather than through conscious emotional processing.',
      },
      {
        id: 'wl-m4-q2',
        ...
        correct: 2,
        explanation:
          "The novel treats the family's silence with respect, presenting it as a culturally specific mode of togetherness - not dysfunction but a valid way of processing loss through proximity, routine and shared space.",
      },
      {
        id: 'wl-m4-q3',
        ...
        correct: 1,
        explanation:
          "Squash's repetitive discipline mirrors grief: the same loss revisited daily, the same routines enacted. Through repetition, something gradually shifts - not resolution, but adjustment. Healing is accumulation, not breakthrough.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Because Gopi cannot articulate grief in abstract terms, the physical world becomes the medium through which her inner life is communicated. Sensory language is emotional language in this novel.',
      },
      {
        id: 'wl-m5-q2',
        ...
        correct: 1,
        explanation:
          "Silence and omission are deliberate stylistic choices. The gaps and pauses - conversations cut short, emotions withheld - are where the novel's deepest meanings reside. Maroo trusts the reader to fill in the emotional content.",
      },
      {
        id: 'wl-m5-q3',
        ...
        correct: 1,
        explanation:
          "First-person present tense creates radical immediacy - the reader lives through events alongside Gopi, without the mediation of hindsight. This mirrors a child's moment-by-moment experience of the world.",
      },
    ],
  },
  {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The minimalist style means students must find significance in small, quiet moments rather than dramatic speeches. The ability to analyse apparently simple details is what distinguishes excellent responses.',
      },
      {
        id: 'wl-m6-q2',
        ...
        correct: 1,
        explanation:
          'In this novel, form and content are inseparable. The minimalist style is itself a form of grief - spare, restrained, saying less than it feels. Discussing this connection demonstrates sophisticated AO2 understanding.',
      },
      {
        id: 'wl-m6-q3',
        ...
        correct: 1,
        explanation:
          "Avoid framing the family's silence as dysfunction. The novel treats their mode of grieving - through proximity, routine, action and presence - with respect, presenting it as a culturally specific and valid form of processing loss.",
      },
    ],
  },
]
