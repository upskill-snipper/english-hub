    ...
    sections: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 4,
            guidanceNotes:
              'Scan the text for references to place, geography, landscape features. Extract factual details without copying word-for-word. Consider climate, terrain, structures, and surroundings.',
          },
          {
            question:
              "Identify four key details about the character's background from the passage.",
            marks: 4,
            guidanceNotes:
              "Look for biographical information: where they're from, their history, family, experiences. Paraphrase rather than quote. Each detail should be separate and relevant.",
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Analyse the language used in lines 15-25. Focus on how the writer creates mood.',
            marks: 8,
            guidanceNotes:
              'Identify 3-4 language techniques. For each, quote, name the technique, explain how it works, then explain its effect on the reader. Link to atmosphere and emotion. Aim for depth over quantity.',
          },
          {
            question: "How does the writer's language in the final paragraph create impact?",
            marks: 8,
            guidanceNotes:
              'Look for techniques like short sentences, repetition, word choice, imagery. Explain why these choices matter. Consider punch, emphasis, clarity, emotional response.',
          },
        ],
        mnemonics: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 8,
            guidanceNotes:
              "Look at: paragraph length, sentence length, pacing, use of short/long sentences, positioning of key information. Explain how arrangement affects the reader's response.",
          },
          {
            question:
              'Analyse the tone and form of this extract. How do they combine to engage the reader?',
            marks: 8,
            guidanceNotes:
              'Identify the tone (attitude, style), the form (text type), and how they work together. Consider whether formal/informal, serious/playful, personal/detached. Link to audience and purpose.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'How successfully does the writer convey their perspective on childhood memories?',
            marks: 20,
            guidanceNotes:
              'Make a clear judgement. Use evidence to show how effectively techniques work. Consider: is the writing persuasive? Are the examples powerful? Does the emotional impact work? Support every point with quotation and analysis.',
          },
          {
            question: 'To what extent do you find this account of the journey convincing?',
            marks: 20,
            guidanceNotes:
              "Evaluate both the writer's ideas and their methods. Consider: credibility, detail, language choice, structure. Include what works well and what might be less convincing. Develop explanation fully with evidence.",
          },
        ],
        mnemonics: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Complete a full Paper 1 mock in 1 hour 45 minutes. How effectively did you manage time?',
            marks: 0,
            guidanceNotes:
              'Time yourself strictly. Note which questions you spent the most time on. Did you finish Q4? Could you have managed time better? Aim to leave 5 minutes for proofreading.',
          },
          {
            question:
              'Which question type do you find most time-consuming? How can you streamline your approach?',
            marks: 0,
            guidanceNotes:
              'If Q2 (language analysis) takes too long, practice being more concise. If Q4 (evaluation) feels rushed, prepare ideas before writing. Identify your weakness and target it.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 64,
            guidanceNotes:
              'This is your best preparation. Complete the full paper in one sitting. Mark strictly against the official marking guide. Identify patterns in your strengths and weaknesses.',
          },
          {
            question:
              'Compare your analysis approach on two different texts. Which techniques are most common?',
            marks: 0,
            guidanceNotes:
              'Build awareness of patterns across different texts. Notice which techniques appear repeatedly and which are rare. This helps you spot them faster in the exam.',
          },
        ],
        commonMistakes: [
    ...
    sections: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 8,
            guidanceNotes:
              'Identify 3-4 similarities and 3-4 differences. Write about 200 words. Use own words throughout. Structure clearly. Link to the specific viewpoints in each text.',
          },
          {
            question:
              'Summarize the similar and different attitudes toward technology shown in both extracts.',
            marks: 8,
            guidanceNotes:
              'Find explicit and implicit viewpoints. Explain what each writer believes and where they agree/disagree. Keep it concise and organized.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 12,
            guidanceNotes:
              'Identify persuasive techniques: rhetorical questions, emotive language, facts, examples, direct address, superlatives. Explain how each persuades. Address audience and purpose.',
          },
          {
            question: 'Analyse the language used to create atmosphere in the opening paragraph.',
            marks: 12,
            guidanceNotes:
              'Look at: descriptive language, imagery, sound devices, word choice. Explain how each creates mood. Consider the effect on the reader.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 12,
            guidanceNotes:
              "Look at: openings, paragraph length, pacing, use of short/long sentences, climactic moments. Explain how each writer's choices work. Show similarities and differences in approach.",
          },
          {
            question:
              "Compare the tone of Writer A and Writer B. How does tone affect each text's impact?",
            marks: 12,
            guidanceNotes:
              "Identify each writer's tone (attitude, voice). Show where they're similar and different. Explain how tone shapes the reader's response to ideas.",
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 24,
            guidanceNotes:
              'Plan 3-4 main arguments. Use rhetorical devices. Address counterarguments. Write clearly and persuasively. Aim for 400+ words. Check all spelling and punctuation.',
          },
          {
            question: 'Write to explain how technology is changing the way we learn.',
            marks: 24,
            guidanceNotes:
              'Organize into clear sections. Provide examples and evidence. Use clear, accessible language. Link ideas with connectives. Maintain consistent register.',
          },
        ],
        mnemonics: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 40,
            guidanceNotes:
              'Create a clear beginning, middle, and end. Develop character and emotion. Use vivid detail. Vary sentence structure. Aim for 500+ words. Proofread carefully.',
          },
          {
            question:
              'Describe a place that is important to you, bringing it to life for the reader.',
            marks: 40,
            guidanceNotes:
              'Use sensory detail: what do readers see, hear, smell, feel? Organize spatially or thematically. Vary sentence length. Include specific, concrete details. Maintain engaging tone throughout.',
          },
        ],
        mnemonics: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Complete a full Paper 2 mock in 1 hour 45 minutes. Check your time allocation.',
            marks: 0,
            guidanceNotes:
              'Track time spent on each question. Did you allocate roughly 35+ minutes to Q5? Could you improve time management? Aim to finish with 5 minutes to spare.',
          },
          {
            question:
              'Which writing question (Q4 or Q5) do you find more challenging for time? Why?',
            marks: 0,
            guidanceNotes:
              'If Q5 is rushed, practice speed writing. If Q4 is rushed, work on concise planning. Identify your weakness and practice it separately.',
          },
        ],
        commonMistakes: [
    ...
    sections: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 15,
            guidanceNotes:
              'Discuss: how they influence each other, how their relationship changes, key moments that show development. Use 3-4 quotations. Link to themes of ambition and power.',
          },
          {
            question: "To what extent is Othello a victim of Iago's manipulation?",
            marks: 15,
            guidanceNotes:
              "Analyse Othello's agency vs. Iago's influence. Use quotations to show Iago's methods and Othello's weaknesses. Consider context: race, prejudice, military hierarchy.",
          },
        ],
        mnemonics: ['CREED = Character, Relationship, Events, Effect, Development'],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              "How does the author use Pip's development to explore social class and ambition?",
            marks: 15,
            guidanceNotes:
              'Analyse key moments: his ambitions, encounters with different classes, final understanding. Use 3-4 quotations. Link to Victorian attitudes about class and social mobility.',
          },
          {
            question:
              "To what extent is Jane Eyre a critique of Victorian society's treatment of women?",
            marks: 15,
            guidanceNotes:
              "Discuss Jane's agency, independence, limitations. Consider marriage, work, morality. Use quotations showing her resistance or acceptance. Link to historical context.",
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 15,
            guidanceNotes:
              'Analyse the causes, consequences, and moral dimensions of ambition in each text. Use 2-3 quotations from each. Discuss: How does genre (drama vs. novel) shape presentation?',
          },
          {
            question:
              'Compare how the two texts present the struggle between social expectation and personal desire.',
            marks: 15,
            guidanceNotes:
              'Identify specific characters facing this conflict. Analyse their responses. Link to historical context (Elizabethan theatre vs. Victorian society). Show similarities and differences.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 10,
            guidanceNotes:
              'Look at: imagery (blood, darkness), syntax (fragmented speech), repetition, tone. Choose 2-3 quotations. Explain how language shows confusion, ambition, guilt.',
          },
          {
            question:
              'How does the author use description to establish setting and mood in Chapter 5?',
            marks: 10,
            guidanceNotes:
              "Identify descriptive techniques: imagery, word choice, sensory detail. Explain effect. Link to character's perspective or emotional state if told from their viewpoint.",
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              "How does Shakespeare structure Macbeth to show the protagonist's fall from power?",
            marks: 10,
            guidanceNotes:
              'Analyse key scenes showing: ambition (Act 1), moral corruption (Act 3), paranoia (Act 4), defeat (Act 5). Discuss pacing and dramatic tension. Link structure to tragedy.',
          },
          {
            question:
              "How does the narrative structure of the novel affect your understanding of Pip's development?",
            marks: 10,
            guidanceNotes:
              "Consider: first-person retrospective narration, flashbacks, Pip's changing perspective. How does this narrative choice reveal his growth? What would change with third-person narration?",
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'To what extent do you agree that Macbeth is a tragedy about the corrupting nature of ambition?',
            marks: 30,
            guidanceNotes:
              'Make a clear argument. Support with 4-5 quotations from the play. Analyse: character development, language, structure, context. Address alternative interpretations. Write 400+ words.',
          },
          {
            question:
              'Analyse how the author presents the theme of class in the novel. What does the text suggest about social mobility?',
            marks: 30,
            guidanceNotes:
              'Discuss 3-4 characters or situations revealing class attitudes. Use quotations. Link to Victorian context. Consider narrative perspective. Develop your interpretation with evidence.',
          },
        ],
        commonMistakes: [
    ...
    sections: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 15,
            guidanceNotes:
              'Analyse how characters develop or struggle with identity. Use 3-4 quotations. Consider: family influence, social pressure, self-discovery. Link to contemporary context.',
          },
          {
            question: 'To what extent is this a critique of modern family life?',
            marks: 15,
            guidanceNotes:
              "Discuss characters' family relationships, conflicts, and dynamics. Use evidence. Consider: what does the text suggest about families? How does this reflect contemporary society?",
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          ...
          {
            question:
              'Compare how two poems explore love. Discuss form, language, and their effects.',
            marks: 15,
            guidanceNotes:
              'Choose two poems with contrasting or similar approaches. Analyse form (structure, rhythm), language (devices, word choice), tone. Show similarities and differences.',
          },
        ],
        mnemonics: ['SMILE = Stanza, Metre, Imagery, Language, Effect'],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          ...
          {
            question:
              "What is the poem about? How does the poet's use of language convey the main idea?",
            marks: 15,
            guidanceNotes:
              'First: understand what the poem literally says. Second: identify how language reveals deeper meaning. Use 2-3 quotations. Explain the relationship between form and meaning.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 15,
            guidanceNotes:
              'Identify specific characters/speakers dealing with identity. Analyse how prose and poetry explore this differently. Use 2-3 quotations from each. Discuss: what does each form reveal?',
          },
          {
            question:
              'Compare the treatment of relationship/love in the modern text and in poetry.',
            marks: 15,
            guidanceNotes:
              'Analyse how characters/speakers experience and express relationships. Compare language, form, and tone. Show similarities and differences in perspective.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 30,
            guidanceNotes:
              'Make a clear argument. Use 4-5 quotations. Analyse: character choices, relationships, conflicts, development. Link to contemporary context. Address alternative readings. Write 400+ words.',
          },
          {
            question:
              'How does the author present family relationships? What does the text suggest about family in modern society?',
            marks: 30,
            guidanceNotes:
              'Discuss 3-4 family relationships or situations. Use evidence. Link to characterization, setting, theme. Consider: what values or critiques are present? Write 400+ words.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Compare how two poems explore loss. Discuss form, language, and their combined effect.',
            marks: 30,
            guidanceNotes:
              'Choose two contrasting or similar approaches. Analyse: speaker, perspective, structure (form, rhythm, rhyme), language (devices, word choice), tone. Link form to emotional impact. Write 400+ words.',
          },
          {
            question:
    ...
    sections: [
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            ...
            marks: 8,
            guidanceNotes:
              'Purpose: what is the writer trying to achieve? Audience: who are they writing for? Form: what type of text? Give specific evidence for each.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Write an informative article for a school magazine about volunteering opportunities.',
            marks: 20,
            guidanceNotes:
              'Organize into clear sections. Use subheadings if appropriate. Include specific examples. Aim for 250+ words. Write for a school audience. Check for errors.',
          },
          {
            question:
              'Write to inform a general audience about the history and benefits of renewable energy.',
            marks: 20,
            guidanceNotes:
              'Structure logically: background, development, current situation. Be informative and accessible. Avoid jargon or explain technical terms. 250+ words.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Identify and explain four language techniques the author uses to create mood.',
            marks: 8,
            guidanceNotes:
              'Quote short phrases. Name technique. Explain effect. Link to overall mood or atmosphere. Aim for 2-3 sentences per technique.',
          },
          {
            question: 'To what extent do you find the argument in this text convincing? (8 marks)',
            marks: 8,
            guidanceNotes:
              'Make a judgment. Use evidence to support your view. Consider: strength of arguments, use of evidence, rhetorical devices, credibility.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 20,
            guidanceNotes:
              'Structure logically: introduction, development, conclusion. Use connectives. Be clear and informative. Aim for 250+ words. Address audience appropriately.',
          },
          {
            question: 'Write a narrative about a significant moment that changed your perspective.',
            marks: 20,
            guidanceNotes:
              'Create a clear beginning, middle, end. Use detail and sensory language. Vary pace. Develop emotion or significance. Aim for 250+ words.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 30,
            guidanceNotes:
              'Choose a character with clear development. Use 4-5 quotations showing change. Explain how their journey relates to central theme. Link to language and structure.',
          },
          {
            question: 'Compare how your studied text and the unseen poem explore loss.',
            marks: 30,
            guidanceNotes:
              'Analyse characters/speakers dealing with loss. Discuss techniques. Compare form and effect. Use evidence from both texts. 400+ words.',
          },
        ],
        commonMistakes: [
          'Plot summary instead of analysis',
        ...
        practiceQuestions: [
          {
            ...
            marks: 30,
            guidanceNotes:
              'Identify characters/speakers experiencing power/powerlessness. Analyse methods (language, form, structure). Show similarities and differences. Use 4-6 quotations total.',
          },
          {
            question:
              'Both texts engage with social change. Compare their approaches and effectiveness.',
            marks: 30,
            guidanceNotes:
              'Discuss: What social changes do they address? How do form and genre shape their exploration? Analyse language. Compare perspectives and impact.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Complete a full past paper under timed conditions. Review your time allocation.',
            marks: 0,
            guidanceNotes:
              'Did you balance sections evenly? Did Section A analysis feel rushed? Could you improve time management? Aim to finish with 5 minutes to spare.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'How has studying literature informed your understanding of language techniques?',
            marks: 0,
            guidanceNotes:
              'Reflect on how close reading of poetry and prose has developed your analytical vocabulary. Notice which techniques appear across different texts.',
          },
        ],
        commonMistakes: [
    ...
    sections: [
      {
        ...
        practiceQuestions: [
          {
            question:
              'Write a persuasive letter to your local councillor about a community issue (40 marks)',
            marks: 40,
            guidanceNotes:
              'Identify: purpose (persuade), audience (councillor), form (letter). Use appropriate tone: formal and respectful. Structure arguments logically. Use persuasive techniques. Aim for 400+ words.',
          },
          {
            question: 'Record a conversation with a peer about a topic of interest (40 marks)',
            marks: 40,
            guidanceNotes:
              'Prepare brief notes about your topic. Speak spontaneously (not scripted). Engage with your partner: ask questions, respond, build on ideas. Show active listening.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Analyse how the writer uses language to persuade the reader to support a cause.',
            marks: 40,
            guidanceNotes:
              'Identify 4-5 persuasive techniques. Quote and explain effect. Link to overall persuasive purpose. Consider: word choice, tone, structure, examples.',
          },
          {
            question:
              "Write an informative article for a newspaper about an issue you've researched.",
            marks: 40,
            guidanceNotes:
              'Research your topic. Structure clearly: headline, introduction, development, conclusion. Use specific examples and evidence. Aim for 400+ words. Check accuracy and spelling.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 30,
            guidanceNotes:
              'Choose texts across different genres. Analyse: characterization, language, structure. Use 4-6 quotations. Show similarities and differences in approach. Link to context.',
          },
          {
            question: 'Analyse how the dramatic structure of the play enhances its tragic effect.',
            marks: 30,
            guidanceNotes:
              'Consider: acts/scenes, turning points, climax, resolution. Analyse specific scenes. Use quotations. Explain dramatic impact. Link structure to theme.',
          },
        ],
        commonMistakes: [
          'Plot summary instead of analysis',
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Analyse the conversation transcript. What does it reveal about the relationship between speakers?',
            marks: 40,
            guidanceNotes:
              'Examine: register (formal/informal), turn-taking, address terms, tone. How do language choices show the relationship? What is the purpose of the interaction?',
          },
          {
            question:
              'Compare two transcripts. What are the differences in register, formality, and tone? Why?',
            marks: 40,
            guidanceNotes:
              "Identify specific linguistic features in each. Explain: who are the speakers? What's the context? Why do these differences appear?",
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Write an analytical essay on a text of your choice, demonstrating accurate use of terminology and sophisticated writing.',
            marks: 0,
            guidanceNotes:
              'Structure: introduction, 3-4 body paragraphs, conclusion. Use subject terminology correctly. Integrate quotations smoothly. Vary sentence structures. Proofread carefully.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Complete a Component 2 mock exam in 2 hours 30 minutes. Evaluate your time management.',
            marks: 0,
            guidanceNotes:
              'Did you have enough time for all questions? Which section was most rushed? Could you improve planning or writing speed? Aim to finish with 5-10 minutes to spare.',
          },
        ],
        commonMistakes: [
    ...
    sections: [
      {
        ...
        practiceQuestions: [
          {
            question:
              'Identify and explain four language techniques used in this extract to create atmosphere.',
            marks: 15,
            guidanceNotes:
              'Name technique, quote, explain effect. Consider: word choice, imagery, sentence structure, sound devices. Link to overall atmosphere.',
          },
          {
            question:
              'Which writer is more effective in persuading their audience? Evaluate both texts.',
            marks: 20,
            guidanceNotes:
              'Make a clear judgment. Use evidence from both texts. Consider: argument strength, evidence quality, rhetorical devices, language effectiveness.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 20,
            guidanceNotes:
              'Purpose: inform. Audience: students. Organize logically. Include specific examples. Use accessible language. 200+ words.',
          },
          {
            question:
              'Write a persuasive article arguing for change at your school or in your community.',
            marks: 20,
            guidanceNotes:
              'Build an argument. Use persuasive techniques: rhetorical questions, emotive language, examples. Address counterarguments. 200+ words.',
          },
          {
            question: 'Write a narrative or description about a significant moment in your life.',
            marks: 40,
            guidanceNotes:
              'For narrative: clear beginning, middle, end. For description: vivid imagery, sensory detail. Develop emotion or significance. 350+ words.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 20,
            guidanceNotes:
              "Identify 3-4 language choices that reveal the author's perspective. Quote and explain effect. Link to overall argument or viewpoint.",
          },
          {
            question: 'To what extent is this text an effective piece of persuasive writing?',
            marks: 20,
            guidanceNotes:
              'Make a judgment. Use evidence: argument strength, language effectiveness, rhetorical devices, credibility. Address strengths and weaknesses.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 40,
            guidanceNotes:
              'Choose a significant relationship. Analyse: dialogue, action, stage directions. Use 4-5 quotations. Link to character development and theme.',
          },
          {
            question: 'How does the author use setting to develop theme in the novel?',
            marks: 40,
            guidanceNotes:
              'Identify 3-4 significant settings. Analyse: description, symbolism, character response. Use evidence. Link setting to theme and character.',
          },
          {
            question: 'Analyse how the poet uses form and language to express emotion.',
            marks: 40,
            guidanceNotes:
              'Look at: stanza form, line length, rhyme, meter, word choice, imagery. Explain how form and language work together. Use quotations.',
          },
        ],
        commonMistakes: [
          'Plot summary rather than analysis',
        ...
        practiceQuestions: [
          {
            ...
            marks: 0,
            guidanceNotes:
              'Choose a topic with substance. Prepare brief notes. Speak naturally (not scripted). Engage audience with eye contact and tone variation. Practice beforehand.',
          },
        ],
        commonMistakes: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 0,
            guidanceNotes:
              'Did you spend enough time reading? Which questions felt rushed? Could you improve pacing? Aim to finish with 5 minutes to spare.',
          },
        ],
        commonMistakes: [
    ...
    sections: [
        ...
        practiceQuestions: [
          {
            ...
            marks: 5,
            guidanceNotes:
              'Find explicit and implicit information. Quote to show evidence. Paraphrase to demonstrate understanding. Draw inferences from details.',
          },
          {
            question: 'Analyse how the writer creates tension in this section. (10 marks)',
            marks: 10,
            guidanceNotes:
              'Identify 3-4 language techniques or structural features. Quote briefly. Explain effect. Link to building tension. Write 6-8 sentences.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Write a letter to the principal of your school persuading them to extend lunch breaks.',
            marks: 25,
            guidanceNotes:
              'Purpose: persuade. Audience: principal (formal). Form: letter (with appropriate greeting/closing). Use persuasive techniques. Aim for 250+ words.',
          },
          {
            question:
              'Write an article for a school magazine informing students about a cultural event.',
            marks: 25,
            guidanceNotes:
              'Purpose: inform. Audience: school community (less formal). Form: article (headline, byline). Organize logically. Include key details. 250+ words.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              "Summarize the key similarities and differences between the two writers' views on education.",
            marks: 15,
            guidanceNotes:
              'Identify 3-4 main points from each text. Write 200 words. Paraphrase thoroughly. Use own words. Structure clearly.',
          },
          {
            question: 'What are the main similarities in how both texts present technology?',
            marks: 15,
            guidanceNotes:
              'Find explicit and implicit attitudes. Paraphrase. Explain with reference to textual detail. Aim for full, well-developed sentences.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              "Analyse how the central character develops throughout the novel. What does their journey reveal about the novel's themes?",
            marks: 35,
            guidanceNotes:
              'Identify key moments showing development. Use 4-5 quotations. Explain link to themes. Structure: introduction, 3-4 body paragraphs, conclusion. 400+ words.',
          },
          {
            question:
              'Compare how two writers present power and powerlessness. Which do you find more effective and why?',
            marks: 35,
            guidanceNotes:
              'Analyse both texts. Use comparative language. Justify your judgment. Link to language, structure, characterization. Integrate quotations. 400+ words.',
          },
        ],
        commonMistakes: [
          'Plot summary instead of analysis',
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'Prepare a presentation on a character from your studied texts. Be ready to discuss their development and significance.',
            marks: 30,
            guidanceNotes:
              "Prepare notes on: who the character is, key moments in their development, why they're significant to the text. Practice speaking for 5-7 minutes. Be ready for follow-up questions.",
          },
        ],
        commonMistakes: [
          'Reading directly from a script',
        ...
        practiceQuestions: [
          {
            ...
            marks: 0,
            guidanceNotes:
              'Did you have enough time for all questions? Which sections felt rushed? Could you improve planning or writing speed? Aim to finish on time with time for proofreading.',
          },
        ],
        commonMistakes: [
      ...
      },
      {
        ...
        practiceQuestions: [
          {
            question:
              'How have your reading and writing skills developed through the course? Give specific examples.',
            marks: 0,
            guidanceNotes:
              'Reflect on: new vocabulary learned, analytical techniques developed, writing styles mastered. Notice connections between reading analysis and writing ability.',
          },
        ],
        commonMistakes: [
          'Treating reading and writing as separate skills',
