  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          id: 'othello-q3',
          questionNumber: 3,
          questionText: 'To what extent is Othello responsible for his own downfall? Discuss the interplay between personal weakness and external manipulation in the tragedy.',
          marks: 13,
        ...
        },
        {
          id: 'othello-q4',
          questionNumber: 4,
          questionText: 'Analyse the language and imagery Shakespeare uses to present Desdemona throughout the play. How does her portrayal compare to the male characters\' perceptions of her?',
          marks: 13,
          suggestedTimeMinutes: 15,
          questionType: 'analysis',
          modelAnswers: {
  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          id: 'henry-v-q3',
          questionNumber: 3,
          questionText: 'To what extent does Shakespeare present Henry V as an ideal leader? Discuss the limitations or problems with his leadership as well as his strengths.',
          marks: 13,
          suggestedTimeMinutes: 15,
          questionType: 'evaluation',
          modelAnswers: {
        ...
        },
        {
          id: 'henry-v-q4',
          questionNumber: 4,
          questionText: 'Examine how Shakespeare presents the experience of war and the common soldiers in Henry V. How does this compare to the heroic vision presented through Henry\'s rhetoric?',
          marks: 13,
          suggestedTimeMinutes: 15,
          questionType: 'analysis',
          modelAnswers: {
      ...
      questions: [
        {
          id: 'henry-v-q5',
          questionNumber: 5,
          questionText: 'Discuss Shakespeare\'s presentation of heroism in Henry V. To what extent does the play celebrate or critique the concept of the heroic?',
          marks: 53,
          suggestedTimeMinutes: 60,
          questionType: 'evaluation',
          modelAnswers: {
  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          id: 'umw-q3',
          questionNumber: 3,
          questionText: 'To what extent is Under Milk Wood a celebration of Welsh life and culture? Discuss how Thomas presents Welsh identity and values.',
          marks: 13,
          suggestedTimeMinutes: 15,
          questionType: 'evaluation',
          modelAnswers: {
        ...
        },
        {
          id: 'umw-q4',
          questionNumber: 4,
          questionText: 'Analyse how Thomas uses different voices and narrative perspectives in Under Milk Wood. What is the effect of his narrative technique?',
          marks: 13,
          suggestedTimeMinutes: 15,
          questionType: 'analysis',
          modelAnswers: {
  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          id: 'hobsons-q3',
          questionNumber: 3,
          questionText: 'Evaluate Hobson\'s position in the play. To what extent is he presented as a villain or as a tragic figure deserving of sympathy?',
          marks: 13,
          suggestedTimeMinutes: 15,
          questionType: 'evaluation',
          modelAnswers: {
        ...
        },
        {
          id: 'hobsons-q4',
          questionNumber: 4,
          questionText: 'Analyse how Brackett uses humour in Hobson\'s Choice. What is the function of humour in the play, and how does it contribute to its themes?',
          marks: 13,
          suggestedTimeMinutes: 15,
          questionType: 'analysis',
          modelAnswers: {
