        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'B, C, D, H — These are the four true statements. B: "which read 11:47." C: "the rain fell in sheets." D: "her small leather suitcase." H: "The platform was empty again."',
              'Grade 6-7': 'B, C, D, H — B is explicitly stated. C: the rain outside is described in detail. D: she picks up her "small leather suitcase." H: final sentence. A is wrong (destination is Edinburgh), E is wrong (the board said late), F is technically true but misleading, G is wrong (taps are mentioned).',
              'Grade 8-9': 'B, C, D, H — Careful textual analysis: (A) destination explicitly "Edinburgh"; (B) "11:47" verbatim; (C) "rain fell in sheets"; (D) "small leather suitcase"; (E) "late...for twenty minutes"; (F) true but distracting; (G) "tap, tap, tap" explicit; (H) final sentence confirmation.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'Write a narrative with clear beginning, middle, and end. Use sensory detail and descriptive language. Include dialogue if effective. Show the reader why the moment is significant. The piece should have approximately 450-500 words with mostly accurate spelling and grammar.',
              'Grade 6-7': 'Create a well-crafted piece using specific techniques. Vary sentence structures; use short sentences for effect and longer ones for description. Consider using metaphor or imagery. Maintain consistent tone. Approximately 500 words with confident control of technical accuracy.',
              'Grade 8-9': 'A sophisticated piece demonstrating control of form and language. Show originality in approach. Use linguistic devices purposefully. Demonstrate distinctive authorial voice. Explore psychological or thematic depth. Word choice precise and sometimes unexpected. Spelling and grammar secure throughout.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7': 'B, E, F, G — (A) "forty-three years," (C) she values annotations, (D) contradicted: they don\'t look up, (H) wrong person.',
              'Grade 8-9': 'B, E, F, G — Textual validation: (B) "pages uncut," (E) "leather chair," (F) "becoming invisible," (G) "A child" listed among believers.',
            },
          ...
          },
          {
            ...
            extractSource: MOCK_2_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The extract starts inside the bookshop showing its beauty and value. Then it shifts to the outside world where people rush past and ignore it. Finally, it shows Margaret waiting for occasional visitors. This structure shows how the bookshop is becoming less important, which creates a sad feeling.',
              'Grade 6-7': 'The structure moves from intimate interior (bookshop magnificence) to external indifference (world rushing past) to final acceptance (faith in remnant believers). This tripartite movement creates pathos. The contrast between careful curation and societal heedlessness is structurally significant. The final paragraph offers consolation rather than resolution — a "once a week" community. This arc from abundance to erasure to diminished hope creates melancholic tone.',
              'Grade 8-9': 'The writer constructs three movements enacting elegiac form. The opening establishes plenitude — abundant books, Margaret\'s expertise, sacred work. The second movement introduces external temporality moving at different pace, operating on different logic, failing to perceive the bookshop. This section performs loss through narrative contrast. The final movement recalibrates expectations without restoring plenitude. Margaret\'s continued work is positioned not as triumph but as care for remnant. The phrase "once a week" quantifies loss. Structurally, the passage enacts its own thematic content through temporal architecture: past abundance, present indifference, diminished future.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'Write about a specific place with details showing what it was like and what is happening to it. Include people affected and their feelings. Use descriptive language. Roughly 450 words.',
              'Grade 6-7': 'Use sensory detail and contrast between past and present. Include character perspective through action/dialogue. Vary sentence structures. Tone should be reflective. Roughly 500 words with secure control.',
              'Grade 8-9': 'Sophisticated exploration moving beyond nostalgia. Use precise imagery. Control perspective and time carefully. Explore what loss reveals about values or ways of being. Spelling and grammar secure throughout.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7': 'A, D, F, H — (B) false: "gone," (C) false: "crumbled," (E) "dead for twelve years," (G) false: "keep walking."',
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'Describe return to familiar place, changes observed, emotional reactions. Use sensory details. Roughly 450 words with mostly accurate technical control.',
              'Grade 6-7': 'Use contrast between past and present. Precise sensory detail. Varied sentence structures. Avoid simple nostalgia. Roughly 500 words with secure control.',
              'Grade 8-9': 'Sophisticated exploration recognizing return is never to the same place. Control time carefully. Employ language techniques deliberately. Explore what comparison reveals about identity/resilience. Secure technical control throughout.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7': 'B, D, F, G — (A) false: "never missed a day," (C) one child mentioned, (E) false: "nothing personal," (H) meaning, not literal content.',
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'Describe pivotal moment. Include events, dialogue, setting, thoughts, feelings. Use sensory detail. Show how understanding changes. Roughly 450 words.',
              'Grade 6-7': 'Use internal and external perspectives. Include dialogue for tension. Precise sensory detail grounding reader. Varied sentence structures. Explore gap between external and internal. Roughly 500 words.',
              'Grade 8-9': 'Sophisticated narrative exploring temporal and phenomenological dimensions. Multiple temporal frames if effective. Control point of view. Recognize major changes are often quiet rather than dramatic. Explore what moment reveals about character/values. Secure technical control.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7': 'B, C, G, H — (A) "at some point during the night," (D) correct, but not about release, (E) "colour of coffee," (F) "detachment," not fear.',
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'Describe disaster and person\'s experience. Include sensory detail. Show emotional reactions. Describe both physical effects and internal response. Roughly 450 words.',
              'Grade 6-7': 'Use focused narrative with specific perspective. Include sensory detail and complex emotions (might feel multiple things). Vary sentence structures. Recognize disaster reveals truths about community/character. Roughly 500 words.',
              'Grade 8-9': 'Sophisticated exploration moving beyond conventional loss narrative. Use precise imagery. Control time carefully. Explore uncomfortable truths: disaster can offer release, loss is unequal, responses contradictory. Secure technical control.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7': 'B, C, E, F — (A) "transformed into...in 1959," not built, (D) "white coat" (cosmetics), (G) "ground floor," (H) "Nothing endures."',
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'Describe place significant in your life. Show what it was like in past, what it is now, what will become. Include sensory detail. Show how character feels. Roughly 450 words.',
              'Grade 6-7': 'Use personal perspective to explore institutional change. Describe place at different temporal moments. Precise sensory detail. Avoid clichéd nostalgia. Reflective rather than sentimental tone. Roughly 500 words.',
              'Grade 8-9': 'Sophisticated exploration using memory not sentimentally but analytically. Control time carefully. Explore complicity of past institutions in systems destroying them. Examine how meaning is produced then erased. Refuse simple nostalgia. Secure technical control.',
            },
            markScheme: [
