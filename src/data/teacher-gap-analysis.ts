    ...
    diagnosticQuestions: [
      {
        id: 'infer-001',
        question:
          'Read this passage: "She gathered her coat and gloves, checking the clock twice." What can we infer about the character\'s state of mind?',
        skillTested: 'Making inferences from textual details',
        expectedResponse:
          'The character is anxious, nervous, or in a hurry; the repeated time-checking and deliberate gathering of items suggests concern about being late or anticipation about an event',
        commonErrors: [
      ...
      },
      {
        id: 'infer-002',
        question:
          'In a passage where a character "avoids his father\'s gaze" and "his voice drops to a whisper," what can we deduce about their relationship?',
        skillTested: 'Deducing relationships from behavioral details',
        expectedResponse:
          'There is tension, discomfort, or conflict between them; the character feels shame, guilt, or fear; the relationship is strained or distant',
        commonErrors: [
      ...
      },
      {
        id: 'infer-003',
        question:
          "A character receives a letter and immediately burns it without opening it. What might we infer about the letter's origin?",
        skillTested: 'Using action to infer about unstated information',
        expectedResponse:
          "The character knows or suspects who it's from and fears its contents; it may contain unwelcome news, accusations, or reminders of a painful past",
        commonErrors: [
      ...
      },
      {
        id: 'infer-004',
        question:
          'In a passage, a wealthy family member "insists on paying" at a restaurant, but the other character "tenses visibly" when offered. What can we infer?',
        skillTested: 'Recognizing complex emotional subtext',
        expectedResponse:
          'There is a history of power imbalance or control; the character may feel humiliated, dependent, or resentful; acceptance comes with emotional cost',
        commonErrors: [
      ...
      },
      {
        id: 'infer-005',
        question:
          'A character "had learned long ago not to ask questions." What can we infer about their past experiences?',
        skillTested: 'Drawing inferences about history from present behavior',
        expectedResponse:
          'They have experienced punishment, dismissal, or harm when asking questions; they come from an environment where curiosity was unwelcome or dangerous',
        commonErrors: [
      ...
      },
      {
        id: 'infer-006',
        question:
          'A narrator describes childhood home in cold, sparse language, but earlier described current home with warmth and detail. What does this contrast suggest?',
        skillTested: 'Using contrasts to infer emotional truth',
        expectedResponse:
          'The childhood home was emotionally empty, neglectful, or traumatic; the current home represents safety, comfort, and belonging they lacked',
        commonErrors: [
    ...
    commonMisconceptions: [
      {
        id: 'misc-inf-001',
        misconception:
          "Inference is the same as explicit information; if it's not directly stated, it's not a valid inference",
        evidence:
          'Students confuse textual evidence with inference, thinking they can only answer if the text explicitly states something',
        correction:
          'Inference bridges the gap between stated details and unstated meanings. Writers intentionally leave gaps for readers to fill using evidence. An inference is valid if supported by textual details, even if never directly stated',
        activities: [
      ...
      },
      {
        ...
        evidence:
          'Students make wild inferences loosely connected to text, or make inferences that contradict textual evidence',
        correction:
          'Inferences must be grounded in textual evidence and must not contradict explicit information. The evidence must logically support the inference. Multiple inferences should be consistent with each other',
        activities: [
      ...
      },
      {
        ...
        evidence:
          "Students avoid making inferences about character states, motivations, or relationships, thinking they're too subjective",
        correction:
          'Emotional inferences are deeply grounded in linguistic choices: word choice, syntax, punctuation, physical details, and behavior. These are analyzable, defensible, and often the most important inferences in literature',
        activities: [
      ...
      },
      {
        id: 'misc-inf-004',
        misconception:
          "Inferences about the past require explicit backstory; you can't infer history from present details",
        evidence:
          'Students miss rich opportunities to infer character history from their present behaviors, attitudes, and relationships',
        correction:
          "Character history is revealed through present behavior, choices, and reactions. Small details-learned behaviors, reflexive responses, avoidances-tell us much about someone's past. Writers use present action as window to history",
        activities: [
    ...
    interventionStrategies: [
      {
        ...
        description:
          'Teach students a explicit three-step process: (1) Identify specific textual detail, (2) Translate detail into what it suggests, (3) Connect suggestion to broader inference. Use sentence stems and scaffolds initially, gradually removing support. Model with think-alouds showing inference failures and corrections.',
        resources: [
    ...
    diagnosticQuestions: [
      {
        id: 'tech-001',
        question:
          'Read: "The crowd roared like a single beast." What technique is used here, and what is its effect?',
        skillTested: 'Identifying and explaining metaphor/simile',
        expectedResponse:
          'This is a simile (comparison using "like"). It suggests the crowd acts as a unified, animalistic force, emphasizing their power and lack of individual agency',
        commonErrors: [
      ...
      },
      {
        id: 'tech-002',
        question:
          'Analyze: "The silence screamed at me from every corner." What is happening linguistically here?',
        skillTested: 'Identifying oxymoron and personification',
        expectedResponse:
          'This uses both oxymoron (silence cannot scream) and personification (silence is given human qualities). Together they create paradox-the absence of sound becomes a powerful presence',
        commonErrors: [
      ...
      },
      {
        ...
        expectedResponse:
          'Anaphora or systematic repetition for emphasis. The repeated structure builds intensity and frustration, suggesting exasperation and the weight of accumulated reminders',
        commonErrors: [
      ...
      },
      {
        id: 'tech-004',
        question:
          'In the phrase "The road less traveled by," what technique creates the effect here?',
        skillTested: 'Identifying word order and inversion effects',
        expectedResponse:
          'This uses inversion (inverted syntax/word order). Standard order would be "the less traveled road." The inversion creates a poetic effect and emphasizes "less traveled"',
        commonErrors: [
      ...
      },
      {
        ...
        expectedResponse:
          'This uses extensive alliteration (repetition of the "p" sound). It creates a playful, tongue-twister effect and emphasizes the words, making the phrase memorable and rhythmic',
        commonErrors: [
      ...
      },
      {
        ...
        expectedResponse:
          'Asyndeton (omission of conjunctions) creates a rushed, chaotic effect through short, staccato sentences. The accumulated sounds build a sense of disorder and overwhelm',
        commonErrors: [
    ...
    commonMisconceptions: [
      {
        ...
        evidence:
          'Students name techniques accurately but cannot explain why an author chose that technique',
        correction:
          'Technique identification is just the first step. The real work is understanding why a writer chose this technique. Effect analysis is where students show sophisticated understanding',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Each technique creates subtly different effects. Understanding these distinctions allows precise analysis',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Techniques encompass all linguistic choices: grammar, syntax, punctuation, word choice, sound patterns',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Terminology can vary. What matters is precise description. Analysis quality matters more than terminology precision',
        activities: [
    ...
    interventionStrategies: [
      {
        ...
        description:
          'Build a comprehensive technique library with examples. Create visual posters showing technique definition, example, and effect. Use deliberate repetition to build automatic recognition. Play games where students match techniques to examples.',
        resources: [
      ...
      },
      {
        ...
        description:
          'Use structured sentence frames to connect technique to effect. Start with obvious techniques, then progress to subtle ones. Model how to articulate precisely what a reader experiences',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Teach systematic annotation: highlight technique, label in margin, write effect briefly. Model on passages. Create annotation codes. Read passages multiple times, each focusing on different technique types.',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          "Examine passages written multiple ways with different techniques. Discuss what each version achieves. Have students revise passages, replacing techniques and analyzing changes. Discuss author's purpose as context.",
        resources: [
    ...
    diagnosticQuestions: [
      {
        id: 'effect-001',
        question:
          'Why does the author use short, punchy sentences like "She left. He didn\'t follow. The silence was absolute."?',
        skillTested: 'Analyzing sentence structure and psychological effect',
        expectedResponse:
          "Short sentences create a staccato rhythm, suggesting shock, finality, and emotional distance. The abruptness mirrors the character's emotions. The final statement about silence hits harder due to the pattern preceding it",
        commonErrors: [
      ...
      },
      {
        id: 'effect-002',
        question:
          'A text repeatedly uses "pale," "cold," "gray," and "empty" to describe a setting. What is the cumulative effect?',
        skillTested: 'Recognizing color and descriptor patterns',
        expectedResponse:
          'The language creates a sense of desolation, emotional emptiness, or loss. The repeated emphasis on lack and absence builds an atmosphere of depression, abandonment, or death',
        commonErrors: [
      ...
      },
      {
        id: 'effect-003',
        question:
          'Why might an author use complex, lengthy sentences filled with parentheses and multiple clauses?',
        skillTested: 'Understanding how syntax creates reader experience',
        expectedResponse:
          'Complex sentences create intellectual demand, slowness, or the sense of an overwhelmed mind. The reader must work to parse meaning, mirroring cognitive difficulty or emotional confusion',
        commonErrors: [
      ...
      },
      {
        ...
        expectedResponse:
          'Single use highlights importance; three uses intensifies the message, drives it home, builds emotional force. The repetition suggests obsession, urgency, or the weight of accumulated emphasis',
        commonErrors: [
      ...
      },
      {
        id: 'effect-005',
        question:
          "How does using first-person versus third-person narration affect the reader's relationship to a character?",
        skillTested: 'Understanding narrative perspective effects',
        expectedResponse:
          "First-person creates intimacy and immediacy; the reader experiences the character's thoughts directly. Third-person creates distance and allows multiple perspectives. First-person makes the reader complicit; third-person creates opportunity for irony",
        commonErrors: [
      ...
      },
      {
        ...
        expectedResponse:
          'Nominalization (noun-heavy language) can create distance, abstraction, or lack of accountability. It makes events seem inevitable or removes human agency. It sounds formal or bureaucratic',
        commonErrors: [
    ...
    commonMisconceptions: [
      {
        ...
        evidence:
          'Students write "this is sad" or "this is scary" without explaining the linguistic mechanism',
        correction:
          'Effect analysis requires explaining the specific connection between technique and the reader\'s response. "The short sentences and repeated "no" create urgency and finality, making the reader feel despair" is analysis',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Context determines effect. Repetition can create emphasis, rhythm, obsession, or tedium depending on context. Analysis requires considering the specific moment and surrounding language',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Effect analysis requires precise, technical language. Compare "this makes you feel stuff" to "the asyndeton creates a breathless, chaotic effect, propelling the reader through the chaos." Develop sophisticated vocabulary',
        activities: [
      ...
      },
      {
        ...
        correction:
          'While techniques create tendencies, readers interpret differently. Analysis should consider likely effects while acknowledging variation. Context clues help determine intended effect',
        activities: [
    ...
    interventionStrategies: [
      {
        ...
        duration: '3-4 lessons',
        description:
          "Teach a model: (1) Identify technique, (2) Name the effect, (3) Explain why the language creates that effect, (4) Connect to author's purpose. Use consistent sentence frames. Model extensively. Use same passage multiple times, analyzing different techniques",
        resources: [
          'Effect analysis sentence frames',
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Build extensive effect vocabulary: pace, rhythm, tone, atmosphere, perspective, tension. Create a class glossary. Practice replacing vague language with precise alternatives. Play word substitution games. Read critical analysis and identify effect vocabulary',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Present same passage with different linguistic choices. Analyze the different effects each creates. Have students revise passages, changing one technique at a time and tracking how effect changes. This builds understanding that form creates meaning',
        resources: [
          'Multi-version passages',
      ...
      },
      {
        ...
        duration: '3-4 lessons',
        description:
          'Emphasize that effect depends on context: surrounding sentences, passage purpose, audience, genre expectations. Teach students to consider "what comes before," "what comes after," and "why is this passage here?" Analyze same technique in different texts',
        resources: [
    ...
    diagnosticQuestions: [
      {
        id: 'struct-001',
        question:
          'Why might a story begin with the ending? What effect does this narrative structure create?',
        skillTested: 'Understanding non-linear narrative',
        expectedResponse:
          "Beginning with the ending creates foreknowledge and allows for mystery. It reduces suspense while increasing dramatic irony. The reader understands characters' fates before understanding their journeys",
        commonErrors: [
      ...
      },
      {
        id: 'struct-002',
        question:
          'A text alternates between past and present, switching perspective each time. What structural effect does this create?',
        skillTested: 'Analyzing multi-perspective and temporal structure',
        expectedResponse:
          'The alternation creates layers of understanding and raises questions about how past influences present. It positions two perspectives as equally important. The back-and-forth rhythm creates a sense of dialogue',
        commonErrors: [
      ...
      },
      {
        id: 'struct-003',
        question:
          'Why does a poem repeat the same line at the beginning and end? What structural purpose does this serve?',
        skillTested: 'Understanding cyclical structure',
        expectedResponse:
          'The repetition creates a sense of return or closure, suggesting the speaker has returned to where they began, potentially with new understanding. It can feel satisfying or ironic',
        commonErrors: [
      ...
      },
      {
        id: 'struct-004',
        question:
          'Why might a long, complex paragraph be followed by a very short one-just one sentence? What is the structural effect?',
        skillTested: 'Understanding paragraph length effects',
        expectedResponse:
          'The short sentence provides relief and emphasis through contrast. It slows the reader, forces attention, and often signals something significant. The dramatic shift in pace creates a moment of clarity or shock',
        commonErrors: [
      ...
      },
      {
        id: 'struct-005',
        question:
          'A text is divided into multiple short sections, each with its own heading. How does this sectioning shape how we read?',
        skillTested: 'Understanding text division effects',
        expectedResponse:
          'Sections create natural pauses, allow readers to stop and resume, and can signal thematic shifts. Headings provide interpretation guides. The sectioning breaks content into digestible units and emphasizes certain ideas',
        commonErrors: [
      ...
      },
      {
        id: 'struct-006',
        question:
          'Why do many stories build to a climax and then resolve quickly? How does this structure shape tension?',
        skillTested: 'Understanding conventional narrative structure',
        expectedResponse:
          'The three-act structure builds reader engagement and creates a satisfying arc. The rapid resolution after climax prevents exhaustion and provides release from tension. It creates psychological satisfaction',
        commonErrors: [
    ...
    commonMisconceptions: [
      {
        ...
        evidence:
          'Students discuss structure only in technical terms without considering its effect',
        correction:
          'Structure is a fundamental meaning-making tool. How a text is organized shapes how readers understand it. The order of information, the breaks, the pacing-all of these create meaning',
        activities: [
      ...
      },
      {
        ...
        correction:
          "Non-linear structures serve specific purposes: creating mystery, developing themes, positioning perspective. They're not better or worse; they're different tools for different effects",
        activities: [
      ...
      },
      {
        ...
        correction:
          "Structure should be analyzed from the first reading. Notice what comes first, what comes last, what's emphasized. Structure is part of content, not separate",
        activities: [
      ...
      },
      {
        id: 'misc-struct-004',
        misconception:
          'There are only a few standard structures; everything else is just experimenting',
        evidence: 'Students lack vocabulary for describing diverse structural approaches',
        correction:
          'While some structures are conventional, infinite variations exist. Develop vocabulary for describing structural innovations. Understand the full range of possibilities',
        activities: [
    ...
    interventionStrategies: [
      {
        ...
        duration: '2-3 lessons',
        description:
          'Teach students to map text structure visually: timeline for chronological events, flowchart for cause-effect, layers for nested narratives. Create visual outlines. Use physical arrangement. This kinesthetic approach helps students grasp patterns',
        resources: [
          'Timeline templates',
      ...
      },
      {
        ...
        duration: '3-4 lessons',
        description:
          "Take a passage and reorganize it in different ways. Read each version and discuss how meaning changes. Have students predict what will happen next based on structure. Discuss author's choices",
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          "Teach common structures: three-act narrative, hero's journey, sonnet structure, flashback structure, frame narrative, parallel structure. Provide multiple examples. Play recognition games. Discuss how genre and form conventions shape structure",
        resources: [
      ...
      },
      {
        ...
        duration: '3-4 lessons',
        description:
          'For each structural element, ask: "What does this accomplish?" Model how experts question structure. Develop language for articulating effects precisely. Progress from obvious to subtle effects',
        resources: [
    ...
    diagnosticQuestions: [
      {
        id: 'eval-001',
        question:
          "Do you think this character's decision was realistic? Support your judgment with evidence",
        skillTested: 'Making supported judgments about believability',
        expectedResponse:
          "Strong response considers: character's prior behavior and psychology, circumstances forcing the decision, alternative choices, what the text tells us about their reasoning",
        commonErrors: [
      ...
      },
      {
        id: 'eval-002',
        question:
          'Is the ending satisfying? Evaluate based on narrative structure and character development',
        skillTested: 'Evaluating endings against narrative and thematic demands',
        expectedResponse:
          'Strong response considers: resolution of conflicts, character arc completion, alignment with tone/genre, whether it feels earned, thematic coherence',
        commonErrors: [
      ...
      },
      {
        id: 'eval-003',
        question:
          "How effective is this author's use of metaphor? Consider frequency, originality, and coherence",
        skillTested: 'Evaluating technique effectiveness across multiple criteria',
        expectedResponse:
          'Strong response considers: are metaphors fresh or clichéd? Do they recur coherently? Do they enhance meaning or distract? Are they appropriate to context and purpose?',
        commonErrors: [
      ...
      },
      {
        id: 'eval-004',
        question:
          'Is the dialogue in this scene convincing? What makes dialogue feel authentic or artificial?',
        skillTested: 'Evaluating dialogue authenticity',
        expectedResponse:
          "Strong response considers: sentence structure and length variations, vernacular appropriateness, subtext and what's unsaid, character voice distinctiveness, natural pauses and interruptions",
        commonErrors: [
      ...
      },
      {
        id: 'eval-005',
        question:
          "Evaluate the narrator's reliability. What evidence suggests trustworthiness or deception?",
        skillTested: 'Making judgments about narrative reliability',
        expectedResponse:
          'Strong response identifies: contradictions in account, gaps in knowledge, acknowledged biases, consistency/inconsistency with external evidence, what readers must verify or doubt',
        commonErrors: [
      ...
      },
      {
        id: 'eval-006',
        question:
          'Is this text successful in achieving its apparent purpose? What evidence supports your judgment?',
        skillTested: 'Evaluating texts against their purposes',
        expectedResponse:
          "Strong response identifies: the text's likely purpose, criteria for success, evidence of effectiveness or failure, consideration of intended audience, acknowledgment of trade-offs",
        commonErrors: [
    ...
    commonMisconceptions: [
      {
        ...
        correction:
          'Critical evaluation requires evidence, reasoning, and consideration of multiple perspectives. Literary evaluation uses shared criteria and conventions',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Strong evaluation considers both strengths and weaknesses. Appreciation of strengths is as important as identifying limitations',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Effectiveness is contextual. A technique might be brilliant in one context and misguided in another. Evaluation must account for context',
        activities: [
      ...
      },
      {
        ...
        correction:
          "Experimental approaches can be highly effective. Evaluate against the text's goals, not against your expectations. Innovation requires evaluation on its own terms",
        activities: [
    ...
    interventionStrategies: [
      {
        ...
        duration: '3-4 lessons',
        description:
          'Teach students to develop evaluation criteria before evaluating. For any judgment, establish: What are we evaluating? What criteria matter? How do we measure success? Create rubrics collaboratively. Use consistent frameworks across texts',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Establish non-negotiable requirement: every evaluative claim requires evidence. Teach evidence hierarchy: specific quotation is strongest, pattern reference is strong, general statement is weakest. Use sentence frames. Provide extensive practice',
        resources: [
      ...
      },
      {
        ...
        duration: '3-4 lessons',
        description:
          'Teach students to ask: For whom is this effective? In what context? For what purpose? Have students evaluate same text from different perspectives. Discuss how audience, time period, genre, and purpose shape effectiveness',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Engage students in structured evaluative discussions. Present competing evaluations and have students argue for/against. Model respectful disagreement. Teach students to acknowledge strong points while maintaining their position',
        resources: [
          'Debate prompts',
    ...
    diagnosticQuestions: [
      {
        ...
        expectedResponse:
          'Strong revision specifies what kind of dark/cold, uses sensory language, creates atmosphere. Example: "Shadow pooled in corners like spilled ink. The cold bit at exposed skin, a predatory chill."',
        commonErrors: [
      ...
      },
      {
        id: 'desc-002',
        question:
          'Describe a character\'s fear without using the word "fear." Show it through physical detail',
        skillTested: 'Using physical detail to convey emotion',
        expectedResponse:
          'Strong response shows fear through: trembling hands, shallow breathing, jaw clenching, eyes darting, sweat, stomach tightness. Physical details create emotional understanding',
        commonErrors: [
      ...
      },
      {
        id: 'desc-003',
        question:
          'Describe a place using not just visual detail but sound, smell, texture, and taste. Make it multi-sensory',
        skillTested: 'Developing multi-sensory, immersive description',
        expectedResponse:
          'Strong response engages multiple senses, choosing details that create coherent atmosphere. Example: forest might include "dark shadows, bird song layering, earth-thick smell, damp moss soft underfoot, moisture taste in air"',
        commonErrors: [
      ...
      },
      {
        id: 'desc-004',
        question:
          'Describe an object so specifically that a reader could visualize it clearly. What precise details matter most?',
        skillTested: 'Selecting precise, revealing details',
        expectedResponse:
          'Strong response focuses on specific, revealing details: particular colors, textures, proportions, unusual characteristics. Example: coffee cup "chipped on rim, stained with permanent ghost, handle worn smooth from thousands of grasps"',
        commonErrors: [
      ...
      },
      {
        id: 'desc-005',
        question:
          "Write a description that reveals character through environment. Don't describe the person; describe their space",
        skillTested: 'Using environmental detail to reveal character',
        expectedResponse:
          "Strong response selects environmental details that suggest personality, values, habits, emotional state. A teenager's room with posters, books, half-finished projects, expensive equipment next to broken things-tells a character story",
        commonErrors: [
      ...
      },
      {
        id: 'desc-006',
        question:
          'Describe the same scene from two different emotional perspectives (joyful and terrified). How does perspective shape what you notice?',
        skillTested: 'Understanding how perspective shapes perception',
        expectedResponse:
          'Strong response shows that same scene looks different when described by different emotional states. Bright light becomes harsh or beautiful depending on filter. The joyful person notices beauty; terrified person notices dangers',
        commonErrors: [
    ...
    commonMisconceptions: [
      {
        ...
        evidence:
          'Students write: "absolutely magnificent, gorgeous, breathtakingly beautiful landscape"',
        correction:
          'Effective description uses precise, specific language-often simple words. One specific detail outperforms piles of generic adjectives. Quality over quantity; specificity over grandiosity',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Description serves purpose. Sometimes a sentence suffices; sometimes a paragraph. Strategic description is more effective than constant detail. Restraint is a virtue',
        activities: [
      ...
      },
      {
        ...
        correction:
          'The most powerful description often conveys emotional or psychological states. Physical detail is the vehicle, not the destination. Description that creates atmosphere and reveals inner life is more effective',
        activities: [
      ...
      },
      {
        ...
        correction:
          "Description serves the story's purpose and tone. Some descriptions should be ugly, harsh, ordinary, mundane. Match description style to tone and purpose",
        activities: [
    ...
    interventionStrategies: [
      {
        ...
        duration: '3-4 lessons',
        description:
          'Teach the hierarchy: specific noun/verb > concrete detail > generic adjective > abstract descriptor. Model replacing "big beautiful building" with "mansion sprawled across lot, columns cracked from decades of weather." Practice identifying generic descriptions and replacing them. Play "detail detective"',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Teach sensory awareness and description. Start with single senses, then combine. Use sensory imagery exercises: describe one place through taste only, then sound only, then layering senses. Discuss when multi-sensory is appropriate',
        resources: [
      ...
      },
      {
        ...
        duration: '3-4 lessons',
        description:
          'Teach that description reveals narrator and character. Environmental detail shows character; physical detail shows emotion; sensory focus shows priorities. Have students describe same place from different emotional perspectives. Practice showing character through environment',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Emphasize that description serves purpose: creating atmosphere, revealing character, moving plot, controlling pacing. Teach students to ask: "Why am I describing this?" Practice alternating detailed and sparse passages. Discuss how description speed affects reader experience',
        resources: [
    ...
    diagnosticQuestions: [
      {
        id: 'narr-001',
        question:
          'Should your story begin with action or background information? What are the trade-offs?',
        skillTested: 'Understanding different opening strategies',
        expectedResponse:
          'Strong response acknowledges trade-offs: action openings grab readers immediately but may lack context; background openings establish world/character but may feel slow. The right choice depends on story needs and intended effect',
        commonErrors: [
      ...
      },
      {
        ...
        expectedResponse:
          'Strong response recognizes that post-climax pacing depends on purpose: quick resolution can feel satisfying; lingering can show consequences. Genre and reader expectations matter',
        commonErrors: [
      ...
      },
      {
        id: 'narr-003',
        question:
          'When should you reveal important information? Early, midway, or late? What determines the best timing?',
        skillTested: 'Understanding information management and revelation timing',
        expectedResponse:
          'Strong response recognizes that revelation timing creates mystery, surprise, or dramatic irony. Early revelation allows readers to anticipate; late creates shock. Midway builds complexity. Purpose and effect determine timing',
        commonErrors: [
      ...
      },
      {
        ...
        expectedResponse:
          'Strong response recognizes that thread management affects pacing. Introducing threads too quickly overwhelms; pacing allows development. Threads should connect thematically or causally. Timing creates balance',
        commonErrors: [
      ...
      },
      {
        id: 'narr-005',
        question:
          'Your story includes a moment of calm or reflection. Is this effective pacing or should it be cut?',
        skillTested: 'Understanding pacing variation and slower sections',
        expectedResponse:
          'Strong response recognizes that constant high tension exhausts readers. Strategic calm allows processing and sets up later action. The calm section should reveal character, develop relationships, or deepen meaning',
        commonErrors: [
      ...
      },
      {
        id: 'narr-006',
        question:
          'How do you know when your story should end? What determines the right ending point?',
        skillTested: 'Understanding closure and where stories should stop',
        expectedResponse:
          'Strong response recognizes that stories should end when the central question is answered or when the arc feels complete. Continuing past the natural ending point feels forced. The right ending shows what the story means',
        commonErrors: [
    ...
    commonMisconceptions: [
      {
        ...
        correction:
          'Pacing variation is essential. Constant action exhausts readers and prevents understanding. Strategic pacing-alternating intense and calm-creates more effective narratives',
        activities: [
      ...
      },
      {
        ...
        correction:
          'While chronological is conventional, many effective structures exist: non-linear, frame narratives, nested stories, in medias res. Structure is a tool; choose structures that serve story needs',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Backstory should be revealed gradually, woven throughout. Revealing little by little maintains mystery and pacing. Information should become apparent as readers need it',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Character and plot are inseparable. Character choices drive plot; plot reveals and develops character. Strong narratives integrate them completely',
        activities: [
    ...
    interventionStrategies: [
      {
        ...
        duration: '3-4 lessons',
        description:
          "Teach conventional three-act structure and variations (five-act, hero's journey, non-linear). Read examples of each. Discuss when different structures suit different stories. Have students outline same story in multiple structures",
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Teach pacing as intentional choice. Analyze published stories for pacing variations. Chart pacing visually. Have students rewrite sections with different pacing and discuss effects. Teach that short sentences accelerate; long sentences slow down',
        resources: [
      ...
      },
      {
        ...
        duration: '3-4 lessons',
        description:
          'Teach strategic information management. Discuss dramatic irony, foreshadowing, and revelation timing. Have students map information revealing. Discuss what happens with reader knowledge variation. Practice weaving backstory naturally',
        resources: [
      ...
      },
      {
        ...
        duration: '3-4 lessons',
        description:
          'Emphasize that strong narratives integrate character and plot completely. Teach character arc (internal change) and plot arc (external events) and how they parallel. Have students analyze stories showing alignment. Practice developing story ideas as character studies and plot-driven narratives simultaneously',
        resources: [
    ...
    diagnosticQuestions: [
      {
        id: 'trans-001',
        question:
          'Write a paragraph persuading people to recycle. What makes persuasion effective?',
        skillTested: 'Identifying and using persuasive techniques',
        expectedResponse:
          'Strong response uses multiple techniques: clear thesis, evidence/reasoning, appeals to emotion/logic/credibility, engaging language. Discusses why each technique matters for persuasion',
        commonErrors: [
      ...
      },
      {
        id: 'trans-002',
        question:
          'Present a strong counterargument to your position, then refute it. How does this strengthen your argument?',
        skillTested: 'Understanding counterargument and sophisticated argumentation',
        expectedResponse:
          'Strong response presents opposing view fairly, explains its appeal, then provides reasoned refutation. This shows sophisticated thinking and addresses potential reader objections, appearing more convincing',
        commonErrors: [
      ...
      },
      {
        id: 'trans-003',
        question:
          'What evidence would convince a skeptical reader? What counts as good evidence in argument?',
        skillTested: 'Understanding evidence strength and relevance',
        expectedResponse:
          'Strong response identifies: specific examples, statistics, expert testimony, logical reasoning, case studies. Discusses why evidence matters and how weak evidence undermines argument',
        commonErrors: [
      ...
      },
      {
        id: 'trans-004',
        question:
          'Adapt your argument for three different audiences: politicians, teenagers, wealthy businesspeople. How do you adjust your approach?',
        skillTested: 'Understanding audience awareness and adaptation',
        expectedResponse:
          'Strong response shows how persuasion is audience-dependent. Different audiences have different concerns and values. Effective persuasion speaks to audience interests and uses appropriate language',
        commonErrors: [
      ...
      },
      {
        ...
        expectedResponse:
          'Strong response identifies potential fallacies: ad hominem, false cause, false dichotomy, appeal to authority. Shows awareness that logic matters for persuasion and credibility',
        commonErrors: [
      ...
      },
      {
        id: 'trans-006',
        question:
          'How does your tone affect persuasiveness? When is anger/humor/formality effective or counterproductive?',
        skillTested: 'Understanding tone and its persuasive effect',
        expectedResponse:
          'Strong response recognizes tone as strategic choice. Some audiences respond to anger, others to humor or formality. Tone should match message and audience. Condescending tone undermines persuasion',
        commonErrors: [
    ...
    commonMisconceptions: [
      {
        id: 'misc-trans-001',
        misconception:
          "Persuasion means telling people they're wrong; stronger persuasion = more forceful",
        evidence: 'Students write aggressive, dismissive arguments that alienate readers',
        correction:
          'Effective persuasion respects the reader. Aggressive, dismissive tone undermines credibility. The strongest persuasion is often reasonable, measured, and respectful. Force alienates; reason convinces',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Effective persuasion uses both logic and emotion. Stories and emotional truth can be as persuasive as statistics. The key is honesty: emotional appeals should be genuine, not exploitative',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Acknowledging strong counterarguments strengthens persuasion. It shows sophisticated thinking, addresses reader concerns proactively, and demonstrates confidence. Avoiding opposition looks defensive',
        activities: [
      ...
      },
      {
        id: 'misc-trans-004',
        misconception:
          'All evidence is equally valid; more evidence always makes stronger argument',
        evidence: 'Students cite personal anecdotes alongside statistics',
        correction:
          'Evidence has hierarchy: controlled studies > statistics > expert testimony > personal examples. Carefully selected evidence is stronger than quantity. Selection bias undermines credibility',
        activities: [
          'Evidence hierarchy',
          'Selection awareness',
          'Evidence evaluation',
    ...
    interventionStrategies: [
      {
        ...
        duration: '3-4 lessons',
        description:
          'Teach major persuasive techniques: ethos (credibility), pathos (emotion), logos (logic), rhetorical questions, antithesis, repetition, inclusive language. Provide examples and have students identify techniques in persuasive texts. Practice using techniques purposefully',
        resources: [
      ...
      },
      {
        ...
        duration: '3-4 lessons',
        description:
          'Teach argument structure: thesis, supporting points, evidence, reasoning, conclusion. Use essay outlines to make structure visible. Teach logical reasoning and common fallacies. Have students evaluate arguments for logical strength',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          "Teach audience analysis: What does this audience care about? What's their current position? What language do they use? What evidence matters to them? Have students write same argument for different audiences, adjusting tone, evidence, and approach",
        resources: [
          'Audience analysis worksheets',
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Teach students to research counterarguments seriously, present them fairly, and develop strong refutations. Use debate frameworks. Have students practice articulating opposing views before refuting them. Discuss why this strengthens argument',
        resources: [
    ...
    diagnosticQuestions: [
      {
        id: 'comp-001',
        question:
          'Compare these two passages on the same topic. What are key similarities and differences in approach?',
        skillTested: 'Identifying similarities and differences systematically',
        expectedResponse:
          'Strong response identifies multiple points of comparison: tone, purpose, audience, techniques, evidence, structure. Goes beyond surface to deeper structural and rhetorical differences',
        commonErrors: [
      ...
      },
      {
        id: 'comp-002',
        question:
          'Both passages use descriptive language, but to different effects. Analyze their different uses',
        skillTested: 'Comparing technique effects across texts',
        expectedResponse:
          'Strong response analyzes description in each text, identifies how they differ, and discusses why differences matter. Shows understanding that same technique serves different purposes',
        commonErrors: [
      ...
      },
      {
        id: 'comp-003',
        question:
          'These texts are written for different audiences. How does audience influence their approach?',
        skillTested: 'Understanding how audience shapes choices',
        expectedResponse:
          'Strong response identifies intended audience for each, explains how this shapes choices (language, evidence, tone, structure), and shows how different audiences create necessarily different approaches',
        commonErrors: [
      ...
      },
      {
        id: 'comp-004',
        question:
          'Both passages convey similar information, but one is much shorter. What information is prioritized in each?',
        skillTested: 'Comparing information management and emphasis',
        expectedResponse:
          'Strong response identifies what each text emphasizes, discusses how decisions about inclusion/exclusion shape argument, and shows how space = importance',
        commonErrors: [
      ...
      },
      {
        id: 'comp-005',
        question:
          'Compare the tone of these texts. How do tone differences affect how readers receive the message?',
        skillTested: 'Comparing tone and analyzing its effect',
        expectedResponse:
          'Strong response identifies tone in each text, explains how language creates it, and discusses how different tones affect reader reception. Shows that tone is rhetorical choice',
        commonErrors: [
      ...
      },
      {
        id: 'comp-006',
        question:
          'Structure these passages differently. How does structure choice affect the message?',
        skillTested: 'Understanding how structure creates meaning',
        expectedResponse:
          'Strong response recognizes structure as rhetorical choice, shows how different structures emphasize different aspects, and discusses how structure affects reader understanding',
        commonErrors: [
    ...
    commonMisconceptions: [
      {
        id: 'misc-comp-001',
        misconception:
          'Comparison means describing each text, then noting similarities and differences',
        evidence:
          'Students write one analysis of Text A, one of Text B, then add comparison sections',
        correction:
          'Comparison is integrated throughout. Discuss texts in dialogue, weaving analysis. Comparative language should thread through. Each analytical point should illuminate both texts simultaneously',
        activities: [
      ...
      },
      {
        ...
        evidence:
          'Students note that Text A is longer, Text B is formal, without exploring significance',
        correction:
          "Effective comparison identifies differences and explores their significance. Why is Text A longer? What does that accomplish? Surface observation without interpretation isn't comparison",
        activities: [
          'Why questions',
      ...
      },
      {
        ...
        correction:
          'Similarities are often more revealing. Both texts might use narrative even with different tones. Similarities with different effects are particularly interesting',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Comparison describes and analyzes; judgment depends entirely on criteria and context. Text A might be more effective for audience X with purpose Y. Avoid simple preference; discuss contextual effectiveness',
        activities: [
    ...
    interventionStrategies: [
      {
        ...
        duration: '3-4 lessons',
        description:
          'Teach integrated comparison explicitly. Use comparative language frames. Model weaving discussion of both texts simultaneously. Practice identifying an analytical point, then exploring it in both texts without separating them',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Teach the "so what?" test: identify difference, then ask why it matters. Develop reasons: rhetorical effect, audience appeal, emphasis, purpose achievement, credibility. Have students practice explaining significance',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Provide framework for systematic comparison: Tone, Purpose, Audience, Techniques, Structure, Evidence, Emphasis. Teach students to apply this framework. Use the framework to ensure comprehensive analysis',
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Teach that effectiveness depends on: purpose, intended audience, context, criteria. Have students analyze effectiveness with multiple audiences in mind. Discuss how same text might be effective for one audience and less for another',
        resources: [
    ...
    diagnosticQuestions: [
      {
        id: 'poem-001',
        question:
          'Read this unfamiliar poem once. What is your first impression? What are you noticing?',
        skillTested: 'Initial impressions and identifying broad features',
        expectedResponse:
          'Strong response notes: tone, form/structure, apparent subject, emotional register, language register. First impressions often catch major features',
        commonErrors: [
      ...
      },
      {
        id: 'poem-002',
        question:
          'This poem has a regular rhyme scheme. What effect does the regularity or irregularity create?',
        skillTested: 'Analyzing form and its effects',
        expectedResponse:
          'Strong response identifies rhyme scheme, notes whether regular or irregular, and discusses effects: regular can feel predictable, controlled, song-like; irregular can feel surprising, disrupted, realistic',
        commonErrors: [
      ...
      },
      {
        id: 'poem-003',
        question:
          "Identify the poem's central image, metaphor, or symbol. What might it represent?",
        skillTested: 'Recognizing major figurative elements',
        expectedResponse:
          "Strong response identifies central image/metaphor, explores what it represents, considers multiple interpretations, and discusses how it's developed throughout",
        commonErrors: [
      ...
      },
      {
        id: 'poem-004',
        question:
          "How does the poem's pacing shift? Are lines long or short? Where do breaks occur?",
        skillTested: 'Analyzing form elements: line length, stanzaic structure, enjambment',
        expectedResponse:
          'Strong response describes pacing changes, identifies long/short lines and effects, notes enjambment or breaks, and discusses how these create rhythm and meaning',
        commonErrors: [
      ...
      },
      {
        id: 'poem-005',
        question:
          "What is the poem's tone, and how do language choices create it? Does tone shift?",
        skillTested: 'Identifying tone and analyzing its linguistic creation',
        expectedResponse:
          'Strong response names tone, identifies specific language choices creating it, notes shifts if present, and discusses emotional effect. Shows that tone is created through deliberate choice',
        commonErrors: [
          'Not identifying tone clearly',
      ...
      },
      {
        ...
        expectedResponse:
          'Strong response identifies central concern, shows how the poem explores this through imagery and language, and acknowledges that themes often have complexity and multiple valid interpretations',
        commonErrors: [
    ...
    commonMisconceptions: [
      {
        id: 'misc-poem-001',
        misconception:
          "Poetry is mysterious and inaccessible; you either understand it or you don't",
        evidence: 'Students give up on unfamiliar poetry',
        correction:
          'Poetry is challenging but analyzable. It uses techniques purposefully. While multiple interpretations exist, not all are equally valid. Systematic close reading and attention to language reveal meaning',
        activities: [
      ...
      },
      {
        id: 'misc-poem-002',
        misconception:
          'Poetry has hidden meaning you have to find; analysis means guessing correctly',
        evidence: 'Students make unsupported interpretations',
        correction:
          'Poetry meaning is created through language, not hidden. Interpretations should be supported by textual evidence. Multiple valid interpretations can coexist. Analysis means explaining how language creates meaning',
        activities: [
      ...
      },
      {
        ...
        correction:
          'Form and content are inseparable. Line breaks, rhyme, meter, stanza structure-all these create meaning. Form is not decoration; it is fundamental',
        activities: [
      ...
      },
      {
        ...
        correction:
          'While poetry uses symbolism, not everything is symbolic. Concrete images can matter for themselves. Some elements are ornamental. All interpretations should be supported',
        activities: [
    ...
    interventionStrategies: [
      {
        ...
        duration: '4-5 lessons',
        description:
          'Teach explicit steps: (1) Read for impression and subject, (2) Analyze form, (3) Close read language, (4) Explore imagery and symbolism, (5) Consider theme and effect. Use the framework consistently. Gradually internalize the process',
        resources: [
      ...
      },
      {
        ...
        duration: '3-4 lessons',
        description:
          "Teach major formal elements: rhyme schemes, meter, line length, enjambment, stanzaic structure. Analyze how each affects the poem. Compare poems with different formal choices. Have students examine form's effects explicitly",
        resources: [
      ...
      },
      {
        ...
        duration: '2-3 lessons',
        description:
          'Establish that all interpretations require evidence. Teach what counts as evidence: specific language, images, formal choices, patterns. Practice finding evidence. Discuss when evidence strongly vs. weakly supports a reading',
        resources: [
      ...
      },
      {
        ...
        description:
          'Regular practice with variety of poems builds confidence. Start with more accessible poems, progress to challenging. Discuss poems collaboratively before individual analysis. Build community around poetry. Celebrate successful analysis',
        resources: [
