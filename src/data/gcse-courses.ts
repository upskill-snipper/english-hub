...
`,
      quiz: [
        {
          id: 'gcse-lr-m1-q1',
          question: 'How many marks is AQA Paper 1 Question 1 worth?',
        ...
        {
          id: 'gcse-lr-m1-q3',
          question: 'What is the most common reason students lose marks on Q1?',
          options: [
        ...
        {
          id: 'gcse-lr-m1-q4',
          question: 'Approximately how long should you spend on Paper 1 Q1 in the exam?',
          options: ['1-2 minutes', '5 minutes', '10 minutes', '15 minutes'],
          correct: 1,
          explanation:
...
`,
      quiz: [
        {
          id: 'gcse-lr-m2-q1',
          question: 'How many marks is Paper 1 Question 2 worth?',
        ...
        {
          id: 'gcse-lr-m2-q2',
          question: 'Which analytical framework is recommended for Q2 paragraphs?',
          options: [
        ...
        {
          id: 'gcse-lr-m2-q3',
          question: 'What does the term "connotation" refer to?',
          options: [
        ...
        {
          id: 'gcse-lr-m2-q4',
          question: 'Which of the following is an example of "feature spotting"?',
          options: [
...
`,
      quiz: [
        {
          id: 'gcse-lr-m3-q1',
          question: 'What does Paper 1 Q3 ask you to analyse?',
          options: [
        ...
        {
          id: 'gcse-lr-m3-q2',
          question: 'Which of the following is a structural feature?',
          options: [
        ...
        {
          id: 'gcse-lr-m3-q4',
          question: 'What is the most common mistake students make on Q3?',
          options: [
...
`,
      quiz: [
        {
          id: 'gcse-lr-m4-q1',
          question: 'How many marks is Paper 1 Question 4 worth?',
        ...
        {
          id: 'gcse-lr-m4-q2',
          question: 'What does Q4 primarily require you to do?',
          options: [
        ...
        {
          id: 'gcse-lr-m4-q3',
          question: 'Which phrase would best demonstrate evaluative writing?',
          options: [
            '"The writer uses a metaphor"',
        ...
        {
          id: 'gcse-lr-m4-q4',
          question: 'How long should you spend on Q4 in the exam?',
          options: ['5-10 minutes', '10-15 minutes', '20-25 minutes', '30-35 minutes'],
          correct: 2,
          explanation:
...
`,
      quiz: [
        {
          id: 'gcse-lr-m5-q1',
          question: 'How many statements must you select as true in Paper 2 Q1?',
        ...
        {
          id: 'gcse-lr-m5-q2',
          question: 'What happens if you shade five boxes instead of four?',
          options: [
        ...
        {
          id: 'gcse-lr-m5-q3',
          question: 'What type of information does Q1 test?',
          options: [
        ...
        {
          id: 'gcse-lr-m5-q4',
          question: 'What is the best strategy for tackling a statement you are unsure about?',
          options: [
...
`,
      quiz: [
        {
          id: 'gcse-lr-m6-q1',
          question: 'What skill does Paper 2 Q2 primarily test?',
          options: [
            'Language analysis',
            'Structural analysis',
        ...
        {
          id: 'gcse-lr-m6-q2',
          question: 'How should you structure your Q2 response?',
          options: [
        ...
        {
          id: 'gcse-lr-m6-q3',
          question: 'What is the key difference between Paper 2 Q2 and Q3?',
          options: [
        ...
        {
          id: 'gcse-lr-m6-q4',
          question: 'Which of the following is an effective comparative connective?',
          options: [
            '"Furthermore"',
...
`,
      quiz: [
        {
          id: 'gcse-lr-m7-q1',
          question: 'How many marks is Paper 2 Question 3 worth?',
        ...
        {
          id: 'gcse-lr-m7-q2',
          question: 'What is the key difference between Q2 and Q3 on Paper 2?',
          options: [
        ...
        {
          id: 'gcse-lr-m7-q3',
          question: 'What structure should each paragraph in a Q3 response follow?',
          options: [
        ...
        {
          id: 'gcse-lr-m7-q4',
          question: 'Which response demonstrates effective embedded comparison?',
          options: [
...
`,
      quiz: [
        ...
        {
          id: 'gcse-lr-m8-q2',
          question: 'What must you include in every Q4 paragraph?',
          options: [
        ...
        {
          id: 'gcse-lr-m8-q3',
          question: 'What is the key difference between Paper 2 Q3 and Q4?',
          options: [
        ...
        },
        {
          ...
          options: ['Hyperbole', 'Anecdote', 'Counter-argument', 'Direct address'],
          correct: 2,
          explanation:
  ...
  assessmentQuestions: [
    ...
    {
      id: 'gcse-lr-a2',
      question: 'Which analytical framework is most effective for Paper 1 Q2 paragraphs?',
      options: [
    ...
    {
      id: 'gcse-lr-a4',
      question: 'Paper 1 Q3 asks about structure. Which of the following is a structural feature?',
      options: [
    ...
    {
      id: 'gcse-lr-a6',
      question: 'Paper 1 Q4 is worth 20 marks. What does it require you to do?',
      options: [
    ...
    {
      id: 'gcse-lr-a7',
      question: 'Which phrase demonstrates evaluative writing suitable for Q4?',
      options: [
    ...
    {
      id: 'gcse-lr-a8',
      question: 'On Paper 2 Q1, what happens if a student shades six boxes instead of four?',
      options: [
    ...
    {
      id: 'gcse-lr-a10',
      question: 'Which connective is most effective for synthesising two sources in Q2?',
      options: [
        '"Furthermore"',
        '"Firstly"',
        '"In contrast to Source A, Source B suggests…"',
    ...
    {
      id: 'gcse-lr-a11',
      question: 'What is the critical difference between Paper 2 Q2 and Paper 2 Q3?',
      options: [
    ...
    {
      id: 'gcse-lr-a13',
      question: 'Paper 2 Q4 asks you to compare viewpoints. What must every paragraph include?',
      options: [
        'A quotation from Source A only',
    ...
    {
      id: 'gcse-lr-a14',
      question: 'What is a "counter-argument" in persuasive writing?',
      options: [
    ...
    {
      id: 'gcse-lr-a18',
      question: 'Which is the correct mark allocation for Paper 2 reading questions?',
      options: [
        'Q1: 4, Q2: 8, Q3: 8, Q4: 20',
        'Q1: 4, Q2: 8, Q3: 12, Q4: 16',
        'Q1: 4, Q2: 12, Q3: 12, Q4: 12',
    ...
    {
      id: 'gcse-lr-a20',
      question: 'Across both papers, which skill is tested by the highest number of total marks?',
      options: [
...
<div class="common-mistake"><strong>Common Mistake:</strong> Writing a plan so detailed that it becomes a first draft. Your plan should be rough, fast, and private - bullet points and single words are fine. No marker marks the plan, so do not waste time making it neat.</div>`,
      quiz: [
        {
          id: 'gcse-lw-m1-q1',
          question: 'How long should you spend planning a 45-minute writing task?',
          options: [
            '1-2 minutes',
            'About 5 minutes',
            '10-15 minutes',
            'You should not plan at all',
          ],
          correct: 1,
          explanation:
            'Five minutes of planning is the recommended time. It is enough to create a clear structure without eating into your writing time. The ideal split is 5 mins plan, 35 mins write, 5 mins proofread.',
        },
        {
          id: 'gcse-lw-m1-q2',
          question: 'What is a "conceptualised response"?',
          options: [
            'A response that uses long words',
            'A response shaped around a central idea from start to finish',
            'A response that includes a counter-argument',
            'A response written entirely in paragraphs',
          ],
          correct: 1,
          explanation:
            'A conceptualised response is one where a deliberate central idea or theme runs through the whole piece. Markers reward this because it shows the writer has crafted the work, not just improvised.',
        },
        {
          id: 'gcse-lw-m1-q3',
          question: 'What should you include in a mind map plan for creative writing?',
          options: [
            'Only the plot events in order',
            'Senses, mood, techniques, and structure',
            'A full first draft of your opening',
            'A list of every character name',
          ],
          correct: 1,
          explanation:
            'A good creative writing mind map branches into sensory details, mood/atmosphere, specific techniques you will use, and your structural approach. These ensure your writing is rich and deliberate.',
        },
        {
          id: 'gcse-lw-m1-q4',
          question: 'In a Paper 2 bullet outline, what goes in point 4?',
          options: [
            'Your weakest argument',
            'A personal anecdote',
            'A counter-argument followed by a rebuttal',
            'A summary of points 1-3',
          ],
          correct: 2,
          explanation:
            'Point 4 is where you acknowledge the opposing view and then dismantle it. This shows markers you can consider different perspectives, which is a higher-level skill rewarded in the marking guide.',
        },
      ],
    },
    {
      ...
      quiz: [
        {
          ...
          options: [
            ...
            'Reveal emotions through physical details rather than stating them directly',
            'Show your plan to markers',
            'Write in the present tense',
          ],
          correct: 1,
          explanation:
            '"Show, don\'t tell" means conveying emotions, atmosphere, or character through concrete physical details and actions rather than simply labelling them. "Her hands trembled" is more powerful than "She was nervous."',
        },
        {
          id: 'gcse-lw-m2-q2',
          question: 'How many senses should a top-band descriptive piece engage?',
          options: [
            'Only sight',
            'Sight and sound',
            'At least three to five senses',
            'Exactly two',
          ],
          correct: 2,
          explanation:
            'Top-band responses aim to engage multiple senses - ideally all five. This creates an immersive, textured experience for the reader and demonstrates sophisticated descriptive skill.',
        },
        {
          id: 'gcse-lw-m2-q3',
          question: 'What is pathetic fallacy?',
          options: [
            'A mistake in your writing',
            'Using weather or nature to mirror mood or emotion',
            'A type of unreliable narrator',
            'A paragraph that is too short',
          ],
          correct: 1,
          explanation:
            'Pathetic fallacy is when a writer uses elements of the natural world - weather, landscape, seasons - to reflect the mood of the scene or the emotions of a character. For example, a storm during an argument.',
        },
        {
          id: 'gcse-lw-m2-q4',
          question: 'What is a "zoom in/out" structural technique?',
          options: [
            'Using a magnifying glass image',
            'Shifting focus from a wide landscape to a tiny detail, or the reverse',
            'Writing in very large and very small handwriting',
            'Repeating the same sentence at different points',
          ],
          correct: 1,
          explanation:
            'Zoom in/out means moving your descriptive focus from a broad panorama to a precise detail (or the other way around). This gives your writing a cinematic quality and a clear sense of structure.',
        },
      ],
    },
    {
      ...
      quiz: [
        {
          ...
          question: 'What does "in medias res" mean?',
          options: [
            'At the very beginning of events',
          ...
          correct: 1,
          explanation:
            '"In medias res" is a Latin term meaning "in the middle of things." It is a narrative technique where the story begins mid-action, hooking the reader immediately and avoiding a slow build-up.',
        },
        {
          id: 'gcse-lw-m3-q2',
          question: 'What is the best approach to plot scope in a 45-minute narrative?',
          options: [
            'Cover an entire year of events',
            'Include at least five characters',
            'Focus on one event, one character, and one setting',
            'Write as many plot twists as possible',
          ],
          correct: 2,
          explanation:
            'A focused, controlled narrative scores higher than a sprawling one. Concentrating on one event, one main character, and one setting allows you to write with depth and detail within the time limit.',
        },
        {
          id: 'gcse-lw-m3-q3',
          question: 'How should dialogue tags be used in a narrative?',
          options: [
            'Use a different creative tag every time ("exclaimed," "bellowed," "retorted")',
            'Use "said" sparingly and show emotion through surrounding action',
            'Avoid dialogue entirely',
            'Always use adverbs with tags ("she said angrily")',
          ],
          correct: 1,
          explanation:
            '"Said" is almost invisible to readers and keeps the focus on the dialogue itself. Emotion is best conveyed through actions around the speech - for example, what the character does with their hands - rather than through constant adverbs or dramatic tags.',
        },
        {
          id: 'gcse-lw-m3-q4',
          question: 'Which is the strongest type of story ending for GCSE?',
          options: [
            'A long summary explaining what happened to every character',
            '"And then I woke up - it was all a dream"',
            'A subtle, image-based or circular ending',
            'A cliffhanger that leaves the entire story unresolved',
          ],
          correct: 2,
          explanation:
            'Subtle, image-based, or circular endings demonstrate sophistication and deliberate craft. "It was all a dream" endings are heavily penalised because they undermine the entire story. A good ending resonates, it does not explain.',
        },
      ],
    },
    {
      ...
      quiz: [
        {
          ...
          options: [
            'Adjectives, Facts, Onomatopoeia, Repetition, Endings, Similes, Tension',
            'Alliteration, Facts, Opinions, Rhetorical questions, Emotive language, Statistics, Three (rule of three)',
            'Audience, Form, Organisation, Register, Evidence, Structure, Tone',
            'Argument, Formal language, Opening, Rebuttal, Example, Summary, Theme',
          ],
          correct: 1,
          explanation:
            'AFOREST stands for Alliteration, Facts, Opinions, Rhetorical questions, Emotive language, Statistics, and Three (rule of three). These are the core persuasive techniques you should use in viewpoint writing.',
        },
        {
          id: 'gcse-lw-m4-q2',
          question: 'Why should you include a counter-argument in viewpoint writing?',
          options: [
            'To show you cannot make up your mind',
            'To fill up space',
            'To demonstrate mature, balanced thinking and then strengthen your own position',
            'Because the marking guide requires exactly four paragraphs',
          ],
          correct: 2,
          explanation:
            'Including a counter-argument shows markers that you can consider multiple perspectives - a higher-level skill. The key is to acknowledge the opposing view and then rebut it, which actually strengthens your argument.',
        },
        {
          id: 'gcse-lw-m4-q3',
          question: 'If the question asks you to write a speech, what must you include?',
          options: [
            'Addresses and a date',
            'Bullet points and subheadings',
            'Direct address to the audience and rhetorical techniques',
            'A bibliography',
          ],
          correct: 2,
          explanation:
            'A speech must directly address the audience ("Ladies and gentlemen," "you," "we") and use spoken-word techniques like rhetorical questions, repetition, and the rule of three. Ignoring the form conventions loses marks.',
        },
        {
          id: 'gcse-lw-m4-q4',
          ...
          options: [
            ...
            'To make an abstract argument feel personal and real',
            'To meet the word count',
            'To prove you have done research',
          ],
          correct: 1,
          explanation:
            'Anecdotes - short personal stories - make arguments concrete and relatable. They help the reader connect emotionally to your point, which is far more persuasive than abstract reasoning alone.',
        },
      ],
    },
    {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Using minor sentences (fragments) in every paragraph. One or two across the whole piece create impact. Five or six suggest you do not know how to write a complete sentence. Markers needs to see range, not repetition of one trick.</div>`,
      quiz: [
        {
          id: 'gcse-lw-m5-q1',
          question: 'Why are short sentences most effective after longer ones?',
          options: [
            'Because markers prefer short sentences',
            'Because the contrast creates sudden impact, like a punch',
            'Because they save time',
            'Because they are grammatically simpler',
          ],
          correct: 1,
          explanation:
            'Short sentences create impact through contrast. After long, flowing sentences, a short one creates a sudden shift in pace that catches the reader off guard. Without the contrast, the effect is lost.',
        },
        {
          id: 'gcse-lw-m5-q2',
          ...
          options: [
            ...
            'A word or phrase that signals the direction of your argument (e.g., "however," "furthermore")',
            'A pen used for marking exams',
            'A paragraph that contains only dialogue',
          ],
          correct: 1,
          explanation:
            'Discourse markers are connective words and phrases like "however," "furthermore," "consequently," and "on the other hand" that guide the reader through your argument by showing the relationship between ideas.',
        },
        {
          id: 'gcse-lw-m5-q3',
          question: 'How often should you use a one-line paragraph?',
          options: [
            'Every other paragraph',
            'Once or twice per piece for maximum impact',
            'Never - paragraphs must always be at least three sentences',
            'In every paragraph to keep things concise',
          ],
          correct: 1,
          explanation:
            'A one-line paragraph isolates a moment or idea, giving it enormous weight. Using it once or twice per piece creates genuine impact. Using it constantly dilutes the effect and looks like you cannot develop ideas.',
        },
        {
          id: 'gcse-lw-m5-q4',
          question: 'What does the marking guide mean by "a range of sentence forms"?',
          options: [
            'Using only complex sentences',
            'Varying sentence lengths and types deliberately for effect',
            'Writing at least 30 sentences',
            'Starting every sentence with a different word',
          ],
          correct: 1,
          explanation:
            'The marking guide rewards deliberate variety - using simple, compound, complex, and minor sentences where each choice serves the meaning. It is about conscious control, not random variation.',
        },
      ],
    },
    {
      ...
      quiz: [
        {
          ...
          options: [
            'Connotation is the spelling; denotation is the pronunciation',
            'Denotation is the dictionary meaning; connotation is the emotional or cultural associations',
            'They are the same thing',
            'Connotation only applies to nouns',
          ],
          correct: 1,
          explanation:
            'Denotation is a word\'s literal, dictionary meaning. Connotation is the feelings, associations, and implied meanings a word carries. "Home" and "house" denote the same thing, but "home" connotes warmth and belonging.',
        },
        {
          id: 'gcse-lw-m6-q2',
          question: 'What does the marking guide mean by "ambitious vocabulary"?',
          options: [
            'Using the longest words you can find',
            'Choosing the most precise, evocative word for each moment',
            'Using at least 50 different adjectives',
            'Only using words with four or more syllables',
          ],
          correct: 1,
          explanation:
            'Ambitious vocabulary means selecting words with precision and purpose - choosing the word that captures exactly the right shade of meaning. A well-chosen short word can be more ambitious than a misused long one.',
        },
        {
          id: 'gcse-lw-m6-q3',
          question: 'Why should you avoid cliches in your writing?',
          options: [
            'They are too short',
            'They are grammatically incorrect',
            'They are overused and have lost their impact',
            'They are too difficult for markers to understand',
          ],
          correct: 2,
          explanation:
            "Cliches are phrases so familiar they no longer create any vivid picture in the reader's mind. They signal lazy writing. Markers reward originality, so push past your first instinct and find a fresher way to express the idea.",
        },
        {
          id: 'gcse-lw-m6-q4',
          question: 'Which is the best replacement for "walked slowly"?',
          options: ['Perambulated leisurely', 'Trudged', 'Moved in a slow walking manner', 'Went'],
          correct: 1,
          explanation:
            '"Trudged" is a single, precise verb that conveys slow, heavy, reluctant movement. It is ambitious but natural. "Perambulated leisurely" is over-the-top and sounds unnatural. "Went" is too vague. A strong verb does the work of a verb and an adverb combined.',
        },
      ],
    },
    {
      ...
      quiz: [
        {
          ...
          options: [
            ...
            'Forgetting to use a comma after a name',
            'Using a comma instead of an apostrophe',
          ],
          correct: 1,
          explanation:
            'A comma splice occurs when two independent clauses (complete sentences) are joined with just a comma. For example: "It was raining, we stayed inside." Fix it with a full stop, semi-colon, or conjunction.',
        },
        {
          id: 'gcse-lw-m7-q2',
          question: 'How many marks is technical accuracy worth on each writing paper?',
          options: ['8 marks', '12 marks', '16 marks', '24 marks'],
          correct: 2,
          explanation:
            'Technical accuracy (spelling, punctuation, and grammar) is worth 16 out of 40 marks on the writing section - that is 40% of your mark. It is one of the easiest areas to improve with practice and careful proofreading.',
        },
        {
          id: 'gcse-lw-m7-q3',
          question: 'Which sentence uses a semi-colon correctly?',
          options: [
            'The dog was tired; and it slept.',
            'The rain hammered the roof; inside, nobody spoke.',
            'She went to the shop; milk, bread, eggs.',
            'He ran fast; because he was late.',
          ],
          correct: 1,
          explanation:
            'A semi-colon correctly joins two closely related independent clauses that could each stand alone as sentences. "The rain hammered the roof" and "inside, nobody spoke" are both complete ideas linked by theme.',
        },
        {
          id: 'gcse-lw-m7-q4',
          question: 'What should you do if you are unsure how to spell a word in the exam?',
          options: [
            'Leave a blank space',
            'Guess and hope for the best',
            'Use a synonym you can spell correctly',
            'Write it phonetically',
          ],
          correct: 2,
          explanation:
            'If you cannot spell a word, replace it with a synonym you are confident about. Markers cannot penalise a word you did not write, and using a well-spelled alternative keeps your technical accuracy marks safe.',
        },
      ],
    },
  ],
  assessmentQuestions: [
    {
      ...
      options: [
        '5 mins plan, 35 mins write, 5 mins proofread',
        '10 mins plan, 35 mins write, 0 mins proofread',
        '0 mins plan, 40 mins write, 5 mins proofread',
        '5 mins plan, 40 mins write, 0 mins proofread',
      ],
      correct: 0,
      explanation:
        'The 5-35-5 split is the recommended approach. Planning ensures your writing has direction and structure, while proofreading catches SPaG errors that could cost several marks.',
    },
    {
      id: 'gcse-lw-a2',
      ...
      options: [
        'She was very afraid.',
        'Her fingers whitened around the door handle; she could not make herself turn it.',
        'She felt fear running through her body.',
        'The character experienced a feeling of intense terror.',
      ],
      correct: 1,
      explanation:
        '"Show, don\'t tell" conveys emotion through physical details rather than labelling the feeling. Whitened fingers and an inability to turn the handle show fear far more vividly than stating "she was afraid."',
    },
    {
      id: 'gcse-lw-a3',
      question: 'What is a "conceptualised response"?',
      options: [
        'A response written entirely in bullet points',
        'A response that uses difficult vocabulary throughout',
        'A response shaped around a central idea or theme from start to finish',
        'A response that follows the exact structure of the example in the textbook',
      ],
      correct: 2,
      explanation:
        'A conceptualised response is deliberately crafted around a unifying idea or theme. It demonstrates that the writer planned and controlled the piece rather than writing randomly.',
    },
    {
      id: 'gcse-lw-a4',
      ...
      correct: 2,
      explanation:
        "A formal letter requires your address (top right), the recipient's address (left), the date, an appropriate greeting (Dear Sir/Madam or Dear Mr/Ms), and a sign-off (Yours faithfully/sincerely). Missing these loses marks for form.",
    },
    {
      id: 'gcse-lw-a5',
      ...
      correct: 2,
      explanation:
        '"The sun set, the stars appeared" is a comma splice - two complete sentences joined by only a comma. The other options fix this with a conjunction, a semi-colon, or a full stop.',
    },
    {
      id: 'gcse-lw-a6',
      question: 'What does AFOREST stand for?',
      options: [
        'Alliteration, Facts, Opinions, Rhetorical questions, Emotive language, Statistics, Three',
        'Adjectives, Facts, Onomatopoeia, Repetition, Emotive language, Similes, Tension',
        'Alliteration, Form, Organisation, Rhetoric, Evidence, Structure, Tone',
        'Anecdotes, Facts, Opinions, Repetition, Examples, Statistics, Tricolon',
      ],
      correct: 0,
      explanation:
        'AFOREST is a mnemonic for persuasive techniques: Alliteration, Facts, Opinions, Rhetorical questions, Emotive language, Statistics, and Three (rule of three).',
    },
    {
      id: 'gcse-lw-a7',
      question: 'What does "in medias res" mean?',
      options: [
        'At the very end of events',
      ...
      correct: 2,
      explanation:
        '"In medias res" is Latin for "in the middle of things." It means beginning a story mid-action to immediately engage the reader, rather than starting with slow background information.',
    },
    {
      id: 'gcse-lw-a8',
      question: 'Which is the best example of ambitious vocabulary replacing a weak verb?',
      options: [
        'He walked quickly → He moved at speed',
        'He walked quickly → He sprinted',
        'He walked quickly → He perambulated hastily',
        'He walked quickly → He went fast',
      ],
      correct: 1,
      explanation:
        '"Sprinted" is a single precise verb that replaces both a weak verb and its adverb. It is ambitious but natural. "Perambulated hastily" is over-the-top, while "went fast" and "moved at speed" are vague.',
    },
    {
      id: 'gcse-lw-a9',
      question:
        'How many marks is technical accuracy (SPaG) worth out of 40 on the writing question?',
      options: ['8 marks', '12 marks', '16 marks', '24 marks'],
      correct: 2,
      explanation:
        'Technical accuracy accounts for 16 out of 40 marks - 40% of your writing score. This covers spelling, punctuation, grammar, and sentence control.',
    },
    {
      id: 'gcse-lw-a10',
      ...
      options: [
        ...
        'Overuse suggests you cannot write complete sentences and reduces your demonstrated range',
        'Markers will stop reading',
        'They make your writing too long',
      ],
      correct: 1,
      explanation:
        'One or two fragments create deliberate impact, but overusing them suggests a limited range of sentence forms. The marking guide rewards variety - markers need to see you can control simple, compound, and complex sentences too.',
    },
    {
      id: 'gcse-lw-a11',
      question:
        'Which structural technique involves ending a piece with the same image it opened with?',
      options: ['In medias res', 'Flashback', 'Circular structure', 'Zoom in/out'],
      correct: 2,
      explanation:
        'A circular structure returns to the opening image, setting, or idea at the end - but with something changed. This creates a sense of completeness and shows deliberate structural control.',
    },
    {
      id: 'gcse-lw-a12',
      question: 'What is the difference between connotation and denotation?',
      options: [
        'Connotation is the literal meaning; denotation is the implied meaning',
        'Denotation is the dictionary meaning; connotation is the emotional associations',
        'They mean the same thing',
        'Connotation applies to verbs; denotation applies to nouns',
      ],
      correct: 1,
      explanation:
        'Denotation is a word\'s literal, dictionary meaning. Connotation is the emotional, cultural, or implied associations a word carries. "Home" denotes a dwelling but connotes warmth and belonging.',
    },
    {
      id: 'gcse-lw-a13',
      ...
      options: [
        ...
        'To fill space and reach the word count',
        'To show balanced, mature thinking and then strengthen your own position',
        'Because the marking guide says you must write exactly five paragraphs',
      ],
      correct: 2,
      explanation:
        'A counter-argument demonstrates that you can engage with different perspectives - a higher-order skill. Acknowledging the opposition and then rebutting it actually makes your own argument more convincing.',
    },
    {
      id: 'gcse-lw-a14',
      question: 'Which sentence uses a semi-colon correctly?',
      options: [
        'She loved the garden; and the flowers.',
        'The city was alive; music poured from every doorway.',
        'He bought; apples, oranges, and bananas.',
        'Running fast; she tripped.',
      ],
      correct: 1,
      explanation:
        'A semi-colon joins two independent clauses that are closely related. "The city was alive" and "music poured from every doorway" are both complete sentences linked by theme, making this the correct usage.',
    },
    {
      id: 'gcse-lw-a15',
      question: 'What is pathetic fallacy?',
      ...
      correct: 1,
      explanation:
        'Pathetic fallacy is when elements of the natural world - weather, seasons, landscape - are used to mirror the mood of a scene or the emotions of a character. For example, a thunderstorm during a moment of anger.',
    },
    {
      id: 'gcse-lw-a16',
      question: 'Which opening technique is most effective for a narrative?',
      options: [
        'The alarm clock buzzed and I got out of bed.',
        '"Don\'t open that door."',
        'My name is Sarah and I am going to tell you a story.',
        'It was a normal day, just like any other.',
      ],
      correct: 1,
      explanation:
        'A line of dialogue thrown in mid-action immediately hooks the reader and creates intrigue. The alarm clock opening is a notorious cliche. Introducing yourself or saying "it was a normal day" is flat and wastes your strongest moment.',
    },
    {
      id: 'gcse-lw-a17',
      ...
      options: [
        ...
        'Comma splicing (joining sentences with commas)',
        'Overusing semi-colons',
        'Forgetting question marks',
      ],
      correct: 1,
      explanation:
        'Comma splicing - joining two independent clauses with just a comma - is the most common punctuation error markers see at GCSE. It can be fixed with a full stop, a semi-colon, or by adding a conjunction.',
    },
    {
      id: 'gcse-lw-a18',
      ...
      options: [
        ...
        'Using bullet points for every paragraph',
        'Directly addressing the audience',
        'Writing in the third person',
      ],
      correct: 2,
      explanation:
        'A speech must directly address the audience using "you," "we," and phrases like "Ladies and gentlemen." This distinguishes it from other forms and demonstrates that you understand the conventions of the task.',
    },
    {
      id: 'gcse-lw-a19',
      question: 'What should you do during the last 5 minutes of a writing exam?',
      options: [
        'Write a new concluding paragraph',
        'Add more descriptive detail to your opening',
        'Proofread for SPaG errors and correct mistakes',
        'Start the next question early',
      ],
      correct: 2,
      explanation:
        'The final five minutes should be dedicated to proofreading. Catching and correcting spelling, punctuation, and grammar errors in this time can gain you 3-4 marks. Corrections with a single line through the mistake are perfectly acceptable.',
    },
    {
      id: 'gcse-lw-a20',
      question: 'Which of these is a cliche that should be avoided?',
      options: [
        'The factory loomed above the street, its walls swallowing the light.',
        'Her heart pounded like a drum.',
        'The silence folded itself around us like a held breath.',
        'Morning arrived with the reluctance of a Monday.',
      ],
      correct: 1,
      explanation:
        '"Her heart pounded like a drum" is one of the most overused similes in student writing. It no longer creates any vivid image. The other options use original figurative language that feels fresh and specific.',
    },
  ],
}
...
`,
      quiz: [
        ...
        {
          id: 'gcse-lp-m1-q3',
          question: 'What is the main danger of "technique-spotting" without further comment?',
          options: [
            'It takes too long',
...
`,
      quiz: [
        ...
        {
          id: 'gcse-lp-m3-q3',
          question: 'What is the difference between identifying a theme and analysing a theme?',
          options: [
        ...
        {
          id: 'gcse-lp-m3-q4',
          question: 'When can you make contextual comments in an unseen poetry response?',
          options: [
...
`,
      quiz: [
        ...
        {
          id: 'gcse-lp-m4-q2',
          question: 'In the wall extract, why is the final line placed in its own stanza?',
          options: [
        ...
        {
          id: 'gcse-lp-m4-q4',
          question: 'What is the rhythmic pattern of iambic pentameter?',
          options: [
...
`,
      quiz: [
        ...
        {
          id: 'gcse-lp-m5-q2',
          question: 'What is the recommended approach when comparing two poems in an essay?',
          options: [
        ...
        {
          id: 'gcse-lp-m5-q4',
          question: 'In the model answer, why is the analysis of "setting glue" effective?',
          options: [
...
`,
      quiz: [
        ...
        {
          id: 'gcse-lp-m6-q3',
          question: 'Which of the following is a useful comparative connective?',
          options: ['"Furthermore"', '"In contrast"', '"For example"', '"In conclusion"'],
          correct: 1,
          explanation:
        ...
        {
          id: 'gcse-lp-m6-q4',
          question: 'How much time should you approximately spend on the comparison question?',
          options: ['10 minutes', '20 minutes', '35 minutes', '45 minutes'],
          correct: 1,
          explanation:
  ...
  assessmentQuestions: [
    ...
    {
      id: 'gcse-lp-a5',
      question: 'A Shakespearean sonnet typically ends with which structural feature?',
      options: ['A sestet', 'A rhyming couplet', 'A single isolated line', 'A repeated refrain'],
      correct: 1,
      explanation:
    ...
    {
      id: 'gcse-lp-a6',
      question: 'When comparing two poems, which approach is most effective?',
      options: [
    ...
    {
      id: 'gcse-lp-a7',
      question: 'Which term describes the repetition of "s" and "sh" sounds in a line of poetry?',
      options: ['Alliteration', 'Assonance', 'Sibilance', 'Onomatopoeia'],
      correct: 2,
      explanation:
    ...
    {
      id: 'gcse-lp-a8',
      question: 'Why is it important to use tentative language when analysing poetry?',
      options: [
    ...
    {
      id: 'gcse-lp-a10',
      question: 'What is the key difference between surface meaning and deeper meaning?',
      options: [
    ...
    {
      id: 'gcse-lp-a11',
      question: 'Which of the following best describes caesura?',
      options: [
    ...
    {
      id: 'gcse-lp-a13',
      question: 'In an essay, what is the purpose of the "L" (Link) in a PETAL paragraph?',
      options: [
    ...
    },
    {
      ...
      options: ['Sonnet', 'Free verse poem', 'Dramatic monologue', 'Ballad'],
      correct: 2,
      explanation:
    ...
    {
      id: 'gcse-lp-a15',
      question: 'Why might a poet choose to use free verse rather than a strict form?',
      options: [
    ...
    {
      id: 'gcse-lp-a16',
      question: 'Which of these is the strongest analytical statement?',
      options: [
    ...
    },
    {
      ...
      options: ['AABB CCDD EEFF GG', 'ABAB CDCD EFEF GG', 'ABBA ABBA CDE CDE', 'ABCABC DEFDEF GG'],
      correct: 1,
      explanation:
    ...
    {
      id: 'gcse-lp-a19',
      question: 'How many times should you ideally read an unseen poem before writing your answer?',
      ...
      quiz: [
        {
          ...
          correct: 1,
          explanation:
            'Macbeth himself identifies "vaulting ambition" as his only motivation. This unchecked ambition is his hamartia - the fatal flaw that drives his downfall from loyal warrior to tyrannical murderer.',
        },
        {
          id: 'gcse-ld-m1-q2',
          question: 'What does Lady Macbeth ask the spirits to do in Act 1 Scene 5?',
          options: [
            'Kill King Duncan for her',
            'Make her invisible',
            'Unsex her and fill her with cruelty',
            'Give her the power to see the future',
          ],
          correct: 2,
          explanation:
            'Lady Macbeth calls on spirits to "unsex me here" and fill her with "direst cruelty." She wants to reject feminine compassion so she can drive the murder of Duncan without hesitation.',
        },
        {
          id: 'gcse-ld-m1-q3',
          question: "How does Lady Macbeth's sleepwalking scene connect to the theme of guilt?",
          options: [
            'It shows she is physically ill from lack of sleep',
            'It shows guilt cannot be suppressed and will resurface',
            'It proves the witches have cursed her',
            'It demonstrates that she regrets marrying Macbeth',
          ],
          correct: 1,
          explanation:
            'Lady Macbeth tried to suppress her guilt ("A little water clears us of this deed") but it erupts in her unconscious mind. Her obsessive handwashing shows guilt is inescapable, mirroring Macbeth\'s earlier vision of bloody hands.',
        },
        {
          id: 'gcse-ld-m1-q4',
          question: 'What is the significance of the word "wyrd" in relation to the Weird Sisters?',
          options: [
            'It means they are strange or bizarre',
            'It comes from Old English meaning fate or destiny',
            'It is a Scottish dialect word for witch',
            'It describes their physical appearance',
          ],
          correct: 1,
          explanation:
            '"Wyrd" is Old English for fate or destiny. Calling the witches "Weird Sisters" links them to the concept of fate and raises the key question of whether Macbeth\'s downfall was predestined or a result of his own choices.',
        },
      ],
    },
    {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Bolting on context as a separate paragraph. Instead, weave it into your analysis: "Shakespeare uses the chaos in nature after Duncan's murder to reflect the Jacobean belief in the Divine Right of Kings - regicide disrupts the God-given natural order."</div>`,
      quiz: [
        {
          id: 'gcse-ld-m2-q1',
          question: "What is the purpose of Macbeth's dagger soliloquy (Act 2, Scene 1)?",
          options: [
            'To show Macbeth boasting about his plan',
            "To reveal Macbeth's fractured mental state before the murder",
            'To explain the history of the dagger',
            'To show Macbeth communicating with the witches',
          ],
          correct: 1,
          explanation:
            "The dagger soliloquy exposes Macbeth's inner turmoil. His questions, contradictions, and hallucination of a bloody dagger reveal a mind at war with itself, building tension for the audience before Duncan's murder.",
        },
        {
          id: 'gcse-ld-m2-q2',
          question: 'What is dramatic irony in the context of Macbeth?',
          options: [
            'When characters make funny jokes on stage',
            'When the audience knows something the characters do not',
            'When the stage directions contradict the dialogue',
            'When a character speaks in rhyming couplets',
          ],
          correct: 1,
          explanation:
            "Dramatic irony occurs when the audience has knowledge that a character lacks. For example, when Duncan praises Macbeth's castle as pleasant, the audience knows he is about to be murdered there - creating tension and horror.",
        },
        {
          id: 'gcse-ld-m2-q3',
          question: 'Why is the Jacobean context of the Gunpowder Plot (1605) relevant to Macbeth?',
          options: [
            'Shakespeare was involved in the plot',
            'It explains why the play is set in Scotland',
            'A play about regicide would have powerfully resonated with an audience who had recently survived an assassination attempt on their king',
            'It is the reason the play features witches',
          ],
          correct: 2,
          explanation:
            'The Gunpowder Plot was a failed attempt to assassinate King James I in 1605. Macbeth, written around 1606, dramatises the horror of regicide and its consequences - a theme that would have felt immediate and dangerous to the original audience.',
        },
        {
          id: 'gcse-ld-m2-q4',
          question: '"Fair is foul, and foul is fair" is an example of which technique?',
          options: ['Simile', 'Onomatopoeia', 'Paradox', 'Alliteration only'],
          correct: 2,
          explanation:
            '"Fair is foul, and foul is fair" is a paradox - a statement that contradicts itself. It establishes the play\'s central theme that appearances are deceptive and moral boundaries are blurred. It also contains alliteration of the "f" sound, but paradox is the primary technique.',
        },
      ],
    },
    {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Describing the Inspector as a normal detective. He is a dramatic device - possibly supernatural - used by Priestley to expose the Birlings' guilt and deliver the play's socialist message. Treat him as a symbol, not a realistic character.</div>`,
      quiz: [
        {
          id: 'gcse-ld-m3-q1',
          question: 'Why does Priestley set the play in 1912 but write it in 1945?',
          options: [
            'Because the play is based on a true story from 1912',
            "To create dramatic irony - the audience knows Birling's confident predictions are wrong",
            'Because he wanted to write a historical drama',
            'To avoid censorship laws of the 1940s',
          ],
          correct: 1,
          explanation:
            'Priestley uses the time gap to create dramatic irony. When Birling says the Titanic is "unsinkable" and predicts no war, the 1945 audience knows he is completely wrong. This undermines Birling\'s authority and exposes his arrogant worldview.',
        },
        {
          id: 'gcse-ld-m3-q2',
          question: 'Which character undergoes the most significant transformation in the play?',
          options: ['Arthur Birling', 'Mrs Birling', 'Sheila Birling', 'Gerald Croft'],
          correct: 2,
          explanation:
            'Sheila changes the most dramatically. She moves from a naive, privileged young woman to someone who fully accepts responsibility, challenges her parents, and refuses to pretend "nothing happened." She represents Priestley\'s hope for the younger generation.',
        },
        {
          id: 'gcse-ld-m3-q3',
          question:
            'What does Inspector Goole\'s final speech - "fire and blood and anguish" - refer to?',
          options: [
            'The fires that will destroy the Birling factory',
            'The two World Wars that the 1945 audience had lived through',
            'A biblical prophecy about the end of the world',
            'The violent revolution that Priestley wanted to start',
          ],
          correct: 1,
          explanation:
            'The phrase "fire and blood and anguish" refers to the two World Wars (1914-18 and 1939-45). The 1945 audience had just experienced this. Priestley is arguing that selfishness, inequality, and refusing social responsibility lead to catastrophic consequences.',
        },
        {
          id: 'gcse-ld-m3-q4',
          question:
            'Why is the Inspector best understood as a dramatic device rather than a realistic character?',
          options: [
            'Because he is played by a different actor in each performance',
            'Because his name "Goole" suggests "ghoul," he may be supernatural, and he functions as Priestley\'s moral mouthpiece',
            'Because he only appears in Act 1',
            'Because he is based on a real inspector from 1912',
          ],
          correct: 1,
          explanation:
            'The Inspector is mysterious and possibly supernatural - his name suggests "ghoul." He knows everything, delivers Priestley\'s socialist message, and vanishes. He is a dramatic device designed to force the Birlings (and the audience) to examine their moral responsibility.',
        },
      ],
    },
    {
      ...
      quiz: [
        {
          ...
          options: [
            'The time of day changing from evening to night',
            'The shift from comfortable self-deception to harsh moral scrutiny',
            'The Inspector turning on more lights to search for evidence',
            "The deterioration of the Birlings' electricity supply",
          ],
          correct: 1,
          explanation:
            '"Pink and intimate" represents the Birlings\' comfortable, rose-tinted worldview. "Brighter and harder" represents the harsh truth the Inspector forces them to confront. Priestley uses lighting symbolically to reinforce his theme that the privileged must face the reality of inequality.',
        },
        {
          id: 'gcse-ld-m4-q2',
          question: 'Why does Priestley set the entire play in one room on one evening?',
          options: [
            'Because he could not afford multiple sets',
            'To create a claustrophobic, pressure-cooker atmosphere with no escape for the Birlings',
            'Because the story only requires one location',
            'To make the play shorter and easier to perform',
          ],
          correct: 1,
          explanation:
            "By following the classical unities (one room, one evening, real time), Priestley creates a claustrophobic atmosphere. The Birlings cannot escape the Inspector's questioning, which builds tension and mirrors the inescapability of moral accountability.",
        },
        {
          id: 'gcse-ld-m4-q3',
          question:
            'What does Birling\'s line "A man has to mind his own business and look after himself" represent?',
          options: [
            "Priestley's own political views",
            'The capitalist, individualist philosophy that Priestley is criticising',
            'Good advice for the audience',
            'A compromise between socialism and capitalism',
          ],
          correct: 1,
          explanation:
            "Birling's philosophy of selfish individualism represents the capitalist worldview that Priestley, a committed socialist, is attacking. By making Birling arrogant, wrong about the Titanic, and morally bankrupt, Priestley discredits this philosophy and promotes collective responsibility instead.",
        },
        {
          id: 'gcse-ld-m4-q4',
          question: 'Why is the final phone call (announcing a real inspector) significant?',
          options: [
            'It proves the first Inspector was fake',
            'It sets up a sequel to the play',
            "It represents a second chance to learn the lesson and mirrors the 1945 audience's own second chance",
            'It is a plot twist designed purely for entertainment',
          ],
          correct: 2,
          explanation:
            'The final phone call gives the Birlings - and symbolically the audience - a second chance. Just as Britain in 1945 had a second chance to build a fairer society after two world wars, the Birlings have another opportunity to accept responsibility. Priestley warns that ignoring the lesson means the consequences will repeat.',
        },
      ],
    },
    {
      ...
      quiz: [
        {
          id: 'gcse-ld-m5-q1',
          question:
            'What should you do FIRST when you encounter a 19th-century novel extract in the exam?',
          options: [
            'Start writing your essay immediately',
            'Try to identify which novel it is from',
            'Read the extract twice - once for meaning, once for detail',
            'Count the number of paragraphs',
          ],
          correct: 2,
          explanation:
            'Always read the extract twice. The first reading gives you overall meaning and tone. The second allows you to notice specific language choices, techniques, and details that you can analyse in your essay.',
        },
        {
          id: 'gcse-ld-m5-q2',
          question: 'Which of the following is a gothic convention?',
          options: [
            'A realistic urban setting with factories',
            'Humorous dialogue between characters',
            'Dark, isolated settings with supernatural elements and extreme emotions',
            'A happy ending with a wedding',
          ],
          correct: 2,
          explanation:
            'Gothic conventions include dark or isolated settings (castles, moors), the supernatural (ghosts, the uncanny), and extreme emotions (terror, madness, despair). These elements create an atmosphere of mystery, dread, and psychological intensity.',
        },
        {
          id: 'gcse-ld-m5-q3',
          question: 'What is pathetic fallacy?',
          options: [
            ...
            "When weather or landscape reflects a character's emotions or the mood of a scene",
            'When the narrator directly addresses the reader',
            'When animals are given human characteristics',
          ],
          correct: 1,
          explanation:
            "Pathetic fallacy is the literary technique of using weather, landscape, or natural phenomena to reflect characters' emotions or the mood. A storm during a moment of conflict, or fog during confusion, are classic examples found throughout 19th-century fiction.",
        },
        {
          id: 'gcse-ld-m5-q4',
          question:
            'Why is social class an important contextual lens for analysing 19th-century texts?',
          options: [
            'Because all Victorian novels are about wealthy people',
            'Because Victorian society was rigidly divided by class, and many writers used fiction to expose inequality and injustice',
            'Because markers only give marks for discussing class',
            'Because there were no other important themes in the 19th century',
          ],
          correct: 1,
          explanation:
            'Victorian Britain had extreme class divisions. Many 19th-century novelists - Dickens, Gaskell, Hardy, Brontë - used their fiction to expose the suffering of the poor and critique the selfishness of the wealthy. Recognising class dynamics in an extract and linking them to this context will strengthen your analysis.',
        },
      ],
    },
    {
      ...
      quiz: [
        {
          ...
          options: [
            ...
            'A quotation from the text that proves your point',
            'A single sentence at the start of your essay that presents your overall argument',
            'A list of the points you will make in your essay',
          ],
          correct: 2,
          explanation:
            'A thesis statement is one clear sentence at the beginning of your essay that states your overall argument in response to the question. It gives your essay a clear direction and shows markers you have a focused, considered response.',
        },
        {
          id: 'gcse-ld-m6-q2',
          question: 'Which of the following is a strong topic sentence?',
          options: [
            'In the play, Macbeth kills Duncan.',
            "Shakespeare uses the witches' prophecy to ignite Macbeth's latent ambition, suggesting his desire for power existed before their intervention.",
            'This paragraph is about ambition.',
            'There are many themes in Macbeth such as guilt and ambition.',
          ],
          correct: 1,
          explanation:
            'A strong topic sentence makes an argument, names the writer and their technique, and links directly to the theme in the question. Option B does all three in one sentence, immediately signalling a high-quality analytical paragraph.',
        },
        {
          id: 'gcse-ld-m6-q3',
          question:
            'In the WHAT-HOW-WHY paragraph structure, what does the "WHY" step require you to do?',
          options: [
            'Retell what happens in the scene',
            'Identify the technique the writer uses',
            'Explain why the writer made this choice by linking to theme, context, or their message',
            'Write a quotation from the text',
          ],
          correct: 2,
          explanation:
            'The "WHY" step is where you explain the writer\'s purpose - why they made this particular choice. This is where you link to themes, context, character development, or the writer\'s overall message. It is the step that moves your answer from description to genuine analysis.',
        },
        {
          id: 'gcse-ld-m6-q4',
          question: 'Which is the better way to use context in a literature essay?',
          options: [
            'Write a separate paragraph at the end listing historical facts',
            'Weave context into your analysis by explaining why the writer made specific choices in relation to their society',
            'Mention context in your introduction and never refer to it again',
            'Only include context if the question specifically asks for it',
          ],
          correct: 1,
          explanation:
            'Context should be integrated into your analysis, not bolted on as a separate paragraph. The best approach is to use context to explain WHY the writer made a particular choice: "Shakespeare\'s Jacobean audience would have viewed regicide as a sin against God, which intensifies the horror of Duncan\'s murder."',
        },
      ],
    },
  ],
  assessmentQuestions: [
    {
      ...
      options: ['Cowardice', 'Vaulting ambition', 'Jealousy', 'Greed'],
      correct: 1,
      explanation:
        'Macbeth\'s hamartia (tragic flaw) is his "vaulting ambition." He identifies this himself in Act 1 Scene 7, and it is the driving force behind every destructive choice he makes in the play.',
    },
    {
      id: 'gcse-ld-a2',
      question:
      ...
      options: [
        'He is too generous with money',
        'He is too compassionate and gentle to commit murder',
        'He drinks too much milk',
        'He is too kind to the servants',
      ],
      correct: 1,
      explanation:
        'Lady Macbeth fears her husband is too gentle and moral - too full of natural human compassion - to seize the crown by murder. The metaphor of "milk" suggests softness, nurture, and innocence, qualities she sees as weaknesses.',
    },
    {
      id: 'gcse-ld-a3',
      question: 'What is the significance of the phrase "Fair is foul, and foul is fair"?',
      options: [
        'It describes the weather in Scotland',
        'It is a paradox that establishes the theme that nothing is what it seems',
        "It is the witches' greeting to Macbeth",
        'It describes the difference between England and Scotland',
      ],
      correct: 1,
      explanation:
        "This paradox, spoken by the witches in the opening scene, establishes a central theme: appearances are deceptive and moral boundaries are blurred. It foreshadows the play's events where honourable-seeming Macbeth commits terrible acts.",
    },
    {
      id: 'gcse-ld-a4',
      question: 'How does Shakespeare use the motif of blood in Macbeth?',
      options: [
        'Only to show physical injuries from battle',
        'As a recurring symbol of guilt that cannot be washed away',
        'To represent the colour of the Scottish flag',
        'Only in the final battle scene',
      ],
      correct: 1,
      explanation:
        'Blood is a powerful recurring motif representing guilt. Macbeth fears "the multitudinous seas incarnadine" after Duncan\'s murder, and Lady Macbeth obsessively tries to wash imaginary blood from her hands. Both show that guilt stains the conscience permanently.',
    },
    {
      id: 'gcse-ld-a5',
      question: 'What is dramatic irony?',
      options: [
        'When a play contains unexpected humour',
        'When the audience knows something that a character on stage does not',
        'When a character says the opposite of what they mean',
        'When the ending of a play is surprising',
      ],
      correct: 1,
      explanation:
        "Dramatic irony occurs when the audience possesses knowledge that characters lack. In Macbeth, when Duncan praises the castle where he will be murdered, the audience's awareness of his fate creates tension and horror.",
    },
    {
      id: 'gcse-ld-a6',
      question: 'Why is the Jacobean context of the Divine Right of Kings important to Macbeth?',
      options: [
        'It explains why Macbeth wants to be king',
        "It means that killing a king was seen as a sin against God, not just a political crime, which intensifies the horror of Duncan's murder",
        'It is why the play is set in Scotland rather than England',
        'It only matters for the final scene of the play',
      ],
      correct: 1,
      explanation:
        "James I believed monarchs were appointed by God. This means Duncan's murder is not merely treason but a sacrilegious act that disrupts the divine order - which is why nature itself erupts in chaos afterwards. This belief intensifies the moral weight of Macbeth's crime for the original audience.",
    },
    {
      id: 'gcse-ld-a7',
      question:
        'In An Inspector Calls, why does Priestley make Mr Birling predict the Titanic is "unsinkable"?',
      options: [
        'To show that Birling is interested in ships',
        "To create dramatic irony that undermines Birling's authority and worldview",
        'To provide historical information for the audience',
        'To foreshadow that a character will drown',
      ],
      correct: 1,
      explanation:
        "The 1945 audience knew the Titanic sank in 1912. Birling's confident prediction is spectacularly wrong, creating dramatic irony that undermines everything he says. If he is wrong about the Titanic, he is probably wrong about his selfish capitalist philosophy too.",
    },
    {
      id: 'gcse-ld-a8',
      question: 'What does the name "Goole" suggest about the Inspector\'s nature?',
      options: [
        'He comes from the town of Goole in Yorkshire',
        'It suggests "ghoul," implying he may be a supernatural or otherworldly figure',
        'It is a common surname in 1912',
        'It rhymes with "fool," suggesting he is easily deceived',
      ],
      correct: 1,
      explanation:
        'The name "Goole" sounds like "ghoul" - a supernatural being associated with death. This reinforces the idea that the Inspector is not a real police officer but a dramatic device, possibly supernatural, used by Priestley to deliver the play\'s moral message.',
    },
    {
      id: 'gcse-ld-a9',
      question:
        "Which character in An Inspector Calls represents Priestley's hope for the younger generation?",
      options: ['Arthur Birling', 'Mrs Birling', 'Sheila Birling', 'Gerald Croft'],
      correct: 2,
      explanation:
        "Sheila undergoes the most dramatic transformation. She fully accepts responsibility for her role in Eva's death, challenges her parents' refusal to change, and refuses to pretend \"nothing happened.\" She represents Priestley's belief that the young can build a more just society.",
    },
    {
      id: 'gcse-ld-a10',
      question:
        'What does the lighting change from "pink and intimate" to "brighter and harder" symbolise in An Inspector Calls?',
      options: [
        'The time changing from evening to night',
        'The shift from comfortable ignorance to the harsh light of moral truth',
        'The Inspector turning on the electric lights',
        'A change in the season from autumn to winter',
      ],
      correct: 1,
      explanation:
        "The pink light represents the Birlings' rose-tinted, sheltered worldview. The brighter, harder light represents the uncomfortable truth the Inspector forces them to confront. Priestley uses this stage direction symbolically to reinforce his themes of moral responsibility and self-deception.",
    },
    {
      id: 'gcse-ld-a11',
      question: 'What does the Inspector\'s phrase "fire and blood and anguish" refer to?',
      options: [
        "A factory fire at Birling's business",
        'The two World Wars that the 1945 audience had just lived through',
        'A biblical description of hell',
        'The Russian Revolution of 1917',
      ],
      correct: 1,
      explanation:
        'The Inspector warns that if people do not learn social responsibility, they "will be taught it in fire and blood and anguish." For the 1945 audience, this clearly refers to the devastation of two World Wars - events that proved the consequences of ignoring inequality and injustice.',
    },
    {
      id: 'gcse-ld-a12',
      question: 'What is the "Angel in the House" ideal in Victorian context?',
      options: [
        'A type of gothic ghost story',
        'The expectation that women should be domestic, obedient, and morally pure',
        'A religious movement that built houses for the poor',
        'A style of Victorian architecture',
      ],
      correct: 1,
      explanation:
        'The "Angel in the House" was the Victorian ideal of femininity: women should be devoted to home and family, submissive to their husbands, and morally pure. Female characters in 19th-century novels who defy this ideal are often punished, reflecting the restrictive gender norms of the period.',
    },
    {
      id: 'gcse-ld-a13',
      question: 'What is pathetic fallacy?',
      options: [
        'A logical error in an argument',
        "Using weather or landscape to reflect characters' emotions or the mood of a scene",
        'A character who is pathetically weak',
        'A plot device where a coincidence solves the story',
      ],
      correct: 1,
      explanation:
        "Pathetic fallacy is the technique of using natural phenomena - weather, landscape, seasons - to mirror characters' emotions or the atmosphere of a scene. Storms during conflict, fog during confusion, and sunshine during happiness are common examples in 19th-century fiction.",
    },
    {
      id: 'gcse-ld-a14',
      question: 'Which of the following is a gothic convention?',
      options: [
        'A realistic factory setting',
        'Witty dialogue at a dinner party',
        'A dark, isolated setting with supernatural elements and extreme emotions',
        "A detailed description of a character's daily routine",
      ],
      correct: 2,
      explanation:
        'Gothic conventions include dark and isolated settings (castles, moors, graveyards), the supernatural (ghosts, the uncanny), extreme emotions (terror, madness, obsession), and pathetic fallacy. These elements create an atmosphere of dread and psychological intensity.',
    },
    {
      id: 'gcse-ld-a15',
      question: 'What is a thesis statement?',
      options: [
        'A quotation from the text that supports your argument',
        'A single sentence at the start of your essay stating your overall argument',
        'A summary of the plot',
        'The topic sentence of your final paragraph',
      ],
      correct: 1,
      explanation:
        'A thesis statement is one clear sentence at the beginning of your essay that presents your overall argument in response to the question. It gives your essay direction and immediately signals to markers that you have a focused, analytical response.',
    },
    {
      id: 'gcse-ld-a16',
      question: 'What is the difference between an embedded quotation and a bolt-on quotation?',
      options: [
        'Embedded quotations are longer than bolt-on quotations',
        'An embedded quotation is woven naturally into your sentence; a bolt-on sits separately',
        'Bolt-on quotations are more sophisticated',
        'There is no difference - they are the same thing',
      ],
      correct: 1,
      explanation:
        'An embedded quotation flows naturally within your own sentence (e.g., Macbeth\'s "vaulting ambition" drives him to murder). A bolt-on quotation sits separately and reads awkwardly (e.g., Macbeth is ambitious. "I have no spur..."). Embedded quotations are more fluent and score higher marks.',
    },
    {
      id: 'gcse-ld-a17',
      question: 'In the WHAT-HOW-WHY paragraph structure, what does the "HOW" step involve?',
      options: [
        'Describing what happens in the scene',
        'Analysing the specific technique and language the writer uses',
        'Explaining the historical context of the text',
        'Giving your personal opinion about the character',
      ],
      correct: 1,
      explanation:
        'The "HOW" step requires you to analyse the writer\'s methods - the specific techniques, word choices, and structural features they use to create meaning. This is the analytical heart of the paragraph, where you demonstrate your understanding of the writer\'s craft.',
    },
    {
      id: 'gcse-ld-a18',
      question: 'Why should you spend 5 minutes planning before writing a literature essay?',
      options: [
        'Because the exam rules require it',
        'Because a planned essay is always more structured, focused, and coherent than an unplanned one',
        'Because it uses up time so you write less',
        'Because markers will mark your plan separately',
      ],
      correct: 1,
      explanation:
        'Planning ensures your essay has a clear argument (thesis), logically ordered paragraphs, and relevant quotations ready to use. An unplanned essay often rambles, repeats points, or drifts away from the question. Five minutes of planning saves time and improves quality.',
    },
    {
      id: 'gcse-ld-a19',
      question: 'How should context best be used in a literature essay?',
      options: [
        'In a separate paragraph at the end of your essay',
        'Woven into your analysis to explain why the writer made specific choices',
        'Only if the question specifically mentions context',
        'As a long introduction before you discuss the text',
      ],
      correct: 1,
      explanation:
    ...
    {
      id: 'gcse-ld-a20',
      question: 'What is the most important reason Macbeth is considered a tragic hero?',
      options: [
        'He dies at the end of the play',
        'He is a character of high status whose fatal flaw leads to his downfall, and he retains enough self-awareness to understand what he has lost',
        'He fights bravely in the final battle',
        'He is married to Lady Macbeth',
      ],
      correct: 1,
      explanation:
...
<div class="common-mistake"><strong>Common Mistake:</strong> Spending 30 minutes perfecting a 4-mark question and then rushing the 40-mark essay. Always check the marks before you write. The essay is where the big marks live - protect that time at all costs.</div>`,
      quiz: [
        {
          id: 'gcse-rb-m1-q1',
          question: 'How many papers do you sit across GCSE English Language and Literature?',
          options: ['Two', 'Three', 'Four', 'Six'],
          correct: 2,
          explanation:
            'You sit four papers in total: Language Paper 1, Language Paper 2, Literature Paper 1, and Literature Paper 2.',
        },
        {
          id: 'gcse-rb-m1-q2',
          question: 'What is the recommended rule for time allocation per question?',
          options: [
            'Two minutes per mark',
            'Roughly one minute per mark',
            'Five minutes per question regardless of marks',
            'Split time equally between all questions',
          ],
          correct: 1,
          explanation:
            'The golden rule is roughly one minute per mark. This ensures you give high-mark questions the time they deserve and do not overspend on low-mark ones.',
        },
        {
          id: 'gcse-rb-m1-q3',
          question: 'What are AOs?',
          options: [
            'Answer Outlines - templates for your answers',
            'what markers look for - the specific skills being marked',
            'Automatic Options - multiple choice answers',
            'Academic Overviews - summaries of each text',
          ],
          correct: 1,
          explanation:
            'AOs are what markers look for. They define exactly which skills markers are looking for in each question. Knowing them helps you target your answer precisely.',
        },
        {
          id: 'gcse-rb-m1-q4',
          question: 'If you feel stuck on a question, what should you do?',
          options: [
            'Leave it completely blank and move on',
            'Spend as long as it takes to finish it',
            'Give yourself five more minutes, write what you can, then move on',
            'Ask the invigilator for help',
          ],
          correct: 2,
          explanation:
            'The five-minute rule: write what you can - even bullet points - then move on. A partial answer always scores more than a blank space, and you protect time for other questions.',
        },
      ],
    },
    {
...
<p><strong>Ending:</strong> Return to an image from the opening (cyclical structure) or end on an ambiguous, thought-provoking line.</p>
      ...
      quiz: [
        {
          id: 'gcse-rb-m2-q1',
          question: 'How many marks is Question 1 on Language Paper 1 worth?',
          options: ['2 marks', '4 marks', '8 marks', '12 marks'],
          correct: 1,
          explanation:
            'Question 1 is worth 4 marks. It is the simplest question - just list four things from the specified lines. Spend no more than 5 minutes on it.',
        },
        {
          id: 'gcse-rb-m2-q2',
          question: 'What is the key skill for Question 3 (structure)?',
          options: [
            'Identifying language techniques like metaphor',
            'Spotting structural shifts and explaining how the writer moves the reader through the text',
            'Comparing the text to another source',
            'Writing your own creative response',
          ],
          correct: 1,
          explanation:
            'Question 3 tests your ability to analyse structure - focus shifts, pace changes, narrative perspective, beginnings and endings, and how these choices affect the reader.',
        },
        {
          id: 'gcse-rb-m2-q3',
          question: 'For Question 5 (creative writing), what common mistake should you avoid?',
          options: [
            'Using too many adjectives',
            'Writing a huge plot with too many events instead of focusing on quality description',
            'Making your writing too short',
            'Using first person narration',
          ],
          correct: 1,
          explanation:
            'Markers are looking for quality of writing, not quantity of plot. A single well-described scene scores higher than a rushed adventure with five plot twists. Slow down and show off your language skills.',
        },
        {
          id: 'gcse-rb-m2-q4',
          question: 'How should you approach Question 4 (evaluation)?',
          options: [
            'Simply agree with the statement and give evidence',
            'Write a balanced answer: agree with evidence, consider a counterargument, then conclude',
            'Disagree completely and ignore the statement',
            'Just retell the story in your own words',
          ],
          correct: 1,
          explanation:
            'Question 4 rewards a balanced evaluation. Agree with evidence, then consider an alternative interpretation, then reach a personal conclusion. This shows sophisticated critical thinking.',
        },
      ],
    },
    {
...
<p>Both writers present the city as overwhelming, but for different reasons. Source A describes London as a place of "unbearable noise and filth," using the adjective "unbearable" to suggest the 19th-century writer feels physically oppressed by urban life. In contrast, Source B's modern writer describes the city as "relentlessly alive," where the adverb "relentlessly" implies exhaustion but also excitement. While Source A focuses on discomfort, Source B acknowledges that the chaos is part of the city's appeal, reflecting a more ambivalent modern attitude.</p>
      ...
      quiz: [
        {
          id: 'gcse-rb-m3-q1',
          question: 'What is the key difference between Language Paper 1 and Paper 2?',
          options: [
            'Paper 2 has no writing section',
            'Paper 2 uses two non-fiction texts and requires comparison',
            'Paper 2 is shorter',
            'Paper 2 only tests creative writing',
          ],
          correct: 1,
          explanation:
            'Paper 2 gives you two non-fiction texts (one older, one modern) and requires you to compare them. Paper 1 uses a single fiction extract with no comparison.',
        },
        {
          id: 'gcse-rb-m3-q2',
          question: 'What should you NOT do when answering Question 4 (compare viewpoints)?',
          options: [
            'Use comparative connectives',
            "Discuss both writers' methods",
            'Write about Source A for half the answer, then Source B for the other half',
            'Include evidence from both texts',
          ],
          correct: 2,
          explanation:
            'Writing about each source separately is not comparison. Every paragraph should discuss both sources, weaving them together with comparative connectives like "Similarly" and "In contrast."',
        },
        {
          id: 'gcse-rb-m3-q3',
          question: 'What skill does Question 2 test?',
          options: [
            'Language analysis',
            'Synthesis - summarising and comparing information from both sources',
            'Creative writing',
            'Structural analysis',
          ],
          correct: 1,
          explanation:
            'Question 2 tests synthesis: pulling together information from both sources to identify similarities or differences. You summarise ideas, not analyse language.',
        },
        {
          id: 'gcse-rb-m3-q4',
          question:
            'For Question 5 (viewpoint writing), what must you identify from the task before writing?',
          options: [
            'The number of paragraphs needed',
            'Form, audience, and purpose',
            'Which literary techniques to use',
            'The historical context of the topic',
          ],
          correct: 1,
          explanation:
            'Every transactional writing task has a form (letter, article, speech), audience (who you are writing to), and purpose (persuade, argue, advise). These determine your tone, structure, and techniques.',
        },
      ],
    },
    {
...
<p>Context should be woven into your analysis, not bolted on as a separate paragraph. Bad: "In Victorian times, women had no rights." Good: "Dickens highlights the vulnerability of working-class women through Nancy's inability to escape Sikes, reflecting the limited legal protections available to women in the 1830s." The second version connects context directly to the text and the question.</p>
      ...
      quiz: [
        {
          id: 'gcse-rb-m4-q1',
          question: 'What does "extract-to-whole" mean in a Literature essay?',
          options: [
            'Only write about the extract provided',
            'Start with the extract, then broaden to discuss the wider text',
            'Ignore the extract and write about the whole play',
            'Copy the extract into your answer',
          ],
          correct: 1,
          explanation:
            'Extract-to-whole means analysing the printed extract in detail first, then moving beyond it to discuss how the theme or character appears in other parts of the text. This shows full knowledge of the work.',
        },
        {
          id: 'gcse-rb-m4-q2',
          question: 'How should you refer to the author in a Literature essay?',
          options: [
            'Use phrases like "the text says" without naming the author',
            'Use the author\'s name and phrases like "Shakespeare presents" to show authorial intent',
            'Always use first names like "William" or "Charles"',
            'Avoid mentioning the author at all',
          ],
          correct: 1,
          explanation:
            'Using the author\'s surname with active verbs like "presents," "suggests," or "challenges" shows you understand the text was deliberately crafted. This demonstrates awareness of authorial intent.',
        },
        {
          id: 'gcse-rb-m4-q3',
          question: 'How should context be used in a Literature answer?',
          options: [
            'As a separate paragraph at the end of the essay',
            'Woven into your analysis and linked directly to the text and question',
            'Only if the question specifically mentions context',
            'By listing historical facts at the start of each paragraph',
          ],
          correct: 1,
          explanation:
            'Context is most effective when it is embedded in your analysis. Connect historical, social, or cultural ideas directly to the text and the question rather than writing a standalone "context paragraph."',
        },
        {
          id: 'gcse-rb-m4-q4',
          question: 'What is a good time split for Literature Paper 1?',
          options: [
            'All time on Shakespeare, rush the novel',
            '50 minutes Shakespeare, 50 minutes novel, 5 minutes reading',
            '30 minutes each with 45 minutes spare',
            '90 minutes on the novel only',
          ],
          correct: 1,
          explanation:
            'Roughly 50 minutes on Shakespeare, 50 minutes on the 19th-century novel, with 5 minutes at the start for reading the extracts and planning. This ensures both sections get equal attention.',
        },
      ],
    },
    {
      ...
      quiz: [
        {
          id: 'gcse-rb-m5-q1',
          question:
            'What is unique about the Modern Text section compared to other Literature sections?',
          options: [
            'It is the longest section',
            'There is no extract - you must recall quotations from memory',
            'You must compare two texts',
            'It only tests context knowledge',
          ],
          correct: 1,
          explanation:
            'The Modern Text section provides no extract. You must recall quotations from memory, which is why memorising 10-15 short quotations per character or theme is essential.',
        },
        {
          id: 'gcse-rb-m5-q2',
          question:
            'When choosing a poem to compare with the printed anthology poem, what should you consider?',
          options: [
            'Choose the poem you know best, regardless of theme',
            'Choose a poem with the same theme but a different approach or perspective',
            'Always choose the shortest poem',
            'Choose a poem by the same poet',
          ],
          correct: 1,
          explanation:
            'Pick a poem that shares the theme but takes a different approach. This contrast gives you plenty of material for comparison. Two poems that are too similar leave you with little to say.',
        },
        {
          id: 'gcse-rb-m5-q3',
          ...
          options: [
            'Once quickly',
            'Twice - for meaning and language',
            'Three times - meaning, language, then structure',
            'As many times as possible',
          ],
          correct: 2,
          explanation:
            'The three-read strategy covers all bases: Read 1 for overall meaning, Read 2 for language and techniques, Read 3 for structure and form. This systematic approach prevents you from missing key features.',
        },
        {
          id: 'gcse-rb-m5-q4',
          question:
            'If you cannot remember an exact quotation in the Modern Text section, what should you do?',
          options: [
            'Leave a blank space',
            'Make up a quotation',
            'Paraphrase and say "the writer describes..."',
            'Skip that point entirely',
          ],
          correct: 2,
          explanation:
            'Paraphrasing is always better than leaving a gap. You keep the marks for your analytical point even if you lose a mark for quotation precision. markers reward your ideas, not just your memory.',
        },
      ],
    },
    {
...
<div class="common-mistake"><strong>Common Mistake:</strong> Using sophisticated vocabulary incorrectly. "The protagonist was very loquacious" sounds impressive, but if you do not know what "loquacious" means and use it in the wrong context, you lose marks for accuracy. Only use words you are confident about.</div>`,
      quiz: [
        {
          id: 'gcse-rb-m6-q1',
          question: 'What is the difference between Grade 5 and Grade 8 language analysis?',
          options: [
            'Grade 8 answers are longer',
            'Grade 8 answers zoom in on individual word choices and explain their effects',
            'Grade 8 answers use more quotations',
            'Grade 8 answers always disagree with the writer',
          ],
          correct: 1,
          explanation:
            'The key difference is precision. Grade 8 answers analyse individual words and their connotations, while Grade 5 answers tend to make general comments about "descriptive language" without zooming in.',
        },
        {
          id: 'gcse-rb-m6-q2',
          question: 'Which of these is a "killer error" that costs marks in writing?',
          options: [
          ...
          correct: 1,
          explanation:
            'Comma splices (joining two sentences with just a comma instead of a full stop, semicolon, or conjunction) are one of the five most penalised errors. They signal weak punctuation control.',
        },
        {
          id: 'gcse-rb-m6-q3',
          question: 'How should you use subject terminology in your answers?',
          options: [
            'Label every technique you can spot',
            'Only use terminology when you can explain WHY the technique creates its effect',
            'Avoid terminology completely',
            'Use as many technical terms as possible in every sentence',
          ],
          correct: 1,
          explanation:
            'Terminology must serve your analysis. Labelling a technique without explaining its effect earns nothing. Always follow the technique with an explanation of why the writer chose it and how it affects the reader.',
        },
        {
          id: 'gcse-rb-m6-q4',
          question: 'What is the best way to proofread your writing for grammar errors?',
          options: [
            'Read it through once quickly',
            'Read it backwards sentence by sentence',
            'Ask the person next to you to check it',
            'Only check the first paragraph',
          ],
          correct: 1,
          explanation:
            'Reading backwards forces your brain to focus on each sentence as an isolated unit, making it much easier to spot grammar and punctuation errors. Reading forwards, your brain fills in gaps and misses mistakes.',
        },
      ],
    },
    {
...
<div class="common-mistake"><strong>Common Mistake:</strong> "Feature spotting" - listing techniques without explaining their significance. Saying "Shakespeare uses iambic pentameter" is worthless unless you explain why: "The disruption of iambic pentameter in Macbeth's later speeches mirrors his psychological disintegration." Always connect technique to meaning.</div>`,
      quiz: [
        {
          id: 'gcse-rb-m7-q1',
          question: 'What makes a quotation "versatile"?',
          options: [
            'It is very long and detailed',
            'It can be applied to multiple themes or questions',
            'It comes from the most important scene',
            'It contains a literary technique',
          ],
          correct: 1,
          explanation:
            'A versatile quotation links to multiple themes, so one memorised quotation can serve you across different questions. This is the most efficient revision strategy for Literature.',
        },
        {
          id: 'gcse-rb-m7-q2',
          question: 'How should context be used in a Literature essay?',
          options: [
            'As a separate paragraph of historical facts',
            'Woven into analysis and directly connected to the text and question',
            'Only when the question mentions context',
            'As the opening sentence of every paragraph',
          ],
          correct: 1,
          explanation:
            'Context must illuminate the text. Weave contextual points into your analysis so they directly support your argument about the text, rather than sitting as standalone historical facts.',
        },
        {
          id: 'gcse-rb-m7-q3',
          question: 'Why is the word "perhaps" powerful in a Literature essay?',
          options: [
            'It makes your answer longer',
            'It shows tentative, exploratory thinking that considers multiple interpretations',
            'It avoids the need for evidence',
            'It is a command word',
          ],
          correct: 1,
          explanation:
            '"Perhaps" signals nuanced thinking - you are exploring possibilities rather than making simplistic claims. This is exactly what Markers reward at the highest mark bands.',
        },
        {
          id: 'gcse-rb-m7-q4',
          question: 'What is "feature spotting" and why should you avoid it?',
          options: [
            'Finding hidden details in the text - it is a useful skill',
            'Listing techniques without explaining their significance - it earns no marks',
            'Identifying themes across multiple texts - it is too time-consuming',
            'Spotting errors in the exam paper - it wastes time',
          ],
          correct: 1,
          explanation:
            'Feature spotting means labelling techniques (like "this is a metaphor") without explaining why the writer used them or what effect they create. It earns zero analytical marks.',
        },
      ],
    },
    {
...
<p><strong>One final thought:</strong> You have studied these texts for two years. You know more than you think you do. The exam is not a test of everything - it is a test of how well you apply what you know to the specific questions in front of you. Stay focused, stay calm, and show markers what you can do. You have got this.</p>`,
      quiz: [
        {
          id: 'gcse-rb-m8-q1',
          question: 'What should you revise the night before the exam?',
          options: [
            'New quotations you have not studied before',
            'Your quotation list, key terminology, and one model answer',
            'The entire set text from beginning to end',
            'A brand new past paper',
          ],
          correct: 1,
          explanation:
            'The night before, review what you already know: your quotation list, key terminology, and one strong model answer. Do not try to learn new material - it will not stick and will increase anxiety.',
        },
        {
          id: 'gcse-rb-m8-q2',
          question: 'Why is sleep more important than late-night cramming?',
          options: [
            'It is not - you should study as late as possible',
            'Sleep transfers information from short-term to long-term memory',
            'You need to dream about the exam',
            'Sleep only matters if the exam is in the morning',
          ],
          correct: 1,
          explanation:
            'During sleep, your brain consolidates memories and transfers them to long-term storage. Cutting sleep to cram actually undermines your ability to recall information the next day.',
        },
        {
          id: 'gcse-rb-m8-q3',
          ...
          options: [
            ...
            'Read the question 4 times, plan for 7 minutes, write for 8 minutes',
            'Answer 4 questions in 7-8 minutes each',
            'Revise for 4 hours, rest for 7, sleep for 8',
          ],
          correct: 0,
          explanation:
            'The 4-7-8 technique (breathe in 4 seconds, hold 7, out 8) activates your parasympathetic nervous system and physically reduces anxiety. It takes under a minute and can be done silently during the exam.',
        },
        {
          id: 'gcse-rb-m8-q4',
          question: 'What should you do in the first two minutes after receiving the exam paper?',
          options: [
            'Start writing immediately to save time',
            'Read the paper slowly, breathe, choose questions carefully, and write a time plan',
            'Read the hardest question first',
            'Check what your classmates are doing',
          ],
          correct: 1,
          explanation:
            'Spending two minutes reading the paper, breathing, choosing questions, and writing a time plan in the margin prevents rushed mistakes and ensures you tackle the right questions in the right order.',
        },
      ],
    },
  ],
  assessmentQuestions: [
    {
      id: 'gcse-rb-a1',
      question: 'What is the recommended time allocation rule for exam questions?',
      options: [
        'Two minutes per mark',
        'Roughly one minute per mark',
        'Equal time for every question',
        'All time on the highest-mark question',
      ],
      correct: 1,
      explanation:
        'Spending roughly one minute per mark ensures high-mark questions get the time they deserve and low-mark questions do not eat into your writing time.',
    },
    {
      id: 'gcse-rb-a2',
      question: 'On Language Paper 1, Question 1, what are you asked to do?',
      options: [
        "Analyse the writer's use of language",
        'Write a creative piece',
        'List four things from the text',
        'Compare two sources',
      ],
      correct: 2,
      explanation:
        'Question 1 is a simple retrieval task: list four things from the specified lines. No analysis needed. It is worth 4 marks and should take about 5 minutes.',
    },
    {
      id: 'gcse-rb-a3',
      question: 'What is the key difference between Language Paper 1 and Paper 2?',
      options: [
        ...
        'Paper 2 uses two non-fiction texts and requires comparison',
        'Paper 2 has no writing section',
        'Paper 1 is only about poetry',
      ],
      correct: 1,
      explanation:
        "Paper 1 uses one fiction extract; Paper 2 uses two non-fiction texts and requires you to compare writers' viewpoints and methods.",
    },
    {
      id: 'gcse-rb-a4',
      question: 'In a Language Paper 2 comparison answer, what must you avoid?',
      options: [
        'Using comparative connectives',
        'Writing about Source A and Source B in separate halves instead of weaving them together',
        "Discussing both writers' methods",
        'Using quotations from both texts',
      ],
      correct: 1,
      explanation:
        'Writing about each source in separate blocks is not comparison. Every paragraph should discuss both sources, using comparative connectives to weave the analysis together.',
    },
    {
      id: 'gcse-rb-a5',
      question: 'What does "extract-to-whole" mean in a Literature essay?',
      options: [
        ...
        'Analyse the extract first, then discuss the wider text',
        'Ignore the extract completely',
        'Quote the entire extract in your answer',
      ],
      correct: 1,
      explanation:
        'Extract-to-whole means starting with detailed analysis of the printed extract, then broadening to discuss how the theme or character appears elsewhere in the text.',
    },
    {
      id: 'gcse-rb-a6',
      question: 'How should you refer to the writer in a Literature essay?',
      options: [
        'By first name only',
        'By surname with active verbs like "presents" or "suggests"',
        'Do not mention the writer at all',
        'Use "the book says" instead',
      ],
      correct: 1,
      explanation:
        "Using the author's surname with deliberate verbs shows awareness of authorial intent - the understanding that the text was crafted on purpose.",
    },
    {
      id: 'gcse-rb-a7',
      question: 'What is a "versatile quotation"?',
      options: [
        'A very long quotation',
        'A short quotation that links to multiple themes',
        'A quotation from the exam paper',
        'A quotation used by markers',
      ],
      correct: 1,
      explanation:
        'Versatile quotations are short (3-7 words) and link to multiple themes, making them useful across different possible exam questions.',
    },
    {
      id: 'gcse-rb-a8',
      question: 'In the Literature Paper 2 modern text section, why is memorisation important?',
      options: [
        'The exam is open book',
        'There is no extract provided - you must recall quotations from memory',
        'You need to write out the entire text',
        'Memorisation is not important for this section',
      ],
      correct: 1,
      explanation:
        'Unlike other Literature sections, the modern text question provides no extract. You must remember quotations and use them from memory.',
    },
    {
      id: 'gcse-rb-a9',
      question: 'What is the three-read strategy for unseen poetry?',
      options: [
        'Read for meaning, then language, then structure',
        'Read the title, the first line, and the last line',
        'Read it once and start writing immediately',
        'Read three different poems before choosing one',
      ],
      correct: 0,
      explanation:
        'Read 1: overall meaning. Read 2: underline striking language and techniques. Read 3: examine structure, form, and line arrangement. This systematic approach ensures thorough analysis.',
    },
    {
      id: 'gcse-rb-a10',
      question: 'What does "zooming in on single words" mean in language analysis?',
      options: [
        'Using a magnifying glass on the text',
        'Analysing individual word choices and their connotations rather than making general comments',
        'Counting how many times a word appears',
        'Only quoting one word per answer',
      ],
      correct: 1,
      explanation:
        'Zooming in means selecting a single word and exploring its connotations, effects, and significance. This precision is what separates top-band answers from mid-range ones.',
    },
    {
      id: 'gcse-rb-a11',
      question: 'Why should every analytical point reference the reader?',
      options: [
        'Because the reader wrote the text',
        'Because texts are designed to provoke a response, and Markers are looking for to see you understand this',
        'Because it makes your answer longer',
        'Because it is a rule of English grammar',
      ],
      correct: 1,
      explanation:
        'Writers craft texts to affect readers. Explaining the impact on the reader ("This makes the reader feel...") shows you understand the purpose of literary techniques.',
    },
    {
      id: 'gcse-rb-a12',
      question: 'What are the "five killer errors" in writing?',
      options: [
        'Spelling, vocabulary, tone, length, and handwriting',
        "Comma splices, missing apostrophes, their/there/they're, inconsistent tense, missing capitals",
        'Using short sentences, repeating words, starting with "I", using "nice", ending with "The End"',
        'Metaphor, simile, alliteration, personification, and onomatopoeia',
      ],
      correct: 1,
      explanation:
        'These five errors - comma splices, missing apostrophes, homophones, tense shifts, and missing capitals - are the most common technical mistakes and cost the most marks for accuracy.',
    },
    {
      id: 'gcse-rb-a13',
      question: 'How should context be integrated into a Literature essay?',
      options: [
        'As a standalone paragraph of historical facts',
        'Woven into analysis and directly linked to the text',
        'Only in the introduction',
        'It should not be included at all',
      ],
      correct: 1,
      explanation:
        'Context is most effective when embedded in analysis. Connect it directly to your points about the text rather than writing a separate block of historical information.',
    },
    {
      id: 'gcse-rb-a14',
      question: 'What is "feature spotting" and why is it a problem?',
      options: [
        'Identifying key themes - it is helpful',
        'Listing techniques without explaining their effect - it earns no analytical marks',
        'Finding mistakes in the text - it wastes time',
        'Memorising literary features - it is too difficult',
      ],
      correct: 1,
      explanation:
        'Feature spotting means labelling techniques without analysis. Saying "this is a metaphor" earns nothing; explaining why the metaphor was used and its effect on the reader earns marks.',
    },
    {
      id: 'gcse-rb-a15',
      question: 'What is the best way to end a creative writing piece?',
      options: [
        'Write "The End"',
        'End with a striking image or thought-provoking line',
        'Summarise everything that happened',
        'End mid-sentence for dramatic effect',
      ],
      correct: 1,
      explanation:
        'A powerful final image or thought-provoking line leaves a strong lasting impression. Avoid flat endings like "In conclusion" or "The End" - make your final words memorable.',
    },
    {
      id: 'gcse-rb-a16',
      question: 'In Language Paper 1, Question 3, what are you analysing?',
      options: [
        'Language techniques',
      ...
      correct: 1,
      explanation:
        'Question 3 focuses on structure: how the writer moves the reader through the text using focus shifts, pace changes, paragraph structure, and other organisational choices.',
    },
    {
      id: 'gcse-rb-a17',
      question: 'Why is the word "perhaps" valuable in a Literature essay?',
      options: [
        'It avoids the need for evidence',
        'It signals exploratory, nuanced thinking that considers multiple interpretations',
        'It makes sentences grammatically correct',
        'It is required by the marking guide',
      ],
      correct: 1,
      explanation:
        '"Perhaps" shows you can consider multiple interpretations rather than making simplistic claims. This exploratory thinking is rewarded at the highest mark bands.',
    },
    {
      id: 'gcse-rb-a18',
      question: 'What should you do the night before the exam?',
      options: [
        'Stay up and learn new material',
        'Review your quotation list, key terms, and one model answer, then sleep well',
        'Read the entire set text cover to cover',
        'Start a new past paper at 11pm',
      ],
      correct: 1,
      explanation:
        'The night before, review what you already know briefly, then prioritise sleep. Your brain consolidates memories during sleep, so rest is more productive than last-minute cramming.',
    },
    {
      id: 'gcse-rb-a19',
      question: 'What is the 4-7-8 breathing technique used for?',
      options: [
        'Timing your exam answers',
        'Reducing anxiety during the exam by activating the parasympathetic nervous system',
        'Counting paragraphs in your essay',
        'Pacing your reading speed',
      ],
      correct: 1,
      explanation:
        "Breathing in for 4 seconds, holding for 7, and exhaling for 8 activates the body's calming response. It takes under a minute and can be done silently if panic arises during the exam.",
    },
    {
      id: 'gcse-rb-a20',
      question:
        'For creative writing on Language Paper 1, what common mistake costs the most marks?',
      options: [
        'Using too much dialogue',
        'Writing a plot-heavy story instead of focusing on quality description and language',
        'Making the piece too short',
        'Writing in first person',
      ],
      correct: 1,
      explanation:
        'Markers reward quality of writing - vocabulary, sentence variety, sensory detail, crafted structure. A single well-described scene scores far higher than a rushed, plot-heavy story with five events and no descriptive depth.',
    },
  ],
}

export const gcseCourses: CourseData[] = [
  gcseLangReading,
  gcseLangWriting,
  gcseLitPoetry,
  gcseLitProse,
