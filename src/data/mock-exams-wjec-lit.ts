...
// Some "extracts" in this file are not verbatim source text. The Blood Brothers
// "Mrs. Johnstone" extract ("I should have known that the working classes were
// built to be chained...") is fabricated - Russell uses song-form on this
// theme, not the prose printed here. Other extracts (Macbeth 1.7, Inspector
// Calls "millions of Eva Smiths", Christmas Carol "shadows of things") are
// substantially accurate. Verify against primary texts before citing.
        ...
        questions: [
          {
            ...
            marks: 40,
            questionText:
              'Explore how Shakespeare presents the theme of ambition in Macbeth. You must refer to the extract below and to other parts of the play.',
            extract:
              "MACBETH: If it were done when 'tis done, then 'twere well\nIt were done quickly: that but this blow\nMight be the be-all and the end-all here,\nBut here, upon this bank and shoal of time,\nWe'd jump the life to come. But in these cases\nWe still have judgement here; that we but teach\nBloody instructions, which, being taught, return\nTo plague the inventor: this even-handed justice\nCommends the ingredients of our poison'd chalice\nTo our own lips.",
            markScheme:
              "AO1 (12 marks): Identify and interpret ideas about ambition; analyse structural features and language techniques (soliloquy, metaphor). AO2 (12 marks): Explore how language and form reveal Macbeth's psychological conflict; semantic field of fear/poison. AO3 (16 marks): Consider contextual significance of unchecked ambition in Jacobean society; parallels with historical figures; gender and masculinity pressures.",
            modelAnswer:
        ...
        questions: [
          {
            ...
            marks: 40,
            questionText:
              'Examine how Shakespeare presents the relationship between the Montague and Capulet families. You must refer to the extract below and to other parts of the play.',
            extract:
              "TYBALT: What, dost thou make us minstrels?\nROMEO: Nay, good Mercutio, let's retire:\nThe day is hot, the Capulets abroad,\nAnd, if we meet, we shall not 'scape a brawl;\nFor now, these hot days, is the mad blood stirring.",
            markScheme:
              'AO1 (12 marks): Analyse dialogue and dramatic irony; identify conflict dynamics. AO2 (12 marks): Examine language choices (insult, provocative tone); dramatic tension. AO3 (16 marks): Social context of feuds; honour culture in Renaissance Verona; inevitability of tragedy.',
            modelAnswer:
        ...
        questions: [
          {
            ...
            marks: 40,
            questionText:
              'How does Shakespeare present Shylock as a complex character? You must refer to the extract below and to other parts of the play.',
            extract:
              'SHYLOCK: I am not merry; but I do beguile the thing I am by seeming otherwise... I have a daughter... I had it of Leah... would she were hearsed at my foot, and the jewels in her ear! would she were dead at my foot, and the ducats in her coffin!',
            markScheme:
              "AO1 (12 marks): Analyse Shylock's complexity (grievance, isolation, loss); examine contradiction between public performance and private feeling. AO2 (12 marks): Explore language of alienation; metaphors of theft and betrayal; contrast between emotional vulnerability and commercial hardness. AO3 (16 marks): Representation of Jewish characters in Elizabethan drama; Shylock as outsider; historical contexts of anti-Semitism.",
            modelAnswer:
        ...
        questions: [
          {
            ...
            marks: 50,
            questionText:
              "Examine how Charlotte Bronte presents Jane's struggle for independence and self-determination. You must refer to the extract below and to other parts of the text.",
            extract:
              '"I am no bird; and no net ensnares me; I am a free human being with an independent will." "I have as much soul as you, and full as much heart! And if God had gifted me with some beauty and much wealth, I should make it as hard for you to leave me, as it is now for me to leave you."',
            markScheme:
              "AO1 (15 marks): Analyse Jane's assertions of selfhood; trace her development toward independence. AO2 (15 marks): Examine rhetoric (metaphor, parallelism, imperative); analyse relationship to Gothic tradition. AO3 (20 marks): Victorian feminism; gender ideology; class and marriage; Bronte's biographical context.",
            modelAnswer:
