...
export interface WorkbookExercise {
  title: string
  type: 'annotation' | 'writing' | 'comprehension' | 'vocabulary' | 'grammar' | 'creative' | 'comparison' | 'analysis' | 'research' | 'discussion'
  instructions: string
  scaffolding?: string
  ...
  readingList: [
    {
      ...
      description: 'Dahl\'s memoir of his childhood, covering school experiences and family life. Excellent for teaching narrative voice and selective detail.',
    },
    {
      ...
      difficulty: 'accessible',
      termRelevance: 'Term 1 - Autobiography and Personal Narrative',
      description: 'A memoir of growing up unwanted in 1940s China. Rich in cultural context and themes of identity, family, and resilience.',
    },
    {
      title: 'Skellig',
      author: 'David Almond',
      ...
      description: 'A mysterious, poetic novel exploring friendship, family, and the boundaries between the ordinary and extraordinary.',
    },
    {
      ...
      difficulty: 'accessible',
      termRelevance: 'Term 2 - Novel Study',
      description: 'Set in Taliban-era Kabul, this novel follows a girl who disguises herself as a boy to support her family. Themes of identity, courage, and belonging.',
    },
    {
      title: 'Holes',
      author: 'Louis Sachar',
      ...
      difficulty: 'accessible',
      termRelevance: 'Term 2 - Novel Study',
      description: 'A brilliantly structured novel with interwoven timelines. Excellent for teaching narrative structure, symbolism, and fate versus free will.',
    },
    {
      ...
      difficulty: 'moderate',
      termRelevance: 'Term 2 - Novel Study',
      description: 'A powerful novel about grief, truth, and storytelling. Accessible prose with challenging emotional and thematic content.',
    },
    {
      title: 'The Crossover',
      ...
      description: 'A verse novel about twin brothers and basketball. Excellent for reluctant readers and for demonstrating that poetry can be contemporary and engaging.',
    },
    {
      ...
      difficulty: 'moderate',
      termRelevance: 'Term 3 - Poetry and Performance',
      description: 'A curated selection of poems exploring identity, belonging, and voice from diverse contemporary poets.',
    },
  ],
  vocabulary: [
    { word: 'narrative', definition: 'A spoken or written account of connected events; a story', exampleSentence: 'The author constructs a compelling narrative about her childhood in Shanghai.', unit: 'Autobiography', tier: 3 },
    { word: 'memoir', definition: 'A written account of personal experiences and memories', exampleSentence: 'Dahl\'s memoir captures the joys and terrors of a 1920s schoolboy.', unit: 'Autobiography', tier: 3 },
    { word: 'perspective', definition: 'A particular way of considering something; a point of view', exampleSentence: 'The story is told from the perspective of a young child who does not fully understand what is happening.', unit: 'Autobiography', tier: 2 },
    { word: 'convey', definition: 'To communicate or express a feeling, idea, or meaning', exampleSentence: 'The writer uses short sentences to convey a sense of urgency and fear.', unit: 'All units', tier: 2 },
    { word: 'implicit', definition: 'Suggested but not directly expressed; implied', exampleSentence: 'The writer makes an implicit criticism of the education system through her description of the harsh teacher.', unit: 'Novel Study', tier: 2 },
    { word: 'symbolism', definition: 'The use of objects, characters, or events to represent abstract ideas or concepts', exampleSentence: 'The locked door is used as symbolism for the character\'s isolation from the rest of the family.', unit: 'Novel Study', tier: 3 },
    { word: 'empathy', definition: 'The ability to understand and share the feelings of another person', exampleSentence: 'The writer builds empathy for the protagonist by showing us her private thoughts.', unit: 'Novel Study', tier: 2 },
    { word: 'metaphor', definition: 'A figure of speech in which a word or phrase is applied to something it does not literally describe, to suggest a comparison', exampleSentence: 'The poet uses the metaphor of a cage to represent the restrictions placed on the speaker.', unit: 'Poetry', tier: 3 },
    { word: 'enjambment', definition: 'The continuation of a sentence or clause across a line break in poetry', exampleSentence: 'The enjambment creates a sense of urgency as the reader is carried from one line to the next without pause.', unit: 'Poetry', tier: 3 },
    { word: 'connotation', definition: 'An idea or feeling that a word suggests in addition to its literal meaning', exampleSentence: 'The word "crawled" has connotations of weakness and submission.', unit: 'All units', tier: 2 },
    { word: 'vivid', definition: 'Producing powerful feelings or strong, clear images in the mind', exampleSentence: 'The writer creates a vivid picture of the market using sounds, smells, and colours.', unit: 'Autobiography', tier: 2 },
    { word: 'inference', definition: 'A conclusion reached on the basis of evidence and reasoning rather than explicit statement', exampleSentence: 'We can make an inference about the character\'s mood from the way she slams the door shut.', unit: 'All units', tier: 2 },
    { word: 'tone', definition: 'The general character or attitude expressed in a piece of writing', exampleSentence: 'The tone shifts from playful to menacing in the second stanza of the poem.', unit: 'Poetry', tier: 2 },
    { word: 'atmosphere', definition: 'The mood or feeling created by a text or setting', exampleSentence: 'Dahl creates a tense atmosphere in the schoolroom by describing the silence broken only by the swish of the cane.', unit: 'All units', tier: 2 },
    { word: 'resilience', definition: 'The capacity to recover quickly from difficulties; toughness', exampleSentence: 'The protagonist shows remarkable resilience despite the hardships she faces.', unit: 'Novel Study', tier: 2 },
  ],
  rubrics: [
    {
      ...
      descriptors: [
        { level: 'Excelling', description: 'Detailed, perceptive analysis of language with well-selected, embedded quotations. Clear understanding of writer\'s methods and their effects. Develops interpretations with confidence, exploring alternative meanings. Conceptual vocabulary used accurately (e.g., connotation, symbolism, tone).' },
        { level: 'Secure', description: 'Clear analysis of language with relevant quotations. Identifies writer\'s techniques and explains their effects. Shows understanding of implicit meaning. Uses some subject-specific vocabulary appropriately.' },
        { level: 'Developing', description: 'Some relevant comments about language with supporting quotations, though these may be over-long. Begins to identify techniques but explanations of effect are underdeveloped or surface-level. Comments tend toward retelling rather than analysis.' },
        { level: 'Emerging', description: 'Simple comments about the text with limited or no supporting evidence. May retell the content without analysis. Little or no awareness of writer\'s techniques. Limited vocabulary for discussing texts.' },
      ],
    },
    {
      ...
      descriptors: [
        { level: 'Excelling', description: 'Engaging, well-structured writing with a clear sense of purpose. Ambitious vocabulary used precisely. Varied sentence structures for deliberate effect. Accurate spelling, punctuation, and grammar throughout. Uses literary techniques (simile, metaphor, personification) effectively and originally.' },
        { level: 'Secure', description: 'Clearly organised writing with a logical structure. Vocabulary is appropriate and occasionally ambitious. Some variety in sentence structures. Generally accurate spelling, punctuation, and grammar with only minor errors. Attempts literary techniques with some success.' },
        { level: 'Developing', description: 'Writing has a basic structure but may lose coherence in places. Vocabulary is sometimes repetitive or imprecise. Sentence structures are mostly simple or compound. Spelling and punctuation errors are present but do not prevent understanding. Attempts at techniques may be formulaic.' },
        { level: 'Emerging', description: 'Limited structure with unclear organisation. Basic vocabulary. Simple sentences dominate. Frequent errors in spelling and punctuation that hinder understanding. Little or no use of literary techniques.' },
      ],
    },
  ],
}
  ...
  readingList: [
    {
      ...
      description: 'A graphic novel version provides visual support for understanding the plot and characters before engaging with the original text.',
    },
    {
      ...
      description: 'A dystopian novel exploring racial prejudice in an inverted society. Powerful exploration of power, privilege, and responsibility.',
    },
    {
      title: 'Animal Farm',
      ...
      difficulty: 'moderate',
      termRelevance: 'Term 1 - Power and Responsibility',
      description: 'An accessible allegory of totalitarianism that introduces students to political fiction and the concept of satire.',
    },
    {
      ...
      description: 'A selection of war poems spanning different periods, ideal for comparison work on how poets present conflict and power.',
    },
    {
      ...
      description: 'A novel about friendship and refugee experience that links well to the rhetoric unit through themes of justice and advocacy.',
    },
    {
      ...
      termRelevance: 'Term 3 - Rhetoric and Persuasion',
      description: 'Extracts from landmark speeches for analysis of rhetorical technique and persuasive strategy.',
    },
  ],
  vocabulary: [
    { word: 'soliloquy', definition: 'A speech in a play in which a character speaks their thoughts aloud while alone on stage', exampleSentence: 'Macbeth\'s soliloquy reveals his internal struggle between ambition and morality.', unit: 'Shakespeare', tier: 3 },
    { word: 'dramatic irony', definition: 'When the audience knows something that the characters on stage do not', exampleSentence: 'There is dramatic irony when Duncan praises Macbeth\'s castle, unaware that he will be murdered there.', unit: 'Shakespeare', tier: 3 },
    { word: 'rhetoric', definition: 'The art of effective or persuasive speaking or writing', exampleSentence: 'The politician\'s rhetoric was designed to appeal to voters\' emotions rather than their reason.', unit: 'Rhetoric and Persuasion', tier: 3 },
    { word: 'anaphora', definition: 'The repetition of a word or phrase at the beginning of successive clauses for rhetorical effect', exampleSentence: 'King used anaphora when he repeated "I have a dream" to build momentum and emphasis.', unit: 'Rhetoric and Persuasion', tier: 3 },
    { word: 'juxtaposition', definition: 'Placing two things close together to highlight their differences or create contrast', exampleSentence: 'Shakespeare uses juxtaposition of light and dark imagery to contrast good and evil.', unit: 'All units', tier: 2 },
    { word: 'foreshadowing', definition: 'A hint or warning about events that will happen later in the story', exampleSentence: 'The witches\' prophecies are an example of foreshadowing, hinting at Macbeth\'s rise and fall.', unit: 'Shakespeare', tier: 3 },
    { word: 'ambiguity', definition: 'The quality of being open to more than one interpretation', exampleSentence: 'There is deliberate ambiguity in the poem\'s final line, leaving the reader to decide the speaker\'s fate.', unit: 'Poetry', tier: 2 },
    { word: 'tricolon', definition: 'A rhetorical device using a series of three parallel words, phrases, or clauses', exampleSentence: 'The speaker\'s use of tricolon ("we will fight, we will resist, we will overcome") creates a powerful rhythm.', unit: 'Rhetoric and Persuasion', tier: 3 },
    { word: 'tyranny', definition: 'Cruel and oppressive government or rule; the abuse of power', exampleSentence: 'Macbeth\'s reign descends into tyranny as he murders anyone who threatens his hold on power.', unit: 'Shakespeare', tier: 2 },
    { word: 'subvert', definition: 'To undermine the power or authority of something; to challenge expectations', exampleSentence: 'The poet subverts the traditional love poem by revealing the speaker\'s controlling nature.', unit: 'Poetry', tier: 2 },
    { word: 'pathos', definition: 'A quality that evokes pity, sympathy, or sadness in the audience', exampleSentence: 'The speech creates pathos by describing the suffering of innocent children.', unit: 'Rhetoric and Persuasion', tier: 3 },
    { word: 'imperative', definition: 'A verb form used to give commands or instructions', exampleSentence: 'Lady Macbeth uses imperative verbs like "unsex" and "fill" to demand supernatural transformation.', unit: 'Shakespeare', tier: 3 },
  ],
  rubrics: [
    {
      ...
      descriptors: [
        { level: 'Excelling', description: 'Insightful analysis of Shakespeare\'s language choices with precisely selected quotations. Explores the effects of dramatic techniques on the audience with confidence. Engages with context (historical, social) to deepen interpretation. Sustains a coherent argument across multiple paragraphs.' },
        { level: 'Secure', description: 'Clear analysis of key speeches and scenes with relevant quotations. Identifies dramatic techniques and explains their effects. Some awareness of context and its influence on meaning. Writing is well-organised with clear paragraphing.' },
        { level: 'Developing', description: 'Some relevant comments on Shakespeare\'s language with supporting quotations. May identify techniques but struggles to explain effects fully. Limited engagement with context. Writing may lack clear structure or sustained argument.' },
        { level: 'Emerging', description: 'Basic retelling of events with limited analysis. Quotations, if used, tend to be lengthy and unanalysed. Little or no engagement with language, form, structure, or context. Writing lacks clear organisation.' },
      ],
    },
    {
      ...
      descriptors: [
        { level: 'Excelling', description: 'Sustained, integrated comparison throughout. Explores similarities and differences in methods and effects with perceptive analysis. Uses comparative connectives fluidly. Both poems receive equally detailed treatment. Alternative interpretations considered.' },
        { level: 'Secure', description: 'Clear comparison with references to both poems in most paragraphs. Identifies key similarities and differences in methods. Uses comparative connectives. Analysis is relevant and mostly developed.' },
        { level: 'Developing', description: 'Some comparison attempted but may treat poems sequentially. Limited use of comparative connectives. One poem may receive more attention than the other. Analysis is present but underdeveloped.' },
        { level: 'Emerging', description: 'Minimal comparison. Poems discussed separately with little or no attempt to draw connections. Analysis is limited to identification of features without exploration of effect.' },
      ],
    },
    {
      ...
      descriptors: [
        ...
        { level: 'Secure', description: 'Clearly persuasive writing with a consistent sense of audience. Several rhetorical devices used effectively. Ideas are logically sequenced. Tone is appropriate and sustained. Generally accurate with some ambitious choices.' },
        { level: 'Developing', description: 'Attempts to persuade with some awareness of audience. A limited range of rhetorical devices, some of which may feel forced. Ideas present but may lack logical progression. Some technical inaccuracy.' },
        { level: 'Emerging', description: 'Limited persuasive intent. Few or no rhetorical devices. Writing reads as personal opinion without strategic argumentation. Frequent technical errors. Limited sense of audience or purpose.' },
      ],
    },
  ],
}
...
const year9Resources: CurriculumResource = {
  ...
  workbook: [
    ...
    },
    {
      ...
      extensionTask:
        'Write the introduction and first body paragraph of your essay in full.',
    },
    {
  ...
  readingList: [
    {
      ...
      description: 'The core set text for the term. A moral allegory about redemption, social responsibility, and the power of compassion to transform individuals and society.',
    },
    {
      ...
      description: 'A political play exploring social responsibility, class, and generational conflict. Complements the themes of A Christmas Carol while introducing dramatic form.',
    },
    {
      title: 'Animal Farm',
      author: 'George Orwell',
      ...
      description: 'An allegory of revolution and the corruption of power. Excellent for teaching critical thinking about political systems and propaganda.',
    },
    {
      ...
      difficulty: 'challenging',
      termRelevance: 'Term 2 - Alternative novel study',
      description: 'A novel exploring civilisation versus savagery, power, and moral responsibility. Challenging language but deeply engaging themes for Year 9.',
    },
    {
      ...
      description: 'A contemporary novel about racial injustice, identity, and finding your voice. Connects to critical thinking themes and develops empathy.',
    },
    {
      ...
      difficulty: 'challenging',
      termRelevance: 'Independent reading',
      description: 'A dystopia about censorship and the power of literature. Excellent for developing critical thinking about the role of books and ideas in society.',
    },
  ],
  vocabulary: [
    { word: 'allegory', definition: 'A story in which the characters and events represent broader themes, moral lessons, or political situations', exampleSentence: 'A Christmas Carol can be read as an allegory for the moral responsibilities of the wealthy toward the poor.', unit: '19th-Century Prose', tier: 3 },
    { word: 'redemption', definition: 'The act of being saved from sin, error, or evil; the process of moral transformation', exampleSentence: 'Scrooge\'s redemption is made possible by his willingness to confront the consequences of his greed.', unit: '19th-Century Prose', tier: 2 },
    { word: 'didactic', definition: 'Intended to teach or instruct, especially regarding moral lessons', exampleSentence: 'Dickens\'s didactic purpose is clear: he wants the reader to recognise their own responsibility toward the poor.', unit: '19th-Century Prose', tier: 3 },
    { word: 'microcosm', definition: 'A small-scale representation of something much larger', exampleSentence: 'The Birling household functions as a microcosm of Edwardian class society.', unit: 'Modern Drama', tier: 3 },
    { word: 'critique', definition: 'A detailed analysis and assessment, often of a social or political system', exampleSentence: 'Priestley\'s play is a critique of capitalist individualism and its consequences for vulnerable people.', unit: 'Modern Drama', tier: 2 },
    { word: 'synthesis', definition: 'The combination of ideas or elements to form a connected whole or a new interpretation', exampleSentence: 'Your conclusion should offer a synthesis of your main arguments rather than simply listing them.', unit: 'Pre-IGCSE', tier: 2 },
    { word: 'evaluate', definition: 'To assess the quality, importance, or value of something by weighing evidence and arguments', exampleSentence: 'Evaluate the extent to which Dickens presents Scrooge as a victim of his own upbringing.', unit: 'Pre-IGCSE', tier: 2 },
    { word: 'nuanced', definition: 'Characterised by subtle distinctions and variations rather than simple, absolute positions', exampleSentence: 'A nuanced response acknowledges that Scrooge is both villain and victim, rather than presenting him as purely one or the other.', unit: 'All units', tier: 2 },
    { word: 'motif', definition: 'A recurring element (image, idea, or symbol) that has significance in a text', exampleSentence: 'The motif of cold and warmth runs throughout A Christmas Carol, representing isolation and human connection.', unit: '19th-Century Prose', tier: 3 },
    { word: 'thesis', definition: 'A statement or argument that a writer puts forward and supports with evidence', exampleSentence: 'Your essay should open with a clear thesis that states your overall argument in one sentence.', unit: 'Pre-IGCSE', tier: 2 },
  ],
  rubrics: [
    {
      ...
      descriptors: [
        ...
        { level: 'Secure', description: 'A clear argument with well-selected evidence. Analysis of writer\'s methods is relevant and developed. Some engagement with context. Appropriate academic register. Generally accurate with clear paragraphing and logical progression. Introduction states argument; conclusion draws threads together.' },
        { level: 'Developing', description: 'An argument is attempted but may drift or lose focus. Some analysis of language with relevant quotations but explanations may be surface-level. Context may be presented as separate information rather than integrated into analysis. Expression is generally clear but may lack sophistication. Some structural weaknesses.' },
        { level: 'Emerging', description: 'Limited argument with tendency toward retelling. Evidence used is sparse or poorly selected. Little analysis of writer\'s methods. Context absent or inaccurate. Expression is simple with limited vocabulary. Structural organisation is weak. Technical errors are frequent.' },
      ],
    },
    {
      ...
      descriptors: [
        { level: 'Excelling', description: 'Perceptive, detailed analysis of language and structure. Identifies subtle effects and explores multiple possible interpretations. Analysis is precise, using correct terminology. Comments on how structure contributes to meaning. Writes with confidence and fluency about an unfamiliar text.' },
        { level: 'Secure', description: 'Clear analysis of language features with appropriate terminology. Identifies structural features and comments on their effects. Quotations are well-selected and embedded. Explanations are developed beyond identification. Response is organised and focused.' },
        { level: 'Developing', description: 'Identifies some language features with relevant examples. May use terminology inconsistently or inaccurately. Structural analysis is limited. Explanations tend toward labelling techniques without fully exploring effects. Some relevant comments but lacks depth.' },
        { level: 'Emerging', description: 'Limited identification of language features. May rely on content summary rather than analysis. Quotations, if used, are poorly chosen or overly long. Little or no structural analysis. Terminology is absent or incorrect.' },
      ],
    },
  ],
}
  ...
  readingList: [
    {
      ...
      description: 'A novella set during the Great Depression exploring friendship, dreams, loneliness, and the American Dream. Core set text for IGCSE Literature.',
    },
    {
      title: 'An Inspector Calls',
      author: 'J.B. Priestley',
      ...
      difficulty: 'moderate',
      termRelevance: 'Set text throughout',
      description: 'A morality play set in 1912 but written in 1945, exploring social responsibility, class, and generational conflict. Core set text for IGCSE Literature.',
    },
    {
      title: 'Macbeth',
      ...
      difficulty: 'challenging',
      termRelevance: 'Set text throughout',
      description: 'Shakespeare\'s exploration of ambition, guilt, and the supernatural. Students should aim to read the full play and know key soliloquies thoroughly.',
    },
    {
      ...
      description: 'A companion text for Of Mice and Men, exploring the American Dream from the perspective of wealth and corruption.',
    },
    {
      ...
      difficulty: 'moderate',
      termRelevance: 'Wider reading',
      description: 'A companion text for An Inspector Calls, exploring family, loyalty, and the consequences of obsessive desire.',
    },
  ],
  vocabulary: [
    { word: 'protagonist', definition: 'The leading character in a story, play, or novel', exampleSentence: 'George can be seen as the protagonist of the novella, as the story is largely filtered through his perspective.', unit: 'Set Texts', tier: 3 },
    { word: 'antagonist', definition: 'A character who opposes the protagonist; a source of conflict', exampleSentence: 'Curley functions as an antagonist whose aggression threatens George and Lennie\'s dream.', unit: 'Set Texts', tier: 3 },
    { word: 'cyclical structure', definition: 'A narrative structure that ends where it began, creating a sense of inevitability or repetition', exampleSentence: 'The novella\'s cyclical structure, returning to the riverbank, suggests that the dream was always doomed to fail.', unit: 'Of Mice and Men', tier: 3 },
    { word: 'social responsibility', definition: 'The idea that individuals and organisations have a duty to act in the best interests of society', exampleSentence: 'Priestley uses the Inspector to argue that social responsibility is not optional but a moral imperative.', unit: 'An Inspector Calls', tier: 2 },
    { word: 'hubris', definition: 'Excessive pride or self-confidence, especially when leading to downfall', exampleSentence: 'Macbeth\'s hubris, fuelled by the witches\' prophecies, blinds him to the consequences of his actions.', unit: 'Macbeth', tier: 3 },
    { word: 'catharsis', definition: 'The emotional release experienced by the audience at the end of a tragedy', exampleSentence: 'The audience experiences catharsis as Macbeth is finally defeated, restoring moral order to Scotland.', unit: 'Macbeth', tier: 3 },
    { word: 'register', definition: 'The level of formality in a piece of writing, determined by audience and purpose', exampleSentence: 'Adjust your register to match the task: a letter to a headteacher requires formal register, while a magazine article for teenagers allows a more conversational tone.', unit: 'Paper 1', tier: 2 },
    { word: 'discourse marker', definition: 'A word or phrase that signals the direction of an argument (e.g., however, furthermore, consequently)', exampleSentence: 'Use discourse markers to guide your reader through your argument: "Furthermore," "In contrast," "As a result."', unit: 'Paper 1', tier: 3 },
  ],
  rubrics: [
    {
      ...
      descriptors: [
        { level: 'Band 5 (Top)', description: 'Perceptive understanding demonstrated through precise, well-selected references. Sophisticated analysis of how language is used to achieve effects. Evaluation is assured and personal, with a clear sense of the writer\'s craft. Synthesis across texts (where required) is seamless.' },
        { level: 'Band 4', description: 'Secure understanding with well-chosen references. Clear analysis of language features and their effects. Comments are developed and supported. Comparison (where required) is sustained and balanced.' },
        { level: 'Band 3', description: 'Sound understanding with relevant references. Some analysis of language, though explanations may not be fully developed. Comparison (where required) is attempted with some success. Ideas are generally clear.' },
        { level: 'Band 2', description: 'Limited understanding demonstrated through broad references. Identification of some features but limited analysis. Comparison is uneven or underdeveloped. Some retelling rather than analysis.' },
        { level: 'Band 1', description: 'Basic understanding with little supporting evidence. Simple identification without analysis. No meaningful comparison. Response is largely descriptive or narrative.' },
      ],
    },
    {
      title: 'IGCSE Literature Set Text Essay Rubric',
      assessmentObjective: 'AO1-AO4: Response to text, analysis of methods, context, and written quality',
      descriptors: [
        { level: 'Band 5 (Top)', description: 'Conceptual, exploratory response that engages critically with the text. Precise analysis of writer\'s methods with insightful comment on effects. Contextual understanding is integrated, illuminating interpretation. Expression is fluent, academic, and technically controlled. A convincing personal response is sustained throughout.' },
        { level: 'Band 4', description: 'Thoughtful, developed response with a clear argument. Analysis of writer\'s methods is relevant and detailed. Context is used to support interpretation. Expression is clear and well-organised with appropriate terminology. Personal engagement with the text is evident.' },
        { level: 'Band 3', description: 'A relevant response with some development. Some analysis of writer\'s methods, though this may be inconsistent. Context is referenced but not always integrated. Expression is generally clear. Evidence of personal response.' },
        { level: 'Band 2', description: 'Supported response with some relevant points. Limited analysis of methods. Context may be asserted rather than explored. Expression is sometimes unclear. Personal response is emerging.' },
        { level: 'Band 1', description: 'Simple response with limited reference to the text. No meaningful analysis of methods. Context is absent or inaccurate. Expression is basic with frequent errors. Little evidence of personal engagement.' },
      ],
    },
  ],
}
  ...
  readingList: [
    {
      ...
      description: 'An accessible introduction to how language works, covering acquisition, grammar, and the nature of human language. Excellent background reading.',
    },
    {
      ...
      description: 'An introduction to critical discourse analysis. Essential for understanding how language shapes and is shaped by power relations.',
    },
    {
      ...
      description: 'Explores gender differences in conversational style. Useful for the language and identity unit and as context for investigation topics.',
    },
    {
      title: 'Mother Tongue',
      author: 'Bill Bryson',
      ...
      description: 'An entertaining and informative history of the English language. Provides excellent context for the language change component.',
    },
    {
      ...
      description: 'Explores English as a global language, covering varieties, attitudes, and the politics of language. Supports investigation topics related to world Englishes.',
    },
    {
      ...
      description: 'An analysis of how the internet is changing language. Highly relevant to student investigations and to understanding language change in real time.',
    },
  ],
  vocabulary: [
    { word: 'lexis', definition: 'The total stock of words in a language; vocabulary considered as a system', exampleSentence: 'The lexis of the advertisement draws heavily from a semantic field of nature and purity.', unit: 'Linguistic Frameworks', tier: 3 },
    { word: 'pragmatics', definition: 'The study of how context contributes to meaning beyond the literal sense of words', exampleSentence: 'A pragmatic analysis reveals that the speaker\'s question "Is that your coat on the floor?" functions as an indirect command to pick it up.', unit: 'Linguistic Frameworks', tier: 3 },
    { word: 'implicature', definition: 'Something that is suggested or implied by an utterance rather than explicitly stated', exampleSentence: 'The implicature of "I\'ve got an early start tomorrow" in response to a party invitation is that the speaker is declining.', unit: 'Pragmatics', tier: 3 },
    { word: 'idiolect', definition: 'The speech habits and patterns peculiar to an individual person', exampleSentence: 'Her idiolect includes frequent use of hedging devices and rising intonation on declarative sentences.', unit: 'Language and Identity', tier: 3 },
    { word: 'sociolect', definition: 'A variety of language associated with a particular social group', exampleSentence: 'The sociolect of medical professionals includes specialised terminology and nominalisation.', unit: 'Language and Identity', tier: 3 },
    { word: 'code-switching', definition: 'The practice of alternating between two or more languages or language varieties within a single conversation', exampleSentence: 'The bilingual speaker engages in code-switching, using Arabic for family-related topics and English for work-related topics.', unit: 'Language and Identity', tier: 3 },
    { word: 'nominalisation', definition: 'The process of turning a verb or adjective into a noun, often creating a more formal or abstract register', exampleSentence: 'The political speech uses nominalisation ("the destruction of communities") to remove agency and avoid attributing blame.', unit: 'Grammar', tier: 3 },
    { word: 'presupposition', definition: 'An implicit assumption that must be true for a statement to make sense', exampleSentence: 'The question "When did you stop cheating?" carries the presupposition that the listener was cheating at some point.', unit: 'Pragmatics', tier: 3 },
    { word: 'corpus', definition: 'A large, structured collection of texts used for linguistic analysis', exampleSentence: 'The investigation draws on a corpus of 50 social media posts collected over a two-week period.', unit: 'Unit 4 Investigation', tier: 3 },
    { word: 'deixis', definition: 'Words or phrases whose meaning depends on context, such as "this," "here," "now," "I," and "you"', exampleSentence: 'The use of spatial deixis ("over there," "this place") anchors the narrative in the speaker\'s physical location.', unit: 'Pragmatics', tier: 3 },
    { word: 'amelioration', definition: 'A process of language change in which a word acquires a more positive meaning over time', exampleSentence: 'The word "nice" has undergone amelioration, shifting from its original meaning of "foolish" to its modern sense of "pleasant."', unit: 'Language Change', tier: 3 },
    { word: 'pejoration', definition: 'A process of language change in which a word acquires a more negative meaning over time', exampleSentence: 'The word "villain" has undergone pejoration, originally meaning "farm worker" but now meaning "criminal" or "evil person."', unit: 'Language Change', tier: 3 },
  ],
  rubrics: [
    {
      title: 'IAL Text Analysis Rubric',
      assessmentObjective: 'AO1/AO2: Knowledge of linguistic concepts and analysis of language in context',
      descriptors: [
        { level: 'Band 5 (Top)', description: 'Perceptive, exploratory analysis that demonstrates sophisticated understanding of linguistic concepts. Terminology is precise and used fluently. Analysis systematically addresses multiple linguistic levels. Theoretical frameworks are applied convincingly and add genuine analytical insight. The response shows independent thinking and the ability to weigh competing interpretations.' },
        { level: 'Band 4', description: 'Detailed, well-organised analysis with accurate and consistent use of terminology. Addresses language features at multiple levels. Theories are referenced and applied appropriately. Ideas are well-developed and supported with evidence. Clear awareness of the relationship between language and context.' },
        { level: 'Band 3', description: 'Competent analysis with generally accurate terminology. Addresses features at two or more linguistic levels. Some reference to theory, though application may be surface-level. Ideas are supported with examples. Awareness of context, though this may not be fully integrated into analysis.' },
        { level: 'Band 2', description: 'Some relevant analysis but terminology may be inaccurate or inconsistent. May focus on one linguistic level at the expense of others. Limited or no reference to theory. Some ideas are underdeveloped. Context may be acknowledged but not connected to linguistic features.' },
        { level: 'Band 1', description: 'Limited analysis with minimal or incorrect use of terminology. May rely on GCSE-level approaches (identifying "language techniques" without linguistic precision). No reference to theory. Ideas are undeveloped and unsupported. Little or no awareness of context.' },
      ],
    },
    {
      ...
      descriptors: [
        { level: 'Band 5 (Top)', description: 'A focused, well-designed investigation with a clear, answerable research question. Methodology is justified and appropriate. Data is presented clearly and analysed systematically using precise linguistic terminology. Findings are connected to relevant theories and evaluated critically. Limitations are honestly assessed and suggestions for further research are insightful. Written in an academic register with fluent expression.' },
        { level: 'Band 4', description: 'A clearly structured investigation with a focused research question. Methodology is explained and largely appropriate. Data is presented and analysed with generally accurate terminology. Findings are related to some relevant theories. Evaluation of limitations is present. Written clearly in an appropriate register.' },
        { level: 'Band 3', description: 'An investigation with a workable research question, though it may be somewhat broad. Methodology is described but justification may be limited. Data analysis uses some appropriate terminology. Some reference to theory. Evaluation is present but may be superficial. Expression is generally clear.' },
        { level: 'Band 2', description: 'An investigation with a vague or overly broad research question. Methodology is unclear or poorly justified. Data analysis is descriptive rather than analytical. Terminology is limited or inaccurate. Little or no reference to theory. Evaluation is minimal. Expression may lack academic register.' },
        { level: 'Band 1', description: 'An unfocused investigation with no clear research question. Methodology is absent or inappropriate. Data is presented without meaningful analysis. Terminology is absent or incorrect. No theoretical engagement. No evaluation. Expression is informal or unclear.' },
      ],
    },
  ],
}
