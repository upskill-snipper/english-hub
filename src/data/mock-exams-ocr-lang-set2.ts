...
export const ocrLangMocksSet2: MockExamPaper[] = [
  // COMPONENT 01: Communicating Information and Ideas - Mock Exam 1: Artificial Intelligence
  {
    ...
    description: 'Students read an article about AI in everyday life and respond to writing tasks covering summary, persuasion, and advice.',
    ...
    tasks: [
      {
        taskNumber: 1,
        title: 'Summary Task',
        instruction: 'Write a summary of the key benefits and concerns about artificial intelligence mentioned in the article. Your answer should be approximately 150-200 words.',
        marks: 20,
      },
      {
        taskNumber: 2,
        title: 'Persuasive Writing',
        instruction: 'Write a persuasive article for a technology magazine arguing that AI development should continue, but only with strict government oversight. Address at least three specific concerns about AI and explain how regulation addresses each. Your answer should be approximately 250-300 words.',
        marks: 30,
      },
      {
        taskNumber: 3,
        title: 'Informative Writing',
        instruction: 'Create an informative guide for adults learning about AI, explaining what artificial intelligence is, how it works, and where they will encounter it in daily life. Use clear language, headings, and practical examples. Your answer should be approximately 200-250 words.',
        marks: 30,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Identifies main benefits (productivity, accuracy, accessibility, cost reduction) and concerns (bias, privacy, job displacement, ethical issues). Award full marks for balanced coverage.',
            },
            {
              criterion: 'Appropriate vocabulary and clarity',
              marks: 5,
              details: 'Uses subject-specific terminology (machine learning, automation, algorithms). Sentences are clear and technical where appropriate.',
            },
            {
              criterion: 'Length and form',
              marks: 5,
              details: 'Approximately 150-200 words. Format as continuous prose or structured comparison.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Clearly argues for continued AI development with oversight. Uses evidence and logical reasoning. Anticipates counter-arguments.',
            },
            {
              criterion: 'Addressing specific concerns',
              marks: 10,
              details: 'Identifies three distinct concerns (bias, privacy, displacement) and explains how regulation addresses each.',
            },
            {
              criterion: 'Structure and tone',
              marks: 8,
              details: 'Clear introduction of position, developed paragraphs addressing each concern, conclusion reinforcing argument. Professional register.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Explains what AI is, how it works, and where encountered, using accessible language without oversimplification.',
            },
            {
              criterion: 'Practical examples',
              marks: 10,
              details: 'Provides concrete, recognizable examples of AI in everyday contexts (smartphones, recommendations, navigation).',
            },
            {
              criterion: 'Organization and accessibility',
              marks: 8,
              details: 'Effective use of headings and logical progression. Language is clear and welcoming for adult learners.',
            },
          ],
        },
      ],
...
The path forward requires balanced governance that enables beneficial AI while addressing legitimate concerns.`,
        marks: 19,
        feedback: 'Excellent balanced coverage of both benefits and concerns. Clear terminology used appropriately. Could expand slightly on solutions or implications.',
      },
      {
        taskNumber: 2,
...
The path forward is clear: continue developing this powerful technology while establishing guardrails protecting human dignity, fairness, and privacy.`,
        marks: 28,
        feedback: 'Strong persuasive argument with clear position. Excellent addressing of three specific concerns with explanations of regulatory solutions. Well-structured with good evidence.',
      },
      {
        taskNumber: 3,
...
Understanding AI helps you make informed decisions about technology in your life. You can question whether AI recommendations serve your interests or someone else's. You can understand data privacy implications when using AI-powered services. You can evaluate claims about AI's capabilities and limitations. In a world increasingly shaped by AI, literacy about this technology matters for your security, privacy, and empowerment.`,
        marks: 26,
        feedback: 'Excellent clear explanations using accessible language and familiar examples. Good organization with headings. Could include more depth on some technical aspects for adult learners.',
      },
    ],
  },
  ...
  // COMPONENT 01: Communicating Information and Ideas - Mock Exam 2: Urban Green Spaces
  {
    ...
    description: 'Students read about urban green space initiatives and respond to writing tasks involving analysis, persuasion, and guidance.',
    ...
    tasks: [
      {
        ...
        instruction: 'Write an informative summary of the environmental and human health benefits of urban green spaces. Organize your response using clear headings for environmental and health benefits. Your answer should be approximately 150-200 words.',
        marks: 20,
      },
      {
        taskNumber: 2,
        title: 'Persuasive Campaign',
        instruction: 'Write a persuasive campaign text for your local council arguing for increased investment in parks and green spaces. Address the concerns about budget constraints and maintenance costs, and explain why green space investment is economically justified. Your answer should be approximately 250-300 words.',
        marks: 30,
      },
      {
        taskNumber: 3,
        title: 'Community Action Guide',
        instruction: 'Create a guide for community members on how to advocate for green space improvement in their neighborhood. Include practical steps, potential partners to engage, and how to build community support. Your answer should be approximately 200-250 words.',
        marks: 30,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Covers environmental benefits (air quality, stormwater, heat reduction, carbon sequestration) and health benefits (cognitive, stress reduction, physical). Award full marks for comprehensive coverage.',
            },
            {
              criterion: 'Organization and clarity',
              marks: 5,
              details: 'Effective use of headings to separate environmental and health sections. Sentences clearly present specific benefits.',
            },
            {
              criterion: 'Evidence and examples',
              marks: 5,
              details: 'References specific benefits from source material (e.g., stormwater management, cognitive development).',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Compelling argument for increased investment. Uses evidence and logic. Tone appropriate for council communication.',
            },
            {
              criterion: 'Addressing cost concerns',
              marks: 10,
              details: 'Specifically addresses budget constraints and maintenance costs, explaining why investment is justified economically.',
            },
            {
              criterion: 'Structure and impact',
              marks: 8,
              details: 'Clear argument development. Strong opening establishing need. Effective conclusion motivating council action.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Provides clear, actionable steps community members can follow. Steps are realistic and specific.',
            },
            {
              criterion: 'Identifying partners and resources',
              marks: 10,
              details: 'Identifies relevant partners (council, environmental groups, businesses) and explains how to engage them.',
            },
            {
              criterion: 'Building community support',
              marks: 8,
              details: 'Addresses how to generate momentum and build broad community engagement in advocacy.',
            },
          ],
        },
      ],
...
Green spaces serve essential rather than optional functions in healthy cities.`,
        marks: 20,
        feedback: 'Excellent comprehensive coverage organized clearly with headings. Good balance of environmental and health benefits. Could include slightly more specific examples.',
      },
      {
        taskNumber: 2,
...
The economic case is clear: invest in parks now, or pay far more later in health, infrastructure, and social costs.`,
        marks: 29,
        feedback: 'Strong persuasive argument directly addressing cost concerns. Excellent economic reasoning with specific value propositions. Could strengthen with one additional specific example.',
      },
      {
        taskNumber: 3,
...
Your advocacy creates healthier, more livable neighborhoods for everyone.`,
        marks: 27,
        feedback: 'Clear, practical steps with logical progression. Good identification of coalition partners. Could expand slightly on communication strategies with media.',
      },
    ],
  },
  ...
  // COMPONENT 01: Communicating Information and Ideas - Mock Exam 3: Digital Literacy
  {
    ...
    description: 'Students read about digital literacy challenges and respond to writing tasks involving explanation, persuasion, and guidance.',
    ...
    tasks: [
      {
        taskNumber: 1,
        title: 'Summary Task',
        instruction: 'Write a summary of the key digital literacy skills needed in modern life and the gaps that exist in digital competency. Your answer should be approximately 150-200 words.',
        marks: 20,
      },
      {
        taskNumber: 2,
        title: 'Persuasive Proposal',
        instruction: 'Write a persuasive proposal to your local authority arguing that they should fund a free community digital literacy program. Address the benefits to different groups and explain how this investment benefits the whole community. Your answer should be approximately 250-300 words.',
        marks: 30,
      },
      {
        taskNumber: 3,
        title: 'Parent Information Guide',
        instruction: 'Create an informative guide for parents on digital literacy, covering what it is, why it matters, warning signs of digital problems, and how parents can help develop their children\'s digital skills. Your answer should be approximately 200-250 words.',
        marks: 30,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Covers technical skills, information literacy, communication, creative skills, critical thinking, and cybersecurity. Award full marks for comprehensive coverage.',
            },
            {
              criterion: 'Explaining existing gaps',
              marks: 5,
              details: 'Identifies specific gaps (age, income, geography, development level). Explains implications of gaps.',
            },
            {
              criterion: 'Clarity and conciseness',
              marks: 5,
              details: 'Summary is clear, well-organized, and appropriately detailed within word limit.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Makes compelling argument for public digital literacy funding. Uses evidence and logic. Addresses why local authority should prioritize this.',
            },
            {
              criterion: 'Demonstrating community benefit',
              marks: 10,
              details: 'Shows how program benefits diverse groups (elderly, low-income, families). Explains broader community advantages.',
            },
            {
              criterion: 'Structure and tone',
              marks: 8,
              details: 'Appropriate formal tone for government proposal. Clear argument development with logical conclusion.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Clearly explains what digital literacy means and what skills are included, in language accessible to parents.',
            },
            {
              criterion: 'Addressing parental concerns',
              marks: 10,
              details: 'Identifies warning signs of problems (addiction, exposure to harmful content). Explains risks clearly.',
            },
            {
              criterion: 'Practical guidance',
              marks: 8,
              details: 'Provides specific, actionable steps parents can take to develop children\'s digital skills safely.',
            },
          ],
        },
      ],
...
Addressing these gaps requires community and governmental commitment.`,
        marks: 20,
        feedback: 'Comprehensive coverage of digital literacy competencies and gaps. Good identification of affected populations. Could include specific statistics more effectively.',
      },
      {
        taskNumber: 2,
...
This proposal requires modest initial investment for substantial community return. I urge approval.`,
        marks: 28,
        feedback: 'Strong persuasive proposal with clear benefits demonstrated for multiple populations. Good economic reasoning. Could strengthen by addressing implementation details.',
      },
      {
        taskNumber: 3,
...
Digital literacy empowers children while protecting them from risks. Your involvement as a parent matters tremendously.`,
        marks: 26,
        feedback: 'Clear, accessible guide addressing parent concerns effectively. Good balance of explanation and practical guidance. Could include more specific warning sign examples.',
      },
    ],
  },
  ...
  // COMPONENT 01: Communicating Information and Ideas - Mock Exam 4: Ocean Plastic Pollution
  {
    ...
    description: 'Students read about ocean plastic pollution and respond to writing tasks involving analysis, persuasion, and advocacy.',
    ...
    tasks: [
      {
        taskNumber: 1,
        title: 'Analysis Task',
        instruction: 'Write an analysis of the sources of ocean plastic pollution and the impacts it has on marine ecosystems. Organize your response clearly, addressing sources and impacts separately. Your answer should be approximately 150-200 words.',
        marks: 20,
      },
      {
        taskNumber: 2,
        title: 'Persuasive Article',
        instruction: 'Write a persuasive article for a business magazine arguing that corporations must take responsibility for plastic waste by implementing sustainable packaging and production practices. Address cost concerns and explain why this is economically advantageous long-term. Your answer should be approximately 250-300 words.',
        marks: 30,
      },
      {
        taskNumber: 3,
        title: 'Action Guide',
        instruction: 'Create a practical guide for consumers on reducing personal plastic consumption and ocean plastic impact. Include specific daily actions, shopping habits, and advocacy steps. Your answer should be approximately 200-250 words.',
        marks: 30,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Covers fishing nets, single-use plastics, microplastics, industrial sources, improper waste management, and marine vessels. Award full marks for comprehensive coverage.',
            },
            {
              criterion: 'Explaining ecosystem impacts',
              marks: 5,
              details: 'Addresses animal entanglement, ingestion consequences, food chain accumulation, ecosystem disruption, and chemical release.',
            },
            {
              criterion: 'Organization and clarity',
              marks: 5,
              details: 'Clear separation of sources and impacts. Information is presented logically and understandably.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Makes compelling business argument for sustainable practices. Uses evidence and logic. Addresses why corporations should prioritize this.',
            },
            {
              criterion: 'Addressing cost concerns',
              marks: 10,
              details: 'Specifically addresses short-term costs and explains long-term economic advantages (consumer loyalty, regulatory compliance, risk mitigation).',
            },
            {
              criterion: 'Structure and tone',
              marks: 8,
              details: 'Professional business magazine tone. Clear argument with logical development and compelling conclusion.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Provides specific, achievable daily actions consumers can implement immediately.',
            },
            {
              criterion: 'Shopping and consumption guidance',
              marks: 10,
              details: 'Addresses sustainable shopping habits, packaging choices, and product selection.',
            },
            {
              criterion: 'Advocacy and systemic change',
              marks: 8,
              details: 'Includes ways consumers can advocate for policy change and corporate responsibility.',
            },
          ],
        },
      ],
...
The accumulation continues at alarming rates threatening all ocean ecosystems.`,
        marks: 19,
        feedback: 'Good comprehensive coverage of sources and impacts. Clear organization. Could strengthen with specific quantitative examples about scale.',
      },
      {
        taskNumber: 2,
...
The economic case is compelling.`,
        marks: 29,
        feedback: 'Excellent persuasive argument with strong business logic. Addresses cost concerns thoroughly with long-term perspective. Could strengthen with specific company examples.',
      },
      {
        taskNumber: 3,
...
Personal responsibility combines with systemic change creating substantial environmental impact.`,
        marks: 25,
        feedback: 'Clear, actionable guide with practical suggestions across multiple areas. Good balance of personal and systemic actions. Could strengthen with specific product examples.',
      },
    ],
  },
  ...
  // COMPONENT 01: Communicating Information and Ideas - Mock Exam 5: Mental Health in Schools
  {
    ...
    description: 'Students read about school mental health challenges and respond to writing tasks involving analysis, persuasion, and guidance.',
    ...
    tasks: [
      {
        taskNumber: 1,
        title: 'Analysis Task',
        instruction: 'Write an analysis identifying the key factors contributing to mental health problems in young people and explaining how schools can identify and support struggling students early. Your answer should be approximately 150-200 words.',
        marks: 20,
      },
      {
        taskNumber: 2,
        title: 'Persuasive Argument',
        instruction: 'Write a persuasive article for educational leaders arguing that mental health support should be prioritized equally with academic achievement in schools. Address resource allocation concerns and explain why this benefits academic performance. Your answer should be approximately 250-300 words.',
        marks: 30,
      },
      {
        taskNumber: 3,
        title: 'Student Support Guide',
        instruction: 'Create an informative guide for students on recognizing mental health struggles in themselves and friends, and accessing available support. Include warning signs, resources, and how to help a struggling friend. Your answer should be approximately 200-250 words.',
        marks: 30,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Covers academic pressure, social comparison, sleep deprivation, bullying, family stress, developmental challenges, and trauma. Award full marks for comprehensive coverage.',
            },
            {
              criterion: 'School identification and support',
              marks: 5,
              details: 'Explains how schools can identify struggling students and provide early intervention.',
            },
            {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Makes compelling argument that mental health deserves equal prioritization with academics. Uses evidence and logic.',
            },
            {
              criterion: 'Addressing resource concerns',
              marks: 10,
              details: 'Addresses funding constraints and explains how mental health investment benefits academic performance.',
            },
            {
              criterion: 'Structure and effectiveness',
              marks: 8,
              details: 'Strong argument development. Appropriate tone for educational leadership audience. Compelling conclusion.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Clearly identifies warning signs of mental health struggles (behavioral, academic, social changes).',
            },
            {
              criterion: 'Resource accessibility',
              marks: 10,
              details: 'Lists specific available support resources and how students access them. Clear and welcoming presentation.',
            },
            {
              criterion: 'Supporting others',
              marks: 8,
              details: 'Provides practical guidance on helping struggling friends and maintaining own wellbeing.',
            },
          ],
        },
      ],
...
School vigilance combined with supportive response saves lives.`,
        marks: 20,
        feedback: 'Comprehensive identification of contributing factors with clear examples. Good explanation of school identification methods. Could strengthen with specific warning sign details.',
      },
      {
        taskNumber: 2,
...
The choice is clear: invest in mental health support, watch academic outcomes improve, and create genuinely thriving schools.`,
        marks: 29,
        feedback: 'Strong persuasive argument with compelling business logic. Excellent reframing of mental health as academically supportive. Could strengthen with specific outcome statistics.',
      },
      {
        taskNumber: 3,
...
You are not alone. Asking for help is brave.`,
        marks: 26,
        feedback: 'Accessible, helpful guide with practical information. Good balance of self-awareness and helping others. Could strengthen with more specific school-based resource examples.',
      },
    ],
  },
  ...
  // COMPONENT 01: Communicating Information and Ideas - Mock Exam 6: Community Resilience
  {
    ...
    description: 'Students read about community resilience and respond to writing tasks involving explanation, persuasion, and community development guidance.',
    ...
    tasks: [
      {
        ...
        instruction: 'Write an analysis identifying the key dimensions of community resilience and explaining how these dimensions benefit communities beyond just crisis response. Your answer should be approximately 150-200 words.',
        marks: 20,
      },
      {
        taskNumber: 2,
        title: 'Persuasive Proposal',
        instruction: 'Write a persuasive proposal to local government arguing that significant investment in community resilience programs is essential for long-term community wellbeing. Address cost concerns and explain how resilience investment generates economic returns. Your answer should be approximately 250-300 words.',
        marks: 30,
      },
      {
        taskNumber: 3,
        title: 'Community Engagement Guide',
        instruction: 'Create a practical guide for community members on building local connections and contributing to community resilience. Include specific actions individuals can take and how to initiate community projects. Your answer should be approximately 200-250 words.',
        marks: 30,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Covers social cohesion, economic diversity, infrastructure, institutional capacity, health, environmental sustainability, cultural cohesion, and information access. Award full marks for comprehensive coverage.',
            },
            {
              criterion: 'Benefits beyond crisis',
              marks: 5,
              details: 'Explains how resilience improves health, education, economic vitality, crime reduction, civic engagement, and innovation.',
            },
            {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Makes compelling argument for government resilience investment. Uses evidence and logic. Addresses why local government should prioritize this.',
            },
            {
              criterion: 'Economic justification',
              marks: 10,
              details: 'Addresses cost concerns and explains economic returns from resilience investment (improved health outcomes, economic development, disaster preparedness).',
            },
            {
              criterion: 'Structure and tone',
              marks: 8,
              details: 'Appropriate tone for government proposal. Clear argument development with logical conclusion.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Provides specific, achievable actions individuals can take to build community connections.',
            },
            {
              criterion: 'Community project initiation',
              marks: 10,
              details: 'Explains how to identify community needs, gather support, and initiate resilience-building projects.',
            },
            {
              criterion: 'Motivation and accessibility',
              marks: 8,
              details: 'Demonstrates why community participation matters and makes participation accessible to varied individuals.',
            },
          ],
        },
      ],
...
These benefits accumulate, creating the foundation for truly thriving communities.`,
        marks: 19,
        feedback: 'Comprehensive coverage of resilience dimensions with clear examples of benefits. Good organization. Could strengthen with specific statistics about benefit magnitudes.',
      },
      {
        taskNumber: 2,
...
We can invest in resilience now, or pay far more later.`,
        marks: 28,
        feedback: 'Strong economic argument with specific cost-benefit reasoning. Excellent disaster preparedness example. Could strengthen with specific dollar amount examples.',
      },
      {
        taskNumber: 3,
...
Remember: your personal security depends on community security. Building community resilience is enlightened self-interest.`,
        marks: 27,
        feedback: 'Excellent practical guide with specific achievable actions. Good variety of participation options. Could strengthen with examples of successful community projects.',
      },
    ],
  },
];
