  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. The house was silent in a way that felt deliberate. 2. The front door opened easily without resistance. 3. The hallway was long and narrow. 4. The wallpaper had a dark green vine pattern.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'How does the writer use language to create a sense of unease in the extract?\n\nYou should consider:\n- word choices and their effects\n- imagery and figurative language\n- the overall impact on the reader.',
            marks: 8,
      ...
      },
      {
        ...
        description:
          'You are advised to spend about 50 minutes on this section. You are reminded of the need to plan your answer.',
        totalMarks: 40,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A clear and engaging piece that: uses descriptive or narrative techniques (simile, metaphor, sensory detail); has a clear structure with distinct paragraphs; includes varied vocabulary; attempts to create atmosphere; demonstrates generally accurate spelling, punctuation, and grammar.',
              'Grade 6-7':
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. The bombardment had stopped an hour ago. 2. Ellis was lying face down in a crater. 3. He could smell cordite and churned soil. 4. His left arm was at an unnatural angle.',
            },
            markScheme: [
              '1 mark per valid point drawn from the first two paragraphs',
              'Maximum 4 marks',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'How does the writer use language to convey the devastation of war in the extract?\n\nYou should consider:\n- word choices and their effects\n- imagery and figurative language\n- the overall impact on the reader.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_02,
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              'How does the writer use structure to contrast destruction and beauty in the extract?\n\nYou should consider:\n- the overall organisation of the text\n- how the writer shifts focus between paragraphs\n- any other structural features that interest you.',
            marks: 12,
            suggestedTimeMinutes: 18,
            questionType: 'analysis',
            extract: EXTRACT_02,
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              '"The writer suggests that nature is indifferent to human suffering, and this makes the extract more powerful."\n\nTo what extent do you agree with this statement? You should refer closely to the text in your answer.',
            marks: 16,
            suggestedTimeMinutes: 22,
            questionType: 'evaluation',
            extract: EXTRACT_02,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A clear and engaging piece that: uses descriptive or narrative techniques; has a clear structure with distinct paragraphs; includes varied vocabulary; attempts to create atmosphere; demonstrates generally accurate spelling, punctuation, and grammar.',
              'Grade 6-7':
              ...
              'Grade 8-9':
                'An assured, crafted piece that: creates a vivid, immersive experience through precise, original imagery; demonstrates sophisticated structural control; uses an extensive vocabulary with precise word choices; employs varied sentence structures with complete control; shows technical virtuosity and a distinctive voice.',
            },
            markScheme: [
              'Content & Organisation (32 marks): Voice, imagery, atmosphere, structural control',
              'Technical Accuracy (8 marks): SPaG accuracy, ambition, and variety',
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. She was good at knowing what other people were thinking. 2. She did not believe in supernatural abilities. 3. She had spent her childhood watching faces. 4. She grew up uncertain of her welcome.',
            },
            markScheme: [
              '1 mark per valid point drawn from the first two paragraphs',
              'Maximum 4 marks',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              "How does the writer use language to present Nadia's experience of reading other people?\n\nYou should consider:\n- word choices and their effects\n- imagery and figurative language\n- the overall impact on the reader.",
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_03,
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              "How does the writer structure the extract to reveal Nadia's character to the reader?\n\nYou should consider:\n- the overall organisation of the text\n- how the writer controls the release of information\n- sentence-level structural choices.",
            marks: 12,
            suggestedTimeMinutes: 18,
            questionType: 'analysis',
            extract: EXTRACT_03,
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              '"The writer presents Nadia\'s ability to read people as a curse rather than a gift."\n\nTo what extent do you agree with this statement? You should refer closely to the text in your answer.',
            marks: 16,
            suggestedTimeMinutes: 22,
            questionType: 'evaluation',
            extract: EXTRACT_03,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A clear and engaging piece that: uses descriptive or narrative techniques; has a clear structure with distinct paragraphs; includes varied vocabulary; attempts to create atmosphere or tension; demonstrates generally accurate spelling, punctuation, and grammar.',
              'Grade 6-7':
                'A compelling piece that: crafts sustained atmosphere or character through sensory detail; uses varied and ambitious vocabulary; demonstrates conscious structural choices; employs a range of sentence forms for effect; shows consistent accuracy with some sophisticated constructions.',
              'Grade 8-9':
                'An assured, crafted piece that: creates a vivid, immersive experience through precise imagery and psychological insight; demonstrates sophisticated structural control; uses an extensive vocabulary with precise word choices; employs varied sentence structures with complete control; shows technical virtuosity and a distinctive voice.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. The river had mostly dried up the summer Tom turned fourteen. 2. There was still a thin trickle of water at the deepest point. 3. The old swimming hole was now a muddy depression. 4. A rope swing still hung from an oak branch above dry ground.',
            },
            markScheme: [
              '1 mark per valid point drawn from the first two paragraphs',
              'Maximum 4 marks',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'How does the writer use language to present the changes to the river and the landscape?\n\nYou should consider:\n- word choices and their effects\n- imagery and figurative language\n- the overall impact on the reader.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_04,
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              "How does the writer structure the extract to develop Tom's growing understanding?\n\nYou should consider:\n- the overall organisation of the text\n- how the writer uses different perspectives and time frames\n- any other structural features that interest you.",
            marks: 12,
            suggestedTimeMinutes: 18,
            questionType: 'analysis',
            extract: EXTRACT_04,
            ...
            modelAnswers: {
              'Grade 4-5':
                "The extract starts by showing Tom looking at the dried-up river in the present. The second paragraph describes what has been revealed by the low water. The third paragraph goes back in time to the grandfather's warning, which Tom did not understand at the time. The fourth paragraph widens the focus to show the effect on the whole village. The final paragraph returns to Tom sitting on the porch, now understanding what his grandfather meant. The structure moves from observation to memory to understanding, showing Tom's growing maturity.",
              'Grade 6-7':
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              '"The writer uses the dried-up river to represent something much larger - the end of childhood innocence."\n\nTo what extent do you agree with this statement? You should refer closely to the text in your answer.',
            marks: 16,
            suggestedTimeMinutes: 22,
            questionType: 'evaluation',
            extract: EXTRACT_04,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A clear and engaging piece that: uses descriptive or narrative techniques; has a clear structure with distinct paragraphs; includes varied vocabulary; attempts to create atmosphere or convey emotion; demonstrates generally accurate spelling, punctuation, and grammar.',
              'Grade 6-7':
                'A compelling piece that: crafts sustained atmosphere or emotional depth; uses varied and ambitious vocabulary; demonstrates conscious structural choices; employs a range of sentence forms for effect; shows consistent accuracy with some sophisticated constructions.',
              'Grade 8-9':
                'An assured, crafted piece that: creates a vivid, immersive experience through precise imagery and thematic depth; demonstrates sophisticated structural control; uses an extensive vocabulary with precise word choices; employs varied sentence structures with complete control; shows technical virtuosity and a distinctive voice.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. She was studying ancient woodland. 2. She had been researching this patch of forest for seven years. 3. She discovered that trees communicate through fungal threads. 4. The trees exchange carbon, nitrogen, phosphorus, and water.',
            },
            markScheme: [
              '1 mark per valid point drawn from the first two paragraphs',
              'Maximum 4 marks',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'How does the writer use language to present the natural world as complex and interconnected?\n\nYou should consider:\n- word choices and their effects\n- imagery and figurative language\n- the overall impact on the reader.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_05,
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText:
              "How does the writer structure the extract to develop the reader's understanding of the forest?\n\nYou should consider:\n- the overall organisation of the text\n- how the writer moves between observation and reflection\n- any other structural features that interest you.",
            marks: 12,
            suggestedTimeMinutes: 18,
            questionType: 'analysis',
            extract: EXTRACT_05,
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              '"The writer makes us see the natural world not as something separate from human experience but as something we are deeply connected to."\n\nTo what extent do you agree with this statement? You should refer closely to the text in your answer.',
            marks: 16,
            suggestedTimeMinutes: 22,
            questionType: 'evaluation',
            extract: EXTRACT_05,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A clear and engaging piece that: uses descriptive or narrative techniques; has a clear structure with distinct paragraphs; includes varied vocabulary; attempts to create atmosphere or a sense of place; demonstrates generally accurate spelling, punctuation, and grammar.',
              'Grade 6-7':
                'A compelling piece that: crafts sustained atmosphere or sense of place through sensory detail; uses varied and ambitious vocabulary; demonstrates conscious structural choices; employs a range of sentence forms for effect; shows consistent accuracy with some sophisticated constructions.',
              'Grade 8-9':
                'An assured, crafted piece that: creates a vivid, immersive experience through precise, original imagery of the natural world; demonstrates sophisticated structural control with deliberate shifts in perspective or scale; uses an extensive vocabulary with precise word choices; employs varied sentence structures with complete control; shows technical virtuosity and a distinctive voice.',
            },
            markScheme: [
              'Content & Organisation (32 marks): Voice, imagery, atmosphere, structural control',
              'Technical Accuracy (8 marks): SPaG accuracy, ambition, and variety',
