...
const P01_SOURCE_B_REF = 'Professor Daniel Okafor, "The Myth of the Screen-Damaged Generation", New Statesman, 2024'
...
const P03_SOURCE_B_REF = 'Professor Helen Marchetti, "In Defence of Examinations", The Spectator, 2024'
...
const P05_SOURCE_B_REF = 'Professor Amira Hassan, "Who Owns the City?", London Review of Books, 2024'
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
        ...
        questions: [
          {
            id: 'ocr-p1-01-q1',
            questionNumber: 1,
            questionText: 'Read Source A. Identify four concerns the writer expresses about social media and young people.',
            marks: 4,
            ...
            modelAnswers: {
              'Grade 4-5': '1. Students disappear into their phones during break times. 2. A student could not sleep for three weeks because of group chat anxiety. 3. Social media platforms are deliberately designed to be addictive. 4. Children are being treated as data points in an advertising algorithm.',
            },
          ...
          },
          {
            id: 'ocr-p1-01-q2',
            questionNumber: 2,
            questionText: 'Read Source A. How does the writer use the example of the Year 10 student to strengthen her argument?\n\nExplain using evidence from the text.',
            marks: 8,
          ...
          },
          {
            id: 'ocr-p1-01-q3',
            questionNumber: 3,
            questionText: 'Read Source B. How does the writer use language and structure to present their perspective on social media and young people?\n\nAnalyse the techniques used and their effects.',
            marks: 12,
          ...
          },
          {
            id: 'ocr-p1-01-q4',
            questionNumber: 4,
            questionText: 'Read both Source A and Source B. Compare how the two writers convey their different perspectives on social media and young people.\n\nIn your answer you should:\n- compare their different perspectives\n- compare the methods they use to convey their perspectives\n- support your response with references to both texts.',
            marks: 16,
      ...
      },
      {
        ...
        description: 'You are advised to spend about 45 minutes on this section. Answer the question below.',
        totalMarks: 40,
        ...
        questions: [
          {
            id: 'ocr-p1-01-q5',
            questionNumber: 5,
            questionText: '"Social media does more harm than good to young people."\n\nWrite an article for a broadsheet newspaper in which you argue for or against this statement.\n\n(32 marks for content and organisation / 8 marks for technical accuracy)',
            marks: 40,
            suggestedTimeMinutes: 45,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear, purposeful article with: a sustained argument for or against; some persuasive techniques including rhetorical questions and evidence; appropriate register for a newspaper audience; generally accurate spelling and punctuation.',
              'Grade 6-7': 'A well-crafted article with: a sophisticated and nuanced argument; effective use of rhetorical devices, counter-argument, and evidence; a distinctive voice appropriate to broadsheet register; well-organised paragraphs with discourse markers; consistent technical accuracy with varied sentence structures.',
        ...
        questions: [
          {
            id: 'ocr-p1-02-q1',
            questionNumber: 1,
            questionText: 'Read Source A. Identify four negative consequences of losing green spaces that the writer describes.',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              'Grade 4-5': '1. Loss of wildflowers and natural habitats. 2. Increased stress and worsened mental health. 3. Less encouragement for physical activity. 4. Higher rates of depression and cardiovascular disease in communities without green space.',
            },
          ...
          },
          {
            id: 'ocr-p1-02-q2',
            questionNumber: 2,
            questionText: 'Read Source A. How does the writer use the opening description of Thornfield Meadow to strengthen her argument?\n\nExplain using evidence from the text.',
            marks: 8,
            suggestedTimeMinutes: 10,
            questionType: 'analysis',
            extract: P02_SOURCE_A,
          ...
          },
          {
            id: 'ocr-p1-02-q3',
            questionNumber: 3,
            questionText: 'Read Source B. How does the writer use language and structure to present their argument about green spaces and development?\n\nAnalyse the techniques used and their effects.',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
          ...
          },
          {
            id: 'ocr-p1-02-q4',
            questionNumber: 4,
            questionText: 'Read both Source A and Source B. Compare how the two writers convey their different perspectives on the relationship between development and the natural environment.\n\nIn your answer you should:\n- compare their different perspectives\n- compare the methods they use to convey their perspectives\n- support your response with references to both texts.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'comparison',
            extract: `Source A:\n${P02_SOURCE_A}\n\n---\n\nSource B:\n${P02_SOURCE_B}`,
        ...
        questions: [
          {
            id: 'ocr-p1-02-q5',
            questionNumber: 5,
            questionText: 'Your local council is planning to build new homes on a green space near your school.\n\nWrite a speech to be delivered at a public meeting in which you argue whether this development should or should not go ahead.\n\n(32 marks for content and organisation / 8 marks for technical accuracy)',
            marks: 40,
            suggestedTimeMinutes: 45,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear, purposeful speech with: a sustained argument; direct address to the audience; some persuasive techniques including rhetorical questions and emotive language; generally accurate spelling and punctuation.',
              'Grade 6-7': 'A well-crafted speech with: sophisticated rhetorical techniques including tricolon, anaphora, and counter-argument; appropriate register for a public meeting; a compelling opening and memorable conclusion; consistent technical accuracy with varied sentence structures.',
              'Grade 8-9': 'An outstanding speech with: compelling argument that addresses complexity; masterful rhetorical control with strategic use of personal testimony, evidence, and emotional appeal; a distinctive, authoritative voice; structural sophistication building to a powerful call to action; technical virtuosity throughout.',
            },
            markScheme: [
              'Content & Organisation (32 marks): Communication is convincing; tone, style and register match purpose and audience; argument is structured with clear viewpoint; paragraphs are coherently linked',
              'Technical Accuracy (8 marks): Sentence demarcation is accurate; wide range of punctuation used; spelling is accurate including ambitious vocabulary; varied sentence forms used for effect',
        ...
        questions: [
          {
            id: 'ocr-p1-03-q1',
            questionNumber: 1,
            questionText: 'Read Source A. Identify four criticisms the writer makes of the current education system.',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              'Grade 4-5': '1. Students are forced into classrooms early in the morning despite their biology. 2. Subjects are taught in rigid fifty-minute blocks. 3. The system tests memory rather than understanding. 4. Children are sorted into hierarchies based on exam performance which does not predict adult success.',
            },
          ...
          },
          {
            id: 'ocr-p1-03-q2',
            questionNumber: 2,
            questionText: 'Read Source A. How does the writer use their personal experience to make their argument more convincing?\n\nExplain using evidence from the text.',
            marks: 8,
            suggestedTimeMinutes: 10,
            questionType: 'analysis',
            extract: P03_SOURCE_A,
          ...
          },
          {
            id: 'ocr-p1-03-q3',
            questionNumber: 3,
            questionText: 'Read Source B. How does the writer use language and structure to defend the examination system?\n\nAnalyse the techniques used and their effects.',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
          ...
          },
          {
            id: 'ocr-p1-03-q4',
            questionNumber: 4,
            questionText: 'Read both Source A and Source B. Compare how the two writers convey their different perspectives on the education system and examinations.\n\nIn your answer you should:\n- compare their different perspectives\n- compare the methods they use to convey their perspectives\n- support your response with references to both texts.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'comparison',
            extract: `Source A:\n${P03_SOURCE_A}\n\n---\n\nSource B:\n${P03_SOURCE_B}`,
        ...
        questions: [
          {
            id: 'ocr-p1-03-q5',
            questionNumber: 5,
            questionText: '"Exams are an outdated way of measuring what young people know and can do."\n\nWrite a blog post for a student website in which you argue for or against this statement.\n\n(32 marks for content and organisation / 8 marks for technical accuracy)',
            marks: 40,
            suggestedTimeMinutes: 45,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear, purposeful blog post with: a sustained argument; appropriate informal-yet-informed register; some persuasive techniques; personal voice; generally accurate spelling and punctuation.',
              'Grade 6-7': 'A well-crafted blog post with: sophisticated argument drawing on personal experience and wider evidence; engaging opening that hooks the reader; appropriate register balancing accessibility with intellectual substance; consistent technical accuracy with varied sentence structures.',
              'Grade 8-9': 'An outstanding blog post with: a compelling, original argument that acknowledges complexity; distinctive voice combining personal conviction with intellectual rigour; ambitious vocabulary and syntactic variety; structural sophistication including a powerful conclusion; technical virtuosity throughout.',
            },
            markScheme: [
              'Content & Organisation (32 marks): Communication is convincing; tone, style and register match purpose and audience; argument is structured with clear viewpoint; paragraphs are coherently linked',
              'Technical Accuracy (8 marks): Sentence demarcation is accurate; wide range of punctuation used; spelling is accurate including ambitious vocabulary; varied sentence forms used for effect',
        ...
        questions: [
          {
            id: 'ocr-p1-04-q1',
            questionNumber: 1,
            questionText: 'Read Source A. Identify four ways the writer suggests the wellness industry is harmful.',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              'Grade 4-5': '1. It makes people feel their bodies are always in crisis. 2. Every headline warns of new dietary dangers. 3. Influencers promote supplements, detoxes, and elimination diets. 4. The writer\'s daughter became malnourished by following an online diet.',
            },
          ...
          },
          {
            id: 'ocr-p1-04-q2',
            questionNumber: 2,
            questionText: 'Read Source A. How does the writer use the story of her daughter to convey her argument about the wellness industry?\n\nExplain using evidence from the text.',
            marks: 8,
            suggestedTimeMinutes: 10,
            questionType: 'analysis',
            extract: P04_SOURCE_A,
          ...
          },
          {
            id: 'ocr-p1-04-q3',
            questionNumber: 3,
            questionText: 'Read Source B. How does the writer use language and structure to present their argument about health and the body?\n\nAnalyse the techniques used and their effects.',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
          ...
          },
          {
            id: 'ocr-p1-04-q4',
            questionNumber: 4,
            questionText: 'Read both Source A and Source B. Compare how the two writers convey their perspectives on modern attitudes to health and the body.\n\nIn your answer you should:\n- compare their different perspectives\n- compare the methods they use to convey their perspectives\n- support your response with references to both texts.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'comparison',
            extract: `Source A:\n${P04_SOURCE_A}\n\n---\n\nSource B:\n${P04_SOURCE_B}`,
        ...
        questions: [
          {
            id: 'ocr-p1-04-q5',
            questionNumber: 5,
            questionText: '"Young people today are under too much pressure to look and feel perfect."\n\nWrite a letter to the editor of a health magazine in which you argue for or against this view.\n\n(32 marks for content and organisation / 8 marks for technical accuracy)',
            marks: 40,
            suggestedTimeMinutes: 45,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear, purposeful letter with: appropriate format including salutation and sign-off; a sustained argument; some persuasive techniques; generally accurate spelling and punctuation.',
              'Grade 6-7': 'A well-crafted letter with: sophisticated argument drawing on personal experience and wider evidence; appropriate formal register for a magazine editor; effective use of rhetorical devices and counter-argument; consistent technical accuracy with varied sentence structures.',
              'Grade 8-9': 'An outstanding letter with: a compelling, nuanced argument that goes beyond simple agreement or disagreement; distinctive voice combining passion with restraint; ambitious vocabulary and syntactic variety; structural sophistication; impeccable letter conventions; technical virtuosity throughout.',
            },
            markScheme: [
              'Content & Organisation (32 marks): Communication is convincing; tone, style and register match purpose and audience; argument is structured with clear viewpoint; paragraphs are coherently linked',
              'Technical Accuracy (8 marks): Sentence demarcation is accurate; wide range of punctuation used; spelling is accurate including ambitious vocabulary; varied sentence forms used for effect',
        ...
        questions: [
          {
            id: 'ocr-p1-05-q1',
            questionNumber: 1,
            questionText: 'Read Source A. Identify four things that changed on the writer\'s estate after the youth centre was demolished.',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              'Grade 4-5': '1. There was nowhere for young people to go except the street. 2. Youth workers disappeared. 3. The community police officers were removed. 4. The library and GP surgery also disappeared.',
            },
          ...
          },
          {
            id: 'ocr-p1-05-q2',
            questionNumber: 2,
            questionText: 'Read Source A. How does the writer use their personal experience of estate life to challenge outsiders\' perceptions?\n\nExplain using evidence from the text.',
            marks: 8,
            suggestedTimeMinutes: 10,
            questionType: 'analysis',
            extract: P05_SOURCE_A,
          ...
          },
          {
            id: 'ocr-p1-05-q3',
            questionNumber: 3,
            questionText: 'Read Source B. How does the writer use language and structure to argue that modern cities are failing their residents?\n\nAnalyse the techniques used and their effects.',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
          ...
          },
          {
            id: 'ocr-p1-05-q4',
            questionNumber: 4,
            questionText: 'Read both Source A and Source B. Compare how the two writers convey their perspectives on communities and urban spaces.\n\nIn your answer you should:\n- compare their different perspectives\n- compare the methods they use to convey their perspectives\n- support your response with references to both texts.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'comparison',
            extract: `Source A:\n${P05_SOURCE_A}\n\n---\n\nSource B:\n${P05_SOURCE_B}`,
        ...
        questions: [
          {
            id: 'ocr-p1-05-q5',
            questionNumber: 5,
            questionText: '"Every town and city should have free, open public spaces where people of all ages and backgrounds can gather."\n\nWrite an article for your local newspaper in which you argue for or against this view.\n\n(32 marks for content and organisation / 8 marks for technical accuracy)',
            marks: 40,
            suggestedTimeMinutes: 45,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear, purposeful article with: a sustained argument; appropriate register for a local newspaper; some persuasive techniques including examples and rhetorical questions; generally accurate spelling and punctuation.',
              'Grade 6-7': 'A well-crafted article with: sophisticated argument balancing idealism with practical consideration; effective use of local examples and wider evidence; appropriate journalistic register; consistent technical accuracy with varied sentence structures.',
