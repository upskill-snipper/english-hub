...
const WJEC_C2_11_SOURCE_B_REF = 'Edmund Hargraves, "Against the Cult of Games", The Saturday Review, 1897'
...
const WJEC_C2_12_SOURCE_A_REF = 'Megan Lloyd-Williams, "The Myth of Justice", The New Statesman, 2023'
...
const WJEC_C2_12_SOURCE_B_REF = 'Elizabeth Fry (attributed), Observations on the Visiting of Female Prisoners, 1827'
...
const WJEC_C2_14_SOURCE_B_REF = 'Charles Knight, "In Defence of the Popular Press", The Edinburgh Review, 1855'
...
const WJEC_C2_15_SOURCE_B_REF = 'William Morris, "Art and the People", a lecture delivered in Birmingham, 1879'
        ...
        questions: [
          {
            id: 'wjec-c2-11-q1',
            questionNumber: 1,
            questionText: 'Read the 21st-century source text about sport (Source A).\n\nList five things you learn about the role of sport from this text.',
            marks: 5,
            ...
            modelAnswers: {
              'Grade 4-5': '1. A nineteen-year-old flanker won Wales the Six Nations. 2. The match was at the Principality Stadium with seventy thousand people. 3. The young player had been stacking shelves in Aldi twelve months earlier. 4. Sport can make strangers unite and grab each other in excitement. 5. The writer believes sport is one of the last places where thousands share the same emotion together.',
            },
          ...
          },
          {
            id: 'wjec-c2-11-q2',
            questionNumber: 2,
            questionText: 'How does the 21st-century writer use language to convey their enthusiasm for sport?\n\nYou should comment on specific words and phrases and their effects.',
            marks: 10,
        ...
        questions: [
          {
            id: 'wjec-c2-11-q5',
            questionNumber: 5,
            questionText: 'Your local council is considering closing the town\'s sports centre to save money.\n\nWrite a letter to the council arguing that the sports centre should remain open.\n\nYou could include:\n- the benefits of the sports centre to the community\n- the consequences of closing it\n- alternative ways to save money.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear letter with: appropriate form and register; relevant arguments; generally accurate SPaG.',
              'Grade 6-7': 'A well-structured letter with: persuasive techniques; developed arguments; consistent accuracy.',
              'Grade 8-9': 'A compelling letter with: sophisticated rhetoric; nuanced counter-arguments; technical virtuosity.',
            },
            markScheme: [
          ...
          },
          {
            id: 'wjec-c2-11-q6',
            questionNumber: 6,
            questionText: '"Sport has become too commercialised. It is no longer about passion and teamwork but about money and celebrity."\n\nWrite an article for a broadsheet newspaper in which you argue for or against this view.',
            marks: 24,
        ...
        questions: [
          {
            id: 'wjec-c2-12-q1',
            questionNumber: 1,
            questionText: 'Read the 21st-century source text about the prison system (Source A).\n\nList five things you learn about the writer\'s experience of working in a prison.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            extract: `Source A:\n${WJEC_C2_12_SOURCE_A}\n\nSource B:\n${WJEC_C2_12_SOURCE_B}`,
            ...
            modelAnswers: {
              'Grade 4-5': '1. The writer worked as a prison teacher for three years. 2. She taught at HMP Swansea. 3. Over eighty per cent of her inmates had been excluded from school before age fourteen. 4. More than half were functionally illiterate. 5. Nearly all came from the same handful of postcodes with high unemployment.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            id: 'wjec-c2-12-q2',
            questionNumber: 2,
            questionText: 'How does the 21st-century writer use language to criticise the prison system?\n\nYou should comment on specific words and phrases and their effects.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: `Source A:\n${WJEC_C2_12_SOURCE_A}`,
          ...
          },
          {
            id: 'wjec-c2-12-q4',
            questionNumber: 4,
            questionText: '"Both writers argue that the prison system punishes poverty rather than crime, but the 19th-century writer makes a more powerful case because individual stories are more moving than statistics."\n\nTo what extent do you agree? You should refer to both texts in your answer.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: `Source A:\n${WJEC_C2_12_SOURCE_A}\n\nSource B:\n${WJEC_C2_12_SOURCE_B}`,
        ...
        questions: [
          {
            id: 'wjec-c2-12-q5',
            questionNumber: 5,
            questionText: 'Your school is organising a debate on the motion: "Community service is a better punishment than prison for non-violent offenders."\n\nWrite the text of a speech arguing either for or against this motion.\n\nYou could include:\n- the purpose of punishment\n- the effects of prison on individuals and families\n- the benefits or drawbacks of community service.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear speech with: appropriate form and register; relevant arguments; generally accurate SPaG.',
              'Grade 6-7': 'A well-structured speech with: rhetorical techniques; developed arguments; consistent accuracy.',
              'Grade 8-9': 'A compelling speech with: sophisticated rhetoric; nuanced counter-arguments; technical virtuosity.',
            },
            markScheme: [
              'Communication & Organisation (10 marks): Purpose, audience, form, structure',
              'Writing Accurately (6 marks): Sentence variety, vocabulary, SPaG',
          ...
          },
          {
            id: 'wjec-c2-12-q6',
            questionNumber: 6,
            questionText: '"Young people today are too quick to judge others and too slow to understand the circumstances that shape people\'s lives."\n\nWrite an article for a magazine aimed at young people in which you explore this idea. You may agree or disagree.',
            marks: 24,
            suggestedTimeMinutes: 40,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear article with: appropriate form; a range of ideas; generally accurate SPaG.',
              'Grade 6-7': 'A well-crafted article with: engaging opening; balanced exploration; consistent accuracy.',
              'Grade 8-9': 'An outstanding article with: compelling voice; nuanced argument; technical virtuosity.',
            },
            markScheme: [
              'Communication & Organisation (14 marks): Purpose, audience, form, voice, structure',
              'Writing Accurately (10 marks): Sentence variety, vocabulary, SPaG',
        ...
        questions: [
          {
            id: 'wjec-c2-13-q1',
            questionNumber: 1,
            questionText: 'Read the 21st-century source text about food and agriculture (Source A).\n\nList five things you learn about how our relationship with food has changed.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            extract: `Source A:\n${WJEC_C2_13_SOURCE_A}\n\nSource B:\n${WJEC_C2_13_SOURCE_B}`,
          ...
          },
          {
            id: 'wjec-c2-13-q2',
            questionNumber: 2,
            questionText: 'How does the 21st-century writer use language to persuade the reader that our relationship with food has become problematic?\n\nYou should comment on specific words and phrases and their effects.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: `Source A:\n${WJEC_C2_13_SOURCE_A}`,
        ...
        questions: [
          {
            id: 'wjec-c2-13-q5',
            questionNumber: 5,
            questionText: 'Your school canteen is considering changing its menu to include only locally sourced, seasonal food.\n\nWrite a report for the school governors giving your views on this proposal.\n\nYou could include:\n- the benefits of locally sourced food\n- potential challenges\n- your recommendation.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear report with: appropriate form and register; relevant points; generally accurate SPaG.',
              'Grade 6-7': 'A well-structured report with: balanced analysis; clear recommendations; consistent accuracy.',
              'Grade 8-9': 'An outstanding report with: sophisticated analysis; compelling logic; technical virtuosity.',
            },
            markScheme: [
              'Communication & Organisation (10 marks): Purpose, audience, form, structure',
              'Writing Accurately (6 marks): Sentence variety, vocabulary, SPaG',
          ...
          },
          {
            id: 'wjec-c2-13-q6',
            questionNumber: 6,
            questionText: '"We have become a nation that knows the price of everything we eat but the value of nothing."\n\nWrite an article for a lifestyle magazine in which you explore our modern relationship with food. You may agree or disagree with the statement.',
            marks: 24,
            suggestedTimeMinutes: 40,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear article with: appropriate form; a range of ideas; generally accurate SPaG.',
              'Grade 6-7': 'A well-crafted article with: engaging opening; thoughtful exploration; consistent accuracy.',
              'Grade 8-9': 'An outstanding article with: compelling voice; nuanced argument; technical virtuosity.',
            },
            markScheme: [
              'Communication & Organisation (14 marks): Purpose, audience, form, voice, structure',
        ...
        questions: [
          {
            id: 'wjec-c2-14-q1',
            questionNumber: 1,
            questionText: 'Read the 21st-century source text about technology and young people (Source A).\n\nList five things you learn about the impact of smartphones on teenagers.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            extract: `Source A:\n${WJEC_C2_14_SOURCE_A}\n\nSource B:\n${WJEC_C2_14_SOURCE_B}`,
          ...
          },
          {
            id: 'wjec-c2-14-q2',
            questionNumber: 2,
            questionText: 'How does the 21st-century writer use language to convey their concern about the effect of technology on young people?\n\nYou should comment on specific words and phrases and their effects.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: `Source A:\n${WJEC_C2_14_SOURCE_A}`,
        ...
        questions: [
          {
            id: 'wjec-c2-14-q5',
            questionNumber: 5,
            questionText: 'Your headteacher is considering banning mobile phones from your school entirely.\n\nWrite a letter to the headteacher giving your views on this proposal.\n\nYou could include:\n- the problems phones cause in school\n- the benefits of having access to a phone\n- your suggested compromise or recommendation.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear letter with: appropriate form and register; relevant arguments; generally accurate SPaG.',
              'Grade 6-7': 'A well-structured letter with: persuasive techniques; balanced reasoning; consistent accuracy.',
              'Grade 8-9': 'A compelling letter with: sophisticated rhetoric; nuanced engagement with counterarguments; technical virtuosity.',
            },
            markScheme: [
              'Communication & Organisation (10 marks): Purpose, audience, form, structure',
              'Writing Accurately (6 marks): Sentence variety, vocabulary, SPaG',
          ...
          },
          {
            id: 'wjec-c2-14-q6',
            questionNumber: 6,
            questionText: '"Social media has done more harm than good to young people\'s mental health."\n\nWrite an article for a national newspaper in which you argue for or against this statement.',
            marks: 24,
            suggestedTimeMinutes: 40,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear article with: appropriate form; a range of ideas; generally accurate SPaG.',
              'Grade 6-7': 'A well-crafted article with: engaging opening; sustained argument; consistent accuracy.',
              'Grade 8-9': 'An outstanding article with: compelling voice; nuanced analysis; technical virtuosity.',
            },
            markScheme: [
              'Communication & Organisation (14 marks): Purpose, audience, form, voice, structure',
              'Writing Accurately (10 marks): Sentence variety, vocabulary, SPaG',
        ...
        questions: [
          {
            id: 'wjec-c2-15-q1',
            questionNumber: 1,
            questionText: 'Read the 21st-century source text about arts funding (Source A).\n\nList five things you learn about the impact of arts cuts in Wales.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            extract: `Source A:\n${WJEC_C2_15_SOURCE_A}\n\nSource B:\n${WJEC_C2_15_SOURCE_B}`,
          ...
          },
          {
            id: 'wjec-c2-15-q2',
            questionNumber: 2,
            questionText: 'How does the 21st-century writer use language to argue that the arts are essential to people\'s lives?\n\nYou should comment on specific words and phrases and their effects.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: `Source A:\n${WJEC_C2_15_SOURCE_A}`,
          ...
          },
          {
            id: 'wjec-c2-15-q4',
            questionNumber: 4,
            questionText: '"Both writers argue that art matters to ordinary people, but the 19th-century writer is more persuasive because he focuses on solutions rather than complaints."\n\nTo what extent do you agree? You should refer to both texts in your answer.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: `Source A:\n${WJEC_C2_15_SOURCE_A}\n\nSource B:\n${WJEC_C2_15_SOURCE_B}`,
        ...
        questions: [
          {
            id: 'wjec-c2-15-q5',
            questionNumber: 5,
            questionText: 'Your local council has announced plans to close the town\'s only art gallery and replace it with a car park.\n\nWrite a speech to be delivered at a public meeting arguing that the gallery should be saved.\n\nYou could include:\n- the importance of the gallery to the community\n- the consequences of its closure\n- alternative solutions to the parking problem.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear speech with: appropriate form and register; relevant arguments; generally accurate SPaG.',
              'Grade 6-7': 'A well-structured speech with: rhetorical techniques; emotional appeal; consistent accuracy.',
              'Grade 8-9': 'A compelling speech with: sophisticated rhetoric; powerful persuasion; technical virtuosity.',
            },
            markScheme: [
              'Communication & Organisation (10 marks): Purpose, audience, form, structure',
              'Writing Accurately (6 marks): Sentence variety, vocabulary, SPaG',
          ...
          },
          {
            id: 'wjec-c2-15-q6',
            questionNumber: 6,
            questionText: '"Every child should study the arts at school until the age of sixteen. The arts are just as important as maths and science."\n\nWrite an article for a broadsheet newspaper in which you argue for or against this view.',
            marks: 24,
            suggestedTimeMinutes: 40,
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear article with: appropriate form; a range of ideas; generally accurate SPaG.',
              'Grade 6-7': 'A well-crafted article with: engaging opening; developed argument; consistent accuracy.',
              'Grade 8-9': 'An outstanding article with: compelling voice; nuanced exploration of both sides; technical virtuosity.',
            },
            markScheme: [
              'Communication & Organisation (14 marks): Purpose, audience, form, voice, structure',
              'Writing Accurately (10 marks): Sentence variety, vocabulary, SPaG',
