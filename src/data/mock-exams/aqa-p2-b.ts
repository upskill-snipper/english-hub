...
const EXAM_07_SOURCE_A_REF =
  'Priya Kaur, "The Retreating Edge", National Geographic Traveller, 2025'
...
const EXAM_08_SOURCE_B_REF =
  'Florence Nightingale, letter to Sidney Herbert, Secretary of State for War, 1855'
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'B, C, F, G - B: "I wanted to see them before they were gone." C: "a morbid kind of tourism, I suppose, but an honest one." F: "minus thirty degrees." G: "I had read about the ice sheets disappearing." A is false (she explicitly says she did not come to find herself). D is false (the landscape was "indifferent to human presence"). E is false (her questions "evaporated"). H is false (the landscape was indifferent to human presence).',
            },
            markScheme: [
              '1 mark for each correct answer',
              'Maximum 4 marks',
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'Both sources show immigrants arriving with very little and working hard. In Source A, Patel\'s parents came with "two suitcases and a dictionary" and his father now runs "three pharmacies." In Source B, Irish immigrants show "industry and enterprise" with women taking in work and men walking "miles each morning" to find jobs. Both sources say immigrants face unfair prejudice - Source A mentions the demand to "prove their worth" and Source B mentions "accusations of criminality." A difference is that Source A focuses on a successful family, while Source B focuses on people still living in poverty.',
              'Grade 6-7':
