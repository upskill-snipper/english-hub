...
const EDUCATION_19C_REF =
  'Rev. James Phillips, Report on Education in Rural Wales, The Cambrian newspaper (1847)'
...
const TRAVEL_21C_REF =
  'Owen Hartley, "Walking Into Weather", National Geographic Traveller UK, 2024'
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. 3.8 million people in the UK experienced destitution in 2024. 2. Destitution means not having enough money for food or heating. 3. People who visit food banks feel ashamed. 4. The writer visited food banks across South Wales. 5. The volunteers who run food banks work without pay.',
            },
          ...
          },
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'We learn that the poor in mining areas lived in terrible conditions. The cottages were next to furnaces and the air was "almost unbreathable." A widow with five children survived on "bread and tea alone." The children were "thin and listless" which shows they were malnourished. The widow\'s husband was killed at work and she received no compensation. The writer says the wealth of the nation comes from their labour but they get nothing back.',
              'Grade 6-7':
                'Rees presents a systematic indictment of industrial exploitation. The physical conditions are conveyed through sensory detail: "the heat from the furnaces rendered the air almost unbreathable" places the domestic and the industrial in grotesque proximity. The widow functions as a representative figure - her individual suffering stands for a systemic failure. The detail of her appearing twenty years older than her actual age is a powerful metonym for the ageing effects of poverty. The phrase "quiet dignity that moved me deeply" complicates the portrait: this is not passive suffering but maintained selfhood under impossible circumstances. The rhetorical question - "What are we to make of a system that consumes men in its furnaces?" - uses the verb "consumes" to make the industrial process literally cannibalistic, while "discards" reduces human beings to waste material. The final tricolon - "This is not misfortune. It is injustice" - enacts a rhetorical reframing from natural disaster to moral failure.',
            },
            markScheme: [
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'We learn that in the 19th century, people argued that women were not suited to serious study. The writer disagrees and uses her own daughters as evidence - one can read Latin, another is good at mathematics, and a third writes poetry. She argues that the real reason people oppose women\'s education is that educated women "ask questions" and "form opinions." She says that society is afraid of women who think for themselves. The phrase "a society that has something to hide" is powerful because it suggests men are covering up their unfair control.',
              'Grade 6-7':
