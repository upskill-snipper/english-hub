...
const SCIENCE_SOURCE_A_REF =
  'Professor James Whitworth, "Rewriting the Code of Life", New Scientist, 2025'
...
const SCIENCE_SOURCE_B_REF =
  'From a lecture by Professor Thomas Huxley at the Royal Institution, 1882'
...
const IMMIGRATION_SOURCE_A_REF =
  'Priya Chakraborty, "Facts, Fear, and the Immigration Debate", The Independent, 2025'
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. Families are forced to move frequently - the writer moved seven times before eighteen. 2. Local authority housing stock has declined by over two million homes. 3. Young people are locked out of home ownership. 4. Over a million children are living in unsuitable housing with health consequences.',
            },
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              'Read both sources. Compare how the two writers convey their different perspectives on immigration.\n\nIn your answer, you should:\n• compare their different perspectives and attitudes\n• compare the methods they use to convey those perspectives\n• support your response with references to both texts.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'comparison',
