...
const EXTRACT_11_SOURCE = 'Adapted from Isabel Allende, The House at the End of Magnolia Street (1984)'
...
const EXTRACT_12_SOURCE = 'Adapted from Sarah Waters, The Night Watch (1941 — set in wartime Britain)'
...
const EXTRACT_13_SOURCE = 'Original literary fiction — crime noir, c. 1952'
...
const EXTRACT_14_SOURCE = 'Adapted from Roger Deakin, Waterlog — Nature Writing (1999)'
...
const EXTRACT_15_SOURCE = 'Original literary fiction — Southern American Gothic, c. 1962'
        ...
        questions: [
          {
            id: 'wjec-c1-11-q1',
            questionNumber: 1,
            questionText: 'Read lines 1-8. List five things you learn about the house and its surroundings from these lines.',
            marks: 5,
            ...
            modelAnswers: {
              'Grade 4-5': '1. The house is three storeys tall with faded coral plaster. 2. It has a tower with a widow\'s walk. 3. It is behind a wrought-iron gate that has rusted half-open. 4. The garden is overgrown with roses climbing the drainpipes. 5. The town is flat and practical, known for canning factories and hardware stores.',
            },
          ...
          },
          {
            id: 'wjec-c1-11-q3',
            questionNumber: 3,
            questionText: 'What impressions do you get of Rosa and her feelings about the house?\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_11,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'A clear piece of creative prose with: recognisable structure; use of descriptive techniques including sensory detail; varied vocabulary; generally accurate SPaG.',
              'Grade 6-7': 'A compelling piece with: controlled atmosphere that blurs the boundary between real and surreal; crafted imagery with original figurative language; structural sophistication (e.g., building from the ordinary to the extraordinary); consistent SPaG accuracy with ambitious punctuation.',
              'Grade 8-9': 'An assured, distinctive piece with: an original voice that sustains tonal control; precise, layered imagery that rewards re-reading; masterful pacing that withholds and reveals; technical virtuosity including sophisticated sentence forms and punctuation used for deliberate effect.',
            },
            markScheme: [
        ...
        questions: [
          {
            id: 'wjec-c1-12-q1',
            questionNumber: 1,
            questionText: 'Read lines 1-6. List five things you learn about Eileen and the scene from these lines.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            extract: EXTRACT_12,
            ...
            modelAnswers: {
              'Grade 4-5': '1. The telegram arrived at half past three on a Tuesday in September. 2. The light was golden and heavy that afternoon. 3. The front door was open. 4. There was a breeze carrying the smell of cut grass and coal smoke. 5. The children were playing in the back garden.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            id: 'wjec-c1-12-q2',
            questionNumber: 2,
            questionText: 'How does the writer use language to convey the devastating impact of the telegram\'s arrival?\n\nYou should comment on:\n- the writer\'s choice of words and phrases\n- the writer\'s use of language features and techniques\n- the effects on the reader.\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_12,
          ...
          },
          {
            id: 'wjec-c1-12-q3',
            questionNumber: 3,
            questionText: 'What impressions do you get of Eileen and how she responds to the news?\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_12,
          ...
          },
          {
            id: 'wjec-c1-12-q4',
            questionNumber: 4,
            questionText: '"The writer creates an overwhelming sense of loss without ever becoming sentimental or melodramatic."\n\nTo what extent do you agree with this view? You should consider the writer\'s use of language and structure in your response.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: EXTRACT_12,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7': 'A compelling piece with: controlled emotional restraint; crafted use of contrast and juxtaposition; structural sophistication (e.g., before/after structure, circular ending); consistent SPaG accuracy with ambitious punctuation.',
              'Grade 8-9': 'An assured, distinctive piece with: an original voice that controls tone with precision; imagery that operates on multiple levels; masterful structural pacing; technical virtuosity that includes varied and sophisticated sentence forms.',
            },
            markScheme: [
              'Content & Organisation (24 marks): Communication, voice, structure',
              'Technical Accuracy (16 marks): Sentence demarcation, punctuation, spelling, sentence variety',
        ...
        questions: [
          {
            id: 'wjec-c1-13-q1',
            questionNumber: 1,
            questionText: 'Read lines 1-7. List five things you learn about Denny Kovacs from these lines.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            extract: EXTRACT_13,
            ...
            modelAnswers: {
              'Grade 4-5': '1. Denny has been watching the woman in the red hat for forty-five minutes. 2. He has a high opinion of his own intelligence. 3. He has survived for twenty-two years in the city. 4. He survives by noticing things. 5. He can detect when someone is about to lie.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            id: 'wjec-c1-13-q2',
            questionNumber: 2,
            questionText: 'How does the writer use language to create tension and a sense of danger in this extract?\n\nYou should comment on:\n- the writer\'s choice of words and phrases\n- the writer\'s use of language features and techniques\n- the effects on the reader.\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_13,
          ...
          },
          {
            id: 'wjec-c1-13-q3',
            questionNumber: 3,
            questionText: 'What impressions do you get of the relationship between Denny and the woman in the red hat?\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_13,
            extractSource: EXTRACT_13_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'Denny and the woman seem to be opponents in some kind of game. He is watching her but she does not acknowledge him, which puts her in control. He thinks she might have "noticed him immediately and decided he was not worth the expenditure of a glance," which would be insulting to someone who prides himself on being noticed and feared. He has been told to deliver a package to her, so they are connected through a third party. The fact that they are in the same room but not communicating creates a tense, cat-and-mouse dynamic.',
              'Grade 6-7': 'The relationship is characterised by an asymmetry of power disguised as mutual indifference. Denny, established as an expert observer, is rendered impotent by the woman\'s refusal to engage: she "gave him nothing." This phrase operates on multiple levels — she offers no information, no reaction, no acknowledgement. The possibility that she "noticed him immediately and decided he was not worth the expenditure of a glance" is devastating to Denny\'s self-conception: the word "expenditure" frames attention as currency, and she has judged him too cheap to spend it on. The delivery task creates an enforced connection — he must approach her — but the three-minute delay suspends them in a charged space between strangers and counterparts. The woman\'s patience ("the patience of a cat watching a mouse hole") is predatory, and the feline simile casts Denny, by implication, as prey — an inversion of his self-image as the city\'s survivor. The reflection in the window, where he sees her raise her cup, introduces a layer of mediation: they observe each other through surfaces, through glass, through reflections, never directly. This suggests a relationship built entirely on indirect reading, where trust is impossible and interpretation is everything.',
            },
            markScheme: [
          ...
          },
          {
            id: 'wjec-c1-13-q4',
            questionNumber: 4,
            questionText: '"The writer creates a gripping atmosphere of suspense that keeps the reader on edge throughout."\n\nTo what extent do you agree with this view? You should consider the writer\'s use of language and structure in your response.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: EXTRACT_13,
            extractSource: EXTRACT_13_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'I agree that the extract is very suspenseful. The writer keeps the reader on edge by not telling us what the package is or why it needs to be delivered. Denny watching the woman creates tension because we don\'t know if she is dangerous. The countdown to four o\'clock gives the extract a deadline, making us feel that something important is about to happen. The rain and dark coffee shop add to the tense atmosphere. The ending, with the woman\'s "unreadable" eyes, leaves us unsure of what will happen next, which is gripping.',
              'Grade 6-7': 'I agree strongly, and I would argue that the extract\'s suspense derives not from what happens (almost nothing does) but from the anticipation of what might. Structurally, the extract is built on delay: the entire passage occupies the space between three fifty-seven and four o\'clock — three minutes stretched across five paragraphs. This temporal distortion mirrors Denny\'s heightened state of awareness, where every detail becomes significant. The writer\'s structural control is evident in the progressive narrowing of focus: the extract opens with forty-five minutes of observation, contracts to "three minutes," and the reader senses an inevitable convergence. The package — "small, wrapped in brown paper, heavier than it looked" — is a masterclass in suggestive withholding: we know its physical properties but nothing of its contents, and this gap between material and meaning generates anxiety. The setting contributes through its liminal quality: the coffee shop is a threshold space, the rain outside creating a boundary between inside and outside that might, at any moment, be breached ("the door might open and admit someone whose intentions were less ambiguous"). The woman herself is the extract\'s central engine of suspense because she is a text that cannot be read — and in a narrative where reading (observing, interpreting, decoding) is equated with survival, illegibility is threat. The final image, viewed through glass and rain — mediated, distorted — refuses resolution, leaving the reader suspended in the same uncertainty that defines Denny\'s experience.',
            },
            markScheme: [
              'Evaluates with a clear, sustained personal response',
              'Analyses language and structural methods',
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear piece of creative prose with: recognisable structure; use of descriptive techniques including atmosphere; varied vocabulary; generally accurate SPaG.',
              'Grade 6-7': 'A compelling piece with: controlled tension sustained through pacing; crafted sensory detail that builds atmosphere; structural sophistication (e.g., compressed timeframe, withheld information); consistent SPaG accuracy with ambitious punctuation.',
              'Grade 8-9': 'An assured, distinctive piece with: an original voice that controls pace with precision; imagery that combines the physical and the psychological; masterful structural withholding that rewards the reader; technical virtuosity across sentence forms and punctuation.',
            },
            markScheme: [
              'Content & Organisation (24 marks): Communication, voice, structure',
              'Technical Accuracy (16 marks): Sentence demarcation, punctuation, spelling, sentence variety',
        ...
        questions: [
          {
            id: 'wjec-c1-14-q1',
            questionNumber: 1,
            questionText: 'Read lines 1-6. List five things you learn about the river and its surroundings from these lines.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            extract: EXTRACT_14,
            ...
            modelAnswers: {
              'Grade 4-5': '1. The river was lower than Jem Catling could remember in sixty years. 2. Alders leaned out over the water on the bank. 3. The tree roots were exposed. 4. You could see the riverbed with stones and mud. 5. Hidden objects were revealed, including a bicycle wheel, a boot, and a pram frame.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            id: 'wjec-c1-14-q2',
            questionNumber: 2,
            questionText: 'How does the writer use language to vividly portray the natural world?\n\nYou should comment on:\n- the writer\'s choice of words and phrases\n- the writer\'s use of language features and techniques\n- the effects on the reader.\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_14,
            extractSource: EXTRACT_14_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The writer brings the natural world to life through vivid description. The heron is described as standing "motionless" and looking as though it was "carved from the same stone as the bridge" — this simile shows how still and statuesque the bird is. Its eye is "bright, unblinking amber" which makes it sound intense and focused. The description of the heron striking the fish — "a movement so swift it seemed to bypass time entirely" — uses hyperbole to show how incredibly fast it was. The river\'s surface carrying "reflections of clouds" creates a beautiful image of two skies, one above and one below. The metaphor "the bones of the earth" for the exposed roots makes the riverbank seem like a living body.',
              'Grade 6-7': 'The writer employs a technique of patient accumulation that mirrors the natural world it describes. The opening metaphor — roots "like the bones of the earth" — anatomises the landscape, presenting the drought-lowered river as an act of excavation, revealing what is normally hidden. The revealed objects (bicycle wheel, boot, pram) function as a compressed human archaeology, and the phrase "an archaeology of carelessness" transforms ecological observation into moral commentary. The heron is rendered through the language of sculpture and stillness: "carved from the same stone" refuses the animate in favour of the geological, while the eye — "bright, unblinking amber" — concentrates life into a single point of colour. The kill sequence demonstrates the writer\'s temporal control: the long, suspended description of patience gives way to a sentence where the strike "seemed to bypass time entirely." The verb "bypass" suggests not speed but the transcendence of temporal experience. The dying fish\'s "brief and futile convulsion" is devastatingly compressed — two adjectives that contain an entire narrative of struggle and failure. The final passage achieves a sustained lyricism: the river reflects clouds so that "looking down was like looking up into a second, inverted sky" — a simile that dissolves the boundary between above and below, creating a doubled world of quiet symmetry. The swallows "carried calendars in their hollow bones" is the extract\'s most memorable image, anthropomorphising instinct as knowledge and transforming departure into admission.',
            },
            markScheme: [
          ...
          },
          {
            id: 'wjec-c1-14-q3',
            questionNumber: 3,
            questionText: 'What impressions do you get of Jem Catling and his relationship with the natural world?\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_14,
          ...
          },
          {
            id: 'wjec-c1-14-q4',
            questionNumber: 4,
            questionText: '"The writer makes the reader see the beauty in ordinary, everyday moments in the natural world."\n\nTo what extent do you agree with this view? You should consider the writer\'s use of language and structure in your response.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: EXTRACT_14,
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear piece of creative prose with: recognisable structure; use of descriptive techniques including sensory detail and imagery; varied vocabulary; generally accurate SPaG.',
              'Grade 6-7': 'A compelling piece with: controlled lyrical quality; crafted imagery that connects the physical and the emotional; structural sophistication (e.g., cyclical patterns, shifts from close-up to wide); consistent SPaG accuracy with ambitious punctuation.',
              'Grade 8-9': 'An assured, distinctive piece with: an original contemplative voice; precise, original imagery that transforms the ordinary; masterful control of pace and perspective; technical virtuosity including varied and sophisticated sentence forms.',
            },
            markScheme: [
              'Content & Organisation (24 marks): Communication, voice, structure',
              'Technical Accuracy (16 marks): Sentence demarcation, punctuation, spelling, sentence variety',
        ...
        questions: [
          {
            id: 'wjec-c1-15-q1',
            questionNumber: 1,
            questionText: 'Read lines 1-8. List five things you learn about the town and Lucille from these lines.',
            marks: 5,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            extract: EXTRACT_15,
            ...
            modelAnswers: {
              'Grade 4-5': '1. The heat was so intense that nothing moved except dogs seeking shade. 2. Main Street was empty at two in the afternoon. 3. The courthouse clock had not kept accurate time since the Eisenhower era. 4. Lucille Boudreaux was sitting on her front porch. 5. She was shelling butter beans into a colander.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            id: 'wjec-c1-15-q2',
            questionNumber: 2,
            questionText: 'How does the writer use language to create a vivid sense of place and community?\n\nYou should comment on:\n- the writer\'s choice of words and phrases\n- the writer\'s use of language features and techniques\n- the effects on the reader.\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_15,
          ...
          },
          {
            id: 'wjec-c1-15-q3',
            questionNumber: 3,
            questionText: 'What impressions do you get of Lucille and her attitude towards the town and its people?\n\nYou must refer to the text to support your answer.',
            marks: 10,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EXTRACT_15,
            extractSource: EXTRACT_15_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'Lucille comes across as a wise, observant woman who understands her community deeply. She has lived in Beulah for all seventy-three years of her life, which means she knows everyone and everything. She understands that there are two kinds of truth — spoken and unspoken — which shows she is thoughtful and perceptive. She notices the town watching the Fontaine boy but she seems more understanding than judgemental. Her porch position gives her a view of the whole community, suggesting she is someone who watches and reflects rather than gossips. The detail about her hands "knowing the work" while her mind wanders suggests she is a deep thinker.',
              'Grade 6-7': 'Lucille is presented as the town\'s unofficial historian and moral conscience — a woman whose seventy-three years of unbroken residency have given her an understanding of Beulah that is simultaneously affectionate and critical. Her philosophical observation about "two kinds of truth" positions her above the town\'s surface narrative: she sees what others perform and what they conceal. The physical detail of her hands "knowing the work so deeply that her mind was free to wander" is a metaphor for her relationship with Beulah itself — she inhabits its routines so completely that she can observe it from a critical distance while remaining embedded within it. Her attitude toward the town\'s response to the Fontaine boy is observational rather than participatory: she notes the watching "from behind curtains and above coffee cups" without indicating that she shares in it. The phrase "everybody had an opinion, and the opinions moved through Beulah the way weather moved through it" is her most perceptive observation — she understands communal judgement as a natural phenomenon, impersonal and unstoppable. Yet there is implicit criticism: the comparison to weather that "could flatten you" acknowledges the destructive potential of collective silence. Her final act — leaning to see the Fontaine house — suggests not gossip but compassion or at least curiosity unclouded by the town\'s predetermined verdict. The "brief, useless rainbows" she observes could be read as an image for her own position: beauty and perception in a context that has no use for either.',
            },
            markScheme: [
          ...
          },
          {
            id: 'wjec-c1-15-q4',
            questionNumber: 4,
            questionText: '"The writer presents a community that is both familiar and deeply unsettling."\n\nTo what extent do you agree with this view? You should consider the writer\'s use of language and structure in your response.',
            marks: 15,
            suggestedTimeMinutes: 18,
            questionType: 'evaluation',
            extract: EXTRACT_15,
        ...
        questions: [
          {
            ...
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear piece of creative prose with: recognisable structure; use of descriptive techniques including setting and atmosphere; varied vocabulary; generally accurate SPaG.',
              'Grade 6-7': 'A compelling piece with: controlled sense of place and community; crafted dialogue and descriptive prose; structural sophistication (e.g., multiple perspectives, tension between surface and subtext); consistent SPaG accuracy with ambitious punctuation.',
              'Grade 8-9': 'An assured, distinctive piece with: an original voice that captures a specific place and time; imagery that operates on both literal and symbolic levels; masterful structural control of revelation and withholding; technical virtuosity including varied and sophisticated sentence forms.',
            },
            markScheme: [
              'Content & Organisation (24 marks): Communication, voice, structure',
              'Technical Accuracy (16 marks): Sentence demarcation, punctuation, spelling, sentence variety',
