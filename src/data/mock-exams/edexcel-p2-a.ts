...
const E02_SOURCE_A_REF =
  'James Harding, "The Beautiful Game\'s Ugly Truth", The Observer Sport, 2024'
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7':
                'B, C, E, F - A is false (he says money is not the main problem). D is false (the connection was "not manufactured by marketing departments"). G is false (1,100%, not 110%). H is true but falls outside the specified lines.',
            },
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7':
                'A, C, E, H - B is false (the system is "extraordinarily inefficient" at this). D is false (doubled, not tripled). F is true but appears in a later section. G is false (one in three, not one in five).',
            },
            markScheme: ['1 mark per correct answer, maximum 4'],
          },
          {
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7':
                'B, E, F, H - A is false ("AI will not take your job"). C is false (a "mixture of relief and anxiety"). D is false ("not a single technology but a constellation"). G is false ("can complete in hours what previously took weeks").',
            },
            markScheme: ['1 mark per correct answer, maximum 4'],
          },
          {
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7':
                'B, C, E, F - A is false (multi-storey car park, not a church). D is false (fastest, not slowest). G is false ("insomniacs watching at 3am"). H is true but appears later in the text.',
            },
            markScheme: ['1 mark per correct answer, maximum 4'],
          },
          {
