...
const EXAM_01_SOURCE_A_REF =
  'Priya Sharma, "Sleeping on the Streets of Britain", The Observer, 2023'
...
const EXAM_01_SOURCE_B_REF =
  'James Greenwood, "A Night in a Workhouse", The Pall Mall Gazette, 1866'
...
const EXAM_03_SOURCE_A_REF =
  'Rachel Okonkwo, "Screen-Bound: The Silent Crisis in Our Homes", The Telegraph, 2024'
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7':
                'A, C, F, H - Note: E is also arguably true ("Last January"), meaning careful selection is needed. B is false - it was a week. D is contradicted by "little protection." G is directly refuted by the text. The four clearest TRUE statements are A, C, F, and H.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A, C, E, F - A: "a fresh cohort of five-year-olds enters school bright-eyed and bursting with curiosity." C: "Our education system is broken." E: "bright-eyed." F: "drained, anxious." B is false (they leave "drained" and "anxious"). D is false (it says "numbers" not "letters"). G is also true. H is false.',
              'Grade 6-7':
                'A, C, E, F (or A, C, F, G) - Multiple combinations are valid. B is clearly false, D is false ("numbers" not "letters"), H is directly contradicted. The safest four are A, C, E, F.',
            },
            markScheme: [
              '1 mark for each correct answer',
              'Maximum 4 marks',
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7':
                'A, C, E, G (or A, C, G, H) - Multiple valid combinations exist. B is false (novel, not magazine). D is false (ten, not five minutes). F is directly contradicted. The clearest four are A, C, E, G.',
            },
            markScheme: [
              '1 mark for each correct answer',
              'Maximum 4 marks',
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7':
                'A, C, E, F (or A, C, E, G) - D is clearly false (six, not seven). H is directly contradicted. B cannot be confirmed from the text. The strongest four are A, C, E, F.',
            },
            markScheme: [
              '1 mark for each correct answer',
              'Maximum 4 marks',
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A, C, D, F - A: "They are building a shopping centre where the community garden used to be." C: "who is seventy-eight." D: "has tended a plot there for thirty-one years." F: "stood at the fence." B is false (Monday). E is false (crocuses, not daffodils). G is false (the decision was made "in a boardroom"). H is also true.',
              'Grade 6-7':
                'A, C, D, F (or A, C, D, H) - B is clearly false (Monday, not Tuesday). E is false (crocuses, not daffodils). G is directly contradicted. Multiple valid combinations exist; the safest four are A, C, D, F.',
            },
            markScheme: [
              '1 mark for each correct answer',
              'Maximum 4 marks',
