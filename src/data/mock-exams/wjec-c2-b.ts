...
const IMMIGRATION_SOURCE_B_REF = 'Friedrich Engels, The Condition of the Working Class in England (1845)'
...
const CHILDHOOD_SOURCE_B_REF = 'Charles Dickens, "A Walk Through the Workhouse", Household Words (1850)'
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: 'You are advised to spend about 60 minutes on this section. You should divide your time equally between the two tasks.',
        totalMarks: 40,
        suggestedTimeMinutes: 60,
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'A clear informative text with: appropriate tone for teenagers; relevant points about mental health; generally accurate SPaG.',
              'Grade 6-7': 'A well-structured informative piece with: engaging tone; well-developed explanations; consistent accuracy and varied vocabulary.',
              'Grade 8-9': 'A compelling and authoritative text with: sophisticated awareness of audience; nuanced exploration of the topic; technical virtuosity.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A speech with: clear position; some persuasive techniques; appropriate form with address to audience; generally accurate SPaG.',
              'Grade 6-7': 'A well-crafted speech with: sustained argument; effective rhetorical devices; convincing counter-arguments addressed; consistent accuracy.',
              'Grade 8-9': 'An outstanding speech with: commanding voice; sophisticated reasoning; masterful use of rhetorical techniques; technical precision throughout.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': '1. Rock pools in Pembrokeshire that used to be full of life are now empty. 2. Wales has lost 73% of its monitored insect populations since 1990. 3. One in six species in the UK is at risk of extinction. 4. The hedgehog population has halved in twenty years. 5. The dawn chorus is quieter than it used to be.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
        ...
        questions: [
          {
            ...
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear formal letter with: appropriate conventions; a range of relevant points; generally accurate SPaG.',
              'Grade 6-7': 'A well-structured letter with: confident formal register; persuasive argument with evidence; consistent accuracy.',
              'Grade 8-9': 'A sophisticated letter with: commanding authoritative voice; nuanced reasoning balancing multiple perspectives; flawless technical accuracy.',
            },
            markScheme: [
              'Communication & Organisation (10 marks): Purpose, audience, form, structure',
              'Writing Accurately (6 marks): Sentence variety, vocabulary, SPaG',
          ...
          },
          {
            ...
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A newspaper article with: appropriate headline and structure; clear argument; relevant examples; generally accurate SPaG.',
              'Grade 6-7': 'A well-crafted article with: engaging headline; sustained and developed argument; effective use of evidence; consistent accuracy.',
              'Grade 8-9': 'An outstanding article with: arresting headline; sophisticated and nuanced argument; masterful control of tone and register; technical precision.',
            },
            markScheme: [
              'Communication & Organisation (14 marks): Purpose, audience, form, voice, structure, paragraphing',
              'Writing Accurately (10 marks): Sentence variety, vocabulary range, SPaG',
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5': '1. Riders earned an average of £4.80 an hour after expenses. 2. They received no sick pay, holiday pay, or pension. 3. The riders were mostly young men from immigrant backgrounds. 4. The app tracked their every movement. 5. A customer rating below 4.5 meant fewer deliveries.',
            },
            markScheme: ['1 mark per valid point, maximum 5'],
          },
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'The writer uses sarcasm in "be your own boss" to mock the promises of the gig economy. The word "disposable" shows how little the workers are valued. The contrast between "independent contractors" and reality highlights the dishonesty of the companies. The description of riding "on a rainy Tuesday night" makes the reader feel sympathy for the workers.',
        ...
        questions: [
          {
            ...
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear informative text with: appropriate form and register; practical advice; generally accurate SPaG.',
              'Grade 6-7': 'A well-organised text with: engaging and authoritative tone; well-developed points with examples; consistent accuracy.',
              'Grade 8-9': 'A compelling and polished text with: sophisticated awareness of audience; original insights; technical precision.',
            },
            markScheme: [
              'Communication & Organisation (10 marks): Purpose, audience, form, structure',
              'Writing Accurately (6 marks): Sentence variety, vocabulary, SPaG',
        ...
        questions: [
          {
            ...
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear website text with: appropriate register for school audience; relevant ideas; generally accurate SPaG.',
              'Grade 6-7': 'A well-crafted text with: engaging opening; thoughtful exploration of benefits; consistent accuracy and varied expression.',
              'Grade 8-9': 'A sophisticated text with: compelling voice; nuanced argument that avoids cliché; technical virtuosity.',
            },
            markScheme: [
              'Communication & Organisation (10 marks): Purpose, audience, form, structure',
              'Writing Accurately (6 marks): Sentence variety, vocabulary, SPaG',
          ...
          },
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'A newspaper article with: appropriate headline and structure; clear argument; relevant examples; generally accurate SPaG.',
              'Grade 6-7': 'A well-crafted article with: engaging headline; sustained and balanced argument; effective use of evidence; consistent accuracy.',
              'Grade 8-9': 'An outstanding article with: arresting headline; sophisticated reasoning that engages with complexity; masterful control of tone; technical precision.',
            },
            markScheme: [
              'Communication & Organisation (14 marks): Purpose, audience, form, voice, structure, paragraphing',
              'Writing Accurately (10 marks): Sentence variety, vocabulary range, SPaG',
        ...
        questions: [
          {
            ...
            questionType: 'transactional-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear report with: appropriate formal conventions; arguments on both sides; generally accurate SPaG.',
              'Grade 6-7': 'A well-structured report with: clear subheadings and formal register; balanced and well-evidenced arguments; consistent accuracy.',
              'Grade 8-9': 'A polished report with: professional presentation; sophisticated analysis of competing perspectives; technical precision.',
            },
            markScheme: [
              'Communication & Organisation (10 marks): Purpose, audience, form, structure',
              'Writing Accurately (6 marks): Sentence variety, vocabulary, SPaG',
          ...
          },
          {
            ...
            modelAnswers: {
              'Grade 4-5': 'A speech with: clear position; some persuasive techniques; appropriate form with address to audience; generally accurate SPaG.',
              'Grade 6-7': 'A well-crafted speech with: sustained and nuanced argument; effective rhetorical devices; awareness of counter-arguments; consistent accuracy.',
              'Grade 8-9': 'An outstanding speech with: compelling voice that balances authority and empathy; sophisticated engagement with the complexity of the statement; technical mastery.',
            },
            markScheme: [
              'Communication & Organisation (14 marks): Purpose, audience, form, voice, structure, paragraphing',
              'Writing Accurately (10 marks): Sentence variety, vocabulary range, SPaG',
