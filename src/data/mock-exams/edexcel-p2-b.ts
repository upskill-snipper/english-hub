...
const P06_SOURCE_B_REF =
  'Dr Edward Lankester, evidence to the Select Committee on Public Health, 1862'
...
const P08_SOURCE_B_REF =
  "Original composition in the style of Flora Thompson's Lark Rise to Candleford (Thompson's trilogy in fact published 1939-43; do not cite as Thompson)"
