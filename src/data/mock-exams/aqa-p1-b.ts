...
const EXTRACT_MAGICAL_REALISM_SOURCE =
  'Original literary fiction composition - magical realism genre'
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A, D, F, G - A: "The sirens had not sounded for three days." D: "three at noon meant a patrol was passing through." F: "the people of Sector Nine." G: "a long, unbroken wail at sunset meant curfew."',
              'Grade 6-7':
                'A, D, F, G - B is false (it says "months since the Transition"). C is false (two blasts meant water rations, not food). E is false (silence meant the Authority had stopped watching). H is false (silence was the most frightening thing).',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'Look in detail at the extract from the paragraph beginning "The corridor outside..." How does the writer use language here to describe the decaying environment?\n\nYou could include the writer\'s choice of:\n- words and phrases\n- language features and techniques\n- sentence forms.',
            marks: 8,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'B, C, E, F - B: "Martha grabbed the edge of the bunk." C: "other women cried out." E: "The single oil lamp that hung from a beam." F: "throwing wild shadows across the low ceiling."',
              'Grade 6-7':
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'Look in detail at the second paragraph of the source, beginning "They had been at sea for forty-seven days." How does the writer use language here to convey the experience of the voyage?\n\nYou could include the writer\'s choice of:\n- words and phrases\n- language features and techniques\n- sentence forms.',
            marks: 8,
            suggestedTimeMinutes: 10,
            questionType: 'analysis',
            extract: EXTRACT_HISTORICAL,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A, C, E, H - A: "Rain hammered the windscreen." C: "PACIFIC STORAGE." E: "He had been waiting for two hours." H: "casting a sickly pink glow across the wet pavement."',
              'Grade 6-7':
                'A, C, E, H - B is false (Nolan is in a car across the street). D is false (it was half past eleven, not midnight). F is false (the coffee "had gone cold long ago"). G is false (it was his left knee, not right).',
            },
            markScheme: [
              '1 mark for each correct answer',
              'Maximum 4 marks',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'Look in detail at the extract from the paragraph beginning "A car turned into the street..." to the end. How does the writer use language here to create an atmosphere of suspense and menace?\n\nYou could include the writer\'s choice of:\n- words and phrases\n- language features and techniques\n- sentence forms.',
            marks: 8,
            suggestedTimeMinutes: 10,
            questionType: 'analysis',
            extract: EXTRACT_CRIME_NOIR,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A, C, E, F - A: "Alma Reyes discovered that she could hear colours." C: "a low, warm hum" from the geraniums. E: "The sunflowers boomed like tubas." F: "by lunchtime the whole garden was singing to her."',
              'Grade 6-7':
                'A, C, E, F - B is false (she was sixty-three, not seventy-three). D is false (the lavender "whispered in a silvery soprano" - the deep booming was the sunflowers). G is false (the earth had "a deep and patient drone"). H is true - "through the soles of her slippers" - so H could replace one of the above as a valid answer.',
            },
            markScheme: [
              '1 mark for each correct answer',
              'Maximum 4 marks',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'Look in detail at the third paragraph of the source, beginning "The fig tree\'s leaves..." How does the writer use language here to describe the experience of hearing the tree?\n\nYou could include the writer\'s choice of:\n- words and phrases\n- language features and techniques\n- sentence forms.',
            marks: 8,
            suggestedTimeMinutes: 10,
            questionType: 'analysis',
            extract: EXTRACT_MAGICAL_REALISM,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A, C, E, F - A: "The argument had ended twenty minutes ago." C: "washing the same plate for the third time." E: "Through the window, she could see the garden." F: "the lawn that needed mowing."',
              'Grade 6-7':
                'A, C, E, F - B is false (she was at the sink, not the cooker). D is false (her hands moved in "slow, mechanical circles"). G is false (Tom had "promised to fix" the fence but had not done so). H is also true - "the trampoline the children had outgrown" - so H could validly replace one of the others.',
            },
            markScheme: [
              '1 mark for each correct answer',
              'Maximum 4 marks',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              'Look in detail at the extract from the second paragraph, beginning "Upstairs, a door closed," to the end of the third paragraph. How does the writer use language here to convey the emotional atmosphere after the argument?\n\nYou could include the writer\'s choice of:\n- words and phrases\n- language features and techniques\n- sentence forms.',
            marks: 8,
            suggestedTimeMinutes: 10,
            questionType: 'analysis',
            extract: EXTRACT_DOMESTIC_DRAMA,
