  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. The house felt like it had been waiting. 2. The gate hinges screamed when opened. 3. The air inside was thick and sweet. 4. The grandfather clock was ticking despite years of dust.',
            },
            markScheme: [
      ...
      },
      {
        ...
        description:
          'You are advised to spend about 45 minutes on this section. You must complete BOTH questions. You are reminded of the need to plan your answers.',
        totalMarks: 40,
        suggestedTimeMinutes: 45,
        questions: [
          {
            ...
            questionNumber: 4,
            questionText:
              'Write the opening of a story that begins with a character entering an unfamiliar building.\n\nYou may wish to use the reading extract as a stimulus for your writing.\n\nWrite approximately 150-200 words.\n\n(8 marks for content and organisation / 8 marks for technical accuracy)',
            marks: 16,
            suggestedTimeMinutes: 15,
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5':
                'A clear, focused opening that: establishes a character and setting; uses some descriptive techniques (simile, adjectives); creates a sense of atmosphere; demonstrates generally accurate spelling, punctuation, and grammar.',
              'Grade 6-7':
                'A compelling opening that: crafts atmosphere through sustained sensory detail; creates intrigue or tension through deliberate choices; demonstrates controlled, varied sentence structures; shows consistent technical accuracy with some ambitious constructions.',
              'Grade 8-9':
                'An assured, crafted opening that: creates a distinctive voice and atmosphere from the first line; uses precise, original imagery; demonstrates sophisticated structural choices; shows technical virtuosity and an extensive vocabulary deployed with control.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. Thomas found the letter on the morning of his departure. 2. It was tucked beneath the sugar bowl. 3. The paper was thin and almost translucent. 4. Her handwriting sloped across the page.',
            },
            markScheme: [
              '1 mark per valid point, maximum 4',
              'Must be from the first two paragraphs only',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              "Read the whole extract. Analyse how the writer uses language and structure to convey the emotions of love and loss.\n\nIn your answer you should consider:\n- the writer's use of words and phrases\n- the writer's use of language features and techniques\n- how the writer has structured the text to create effects\n\nSupport your views with detailed reference to the text.\n\n(8 marks for language analysis, 8 marks for structural analysis)",
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'analysis',
            extract: EXTRACT_02_ROMANCE,
        ...
        questions: [
          {
            ...
            questionNumber: 4,
            questionText:
              'Write a description of a place that holds a powerful memory for your character.\n\nYou may wish to use the reading extract as a stimulus for your writing.\n\nWrite approximately 150-200 words.\n\n(8 marks for content and organisation / 8 marks for technical accuracy)',
            marks: 16,
            suggestedTimeMinutes: 15,
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5':
                'A clear, focused description that: establishes a setting with some sensory detail; connects the place to a memory or emotion; uses some descriptive techniques; demonstrates generally accurate spelling, punctuation, and grammar.',
              'Grade 6-7':
                'A compelling description that: creates atmosphere through sustained sensory imagery; links physical details to emotional resonance; demonstrates controlled, varied sentence structures; shows consistent technical accuracy with ambitious constructions.',
              'Grade 8-9':
                'An assured, crafted piece that: interweaves place and memory with seamless sophistication; uses precise, original imagery; demonstrates a distinctive voice and masterful control of tone; shows technical virtuosity throughout.',
            },
            markScheme: [
              'AO5 Content & Organisation (8 marks): Communication, tone, register appropriate to form',
          ...
          },
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A clear and engaging piece of imaginative writing that: has a recognisable narrative structure; uses descriptive and narrative techniques; includes varied vocabulary; creates atmosphere or emotional impact; demonstrates generally accurate spelling and punctuation.',
              'Grade 6-7':
                'A compelling piece that: crafts a controlled narrative with deliberate pacing; uses varied and ambitious vocabulary; demonstrates conscious structural choices; shows consistent accuracy in spelling, punctuation, and grammar with ambitious constructions.',
              'Grade 8-9':
                'An assured, sophisticated piece that: creates a vivid, immersive narrative with a distinctive voice; demonstrates masterful structural control; uses precise, original imagery and extensive vocabulary; shows technical virtuosity throughout; crafts a satisfying narrative arc with emotional and thematic depth.',
            },
            markScheme: [
              'AO5 Content & Organisation (16 marks): Compelling, crafted narrative',
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                "1. The field was quiet after the shelling. 2. Aden's ears were ringing. 3. Trees had been knocked onto their sides. 4. The trench wall had collapsed in three places.",
            },
            markScheme: [
              '1 mark per valid point, maximum 4',
              'Must be from the first two paragraphs only',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              "Read the whole extract. Analyse how the writer uses language and structure to present the psychological impact of war.\n\nIn your answer you should consider:\n- the writer's use of words and phrases\n- the writer's use of language features and techniques\n- how the writer has structured the text to create effects\n\nSupport your views with detailed reference to the text.\n\n(8 marks for language analysis, 8 marks for structural analysis)",
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'analysis',
            extract: EXTRACT_03_WAR,
        ...
        questions: [
          {
            ...
            questionNumber: 4,
            questionText:
              'Write a description of a scene immediately after something dramatic has happened. Focus on the details of the aftermath rather than the event itself.\n\nYou may wish to use the reading extract as a stimulus for your writing.\n\nWrite approximately 150-200 words.\n\n(8 marks for content and organisation / 8 marks for technical accuracy)',
            marks: 16,
            suggestedTimeMinutes: 15,
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5':
                'A clear, focused description that: establishes a scene of aftermath; uses sensory detail to convey the setting; employs some descriptive techniques; demonstrates generally accurate spelling, punctuation, and grammar.',
              'Grade 6-7':
                'A compelling description that: creates atmosphere through sustained, well-chosen detail; focuses on the aftermath without needing to explain the event; demonstrates controlled, varied sentence structures; shows consistent technical accuracy with ambitious constructions.',
              'Grade 8-9':
                'An assured, crafted description that: reveals the drama entirely through its aftermath; uses precise, original imagery with restraint and control; demonstrates sophisticated structural choices; shows technical virtuosity and a distinctive voice throughout.',
            },
            markScheme: [
              'AO5 Content & Organisation (8 marks): Communication, tone, register appropriate to form',
          ...
          },
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A clear and engaging piece of imaginative writing that: has a recognisable narrative structure; uses descriptive and narrative techniques; includes varied vocabulary; creates atmosphere or tension; demonstrates generally accurate spelling and punctuation.',
              'Grade 6-7':
                'A compelling piece that: crafts a controlled narrative with deliberate pacing and contrast; uses varied and ambitious vocabulary; demonstrates conscious structural choices; shows consistent accuracy in spelling, punctuation, and grammar.',
              'Grade 8-9':
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. The river narrowed without warning. 2. The jungle closed in on both sides. 3. The light changed from white to green to near darkness. 4. The current shifted and became stronger.',
            },
            markScheme: [
              '1 mark per valid point, maximum 4',
              'Must be from the first two paragraphs only',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              "Read the whole extract. Analyse how the writer uses language and structure to create a mounting sense of danger and urgency.\n\nIn your answer you should consider:\n- the writer's use of words and phrases\n- the writer's use of language features and techniques\n- how the writer has structured the text to create effects\n\nSupport your views with detailed reference to the text.\n\n(8 marks for language analysis, 8 marks for structural analysis)",
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'analysis',
            extract: EXTRACT_04_ADVENTURE,
        ...
        questions: [
          {
            ...
            questionNumber: 4,
            questionText:
              'Write the opening of a story in which a character realises they are in danger.\n\nYou may wish to use the reading extract as a stimulus for your writing.\n\nWrite approximately 150-200 words.\n\n(8 marks for content and organisation / 8 marks for technical accuracy)',
            marks: 16,
            suggestedTimeMinutes: 15,
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5':
                'A clear, focused opening that: establishes a character and a moment of realisation; uses some techniques to convey danger; demonstrates generally accurate spelling, punctuation, and grammar.',
              'Grade 6-7':
                'A compelling opening that: builds tension through controlled pacing; uses sensory detail to convey the shift from safety to danger; demonstrates varied sentence structures; shows consistent technical accuracy with ambitious constructions.',
              'Grade 8-9':
                "An assured, crafted opening that: captures the precise moment of realisation with originality and precision; uses structure and language to control the reader's experience of time; demonstrates a distinctive voice and technical virtuosity throughout.",
            },
            markScheme: [
              'AO5 Content & Organisation (8 marks): Communication, tone, register appropriate to form',
          ...
          },
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A clear and engaging piece of imaginative writing that: has a recognisable narrative structure; uses descriptive and narrative techniques; includes varied vocabulary; creates tension or excitement; demonstrates generally accurate spelling and punctuation.',
              'Grade 6-7':
                'A compelling piece that: crafts a controlled narrative with effective pacing; uses varied and ambitious vocabulary; demonstrates structural choices that build and sustain tension; shows consistent accuracy in spelling, punctuation, and grammar.',
              'Grade 8-9':
                'An assured, sophisticated piece that: creates a vivid, immersive narrative with a distinctive voice; demonstrates masterful control of pace and tension; uses precise, original imagery and extensive vocabulary; shows technical virtuosity throughout; crafts a satisfying narrative arc with thematic resonance.',
            },
            markScheme: [
              'AO5 Content & Organisation (16 marks): Compelling, crafted narrative',
              'AO5: Effective use of tone, style, and register',
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                '1. Dr Marsh had a theory about doors. 2. Every patient paused at the threshold of her consulting room. 3. The hesitators were not ready. 4. Those who knocked twice then opened the door themselves were the most interesting to her.',
            },
            markScheme: [
              '1 mark per valid point, maximum 4',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText:
              "Read the whole extract. Analyse how the writer uses language and structure to create a sense of psychological tension and intrigue.\n\nIn your answer you should consider:\n- the writer's use of words and phrases\n- the writer's use of language features and techniques\n- how the writer has structured the text to create effects\n\nSupport your views with detailed reference to the text.\n\n(8 marks for language analysis, 8 marks for structural analysis)",
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'analysis',
            extract: EXTRACT_05_PSYCHOLOGICAL,
        ...
        questions: [
          {
            ...
            questionNumber: 4,
            questionText:
              'Write the opening of a story told from the perspective of someone who notices details that other people miss.\n\nYou may wish to use the reading extract as a stimulus for your writing.\n\nWrite approximately 150-200 words.\n\n(8 marks for content and organisation / 8 marks for technical accuracy)',
            marks: 16,
            suggestedTimeMinutes: 15,
            questionType: 'creative-writing',
            modelAnswers: {
              'Grade 4-5':
                'A clear, focused opening that: establishes a distinctive character perspective; includes specific observed details; uses some narrative and descriptive techniques; demonstrates generally accurate spelling, punctuation, and grammar.',
              'Grade 6-7':
                'A compelling opening that: creates an intriguing narrative voice through specific observational detail; establishes character through what they notice; demonstrates controlled, varied sentence structures; shows consistent technical accuracy with ambitious constructions.',
              'Grade 8-9':
                'An assured, crafted opening that: creates a distinctive, compelling narrative voice; reveals character entirely through the quality and nature of their observations; demonstrates sophisticated structural choices; shows technical virtuosity and precise vocabulary throughout.',
            },
            markScheme: [
              'AO5 Content & Organisation (8 marks): Communication, tone, register appropriate to form',
          ...
          },
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A clear and engaging piece of imaginative writing that: has a recognisable narrative structure; uses descriptive and narrative techniques; includes varied vocabulary; creates tension or intrigue; demonstrates generally accurate spelling and punctuation.',
              'Grade 6-7':
                'A compelling piece that: crafts a controlled narrative with effective use of dialogue and subtext; uses varied and ambitious vocabulary; demonstrates structural choices that sustain psychological tension; shows consistent accuracy in spelling, punctuation, and grammar.',
              'Grade 8-9':
