...
export const studentGapAnalysis: StudentGap[] = [
  {
    ...
    description:
      'Students struggle to spot and name literary/language devices in texts (metaphor, simile, personification, alliteration, etc.)',
    diagnosticQuestion:
      "Read this sentence: 'The moon was a silver coin in the night sky.' What technique is used and why?",
    interventionActivities: [
      {
        title: 'Technique Hunt',
        description:
          'Provide short passages with highlighted techniques. Students identify and label each one, then discuss effect.',
        steps: [
      ...
      },
      {
        ...
        description:
          'Create flashcard pairs: technique name + definition + example. Use for matching games and repeated exposure.',
        steps: [
      ...
      },
      {
        ...
        description:
          'Give effect/meaning, students identify which technique creates it. Builds understanding of purpose.',
        steps: [
      ...
      },
      {
        ...
        description:
          'Students write sentences using specific techniques. Builds understanding through creation.',
        steps: [
  ...
  },
  {
    ...
    description:
      "Students write disjointed paragraphs without clear topic sentences, evidence, or explanation. Ideas don't link.",
    diagnosticQuestion:
      'Write one paragraph analyzing this character. Use a quote and explain what it reveals.',
    interventionActivities: [
      {
        title: 'PEEL Frame Mastery',
        description:
          'Explicitly teach and scaffold the PEEL (Point-Evidence-Explanation-Link) structure.',
        steps: [
      ...
      },
      {
        ...
        description:
          'Scrambled sentences from good paragraph. Students rebuild in correct order, explaining reasoning.',
        steps: [
      ...
      },
      {
        ...
        description:
          "Dedicate practice to the 'explanation' part-the hardest skill for most students.",
        steps: [
      ...
      },
      {
        ...
        description:
          'Students struggle with links. Practice explicitly returning to the essay question.',
        steps: [
  ...
  },
  {
    ...
    description:
      'Students lack background about texts, eras, authors, or historical events that prevent deep understanding.',
    diagnosticQuestion:
      'Why might the writer have included the date 1984 in the title of this novel? What does that year represent?',
    interventionActivities: [
      {
        title: 'Context Snap',
      ...
      },
      {
        ...
        description:
          "Short, focused video/document about author's life or historical setting. Activates schema before text work.",
        steps: [
  ...
  },
  {
    ...
    description:
      'Students struggle with comparative analysis-finding links, contrasts, and thematic connections across texts.',
    diagnosticQuestion:
      'Compare how two texts present the theme of power. What are key similarities and differences?',
    interventionActivities: [
      {
        title: 'Venn Diagram Deep Dive',
        description:
          "Start simple: overlapping circles force students to think about what's shared vs. unique.",
        steps: [
      ...
      },
      {
        ...
        description:
          "Take one concept (e.g., 'power'). Find how it appears in 2-3 texts. Compare language choices.",
        steps: [
      ...
      },
      {
        ...
        description:
          'Give students 6-8 quotes (mix from different texts). Rank by how well they support a comparative point.',
        steps: [
  ...
  },
  {
    ...
    description:
      'Students make basic spelling, punctuation, and grammar errors that lose marks in formal writing.',
    diagnosticQuestion: 'Proofread this paragraph and identify all spelling and grammar mistakes.',
    interventionActivities: [
      {
        title: 'Personal Error Log',
        description:
          'Students track their own recurring errors. Build awareness and muscle memory.',
        steps: [
  ...
  },
  {
    ...
    description:
      "Students retell plot or paraphrase quotes instead of analyzing meaning, effect, and writer's purpose.",
    diagnosticQuestion:
      "The character says 'I'll never forgive you.' What does this reveal about the character and their relationship?",
    interventionActivities: [
      {
        title: 'So What? Because? Deeper Strategy',
        description:
          'Teach students to push beyond surface-level observations with strategic questioning.',
        steps: [
  ...
  },
  {
    ...
    description:
      'Topic sentences are vague, too broad, or missing. Paragraphs lack clear central idea.',
    diagnosticQuestion: 'What is the main point of this paragraph? Write it as one sentence.',
    interventionActivities: [
      {
        title: 'Topic Sentence Revision',
        description:
          'Take existing weak paragraphs. Rewrite topic sentences to be clear and specific.',
        steps: [
  ...
  },
  {
    ...
    description:
      "Students use quotes that don't support their point, or embed them awkwardly without context.",
    diagnosticQuestion:
      "Choose a quote to support this point: 'The protagonist is deeply flawed.' Why is this the best quote?",
    interventionActivities: [
      {
        title: 'Quote Match',
        description:
          'Give analytical claims and quote options. Students select the best quote and justify.',
        steps: [
  ...
  },
  {
    ...
    description:
      'Students only understand surface-level meaning. Cannot read between the lines or understand implications.',
    diagnosticQuestion:
      'The character remains silent when accused. What might this silence suggest about their character?',
    interventionActivities: [
      {
      ...
      },
      {
        ...
        description:
          'Symbolic or metaphorical details require inference. Build this skill explicitly.',
        steps: [
  ...
  },
  {
    ...
    diagnosticQuestion:
      "Write an opening paragraph for this essay question: 'How does the writer present power in this text?'",
    interventionActivities: [
      {
  ...
  },
  {
    ...
    description:
      "Students run out of time, produce unfinished answers, or don't follow exam question demands.",
    diagnosticQuestion:
      'You have 45 minutes. How would you plan this essay to ensure you finish a complete answer?',
    interventionActivities: [
      {
      ...
      },
      {
        ...
        description:
          'Students often miss what the question actually asks (compare vs. analyze, etc.)',
        steps: [
      ...
      },
      {
        ...
        description:
          'Break essay into sections with time targets (intro 10 mins, main body 25 mins, etc.)',
        steps: [
  ...
  },
  {
    ...
    description:
      'Students overuse basic words and simple sentence structures. Limited ability to express complex ideas.',
    diagnostionQuestion:
      "Rewrite this sentence using more precise vocabulary: 'The character is sad about what happened'",
    interventionActivities: [
      {
      ...
      },
      {
        ...
        description:
          'Deliberate reading practice. Students notice and collect sophisticated vocabulary.',
        steps: [
  ...
  },
  {
    ...
    description:
      'Conclusions just repeat the introduction or end weakly without synthesis or significance.',
    diagnosticQuestion:
      'Write a concluding paragraph for this essay that sums up your argument and explains why it matters.',
    interventionActivities: [
      {
        title: 'Conclusion as Synthesis, Not Repetition',
        description:
          'Teach students to synthesize evidence into broader insight, not restate introduction.',
        steps: [
  ...
  },
  {
    ...
    description:
      'Creative writing lacks vivid detail, dynamic dialogue, and sensory engagement. Over-reliance on telling rather than showing.',
    diagnosticQuestion:
      "Write a short scene (100 words) showing a character's sadness through action and dialogue, not narration.",
    interventionActivities: [
      {
        title: "Show Don't Tell Revision",
        description:
          'Identify places where students explain emotion. Replace with action/sensory detail.',
        steps: [
          "Weak: 'She was angry'",
      ...
      },
      {
        ...
        description:
          'Teach dialogue as characterization and plot advancement, not just information delivery.',
        steps: [
      ...
      },
      {
        ...
        description:
          'Before writing, students deeply develop characters by answering interview questions.',
        steps: [
...
export const lessonIdeasBank: LessonIdea[] = [
  // ---- STARTER ACTIVITIES (15 starters: 5-minute engagement hooks)
  {
    ...
    description:
      'Show a provocative quote from the text without context. Students predict who said it, when, and why. Builds anticipation and engages prior knowledge.',
    duration: '5 minutes',
    suitableFor: ['KS3', 'GCSE'],
    resourcesNeeded: ['Quote slide', 'whiteboard'],
    differentiation:
      'Give struggling students 2-3 character options. Push others to predict mood/scene details.',
  },
  {
    id: 'starter-vocabulary-sprint',
    title: 'Vocabulary Sprint',
    description:
      'Display 5 subject-specific words. Students write definitions in their own words (30 seconds each). Quick activation of key concepts.',
    duration: '5 minutes',
    suitableFor: ['KS3', 'GCSE'],
    resourcesNeeded: ['Word slides', 'mini-whiteboards'],
    differentiation:
      'KS3: Use words from upcoming lesson. GCSE: Use advanced synonyms requiring nuance.',
  },
  {
    id: 'starter-statement-agree-disagree',
    title: 'Statement: Agree/Disagree/Unsure',
    description:
      'Display a bold statement about the text/topic. Students position themselves physically (corners of room) or use thumbs up/down. Creates discussion opener.',
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Show an image related to text/theme. 30 seconds silent observation, then popcorn share observations. Activates visual literacy.',
    duration: '5 minutes',
    suitableFor: ['both'],
    resourcesNeeded: ['Relevant image', 'projector'],
    differentiation:
      "Provide question prompts for struggling students (What's the mood? Who might this be?).",
  },
  {
    id: 'starter-previous-lesson-recall',
    title: 'Last Lesson: Quick Recall',
    description:
      'Display 3 questions about previous lesson content. Students write answers on mini-whiteboards. Checks understanding and builds momentum.',
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Display a character/theme name. Students shout words that come to mind. Write all on board (or use Wordle generator). Quick mood-setting.',
    duration: '5 minutes',
    suitableFor: ['KS3'],
  ...
  },
  {
    ...
    description:
      'Describe a character without naming them. Students guess who based on description. Builds familiarity and engagement.',
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Display two versions of something (character at start vs. end of text, old social custom vs. modern). Students spot differences quickly.',
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Display a moment from text. Students place it on 1-10 scale (scary-safe, hopeful-bleak, etc.). Quick gauge of emotional literacy.',
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'State 4 facts about text (3 true, 1 false). Students vote on which is false. Reinforces knowledge checkpoints.',
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Show a scene-relevant illustration without caption. Students write their own captions individually or in pairs. Creative and quick.',
    duration: '5 minutes',
    suitableFor: ['KS3'],
  ...
  },
  {
    ...
    description:
      'Read an extract aloud with different character voices/accents. Students identify the character or register shift. Builds listening skills.',
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Share 2-3 surprising facts about the author. Students predict how these might influence the text. Activates biographical context.',
    duration: '5 minutes',
    suitableFor: ['GCSE'],
  ...
  },
  {
    ...
    description:
      'Display formal dialogue from text. Students translate to modern text/tweet language. Highlights language change and character.',
    duration: '5 minutes',
    suitableFor: ['KS3'],
  ...
  },
  {
    ...
    description:
      "Pose a moral dilemma a character faces. Students decide quickly what they'd do. Sets up character study and ethical discussion.",
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  // ---- MAIN CLASSROOM ACTIVITIES (20 differentiated activities)
  {
    ...
    description:
      "Divide text into 4-5 sections. Assign each group a section. They become 'experts,' then reform groups with one expert from each section. Covers whole text efficiently.",
    duration: '30-40 minutes',
    suitableFor: ['both'],
    resourcesNeeded: ['Text divided into sections', 'worksheet with questions for each section'],
    differentiation:
      'Assign easier sections to lower ability groups. Provide guided questions for some groups.',
  },
  {
    id: 'main-character-hot-seat',
    title: 'Hot Seat: Interview a Character',
    description:
      'One student (or you) sits as a character. Others ask questions. Character answers in-role. Builds empathy and deep character understanding.',
    duration: '20-30 minutes',
    suitableFor: ['KS3'],
    resourcesNeeded: ['Chair', 'question cards (optional)'],
    differentiation:
      'Provide character knowledge cards for student in hot seat. Scaffold questions for less experienced students.',
  },
  {
    id: 'main-debate-resolution',
    title: 'Debate: Text-Based Resolution',
    description:
      "State a resolution: 'Character X was justified in their actions.' Half argue for, half against. Use textual evidence.",
    duration: '35-40 minutes',
    suitableFor: ['GCSE'],
    resourcesNeeded: ['Resolution statement', 'whiteboard for evidence tracking'],
    differentiation:
      'Provide evidence cards for lower ability students. Ask higher ability to find counter-evidence.',
  },
  {
    id: 'main-close-reading-pair-work',
    title: 'Paired Close Reading with Annotation',
    description:
      'Pairs read short passage together. Highlight/annotate for: language techniques, key words, character voice, mood shifts. Discuss findings.',
    duration: '25-30 minutes',
    suitableFor: ['both'],
    resourcesNeeded: ['Passage printout or slides', 'highlighters/colored pens'],
    differentiation:
      'Provide annotation prompt cards for struggling pairs (What mood word appears? What technique is used?).',
  },
  {
    id: 'main-creative-rewrite',
    title: 'Creative Rewrite: Change a Scene',
    description:
      'Take a key scene. Rewrite from different perspective, in different genre, with different ending. Deepens understanding through creative lens.',
    duration: '35 minutes',
    suitableFor: ['KS3'],
    resourcesNeeded: ['Original scene', 'writing templates (optional)'],
    differentiation:
      'Provide frame for rewrite. Ask higher ability to explain how change affects meaning.',
  },
  {
    id: 'main-comparison-matrix',
    title: 'Comparison Matrix: Two Texts/Characters',
    description:
      'Create matrix: rows = characters/texts, columns = themes/techniques/actions. Fill in examples. Visual comparison building.',
    duration: '30-35 minutes',
    suitableFor: ['GCSE'],
    resourcesNeeded: ['Matrix template', 'texts/character summaries'],
    differentiation:
      'Pre-fill some boxes for lower ability. Ask higher ability to rank similarities/differences by significance.',
  },
  {
    id: 'main-vocabulary-game-taboo',
    title: 'Vocabulary Game: Taboo or Pictionary',
    description:
      'Students describe/draw vocabulary words without saying the word. Others guess. Fun, repeated vocabulary exposure.',
    duration: '20-25 minutes',
    suitableFor: ['KS3'],
    resourcesNeeded: ['Vocabulary cards', 'whiteboard/paper for drawings'],
    differentiation:
      'Use advanced vocabulary for high ability. Provide images for struggling students in Pictionary.',
  },
  {
    id: 'main-mini-essay-timed-write',
    title: 'Mini Essay: Timed Write (45 mins)',
    description:
      'Full exam-style question with planning time. Students write under timed conditions. Builds stamina and technique.',
    duration: '50 minutes (5 plan + 40 write + 5 review)',
    suitableFor: ['GCSE'],
    resourcesNeeded: ['Essay question', 'planning template', 'timer'],
    differentiation:
      'Provide sentence starters for lower ability. Ask higher ability to peer-check for analysis depth.',
  },
  {
    id: 'main-image-text-pairing',
    title: 'Match Images to Text Moments',
    description:
      'Display 6-8 images without captions. Students match to key moments in text, explaining their choices.',
    duration: '20-25 minutes',
    suitableFor: ['both'],
    resourcesNeeded: ['Curated images', 'text references'],
    differentiation:
      'Provide page numbers/summaries for lower ability. Ask higher ability to create images for alternate moments.',
  },
  {
    id: 'main-dialogue-craft',
    title: 'Writing Dialogue: Skill Focus',
    description:
      'Model effective dialogue (natural, reveals character, advances plot). Students write conversation between two characters, applying techniques.',
    duration: '30 minutes',
    suitableFor: ['KS3'],
    resourcesNeeded: ['Model dialogue', 'dialogue guidelines poster', 'writing paper'],
    differentiation:
      'Provide sentence starters and character context. Ask higher ability to add stage directions revealing emotion.',
  },
  {
    id: 'main-theme-web',
    title: 'Theme Web: Evidence Collection',
    description:
      'Central circle = theme. Outer circles = examples from text (quotes, scenes, character actions). Visual consolidation of theme understanding.',
    duration: '30-35 minutes',
    suitableFor: ['both'],
    resourcesNeeded: ['Large paper/whiteboard', 'markers', 'text references'],
    differentiation:
      'Provide starter examples for lower ability. Ask higher ability to rank evidence by significance.',
  },
  {
    id: 'main-perspective-shift-writing',
    title: 'Perspective Shift: Rewrite in Different Voice',
    description:
      "Rewrite scene from different character's perspective or as interior monologue. Deepens empathy and understanding of multiple viewpoints.",
    duration: '30 minutes',
    suitableFor: ['KS3'],
    resourcesNeeded: ['Original scene', 'writing template'],
    differentiation:
      'Provide character thoughts/motivations for struggling students. Ask higher ability to explain how perspective changes interpretation.',
  },
  {
    id: 'main-annotate-complex-passage',
    title: 'Deep Annotation: Language & Context',
    description:
      "Display complex passage. Model detailed annotation noting: word choice, techniques, historical context, author's purpose. Students annotate similarly.",
    duration: '25-30 minutes',
    suitableFor: ['GCSE'],
    resourcesNeeded: ['Complex passage', 'annotation key/legend'],
    differentiation:
      'Provide annotation prompts. Ask higher ability to link annotations to essay question.',
  },
  {
    id: 'main-fact-or-interpretation',
    title: 'Fact vs. Interpretation: Sort Activity',
    description:
      'Display statements about text (some factual, some interpretive). Students sort into columns. Builds critical thinking about evidence vs. analysis.',
    duration: '20-25 minutes',
    suitableFor: ['both'],
    resourcesNeeded: ['Statement cards', 'two-column poster'],
    differentiation:
      'Provide definitions of fact vs. interpretation. Ask higher ability to convert facts into interpretive statements.',
  },
  {
    id: 'main-socratic-seminar-circle',
    title: 'Socratic Seminar: Student-Led Discussion',
    description:
      "Arrange in circle. Students ask questions, respond to each other's ideas. Teacher facilitates, not dictates. Builds critical discussion.",
    duration: '35-40 minutes',
    suitableFor: ['GCSE'],
    resourcesNeeded: ['Discussion question', 'student preparation'],
    differentiation:
      'Provide question cards for quieter students. Ask higher ability to pose follow-up questions that deepen thinking.',
  },
  {
    id: 'main-storyboard-visual-summary',
    title: 'Storyboard: Visual Summary of Events',
    description:
      'Divide text into 6-8 key moments. Students draw/describe each in sequence. Visual consolidation and sequencing practice.',
    duration: '30 minutes',
    suitableFor: ['KS3'],
    resourcesNeeded: ['Storyboard template', 'colored pencils'],
    differentiation:
      'Provide images to sequence for lower ability. Ask higher ability to add captions explaining significance of each moment.',
  },
  {
    id: 'main-irony-spotting-hunt',
    title: 'Irony Hunt: Find 3 Examples',
    description:
      "Students search text for irony (situational, verbal, dramatic). Record with explanation of why it's ironic. Builds sophisticated understanding.",
    duration: '25-30 minutes',
    suitableFor: ['GCSE'],
    resourcesNeeded: ['Text access', 'irony definition poster'],
    differentiation:
      'Provide page references for lower ability. Ask higher ability to analyze effect of irony on reader/meaning.',
  },
  {
    id: 'main-writing-analysis-paragraph',
    title: 'Scaffolded Analysis Paragraph Writing',
    description:
      'Provide: claim, quote, and analysis starters. Students complete PEEL paragraph. Builds analytical writing muscle.',
    duration: '20-25 minutes',
    suitableFor: ['both'],
    resourcesNeeded: ['PEEL template with scaffolding'],
    differentiation:
      'Provide more detailed scaffolds for lower ability. Ask higher ability to remove scaffolds for second paragraph.',
  },
  ...
  // ---- PLENARY ACTIVITIES (15 review/synthesis activities)
  {
    ...
    description:
      'Students write one thing they learned today and one remaining question. Checks understanding and informs next lesson.',
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Two teams compete. Quick questions about lesson. Fun recap and engagement booster.',
    duration: '10 minutes',
    suitableFor: ['KS3'],
    resourcesNeeded: ['Quiz questions', 'scoreboard'],
    differentiation:
      'Mix easy and hard questions. Award points for reasoning, not just correct answers.',
  },
  {
    id: 'plenary-summary-sentence-building',
    title: 'Build the Summary Sentence',
    description:
      'Display sentence with blanks. Students complete with key terms/ideas from lesson. Co-creates lesson summary.',
    duration: '5 minutes',
    suitableFor: ['KS3'],
    resourcesNeeded: ['Sentence template with blanks'],
    differentiation:
      'Provide word bank for lower ability. Ask higher ability to create their own summary sentence.',
  },
  {
    id: 'plenary-whip-around',
    title: 'Whip Around: Quick Fire Answers',
    description:
      'Pose a question. Go around the room, each student gives one-word or brief answer. Builds participation and consolidation.',
    duration: '5-10 minutes',
    suitableFor: ['both'],
    resourcesNeeded: ['Focus question'],
    differentiation:
      'Pass option available. Scaffold responses for struggling students (or accept their idea even if imperfect).',
  },
  {
    id: 'plenary-reflection-thinking-pair-share',
    title: 'Reflection: Think-Pair-Share',
    description:
      'Reflect individually (2 mins). Discuss with partner (2 mins). Share with class (1 min). Deepens metacognitive thinking.',
  ...
  },
  {
    ...
    description:
      'Students write: Mud (unclear concept), Glitter (interesting discovery), Gold (something valuable learned). Honest feedback.',
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      "Display today's focus. Students name one connection to previous lessons or their own life. Builds schema.",
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Display 3-5 quick questions. Students answer to self-assess. Enables reflection on progress.',
    duration: '5-7 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Each student teaches their partner one key idea from the lesson in one minute. Consolidates learning through teaching.',
    duration: '5 minutes',
    suitableFor: ['both'],
    resourcesNeeded: ['Focus concept'],
    differentiation:
      "Provide sentence frame: 'Today we learned... The most important part is... because...'",
  },
  {
    id: 'plenary-gallery-walk-review',
    title: 'Gallery Walk: Review Student Work',
    description:
      "Display student work around room. Class walks and views others' annotations/answers/diagrams. Celebrates learning.",
  ...
  },
  {
    ...
    description:
      "Each student suggests one word summarizing today's learning. Create word cloud or list. Synthesizes lesson into essence.",
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Green = confident, Amber = okay, Red = need help. Students indicate against learning objectives. Targets intervention.',
  ...
  },
  {
    ...
    description:
      'For ongoing texts: students predict next plot turn or character action. Builds anticipation and hooks next lesson.',
    duration: '5 minutes',
    suitableFor: ['KS3'],
  ...
  },
  {
    ...
    description:
      "Students write one question they'd ask a friend about today's topic. Frames learning for ongoing conversation.",
    duration: '5 minutes',
    suitableFor: ['both'],
  ...
  },
  {
    ...
    description:
      'Explain homework, model first question, explain how it connects to lesson. Clear expectations.',
    duration: '5 minutes',
    suitableFor: ['both'],
...
export const homeworkBank: HomeworkTask[] = [
  {
    ...
    description:
      'Write 5 sentences using subject vocabulary words correctly in context. Each sentence must demonstrate understanding of word meaning.',
    estimatedTime: '15-20 minutes',
    markingGuidance:
      'Award 1 mark per correct usage. Sentence must be accurate and show meaning understanding (not just define the word).',
    modelAnswer:
      "Word: 'Ambiguous' - Example: 'The character's motives remain ambiguous throughout the play, leaving readers unsure of his true intentions.'",
    suitableFor: 'both',
  },
  {
  ...
  },
  {
    ...
    description:
      'Create a detailed profile of an assigned character including: appearance, personality, key actions, relationships, development. Use evidence from text.',
    estimatedTime: '25-30 minutes',
    markingGuidance:
      'Completeness of details = 3 marks, Evidence from text = 4 marks, Understanding of development/change = 3 marks. Total = 10 marks.',
    modelAnswer:
      "Name: Lady Macbeth | Initial Appearance: Ambitious, strong-willed, mentally sharp | Development: Begins as manipulator of Macbeth, convinces him to kill Duncan. Later, guilt manifests in sleepwalking and eventual suicide. | Key Quote: 'Out, damned spot!' reveals internal psychological breakdown.",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Choose a theme (power, love, ambition, identity). Find 5 moments where this theme appears. Record: scene, quote/description, how it shows the theme.',
    estimatedTime: '20 minutes',
    markingGuidance:
      'Relevance of references = 5 marks, Accuracy of scene location = 3 marks, Explanation of thematic link = 2 marks. Total = 10 marks.',
    modelAnswer:
      "Theme: Power | Reference 1 - Scene: Opening | Quote: 'Now is the winter of our discontent' | How it shows theme: The language immediately establishes power struggle and political disorder.",
    suitableFor: 'both',
  },
  {
    ...
    description:
      "Write a diary entry from a character's perspective (200-250 words) capturing their thoughts/emotions at a key moment in the text.",
    estimatedTime: '25-30 minutes',
    markingGuidance:
      'Voice/characterization = 3 marks, Textual knowledge (accurate to scene/moment) = 3 marks, Writing quality (varied sentences, vocabulary) = 2 marks, Length = 1 mark. Total = 9 marks.',
    modelAnswer:
      "Dear Diary, Today I did something I never thought I'd do. He asked me to choose-family or love. My hands shook as I made my choice. I said his name, not theirs. What have I become?",
    suitableFor: 'KS3',
  },
  {
    ...
    description:
      'Write a paragraph comparing how two texts treat the same theme/character type. Use embedded quotes from both texts.',
    estimatedTime: '25-30 minutes',
    markingGuidance:
      'Identification of similarity/difference = 2 marks, Evidence from both texts = 4 marks, Analytical link = 2 marks, Conclusion about significance = 2 marks. Total = 10 marks.',
    modelAnswer:
      "Both texts explore power through conflict, but they present different models. Text A shows power as violent and corrupting ('He seized control'). Text B presents power as subtle and linguistic ('Her words controlled the room'). This reveals two views: power as physical force vs. power as influence.",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Annotate a provided short passage (10-15 lines) marking: techniques, word choices, tone shifts, mood. Write brief explanations for each annotation.',
    estimatedTime: '15-20 minutes',
    markingGuidance:
      'Identification of devices = 4 marks, Accuracy of explanations = 4 marks, Link to effect/meaning = 2 marks. Total = 10 marks.',
    modelAnswer:
      "[On text: 'The room fell silent'] Annotation: Semantic field of silence/absence-creates tension and unease. Implies power shift: whoever breaks silence has power.",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Research the author and find 3 biographical facts that might have influenced the text. Explain the possible connection for each.',
    estimatedTime: '20-25 minutes',
    markingGuidance:
      'Accuracy of facts = 3 marks, Quality of sources = 2 marks, Thoughtfulness of connections to text = 5 marks. Total = 10 marks.',
    modelAnswer:
      'Fact: Author lived during period of war. Connection: Text includes themes of conflict and loss. This reflects his lived experience and gives authenticity to emotional scenes.',
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Identify one recurring image (e.g., light/darkness, water, cages). Find 3-4 instances. Explain what the pattern suggests about meaning.',
    estimatedTime: '25 minutes',
    markingGuidance:
      'Identification of image = 2 marks, Location of 3+ instances = 3 marks, Pattern interpretation = 4 marks, Conclusion about significance = 1 mark. Total = 10 marks.',
    modelAnswer:
      "Image: Light. Instance 1: 'A beam of light through the window.' Instance 2: 'His face darkened.' Instance 3: 'Hope flickered.' Pattern: Light represents hope/truth. Darkness represents despair/ignorance. The text suggests that enlightenment is fleeting.",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Plan an essay response to a given question using provided graphic organizer (thesis, 3 main points with evidence, conclusion idea).',
    estimatedTime: '15-20 minutes',
    markingGuidance:
      'Thesis clarity = 2 marks, Relevance of 3 points = 4 marks, Evidence selection = 3 marks, Logical organization = 1 mark. Total = 10 marks.',
    modelAnswer:
      "Question: How does the writer present ambition? | Thesis: The writer shows ambition as corrupting and destructive. | Point 1: Protagonist's ambition leads to moral compromise (evidence: specific quote). | Point 2: Ambition isolates him from family (evidence: specific scene).",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      "Choose a key concept (e.g., 'fear,' 'power,' 'love'). Create a word web showing related words, antonyms, synonyms, and example usage in text.",
    estimatedTime: '15 minutes',
    markingGuidance:
      'Center word = 1 mark, Related words (5+) = 3 marks, Connections/relationships shown = 3 marks, Text references = 3 marks. Total = 10 marks.',
    modelAnswer:
      "Center: POWER | Related: Control, Dominance, Authority, Influence, Weakness (antonym) | Text reference: In Act 2, 'power' appears in contexts of both violent seizing and subtle influence.",
    suitableFor: 'both',
  },
  {
    ...
    description:
      "Respond to an open-ended discussion question (e.g., 'Is this character a hero or villain?'). Present a clear position with supporting evidence.",
    estimatedTime: '20 minutes',
    markingGuidance:
      'Clear position = 2 marks, Supporting evidence (2+) = 4 marks, Acknowledgment of alternative view = 2 marks, Conclusion = 2 marks. Total = 10 marks.',
    modelAnswer:
      'Question: Is Character X sympathetic? My position: Yes, despite his actions. Evidence 1: His background reveals difficult circumstances. Evidence 2: His internal conflict is shown through soliloquy. Counterpoint: Some might argue his violence is unforgivable. My conclusion: Understanding is not the same as approval.',
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      "Rewrite a key scene from a different character's perspective, in a different genre, or with a different ending (brief: 50-75 words).",
    estimatedTime: '20-25 minutes',
    markingGuidance:
      'Accuracy to original scene = 2 marks, Creative choice clearly shown = 3 marks, Writing quality = 2 marks, Word count = 1 mark. Total = 8 marks.',
    modelAnswer:
      "Original: Character leaves without explanation. Rewrite (from her perspective): 'I had to leave. His face would break my resolve, and I'd never find the strength to do what must be done. One foot in front of the other. Don't look back.'",
    suitableFor: 'KS3',
  },
  {
    ...
    description:
      'Provided a short unseen text passage, identify and name 5 language techniques and briefly explain the effect of each.',
    estimatedTime: '15-20 minutes',
    markingGuidance:
      'Correct identification = 2 marks, Accurate naming = 2 marks, Effect explanation = 6 marks. Total = 10 marks.',
    modelAnswer:
      "Technique 1: Metaphor - 'Heart of stone' - shows emotional hardness. Technique 2: Alliteration - 'Silent shadow' - creates eerie mood.",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      "Plan (don't write full answer) a response comparing how two texts approach a similar theme/technique. Include thesis and 3 comparison points.",
    estimatedTime: '15-20 minutes',
    markingGuidance:
      'Thesis comparing both = 2 marks, 3 clear points = 4 marks, Evidence selection = 3 marks, Awareness of differences = 1 mark. Total = 10 marks.',
    modelAnswer:
      "Thesis: Both texts explore power, but Text A emphasizes violence while Text B emphasizes rhetoric. | Point 1: Power expressed as violence (A) vs. words (B). | Point 2: Protagonist's success/failure linked to each approach. | Point 3: Reader sympathy differs based on method.",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Draw/create a diagram showing key characters and the relationships between them (allies, enemies, complex). Add brief notes on how relationships change.',
    estimatedTime: '20 minutes',
    markingGuidance:
      'All major characters included = 2 marks, Accuracy of relationships = 4 marks, Notes on change/complexity = 3 marks, Visual clarity = 1 mark. Total = 10 marks.',
    modelAnswer:
      '[Visual diagram with characters as nodes] A ←→ B (allies, become enemies) | A → C (power dynamic, C dominated)',
    suitableFor: 'KS3',
  },
  {
    ...
    description:
      'Provided text with 10 deliberate errors (spelling, grammar, punctuation). Identify and correct all errors. Explain the rule for each.',
    estimatedTime: '15 minutes',
    markingGuidance:
      'Identification = 5 marks, Correction = 3 marks, Rule explanation = 2 marks. Total = 10 marks.',
    modelAnswer:
      "Error: 'Their going to the store' | Correction: 'They're going to the store' | Rule: They're = they are (contraction); their = possessive.",
    suitableFor: 'KS3',
  },
  {
    ...
    description:
      "Fill in provided sheet with research on text's historical/cultural context: dates, events, social norms, author details, relevant to text understanding.",
    estimatedTime: '25-30 minutes',
    markingGuidance:
      'Completeness = 3 marks, Accuracy = 4 marks, Relevance to text = 3 marks. Total = 10 marks.',
    modelAnswer:
      "Text written: 1818 | Historical context: Post-Napoleonic War anxiety | Social norms: Women's limited agency | Relevance: These anxieties appear as themes of power and control in the novel.",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Given a weak analytical paragraph, rewrite it improving: topic sentence clarity, evidence integration, explanation depth, link to question.',
    estimatedTime: '20 minutes',
    markingGuidance:
      'Topic sentence improvement = 2 marks, Evidence integration = 2 marks, Explanation depth = 3 marks, Link quality = 2 marks, Writing flow = 1 mark. Total = 10 marks.',
    modelAnswer:
      "Weak: 'Shakespeare uses metaphors. Metaphors help the reader understand better. This is important.' Strong: 'Through the metaphor of disease pervading the state of Denmark, Shakespeare reveals how corruption spreads insidiously, infecting every level of society. This extended image suggests that rot cannot be contained-it will ultimately destroy the entire body politic.'",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Answer an essay question in 20 minutes (shorter practice run). Focus on clear structure and time management. Plan for 3 mins, write for 15 mins, review for 2 mins.',
    estimatedTime: '25 minutes',
    markingGuidance:
      'Structure = 2 marks, Evidence use = 3 marks, Analysis quality = 3 marks, Completion/length = 2 marks. Total = 10 marks.',
  ...
  },
  {
    ...
    description:
      'Write a 150-200 word dialogue between two characters (given or your choice) that reveals character voice and advances understanding.',
    estimatedTime: '20-25 minutes',
    markingGuidance:
      'Character differentiation (distinct voices) = 3 marks, Natural dialogue flow = 2 marks, Reveals character insight = 3 marks, Writing quality = 2 marks. Total = 10 marks.',
    modelAnswer:
      "'You knew, didn't you?' 'I suspected.' 'And did nothing.' 'What could I do?' The question hung between them, heavy as the silence that followed. [continues to show conflict through dialogue]",
    suitableFor: 'KS3',
  },
  {
    ...
    description:
      'Choose one object/image that functions symbolically in the text. Find 2-3 instances. Explain what it symbolizes and its significance to overall meaning.',
    estimatedTime: '20 minutes',
    markingGuidance:
      'Symbol identification = 2 marks, 2-3 instances located = 3 marks, Symbolic meaning = 3 marks, Significance to theme = 2 marks. Total = 10 marks.',
    modelAnswer:
      "Symbol: The rose | Instance 1: Given as love token. Instance 2: Crushed underfoot. Instance 3: Referenced as decayed. Meaning: Beauty and love, and their fragility. Significance: The recurring destruction of the rose mirrors the text's theme of beauty destroyed by violence.",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Read provided passage. Identify the tone and explain how the writer creates it through word choice, punctuation, sentence structure.',
    estimatedTime: '15-20 minutes',
    markingGuidance:
      'Tone identification = 2 marks, Device identification = 3 marks, Effect explanation = 4 marks, Link to meaning = 1 mark. Total = 10 marks.',
    modelAnswer:
      "Tone: Menacing/ominous | How created: Short, punchy sentences ('He arrived.' 'She stared.') create tension. Descriptive words ('dark,' 'cold') establish dread. Repetition of 'wait' emphasizes anticipation. These choices make the reader feel uneasy, mirroring the character's anxiety.",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      "Analyze how the text's narrative perspective (first person, third person, unreliable narrator?) shapes reader understanding and interpretations.",
    estimatedTime: '20-25 minutes',
    markingGuidance:
      'Understanding of narrative perspective = 2 marks, Evidence from text = 3 marks, Analysis of how it shapes meaning = 4 marks, Conclusion = 1 mark. Total = 10 marks.',
    modelAnswer:
      "The text uses an unreliable first-person narrator who misrepresents events. This forces readers to read between the lines and question the narrator's truthfulness. We must reconstruct 'truth' from contradictions. This technique implicates readers in the narrator's moral confusion.",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Write a reflective journal entry (250+ words) responding to recent reading: What moved you? What confused you? What do you predict? What questions do you have?',
    estimatedTime: '20-25 minutes',
    markingGuidance:
      'Evidence of engagement = 3 marks, Depth of reflection = 3 marks, Textual reference = 2 marks, Writing quality = 2 marks. Total = 10 marks.',
    modelAnswer:
      "'I didn't expect the character to betray his best friend. It made me reconsider everything. Now I'm wondering if friendship is ever truly solid, or if it always cracks under pressure. The author seems to suggest...'",
    suitableFor: 'KS3',
  },
  {
    ...
    description:
      'The text (or critical interpretation) assumes X about a character/event. Do you agree? Write a counter-argument with evidence.',
    estimatedTime: '20 minutes',
    markingGuidance:
      'Understanding of assumption = 2 marks, Counter-argument clarity = 3 marks, Supporting evidence = 3 marks, Conclusion = 2 marks. Total = 10 marks.',
    modelAnswer:
      'Assumption: The protagonist is villainous. Counter-argument: His actions stem from desperation and circumstance, not evil intent. Evidence 1: He hesitates before each act. Evidence 2: He expresses regret. Therefore, judging him as purely villainous oversimplifies.',
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      "Examine the text's structure (chapters, sections, narrative timeline). How does this structure create meaning, suspense, or emotional effect?",
    estimatedTime: '20 minutes',
    markingGuidance:
      'Structure identified = 2 marks, Specific examples = 3 marks, Effect analysis = 4 marks, Link to overall meaning = 1 mark. Total = 10 marks.',
    modelAnswer:
      'The text alternates between past and present timelines. This structure builds suspense: readers know the outcome but not the cause. The gradual reveals create mystery and deepen tragic irony.',
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Identify and record 5 essential quotes from the text that will be useful for essays. Include brief note on why each is significant.',
    estimatedTime: '15 minutes',
    markingGuidance: '5 accurate quotes = 5 marks, Significance notes = 5 marks. Total = 10 marks.',
    modelAnswer:
      "Quote 1: 'All power corrupts' (p. 45) - Significance: Central thesis of the text. Quote 2: [continues x4]",
    suitableFor: 'GCSE',
  },
  {
    ...
    description:
      'Write a 200-word reflection: After reading/studying this text, what do you believe is its central message or theme? Why? What evidence?',
    estimatedTime: '20 minutes',
    markingGuidance:
      'Thesis clarity = 3 marks, Evidence = 4 marks, Personal engagement = 2 marks, Writing quality = 1 mark. Total = 10 marks.',
    modelAnswer:
  ...
  },
  {
    ...
    description:
      'Complete a full exam-question response under timed conditions (45 minutes including planning). This is a complete summative practice.',
    estimatedTime: '50 minutes (5 plan, 40 write, 5 review)',
    markingGuidance:
      'Use full exam rubric: 8-9 marks = sophisticated analysis, 6-7 = secure understanding, 5 = adequate with some gaps, 4 = developing, 3 = basic. Award for analysis depth, evidence selection, technical accuracy, engagement with question.',
