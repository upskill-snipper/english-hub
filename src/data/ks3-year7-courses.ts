...
export const ks3Year7Courses: CourseData[] = [
  {
    ...
    duration: '6-8 hours',
    level: 'Year 7',
    description: "Explore identity and belonging through Katherine Rundell's Fox Girl and White Gazelle. Develop reading comprehension, character analysis, PEE paragraph writing, and inference skills aligned to 7R.1–7R.6 and 7W.1–7W.9.",
    color: '#f59e0b',
  ...
  },
  {
    ...
    duration: '6-8 hours',
    level: 'Year 7',
    description: "Discover what makes a writer's voice unique and how language shapes identity. Covers tone, perspective, descriptive writing, reflective writing, and empathy through diverse texts. Aligned to 7R.3–7R.5 and 7W.1–7W.6.",
    color: '#8b5cf6',
  ...
  },
  {
    ...
    duration: '6-8 hours',
    level: 'Year 7',
    description: 'Analyse narrative structure and moral themes in folk tales from different cultures, then explore poetry through annotation, imagery, and comparison. End-of-year assessment combines both skills. Aligned to 7R.3–7R.6 and 7W.2–7W.5.',
    color: '#10b981',
