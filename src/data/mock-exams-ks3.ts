    ...
    sections: [
      {
        ...
        instructions: 'Write a formal letter of response about proposed school changes. Aim for 150-200 words. Use correct letter structure, formal tone, and logical arguments. (20 marks)',
        questions: [
          {
            id: 'ks3-y7-writing-q1',
            questionNumber: 1,
            marks: 20,
            questionText: 'Write a formal letter to your headteacher responding to proposed changes in the school lunch system.',
            bulletPoints: [
      ...
      },
      {
        ...
        instructions: 'Write a creative story based on the prompt provided. Aim for 250-300 words. Use vivid descriptions, varied sentence structures, and narrative techniques. (20 marks)',
        questions: [
          {
            id: 'ks3-y7-writing-q2',
            questionNumber: 2,
            marks: 20,
            questionText: 'Write a creative short story beginning with: "The box had been sitting in the attic for fifty years, and nobody knew what was inside."',
            bulletPoints: [
    ...
    sections: [
      {
        ...
        instructions: 'Write a persuasive article arguing for or against banning social media during school hours. Approximately 300 words. Use rhetorical devices and clear argument structure. (25 marks)',
        questions: [
          {
            id: 'ks3-y8-writing-q1',
            questionNumber: 1,
            marks: 25,
            questionText: 'Write a persuasive article for a school newspaper arguing either for or against banning social media use during the school day.',
            bulletPoints: [
      ...
      },
      {
        ...
        instructions: 'Write a narrative story about a character discovering something unexpected that forces them to reconsider their assumptions. Approximately 300-350 words. Use narrative techniques effectively. (25 marks)',
        questions: [
          {
            id: 'ks3-y8-writing-q2',
            questionNumber: 2,
            marks: 25,
            questionText: 'Write a narrative story about a character who discovers something unexpected that forces them to reconsider their assumptions about someone they thought they knew well.',
            bulletPoints: [
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            markScheme: '2 marks: Identifies language features (metaphor, word choice, sentence structure, repetition). 2 marks: Quotes specific words/phrases; explains connotations. 2 marks: Connects language to Elena\'s character and emotional state. 2 marks: Synthesizes analysis discussing overall effect. High-level response recognizes how form reinforces content.',
    ...
    sections: [
      {
        ...
        instructions: 'Write a persuasive essay responding to the statement: "The most important quality for success is not talent, but persistence." Approximately 400-450 words. Use sophisticated persuasive techniques, structured arguments, and formal register. (30 marks)',
        questions: [
          {
            id: 'ks3-y9-writing-q1',
            questionNumber: 1,
            marks: 30,
            questionText: 'Write a persuasive essay responding to the statement: "The most important quality for success is not talent, but persistence."',
            bulletPoints: [
      ...
      },
      {
        ...
        instructions: 'Write a narrative story with the title "The Last Train." Consider how your protagonist experiences a moment that changes everything. Approximately 400-450 words. Use sophisticated narrative techniques. (30 marks)',
        questions: [
          {
            id: 'ks3-y9-writing-q2',
            questionNumber: 2,
            marks: 30,
            questionText: 'Write a narrative story with the title: "The Last Train." Consider how your protagonist might experience a moment that changes everything.',
            bulletPoints: [
    ...
    sections: [
      {
        ...
        instructions: 'Answer all questions about A Midsummer Night\'s Dream. Support all claims with evidence from the play text. Refer to specific scenes and quotations.',
        questions: [
          {
            id: 'ks3-y9-shakespeare-q1',
            questionNumber: 1,
            marks: 4,
            questionText: 'How does Shakespeare present the theme of love through the romantic relationships in the play?',
          ...
          },
          {
            ...
            questionNumber: 2,
            marks: 5,
            questionText: 'Analyze Shakespeare\'s use of magic and the supernatural in the play. What purpose does magic serve in the narrative?',
