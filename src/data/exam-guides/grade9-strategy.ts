...
export const grade9Strategy: Grade9Strategy = {
  ...
  sections: [
    // ── Section 1: The Grade 9 Mindset ──────────────────────────────────────
    {
      heading: 'The Grade 9 Mindset',
      content:
        ...
        '<ul>' +
        '<li>A <strong>Grade 5</strong> student <em>describes</em> what happens.</li>' +
        '<li>A <strong>Grade 7</strong> student <em>explains</em> how language works.</li>' +
        ...
        '[abstract concept], reflecting [contextual force].</em></p>',
      examples: [
        {
    ...
    // ── Section 2: Mastering AO2: Language Analysis ─────────────────────────
    {
    ...
    // ── Section 3: Building a Conceptualised Response ───────────────────────
    {
      ...
      content:
        ...
        'while introducing the next stage of your argument. Think of connective phrases like:</p>' +
        '<ul>' +
        '<li>"This idea is developed further when..."</li>' +
        '<li>"However, [Author] complicates this by..."</li>' +
        '<li>"The significance of this becomes clear when..."</li>' +
        '</ul>' +
      ...
      examples: [
        {
          label: 'Weak paragraph opening (Grade 5-6)',
          text:
            'In the next part of the extract, Stevenson describes Hyde\'s appearance. He says that Hyde gives an impression of "deformity" ' +
            'which shows that Hyde is evil.',
        },
        {
    ...
    // ── Section 4: Writing Skills That Examiners Love ───────────────────────
    {
      heading: 'Writing Skills That Examiners Love',
      content:
        '<p>Whether you are writing creatively (Language Q5) or analytically (Literature essays), examiners reward <strong>sophisticated, controlled writing</strong>. ' +
        'Here is what separates Grade 9 writing from the rest.</p>' +
        '<h4>Varied Sentence Structures</h4>' +
        '<p>Rotate your sentence openings consciously:</p>' +
        '<ul>' +
        '<li><strong>Fronted adverbials:</strong> "Beneath the fluorescent glare, the corridor stretched endlessly."</li>' +
        '<li><strong>Present participles:</strong> "Clutching the letter, she felt the paper grow damp beneath her fingers."</li>' +
        '<li><strong>Short sentences for impact:</strong> "He ran. Nothing else mattered."</li>' +
        ...
        'anaphora, statistics, emotive language, and counter-arguments you then dismantle.</p>',
      examples: [
        {
    ...
    // ── Section 5: Time Management Under Pressure ───────────────────────────
    {
      ...
      content:
        ...
        'Three excellent paragraphs will score higher than three excellent paragraphs plus one rushed, half-finished paragraph that eats into ' +
        'time for the next question. The marks you lose by leaving one question slightly short are far fewer than the marks you lose by ' +
        'barely starting another.</p>' +
        '<h4>Planning Strategies</h4>' +
        '<p>Spend <strong>5 minutes planning</strong> every Literature response. Write down: your thesis (one sentence), 3-4 key quotations, ' +
        'and a one-word note for the context link in each paragraph. This prevents mid-essay panic and rambling. ' +
        'For Language Q5, plan your opening, 3-4 key paragraphs, and your ending (which should mirror the opening).</p>',
      examples: [
        {
          label: 'Poor time management (common mistake)',
          text:
            'The student spends 50 minutes on the first Literature question, writing six paragraphs of detailed analysis. ' +
            'They then have only 15 minutes for the second question and produce one rushed paragraph. ' +
            'Result: 28/30 on Q1 but only 8/30 on Q2 = 36/60. If they had split time evenly, they could score 24/30 + 22/30 = 46/60.',
        },
        {
          label: 'Smart time management',
          text:
            'The student writes a brief plan (3 minutes), writes three focused paragraphs with embedded quotations and context (22 minutes), ' +
            'and uses the final 5 minutes to write a short but powerful concluding sentence that ties back to the thesis. ' +
            'They then move on to the next question with full time available.',
        },
      ],
    },

    // ── Section 6: The Power of Context in Literature ───────────────────────
    {
      ...
      content:
        ...
        '<ul>' +
        '<li>"Writing in [year/period], [Author] reflects the contemporary anxiety that..."</li>' +
        '<li>"A [contemporary/modern] audience would recognise this as..."</li>' +
        '<li>"This resonates with the [historical event/social attitude] of the time, suggesting that [Author]..."</li>' +
    ...
    // ── Section 7: Common Mistakes That Cost Marks ──────────────────────────
    {
      ...
      content:
        ...
        'Examiners call this "feature-spotting" and it caps you at Grade 4-5. Every technique you name must be followed by analysis of what it does and why.</p>' +
        '<h4>2. Retelling the Story</h4>' +
        '<p>The examiner knows the plot. Narrating what happens ("In this scene, Macbeth kills Duncan and then feels guilty") wastes time and shows ' +
        'no analytical skill. Always focus on <strong>how and why</strong> the writer tells the story, not <strong>what</strong> happens.</p>' +
        '<h4>3. Generic Context Paragraphs</h4>' +
        '<p>A paragraph that begins "In Victorian times..." and contains no quotation is a wasted paragraph. Context must be woven into your analysis ' +
        'of specific textual moments, not presented as a separate history essay.</p>' +
        '<h4>4. Running Out of Time</h4>' +
        '<p>Spending too long on one question means another question is barely answered. The marks you gain by perfecting one answer are always fewer ' +
      ...
      examples: [
        {
          label: 'Feature-spotting (Grade 4-5)',
          text:
            'Shelley uses alliteration in "boundless and bare" and "lone and level." He also uses a metaphor when he says ' +
            '"the hand that mocked them." These are examples of figurative language.',
        },
        {
