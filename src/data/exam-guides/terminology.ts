...
export const terminologyList: TerminologyEntry[] = [
  ...
  },
  {
    ...
    category: 'figurative',
    definition:
      'An extended narrative in which characters, events, and settings represent abstract ideas or moral principles. The entire text functions as a sustained metaphor.',
    example:
      'Animal Farm is an allegory for the Russian Revolution and the corruption of socialist ideals under Stalinism.',
  },
  {
    term: 'Juxtaposition',
    category: 'figurative',
  ...
  },
  {
    ...
    category: 'sound',
    definition:
      'The pattern of stressed and unstressed syllables in speech or writing. Rhythm controls pace, creates mood, and can mirror the content of the text. Regular rhythm can feel controlled or hypnotic; irregular rhythm can create unease or urgency.',
    example:
      'Iambic pentameter in Shakespeare (da-DUM da-DUM da-DUM da-DUM da-DUM) creates a heartbeat-like regularity that mirrors natural speech and can be disrupted for dramatic effect.',
  },
  ...
  },
  {
    ...
    category: 'structural',
    definition:
      'A "turn" or shift in thought, argument, or emotion within a poem. Most associated with sonnets (typically at line 9 in Petrarchan sonnets, or before the final couplet in Shakespearean sonnets), but can occur in any poem.',
    example:
      'In Shakespeare\'s Sonnet 18, the volta at "But thy eternal summer shall not fade" shifts from describing the shortcomings of nature to praising the permanence of the beloved through poetry.',
  },
  {
    term: 'Enjambment',
    category: 'structural',
  ...
  },
  {
    ...
    category: 'structural',
    definition:
      'A scene or passage that shifts the narrative to an earlier point in time. Used to provide backstory, reveal character motivation, or create dramatic contrast between past and present.',
    example:
      'In A Christmas Carol, the Ghost of Christmas Past takes Scrooge back to scenes from his youth, revealing the emotional wounds that hardened him into the miser he has become.',
  },
  {
    term: 'In Medias Res',
    category: 'structural',
  ...
  // ═══════════════════════════════════════════════════════════════════════════════
  {
    ...
    category: 'poetry',
    definition:
      'A grouped set of lines within a poem, separated from other groups by a blank line. Functions like a paragraph in prose, often containing a single idea or stage of the argument. Stanza length and regularity (or irregularity) are significant structural choices.',
    example:
      'Regular four-line stanzas (quatrains) in "London" by Blake create a controlled, measured rhythm that contrasts with the chaos and suffering described within them.',
  },
  {
    term: 'Couplet',
    category: 'poetry',
  ...
  },
  {
    ...
    category: 'poetry',
    definition:
      'A stanza or unit of four lines. The most common stanza form in English poetry. Various rhyme schemes are possible (ABAB, ABBA, AABB, etc.), each creating a different effect.',
    example:
      'Shakespearean sonnets are structured as three quatrains followed by a couplet, each quatrain developing a different facet of the argument.',
  },
  {
    term: 'Free Verse',
    category: 'poetry',
