      ...
      sections: [
        {
          ...
          questions: [
            {
              question: 'Q1 - Multiple choice (NEW 2026: replaces "list four things")',
              marks: 4,
              ao: 'AO1',
            ...
            {
              question: 'Q2 - How does the writer use language to describe/present [focus]?',
              marks: 8,
              ao: 'AO2',
      ...
      sections: [
        {
          ...
          questions: [
            ...
            {
              question: 'Q3 - How does the writer use language to [focus]? (Source A only)',
              marks: 12,
              ao: 'AO2',
            ...
            },
            {
              ...
              marks: 16,
              ao: 'AO3',
              skill: 'Compare perspectives and methods across both sources',
              time: '20 minutes',
              advice:
          ...
          questions: [
            {
              ...
              skill: 'Extract-to-whole analysis of Shakespeare play. 4 additional marks for SPaG.',
              time: '50-55 minutes',
              advice:
      ...
      sections: [
        {
          ...
          questions: [
            {
              question: 'How does [author/playwright] present [character/theme] in [text]?',
              marks: 30,
        ...
        },
        {
          ...
          questions: [
            {
              question: 'Part 1: In [poem title], how does the poet present [theme/idea]?',
              marks: 24,
              ao: 'AO1 + AO2',
            ...
            {
              question: 'Part 2: Compare how the poets present [shared theme] in both poems.',
              marks: 12,
              ao: 'AO2',
