...
export const genericOverview = {
  ...
  universalAOs: {
    language: [
      ...
      },
      {
        code: 'AO7-AO9',
        description:
          'These cover Spoken Language (AO7: presenting, AO8: listening/responding, AO9: using Standard English). They are assessed separately and reported as Pass/Merit/Distinction - they do not contribute to the 9-1 grade.',
    ...
    keyPrinciple:
      'AO1 and AO2 together account for approximately 70% of all Literature marks across every board. Context (AO3) matters but is secondary to close textual analysis.',
  },
    ...
    comparisons: [
      {
        ...
        level45:
          "The metaphor positions the reader to experience the narrator's fear from the inside - the simile 'like a caged bird' both evokes the physical constraint and the psychological imprisonment, suggesting that fear is not merely felt but <em>inhabited</em>.",
      },
      {
        level3: 'Context added as separate paragraph at the end',
        level45:
          "Context woven into analysis: \"Writing in 1945, with the Welfare State being created around him, Priestley weaponises Birling's obliviousness - his confident prediction that 'the Titanic…unsinkable' becomes dramatic irony that the original audience would have felt viscerally.\"",
      },
      {
        level3: 'This is effective because it creates tension',
        level45:
          'This is particularly effective because it positions the reader to anticipate the revelation before it is made explicit - Stevenson withholds the name but saturates the description with enough sensory revulsion that the reader constructs their own version of Hyde before the text confirms it.',
      },
      {
        level3: 'Dickens presents Scrooge as greedy',
        level45:
          'Dickens constructs Scrooge less as a psychologically complex individual than as a moral argument - his transformation is deliberately rapid because Dickens is not interested in realistic character development; he is writing a polemic designed to shame his middle-class readership into charitable action before Christmas Day.',
      },
    ],
  },
  ...
  gradeBoundarySummary: {
    ...
    insight:
      'Even Grade 9 English Language at AQA requires only 74.4%. Getting everything right is not expected - what earns the top grade is quality of analytical writing, not perfection.',
    boards: [
      {
        board: 'AQA 8700',
        subject: 'Language',
