...
The destruction, however, brought unexpected benefits. The medieval street plan, with its narrow, crowded lanes, was replaced by wider streets and buildings constructed from brick and stone. New building regulations were introduced, and Sir Christopher Wren was commissioned to design a magnificent new St Paul's Cathedral, which still stands today.`,
    questions: [
      ...
      },
      {
        ...
        acceptableKeywords: ["wind", "winds", "easterly", "timber", "wooden", "tightly packed", "close together", "narrow"],
        skill: "literal",
        points: 2,
      },
    ],
...
He held his breath. Nobody visited the farm in weather like this. Nobody reasonable, anyway. The knocking came again, patient and unhurried, and this time it was accompanied by a voice he did not recognise.`,
    questions: [
      ...
      },
      {
        id: "p5q3",
        type: "short-answer",
        question: "How does the writer create a sense of tension in the final paragraph? Give two techniques with evidence.",
        correctAnswer: "short sentences darkness unknown visitor knocking",
        acceptableKeywords: ["short sentence", "darkness", "unknown", "mystery", "knocking", "suspense", "tension", "nobody", "did not recognise", "patient", "unhurried", "deliberate"],
        skill: "evaluative",
        points: 3,
      },
      {
...
Solutions exist but require coordinated global action: reducing single-use plastics, investing in waste management infrastructure in developing nations, and funding research into biodegradable alternatives. Without urgent intervention, scientists estimate that by 2050, the ocean will contain more plastic by weight than fish.`,
    questions: [
      ...
      },
      {
        id: "p6q3",
        type: "short-answer",
        question: "Explain why microplastics are described as a 'far greater danger' than visible plastic waste.",
        correctAnswer: "invisible found everywhere food chain blood",
        acceptableKeywords: ["invisible", "cannot see", "everywhere", "food chain", "blood", "toxic", "smaller", "difficult to remove", "plankton", "whales", "human"],
        skill: "inferential",
        points: 3,
      },
      {
...
She began to read, and as she did, the temperature in the room dropped so markedly that her breath became visible. The torch flickered once, twice, and then steadied. Behind her, a floorboard creaked though she was standing perfectly still.`,
    questions: [
      ...
      },
      {
        id: "p7q2",
        type: "short-answer",
        question: "How does the writer use structural techniques to build suspense in the final paragraph? Refer to specific details.",
        correctAnswer: "short sentences temperature drop torch flicker floorboard creak standing still",
        acceptableKeywords: ["short sentence", "temperature", "drop", "cold", "breath visible", "torch", "flicker", "floorboard", "creak", "standing still", "contrast", "shift", "pace", "tension"],
        skill: "evaluative",
        points: 3,
      },
      {
    ...
    questions: [
      {
        id: "p8q1",
        type: "multiple-choice",
        question: "According to the passage, why does facial recognition technology have higher error rates for people with darker skin?",
        options: [
      ...
      },
      {
        id: "p8q2",
        type: "short-answer",
        question: "What does the writer mean by 'effectively automated prejudice'? Explain in your own words.",
        correctAnswer: "technology reproduces human biases automatically without intention",
        acceptableKeywords: ["automat", "bias", "prejudice", "discriminat", "reproduce", "built in", "coded", "systematic", "without knowing", "unintentional"],
        skill: "inferential",
        points: 3,
      },
      {
        ...
        options: [
          ...
          { id: "b", text: "The decision to develop AI has already been made and cannot be reversed" },
      ...
      },
      {
        ...
        options: [
          ...
          { id: "c", text: "Interdisciplinary oversight including ethicists, sociologists, and affected communities" },
    ...
    questions: [
      {
        id: "p9q1",
        type: "short-answer",
        question: "Analyse the significance of the metaphor 'her hair a flag of dark curls' and what it suggests about the woman in the photograph.",
        correctAnswer: "freedom movement energy vitality flag suggests patriotism or declaration",
        acceptableKeywords: ["freedom", "movement", "energy", "vitality", "wild", "flag", "declaration", "visible", "bold", "wind", "dynamic", "uncontrolled"],
        skill: "evaluative",
        points: 3,
      },
      {
        id: "p9q2",
        type: "multiple-choice",
        question: "What does the phrase 'bordered on recognition' suggest about Clara's response to the photograph?",
        options: [
      ...
      },
      {
        id: "p9q3",
        type: "short-answer",
        question: "Explain the final sentence: 'Memory, like photography, was an act of ruthless editing — it preserved the frame and discarded the context.' What is the writer arguing about memory?",
        correctAnswer: "memory is selective preserves some moments discards full truth incomplete partial",
        acceptableKeywords: ["selective", "incomplete", "partial", "editing", "choose", "discard", "unreliable", "construct", "frame", "context", "truth", "subjective"],
        skill: "evaluative",
        points: 4,
      },
      {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id: "c", text: "More choice leads to anxiety, dissatisfaction, and a sense of missed opportunity" },
      ...
      },
      {
        id: "p10q2",
        type: "short-answer",
        question: "Analyse the rhetorical effect of the final sentence: 'freedom without structure is merely another form of abandonment.' How does the writer use this to conclude their argument?",
        correctAnswer: "redefines freedom challenges assumption paradox epigram provocative",
        acceptableKeywords: ["redefin", "paradox", "epigram", "provocat", "challenge", "assumption", "freedom", "abandon", "structure", "antithes", "contrast", "powerful", "memorable", "conclud"],
        skill: "evaluative",
        points: 4,
      },
      {
        ...
        options: [
          ...
          { id: "c", text: "Institutions should curate and structure choices rather than simply maximising them" },
      ...
      },
      {
        id: "p10q4",
        type: "short-answer",
        question: "Why does the writer argue that curating choices 'is not paternalism'? What distinction are they drawing?",
        correctAnswer: "distinction between controlling people and helping them make better decisions supporting not restricting",
        acceptableKeywords: ["paternalism", "control", "help", "support", "facilitat", "good decision", "overwhelm", "structure", "freedom", "guid", "not restrict", "curate", "inform"],
        skill: "inferential",
        points: 3,
      },
    ],
