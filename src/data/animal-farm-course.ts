...
`,
      quiz: [
        ...
        {
          id: 'af-m1-q2',
          question: 'Which historical event is Animal Farm primarily an allegory of?',
          options: [
        ...
        {
          id: 'af-m1-q3',
          question: 'Why did Orwell struggle to get Animal Farm published?',
          options: [
        ...
        {
          id: 'af-m1-q4',
          question: 'What subtitle did Orwell give Animal Farm on the original edition?',
          options: ['A Political Satire', 'A Fairy Story', 'A Fable for Our Times', 'An Allegory'],
          correct: 1,
          explanation:
      ...
      quiz: [
        {
          ...
          options: ['Stalin and Trotsky', 'Marx and Lenin', 'Lenin and Trotsky', 'Marx and Engels'],
          correct: 1,
          explanation:
...
`,
      quiz: [
        ...
        },
        {
          id: 'af-m4-q3',
          question:
            'What historical events do the confessions and executions in Chapter 7 parallel?',
          options: [
...
`,
      quiz: [
        ...
        {
          id: 'af-m5-q2',
          question: 'What is the single commandment that replaces all seven at the end?',
          options: [
        ...
        {
          id: 'af-m5-q4',
          question: 'What is the significance of the final scene where pigs and humans play cards?',
          options: [
        ...
        },
        {
          ...
          options: ['Napoleon Farm', 'Pig Farm', 'Manor Farm - its original name', 'New Farm'],
          correct: 2,
          explanation:
      ...
      quiz: [
        {
          ...
          options: ['Big Brother', 'Doublethink', 'Thoughtcrime', 'Newspeak'],
          correct: 1,
          explanation:
        ...
        {
          id: 'af-m7-q2',
          question: 'What is the most effective form of control the pigs use to maintain power?',
          options: [
        ...
        {
          id: 'af-m7-q3',
          question: 'What does Orwell argue is the real reason revolutions fail?',
          options: [
        ...
        {
          id: 'af-m7-q5',
          question: "Why does Orwell present Benjamin's silence as a moral failure?",
          options: [
      ...
      quiz: [
        {
          id: 'af-m8-q1',
          question:
            'What historical event does the final dinner scene between pigs and humans most closely parallel?',
          options: [
        ...
        },
        {
          id: 'af-m8-q2',
          question:
            'Why did Orwell choose the allegorical fable form rather than a straightforward political essay?',
          options: [
        ...
        },
        {
          id: 'af-m8-q4',
          question:
            'What is the literary term for presenting familiar things in an unfamiliar way to force fresh perception?',
          options: ['Personification', 'Allegory', 'Defamiliarisation', 'Metaphor'],
          correct: 2,
          explanation:
...
`,
  ...
  assessmentQuestions: [
    ...
    {
      id: 'af-aq7',
      question: 'What is the first Commandment to be altered?',
      options: [
    ...
    {
      id: 'af-aq8',
      question: 'How does Napoleon seize sole power on the farm?',
      options: [
    ...
    },
    {
      id: 'af-aq9',
      question:
        "What does Frederick's attack on the farm and destruction of the windmill represent?",
      options: [
        'The French Revolution',
        'The Russian Civil War',
    ...
    {
      id: 'af-aq12',
      question: "What is the effect of the narrator's detached tone during the execution scene?",
      options: [
    ...
    {
      id: 'af-aq15',
      question: 'What structural pattern do the Seven Commandments create across the novella?',
      options: [
    ...
    {
      id: 'af-aq16',
      question: 'What does the phrase "bolting on context" mean in exam technique?',
      options: [
    ...
    {
      id: 'af-aq20',
      question: 'How should you divide your time on the AQA Modern Text question (45 minutes)?',
      options: [
