    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The entail means the estate will pass to Mr Collins rather than the Bennet daughters, illustrating how property laws disadvantaged women and made marriage an economic necessity - a central concern of the novel.',
      },
      {
        ...
        correct: 1,
        explanation:
          'The opening line is ironic because it presents a social assumption - that wealthy men must want wives - as if it were universal truth, when in fact it exposes how society views marriage as an economic transaction rather than a matter of genuine affection.',
      },
      {
        ...
        correct: 0,
        explanation:
          "While Romantic writers like Wordsworth and Byron celebrated emotion, nature, and rebellion, Austen's neoclassical style prioritises reason, precise social observation, and moral discernment - though her controlled prose conceals a sharp critique of society.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        question:
          "Why is Darcy's letter (Chapter 35) considered the most important structural device in the novel?",
        options: [
        ...
        correct: 1,
        explanation:
          "Darcy's letter is the structural pivot of the novel because it provides Elizabeth - and the reader - with information that completely reverses previous judgments. It forces Elizabeth to recognise her own prejudice and begins the process of transformation for both protagonists.",
      },
      {
        id: 'igcse-classic-pp-m2-q2',
        question:
          "What function does the Charlotte-Collins marriage serve in the novel's structure?",
        options: [
        ...
        correct: 1,
        explanation:
          "Charlotte's pragmatic, loveless marriage to Collins serves as a structural foil to Elizabeth and Darcy. It represents the harsh economic reality that Elizabeth risks by refusing to marry for convenience, and it illuminates the theme of marriage as a financial transaction.",
      },
      {
        ...
        correct: 0,
        explanation:
          "Lydia's elopement is the structural crisis of Volume III. It threatens the family's reputation, tests Darcy's transformation through his secret intervention, and removes the final obstacles to the central relationship - proving that Darcy has genuinely changed.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "This line is the emotional and moral turning point of Elizabeth's arc. She recognises that her pride in her own judgment has led her to misjudge both Darcy and Wickham, and that her prejudice has been as significant a flaw as Darcy's pride.",
      },
      {
        ...
        correct: 1,
        explanation:
          "Wickham is Darcy's structural foil. His charming, agreeable surface hides lies and moral corruption, while Darcy's reserved, seemingly arrogant exterior conceals integrity and genuine worth. This contrast reinforces the novel's theme that appearances are unreliable.",
      },
      {
        ...
        correct: 1,
        explanation:
          "Mr Bennet's wit and intelligence make him entertaining, but Austen shows that his ironic detachment is a form of irresponsibility. His failure to discipline his daughters or plan for their futures leaves them economically and socially vulnerable, as the Lydia crisis reveals.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        question:
          'How does Austen use the spectrum of marriages to develop the theme of marriage in the novel?',
        options: [
        ...
        correct: 1,
        explanation:
          'Austen presents a range of marriages - from the dysfunctional Bennets to the pragmatic Charlotte-Collins match to the ideal Elizabeth-Darcy union - to argue that genuine happiness in marriage requires emotional, intellectual, and moral compatibility, not merely wealth or passion.',
      },
      {
        id: 'igcse-classic-pp-m4-q2',
        question:
          'What does Austen suggest about the relationship between pride and self-knowledge?',
        options: [
        ...
        correct: 1,
        explanation:
          'Austen distinguishes between justified self-respect and blinding arrogance. Both Elizabeth and Darcy must learn that excessive pride - whether social or intellectual - prevents self-knowledge and empathy. The novel argues that pride becomes destructive only when it blocks honest self-examination.',
      },
      {
        ...
        correct: 2,
        explanation:
          "The gap between appearance and reality structures the entire novel. From the misleading first impressions at the Meryton Assembly to Wickham's false charm and Darcy's concealed integrity, Austen demonstrates that surface judgments are unreliable and true understanding requires patience and humility.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "Free indirect discourse merges the narrator's voice with a character's thoughts, creating an intimate yet critically distanced perspective. Austen uses it to align the reader with Elizabeth's perceptions while subtly signalling, through irony, when those perceptions are mistaken.",
      },
      {
        id: 'igcse-classic-pp-m5-q2',
        question:
          "How does Lady Catherine's attempt to prevent Elizabeth and Darcy's match demonstrate situational irony?",
        options: [
        ...
        correct: 1,
        explanation:
          "This is situational irony because events turn out contrary to Lady Catherine's intentions. Her report of Elizabeth's refusal to promise not to accept Darcy actually gives him hope, accelerating the very outcome she sought to prevent.",
      },
      {
        ...
        correct: 1,
        explanation:
          "Mr Collins's dialogue is characterised by its pomposity, excessive length, and obsequiousness - particularly towards Lady Catherine. Austen uses his speeches as satirical portraits of sycophancy and self-importance, exposing the absurdity of rigid social hierarchies.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        question:
          'What does the word "how" signal in an IGCSE Literature question like "How does Austen present the theme of pride?"',
        options: [
        ...
        correct: 1,
        explanation:
          'The word "how" directs you to focus on the writer\'s craft - the specific techniques Austen uses to present, develop, and explore the theme. Responses that describe what happens without analysing how Austen constructs meaning will not access the top mark bands.',
      },
      {
        ...
        correct: 1,
        explanation:
          'Examiners consistently highlight word-level analysis as a distinguishing feature of top-band responses. Explaining why a specific word choice is significant - such as why "tolerable" is more revealing than a neutral alternative - demonstrates sophisticated analytical skill.',
      },
      {
        id: 'igcse-classic-pp-m6-q3',
        question:
          'What is the most important quality of a conceptualised argument in a Literature essay?',
        options: [
        ...
        correct: 2,
        explanation:
          'A conceptualised argument is an overarching thesis or interpretation that threads through the entire essay. Every paragraph should advance this thesis, creating a coherent, unified response rather than a list of disconnected points.',
      },
    ],
  },
]
    ...
    quiz: [
      {
        ...
        question:
          "How did Dickens's childhood experience of the blacking factory influence Great Expectations?",
        options: [
        ...
        correct: 1,
        explanation:
          "Dickens's traumatic childhood experience of poverty and menial labour directly shaped Pip's shame about his humble origins, his desperate desire for gentility, and the novel's central critique of class snobbery.",
      },
      {
        ...
        correct: 1,
        explanation:
          "A Bildungsroman traces a protagonist's moral and psychological growth from youth to maturity. Great Expectations is a classic example, following Pip from innocent childhood through his corrupting experience of wealth and social ambition to his eventual moral reawakening.",
      },
      {
        ...
        correct: 1,
        explanation:
          "Weekly serial publication required Dickens to end each instalment with a hook to keep readers engaged. This format shaped the novel's episodic structure, creating its distinctive rhythm of suspense, revelation, and surprise.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The tripartite structure creates a powerful structural irony: as Pip rises socially, he falls morally, and as he loses his wealth and status, he recovers his moral compass. This challenges the Victorian equation of social status with moral worth.',
      },
      {
        id: 'igcse-classic-ge-m2-q2',
        question:
          "Why is the revelation of Magwitch as Pip's benefactor the novel's most important structural twist?",
        options: [
        ...
        correct: 1,
        explanation:
          "The Magwitch revelation is devastating because it demolishes Pip's entire self-narrative. His gentlemanly status - which he believed came from the respectable Miss Havisham - actually derives from a convict. This forces Pip to confront his snobbery and begins his moral recovery.",
      },
      {
        ...
        correct: 1,
        explanation:
          'Joe\'s selfless nursing of Pip reverses the social dynamic - the "gentleman" is now dependent on the blacksmith. This structural parallel with Stage One, where Joe cared for the young Pip, marks Pip\'s moral recovery and return to authentic values.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        question:
          "How does Dickens's use of retrospective narration create dramatic irony in the novel?",
        options: [
        ...
        correct: 0,
        explanation:
          'Retrospective narration allows the older, wiser Pip to tell the story of his younger, more foolish self. This creates dramatic irony because the narrator can signal connections and moral failings that the younger Pip did not recognise at the time.',
      },
      {
        id: 'igcse-classic-ge-m3-q2',
        question:
          "Why is the revelation that Estella is Magwitch's daughter structurally and thematically significant?",
        options: [
        ...
        correct: 2,
        explanation:
          "The revelation creates powerful irony: Estella, whom Pip worships as the embodiment of refined gentility, is the daughter of the convict whose money funds Pip's own gentlemanly status. This demolishes the artificial class distinctions that have driven Pip's aspirations.",
      },
      {
        ...
        correct: 1,
        explanation:
          'Wemmick\'s split between his cold office persona and his warm domestic self at the "Castle" critiques the Victorian tendency to separate public from private morality. Dickens uses this duality to expose how institutional life could suppress genuine human compassion.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        question:
          "What is Dickens's central argument about class and social ambition in the novel?",
        options: [
        ...
        correct: 2,
        explanation:
          'Dickens does not simply invert the class hierarchy. He argues that moral worth is independent of social status, and that the pursuit of gentility becomes destructive when it replaces genuine human values - compassion, loyalty, and integrity - with superficial markers of class.',
      },
      {
        ...
        correct: 1,
        explanation:
          "Pip's persistent guilt serves a dual function: it prevents him from fully embracing his snobbish lifestyle, acting as an uncomfortable reminder of his moral failings, but it also preserves his capacity for moral growth - ultimately driving his journey toward redemption.",
      },
      {
        ...
        correct: 1,
        explanation:
          "Dickens systematically blurs the line between criminal and respectable: Pip's gentility is funded by Magwitch, Jaggers inhabits both worlds, Compeyson's genteel appearance earns him lenience, and Miss Havisham's outward respectability masks her moral corruption. This challenges simplistic Victorian distinctions.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "Satis House is the novel's most sustained Gothic image. Its stopped clocks symbolise arrested time, its decay mirrors Miss Havisham's psychological damage, and her spectral presence in her rotting wedding dress embodies the destructive power of unresolved trauma.",
      },
      {
        ...
        correct: 1,
        explanation:
          "Hands function as a recurring symbol throughout the novel. Pip's \"coarse hands\" embody his class shame; Joe's strong hands represent honest labour; Estella's cold hands reflect her emotional training; Jaggers's hand-washing suggests moral contamination. The motif connects class, guilt, and character.",
      },
      {
        id: 'igcse-classic-ge-m5-q3',
        question:
          'How does the double voice of first-person retrospective narration function in the novel?',
        options: [
        ...
        correct: 1,
        explanation:
          "The retrospective narration creates a double voice: we experience events through the younger Pip's emotions while the older narrator's tone signals regret and self-awareness. This allows Dickens to make us sympathise with Pip while also recognising his moral failings.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        question:
          'Why is it important to use the "language of construction" when writing about characters?',
        options: [
        ...
        correct: 1,
        explanation:
          'Using the language of construction - "Dickens presents," "Dickens uses," "Dickens constructs" - demonstrates awareness that characters are created by a writer to serve thematic purposes. This keeps your focus on the writer\'s craft (AO2) rather than on plot retelling.',
      },
      {
        ...
        correct: 1,
        explanation:
          'The "coarse hands" passage is rich for analysis because the adjectives "coarse" and "common" reveal Pip\'s internalisation of class-based judgment. These words belong to social evaluation, not personal experience, showing how external class prejudice has been absorbed into Pip\'s self-image.',
      },
      {
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "Hawthorne was haunted by his family's participation in Puritan persecution, including the Salem witch trials. The Scarlet Letter is partly his reckoning with this legacy, examining how moral authoritarianism can produce cruelty and hypocrisy.",
      },
      {
        ...
        correct: 0,
        explanation:
          'The doctrine of predestination created intense anxiety about spiritual status, driving the Puritans to monitor both behaviour and inner lives obsessively. The scarlet letter itself - making invisible sin visible - is a direct expression of this impulse to expose and control.',
      },
      {
        ...
        correct: 2,
        explanation:
          "Hawthorne's ambivalence toward Puritanism is central to the novel's moral complexity. He respects the Puritans' seriousness of purpose but condemns their rigid intolerance, and this dual perspective creates the nuanced moral world of the novel.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The three scaffold scenes create a deliberate structural architecture: the first establishes concealment versus exposure, the second shows Dimmesdale's failed midnight confession, and the third resolves the tension through genuine public confession. This symmetry charts his moral journey.",
      },
      {
        ...
        correct: 0,
        explanation:
          'Hawthorne structures the novel around a tension between public spaces (scaffold, marketplace, church) where community authority operates, and private spaces (forest, cottage) where authentic feeling can be expressed. The forest scene, where Hester removes her letter, is the key private moment.',
      },
      {
        ...
        correct: 1,
        explanation:
          "Hawthorne skips over long periods while rendering scaffold scenes, the forest meeting, and the final procession in intense, slow-motion detail. This uneven compression focuses the reader's attention on the moments of greatest psychological and moral significance.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Hester\'s beautiful embroidery of the letter transforms a mark of shame into a work of art, implicitly asserting her creative identity against the community\'s attempt to define her. Over time, her charitable deeds lead some to reinterpret the "A" as "Able" - a quiet moral revolution.',
      },
      {
        id: 'igcse-classic-sl-m3-q2',
        question:
          "Why does Hawthorne present Chillingworth's revenge as worse than the original sin of adultery?",
        options: [
        ...
        correct: 1,
        explanation:
          "Hawthorne distinguishes between sins of passion (Hester and Dimmesdale's adultery) and sins of cold calculation (Chillingworth's revenge). The deliberate, sustained nature of Chillingworth's torment - and his physical transformation into something monstrous - marks revenge as the novel's most destructive sin.",
      },
      {
        ...
        correct: 1,
        explanation:
          'Pearl acts as a moral mirror by persistently drawing attention to the scarlet letter, demanding that Dimmesdale acknowledge her publicly, and refusing to let Hester remove the letter in the forest. She is the living embodiment of truth that cannot be suppressed or denied.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        question:
          'What does Hawthorne suggest about the relative destructiveness of concealed versus public sin?',
        options: [
        ...
        correct: 1,
        explanation:
          'Hawthorne demonstrates that concealed sin is more destructive than public transgression. Hester, who bears her shame openly, grows in strength and moral stature. Dimmesdale, who hides his sin, deteriorates physically and psychologically. Truth, however painful, is necessary for moral health.',
      },
      {
        ...
        correct: 2,
        explanation:
          'Hawthorne contrasts the judgmental Puritan settlement with the free, amoral forest where Hester can remove her letter and speak honestly. However, he does not simply endorse nature over society - characters must return to the community, and both realms have moral implications.',
      },
      {
        ...
        correct: 1,
        explanation:
          "The scarlet letter's shifting meaning - from a mark of shame to a sign of ability - demonstrates Hawthorne's argument that while society attempts to fix identity through labels, the individual retains the power to redefine those labels through sustained moral action.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The letter\'s shifting meaning - from "Adulteress" to "Able" to possibly "Angel" - is central to Hawthorne\'s argument that symbols are interpreted differently by different observers and that moral judgment is complex and unstable. This instability is a deliberate artistic choice, not a flaw.',
      },
      {
        ...
        correct: 1,
        explanation:
          "Hawthorne's narrator is deliberately evasive, offering multiple possible readings of events rather than providing definitive interpretations. This technique creates interpretive ambiguity that mirrors the novel's argument about the impossibility of fixed moral judgment.",
      },
      {
        ...
        correct: 1,
        explanation:
          'Hawthorne deliberately chooses names that reinforce characterisation: Dimmesdale\'s "dim" suggests concealment; Chillingworth\'s "chilling" suggests coldness and emotional frigidity; Pearl is the precious thing obtained at great cost. These symbolic names add layers of meaning to the characters.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        question:
          "Why is it important to acknowledge Hawthorne's moral ambiguity in exam responses?",
        options: [
        ...
        correct: 1,
        explanation:
          "Hawthorne's deliberate moral ambiguity is a defining feature of the novel. Engaging with this complexity - showing that the novel resists simple interpretation - demonstrates the kind of literary maturity and analytical sophistication that examiners reward with the highest marks.",
      },
      {
        ...
        correct: 1,
        explanation:
          'The model response zooms in on the word "illuminated" to argue that Hawthorne subverts the community\'s intention - the letter that should diminish Hester actually suggests radiance and elevation. This kind of word-level analysis is precisely what examiners reward.',
      },
      {
        id: 'igcse-classic-sl-m6-q3',
        question:
          'What structural feature does the model plan use to frame its argument about guilt?',
        options: [
        ...
        correct: 1,
        explanation:
          'The plan uses the three scaffold scenes as a structural framework, showing how they chart a progression from externally imposed shame (first scaffold) through failed private confession (midnight scaffold) to genuine public acknowledgment (final scaffold). This demonstrates strong structural awareness.',
      },
    ],
  },
]
