    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The exam tests your ability to analyse the writer's craft - how and why they made specific choices - not your ability to retell the story. Analysis of method and effect is central to achieving high marks.",
      },
      {
        id: 'iglit-dp-m1-q2',
        question:
          'Which two Assessment Objectives carry the most weight across the IGCSE Literature paper?',
        options: ['AO3 and AO4', 'AO1 and AO3', 'AO1 and AO2', 'AO2 and AO4'],
        correct: 2,
        explanation:
          'AO1 (personal response with textual references) and AO2 (analysis of language, form and structure) are the most heavily weighted objectives. These should be the primary focus of your revision and essay writing.',
      },
      {
        id: 'iglit-dp-m1-q3',
        ...
        correct: 2,
        explanation:
          'Versatile quotations connect to multiple themes and characters, meaning you can deploy them effectively no matter what question appears on the exam. Short, language-rich, multi-theme quotations are the most valuable to memorise.',
      },
      {
        id: 'iglit-dp-m1-q4',
        ...
        correct: 1,
        explanation:
          'A conceptualised argument is an overarching interpretation that threads through your whole essay, giving it coherence and direction. It goes beyond listing points to present a unified, critical reading of the text.',
      },
      {
        id: 'iglit-dp-m1-q5',
        ...
        correct: 1,
        explanation:
          "Simply identifying a metaphor or simile without analysing what it means and why the writer chose it demonstrates recognition, not analysis. Marks are awarded for explaining the effect and significance of the writer's choices.",
      },
    ],
  },
    ...
    quiz: [
      {
        id: 'iglit-dp-m2-q2',
        question:
          'Why should you avoid working through an extract line by line from top to bottom?',
        options: [
        ...
        correct: 1,
        explanation:
          'A line-by-line approach produces a commentary rather than a structured argument. The strongest responses select the most significant moments and organise them around a conceptualised thesis.',
      },
      {
        id: 'iglit-dp-m2-q3',
        ...
        correct: 2,
        explanation:
          'The best responses weave naturally between the extract and wider text using connective phrases. The transition should feel organic, not like two separate essays joined together.',
      },
      {
        id: 'iglit-dp-m2-q4',
        ...
        correct: 1,
        explanation:
          'A strong opening responds directly to the question, establishes your overarching interpretation (conceptualised argument), and briefly situates where the extract falls in the text and why this matters.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          "A foil is a character who contrasts with another character in order to highlight specific qualities. For example, Banquo serves as a foil to Macbeth - their contrasting responses to the prophecy highlight Macbeth's moral weakness.",
      },
      {
        id: 'iglit-dp-m3-q3',
        ...
        correct: 1,
        explanation:
          'Referring to the writer by name (e.g., "Shakespeare presents...") keeps your analysis focused on authorial intent and craft. It signals to the examiner that you understand characters are deliberate constructs, not real people.',
      },
      {
        id: 'iglit-dp-m3-q4',
        ...
        correct: 1,
        explanation:
          "The strongest response names the writer, identifies a specific technique (metaphor), quotes precisely, and explains the effect. It analyses the writer's craft rather than simply describing what happens.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          'A motif is a recurring image, symbol, or idea that appears throughout a text and helps develop its themes. Blood in Macbeth and the telephone in An Inspector Calls are examples of motifs.',
      },
      {
        id: 'iglit-dp-m4-q3',
        ...
        correct: 1,
        explanation:
          'Connecting themes shows that you understand the text as a complex, interconnected whole rather than a collection of separate ideas. This level of conceptualised thinking is characteristic of top-band responses.',
      },
      {
        id: 'iglit-dp-m4-q4',
        ...
        correct: 1,
        explanation:
          'Organising chronologically - from introduction through development, climax, and resolution - naturally demonstrates your knowledge of the whole text and shows how the writer develops the theme over time.',
      },
      {
        id: 'iglit-dp-m4-q5',
        ...
        correct: 1,
        explanation:
          'The best thematic quotations contain language - imagery, metaphors, powerful verbs - that directly embodies the theme. This gives you rich material for close analysis of how the writer communicates their message.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The gap between the 1912 setting and the 1945 writing date creates dramatic irony. The audience knows Birling's predictions are wrong, which undermines his authority and reinforces Priestley's message about the need for social change.",
      },
      {
        id: 'iglit-dp-m5-q3',
        question:
          'Which strategy starts with the text and brings in context to explain audience reaction?',
        options: [
        ...
        correct: 1,
        explanation:
          'The "Audience Response" frame explains how a contemporary audience would have responded to a textual moment and why, using context to illuminate the significance of the writer\'s choices.',
      },
      {
        id: 'iglit-dp-m5-q4',
        ...
        correct: 1,
        explanation:
          'Quality over quantity is the rule for AO3. You need 2-3 contextual references per essay, but each must be well integrated into your analysis, not bolted on as disconnected historical facts.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "Denotation is a word's literal, dictionary meaning. Connotation is the web of associations, feelings, and ideas the word carries beyond its literal meaning. Strong close reading explores both layers.",
      },
      {
        id: 'iglit-dp-m6-q2',
        question:
        ...
        correct: 1,
        explanation:
          "The serpent alludes to the serpent in the Garden of Eden, connecting Macbeth's planned regicide to the original sin - the first act of disobedience against divine authority. A Jacobean audience would have recognised this link immediately.",
      },
      {
        id: 'iglit-dp-m6-q3',
        ...
        correct: 2,
        explanation:
          'Verbs convey action and energy, so they reveal how something happens, not just what happens. This makes them rich for analysis - a verb choice can communicate force, gentleness, hesitation, violence, and much more.',
      },
      {
        id: 'iglit-dp-m6-q4',
        question:
          'What is the problem with writing "Shakespeare uses alliteration to make it stand out"?',
        options: [
        ...
        correct: 1,
        explanation:
          'This is feature-spotting with a vague explanation. Identifying a technique without analysing its specific effect on meaning earns minimal marks. You must explain what the alliteration achieves in terms of sound, mood, or meaning.',
      },
      {
        id: 'iglit-dp-m6-q5',
        ...
        correct: 1,
        explanation:
          "A soliloquy is when a character speaks alone on stage, revealing their private thoughts directly to the audience. It is significant for close reading because the playwright deliberately chose this moment to give the audience privileged access to the character's inner world.",
      },
    ],
  },
    ...
    quiz: [
      {
        id: 'iglit-dp-m7-q1',
        question:
          "Why does Shakespeare use prose rather than verse for Lady Macbeth's sleepwalking scene?",
        options: [
        ...
        correct: 1,
        explanation:
          "Shakespeare typically uses verse for noble characters and prose for lower-status characters or those in disordered mental states. Lady Macbeth's shift to prose in the sleepwalking scene reflects her psychological breakdown.",
      },
      {
        id: 'iglit-dp-m7-q2',
        ...
        correct: 1,
        explanation:
          'Both Macbeth and Banquo hear the witches\' prophecy, but Banquo warns against trusting "the instruments of darkness" while Macbeth is seduced. Banquo\'s integrity highlights that Macbeth could have chosen differently.',
      },
      {
        id: 'iglit-dp-m7-q3',
        question:
          'What is the significance of Lady Macbeth\'s line "A little water clears us of this deed" in relation to the wider play?',
        options: [
        ...
        correct: 1,
        explanation:
          "Lady Macbeth's confident dismissal creates dramatic irony with her Act 5 sleepwalking scene, where she compulsively tries to wash imaginary blood from her hands. Her earlier pragmatism fatally underestimated the power of guilt.",
      },
      {
        id: 'iglit-dp-m7-q4',
        question:
          'What does "Vaulting ambition, which o\'erleaps itself" suggest about Macbeth\'s motivation?',
        options: [
        ...
        correct: 1,
        explanation:
          'Macbeth admits ambition is his sole motivation ("no spur... but only vaulting ambition"). The image of ambition that "o\'erleaps itself" suggests an uncontrollable force that exceeds its bounds and collapses - foreshadowing his inevitable destruction.',
      },
      {
        id: 'iglit-dp-m7-q5',
        ...
        correct: 1,
        explanation:
          "The banquet scene is a turning point because Macbeth's private guilt becomes publicly visible. Banquo's ghost - seen only by Macbeth - causes him to break down in front of his guests, marking the beginning of his public unravelling.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The gap between the 1912 setting and 1945 writing date creates massive dramatic irony. The audience knows Birling's predictions about war and the Titanic are wrong, which undermines his authority and discredits the capitalist worldview he represents.",
      },
      {
        id: 'iglit-dp-m8-q2',
        ...
        correct: 1,
        explanation:
          "Inspector Goole functions as Priestley's dramatic device - simultaneously detective, moral judge, and prophetic voice. His purpose is to expose the Birlings' complicity and articulate the socialist message of collective responsibility.",
      },
      {
        id: 'iglit-dp-m8-q3',
        ...
        correct: 0,
        explanation:
          "Sheila's arc is the most dramatic transformation in the play. She begins as a shallow, privileged young woman but ends as a moral force who accepts responsibility, shows genuine remorse, and challenges her parents' refusal to learn.",
      },
      {
        id: 'iglit-dp-m8-q4',
        ...
        correct: 1,
        explanation:
          'The final phone call announces a real inspector is on the way, creating a cyclical structure. It suggests that the Birlings - and by extension, society - cannot escape the consequences of inequality and moral neglect, regardless of whether the first Inspector was "real".',
      },
      {
        id: 'iglit-dp-m8-q5',
        ...
        correct: 1,
        explanation:
          "Priestley uses dramatic irony to make Birling's confident predictions about war and the Titanic spectacularly wrong. By discrediting Birling so thoroughly, Priestley undermines the capitalist, individualist philosophy Birling represents.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          'Five minutes of planning is the optimal balance. It is enough time to decode the question, formulate a thesis, select 4-5 points with quotations, and check AO coverage - without eating into your writing time.',
      },
      {
        id: 'iglit-dp-m9-q2',
        ...
        correct: 1,
        explanation:
          'PEACE stands for Point (topic sentence), Evidence (quotation), Analysis (close reading of language/structure), Context (historical/social connections), and Effect/Evaluation (impact on reader, link to thesis).',
      },
      {
        id: 'iglit-dp-m9-q3',
        ...
        correct: 2,
        explanation:
          "A conclusion should never introduce new evidence or new points. It should synthesise the argument you have already made, return to your thesis, and offer a final evaluative comment on the writer's purpose or the text's significance.",
      },
      {
        id: 'iglit-dp-m9-q4',
        ...
        correct: 1,
        explanation:
          'While plans are not formally marked, examiners may read your plan if your essay is incomplete. A strong plan can demonstrate understanding and the direction of your argument even if you ran out of time to write it all up.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The most important hallmark of a top-band response is a conceptualised argument - a central thesis stated in the introduction and developed through every paragraph. This gives the essay coherence, direction, and analytical depth.',
      },
      {
        id: 'iglit-dp-m10-q2',
        ...
        correct: 1,
        explanation:
          'The "So What?" test means asking, after every analytical point, why it matters. If you cannot explain the significance of your point for the reader, the text, or the writer\'s purpose, your analysis is incomplete.',
      },
      {
        id: 'iglit-dp-m10-q3',
        ...
        correct: 2,
        explanation:
          'At the 40-minute mark in a 45-minute essay, you should begin your conclusion. This leaves enough time to write a purposeful concluding paragraph and still have 2-3 minutes for proofreading.',
      },
      {
        id: 'iglit-dp-m10-q4',
        ...
        correct: 1,
        explanation:
          'A strong essay with five solid paragraphs always outscores one with a brilliant first paragraph and three rushed ones. Allocating time evenly ensures consistent quality throughout the entire response.',
      },
      {
        id: 'iglit-dp-m10-q5',
        question:
          'What distinguishes top-band responses from mid-range ones, according to examiners?',
        options: [
        ...
        correct: 1,
        explanation:
          "Examiners consistently identify a genuine personal voice, a clear conceptualised argument, and consistent focus on the writer's methods as the features that distinguish top-band responses from mid-range ones.",
      },
    ],
  },
]
...
const dramaProseAssessment: CourseQuiz[] = [
  {
    ...
    options: [
      ...
      'Using accurate spelling and grammar',
    ],
    correct: 1,
    explanation:
      'AO2 focuses on analysing the language, form and structure used by a writer to create meanings and effects, using relevant subject terminology where appropriate.',
  },
  {
    id: 'iglit-dp-a2',
    question: 'What does it mean to treat a character as a "construct"?',
    options: [
      'To describe them as a real person',
      'To focus on their physical appearance',
      'To recognise they are deliberately created by the writer for specific purposes',
      'To compare them with real historical figures',
    ],
    correct: 2,
    explanation:
      'Treating a character as a construct means understanding that the writer deliberately created them to serve artistic purposes - embodying themes, creating tension, representing ideas.',
  },
  {
    id: 'iglit-dp-a3',
    question: 'In Macbeth, what does the metaphor "full of scorpions is my mind" convey?',
    options: [
      "Macbeth's physical illness",
      'The venomous, corrosive nature of his guilt and psychological torment',
      'His fear of insects',
      'His anger at the witches',
    ],
    correct: 1,
    explanation:
      "The scorpion metaphor conveys Macbeth's guilt as something venomous and self-destructive - his thoughts actively poison him from within, creating visceral imagery of psychological torment.",
  },
  {
    id: 'iglit-dp-a4',
    question:
      "Why is Priestley's choice to set An Inspector Calls in 1912 while writing in 1945 significant?",
    options: [
      'It was the only period he knew about',
      "It creates dramatic irony as the audience knows the characters' predictions are wrong",
      'It makes the play more historically accurate',
      'It was required by the theatre company',
    ],
    correct: 1,
    explanation:
      "The dual time-frame creates dramatic irony. The 1945 audience knows Birling's predictions about war and the Titanic are wrong, which discredits his worldview and strengthens Priestley's socialist message.",
  },
  {
    id: 'iglit-dp-a5',
    question: 'What is "bolted-on" context and why should it be avoided?',
    options: [
      'Context placed in the conclusion',
      "Historical facts presented in isolation without connection to the text's meaning",
      'Using too much context in one essay',
      "Referring to the writer's biography",
    ],
    correct: 1,
    explanation:
      'Bolted-on context is a disconnected historical statement that does not connect to the text or its meaning. It reads as a history lesson rather than literary analysis and scores poorly for AO3.',
  },
  {
    id: 'iglit-dp-a6',
    question: 'How does Banquo function in relation to Macbeth?',
    options: [
      'As his loyal supporter throughout',
      "As a foil - both hear the prophecy but Banquo resists temptation, highlighting Macbeth's moral failure",
      'As the main antagonist',
      'As a comic relief character',
    ],
    correct: 1,
    explanation:
      "Banquo is Macbeth's foil. Both hear the witches' prophecy, but Banquo resists temptation while Macbeth succumbs. This contrast shows that a different moral choice was always available to Macbeth.",
  },
  {
    id: 'iglit-dp-a7',
    ...
    options: [
      ...
      'An overarching thesis that unifies the entire essay',
      'A list of literary devices',
      'A description of the historical context',
    ],
    correct: 1,
    explanation:
      'A conceptualised argument is an overarching thesis or interpretation that threads through the whole essay, giving it coherence and direction. It goes beyond listing points to present a unified critical reading.',
  },
  {
    id: 'iglit-dp-a8',
    question: "What is the significance of Lady Macbeth's sleepwalking scene (Act 5, Scene 1)?",
    options: [
      'It shows she is physically ill',
      'It reveals the complete reversal of her earlier confidence, proving guilt is inescapable',
      'It is comic relief before the final battle',
      'It shows she is planning another murder',
    ],
    correct: 1,
    explanation:
      'The sleepwalking scene is a devastating reversal. The woman who dismissed guilt with "a little water clears us of this deed" is now compulsively trying to wash imaginary blood from her hands, proving guilt cannot be suppressed.',
  },
  {
    id: 'iglit-dp-a9',
    question: 'Who does Inspector Goole function as in An Inspector Calls?',
    options: [
      'A real police detective',
      "Priestley's mouthpiece - voicing the socialist message of collective responsibility",
      'A family friend testing the Birlings',
      "Eva Smith's father",
    ],
    correct: 1,
    explanation:
      "Inspector Goole is Priestley's mouthpiece, voicing the playwright's socialist message about collective responsibility. His function is more important than his identity - he is a dramatic device for moral reckoning.",
  },
  {
    id: 'iglit-dp-a10',
    question: 'What is the difference between denotation and connotation in close reading?',
    options: [
      'Denotation is for poetry, connotation for prose',
      'Denotation is the literal meaning; connotation is the associations and feelings a word carries',
      'They are the same thing',
      "Denotation is the writer's meaning; connotation is the reader's",
    ],
    correct: 1,
    explanation:
      "Denotation is a word's literal, dictionary meaning. Connotation is the web of associations, feelings, and ideas it carries beyond its literal meaning. Strong analysis explores both layers.",
  },
  {
    id: 'iglit-dp-a11',
    ...
    options: [
      'The play is over',
      'A cyclical structure suggesting consequences cannot be escaped',
      'The Inspector is returning for his hat',
      'Mr Birling has been arrested',
    ],
    correct: 1,
    explanation:
      "The final phone call creates a cyclical structure, announcing that a real inspector is coming. It suggests the Birlings - and society - cannot escape accountability, reinforcing Priestley's warning.",
  },
  {
    id: 'iglit-dp-a12',
    question: 'In the context of Macbeth, what is the "Great Chain of Being"?',
    options: [
      'A physical chain used in the play',
      'A Jacobean belief in a divinely ordained hierarchy where disrupting the order causes chaos',
      'A metaphor for friendship between characters',
      'A trade route mentioned in the play',
    ],
    correct: 1,
    explanation:
      'The Great Chain of Being was a Jacobean belief that all creation existed in a fixed, divinely ordained hierarchy. Disrupting this order - through regicide, for example - was thought to cause chaos in nature itself.',
  },
  {
    id: 'iglit-dp-a13',
    ...
    options: [
      ...
      'She goes from superficial privilege to genuine moral awareness, accepting responsibility and challenging her parents',
      'She leaves the house at the end',
      'She becomes friends with the Inspector',
    ],
    correct: 1,
    explanation:
      "Sheila transforms from a complacent, materialistic young woman into a moral voice who accepts responsibility, shows genuine remorse, and challenges her parents' refusal to learn. She embodies Priestley's hope.",
  },
  {
    id: 'iglit-dp-a14',
    question: 'What is "feature-spotting" and why is it problematic?',
    options: [
      'Identifying too many themes in one essay',
      'Naming a literary device without explaining its effect on meaning',
      'Spotting errors in the text',
      'Identifying contextual features',
    ],
    correct: 1,
    explanation:
      'Feature-spotting is identifying a literary device (e.g., "this is a metaphor") without analysing its meaning or effect. It demonstrates recognition but not analysis, and earns minimal marks.',
  },
  {
    id: 'iglit-dp-a15',
    question: 'What should the opening paragraph of a Literature essay achieve?',
    options: [
      'Summarise the entire plot',
      'Respond to the question, state a thesis, and establish the direction of the argument',
      'List all themes in the text',
      'Provide a biography of the writer',
    ],
    correct: 1,
    explanation:
      'The opening paragraph should respond directly to the question, state your conceptualised thesis, and establish the direction of your argument. Avoid generic introductions or plot summaries.',
  },
  {
    id: 'iglit-dp-a16',
    question: 'What is a motif?',
    options: [
      'The main character of a text',
      'A recurring image, symbol, or idea that contributes to themes',
      'A type of poem',
      'The moral of the story',
    ],
    correct: 1,
    explanation:
      'A motif is a recurring image, symbol, or idea that appears throughout a text and contributes to its themes. Examples include blood in Macbeth and the telephone in An Inspector Calls.',
  },
  {
    id: 'iglit-dp-a17',
    question:
      'Why does Shakespeare begin Macbeth with the witches rather than with Macbeth himself?',
    options: [
      'Because the witches are the main characters',
      'To immediately establish an atmosphere of moral inversion and supernatural unease',
      'Because it was a convention to start plays with minor characters',
      'Because the actor playing Macbeth was not ready',
    ],
    correct: 1,
    explanation:
      'Opening with the witches immediately establishes the play\'s atmosphere of moral inversion ("fair is foul, and foul is fair") and supernatural unease, signalling that normal moral categories will be unreliable.',
  },
  {
    id: 'iglit-dp-a18',
    question:
      'How should you balance extract analysis and wider text discussion in an extract-based essay?',
    options: [
      'Focus entirely on the extract',
      'Aim for roughly 60% extract and 40% wider text, weaving between the two',
      'Write about the wider text first, then the extract',
      'Ignore the extract and write about the whole text',
    ],
    correct: 1,
    explanation:
      'Aim for roughly 60% extract analysis and 40% wider text discussion, but weave between the two rather than treating them as separate halves. This balance ensures close analysis while demonstrating whole-text knowledge.',
  },
  {
    id: 'iglit-dp-a19',
    ...
    options: [
      'The working class',
      'Capitalist self-interest and moral blindness of the privileged class',
      'The voice of reason',
      "Priestley's own political views",
    ],
    correct: 1,
    explanation:
      'Mr Birling represents capitalist self-interest and the moral blindness of the privileged class. Priestley discredits his worldview through dramatic irony, making his confident predictions spectacularly wrong.',
  },
  {
    id: 'iglit-dp-a20',
    question: 'What is the "So What?" test in essay writing?',
    options: [
      'A way of checking if your essay is long enough',
      "Asking why your analytical point matters - what its significance is for the reader, text, or writer's purpose",
      'A way of choosing which quotation to use',
      'A test the examiner applies to your conclusion',
    ],
    correct: 1,
    explanation:
      'The "So What?" test means asking, after every analytical point, why it matters. If you cannot explain the significance of your point, your analysis is incomplete and needs a sentence explaining its importance.',
  },
]
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Poets create meaning through language (word choices and imagery), form (the overall type and shape of the poem), and structure (the internal organisation and progression of ideas). All three must be discussed in strong responses.',
      },
      {
        id: 'iglit-po-m1-q2',
        ...
        correct: 1,
        explanation:
          'Form refers to the overall type and shape of a poem (e.g., sonnet, ballad, free verse). Structure refers to the internal organisation - how ideas are sequenced, where shifts occur, how stanzas relate to each other.',
      },
      {
        id: 'iglit-po-m1-q3',
        ...
        correct: 2,
        explanation:
          'A volta is a turn or shift in a poem - a change in argument, mood, or perspective. Sonnets typically feature a volta, but the term can apply to any poem where a significant shift occurs.',
      },
      {
        id: 'iglit-po-m1-q4',
        ...
        correct: 1,
        explanation:
          'Line-by-line paraphrasing produces summary, not analysis. The exam tests your ability to explain how the poet uses language, form, and structure to create meaning - not your ability to retell what the poem says.',
      },
      {
        id: 'iglit-po-m1-q5',
        ...
        correct: 1,
        explanation:
          'Enjambment occurs when a sentence or phrase runs over from one line to the next without end-stopping punctuation. It creates momentum, can generate surprise, and often emphasises the word at the start of the next line.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'A Petrarchan sonnet has an octave (8 lines) and sestet (6 lines) with the volta typically between them. A Shakespearean sonnet has three quatrains (4 lines each) and a concluding couplet, with the volta before the couplet.',
      },
      {
        id: 'iglit-po-m2-q2',
        question:
          'Why is identifying a form without explaining its effect considered "feature-spotting"?',
        options: [
        ...
        correct: 1,
        explanation:
          'Simply identifying "this is a sonnet" is feature-spotting because it demonstrates recognition without analysis. You must explain why the poet chose this form and how it contributes to the poem\'s meaning and effect.',
      },
      {
        id: 'iglit-po-m2-q3',
        ...
        correct: 1,
        explanation:
          "Caesura creates a pause within a line of poetry, usually through punctuation. This can produce emphasis on surrounding words, interrupt the rhythm to create a sense of disruption, or signal a shift in the speaker's thought.",
      },
      {
        id: 'iglit-po-m2-q4',
        question:
          'What might a poet communicate by choosing free verse rather than a traditional form?',
        options: [
        ...
        correct: 1,
        explanation:
          "Choosing free verse is a deliberate rejection of traditional formal constraints. This can mirror themes of freedom, rebellion, individuality, or disorder within the poem's content. Free verse is not formless - it creates its own form.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'A metaphor makes a direct comparison by stating one thing IS another ("life\'s but a walking shadow"). A simile uses "like" or "as" to compare, making the comparison more tentative ("my love is like a red, red rose").',
      },
      {
        id: 'iglit-po-m3-q2',
        ...
        correct: 1,
        explanation:
          'Considering alternatives shows you understand that the poet\'s word choice is deliberate and purposeful. By explaining why "devour" is more effective than "erode" or "diminish", you demonstrate genuine engagement with the writer\'s craft.',
      },
      {
        id: 'iglit-po-m3-q3',
        ...
        correct: 1,
        explanation:
          'Pathetic fallacy is when the natural environment mirrors emotions or mood - storms accompanying turmoil, sunshine accompanying joy. It connects human experience to the natural world and can suggest cosmic significance.',
      },
      {
        id: 'iglit-po-m3-q4',
        ...
        correct: 1,
        explanation:
          'Sibilance (repetition of "s" sounds) creates a hissing effect. Depending on context, this can suggest menace or secrecy (a sinister whisper) or calm and soothing intimacy (soft, gentle sounds).',
      },
      {
        id: 'iglit-po-m3-q5',
        ...
        correct: 1,
        explanation:
          'An extended metaphor is a metaphor that is sustained and developed over several lines or even an entire poem. Multiple aspects of the comparison are explored, creating a rich, layered meaning. It is also called a conceit.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The integrated approach organises each paragraph around a specific aspect (theme, technique, structure) and discusses both poems within that paragraph. This produces genuine comparison rather than two separate analyses.',
      },
      {
        id: 'iglit-po-m4-q2',
        ...
        correct: 1,
        explanation:
          'Aim for 4-5 short quotations per poem that are rich in language, thematically versatile, and from different parts of the poem (opening, middle, end). Quality and analysability matter more than quantity.',
      },
      {
        id: 'iglit-po-m4-q3',
        ...
        correct: 1,
        explanation:
          'The best comparisons explore poems that share a theme but approach it through different methods - contrasting forms, opposing tones, or different perspectives. This creates rich material for discussing similarities AND differences.',
      },
      {
        id: 'iglit-po-m4-q4',
        question:
          'Why is "active recall" more effective than re-reading for memorising quotations?',
        options: [
        ...
        correct: 1,
        explanation:
          'Active recall - testing yourself by trying to remember quotations before checking - strengthens memory far more effectively than passive re-reading. The effort of retrieval is what builds strong, lasting memories.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "Strong comparisons go beyond identifying shared themes to analyse how the poets' methods - imagery, form, structure, tone - differ in their treatment of those themes. Method comparison is where the sophisticated analysis lies.",
      },
      {
        id: 'iglit-po-m5-q2',
        question:
          'Why should you organise a comparison essay by "point of comparison" rather than by poem?',
        options: [
        ...
        correct: 1,
        explanation:
          'Organising by point of comparison means both poems are discussed in every paragraph, producing genuine integration. The alternative - writing about Poem A then Poem B - tends to produce two separate analyses rather than a true comparison.',
      },
      {
        id: 'iglit-po-m5-q3',
        ...
        correct: 1,
        explanation:
          'A comparative thesis is an overarching argument about the relationship between two poems - how they connect and diverge in their treatment of a shared theme. It gives your comparison essay coherence and direction.',
      },
      {
        id: 'iglit-po-m5-q4',
        ...
        correct: 2,
        explanation:
          '"While Poet A uses... Poet B instead..." signals a contrast, showing that the poets take different approaches. Using a range of comparative connectives throughout your essay demonstrates sophisticated comparative thinking.',
      },
      {
        id: 'iglit-po-m5-q5',
        ...
        correct: 1,
        explanation:
          'Evaluative language ("more effectively", "achieves a greater sense of...") shows you are making critical judgements about the poets\' choices, not just listing differences. This demonstrates the sophisticated, personal critical voice that examiners reward.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Unseen poetry requires no memorisation, no contextual knowledge, and no prior study. The poem is right in front of you, and examiners reward any well-supported interpretation. It tests pure analytical skill.',
      },
      {
        id: 'iglit-po-m6-q2',
        ...
        correct: 1,
        explanation:
          'Start with what you do understand, focus on concrete images and tone, and embrace ambiguity. Exploring multiple possible meanings ("This could suggest... or alternatively...") is actually a strength that examiners reward.',
      },
      {
        id: 'iglit-po-m6-q3',
        ...
        correct: 1,
        explanation:
          'Spend 3-5 minutes on your second read and annotation. This is enough time to identify key techniques, striking images, and structural features without eating into your writing time.',
      },
      {
        id: 'iglit-po-m6-q4',
        question:
          'Why should you refer to "the speaker" rather than "the poet" when analysing unseen poetry?',
        options: [
        ...
        correct: 1,
        explanation:
          'The speaker of a poem is not necessarily the poet themselves - many poems use a persona or character as the voice. Referring to "the speaker" avoids making biographical assumptions and keeps your analysis focused on the text.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          "The three angles strategy generates depth from a single quotation: (1) analyse a key word's connotations, (2) identify the technique and its effect, (3) connect to the poem's wider theme. This produces three analytical sentences efficiently.",
      },
      {
        id: 'iglit-po-m7-q2',
        ...
        correct: 1,
        explanation:
          "Marks are earned through analysis, not through introductions. A 2-4 sentence introduction that states your thesis and the poem's form is sufficient. Every additional sentence in the introduction is time you could spend on close reading.",
      },
      {
        id: 'iglit-po-m7-q3',
        ...
        correct: 1,
        explanation:
          'The "one more sentence" rule pushes you to add a sentence about effect, significance, or wider connection after every analytical point. This additional depth is often what distinguishes good analysis from excellent analysis.',
      },
      {
        id: 'iglit-po-m7-q4',
        ...
        correct: 1,
        explanation:
          "Combining AOs in fluid sentences is both efficient and impressive. For example: \"The metaphor 'iron curtain', evoking the Cold War's ideological divide [AO3], creates a sense of impenetrable separation [AO1] through its connotations of industrial permanence [AO2].\"",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'An effective opening responds directly to the question, identifies at least one technique and its effect, discusses form where relevant, and establishes the conceptualised thesis that the rest of the essay will develop.',
      },
      {
        id: 'iglit-po-m8-q2',
        ...
        correct: 1,
        explanation:
          'A strong comparative paragraph integrates discussion of both poems, compares methods rather than just content, uses comparative connectives, and includes evaluative judgement about relative effectiveness.',
      },
      {
        id: 'iglit-po-m8-q3',
        question:
          'If you struggle to explain the effects of techniques, what two questions should you ask?',
        options: [
        ...
        correct: 1,
        explanation:
          'Asking "What does this make the reader think, feel, or imagine?" generates the effect. Asking "Why might the poet want this?" generates the purpose. Together, these two questions produce the analytical depth that AO2 requires.',
      },
      {
        id: 'iglit-po-m8-q4',
        ...
        correct: 1,
        explanation:
          'Practising with challenging poems builds the resilience and analytical flexibility you need for unseen poetry, where the poem is unpredictable. If you only practise with comfortable poems, you will be underprepared for difficulty.',
      },
      {
        id: 'iglit-po-m8-q5',
        question:
          'According to this module, what is the single most effective revision activity for poetry?',
        options: [
        ...
        correct: 2,
        explanation:
          'Timed practice with unfamiliar poems is the single most effective revision activity. It builds speed, confidence, and analytical fluency simultaneously. There is no substitute for the experience of writing under real conditions.',
      },
    ],
  },
]
...
const poetryAssessment: CourseQuiz[] = [
  {
    ...
    correct: 1,
    explanation:
      'Poets create meaning through language (word choices, imagery), form (the overall type of poem), and structure (internal organisation). All three should be discussed in strong responses.',
  },
  {
    id: 'iglit-po-a2',
    question: 'What is "enjambment"?',
    options: [
      ...
      'The final line of a stanza',
    ],
    correct: 1,
    explanation:
      'Enjambment occurs when a sentence or phrase continues from one line to the next without end-stopping punctuation, creating momentum and often emphasising the word at the start of the new line.',
  },
  {
    id: 'iglit-po-a3',
    question: 'What is a "volta" in poetry?',
    ...
    correct: 1,
    explanation:
      "A volta is a turn or shift in a poem's argument, mood, or perspective. While traditionally associated with sonnets, the term can apply to any poem that contains a significant shift.",
  },
  {
    id: 'iglit-po-a4',
    question: 'What is the difference between a Petrarchan and Shakespearean sonnet structure?',
    options: [
      'Petrarchan has octave/sestet; Shakespearean has three quatrains and a couplet',
      'Petrarchan is 12 lines; Shakespearean is 14',
      'They are identical',
      'Petrarchan uses free verse; Shakespearean uses metre',
    ],
    correct: 0,
    explanation:
      'A Petrarchan sonnet has an octave (8 lines) and sestet (6 lines) with the volta between them. A Shakespearean sonnet has three quatrains (4 lines each) and a concluding couplet, with the volta before the couplet.',
  },
  {
    id: 'iglit-po-a5',
    question: 'What is "pathetic fallacy"?',
    options: [
      'A logical error in a poem',
      "When the natural environment reflects characters' emotions or the poem's mood",
      'A type of understatement',
      'When a poet admits they are wrong',
    ],
    correct: 1,
    explanation:
      'Pathetic fallacy is when the natural environment mirrors emotions or mood - storms for turmoil, sunshine for joy. It connects human experience to the natural world.',
  },
  {
    id: 'iglit-po-a6',
    question: 'What distinguishes a metaphor from a simile?',
    options: [
      'Metaphors are longer',
      'A metaphor states one thing IS another; a simile compares using "like" or "as"',
  ...
  },
  {
    id: 'iglit-po-a7',
    question:
      'Why is the "integrated" approach to comparison essays superior to the "block" approach?',
    options: [
      'It is shorter',
      'It produces genuine comparison by discussing both poems in every paragraph',
      'Examiners require it',
      'It uses fewer quotations',
    ],
    correct: 1,
    explanation:
      'The integrated approach - discussing both poems in every paragraph organised by theme or technique - produces genuine comparative analysis. The block method (Poem A then Poem B) tends to produce two separate analyses with only superficial comparison.',
  },
  {
    id: 'iglit-po-a8',
    ...
    options: [
      ...
      'Start with what you understand, focus on images and tone, and explore multiple interpretations',
      'Write about a different poem',
      'Ask the invigilator for help',
    ],
    correct: 1,
    explanation:
      'Start with accessible moments, focus on concrete images and tone, and embrace ambiguity by exploring multiple possible meanings. You do not need to understand everything to write a strong analytical response.',
  },
  {
    id: 'iglit-po-a9',
    question: 'What is an "extended metaphor"?',
    options: [
      'A very long simile',
      'A metaphor sustained over several lines or an entire poem',
      'A metaphor that is repeated in different poems',
      'A metaphor followed by an explanation',
    ],
    correct: 1,
    explanation:
      'An extended metaphor is a metaphor developed over several lines or even a whole poem, with multiple aspects of the comparison explored. It creates layered, complex meaning.',
  },
  {
    id: 'iglit-po-a10',
    ...
    options: [
      ...
      'Because the voice may be a persona, not the poet themselves',
      'Because examiners deduct marks for saying "the poet"',
      'Because all poems use fictional characters',
    ],
    correct: 1,
    explanation:
      'Many poems use a persona or character as the speaker, not the poet\'s own voice. Referring to "the speaker" avoids biographical assumptions and keeps analysis focused on the text itself.',
  },
  {
    id: 'iglit-po-a11',
    question: 'What is "sibilance" and what effect can it create?',
    options: [
      'Repetition of "b" sounds creating a booming effect',
      'Repetition of "s" sounds creating hissing, menace, or calm',
      'Repetition of vowel sounds creating musicality',
      'Words that sound like what they describe',
    ],
    correct: 1,
    explanation:
      'Sibilance is the repetition of "s" sounds. Depending on context, it can create a sinister hissing effect (suggesting menace or secrecy) or a soft, soothing quality (suggesting calm or intimacy).',
  },
  {
    id: 'iglit-po-a12',
    question: 'What does the "consider alternatives" technique involve?',
    options: [
      'Listing synonyms for every word',
      "Explaining why the poet's word choice is more effective than alternatives they could have used",
      'Comparing the poem with alternative poems',
      'Suggesting improvements to the poem',
    ],
    correct: 1,
    explanation:
      'The "consider alternatives" technique means explaining why the poet chose this specific word over alternatives. For example, "devour" instead of "erode" - the violence of "devour" makes time seem predatory, which "erode" would not achieve.',
  },
  {
    id: 'iglit-po-a13',
    question: 'How should quotations be selected for anthology poem revision?',
    options: [
      'Choose the longest quotations',
      'Choose short, language-rich, thematically versatile quotations from different parts of the poem',
      'Choose quotations from the first stanza only',
      'Choose quotations that describe the setting',
    ],
    correct: 1,
    explanation:
      'Select 4-5 short quotations per poem that are rich in analysable language, versatile across multiple themes, and from different parts of the poem (opening, middle, end) to demonstrate whole-poem knowledge.',
  },
  {
    id: 'iglit-po-a14',
    question: 'What is the "three angles" strategy?',
    options: [
      'Reading a poem from three perspectives',
      'Analysing a quotation at word level, technique level, and poem level',
      'Writing three drafts of your essay',
      'Comparing three poems simultaneously',
    ],
    correct: 1,
    explanation:
      'The "three angles" strategy generates analytical depth from a single quotation: (1) word-level connotations, (2) technique identification and effect, (3) connection to wider poem themes. This efficiently produces a well-developed paragraph.',
  },
  {
    id: 'iglit-po-a15',
    ...
    options: [
      ...
      'Timed practice with unfamiliar poems followed by self-assessment',
      'Memorising model answers',
      'Reading as many poems as possible without analysing them',
    ],
    correct: 1,
    explanation:
      'Timed practice with unfamiliar poems, followed by self-assessment against the Assessment Objectives, is the most effective revision activity. It builds speed, confidence, and analytical fluency simultaneously.',
  },
]
