...
const lesson1: LessonPlan = {
  ...
  keywords: [
    'dramatic irony', 'chorus', 'omniscient', 'prologue',
    'foreboding', 'Greek chorus', 'authorial voice', 'staging',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a definition card for dramatic irony with an everyday example (e.g., a horror film where the audience sees the danger but the character does not).',
      core: 'Students explain in their own words why dramatic irony increases tension rather than reducing it.',
      stretch: 'Students compare the prologue to a Greek tragedy and consider why Russell chose this classical structure for a working-class story.',
    },
    resources: ['Prologue extract displayed on board', 'Definition cards for support tier', 'Mini-whiteboards'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a word bank of effects (tension, foreboding, guilt, unease) and a partially completed first row.',
        core: 'Students complete all rows independently and write a summary sentence about the Narrator\'s overall purpose.',
        stretch: 'Students evaluate which role (narrator/judge/fate figure) is most important and justify their answer with textual evidence.',
      },
      resources: ['Narrator extracts handout', 'Role-tracking table worksheet', 'Word bank (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a paragraph frame with sentence starters: "Russell uses the Narrator to... This is shown when... The effect on the audience is..."',
        core: 'Students write two full PEE paragraphs independently and peer assess.',
        stretch: 'Students include a counter-argument: "However, an alternative interpretation is..." and consider how staging (the Narrator watching from the shadows) contributes to the effect.',
      },
      resources: ['PEE model paragraph on board', 'Paragraph frame (support tier)', 'Peer assessment checklist'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students argue why the ambiguity itself is more powerful than any single interpretation.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'What is dramatic irony and how does Russell use it in the prologue of Blood Brothers?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain the significance of the Narrator\'s recurring reference to "shoes upon the table".',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'How does the Narrator function differently from a traditional character in a play?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Do you think the Narrator represents fate, society, or something else? Explain your view with evidence.',
      lines: 6,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  keywords: [
    'poverty', 'maternal instinct', 'sacrifice', 'exploitation',
    'working class', 'authorial intention', 'pathos', 'monologue',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a simple agree/disagree card for students to hold up, then ask them to explain their choice verbally.',
      core: 'Students must give a reason for and against the decision before choosing a side.',
      stretch: 'Students consider how social class affects the range of options available to people and link to 1960s Liverpool context.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide guided annotation prompts beside each extract (e.g., "What does the word \'left\' suggest about how she sees herself?").',
        ...
        stretch: 'Students compare how Mrs Johnstone is presented in the early scenes versus the ending and analyse how Russell develops her character across the play.',
      },
      resources: ['Key extracts handout (x4)', 'Annotation guide (support tier)', 'Coloured pens for annotation'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a writing frame with sentence starters for each section (victim argument, responsibility argument, conclusion).',
        core: 'Students write a full balanced response with embedded quotations.',
        stretch: 'Students consider Russell\'s authorial intention — does he want the audience to blame Mrs Johnstone or the system that trapped her? Use contextual evidence about 1980s Thatcherism.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain how Russell manipulates the audience\'s sympathy through specific dramatic techniques.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'How does Russell present Mrs Johnstone as a victim of poverty in the opening of the play?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why does Mrs Johnstone agree to give away one of her twins? What does this reveal about her character?',
      lines: 5,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  keywords: [
    'manipulation', 'paranoia', 'privilege', 'exploitation',
    'middle class', 'antagonist', 'dramatic foil', 'hysteria',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students consider how Russell might use the employer-employee relationship to comment on wider class structures in 1980s Britain.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students argue whether Mrs Lyons is a villain or a victim of her own class anxieties, using evidence from across the play.',
      },
      resources: ['Character arc timeline worksheet', 'Key quotations sheet', 'Partially completed version (support tier)'],
    },
    {
      ...
      differentiation: {
        ...
        stretch: 'Students analyse what Russell is saying about class through the contrast — is he arguing that wealth corrupts, or that poverty ennobles? Evaluate both sides.',
      },
      resources: ['Comparison table template', 'Venn diagram (support tier)', 'Connectives word mat'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Provide three pre-written questions for students who find it difficult to generate their own.',
      core: 'Students prepare and ask their own questions, using evidence from the text.',
      stretch: 'Students challenge the hot-seater with counter-evidence: "But in Act 2 you said..."',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Why does Mrs Lyons tell Mickey the truth at the end of the play? What is Russell\'s intention in this moment?',
      lines: 5,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  keywords: [
    'dialect', 'register', 'innocence', 'sociolect',
    'juxtaposition', 'nature vs nurture', 'blood bond', 'dramatic irony',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Highlight specific words in each extract and ask students to describe the difference (e.g., formal vs informal).',
      core: 'Students identify three specific linguistic differences and suggest what each reveals about the speaker.',
      stretch: 'Students consider whether Russell is reinforcing or challenging stereotypes about working-class and middle-class speech.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide colour-coded annotation prompts: yellow = language differences, blue = humour, pink = dramatic irony.',
        core: 'Students annotate independently and write a summary sentence for each of the four focus areas.',
        stretch: 'Students analyse how Russell uses the stage directions in this scene to enhance the sense of instant connection between the boys.',
      },
      resources: ['First meeting extract handout', 'Annotation colour guide (support tier)', 'Highlighters'],
    },
    {
      ...
      differentiation: {
        ...
        stretch: 'Students add a paragraph from the Narrator\'s perspective, commenting ominously on the friendship.',
      },
      resources: ['Diary entry template (support tier)', 'Character voice word banks for Mickey and Edward'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students consider Russell\'s structural choice — why does he dedicate so much stage time to the childhood scenes?',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'How does Russell use language to show class differences between Mickey and Edward as children?',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  keywords: [
    'adolescence', 'disillusionment', 'class consciousness', 'resentment',
    'unemployment', 'structural contrast', 'turning point', 'inequality',
  ],
  starterActivity: {
    title: 'Then and Now',
    duration: '7 minutes',
    ...
    differentiation: {
      support: 'Provide a list of possible reasons for friendships changing and ask students to rank them.',
      core: 'Students generate their own reasons and link at least one to the play.',
      stretch: 'Students consider whether it is growing up itself or growing up in an unequal society that damages the friendship.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a "then vs now" grid with prompts for each character (how they spoke as children vs teenagers).',
        core: 'Students complete the dual-column analysis independently and identify the key turning point in the friendship.',
        stretch: 'Students analyse the structural significance of this shift: why does Russell compress time and skip over several years? What effect does this have?',
      },
      resources: ['Act 2 extracts handout', 'Dual-column analysis template', 'Then vs Now grid (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a paragraph frame and a context information card about 1980s Liverpool unemployment.',
        core: 'Students write a full PEE paragraph with embedded quotation and contextual link.',
        stretch: 'Students write a second paragraph comparing Mickey\'s experience with Edward\'s, arguing that Russell uses the contrast to show how class determines life chances.',
      },
      resources: ['Mickey\'s speech extract', 'Context card: 1980s Liverpool', 'Paragraph frame (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students argue that Russell shows it is not the characters but the system that changed — the boys are the same, their circumstances are not.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'How does Russell show that class divisions become more visible during adolescence?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Analyse the significance of Mickey\'s line: "I grew up. An\' you didn\'t, because you didn\'t need to."',
      lines: 6,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  keywords: [
    'love triangle', 'loyalty', 'gender roles', 'catalyst',
    'agency', 'trapped', 'pragmatism', 'betrayal',
  ],
  starterActivity: {
    title: 'The Triangle',
    duration: '7 minutes',
    ...
    differentiation: {
      support: 'Provide a brief character summary of Linda and her relationships before the discussion.',
      core: 'Students identify how each character in the triangle might feel at different points in the play.',
      stretch: 'Students consider whether the love triangle is a personal tragedy or Russell\'s metaphor for class mobility.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students compare Linda\'s trajectory with Mrs Johnstone\'s — does Russell suggest that working-class women are trapped in a cycle?',
      },
      resources: ['Four extracts handout', 'Character development grid', 'Partially completed grid (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a structured paragraph frame with sentence starters and a quotation bank.',
        core: 'Students write two full paragraphs with embedded quotations and structural analysis.',
        stretch: 'Students add a third paragraph evaluating whether Linda has genuine agency or whether she is trapped by her circumstances, linking to Russell\'s presentation of gender.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students argue that Linda is both — Russell uses her as a device but gives her enough humanity that the audience cannot simply reduce her to a function.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'To what extent does Russell present Linda as having genuine agency (the power to make her own choices)?',
      lines: 6,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  keywords: [
    'social class', 'inequality', 'Thatcherism', 'meritocracy',
    'determinism', 'social mobility', 'poverty trap', 'privilege',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students consider what would need to change in society for the two babies to have equal chances.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a quotation bank matched to each category; students explain the quotations.',
        core: 'Students find their own evidence and write explanations independently.',
        stretch: 'Students add a sixth category of their own and evaluate which area of inequality Russell presents as most damaging.',
      },
      resources: ['Evidence grid worksheet', 'Quotation bank (support tier)', 'Context reference sheet'],
    },
    {
      ...
      differentiation: {
        ...
        stretch: 'Students extend their paragraph to link to modern debates about institutional classism and bias in the justice system.',
      },
      resources: ['Policeman scenes extracts', 'Annotated versions (support tier)', 'PEE structure reminder'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain whether they think Russell\'s message is still relevant today and why.',
    },
  },
  homework:
...
const lesson8: LessonPlan = {
  ...
  keywords: [
    'nature', 'nurture', 'environment', 'heredity',
    'determinism', 'social conditioning', 'identity', 'tabula rasa',
  ],
  starterActivity: {
    title: 'Born or Made?',
    duration: '8 minutes',
    ...
    differentiation: {
      support: 'Provide simple definitions of nature (what you are born with) and nurture (how you are raised) on cards.',
      core: 'Students justify their vote for each trait with a reason.',
      stretch: 'Students consider whether the nature vs nurture distinction is too simplistic — could both always be involved?',
    },
    resources: ['Traits list slide', 'Nature/Nurture definition cards (support tier)', 'Voting cards'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a partially completed chart with the "birth" and "childhood" stages filled in.',
        core: 'Students complete the chart independently and write a summary statement about Russell\'s argument.',
        stretch: 'Students identify moments where nature seems to override nurture (e.g., both boys\' instinct to befriend each other) and consider what this adds to Russell\'s argument.',
      },
      resources: ['Five-stage comparison chart template', 'Partially completed chart (support tier)', 'Quotation reference sheet'],
    },
    {
      ...
      differentiation: {
        support: 'Provide each team with a starter argument and a relevant quotation to build from.',
        core: 'Students develop their own arguments with evidence and present confidently.',
        stretch: 'Students play devil\'s advocate during the debate and in their written conclusion, acknowledge the strongest argument from the opposing side.',
      },
      resources: ['Debate preparation sheets', 'Starter arguments (support tier)', 'Timer for debate'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Explain why Russell might want to leave some ambiguity rather than giving a completely clear answer.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'What is the nature vs nurture debate and how does Russell use Blood Brothers to explore it?',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Is there any evidence in the play that nature plays a role? How does this affect Russell\'s argument?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'How might the nature vs nurture debate in Blood Brothers connect to real-world issues of social inequality?',
      lines: 5,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  keywords: [
    'fate', 'superstition', 'inevitability', 'foreboding',
    'motif', 'climax', 'catharsis', 'tragic ending',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students consider whether Russell uses superstition to represent working-class fatalism — the belief that life is beyond your control.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students argue whether the superstition motifs suggest that the ending is genuinely fated or whether Russell uses them ironically to distract from the real cause (class).',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide a guided annotation worksheet with specific prompts for each section of the extract.',
        core: 'Students annotate independently and write a full analytical response.',
        stretch: 'Students consider the Narrator\'s final question to the audience — "And do we blame superstition for what came to pass? / Or could it be what we, the English, have come to know as class?" — and analyse how this shapes the audience\'s final interpretation.',
      },
      resources: ['Final scene extract or video clip', 'Guided annotation sheet (support tier)', 'Response planning template'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students analyse the rhetorical effect of ending with a question rather than a statement.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Analyse the Narrator\'s closing lines: "And do we blame superstition for what came to pass? / Or could it be what we, the English, have come to know as class?"',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Is the ending of Blood Brothers inevitable, or could the tragedy have been avoided?',
      lines: 6,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  keywords: [
    'AO1', 'AO2', 'AO3', 'AO4',
    'thesis statement', 'embedded quotation', 'topic sentence', 'evaluative conclusion',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain how to integrate all four AOs within a single paragraph rather than addressing them separately.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a quotation bank of eight key quotations to select from, and a plan template with prompts.',
        core: 'Students plan independently from memory, then refine using the model plan.',
        stretch: 'Students plan a fourth paragraph that challenges or nuances the question (e.g., "However, Russell also suggests that superstition and fate play a role...").',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide a paragraph frame for the introduction and first paragraph; students write paragraphs 2-3 and the conclusion independently.',
        core: 'Students write the full response independently under timed conditions.',
        stretch: 'Students aim for a sophisticated response that integrates alternative interpretations and evaluates Russell\'s authorial choices.',
      },
      resources: ['Lined paper or exam booklets', 'Paragraph frame (support tier)', 'Timer displayed on board'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Provide a simplified self-assessment checklist (tick-box format) with clear descriptors.',
      core: 'Students use the full mark scheme and write detailed targets.',
      stretch: 'Students identify the single weakest paragraph in their response and rewrite it on a separate sheet.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Write an introduction for the essay question: "How does Russell present the theme of social class in Blood Brothers?"',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Write an analytical paragraph about how Russell presents class inequality through Mickey\'s experience.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Write a concluding paragraph that evaluates Russell\'s overall message about class.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Identify three common mistakes students make when writing about Blood Brothers in the exam and explain how to avoid them.',
      lines: 6,
      modelAnswer:
