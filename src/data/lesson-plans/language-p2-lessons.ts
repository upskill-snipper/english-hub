...
export const languageP2LessonPlans: LessonPlan[] = [
  // ── Lesson 1: Paper 2 Overview ───────────────────────────────────────────
  {
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support: 'Provide a partially completed summary grid with some cells pre-filled.',
      ...
      },
      {
        ...
        resources: ['Source A and Source B printed handouts', 'Comparison table template'],
      },
      {
        ...
        differentiation: {
          support: 'Reduce to six statements (four true, two false) with line references provided.',
    ...
    worksheetQuestions: [
      {
        question: 'How many marks is AQA English Language Paper 2 worth in total?',
        lines: 1,
  ...
  // ── Lesson 2: Q1 True or False ──────────────────────────────────────────
  {
    ...
    keywords: ['explicit', 'implicit', 'shade', 'true', 'false', 'distractor', 'paraphrase'],
    starterActivity: {
      title: 'Spot the Lie',
      duration: '7 minutes',
      instructions:
      ...
      differentiation: {
        support:
          'Teacher highlights which statements are about facts vs opinions to scaffold understanding.',
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students predict which statements are designed to be traps before the teacher reveals answers.',
        },
        resources: ['Source A printed handout', 'Eight statements displayed on board'],
      },
      {
        ...
        differentiation: {
          support:
            'Set 1 includes line references. Set 2 includes the relevant paragraph highlighted.',
          core: 'Both sets without line references but statements are in text order.',
          stretch:
            'Set 2 statements are deliberately not in text order - students must scan the whole text.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            "Students write one true and one false statement, with a scaffold: 'Change one detail to make it false.'",
          core: 'Two true, two false statements as described.',
          stretch:
            'Students must create one false statement that uses the exact wording from the text but changes the meaning through context.',
        },
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          "Write tips and a brief explanation of why each matters, with an example from today's practice.",
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Explain why statement A is false. Refer to the text in your answer.',
        lines: 3,
        modelAnswer:
      ...
      {
        question: 'Explain why statement D is false. Refer to the text in your answer.',
        lines: 3,
        modelAnswer:
      ...
      {
        question: 'How long should you spend on Q1 in the exam, and why?',
        lines: 2,
        modelAnswer:
  ...
  // ── Lesson 3: Q2 Summary and Synthesis ──────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          "Provide sentence starters: 'Both images show...' / 'However, the modern image...'",
        core: 'Students compare independently.',
        stretch:
          'Students also infer what each image suggests about attitudes to education in its era.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a pre-highlighted version of both sources with key attitudes underlined.',
          core: 'Students highlight independently and contribute to class discussion.',
          stretch:
            "Students identify implicit attitudes as well as explicit ones (e.g., what does the word 'sentimental' in Source B imply about the writer's view of opponents?).",
        },
        resources: ['Source A and Source B handouts', 'Sample Q2 question projected'],
      },
      {
        ...
        differentiation: {
          support:
            'Provide a writing frame with sentence starters for the WHAT-HOW-LINK structure.',
          core: 'Students annotate the model paragraph and plan their own second paragraph.',
          stretch:
            'Students write their own second paragraph independently, aiming for perceptive inference.',
        },
        resources: ['Model paragraph on board/slide', 'WHAT-HOW-LINK writing frame'],
      },
      {
        ...
        differentiation: {
          support:
            'Students write 2 paragraphs using the writing frame. Peer-assessment uses a simplified tick-list.',
          core: '3 paragraphs as described, full peer-assessment.',
          stretch:
            'Students aim for 4 paragraphs and must include at least one point about implicit attitudes.',
        },
        resources: ['Timer displayed', 'Peer-assessment checklist'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Mistakes are labelled A, B, C; students match each to the correct description from a list.',
    ...
    worksheetQuestions: [
      {
        question: 'What does Q2 ask you to do? Explain in your own words.',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 4: Q3 Language Analysis ──────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide four adjectives to choose from and discuss which changes the meaning most.',
        core: 'Students generate their own replacement words and explain the shift in meaning.',
        stretch:
          "Students also consider how 'isolation' could be replaced and the cumulative effect of the pairing.",
      },
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a glossary for challenging 19th-century vocabulary. Pre-identify three key quotations for students to focus on.',
          core: 'Students annotate independently using the circle/underline/box system.',
          stretch:
            "Students also comment on sentence structure and how the writer's syntax contributes to tone.",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a writing frame with sentence starters for each element (WHAT/HOW/WHY).',
          core: 'Students write independently using the WHAT-HOW-WHY structure.',
          stretch:
            'Students write two paragraphs and link them, showing how language choices build a cumulative effect.',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Students write 2 paragraphs in 12 minutes using the writing frame. Self-assess against Level 2/3 descriptors.',
          core: '3 paragraphs, self-assess against Level 3/4.',
          stretch:
            'Students aim for a perceptive, evaluative response that considers the overall tone and how it develops.',
        },
        resources: ['Timer displayed', 'Mark scheme descriptors (simplified, projected)'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'After the quiz, students explain which techniques are most effective in Source B and why.',
      },
    ...
    worksheetQuestions: [
      {
        question: 'What does Q3 on Paper 2 ask you to do? How is it different from Q2?',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 5: Q4 Comparing Viewpoints ──────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Methods are identified by the teacher; students match them to the correct statement.',
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Points of comparison are pre-identified on the grid; students find the quotations.',
          core: 'Students identify their own points of comparison and complete the grid.',
          stretch:
            'Students also note how the methods differ despite the similar viewpoints (e.g., modern vs Victorian rhetorical style).',
        },
        resources: ['Source A and Source B printed handouts', 'Planning grid template'],
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students write their own paragraph independently, aiming for perceptive comparison of methods.',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Students use their planning grid and the writing frame. Aim for 2-3 paragraphs.',
          core: '3-4 paragraphs using the grid as a plan.',
          stretch:
            "4+ paragraphs with perceptive analysis of how the different time periods influence the writers' methods.",
        },
    ...
    worksheetQuestions: [
      {
        question: 'What two things does Q4 ask you to compare? Why is it important to cover both?',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 6: Q4 Advanced - Top-Band Comparison ────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Paragraphs are colour-coded to highlight the differences (viewpoints in blue, methods in green, context in yellow).',
        core: 'Students rank and annotate independently.',
        stretch:
          "Students identify specifically which words and phrases in paragraph Z make it 'perceptive.'",
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            "Provide guiding questions for annotation: 'How does the writer feel about travel?' 'What words or techniques help you see this?' 'When was this written and who for?'",
          core: 'Students annotate independently using the three-focus system.',
          stretch:
            "Students also identify moments where the writers' viewpoints are more complex or contradictory than they first appear.",
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students also plan a contextual comment for each theme (e.g., how 21st-century cynicism vs Victorian wonder shapes the tone).',
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            "Include an evaluative conclusion that considers which writer's perspective is more convincing and why.",
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students rewrite one of their own paragraphs to make it more perceptive, using the model as inspiration.',
      },
    },
    homework:
  ...
  // ── Lesson 7: Q5 Article Writing ───────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          "Provide a formula: [Topic] + [Strong Verb/Adjective] + [Provocation]. E.g., 'Cheap Food: The Price We Cannot Afford.'",
        core: 'Students write headlines independently.',
        stretch:
          'Students write three headlines in different styles (factual, provocative, humorous) and evaluate which is most effective.',
      },
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a pre-annotated version with structural labels and students explain why each feature is effective.',
          core: 'Students annotate independently, then compare with a partner.',
          stretch:
            'Students also identify where the writer shifts tone or register and comment on why.',
        },
        resources: ['Source A printed handout', 'Article structure reference card'],
      },
      {
        ...
        differentiation: {
          support:
            'Provide a partially completed plan with the counter-argument pre-written. Focus on writing a strong opening paragraph.',
          core: 'Students plan and write the first three sections independently.',
          stretch:
            'Students aim for a distinctive authorial voice - witty, angry, measured - and sustain it throughout.',
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students aim for all eight techniques and consider where each has maximum impact (e.g., rhetorical question at the end, anecdote at the start).',
        },
    ...
    worksheetQuestions: [
      {
        question: 'How many marks is Q5 worth, and how are those marks divided?',
        lines: 2,
        modelAnswer:
      ...
      {
        question: 'Identify the counter-argument in Source A. How does the writer respond to it?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 8: Q5 Speech Writing ────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students explain why each technique is particularly suited to spoken delivery (e.g., repetition aids memory and creates rhythm).',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students also consider how to adapt their tone for a school assembly audience - not too formal, not too casual.',
        },
        resources: ['Source A and Source B printed handouts', 'Speech structure template'],
      },
      {
        ...
        differentiation: {
          support:
            "Provide sentence frames for each technique that students complete (e.g., 'We need ___. We need ___. We need ___.').",
          core: 'Students write original sentences for all six techniques.',
          stretch:
            'Students combine two techniques in a single sentence (e.g., anaphora + rhetorical question).',
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Aim for a distinctive voice that shifts tone (e.g., humour to seriousness, personal anecdote to broader argument). 500+ words.',
        },
        resources: ['Timer displayed', 'Rhetorical techniques reference card'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'After delivering, the speaker identifies which technique landed best and which needs reworking.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question: 'List three key differences between writing a speech and writing an article.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Write an example of antithesis on the topic of sport vs academic results.',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 9: Q5 Letter Writing ────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students rewrite option (3) to match the formal-but-engaging register of option (2).',
      },
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a printed letter template with the format pre-labelled - students stick it in their books.',
          core: 'Students copy the format with annotations.',
          stretch:
            "Students also note common errors (e.g., 'Yours Faithfully' with a capital F is wrong after 'Dear Mr Smith').",
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students also plan the specific tone of each paragraph (e.g., factual opening, emotive middle, assertive close).',
        },
        resources: ['Source A and Source B handouts', 'Paragraph planner template'],
      },
      {
        ...
        differentiation: {
          support:
            'Use the paragraph planner with sentence starters. Aim for 300-350 words. Focus on format and register.',
          core: 'Write independently. Aim for 400-500 words. Focus on sustained argument and counter-argument.',
          stretch:
            'Aim for 500+ words with sophisticated vocabulary, varied sentence structures, and a distinctive authorial voice within the formal register.',
        },
        resources: ['Timer displayed', 'Paragraph planners from previous activity'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Partners also assess whether the argument is logical and sustained, providing written feedback.',
      },
  ...
  // ── Lesson 10: Full Paper Practice ─────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Adjusted timings are pre-printed and stuck into books. Teacher will announce each time boundary.',
        core: 'Students note their own timings and self-manage with clock-watching.',
        stretch:
          'Students also set personal targets for each question based on previous performance.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            "Provide guiding questions to annotate against: 'What does the writer think about sport?' 'What tone do they use?'",
          core: 'Students annotate independently using strategies learned in previous lessons.',
          stretch:
            "Students make brief marginal notes linking specific quotations to specific questions (e.g., 'Q3 - language' next to a powerful phrase).",
        },
        resources: ['Source A and Source B printed handouts (exam-style layout)'],
      },
      {
        ...
        differentiation: {
          support:
            "Provide a question-by-question prompt card with reminders (e.g., 'Q2: Write about BOTH sources. Focus on WHAT they say, not HOW.').",
          core: 'Students work independently with time prompts.',
          stretch:
            'Students manage their own time without teacher prompts, aiming to finish with time to spare for checking.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a planning template. Focus on clear paragraphs, correct article format, and three persuasive techniques.',
          core: 'Plan and write independently. Aim for 400+ words with varied techniques and a counter-argument.',
          stretch:
            'Aim for a sophisticated, engaging piece with a distinctive voice, varied sentence structures, and ambitious vocabulary.',
        },
        resources: ['Timer displayed', 'Planning template for support tier'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Mark scheme is simplified to two bands (lower/higher) with student-friendly language.',
        core: 'Full four-level mark scheme descriptors.',
        stretch:
          "Students also write a specific action plan: 'To improve my Q4, I will practise... by doing...'",
      },
      resources: ['Simplified mark scheme handout', 'Reflection slip'],
    },
    homework:
