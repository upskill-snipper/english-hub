...
export const y12IalExtendedLessons: LessonPlan[] = [
  ...
  // ── Lesson 3: Timed Essay Under Exam Conditions ──────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support: 'Provide the five-criterion checklist as a pre-printed annotation guide.',
  ...
  // ── Lesson 5: Understanding Mark Descriptors and Self-Marking ────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide the sentence frame as written above.',
  ...
  // ── Lesson 6: Unit 1 Mock Exam Walkthrough ───────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a template with the required sections pre-labelled and a box for each.',
