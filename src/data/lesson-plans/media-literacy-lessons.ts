...
const lesson1: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a prompt sheet listing common media encounters (e.g., TV, phone notifications, posters) to help students build their list.',
      core: 'Students categorise independently and add notes on why each text was created (to inform, persuade, entertain).',
      stretch:
        'Students consider which media texts they consumed passively versus actively and discuss why the distinction matters.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a word bank of media terms (headline, caption, logo, hashtag, slogan) and sentence starters for each question.',
        core: 'Students complete the grid independently, using subject-specific terminology in their responses.',
        stretch:
          'Students add a column evaluating how effectively each text achieves its purpose, with evidence from the text itself.',
      },
      resources: [
        'Six printed/displayed media texts',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a PACT scaffold with sentence starters for each element of the paragraph.',
        core: 'Students write a full PACT paragraph independently, embedding at least three media terminology words.',
        stretch:
          'Students write a second paragraph comparing their chosen text with another from the gallery walk, analysing differences in construction.',
      },
      resources: [
        'Projected advert for modelling',
        'PACT scaffold sheet (support tier)',
        'Media terminology reference card',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students frame their question as something that challenges or extends the lesson content.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Define "media literacy" in your own words and explain why it is important in the 21st century.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Choose one media text and explain how it has been constructed to appeal to its target audience. Use the PACT framework.',
      lines: 8,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students create their own slogan for an imaginary product and explain their language choices.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed toolkit with definitions already written; students add examples and sketches.',
        core: 'Students create the full toolkit independently, writing definitions in their own words.',
        stretch:
          'Students rank the six techniques from most to least persuasive and justify their top choice in a short paragraph.',
      },
      resources: [
        'Visual techniques slide deck with advert examples',
        'Toolkit template (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a pre-structured paragraph frame with connectives and sentence starters for comparison.',
        core: 'Students complete the table and write the comparative paragraph independently using at least four media terms.',
        stretch:
          'Students evaluate which advert is more effective at reaching its target audience and explain why, considering cultural context.',
      },
      resources: [
        'Two printed adverts for comparison',
        'Comparative analysis table',
        'Paragraph frame (support tier)',
        'Media terms checklist',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Students can refer to their Visual Techniques Toolkit and are expected to identify at least two techniques.',
      core: 'Students identify at least four techniques and explain the effect of one.',
      stretch:
        'Students comment on the overall effectiveness of the advert, considering what is absent as well as what is present.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Explain what "colour connotation" means and give an example of how it is used in advertising.',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Analyse the use of language in the following slogan: "Taste the Rainbow." What techniques are used and what effect do they create?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Compare two adverts for similar products aimed at different audiences. How do they use different techniques to appeal to their target demographics?',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Why do advertisers use celebrities or models in their adverts? Explain with reference to audience response.',
      lines: 5,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students rewrite both headlines to be as neutral and objective as possible, then discuss what is lost or gained.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide annotations for the first three techniques; students complete the remaining three independently.',
        core: 'Students annotate all six examples independently, using the correct terminology.',
        stretch:
          'Students identify which technique is the most subtle and therefore the most dangerous form of bias, justifying their choice.',
      },
      resources: [
        'Bias techniques handout with real examples',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed comparison grid and a paragraph frame with connectives.',
        core: 'Students complete the grid and write the paragraph independently, using at least five media literacy terms.',
        stretch:
          'Students add a concluding sentence evaluating which article is more trustworthy and why, considering ownership and political alignment.',
      },
      resources: [
        'Two news articles (tabloid and broadsheet)',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students consider whether objectivity is possible or desirable in journalism and explain their position.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Explain three techniques that newspapers use to introduce bias into their reporting.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Compare how a tabloid and a broadsheet might report on the same event differently. Use specific examples of techniques.',
      lines: 8,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a word bank of social media terms (hashtag, caption, filter, tag, emoji) to guide annotations.',
      core: 'Students annotate independently and explain the purpose of at least three features.',
      stretch:
        'Students consider how the same message would be communicated in formal written English and discuss what is gained and lost in translation.',
    },
    resources: [
      'Fictional social media post slide',
      'Mini-whiteboards',
      'Word bank (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a completed model analysis for the first post and sentence starters for the remaining two.',
        core: 'Students complete all three analyses independently using media literacy terminology.',
        stretch:
          'Students consider the ethical implications of undisclosed advertising and discuss whether influencer marketing should be more heavily regulated.',
      },
      resources: [
        'Three anonymised social media post examples',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide pre-written argument structures with gaps for students to add evidence and examples.',
        core: 'Students construct arguments independently using the resource pack, structuring point, evidence, and explanation.',
        stretch:
          'Students act as adjudicators for the debate, evaluating the strength of both sides and writing a balanced conclusion.',
      },
      resources: [
        'Debate resource packs (two sets)',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Sentence starter: "One way social media has changed language is... I think this is [positive/negative/neutral] because..."',
      core: 'Full written response with a specific example and clear reasoning.',
      stretch:
        'Students link their response to the concepts of descriptivism or prescriptivism discussed in the debate.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Identify four distinctive language features of social media communication and explain the purpose of each.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'How do influencers blur the line between personal content and advertising? Give examples of techniques they use.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Do you think social media is changing the English language for better or worse? Write a balanced argument considering both perspectives.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'What is the difference between "descriptivism" and "prescriptivism" in attitudes to language? How does each view relate to social media language?',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide the two extreme examples (most formal and most informal) already placed on the spectrum.',
      core: 'Students sort independently and identify two language features that signal the register of each text.',
      stretch:
        'Students explain why the same person might use all eight registers in a single day and what this tells us about language.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a checklist of features to look for (contractions, sentence length, punctuation, greetings) and highlight the first pair as a model.',
        core: 'Students annotate independently and complete the summary table with their own examples.',
        stretch:
          'Students identify a "middle register" (semi-formal) and explain when and why it is used in digital communication.',
      },
      resources: [
        'Paired digital texts worksheet',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a scaffold for each text with the opening line and key structural features already in place.',
        ...
        stretch:
          'Students write a fourth version - a social media post explaining their absence - and analyse how this register differs from all three.',
      },
      resources: [
        'Scenario card',
        'Register checklist for peer assessment',
        'Scaffold sheets (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Students identify at least two features that make the text inappropriate for its context.',
      core: 'Students explain why the register is inappropriate and suggest corrections.',
      stretch:
        'Students discuss whether there are situations where deliberately using the wrong register can be effective (e.g., humour, satire).',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Define "register" in your own words and explain what determines which register a writer uses.',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Identify four language features that distinguish formal digital communication from informal digital communication.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Rewrite the following text message in formal register, suitable for a professional email: "hey can u send me that report thing asap? cheers mate"',
      lines: 5,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a two-column observation grid (What I See / What I Hear) to structure note-taking.',
      core: 'Students write freely and then categorise their observations into visual and audio techniques.',
      stretch:
        'Students infer the mood, genre, and target audience from the clip alone and explain their reasoning.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed reference page with definitions; students add effects and examples.',
        core: 'Students complete the full reference page independently with their own descriptions of each effect.',
        stretch:
          'Students identify which techniques are used most commonly in specific genres (horror, comedy, action) and explain why.',
      },
      resources: [
        'Cinematography slide deck',
        'Short film clips for examples',
        'Reference page template (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide sentence starters for the paragraph and a simplified analysis grid focusing on three key techniques.',
        core: 'Students write a full paragraph independently analysing at least three techniques with specific evidence.',
        stretch:
          'Students write a second paragraph considering how the extract would change if one key technique were altered (e.g., changing the music from minor to major key).',
      },
      resources: [
        'Film extract (3 minutes)',
        'Analysis grid',
        'Paragraph scaffold (support tier)',
        'Cinematography toolkit reference',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students must explain the effect of each technique on the audience, not just identify it.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Explain the difference between a close-up shot and a long shot. When might a director choose to use each one?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'What is the difference between diegetic and non-diegetic sound? Give an example of each and explain its effect.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Analyse a film extract you have watched, explaining how the director uses at least three techniques to create meaning for the audience.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Why is it useful to analyse film and television as "texts"? How is this similar to analysing written texts?',
      lines: 5,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a multiple-choice option for each clip (e.g., "Is this clip: A) comedy, B) news, C) true crime?").',
      core: 'Students identify the genre, audience, and purpose independently with reasoning.',
      stretch:
        'Students consider how the same script would be received differently if delivered in a different tone or accent.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a pre-annotated transcript with two features already identified; students find and annotate three more.',
        core: 'Students annotate the full transcript independently and write the analysis using at least three techniques.',
        stretch:
          'Students consider the structural choices of the extract - how does the podcaster sequence their ideas for maximum impact?',
      },
      resources: [
        'Podcast extract audio (2-3 minutes)',
        'Printed transcript',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a script template with structural markers (hook, introduction, example, question, sign-off) and sentence starters.',
        core: 'Students write the full script independently, incorporating at least four techniques.',
        stretch:
          'Students record their scripts using a phone or device and listen back, evaluating their own delivery and making improvements.',
      },
      resources: [
        'Script template (support tier)',
        'Timer for performances',
        'Recording devices (stretch tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students draw a parallel between how audio media and written fiction both rely on the audience's imagination.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Explain how podcasters use "direct address" to engage their audience. Why is this technique particularly effective in audio media?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'What role does "pace" play in a podcast, and how can changes in pace affect the listener\'s experience?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Compare how a podcast and a television programme might cover the same topic differently. What are the advantages and limitations of each medium?',
      lines: 8,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a simple definition comparison sheet: "Persuasion is... Propaganda is..." with examples.',
      core: 'Students articulate the distinction independently and justify their categorisation of each text.',
      stretch:
        'Students consider whether all persuasion exists on a spectrum with propaganda and discuss where the ethical line falls.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide definitions for each technique; students focus on identifying examples and explaining effects.',
        core: 'Students write their own definitions and analyse each example independently.',
        stretch:
          'Students find a modern real-world example of each technique from their own media consumption and add it to their guide.',
      },
      resources: [
        'Propaganda examples pack (historical and modern)',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide an annotated model analysis of the historical poster; students write independently about the modern text using the model as a guide.',
        core: 'Students analyse both texts independently, using accurate terminology and specific evidence.',
        stretch:
          'Students compare the two texts, discussing how propaganda techniques have evolved from print to digital media and why.',
      },
      resources: [
        'Historical propaganda poster',
        'Modern propaganda-style text',
        'Model analysis (support tier)',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Students select five red flags from a provided list of ten and explain their choices.',
      core: 'Students generate their own five red flags based on the lesson content.',
      stretch:
        'Students rank their red flags from most to least dangerous and explain their reasoning.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Define propaganda and explain how it differs from other forms of persuasion such as advertising.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Explain three propaganda techniques with examples and describe how each one manipulates the audience.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Analyse a propaganda poster, identifying at least three techniques and evaluating its effectiveness.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Why is it important to be able to recognise propaganda techniques in modern media?',
      lines: 5,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students propose a multi-platform campaign using two or more formats and explain how they would complement each other.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students include a brief analysis of a professional example of their chosen format, explaining which techniques they will adopt and adapt.',
      },
      resources: [
        'Planning sheet',
        'Guided planning template (support tier)',
        'Examples of professional media texts for reference',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a design template with layout guides and a reflective commentary scaffold with sentence starters.',
        core: 'Students create and reflect independently, demonstrating at least five deliberate technical choices.',
        stretch:
          'Students create a second version of their text for a different audience and write a comparative commentary explaining how and why they adapted their choices.',
      },
      resources: [
        'A3 paper, art materials, devices',
        'Design templates (support tier)',
        'Social media post templates',
        'Reflective commentary scaffold (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a feedback sentence starter: "One effective technique I noticed is... One improvement could be..."',
      core: 'Students give specific, terminology-driven feedback.',
      stretch:
        'Students evaluate whether the text would achieve its stated purpose with its target audience and explain why.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Explain three deliberate choices you made when creating your media text and justify each one using media literacy terminology.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'How does the experience of creating a media text change the way you "read" media texts produced by others?',
      lines: 5,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'After the vote, provide a checklist of "red flag" features (sensational language, no named source, suspicious URL) to help students revise their answers.',
      core: 'Students explain their reasoning for each vote before the reveal.',
      stretch:
        'Students consider why fake news is more dangerous now than in previous eras and link their answer to social media and algorithms.',
    },
    resources: [
      'Six headline slides (three real, three fake)',
      'Red flag checklist (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the CRAAP questions as a simplified checklist with yes/no responses; students give an overall score with one sentence of justification.',
        core: 'Students complete the full evaluation grid independently with written justifications for each criterion.',
        stretch:
          'Students identify which CRAAP criterion is most important and argue why, then suggest additional criteria that the framework might be missing.',
      },
      resources: [
        'CRAAP test explanation handout',
        'Four source examples',
        'Evaluation grid worksheet',
        'Simplified checklist (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a step-by-step fact-checking guide and limit the investigation to three claims with scaffolded response frames.',
        core: 'Students investigate all five claims independently and write justified verdicts.',
        stretch:
          'Students create their own "Fake News Survival Guide" - a one-page resource for younger students explaining how to spot and check fake news.',
      },
      resources: [
        'Claims dossier (five items)',
        'Fact-checking strategy guide',
        'Devices for internet access (optional)',
        'Response frame (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a pledge template with options to select from and space to add one personal pledge.',
      core: 'Students write three original pledges with reasoning.',
      stretch:
        'Students reflect on which lesson in the unit was most impactful for them and explain why in a short paragraph.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Explain the difference between misinformation and disinformation. Why does the distinction matter?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Apply the CRAAP test to evaluate the reliability of a source. Explain your assessment for each criterion.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'What is "confirmation bias" and how does it make people more vulnerable to fake news?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Why is media literacy considered an essential skill in the 21st century? Use evidence and examples from across this unit to support your answer.',
      lines: 8,
      modelAnswer:
