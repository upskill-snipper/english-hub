...
export const y10IgcseLangP1Lessons: LessonPlan[] = [
  // ── Lesson 1: Understanding the Paper Structure ───────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Allow support students to keep their structure table visible during the speed-round.',
        core: 'Students answer from memory after packing away their notes.',
        stretch:
          'Stretch students must explain the reasoning behind their answers, not just state the answer.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Paper 1 (4EA1/01) lasts 135 minutes and is worth 90 marks. The paper has two sections. State the name of each section and how many marks each is worth.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Complete the table below for Section A. For each question, state: the task, the marks available, and the Assessment Objective tested.\n\nQ1: ___  Q2: ___  Q3: ___  Q4: ___  Q5: ___',
        lines: 8,
        modelAnswer:
      ...
      {
        question:
          'Section B is worth 45 marks, split between AO4 and AO5. How many marks does each AO carry, and what does each AO assess?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'A student spends 40 minutes on Questions 1-3 and only 20 minutes on Question 5. Explain why this is a poor timing strategy.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Draft a minute-by-minute timing plan for the full 135-minute Paper 1. Include all five Section A questions, Section B planning and writing, and a checking phase.',
        lines: 10,
        modelAnswer:
  ...
  // ── Lesson 2: Q1 and Q2 - Retrieval and Inference (AO1) ──────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Label the cards with a small R or I to allow students to check their sorting after completing it independently.',
        core: 'Students sort unsupported; justify any they found difficult to categorise.',
        stretch:
          'Students add one example of their own to each column, writing a mini passage and a corresponding question.',
      },
      resources: [
        'Retrieval vs. Inference sort cards (one set per pair)',
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide the lines underlined in the extract; students must choose the two most precise items from within the underlined section.',
          core: 'Students work with the full extract and locate the relevant lines independently before selecting.',
          stretch:
            'Students write a brief explanation of why alternative selections would not be awarded marks, linking to precision of focus.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide the extract with key phrases circled and a synonym bank; students use the synonyms to construct paraphrase sentences.',
          core: 'Students apply the four-step method independently with no scaffolding beyond the method prompt.',
          stretch:
            'Students rank their four points from most obvious to most inferential and explain why the inferential points demonstrate deeper reading.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide sentence starters for improving the weak response: "The writer felt..." / "The writer was concerned by..." / "The writer seemed to...".',
        core: 'Students rewrite the weak response in full before comparing with a partner.',
        stretch:
          'Students identify the maximum marks the weak response could receive and justify their judgement with reference to the mark scheme criteria.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          "Using the same extract, answer this Question 2: What are the writer's thoughts and feelings about the journey? Write your answer in your own words. (4 marks)",
        lines: 8,
        modelAnswer:
      ...
      {
        question:
          'Explain the difference between retrieval and inference. Give one example of each using the extract above.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'A student writes this Q2 answer: "The writer says the road wound endlessly upward and each step felt like a small defeat." Explain why this response would score low marks.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Rewrite the weak answer above as a full-mark Q2 response, using four distinct paraphrased points.',
        lines: 8,
        modelAnswer:
  ...
  // ── Lesson 3: Q3 - Description Using Quotations (AO1) ────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide the three criteria on a card before the activity so students can apply them as a checklist.',
        core: 'Students rank without any criteria card, deriving the principles from discussion.',
        stretch:
          'Students rewrite the weaker sentence in each pair to improve it before the teacher reveals the discussion.',
      },
      resources: [
        'Good Quote / Bad Quote slide (four pairs)',
        'Mini-whiteboards',
        'Criteria card (support scaffold)',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide sentence frames: "The writer describes the [topic] as \'[quotation]\', which suggests…" for each of the five examples.',
          core: 'Students construct fully original embedded sentences without frames, varying their embedding technique.',
          stretch:
            'Students choose which of the three embedding techniques is most appropriate for each quotation and justify their choice in a footnote.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Highlight six relevant sentences in the extract and instruct students to choose five; students focus on embedding rather than scanning.',
          core: 'Students scan the full extract and independently select their five best points.',
          stretch:
            "Students aim to capture the range of the writer's description (physical setting, atmosphere, people, language choices) rather than clustering around one aspect.",
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'The short paragraph used in the plenary can be the same topic as the main activity extract to lower cognitive load.',
        core: 'Use a completely fresh paragraph on a different topic.',
        stretch:
          'Students must ensure their five points come from five different sentences in the paragraph (no doubling up on source sentences).',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Explain what is meant by an "embedded quotation." Why is embedding better than using a block or standalone quotation in Q3?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'A student writes these two Q3 points: (A) "The market is described as loud." (B) "The market is shown to be noisy and busy." Explain why these two points would only earn one mark between them.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Why is it important to answer Q3 in no more than 7 minutes, even if you feel you could write more?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 4: Q4 - Language and Structure Analysis (AO2) ─────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a terminology bank with definitions (metaphor, simile, personification, alliteration, semantic field, repetition, short sentence, rhetorical question).',
        ...
        stretch:
          'Students write a second effect for each technique - "alternatively, this could suggest…" - to demonstrate the ability to consider multiple interpretations.',
      },
      resources: [
        'Six quotations slide',
        'Mini-whiteboards',
        'Terminology bank (support scaffold)',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide the P-E-E-E frame printed out with labels; students write into the frame, focusing on the Effect and Extended Effect halves.',
          core: 'Students write the complete P-E-E-E paragraph independently after the modelling, following the structure.',
          stretch:
            'Students write two contrasting P-E-E-E paragraphs on the same extract and then write a sentence linking the two points thematically.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a scaffolded response frame with paragraph starters: "The writer uses [technique] when describing…" and "In terms of structure, the writer…"',
          core: 'Students write independently and self-assess against the four-point checklist.',
          stretch:
            'Students attempt a high-band response by integrating language and structure analysis within the same paragraph rather than treating them separately.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a stem for the Effect and Extended Effect: "This creates a sense of… because… Furthermore, this suggests that the writer views…"',
        core: 'Students write the full upgrade independently.',
        stretch:
          'Students also improve the embedded quotation in the original weak paragraph to make it more precise.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is the difference between labelling a technique and analysing it? Explain using an example.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Identify two language techniques in this sentence and explain the effect of each:\n"The wave rose like a vengeful god, dark and ancient, and then it fell upon us."',
        lines: 8,
        modelAnswer:
      ...
      {
        question:
          'A Q4 question asks you to analyse "language and structure." Write one analytical point about structure for this extract: the extract opens with a close-up description of a single bird before widening to describe an entire forest in the final paragraph.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Write a full P-E-E-E analytical paragraph for the quotation: "The hospital corridor stretched out ahead of him, a white, relentless infinity."',
        lines: 8,
        modelAnswer:
      ...
      {
        question:
          'Which Q4 band would you expect a response to reach if it only labels techniques without explaining effects? Explain why.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 5: Q5 - Comparing Writers' Perspectives (AO3) ─────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Highlight the discourse markers in the integrated paragraphs to make the comparison structure visible.',
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a word bank within the gap-fill activity so students select rather than recall markers.',
          core: 'Students complete the gap-fill from the full toolkit and then write original sentences from memory.',
          stretch:
            'Students write a mini-paragraph (3-4 sentences) that uses contrast and similarity markers within the same continuous piece of writing.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a Q5 paragraph scaffold: "Writer A and Writer B both… However, while Writer A [quotation] suggests… Writer B [quotation] implies that…"',
          core: 'Students write independently using the modelled opening as a structural guide.',
          stretch:
            "Students write a concluding paragraph that synthesises both writers' overall perspectives and considers why the time period or context might explain the differences.",
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide the AO3 band descriptors on a card so students can match each response to a descriptor rather than ranking from instinct.',
        core: 'Students rank and predict marks before seeing the descriptors.',
        stretch:
          'Students annotate all three responses to identify the precise moment where each one moves up or is held back from the next band.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Explain the difference between a "sequential" Q5 response and an "integrated" Q5 response. Which scores more highly and why?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Write a comparative opening paragraph for a Q5 response on the theme of "the natural world," using these two perspectives: Writer A finds nature calming and restorative; Writer B finds it threatening and indifferent. Use at least two discourse markers.',
        lines: 8,
        modelAnswer:
      ...
      {
        question:
          'List six comparative discourse markers and place each in a category (contrast / similarity / degree / shift).',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          "A student's Q5 response refers to both texts but only in separate paragraphs - never within the same sentence or paragraph. What band would this likely fall into, and what must the student do to improve?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Q5 is worth 22 marks. How long should you spend on it, and how many comparative points should you aim to make?',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 6: Unseen Non-Fiction Text Practice ────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students identify the genre and describe the implied audience and purpose for each extract.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a printed annotation guide with five prompts: "What is the writer\'s view?", "What language stands out?", "What is the tone here?", "What is puzzling?", "What is the purpose of this paragraph?"',
          core: 'Students annotate freely but aim to address the same five dimensions as the support guide.',
          stretch:
            'Students add a sixth annotation type: "How might this be compared to a text about a different perspective on the same subject?"',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Allow support students to have their annotation guide available during the timed practice.',
          core: 'Students work with annotations only; the annotation guide is removed.',
          stretch:
            'Students complete Q1-Q3 in exactly 14 minutes (the time-proportional target) and then write a reflection on how their annotations helped.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a third sentence: "The most important thing to annotate quickly in an unseen text is… because…"',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is an "unseen text" and why does the Edexcel IGCSE Paper 1 exam always use them in Section A?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'List four non-fiction genres that might appear in Paper 1 Section A and give one key feature that identifies each.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'Describe the "five-minute annotation" strategy in your own words. What are the four things you should mark on the text during your first reading?',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'Explain how annotating a text before answering Q1-Q3 saves time rather than wasting it.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 7: Timed Paragraph Practice - Building Analytical Stamina ──────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide the technique (extended metaphor) and a sentence starter so students can begin immediately without spending time identifying the method.',
        core: 'Students identify the technique and write the paragraph without support.',
        stretch:
          'Students must include both the immediate effect and a wider interpretation in their extended effect sentence.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a partially completed P-E-E-E frame for Round 1 only; students work progressively towards independence in Rounds 2 and 3.',
          core: 'Students complete all three rounds independently with no scaffolding.',
          stretch:
            'Students attempt to write their Round 3 paragraph integrating a structural observation alongside the language technique analysis.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide the opening clause for both paragraphs: "While the explorer conveys a deeply personal…, the documentary script presents…" Students build from there.',
          core: 'Students write independently with only the discourse marker toolkit visible.',
          stretch:
            'Students write a brief linking sentence at the end of each paragraph that connects the comparison to a broader idea about why these writers had different perspectives.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a micro-strategy (a specific action) for addressing their target, not just naming the problem.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Why is it important to practise analytical writing under timed conditions and not just in your own time?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Write a complete P-E-E-E analytical paragraph for this quotation from a polar exploration account:\n"The ice was a vast, indifferent graveyard, strewn with the wreckage of previous expeditions."',
        lines: 8,
        modelAnswer:
      ...
      {
        question:
          'After completing timed paragraph practice, a student realises she always forgets to explain the extended effect under time pressure. Suggest two strategies she could use to address this.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'How many analytical paragraphs should a strong Q4 response contain, and how much time should each paragraph take in the exam?',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 8: Checking and Editing Technique ──────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Tell students the number of each error type in advance: "There are 2 spelling errors, 2 apostrophe errors, 2 comma splices…"',
        core: 'Students search without any category hints.',
        stretch:
          'Students correct all 10 errors and write a brief explanation of the rule that applies to each one.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a colour-coded version of the five steps (each step has a dedicated colour); students use the corresponding colour pen for each category of correction.',
          core: 'Students apply all five steps in sequence, using standard pen annotations.',
          stretch:
            'Students not only correct the errors but rewrite any sentences they deem low-band (e.g. overly simple structures) to improve the AO5 range.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Students focus on only two of the five proofreading steps (spelling and punctuation) for their own work review.',
          core: 'Students apply all five steps to their own work.',
          stretch:
            'Students produce a personal "error dictionary" - a list of every error found with the rule and a corrected version noted alongside it for future revision.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Label which category each error belongs to ("apostrophe error" etc.) so students can locate it by applying just that step.',
        core: 'Students find all five without any labelling.',
        stretch:
          'Students must correct and then rewrite the entire paragraph to improve its AO5 range as well as its accuracy.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Correct the following sentence and name the error type: "Their going to the match tomorrow, even though its raining."',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'Identify and correct the comma splice in this sentence: "The writer describes the landscape in vivid detail, this creates a strong visual impression for the reader."',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'A student uses exactly the same sentence structure throughout their entire Section B response: "I think that… I believe that… I feel that…" How does this affect their AO5 mark, and what could they do instead?',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 9: Full Mock Paper Walkthrough ─────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Allow support students to have their timing plan card on the desk during the mock.',
        core: 'All notes away; the timing plan card is visible only to support students.',
        stretch:
          'Stretch students set themselves an individual mark target for each question and write it on a sticky note on the front of their paper before beginning.',
      },
      resources: [
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Stretch students aim to address structure as well as language in Q4 and to write a final synthesising paragraph for Q5 that identifies the key overall difference in perspective.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide the mark scheme with bullet-pointed acceptable answers for Q1 and Q2 clearly listed so students can match their responses easily.',
          core: 'Students use the full mark scheme as issued.',
          stretch:
            'Students annotate their Q3 response against the mark scheme criteria, not just counting points but assessing whether each point truly meets the description criteria.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a sentence-starter reflection card: "I am pleased with… because…", "I found Q___ most challenging because…", "My target is to…"',
        core: 'Students complete the free-write reflection independently.',
        stretch:
          "Students write a self-mark prediction for Q4 and Q5 and briefly justify their prediction before seeing the teacher's mark.",
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'After completing the mock, review your Q1 and Q2 responses. For Q1: did you select from the correct lines? Were both selections precise words or phrases? For Q2: did you write in your own words, or did you lift phrases?',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'Review your Q3 response. How many distinct embedded-quotation points did you write? Did any of your points repeat the same idea?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Without looking at the mark scheme, write what you believe a Band 4 Q4 response must include. Then check against the mark scheme and note any criteria you missed.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'Review your Q5 response. Count: (a) How many integrated comparative paragraphs did you write? (b) How many discourse markers did you use? (c) Did you refer to both texts in every paragraph?',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'Based on your mock performance, identify the one question you most need to improve and describe exactly what you will practise before the real exam.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 10: Exam-Day Strategy and Time Management ─────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide the data table pre-printed so students only need to fill in their marks and circle their priority question.',
        core: 'Students construct the table and gap analysis independently.',
        stretch:
          'Students write a one-paragraph explanation of why their specific errors occurred (e.g. "I lost marks on Q5 because I wrote sequentially - I need more practice with integrated comparison").',
      },
      resources: [
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a decision-making flowchart: "If you prefer formal register → letter or report; if you prefer persuasive voice → article or speech; if the topic is familiar → lean towards it."',
          core: 'Students make decisions independently then compare with the class.',
          stretch:
            'Students write a brief justification explaining how their chosen form would affect the structural choices and register of their response.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a revision plan template with the days already labelled and some task types pre-filled; students only need to add their personal choices and specific texts to use.',
          core: 'Students construct the full revision plan on blank paper.',
          stretch:
            'Students include a "risk management" section in their plan: "If I am running out of time in the exam and I\'m on Q4, I will…" and "If my mind goes blank on Q5, I will…"',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide five sentence starters to choose from if students struggle to generate their own mantra.',
        core: 'Students write an entirely original mantra based on their personal experience of the mock.',
        stretch:
          'Students write a mantra and a three-sentence explanation of the evidence from their mock that led them to choose it.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'You are 20 minutes into the exam and have just finished Q3, but you feel your Q3 answer was incomplete - you only wrote three points instead of five. Should you go back and add to Q3 or move on to Q4? Justify your decision.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Your teacher gives you a choice of two Section B tasks: Task A is a letter to a local council arguing against the closure of a youth centre; Task B is an article for a school magazine about the benefits of social media. How would you decide which to choose?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Describe three practical actions you can take on the morning of the exam to maximise your performance.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Write your personalised timing plan for the full Paper 1 (135 minutes), making sure it reflects your individual performance data from the mock.',
        lines: 10,
        modelAnswer:
      ...
      {
        question:
          'Identify your two highest-priority revision targets for Paper 1. For each, describe one specific practice activity you will complete in the next two weeks to address it.',
        lines: 8,
        modelAnswer:
