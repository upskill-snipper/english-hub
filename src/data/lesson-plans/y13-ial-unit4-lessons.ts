...
export const y13IalUnit4Lessons: LessonPlan[] = [
  // ── Lesson 1: Choosing Your Research Question ─────────────────────────────
  {
    ...
    duration: '90 minutes',
    objectives: [
      'Understand the scope and assessment requirements of WEN04 Language Investigation coursework',
      'Identify productive broad areas for language investigation (gender, dialect, change, media, power, technology)',
      'Distinguish between a research question and a hypothesis and understand when to use each',
      'Evaluate the feasibility, focus, and linguistic value of potential investigation topics',
      'Draft a focused, researchable question or hypothesis for personal investigation',
    ],
    successCriteria: [
      'I can explain what makes a research question appropriately narrow and linguistically focused',
      'I can articulate the difference between a research question and a testable hypothesis',
      'I can identify at least three potential investigation topics and evaluate their strengths and weaknesses',
      'I can produce a draft research question or hypothesis that is specific, feasible, and genuinely linguistic',
      'I can justify my topic choice with reference to linguistic frameworks and areas of interest',
    ],
    keywords: [
      'research question',
      'hypothesis',
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        core: 'Students sort independently and write a justification for each decision before comparing with a partner.',
        stretch:
          'Students attempt to rewrite all four weak questions into appropriately focused versions, then rank them by how interesting they would be to investigate and explain their ranking.',
      },
      resources: [
        'Question sorting cards or slide display',
        'Mini-whiteboards or sorting mat worksheets',
        'Class checklist template on board',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          core: 'Students complete the note-frame independently and generate their own example questions for at least three areas.',
          stretch:
            'Students annotate each of their generated questions using the What / Where / Who / Why framework and assess whether each meets all four criteria.',
        },
        resources: [
          'WEN04 specification overview handout',
          'Annotated slides: six investigation areas with examples',
          'Guided note-frame worksheet',
          'Mini-whiteboards',
        ],
      },
      {
        ...
        differentiation: {
          support:
            'Provide a glossary of terms and a two-column sorting frame. Pair with a peer who can explain their reasoning aloud.',
          core: 'Students classify all six statements, provide written justifications, and suggest one revision for any statement rated below 3.',
          stretch:
            'Students write their own example of both a research question and a hypothesis for the same broad topic, then explain the analytical implications of choosing each approach.',
        },
        resources: [
          'Classification activity worksheet with six statements',
          'Model examples slide',
          'Focus-rating scale reference card',
        ],
      },
      {
        ...
        differentiation: {
          ...
          core: 'Students generate three original questions, receive peer feedback, and write the justification paragraph independently.',
          stretch:
            'Students research one named linguist relevant to their chosen area and incorporate a reference to their theoretical work in the justification paragraph.',
        },
        resources: [
          'Topic suggestion bank handout',
          'Peer-feedback frame',
          'What / Where / Who / Why framework card',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a fourth section: one linguist whose work is relevant to their question and one specific concept from that work they expect to use in their analysis.',
      },
    },
    homework:
      'Carry out preliminary reading on your chosen investigation area. Find and read at least one academic article or textbook chapter related to your topic. Write a 200-word summary of what you have read, identifying two key concepts or findings that are relevant to your investigation question. Bring the summary and your refined question to the next lesson.',
    worksheetQuestions: [
      {
        question:
          'What is the difference between a research question and a hypothesis in a language investigation? Give one example of each.',
        lines: 6,
        modelAnswer:
          'A research question is open-ended and exploratory, asking how or why language behaves in a particular context without predicting the outcome (e.g. "How do primary school teachers use language to manage transitions between activities?"). A hypothesis is a directional, testable prediction about a linguistic relationship (e.g. "Female beauty vloggers use more hedging language than male beauty vloggers in product recommendation videos"). The choice between them depends on whether preliminary reading suggests a probable direction for the findings.',
        marks: 4,
      },
      {
        question:
          'Identify two features of a strong language investigation question and explain why each feature is important.',
        lines: 6,
        modelAnswer:
          'A strong question is specific, naming a particular linguistic feature (e.g. hedging, imperative structures, lexical field) so that analysis remains focused rather than superficial. It is also feasible, meaning the required data can be collected within the available time and without insurmountable ethical or logistical barriers. Specificity matters because broad questions lead to shallow analysis; feasibility matters because even the best question is worthless if data cannot be gathered.',
        marks: 4,
      },
      {
        question:
          'Write a focused research question or hypothesis for a language investigation into language and gender. Apply the What / Where / Who / Why framework to evaluate your question.',
        lines: 8,
        modelAnswer:
          'Hypothesis: "Male and female presenters on BBC Radio 4 discussion programmes use different frequencies of interruption and back-channel behaviour." What: interruption and back-channel behaviour (specific linguistic features). Where: BBC Radio 4 discussion programmes (defined context). Who: male and female presenters (identified language users). Why: this tests Zimmerman and West\'s dominance theory in a contemporary broadcast context, which is linguistically interesting because it allows evaluation of whether gendered patterns have changed since the original 1975 study.',
        marks: 6,
      },
      {
        question:
          'Explain why an investigation entitled "The themes of power in political speeches" would not score well as a language investigation.',
        lines: 4,
        modelAnswer:
          'This topic is essentially a media or literary studies question because it focuses on themes (content) rather than linguistic features. A language investigation must examine specific language features such as modal verbs, pronoun use, rhetorical structures, or lexical choices. A stronger reformulation would be: "How do modal verbs construct authority in Prime Minister\'s Questions: a comparison across three consecutive parliamentary sessions."',
        marks: 3,
      },
    ],
    teacherNotes: [
      ...
      'The homework preliminary reading task is important: students who arrive at Lesson 2 having engaged with a key theorist will have much richer conversations about methodology.',
    ],
    targetedSkills: [
      'AO1: applying linguistic frameworks to define and focus a research question',
      'AO3: understanding the relationship between social context and language use across investigation areas',
      'Independent research and topic selection',
      'Academic writing: formulating hypotheses and research questions with precision',
      'Critical thinking: evaluating the strengths and limitations of investigation topics',
    ],
  },
  ...
  // ── Lesson 2: Collecting Primary Data Ethically ───────────────────────────
  {
    ...
    duration: '90 minutes',
    objectives: [
      'Understand the range of primary data collection methods available for a language investigation',
      'Evaluate the suitability of different data collection methods for different research questions',
      'Apply core principles of research ethics to the context of a language investigation',
      'Design an appropriate sampling strategy for a defined research question',
      'Produce a data collection plan including ethical considerations and a participant consent framework',
    ],
    successCriteria: [
      'I can describe at least four primary data collection methods and identify a research question suited to each',
      'I can explain the ethical principles of informed consent, anonymity, and the right to withdraw',
      'I can design a sampling strategy appropriate for my own investigation question',
      'I can produce a written data collection plan that includes ethical safeguards',
      'I can anticipate practical challenges in data collection and suggest contingency strategies',
    ],
    keywords: [
      'primary data',
      'secondary data',
    ...
    starterActivity: {
      title: 'Data Collection Method Matching Activity',
      duration: '10 minutes',
      instructions:
      ...
      resources: [
        'Matching activity worksheet or card sort',
        'Display slide with eight research questions and eight methods',
      ],
    },
    mainActivities: [
      {
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students write an additional paragraph addressing potential power imbalances between researcher and participant (e.g. if recording a younger sibling or a younger student) and how these might affect the data.',
        },
        resources: [
          'Case study handout (two scenarios)',
          'Participant information sheet template',
          'Ethics principles reference card',
        ],
      },
      {
        ...
        resources: [
          'Sampling strategies reference sheet',
    ...
    plenaryActivity: {
      title: 'Ethical Dilemma Quick-Fire Discussion',
      duration: '13 minutes',
      instructions:
    ...
    homework:
      'Finalise your data collection plan based on peer feedback from today. If your investigation involves human participants, prepare your participant information sheet and consent form. Begin collecting data or identifying your written corpus. Aim to have at least a preliminary data set ready to discuss in Lesson 4.',
    worksheetQuestions: [
      {
        question:
    ...
    teacherNotes: [
      'Emphasise that data collection planning is one of the most common areas where students underestimate the time required. A realistic timeline should be discussed explicitly.',
      'Students investigating social media language need to understand the distinction between publicly available posts (which do not require consent in the same way) and direct messages or private groups (which do). This is worth a brief discussion.',
      'The participant consent form they draft in this lesson should be a genuine working document they use if their investigation involves participants. Encourage them to keep a copy in their investigation folder.',
      'Some students will want to use family members as participants. While acceptable, they should be warned that this can lead to observer effect issues and may reduce the analytical interest of the data.',
      'If time allows, briefly introduce transcription conventions (Jefferson notation) so students begin to think about how spoken data will be presented in the appendix.',
    ],
    targetedSkills: [
      'AO1: selecting and applying appropriate methods for gathering and organising data',
      'Research design: constructing a principled methodology with clear ethical safeguards',
      'AO2: understanding the importance of context in shaping data collection decisions',
      'Academic integrity: applying ethical principles to primary research',
      'Planning and organisation: producing a realistic and detailed data collection timeline',
    ],
  },
  ...
  // ── Lesson 3: Qualitative vs Quantitative Analysis Methods ───────────────
  {
    ...
    duration: '90 minutes',
    objectives: [
      'Distinguish clearly between qualitative, quantitative, and mixed-methods approaches to linguistic analysis',
      'Evaluate the strengths and limitations of each methodological approach in the context of a language investigation',
      'Apply quantitative analysis techniques to a provided data sample, producing frequency tables and percentage comparisons',
      'Apply qualitative analysis techniques to the same data, producing a close linguistic commentary',
      'Select and justify the most appropriate methodology for their own investigation',
    ],
    successCriteria: [
      'I can define qualitative and quantitative research and explain the key difference between them',
      'I can produce a frequency table for a linguistic feature in a data sample',
      'I can write a close qualitative commentary on selected examples from the data',
      'I can explain why a mixed-methods approach is often most effective for a language investigation',
      'I can justify my chosen methodology with reference to my research question and the type of data I am collecting',
    ],
    keywords: [
      'qualitative',
      'quantitative',
    ...
    starterActivity: {
      title: 'What Does the Number Tell Us? Discussion Starter',
      duration: '10 minutes',
      instructions:
      ...
      resources: ['Statistics display slide', 'Mini-whiteboards or individual writing paper'],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support: 'Provide a partially completed comparison table for students to finish.',
          core: 'Students complete the full table, adding their own examples and notes.',
          stretch:
            'Students add a third column for mixed methods and consider how a two-stage analysis (quantify then qualify) would work for their specific investigation.',
        },
        resources: [
          'Methodology comparison table (printout)',
          'Worked example slides: estate agent descriptions',
        ],
      },
      {
        ...
        resources: [
          'Two printed transcript extracts',
          'Frequency table template',
          'Feature identification reference card',
        ],
      },
      {
        ...
        differentiation: {
          ...
          core: 'Students write three commentaries using appropriate linguistic terminology without scaffolding.',
          stretch:
            'Students write a reflective paragraph evaluating the combined value of their quantitative table and qualitative commentaries, and what a reader would gain from each.',
        },
        resources: [
          'Same transcript extracts used in previous activity',
          'Commentary frame (support version)',
    ...
    homework:
      'Using your data collection plan from Lesson 2, begin your data collection if you have not already done so. While waiting for data, carry out further reading on the methodology most relevant to your investigation. Write 150 words explaining what variables you are measuring and how your methodology addresses the concepts of reliability and validity.',
    worksheetQuestions: [
      {
        question:
          'Explain the difference between qualitative and quantitative research. Which approach focuses on frequency and pattern, and which focuses on meaning and function?',
        lines: 5,
        modelAnswer:
          'Quantitative research focuses on measuring and counting linguistic features to identify patterns, frequency, and distribution, producing numerical data that can be displayed in tables and graphs. Qualitative research focuses on the meaning, function, and effect of language choices in context, producing interpretive analysis grounded in close reading of specific examples. Quantitative research is better suited to identifying how often a feature occurs; qualitative research is better suited to explaining why it occurs and what effect it creates.',
        marks: 4,
      },
      {
        question:
          'What is an operational definition and why is it important in quantitative linguistic analysis?',
        lines: 4,
        modelAnswer:
          'An operational definition specifies in advance exactly what will and will not be classified as a particular linguistic feature, so that counting is consistent and replicable. For example, a researcher investigating hedging must define precisely which expressions count as hedges before counting begins (e.g. including "sort of," "kind of," "I think," and "maybe" but not "perhaps" if it appears in a formal register). Without an operational definition, the same data could be counted differently by different researchers, undermining reliability.',
        marks: 3,
      },
      {
        question:
          'Why might a mixed-methods approach produce a more complete analysis than either a purely qualitative or purely quantitative approach alone?',
        lines: 5,
        modelAnswer:
          'A purely quantitative approach reveals patterns but cannot explain what individual instances of a feature mean in context or why speakers make particular choices. A purely qualitative approach produces rich interpretation but may not reveal whether patterns are consistent across the whole data set or whether they are representative rather than exceptional. A mixed-methods approach combines both: the quantitative element establishes broad patterns across the data, and the qualitative element explains what those patterns mean and how they function. This gives the investigation both rigour (breadth, replicability) and depth (contextual, interpretive insight).',
        marks: 5,
      },
    ],
    teacherNotes: [
      'The frequency-counting activity often exposes inconsistency: different students classify the same item differently. Use this as a teaching moment about the importance of operational definitions and consistent categorisation criteria.',
      'Some students default to purely quantitative approaches because they feel more "scientific." Remind them that linguistics is both a social and a scientific discipline and that qualitative analysis of how language works in context is central to high-quality investigation.',
      'The worked example using estate agent descriptions is a safe choice because it requires no ethical considerations and the language is rich enough for demonstration purposes. Have a set of printed estate agent descriptions available as a backup activity if any group finishes early.',
      'Students who are investigating spoken language need to understand that transcription itself is a form of data preparation, not analysis. Make this distinction clear before Lesson 5.',
    ],
    targetedSkills: [
      'AO1: selecting and applying appropriate analytical frameworks to linguistic data',
      'AO2: close analysis of language in context using appropriate terminology',
      'Quantitative skills: constructing frequency tables and calculating proportional distributions',
      'Qualitative skills: writing interpretive commentary grounded in linguistic evidence',
      'Methodological thinking: justifying analytical choices in relation to a research question',
    ],
  },
  ...
  // ── Lesson 4: Applying Linguistic Frameworks to Data ─────────────────────
  {
    ...
    duration: '90 minutes',
    objectives: [
      'Identify the range of linguistic frameworks applicable to language investigation data',
      'Apply phonological, lexical, grammatical, semantic, pragmatic, and discourse frameworks to sample data',
      'Select the most appropriate framework(s) for a given research question and data type',
      'Produce a multi-framework analytical commentary on a short extract of data',
      'Understand how frameworks interact: how one linguistic level can reinforce patterns observed at another',
    ],
    successCriteria: [
      'I can name and briefly define six key linguistic frameworks used in language investigation analysis',
      'I can identify examples of at least three frameworks operating in a short data extract',
      'I can write an analytical commentary that moves fluently between frameworks and uses appropriate terminology',
      'I can explain how the frameworks I have chosen connect to my research question',
      'I can evaluate what each framework reveals and what it leaves unexplained in relation to my data',
    ],
    keywords: [
      'phonology',
      'lexis',
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students add one annotation of their own to the extract, identifying a feature their partner missed, and classify it by framework.',
      },
      resources: [
        'Annotated transcript extract (printed)',
    ...
    mainActivities: [
      {
        ...
        resources: [
          ...
          'Analytical sentence template card',
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Teacher works with a small group, guiding annotation step-by-step. Provide a reduced list of two pre-selected frameworks for these students to focus on.',
          core: 'Students work independently with the analytical sentence template available for reference.',
          stretch:
      ...
      },
      {
        ...
        resources: ['Discussion frame (support version only)'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students add a fourth question of their own choosing: what is the most significant gap in what your chosen frameworks can reveal, and how might you address this gap?',
      },
    },
    homework:
      'Apply your chosen frameworks to your own data. Annotate at least two pages (or equivalent) of your data and write a 250-word analytical commentary using the sentence template as a guide. Bring your annotated data and commentary draft to Lesson 5.',
    worksheetQuestions: [
      {
        question:
          'Name four linguistic frameworks used in language investigation analysis and give one specific feature associated with each.',
        lines: 6,
        modelAnswer:
          'Lexis: word choice, including semantic fields, formality levels, and evaluative language. Grammar: sentence type distribution, use of modal verbs, passive constructions, and nominalisation. Pragmatics: speech acts, face-threatening acts, politeness strategies, and implicature. Discourse: structural patterns, cohesive devices, turn-taking, and topic management.',
        marks: 4,
      },
      {
        question:
          'Using the analytical sentence template, write one sentence of analysis for the following example: a speaker says "I was sort of wondering if you might be able to help me at some point."',
        lines: 4,
        modelAnswer:
          'At the level of pragmatics, the speaker uses multiple hedging expressions ("sort of wondering," "might be able," "at some point") which function to minimise the imposition of the request on the hearer, suggesting a concern for positive face and the employment of Brown and Levinson\'s negative politeness strategy of indirectness.',
        marks: 4,
      },
      {
        question:
          'Explain what is meant by "frameworks interacting" in linguistic analysis and give one example.',
        lines: 5,
        modelAnswer:
          'Frameworks interact when a pattern identified at one linguistic level is reinforced, complicated, or explained by analysis at another level. For example, in an estate agent property description, the lexical choice "contemporary" (lexical level: evaluative, aspirational connotation) interacts with an implicit pragmatic promise about lifestyle identity (pragmatic level: implicature that the buyer will be modern and stylish), so that meaning is created through the relationship between the two levels simultaneously.',
        marks: 4,
      },
    ],
    teacherNotes: [
    ...
    targetedSkills: [
      'AO1: applying linguistic frameworks systematically and using accurate terminology',
      'AO2: analysing language in context with precision and interpretive depth',
      'Analytical writing: structuring commentary to move from feature identification to interpretation',
      'Multi-level analysis: recognising how different frameworks illuminate different aspects of data',
      'Critical thinking: selecting and justifying the most productive analytical tools for a given question',
    ],
  },
  ...
  // ── Lesson 5: Writing the Hypothesis and Methodology Section ─────────────
  {
    ...
    duration: '90 minutes',
    objectives: [
      'Understand the function and expected content of the introduction and methodology sections in a language investigation report',
      'Write a focused, academically precise hypothesis or research question with full contextualisation',
      'Draft a methodology section that addresses data collection, sampling, analytical approach, and ethical considerations',
      'Apply academic register and formal hedging language appropriate to research writing',
    ...
    successCriteria: [
      ...
      'I can explain why the methodology section must be written before analysis begins',
    ],
    keywords: [
      'methodology',
      'hypothesis',
    ...
    starterActivity: {
      ...
      resources: [
        'Two contrasting methodology paragraphs (printed or displayed)',
        'Annotation guide (support version)',
      ],
    },
    mainActivities: [
      {
        ...
        resources: [
          'Worked example introduction (displayed)',
          'Five-sentence introduction frame (support version)',
          'Named theorists reference list by investigation area',
        ],
      },
      {
      ...
      },
      {
        ...
        differentiation: {
          support: 'Provide a word bank of formal alternatives and passive constructions.',
          core: 'Students rewrite all five sentences independently.',
          stretch:
            'Students identify a sentence from their own draft that reads informally and produce a formal version of it.',
        },
        resources: [
          'Five informal sentence display',
          'Academic register word bank (support version)',
        ],
      },
    ],
    plenaryActivity: {
      title: 'Peer Review: Introduction and Methodology',
      duration: '13 minutes',
      instructions:
    ...
    worksheetQuestions: [
      {
        question:
          'What are the five key elements that a language investigation introduction should include?',
        lines: 5,
        modelAnswer:
          'The introduction should contextualise the broad area of linguistic study (e.g. language and gender, language and dialect); state the specific research question or hypothesis clearly; justify why the topic is linguistically interesting or significant; briefly acknowledge relevant prior research or theoretical context; and signpost the structure of the report so the reader knows what to expect.',
        marks: 5,
      },
      {
        question:
          'Rewrite the following sentence in formal academic register: "I decided to use a mixed methods approach because I thought it would give me better results."',
        lines: 3,
        modelAnswer:
          'A mixed-methods approach was adopted for this investigation in order to combine the breadth of quantitative frequency analysis with the interpretive depth of qualitative close reading, thereby producing a more comprehensive account of the patterns present in the data.',
        marks: 3,
      },
      {
        question:
    ...
    teacherNotes: [
      'The most common weakness in student methodology sections is vagueness: "I collected some transcripts and analysed them." Push students for precise details: how many transcripts, of what length, from what source, using what collection method, with which participants?',
      'Academic register is a skill that needs sustained practice. The register workshop activity in this lesson should be revisited in Lesson 8 when students are drafting the analysis section.',
      'Collect the introduction and methodology drafts after this lesson if possible and provide brief written comments before Lesson 6. Specific feedback at this stage can significantly improve the quality of the full draft.',
      'Some students find the passive voice unnatural. Reassure them that passive constructions are conventional in research writing, not a stylistic weakness, and model several examples from published linguistic research.',
    ],
    targetedSkills: [
      'AO1: writing a clear, principled methodology section that demonstrates understanding of research design',
      'Academic writing: using formal register, passive voice, and appropriate hedging in research writing',
      'AO3: contextualising the investigation within relevant theoretical frameworks',
      'Self-assessment: identifying gaps in a draft against explicit criteria',
      'Peer review: giving targeted, constructive feedback on academic writing',
    ],
  },
  ...
  // ── Lesson 6: Analysing Patterns in Your Data ────────────────────────────
  {
    ...
    duration: '90 minutes',
    objectives: [
      'Systematically identify recurring linguistic patterns within a primary data set',
      'Distinguish between data patterns that are significant and those that may be incidental',
      'Develop an analytical commentary that connects patterns to the research question',
      'Use data visualisation (frequency tables, annotated extracts) to support and present analysis',
      'Begin drafting the analysis section of the investigation report',
    ],
    successCriteria: [
      'I can identify at least three significant recurring patterns in my data set',
      'I can explain why each pattern is relevant to my research question',
      'I can write an analytical paragraph that moves from pattern identification to interpretation to theoretical connection',
      'I can produce a simple data visualisation (frequency table or annotated extract) for at least one pattern',
      'I can evaluate which patterns in my data are most significant and justify my selection',
    ],
    keywords: [
      'pattern',
      'trend',
    ...
    starterActivity: {
      ...
      resources: [
        'Shared dating profile extract (printed)',
        'Guided annotation sheet (support version)',
      ],
    },
    mainActivities: [
      {
      ...
      },
      {
        ...
        differentiation: {
          ...
          core: 'Students draft two full paragraphs independently and peer-check for PEEL structure.',
          stretch:
            'Students write a linking sentence between their two paragraphs that shows how the two patterns connect or contrast with each other, developing a cumulative argument.',
        },
        resources: [
    ...
    plenaryActivity: {
      title: 'Pattern Priority Pyramid',
      duration: '13 minutes',
      instructions:
    ...
    homework:
      'Continue drafting your analysis section. Aim to have written a minimum of three PEEL analytical paragraphs covering your three most significant patterns, each with at least one piece of specific evidence from your data. Bring your draft to Lesson 7 for peer review and development.',
    worksheetQuestions: [
      {
        question:
          'What is meant by a "significant" pattern in the context of language investigation data analysis? Identify three criteria that help determine significance.',
        lines: 5,
        modelAnswer:
          'A significant pattern is one that appears consistently and meaningfully across the data set rather than being isolated or coincidental. Three criteria for significance are: frequency (the pattern appears in multiple instances across the data rather than occurring once); consistency (the pattern holds across different parts of the data set or across different participants); and relevance (the pattern is directly connected to the research question or hypothesis, revealing something meaningful about the linguistic behaviour being investigated).',
        marks: 5,
      },
      {
        question:
          'Explain each stage of the PEEL paragraph structure as applied to language investigation analysis.',
        lines: 6,
        modelAnswer:
          'Point: state the linguistic pattern or finding clearly, naming the feature and the framework to which it belongs. Evidence: quote or cite a specific example from the data that illustrates the pattern, using accurate data references. Explain: analyse the language feature using appropriate linguistic terminology, applying the relevant framework to explain what the feature is doing in context and what effect it creates. Link: connect the analysis to the research question or hypothesis, and where possible to a relevant linguistic theory or concept, showing how this finding contributes to answering the investigation question.',
        marks: 4,
      },
      {
        question:
    ...
    targetedSkills: [
      'AO1: applying analytical frameworks to identify and explain patterns in data',
      'AO2: producing close analysis of linguistic evidence with accurate terminology',
      'Analytical writing: structuring analysis using the PEEL paragraph model',
      'Data organisation: categorising and prioritising findings for investigative rigour',
      'Evaluative thinking: assessing the significance and representativeness of data patterns',
    ],
  },
  ...
  // ── Lesson 7: Discussing Findings with Academic Reference ────────────────
  {
    ...
    duration: '90 minutes',
    objectives: [
      'Understand the function of the discussion section in a language investigation report',
      'Connect personal data findings to named linguistic theories and academic research',
      'Evaluate the extent to which findings support, challenge, or nuance existing theoretical positions',
      'Write a discussion section that moves beyond description to critical academic engagement',
      'Demonstrate awareness of the limitations of findings and the broader significance of the investigation',
    ],
    successCriteria: [
      'I can identify at least two named theories or frameworks relevant to my investigation findings',
    ...
    starterActivity: {
      title: 'Theory Connection Speed Match',
      duration: '10 minutes',
      instructions:
    ...
    mainActivities: [
      {
        ...
        resources: [
          'Worked discussion paragraph (printed)',
          'Colour-coded version (support)',
          'Five-element checklist',
        ],
      },
      {
        title: 'Drafting Your Own Discussion Section',
        duration: '35 minutes',
        instructions:
          'Students draft their own discussion section, working from their PEEL analysis paragraphs drafted in Lesson 6. They must include at least two explicit references to named linguistic theories or named linguists. Teacher circulates, prompting students who are describing findings rather than evaluating them ("Does this support Lakoff\'s features of women\'s language, or does it complicate them? Be specific about which feature."). After 25 minutes of drafting, students carry out a "theory count": how many named theorists or specific theories appear in their discussion? If fewer than two, they have 5 minutes to add references and integrate them meaningfully.',
        differentiation: {
          support:
            'Provide a discussion starter template and a reference sheet of named theorists by investigation area with one key concept noted for each.',
          core: 'Students draft independently using their analysis as a starting point.',
          stretch:
            'Students write a section evaluating two different theoretical positions that could explain the same finding and argue which offers the more convincing account.',
        },
        resources: [
    ...
    plenaryActivity: {
      title: 'Critical Friend: Theory Integration Review',
      duration: '13 minutes',
      instructions:
        'Students exchange discussion drafts with a partner whose investigation topic is in a different area. The reviewer reads the draft and answers three questions in writing: (1) Can you identify at least two specific named theories or theorists? Are they integrated meaningfully or just mentioned in passing? (2) Does the writer evaluate the fit between their findings and the theory, or do they just say the findings "agree with" the theory? (3) Is the limitation paragraph specific and analytically aware? Partners return drafts with written comments. Students have 3 minutes to note one revision they will prioritise.',
      differentiation: {
        support: 'Reviewers focus on question 1 only.',
        core: 'Reviewers answer all three questions with specific textual evidence from the draft.',
        stretch:
          'Reviewers suggest one additional theory not currently mentioned in the draft that could be productively applied to the findings.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is the difference between the analysis section and the discussion section of a language investigation?',
        lines: 4,
        modelAnswer:
          'The analysis section presents and interprets the findings from the data, describing what patterns are present and explaining their linguistic function using close reading and appropriate frameworks. The discussion section moves beyond the data itself to consider what the findings mean in the context of existing linguistic theory and research, evaluating how well findings align with or challenge established theoretical positions, acknowledging limitations, and considering the broader implications for our understanding of the linguistic behaviour studied.',
        marks: 4,
      },
      {
        question:
          'Explain what is meant by "evaluating the fit" between your data and a named theory. Why is this more valuable than simply saying your data "supports" the theory?',
        lines: 5,
        modelAnswer:
          'Evaluating the fit means critically examining the degree to which the findings match the predictions of a theory, including noting any aspects that do not fit, any conditions under which the theory applies or breaks down, and any ways in which the data complicates or nuances the theoretical claim. Simply saying data "supports" a theory is descriptive rather than analytical; it does not demonstrate critical engagement with the theory. Evaluating fit shows understanding that theories have limitations and that real-world data is complex, which is the mark of a sophisticated linguistic investigator.',
        marks: 4,
      },
      {
        question:
          'Write a specific limitation sentence for an investigation into gendered language in workplace email correspondence, explaining how the limitation affects the conclusions.',
        lines: 4,
        modelAnswer:
          'The data set of twenty emails, drawn from a single organisation in the financial sector, limits the generalisability of the findings: the professional culture and register norms of this particular workplace may produce gendered language patterns that are not representative of workplace email communication more broadly, meaning that the conclusions should be treated as findings specific to this community of practice rather than as universally applicable statements about gendered email language.',
        marks: 4,
      },
    ],
    teacherNotes: [
    ...
    targetedSkills: [
      'AO3: understanding linguistic concepts and applying them to contextualise investigation findings',
      'AO1: writing a discussion section that demonstrates critical and analytical engagement',
      'Academic writing: integrating theoretical reference precisely and meaningfully',
      'Critical thinking: evaluating the relationship between data and theory',
      'Metacognitive awareness: acknowledging limitations and implications of research',
    ],
  },
  ...
  // ── Lesson 8: Structuring the Investigation Report ────────────────────────
  {
    ...
    duration: '90 minutes',
    objectives: [
      'Understand the conventional structure of a language investigation report and the function of each section',
      'Apply effective signposting and cohesive devices to create a coherent, well-structured report',
      'Evaluate and reorganise a full draft investigation for structural clarity and logical progression',
      'Present data appendices correctly and reference them appropriately in the main text',
      'Review word count allocation across sections and revise to meet specification requirements',
    ],
    successCriteria: [
      'I can describe the function of each section of the investigation report (introduction, methodology, analysis, discussion, conclusion, appendices)',
      'I can use signposting language to guide the reader through the report and signal transitions between sections',
      'I can evaluate the structural coherence of a draft report and identify specific improvements',
      'I can present my data appendix correctly and reference it in the main text',
      'I can allocate my word count appropriately across sections to maximise analytical depth',
    ],
    keywords: [
      'signposting',
      'cohesion',
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support: 'Provide a model appendix page to copy as a template.',
          core: 'Students review their own appendix against the presentation checklist.',
          stretch:
            'Students produce a full bibliography in correct format for all sources referenced in their report, using the Harvard referencing style.',
        },
        resources: [
          'Model appendix page',
          'Appendix presentation checklist',
          'Harvard referencing guide for linguistics sources',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students add three additional criteria of their own based on the marking criteria for AO1, AO2, and AO3.',
      },
    },
    homework:
      'Using your structural self-review checklist, revise your full draft to address any incomplete or missing elements. Focus particularly on: expanding analysis paragraphs if they are under-developed, adding signposting language at section transitions, and ensuring the appendix is correctly formatted and fully referenced in the main text. Bring your revised full draft to Lesson 9.',
    worksheetQuestions: [
      {
        question:
      ...
      {
        question:
          'Write one structural signpost sentence for each of the following transitions: (a) from the methodology section to the analysis section; (b) from the analysis section to the discussion section.',
        lines: 4,
        modelAnswer:
          '(a) "Having established the data collection process and the analytical frameworks that will be applied, the following section presents a systematic analysis of the patterns identified within the corpus." (b) "Having identified the key patterns present in the data, the discussion section will now contextualise these findings within the existing theoretical literature, evaluating the degree to which they support or challenge established accounts of [topic area]."',
        marks: 4,
      },
    ],
    teacherNotes: [
    ...
    targetedSkills: [
      'AO1: structuring the investigation report according to academic conventions',
      'Academic writing: using cohesive devices and signposting language to create a coherent, readable report',
      'Report organisation: allocating content appropriately across sections to maximise analytical depth',
      'Presentation skills: formatting appendices and referencing data correctly',
      'Self-regulation: using a structured checklist to drive independent revision',
    ],
  },
  ...
  // ── Lesson 9: Writing Conclusions and Evaluations ────────────────────────
  {
    ...
    successCriteria: [
      'I can write a conclusion that directly answers my research question or assesses my hypothesis in light of the evidence',
      'I can use appropriately hedged language to qualify the scope of my conclusions',
      'I can write an evaluative paragraph that honestly assesses the strengths and limitations of my investigation',
      'I can suggest one specific direction for further research with a clear linguistic rationale',
      'I can distinguish between a conclusion (answering the question) and a summary (restating the findings)',
    ],
    keywords: [
      'conclusion',
      'evaluation',
    ...
    starterActivity: {
      title: 'Strong or Weak Conclusion? Comparative Analysis',
      duration: '12 minutes',
      instructions:
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: [
          'Worked evaluation paragraph model',
          'Four-element evaluation frame (support version)',
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'What should a suggestion for further research include? Write a suggestion for further research related to an investigation into dialect variation in media broadcasting.',
        lines: 5,
        modelAnswer:
          'A suggestion for further research should specify a new question or approach that directly addresses a limitation of the current investigation. For example: "Future research could examine a substantially larger corpus of broadcast speech drawn from regional as well as national channels, using a longitudinal design that tracks the same presenters over several years. This would address the current study\'s limitation of small sample size and allow conclusions about whether dialect levelling in broadcast language is a stable trend or a context-specific phenomenon."',
        marks: 4,
      },
    ],
    teacherNotes: [
  ...
  // ── Lesson 10: Peer Review and Final Submission Preparation ──────────────
  {
    ...
    duration: '90 minutes',
    objectives: [
      'Conduct a thorough peer review of a complete draft language investigation using mark-scheme criteria',
      'Implement targeted revisions in response to peer and teacher feedback',
      'Review the complete investigation for accuracy of linguistic terminology, consistency of register, and structural coherence',
      'Prepare the final investigation for submission, ensuring all components are correctly presented',
    ...
    successCriteria: [
      ...
      'I can articulate what I have learned about language investigation methodology that I would apply differently if starting again',
    ],
    keywords: [
      'peer review',
      'mark scheme',
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: [
          'Revision priority plan template',
          'Linguistic terminology accuracy checklist',
          'Peer feedback received',
        ],
      },
      {
        title: 'Final Submission Checklist and Authentication',
        duration: '10 minutes',
        instructions:
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a fourth reflection: how has conducting this investigation changed their understanding of a specific linguistic concept or theory introduced earlier in the A Level?',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is the difference between AO1 and AO2 in the WEN04 mark scheme? Give one example of what each would look like in a language investigation.',
        lines: 6,
        modelAnswer:
          'AO1 assesses the application of linguistic frameworks and methods and the demonstration of knowledge of linguistic concepts: it is largely addressed through the methodology section (where the investigator explains and justifies their analytical approach) and through the accurate use of linguistic terminology throughout the report. AO2 assesses the quality of linguistic analysis and evaluation using appropriate frameworks: it is primarily addressed through the analysis and discussion sections, where the investigator examines specific data examples closely, explains how language features function, and evaluates findings with reference to theory. A strong AO1 response would name and justify the use of the pragmatic framework; a strong AO2 response would then apply that framework to produce specific, insightful analysis of face-threatening acts in the data.',
        marks: 5,
      },
      {
        question:
    ...
    targetedSkills: [
      'AO1: demonstrating methodological rigour and precise use of linguistic frameworks across the full report',
      'AO2: producing close, well-evidenced analysis of real language data',
      'AO3: contextualising findings within established theoretical frameworks',
      'Peer review: giving and applying specific, criterion-referenced feedback to improve academic writing',
