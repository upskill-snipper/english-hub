...
export const ks3LessonPlans: KS3LessonPlan[] = [
...

  {
    ...
    crossCurricular: ['Critical thinking', 'Detective/investigation skills', 'Empathy'],
    sendAdaptations:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Two sentence versions (projected)', 'Comparison grid'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Same text in two formats (projected)', 'Response sheet'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Two paired texts (projected)', 'Venn diagram template'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Two versions of same event (projected)', 'Response sheet'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Short rhythmic poem (printed/projected)', 'Open space for movement'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Essay title (projected)', 'Essay structure diagram'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Three story openings (projected)', 'Response sheet'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Object or image', 'Whiteboard for word bank'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Two opposing persuasive texts', 'Technique identifier sheet'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Two example letters (formal and informal)', 'Comparison chart'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['News story with 5 different headlines', 'Response sheet'],
    },
    mainActivity: {
      description:
    ...
    crossCurricular: ['Media literacy', 'Citizenship (current events)', 'Journalism'],
    sendAdaptations:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Audio clip of famous speech (30 seconds)', 'Speakers'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Three extracts on same scene from different authors', 'Comparison chart'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Two versions of same paragraph', 'Audio of both read aloud'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Sentence with three punctuation versions', 'Response sheet'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Sentences with weak word choices', 'Whiteboard for alternatives'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Video clip of effective presentation', 'Observation checklist'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Short story or article to read aloud'],
    },
    mainActivity: {
      description:
...

  {
    ...
    starterActivity: {
      ...
      duration: '8 mins',
      resources: ['Video clip of formal debate', 'Observation checklist'],
    },
    mainActivity: {
      description:
