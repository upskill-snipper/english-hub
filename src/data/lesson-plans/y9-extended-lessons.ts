...
export const y9ExtendedLessons: LessonPlan[] = [
  ...
  // ── Lesson y9ext-01: Creative Writing Workshop — Narrative ────────────────
  {
    ...
    worksheetQuestions: [
      {
        question: 'Name three structural techniques a writer can use in a narrative and explain what each one does.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'How does varying sentence length help a writer to control pace and tension? Give an example.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Write the opening two sentences of a narrative set in an abandoned building. Focus on creating atmosphere.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson y9ext-02: Transactional Writing — Crafting a Speech ───────────
  {
    ...
    worksheetQuestions: [
      {
        question: 'Explain the difference between pathos, ethos, and logos as persuasive strategies.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'What distinguishes a speech from a formal essay? Give two structural and two language differences.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson y9ext-03: Cross-Text Comparison — A Christmas Carol & OMAM ─────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Reduce to three connectives and provide half-completed sentences for students to finish.',
  ...
  // ── Lesson y9ext-04: GCSE-Readiness Assessment ───────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide the question with key words already highlighted and a simplified mark scheme summary.',
        core: 'Students annotate and decode the question independently before the feedback.',
        stretch: 'Students identify which assessment objective (AO1/AO2/AO3) each part of the mark scheme tests.',
      },
      resources: [
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch: 'Students plan four paragraphs and decide which order gives the strongest argument before writing.',
        },
      ...
      },
      {
        ...
        resources: ['Blank lined paper or assessment booklets', 'Timer', 'Text copies if open-book assessment'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Read each self-assessment question aloud and give students 30 seconds to circle YES / PARTLY / NOT YET for each.',
        core: 'Students complete the grid independently.',
        stretch: 'Students write a one-sentence target for their next essay based on their honest self-assessment.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question: 'What do the three GCSE literature assessment objectives (AO1, AO2, AO3) each assess?',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'Why is planning essential in a timed literary essay? What should a good plan contain?',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson y9ext-05: Grammar Consolidation for GCSE ─────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide a hint card naming the type of error for each sentence so students know what to look for.',
      ...
      resources: ['Error sentences on slides', 'Mini-whiteboards', 'Grammar hint cards (for support)'],
    },
    mainActivities: [
      {
        ...
        resources: ['Sentence transformation worksheet', 'Clause types reference card', 'Annotated model sentences'],
      },
      {
        ...
        differentiation: {
          support: 'Reduce to five sentences with a choice of two punctuation marks per sentence rather than open-ended selection.',
        ...
        resources: ['Punctuation transformation worksheet', 'Colon/semi-colon/dash reference guide', 'Model examples'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Circle the four errors in the weak paragraph so students can focus on correcting them first before improving the structure.',
    ...
    worksheetQuestions: [
      {
        question: 'Explain the difference between a main clause and a subordinate clause. Give an example of each.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Rewrite this sentence to make it more sophisticated: "Steinbeck makes Curley\'s wife seem lonely. She has no real friends."',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'When should a writer use a semi-colon rather than a full stop? Give an original example.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson y9ext-06: Vocabulary Building for GCSE ────────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Synonym cards (one set per pair)', 'Spectrum line on board or as a printed worksheet'],
    },
    mainActivities: [
      {
      ...
      },
      {
        ...
        resources: ['Three weak paragraphs handout', 'Vocabulary list for reference', 'Peer comparison discussion prompt'],
      },
    ],
    plenaryActivity: {
  ...
  // ── Lesson y9ext-07: Reading Unseen Extracts (GCSE Preparation) ──────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Unseen extract (printed, one per student)', 'Mini-whiteboards or blank paper for recall'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a highlighted version of both responses with colour-coding: blue = technique, yellow = quotation, green = effect.',
  ...
  // ── Lesson y9ext-08: Exam Question Deconstruction (GCSE Style) ───────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide one sentence of teacher commentary on each response to help students identify the key differences.',
  ...
  // ── Lesson y9ext-09: Mock Assessment Debrief ─────────────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Returned marked essays', 'Feedback audit sticky note or mini-worksheet', 'AO reference card'],
    },
    mainActivities: [
      {
        ...
        resources: ['Class-level analysis summary (prepared from marked essays)', 'Colour pens for annotation'],
      },
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a sentence frame: "In my next essay, I will ___ so that I can improve my ___."',
        core: 'Students write a full SMART target independently.',
        stretch: 'Students write two SMART targets: one for content/knowledge and one for analytical technique.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question: 'What makes a SMART target more useful than a general target? Give an example of each.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson y9ext-10: End-of-Year Reflection and GCSE Preparation Planning ─
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide a partially completed timeline with the key texts already labelled, so students add skills and activities.',
      ...
      resources: ['Blank timeline on board', 'Year 9 overview handout (teacher prepared)', 'Sticky notes for student contributions'],
    },
    mainActivities: [
      {
        ...
        resources: ['GCSE Overview Sheet (board-specific — prepared by teacher)', 'Annotation pens'],
      },
      {
