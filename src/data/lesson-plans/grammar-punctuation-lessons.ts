...
const lesson1: LessonPlan = {
  ...
  keywords: [
    'simple sentence', 'compound sentence', 'complex sentence', 'subordinate clause',
    'coordinating conjunction', 'independent clause', 'sentence variety',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a reference card defining each sentence type with an example before sorting begins.',
      core: 'Students sort independently and write a one-sentence justification for each category decision.',
      stretch: 'Students identify the subordinate clauses in the complex sentences and explain their grammatical function.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a word bank of coordinating conjunctions (FANBOYS) and subordinating conjunctions. Sentences are pre-labelled with colour-coded parts.',
        core: 'Students complete all three tasks independently and self-check using the answer key on the reverse of the worksheet.',
        stretch: 'Students write five original sentences — one simple, two compound with different conjunctions, and two complex with the subordinate clause in different positions — then annotate the grammatical function of each part.',
      },
      resources: ['Colour-coded model on board', 'Sentence construction worksheet', 'FANBOYS reference card'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a sentence starter bank and an effects glossary (e.g., "creates tension", "builds suspense", "controls pace").',
        core: 'Students write both paragraphs independently and provide written peer feedback using two stars and a wish.',
        stretch: 'Students write a third paragraph that deliberately blends all three types for maximum effect, then annotate their own choices explaining why each sentence type was selected.',
      },
      resources: ['Exemplar extract slide', 'Highlighters', 'Effects glossary (support tier)', 'Peer feedback frame'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Sentence starters provided: "The rain fell, and..." / "As the sky darkened, the rain fell..."',
      core: 'Students write both transformations and a full justification sentence.',
      stretch: 'Students create three different complex sentence versions, varying the position of the subordinate clause, and evaluate which is most effective.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Define a simple sentence, a compound sentence, and a complex sentence. Give one example of each.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Identify the sentence type for each of the following: (a) "She walked to school." (b) "He was tired, but he kept running." (c) "Because the alarm failed, she missed the bus."',
      lines: 3,
      modelAnswer:
    ...
    {
      question: 'Rewrite the following simple sentences as one compound and one complex sentence: "The storm arrived. The streets flooded. People ran for shelter."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain why a writer might use a short simple sentence after a series of long complex sentences. Use an example to support your answer.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Write a paragraph (5-6 sentences) describing a busy market scene. Use at least one of each sentence type and label each sentence with its type.',
      lines: 8,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  keywords: [
    'semicolon', 'colon', 'em dash', 'independent clause',
    'juxtaposition', 'elaboration', 'parenthetical', 'antithesis',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students suggest a context or genre where each version would be most effective and justify their reasoning.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide sentence frames with gaps where the punctuation mark should be inserted, along with a rule summary card.',
        core: 'Students complete practice sentences independently and write one original sentence for each mark.',
        stretch: 'Students write pairs of sentences where changing the punctuation mark changes the emphasis or meaning, then explain the difference.',
      },
      resources: ['Punctuation rules slides', 'Practice sentence worksheet', 'Rule summary card (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a writing frame for the letter with prompts indicating where each punctuation mark should be used. Annotation sentence starters provided.',
        core: 'Students write the letter independently, annotate their punctuation choices, and peer review for accuracy.',
        stretch: 'Students write the letter without a frame, then write a short commentary (50 words) evaluating which punctuation choice was most effective and why.',
      },
      resources: ['Non-fiction extract handout', 'Writing frame (support tier)', 'Peer review checklist'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'After each answer, students write the full sentence with the correct mark and briefly note the effect.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'What is the difference between a colon and a semicolon? Why do students often confuse them?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Insert the correct punctuation mark (semicolon, colon, or dash) in each sentence and explain your choice: (a) "He had one goal _ to win." (b) "The café was empty _ the storm had kept everyone away." (c) "She turned the corner _ and there it was."',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Why might a writer choose to use a dash instead of a comma in a sentence? Give an example to illustrate your answer.',
      lines: 4,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  keywords: [
    'topic sentence', 'paragraph cohesion', 'discourse marker',
    'TEA structure', 'signposting', 'supporting evidence', 'concluding sentence',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide the topic sentence already identified and in position; students order the remaining sentences.',
      core: 'Students reconstruct the full paragraph and identify the topic sentence, explaining their reasoning.',
      stretch: 'Students reconstruct the paragraph, then write an alternative topic sentence that would change the paragraph\'s focus.',
    },
    resources: ['Jumbled paragraph strips (one set per pair)', 'Original paragraph on slide for reveal'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide topic sentence options to choose from rather than writing original ones. Colour-coding guided with labels.',
        core: 'Students colour-code independently, evaluate all three paragraphs, and write original topic sentences.',
        stretch: 'Students rewrite the weak paragraph to match the quality of the excellent one, then annotate the improvements they made.',
      },
      resources: ['TEA model exemplar slide', 'Three-paragraph quality comparison worksheet', 'Highlighters (three colours)'],
    },
    {
      ...
      differentiation: {
        support: 'Full writing frame provided for both paragraphs with sentence starters and a quotation bank.',
        core: 'Writing frame for paragraph one only; paragraph two is independent. Peer feedback using a structured checklist.',
        stretch: 'Both paragraphs written independently. Students add discourse markers to link the two paragraphs cohesively, then evaluate which paragraph is stronger and why.',
      },
      resources: ['Stimulus extract', 'Writing frame (support/core tier)', 'Peer feedback checklist', 'Quotation bank (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Teacher highlights one clue in each weak sentence to help students spot the problem.',
      core: 'Students identify strong and weak sentences and articulate why each is effective or ineffective.',
      stretch: 'Students rewrite all three weak sentences and explain the specific improvement made in each case.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Read the following paragraph and identify the topic sentence. Explain how the rest of the paragraph supports it.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain the TEA paragraph structure. Why is this structure effective for GCSE English responses?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Write a topic sentence for a paragraph that will argue the following: a character in a novel is presented as increasingly isolated.',
      lines: 3,
      modelAnswer:
    ...
    {
      question: 'A student writes: "In this paragraph I am going to talk about the theme of power." Explain why this is a weak topic sentence and rewrite it to make it effective.',
      lines: 5,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  keywords: [
    'active voice', 'passive voice', 'agent', 'subject',
    'emphasis', 'formality', 'impersonal tone', 'transitive verb',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide the two category labels and ask students to sort, rather than identifying the categories themselves.',
      core: 'Students sort and then articulate the grammatical pattern in their own words.',
      stretch: 'Students suggest a reason why passive voice is often used in headlines about crime or politics and connect this to bias or emphasis.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a step-by-step transformation guide and a list of common irregular past participles. Sentences are shorter and simpler.',
        core: 'Students complete all twenty transformations independently and check answers with a partner.',
        stretch: 'Students identify sentences where the passive construction is grammatically possible but stylistically awkward, explaining why active would be preferable.',
      },
      resources: ['Active/passive diagram slide', 'Transformation exercise worksheet', 'Irregular past participle list (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Annotations guided with sentence starters: "The writer uses passive voice here because..." Pre-written event details provided for the writing task.',
        core: 'Students annotate independently and write both versions of the report with a written comparison.',
        stretch: 'Students write a third version that strategically blends active and passive voice, annotating each choice and explaining why it is the most effective version.',
      },
      resources: ['Three extract handout', 'Annotation guidance (support tier)', 'Lined response paper'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Voice is pre-identified for each sentence; students only need to convert and explain.',
      core: 'Students complete all three tasks for each sentence independently.',
      stretch: 'Students write a rule or guideline about when to use each voice, based on the patterns they have observed in the lesson.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain the difference between active and passive voice. Give one example of each.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Convert the following sentences from active to passive voice: (a) "The council demolished the building." (b) "Scientists discovered a new species." (c) "The goalkeeper saved the penalty."',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Why is passive voice commonly used in scientific writing and formal reports? Give an example.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'A student writes: "Mistakes were made." Explain why a politician might choose this passive construction and what effect it creates.',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  keywords: [
    'subject-verb agreement', 'singular', 'plural', 'intervening phrase',
    'compound subject', 'tense consistency', 'pronoun reference', 'homophone',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students find all errors, correct them, and explain the grammatical rule that each error violates.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Students receive a rule card summarising all five rules with examples. Practice sentences include the subject underlined to aid identification.',
        core: 'Students complete all practice sentences and the quiz independently, then peer-mark.',
        stretch: 'Students write their own "tricky" agreement sentences to test a partner, focusing on intervening phrases and collective nouns.',
      },
      resources: ['Rules presentation slides', 'Practice sentences worksheet', 'Rule summary card (support tier)', 'Ten-sentence quiz'],
    },
    {
      ...
      differentiation: {
        support: 'Stations include a rule reminder at the top of each task card. Sentences are shorter and errors are more obvious.',
        core: 'Students complete all four stations independently and self-check using the answer sheets.',
        stretch: 'At each station, students add two original examples of the error type and explain why each is problematic.',
      },
      resources: ['Four station task cards with answer sheets', 'Timer for rotations', 'Rule reminders (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Team includes a stronger student who checks corrections before the paragraph is passed on. Error types are labelled.',
      core: 'Teams work collaboratively, discussing corrections before writing them.',
      stretch: 'Teams must also explain the rule each error violates in a brief annotation beside each correction.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Choose the correct verb form and explain your choice: "The group of students (was/were) waiting outside the hall."',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Identify and correct the subject-verb agreement error in each sentence: (a) "Neither the teacher nor the students was prepared." (b) "Everyone in the classes are expected to attend." (c) "The news are reported every evening."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain why tense consistency is important in writing. Give an example of a tense consistency error and correct it.',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Choose the correct homophone and explain your reasoning: (a) "The dog wagged (its/it\'s) tail." (b) "(There/Their/They\'re) going to the cinema." (c) "The decision will (affect/effect) everyone."',
      lines: 5,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  keywords: [
    'apostrophe', 'contraction', 'possession', 'singular possessive',
    'plural possessive', 'irregular plural', 'omission',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a checklist: "Is it a contraction? Is it showing possession? If neither, remove the apostrophe."',
      core: 'Students identify errors and state the rule that has been broken.',
      stretch: 'Students explain why each error has occurred (e.g., confusion between plural and possessive) and write the correct version.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Exercise sheet has rules printed at the top of each section. Focus on sections 1-3 with extension to 4-5 if ready.',
        core: 'Students complete all five sections independently and self-check.',
        stretch: 'Students complete all sections and then write five sentences that each use both a contraction and a possessive apostrophe correctly.',
      },
      resources: ['Apostrophe rules presentation', 'Progressive exercise sheet', 'Self-check answer key'],
    },
    {
      ...
      differentiation: {
        support: 'In the proofreading task, errors are highlighted in bold. In the writing task, a word bank of possessive phrases is provided.',
        core: 'Students complete both tasks independently with full annotations.',
        stretch: 'Students write an additional 50 words that include an irregular plural possessive and a sentence contrasting "its" and "it\'s." They also write a brief explanation of why apostrophe accuracy matters for GCSE marks.',
      },
      resources: ['Proofreading passage handout', 'Lined response paper', 'Possessive phrase word bank (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students add a branch for tricky cases (its/it\'s, names ending in s) and test their tree on two additional challenge sentences.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Add apostrophes where needed: (a) "The childrens toys were scattered across the floor." (b) "Its been a long day and the dogs lost its collar." (c) "The two brothers houses were on the same street."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain the difference between "its" and "it\'s." Why do so many people confuse them?',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'A student writes: "The teacher\'s were pleased with the student\'s work and gave them lot\'s of praise." Identify and correct every apostrophe error in this sentence.',
      lines: 5,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  keywords: [
    'comma', 'comma splice', 'embedded clause', 'subordinate clause',
    'parenthetical', 'relative clause', 'run-on sentence', 'listing comma',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Teacher explains the first pair and students attempt the remaining two with guidance.',
      core: 'Students explain all three pairs independently in writing.',
      stretch: 'Students create their own ambiguous sentence where comma placement changes meaning, then share with the class.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'A rule card with all four rules and examples is provided. Practice sentences have the subordinate or embedded clause already underlined.',
        core: 'Students complete all practice tasks independently and identify the comma rule used in each sentence.',
        stretch: 'Students find and correct comma splices in a given paragraph, then rewrite each correction in two different ways.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'A bank of embedded clauses is provided for students to insert into the simple sentences. Writing frame with prompts for where to add embedded clauses.',
        core: 'Students write original embedded clauses and compose the paragraph independently.',
        stretch: 'Students vary the type of information in their embedded clauses (description, explanation, contrast) and annotate the effect of each one on the reader.',
      },
      resources: ['Embedded clause model slides', 'Simple sentence expansion worksheet', 'Embedded clause bank (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Error locations are indicated with a highlighted gap where the comma decision needs to be made.',
  ...
  worksheetQuestions: [
    {
      question: 'List the four main uses of commas covered in this lesson and give an example of each.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'What is a comma splice? Give an example and show two different ways to correct it.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Add an embedded clause to each sentence: (a) "The old house creaked in the wind." (b) "The teacher gave out the results." (c) "The river flowed through the valley."',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Proofread the following sentence and correct all comma errors: "Although it was late the children, wanted to keep playing but their parents who were tired said it was time to go home."',
      lines: 4,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  keywords: [
    ...
    'subject terminology', 'word class',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide category headers and reduce the word set to 16 cards covering only nouns, verbs, adjectives, and adverbs.',
      core: 'Students sort all 24 cards into eight categories and identify at least two ambiguous words.',
      stretch: 'Students write a sentence for each ambiguous word showing it functioning as two different word classes.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a colour-coded reference poster. Worksheet focuses on tasks 1-2 with the four main word classes (noun, verb, adjective, adverb).',
        core: 'Students complete all three tasks for all eight word classes independently.',
        stretch: 'Students analyse how changing a single word class choice (e.g., replacing one adjective with another) changes the mood, tone, or connotation of a sentence.',
      },
      resources: ['Model sentence slide', 'Word class worksheet', 'Reference poster (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Key words in the extract are pre-highlighted and labelled by word class. Paragraph frame provided with sentence starters.',
        core: 'Students highlight and analyse independently, then write the analytical paragraph using the frame.',
        stretch: 'Students write two analytical paragraphs covering different word classes, without using the frame, and include a comment on the writer\'s overall pattern of word class choices.',
      },
      resources: ['Literary extract handout', 'Highlighters', 'Paragraph frame', 'Subject terminology list'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students must give their own example word for each class they cross off, used in a sentence.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Define four main word classes (noun, verb, adjective, adverb) and give two examples of each.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Identify the word class of each underlined word: "The (a) ancient (b) castle (c) stood (d) silently (e) on the hill."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain why the word "light" can belong to different word classes. Write three sentences using "light" as a different word class each time.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'A student writes: "The writer uses good describing words to make the reader feel scared." Rewrite this sentence using correct subject terminology.',
      lines: 4,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  keywords: [
    'Standard English', 'non-standard English', 'dialect', 'register',
    'formality', 'idiolect', 'code-switching', 'colloquialism',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide the two column headings and one example already sorted to establish the pattern.',
      core: 'Students sort all ten sentences and articulate the pattern they notice.',
      stretch: 'Students identify the specific grammatical feature that makes each non-standard sentence non-standard (e.g., subject-verb disagreement, double negative, non-standard past tense).',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Exercise includes the non-standard feature underlined with the Standard English rule printed alongside. Focus on patterns 1-3.',
        core: 'Students correct all twenty sentences independently and identify which pattern each error represents.',
        stretch: 'Students also explain why each non-standard form exists (e.g., dialect regularisation) and write a paragraph arguing whether Standard English should be the only form taught in schools.',
      },
      resources: ['Non-standard patterns slides', 'Correction exercise worksheet', 'Rule reference (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Guided analysis questions with sentence starters for each extract. A character profile and dialogue prompts provided for the creative task.',
        core: 'Students analyse both extracts independently and write the creative piece with full annotations.',
        stretch: 'Students write an analytical paragraph comparing the two extracts, evaluating which writer uses non-standard English more effectively and why. Creative piece includes a shift in register for one character to demonstrate code-switching.',
      },
      resources: ['Two literary extract handouts', 'Analysis question sheet', 'Character profile (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Teacher models the first transformation; students complete the second with a partner.',
      core: 'Students complete both transformations independently.',
      stretch: 'Students write a third version in a literary register and discuss how register is a spectrum, not a binary.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Define Standard English. Why is it important in formal writing and exam responses?',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Rewrite the following sentences in Standard English: (a) "We was proper annoyed about it." (b) "She never done nothing wrong." (c) "Me and him went to the shop." (d) "He spoke really quiet like."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why might a novelist choose to write dialogue in non-standard English? Give an example of the effect this creates.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain the concept of "code-switching." Give an example of when a person might code-switch between Standard and non-standard English.',
      lines: 5,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  keywords: [
    'SPaG', 'AO6', 'proofreading', 'technical accuracy',
    'band descriptors', 'self-correction', 'timed writing', 'mark scheme',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Teacher guides students through the band descriptors, highlighting key phrases with annotations.',
      core: 'Students identify which band each extract falls into and justify their decision using the descriptors.',
      stretch: 'Students rewrite the weaker extract\'s first paragraph to bring it up to the higher band, noting every change made.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'CAPS checklist card provided with specific items to look for under each letter. The practice response has errors concentrated and numbered.',
        core: 'Students complete all four passes independently and tally the number of errors found in each category.',
        stretch: 'Students complete all four passes, then add a fifth pass for "style" — identifying places where sentence structure could be varied or vocabulary upgraded for greater impact.',
      },
      resources: ['CAPS proofreading poster/slide', 'Practice response handout', 'CAPS checklist card (support tier)', 'Coloured pens'],
    },
    {
      ...
      differentiation: {
        support: 'A planning frame with paragraph prompts is provided. During proofreading, students focus on C and A passes only.',
        core: 'Students write and proofread independently using all four CAPS passes.',
        stretch: 'Students write without a planning frame and complete a full CAPS proofread plus a style pass. They also write a brief self-assessment identifying their strongest and weakest SPaG area.',
      },
      resources: ['Task instruction slide', 'Planning frame (support tier)', 'CAPS checklist', 'Timer', 'Lined response paper'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Self-assessment grid includes example statements for each score level. Pledge sentence starter provided.',
      core: 'Students self-assess independently and write a detailed pledge with an action plan.',
      stretch: 'Students write a pledge for their two weakest areas and create three practice sentences that target each weakness.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain how SPaG marks are awarded in GCSE English. Why is technical accuracy worth paying attention to?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain the CAPS proofreading strategy. Why is it more effective to proofread in multiple passes rather than one?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Read the following extract from a student response and identify five SPaG errors. Correct each one and explain the rule it breaks.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'A student says: "I don\'t need to worry about SPaG because my ideas are good." Write a response explaining why this attitude is problematic, using specific reference to how SPaG is marked.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'List five specific SPaG features that an examiner would expect to see in a Band 5 (top band) response. Give an example of each.',
      lines: 8,
      modelAnswer:
