...
const lesson1: LessonPlanData = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        "Provide a word bank of adjectives for each image: grand, imposing, prosperous, bright / cramped, shadowy, menacing, decayed. Define 'duality' on a card: 'the existence of two opposite qualities in the same thing.'",
      core: 'Students generate their own adjectives and write a sentence explaining what duality means in their own words.',
      stretch:
        'Students predict how a city that hides darkness behind respectability might mirror a character who hides darkness behind a respectable appearance. What is Stevenson suggesting about Victorian society?',
    },
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the extract with key phrases pre-underlined. Include a glossary: semantic field, personification, juxtaposition, Gothic, sordid, negligence, threshold. Pair support students with a confident reader.',
        core: 'Students complete all four annotation tasks independently and copy the consolidation point.',
        stretch:
          "Students write a paragraph exploring the door as a symbol: 'How does Stevenson use the door to introduce the theme of duality?' Consider: a door is a threshold - a boundary between two worlds. What two worlds does this door separate?",
      },
    },
    {
      ...
      differentiation: {
        support:
          'Provide the six conventions pre-printed in a table with one example already filled in. Students find one more example for each. Include page references to help them locate evidence.',
        core: 'Students complete the full table independently and answer the key question in a written sentence.',
        stretch:
          "Students compare Stevenson's urban Gothic to the traditional Gothic (castles, ruins, remote landscapes). Why is a London street more frightening than a haunted castle? What does this suggest about where Stevenson locates evil - not in remote, exotic places, but in the heart of civilised society?",
      },
    },
    {
      ...
      differentiation: {
        support:
          "Provide the three questions on a card with sentence starters: 'The violence is striking because... / Stevenson makes Hyde's appearance vague because... / The word \"Juggernaut\" suggests...'",
        core: 'Students answer all three questions independently and participate in the discussion.',
        stretch:
          "Students connect Hyde's indescribable appearance to Darwin's theory of evolution and Victorian fears of degeneration. Hyde looks 'not quite human' - could he represent the animal nature that Victorians feared lurked beneath civilised behaviour? Write a paragraph exploring this reading.",
      },
    },
  ],
  plenary: {
    ...
    differentiation: {
      support:
        "Provide a word bank of six terms to choose from: duality, Gothic, secrecy, respectability, evil, Hyde. Students choose three and write a sentence for each using the stem: 'This word matters because...'",
      core: 'Students choose their own three words and write a sentence for each from memory.',
      stretch:
        "Students choose one word and write a PEEL-style mini-paragraph explaining how it connects to a specific quotation from today's lesson.",
    },
  },
  keyVocabulary: [
...
const lesson2: LessonPlanData = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        "Provide two definitions to choose from: (a) 'Evil is something inside a person - they are born with it' or (b) 'Evil is something a person chooses to do.' Students choose one and explain their reasoning.",
      core: 'Students write their own definition of evil and make an argument for innate vs chosen.',
      stretch:
        'Students consider a third option: evil is the absence of social restraint. If you removed all consequences (laws, reputation, punishment), would everyone behave like Hyde? Is Hyde simply honesty without consequences?',
    },
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the extract with key phrases pre-highlighted in colour groups: animal language (red), violence verbs (blue), sensory detail (green). Include a glossary: atavism, degeneration, bestial, primal, escalation.',
        ...
        stretch:
          "Students write a paragraph exploring WHY the violence is unprovoked. Carew is polite, elderly, and non-threatening. What does Hyde's response to kindness reveal? Consider: is Stevenson suggesting that evil does not need a reason - that Hyde's violence is pure, motiveless malignity?",
      },
    },
    {
      ...
      differentiation: {
        support:
          "Provide the four quotations on cards with guided questions: 'Which word is most powerful? What does it suggest? What does the character FEEL when they see Hyde?' Define 'troglodytic' and 'misbegotten' on the glossary card.",
        core: 'Students identify key words/phrases for all four quotations and contribute to the discussion.',
        stretch:
          "Students write a paragraph exploring the idea that Hyde is a projection of Victorian fears about 'the other' - anyone who did not conform to the norms of white, middle-class, Protestant masculinity was viewed with suspicion and disgust. Is Stevenson critiquing this reaction or sharing it?",
      },
    },
    {
      ...
      differentiation: {
        support:
          'Provide a PEEL frame: \'Stevenson presents Hyde as frightening by... This is shown when [character] describes him as "..." The word "..." suggests... Stevenson does this because Victorian readers would have feared...\'',
        core: 'Write a full PEEL paragraph independently with embedded quotation and technique analysis.',
        stretch:
          "Write two paragraphs: one analysing Hyde's violence (what he does) and one analysing others' reactions (how he makes people feel). Which method of characterisation is more effective at creating fear?",
      },
    },
  ],
  plenary: {
    ...
    differentiation: {
      support:
        "Provide two arguments for each position on a cue card. Students choose and complete: 'I think Hyde is/is not human because...'",
      core: 'Students respond independently with textual evidence.',
      stretch:
        "Students argue that the question itself reveals Victorian anxiety: the need to classify Hyde as 'not human' is the same impulse that drives Jekyll to create him - the desire to separate the 'good' self from the 'bad' self. But Stevenson shows this separation is impossible.",
    },
  },
  keyVocabulary: [
...
const lesson3: LessonPlanData = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        "Provide the quotation with key words underlined ('thorough', 'primitive', 'duality', 'truly two'). Define 'duality' and 'repression' on the board. Offer the sentence stem: 'I agree/disagree that people are \"truly two\" because...'",
      ...
      stretch:
        "Students consider the implications: if every person is 'truly two', then is morality a performance? Is being 'good' just hiding the 'bad'? What does this mean for the concept of genuine goodness?",
    },
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          "Provide the three quotations on cards with modern English paraphrases beneath. Include guided questions for each: 'What does this mean in plain English? What does it tell us about why Jekyll created Hyde?'",
        ...
        stretch:
          "Students write a paragraph arguing that Jekyll's confession makes him a sympathetic character - not a villain, but a victim of a repressive society. Use quotations from the confession to support this reading. Consider: does Stevenson want us to blame Jekyll or blame the society that produced him?",
      },
    },
    {
      ...
      differentiation: {
        support:
          "Provide the two quotations with key words glossed: 'incorporated = made into one body', 'original = first, real'. Supply sentence starters for the written answers.",
        core: 'Students answer both questions independently and contribute to the discussion.',
        stretch:
          "Students connect the loss of control to addiction. Jekyll begins by choosing to take the potion; eventually he cannot stop. Write a paragraph: 'How does Stevenson use the relationship between Jekyll and Hyde to explore the concept of addiction - the loss of free will?'",
      },
    },
    {
      ...
      differentiation: {
        support:
          'Students choose from the three provided thesis statements and use a PEEL frame to write their paragraph: \'Stevenson\'s message is that... This is shown when Jekyll says "..." The word "..." suggests... This connects to the theme of...\'',
        ...
        stretch:
          "Students write a paragraph that explores the TENSION between two thesis statements - arguing that the novella's power comes from its refusal to offer a simple moral. Use the phrase 'On one hand... but on the other hand...' to demonstrate evaluative thinking.",
      },
    },
  ],
  plenary: {
    ...
    differentiation: {
      support:
        "Provide four sentence starters, one per quadrant: 'The real monster is Hyde because... / The real monster is Jekyll because... / The real monster is Victorian society because... / The real monster is human nature because...'",
      core: 'Students choose independently and write a justified response.',
      stretch:
        "Students argue that the novella is designed to make ALL four answers equally valid - and that Stevenson's refusal to choose is itself the message. What does narrative ambiguity contribute to a text's lasting power?",
    },
  },
  keyVocabulary: [
...
export const jekyllHydePptxLessons: LessonPlanData[] = [lesson1, lesson2, lesson3]
