...
const edexcelLang1: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Prepare five cards with question types (Q1 retrieval, Q2/Q3 analysis, Q4 evaluation, Q5 writing) and five cards with mark allocations (1 mark, 6 marks, 6 marks, 15 marks, 72 marks). Students match them in pairs, then reveal answers and briefly explain why Edexcel allocates marks this way.',
    differentiation: {
      ...
      stretch:
        'Students predict why marks increase and discuss the cognitive demand of each question type.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students predict assessment criteria for each question before teacher reveals them.',
      },
      resources: [
        'Paper 1 specimen extract',
        'Question overview grid handout',
        'AO reference chart',
  ...
  plenaryActivity: {
    ...
    duration: '7 minutes',
    instructions:
      'Students create a personal timing plan for 105 minutes. Recommend: Q1 (2 mins), Q2 (10 mins), Q3 (10 mins), Q4 (20 mins), Q5 (55 mins), buffer (8 mins). Discuss why Q5 gets the most time and why rushing the planning phase is costly.',
    differentiation: {
      ...
      stretch:
        'Students justify their plan and discuss how they would adjust if they finished Q5 early.',
    },
  },
  homework:
    'Write a 150-word explanation of why Question 5 accounts for more than half the marks on Paper 1. What skills must a student demonstrate to score highly?',
  worksheetQuestions: [
    {
      question: 'List the five questions on Edexcel Language Paper 1 and their mark allocations.',
      lines: 5,
      modelAnswer:
        'Q1: 1 mark (retrieval). Q2: 6 marks (language analysis, AO2). Q3: 6 marks (structure analysis, AO2). Q4: 15 marks (critical evaluation, AO4). Q5: 72 marks (writing persuasively or descriptively, AO5/AO6).',
      marks: 5,
    },
  ],
  teacherNotes: [
...
const edexcelLang2: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Give students a short non-fiction extract (200 words). Ask four retrieval questions. Students race to find answers in one minute per question.',
    differentiation: {
  ...
  mainActivities: [
    {
      ...
      duration: '15 minutes',
      instructions:
        'Display three Q1 questions and model answering each. Discuss why Q1 is only 1 mark: there is one correct answer. Emphasise that Q1 is a confidence-builder designed to be quick and achievable.',
      steps: [
    ...
    },
    {
      ...
      duration: '18 minutes',
      instructions:
        'Provide a fresh non-fiction extract and five Q1-style questions. Students answer under timed conditions (1 minute per question).',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Recap the key tip: read Q1 question first, identify the key word, scan the extract, write concisely. Discuss common mistakes: copying entire sentences, writing opinions, failing to re-read the question.',
    differentiation: {
  ...
  homework:
    'Find a news article online. Write five Q1-style retrieval questions for a peer. Ensure your questions test straightforward retrieval.',
  worksheetQuestions: [
    {
      question: 'What is the purpose of Question 1, and why is it worth only 1 mark?',
      lines: 3,
      modelAnswer:
        'Q1 tests direct retrieval: the ability to locate specific information. It is 1 mark because there is one correct answer.',
      marks: 2,
    },
  ],
  teacherNotes: [
...
const edexcelLang3: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display six short extracts. Each contains one language technique (alliteration, metaphor, rhetorical question, imperative, repetition, triplet). Students identify the technique and predict its effect.',
    differentiation: {
  ...
  mainActivities: [
    {
      ...
      duration: '35 minutes',
      instructions:
        'Display a non-fiction extract. Model the Q2 analytical process. Model writing a secure analytical paragraph. Provide three sample responses.',
      differentiation: {
        ...
        stretch:
          'Students write two analytical paragraphs and self-assess against Level 3 descriptors.',
      },
      resources: [
        'Non-fiction extract',
        'Q2 model paragraph',
        'Three sample Q2 responses',
    ...
    },
    {
      ...
      duration: '35 minutes',
      instructions:
        'Explain the difference between language and structure. Model how to answer Q3.',
      differentiation: {
    ...
    },
    {
      ...
      duration: '12 minutes',
      instructions:
        'Provide a new extract. Students write one paragraph for each question within 15 minutes total.',
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Display two sample responses side by side. Discuss differences. Recap: Q2 = language; Q3 = structure/form.',
    differentiation: {
  ...
  worksheetQuestions: [
    {
      ...
      lines: 5,
      modelAnswer:
        'Language analysis focuses on word choice and techniques like metaphor. Structure analysis focuses on text organization: openings, paragraph progression, sentence variety. Language example: "vivid imagery creates beauty." Structure example: "Short sentences create urgency."',
      marks: 4,
    },
  ],
  teacherNotes: [
...
const edexcelLang4: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Read statements from non-fiction texts. Students vote and discuss why people disagree.',
    differentiation: {
  ...
  mainActivities: [
    {
      ...
      duration: '20 minutes',
      instructions:
        'Define evaluation. Model how to approach Q4: identify viewpoint, decide stance, select evidence, explain reasoning, acknowledge opposing view.',
      steps: [
    ...
    },
    {
      ...
      duration: '18 minutes',
      instructions:
        'Show three Q4 responses (weak, secure, exceptional). Students rank them and identify differences.',
      differentiation: {
    ...
    },
    {
      ...
      duration: '27 minutes',
      instructions:
        'Provide a new extract and Q4 question. Students write a response within 25 minutes.',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Q4 rewards well-supported judgements, not right or wrong answers. Students write one personal tip.',
    differentiation: {
  ...
  worksheetQuestions: [
    {
      ...
      lines: 4,
      modelAnswer:
        'Analysis examines how writers use language and structure. Evaluation judges whether the argument is convincing. Analysis is descriptive; evaluation is critical and requires personal judgement supported by reasoning.',
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang5: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Show three advertising slogans. Students identify purpose, technique, and audience.',
    differentiation: {
  ...
  mainActivities: [
    {
      ...
      duration: '25 minutes',
      instructions:
        'Explain persuasive structure: hook, position, point 1, point 2, counterargument, conclusion. Model planning a Q5A response.',
      differentiation: {
    ...
    },
    {
      ...
      duration: '25 minutes',
      instructions:
        'Teach key techniques: rhetorical questions, repetition, emotive language, triplet, direct address, anecdotes, facts, counterargument.',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Students reflect on techniques used. Write one technique to focus on in next task.',
    differentiation: {
  ...
  homework:
    'Write a persuasive text (300-400 words). Use at least three techniques. Self-assess using Technique Bank and mark scheme.',
  worksheetQuestions: [
    {
      question: 'What is the purpose of persuasive writing?',
      lines: 3,
      modelAnswer:
        'Persuasive writing aims to convince the reader to believe something or take action using techniques and evidence.',
      marks: 3,
    },
  ],
  teacherNotes: [
  ...
  targetedSkills: [
    'persuasive technique application',
...
const edexcelLang6: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Read two versions of a scene (bland vs. vivid). Students vote which is more engaging. Discuss sensory language.',
    differentiation: {
  ...
  mainActivities: [
    {
      ...
      duration: '25 minutes',
      instructions:
        'Explain that effective description is organised (spatial or temporal) and sensory. Model planning a Q5B response.',
      differentiation: {
    ...
    },
    {
      ...
      duration: '25 minutes',
      instructions:
        'Teach key techniques: similes, metaphors, precise adjectives, personification, pathetic fallacy, sensory language.',
      differentiation: {
        support: 'Provide colour-coded examples.',
        core: 'Students identify techniques in a provided passage.',
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Show generic vs. vivid sentence versions. Discuss effectiveness. Recap importance of precise, sensory word choice.',
    differentiation: {
      support: 'Provide sentence starters.',
  ...
  homework:
    'Write a descriptive text (300-400 words) evoking specific emotion. Use at least four techniques. Self-assess using mark scheme.',
  worksheetQuestions: [
    {
      question: 'How is descriptive writing different from narrative writing?',
      lines: 3,
      modelAnswer:
        'Descriptive writing creates vivid pictures and atmosphere. Narrative writing tells a story. Descriptive focuses on sensory details; narrative focuses on plot and action.',
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang7: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display extracts from fiction texts. Students identify narrative techniques: point of view, dialogue, pacing, description, characterisation.',
    differentiation: {
  ...
  mainActivities: [
    {
      ...
      duration: '25 minutes',
      instructions:
        'Display Paper 2 structure: Q1 (short answer narrative analysis, 1-2 marks), Q2 (narrative analysis, 6 marks), Q3 (compare two narrative extracts, 6 marks), Q4 (imaginative writing, 72 marks). Model answering a Q1 question on a fiction extract. Discuss narrative techniques: point of view, dialogue, pacing, sensory description, characterisation.',
      differentiation: {
    ...
    },
    {
      ...
      duration: '30 minutes',
      instructions:
        'Teach key narrative techniques. For each, show an example and explain its effect. Model analysing a fiction passage that employs multiple narrative techniques. Students identify techniques and explain effects.',
      differentiation: {
    ...
    },
    {
      ...
      duration: '12 minutes',
      instructions:
        'Provide three Q1-style questions on a new fiction extract. Students answer within 10 minutes. Discuss answers as a class.',
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Students identify one narrative technique they found tricky and one they felt confident about.',
    differentiation: {
      support: 'Provide sentence starters.',
      core: 'Students write their own reflection.',
  ...
  homework:
    'Identify three narrative techniques in a fiction excerpt and explain their effects on the reader.',
  worksheetQuestions: [
    {
      question: 'Define narrative technique and give two examples with their effects.',
      lines: 4,
      modelAnswer:
        'Narrative techniques are methods writers use to tell stories and engage readers. Examples: dialogue (reveals character and creates immediacy), pacing (controls reader tempo through sentence length and paragraph breaks).',
      marks: 3,
    },
  ],
  teacherNotes: [
  ...
  targetedSkills: [
    'narrative technique identification',
    'effect analysis',
    'fiction-specific terminology',
  ],
}
...
const edexcelLang8: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display five narrative techniques and five possible effects. Students match them and discuss why each technique creates that effect.',
    differentiation: {
  ...
  mainActivities: [
    ...
    },
    {
      ...
      duration: '25 minutes',
      instructions:
        'Show two contrasting fiction passages (e.g., one using first-person, one using third-person; one with dialogue-heavy narrative, one with internal thoughts). Students identify the narrative technique each uses and discuss why the writer chose that approach. This prepares them for Q3 (comparison questions).',
      differentiation: {
    ...
    },
    {
      ...
      duration: '10 minutes',
      instructions:
        'Provide a new fiction extract and a Q2 question. Students write a response within 12 minutes (realistic exam timing for Q2).',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Recap: Q1 requires short answers (1-2 marks); Q2 requires fuller analytical paragraphs (6 marks). Discuss why Q2 is more demanding.',
    differentiation: {
  ...
  homework:
    'Write a Q2 response (6-8 sentences) to a new fiction extract. Use the mark scheme to self-assess.',
  worksheetQuestions: [
    {
      question: 'Analyse a narrative technique from a provided fiction extract.',
      lines: 6,
      modelAnswer:
        "The writer uses [technique] in [quote]. This creates a sense of [effect], making the reader feel [emotional response]. This is effective because [link to characterisation/plot/themes]. The writer's choice of [technique] emphasizes [authorial purpose].",
      marks: 6,
    },
  ],
  teacherNotes: [
...
const edexcelLang9: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display two short fiction passages. Students identify: (1) What narrative techniques do both use? (2) What techniques does only one use? (3) How do they create different effects?',
    differentiation: {
      support: 'Provide pre-labelled techniques.',
  ...
  mainActivities: [
    {
      ...
      resources: [
        'Two fiction extracts',
        'Q3 model paragraph',
        'Three sample Q3 responses',
    ...
    },
    {
      ...
      duration: '30 minutes',
      instructions:
        'Provide two new fiction extracts with different narrative approaches (e.g., different points of view, different pacing, different use of dialogue). Students identify narrative techniques in each and write comparative analytical paragraphs. Circulate and provide formative feedback.',
      differentiation: {
        support: 'Pre-highlight techniques in each extract.',
        core: 'Students identify techniques and write comparative paragraphs.',
        stretch:
          'Students write two comparative paragraphs and identify which narrative approach is more effective.',
      },
    ...
    },
    {
      ...
      duration: '12 minutes',
      instructions:
        'Provide a third pair of fiction extracts and a Q3 question. Students write a response within 15 minutes.',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Recap comparison words: both, whereas, in contrast, similarly, unlike, conversely. Students write three comparison sentences using these words.',
    differentiation: {
  ...
  homework:
    'Write a Q3 response comparing two narrative techniques in two fiction extracts. Use the mark scheme to self-assess.',
  worksheetQuestions: [
    {
      question:
        'What is the difference between analysing a single technique (Q2) and comparing techniques in two extracts (Q3)?',
      lines: 4,
      modelAnswer:
        'Q2 focuses on one extract and explains how a technique creates effects. Q3 requires examining two extracts and comparing how narrative techniques are used similarly or differently. Q3 demands synthesis and contrast, not just explanation.',
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang10: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display three story openings. Students vote which is most engaging and discuss why. Discuss elements of effective story openings: vivid description, intrigue, character introduction.',
    differentiation: {
  ...
  mainActivities: [
    ...
    },
    {
      ...
      duration: '30 minutes',
      instructions:
        'Provide a fresh Q4A task. Students write a narrative response within 45 minutes. Circulate and offer formative feedback. After time, collect responses. Select one or two to mark on visualiser, highlighting effective narrative techniques and structural choices.',
      differentiation: {
      ...
      resources: [
        'Q4A task prompt',
        'Planning template',
        'Narrative Techniques Bank',
        'AO5/AO6 mark scheme descriptors',
      ],
    },
  ],
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Students reflect: What narrative techniques did I use? Which felt most natural? Which do I need to practise more? Students write one technique they will focus on in their next narrative task.',
    differentiation: {
      support: 'Provide reflection sentence starters.',
      core: 'Students write their own reflection.',
  ...
  homework:
    'Write a narrative text (300-400 words) on a prompt of your choice. Focus on using at least three different narrative techniques. Self-assess using the Narrative Techniques Bank and mark scheme.',
  worksheetQuestions: [
    {
      question: 'What is the difference between plot and narrative technique?',
      lines: 3,
      modelAnswer:
        'Plot is the sequence of events in a story (what happens). Narrative technique is how the writer tells the story (point of view, dialogue, pacing, description). A story needs both a compelling plot and effective techniques to engage readers.',
      marks: 3,
    },
  ],
  teacherNotes: [
  ...
  targetedSkills: [
    'narrative technique application',
    'story structure',
    'characterisation',
    'dialogue writing',
    'pacing control',
...
const edexcelLang11: LessonPlan = {
  ...
  keywords: [
    ...
    'imagery',
    'sensory language',
    'characterisation through description',
    'narrative viewpoint',
    'AO5',
    'AO6',
  ],
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Read two story openings: one bland, one vivid and atmospheric. Students vote which is more engaging. Discuss: What makes the vivid version superior? Introduce the idea that fictional description can be both sensory and character-revealing.',
    differentiation: {
  ...
  mainActivities: [
    {
      ...
      duration: '25 minutes',
      instructions:
        'Explain that fictional descriptions serve multiple purposes: establish atmosphere, reveal character through reaction to surroundings, create mood, move plot forward. Model planning a Q4B response to a prompt like "Write a description of an abandoned place" or "Describe a place that holds memories." Create a detailed plan noting: setting details, sensory elements, whose perspective (affects what is noticed), mood to establish, how description links to implied story. Show how to allocate 45 minutes.',
      differentiation: {
        support: 'Provide a descriptive planning frame.',
        core: 'Students create their own plan for a Q4B task.',
        stretch:
          'Students create a plan and identify which techniques will create the intended atmosphere and perspective.',
      },
    ...
    },
    {
      ...
      duration: '25 minutes',
      instructions:
        'Explain that fictional descriptions often blend sensory language with narrative perspective. Model a paragraph that uses description but through a character\'s eyes (third-person limited or first-person). Show how to use dialogue or character reaction alongside description. Teach techniques: precise noun phrases, figurative language, sensory imagery, character perspective filtering. Provide "Imaginative Description Techniques Bank" handout.',
      differentiation: {
        support: 'Provide colour-coded examples.',
        core: 'Students identify techniques in a provided passage.',
        stretch:
          'Students identify techniques and discuss how perspective shapes what is described.',
      },
      resources: [
        'Technique definitions and examples',
        'Imaginative Description Techniques Bank handout',
      ],
    },
    {
      ...
      duration: '30 minutes',
      instructions:
        'Provide a fresh Q4B task. Students write a descriptive response within 45 minutes. After time, collect responses. Select one or two to mark, highlighting effective sensory language and atmospheric creation.',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Discuss: In a fiction story, how is descriptive writing different from narrative writing? (Narrative drives plot and character; description establishes atmosphere and setting.) How do they work together?',
    differentiation: {
      support: 'Provide comparison chart.',
      core: 'Students discuss the relationship.',
      stretch:
        'Students plan how they would blend narrative and description in a piece of fiction.',
    },
  },
  homework:
    'Write a descriptive text (300-400 words) of an imaginative setting that creates a specific atmosphere. Self-assess using the Imaginative Description Techniques Bank and mark scheme.',
  worksheetQuestions: [
    {
      question: 'How can description in fiction be more than just "pretty language"?',
      lines: 3,
      modelAnswer:
        'Effective description reveals character perspective, establishes mood that affects plot, creates atmosphere that engages readers, and foreshadows events. It is purposeful, not decorative.',
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang12: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display: 2 hours 45 minutes total. Paper 1 = 105 minutes (100 marks). Paper 2 = 105 minutes (100 marks). 15-minute reading time. Students calculate: How many minutes per mark on each paper? Why might you allocate time differently despite equal marks?',
    differentiation: {
  ...
  mainActivities: [
    {
      ...
      duration: '25 minutes',
      instructions:
        'Walk through recommended time allocation for both papers. Paper 1: Q1 (2 mins), Q2 (10 mins), Q3 (10 mins), Q4 (20 mins), Q5 (55 mins), buffer (8 mins). Paper 2: identical allocation. Discuss: Why does Q5 get 55 minutes? Why do Q1-Q4 get roughly proportional time to marks? Introduce the concept that students should personalise plans based on strengths and weaknesses (e.g., strong at Q4? Allocate 25 mins. Weak at Q5? Allocate 50 mins and rush slightly on Q2-Q3). Model creating a personalised plan.',
      differentiation: {
        support: 'Provide recommended time plan.',
        core: 'Students create their own personalised plan.',
        stretch:
          'Students create multiple plans based on different scenarios (if Q4 is strong, if Q5 is weak, etc.).',
      },
    ...
    },
    {
      ...
      duration: '10 minutes',
      instructions:
        'Students reflect on their own strengths and weaknesses across the questions. Which questions do they spend the most/least time on? Why? Create a personalised time plan based on honest assessment.',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Discuss: What is the most important thing to remember about time management in this exam? (Example: Q5 is worth the most marks, so allocate the most time.) Students write one personal time management rule.',
    differentiation: {
  ...
  homework:
    'Create a detailed time plan for the full 2-hour 45-minute exam, including reading time and buffer time. Keep it somewhere accessible for exam revision.',
  worksheetQuestions: [
    {
      question: 'Why is time management essential in the Edexcel Language exam?',
      lines: 3,
      modelAnswer:
        'Time management ensures you attempt all questions and allocate proportional time to marks. Q5 is worth 72/100 marks (72%), so rushing it or running out of time will severely impact your grade. Strategic planning prevents this.',
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang13: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display a short passage with 10 intentional errors (spelling, punctuation, grammar). Students race to find as many as possible in 5 minutes. Discuss: What errors did you miss? Why are some errors harder to spot?',
    differentiation: {
  ...
  mainActivities: [
    {
      ...
      duration: '20 minutes',
      instructions:
        "Teach common errors: missing commas in lists, apostrophes (possessive vs. plural), their/there/they're, subject-verb agreement, sentence fragments, comma splices. Model identifying and correcting each. Show student examples (anonymised) containing these errors. Have students identify and correct them.",
      differentiation: {
    ...
    },
    {
      ...
      resources: [
        ...
        'Student paragraph to proofread',
        'Correction key',
      ],
    },
    {
      ...
      duration: '12 minutes',
      instructions:
        'Provide a student response to a Q5 task (containing 8-10 errors). Students proofread within 5 minutes (realistic exam buffer time). Discuss how many errors they caught. Review all errors together.',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Students review their own recent writing and identify their three most common errors. Write them down to focus on in future proofreading.',
    differentiation: {
      support: 'Provide list of common errors to check against.',
      core: 'Students identify their own patterns.',
      stretch:
        'Students create strategies to prevent their personal errors during writing, not just proofreading.',
    },
  },
  homework:
    'Proofread a past exam response (yours or a model answer). Identify and categorise all errors found. Create a personal proofreading checklist.',
  worksheetQuestions: [
    {
      question: 'How does technical accuracy (AO6) affect your overall exam grade?',
      lines: 3,
      modelAnswer:
        'AO6 is assessed on Q5 only and can account for up to 12 marks (out of 36 for Q5). Consistent technical accuracy across words, sentences, and paragraphs can earn you 10-12 marks. Poor technical accuracy can lose you 5-10 marks.',
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang14: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display five generic words (said, nice, sad, happy, angry). Students suggest synonyms with different connotations (whispered, muttered, shouted for "said"; delightful, pleasant, charming for "nice"). Discuss how synonyms create different effects.',
    differentiation: {
  ...
  mainActivities: [
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students discuss why certain word choices are more effective in specific contexts.',
      },
    ...
    },
    {
      ...
      duration: '12 minutes',
      instructions:
        'Provide a student analytical paragraph and a student creative paragraph (both using generic vocabulary). Students identify generic words and suggest more precise alternatives. Discuss how the improvements elevate the quality.',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Students identify one generic word they use frequently and commit to replacing it with more precise alternatives. Create a personal vocabulary goal for exams.',
    differentiation: {
  ...
  homework:
    'Identify five generic words you use frequently. Find three precise synonyms for each. Create a personal vocabulary reference sheet for exam preparation.',
  worksheetQuestions: [
    {
      question: 'Why does precise vocabulary matter in analysis and in creative writing?',
      lines: 3,
      modelAnswer:
        'In analysis, precise terminology (metaphor, alliteration) demonstrates subject knowledge and clarity. In creative writing, precise word choice creates vivid imagery, conveys emotion, and engages readers more effectively than generic language.',
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang15: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Students anonymously write one sentence about their biggest fear regarding timed Q5 writing. Collect and display common themes: "Don\'t know what to write," "Start but get stuck midway," "Run out of time," "Not creative enough." Normalise these feelings.',
    differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Students create a personal confidence statement for Q5 (e.g., "I have planned well. My story doesn\'t have to be perfect. I can write a solid story in 45 minutes."). Write it down to review before exams.',
    differentiation: {
  ...
  homework:
    "Write the opening paragraph of three different stories from different prompts. Don't worry about perfection. Focus on getting words on the page within 5 minutes per prompt. Build fluency and confidence.",
  worksheetQuestions: [
    {
      question:
        "What is the difference between writer's block and lack of skill in creative writing?",
      lines: 3,
      modelAnswer:
        "Writer's block is a psychological barrier (anxiety, overthinking, perfectionism) that prevents writing, even when the skill exists. Lack of skill is an actual inability to structure ideas or use techniques. Recognising the difference is important: if it's block, strategies like planning and positive self-talk help. If it's skill, more practice and instruction are needed.",
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang16: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display myths: "Reading through notes is revision," "Highlighting textbooks helps," "Revision should be painful." Students identify which are myths. Discuss: Effective revision is active, targeted, and varied. It should involve retrieval practice and application, not passive reading.',
    differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Students reflect: Am I confident in my revision approach? Do I know what to revise? Do I have past papers to practise with? If not, solve these issues now (get past papers, clarify weak areas, etc.).',
    differentiation: {
  ...
  homework:
    "Create a detailed revision plan for the next 4-6 weeks leading to your exam. Include which question types to practise, when, and how you'll track progress.",
  worksheetQuestions: [
    {
      question: 'Why is timed practice more important for language exams than other subjects?',
      lines: 3,
      modelAnswer:
        'Language exams require timed creative writing (Q5) and timed analysis. Practising under realistic time pressure is essential to building speed, confidence, and exam technique. Revision without timed practice leaves you unprepared for the actual exam conditions.',
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang17: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Show three Q2 analytical responses (weak, secure, exceptional) and their marks (3 marks, 5 marks, 6 marks). Students predict which gets which mark and why. Discuss: What makes the exceptional response better?',
    differentiation: {
      support: 'Provide marks and ask students to match.',
      core: 'Students predict marks and discuss features.',
      stretch:
        'Students predict marks and identify specific mark scheme descriptors evident in each response.',
    },
  },
  mainActivities: [
    {
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students identify their personal level ceiling and plan strategies to break through it.',
      },
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Students identify their target level for each question (realistic based on current ability). Write them down. For exam revision, focus on reaching target level across all questions.',
    differentiation: {
  ...
  homework:
    'Obtain the full Edexcel Language mark schemes (from exam board or your teacher). Study and annotate them. Create a one-page summary of what each level requires for Q2 and Q5.',
  worksheetQuestions: [
    {
      question: 'How can understanding mark schemes improve your exam performance?',
      lines: 3,
      modelAnswer:
        "Mark schemes reveal exactly what examiners look for at each level. By understanding the criteria and level descriptors, you can deliberately write responses that meet higher levels. Self-assessing against mark schemes shows you what's missing from your work and how to improve.",
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang18: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display four student responses to the same question. Two contain common mistakes. Students identify which are problematic and why.',
    differentiation: {
  ...
  mainActivities: [
    {
      ...
      duration: '20 minutes',
      instructions:
        'Teach common mistakes: Q1 (copying too much instead of concise answer, misreading question), Q2/Q3 (summarising instead of analysing, not embedding quotations, missing the "effect" step), Q4 (not taking a stance, purely summarising writer\'s viewpoint without evaluation), Q5 (lack of planning leading to rushed, underdeveloped responses; generic vocabulary; lack of time management leading to incomplete work). For each, discuss why students make the mistake and how to prevent it.',
      differentiation: {
    ...
    },
    {
      ...
      duration: '12 minutes',
      instructions:
        'Show a student Q4 response that makes a common mistake (e.g., fails to evaluate, just summarises). Discuss: What mistake is made? Where in the response? How could it be fixed? Have students rewrite the response to eliminate the mistake. Repeat with another question type.',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Students identify their most likely mistakes (based on past exam responses or mock exams) and create a prevention plan (e.g., "I rush Q5. Prevention: I will spend 5 minutes planning before writing."). Write it down to review before exams.',
    differentiation: {
  ...
  homework:
    'Review your own past exam responses or mock exams. Identify three mistakes you personally tend to make. Write prevention strategies for each.',
  worksheetQuestions: [
    {
      question: 'Why do students often summarise instead of analyse in Q2 and Q3?',
      lines: 3,
      modelAnswer:
        'Summarising is easier and requires less deep thinking than analysis. To analyse, students must identify how a technique works and explain its effect on the reader. This requires more cognitive effort. Emphasising the "effect" step and modelling analysis helps prevent this mistake.',
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang19: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display a checklist: pen/pencil, ruler, watch, water bottle, snack, tissues, exam timetable. Discuss: What else might students need? What should they NOT do the night before (cram new material, stay up late)?',
    differentiation: {
      support: 'Provide a checklist.',
      core: 'Students create their own checklist.',
      stretch:
        'Students create a holistic prep plan (night before, morning of, first minutes of exam).',
    },
  },
  mainActivities: [
    {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Students create a one-page Exam Day Plan: night-before plan, morning-of plan, paper 1 time allocation, paper 2 time allocation, tactics if stuck. Keep it visible during final prep.',
    differentiation: {
  ...
  homework:
    'Finalise your Exam Day Plan. Prepare your exam materials checklist. Set reminders for final revision during the week before.',
  worksheetQuestions: [
    {
      question: 'Why is the reading time at the start of each paper important?',
      lines: 3,
      modelAnswer:
        'Reading time allows you to scan the entire paper, identify question types, estimate mark allocations, and start planning your time strategy. It also settles nerves. Using reading time strategically sets the tone for successful exam performance.',
      marks: 3,
    },
  ],
  teacherNotes: [
...
const edexcelLang20: LessonPlan = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Students reflect: When we started, what felt most challenging? Q2 analysis? Time management? Vocabulary? Do you feel more confident now? Discuss growth made so far.',
    differentiation: {
      support: 'Provide reflection prompts.',
      core: 'Students reflect freely.',
      stretch:
        'Students identify specific evidence of growth (better mark scheme awareness, faster writing, etc.).',
    },
  },
  mainActivities: [
    {
      ...
      duration: '15 minutes',
      instructions:
        'Students complete a self-assessment across all questions: (1) Q1-Q4 on Papers 1-2 (confidence: 1-5 scale), (2) Q5 (quality of timed writing: 1-5 scale), (3) Time management (1-5 scale), (4) Technical accuracy (1-5 scale). Identify areas of strength and remaining development needs. Discuss: What does this tell you about what to focus on in final prep?',
      differentiation: {
        support: 'Provide a structured self-assessment form.',
        core: 'Students complete self-assessment independently.',
        stretch:
          'Students compare their self-assessment to mock exam data and discuss discrepancies.',
      },
    ...
    },
    {
      ...
      duration: '15 minutes',
      instructions:
        'Guide students in setting exam goals. Discuss two types: (1) Realistic goals based on current ability (e.g., "I will score 65-70% based on my mock exam performance"), (2) Ambitious goals that stretch you (e.g., "I will push myself to score 75% by focusing on Q5 quality"). Both are valuable. Set specific, measurable goals by question: "I will aim for Level 3/4 on Q2," "I will write a 500-word Q5 response with three narrative techniques." Write goals down and review weekly during final prep.',
      differentiation: {
  ...
  plenaryActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Discuss: What will you commit to before the exam? (More timed practice? Proofreading every response? Using mark schemes to guide revision?) Students write a final personal commitment to themselves.',
    differentiation: {
      support: 'Provide commitment statement templates.',
      core: 'Students write their own commitment.',
      stretch:
        'Students create accountability: share their commitment with a peer and check in weekly.',
    },
  },
  homework:
    'Write a final reflection: What have you learned about yourself as a reader, writer, and exam-taker? What are you proud of? What will you carry forward after this exam?',
  worksheetQuestions: [
    {
      question:
        'What is the difference between realistic and ambitious goals? Why do you need both?',
      lines: 3,
      modelAnswer:
        'Realistic goals are based on current ability and provide motivation through achievable targets. Ambitious goals stretch you and encourage growth beyond your current level. Realistic goals build confidence; ambitious goals inspire you to push further. Together, they create a balanced, motivating approach.',
      marks: 3,
    },
  ],
  teacherNotes: [
