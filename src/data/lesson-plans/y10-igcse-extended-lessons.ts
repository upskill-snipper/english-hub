...
export const y10IgcseExtendedLessons: LessonPlan[] = [
  ...
  // ── Lesson y10ext-01: Cross-Paper Close Reading ───────────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Unseen paragraph displayed on board or printed on card', 'Tone word bank (optional)'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a sentence starter: "In the Language Paper I can use PAFT to..." and "In the Literature Paper I can use PAFT to..."',
  ...
  // ── Lesson y10ext-02: Linking Language to Literature ─────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide the four sentences pre-annotated with technique labels — students only decide which paper.',
  ...
  // ── Lesson y10ext-03: Timed Practice — Mixed Extract ─────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students also suggest the approximate marks the question is likely to be worth and justify their estimate.',
      },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students suggest specific strategies for addressing each of the two class priority areas.',
      },
    },
    homework:
  ...
  // ── Lesson y10ext-04: Understanding AO1–AO4 Across All Papers ─────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide a simplified list of four AO descriptions and ask students to match each auction statement to one.',
      ...
      resources: ['Eight AO statements on board or printed cards', 'Auction points tokens or tally on mini-whiteboards'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a labelled pyramid template and AO definitions to support the ranking decision.',
  ...
  // ── Lesson y10ext-05: Revision — Language Terminology ────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Teacher pairs a "Still Fuzzy" student with a "Solid" student for a peer explanation before the mini-explanation.',
        core: 'Students self-assess independently.',
        stretch: 'Students who feel solid on all fifteen write a brief guide explaining the most commonly confused pair for a peer who struggles with it.',
      },
    },
    homework:
  ...
  // ── Lesson y10ext-06: Revision — Literature Texts ────────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Five quotations displayed or read aloud', 'Studied texts available for support tier'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a sentence frame: "I know that [character] says [quotation] which shows [theme]..."',
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'What is a "thematic link" and why are they important in literature revision?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson y10ext-08: Exam Time Management Workshop ───────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide the calculation structure: total time - time used = time remaining; marks-per-minute = marks ÷ minutes.',
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a planning frame for Task 2 with section headings pre-printed.',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a list of strategies from which students select rather than generating from scratch.',
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'What is the "mark-per-minute" rule and what are its limitations?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson y10ext-09: Model Answer Analysis and Peer Marking ──────────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Two sample answers displayed or printed', 'Mark scheme band descriptors for reference'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a menu of features from the model answer and students select the two most useful.',
  ...
  // ── Lesson y10ext-10: End-of-Year Consolidation Assessment ───────────────
  {
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'For the writing task, provide an opening sentence and a brief planning frame.',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a sentence frame: "My signature skill this year is [skill] because [evidence]."',
