...
export const y11IgcseLangP2Lessons: LessonPlan[] = [
  // ── Lesson 1: Paper 2 Structure and Expectations ──────────────────────────
  {
    ...
    worksheetQuestions: [
      {
        question: 'How many marks is Paper 2 worth in total, and how are they split between the two tasks?',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 2: Transactional Writing Forms ─────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Students may use their conventions checklist as a reference during the Conventions Parade.',
  ...
  // ── Lesson 3: Purpose and Audience Adaptation ─────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide sentence frames for justifying responses: "I chose ___ because the writer uses ___, which suggests...".',
  ...
  // ── Lesson 4: Structural Techniques for Writing ───────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Focus only on identifying topic sentences; the discourse marker and weakness tasks are optional extensions.',
    ...
    worksheetQuestions: [
      {
        question:
          'What is a topic sentence and why is it important in transactional writing?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 5: Opening and Closing Strategies ──────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Students share their opening sentence only and receive feedback on the hook technique used.',
  ...
  // ── Lesson 6: Formal and Informal Register ────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Students identify just one feature per extract that indicates formal or informal register.',
    ...
    worksheetQuestions: [
      {
        question:
          'List five features of formal register and five features of informal register.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 7: Persuasive and Discursive Techniques ────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Students choose just their top three techniques and explain their choices verbally.',
  ...
  // ── Lesson 9: Editing for Accuracy and Effect ─────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Students apply SPAR only to the S and A elements first — sentence demarcation and apostrophes.',
  ...
  // ── Lesson 10: Full Timed Paper Practice ──────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: [
        'Exam strategy and timing slide',
        'Sticky notes for target setting',
      ],
    },
    mainActivities: [
      {
