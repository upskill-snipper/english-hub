...
const lesson1: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide prompt questions: "Who is speaking? How old do they sound? What does the name \'Pip\' suggest?"',
      core: 'Students annotate the opening line for language features and narrative voice before discussion.',
      stretch:
        "Students consider the significance of self-naming in relation to the novel's themes of social mobility and reinvention.",
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a pre-highlighted extract with key quotations underlined and a word bank for analytical vocabulary.',
        core: 'Students independently annotate and complete the dual-column table with at least three quotations per column.',
        stretch:
          "Students write a paragraph comparing how Dickens presents Magwitch here with how he is later revealed as Pip's benefactor, considering the effect on the reader.",
      },
      resources: [
        'Chapter 1 extract handout',
        'Dual-column table worksheet',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed annotated sketch with two examples already filled in.',
        core: 'Students create a full annotated sketch with at least four symbolic elements identified.',
        stretch:
          'Students write a paragraph analysing how Dickens uses pathetic fallacy and symbolism to foreshadow later events in the novel.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Sentence starter: "Dickens opens the novel with Pip as a child because he wants the reader to..."',
      core: 'Full written response expected with reference to at least one specific technique.',
      stretch:
        'Students consider how the opening establishes expectations that Dickens will later subvert.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'How does Dickens use the first-person narrative voice to create sympathy for Pip in the opening chapter?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Analyse how Dickens presents Magwitch in the graveyard scene. What methods does he use to create a sense of threat?',
      lines: 6,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide the Latin meaning and a simple question: "If someone named their house \'Enough\', what might that tell us about them?"',
      core: 'Students generate three possible interpretations of the name before teacher feedback.',
      stretch:
        "Students consider the irony of the name in relation to Miss Havisham's obsessive, never-ending grief.",
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students write a paragraph comparing Satis House to the marshes setting from Lesson 1, analysing what each reveals about Dickens's use of pathetic fallacy.",
      },
      resources: [
        'Chapter 8 extract',
        'Quotation-Technique-Effect table',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a paragraph frame with sentence starters and a quotation bank for the PEE paragraph.',
        core: 'Students write a full PEE paragraph independently with at least two embedded quotations.',
        stretch:
          'Students evaluate whether Estella is a villain or a victim, supporting their argument with evidence from the text.',
      },
      resources: [
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a sentence starter: "Pip\'s visit to Satis House is important because it makes him feel..."',
      core: 'Students must reference a specific moment from the visit in their response.',
      stretch:
        'Students compare this turning point to another key moment in the novel and argue which is more significant.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'How does Dickens use the description of Satis House to create a Gothic atmosphere?',
      lines: 6,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students predict what Dickens's own view might be, based on what they know about his background as a writer from a poor family.",
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide quotations for each moment and a partially completed graph; students focus on the moral ratings and explanations.',
        core: 'Students find their own quotations and complete the full timeline and graph independently.',
        stretch:
          "Students annotate the graph with turning points and write an analytical paragraph explaining the overall shape of Pip's moral arc.",
      },
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students write a second paragraph comparing Pip's treatment of Joe with Joe's consistent kindness, evaluating what this reveals about Dickens's views on true gentility.",
      },
      resources: [
        'Chapter 27 extract',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Students choose from two pre-written arguments and explain why they agree with their chosen position.',
      core: 'Students articulate their own argument with textual support.',
      stretch:
        'Students consider whether Dickens intends us to judge Pip or to understand how the class system corrupts good people.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        "How does Dickens criticise the Victorian class system through Pip's transformation?",
      lines: 6,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students identify which character best represents Dickens's view that class does not determine moral worth and explain why.",
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed comparison table and sentence starters for the PEE paragraphs.',
        core: 'Students complete the comparison independently and write two full PEE paragraphs.',
        stretch:
          'Students add a third paragraph evaluating which character Dickens presents more effectively to convey his social message.',
      },
      resources: [
        'Character evidence sheets',
        'Comparison table template',
        'PEE scaffold (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a paragraph frame: "Dickens\'s own experience of... may have influenced his presentation of... because..."',
        core: 'Students write a full AO3 paragraph linking at least two biographical details to the novel.',
        stretch:
          'Students evaluate whether Dickens is criticising all ambition or only ambition that comes at the cost of moral integrity.',
      },
      resources: [
        'Dickens biography handout',
        'Guided questions sheet',
        'AO3 paragraph frame (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students write two sentences - one summarising Dickens's view and one offering a counter-argument.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        "How does Dickens's own background influence his presentation of class in the novel?",
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students rank which character's guilt is most significant to the novel's plot and themes, justifying their choice.",
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students trace how Pip's guilt evolves across the novel and argue whether it is ultimately a positive force that drives his redemption.",
      },
      resources: [
        'Three extract handouts',
        'Analysis framework sheet',
        'Paragraph scaffold (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students evaluate whether Dickens's treatment of redemption is realistic or overly moralistic, linking to Victorian literary conventions.",
      },
      resources: [
        'Character evidence cards (support tier)',
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Does Dickens present Miss Havisham as a character worthy of redemption? Explain your view.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'How does Dickens use guilt as a structural device to connect the plotlines of the novel?',
      lines: 5,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide three options (Miss Havisham, Jaggers, Magwitch) and ask students to justify their choice.',
      core: 'Students explain their prediction with textual evidence before the reveal.',
      stretch:
        'After the reveal, students identify moments of foreshadowing they missed on first reading.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students compare Pip's reaction to Magwitch here with his reaction in Chapter 1, analysing how the power dynamic has shifted and what this reveals about Pip's character development.",
      },
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students evaluate whether Pip's reaction is understandable given his social conditioning, or whether Dickens intends us to condemn it outright.",
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Sentence starter: "Dickens places the revelation here because it changes everything for Pip by..."',
      core: 'Students write a full response referencing the three-stage structure of the novel.',
      stretch:
        'Students explain how the revelation transforms the meaning of events in the first two stages, using the term "dramatic irony."',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        "Analyse Pip's reaction to learning that Magwitch is his benefactor. What does his reaction reveal?",
      lines: 6,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students distinguish between what Miss Havisham has suffered (being jilted) and what she has chosen to do (weaponising Estella).',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the extract with the metaphor highlighted and a PEE scaffold for the paragraph.',
        core: 'Students annotate independently and write a full analytical paragraph with embedded quotations.',
        stretch:
          "Students evaluate whether Miss Havisham's guilt is genuine self-awareness or simply self-pity, supporting their argument with textual evidence.",
      },
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students compare the fire to other moments of consequence in the novel (e.g., Magwitch's recapture, Compeyson's death) and analyse Dickens's pattern of poetic justice.",
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Students explain their vote using a sentence starter: "My view changed/stayed the same because..."',
      core: 'Students explain what specific textual evidence influenced their decision.',
      stretch:
        'Students consider whether Dickens expects the reader to forgive Miss Havisham and what authorial techniques lead to that conclusion.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "What is the symbolic significance of the fire that destroys Miss Havisham's wedding dress?",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "How does Dickens present Miss Havisham's moment of self-recognition in Chapter 49?",
      lines: 5,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide examples of Pip\'s behaviour towards Estella and ask students to categorise each as "love" or "obsession."',
      core: 'Students justify their vote with a specific quotation or event from the novel.',
      stretch:
        "Students consider whether Pip's feelings for Estella are separable from his desire for social advancement - can he love her without wanting to be a gentleman?",
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the five moments pre-identified with quotations; students focus on analysing power dynamics.',
        core: 'Students create the full timeline independently with analysis of each moment.',
        stretch:
          "Students add a parallel timeline showing how Miss Havisham's influence operates at each stage of the relationship.",
      },
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students evaluate whether Dickens presents Estella's emotional detachment as a choice or a consequence of Miss Havisham's conditioning, and what this implies about free will.",
      },
      resources: [
        'Quotation display slide',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students argue which ending is more consistent with Dickens's moral vision across the whole novel.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "How does Dickens use Estella's character to explore the theme of emotional damage?",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "Is Pip's love for Estella genuine, or is it an extension of his social ambition? Explain with evidence.",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "What is the significance of the novel's ending for the relationship between Pip and Estella?",
      lines: 5,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a simple comparison table: "Victorian Punishment" vs "Modern Equivalent" for each example.',
      core: 'Students explain why Victorian justice might have been harsher and connect this to the novel.',
      stretch:
        'Students consider how Dickens, as a social reformer, used fiction as a vehicle for political critique.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students research and reference one real Victorian legal case involving class bias, linking it to Dickens's critique.",
      },
      resources: [
        'Chapter 42 extract',
        'Comparison table template',
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students write a paragraph arguing which character - Jaggers or Wemmick - more effectively represents Dickens's critique of Victorian justice, and why.",
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students evaluate whether Dickens's message about justice is still relevant today, giving a modern example.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'How does Dickens use the contrast between Magwitch and Compeyson to critique the justice system?',
      lines: 6,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students annotate a model paragraph, identifying where it meets Band 4 and how it could be elevated to Band 5.',
    },
    resources: [
      'Mark scheme display slide',
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a planning template with sections for thesis, three paragraphs, quotations, and context.',
        core: 'Students plan independently using their own structure.',
        stretch:
          'Students plan an alternative argument (e.g., that Dickens presents class as inescapable rather than simply unjust) and choose the stronger approach.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Allow access to a quotation bank of ten key quotations. Provide sentence starters for the opening paragraph.',
        core: 'Students write entirely from memory, aiming for three full paragraphs plus an introduction.',
        stretch:
          "Students aim for four paragraphs and a conclusion that evaluates Dickens's overall message about class, challenging or nuancing their thesis.",
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a peer assessment checklist with tick-box criteria and sentence starters for targets.',
      core: 'Students use the mark scheme independently to assess and write two specific targets.',
      stretch:
        "Students write a brief commentary (3-4 sentences) explaining what band their partner's work falls into and why, with specific evidence from the response.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "Model Question: How does Dickens present the theme of social class in the extract and in the novel as a whole? (Extract: Chapter 8 - Pip's first visit to Satis House.)",
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Identify three common weaknesses in GCSE literature essays and explain how to avoid each one.',
      lines: 6,
      modelAnswer:
