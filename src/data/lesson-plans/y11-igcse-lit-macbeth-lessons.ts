...
export const y11IgcseLitMacbethLessons: LessonPlan[] = [
  // ── Lesson 1: Jacobean Context ────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: [
          'Act 1 Scenes 1-2 extract sheet',
          'PETAL writing frame',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students challenge each other: "Can you link your context point to a specific quotation from the play?"',
      },
    },
    homework:
  ...
  // ── Lesson 2: Act 1 - The Witches\' Prophecy and Macbeth\'s Ambition ─────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: [
          'Act 1 Scene 2 and Act 1 Scene 7 extract sheet',
          'Comparison grid',
          'PETAL frame',
        ],
      },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write two sentences: their conclusion and one concession to the opposing view.',
      },
    },
    homework:
  ...
  // ── Lesson 3: Lady Macbeth - Power, Manipulation, Gender ─────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a thesis that holds both readings in tension: "Although Lady Macbeth appears to be... Shakespeare ultimately presents her as..."',
      },
    },
    homework:
  ...
  // ── Lesson 4: The Murder of Duncan - Dramatic Tension and Guilt ──────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide brief descriptions of each moment for students unfamiliar with the scene.',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a list of staging options to choose from rather than generating from scratch.',
        core: 'Students make and justify their own three decisions.',
        stretch:
          "Students write a short paragraph explaining how their staging choices would affect the audience's sympathy for Macbeth at this critical moment.",
      },
    },
    homework:
  ...
  // ── Lesson 5: Macbeth\'s Deterioration - From Hero to Tyrant ──────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          "Provide Aristotle's definition on a card and two quotations from Act 4 to consider.",
        core: 'Students engage with the definition and vote with their own justification.',
        stretch:
          'Students consider: does the "Tomorrow, and tomorrow, and tomorrow" soliloquy (Act 5) restore Macbeth\'s status as a tragic figure? Write two sentences arguing for this view.',
      },
    },
    homework:
  ...
  // ── Lesson 6: The Banquet Scene and Macbeth\'s Paranoia ───────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a thesis sentence that acknowledges the difficulty of identifying a single turning point: "Although... could be considered the turning point, it is the Banquet scene that..."',
      },
    },
    homework:
  ...
  // ── Lesson 7: Lady Macbeth\'s Downfall - Sleepwalking and Guilt ───────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a sentence frame: "In Act 1 Lady Macbeth... but in Act 5 she... This shows that..."',
    ...
    mainActivities: [
      {
        ...
        resources: [
          'Act 5 Scene 1 full extract',
          'Annotation guide',
          'Act 2 Scene 2 comparison extract',
        ],
      },
      {
        ...
        resources: [
          'Verse/prose explanation handout',
          'Act 1 and Act 5 comparison extract',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a third sentence: "Ultimately, Shakespeare presents Lady Macbeth\'s collapse as... because this achieves the dramatic purpose of..."',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question: 'To what extent does the sleepwalking scene generate sympathy for Lady Macbeth?',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 8: Themes - Ambition, Power, Appearance vs Reality, Supernatural
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide eight quotation cards for students to sort into the correct theme branches.',
        core: 'Students generate their own examples for each theme.',
        stretch:
          'Students draw connecting lines between themes and write a one-sentence explanation of each connection.',
      },
    ...
    mainActivities: [
      {
        ...
        resources: [
          'Three-column grid',
          'Quotation banks for Ambition and Power',
          'Peer-teaching instruction card',
        ],
      },
      {
        ...
        resources: [
          'Modelled thematic paragraph',
          'Paragraph frame',
          'Quotation bank for Appearance/Reality and Supernatural',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          "Students add a fifth card summarising how all four themes are connected and what this reveals about Shakespeare's overall message in the play.",
      },
    },
    homework:
  ...
  // ── Lesson 9: Dramatic Techniques - Soliloquies, Imagery, Structure ───────
  {
    ...
    mainActivities: [
      {
        ...
        resources: [
          'Four soliloquy extract sheet',
          'Analysis table',
          'Comparative language prompts',
        ],
      },
      {
    ...
    worksheetQuestions: [
      ...
      {
        question: 'How does the five-act structure of Macbeth contribute to its dramatic power?',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 10: Exam Preparation ───────────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide five candidate points and ask students to rank them in order of importance.',
        core: 'Students generate their own list.',
        stretch:
          'Students add a sixth point specific to Macbeth: the piece of advice they most wish they had received earlier in the course.',
      },
    },
    homework:
