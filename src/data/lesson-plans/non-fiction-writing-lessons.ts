...
const lesson1: LessonPlan = {
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a word bank and a partially completed paragraph with gaps for students to insert techniques.',
        core: 'Students write a full paragraph independently and annotate the techniques they have used.',
        stretch:
          'Students write two paragraphs - one arguing for, one against - and evaluate which is more effective.',
      },
      resources: [
        'AFOREST techniques handout',
        'Model paragraph for annotation',
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students incorporate at least one embedded counterargument within a main paragraph rather than separating it.',
      },
      resources: [
        'Argument structure diagram',
        'Planning frame worksheet',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students suggest how the shared sentences could be improved with an additional layer of persuasion.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Define the term "counterargument" and explain why including one strengthens your own argument.',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Read the following extract and identify three persuasive techniques used: "Are we really prepared to stand by while our green spaces vanish? Every year, 7,000 acres of parkland are lost to development. This is devastating, disgraceful, and deeply short-sighted."',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Write a counterargument paragraph for the following thesis: "All students should study a foreign language until the age of 16." Begin by acknowledging the opposing view, then rebut it.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Explain the difference between "ethos," "pathos," and "logos" and give one example of each.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Write the opening paragraph of an argument for the motion: "The school day should start at 10am." Use at least three persuasive techniques.',
      lines: 8,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a comparison table with headings (Tone, Structure, Language) and one example already filled in.',
      core: 'Students identify three differences independently and share with a partner before class discussion.',
      stretch:
        'Students explain which extract is more persuasive and why, linking their answer to audience and purpose.',
    },
    resources: [
      'Speech extract handout',
      'Article extract handout',
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a pre-highlighted version with technique labels for students to match and explain.',
        core: 'Students annotate independently using a technique checklist, then rank and explain.',
        stretch:
          'Students analyse how the speech builds momentum - how does the order of techniques create a crescendo effect?',
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide sentence starters for each section of the planning frame and a rhetorical devices word bank.',
        core: 'Students plan and write independently, consciously varying their sentence structures.',
        stretch:
          'Students write the speech and then adapt the opening paragraph into an article format, noting the changes required.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a feedback frame: "I thought ___ was effective because..." and "To improve, you could..."',
      core: 'Students give verbal feedback linking their comments to specific persuasive techniques.',
      stretch:
        'Students evaluate whether the speech would need adapting if the audience changed (e.g., adults vs. teenagers).',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Write the opening paragraph of a speech persuading your school governors to invest in better mental health support for students. Use at least three rhetorical devices.',
      lines: 8,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students rewrite the argumentative extract in an advisory tone and explain what changes they made.',
    },
    resources: [
      'Three extract cards',
      'Sorting activity slide',
      'Modal verbs glossary (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a labelled diagram of letter layout and a checklist for students to tick off as they annotate.',
        core: 'Students annotate independently and complete the quiz without support materials.',
        stretch:
          'Students identify how the model letter could be improved and rewrite one paragraph at a higher level.',
      },
      resources: [
        'Model advisory letter',
        'Letter layout diagram',
        'Sincerely/faithfully quiz slide',
      ],
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students write the letter and then produce a second version as an informal advice guide (e.g., a leaflet), noting the differences in tone and format.',
      },
      resources: [
        'Scenario card',
        'Planning grid',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students explain the specific language choices that caused the tone shift and how to avoid them.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'When writing a formal letter, explain when you would use "Yours sincerely" and when you would use "Yours faithfully."',
      lines: 3,
      modelAnswer:
    ...
    {
      question:
        'Rewrite the following sentence so that it uses an advisory rather than an argumentative tone: "You must stop using your phone before bed because it is ruining your sleep."',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Write the opening paragraph of a formal letter to a local councillor advising them on how to improve facilities for young people in your area.',
      lines: 8,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a pre-labelled diagram of the inverted pyramid and a glossary of article terminology.',
        core: 'Students label the article independently and identify any instances of bias.',
        stretch:
          'Students compare the model article with a tabloid version of the same story and analyse how bias is introduced through language choices.',
      },
      resources: [
        'Printed news article',
        'Inverted pyramid diagram',
        'Highlighters',
        'Tabloid comparison (stretch tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a writing frame with paragraph starters and the five Ws pre-identified from the fact sheet.',
        core: 'Students select information from the fact sheet and organise it independently.',
        stretch:
          'Students write two versions of the headline - one neutral, one with tabloid bias - and explain the effect of each.',
      },
      resources: [
        'Scenario fact sheet',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students explain how changing a single word in a headline can shift it from objective to biased.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Explain the "inverted pyramid" structure used in news writing and why it is effective.',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'What are the "five Ws" and why should they appear in the opening paragraph of a news article?',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Rewrite the following biased sentence as an objective, informative statement: "The council\'s outrageous decision to close the beloved community centre has devastated local families."',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Write a standfirst (introductory summary of two to three sentences) for a news article about a school introducing a four-day week trial.',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Reduce the set to six devices and provide a help sheet with simplified definitions.',
      core: 'Full set of ten devices. Students must match and then write an original example for two of them.',
      stretch:
        'Full set plus two additional advanced devices (asyndeton, polysyndeton). Students write original examples for all.',
    },
    resources: [
      'Device matching cards (2 sets per pair)',
      'Answer key slide',
      'Help sheet (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Pre-highlight the devices in the extracts; students focus on naming and explaining the effect.',
        core: 'Students identify, name, and explain devices independently across all three texts.',
        stretch:
          'Students evaluate which extract uses rhetoric most effectively and write a comparative paragraph.',
      },
      resources: [
        'Three printed extracts',
        'Rhetorical devices reference sheet',
        'Annotation guide',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Reduce to four required devices. Provide sentence starters that naturally lead into specific devices.',
        core: 'Six devices required. Students label each device used in the margin.',
        stretch:
          'All nine devices required. Students must also ensure variety in sentence structure and paragraph organisation.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Students select from a shortlist of three devices and use a sentence starter for their explanation.',
      core: 'Students choose freely and write a two-sentence explanation.',
      stretch:
        'Students explain when their chosen device would be inappropriate or counterproductive.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Define "antithesis" and explain its effect on the reader. Provide an original example.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'What is the difference between "hyperbole" and "litotes"? Give an example of each.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Read the following extract and identify four rhetorical devices: "We stand at a crossroads. We can choose complacency, or we can choose courage. Every child, every family, every community deserves better. Is it not time we demanded change?"',
      lines: 6,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students identify a paragraph that could be moved without breaking the logic and explain why.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a pre-completed reference sheet with definitions; students add their own examples for each.',
        core: 'Students complete the reference sheet with definitions and examples during the presentation.',
        stretch:
          'Students evaluate which structural technique is most important for achieving a high grade and justify their answer.',
      },
      resources: [
        'Structural techniques presentation slides',
        'Reference sheet',
        'Annotated published extracts',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide the structural problems pre-identified and a planning frame for the rewrite with paragraph functions labelled.',
        core: 'Students identify problems and rewrite independently, labelling their structural choices in the margin.',
        stretch:
          'Students rewrite and then compose a brief examiner-style commentary explaining how their structural choices improve the piece.',
      },
      resources: [
        'Weak student response handout',
        'Structural techniques checklist',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students write two openings using different hook types and explain which is more effective for this topic.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Explain what a "circular structure" is and why a writer might choose to use one in a non-fiction text.',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'List four discourse markers that signal a shift in focus or a contrasting idea, and write a sentence using one of them.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Explain the "zoom in / zoom out" technique and give an example of how it might be used in an article about education.',
      lines: 5,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a comparison table with categories pre-filled; students add examples from the two texts.',
      core: 'Students identify five differences independently and categorise them.',
      stretch:
        'Students write a third version - a voicemail to a teacher - and explain which register choices they made and why.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide audience and purpose options to choose from at each station, plus a glossary of register-related terms.',
        core: 'Students answer all three questions independently at each station.',
        stretch:
          'Students rank the six texts from most to least formal and write a paragraph justifying their ranking.',
      },
      resources: [
        'Six printed texts (laminated for reuse)',
        'Gallery walk worksheet',
        'Glossary (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a sentence-level register conversion sheet with formal and informal equivalents for key phrases.',
        core: 'Students write both texts independently and highlight register features.',
        stretch:
          'Students write a third version - a speech to Year 7 students - and explain how the register differs from both the letter and the blog post.',
      },
      resources: [
        'Factual bullet points handout',
        'Register conversion sheet (support tier)',
        'Highlighting pens',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide the formal sentence with key words underlined to indicate what needs changing.',
      core: 'Students rewrite both sentences independently.',
      stretch:
        'Students explain which specific changes they made and link each to audience awareness.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Rewrite the following informal sentence in a formal register suitable for a letter to an MP: "Honestly, the state of the roads round here is doing my head in - potholes everywhere and nobody seems to care."',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        "Why is sustaining register important in exam conditions? What happens if a student's register is inconsistent?",
      lines: 4,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students explain the register and audience problems with review (3) and rewrite it for a broadsheet newspaper.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the analysis grid partially completed with conventions listed; students find examples.',
        core: 'Students complete the grid independently with conventions and examples.',
        stretch:
          'Students identify one weakness in the model review and suggest how to improve it, with specific rewritten sentences.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a sentence-level planning frame with starters for each section and an evaluative vocabulary list.',
        core: 'Students plan and write independently, aiming to include all five conventions.',
        stretch:
          'Students write the review and then draft an alternative headline - one for a broadsheet, one for a tabloid - and explain the register difference.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students revise another student's headline to make it more effective and explain their changes.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Explain the difference between a "descriptive" sentence and an "evaluative" sentence in a review. Give an example of each.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Why is it important for a review to include both strengths and weaknesses rather than being entirely positive or entirely negative?',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Write an evaluative paragraph about a school subject you enjoy. Include at least three evaluative adjectives and one piece of specific evidence.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Write a headline for each of the following reviews: (a) a positive review of a new pizza restaurant, (b) a negative review of a school play, (c) a mixed review of a theme park.',
      lines: 5,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a checklist of formal letter conventions so students can compare systematically.',
    ...
    resources: [
      'Flawed letter slide',
      'Corrected letter reveal slide',
      'Conventions checklist (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students explain why each convention exists - what does it communicate about the writer?',
      },
      resources: [
        'Annotated model letter slide',
        'Letter layout template (support tier)',
        'Mini-whiteboards',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a planning frame with paragraph functions and sentence starters for the opening and closing.',
        core: 'Students plan and write independently under timed conditions.',
        stretch:
          'Students include a paragraph that uses concession ("While I acknowledge that...") before rebutting the counterargument.',
      },
      resources: [
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Partners also comment on one strength and one area for improvement in register or argumentation.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "Write out the correct layout for the opening of a formal letter to Mrs J. Patterson, Head of Planning, at Westfield District Council, 14 High Street, Westfield, WF3 8PQ. Your address is 7 Oak Lane, Westfield, WF2 4RD. Today's date is 15 March 2026.",
      lines: 10,
      modelAnswer:
    ...
    {
      question:
        'Explain why formal letters should avoid contractions, slang, and first-name terms.',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Write the closing paragraph and sign-off for a formal letter to the editor of a newspaper in which you have argued that public libraries should receive more funding.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Identify three differences between a formal letter and a formal email in terms of layout and conventions.',
      lines: 5,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide the three categories on a template card that students fill in for each question.',
      core: 'Students decode independently on whiteboards, then check with a partner.',
      stretch:
        'Students explain what register, tone, and structural choices each question demands and why.',
    },
    resources: [
      'Four exam-style questions on slides',
      'Template cards (support tier)',
      'Mini-whiteboards',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students plan without a frame, using their own method, and include notes on specific rhetorical devices they intend to use.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Allow students to keep their planning frame visible and provide a proofreading checklist for the final two minutes.',
        core: 'Full exam conditions with no support materials.',
        stretch:
          'Students aim for the top band: "compelling, convincing communication" with "extensive, ambitious vocabulary" and "varied, inventive structural features."',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a simplified mark scheme with three bands (developing, secure, excellent) and guiding questions.',
      core: 'Full mark scheme. Students self-assess against both AO5 and AO6 independently.',
      stretch:
        'Students identify the single change that would move their response up one mark band and rewrite one paragraph to demonstrate it.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Explain the difference between AO5 (Content and Organisation) and AO6 (Technical Accuracy) in the AQA Paper 2 Section B mark scheme.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'A student writes: "Volunteering is well good because you get to help people and stuff and it looks good on your CV innit." Rewrite this sentence for a speech at a school assembly, maintaining a formal but engaging register.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'List five things you should check during the proofreading stage of a timed exam response.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Write the opening paragraph of a speech persuading your school to introduce a "screen-free day" once a month. Use at least two rhetorical devices and establish a clear, authoritative tone.',
      lines: 8,
      modelAnswer:
