...
const lesson1: LessonPlan = {
  ...
  keywords: [
    'skimming', 'scanning', 'close reading', 'annotation',
    'topic sentence', 'key words', 'inference',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide the three strategy names on a card with simple definitions before the task begins.',
      core: 'Students attempt all three tasks and write a sentence explaining how each strategy felt different.',
      stretch: 'Students explain which strategy required the deepest thinking and why, linking to exam question demands.',
    },
    resources: ['Public libraries text on slide', 'Timer', 'Strategy definition cards (support tier)'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a checklist at each station explaining what to look for (e.g., "For skimming: read the first sentence of each paragraph").',
        core: 'Students complete all tasks independently and self-assess against the model answers provided at each station.',
        stretch: 'At the close reading station, students write a short analytical paragraph explaining how the writer creates a sense of danger.',
      },
      resources: ['Station texts (x3)', 'Annotation guide', 'Retrieval question sheets', 'Model answers for self-assessment'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a table matching question types to strategies with one example already completed.',
        core: 'Students categorise all questions, answer two, and explain their strategy choice for each.',
        stretch: 'Students write their own exam question for each strategy type, based on "The Old Market" text.',
      },
      resources: ['Exam question display slides', 'Practice text handout', 'Strategy-matching table'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain how they would combine strategies when tackling a full exam paper under timed conditions.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Define skimming, scanning, and close reading. Explain when you would use each strategy during an English exam.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Read "The Old Market" text. List four things you learn about the market from this passage.',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'How does the writer use language to suggest the market is in decline? Refer to two examples from the text.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Which reading strategy would you use first when approaching an unseen text in the exam? Explain your reasoning.',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Re-read the sentence: "The smell of roasting chestnuts drifted across the square — sweet, warm, almost defiant in the face of progress." What does the word "defiant" suggest about the market?',
      lines: 5,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  keywords: [
    'inference', 'deduction', 'implicit', 'explicit',
    'connotation', 'implication', 'textual evidence',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students categorise their inferences by reliability — which are most strongly supported by the evidence?',
    },
    resources: ['Abandoned classroom photograph', 'Mini-whiteboards', 'Sentence stem cards (support tier)'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a partially completed inference grid with two rows filled in; students complete two more.',
        core: 'Students complete four rows independently and rank their inferences by strength of evidence.',
        stretch: 'Students write a paragraph explaining what they think the letter contained, supported entirely by inference from the text.',
      },
      resources: ['Practice text: "The Letter"', 'Inference grid worksheet', 'Partially completed grid (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide the location answer (a hospital or doctor\'s waiting room) and ask students to find three pieces of evidence to prove it.',
        core: 'Students answer all three questions with multiple pieces of evidence for each deduction.',
        stretch: 'Students identify what the writer deliberately withholds from the reader and explain how this creates tension.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students write their own example of each, drawn from a text they have studied previously.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'What is the difference between inference and deduction? Provide an example of each.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Re-read "The Letter." What can you infer about the character\'s emotional state? Support your answer with two quotations.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Re-read "The Waiting Room." What can you deduce about the relationship between the woman and the child? Use evidence from the text.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why is inference an important skill for the English Language exam? Explain with reference to specific question types.',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Read the following sentence from "The Waiting Room": "She checked her phone every few minutes, then put it face down on her lap." What does this detail suggest? Explore two possible interpretations.',
      lines: 6,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  keywords: [
    'writer\'s methods', 'language devices', 'structural features', 'effect on reader',
    'imagery', 'juxtaposition', 'semantic field', 'tone', 'anaphora',
  ],
  starterActivity: {
    title: 'Method Bingo',
    duration: '8 minutes',
    ...
    resources: ['Bingo grid handouts', 'Persuasive speech extract on slide', 'Definitions sheet (support tier)'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide an annotation key showing what to look for (language devices, sentence patterns, imagery) with colour coding.',
        core: 'Students annotate independently, identifying at least four methods with quotations and effects.',
        stretch: 'Students analyse how the structural choices (paragraph division, shift from actions to setting) contribute to the overall effect.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide a paragraph frame: "The writer uses [method] in the phrase \'[quotation]\'. This suggests... because... The effect on the reader is..."',
        core: 'Students write two independent paragraphs using WHAT-HOW-WHY structure.',
        stretch: 'Students write a paragraph that analyses how two methods work together to create a combined effect.',
      },
      resources: ['WHAT-HOW-WHY structure display', 'Paragraph frame (support tier)', 'Peer assessment checklist'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students consider what the writer\'s most important overall intention was and which method best serves that intention.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Re-read "The Factory." How does the writer use repetition to convey the monotony of factory work? Refer to specific examples.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Analyse the effect of the simile "fluorescent lights buzzed like trapped insects." What does this suggest about the factory environment?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'What is a semantic field? Identify the semantic field in "The Factory" and explain its effect.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'How does the writer use structure in "The Factory" to develop the reader\'s understanding of the setting?',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Write one WHAT-HOW-WHY paragraph analysing a method of your choice from "The Factory."',
      lines: 8,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  keywords: [
    'evaluate', 'critical response', 'effectiveness', 'alternative interpretation',
    'authorial intent', 'personal response', 'tone', 'perspective',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain how a writer\'s silence or omission can be more powerful than explicit statement.',
    },
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a paragraph frame with sentence starters for each step of the evaluation structure.',
        core: 'Students write one full evaluative paragraph independently after the modelled example.',
        stretch: 'Students write a counter-paragraph exploring where the writer might be doing something other than creating sympathy (e.g., creating tension or conveying resilience).',
      },
      resources: ['Practice text: "The Crossing"', 'Evaluation structure display', 'Paragraph frame (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a planning grid: "Evidence that agrees / Evidence that disagrees / My overall judgement."',
        core: 'Students write two to three paragraphs with evidence, analysis, and a clear personal conclusion.',
        stretch: 'Students evaluate the writer\'s structural choices as well as language choices, considering why the text ends with the mother\'s gaze.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students write a sentence that captures a nuanced evaluation — acknowledging complexity rather than simple agreement.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: '"A student said: \'The writer makes the reader feel sympathy for the boy.\' To what extent do you agree?" Write an evaluative paragraph using evidence from "The Crossing."',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'What does the metaphor "The sea was calm, which felt like a lie" suggest? Evaluate its effectiveness.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Explain what the final sentence — "His mother looked at the horizon as if it owed her something" — reveals about the mother\'s character.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why is it important to consider "alternative interpretations" in an evaluation question? Give an example from "The Crossing."',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  keywords: [
    'summarise', 'synthesise', 'main idea', 'supporting detail',
    'paraphrase', 'integrate', 'connectives of comparison',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Students highlight the single most important sentence in the passage first, then build their tweet from it.',
      core: 'Students write the tweet independently and compare with a partner.',
      stretch: 'Students write two versions: one that summarises the content and one that summarises the writer\'s attitude.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide the four main points; students add supporting details and write the summary.',
        core: 'Students identify main points independently and write a four-sentence summary.',
        stretch: 'Students write a summary that also captures the writer\'s tone and attitude, not just the factual content.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide a Venn diagram to plan similarities and differences before writing, with one example completed.',
        core: 'Students write two to three integrated paragraphs using evidence from both sources.',
        stretch: 'Students evaluate which source presents a more convincing picture of the digital divide and explain why.',
      },
      resources: ['Source B: "Connected at Last"', 'Comparison connectives word bank', 'Venn diagram (support tier)'],
    },
  ],
  plenaryActivity: {
  ...
  worksheetQuestions: [
    {
      question: 'What is the difference between summarising and synthesising? Explain with reference to exam questions.',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Write a four-sentence summary of Source A: "The Digital Divide." Use your own words.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Using both Source A and Source B, summarise the differences in how the writers present the impact of the internet on rural communities.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Why is it important to use your own words when summarising rather than copying from the text?',
      lines: 3,
      modelAnswer:
    ...
    {
      question: 'Identify two connectives of comparison and two connectives of contrast. Write a sentence using one of each, based on the two sources.',
      lines: 4,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  keywords: [
    'viewpoint', 'perspective', 'bias', 'tone',
    'attitude', 'purpose', 'audience', 'register',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Highlight the key words in each headline that reveal the viewpoint (e.g., "invests" vs "foot the bill").',
      core: 'Students identify the viewpoint and three language clues in each headline.',
      stretch: 'Students discuss who the intended audience might be for each headline and how this shapes the language used.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide the viewpoint statement and two pre-selected quotations; students find two more and explain all four.',
        core: 'Students complete the full tracking sheet independently.',
        stretch: 'Students identify where the writer addresses and dismisses counter-arguments, and explain how this rhetorical strategy strengthens the viewpoint.',
      },
      resources: ['Opinion article: "Why School Uniforms Must Go"', 'Viewpoint tracking sheet', 'Pre-selected quotations (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a writing frame with sentence starters: "Contrary to popular belief... Furthermore... It is precisely because..."',
        core: 'Students write independently using three deliberate techniques, annotated in the margin.',
        stretch: 'Students attempt to write in a specific register (e.g., formal newspaper editorial) and explain how register reinforces viewpoint.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students add a second sentence evaluating how successfully the viewpoint is conveyed.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'How does the writer of "Why School Uniforms Must Go" use language to present school uniforms negatively? Refer to two specific examples.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'The writer says: "We are told that uniforms promote equality, but this is a convenient myth." Analyse this sentence.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Write 100 words defending school uniforms. Use at least two language techniques to convey a positive viewpoint.',
      lines: 8,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  keywords: [
    'compare', 'contrast', 'viewpoint', 'perspective',
    'methods', 'similarly', 'conversely', 'whereas',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Teacher underlines key words in each sentence; students discuss what each word suggests.',
      core: 'Students identify three language differences and explain what each reveals about the viewpoint.',
      stretch: 'Students discuss which opening is more persuasive and why, considering rhetorical effectiveness.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide three points of comparison already identified; students find evidence for each.',
        core: 'Students identify four points of comparison with evidence and methods for each.',
        stretch: 'Students also consider how the form of each text (letter vs blog) influences the viewpoint and tone.',
      },
      resources: ['Source A and Source B handouts', 'Comparison planning grid', 'Connectives word bank'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a paragraph frame: "[Point]. In Source A, [writer] uses [method/quotation], which suggests... In contrast, Source B [method/quotation], which creates a different effect because..."',
        core: 'Students write two to three integrated paragraphs independently.',
        stretch: 'Students write a concluding paragraph evaluating which writer presents a more convincing argument, explaining why with reference to methods.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Provide the structure: "While Writer A [viewpoint] through [method], Writer B [viewpoint] using [method]."',
      core: 'Students craft the sentence independently.',
      stretch: 'Students write a sentence that also captures a subtle similarity beneath the surface difference.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Analyse how tone differs between the two sources. Refer to specific language choices.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'How does the form of each text (letter vs blog) influence the viewpoint presented?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Which writer do you find more convincing? Justify your response with reference to methods used in both sources.',
      lines: 6,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  keywords: [
    'non-fiction', 'rhetoric', 'persuasion', 'form',
    'purpose', 'audience', 'ethos', 'pathos', 'logos',
    'direct address', 'anecdote',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students predict what language techniques each text is likely to use, based on its PAF profile.',
    },
    resources: ['Four text extracts on slide', 'Mini-whiteboards', 'PAF reference card (support tier)'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide the technique names in a word bank; students match them to quotations and explain effects.',
        core: 'Students identify five techniques independently, explain effects, and classify as ethos, pathos, or logos.',
        stretch: 'Students analyse how the speech builds in intensity structurally — from personal anecdote to collective accusation to call to action — and explain why this structure is persuasive.',
      },
      resources: ['Speech text: "A Future Worth Fighting For"', 'Analysis grid', 'Rhetorical techniques word bank (support tier)', 'Ethos/Pathos/Logos reference sheet'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a comparison table with headings (tone, audience, technique, purpose) — students fill in evidence for each text.',
        core: 'Students complete the comparison table and write one integrated comparison paragraph.',
        stretch: 'Students evaluate which text is more effective at challenging the reader\'s assumptions and explain why, with specific reference to form and method.',
      },
      resources: ['Article text: "The Cost of Going Green"', 'Comparison table', 'Paragraph frame (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students identify a quotation that uses two types of appeal simultaneously and explain how.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Define ethos, pathos, and logos. Give one example of each from the speech "A Future Worth Fighting For."',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'How does the speaker use the pronoun "we" to position the audience? Analyse its effect.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Analyse the tone of the editorial "The Cost of Going Green." How does it differ from the speech?',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'What does the editorial writer mean by calling green policy a "luxury belief"? Evaluate this claim.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'How does the structure of the speech build towards its final sentence? Explain the effect on the audience.',
      lines: 5,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  keywords: [
    'multi-source', 'time management', 'question decoding', 'mark allocation',
    'assessment objectives', 'retrieval', 'analysis', 'comparison',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students predict what the highest-scoring response to each question would need to include.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide colour-coded highlighting instructions: "Highlight language features in yellow, viewpoint clues in blue."',
        core: 'Students annotate independently using the three-stage reading process.',
        stretch: 'Students note connections and contrasts between the sources in the margins as they read.',
      },
      resources: ['Source A and Source B handouts', 'Questions on display', 'Highlighters', 'Timer'],
    },
    {
      ...
      differentiation: {
        support: 'Provide sentence starters for Q2 and Q3. For Q1, underline the relevant section of Source A.',
        core: 'Students answer Q1-Q3 independently under timed conditions and begin Q4.',
        stretch: 'Students aim for full marks on each question by consciously targeting the top-band descriptors.',
      },
      resources: ['Exam questions handout', 'Mark scheme criteria display', 'Sentence starters (support tier)', 'Timer'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Provide a structured reflection form with tick-box options and space for one written comment.',
      core: 'Students complete all three reflection prompts in writing.',
      stretch: 'Students identify a specific skill gap (e.g., "I struggle to integrate both sources") and create a personal target.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Use details from both sources to write a summary of the differences in how the writers feel about mountain climbing.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'How does the writer of Source B use language and structure to express their changing attitude to climbing?',
      lines: 10,
      modelAnswer:
    ...
    {
      question: 'Explain how you would allocate your time across a Paper 2 reading section with questions worth 4, 8, 12, and 16 marks. Justify your allocation.',
      lines: 5,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  keywords: [
    'exam conditions', 'timed practice', 'mark scheme', 'self-assessment',
    'retrieval', 'analysis', 'synthesis', 'evaluation',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a laminated time-management card that students can keep on their desk during the exam.',
      core: 'Students recall and apply the strategy independently.',
      stretch: 'Students set a specific target for a higher mark band (e.g., "I will explore alternative interpretations in Q4").',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a time-management card and the question-strategy matching guide from Lesson 9. Allow an additional 5 minutes if needed.',
        core: 'Students complete all four questions under strict timed conditions.',
        stretch: 'Students aim for top-band responses by including alternative interpretations and structural analysis.',
      },
      resources: ['Exam paper with sources and questions', 'Time-management card (support tier)', 'Timer display'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Teacher guides the self-assessment process step by step, modelling how to use the mark scheme.',
      core: 'Students self-assess Q1-Q2 and peer-assess Q3 independently using the mark scheme.',
      stretch: 'Students assess their own Q4 against the top-band descriptors and identify specifically what would lift their response to the next band.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Use details from both sources to write a summary of the similarities in how the writers feel about physical books.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'How does the writer of Source A use language and structure to convey her feelings about the bookshop?',
      lines: 12,
      modelAnswer:
    ...
    {
      question: 'Compare how the writers of Source A and Source B convey their perspectives on the future of books and bookshops.',
      lines: 14,
      modelAnswer:
    ...
    {
      question: 'Reflect on your exam performance. Which question did you find most challenging and what specific skill do you need to improve?',
      lines: 4,
      modelAnswer:
