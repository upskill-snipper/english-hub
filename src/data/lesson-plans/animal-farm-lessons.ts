...
export const animalFarmLessons: LessonPlan[] = [
  // ── Lesson 1: Introduction - Orwell, Russian Revolution & Allegory ───
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a word bank: inequality, oppression, freedom, power, corruption, betrayal.',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          "Sentence starter provided: 'An allegory is... Animal Farm is an allegory because...'",
    ...
    worksheetQuestions: [
      {
        question: 'What is an allegory? Explain in your own words.',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 2: Old Major's Speech - Propaganda & Persuasion ───────────
  {
    ...
    starterActivity: {
      ...
      resources: [
        'Speech video clip and speaker',
        'Persuasive techniques checklist (support tier)',
      ],
    },
    mainActivities: [
      {
      ...
      },
      {
        ...
        differentiation: {
          support: 'Provide argument starter cards with pre-selected quotations for each side.',
    ...
    worksheetQuestions: [
      ...
      {
        question: "How does Old Major's speech foreshadow the events of the rest of the novella?",
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 3: Napoleon & Snowball - Leadership & Power Struggle ──────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support: 'Key quotations pre-underlined. PEEL frame provided with sentence starters.',
    ...
    worksheetQuestions: [
      {
        question: 'How does Orwell present Snowball as an effective leader in the early chapters?',
        lines: 5,
        modelAnswer:
      ...
      {
        question: "How does Napoleon consolidate his power after Snowball's expulsion?",
        lines: 5,
        modelAnswer:
      ...
      {
        question: "What is the symbolic significance of Napoleon's dogs?",
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Explain how Snowball is used as a scapegoat after his expulsion.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 4: Squealer - Language, Propaganda & Manipulation ─────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch: "Students write their own 'truthful vs. spun' pair for a school scenario.",
      },
    ...
    worksheetQuestions: [
      ...
      {
        question: 'How does Squealer rewrite the history of the Battle of the Cowshed?',
        lines: 5,
        modelAnswer:
      ...
      {
        question: "Why is Squealer essential to Napoleon's power? Could Napoleon rule without him?",
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 5: Boxer - Loyalty, Exploitation & the Working Class ──────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students argue for both sides before choosing, demonstrating nuanced thinking.',
      },
    ...
    worksheetQuestions: [
      ...
      {
        question: "Why is Benjamin's reaction to Boxer's removal significant?",
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'To what extent is Boxer responsible for his own fate? Argue both sides.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 6: The Commandments - Corruption, Hypocrisy & Revision ───
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students adopt an ironic or satirical tone in the style of Orwell himself.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question: 'What is historical revisionism, and how does Orwell depict it in Animal Farm?',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 7: Key Themes - Power, Corruption, Class, Education ───────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support: 'Paragraph frame provided with the structure modelled and key phrases given.',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students argue why their chosen theme encompasses all the others.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question: 'How does Orwell present the theme of class and inequality in the novella?',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Why is education such an important theme in Animal Farm?',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'How are the themes of language and control connected in the novella?',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Choose two themes and explain how they are connected in Animal Farm.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 8: Symbolism & Allegory - Mapping Characters to History ───
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students explain why authors use symbols instead of stating meaning directly.',
      },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students explain why their chosen symbol is more effective than the runner-up.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question: 'What is the difference between a symbol and an allegory?',
        lines: 3,
        modelAnswer:
      ...
      {
        question: 'What is the symbolic significance of the farmhouse?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 9: Language, Satire & Orwell's Craft ──────────────────────
  {
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support: 'Irony types pre-labelled on each extract. Analysis prompts provided for each.',
      ...
      },
      {
        ...
        differentiation: {
          support: 'Writing frame with sentence stems and a bank of useful analytical phrases.',
    ...
    worksheetQuestions: [
      {
        question: 'Define satire and explain how Animal Farm functions as a satire.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Identify and explain one example of dramatic irony in Animal Farm.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 10: Exam Practice - Writing a Top-Band Essay ──────────────
  {
    ...
    starterActivity: {
      ...
      resources: [
        'Exam question display slide',
        'AO summary card',
        'Question deconstruction frame',
      ],
    },
    mainActivities: [
      {
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Write an effective conclusion for the same essay question.',
        lines: 5,
        modelAnswer:
