...
export const y8Term2Lessons: LessonPlan[] = [
  // ── Lesson 1: Introduction to Conflict Poetry ────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide the three sentence frames: "The poem directly tells us that...", "We can infer that... because...", "The poem makes me feel... because...".',
        core: 'Students write all three sentences independently.',
        stretch:
          'Students write a fourth sentence linking their personal response to a specific technique the poet uses.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'Name the three contextual questions you should ask about any conflict poem, and explain why each one matters.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'Choose one of the poems studied in this lesson. Identify the speaker and explain what their attitude to conflict appears to be.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Write down two differences you noticed between the two poems studied in this lesson.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Explain why a common mistake when studying conflict poetry is to assume all of it is anti-war.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 2: Imagery in War Poetry ─────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a further sentence that zooms in on a single word in their quotation and explores its specific connotations.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is the difference between a simile and a metaphor? Give an example of each from war poetry.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "Why is sensory imagery especially important in war poetry? Explain with reference to the poet's purpose.",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Choose a quotation from one of the poems studied today. Apply steps 3 and 4 of the four-step method.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'A student writes: "The poet uses a metaphor." Explain what is wrong with this analysis and how it should be improved.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 3: Tone and Mood in Conflict Poetry ───────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          "Provide the sentence frame: \"The overall tone of [poem] is [tone word] because the words '[word 1]' and '[word 2]' suggest [explanation].\"",
        core: 'Students write the sentence independently.',
        stretch:
          'Students write two sentences: one for the opening tone and one for the tone after the volta, showing awareness of change.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'Identify the volta in the poem studied today. Explain what triggers the shift and what effect it has on the reader.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'Choose a word from the poem that you think is particularly important for creating tone. Explain your choice in three sentences.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'A student says: "The tone of the poem is sad." Explain why this is a weak analytical statement and write an improved version.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 4: Structure, Form, and Comparison Preparation ────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Students choose from a bank of structural effect words: controlled, fragmented, breathless, relentless, ordered, chaotic.',
        core: 'Students generate their own three words and write their comparative sentence.',
        stretch:
          "Students write a sentence that addresses why the structural difference matters in the context of each poem's theme.",
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Define enjambment and explain the effect it typically creates. Use an example from poetry you have studied.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Why might a war poet choose to write in free verse rather than a regular form like a sonnet?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'How can irregular stanza lengths reflect the content of a conflict poem? Explain with reference to a poem you have studied.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "Write a topic sentence for a paragraph comparing the structural choices of two conflict poems. Include both poems' titles and a comparative connective.",
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 5: Comparative Essay Planning and Writing ─────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Students highlight only comparative connectives and count whether there is at least one per body paragraph.',
        core: 'Students use all three colours and write a self-assessment target.',
        stretch:
          'Students also annotate one of their evaluative comments, explaining whether it focuses on similarity, difference, or significance - and adding a sentence that addresses significance if it is missing.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'Write a comparative sentence about two conflict poems using the connective "whereas."',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'What is "feature-spotting" and why does it fail to score highly in a comparative essay?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Explain the difference between the alternating and block methods for structuring a comparative essay. Which is more effective and why?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Write an evaluative comment that could appear in the conclusion of a comparative essay about two conflict poems.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 6: Introduction to Macbeth and Shakespeare's Language ──────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write an extended answer to the final question (3-4 sentences) explaining the dramatic and psychological function of the soliloquy.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Why was Macbeth written in 1606? Explain how the historical context shaped at least one aspect of the play.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'What is iambic pentameter? Why does it matter when a character breaks this rhythm?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Define dramatic irony. Give an example of dramatic irony from the opening of Macbeth.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Why does Shakespeare switch a character from verse to prose? What does it usually signal?',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 7: Power and Ambition in Macbeth ──────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students argue whether Shakespeare wants the audience to pity or condemn Macbeth at this point, and which is the more powerful response.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'How does Lady Macbeth use the idea of masculinity to persuade Macbeth to kill Duncan? Use a quotation in your answer.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "What does the floating dagger in Act 2 Scene 1 represent? What does it tell us about Macbeth's state of mind?",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "Explain how the banquet scene (Act 3 Scene 4) shows the political consequences of Macbeth's ambition.",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Write a paragraph about how Shakespeare presents the theme of ambition. Include an embedded quotation.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 8: The Soliloquy - "Tomorrow, and tomorrow, and tomorrow" ──────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Students choose from three response options: "I pity Macbeth because...", "I condemn Macbeth because...", "I feel both pity and condemnation because..."',
        core: 'Students write a 3-4 sentence audience response independently.',
        stretch:
          'Students consider how a 1606 audience (who believed strongly in the divine right of kings) would respond differently from a modern audience, and what that tells us about how meaning changes across time.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is the dramatic function of a soliloquy? Why is it particularly important in Macbeth?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Analyse the effect of the triple repetition of "tomorrow" in the opening of the soliloquy.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Explain the metaphor of life as "a poor player / That struts and frets his hour upon the stage." What does this suggest about Macbeth\'s view of human existence?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'How might a director stage the "Tomorrow" soliloquy to emphasise Macbeth\'s psychological isolation?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'How does the "Tomorrow" soliloquy show what ambition ultimately leads to in Macbeth?',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 9: Macbeth and Julius Caesar - Comparative Extract Work ─────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a brief comparison: how does the internal experience of Macbeth differ from that of Brutus at the moment of decision? What does this tell us about the difference between the two plays?',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Briefly explain the historical context of Julius Caesar. Why does Brutus join the conspiracy against Caesar?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Compare the persuasion methods of Lady Macbeth and Cassius. What is the key difference?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Write a comparative topic sentence for a paragraph about how Shakespeare explores the theme of manipulation in Macbeth and Julius Caesar.',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          "Which method of manipulation do you find more disturbing - Lady Macbeth's or Cassius's? Justify your view with evidence from both plays.",
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 10: End-of-Term Assessment ────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students draft a full thesis statement before beginning to write.',
      },
      resources: [
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Students highlight only quotations (green) and circle evaluative comments (underline), and write one strength and one target.',
          core: 'Students use all four colours and write two strengths and one target.',
          stretch:
            'Students write a reflection paragraph explaining which aspect of the essay they are most proud of and why, linking to a specific analytical skill developed this term.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a connection: "What I have learned about conflict in poetry connects to Macbeth because both..."',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          '(Assessment preparation) What are the four key areas you should cover when analysing a conflict poem?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          '(Assessment preparation) Write a model thesis statement for a comparative essay on two conflict poems of your choice.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          '(Assessment preparation) Write a model analytical paragraph about how Shakespeare presents ambition in Macbeth.',
        lines: 8,
        modelAnswer:
      ...
      {
        question:
          '(Assessment preparation) What should a conclusion to a Shakespeare essay include? Write a model conclusion for a Macbeth essay.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          '(Reflection) Which skill developed during this term do you feel most confident about now, and which do you most want to improve? Give specific examples.',
        lines: 6,
        modelAnswer:
