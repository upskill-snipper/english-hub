...
export const y8ExtendedLessons: LessonPlan[] = [
  ...
  // ── Lesson y8ext-01: Consolidating Dystopia Analysis ──────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Control mechanism cards (printed or digital)', 'Sorting grid template', 'Mini-whiteboards'],
    },
    mainActivities: [
      {
      ...
      {
        title: 'Extended Writing: "How Does Collins Show That the Hunger Games Are a Tool of Political Control?"',
        duration: '22 minutes',
        instructions:
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a peer feedback sentence frame: "You successfully... because... One thing you could improve is..."',
    ...
    worksheetQuestions: [
      {
        question: 'Identify three methods the Capitol uses to control the Districts. For each, provide a specific example from the novel.',
        lines: 8,
        modelAnswer:
      ...
      {
        question: 'How does the word "spectacle" apply to the Hunger Games? Explain using evidence from the novel.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Explain how Collins uses the character of Caesar Flickerman to show the role of propaganda in Panem.',
        lines: 6,
        modelAnswer:
    ...
    targetedSkills: ['8R.4', '8R.5', 'Analytical Writing', 'Synthesising Evidence', 'Subject Terminology'],
  },
  ...
  // ── Lesson y8ext-02: Comparing The Hunger Games with 1984 Extracts ─────────
  {
    ...
    mainActivities: [
      {
        title: 'First Reading of 1984 Extract: "It was terribly dangerous to let your thoughts wander..."',
        duration: '18 minutes',
        instructions:
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Allow students to read directly from their written paragraph rather than speaking from memory.',
    ...
    worksheetQuestions: [
      {
        question: 'What is a "telescreen" in 1984? How is it similar to and different from the Hunger Games\' method of surveillance?',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'Write a comparative sentence using a discourse marker that connects how Collins and Orwell present fear.',
        lines: 3,
        modelAnswer:
      ...
      {
        question: 'What does the phrase "thoughtcrime IS death" reveal about the society in 1984? How does this compare with the world of Panem?',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'How does context — the time in which each book was written — help explain the differences between the two novels?',
        lines: 6,
        modelAnswer:
    ...
    targetedSkills: ['8R.1', 'Comparative Writing', 'Contextual Understanding', 'Discourse Markers', '8R.4'],
  },
  ...
  // ── Lesson y8ext-03: Year 8 Wider Reading Response ────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide a sentence frame: "This text is about... It creates a feeling of... My reaction is..."',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide the success criteria on a card so students can hold it next to their work while self-assessing.',
    ...
    worksheetQuestions: [
      {
        question: 'What is meant by "retrieval"? Give an example of a retrieval question you might be asked about a text.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'What is the difference between retrieval and inference? Use an example to illustrate your answer.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Explain what a "structural feature" is and give two examples of how a writer might use structure to affect the reader.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'Write a quick-analysis sentence about the following phrase from an imaginary text: "The silence pressed in like walls."',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson y8ext-04: Cross-Genre Comparison (Novel and Poem) ──────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide a prompt card listing three things to look for: (1) length, (2) feeling or emotion, (3) specific words.',
    ...
    worksheetQuestions: [
      {
        question: 'What is meant by "form" in the context of comparing texts? Give two examples of different literary forms.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Explain how a line break in a poem can affect the meaning or impact for the reader.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Write a comparative sentence connecting The Hunger Games and a conflict poem you have studied. Use at least one discourse marker.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson y8ext-05: Feedback and Redrafting Session ──────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Students write their target using the frame: "Next time I write analytically, I will ___ because ___."',
    ...
    worksheetQuestions: [
      {
        question: 'What is the difference between "editing" and "redrafting"? When is each most useful?',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Rewrite the following weak analytical sentence to make it stronger: "Collins uses the word \'fire\' which is interesting."',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Name three specific improvements a writer can make when redrafting an analytical paragraph.',
        lines: 4,
        modelAnswer:
    ...
    targetedSkills: ['8W.6', 'Analytical Writing', 'Metacognition', 'Vocabulary Development', 'Redrafting'],
  },
  ...
  // ── Lesson y8ext-06: Year 8 End-of-Term Speaking and Listening Task ────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide each group with a brief argument card listing two pre-written points to start from.',
      ...
      resources: ['Motion displayed on board', 'Group argument cards (support)', 'Space for physical movement'],
    },
    mainActivities: [
      {
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Give two features of formal spoken language that make a debate contribution more effective.',
        lines: 4,
        modelAnswer:
    ...
    targetedSkills: ['8SL.1', '8SL.2', 'Oracy', 'Debate', 'Argument Construction', 'Active Listening'],
  },
  ...
  // ── Lesson y8ext-07: Grammar Focus — Complex Sentences ────────────────────
  {
    ...
    worksheetQuestions: [
      {
        question: 'What is the difference between a main clause and a subordinate clause? Give an example of each.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Choose any three subordinating conjunctions and explain what kind of relationship each one creates between clauses.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Rewrite this sentence as a complex sentence: "Lady Macbeth is ambitious. She persuades Macbeth to kill Duncan."',
        lines: 3,
        modelAnswer:
      ...
      {
        question: 'Why is sentence variety important in analytical writing? What happens if a student uses only simple sentences?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson y8ext-08: Building Vocabulary for Year 9 ──────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Vocabulary auction display', 'Glossary card (support)', 'Etymology notes (stretch)'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Students nominate a word from the lesson starter list and use the provided example sentence as a model.',
    ...
    worksheetQuestions: [
      {
        question: 'What does "subverts" mean? Write a sentence using it in the context of a text you have studied this year.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Choose two of the following words and use each in a sentence about a Year 8 text: pervasive, archetype, ideology, juxtapose, paradoxical.',
        lines: 6,
        modelAnswer:
    ...
    targetedSkills: ['8W.1', 'Vocabulary Development', 'Analytical Language', 'Independent Learning', 'Transition'],
  },
  ...
  // ── Lesson y8ext-09: Year 8 Reading for Pleasure Celebration ─────────────
  {
    ...
    worksheetQuestions: [
      {
        question: 'What is the purpose of a book recommendation? How is it different from a book review?',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Write a "hook" sentence for a book you have read recently. Your hook should make the reader immediately curious about the book.',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson y8ext-10: Transition to Year 9 Preparation ────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Students write their word and sentence in their books — verbal contribution optional.',
    ...
    worksheetQuestions: [
      {
        question: 'Write down three things you have learned or improved in English this year. Be as specific as possible.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'Looking back over Year 8, which unit or text did you find most challenging? What specifically made it difficult, and what did you do to overcome it?',
        lines: 6,
        modelAnswer:
    ...
    targetedSkills: ['Reflection', 'Metacognition', 'Self-Assessment', 'Target Setting', 'Transition to Year 9'],
  },
];
