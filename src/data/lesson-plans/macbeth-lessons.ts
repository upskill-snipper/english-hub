...
const lesson1: LessonPlan = {
  ...
  keywords: [
    'Jacobean', 'Divine Right of Kings', 'regicide', 'Great Chain of Being',
    'Gunpowder Plot', 'tragedy', 'hamartia', 'authorial intention',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a glossary of key terms (regicide, Jacobean, Divine Right) alongside the statements.',
      core: 'Students justify each answer with a reason before feedback.',
      stretch: 'Students predict how each contextual fact might influence the plot or characters of a tragedy.',
    },
    resources: ['True/False statement slide', 'Mini-whiteboards', 'Key terms glossary (support tier)'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students add a column evaluating which contextual factor is most important to understanding Shakespeare\'s authorial intentions.',
      },
      resources: ['Station information cards (x4)', 'Note-taking grid worksheet', 'Timer for rotations'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a pre-filled theme table with one example per theme; students add a second example for each.',
        core: 'Students complete the theme table independently and write a ranking justification paragraph.',
        stretch: 'Students explain how two themes interconnect (e.g., how ambition leads to guilt) using specific plot events as evidence.',
      },
      resources: ['Plot summary handout or animated summary video', 'Theme-tracking table worksheet', 'Paragraph frame (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Sentence starter provided: "Jacobean audiences would have been shocked by... because..."',
      core: 'Full written response expected with a specific contextual link.',
      stretch: 'Students write a second sentence evaluating Shakespeare\'s authorial intention in presenting this contextual idea.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'What is the "Divine Right of Kings" and why is it important to understanding Macbeth?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain the concept of the "Great Chain of Being" and how it connects to the events of the play.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Identify two key themes in Macbeth and explain how each connects to a specific character or event.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Why might a Jacobean audience have responded differently to Macbeth than a modern audience?',
      lines: 5,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  keywords: [
    'ambition', 'soliloquy', 'aside', 'hamartia', 'tragic flaw',
    'vaulting ambition', 'prophecy', 'dramatic irony',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a sentence starter for verbal responses: "I think ambition is... because..."',
      core: 'Students explain their position with a real-world or literary example.',
      stretch: 'Students consider how the definition of "acceptable" ambition might differ between Jacobean and modern audiences.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-annotated extract with two devices identified. PEE frame with sentence starters.',
        core: 'Independent annotation and a full PEE paragraph with embedded quotations.',
        stretch: 'Write a second paragraph evaluating whether Macbeth\'s reaction suggests pre-existing ambition or a new temptation.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide a modern English translation alongside the original. Two-column table partially completed.',
        core: 'Students complete the analysis independently with close attention to Shakespeare\'s metaphor.',
        stretch: 'Students compare this soliloquy to the earlier aside in Act 1.3 — how has Macbeth\'s attitude to ambition changed? What has caused the shift?',
      },
      resources: ['Act 1 Scene 7 extract (printed)', 'Modern translation (support tier)', 'Two-column analysis grid'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students consider what Shakespeare\'s authorial intention might be in leaving this ambiguous.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'What is a soliloquy and why is Macbeth\'s soliloquy in Act 1, Scene 7 dramatically significant?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain the effect of the metaphor "vaulting ambition, which o\'erleaps itself and falls on the other."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'How does Macbeth\'s aside in Act 1, Scene 3 ("If chance will have me king") reveal his state of mind?',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Do you think Macbeth was ambitious before the witches\' prophecy, or did they create his ambition? Use evidence from Act 1 to support your answer.',
      lines: 6,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  keywords: [
    'patriarchy', 'transgression', 'soliloquy', 'imperative verbs',
    'emasculation', 'manipulation', 'gender roles', 'subversion',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a word bank of adjectives for column 1 (gentle, submissive, nurturing, pious, modest).',
      core: 'Students brainstorm independently and add a brief explanation for each quality.',
      stretch: 'Students consider which modern expectations of women have changed and which have persisted since the Jacobean era.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-annotated version with two techniques identified. PEE frame with sentence starters.',
        core: 'Independent annotation with a full PEE paragraph embedding at least two quotations.',
        stretch: 'Students evaluate whether Lady Macbeth genuinely rejects femininity or is performing a role she cannot sustain, using the soliloquy as evidence.',
      },
      resources: ['Act 1 Scene 5 soliloquy extract (printed)', 'Annotation guide', 'PEE paragraph frame'],
    },
    {
      ...
      differentiation: {
        support: 'Provide the three techniques pre-identified with line references. Students explain why each is effective.',
        core: 'Students identify the techniques independently and write a full analytical paragraph.',
        stretch: 'Students consider what the baby-dashing image reveals about Lady Macbeth — is this a real memory or a rhetorical strategy? What does each interpretation suggest about her character?',
      },
      resources: ['Act 1 Scene 7 extract (printed)', 'Persuasion techniques reference card', 'Ranking grid'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Provide a choice of five words (powerful, dangerous, ambitious, fearless, manipulative) for students to select from.',
      core: 'Students choose their own word and justify with a quotation.',
      stretch: 'Students explain why their chosen word might be viewed differently by a Jacobean vs a modern audience.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'What does Lady Macbeth mean when she says "unsex me here"? Why is this significant in a Jacobean context?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Analyse the effect of the imagery in "Come to my woman\'s breasts / And take my milk for gall."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'How does Lady Macbeth manipulate Macbeth in Act 1, Scene 7? Identify two techniques and analyse their effect.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Explain what Lady Macbeth means by "Look like the innocent flower, but be the serpent under\'t."',
      lines: 4,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  keywords: [
    'Weird Sisters', 'trochaic tetrameter', 'prophecy', 'equivocation',
    'Daemonologie', 'pathetic fallacy', 'apparition', 'supernatural',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a comparison frame: "Jacobean audiences would have felt... because... Modern audiences might feel... because..."',
      core: 'Students discuss and record two differences between Jacobean and modern responses.',
      stretch: 'Students consider why Shakespeare chose to open the play with the witches — what effect does this create?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a glossary of trochaic tetrameter and equivocation with examples. Partially completed comparison table.',
        core: 'Independent annotation and comparison table with a full PEE paragraph.',
        stretch: 'Students analyse the significance of Macbeth\'s first line — "So foul and fair a day I have not seen" — echoing the witches. What does this suggest about his connection to them?',
      },
      resources: ['Act 1 Scene 1 and Scene 3 extracts', 'Language comparison table', 'Glossary of terms (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a partially completed evidence board with three events pre-mapped. Students add two more.',
        core: 'Students create a complete evidence board independently with annotations for each event.',
        stretch: 'Students evaluate whether the supernatural elements are "real" within the world of the play or projections of Macbeth\'s guilt, using evidence for both sides.',
      },
      resources: ['Dagger soliloquy and banquet scene extracts', 'Evidence board template (A3)', 'Colour pens/sticky notes'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain Shakespeare\'s authorial intention in leaving this question ambiguous.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'What is trochaic tetrameter and why does Shakespeare use it for the witches\' speech?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'How does Shakespeare present the dagger vision in Act 2, Scene 1? What does it reveal about Macbeth?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why is James I\'s book Daemonologie relevant to understanding the witches in Macbeth?',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Do the witches control Macbeth\'s fate, or does he make his own choices? Use evidence from the play.',
      lines: 6,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  keywords: [
    'guilt', 'conscience', 'hallucination', 'dramatic irony',
    'paranoia', 'power dynamic', 'banquet', 'apparition',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students predict how Shakespeare might dramatise guilt on stage — what theatrical techniques could be used?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-annotated extract with key lines highlighted. Split-page template with prompts.',
        core: 'Independent annotation and split-page analysis with a full PEE paragraph.',
        stretch: 'Students analyse how the power dynamic between Macbeth and Lady Macbeth has shifted since Act 1 and what this foreshadows.',
      },
      resources: ['Act 3 Scene 4 extract (printed)', 'Split-page analysis template', 'PEE paragraph frame'],
    },
    {
      ...
      differentiation: {
        support: 'Provide two quotations for each interpretation to scaffold the debate preparation.',
        core: 'Students find their own evidence and present a balanced paragraph.',
        stretch: 'Students consider which interpretation Shakespeare intended and why, linking to Jacobean beliefs about the supernatural vs modern psychology.',
      },
  ...
  worksheetQuestions: [
    {
      question: 'What happens in the banquet scene (Act 3, Scene 4) and why is it dramatically significant?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Analyse the effect of Macbeth\'s words: "Thou canst not say I did it. Never shake thy gory locks at me."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'How does Lady Macbeth respond to Macbeth\'s breakdown? How has their relationship changed since Act 1?',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Is Banquo\'s ghost real or a hallucination? Give evidence for both interpretations.',
      lines: 6,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  keywords: [
    'tyranny', 'Divine Right of Kings', 'regicide', 'legitimate power',
    'pathetic fallacy', 'natural order', 'Great Chain of Being', 'Malcolm',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students consider whether Duncan is too trusting — is his goodness also a weakness?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students evaluate whether Shakespeare presents Duncan as too perfect — is he a realistic character or a symbol of ideal kingship?',
      },
      resources: ['Duncan quotations handout', 'Paragraph frame (support tier)', 'Annotation guide'],
    },
    {
      ...
      differentiation: {
        support: 'Provide the comparison table partially completed with modern translations of key quotations.',
        core: 'Students complete the comparison table independently and write a full comparative paragraph.',
        stretch: 'Students analyse the significance of Malcolm\'s restoration at the end — what is Shakespeare saying about legitimate kingship and the natural order?',
      },
      resources: ['Acts 3-5 quotation selection', 'Comparison table template', 'Modern translations (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students evaluate whether the ending is truly hopeful or whether the cycle could repeat — are there any warning signs?',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Analyse the metaphor: "I am in blood / Stepp\'d in so far that, should I wade no more, / Returning were as tedious as go o\'er."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why does Shakespeare include Malcolm\'s list of "king-becoming graces" in Act 4, Scene 3?',
      lines: 5,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  keywords: [
    'prose', 'verse', 'fragmented speech', 'motif',
    'guilt', 'madness', 'dramatic irony', 'tragic arc',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a modern English translation for each quotation and a sentence starter: "In Act 1, Lady Macbeth was... but in Act 5 she is..."',
      core: 'Students identify at least two changes in language, tone, or power and explain them.',
      stretch: 'Students consider how this transformation reflects Shakespeare\'s message about guilt and natural order.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-annotated extract with three features highlighted. PEE frame with sentence starters for both paragraphs.',
        core: 'Independent annotation and two full PEE paragraphs with embedded quotations.',
        stretch: 'Students analyse the role of the Doctor and Gentlewoman as audience surrogates — what is their function in the scene?',
      },
      resources: ['Act 5 Scene 1 extract (printed)', 'PEE paragraph frame', 'Annotation colour guide'],
    },
    {
      ...
      differentiation: {
        support: 'Provide the arc diagram partially completed with quotations for Acts 1.5 and 5.1.',
        core: 'Students complete the full arc independently with quotations and evaluative summaries.',
        stretch: 'Students compare Lady Macbeth\'s arc to Macbeth\'s — whose decline is more tragic and why?',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students write the epitaph from a specific perspective (Shakespeare, Macbeth, a Jacobean audience, or a feminist critic).',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Why is it significant that Lady Macbeth speaks in prose rather than verse in Act 5, Scene 1?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Analyse the significance of Lady Macbeth\'s words: "Out, damned spot! Out, I say!"',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Compare Lady Macbeth\'s confidence in Act 2.2 ("A little water clears us of this deed") to her despair in Act 5.1 ("All the perfumes of Arabia will not sweeten this little hand"). What does this contrast reveal?',
      lines: 6,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  keywords: [
    'tragic hero', 'hamartia', 'peripeteia', 'catharsis',
    'nihilism', 'equivocation', 'hubris', 'denouement',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide definitions of each term with an example from another text (e.g., Oedipus).',
      core: 'Students complete the checklist independently with textual evidence for Macbeth.',
      stretch: 'Students consider whether Shakespeare deliberately subverts the tragic hero model — is Macbeth a cautionary figure rather than a tragic one?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-annotated version with two features identified. PEE frame with sentence starters.',
        core: 'Independent annotation and a full PEE paragraph with embedded quotations.',
        stretch: 'Students compare this soliloquy to the "vaulting ambition" soliloquy (Act 1.7) — how has Macbeth\'s relationship to his own ambition changed?',
      },
      resources: ['Act 5 Scene 5 soliloquy extract (printed)', 'PEE paragraph frame', 'Annotation guide'],
    },
    {
      ...
      differentiation: {
        support: 'Provide the table partially completed with the first prophecy filled in as a model.',
        core: 'Students complete the table independently and write an evaluative paragraph.',
        stretch: 'Students link equivocation to the theme of appearance vs reality and to the historical context of the Gunpowder Plot trials, where Catholic conspirators were accused of equivocation.',
      },
      resources: ['Act 4 prophecies extract', 'Equivocation table template', 'Act 5 battle extracts'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain how their verdict might differ depending on whether they adopt a Jacobean or modern perspective.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Explain the metaphor "Life\'s but a walking shadow, a poor player / That struts and frets his hour upon the stage."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'What is equivocation and how do the witches use it to manipulate Macbeth in Act 4?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Does Macbeth meet the criteria for Aristotle\'s tragic hero? Use the terms hamartia, peripeteia, and catharsis.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Why does Shakespeare end the play with Malcolm becoming king? What is the significance of this structural choice?',
      lines: 5,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  keywords: [
    'embedded quotation', 'word-level analysis', 'connotation',
    'semantic field', 'authorial intention', 'AO1', 'AO2', 'AO3',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide the first word of each quotation as a prompt (e.g., "Fair is...", "Is this a...", "Out, damned...").',
      core: 'Students recall quotations from memory without prompts.',
      stretch: 'Students also note the act, scene, speaker, and theme for each quotation they recall.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a model analysis for Station 1 and sentence starters for the remaining stations.',
        core: 'Students complete the analysis grid independently for all five stations.',
        stretch: 'Students add an "alternative interpretation" row to each analysis, considering how different readers might respond to the quotation.',
      },
      resources: ['Five station cards with quotations', 'Structured analysis grid (per student)', 'Model analysis (support tier)'],
    },
    {
      ...
      differentiation: {
        ...
        stretch: 'Students write a second paragraph linking their chosen quotation to a different part of the play (whole-text reference).',
      },
      resources: ['Timer', 'Paragraph structure template', 'Simplified mark scheme checklist', 'Model Grade 8/9 paragraph'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students create a "connection card" linking two quotations from different parts of the play and explaining how they relate thematically.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Analyse the quotation: "Look like the innocent flower, but be the serpent under\'t." What technique is used and what is its effect?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Analyse the quotation: "Will all great Neptune\'s ocean wash this blood clean from my hand?" What does it reveal about Macbeth?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why is it important to analyse quotations at word level rather than just identifying techniques?',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Choose any Macbeth quotation and write a Grade 8/9 analytical paragraph that includes word-level analysis, a context link, and an evaluative comment.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Match each quotation to its speaker, the act/scene, and the main theme it relates to: (a) "Fair is foul, and foul is fair", (b) "Unsex me here", (c) "Is this a dagger which I see before me?", (d) "Out, damned spot!", (e) "Tomorrow, and tomorrow, and tomorrow".',
      lines: 10,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  keywords: [
    'AO1', 'AO2', 'AO3', 'AO4', 'extract question',
    'wider play', 'mark scheme', 'band descriptors',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a question-decoding template with prompts: "The key instruction is... The focus is... I must write about..."',
      core: 'Students decode independently and note the AOs they need to address.',
      stretch: 'Students rewrite the question in their own words and identify which AO each part of the question targets.',
    },
    resources: ['Sample exam question slide', 'Question-decoding template (support tier)', 'AO summary card'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a planning template with boxes for each step and suggested wider play moments.',
        core: 'Students plan independently using the 5-minute method.',
        stretch: 'Students plan an additional "conceptualised opening" that immediately establishes a critical argument (e.g., "Shakespeare presents ambition as a corrupting force that...").',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide a paragraph-by-paragraph structure scaffold with sentence starters for each paragraph.',
        core: 'Students write independently under timed conditions.',
        stretch: 'Students aim for a "conceptualised" response that threads a critical argument through every paragraph (e.g., every paragraph links back to the idea that ambition is presented as a destructive force).',
      },
      resources: ['Timer (30 minutes)', 'Exam booklets or lined paper', 'Structure scaffold (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students compare their response to the Band 6 descriptors specifically and identify what would push them from Band 5 to Band 6.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'What are the four Assessment Objectives for AQA GCSE English Literature, and how many marks is each worth in the Macbeth question?',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'What is the difference between a Band 5 (Grade 7) and a Band 6 (Grade 8/9) response?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why is it important to write about both the extract AND the wider play in your response?',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Write a model opening paragraph for the following question: "How does Shakespeare present the theme of guilt in Macbeth?"',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'List three common mistakes students make in the Macbeth exam and explain how to avoid each one.',
      lines: 6,
      modelAnswer:
