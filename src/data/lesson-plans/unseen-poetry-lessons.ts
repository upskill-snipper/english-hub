...
const lesson1: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students consider what the poem might be about beyond its literal meaning - what bigger ideas does it explore?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed SMILE grid with the Subject and Message rows filled in.',
        core: 'Students complete the full SMILE grid independently with textual evidence for each row.',
        stretch:
          'Students write a short paragraph explaining how two SMILE elements work together to create meaning.',
      },
      resources: [
        'SMILE framework poster/handout',
        'Printed poem copies',
        'SMILE grid worksheet',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide guided questions for each reading stage: "Reading 1: Who is \'she\'? What did she build? What grows in the garden?"',
        core: 'Students complete all three readings independently and note how their understanding changed.',
        stretch:
          'Students evaluate which reading stage was most useful and explain why, linking to exam technique.',
      },
      resources: [
        'Printed poem copies',
        'Three Readings worksheet',
        'Guided questions sheet (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students write two possible summaries reflecting different interpretations of the poem.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "Read the poem about the grandfather's hands. What is the poem's subject and who is the speaker?",
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Using the SMILE framework, identify the Message of the poem about the house built from arguments.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Explain how the Three Readings approach helps you develop a deeper understanding of an unseen poem.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Annotate the starter poem (about the train station). Identify the subject, tone, and one language technique the poet uses.',
      lines: 6,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a checklist of eight techniques to find, with line numbers as hints for where to look.',
        core: 'Students identify techniques independently using the toolkit, aiming for at least eight examples.',
        stretch:
          'Students identify techniques not on the toolkit (e.g., extended metaphor, semantic field of predation) and explain the overall effect.',
      },
      resources: [
        'Poetic Techniques Toolkit handout',
        'Printed poem copies',
        'Highlighters',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a table with two columns (Technique | Quotation) and sentence starters for the explanation question.',
        core: 'Students complete both tasks independently within the time limit.',
        stretch:
          'Students answer a third question: "How do the techniques work together to create an overall effect in this poem?"',
      },
      resources: [
        'Printed poem copies',
        'Annotation materials',
        'Response table (support tier)',
        'Timer',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students improve Response B further by adding an alternative interpretation or linking to the wider poem.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Read the poem about the sea. Identify four different poetic techniques and provide a quotation for each.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Choose one technique from the sea poem and explain why the poet might have used it.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Read the poem about morning. List four techniques used and provide a quotation for each.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Explain the difference between identifying a technique and analysing its effect. Use an example from either poem.',
      lines: 5,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide three alternative words and ask students to rank them from closest to furthest in meaning from "dripped".',
      core: 'Students generate their own alternatives and explain the difference in effect.',
      stretch:
        'Students explain how "dripped" connects to the wider image (moon, silver, sleeping) to create an overall atmosphere.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a writing frame: "The word _____ suggests _____ because it has connotations of _____."',
        core: 'Students complete three-level analysis for both quotations independently.',
        stretch:
          'Students explore how the word-level choices across the poem create a sustained semantic field and explain its overall effect.',
      },
      resources: [
        'Printed poem copies',
        'Three-level analysis model on board',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide three pre-selected quotations and a structured paragraph template for each.',
        core: 'Students select their own quotations and write three analytical paragraphs independently.',
        stretch:
          'Students write a concluding sentence for each paragraph that considers an alternative interpretation of the word choice.',
      },
      resources: [
        'Printed poem copies',
        'Peer assessment checklist',
        'Paragraph template (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students explain why their chosen word is more important to the poem's meaning than any other single word.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Read the orchard poem. Choose the quotation "The soil remembers last year\'s fruit" and analyse the word "remembers".',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'In the mother poem, analyse the effect of the word "starched" in "She starched our collars stiff with expectation."',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Explain what "zooming in" means in the context of poetry analysis. Why is it an important skill?',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Choose any quotation from the mother poem and write a full analytical paragraph that zooms in on one word.',
      lines: 8,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide the key terms "pace", "emphasis", and "pause" and ask students to match one to each version.',
      core: 'Students explain the effect of each version in their own words.',
      stretch:
        'Students create a fourth version using a different structural choice and explain its effect.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide an annotation guide highlighting where each structural feature appears, with sentence starters for effects.',
        core: 'Students annotate independently and write effect notes for at least four structural features.',
        stretch:
          'Students write a paragraph explaining how the structure of the entire poem mirrors its emotional journey.',
      },
      resources: [
        'Structural features handout',
        'Printed poem copies',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide guided questions: "How many stanzas? Which is longer? Why might the poet have done this?"',
        core: 'Students write a paragraph independently linking form to meaning.',
        stretch:
          "Students compare this poem's form to a hypothetical version written as a sonnet and explain what would change.",
      },
  ...
  worksheetQuestions: [
    {
      question:
        'Identify three structural features in the poem about walking home from school and explain the effect of each.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'In the river poem, why has the poet chosen to write in free verse rather than a fixed form?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Why is the second stanza of the river poem shorter than the first? What is the effect of this structural choice?',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students write a fourth rain description with a tone of their choice and challenge the class to identify it.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide three tone options for each stanza and ask students to choose the best fit with evidence.',
        core: 'Students identify tone, mood, and atmosphere independently for each stanza with supporting quotations.',
        stretch:
          'Students write a paragraph explaining how the poet uses the tonal shift across the three stanzas to create a broader message about memory and loss.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a paragraph frame for both paragraphs with sentence starters and quotation prompts.',
        core: 'Students write both paragraphs independently, using the model opening as a guide for quality.',
        stretch:
          'Students write a third paragraph exploring how the atmosphere connects to a wider theme, such as absence, memory, or regret.',
      },
      resources: [
        'Printed poem copies',
        'Paragraph frame (support tier)',
        'Model opening on board',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Explain why their word is more accurate than a simpler alternative (e.g., why "suspended" is better than "still").',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Read the fair poem. Identify the tone of each stanza and provide evidence to support your choices.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'How does the poet create an atmosphere of abandonment in the house poem? Analyse two language features.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Explain the difference between tone, mood, and atmosphere. Use examples from either poem.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Why is it important to identify tonal shifts within a poem? How does this help your analysis?',
      lines: 4,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students write sentences that combine two senses (synaesthesia) and explain the effect.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the imagery table with the "Image" column pre-filled; students complete the remaining columns.',
        core: 'Students identify images independently, categorise by sense, and explain figurative meaning.',
        stretch:
          'Students write a paragraph explaining how the poet uses imagery to create a semantic field of nourishment and how this connects to a broader theme of community.',
      },
      resources: [
        'Printed poem copies',
        'Imagery table worksheet',
        'Pre-filled table (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide two pre-selected quotations and a paragraph frame with sentence starters.',
        core: 'Students select their own quotations and write two paragraphs meeting all success criteria.',
        stretch:
          "Students write a third paragraph analysing how the imagery shifts from destruction to recovery and what this suggests about the poem's message.",
      },
      resources: [
        'Printed poem copies',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Students choose from three pre-selected images and complete a sentence frame for their explanation.',
      core: 'Students select and justify their choice independently.',
      stretch:
        'Students explain why their chosen image is more effective than a close alternative from the same poem.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Read the bakery poem. Identify three examples of sensory imagery, state which sense each appeals to, and explain the effect.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Analyse the image "A snail traced its silver signature across the path" from the storm poem.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'What is the difference between literal and figurative imagery? Use an example from the storm poem.',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'How does the poet use imagery in the bakery poem to create a sense of community? Write a full paragraph.',
      lines: 8,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide three prompt questions: "Which response quotes the poem? Which explains why the reader feels that way? Which connects to a bigger idea?"',
      core: 'Students identify three differences independently and note what makes the strong response effective.',
      stretch:
        'Students rewrite the weak response to match the quality of the strong one, using different vocabulary.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide five pre-selected quotations and match each to a suggested phrase from the toolkit.',
        core: 'Students select their own quotations and choose appropriate phrases independently.',
        stretch:
          'Students write two different effect statements for the same quotation, demonstrating range of interpretation.',
      },
      resources: [
        'Effects Toolkit handout',
        'Printed poem copies',
        'Pre-selected quotations sheet (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a paragraph template: "The poet uses [technique] in the quotation [quote]. The word [word] suggests [meaning]. This [effect phrase from toolkit] because [explanation]."',
        core: 'Students write three paragraphs independently, using varied effect phrases.',
        stretch:
          "Students add a sentence to each paragraph considering how the effect contributes to the poem's overall impact and message.",
      },
      resources: [
        'Printed poem copies',
        'Effects Toolkit handout',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Students look specifically for effect statements that use toolkit phrases effectively.',
      core: 'Students evaluate which effect statements are most convincing and consider why.',
      stretch:
        'Students note one effect statement that could be improved and mentally draft a better version.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Read the handwriting poem. Write an effect statement for the quotation "your name, underlined twice, as if you were afraid of being forgotten."',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Write an analytical paragraph about the classroom poem that focuses on the effect of the imagery "children made of light."',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'List five alternative phrases to "this makes the reader feel sad" and explain when each would be most appropriate.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Why is it important to explain effects on the reader in your unseen poetry response? How does this help you access higher marks?',
      lines: 4,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students explain which line they find more effective and why, using comparative language.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students add a sixth row: "overall effect on the reader" and compare how each poem makes them feel and why.',
      },
      resources: [
        'Printed copies of both poems',
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a third paragraph comparing the structural choices in both poems and their effects.',
      },
      resources: [
        'Model paragraph on board',
        'Comparative connectives handout',
        'Paragraph frame (support tier)',
        'Peer assessment checklist',
      ],
    },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students add two more "Do" or "Don\'t" statements of their own based on what they learned.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Write a comparative paragraph about how the two poets use imagery differently to present the father figures.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Compare the endings of the two poems. How does each poet conclude their poem and what is the effect?',
      lines: 6,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students consider how to adapt the timing if they find the poem particularly challenging or straightforward.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide an annotation checklist: "Have you identified the subject? Tone? Two techniques? One interesting word?"',
        core: 'Students annotate freely and create their own plan.',
        stretch:
          'Students identify a through-line or argument for their response (e.g., "the poet contrasts decay with resilience to suggest...").',
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a response opening: "The poet presents resilience and beauty through a contrast between decay and defiance. In the first stanza..." Students continue from this point.',
        core: 'Students write a full response independently within the time limit.',
        stretch:
          "Students aim to include a comment on structure or form as well as language analysis, and consider the poet's overall message in their conclusion.",
      },
      resources: [
        'Lined paper or exam booklets',
        'Countdown timer',
        'Simplified mark scheme grid',
        'Coloured highlighters for self-assessment',
      ],
    },
  ],
  plenaryActivity: {
  ...
  worksheetQuestions: [
    {
      question:
        'How does the poet use contrast in the allotment poem? Identify and analyse one key contrast.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Analyse the simile "like drunks against lamp posts" and explain its effect on the reader.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Explain the significance of the final three lines: "He has learned what the kale knows: / that stubbornness / is its own kind of beauty."',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'List four steps in your timed approach strategy for the unseen poetry question. Explain why each step is important.',
      lines: 6,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Teacher reviews the checklist step by step with targeted students before the exam begins.',
      core: 'Students review the checklist independently and set their personal target.',
      stretch:
        'Students add one additional personal checkpoint to the list based on their self-assessment from Lesson 9.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a planning grid with prompts: "Stanza 1 - what technique can you see? Stanza 2 - what is the tone? Stanza 3 - what is the key image?"',
        core: 'Students complete the response independently under timed conditions.',
        stretch:
          "Students aim for four analytical paragraphs covering language, imagery, structure, and the poem's overall message.",
      },
      resources: [
        'Printed poem with question',
        'Response paper',
        'Countdown timer',
        'Planning grid (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide two sentence starters: "Both poems explore memory through a physical object..." and "However, while Poem 1..., Poem 2...".',
        core: 'Students write two or three comparative paragraphs independently within the time limit.',
        stretch:
          'Students aim to compare methods (how the poets write) as well as ideas (what they write about) in every paragraph.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a peer assessment tick sheet with criteria to look for (quotations used, techniques named, effects explained, both poems compared).',
      core: 'Students use the mark scheme grid independently and write qualitative feedback.',
      stretch:
        "Students identify the single strongest paragraph in their partner's response and explain why it would score highly.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Read "The Photograph." How does the poet use the extended metaphor of the match in Stanza 3? Analyse its effect.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Analyse the final four lines of "The Old Coat": "because for a moment, / just a moment, / I was not wearing a coat. / I was wearing your arms around me."',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Compare how the two poems use physical objects to represent memory. Write a comparative paragraph.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Using the mark scheme, assess the following response extract and suggest how it could be improved: "The poet uses a simile in the poem. The photograph is like a match. This makes the reader feel sad because the person has gone."',
      lines: 6,
      modelAnswer:
