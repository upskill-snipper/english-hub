...
export const poetryPowerConflictLessons: LessonPlan[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: "Provide a glossary defining 'tone', 'authority', and 'power' with examples.",
    ...
    worksheetQuestions: [
      ...
      {
        question: "Analyse the effect of the phrase 'sneer of cold command' in 'Ozymandias'.",
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    title: 'The Charge of the Light Brigade & Exposure: War & Suffering',
    text: 'AQA Power & Conflict Poetry Anthology',
    board: 'AQA',
    yearGroup: 'Year 10/11',
    duration: '60 minutes',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Use the sentence frame with word options provided.',
    ...
    worksheetQuestions: [
      ...
      {
        question: "Analyse the effect of the refrain 'But nothing happens' in 'Exposure'.",
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a partially completed Venn diagram with prompts in each section.',
  ...
  // ─────────────────────────────────────────────
  // LESSON 5: Kamikaze & The Émigrée
  // ─────────────────────────────────────────────
  {
    id: 'ppc-05-kamikaze-emigree',
    title: 'Kamikaze & The Émigrée: Memory, Identity & Loss',
    text: 'AQA Power & Conflict Poetry Anthology',
    board: 'AQA',
    yearGroup: 'Year 10/11',
    duration: '60 minutes',
    objectives: [
      ...
      "Analyse how Rumens presents the power of memory and the pain of exile in 'The Émigrée'",
    ...
    plenaryActivity: {
      ...
      duration: '10 minutes',
      instructions:
        "Students complete a two-column table: 'Memory as Power' and 'Memory as Pain', adding quotations and ideas from both poems into the relevant column. Some quotations may appear in both columns. Students then write one comparative sentence using the structure: 'In both poems, memory is presented as ___, however in Kamikaze it _____ while in The Émigrée it _____.' Share and discuss.",
      differentiation: {
        support: 'Provide quotations pre-selected; students sort them into the columns.',
    ...
    homework:
      "Write a diary entry from the perspective of either the kamikaze pilot's daughter or the émigrée, exploring how memory shapes their sense of identity. 200-300 words.",
    worksheetQuestions: [
      {
        question:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Grid is partially completed with prompts in each cell.',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide the sentence frame with word options for each blank.',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    worksheetQuestions: [
      ...
      {
        question:
          "Write a comparative topic sentence for the following question: 'Compare how poets present the power of memory in Kamikaze and The Émigrée.'",
        lines: 4,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: ['Sample question slide', 'PEEL frame (support tier)', 'Lined response paper'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support: "Provide a prompt: 'The most important thing I learned today is ___.'",
