export interface LessonPlan {
  ...
  mainActivities: { title: string; duration: string; description: string; differentiation?: string; }[];
...
export const igcseLessonPlans: LessonPlan[] = [
...

  {
    ...
    plenaryActivity: {
      ...
      duration: "8 minutes",
      description: "In pairs, one student reads their speech aloud while the other listens. The listener identifies: the opening hook, main ideas (can they list them?), rhetorical devices used, and whether the conclusion is memorable. Provides feedback using sentence stems: 'This device was effective because...', 'I was persuaded by...', 'I would suggest adding...' Class shares examples of effective device use."
    },
    assessmentOpportunities: [
...

  {
    ...
    starterActivity: {
      ...
      duration: "8 minutes",
      description: "Display two short extracts (100-150 words each) on a related topic (both about social media, for example). Students identify: What does Text A discuss? What does Text B discuss? Are there overlapping themes? Where do they differ? This demonstrates that when synthesizing multiple sources, you need to find connections while respecting each text's unique perspective. Model creating a simple Venn diagram with overlapping circles."
    },
    mainActivities: [
      {
        title: "Planning a Synthesis",
        duration: "14 minutes",
        description: "Provide two paired texts (400-500 words each) on a related topic. Model the planning process: Read Text A and identify main themes/ideas. Read Text B and identify main themes/ideas. Now ask: Which ideas appear in both texts? Which ideas are unique to Text A? Which are unique to Text B? Create a grid with three columns: 'Text A only', 'Both texts', 'Text B only'. Students fill in the grid based on the provided texts. Discuss: When synthesizing, you should cover points in the 'Both texts' column and select the most important points from each column. This ensures fair representation of both sources.",
        differentiation: "Lower ability: Provide a partially completed grid with some themes/ideas already identified. Higher ability: Challenge students to identify subtle connections between texts and to determine which ideas are most significant. EAL support: Use color-coding for themes; help identify key sentences that express each theme."
      },
      {
    ...
    mainActivities: [
      {
        ...
        differentiation: "Lower ability: Provide simplified planning templates with sentence starters. Offer pre-developed character/setting options to choose from. Higher ability: Use more open-ended prompts; challenge students to subvert expectations or create complex narrative structures. EAL support: Provide vocabulary and help clarify prompt requirements."
      },
      {
        title: "Drafting the Creative Response",
        duration: "32 minutes",
        description: "Students draft their response to their chosen prompt, applying skills from recent lessons. As they write, they should consider: Are my characters vivid and developed? Is the atmosphere/setting engaging? Are narrative techniques integrated naturally? Is my vocabulary precise and varied? Does my sentence structure vary for interest and effect? Emphasize quality over quantity—a shorter response with vivid detail and strong technique is superior to a longer, rushed piece. After drafting, students do a quick self-edit: Check dialogue punctuation, scan for repeated words, ensure transitions are clear, verify that descriptions are specific. Time management note: In an exam, students would have approximately 45-60 minutes for creative writing; this activity replicates that constraint.",
        differentiation: "Lower ability: Provide a paragraph-by-paragraph outline to follow. Reduce word count expectation (400-500 words rather than 600+). Offer feedback on sentence starters/transitions. Higher ability: Provide no outline; challenge students to experiment with narrative structure, point of view, or unexpected endings. EAL support: Provide vocabulary support and help with complex sentence construction."
      }
    ],
    plenaryActivity: {
      title: "Celebrating Creative Writing and Reflecting",
      duration: "10 minutes",
      description: "Invite 2-3 volunteers to share opening paragraphs of their creative writing (or if time short, just opening sentences). Class appreciates the different approaches and styles. Facilitate a reflection: What technique from recent lessons did you use most effectively? What was challenging about this prompt? How would you improve your draft if you had more time? What are you most proud of in your creative writing? This metacognitive reflection helps students recognize their progress and identify areas for future focus. End by emphasizing that creative writing is valuable for its own sake—it develops imagination, communication skills, and personal voice beyond IGCSE assessment."
    },
    assessmentOpportunities: [
