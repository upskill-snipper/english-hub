...
export const y12IalUnit2Lessons: LessonPlan[] = [
  // ── Lesson 1: Prescriptivism vs Descriptivism ──────────────────────────────
  {
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Explain one argument a prescriptivist might use against the use of "they" as a singular pronoun.',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 2: Historical English Change — Old, Middle, and Early Modern ────
  {
    ...
    worksheetQuestions: [
      {
        question: 'What is a synthetic language? Give an example of how this affected Old English grammar.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Give three examples of the lexical stratification created by the Norman Conquest, explaining what each pair reveals.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'What was the Great Vowel Shift and why is it significant for understanding Early Modern English?',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 3: Contemporary Change — Technology, Globalisation, Youth Language
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide an argument planning frame with sentence starters for the opening, evidence, and conclusion.',
    ...
    worksheetQuestions: [
      {
        question: 'Define "neologism" and give three examples from contemporary English, each from a different driver of change.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Explain what Jean Aitchison meant by the "damp spoon syndrome" in the context of language change.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'How might globalisation threaten linguistic diversity? Use specific evidence in your answer.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 4: Language and the Internet — Netspeak, Emoji, Social Media ────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide a feature checklist for students to tick rather than generating observations independently.',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students pre-identify a specific piece of counter-evidence to the position they agree with.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question: 'Define computer-mediated communication (CMC) and explain how it differs from both traditional written language and face-to-face speech.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Identify and explain three graphological features of netspeak with an example of each.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'Explain how emoji can function as a semantic device rather than merely a paralinguistic one.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 5: Language Attitudes and the Change Debate ─────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a partially completed map with six nodes already placed and connected; students add the remaining two and their connections.',
        core: 'Students create their own map from scratch using the key terms list.',
        stretch: 'Students add three additional concepts from their wider reading or general knowledge and justify their inclusion.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question: 'What is "standard language ideology" and how does it differ from a purely linguistic description of standard English?',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Explain the difference between overt prestige and covert prestige, with an example of each.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'How can critical discourse analysis reveal ideological assumptions in a text about language?',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 6: Child Language Acquisition — Chomsky, Skinner, Piaget ────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students write the theorist\'s name AND a one-word qualification of their own (e.g., "Chomsky — innate").',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question: 'What are "virtuous errors" and what do they suggest about how children acquire language?',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Explain how Vygotsky\'s Zone of Proximal Development challenges Piaget\'s theory of cognitive development.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 7: Critical Discourse Analysis of Language Change ───────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students rewrite each sentence to remove the presupposition and consider what is lost in meaning.',
      },
      resources: [
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support: 'Provide the example sentences pre-populated; students add only the tool name and a brief explanation.',
          core: 'Students generate their own example sentences for each tool.',
          stretch: 'Students rank the six tools in order of analytical power for this specific topic (language change) and justify their ranking.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students challenge someone else\'s sticky note with a counter-analysis on a different coloured note.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question: 'What is presupposition in the context of CDA? Give one example from a text about language change.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Explain how passivisation can be used ideologically in texts about language change.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 8: Analysing Diachronic Data — Historical Text Comparison ────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide a list of linguistic levels (spelling, punctuation, vocabulary, grammar, pronouns) as a structured search checklist.',
        core: 'Students generate their own list of differences and then rank them by significance.',
        stretch: 'Students suggest what these changes reveal about broader patterns of English change and connect each to a concept or period from earlier lessons.',
      },
      resources: [
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support: 'Provide a sentence-stem framework for each analytical move: "At the level of [framework], the text shows [feature]. This is significant because it reflects [historical context]..."',
          core: 'Students apply the framework to their own examples after the modelled examples.',
          stretch: 'Students evaluate which of the six levels offers the most diagnostic evidence for dating a text from this period and justify their choice.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Students focus only on identifying whether the extract is description or analysis, without suggesting upgrades.',
    ...
    worksheetQuestions: [
      {
        question: 'Explain the difference between diachronic and synchronic analysis in linguistics.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Identify and explain two grammatical features that would indicate a text was written before 1700.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 9: Comparative Essays — Structure, Argument, and Evidence ────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide a model opening paragraph for a different question; students use its structure as a template.',
        core: 'Students write independently to time.',
        stretch: 'Students write two alternative openings and evaluate which makes the stronger analytical claim.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question: 'What are the three assessment objectives for WEN02 and what does each require from a student?',
        lines: 8,
        modelAnswer:
      ...
      {
        question: 'Explain the difference between a description-level observation and an analysis-level observation in a comparative essay. Give a brief example of each.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'What should an essay introduction contain in a comparative essay on language change?',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 10: Timed Exam Essay Practice ────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Students focus only on AO1 self-assessment (terminology use) as this is most accessible for initial self-evaluation.',
        core: 'Students complete all three AO self-assessments.',
        stretch: 'Students write a specific, actionable target for each AO rather than a general comment.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question: 'Explain three strategies for effective time management in a 55-minute WEN02 essay question.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'What does it mean to "maintain a line of argument" in a comparative essay on language change?',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'How should you allocate your marks across AO1, AO2, and AO3 in a WEN02 response?',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Practise writing a topic sentence for a paragraph comparing two texts on language change. The paragraph will discuss changes in pronoun use between 1600 and the present day.',
        lines: 4,
        modelAnswer:
