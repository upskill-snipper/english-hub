...
const lesson1: LessonPlan = {
  ...
  keywords: [
    'spaced repetition', 'retrieval practice', 'working memory',
    'long-term memory', 'encoding', 'consolidation', 'forgetting curve',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a worksheet with spaces numbered 1-20 so students have a clear structure for recording.',
      core: 'Students attempt the task independently and then compare results with a partner.',
      stretch: 'Students predict which types of words they remembered best (concrete vs abstract, first vs last) and hypothesise why.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-labelled diagram with key terms; students match definitions to the correct stage.',
        core: 'Students annotate a blank diagram independently and write a one-paragraph summary of the forgetting curve.',
        stretch: 'Students research and explain why sleep is important for memory consolidation and add this to their diagram.',
      },
      resources: ['Memory process diagram (blank and labelled versions)', 'Forgetting curve graph', 'Spaced vs massed practice comparison graph'],
    },
    {
      ...
      differentiation: {
        support: 'Provide pre-written quiz questions for self-quizzing so students can focus on the retrieval process rather than question creation.',
        core: 'Students practise all three methods and identify which they found most effective, justifying their choice.',
        stretch: 'Students design a two-week retrieval practice schedule incorporating all three methods across multiple subjects.',
      },
      resources: ['Retrieval practice method cards', 'Reflection rating sheet', 'Leitner System diagram', 'Blank paper for brain dumps'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Sentence starter provided: "Cramming does not work because... Instead, you should..."',
      core: 'Full written response expected using at least two key terms from the lesson.',
      stretch: 'Students include a specific example or analogy to make their explanation memorable.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain the difference between working memory and long-term memory. Why is this distinction important for revision?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Describe two retrieval practice strategies and explain why they are more effective than re-reading notes.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Design a five-day spaced repetition plan for revising the causes of World War One. Explain your spacing choices.',
      lines: 8,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  keywords: [
    'dual coding', 'active recall', 'elaboration', 'interleaving',
    'cognitive load', 'chunking', 'schema',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a sorting card activity with descriptions of each method for physical ranking.',
      core: 'Students rank independently, then compare with a partner and justify disagreements.',
      stretch: 'Students explain the cognitive science principle behind why each method is effective or ineffective.',
    },
    resources: ['Revision methods list slide', 'Sorting cards (support tier)', 'Evidence-based ranking reveal slide'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide the critique framework with sentence starters: "This resource is effective/ineffective because..."',
        core: 'Students complete the critique independently and suggest one improvement for each weak resource.',
        stretch: 'Students redesign one of the weak resources using all four principles and explain their choices.',
      },
      resources: ['Example revision resources (3 good, 3 poor)', 'Critique framework worksheet', 'Dual coding examples sheet'],
    },
    {
      ...
      differentiation: {
        support: 'Provide templates for each resource type with clear sections labelled and one completed example.',
        core: 'Students create all three resources independently using the principles discussed.',
        stretch: 'Students create a fourth resource type of their own design, explaining which cognitive science principles it applies.',
      },
      resources: ['Flashcard blanks', 'Knowledge organiser template', 'Cornell Notes template', 'Coloured pens', 'Subject notes/textbooks'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students justify each score with a specific reference to cognitive science principles.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Explain the difference between a revision resource that promotes "recognition" versus one that promotes "recall." Why does this matter for exams?',
      lines: 5,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  keywords: [
    'mind map', 'spatial memory', 'hierarchical organisation', 'cross-links',
    'visual encoding', 'schema', 'categorisation',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Students work in pairs to describe their room layout and then discuss why spatial memory is strong.',
      core: 'Students complete the recall test independently and reflect on which version they found easier.',
      stretch: 'Students explain the cognitive science behind why spatial organisation aids memory, linking to dual coding.',
    },
  ...
  mainActivities: [
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide a partially completed mind map template with the central topic and main branches already drawn; students add sub-branches and details.',
        core: 'Students create and recreate the mind map independently, identifying gaps.',
        stretch: 'Students recreate their mind map twice — once immediately and once at the end of the lesson — to experience the spacing effect within a single session.',
      },
      resources: ['Blank A3 paper', 'Coloured pens', 'Subject notes/textbooks', 'Mind map template (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain how they would use mind maps as an ongoing retrieval tool across a revision period.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Explain how mind maps can be used as a retrieval practice tool, not just a note-taking method.',
      lines: 4,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  keywords: [
    'Leitner System', 'active recall', 'interleaving', 'elaborative interrogation',
    'self-testing', 'metacognition', 'overlearning',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students predict the evidence-based alternative for each myth before it is revealed.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a Leitner System diagram with labels and a step-by-step guide students can keep.',
        core: 'Students draw and label their own Leitner System diagram and explain each box\'s review frequency.',
        stretch: 'Students calculate the mathematical efficiency of the Leitner System — how many reviews does a card need vs daily review of every card?',
      },
      resources: ['Five labelled boxes or trays', 'Sample flashcards (good and bad examples)', 'Leitner System diagram handout'],
    },
    {
      ...
      differentiation: {
        support: 'Provide flashcard templates with the question/answer structure pre-printed and one example card completed for their subject.',
        core: 'Students create all 15 cards independently, following the five rules, and complete the Leitner sorting process.',
        stretch: 'Students also create five "connection cards" that link two different topics together and explain the relationship.',
      },
      resources: ['Blank flashcards or card stock', 'Flashcard design rules poster', 'Accuracy tally chart', 'Subject notes/textbooks'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students rewrite their weakest two cards based on partner feedback and explain the improvements.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'List three common mistakes students make when creating flashcards and explain how to fix each one.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Why is it important to include an "elaboration prompt" on the answer side of a flashcard?',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'A student says: "I made 200 flashcards last weekend and now I know everything for my biology exam." Explain what is wrong with this approach.',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  keywords: [
    'mark scheme', 'command words', 'assessment objectives',
    'indicative content', 'examiner report', 'question stems',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students rewrite two questions replacing the command word (e.g., change "describe" to "evaluate") and explain how the expected answer changes.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Mark scheme is colour-coded by assessment objective, and level descriptors are simplified.',
        core: 'Students complete ranking and annotation independently, then write detailed feedback for the Grade 5 response.',
        stretch: 'Students rewrite the Grade 5 response\'s weakest paragraph to meet Grade 7 criteria and annotate their improvements.',
      },
      resources: ['Sample exam question', 'Three levelled student responses', 'Official mark scheme', 'Annotation guide'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a partially completed analysis grid with column headings and one example row filled in.',
        core: 'Students complete the analysis grid in groups and create their personal hit list independently.',
        stretch: 'Students analyse examiner reports alongside the papers to identify commonly missed topics and add these to their hit list.',
      },
      resources: ['Five past papers (front pages and question lists)', 'Analysis grid worksheet', 'Examiner reports (stretch tier)', 'Personal hit list template'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students create a six-week past paper schedule that incorporates spaced repetition of weak topics.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Why is completing past papers considered more effective than re-reading notes or textbooks?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain what a mark scheme tells you and how to use it effectively after completing a past paper.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'What are "command words" and why is understanding them essential for exam success?',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'How can analysing multiple past papers help you predict what might come up in your exam?',
      lines: 5,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  keywords: [
    'Pomodoro Technique', 'interleaving', 'time audit',
    'prioritisation', 'work-rest cycle', 'procrastination',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students compare weekday and weekend schedules and calculate their total available weekly revision hours.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a Pomodoro session planner template with time slots pre-labelled and one completed example.',
        core: 'Students plan their own 2-hour Pomodoro session for this evening, choosing subjects and techniques.',
        stretch: 'Students design a full Saturday revision schedule using Pomodoro blocks with interleaved subjects.',
      },
      resources: ['Pomodoro Technique explanation slide', 'Session planner template', 'Timer for mini Pomodoro exercise'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a simplified timetable with fewer subjects and pre-suggested slot allocations based on exam dates.',
        core: 'Students create a full two-week timetable independently and peer-assess against the checklist.',
        stretch: 'Students create a timetable that spans from now to the exam period, building in spaced repetition cycles for each subject.',
      },
      resources: ['Two-week timetable grid template', 'Subject weighting worksheet', 'Scheduling principles checklist', 'Exam date list'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students add a fourth pledge about reviewing and adjusting their timetable at the end of the week.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'What is "interleaving" and why is it better than studying one subject for several hours?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'A student says: "I revised for 6 hours on Saturday but I do not feel like I learned anything." What might have gone wrong and what advice would you give?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why is it important to include specific techniques, not just subject names, in a revision timetable?',
      lines: 4,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  keywords: [
    'active revision', 'passive revision', 'illusion of competence',
    'generation effect', 'testing effect', 'elaboration',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students predict the results before the quiz and hypothesise the cognitive reason for the outcome.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Sorting cards provided for physical manipulation. Active/passive definitions clearly displayed.',
        core: 'Students sort independently, discuss with a partner, then compare with the evidence-based ranking.',
        stretch: 'Students explain the cognitive science behind why each strategy is active or passive, using terms like retrieval, generation effect, and elaboration.',
      },
      resources: ['15 revision activities list/sorting cards', 'Active-passive spectrum poster', 'Two-column table worksheet'],
    },
    {
      ...
      differentiation: {
        support: 'Transformation worksheet includes suggested active alternatives for common passive habits.',
        core: 'Students design their own active alternatives and practise one for 10 minutes with real content.',
        stretch: 'Students design an active revision session plan for an entire evening that eliminates all passive methods.',
      },
      resources: ['Passive to Active Transformation worksheet', 'Subject notes for practice activity', 'Swap list template', 'Timer for practice session'],
    },
  ],
  plenaryActivity: {
    title: 'Pledge Wall',
    ...
    differentiation: {
      ...
      stretch: 'Students identify a strategy for holding themselves accountable to their pledge over the next month.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain the difference between active and passive revision. Give one example of each.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'What is the "illusion of competence" and why is it dangerous for exam preparation?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Transform the following passive revision plan into an active one: "Tuesday evening: Re-read chapters 4-6 of the biology textbook and highlight key terms."',
      lines: 5,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  keywords: [
    'command word', 'question deconstruction', 'time allocation',
    'focused response', 'rubric', 'mark allocation', 'topic focus',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Key differences between the two responses are highlighted in colour for students to spot.',
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students add a fifth column — "common mistakes" — predicting where students typically go wrong on each question type.',
      },
      resources: ['QDPC method explanation poster', 'Six exam questions from different subjects', 'QDPC grid worksheet', 'Coloured highlighters'],
    },
    {
      ...
      differentiation: {
        ...
        stretch: 'Students rewrite their weakest paragraph to make it more directly focused on the question.',
      },
      resources: ['Time allocation formula slide', 'Three sample paper mark breakdowns', '12-mark exam question', 'Planning templates', 'Timer'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students create different routine cards for different question types (short answer, essay, data response).',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Using the QDPC method, deconstruct this exam question: "Analyse how Dickens presents the theme of social class in A Christmas Carol."',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Explain the time allocation formula and apply it to a 1 hour 45 minute exam worth 80 marks.',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'What is the difference between a "knowledge dump" and a "focused response"? Why does this distinction matter?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why is it worth spending 2 minutes planning before writing a longer exam response, even though it feels like wasted time?',
      lines: 4,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  keywords: [
    'fight-or-flight response', 'cognitive reappraisal', 'box breathing',
    'growth mindset', 'self-efficacy', 'catastrophising', 'grounding',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain why each physical symptom is a logical result of the fight-or-flight response (e.g., racing heart pumps blood to muscles for running).',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students research the scientific evidence behind one technique and present a 30-second summary to the class.',
      },
      resources: ['Box breathing guide card', 'Cognitive reappraisal worksheet', '5-4-3-2-1 grounding poster', 'Lined paper for expressive writing', 'Timer'],
    },
    {
      ...
      differentiation: {
        support: 'Template provided with each phase structured and example actions listed for selection.',
        core: 'Students create their plan independently using techniques from the lesson.',
        stretch: 'Students add a "recovery" phase — what to do between exams on the same day or after a paper that did not go well.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students include specific advice based on their personal anxiety triggers and most effective management techniques.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain why exam anxiety causes physical symptoms like a racing heart and sweating.',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'What is "cognitive reappraisal" and how can it help manage exam anxiety? Give an example.',
      lines: 5,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  keywords: [
    'consolidation', 'traffic light audit', 'diminishing returns',
    'confidence building', 'strategic prioritisation', 'exam readiness',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students add three of their own "Dos" and "Don\'ts" with evidence-based justifications.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide pre-printed specification checklists with topic lists already organised by unit.',
        core: 'Students complete the traffic light audit independently for at least two subjects.',
        stretch: 'Students calculate the exact number of hours needed for their Amber and Red topics and map this against available time.',
      },
      resources: ['Specification checklists for each subject', 'Traffic light coloured pens or stickers', 'Time allocation guide'],
    },
    {
      ...
      differentiation: {
        ...
        stretch: 'Students create contingency plans for each day: "If I finish early, I will... If I feel overwhelmed, I will..."',
      },
      resources: ['Final-week planner template', 'Blank paper for brain dump', 'Timer', 'Exam timetable'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students write a fourth response: "How will I continue to use these strategies beyond GCSEs?"',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Why should the final week focus on consolidation rather than trying to learn new material?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain the traffic light audit system and the recommended time allocation for each category in the final week.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'A student has three exams in one week. Create a brief plan for how they should structure their final-week revision to cover all three subjects effectively.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Reflect on the revision techniques you have learned across this course. Which three strategies do you believe will have the greatest impact on your exam results, and why?',
      lines: 8,
      modelAnswer:
