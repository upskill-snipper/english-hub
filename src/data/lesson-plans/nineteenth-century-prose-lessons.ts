...
const lesson1: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a word bank of key terms (industrialisation, workhouse, suffrage) to assist discussion.',
      core: 'Students sort independently and justify each choice with reasoning.',
      stretch:
        'Students predict which social issues would be most likely to appear in fiction and explain why writers might choose fiction over non-fiction to address them.',
    },
    resources: [
      'Statement sorting cards',
      'Key terms word bank (support tier)',
      'Mini-whiteboards',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students evaluate which contextual factor had the most significant influence on Victorian literature, writing a justified paragraph.',
      },
      resources: [
        'Station information cards (x5)',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide colour-coded annotation prompts and a PEE paragraph frame with sentence starters.',
        core: 'Students annotate independently and produce a full PEE paragraph.',
        stretch:
          'Students write a second paragraph analysing the writer\'s use of language (e.g., personification of the houses, metaphor of poverty as "contagion") and its effect on the reader.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Sentence starter provided: "A Victorian writer might use fiction to criticise... because..."',
      core: 'Full written response expected with a specific contextual link.',
      stretch:
        'Students explain why prose fiction was a particularly effective vehicle for social criticism in the 19th century, considering literacy rates and serialisation.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Explain three key features of Victorian society that influenced 19th century prose writing.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "How might a 19th century writer use a wealthy character's reaction to poverty to criticise Victorian society?",
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Why did many 19th century writers use fiction rather than non-fiction to address social issues?',
      lines: 5,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a checklist of Victorian language features to look for (e.g., longer sentences, formal words, inverted word order).',
      core: 'Students identify Victorian sentences and explain their reasoning.',
      stretch:
        'Students rewrite two of the Victorian sentences in modern English, then discuss what is lost or gained in translation.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a glossary of root words (e.g., "supplicare" = to kneel/beg) and guided questions for each unfamiliar word.',
        core: 'Students apply the four strategies independently and record their process.',
        stretch:
          'Students analyse the writer\'s word choices: why "supplicant" rather than "beggar"? What connotations does each word carry?',
      },
      resources: [
        'Vocabulary strategies poster',
        'Extract handout',
        'Root words glossary (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a colour-coded version with the main clause already highlighted and one subordinate clause bracketed.',
        core: 'Students dissect the sentence independently and produce a modern rewrite.',
        stretch:
          'Students write their own periodic sentence in Victorian style on a topic of their choice, then explain the effect it creates.',
      },
      resources: [
        'Extract handout',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students identify what emotional tone or connotation is lost in the modern paraphrase.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Define the following words as they are used in 19th century prose: countenance, supplicant, condescension, tranquillity.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Explain two strategies you can use to work out the meaning of an unfamiliar word in a 19th century text.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Rewrite the following Victorian sentence in modern English, then explain what is lost in the translation: "She was possessed of a disposition so amiable that even those who had cause to resent her found their animosity quite disarmed."',
      lines: 6,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a list of Gothic features (darkness, isolation, mystery, decay, supernatural) to match against each phrase.',
      core: 'Students categorise independently and justify choices with reference to mood and atmosphere.',
      stretch:
        'Students explain why certain images create unease psychologically - what is it about darkness, isolation, or decay that frightens us?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed map with definitions given; students add examples and effects.',
        core: 'Students create the map independently from teacher input.',
        stretch:
          'Students add a layer identifying which conventions reflect specific Victorian anxieties (e.g., the doppelg\u00e4nger and fears about hidden identity; transgression and fears about science).',
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a conventions checklist to tick off as they find each one, plus a paragraph frame.',
        core: 'Students identify conventions and write an analytical paragraph independently.',
        stretch:
          'Students evaluate which single technique is most effective in creating Gothic atmosphere and justify their choice with close textual reference. They also consider what Victorian anxiety this passage might reflect.',
      },
      resources: [
        'Extract handout',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a setting prompt (e.g., "an abandoned hospital at midnight") and a word bank of Gothic vocabulary.',
      core: 'Students write independently, choosing their own setting.',
      stretch:
        'Students embed a specific Victorian anxiety into their writing (e.g., fear of scientific progress, fear of the "other").',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Analyse how the writer creates a sense of unease in the extract through their description of the house and its surroundings.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Explain what is meant by the term "the uncanny" and why it was important in Gothic literature.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'How might Gothic conventions reflect Victorian societal anxieties? Give two examples.',
      lines: 6,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide two or three examples of books that influenced change for students to discuss.',
      core: 'Students generate their own examples and justify whether fiction or non-fiction is more persuasive.',
      stretch:
        'Students consider counter-arguments: what are the limitations of fiction as a tool for social change?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students rank the six techniques from most to least persuasive, justifying their ranking.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Teacher pre-labels two techniques in the extract; students find and analyse two more using guided questions.',
        core: 'Students identify techniques and write a PEE paragraph independently.',
        stretch:
          'Students write a second paragraph evaluating the final sentence ("She had forgotten how") - why is this more powerful than describing the child crying?',
      },
      resources: [
        'Extract handout',
        'PEE paragraph frame (support tier)',
        'Social Realism Toolkit reference',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students evaluate: is evoking emotion enough to create change, or does the writer need to propose a solution?',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Why is the final sentence of the extract - "She had forgotten how" - particularly effective?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Explain what is meant by the term "didactic" and give an example of how a 19th century text might be didactic.',
      lines: 4,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a pre-printed version of the model paragraph for annotation rather than copying from the board.',
        core: 'Students copy and annotate the model paragraph, then identify one additional technique independently.',
        stretch:
          "Students write their own paragraph on a different technique from the extract before seeing the teacher's model.",
      },
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students write a third paragraph evaluating the effectiveness of the final sentence's ironic tone and what it reveals about Victorian social expectations.",
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students identify which step they find most challenging and explain what they will do to improve.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'What are the four steps of the extract analysis method, and what does each involve?',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'What is the effect of the ironic final sentence in the second extract about Mrs Ellwood?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        "Explain the difference between a response that retells the story and one that analyses the writer's methods.",
      lines: 5,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide guiding questions: "What does the reader know in version 1 that they don\'t know in version 3?"',
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students add a column evaluating the advantages and disadvantages of each technique for a writer.',
      },
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a third version of the extract using free indirect discourse and explain how it differs from both originals.',
      },
  ...
  worksheetQuestions: [
    {
      question:
        'Explain the difference between first-person narration and third-person omniscient narration.',
      lines: 5,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students consider: can a character without social power still have agency? How might a writer show this?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students consider how these three themes intersect - e.g., a wealthy woman has class privilege but is constrained by gender expectations.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide guided annotation prompts highlighting key phrases and a paragraph frame for the evaluative response.',
        core: 'Students analyse and write the evaluative paragraph independently.',
        stretch:
          'Students consider what a feminist reading of this extract would emphasise versus a historicist reading, and how these interpretations differ.',
      },
      resources: [
        'Extract handout',
        'Annotation prompts (support tier)',
        'Evaluative paragraph frame (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students articulate how a single text can simultaneously challenge one social norm while reinforcing another.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Explain the concept of "the angel in the house" and how 19th century writers responded to it.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        "Analyse how the writer presents Mrs Blackwood's resistance to Mr Thornbury's authority in the extract.",
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'What is meant by the term "hegemony" in the context of Victorian class and gender relations?',
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Why is it important to consider whether a writer is reinforcing or challenging social norms when analysing 19th century prose?',
      lines: 5,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a checklist of reasons a narrator might be unreliable (lying, biased, confused, self-deceived).',
      core: 'Students discuss and identify reasons for unreliability independently.',
      stretch:
        'Students consider: is every first-person narrator inherently somewhat unreliable? Why or why not?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students consider which type is most challenging for the reader to detect and why.',
      },
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students write a paragraph from the brother's perspective and explain how having both accounts would change the reader's interpretation.",
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students consider: does the narrator know he is being unreliable, or is he self-deceived?',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Identify and analyse three clues in the extract that suggest the narrator is unreliable.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Explain the difference between a deliberately lying narrator and a self-deceived narrator.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'What is the effect on the reader of the final sentences: "Only I know the truth of it. Only I"?',
      lines: 5,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide prompts: "Which uses longer sentences? Which sounds more formal? Which is more direct?"',
      core: 'Students identify differences independently.',
      stretch:
        'Students consider which statement is more persuasive and why - does formality help or hinder persuasion?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed comparison grid and a comparative paragraph frame with connectives.',
        core: 'Students complete the grid and write two paragraphs independently.',
        stretch:
          'Students write a third paragraph evaluating which text is more effective in persuading the reader and why, considering both historical context and rhetorical strategy.',
      },
      resources: [
        'Dual text handout',
        'Comparison grid worksheet',
        'Paragraph frame with connectives (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Teacher identifies the technique for the student and provides the quotations; student analyses the effects.',
        core: 'Students select technique, find quotations, and analyse independently.',
        stretch:
          'Students analyse a second technique and consider how audience expectations have changed between the 19th and 21st centuries.',
      },
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Both texts use rhetorical questions. Compare how this technique is used in each text and analyse its effect.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "Which text do you find more persuasive, and why? Consider both the writer's techniques and the intended audience.",
      lines: 6,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a list of eight tips - students select the five most important and rank them.',
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a planning grid with prompts: "Paragraph 1: How is Mr Gripe characterised? Paragraph 2: What contrasts are used? Paragraph 3: What is the effect of the ending?"',
        core: 'Students plan and write independently under timed conditions.',
        stretch:
          'Students aim for a "perceptive" response by considering multiple interpretations - e.g., is the writer criticising Gripe alone, or the entire social system that enabled him?',
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Teacher models how to apply the mark scheme using a sample response before students assess their own.',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students identify connections between the skills learned in this unit and their set text study.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "How does the writer use irony to present Mr Gripe's funeral in the opening paragraph?",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Analyse the effect of the tricolon "paintings he never looked at, books he had never read, and a dining table at which he had always eaten alone."',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "How does the writer use the ending of the extract - the mill workers' reaction - to present their attitude towards Gripe and the class system?",
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Evaluate how successfully the writer uses this extract to comment on Victorian values. Consider at least two specific techniques in your response.',
      lines: 8,
      modelAnswer:
