...
export const wjecLanguageLessonPlans: WJECLessonPlan[] = [
  {
    ...
    starterActivity: {
      description:
        'Component Balance Challenge: Display a pie chart showing WJEC C700QS assessment weightings (Creative Writing 25%, Transactional Writing 25%, Reading Analysis 25%, Language Study 25%). Students estimate how much time to spend on each component in a 1.5-hour paper. Discuss their reasoning. Reveal actual suggested time allocations. Discuss why WJEC balances writing and reading equally.',
      duration: '10 mins',
      resources: [
        'Pie chart of WJEC assessment weightings (projected)',
        'Time allocation reference sheet',
        'Whiteboard for student estimates',
      ],
    },
    mainActivity: {
      description:
        'Build a comprehensive WJEC C700QS framework showing both components, assessment weightings, mark allocations per task, question types, and time management strategy. Use WJEC specimen papers to identify each component in context. Students work in pairs to complete a blank template, then compare in groups of four. Build a master version on the board together. Key teaching: Component 1 (2 hours total: 1 hour creative writing + 1 hour transactional writing); Component 2 (1.5 hours: 45 mins reading, 45 mins language study). Run a "timing simulation": project questions from both components (creative prompt, transactional task, reading passage with questions, language analysis task) and ask students to allocate time appropriately, considering their personal reading/writing speed. Debrief: Which task do you prefer? Which takes longest? How will you manage pacing on exam day? Students write personalized exam strategy card.',
      duration: '35 mins',
      steps: [
        'Distribute blank WJEC C700QS framework showing Component 1 and 2',
        'Using projected WJEC specimen papers, students identify task types and marks',
        'Fill in: component, task type, marks, suggested time, question style',
        'Pairs compare with groups of four, resolving differences',
        'Teacher builds master version on board; discuss time allocation rationale',
        'Project four different tasks (one from each assessment area); students allocate time realistically',
        'Discuss: Which tasks feel longest? Why? How will anxiety affect your pacing?',
        'Students write personalized exam strategy: which tasks to attempt first, how to manage time, what contingencies if running late',
      ],
      differentiation: {
        support:
          'Provide partially completed framework with Component 1 tasks pre-filled. Include visual timer showing time allocation per section. Offer time management checklist (Have I planned my time? Do I know which tasks suit me?). Allow extra time to process timing information.',
        stretch:
          'Students analyse past paper data to identify which components carry highest marks across multiple years. Create a personalized component priority ranking (e.g., if stronger at writing, allocate more time to creative writing). Write rationale for your strategy choices.',
      },
    },
    plenary: {
      description:
        'Strategy Card Swap: Students exchange personalized exam strategy cards with a partner. Partner reads the strategy and provides constructive feedback: Is the time allocation realistic? Have you considered contingencies (e.g., running over time)? Partners return cards with annotations. Whole-class reflection: What makes a good exam strategy?',
      duration: '10 mins',
    },
    homework:
      'Create a revision poster showing WJEC C700QS structure: both components, marks, weightings, task types, time allocation, and one key success criterion per component. Include a visual timer showing how to pace yourself across each paper. Bring to next lesson for peer review.',
    resourcesNeeded: [
      'Pie chart of WJEC assessment weightings',
      'Time allocation reference sheet',
      'Blank WJEC C700QS framework sheet',
      'WJEC specimen papers (projected or printed)',
      'Four sample questions (one from each task type)',
      'Personalized exam strategy template',
      'Countdown timer for classroom use',
    ],
    assessmentOpportunities: [
      'Time allocation estimate in starter (quick assessment of initial understanding)',
      'Check completed framework for accuracy',
      'Assess personalized exam strategy for realism and detail',
      'Peer feedback on strategy card completeness',
    ],
    keyVocabulary: [
      'component',
    ...
    crossCurricular: [
      'Mathematics (proportions, time allocation)',
      'Planning and organization skills',
    ],
    sendAdaptations:
      'Provide pre-completed weighting diagram with visual breakdown; simplify framework to show only main task types; allow extra time to process timing concepts; pair with stronger peer for strategy development; offer visual timer template; provide checklist to guide strategy card completion; seat near teacher for additional explanation.',
  },

  {
    ...
    starterActivity: {
      ...
      duration: '10 mins',
      resources: [
        'Five sample opening paragraphs (projected/printed)',
        'Sticky note pads',
        'Opening effectiveness checklist',
      ],
    },
    mainActivity: {
      description:
        'Teach creative narrative writing through the lens of WJEC assessment: (1) Opening hook: Start with specificity, sensory detail, or unexpected juxtaposition. Avoid "Once upon a time" generics. (2) Character development: Show character through dialogue, action, internal thought; avoid telling emotions. (3) Pacing and tension: Vary sentence length to control pace. Short sentences create urgency; longer sentences allow reflection. (4) Descriptive technique: Use imagery (visual, auditory, tactile, olfactory, gustatory), metaphor, symbolism. Connect description to mood and meaning. (5) Resolution: Conclude with meaning-making moment, not simply "and then they woke up" (if dream framework used). Model a complete narrative (500 words): Opening (specific sensory detail + character introduced), Development (character motivation, action, dialogue, internal reflection), Turn (moment of realization or change), Resolution (what the character has learned or how their understanding has shifted). Show Grade 5 response (clear narrative, some sensory detail, technical accuracy adequate but not polished) and Grade 8+ response (compelling voice, layered characterization, sophisticated technique use, minimal errors). Complete one timed creative writing task (45 mins) responding to a WJEC-style prompt (open-ended narrative or descriptive prompt). Self-assess using detailed mark scheme: Does the opening hook? Is character developed beyond telling? Is description vivid and purposeful? Is there a clear arc (setup, development, resolution or thematic shift)? Are technical errors minimal?',
      duration: '35 mins',
      steps: [
        'Introduce WJEC creative writing assessment criteria: content & organization, technical accuracy, use of linguistic features',
        'Discuss what makes opening compelling: specificity, sensory detail, intrigue, voice',
        'Model character development: showing vs telling emotion through action and dialogue',
        'Discuss pacing: how sentence length variation controls reader experience',
        'Model descriptive technique use: imagery, metaphor, symbolism in service of meaning',
        'Discuss resolution: must provide insight, not just end plot',
        'Show Grade 5 narrative (clear but generic; adequate but not polished writing)',
        'Show Grade 8+ narrative (compelling voice; sophisticated characterization; varied descriptive techniques; precise language; minimal errors)',
        'Discuss what distinguishes high-level creative writing: specificity, voice, technique variety, technical precision',
        'Distribute WJEC-style creative prompt (open-ended narrative or descriptive)',
        'Students plan (10 mins): brainstorm character/setting, identify key moments, note techniques to use',
        'Students draft (35 mins): aim for 500-600 words, maintaining focus on technique and accuracy',
      ],
      differentiation: {
        support:
          'Provide writing frame: (Opening: "In [setting], [specific detail]. [Character] was...") (Development: "First, [action]. Then, [complication]...") (Turn: "That\'s when [realization]...") (Resolution: "From that moment..."). Offer bank of descriptive language (imagery words, metaphor examples). Reduce target length (aim for 350-400 words instead of 500-600). Allow extra 5 minutes for planning.',
        stretch:
          'Challenge students to use three different literary techniques intentionally, annotating which technique appears where and why. Write opening two different ways and explain which is more effective. Analyse how professional writers use pacing and voice; replicate one technique in their own writing.',
      },
    },
    plenary: {
      description:
        'Technique Spotlight: Students read aloud one sentence from their creative writing that demonstrates a particular technique (imagery, dialogue, pacing variation, metaphor, etc.). Class identifies the technique and discusses its effect. Repeat with 5-6 different examples. Reinforce: Technique is only valuable if it serves the story, creates effect, or reveals character.',
      duration: '10 mins',
    },
    homework:
    ...
    resourcesNeeded: [
      'Five sample openings (varying quality)',
      'Opening effectiveness checklist',
      'WJEC creative writing prompts (past papers or specimen)',
      'Character development examples (showing vs telling)',
      'Descriptive language word bank (for support)',
      'Writing frame template (for support)',
      'Grade 5 and Grade 8+ model narratives',
      'Detailed WJEC creative writing mark scheme (0-25)',
      'Timer for writing session',
    ],
    assessmentOpportunities: [
      'Opening analysis in carousel activity (quick check of engagement awareness)',
      'Planning notes (organization check)',
      'Timed creative writing task (self-assessed against mark scheme)',
      'Annotation of techniques used (reflection on craft)',
      'Homework creative writing (self-assessed for technique and accuracy)',
    ],
    keyVocabulary: [
      'narrative',
      'descriptive',
    ...
    crossCurricular: [
      'Creative writing',
      'Literary analysis',
      'Psychology (character motivation)',
      'Visual arts (composition, imagery)',
    ],
    sendAdaptations:
      'Provide detailed writing frame with sentence starters; offer comprehensive descriptive language word bank; reduce target length (aim for 350-400 words instead of 500-600); allow typed response if handwriting is barrier; allow extra 10 minutes per task; provide example narratives showing different technique approaches; pair with peer for planning discussion; allow verbal planning recorded by TA; use highlighted examples showing effective techniques; provide annotation template for reflecting on technique use.',
  },

  {
    ...
    resourcesNeeded: [
      'Three register-variant texts on same topic',
      'Register identification checklist',
      'Audience/purpose analysis chart',
      'WJEC transactional writing prompts (different audiences)',
      'Structure frame template (for support)',
      'Register-specific word bank (for support)',
      'Grade 5 and Grade 8+ model transactional texts',
      'Detailed WJEC transactional mark scheme (0-25)',
      'Timer for writing sessions',
    ],
    assessmentOpportunities: [
      'Register identification in starter (quick check)',
      'Two timed transactional writing tasks (self-assessed against mark scheme)',
      'Register consistency peer feedback during plenary',
      'Homework transactional text (self-assessed for register consistency and purposeful detail)',
    ],
    keyVocabulary: [
      'transactional',
      'register',
...

  {
    ...
    resourcesNeeded: [
      'Short literary paragraph (starter)',
      'Meaning layers diagram',
      'WJEC-style passages (400-500 words)',
      'Question scaffolds (for support)',
      'Three question types (retrieval, inference, technique)',
      'Grade 5 and Grade 8+ model reading responses',
      'Detailed WJEC reading mark scheme (0-25)',
      'Highlighted example passages (for support)',
      'Timer for reading tasks',
    ],
    assessmentOpportunities: [
      'Meaning layers identification in starter (quick check)',
      'Three timed reading tasks (self-assessed against mark scheme)',
      'Evidence strength analysis in plenary',
      'Homework reading analysis (self-assessed for quotation use and explanation depth)',
    ],
    keyVocabulary: [
      'explicit',
      'implicit',
...

  {
    ...
    starterActivity: {
      description:
        'Syntax Surgery: Display a sentence written two ways with different syntax: Version 1 (short, simple sentences creating staccato effect): "She walked to the door. Her hand shook. She turned the handle slowly." Version 2 (long, complex sentence creating flowing effect): "As she walked slowly to the door, her trembling hand reached for the handle, which turned with deliberate care." Students compare: How is the effect different? Why does syntax matter? Introduce the concept of deliberate syntactic choice as stylistic tool.',
      duration: '10 mins',
      resources: [
        'Two syntax-variant sentences (projected/printed)',
        'Sentence effect comparison chart',
        'Stylistic device examples',
      ],
    },
    mainActivity: {
      description:
        "Teach language study (grammar, syntax, stylistic devices) for WJEC: (1) Grammatical structures: Simple sentence (one independent clause), compound (two independent clauses), complex (independent + dependent clause). Each serves different purpose. (2) Sentence types by purpose: Statement (declarative), question (interrogative), command (imperative), exclamation (exclamatory). Each creates different reader effect. (3) Syntax as style: Short sentences create pace/urgency. Long sentences create reflection/complexity. Inverted word order (fronting) emphasizes particular element. (4) Stylistic devices: Repetition (emphasizes idea), parallelism (creates pattern and balance), listing (accumulates detail or argument), rhetorical question (engages reader and signals argument), alliteration/assonance (creates musicality or emphasis). (5) Lexical choice: Formal vs informal diction, abstract vs concrete language, positive vs negative word connotation. Model language analysis: Provide short passage. Identify grammatical structures used. Analyze effect of sentence length variation. Identify stylistic devices. Explain how language choices combine to create overall effect. Show Grade 5 analysis (identifies techniques, basic explanation of effect) and Grade 8+ analysis (identifies techniques, explains effect with specificity, links to writer's purpose and broader context). Complete three language analysis tasks (10-15 mins each) identifying and explaining grammatical, syntactic, and stylistic features. Self-assess using mark scheme: Did I identify specific language features? Did I explain their effects? Did I link to writer's purpose?",
      duration: '35 mins',
      steps: [
        'Introduce WJEC language study assessment criteria: identification of features, analysis of effect, use of textual evidence',
        'Teach grammatical structures: simple, compound, complex; explain why writers choose each',
        'Teach sentence types by purpose: statement, question, command, exclamation; discuss effect each creates',
        'Model syntax as style: sentence length variation, word order choices, structural patterns',
        'Teach stylistic devices: repetition, parallelism, listing, rhetorical question, alliteration, assonance',
        'Discuss lexical choice: formality, concreteness, connotation, word associations',
        'Model language analysis: passage analysis identifying and explaining three language features',
        'Show Grade 5 analysis (features identified, basic effect explanation)',
        'Show Grade 8+ analysis (features identified, effect explained specifically, purpose linked, context aware)',
        'Distribute three passages for language analysis',
        'Task 1 - Grammatical analysis (identify simple/compound/complex sentences; explain effect) - 15 mins',
        'Task 2 - Stylistic device analysis (identify 2-3 devices; explain how each creates effect) - 15 mins',
        'Task 3 - Integrated language analysis (identify 3+ language features; explain combined effect) - 15 mins',
        'Self-assess all three using detailed mark scheme',
      ],
      differentiation: {
        support:
          'Provide feature identification checklist: Does the passage include short sentences? Long sentences? Repetition? Questions? Commands? Pre-highlight language features in text. Offer analysis sentence starters: "The writer uses [technique] to [effect]. This creates [reader response]..." Reduce number of features to identify (1-2 instead of 3). Allow extra 2 minutes per task.',
        stretch:
          "Identify how multiple language features work together to create cumulative effect. Compare two passages and discuss how different language choices create different effects. Analyse how a writer's language choices reflect their purpose and intended audience. Rewrite a passage using different language choices; explain how effect shifts.",
      },
    },
    plenary: {
      description:
        'Language Effect Map: Display a short passage and create a visual map: Central box = passage excerpt. Arrows pointing outward to surrounding boxes, each identifying one language feature. Further arrows from each feature box to effect boxes. Example: Central passage → "short sentences" arrow → "pace" and "tension" boxes. Class completes the map together, adding features and effects. Reinforce: Language features create effects; the more features you identify and explain, the higher your analysis marks.',
      duration: '10 mins',
    },
    homework:
    ...
    resourcesNeeded: [
      'Two syntax-variant sentences (starter)',
      'Sentence effect comparison chart',
      'Grammatical structures explanation sheet',
      'Sentence types by purpose poster',
      'Stylistic device examples (repetition, parallelism, etc.)',
      'Three language analysis passages (100-200 words each)',
      'Feature identification checklist (for support)',
      'Analysis sentence starters (for support)',
      'Grade 5 and Grade 8+ model language analyses',
      'Detailed WJEC language analysis mark scheme (0-25)',
      'Language effect map template',
    ],
    assessmentOpportunities: [
      'Syntax effect comparison in starter (quick check of awareness)',
      'Three timed language analysis tasks (self-assessed against mark scheme)',
      'Language effect map co-construction (group check of understanding)',
      'Homework language analysis passage (self-assessed for feature identification and effect explanation)',
    ],
    keyVocabulary: [
      'grammar',
      'syntax',
...

  {
    ...
    resourcesNeeded: [
      'Two short texts on related topic (starter)',
      'Venn diagram template',
      'Comparison prompt cards',
      'Two WJEC-style texts for main task (different genres/periods)',
      'Comparison planning frame (for support)',
      'Comparative language starters sheet (for support)',
      'Grade 5 and Grade 8+ model comparison responses',
      'Detailed WJEC comparison mark scheme (0-25)',
      'Timer for writing task',
    ],
    assessmentOpportunities: [
      'Venn diagram creation in starter (quick check of comparison awareness)',
      'Comparison planning (check for identification of multiple comparison points)',
      'Timed comparison analysis (self-assessed against mark scheme)',
      'Comparative statement peer review in plenary',
      'Homework comparison analysis (self-assessed for multiple point comparison and language variety)',
    ],
    keyVocabulary: [
      'comparison',
      'similarity',
    ...
    sendAdaptations:
      'Provide comparison planning frame with identified similarities/differences; offer comprehensive comparative language starters sheet; reduce comparison length (aim for 400 words instead of 500-600); allow typed response if handwriting is barrier; allow extra 10 minutes for planning; provide annotated example comparison showing effective technique; pair with peer for comparison point brainstorming; allow verbal comparison recorded by TA; use side-by-side text layout for easier reference.',
  },

  {
    ...
    starterActivity: {
      description:
        "Time Estimation Challenge: Display a creative writing prompt and a transactional writing prompt. Ask students: How long would each task take you realistically? Collect estimates for each. Discuss variation in answers (different writing speeds, different confidence levels). Introduce the concept of personalized timing strategy: You don't need equal time for both; allocate based on your strengths and speed.",
      duration: '10 mins',
      resources: [
        'One creative prompt and one transactional prompt (projected)',
        'Time estimation worksheet',
        'Personal writing speed reference sheet',
      ],
    },
    mainActivity: {
      description:
        'Simulate a realistic 1-hour WJEC writing session: (1) Students receive both creative and transactional prompts simultaneously. (2) They must allocate 60 minutes between the two tasks (e.g., 35 mins creative + 25 mins transactional, or 30 mins each, or 25 mins creative + 35 mins transactional, depending on personal preference and strengths). (3) Within each task allocation: 5 mins planning, remaining time drafting. (4) Emphasis on completing both tasks, even if not to full polish. Debrief after session: (A) Did your time allocation work? (B) Which task felt rushed? Why? (C) What would you change in a real exam? (D) How confident are you that both pieces communicated their purpose effectively? Complete the 1-hour simulation once with teacher guidance, then discuss personalized timing strategies. Introduce the concept of "priority order": Should you attempt creative first (while freshest) or transactional (while details are sharp)? Should you attempt the task you\'re strongest at first (build confidence) or weakest first (more thinking time needed)? Students create individualized timing plan.',
      duration: '35 mins',
      steps: [
        'Explain that this 1-hour session mirrors actual WJEC paper conditions',
        'Distribute creative and transactional prompts simultaneously',
        'Students must allocate 60 minutes between tasks realistically',
        'Suggest time option 1 (35 mins creative, 25 mins transactional) for creative writers',
        'Suggest time option 2 (30 mins each) for balanced writers',
        'Suggest time option 3 (25 mins creative, 35 mins transactional) for transactional writers',
        'Within each task: 5 mins planning, remaining time drafting',
        'Set timer for full 60 minutes; students write continuously',
        'Call out time checks at 10, 20, 30, 45-minute marks to encourage pacing awareness',
        'At 60 minutes, students stop and submit both drafts',
        'Debrief immediately: Which task felt rushed? Did time allocation match your plan? What happened if you ran over?',
        'Discuss adjustments for next session',
        'Students create personal timing plan for next timed writing session',
      ],
      differentiation: {
        support:
          'Provide reduced time simulation (45 minutes instead of 60, with shorter prompts). Offer time management checklist (Did I allocate time before starting? Did I check time every 15 minutes?). Allow 1 extra minute for planning per task. Pair with stronger peer for timing discussion post-simulation.',
        stretch:
          'Challenge students to complete full 60-minute session, then review both pieces for technical accuracy and refinement opportunities under additional time constraints (if revising). Analyse their actual time use vs planned time; identify discrepancies and plan adjustments. Set increasingly tight time limits across multiple practice sessions.',
      },
    },
    plenary: {
      description:
    ...
    resourcesNeeded: [
      'One creative and one transactional prompt (for main activity)',
      'Timer (visible to all)',
      'Time management checklist (for support)',
      'Personal timing plan template',
      'Practice prompts for homework',
      'Reflection sheet for post-session debrief',
    ],
    assessmentOpportunities: [
      'Time estimation in starter (awareness check)',
      'Actual time allocation during 60-minute simulation (did students follow their plan?)',
      'Completion of both tasks within time (practical check)',
      'Post-simulation reflection (metacognition about pacing)',
      'Homework timing practice and reflection',
    ],
    keyVocabulary: [
      'time management',
      'allocation',
...

  {
    ...
    mainActivity: {
      ...
      differentiation: {
        support:
          'Provide word lists for transactional writing; pre-reading annotations highlighting key vocabulary; simplified mark scheme; extended time (1.5x) if applicable',
        stretch:
          'Challenge to write multiple creative opening variations; analyze examiner feedback on strengths; identify complex language patterns in reading passages; create own mark scheme',
      },
    },
    plenary: {
      description:
        "Development Planning: Each student writes a personal exam development plan for final weeks: (1) What will I focus on before the real exam? (2) What specific skill (creative opening, transactional register consistency, inference analysis, technique identification) needs practice? (3) What resources or support do I need? (4) What's one thing I did well that I want to repeat in the real exam? Students share one focus area with a partner. Teacher collects all development plans to inform targeted revision support.",
      duration: '10 mins',
    },
    homework:
    ...
    resourcesNeeded: [
      'Full WJEC C700QS mock exam paper (both components)',
      'Detailed mark schemes for all sections (0-25 for each)',
      'Time management reminders/warnings for teacher',
      'Self-assessment sheet template (strengths, challenges, priorities)',
      'Development plan template',
      'Exam conditions (invigilated, timed, quiet environment)',
    ],
    assessmentOpportunities: [
      'Pre-exam readiness checklist (identifies preparation gaps)',
      'Complete mock exam response (comprehensive assessment of all skills)',
      'Self-assessment against mark schemes (identifies student perception vs actual performance)',
      'Personal development plan (identifies priorities for final revision)',
      'Homework focused practice task and reflection',
    ],
    keyVocabulary: [
      'mock exam',
...

  {
    ...
    resourcesNeeded: [
      'Two voice-distinct passages (starter)',
      'Voice characteristics chart',
      'Technique purposefulness checklist (for support)',
      'Student creative writing draft from previous lesson',
      'Grade 6 and Grade 9 model creative responses',
      'Revision annotation template',
      'Reading aloud checklist',
    ],
    assessmentOpportunities: [
      'Voice identification in starter passages (quick check)',
      'Revision task (check for voice consistency improvements)',
      'Peer review of revision choices (qualitative feedback)',
      'Plenary voice showcase (formative assessment of voice consistency)',
      'Homework annotated revision and reflection',
    ],
    keyVocabulary: [
      'voice',
      'perspective',
...

  {
    ...
    resourcesNeeded: [
      'Five register-variant opening sentences (starter)',
      'Register formality scale',
      'Audience-register matching chart',
      'Complex transactional prompt requiring multiple purposes',
      'Planning sheet (for support)',
      'Structured organizer template (for support)',
      'Grade 5 and Grade 9 model transactional responses',
      'Detailed WJEC transactional mark scheme (0-25)',
      'Timer for writing session',
    ],
    assessmentOpportunities: [
      'Register precision identification in starter (quick check)',
      'Planning sheet (check for purpose identification and audience analysis)',
      'Timed transactional writing task (self-assessed against mark scheme)',
      'Purpose effectiveness analysis in plenary',
      'Homework annotated transactional response (self-assessed for multiple purpose achievement and register consistency)',
    ],
    keyVocabulary: [
      'transactional',
      'purpose complexity',
...

  {
    ...
    resourcesNeeded: [
      'Short passage with layered implication (starter)',
      'Inference layers diagram',
      'Literary passage for main tasks (600 words)',
      'Inference development scaffolds (for support)',
      'Technique analysis scaffolds (for support)',
      'Grade 6 and Grade 9 model reading responses',
      'Detailed WJEC reading analysis mark scheme (0-25)',
      'Context information for passage (author, period, genre)',
    ],
    assessmentOpportunities: [
      'Inference layers identification in starter (quick check)',
      'Three timed reading analysis tasks (self-assessed against mark scheme)',
      'Interpretation strength comparison in plenary',
      'Homework reading analysis (self-assessed for inference development and technique analysis depth)',
    ],
    keyVocabulary: [
      'inference',
      'developed inference',
...

  {
    ...
    starterActivity: {
      ...
      duration: '10 mins',
      resources: [
        'Sample sentence with multiple potential effects (projected)',
        'Effect precision checklist',
        'Context consideration guide',
      ],
    },
    mainActivity: {
      description:
        'Teach sophisticated language analysis: (1) Feature identification with precision: Don\'t just identify "short sentences"; identify "two consecutive single-word sentences creating staccato pace." (2) Effect specificity: Don\'t say "creates effect"; specify "creates urgency and prevents reader pause, mirroring the character\'s panicked mental state." (3) Purpose linkage: Consider why the writer made this choice. What reader response is desired? (4) Contextual awareness: Consider genre (news article demands different language than poem), intended audience (academic writing differs from advertising), purpose (persuade vs inform vs entertain). (5) Multiple feature integration: Show how several language features work together to create cumulative effect. Model a language analysis passage: Analyze a 200-word excerpt, identifying 3-4 language features and explaining how each creates effect while contributing to overall impact. Show Grade 5 analysis (features identified, basic effect explanation) and Grade 9 analysis (precise feature identification, specific effect explanation, purpose linkage, contextual awareness, integrated analysis of multiple features). Complete one integrated language analysis task (30 mins) analyzing multiple features from provided passage. Self-assess using detailed mark scheme.',
      duration: '35 mins',
      steps: [
        'Introduce precision in feature identification: avoid vague labels',
        'Teach effect specificity: move from "creates effect" to "creates reader response of X because [reason]"',
        'Discuss purpose linkage: why would writer choose this language?',
        'Introduce contextual consideration: genre, audience, purpose shape language choices',
        'Model identifying multiple features working together to create cumulative effect',
        'Show Grade 5 language analysis (features identified, basic effect)',
        'Show Grade 9 language analysis (precise identification, specific effect, purpose linked, contextual aware, integrated)',
        'Distribute 200-300 word passage for analysis',
        'Students identify 3-4 language features (grammatical, stylistic, lexical)',
        'Students explain effect of each feature with specificity',
        "Students link features to writer's purpose and overall impact",
        'Students consider context (genre, audience, purpose) shaping language choices',
      ],
      differentiation: {
        support:
          'Provide feature identification checklist: Does the passage include short sentences? Long sentences? Repetition? Questions? Alliteration? Pre-highlight language features. Offer effect specificity checklist: "What does this feature make the reader feel/think? Why?" Provide purpose linking sentence starter: "The writer likely used [feature] to [purpose]." Allow analysis of 2 features instead of 3-4.',
        stretch:
          'Identify how multiple features work together to create cumulative effect. Analyse how the same feature might create different effects in different contexts. Rewrite passage changing language choices; explain how meaning shifts. Compare language choices in two texts addressing similar topics; discuss why writers made different choices.',
      },
    },
    plenary: {
      description:
        'Feature Integration Map: Display a passage and create a visual map showing language features identified and their effects. Central box = passage. Arrows to feature boxes. Arrows to effect boxes. Further arrows showing how effects combine to create overall impact. Class co-creates the map. Reinforce: High-level language analysis integrates multiple features and shows how they work together.',
      duration: '10 mins',
    },
    homework:
    ...
    resourcesNeeded: [
      'Sample sentence with multiple effects (starter)',
      'Effect precision checklist',
      'Context consideration guide',
      'Passage for main task (200-300 words)',
      'Feature identification checklist (for support)',
      'Effect specificity checklist (for support)',
      'Purpose linking sentence starters (for support)',
      'Grade 5 and Grade 9 model language analyses',
      'Detailed WJEC language analysis mark scheme (0-25)',
      'Feature integration map template',
    ],
    assessmentOpportunities: [
      'Effect precision identification in starter (quick check)',
      'Feature identification and effect explanation in main task (self-assessed)',
      'Feature integration in plenary map co-creation',
      'Homework language analysis passage (self-assessed for precision and depth)',
    ],
    keyVocabulary: [
      'language feature',
      'grammatical',
...

  {
    ...
    mainActivity: {
      ...
      differentiation: {
        support:
          'Provide model answer; use sentence stems/word banks; break task into smaller chunks; allow extra time; reduce number of practice attempts; provide checklist for quality checking',
        stretch:
          'Complete multiple skill areas; create own practice task for peer; analyze own performance against mark scheme; design strategy for avoiding similar errors in real exam',
      },
    },
    plenary: {
      description:
        "Confidence Reflection: Students reflect: (1) Did focused practice on this skill help? (2) Are you more confident now? (3) What would you still like to practice before the real exam? (4) What's one thing you learned or improved today? Whole-class discussion: Share successes. Discuss how targeted practice builds skill and confidence. Remind: Final weeks before exam should focus on your weakest areas, not reviewing strengths.",
      duration: '10 mins',
    },
    homework:
      'Choose your single weakest skill from mock exam feedback. Complete three focused practice tasks targeting that skill area: (1) Analysis/identification task, (2) Quick practice task, (3) Timed exam-style task. Reflect: Has your confidence in this skill improved? What would help you feel more prepared before the real exam? Bring practice tasks and reflection to next lesson.',
    resourcesNeeded: [
      'Mock exam feedback (student documents)',
      'Common weaknesses poster',
      'Targeted skill-building materials for each weakness area: Creative openings (strong opening analysis + quick practice), Transactional register (register analysis + practice task), Inference development (clue identification + practice), Technique analysis (technique identification + effect explanation practice)',
      'Multiple short practice activities vs one long task',
      'Scaffolded and unsupported practice versions',
      'Confidence reflection sheet',
    ],
    assessmentOpportunities: [
      'Weakness identification from mock exam (self-assessment)',
      'Focused practice task completion (check for understanding)',
      'Peer feedback on focused practice task',
      'Confidence reflection and improvement identification',
      'Homework targeted practice tasks and reflection',
    ],
    keyVocabulary: [
      'weakness',
      'targeted',
...

  {
    ...
    starterActivity: {
      description:
        'Confidence Stocktake: Students complete a quick self-assessment: (1) Rate your confidence in each skill (creative writing, transactional writing, reading analysis, language analysis) on a 1-10 scale. (2) Identify one skill where confidence has grown since start of revision. (3) Identify one strategy that helped build confidence (e.g., targeted practice, understanding mark scheme, time management planning). Whole-class discussion: Celebrate improvements. Identify common confidence-building strategies to share.',
      duration: '10 mins',
      resources: [
        'Confidence self-assessment scale (1-10 for each skill)',
        'Improvement tracking sheet',
        'Strategy sharing chart',
      ],
    },
    mainActivity: {
      description:
        'Address exam stress and build final-stage confidence: (1) Discuss common exam anxieties: time pressure, fear of blank page, worry about mistakes, physical symptoms (racing heart, shaking hands). Normalize these responses; they\'re common. (2) Introduce practical anxiety management techniques: Deep breathing (4-count in, 6-count out), positive self-talk ("I\'ve prepared well for this exam"), physical techniques (tensing and releasing muscle groups), grounding (5 things you can see, 4 you can hear, 3 you can touch, 2 you can smell, 1 you can taste). (3) Discuss exam day logistics: What to bring, when to arrive, what to do if you feel panicked (raise hand, ask for water, breathe). (4) Create personal pre-exam routine: 30 minutes before exam, what will help you settle (quiet reflection, review of strategy card, conversation with supportive person)? (5) Finalize exam strategy: Review timing plan, priority order (which task first?), contingencies (if running late, what will you do?). Practice one anxiety management technique together (deep breathing or grounding exercise). Create personal "exam day kit": strategy card, anxiety management reminder card, confidence statements.',
      duration: '40 mins',
      steps: [
        'Introduce common exam anxieties and normalize responses',
        'Teach deep breathing technique: 4-in, 6-out',
        'Teach grounding technique: 5-4-3-2-1 sensory awareness',
        'Discuss positive self-talk: "I\'ve prepared for this. I know what to do."',
        'Discuss physical anxiety management: exercise beforehand, warm-up stretches',
        'Review exam day logistics: timing, arrival, what to bring',
        'Create personal pre-exam routine: what helps you feel ready?',
        'Finalize timing strategy: review plan, priority order, contingencies',
        'Practice one anxiety management technique together (deep breathing)',
        'Each student creates personal exam day kit: strategy card, anxiety reminder, confidence statements',
        'Practice accessing kit and using techniques if anxiety spikes during exam',
      ],
      differentiation: {
        support:
          'Provide anxiety management reminder card with step-by-step breathing instructions and grounding script. Allow practice of techniques multiple times. Discuss one-on-one any specific exam anxieties. Create simplified exam day kit. Assign peer or teacher check-in immediately before exam. Discuss contingencies for specific worries (e.g., "What if I go blank?").',
        stretch:
          'Discuss how to channel exam nerves into focused energy. Develop personalized resilience strategies beyond basic anxiety management. Reflect on past successes and apply confidence lessons to final exam.',
      },
    },
    plenary: {
      description:
        'Confidence & Readiness Affirmation: Each student writes one sentence affirming their readiness and confidence: "I am ready for this exam because ___." or "I will manage exam anxiety by ___." Students optionally share with a partner or small group. Whole-class affirmation: Teacher and classmates acknowledge each other\'s readiness. Send students into final revision phase with clear message: You\'ve prepared well. You have strategies. You will do this.',
      duration: '10 mins',
    },
    homework:
    ...
    resourcesNeeded: [
      'Confidence self-assessment scale (1-10 for each skill)',
      'Anxiety management technique instruction sheet (deep breathing, grounding, positive self-talk)',
      'Exam day logistics checklist',
      'Personal pre-exam routine template',
      'Exam day kit assembly checklist: strategy card, anxiety reminder, confidence statements',
      'One-on-one anxiety discussion (for support students)',
      'Affirmation reflection sheet',
    ],
    assessmentOpportunities: [
      'Confidence stocktake self-assessment',
      'Anxiety management technique practice (formative check)',
      'Personal exam strategy finalization (readiness check)',
      'Personal affirmation reflection',
      'Exam day kit assembly (readiness indicator)',
    ],
    keyVocabulary: [
      'confidence',
      'anxiety',
...

  {
    ...
    starterActivity: {
      ...
      duration: '10 mins',
      resources: [
        'Marked exam papers and detailed feedback',
        'Performance reaction sheet',
        'Emotional processing support (if needed)',
      ],
    },
    mainActivity: {
      description:
        'Conduct thorough exam analysis and reflection: (1) Students use detailed mark scheme to analyze each section: Where did marks go? What would have earned more marks? (2) Pattern analysis: Across all four task types, what patterns emerge? (E.g., consistently strong narrative voice, weak register consistency, good inference but poor technique analysis, strong openings but weak closings.) (3) Improvement identification: Compare mock exam to final exam if marks improved, identify what helped. If marks stayed similar, identify what needs development. (4) Skill strength vs weakness comparison: Return to pre-exam confidence self-assessment. How did confidence predict actual performance? What was overconfident? What did you underestimate? (5) Future application: What have you learned about yourself as a writer and reader? What writing habits, reading strategies, exam techniques will serve you well in future English work and other subjects? (6) Celebration and closure: What went well? What achievement are you proud of? Complete an "Exam Learning Reflection" sheet capturing all analysis and identifying personal growth areas.',
      duration: '40 mins',
      steps: [
        'Distribute marked exam papers and detailed feedback',
        'Students analyze each section using detailed mark scheme: section mark, band descriptor, what earned marks, what lost marks',
        'Pattern analysis: across creative writing, transactional writing, reading analysis, language analysis, what patterns emerge?',
        'Improvement comparison: if this was better than mock exam, what helped? If similar, what needs development?',
        'Confidence vs performance analysis: were you overconfident anywhere? Underconfident?',
        'Skill strength/weakness summary: what are your clear strengths? Clear development areas?',
        'Future application thinking: what have you learned about yourself? What habits/strategies will help future learning?',
        'Celebration: what achievement are you proud of? What went well?',
        'Complete "Exam Learning Reflection" sheet with analysis, patterns, future plans',
      ],
      differentiation: {
        support:
          'Provide guided reflection prompts: "In my creative writing, the strongest part was ___ because ___. I could improve by ___." Offer one-on-one support reviewing feedback. Celebrate specific improvements (e.g., "Your transactional register is much more consistent than in mock exam"). Focus on effort and growth, not just marks.',
        stretch:
          'Analyse mark scheme in depth to understand exact grading criteria for each band. Develop detailed improvement plan for next assessment or exam. Reflect on metacognitive learning (what you learned about how you learn best). Set ambitious future targets.',
      },
    },
    plenary: {
      description:
        "Learning & Growth Affirmation: Students share (optionally): (1) One thing they did well and are proud of, (2) One thing they'll do differently next time based on this exam experience. Whole-class discussion: Celebrate diverse achievements. Reinforce that exams are learning opportunities. Growth happens through effort and reflection, not just marks. End with clear message: You've done the exam. You've learned from it. You're ready for whatever comes next.",
      duration: '10 mins',
    },
    homework:
    ...
    resourcesNeeded: [
      'Marked exam papers and detailed feedback',
      'Performance reaction sheet',
      'Exam section analysis template (mark breakdown, band descriptor analysis)',
      'Pattern analysis worksheet',
      'Improvement comparison sheet',
      'Exam Learning Reflection template',
      'Learning & Growth Affirmation prompt sheet',
      'Next Steps planning template',
    ],
    assessmentOpportunities: [
      'Performance analysis against mark scheme (self-assessment)',
      'Pattern identification across task types',
      'Improvement reflection',
      'Confidence vs actual performance analysis',
      'Learning reflection (metacognitive assessment)',
      'Growth affirmation sharing',
      'Post-exam reflection letter (summative reflection)',
    ],
    keyVocabulary: [
      'reflection',
