...
const lesson1: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a timeline with key dates and a glossary defining Elizabethan (1558-1603) and Jacobean (1603-1625).',
      core: 'Students sort independently, then justify two of their choices in writing using full sentences.',
      stretch:
        'Students predict how each social fact might influence the content or themes of a Shakespeare play.',
    },
    resources: [
      'Statement cards (x12)',
      'Sorting grid worksheet',
      'Key dates timeline (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students rank the four areas by significance to Shakespeare's writing, justifying their top choice in a paragraph.",
      },
      resources: [
        'Information sheets (x4)',
        'A3 poster paper',
        'Poster template (support tier)',
        'Timer',
      ],
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students identify an alternative match for two of the pairs and argue which connection is stronger.',
      },
      resources: [
        'Context-to-Text matching cards (x16)',
        'Connection recording sheet',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Sentence starter provided: "Understanding the society Shakespeare wrote in is important because..."',
      core: 'Full written response expected, referencing at least one specific contextual detail.',
      stretch:
        'Students explain why a modern audience might miss meaning without contextual knowledge, using a specific example.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        "Why is it important for GCSE students to understand the historical context of Shakespeare's plays?",
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        "How might the Protestant Reformation have influenced the themes of Shakespeare's plays?",
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        "Explain how the social hierarchy of Shakespeare's time is reflected in the structure of his plays.",
      lines: 5,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a comparison table with prompts: lighting, sound, costumes, audience, stage.',
      core: 'Students generate their own comparison points and write two sentences summarising the biggest difference.',
      stretch:
        'Students hypothesise how the lack of technology made Shakespeare a better writer, with specific reasoning.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a word bank and pre-labelled diagram with three features missing for students to complete.',
        core: 'Students label all features independently and write function notes for each.',
        stretch:
          'Students explain how two features worked together in a specific play (e.g., the balcony and thrust stage in Romeo and Juliet).',
      },
      resources: [
        'Globe Theatre diagram (A4)',
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students argue whether the Globe's limitations ultimately made Shakespeare's plays better than modern productions, using evidence from the extracts.",
      },
      resources: [
        'Extract handout (x3 passages)',
        'Annotation guide',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a director\'s notes template with prompts: "The actor should stand... because..." / "I would use the trapdoor to..."',
      core: "Students write three independent director's notes with clear justification.",
      stretch:
        'Students explain what would be lost if their scene were performed in a modern proscenium theatre instead.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "Describe three key features of the Globe Theatre and explain how each influenced Shakespeare's writing.",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Why does the Chorus in Henry V ask the audience to use their imagination? What does this tell us about the Globe?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Explain why understanding the Globe Theatre helps students achieve higher marks in their GCSE Shakespeare exam.',
      lines: 5,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide three additional lines with stresses pre-marked for practice before independent work.',
      core: 'Students clap the rhythm and then try to mark stresses on a new unmarked line independently.',
      stretch:
        'Students explain why the heartbeat analogy is significant - verse is alive, natural, ordered - and predict when Shakespeare might break this pattern.',
    },
    resources: [
      'Rhythm audio or clapping guide',
      'Displayed line with stress markings',
      'Practice lines worksheet',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students challenge the "rule" by finding an exception (e.g., Shylock\'s powerful prose in The Merchant of Venice) and explaining why Shakespeare broke the convention.',
      },
      resources: [
        'Paired extracts handout (x4 pairs)',
        'Verse/prose decision flowchart (support tier)',
        'Explanation recording sheet',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide the type of disruption for each extract; students focus only on explaining the effect.',
        core: 'Students identify the disruption type and write analytical sentences for all six extracts.',
        stretch:
          'Students write a full paragraph comparing two disruptions and arguing which is more dramatically effective.',
      },
      resources: [
        'Six annotated extract cards',
        'Scanning guide sheet',
        'Analytical sentence frame',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students explain a scenario where the "wrong" choice (e.g., a king in prose) would be dramatically more powerful and why.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Explain why Shakespeare uses both verse and prose in his plays. What does each form typically signify?',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'What is a "shared line" in Shakespeare\'s verse and what dramatic effect does it create?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Analyse the dramatic effect of the line "Never, never, never, never, never" from King Lear.',
      lines: 5,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a definition card distinguishing soliloquy, aside, and monologue with simple examples.',
      core: 'Students write their own definitions after the demonstration, then compare with the textbook definition.',
      stretch:
        'Students discuss why soliloquies create a unique relationship between character and audience - the concept of "audience complicity."',
    },
    resources: [
      'Thought bubble cards',
      'Role-play scenario script',
      'Definition cards (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a modern English translation alongside the original and a partially completed analysis grid.',
        core: 'Students complete all four analysis tasks independently and prepare a two-minute group presentation.',
        stretch:
          "Students compare their soliloquy's function with another group's and write a paragraph on how Shakespeare uses soliloquies differently depending on genre (tragedy vs comedy).",
      },
      resources: [
        'Glossed soliloquy handouts (x4)',
        'Analysis grid',
        'Modern English translations (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          "Provide a three-column table (audience knows / character doesn't know / effect) with the first example completed.",
        core: 'Students complete all three examples independently using full sentences.',
        stretch:
          'Students explain how dramatic irony functions differently in comedy (Twelfth Night) vs tragedy (Othello) and why Shakespeare uses it for different purposes.',
      },
      resources: [
        'Dramatic irony scenario cards (x3)',
        'Three-column table worksheet',
        'Completed example (support tier)',
      ],
    },
  ],
  plenaryActivity: {
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Explain how dramatic irony creates tension in a Shakespeare tragedy. Use a specific example.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Why are soliloquies and dramatic irony particularly important techniques for GCSE students to analyse?',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide three of the positions pre-placed and a brief explanation of the concept before sorting.',
      core: 'Students sort independently and then compare with the actual chain, noting any differences.',
      stretch:
        'Students identify which modern beliefs still echo the Chain of Being and which have been rejected, explaining why.',
    },
    resources: [
      'Hierarchy cards (x10)',
      'Great Chain of Being diagram',
      'Explanation card (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the cause-and-effect chart partially completed with the first two examples filled in.',
        core: 'Students complete all five examples independently and write the summary paragraph.',
        stretch:
          'Students argue whether Shakespeare genuinely believed in the Chain or used it as a convenient dramatic framework, supporting their view with evidence.',
      },
      resources: [
        'Five disruption scenario cards',
        'Cause-and-effect chart',
        'Summary paragraph frame (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a sentence frame: "In [play], the Chain is restored when... This shows that Shakespeare believed..."',
        core: 'Students write a comparative paragraph covering two plays without a frame.',
        stretch:
          "Students consider whether the restoration is always convincing - is Malcolm really a better king than Macbeth? Is the Prince's peace worth the deaths of Romeo and Juliet? - and write a critical evaluation.",
      },
      resources: [
        'Endings summary cards',
        'Sentence frame (support tier)',
        'Comparative paragraph model',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Sentence starter: "In [play], Shakespeare uses the Great Chain of Being to show his audience that..."',
      core: 'Full response required with a specific disruption and authorial intention.',
      stretch:
        'Students add a sentence explaining how a Jacobean audience would respond differently to a modern audience.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'What is the Great Chain of Being and why was it important to Elizabethan and Jacobean audiences?',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Do you think Shakespeare genuinely believed in the Great Chain of Being, or did he simply use it as a dramatic device? Explain your view.',
      lines: 6,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a simplified version of each rule with modern comparisons to aid understanding.',
      ...
      stretch:
        'Students consider how the fact that female roles were played by boys might have allowed Shakespeare to explore gender more radically.',
    },
    resources: [
      'Rules display slide',
      'Discussion prompts',
      'Simplified rules card (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide character profiles with key quotations already highlighted and a simplified spectrum with three positions only.',
        core: 'Students place and justify all six characters on the spectrum independently.',
        stretch:
          'Students identify how the same character might occupy different positions at different points in the play (e.g., Lady Macbeth begins challenging and ends conforming through madness and death).',
      },
      resources: [
        'Character profile cards (x6)',
        'Spectrum worksheet',
        'Simplified spectrum (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a glossed version of the speech and a colour-coding task: pink for feminine words, blue for masculine/violent words.',
        core: 'Students annotate independently and write the analytical paragraph using the focus question.',
        stretch:
          "Students consider whether Lady Macbeth's subsequent madness and death is Shakespeare punishing her for rejecting femininity, and what this says about his attitude to gender transgression.",
      },
      resources: [
        'Speech extract (glossed and unglossed versions)',
        'Annotation guide',
        'Colour-coding sheet (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide sentence starters: "Shakespeare was progressive because..." OR "Shakespeare was conservative because..."',
      core: 'Students write a balanced response acknowledging both sides.',
      stretch:
        'Students consider the anachronism problem: can we apply the term "feminist" to a 1600s writer, and what are the risks of doing so?',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'How does Shakespeare use Lady Macbeth to challenge and ultimately reinforce gender expectations?',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Why does Shakespeare use cross-dressing in plays like Twelfth Night and The Merchant of Venice?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Is it fair to describe Shakespeare as a "feminist" writer? Explain your reasoning.',
      lines: 6,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a word bank of leadership qualities and a simplified definition of the Divine Right of Kings.',
      core: 'Students generate their own list and write two sentences comparing modern and Jacobean ideals of leadership.',
      stretch:
        'Students consider why the idea of Divine Right would be politically useful for a monarch and potentially dangerous for a playwright.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide pre-written character summaries with key evidence highlighted and a simplified three-point rating scale.',
        core: 'Students rate and justify all five kings independently using full sentences.',
        stretch:
          'Students argue that Shakespeare deliberately avoids creating a perfect king to show that power always corrupts, using evidence from at least two plays.',
      },
      resources: [
        'King character cards (x5)',
        'Score card worksheet',
        'Simplified rating scale (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a paragraph frame with key vocabulary and sentence starters for each of the three examples.',
        core: 'Students write independently, referencing at least two of the three examples.',
        stretch:
          'Students evaluate whether Shakespeare was genuinely subversive or simply a skilled entertainer who knew how to flatter his patrons while appearing to challenge them.',
      },
      resources: [
        'Political context information sheet',
        'Paragraph frame (support tier)',
        'Elizabeth I quotation slide',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students argue that the continuum is too simplistic and explain why Shakespeare's presentation of kingship resists binary categories.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'What is the "Divine Right of Kings" and how does it affect Shakespeare\'s presentation of kingship?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'Compare Duncan and Macbeth as rulers. What does Shakespeare suggest about kingship through this contrast?',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Does Shakespeare present power as inherently corrupting? Use evidence from at least two plays to support your answer.',
      lines: 6,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students hypothesise how James I's personal beliefs about witchcraft might have influenced what Shakespeare chose to write about.",
    },
    resources: [
      'Facts display slide',
      'Surprise scale recording sheet',
      'Simplified explanations (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide casebook entries partially completed for the first two categories; students complete the remaining two.',
        core: 'Students complete all four casebook entries independently with specific textual evidence.',
        stretch:
          'Students identify which category Shakespeare uses most effectively and write a paragraph defending their choice.',
      },
      resources: [
        'Extract handouts (x4 categories)',
        'Casebook worksheet',
        'Partially completed casebook (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide the for/against table partially completed and a paragraph frame for the written response.',
        core: 'Students complete the table and write an independent paragraph taking a clear position.',
        stretch:
          'Students argue that Shakespeare deliberately keeps the answer ambiguous and explain why this ambiguity is more powerful than a definitive answer.',
      },
      resources: [
        'Dagger and ghost extracts',
        'For/against table',
        'Paragraph frame (support tier)',
      ],
    },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a sentence starter for verbal contributions: "I think the supernatural is real/imagined because..."',
      core: 'Students justify their position with specific textual evidence.',
      stretch:
        "Students explain how the ambiguity serves Shakespeare's broader thematic concerns about guilt, power, and moral order.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "Explain why James I's Daemonologie is important context for understanding the supernatural in Shakespeare.",
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        "Why does Shakespeare make the witches' prophecies in Macbeth ambiguous rather than straightforward?",
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        "How would a Jacobean audience's response to the supernatural in Shakespeare differ from a modern audience's response?",
      lines: 5,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a simple rule: "Comedies usually end in marriage; tragedies usually end in death." Students apply this rule.',
      core: 'Students sort independently and write a sentence explaining the patterns they notice.',
      stretch:
        'Students identify plays that blur the boundary between comedy and tragedy and explain why Shakespeare does this.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed table with key terms filled in; students add examples from specific plays.',
        core: 'Students complete the full table and add at least one specific play example per row.',
        stretch:
          'Students add a third column for "tragicomedy" or "problem play" (e.g., The Merchant of Venice, Measure for Measure) and explain why Shakespeare sometimes resists neat categorisation.',
      },
      resources: [
        'Genre comparison table worksheet',
        'Partially completed table (support tier)',
        'Key terms glossary',
      ],
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students compare how the opening of Macbeth and A Midsummer Night's Dream establish their respective genres through language, imagery, and atmosphere, writing a comparative paragraph.",
      },
      resources: [
        'Opening extracts handout (x3)',
        'Annotation guide',
        'Annotated examples (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a prompt: "In a comedy version of Macbeth, the murder scene would be..." to get students started.',
      core: 'Students generate their own genre-swapped scenarios and explain what would change.',
      stretch:
        'Students argue that Shakespeare already includes comedic elements in Macbeth (e.g., the Porter scene) and explain what purpose these serve within a tragedy.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Explain the concept of "hamartia" and discuss its importance to Shakespearean tragedy.',
      lines: 6,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a simplified version of the mark scheme with key words underlined and a "translation" into student-friendly language.',
      core: 'Students highlight independently and identify three key differences between levels.',
      stretch:
        'Students rewrite a Level 2 descriptor to make it Level 6, demonstrating understanding of progression.',
    },
    resources: [
      'Mark scheme display (Levels 2, 4, 6)',
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a PETAL scaffold with sentence starters for each element and a word bank of analytical verbs (suggests, implies, reveals, conveys).',
        core: 'Students write a full PETAL paragraph independently and peer-assess using the checklist.',
        stretch:
          'Students write two PETAL paragraphs offering different interpretations of the same extract, demonstrating the ability to consider alternative readings.',
      },
      resources: [
        'PETAL framework poster',
        'Model paragraph display',
        'Extract and question handout',
        'Peer assessment checklist',
        'PETAL scaffold (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a planning template with space for two paragraphs, each with PETAL prompts, and a reminder of key contextual points.',
        core: 'Students plan and write independently, aiming for three paragraphs with integrated context.',
        stretch:
          "Students include an evaluative opening or closing that considers Shakespeare's overall authorial intention or alternative interpretations.",
      },
      resources: [
        'Exam-style extract and question',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide a self-assessment checklist with specific prompts for each colour (e.g., "Did I embed a quotation? If yes = green, if I used a standalone quotation = amber, if no quotation = red").',
      core: 'Students self-assess independently and set a specific, actionable target.',
      stretch:
        "Students swap with a partner and compare self-assessments, offering additional feedback on one another's work.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'What are the four Assessment Objectives for the AQA GCSE Shakespeare question, and how many marks are they worth?',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Write a PETAL paragraph analysing how Shakespeare uses the word "blood" in Macbeth.',
      lines: 8,
      modelAnswer:
    ...
    {
      question:
        'Explain the difference between "bolted on" context and "integrated" context. Give an example of each.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Why is it important to discuss Shakespeare\'s "authorial intention" in a GCSE exam response?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'What are the most common mistakes students make in the Shakespeare exam, and how can they be avoided?',
      lines: 6,
      modelAnswer:
