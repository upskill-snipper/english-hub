...
const lesson1: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a simple diagram showing the three narrative layers (Walton → Victor → Creature) for students to annotate.',
      core: 'Students identify potential problems with each layer of narration in a short written response.',
      stretch:
        'Students consider why Shelley chose an epistolary form rather than a straightforward first-person narrative, linking to Romantic literary conventions.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide highlighted key quotations with guiding questions for each (e.g., "What does this word suggest about Walton\'s character?").',
        core: "Students annotate independently and write one PEE paragraph on Walton's ambition.",
        stretch:
          "Students compare Walton's language to that of real Romantic explorers or poets, considering Shelley's critique of Romantic idealism.",
      },
      resources: [
        "Walton's letters extract (Letters 1 and 4)",
        'Annotation guide',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed comparison table with sentence starters for the paragraph.',
        core: 'Students complete the table and write a full analytical paragraph independently.',
        stretch:
          "Students evaluate whether Walton's decision to turn back the ship represents genuine learning or mere cowardice, using textual evidence.",
      },
      resources: [
        'Comparison table worksheet',
        'Key quotations handout',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students link their answer to a specific effect on the reader, such as creating suspense or establishing a moral framework.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'What is a frame narrative and how does Shelley use this technique in Frankenstein?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'How does Shelley present Walton as a parallel to Victor Frankenstein? Use evidence from the letters.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "What does Walton's decision to turn the ship around suggest about his character and about the novel's message?",
      lines: 5,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a brief written summary of the Prometheus myth with key vocabulary defined.',
      core: 'Students explain the Prometheus connection verbally with reference to the concept of hubris.',
      stretch:
        'Students consider why Shelley chose the Prometheus myth specifically rather than other transgression myths such as Icarus or Faust.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide pre-selected quotations with colour-coded highlighting categories and guiding questions.',
        core: 'Students select and annotate their own quotations independently, writing brief analytical notes.',
        stretch:
          "Students link Victor's language to the Romantic concept of the sublime and consider how Shelley both draws on and critiques Romantic ideals of genius.",
      },
      resources: [
        'Chapter 4 extract handout',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed analysis table and a PEE frame with sentence starters.',
        core: 'Students complete the analysis table and write a PEE paragraph independently.',
        stretch:
          "Students evaluate whether Victor's horror at his creation reflects guilt, cowardice, or aesthetic revulsion, linking to Shelley's wider critique of superficial judgement.",
      },
      resources: [
        'Chapter 5 extract',
        'Analysis table worksheet',
        'PEE frame (support tier)',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students add a second sentence linking Shelley's warning to a modern scientific parallel.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "How does Shelley present Victor's obsession in Chapter 4? Use a quotation in your answer.",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'How might a reader in 1818 have responded differently to the creation scene compared to a modern reader?',
      lines: 5,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a simple definition card for tabula rasa with a visual analogy (blank whiteboard).',
      core: 'Students justify their position with a real-world or literary example.',
      stretch:
        "Students consider whether Shelley endorses or complicates the tabula rasa theory through the Creature's development.",
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a sensory imagery identification grid with examples already categorised; students add further examples.',
        core: 'Students annotate the extract independently and write analytical notes on three quotations.',
        stretch:
          "Students compare the Creature's awakening to Adam's awakening in Paradise Lost (a text the Creature later reads) and discuss Shelley's allusion.",
      },
      resources: [
        "Creature's awakening extract",
        'Sensory imagery grid',
        'Paradise Lost comparison extract (stretch)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a pre-structured timeline with events listed; students add the analysis columns.',
        core: 'Students create the timeline and write the paragraph independently.',
        stretch:
          "Students consider Shelley's possible commentary on the treatment of marginalised groups in Regency society, linking to Mary Wollstonecraft's ideas about social justice.",
      },
      resources: [
        'Timeline template',
        'Key quotations from rejection scenes',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students explain how Shelley manipulates reader sympathy through narrative perspective - we hear the Creature's version precisely because Victor has denied it a voice.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'How does Shelley present the Creature as innocent in its early experiences? Use evidence.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "Explain how the theme of rejection drives the Creature's development across the novel.",
      lines: 6,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a word bank of qualities (language, empathy, love, intelligence, morality) for students to discuss.',
      core: 'Students rank their qualities in order of importance and justify their top choice.',
      stretch:
        "Students consider the philosophical distinction between biological humanity and moral/intellectual humanity, linking to Shelley's challenge to her readers.",
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the two-column table with one example per column completed; students add further examples.',
        ...
        stretch:
          'Students link the Creature\'s education to Rousseau\'s idea of the "noble savage" and consider whether Shelley suggests the Creature was better off before it learned about human society.',
      },
      resources: [
        'De Lacey extracts',
        'Two-column table worksheet',
        'Rousseau context card (stretch)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide simplified summaries of each text with guiding questions and key quotations pre-selected.',
        core: 'Students work with the original summaries and select their own key quotations.',
        stretch:
          'Students write a paragraph comparing the Creature\'s identification with Satan ("I ought to be thy Adam, but I am rather the fallen angel") to Victor\'s own Promethean transgression.',
      },
      resources: [
        'Three-text summary cards',
        "Creature's responses extract",
        'Group work roles card',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students reflect on why Shelley positions this episode of sympathy-building immediately before the Creature's rejection and descent into violence.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'What does the Creature learn from observing the De Lacey family, and how does this affect it?',
      lines: 6,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a simple "responsibility pyramid" template with three tiers for students to rank the parties involved.',
      core: 'Students justify their position with reasoning and prepare to defend it.',
      stretch:
        'Students consider how concepts of moral and legal responsibility differ, and which framework Shelley is more interested in.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students consider the significance of William being a child - how does this affect the reader's sympathy and complicate their response to the Creature?",
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed "Justice Audit" table and a paragraph frame with sentence starters.',
        core: 'Students complete the audit and write a paragraph independently.',
        stretch:
          "Students link Justine's wrongful execution to Mary Wollstonecraft's writings on the vulnerability of women in patriarchal legal systems.",
      },
      resources: [
        "Justine's trial extracts",
        'Justice Audit table',
        'Paragraph frame (support tier)',
      ],
    },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Students explain their vote in one sentence using a provided frame: "I now think... is most responsible because..."',
      core: 'Students write two sentences explaining any shift in their view and what caused it.',
      stretch:
        "Students reflect on how Shelley's narrative structure (hearing the Creature's perspective) is designed to shift blame away from the Creature and towards Victor.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "How does Shelley present the Creature's murder of William? Is the Creature presented as purely evil?",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "Why does Victor remain silent during Justine's trial, and what does this reveal about his character?",
      lines: 5,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students consider whether "rights" only apply to beings created naturally, and how Shelley\'s novel anticipates modern debates about the rights of artificial beings.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the persuasive techniques table with categories pre-labelled and one example per category completed.',
        core: "Students complete the table independently and write a summary of the Creature's most effective strategy.",
        stretch:
          "Students compare the Creature's rhetorical skill to that of Satan in Paradise Lost and discuss how Shelley uses eloquence to unsettle the reader's assumptions about monstrosity.",
      },
      resources: [
        'Chapter 17 extract',
        'Persuasive techniques table',
        'Key quotation analysis card',
      ],
    },
    {
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students ask questions that connect to wider themes: responsibility, playing God, the ethics of creation.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'What is significant about the Creature\'s statement, "I am malicious because I am miserable"?',
      lines: 5,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide four quotation pairs with clear thematic links labelled (e.g., both about isolation).',
      core: 'Students match unlabelled quotations and identify the shared theme for each pair.',
      stretch:
        'Students consider why Shelley makes Victor and the Creature sound so similar - what is the authorial intention behind linguistic mirroring?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the comparison grid with quotations pre-selected; students write the analysis for each parallel.',
        core: 'Students select their own quotations and complete the analysis independently.',
        stretch:
          "Students argue whether the Creature can be read as a physical manifestation of Victor's repressed guilt and darker impulses, using psychoanalytic reading.",
      },
      resources: [
        'Comparison grid worksheet',
        'Key quotations bank',
        'Psychoanalytic reading guide (stretch)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a full paragraph frame with sentence starters and a word bank of analytical vocabulary.',
        core: 'Students write both paragraphs independently using the model opening as a guide.',
        stretch:
          "Students add a third paragraph evaluating the significance of the doubling for the reader's moral judgement - if Victor and the Creature are mirrors, can we condemn one without condemning the other?",
      },
      resources: [
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students explain how their chosen word connects to a specific Gothic convention or Romantic idea.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'What is a doppelganger and how does this concept apply to Victor and the Creature?',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        "How does the doubling of Victor and the Creature affect the reader's moral judgement?",
      lines: 5,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students identify one convention Shelley subverts (e.g., the "monster" is eloquent and sympathetic) and explain the effect of this subversion.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the analysis table with one extract completed as a model; students complete the other two.',
        core: 'Students complete the table independently for all three extracts.',
        stretch:
          "Students compare Shelley's use of the sublime to that of other Romantic writers (Wordsworth, Byron) and consider whether Shelley celebrates or critiques the Romantic relationship with nature.",
      },
      resources: [
        'Three landscape extracts',
        'Sublime analysis table',
        'Edmund Burke context card',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide a list of chapter references for each convention so students know where to look.',
        core: 'Students locate examples independently and write a PEE paragraph.',
        stretch:
          'Students evaluate whether Frankenstein is better described as a Gothic novel, a Romantic novel, or a science fiction novel, and justify their answer.',
      },
      resources: [
        'Gothic Convention Hunt worksheet',
        'Novel or extract booklet',
        'PEE frame (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Groups explain not just what makes the scene Gothic, but how Shelley subverts reader expectations within it.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Identify three Gothic conventions Shelley uses in Frankenstein and explain their effect.',
      lines: 6,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a simple table with the three examples and columns for "benefit" and "danger" pre-structured.',
      core: 'Students complete the table and formulate a position on the responsibility question.',
      stretch:
        "Students consider how the ethical frameworks of 1818 (religious morality, natural philosophy) differ from modern scientific ethics and how this shapes Shelley's critique.",
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the Responsibility Audit with key moments identified; students find quotations and write analysis.',
        core: 'Students complete the audit independently and write a full analytical paragraph.',
        stretch:
          "Students compare Victor's approach to creation with the responsibilities of a parent, arguing that Shelley critiques not just bad science but bad parenting.",
      },
      resources: [
        'Responsibility Audit worksheet',
        'Key quotations bank',
        'Paragraph frame (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Provide argument cards with pre-written points and quotations for each side; students select and present.',
        core: 'Students develop their own arguments with textual evidence and present them.',
        stretch:
          'Students consider a third position: Shelley critiques not science but the Romantic/Enlightenment culture that glorifies individual genius at the expense of communal responsibility.',
      },
      resources: [
        'Debate preparation sheet',
        'Argument cards (support tier)',
        'Quotation evidence bank',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Provide three modern examples to choose from (AI, genetic engineering, nuclear weapons).',
      core: 'Students choose their own example and write a justified response.',
      stretch:
        "Students explain specifically which aspect of Shelley's critique (abandonment, lack of foresight, playing God) is most relevant to their chosen example.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        "How does the historical context of Galvanism and the Enlightenment shape the novel's treatment of science?",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Is Frankenstein a warning against science itself, or against irresponsible science? Argue your view.',
      lines: 6,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a colour-coded annotation key: green for command words, blue for AO2 focus, red for AO3 opportunities.',
      core: 'Students annotate the question independently and identify the AOs they need to address.',
      stretch:
        'Students plan a brief response structure (four or five topic sentences) before moving to the main activity.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a paragraph-by-paragraph planning frame with sentence starters for the introduction and first body paragraph.',
        core: 'Students write independently with access to the planning template but no sentence starters.',
        stretch:
          'Students aim for five or six analytical paragraphs that integrate extract and wider novel analysis seamlessly rather than treating them as separate sections.',
      },
      resources: [
        'Extract handout (De Lacey rejection)',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a simplified assessment grid with three criteria and clear examples of each level.',
        core: 'Students use the full assessment criteria grid and write detailed WWW/EBI comments.',
        stretch:
          "Students rewrite their weakest paragraph from scratch, incorporating their partner's feedback and aiming for the top band of the mark scheme.",
      },
      resources: [
        'Assessment criteria grid',
        'Coloured highlighters',
        'Improvement paragraph template',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students write a tip specifically targeting the highest mark band (e.g., "use tentative language - \'Shelley perhaps suggests\' - to show critical thinking").',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "How does Shelley use the Creature's language in this extract to generate sympathy?",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Analyse how Shelley presents the De Lacey rejection scene as a turning point in the novel.',
      lines: 6,
      modelAnswer:
