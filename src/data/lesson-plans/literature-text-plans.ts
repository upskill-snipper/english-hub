...
const macbethLesson1: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '8 minutes',
    instructions:
      'Display 8 true/false statements about Jacobean England (Divine Right of Kings, witchcraft beliefs, gender roles). Students use mini-whiteboards. Discuss why these beliefs matter to understanding a play about regicide written in 1606.',
  ...
  mainActivity: {
    ...
    duration: '42 minutes',
    instructions:
      'Station 1: King James I & Gunpowder Plot. Station 2: Divine Right & Great Chain of Being. Station 3: Witchcraft & Supernatural. Station 4: Gender & Power. Students rotate every 4 minutes completing a note-taking grid. Then complete a theme-tracking table identifying ambition, guilt, supernatural, and kingship across all five acts with key events and characters.',
    differentiation: {
      ...
      stretch:
        "Add evaluation of which contextual factor most influences Shakespeare's presentation of themes.",
    },
    resources: [
      'Station information cards (4)',
      'Note-taking grid',
  ...
  plenary: {
    ...
    duration: '5 minutes',
    instructions:
      'Students write: "Explain one way Jacobean context is important to understanding Macbeth." Collect to assess prior understanding.',
    differentiation: {
  ...
  homework:
    "Research King James I's relationship with Shakespeare and write one paragraph on how it influenced Macbeth.",
  resourcesNeeded: [
    'Jacobean context slides',
    'Station cards',
    'Note-taking grids',
    'Theme table worksheet',
  ],
  assessmentOpportunities: [
    'Exit ticket responses',
    'Theme-tracking accuracy',
  ...
  sendAdaptations:
    'Provide audio recording of context information. Simplify vocabulary list. Offer pre-written theme examples for completion.',
}
...
const macbethLesson2: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '7 minutes',
    instructions:
      'Students position themselves on a line: "Ambition is always a positive quality" (Agree to Disagree). Three students justify their position. Link to concept of hamartia (tragic flaw) and Jacobean beliefs about dangerous ambition.',
  ...
  plenary: {
    ...
    duration: '6 minutes',
    instructions:
      'Debate: "The witches control Macbeth; he is not responsible for his actions." Half class agrees, half disagrees. Each side presents one textual argument. Discuss why Shakespeare leaves this ambiguous.',
    differentiation: {
  ...
  homework:
    'Memorise "I have no spur to prick the sides of my intent, but only vaulting ambition" (Act 1.7) and write three sentences explaining the metaphor and what it reveals about Macbeth.',
  resourcesNeeded: [
    'Act 1 Scene 3 extract (printed)',
    'Modern translation',
    'PEE frame',
    'Key quotation slides',
  ],
  assessmentOpportunities: [
    'PEE paragraph quality',
    'Annotation precision',
    'Debate argumentation',
    'Homework quotation understanding',
  ],
  keyVocabulary: [
    'soliloquy',
    'aside',
  ...
  sendAdaptations:
    "Provide simplified extract. Audio recording of scene. Visual diagram showing Macbeth's emotional journey. Simplified PEE template.",
}
...
const macbethLesson3: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Quick brainstorm: "How do we show guilt in real life?" (body language, avoidance, aggression, obsession). Then show image of Macbeth\'s dagger. Discuss: how might a character show psychological guilt in a play?',
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Evaluate how Macbeth's guilt responses differ between Acts 2 and 3, showing progression of psychological breakdown.",
    },
    resources: [
      'Act 2.1 dagger extract',
      'Act 3.4 ghost extract',
      'Comparison grid',
      'Paragraph frame',
      'Annotation guide',
    ],
  ...
  plenary: {
    ...
    duration: '5 minutes',
    instructions:
      'Without naming the emotion "guilt," students identify how the text shows it (language, behaviour, imagery). List responses. Highlight: Shakespeare never directly states emotions; he shows them through language choices.',
    differentiation: {
  ...
  homework:
    "Write a detailed analysis of one quotation from the dagger soliloquy showing how language conveys Macbeth's mental state. (Aim for 8-10 sentences.)",
  resourcesNeeded: [
    'Dagger soliloquy extract',
    'Ghost scene extract',
    'Comparison grid',
    'Analysis frame',
  ],
  assessmentOpportunities: [
    'Annotation quality',
    'Paragraph analysis',
    'Understanding of psychological imagery',
    'Quotation selection',
  ],
  keyVocabulary: [
    'soliloquy',
  ...
  sendAdaptations:
    "Simplified extracts with key phrases highlighted. Visual timeline of Macbeth's guilt. Audio recording. Structured paragraph template with sentence starters.",
}
...
const macbethLesson4: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Define manipulation. Show short clip of Lady Macbeth\'s "unsex me here" speech (film version if available). Students discuss: how is Lady Macbeth powerful despite being a woman in Jacobean society?',
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Evaluate Shakespeare's presentation of gender and power: is Lady Macbeth punished for exceeding traditional female roles?",
    },
    resources: [
      'Act 1.7 extract',
      'Act 2.2 extract',
      'Act 5.1 sleepwalking extract',
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      "Display the quotation from Act 2.2. Discuss: Why is it ironic that Lady Macbeth says this? What does Act 5.1's obsessive hand-washing tell us about the truth of guilt? Link to broader theme.",
    differentiation: {
  ...
  homework:
    'Write a full analytical essay (300-400 words): "Analyse how Shakespeare presents Lady Macbeth\'s power and its ultimate destruction."',
  resourcesNeeded: [
    'Key extracts (4)',
    'Character arc template',
    'Essay frame',
  ...
  sendAdaptations:
    "Heavily annotated extracts. Pre-filled character arc. Essay template with section headings and sentence starters. Visual summary of Lady Macbeth's journey.",
}
...
const macbethLesson5: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '7 minutes',
    instructions:
      'Play a quick game: "All in this room are safe from slings and arrows." (True but misleading - they\'re protected by walls/roof, not morally.) Link to witches\' equivocations. Discuss: how can something be "true" but still deceptive?',
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Debate the extent of Macbeth's agency vs the witches' control using textual evidence.",
    },
    resources: [
      'Act 4.1 prophecies extract',
      'Act 5.6-7 battle extract',
      'Prophecy table template',
      'Paragraph frame',
    ],
  },
  plenary: {
    ...
    duration: '5 minutes',
    instructions:
      "Briefly read Malcolm's final speech. Discuss: how does the restoration of order mirror the Great Chain of Being concept from Lesson 1? Link Shakespeare's ending to Jacobean beliefs about moral order.",
    differentiation: {
  ...
  homework:
    'Revise all five lessons. Write a practice exam paragraph: "How does Shakespeare present the consequences of ambition in Macbeth?"',
  resourcesNeeded: [
    'Act 4.1 extract',
    'Act 5.6-7 extract',
    'Prophecy table',
    "Malcolm's final speech",
  ],
  assessmentOpportunities: [
    'Understanding of equivocation',
    'Prophecy tracking',
    'Analytical paragraph quality',
    'Exam-style writing',
  ],
  keyVocabulary: [
    'equivocation',
  ...
  sendAdaptations:
    'Simplified prophecy table. Pre-highlighted key phrases in extracts. Completed examples of prophecy interpretations. Exam paragraph template.',
}
...
const macbethLesson6: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Display three exam questions. Highlight command words: "How does Shakespeare present...", "Analyse the effect of...", "Compare...". Discuss what each word demands. Remind students: analyse means explain the effect of language choices, not just identify them.',
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Provide two extract questions; students choose the stronger analysis to explain why.',
    },
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Students use mark scheme to self-assess their extract response. Identify one strength and one area for improvement. Write one sentence: "To improve my next response, I will..."',
    differentiation: {
  ...
  homework:
    'Complete the essay plan from the plenary into a full 40-minute answer (500-600 words).',
  resourcesNeeded: [
    'Unseen extract',
    'Essay title',
    'Model answer',
  ...
  sendAdaptations:
    'Simplified mark scheme. Model answer with annotations showing AO2 analysis. Extended time for timed activity (50 minutes instead of 30). Essay planning scaffold with checklist.',
}
...
const christmasCarolLesson1: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '7 minutes',
    instructions:
      'Show images of Victorian London: wealthy mansion and workhouse. Discuss: who bears responsibility for poverty - the individual or society? This debate drives the entire novella.',
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Add column evaluating how effective each spirit is in changing Scrooge's perspective.",
    },
    resources: [
      'Five-stave diagram',
      'Stave summaries',
      'Structure table',
      'Context slides on Victorian poverty',
    ],
  },
  plenary: {
    ...
    duration: '5 minutes',
    instructions:
      'Conclude: "A Christmas Carol is a ghost story, but Dickens\' real message is social and moral." Discuss: what is he arguing about human responsibility? Why publish this as a novella rather than a sermon?',
    differentiation: {
      support: 'Provide sentence starter: "Dickens wants readers to understand that..."',
      core: 'Full response linking story to message.',
      stretch:
        'Consider whether ghost story is an effective method for delivering social critique.',
    },
  },
  homework:
    "Research one fact about Victorian workhouses or poverty and write 3-4 sentences on how it contextualises Dickens' critique.",
  resourcesNeeded: [
    'Five-stave diagram',
    'Stave summaries',
    'Structure table',
    'Victorian context images',
  ],
  assessmentOpportunities: [
  ...
  sendAdaptations:
    'Heavily illustrated five-stave diagram with images. Pre-completed stave table. Audio summary of each stave. Visual timeline with key events marked.',
}
...
const christmasCarolLesson2: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Display key opening quotations (e.g., "Hard as flint", "tight-fisted hand", "counting house"). Students use one word to describe Scrooge. Build word cloud on board. Discuss: does Dickens want us to sympathise with or condemn Scrooge?',
  ...
  plenary: {
    ...
    duration: '3 minutes',
    instructions:
      "Display Scrooge's response to the charity collectors. Discuss: why does Dickens make Scrooge's words so cold and harsh? What is the historical context? (Workhouses did exist, Poor Laws were harsh.)",
    differentiation: {
  ...
  homework:
    'Analyse the phrase "hard as flint, cold as ice". Explain what Dickens suggests through this metaphor and how it links to his social message.',
  resourcesNeeded: [
    'Stave 1 extract',
    'Character profile template',
    'Key quotations slide',
    'Paragraph frame',
  ],
  assessmentOpportunities: [
    'Annotation accuracy',
  ...
  sendAdaptations:
    "Heavily annotated extract. Simplified character profile. Visual representation of Scrooge's coldness (colour palette). Pre-filled paragraph with gaps to complete.",
}
...
const christmasCarolLesson3: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Quick brainstorm: students list elements of a happy Christmas (family, warmth, laughter, simple pleasures). Show image of Cratchit household. Discuss: notice the contrast - the Cratchits are poor but happy. What does this suggest?',
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Analyse Dickens' use of sentimentality - is the Cratchit portrayal effective or manipulative?",
    },
    resources: [
      'Stave 2 past extract',
      'Stave 3 present extract',
  ...
  plenary: {
    ...
    duration: '2 minutes',
    instructions:
      "Briefly read Scrooge's question about Tiny Tim in Stave 3 and his visible distress. Discuss: when does Scrooge's change truly begin?",
    differentiation: {
  ...
  homework:
    'Write a detailed comparison (300 words): "Compare the presentation of Scrooge\'s home and the Cratchit home. What does each suggest about the characters who live there?"',
  resourcesNeeded: [
    'Stave 2 extract',
    'Stave 3 extract',
    'Venn diagram',
    'Cratchit home description',
    'Paragraph frame',
  ],
  assessmentOpportunities: [
    'Understanding of past/present narrative',
    'Comparative analysis',
    'Interpretation of moral contrast',
    'Essay writing',
  ],
  keyVocabulary: [
    'redemption',
  ...
  sendAdaptations:
    'Heavily illustrated Staves 2 and 3 with character images. Pre-annotated extracts. Completed Venn diagram example. Essay template with structure guidance.',
}
...
const christmasCarolLesson4: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Discuss: "Who fears death? Why?" Then reveal: Stave 4 is about Scrooge\'s future death and what happens after. The Ghost is silent and terrifying. Why would Dickens make this spirit different from the first two?',
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Brief transition to Stave 5. Scrooge wakes on Christmas morning and learns the night was only hours long, not years. Discuss: why does Dickens make it so short? What is the message?',
    differentiation: {
  ...
  homework:
    "Analyse one symbolic object from Stave 4 (e.g., bed curtains, wedding ring, Scrooge's grave). Write 3-4 sentences on what it symbolises and why Dickens includes it.",
  resourcesNeeded: ['Stave 4 extract', 'Fear table', 'Paragraph frame', 'Symbol analysis guide'],
  assessmentOpportunities: [
    'Understanding of silent spirit',
    'Symbolic analysis',
    'Paragraph quality',
  ...
  sendAdaptations:
    'Heavily annotated extract with emotional tone marked. Fear table completed as example. Visual timeline showing the one-night redemption arc. Symbol analysis scaffold.',
}
...
const christmasCarolLesson5: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Discuss: can a greedy, isolated man completely change overnight? Why or why not? This is key to evaluating Dickens' argument about human capacity for redemption.",
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Return to opening - Scrooge\'s coldness and Dickens\' social critique. Conclude: "A Christmas Carol is both a moral argument for individual compassion AND a critique of systemic indifference." Discuss whether both messages work together or create tension.',
    differentiation: {
  ...
  homework:
    'Write a practice exam question (40 min): "How does Dickens present redemption and transformation in A Christmas Carol?" Include analysis of Scrooge\'s journey.',
  resourcesNeeded: [
    'Stave 5 extract',
    'Character comparison template',
    'Paragraph frame',
    'Exam question',
  ],
  assessmentOpportunities: [
  ...
  sendAdaptations:
    "Heavily illustrated Stave 5 with Scrooge's actions depicted. Pre-filled character comparison example. Exam essay template with structure headings.",
}
...
const christmasCarolLesson6: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Display five key themes: Redemption, Charity, Family, Isolation, Social Responsibility. Students place each on a spectrum from "barely present" to "central". Discuss: which theme is most important to Dickens?',
  ...
  plenary: {
    ...
    duration: '3 minutes',
    instructions:
      'Students use mark scheme to assess their extract response. Identify one AO2 analysis strength and one area to develop before the full exam.',
    differentiation: {
  ...
  homework:
    'Complete the essay plan from the lesson into a full 40-minute response (500-600 words).',
  resourcesNeeded: [
    'Methods reference sheet',
    'Extract exam question',
    'Essay exam question',
    'Model answers',
    'Mark scheme',
    'Plan template',
  ...
  sendAdaptations:
    'Pre-completed methods table with colour coding. Simplified extract response. Model answers with annotations. Extended time for timed work.',
}
...
const inspectorLesson1: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '7 minutes',
    instructions:
      "Display the title. Ask: what is an inspector's job? Then reveal: the play is set in 1912 but written in 1945. What historical events happened between these dates? How might this affect Priestley's message?",
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclusion: "This play is not primarily a detective mystery. It\'s a moral argument about social responsibility and collective guilt." Each character shares blame for Eva Smith\'s death. Discuss: why does Priestley make the guilt collective rather than individual?',
    differentiation: {
  ...
  homework:
    "Research 1912 and 1945 - what major events happened? Write 4-5 sentences on how the gap between these dates shapes the play's meaning.",
  resourcesNeeded: [
    'Timeline 1912-1945',
    'Character table',
    'Context slides',
  ...
  sendAdaptations:
    'Illustrated timeline with key events. Pre-completed character table. Visual diagram of Birling family relationships. Simplified context summary.',
}
...
const inspectorLesson2: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Show opening stage directions describing the Birling home as "substantial and comfortable". Then display Mr Birling\'s first lines celebrating a prosperous business deal. Ask: what is Priestley establishing about the family?',
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      "Highlight Sheila's reaction when the Inspector shows the photograph. She recognises Eva from Millwards department store. Discuss: why is Sheila's growing sympathy important to Priestley's argument about moral responsibility?",
    differentiation: {
  ...
  homework:
    'Analyse Mr Birling\'s speech beginning "A man has to mind his own business". Explain what Priestley suggests about this philosophy through context and dramatic irony.',
  resourcesNeeded: [
    'Act 1 extract',
    'Dramatic irony table',
    'Key quotation slide',
    'Paragraph frame',
  ],
  assessmentOpportunities: [
    'Understanding of dramatic irony',
    'Character analysis',
    'Paragraph quality',
  ...
  sendAdaptations:
    "Heavily annotated extract with dramatic irony marked. Pre-completed irony table example. Visual comparison of Birling's predictions vs reality. Simplified paragraph frame.",
}
...
const inspectorLesson3: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Establish: Mr Birling fired Eva for asking for higher wages. Now the Inspector will reveal how others harmed her. Discuss: if multiple people cause someone's death, is everyone equally guilty?",
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Evaluate whether Gerald's affair or the parents' dismissal is more morally culpable.",
    },
  ...
  plenary: {
    ...
    duration: '3 minutes',
    instructions:
      'Sheila realises: "We\'re all partly responsible" for Eva\'s fate. Her parents refuse to accept this. Discuss: why does Priestley make the younger generation more morally aware?',
    differentiation: {
      support: 'Quote the line and explain collective responsibility.',
      core: 'Discuss generational difference in moral awareness.',
      stretch:
        'Evaluate whether the play suggests optimism about social change through younger generations.',
    },
  },
  homework:
    'Write a comparison (300 words): "Compare how Sheila and her parents respond differently to the revelation of their actions. What does this suggest about moral responsibility?"',
  resourcesNeeded: [
    'Act 2 extract',
    'Guilt response table',
    'Comparison frame',
    'Key quotations slide',
  ],
  assessmentOpportunities: [
    ...
    'Comparative essay',
    'Moral awareness identification',
  ],
  keyVocabulary: [
    'complicity',
    'collective guilt',
  ...
  sendAdaptations:
    'Heavily annotated extract. Pre-filled guilt response table example. Comparison essay template with section headings. Character response visual.',
}
...
const inspectorLesson4: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "By Act 2/3, most characters have confessed. Mr Birling, Mrs Birling, and Eric remain. Ask: what might each character's reaction reveal about their values and moral capacity?",
  ...
  plenary: {
    ...
    duration: '5 minutes',
    instructions:
      'By the end, Eric and Sheila are united against their parents. The family is morally split. Discuss: what is Priestley suggesting about the impossibility of maintaining moral blindness in the face of truth?',
    differentiation: {
      support: 'Explain the family division.',
      core: 'Discuss moral implications.',
      stretch:
        'Consider whether Priestley offers hope for social change through the younger generation.',
    },
  },
  homework:
    "Analyse Mrs Birling's character. Write 4-5 sentences on whether she is presented as evil or as a tragic product of her class and ideology.",
  resourcesNeeded: [
    'Mrs Birling extract',
    'Eric extract',
    'Character contrast table',
  ...
  sendAdaptations:
    'Heavily annotated extracts. Pre-filled character contrast. Simplified moral interpretation. Audio recording of emotional scenes.',
}
...
const inspectorLesson5: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '7 minutes',
    instructions:
      'As Act 3 concludes, a phone call reveals no girl has actually died at the hospital. The "Inspector" may not be a real police officer. Ask: what does this revelation change about the play? Does it matter if he\'s "real"?',
  ...
  plenary: {
    ...
    duration: '3 minutes',
    instructions:
      'Conclude: "The play\'s mystery is not who the Inspector is. It\'s whether people will learn from moral judgment." Priestley suggests society must choose: accept collective responsibility or continue in selfish isolation.',
    differentiation: {
  ...
  homework:
    "Memorise and analyse the Inspector's final speech. Write 5-6 sentences explaining what Priestley argues about human responsibility and social connection.",
  resourcesNeeded: ['Act 3 ending extract', 'Final speech', 'Function diagram', 'Analysis frame'],
  assessmentOpportunities: [
    'Understanding of symbolism',
    'Dramatic twist analysis',
    'Moral message comprehension',
    'Quotation analysis',
  ],
  keyVocabulary: [
    'symbolic',
  ...
  sendAdaptations:
    "Highlighted final speech. Annotated extract. Visual diagram of Inspector's function. Simplified analysis frame with sentence starters.",
}
...
const inspectorLesson6: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Recall: three acts, one evening, one room. Priestley reveals guilt progressively. Why is this structure so effective for his moral argument?',
  ...
  plenary: {
    ...
    duration: '2 minutes',
    instructions:
      "Remind students: the play is not a mystery novel. Focus on Priestley's social argument. Link all analysis to the moral message about responsibility.",
    differentiation: {
  ...
  sendAdaptations:
    'Pre-completed techniques sheet. Simplified extract response frame. Model answers with annotations. Extended time for timed work.',
}
...
const jekyllHydeLesson1: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '7 minutes',
    instructions:
      'Ask students: do people have a "shadow self"? Darker impulses we hide? Stevenson explores this in 1886, reflecting Victorian anxieties about repression. Discuss: what is the cost of suppressing your true nature?',
    resources: ['Discussion prompt'],
  },
  mainActivity: {
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      "Conclude: Stevenson is not just writing a horror story. He's exploring Victorian anxieties about the divided self and the danger of moral repression. The novella asks: what happens when you deny your nature?",
    differentiation: {
  ...
  homework:
    "Research Victorian attitudes to science, morality, and respectability. Write 4-5 sentences on how these attitudes influenced Stevenson's novel.",
  resourcesNeeded: [
    'Victorian context slides',
    'Structure map',
    'Theme web',
    'Narrative techniques guide',
  ],
  assessmentOpportunities: [
    'Context understanding',
  ...
  sendAdaptations:
    'Illustrated Victorian London images. Pre-filled structure map. Visual theme web. Simplified context summary with key points.',
}
...
const jekyllHydeLesson2: LiteratureLesson = {
  ...
  mainActivity: {
    ...
    resources: [
      'Early chapters extract',
      'Annotation guide',
      'Observation/Suggestion table',
      'Paragraph frame',
    ],
  },
  plenary: {
    ...
    duration: '5 minutes',
    instructions:
      "Utterson's dreams and discomfort mount. He senses something deeply wrong. Discuss: what is Stevenson's purpose in withholding explanation? How does mystery serve his moral argument?",
    differentiation: {
  ...
  homework:
    "Analyse Stevenson's physical description of Hyde (select one passage, 3-5 lines). Explain what the language suggests about his nature and moral status.",
  resourcesNeeded: [
    'Early chapters extract',
    'Annotation guide',
    'Observation/Suggestion table',
...
const jekyllHydeLesson3: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Dr Jekyll is respectable, successful, intelligent. Why would he risk everything? Discuss: what do his reasons reveal about Victorian repression?',
    resources: ['Discussion prompt'],
  },
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Evaluate whether Jekyll is victim or villain - does Stevenson hold him responsible?',
    },
    resources: [
      "Jekyll's confession extract",
      'Annotation guide',
      'Paragraph frame',
      'Context on scientific ambition',
    ],
  },
  plenary: {
    ...
    duration: '3 minutes',
    instructions:
      "Stevenson's critique: science, if pursued without moral restraint, enables human corruption. The potion is not evil - Jekyll's use of it is. Discuss: is this fair?",
    differentiation: {
  ...
  homework:
    "Write a detailed analysis of one transformation passage from Jekyll's confession. Explain what the language reveals about his emotional state and Stevenson's view of the experiment.",
  ...
  sendAdaptations:
    'Heavily annotated confession extract. Simplified version of confession in modern English. Transformation passage with emotional tone marked. Paragraph frame with sentence starters.',
}
...
const jekyllHydeLesson4: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '7 minutes',
    instructions:
      "Three possible interpretations: (1) Hyde is genuinely evil, a separate being. (2) Hyde is Jekyll's repressed self - amoral, not evil. (3) Hyde is a victim of Jekyll's experiment. Students vote. Discuss: what does Stevenson's text suggest?",
  ...
  plenary: {
    ...
    duration: '3 minutes',
    instructions:
      "Conclude: Stevenson deliberately leaves this ambiguous. Is Hyde pure evil or merely Jekyll's unleashed appetites? The answer reveals your interpretation of human nature itself.",
    differentiation: {
  ...
  homework:
    'Write a comparative paragraph (200-250 words): "Compare how Stevenson presents Jekyll and Hyde. What does each character reveal about the other?"',
  resourcesNeeded: [
    'Hyde scenes extract',
    'Character profile template',
    'Comparison frame',
  ...
  sendAdaptations:
    'Illustrated character profile comparing Jekyll and Hyde. Annotated description passages. Simplified interpretation options. Comparison essay scaffold.',
}
...
const jekyllHydeLesson5: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'As the novella progresses, Jekyll transitions from wanting the transformation to dreading it. He begins transforming involuntarily. Ask: what has he lost?',
    resources: ['Discussion prompt'],
  },
  mainActivity: {
  ...
  plenary: {
    ...
    duration: '3 minutes',
    instructions:
      "Conclusion: Jekyll's tragedy is not Hyde's evil. It's Jekyll's belief that he could separate and deny part of himself. Stevenson argues: accept your whole nature, or pay the price.",
    differentiation: {
  ...
  sendAdaptations:
    "Heavily annotated final chapters. Visual timeline of Jekyll's agency with illustrations. Simplified moral lesson explanation. Analysis frame with sentence starters.",
}
...
const jekyllHydeLesson6: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '5 minutes',
    instructions:
      "Recall: we learn about Jekyll through Utterson's eyes first, then letters, then Jekyll's confession. Why does Stevenson structure the novella this way? Why not tell Jekyll's story directly?",
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Remind: Jekyll & Hyde is fundamentally about the divided self and the dangers of moral repression. Link all analysis to this central theme. Use specific terminology: duality, manifestation, repression, moral restraint.',
    differentiation: {
      support: 'Provide exam focus checklist.',
  ...
  sendAdaptations:
    'Pre-completed methods sheet. Simplified extract response frame. Model answers with annotations. Extended time for timed work.',
}
...
const romeoJulietLesson1: LiteratureLesson = {
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: this play explores whether love can overcome hatred, and at what cost. From the outset, we know the answer: it cannot, and the lovers will die.',
    differentiation: {
  ...
  homework:
    "Research Elizabethan concepts of courtly love and honour. Write 4-5 sentences on how these contexts shape the lovers' choices.",
  resourcesNeeded: [
    'Context slides',
    'Conflict chart',
    'Prologue text',
    'Feudal honour explanation',
  ],
  assessmentOpportunities: [
    'Context understanding',
    'Conflict identification',
    'Tragic structure comprehension',
  ],
  keyVocabulary: [
    'star-crossed',
    'courtly love',
  ...
  sendAdaptations:
    'Illustrated context slides with Elizabethan London images. Pre-filled conflict chart. Visual family tree of Montagues and Capulets. Simplified context summary.',
}
...
const romeoJulietLesson2: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Show the moment Romeo first sees Juliet at the ball. He forgets Rosaline instantly. Ask: is this romantic or problematic? What does it suggest about Romeo's nature?",
  ...
  mainActivity: {
    ...
    duration: '47 minutes',
    instructions:
      'Read Act 1.5 (Romeo at the ball) and Act 2.2 (balcony scene). Focus on: (1) Romeo\'s language - hyperbolic, poetic, comparing Juliet to light and divinity. Annotate for metaphor and imagery. (2) His recklessness - he ignores danger to be near her. (3) The balcony scene - both lovers speak poetry, but they are also deeply vulnerable. Juliet\'s "What\'s in a name?" speech questions the feud\'s logic. Create a poetry analysis table: "Language Device | Purpose | Effect". Students write analytical paragraph: "How does Shakespeare use language and imagery to present Romeo\'s love as both beautiful and dangerous?"',
    differentiation: {
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'The balcony scene is poetic and tender, but Shakespeare reminds us of danger: Romeo is trespassing, both families would condemn this union. Beauty and danger coexist. Discuss: does Shakespeare warn us?',
    differentiation: {
  ...
  homework:
    "Memorise and analyse one quotation from the balcony scene (Juliet's \"What's in a name?\" or Romeo's response). Write 5-6 sentences explaining what it reveals about their love and their understanding of the feud.",
  ...
  sendAdaptations:
    'Heavily annotated extracts with literary devices marked. Simplified poetry analysis table. Visual setting of balcony scene. Paragraph frame with sentence starters.',
}
...
const romeoJulietLesson3: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'In Act 3, the lovers have just married secretly. Then Tybalt challenges Romeo. A street fight erupts. Ask: what is the consequence of this one act of violence?',
  ...
  mainActivity: {
    ...
    resources: [
      'Act 3.1 brawl extract',
      'Act 3.2 Juliet response',
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'After Act 3.1, the lovers cannot escape their fate. The feud has claimed them. Shakespeare suggests that their love, while beautiful, cannot survive in a world of violence and hatred.',
    differentiation: {
  ...
  homework:
    "Write a detailed analysis of Romeo's response to killing Tybalt. Explain what his language and actions reveal about his character and his tragic flaw.",
  resourcesNeeded: [
    'Act 3.1 extract',
    'Act 3.2 extract',
    'Before/After diagram',
  ...
  assessmentOpportunities: [
    'Understanding of turning point',
    'Emotional analysis',
    'Paragraph quality',
  ...
  sendAdaptations:
    'Heavily annotated extracts with emotional tone marked. Pre-filled before/after diagram. Visual scene of street fight. Simplified analysis frame.',
}
...
const romeoJulietLesson4: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Romeo and Juliet marry and consummate their love. But Romeo must flee at dawn or die. Ask: why does Shakespeare give them this one perfect moment before tragedy?',
  ...
  plenary: {
    ...
    duration: '5 minutes',
    instructions:
      "The Friar's potion is meant to preserve Juliet's marriage to Romeo. Instead, it will cause both their deaths. Shakespeare shows how good intentions combined with miscommunication lead to tragedy.",
    differentiation: {
  ...
  homework:
    'Write a comparison (250-300 words): "Compare Romeo and Juliet\'s responses to their separation and the threat of Juliet\'s marriage to Paris. What does their contrast reveal about their characters?"',
  resourcesNeeded: [
    'Act 3.5 extract',
    'Act 4.1 extract',
    'Dramatic irony table',
  ...
  sendAdaptations:
    'Heavily annotated extracts. Pre-filled dramatic irony table example. Visual timeline of plot progression. Comparison essay scaffold.',
}
...
const romeoJulietLesson5: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Romeo receives false news that Juliet is dead. He purchases poison and goes to her tomb. What will happen when both lovers believe the other is dead?',
  ...
  homework:
    "Analyse Romeo's final speech before drinking poison (Act 5.3.102-120). Write 6-7 sentences explaining what it reveals about his love, his despair, and Shakespeare's presentation of tragedy.",
  resourcesNeeded: [
    'Act 5.3 extract',
    'Final irony table',
    'Paragraph frame',
    'Final speech quotation',
  ],
  assessmentOpportunities: [
    'Understanding of tragic resolution',
    'Irony analysis',
    'Quotation analysis',
  ...
  sendAdaptations:
    'Heavily annotated tomb scene with emotional tone marked. Pre-filled irony table. Visual timeline of final act. Paragraph frame with sentence starters.',
}
...
const romeoJulietLesson6: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '5 minutes',
    instructions:
      'Recall key techniques: dramatic irony, poetic language, imagery (light/dark, stars, fate), soliloquies, dramatic structure. Which is most important to understanding the play?',
  ...
  plenary: {
    ...
    duration: '2 minutes',
    instructions:
      'Key: Romeo & Juliet is fundamentally a tragedy about the collision between love and hatred, private passion and public enmity. Use specific terminology: dramatic irony, imagery, poetic language, tragic inevitability. Link all analysis to this central tension.',
    differentiation: {
      support: 'Provide exam focus checklist.',
...
const macbethActOneAmbition: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '7 minutes',
    instructions:
      'Students rank motivations: family, honour, wealth, power, fame. Discuss: which drive Macbeth in Act 1? Show image of ambitious people (politicians, CEOs). Is ambition inherently dangerous or does context matter? Link to Jacobean beliefs about unchecked ambition threatening divine order.',
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Evaluate Shakespeare's intentional ambiguity: does he want audiences to judge Macbeth harshly or sympathetically given the forces arrayed against him?",
    },
    resources: [
      'Act 1.3 witches extract',
      'Act 1.7 Lady Macbeth extract',
      'Reasons chart template',
      'Response frame',
      'Context notes on Jacobean fatalism',
    ],
  },
  plenary: {
    ...
    duration: '3 minutes',
    instructions:
      'Define hamartia. Conclude: "Macbeth\'s ambition is triggered by the witches but shaped by Lady Macbeth and enabled by his own desire for power. All three must work together for tragedy to unfold." Students exit with this idea in mind for future lessons.',
    differentiation: {
  ...
  homework:
    'Write a 400-word analytical essay: "How does Shakespeare present the competing forces of fate, influence, and free will in Act 1 of Macbeth?" Include at least three quotations.',
  resourcesNeeded: [
    'Act 1.3 and 1.7 extracts',
    'Reasons chart',
    'Context slides on Jacobean fatalism',
    'Hamartia definition card',
  ],
  assessmentOpportunities: [
    'Annotation precision',
    'Chart accuracy',
    'Essay analysis',
    'Understanding of tragic flaw concept',
    'Quotation selection',
  ],
  keyVocabulary: [
    'ambition',
  ...
  sendAdaptations:
    'Heavily annotated extracts with line numbers. Pre-filled reasons chart. Essay frame with paragraph headings. Audio recording of key scenes. Simplified explanation of hamartia with modern examples.',
}
...
const macbethActTwoGuilt: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Show film stills of a heist movie before and after the crime. Discuss: how do characters' emotions and thoughts change after crossing a moral line? Introduce: Act 2 shows Macbeth's conscience erupting before he even commits the murder.",
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Write second paragraph comparing the dagger to the ghost of Banquo in Act 3, discussing how both reveal Macbeth's internal state.",
    },
    resources: [
      'Act 2.1 soliloquy extract',
      'Act 2.2 extract',
      'Chart template',
      'Paragraph frame',
  ...
  plenary: {
    ...
    duration: '5 minutes',
    instructions:
      'Brief discussion: Macbeth has killed Duncan and become king. Seems like ambition is satisfied. But why does he seem miserable? Introduce idea of Act 3: becoming king does not bring peace; it brings paranoia and further violence.',
    differentiation: {
      support: "Provide clear summary of Act 2's ending.",
      core: 'Predict what Macbeth might do next and why.',
      stretch:
        'Discuss: does guilt serve as a natural brake on further crime, or will Macbeth commit more violence to protect his position?',
    },
  },
  homework:
    "Memorise six lines from the dagger soliloquy and write detailed analysis of one device's use. Aim for 8-10 sentences showing sophisticated analysis of Shakespeare's methods.",
  resourcesNeeded: [
    'Act 2.1.33-61 soliloquy',
    'Act 2.2 extract',
    'Chart template',
    'Analysis frame',
    'Device guide',
  ...
  assessmentOpportunities: [
    ...
    'Analytical paragraph quality',
    'Quotation memorisation and analysis',
  ],
  keyVocabulary: [
    'soliloquy',
    'personification',
  ...
  sendAdaptations:
    "Simplified soliloquy with modern English translation. Pre-annotated version for comparison. Chart template with examples. Paragraph frame with all sentence starters provided. Visual diagram of Macbeth's emotional state.",
}
...
const macbethActThreeTyranny: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Define: Ambition (desire to achieve), Power (ability to control). Discuss: Does gaining power satisfy ambition or create new anxieties? Show image of secure vs insecure ruler. Introduce: Macbeth has achieved his ambition but now fears losing his power.',
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Evaluate: does Macbeth have legitimate political concerns about Banquo's heirs, or is his paranoia entirely irrational? Use context of Renaissance political theory.",
    },
    resources: [
      'Act 3.1.48-72 soliloquy',
      'Act 3.4 banquet scene extract',
      'Spiral diagram template',
      'Paragraph frame',
      'Context on Renaissance kingship',
    ],
  },
  plenary: {
    ...
    duration: '5 minutes',
    instructions:
      "Conclude: \"Macbeth's tyranny stems from paranoia. The more he tries to secure power through violence, the more isolated and fearful he becomes.\" Link to kingship theme: a true king should rule through legitimacy and virtue, not fear. This sets up Act 4's witches' prophecies and Act 5's inevitable downfall.",
    differentiation: {
  ...
  homework:
    'Write extended response (500 words): "Analyse the transition from Macbeth as murderer to Macbeth as tyrant in Act 3. How has his character and motivation changed?" Include at least three quotations.',
  resourcesNeeded: [
    'Act 3.1 soliloquy',
    'Act 3.4 banquet scene',
    'Spiral diagram template',
    'Context on Renaissance kingship',
  ],
  assessmentOpportunities: [
  ...
  sendAdaptations:
    'Simplified extracts with key phrases highlighted. Pre-filled spiral diagram. Response frame with section headings. Audio recordings of scenes. Visual timeline of Act 3 events.',
}
...
const macbethActFiveDownfall: LiteratureLesson = {
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Write second response debating whether Macbeth is ultimately responsible for his downfall despite the witches' deception.",
    },
    resources: [
      'Act 4.1 prophecies',
      'Act 5.6-7 battle scene',
      'Prophecy table template',
      'Response frame',
  ...
  plenary: {
    ...
    duration: '5 minutes',
    instructions:
      "Read Malcolm's final speech briefly. Discuss: how does the restoration of order mirror the opening? Macbeth's unchecked ambition has destroyed Scotland; his death restores the natural hierarchy. Link to Jacobean political philosophy: legitimate kingship vs tyranny. Conclude the complete arc: Act 1 ambition → Act 2 guilt → Act 3 tyranny → Act 5 justice.",
    differentiation: {
      support: "Provide Malcolm's key quotations.",
      core: 'Understand tragic resolution.',
      stretch:
        "Evaluate whether Malcolm's restoration fully repairs Scotland or if permanent damage persists.",
    },
  },
  homework:
    'Revise Acts 1-5. Write practice exam response (timed 30 min): "How does Shakespeare use the witches to explore ideas about fate and responsibility in Macbeth?"',
  resourcesNeeded: [
    'Act 4.1 prophecies',
    'Act 5.6-7 battle scene',
    "Malcolm's final speech",
  ...
  sendAdaptations:
    'Simplified battle scene. Pre-completed prophecy examples. Response frame with sentence starters. Visual timeline of entire play. Glossary of key concepts.',
}
...
const jekyllHydeDuality: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Discussion: Can one person contain both good and evil? Or are they separate? Show images of Jekyll vs Hyde. Introduce: Victorian society believed humans could separate their "respectable" and "hidden" selves. Stevenson challenges this.',
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Add evaluation column to chart: "What does each character\'s behaviour reveal about human nature?"',
    },
    resources: [
      'Jekyll descriptions',
      'Hyde descriptions',
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Jekyll attempts to create two separate selves but discovers they are fundamentally one. The potion does not create evil; it releases what is already within." Link to Victorian hypocrisy: respectable surface hiding darker desires.',
    differentiation: {
  ...
  homework:
    'Write 400-word response: "Evaluate whether Stevenson suggests that good and evil are separate forces or two aspects of one nature." Use at least three quotations.',
  resourcesNeeded: [
    'Jekyll and Hyde descriptions',
    'Confession extract',
    'Comparison chart',
    'Paragraph frame',
  ],
  assessmentOpportunities: [
    ...
    'Textual annotation',
    'Analytical paragraph',
    'Understanding of duality theme',
    'Quotation selection',
  ],
  keyVocabulary: [
    'duality',
  ...
  sendAdaptations:
    'Visual comparison chart with images. Pre-highlighted confession extract. Paragraph frame with sentence starters. Audio recording of confession scene. Simplified vocabulary.',
}
...
const jekyllHydeVictorianRepression: LiteratureLesson = {
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Research Victorian attitudes toward medicine, science, sexuality. Evaluate how relevant Stevenson's critique was to his contemporaries.",
    },
    resources: [
      "Jekyll's public life passages",
      'Confession extract on desires',
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Key message: "Stevenson suggests that Victorian repression is dangerous. Suppressed desires do not disappear; they transform into something monstrous." Link to tragic ending: Jekyll\'s attempt to deny his darker nature leads to his destruction.',
    differentiation: {
  ...
  homework:
    'Write analytical essay (400-500 words): "Analyse how Stevenson uses the figure of Jekyll to critique Victorian society\'s repression of human desires and hypocrisy."',
  resourcesNeeded: [
    "Jekyll's public and private passages",
    'Confession extract',
    'Context slides on Victorian morality',
    'Chart template',
  ],
  assessmentOpportunities: [
  ...
  sendAdaptations:
    'Visual comparison of Victorian respectability vs hidden life. Pre-annotated confession extract. Chart template with examples. Essay frame with paragraph headings. Historical context slides.',
}
...
const jekyllHydeTransformation: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Discussion: what happens when something that initially feels like freedom (drinking, drugs, risky behaviour) becomes compulsive? Show brief scene of transformation. Introduce: Jekyll's potion mirrors addiction - initially voluntary, eventually compulsive.",
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Add evaluation: why does Jekyll lose control? Is it the potion's failure or the nature of desire itself?",
    },
    resources: [
      'Early transformation passages',
      'Later involuntary transformation passages',
      'Timeline template',
      'Paragraph frame',
    ],
  },
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Jekyll believed science could separate and control human nature. The involuntary transformation proves him wrong. His attempt at rational control backfires into complete loss of control." Link to Victorian anxieties about science and progress.',
    differentiation: {
  ...
  homework:
    'Write extended analysis (450 words): "Examine how Stevenson uses the transformation to present themes of addiction, loss of control, and the failure of reason." Include specific textual references.',
  resourcesNeeded: [
    'Early transformation passages',
    'Late transformation passages',
    'Timeline template',
    'Paragraph frame',
  ],
  assessmentOpportunities: [
  ...
  sendAdaptations:
    'Visual timeline showing transformation stages. Pre-annotated passages highlighting control language. Paragraph frame with sentence starters. Audio recording of transformation descriptions.',
}
...
const jekyllHydeFinalChapter: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Discussion: does confession redeem someone? Or is it too late if the damage is done? Show image of final scene. Introduce: Jekyll's full confession is the novella's climax - he finally tells the truth.",
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Evaluate whether Jekyll's confession is truthful or self-serving. Does he blame Hyde or accept responsibility?",
    },
    resources: [
      "Jekyll's confession chapter",
      'Chart template',
      'Response frame',
      'Damnation/redemption vocabulary',
    ],
  },
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Stevenson\'s ending offers no redemption. Jekyll\'s confession comes too late. His attempt to separate and control human nature leads not to liberation but to damnation. The novella suggests: accept your whole self or be destroyed by denial." Link to Victorian anxieties about respectability.',
    differentiation: {
      support: 'Provide conclusion statement.',
      core: 'Understand tragic resolution.',
      stretch:
        'Discuss: is this a pessimistic message? Or a realistic one about denying human nature?',
    },
  },
  homework:
    'Write final analytical essay (500-600 words): "Analyse how the final chapter of Jekyll and Hyde completes Stevenson\'s exploration of duality and human nature. What is his ultimate message?" Include at least four quotations.',
  resourcesNeeded: [
    "Jekyll's confession chapter",
    'Chart template',
    'Response frame',
  ...
  sendAdaptations:
    'Pre-highlighted confession with key emotional turns marked. Chart template with examples. Response frame with paragraph headings. Audio recording of confession. Glossary of difficult vocabulary.',
}
...
const inspectorBirlingCapitalism: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Debate: If a business is losing money paying fair wages, should the owner cut wages to save the company? Two sides. Discuss: does profit justify any action? Introduce: this is the core of Birling's philosophy in the play.",
  ...
  plenary: {
    ...
    differentiation: {
      ...
      stretch:
        'Consider: was Priestly right? Is individual profit or collective welfare more important?',
    },
  },
  homework:
    'Write 400-word analytical response: "Analyse how Priestly uses Birling\'s character to critique capitalist values and demand social responsibility."',
  resourcesNeeded: [
    'Act 1 extracts',
    "Birling's speeches",
    'Chart template',
  ...
  assessmentOpportunities: [
    ...
    'Chart completion',
    'Analytical paragraph',
    'Understanding of social message',
  ...
  sendAdaptations:
    'Pre-annotated extracts highlighting key arguments. Chart template with examples. Paragraph frame with sentence starters. Context summary cards. Visual comparison of Birling vs Inspector values.',
}
...
const inspectorSheilaTransformation: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Discussion: if you hurt someone without meaning to, does being sorry change anything? Should it change how you're punished? Introduce: Sheila harms Eva Smith out of vanity but later shows genuine remorse.",
    resources: ['Discussion prompt'],
  },
  mainActivity: {
    ...
    duration: '47 minutes',
    instructions:
      'PART 1 (15 min): Read Act 1-2 where Sheila gets Eva Smith fired from Milwards. Annotate for: her vanity, her thoughtlessness, her initial lack of guilt. Track how she views the situation: "Just because I happened to laugh when some girl made a face at a customer." Examine her tone: casual, dismissive. PART 2 (18 min): Read Act 2-3 where Sheila realizes the consequences and becomes deeply upset. Annotate for: "That\'s the second time I\'ve had it thrown in my face. It doesn\'t matter now, does it, what happened to her?... I wish you\'d stop telling me to sit down." Examine: genuine shame, horror, understanding of her role. PART 3 (14 min): Students create a character arc showing Sheila\'s emotional and moral journey. Write analytical paragraph: "How does Priestly present Sheila\'s capacity for moral change? What makes her redemption credible or incomplete?"',
    differentiation: {
      support: 'Pre-highlighted extracts showing tone shift. Arc template.',
      core: 'Independent annotation and arc creation.',
      stretch:
        'Evaluate: has Sheila truly changed or just learned to feel guilt? Will she act differently after the play?',
    },
    resources: [
      'Act 1-2 Sheila excerpt',
      'Act 2-3 Sheila excerpt',
      'Arc template',
      'Paragraph frame',
      'Tone analysis guide',
    ],
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Sheila represents hope for moral change. Unlike her parents who remain defensive, she accepts responsibility and shows genuine remorse. Priestly suggests that younger generation can build better society." Link to 1945 post-war audience.',
    differentiation: {
  ...
  homework:
    "Write analytical essay (450 words): \"Analyse how Priestly presents Sheila's moral development as more genuine than her parents' responses. What does this suggest about society's capacity for change?\"",
  resourcesNeeded: [
    'Act 1-2 Sheila lines',
    'Act 2-3 Sheila lines',
    'Arc template',
    'Paragraph frame',
  ],
  assessmentOpportunities: [
  ...
  sendAdaptations:
    "Visual character arc with emotional markers. Pre-annotated extracts with tone shifts highlighted. Paragraph frame with sentence starters. Audio recording of Sheila's lines showing emotional change. Comparison chart.",
}
...
const inspectorGeraldSecrets: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Discussion: if someone helps another person (giving money, shelter, attention) but for selfish reasons, are they still responsible for consequences? Introduce: Gerald gives Eva Smith money and a place to stay but uses her.',
    resources: ['Discussion prompt'],
  },
  mainActivity: {
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Gerald\'s class and gender allow him to escape consequence. He helps Eva while exploiting her. Priestly suggests that middle-class respectability masks exploitation and injustice." Link to themes of social inequality.',
    differentiation: {
      support: 'Provide conclusion.',
  ...
  homework:
    'Write 450-word analytical response: "How does Priestly use Gerald\'s character to expose the hypocrisy of middle-class respectability and the exploitation of working-class women?"',
  resourcesNeeded: [
    'Gerald extracts',
    'Affair revelation',
    'Analysis template',
  ...
  sendAdaptations:
    "Pre-highlighted passages showing contradiction. Two-column chart with examples. Response frame with sentence starters. Context summary on class and gender dynamics. Visual comparison of Gerald's narrative vs reality.",
}
...
const inspectorInspectorRole: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Discussion: is the Inspector real or a ghost/spirit? Does it matter? Introduce: Priestly's ambiguity about the Inspector's identity serves his moral purpose.",
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "The Inspector articulates Priestly\'s social vision: we are all connected; our actions have consequences; we must accept collective responsibility. Whether he is real is less important than his message." Link to 1945 election and post-war social change.',
    differentiation: {
      support: 'Provide key message.',
      core: "Understand Inspector's moral function.",
      stretch:
        "Discuss: how has British society changed since 1945? Is Priestly's vision realized?",
    },
  },
  homework:
    'Write final analytical essay (500-600 words): "Analyse how Priestly uses the Inspector to convey his message about social responsibility and interconnectedness. Is the play ultimately optimistic or pessimistic about social change?"',
  resourcesNeeded: [
    'Inspector speeches',
    'Final speech',
  ...
  sendAdaptations:
    'Pre-highlighted key speeches with rhetorical devices marked. Final speech annotation guide. Paragraph frame with sentence starters. Context summary on 1945 post-war Britain. Audio recording of Inspector speeches.',
}
...
const christmasCarolScroogeIsolation: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Discussion: what's the difference between being alone and being isolated? Can you be surrounded by people and still isolated? Introduce: Scrooge is wealthy but utterly isolated by his own choices.",
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Scrooge\'s wealth has bought him isolation and moral blindness. Dickens suggests that greed does not create happiness; it creates disconnection and loss of humanity." Link to social message about community and compassion.',
    differentiation: {
      support: 'Provide conclusion.',
      core: 'Understand isolation as consequence of greed.',
      stretch:
        "Consider: can Scrooge's redemption undo years of isolation? Is true connection possible after?",
    },
  },
  homework:
    'Write analytical response (400 words): "How does Dickens use imagery and characterisation to present Scrooge\'s isolation as a moral and emotional consequence of his greed?"',
  resourcesNeeded: [
  ...
  sendAdaptations:
    'Visual map with images showing isolation. Pre-highlighted descriptive passages. Paragraph frame with sentence starters. Contrast images: Scrooge alone vs Cratchit family. Audio recording of isolation descriptions.',
}
...
const christmasCarolFezziwigScrooge: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Display contrasting management styles: generous/people-focused vs profit-focused/people-as-cost. Discuss: which is better for workers? Which is more profitable? Introduce: Scrooge worked for Fezziwig and learned different values, but abandoned them.',
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Scrooge chose profit over Fezziwig\'s compassion. The Spirit of Christmas Past shows him what he sacrificed: a humanity and kindness that might have brought genuine happiness." Link to themes of redemption and choice.',
    differentiation: {
      support: 'Provide conclusion.',
      core: "Understand Scrooge's moral choice.",
      stretch:
        "Discuss: was Scrooge's choice inevitable or could he have remained compassionate while successful?",
    },
  },
  homework:
    'Write analytical essay (450 words): "How does Dickens use the contrast between Fezziwig and Scrooge to present a critique of ambition and capitalism? What alternative does the novella suggest?"',
  resourcesNeeded: [
    'Fezziwig scene',
    'Present Scrooge passages',
    'Comparison chart',
  ...
  sendAdaptations:
    "Visual comparison chart with images. Pre-highlighted contrasting passages. Paragraph frame with sentence starters. Timeline showing Scrooge's moral journey. Audio recording of Fezziwig scene.",
}
...
const christmasCarolIgnoranceWant: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Show images of Victorian London: wealthy areas vs slums. Discuss: are poor people invisible to the wealthy? Why might Scrooge not know how people live below his station? Introduce: the Spirit of Christmas Present reveals hidden suffering.',
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      core: 'Independent annotation and response.',
      stretch:
        "Research Victorian poor laws and workhouses: how radical was Dickens' critique in 1843?",
    },
    resources: [
      'Ignorance & Want passage',
      '"Surplus population" passage',
      'Chart template',
      'Response frame',
      'Victorian context slides',
    ],
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Dickens argues that poverty is not inevitable or deserved; it results from ignorance (lack of education, opportunity) and social indifference. Society must change or children will suffer." Link to post-WWII welfare state expectations.',
    differentiation: {
      support: 'Provide conclusion.',
      core: "Understand Dickens' social critique.",
      stretch:
        "Discuss: has modern society adequately addressed Dickens' concerns about ignorance and poverty?",
    },
  },
  homework:
    'Write analytical essay (500 words): "How does Dickens present Ignorance and Want to deliver a powerful critique of Victorian society and demand for social responsibility? How does this connect to Scrooge\'s redemption?"',
  resourcesNeeded: [
    'Ignorance & Want passage',
    '"Surplus population" passage',
    'Chart template',
  ...
  assessmentOpportunities: [
    'Annotation precision',
    'Chart accuracy',
    'Understanding of social critique',
    'Essay quality',
    'Contextual awareness',
  ],
  keyVocabulary: [
  ...
  sendAdaptations:
    'Visual description of Ignorance and Want with annotations. Pre-highlighted "surplus population" passage with moral horror noted. Chart template with examples. Context summary on Victorian poor laws. Audio recording of key passages.',
}
...
const christmasCarolRedemption: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Debate: can someone fundamentally change their nature and values? Or do they just pretend? Introduce: the novella argues for genuine transformation, but is it realistic?',
    resources: ['Discussion prompt'],
  },
  mainActivity: {
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Dickens\' novella is fundamentally hopeful. It argues that redemption is possible, that people can change radically, and that individual change can inspire social change." Link to Christmas themes of renewal and second chances.',
    differentiation: {
      support: 'Provide conclusion.',
      core: "Understand redemption as novella's central message.",
      stretch:
        'Discuss: why is A Christmas Carol so popular during Christmas season? What does it offer readers spiritually and morally?',
    },
  },
  homework:
    'Write final analytical essay (550 words): "Analyse how Dickens presents the possibility of redemption in Scrooge\'s transformation. How convincing is the change? What does the novella ultimately argue about human nature and moral responsibility?"',
  ...
  sendAdaptations:
    "Visual before/after character analysis with images. Pre-highlighted transformation passages. Chart template with examples. Paragraph frame with sentence starters. Summary of entire novella's arc.",
}
...
const bloodBrothersNatureNurture: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Discussion: if identical twins were raised in completely different circumstances, would they be the same person? Show images of Mickey and Edward at different ages. Introduce: Russell uses the twins to explore whether our nature or circumstances define us.',
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Russell\'s play suggests that while the twins share blood, nurture profoundly shapes who they become. Yet the tragic ending suggests that even identical twins cannot escape the social structures that divide them." Link to social inequality themes.',
    differentiation: {
      support: 'Provide conclusion.',
      core: 'Understand the nature/nurture dilemma Russell presents.',
      stretch:
        'Consider: can social systems be changed to give all children opportunities, or are class differences inevitable?',
    },
  },
  homework:
    'Write analytical response (400 words): "How does Russell use the twin brothers to explore the question of nature versus nurture? What does the play suggest about the power of environment to shape human destiny?"',
  resourcesNeeded: [
    'Early Mickey/Edward scenes',
    'Adolescent scenes',
    'Comparison table',
    'Paragraph frame',
  ],
  ...
  sendAdaptations:
    "Visual timeline showing Mickey and Edward's development. Pre-selected key scenes with annotations. Comparison table with examples. Paragraph frame with sentence starters. Summary of nature/nurture debate.",
}
...
const bloodBrothersClassDivide: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      'Discussion: how does family wealth affect opportunities? (Education, housing, career, confidence, expectations.) Show contrast images: wealthy vs poor neighbourhoods. Introduce: Russell uses the families to show how class determines destiny in 1980s Britain.',
  ...
  mainActivity: {
    ...
    duration: '47 minutes',
    instructions:
      "PART 1 (15 min): Read scenes showing the Johnstone family: crowded housing, financial stress, job insecurity, Mrs Johnstone's desperation, the poverty that forces her into giving away Mickey. Annotate for: language showing poverty's weight, the lack of choice, the exhaustion. Track: poverty is structural, not individual failing. PART 2 (18 min): Contrast with the Lyons family: comfortable home, money for education, professional stability, plans for Edward's future. Annotate for: ease, options, casual mention of money, lack of anxiety. PART 3 (14 min): Students create a Venn diagram: Johnstone Family Only | Both Families | Lyons Family Only. Add words/phrases showing resources, opportunities, language, values. Write analytical paragraph: \"How does Russell use the two families to present class as a determining force in life outcomes? What critique of 1980s social inequality is he offering?\"",
    differentiation: {
      support: 'Selected family scenes. Venn diagram template.',
      core: 'Independent scene selection and analysis.',
      stretch:
        "Research 1980s Britain: Thatcher's policies, unemployment, social inequality. How does Russell respond to these issues in his play?",
    },
    resources: [
      'Johnstone family scenes',
      'Lyons family scenes',
      'Venn diagram template',
      'Paragraph frame',
      '1980s context slides',
    ],
  },
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Russell shows that class is not about individual merit; it is about systems that give opportunities to some while trapping others in poverty. The tragic ending is inevitable given the structural inequality."',
    differentiation: {
      support: 'Provide conclusion.',
      core: 'Understand class as structural, not individual.',
      stretch:
        'Discuss: can individual goodness (Mickey, Edward, even Mrs Johnstone) overcome structural inequality?',
    },
  },
  homework:
    'Write analytical essay (450 words): "How does Russell use the contrast between the Johnstone and Lyons families to critique class inequality in 1980s Britain? What does the tragic ending suggest about social mobility?"',
  resourcesNeeded: [
    'Johnstone family scenes',
    'Lyons family scenes',
    'Venn diagram',
  ...
  sendAdaptations:
    "Visual Venn diagram with images. Pre-highlighted family scenes showing contrasts. Paragraph frame with sentence starters. Context summary on 1980s inequality. Timeline of families' diverging paths.",
}
...
const bloodBrothersSuperstition: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Discussion: is the tragedy inevitable or could different choices prevent it? Play opening lines of the play (Narrator's prediction). Introduce: Russell uses superstition and the Narrator to create a sense of inevitability.",
  ...
  mainActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Evaluate: what is Russell's real message-that fate is real, or that social inequality is so powerful it seems like fate?",
    },
    resources: [
      "Narrator's opening speech",
      'Superstition moments',
      'Final scene',
      'Paragraph frame',
    ],
  },
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Russell uses superstition and the Narrator to suggest that the tragedy is inevitable. Whether literally fated or socially determined, the brothers cannot escape their destinies. The play asks: how much control do we have over our lives?"',
    differentiation: {
      support: 'Provide conclusion.',
  ...
  homework:
    'Write analytical response (400 words): "How does Russell use the Narrator and superstition to create a sense of tragic inevitability? What is his commentary on human agency and social determination?"',
  resourcesNeeded: ["Narrator's speech", 'Superstition moments', 'Final scene', 'Paragraph frame'],
  assessmentOpportunities: [
    'Speech analysis',
    'Superstition identification',
    'Dramatic technique understanding',
    'Response quality',
    'Thematic comprehension',
  ],
  keyVocabulary: [
  ...
  sendAdaptations:
    "Pre-highlighted Narrator's speech. Timeline showing fate-related moments. Paragraph frame with sentence starters. Visual summary of omens. Audio recording of opening speech.",
}
...
const bloodBrothersEnding: LiteratureLesson = {
  ...
  starterActivity: {
    ...
    duration: '6 minutes',
    instructions:
      "Discussion: if someone breaks the law under desperation, are they equally guilty as someone who breaks it from malice? Introduce: Mickey's death raises questions about justice and the circumstances that drive people to desperate acts.",
  ...
  plenary: {
    ...
    duration: '4 minutes',
    instructions:
      'Conclude: "Blood Brothers\' tragic ending is not just personal tragedy; it is social tragedy. Two identical brothers, separated by class, destroyed by a system that divides them. Russell argues: if we allow such inequality, this is the result." Link to social responsibility and systemic change.',
    differentiation: {
      support: 'Provide conclusion.',
      core: 'Understand tragedy as social statement.',
      stretch:
        "Discuss: nearly 40 years after writing, is Russell's critique still relevant to British society?",
    },
  },
  homework:
    'Write final analytical essay (550 words): "Analyse the significance of the ending of Blood Brothers. How does Russell use the deaths of Mickey and Edward to deliver a powerful social message about class inequality and the failure of society?"',
  ...
  sendAdaptations:
    'Visual timeline of final scenes. Pre-highlighted confrontation passage. Paragraph frame with sentence starters. Summary of social messages throughout play. Audio recording of final revelation.',
}
