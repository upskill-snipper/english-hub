...
export const ks3CurriculumLessons: LessonPlan[] = [
  ...
  // ── Lesson 1: Explicit Reading - Fox Girl: Character Introduction ──────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide an adjective bank on tables for students who struggle with vocabulary retrieval.',
        core: 'Students generate their own adjectives and justify their choices verbally to a partner.',
        stretch:
          'Students consider what is deliberately left ambiguous in each image and why a creator might do that.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Pre-highlight five key words in the extract for students to focus their annotations on.',
          core: 'Students annotate independently, identifying language choices and their effects.',
          stretch:
            'Students annotate with a focus on what is implied but not directly stated - what must we infer about the character?',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a pre-structured mind map template with the four branches and sentence starters for annotations.',
          core: 'Students create their own mind map with at least two quotations per branch.',
          stretch:
            'Students add a fifth branch - "Reader Response" - and explain how the writer makes us feel about the character and why.',
        },
        resources: [
          'A3 mind map paper or template',
          'Coloured pens',
          'Extract (from previous activity)',
        ],
      },
      {
        ...
        differentiation: {
          support:
            'Provide a pre-printed vocabulary sheet with definitions and space for students to write example sentences.',
          core: 'Students write definitions and use each word in a sentence about the character.',
          stretch:
            'Students identify the connotations of each word and explain why the writer chose it over a synonym.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a sentence starter: "The writer creates the impression that the protagonist is... because..."',
        core: 'Students write independently using lesson keywords.',
        stretch:
          'Students write two sentences - one about what is revealed and one about what is concealed about the character.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What does the word "characterisation" mean? Give two methods a writer might use to characterise a person.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Choose one quotation from the extract that creates a strong impression of the protagonist. Write it out and explain what it suggests.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'What is the difference between what a writer tells us directly about a character and what we must infer? Give an example of each from the extract.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Why do you think the writer chose to open the story with this particular scene? What does it establish for the reader?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 2: Reading & Discussion - Deepening Character Understanding ─────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students predict possible thematic connections between the two texts based on titles alone.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a comparison sentence frame: "The protagonist in Fox Girl seems... whereas the protagonist in White Gazelle seems... because..."',
          core: 'Students write an independent comparison using evidence from both texts.',
          stretch:
            'Students consider how the cultural context of each text shapes the way the protagonist is presented.',
        },
        resources: [
          'White Gazelle opening extract (printed copies)',
          'Fox Girl extract from Lesson 1',
        ],
      },
      {
        ...
        differentiation: {
          support:
            'Provide discussion prompt cards at each station with sentence starters and key vocabulary.',
          core: 'Students discuss independently, using evidence from both texts.',
          stretch:
            'Students are assigned the role of "challenger" - they must offer an alternative interpretation at each station.',
        },
        resources: [
          'A3 discussion station papers (x4)',
          'Coloured marker pens (one per group)',
          'Discussion prompt cards (support tier)',
        ],
      },
      {
        ...
        differentiation: {
          support:
            'Provide a writing frame with sentence starters for comparison (similarly, in contrast, both characters).',
          core: 'Students write a full paragraph independently with at least one quotation from each text.',
          stretch:
            'Students write two paragraphs - one on similarity and one on difference - linking to theme.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a cloze sentence for the final reflection: "Comparing the two texts helped me understand that..."',
        core: 'Students articulate their reflection independently.',
        stretch:
          'Students suggest what other text or type of text could be added to this pairing and why.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is meant by a "theme" in a text? Give one example of a theme that appears in both Fox Girl and White Gazelle.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'How does the writer of White Gazelle create sympathy for the protagonist in the opening? Use a quotation to support your answer.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Compare how the two writers introduce their protagonists. What is similar and what is different about their approaches?',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 3: Writing - Modelling Analytical Writing (Character Analysis) ──
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a sentence frame for embedding: "The writer uses the [technique] \'[quotation]\' to suggest..."',
        core: 'Students convert the dropped quotations independently.',
        stretch:
          'Students write their own embedded quotation sentence from scratch using the Fox Girl extract.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Students copy the model and annotate with teacher guidance, using a colour-coded system.',
          core: 'Students copy, annotate independently, and note one technique they want to replicate in their own writing.',
          stretch:
            'Students evaluate the model: is there anything they would improve? They write an improved version of the explanation sentence.',
        },
        resources: [
          'Visualiser or interactive whiteboard',
          'Fox Girl extract',
          'PEEL annotation guide',
        ],
      },
      {
        ...
        differentiation: {
          support:
            'Provide a writing frame with sentence starters for each PEEL component and a pre-selected quotation to use.',
          core: 'Students write independently following the stepped scaffold, choosing their own quotation.',
          stretch:
            'Students write two PEEL paragraphs and attempt to link them with a connective that shows progression of argument.',
        },
        resources: [
          'White Gazelle extract',
          'PEEL writing frame (support tier)',
          'Peer assessment checklist',
          'Analytical verbs word mat',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a brief rule explanation for each correction, suitable for teaching a younger student.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'List four analytical verbs you could use instead of "shows" when explaining the effect of a quotation.',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'Correct the quotation punctuation in this sentence: The writer says she was like a shadow creeping through the doorway to show that she is secretive.',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'Write a PEEL paragraph analysing how the writer presents the setting in either Fox Girl or White Gazelle. Embed at least one quotation.',
        lines: 8,
        modelAnswer:
  ...
  // ── Lesson 4: Application - Guided Practice (Reading to Writing) ───────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write an example sentence using a connective from each category, applied to the two studied texts.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a pre-annotated version with two elements already identified; students complete the remaining annotations.',
          core: 'Students annotate independently and note the structural pattern.',
          stretch:
            'Students evaluate whether the paragraph gives equal weight to both texts and suggest improvements if not.',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a structured writing frame with sentence starters for each step and pre-selected quotations.',
          core: 'Students follow the scaffold independently, selecting their own quotations.',
          stretch:
            'Students write a second comparison paragraph on a different aspect of character (e.g., vulnerability) and link the two paragraphs together.',
        },
        resources: [
          'Both extracts',
          'Writing scaffold slide',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide sentence starters for the target: "Next time I will focus on... because my paragraph currently..."',
        core: 'Students self-assess and set a specific, actionable target.',
        stretch:
          'Students rewrite their weakest sentence to demonstrate improvement before submitting.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'List three comparative connectives and write a sentence using each one to compare the two protagonists.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'What is the difference between writing two separate paragraphs about two texts and writing one integrated comparison paragraph?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "Write a comparison paragraph about how both writers use setting to reflect their protagonists' emotions. Use evidence from both texts.",
        lines: 8,
        modelAnswer:
  ...
  // ── Lesson 5: Assessment - Independent Character & Theme Essay ─────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students plan a three-paragraph response with a conceptual introduction that addresses the idea of "adversity" more broadly.',
      },
      resources: [
        'Assessment question slide',
        'Planning template (support tier)',
        'Both extracts (clean copies, no annotations)',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a word mat with analytical vocabulary and comparative connectives. Allow access to the planning template but not to annotated extracts.',
          core: 'Students write independently with access to clean extracts only.',
          stretch:
            'Students aim for three comparison paragraphs and a conceptual introduction that engages with the theme of adversity beyond the two texts.',
        },
        resources: [
          'Clean copies of both extracts',
          'Lined paper or exercise books',
          'Word mat (support tier)',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a brief paragraph explaining how their analytical writing has improved since Lesson 1 and what specific changes they made.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'This assessment question asks you to "compare." What does this mean you must do in your response?',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'Write the opening sentence of a comparison paragraph about how both writers present their protagonists as determined. This sentence should address both texts.',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 6: Explicit Reading - Voice and Identity in Poetry ──────────────
  {
    ...
    keywords: ['voice', 'persona', 'speaker', 'identity', 'tone', 'form', 'stanza', 'first person'],
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a listening grid with categories (age, mood, confidence) for students to complete during each clip.',
        core: 'Students make independent observations and justify them.',
        stretch:
          'Students consider what the speaker might be trying to convey about themselves and whether voice can be performed or constructed.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students consider how the form of each poem (layout, structure, line breaks) contributes to the expression of voice.',
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Groups compare the three voices and explain which feels most authentic and why.',
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students add synonyms and antonyms for each keyword and note how changing the word choice would change the voice.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a prompt: "Write one line spoken by a character who is [nervous/angry/excited] without using that word."',
        core: 'Students write independently and aim for subtlety.',
        stretch:
          'Students write two contrasting lines - the same message delivered in two very different voices.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'What is meant by "tone" in a poem? Give two examples of different tones a poet might use.',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'Choose one of the poems studied today. How does the speaker express their identity? Use a quotation to support your answer.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 7: Reading & Discussion - Developing Voice and Perspective ──────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students consider which perspective creates the most empathy and which creates the most distance, and why a writer might choose each.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students rank the three voices from most to least effective for engaging a teenage audience and justify their ranking.',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide discussion stems: "I think we write in our own voice because...", "I think we create a character because..."',
          core: 'Students participate in the structured discussion protocol independently.',
          stretch:
            'Students consider examples from social media - how do people construct different "voices" or identities online?',
        },
        resources: [
          'Talking Chips (counters or tokens, 4 per student)',
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students rewrite the same text twice - in two contrasting voices - and explain the effect of each.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students explain why the distinction between authentic and performed voice is not always clear-cut.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Explain the difference between first person, second person, and third person perspectives. Give an example sentence for each.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          "Choose one of the mentor texts from today's lesson. What specific word choices or sentence structures help create the voice? Explain how they achieve this effect.",
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 8: Writing - Modelling Creative Writing with Voice ──────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a character profile card with three adjectives and suggested vocabulary to use.',
        core: 'Students rewrite independently in the assigned voice.',
        stretch:
          'Students rewrite the paragraph twice in two contrasting voices and explain the key differences.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students suggest improvements to the model paragraph - is there a stronger word choice or a better sentence structure?',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a writing scaffold with an opening sentence starter and a checklist of techniques to include.',
          core: 'Students write independently, applying the modelled techniques.',
          stretch:
            'Students experiment with an unusual structural choice - beginning in medias res, using second person, or starting with dialogue.',
        },
        resources: [
          'Exercise books or lined paper',
          'Writing checklist slide',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students offer specific, constructive feedback using the language of the lesson (voice, tone, register, sentence variety).',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Why is sentence variety important in creative writing? Give an example of when a short sentence might be effective and when a long sentence might be effective.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'What is a "narrative voice"? How is it different from your normal speaking voice?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Rewrite the following sentence to give it a stronger voice: "I walked down the street and it was cold." Write two versions: one in an anxious voice and one in a defiant voice.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 9: Application - Guided Creative Writing Practice ───────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a five senses grid to structure the sensory details before writing the paragraph.',
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a simplified peer review sheet with tick-box criteria and space for one comment per area.',
          core: 'Students use the full peer review sheet and provide specific, constructive comments.',
          stretch:
            'Students provide one "model sentence" - rewriting one of their partner\'s sentences to demonstrate how it could be improved.',
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students add a structural twist - a shift in time, a change in perspective, or a circular ending that echoes the opening.',
        },
        resources: [
          "Students' drafts",
          'Figurative language examples card (support tier)',
          'Paragraphing rules reminder',
        ],
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students also check for ambitious vocabulary and upgrade one "ordinary" word to a more precise or evocative alternative.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students explain the specific technique that made the biggest difference to their writing.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is the difference between a simile and a metaphor? Write one of each describing a stormy sky.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Read your creative writing draft. Identify one sentence you are proud of and explain why it is effective. Then identify one sentence that needs improvement and rewrite it.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 10: Assessment - Independent Creative Writing ───────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a printed planning template with guided prompts and a vocabulary bank of descriptive words.',
        core: 'Students plan independently using the displayed prompts.',
        stretch:
          'Students plan a piece with a deliberate structural feature (non-linear timeline, shifting perspective, or circular structure).',
      },
      resources: [
        'Assessment prompts slide',
        'Planning template (support tier)',
        'Vocabulary bank (support tier)',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Allow access to a vocabulary bank and a techniques reminder card. Minimum 200 words.',
          core: 'Students write independently. Minimum 300 words.',
          stretch:
            'Students aim for 400+ words with a sophisticated structural choice and at least three different descriptive techniques.',
        },
        resources: [
          'Lined paper or exercise books',
          'Vocabulary bank and techniques card (support tier only)',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a brief paragraph explaining how their understanding of "voice" has changed since the start of the unit.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Before you begin writing, outline your plan: Who is your narrator? What tone will you use? What is your opening line?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'After writing, list three techniques you used in your piece and give one example of each from your writing.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'What was the most challenging part of writing with a distinctive voice? What would you do differently next time?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 11: Explicit Reading - How Writers Shape Meaning ────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students suggest a text or film that does not follow the traditional pyramid and explain its alternative structure.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a structural features word bank and pre-divided sections on the extract.',
          core: "Students annotate independently using the teacher's model as a guide.",
          stretch:
            'Students analyse how the shift between sections is created - what specific moment marks the change and how does the writer signal it?',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide sentence starters for explaining effect: "This creates the effect of... because..."',
          core: 'Students identify and explain independently.',
          stretch:
            'Students explain how the language choices at this moment differ from the language used earlier in the extract and why the writer made this shift.',
        },
        resources: [
          'Extract (annotated from previous activity)',
          'Sentence starters card (support tier)',
        ],
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students create their own quiz questions for a partner using the new terminology.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a sentence frame: "I noticed that the writer used [feature] in the [section] which created the effect of..."',
        core: 'Students write independently.',
        stretch:
          'Students answer the exit question in writing, connecting structure analysis to deeper understanding of meaning.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          "Why do writers make structural choices? Give one example of how a structural choice can affect the reader's experience.",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "Choose one moment from today's extract where language and structure work together to create effect. Analyse how they work together using evidence.",
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 12: Reading & Discussion - Poetry: Language and Structure ────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students explain why poets might choose specific sounds - what is the relationship between sound and meaning?',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            "Students identify the volta (turn or shift) in the poem and explain how the poem's meaning changes at that point.",
        },
        resources: [
          'Poem (printed copies, double-spaced for annotation)',
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students propose a third interpretation of their own and defend it with evidence.',
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students include two interpretations within their paragraph, using "however" or "alternatively" to introduce the second.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students must provide an example from the poem as well as crossing off the technique.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Define enjambment and caesura. Explain the effect each might have on the reader.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Why is it important to consider more than one interpretation of a poem? How does this strengthen your analysis?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "Choose one image from the poem studied today. Write a paragraph analysing how it contributes to the poem's meaning. Consider more than one interpretation.",
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 13: Writing - Analytical Essay on Poetry ────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write an introduction that includes a conceptual opening - starting with a broader idea about poetry or the theme before narrowing to the specific poem.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Students copy and annotate with teacher guidance, focusing on identifying where language and structure analysis each appear.',
          core: 'Students annotate independently and plan how to apply the same integration in their own paragraph.',
          stretch:
            'Students evaluate the model and suggest how the integration of language and structure could be made even more seamless.',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a writing frame with sentence starters for each paragraph section and a terminology bank.',
          core: 'Students write independently using the progress guide.',
          stretch:
            "Students aim for three analytical paragraphs and a conclusion that offers a final evaluative judgement about the poet's success.",
        },
        resources: [
          'Poem text',
          'Writing frame (support tier)',
          'Terminology bank',
          'Progress guide slide',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Students check against the terminology bank to identify terms they could have included.',
        core: 'Students self-assess their terminology usage and set a target.',
        stretch:
          'Students check whether their terminology is used accurately - not just present but correctly applied.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'Explain how you can analyse both language and structure within the same paragraph. Give a brief example.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "Write a conclusion for your essay that summarises your argument and offers a final evaluation of the poet's techniques.",
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 14: Application - Reading to Writing Transfer ───────────────────
  {
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            "Students identify the poet's or writer's overall intention and how language and structure work together to achieve it.",
        },
        resources: [
          'Unseen text (printed copies, double-spaced)',
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a planning template and writing frame. Allow access to the strategy card and terminology bank.',
          core: 'Students plan and write independently.',
          stretch:
            'Students aim for three paragraphs and a conclusion, with at least one paragraph integrating both language and structure analysis.',
        },
        resources: [
          'Exercise books or lined paper',
          'Planning template (support tier)',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a self-assessment grid with the criteria pre-printed and space for traffic lighting.',
        core: 'Students self-assess and write specific, actionable targets.',
        stretch:
          'Students compare their response to this unseen text with their Lesson 13 essay - what skills transferred well and what was harder without familiarity?',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'What is the difference between analysing a studied text and an unseen text? What makes unseen texts more challenging?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "Write one analytical paragraph about a technique used in today's unseen text. Embed a quotation and explain its effect.",
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 15: Assessment - Shaping Meaning Extended Response ──────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a planning template. Allow access to a terminology bank but not to writing frames.',
        core: 'Students plan independently.',
        stretch:
          'Students plan a response that integrates analysis of how language and structure work together at key moments.',
      },
      resources: [
        'Assessment text (unseen, printed copies)',
        'Planning template (support tier)',
        'Terminology bank (support tier)',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students aim for three paragraphs with integrated language and structure analysis, plus a conceptual introduction and evaluative conclusion.',
        },
        resources: [
          'Lined paper or exercise books',
          'Assessment text',
          'Terminology bank (support tier only)',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a letter to their Year 8 self giving advice about how to succeed in English.',
      },
    },
    homework: 'No homework. Enjoy the break and read something for pleasure over the holidays.',
    worksheetQuestions: [
      {
      ...
      {
        question:
          'Identify two language techniques and two structural features in the assessment text. Name each and provide the evidence.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          "Which technique do you think is most effective in shaping the reader's response? Write a paragraph explaining why.",
        lines: 8,
        modelAnswer:
  ...
  // ── Lesson 16: Explicit Reading - Introducing Dystopia and Power ────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a definition of dystopia on the table and discuss each scenario as a guided class activity.',
        core: 'Students discuss independently and articulate their reasoning.',
        stretch:
          'Students consider: what makes dystopian fiction compelling? Why do we enjoy reading about terrible societies?',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            "Students analyse the narrative perspective - how does Katniss's first-person voice shape our understanding of the power dynamics?",
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a partially completed concept map with guiding labels and one quotation as a model.',
          core: 'Students create the concept map independently with quotation evidence.',
          stretch:
            'Students add a branch for "Resistance" - how does Katniss challenge or resist the power structure, even subtly?',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a pre-printed vocabulary sheet with definitions; students add the examples.',
          core: 'Students record definitions and both examples independently.',
          stretch:
            'Students identify which vocabulary words could apply to other texts they have studied and explain the connections.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a sentence starter: "Collins makes the reader feel the society is unjust by..."',
        core: 'Students write independently using at least one keyword from the lesson.',
        stretch:
          'Students explain why Collins chose to write a dystopian novel rather than a factual text about inequality.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'How does Collins create tension during the Reaping scene? Use a quotation to support your answer.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'What connections can you make between the power structures in The Hunger Games and real-world examples of inequality? Explain one connection.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 17: Reading & Discussion - Power, Oppression, and Resistance ────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students position themselves in the middle and explain the complexity - why both sides have merit.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide the four types with example quotations for the first type; students complete the rest.',
          core: 'Students identify evidence for all four types independently.',
          stretch:
            'Students rank the types of resistance from most to least effective in the novel and prepare to defend their ranking in the debate.',
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            "Students deliver rebuttals that directly engage with and dismantle the opposing team's arguments.",
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students evaluate whether fiction like The Hunger Games can inspire real-world change.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students explain how their quotation connects to a specific aspect of social justice.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          "What are the four types of resistance discussed in today's lesson? Give an example from the text for each.",
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'Why might Collins have chosen to present Katniss as a reluctant rebel rather than a deliberate revolutionary? What effect does this have on the reader?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Connect one theme from The Hunger Games to a real-world issue. Explain the connection and why you think Collins included this theme.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 18: Writing - Social Justice Analytical Writing ─────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a topic sentence formula: "[Author] presents [theme] as [argument] through [method]."',
        core: 'Students rewrite independently and compare with the models.',
        stretch:
          'Students write their own topic sentence for their first analytical paragraph, ready for the main activity.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Students copy and annotate with teacher guidance, focusing on identifying the topic sentence and conceptual vocabulary.',
          core: 'Students annotate independently and note techniques to replicate.',
          stretch:
            "Students evaluate the model's analysis - does it go deep enough? How could the significance be explored further?",
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a writing frame with sentence starters and a conceptual vocabulary bank.',
          core: 'Students write independently using the progress guide.',
          stretch:
            "Students write a third paragraph that evaluates Collins's overall success in presenting social inequality, considering why she chose the dystopian genre.",
        },
        resources: [
          'Exercise books',
          'Writing frame (support tier)',
          'Conceptual vocabulary bank',
          'Extracts from previous lessons',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students vary their subordinate clause positions (beginning, middle, end of sentence) for stylistic effect.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What makes a strong topic sentence? Rewrite this weak example: "The writer shows inequality."',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'What is a subordinate clause? Write a complex sentence about The Hunger Games that includes one.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Write an analytical paragraph about how Collins uses the character of Effie Trinket to highlight inequality. Use conceptual vocabulary and embed a quotation.',
        lines: 8,
        modelAnswer:
  ...
  // ── Lesson 19: Application - Comparative Social Justice Analysis ───────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students consider whether the most effective approach might combine elements of both fiction and non-fiction.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide an annotation guide with specific techniques to look for in non-fiction.',
          core: 'Students annotate independently and identify differences.',
          stretch:
            'Students evaluate which techniques are most effective in the non-fiction text and why.',
        },
        resources: [
          'Non-fiction text (printed copies)',
          'Non-fiction annotation guide (support tier)',
        ],
      },
      {
        ...
        differentiation: {
          ...
          core: 'Students plan and write independently.',
          stretch:
            'Students write a sophisticated evaluative conclusion that considers how the two texts serve different but complementary purposes in raising awareness of inequality.',
        },
        resources: [
          'Both texts',
          'Planning template (support tier)',
          'Comparison connectives sheet',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          "Students rewrite their partner's weakest paragraph to demonstrate how it could be improved.",
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What are the key differences between how fiction and non-fiction present a theme like inequality?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Write an evaluative paragraph comparing the effectiveness of the two texts in conveying a message about inequality.',
        lines: 8,
        modelAnswer:
  ...
  // ── Lesson 20: Assessment - Social Justice Extended Essay ──────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        core: 'Students plan independently.',
        stretch:
          'Students plan a response with a conceptual introduction and evaluative conclusion that considers the significance of the novel beyond its story.',
      },
      resources: [
        'Assessment question slide',
        'Planning template (support tier)',
        'Vocabulary bank (support tier)',
        'Clean extract copies',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Introduction + three paragraphs + evaluative conclusion. Integrated language-structure analysis throughout.',
        },
        resources: [
          'Lined paper or exercise books',
          'Clean text extracts',
          'Vocabulary bank (support tier only)',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        core: 'Students reflect independently.',
        stretch:
          'Students write a recommendation: should The Hunger Games be studied in schools to teach about social justice? Why or why not?',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is your thesis - your main argument - about how Collins presents power and inequality?',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'List three conceptual vocabulary words you plan to use in your essay and write a sentence using each.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'After completing your essay, rate your confidence in each success criterion (1-5) and explain one area you want to improve.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 21: Explicit Reading - Introduction to Conflict Poetry ──────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students consider why different people might respond to the same image with very different words - what does this tell us about perspective?',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            "Students compare the poets' intentions - are both anti-war, or does one present a more complex view?",
        },
        resources: [
          'Two conflict poems (printed copies)',
          'Historical context information sheet',
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students consider how the quotation would have been received by its original audience compared to a modern reader.',
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students explain how their response might differ from someone reading the poem when it was first published.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students consider whether a poem can be fully understood without knowing its context.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is "juxtaposition"? Give an example from one of the conflict poems studied today.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "Why might a poet use irony when writing about war? Give an example from today's lesson.",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Choose one quotation from either poem. Write a paragraph analysing how it presents the reality of conflict.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 22: Reading & Discussion - Shakespeare and Conflict ─────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a glossary with all difficult words defined and a partially completed translation.',
        core: 'Students use the glossary to translate independently.',
        stretch:
          'Students attempt to translate before checking the glossary, using context clues alone.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a heavily glossed extract with modern English paraphrase alongside the original.',
          core: 'Students use the standard glossary and annotate independently after the modelled analysis.',
          stretch:
            'Students analyse the verse form - how does Shakespeare use iambic pentameter or shifts to prose to convey meaning?',
        },
        resources: [
          'Shakespeare extract (with marginal glossary)',
          'Heavily glossed version (support tier)',
        ],
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Groups consider how the historical and cultural contexts differ and whether this changes the meaning of shared themes.',
        },
        resources: [
          'Comparison grid handout',
          'Shakespeare extract and conflict poems for reference',
        ],
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students perform and then explain the reasoning behind their performance choices - why did they emphasise specific words?',
        },
    ...
    worksheetQuestions: [
      {
        question:
          "What is a soliloquy? Why might Shakespeare use a soliloquy to explore a character's feelings about conflict?",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Identify one similarity and one difference between how Shakespeare and a modern conflict poet present the theme of power.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Choose one quotation from the Shakespeare extract. Explain what it means in your own words and analyse how the language creates a specific effect.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 23: Writing - Comparative Essay: Poetry and Shakespeare ─────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a sentence frame with the semi-colon position marked: "[Text A point]; [Text B contrast]."',
        core: 'Students write three semi-colon sentences independently.',
        stretch:
          'Students use the semi-colon within a complex sentence that also contains a subordinate clause.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students suggest how the model could be improved - is there a deeper comparison or a more nuanced argument?',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a writing frame with sentence starters and a terminology bank covering both poetry and drama terms.',
          core: 'Students write independently using the progress guide.',
          stretch:
            'Students write a third paragraph comparing how the different forms (lyric poetry vs. dramatic verse) shape the presentation of conflict, and an evaluative conclusion.',
        },
        resources: [
          'Exercise books',
          'Writing frame (support tier)',
    ...
    worksheetQuestions: [
      {
        question:
          'What does "integrated comparison" mean? How is it different from writing about each text separately?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Write a semi-colon sentence comparing how the conflict poem and the Shakespeare extract present the theme of power.',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'Why does comparing texts from different literary forms (poetry and drama) deepen our understanding of a shared theme?',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 24: Application - Guided Independent Comparison ─────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students identify how this poem connects to and differs from the other conflict poems studied in the unit.',
      },
      resources: [
        'New conflict poem (printed, double-spaced)',
        'Shakespeare extract (from Lesson 22)',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students plan a response with a nuanced thesis that acknowledges both similarities and differences in how the texts treat conflict.',
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Teacher provides brief verbal prompts if students are stuck, and allows access to the terminology bank.',
          core: 'Students write independently.',
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students make two improvements and explain how each one strengthens their essay.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Teacher speaks briefly with students who rated themselves low to discuss specific support.',
    ...
    worksheetQuestions: [
      {
        question:
          'List five key terms you should use in a comparative essay on conflict poetry and Shakespeare.',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'What is the most important thing to remember when writing an integrated comparison?',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'Write the opening sentence of a comparison paragraph that addresses both the new poem and the Shakespeare extract.',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 25: Assessment - Comparative Conflict Analysis ──────────────────
  {
    ...
    starterActivity: {
      ...
      resources: [
        'Assessment texts (printed, clean copies)',
        'Terminology bank (support tier only)',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Three integrated paragraphs + contextual analysis + evaluative conclusion. Semi-colon sentences throughout.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        core: 'Students reflect independently.',
        stretch:
          'Students write a recommendation for which texts should be studied next year and why.',
      },
    },
    homework: 'No homework. Read for pleasure over the break.',
    worksheetQuestions: [
      {
        question:
          'Write your thesis statement for this essay - one sentence that captures your main argument about how conflict is presented across both texts.',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'After completing your essay, identify one paragraph you are proud of and explain why it demonstrates strong comparative analysis.',
        lines: 5,
        modelAnswer:
  ...
  // ── Lesson 26: Explicit Reading - Dickens, Context, and Character ──────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students consider: why might Dickens have chosen fiction rather than non-fiction to campaign for social change?',
      },
      resources: [
        'Gallery walk stations (printed images/facts, x6)',
        'Recording sheet (support tier)',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            "Students analyse Dickens's narrative voice - how does the narrator's tone towards Scrooge guide the reader's response?",
        },
        resources: [
          'A Christmas Carol Stave One extract (printed copies)',
          'Annotation prompts (support tier)',
        ],
      },
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a sentence starter: "Knowing about Victorian society changes my reading because..."',
        core: 'Students write independently.',
        stretch:
          "Students consider whether the novel's message about poverty is still relevant today and why.",
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          'What is an allegory? How might A Christmas Carol be read as an allegory for Victorian society?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Choose one quotation from the opening that presents Scrooge negatively. Analyse the language and explain what Scrooge symbolises.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 27: Reading & Discussion - Themes of Redemption and Responsibility
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          "Students consider what the speed of Scrooge's transformation tells us about Dickens's view of human nature.",
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide the grid with stave summaries and one quotation per stave already filled in.',
          core: 'Students complete the grid independently using their knowledge and the text.',
          stretch:
            "Students analyse Dickens's structural choice of five staves - how does this mirror a five-act play and why?",
        },
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide three pre-prepared talking points with quotation evidence that students can use.',
          core: 'Students prepare their own contributions and engage independently.',
          stretch:
            'Students draw on wider reading or knowledge of Victorian history to support their arguments.',
        },
        resources: [
          'Socratic seminar rules card',
          'Talking points (support tier)',
          'Text for reference',
        ],
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students present an argument and then a counter-argument within the same paragraph.',
        },
        resources: ['Exercise books'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students explain why their quotation is more important than any alternative and what would be lost without it.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          "What is the role of the three Ghosts in Scrooge's transformation? How does each one contribute to his redemption?",
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'What does Dickens mean by "social responsibility"? How does he present this idea through the novella?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Do you agree with Dickens that individuals can change society by changing themselves? Evaluate this idea using evidence from the text.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 28: Writing - GCSE-Style Analytical Writing on A Christmas Carol ─
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a conceptual introduction frame: "Dickens uses A Christmas Carol to [purpose], presenting [theme] as [concept] in order to [effect on reader/society]."',
        core: 'Students write independently after analysing the models.',
        stretch:
          'Students write an introduction that positions Dickens within the wider Victorian social reform movement.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Students copy, annotate with teacher guidance, and identify the three elements: text + analysis + context.',
          core: 'Students annotate independently and plan their own contextually integrated paragraph.',
          stretch:
            'Students evaluate whether the contextual integration is effective or whether it interrupts the analysis.',
        },
        resources: ['Visualiser or whiteboard'],
      },
      {
        ...
        differentiation: {
          support:
            'Provide a paragraph planning frame and contextual prompts. Allow access to key quotations list.',
          core: 'Students write independently using the progress guide.',
          stretch:
            "Students write a response that considers how Dickens's presentation of the theme changes across the novella - a developmental argument rather than a static one.",
        },
        resources: [
          'Exercise books',
          'Paragraph planning frame (support tier)',
          'Key quotations list (support tier)',
          'Text for reference',
        ],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students explain the difference between "bolt-on" and "integrated" context and why the latter is more effective.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'What is the difference between "bolt-on" context and "integrated" context in an essay? Give an example of each.',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'What is a "conceptual" argument? How is it different from a "descriptive" response to a text?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "Write a paragraph about Dickens's presentation of poverty that integrates contextual knowledge within the analysis.",
        lines: 8,
        modelAnswer:
  ...
  // ── Lesson 29: Application - Independent Analysis Practice ─────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students identify the specific differences between Level 3 and Level 4 and what they need to do to reach the top.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Allow access to the text and a key quotations prompt sheet. Minimum: introduction + two paragraphs.',
          core: 'Full independence with text access only. Introduction + three paragraphs.',
          stretch:
            'Introduction + three paragraphs + conclusion. Response should trace how the theme develops through the stave, not just identify techniques.',
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students identify one specific paragraph that best demonstrates Level 4 writing and explain why.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          "How does Dickens use the Ghost of Christmas Present to challenge Scrooge's worldview? Use a quotation to support your answer.",
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'After self-assessing, what is your main area for improvement? Write a specific, actionable target.',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 30: Assessment - A Christmas Carol Extended Essay ────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Plan a response that traces the development of the theme across the novella, with a nuanced thesis that acknowledges complexity.',
      },
      resources: [
        'Assessment question slide',
        'Text (clean copy)',
        'Key quotations prompt (support tier only)',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Allow access to key quotations prompt and text. Minimum: introduction + two paragraphs + conclusion.',
          core: 'Full independence with text. Introduction + three paragraphs + conclusion.',
          stretch:
            "Four paragraphs tracing the theme's development, with an evaluative conclusion that considers the text's lasting significance and Dickens's legacy.",
        },
        resources: [
          'Lined paper or exercise books',
          'Text (clean copy)',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a detailed reflection on how their analytical writing has evolved from simple PEE paragraphs in Year 7 to conceptual, contextualised analysis in Year 9.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'Write your thesis statement for this assessment - one sentence that captures your conceptual argument about how Dickens presents redemption.',
        lines: 3,
        modelAnswer:
      ...
      {
        question:
          'List three contextual points you will integrate into your analysis. For each, explain how it connects to the theme of redemption.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          'After completing your essay, rate your response against the GCSE criteria (Level 1-4) and justify your rating with specific reference to your writing.',
        lines: 4,
        modelAnswer:
