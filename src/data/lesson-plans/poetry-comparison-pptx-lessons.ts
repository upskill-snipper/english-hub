...
const lesson1: LessonPlanData = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support: "Provide the four types of power pre-printed on a card. Students match each type to one of the two poems after the teacher's introduction. Define: transience, tyranny, domestic power, irony.",
      core: "Students write their own definition and engage in the pair discussion independently.",
      stretch: "Students add a fifth type of power: the power of ART and WRITING to outlive political rulers. 'Ozymandias is forgotten, but Shelley's poem about him is immortal.' What does this suggest about poetry's relationship to power?",
    },
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: "Provide the four quotations on annotation cards with one guided question per quotation. Include a glossary: transience, irony, alliteration, sonnet, tyranny, hubris. Define 'Ozymandias' as the Greek name for Pharaoh Ramesses II.",
        ...
        stretch: "Students explore Shelley's political radicalism: he believed that all monarchies and empires would eventually fall. How does the poem function as a political statement as well as a literary one? Is Shelley predicting the fall of the British Empire?",
      },
    },
    {
      ...
      differentiation: {
        support: "Provide a character card explaining who the Duke is, who the Duchess was, and who he is speaking to. Highlight key lines in the anthology for students to focus on. Supply sentence starters for each question.",
        core: "Students answer all three questions independently using their anthology and write the key point.",
        stretch: "Students compare the Duke to a modern controlling partner. Is Browning's poem an early critique of coercive control? How does the dramatic monologue form (the victim has no voice; only the abuser speaks) mirror the power dynamic in abusive relationships?",
      },
    },
    {
  ...
  plenary: {
    ...
    differentiation: {
      support: "Provide sentence starters: 'I think [Ozymandias's / the Duke's] power is more dangerous because...'",
      core: "Students vote independently and justify with textual evidence.",
      stretch: "Students consider: which poem would be more effective as a warning to a modern audience? Why? What does each poem say about power that is still relevant today?",
    },
  },
  keyVocabulary: [
...
const lesson2: LessonPlanData = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support: "Provide sentence starters: 'An unwanted memory feels like... It arrives when... I cannot control it because...' Define: intrusive memory, PTSD, psychological trauma.",
      core: "Students write independently and contribute vocabulary to the board.",
      stretch: "Students consider the difference between CHOOSING to remember and being FORCED to remember. Which is more psychologically damaging? How might this distinction apply to a soldier vs a photographer?",
    },
  },
  mainActivities: [
    {
    ...
    },
    {
      ...
      differentiation: {
        support: "Provide a summary card explaining the poem's scenario: who, where, what he does, how he feels. Supply guided questions with line references and sentence starters.",
        core: "Students answer all three questions independently and contribute to the discussion.",
        stretch: "Students connect the poem to modern media: we see more images of conflict than ever before (social media, 24-hour news). Has exposure made us more empathetic or more numb? How would Duffy respond to the 'scroll past' culture of 2024?",
      },
    },
    {
      ...
      differentiation: {
        support: "Provide the planning grid pre-filled and a comparison scaffold with sentence starters for both poems. Students follow the scaffold for their chosen row.",
        core: "Students select a row and write a comparison point independently using the alternating structure.",
        stretch: "Students write TWO comparison points and link them with a thread sentence: 'While both poets explore the persistence of memory, the nature of the moral burden is fundamentally different...'",
      },
    },
  ],
  plenary: {
    ...
    differentiation: {
      support: "Provide sentence starters for justification: 'I think the soldier / photographer suffers more because...'",
      core: "Students vote and justify with a reference to a specific line or image from one of the poems.",
      stretch: "Students argue that the question misses the point — both poems are ultimately about the FAILURE of society to share the burden of conflict. The real accusation is directed at the reader, not at the sufferer.",
    },
  },
  keyVocabulary: [
...
const lesson3: LessonPlanData = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support: "Provide a printed exam format card that students can keep in their revision folder. Highlight the key instruction word: COMPARE. Explain that this means every paragraph must mention BOTH poems.",
      ...
      stretch: "Students calculate: if AO3 is only 6 marks, roughly how many sentences per essay should be context? (Answer: 3–4 well-placed sentences woven into analysis, not a separate paragraph.) This challenges the common practice of writing a 'context paragraph'.",
    },
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: "Provide the model paragraph pre-printed with the five components already colour-coded. Students match each colour to the correct label. Then identify the components in the weak paragraph (or notice their absence).",
        ...
        stretch: "Students rewrite the weak paragraph to make it strong, using the five-component structure. Then compare their rewrite with the model — is there more than one way to write a strong comparison paragraph?",
      },
    },
    {
    ...
    },
    {
      ...
      differentiation: {
        support: "Provide the five-component checklist printed at the top of the writing paper so students can refer to it while writing. Allow 14 minutes instead of 12. Teacher visits support-tier students at the 3-minute mark to check they have started with a topic sentence.",
        core: "Students write under timed conditions and self-assess against the checklist independently.",
        stretch: "Students write TWO comparison points in 12 minutes (simulating exam pace of ~4 minutes per paragraph). Self-assess both and identify which is stronger and why.",
      },
    },
  ],
  plenary: {
    ...
    differentiation: {
      support: "Provide a list of six tips. Students choose their top three and write them on their sticky note.",
      core: "Students write three tips from memory based on today's lesson.",
      stretch: "Students write three tips AND one personal target based on their timed writing performance: 'The specific thing I need to improve is...'",
    },
  },
  keyVocabulary: [
...
export const poetryComparisonPptxLessons: LessonPlanData[] = [
  lesson1,
  lesson2,
  lesson3,
]
