...
const lesson1: LessonPlan = {
  ...
  keywords: [
    'prologue', 'sonnet', 'iambic pentameter', 'fate',
    'star-crossed', 'foreshadowing', 'dramatic irony', 'tragedy',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a definition of "star-crossed" and a sentence starter: "This phrase suggests the lovers will..."',
      core: 'Students discuss and record their interpretation independently before feedback.',
      stretch: 'Students consider how the concept of fate in Elizabethan England differs from modern ideas of free will and choice.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-annotated version with the rhyme scheme marked; students focus on vocabulary and meaning.',
        core: 'Students annotate independently, identifying both structural features and key language choices.',
        stretch: 'Students compare the Prologue sonnet to a Petrarchan sonnet and evaluate why Shakespeare chose his own form.',
      },
      resources: ['Prologue text handout', 'Sonnet structure reference sheet', 'Coloured highlighters'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a completed first row of the table and sentence starters for the paragraph: "Shakespeare presents fate as..."',
        core: 'Students complete the table and write a full PEE paragraph independently.',
        stretch: 'Students write a second paragraph evaluating whether the Prologue suggests the lovers have any agency or are entirely controlled by fate.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Sentence starter: "Shakespeare reveals the ending because he wants the audience to..."',
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Analyse the phrase "star-crossed lovers" and explain what it reveals about the play.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why might Shakespeare have chosen to write the Prologue as a sonnet rather than in blank verse?',
      lines: 6,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  keywords: [
    'feud', 'patriarchy', 'honour', 'juxtaposition',
    'shared sonnet', 'courtly love', 'Petrarchan', 'dramatic tension',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students consider how the servants\' language mirrors the behaviour of their masters and what this suggests about the feud\'s reach.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-completed row of the comparison table; students complete the remaining rows with guidance.',
        core: 'Students complete the comparison table independently and write a summary sentence for each row.',
        stretch: 'Students link the Prince\'s role to the Elizabethan concept of the monarch as God\'s representative and the Great Chain of Being.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide a glossary of religious terms and a paragraph frame with sentence starters.',
        core: 'Students write a full PEE paragraph independently, embedding quotations.',
        stretch: 'Students evaluate whether the religious language elevates their love or foreshadows its sacrificial end.',
      },
      resources: ['Act 1, Scene 5 extract', 'Sonnet annotation guide', 'PEE paragraph frame (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Students can refer to their notes and use a sentence frame: "I think Shakespeare is more interested in... because..."',
      core: 'Students justify their position with a specific quotation.',
      stretch: 'Students argue that both are equally important and explain how they are interconnected.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Analyse the significance of Romeo and Juliet sharing a sonnet in their first meeting.',
      lines: 6,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  keywords: [
    'soliloquy', 'imagery', 'celestial', 'Petrarchan conventions',
    'patriarchy', 'subversive', 'clandestine', 'dramatic irony',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a modern English paraphrase and a sentence starter: "Juliet is arguing that..."',
      core: 'Students explain Juliet\'s argument in their own words and consider whether they agree.',
      stretch: 'Students evaluate whether Juliet\'s argument is idealistic or radical, and what it reveals about her character.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-annotated text highlighting key imagery; students focus on explaining effects.',
        core: 'Students annotate independently and write a full PEE paragraph with embedded quotations.',
        stretch: 'Students compare Romeo\'s language here to his earlier descriptions of Rosaline and evaluate what the difference reveals about the nature of his love.',
      },
      resources: ['Act 2, Scene 2 extract (Romeo\'s soliloquy)', 'Petrarchan conventions reference card', 'Annotation guide'],
    },
    {
      ...
      differentiation: {
        support: 'Provide the character analysis grid with one completed example and sentence starters for the paragraph.',
        core: 'Students complete the grid and paragraph independently.',
        stretch: 'Students evaluate whether Juliet\'s agency is empowering or ultimately contributes to her tragic end.',
      },
      resources: ['Act 2, Scene 2 extract (Juliet\'s lines)', 'Character analysis grid', 'Elizabethan gender roles reference card'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students consider the role of Friar Lawrence and evaluate his motivations for agreeing to the marriage.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Why does Shakespeare have Romeo and Juliet marry in secret? What is the dramatic purpose?',
      lines: 5,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  keywords: [
    'foil', 'catalyst', 'masculinity', 'honour',
    'hot-blooded', 'peripeteia', 'dramatic function', 'curse',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students consider how these attitudes connect to the feud and whether the feud creates toxic masculinity or vice versa.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a partially completed character profile with quotations supplied; students explain their significance.',
        core: 'Students complete profiles independently, selecting their own quotations from the text.',
        stretch: 'Students evaluate which character is more responsible for the tragedy and justify their answer.',
      },
      resources: ['Character profile worksheet', 'Act 1 and Act 3 extracts', 'Venn diagram template'],
    },
    {
      ...
      differentiation: {
        ...
        stretch: 'Students evaluate whether Romeo is right to call himself "fortune\'s fool" or whether his choices, not fate, cause the tragedy.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students argue that the ranking itself is impossible because Shakespeare deliberately makes blame ambiguous.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Explain the significance of Romeo\'s exclamation "O, I am fortune\'s fool!" after killing Tybalt.',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  keywords: [
    'peripeteia', 'banishment', 'exile', 'dramatic structure',
    'tragic momentum', 'hamartia', 'catharsis', 'climax',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students compare this structure to another Shakespeare tragedy they know and identify a similar turning point.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a modern English paraphrase and a list of the oxymora with definitions. Students explain the effect of two examples.',
        core: 'Students identify the oxymora independently and write a full analytical paragraph.',
        stretch: 'Students evaluate whether Juliet\'s choice to side with Romeo over Tybalt represents strength or the beginning of her tragic downfall.',
      },
      resources: ['Act 3, Scene 2 extract', 'Oxymoron definition card', 'Paragraph frame (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide both quotations side-by-side with key words highlighted; students explain the contrast.',
        core: 'Students select their own quotations from both scenes and write a comparative paragraph.',
        stretch: 'Students evaluate whether Romeo\'s extreme reaction to banishment foreshadows his impulsive decision to take his own life in Act 5.',
      },
      resources: ['Act 3, Scene 3 extract', 'Comparison table template', 'Act 2, Scene 2 extract for reference'],
    },
  ],
  plenaryActivity: {
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Evaluate whether Romeo\'s banishment or his impulsiveness is more responsible for the tragedy.',
      lines: 6,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  keywords: [
    'patriarchy', 'filial duty', 'obedience', 'agency',
    'isolation', 'defiance', 'arranged marriage', 'dramatic irony',
  ],
  starterActivity: {
    title: 'Obey or Defy?',
    duration: '7 minutes',
    ...
    differentiation: {
      support: 'Provide a simplified scenario with clear options and a sentence starter for discussion.',
      core: 'Students discuss independently and consider the social consequences.',
      stretch: 'Students compare Elizabethan expectations of filial obedience with modern attitudes and consider what Shakespeare\'s audience would have thought of Juliet.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students compare Capulet\'s behaviour here with his earlier protectiveness in Act 1, Scene 2 ("my child is yet a stranger in the world") and evaluate why he changes.',
      },
      resources: ['Act 3, Scene 5 extract', 'Annotation guide', 'Scaffolded paragraph (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a pre-drawn diagram with character names; students add quotations and explanations.',
        core: 'Students create the diagram from scratch, selecting their own quotations.',
        stretch: 'Students evaluate whether the Nurse\'s betrayal or Capulet\'s threats is the more significant moment of abandonment, and justify their answer.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Sentence starter: "I am alone now. My father has... My mother has... The Nurse has... I must..."',
  ...
  worksheetQuestions: [
    {
      question: 'How does Shakespeare present Lord Capulet as a threatening figure in Act 3, Scene 5?',
      lines: 6,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  keywords: [
    'catharsis', 'denouement', 'pathos', 'resolution',
    'sacrifice', 'reconciliation', 'tragic waste', 'didactic',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a modern English paraphrase and a clear question: "What had to happen before the feud could end?"',
      core: 'Students discuss the moral implications of the line independently.',
      stretch: 'Students consider whether Shakespeare is criticising the parents, society, or fate — or all three.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students compare the brevity of Juliet\'s death (three lines) with Romeo\'s longer speech and evaluate why Shakespeare gives them different amounts of stage time.',
      },
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch: 'Students evaluate whether the play is ultimately didactic (teaching a moral lesson) or nihilistic (suggesting that nothing meaningful has been learned).',
      },
      resources: ['Prince\'s final speech extract', 'Debate preparation sheet', 'Argument cards (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students write two alternative couplets — one optimistic, one pessimistic — and evaluate which better fits Shakespeare\'s intentions.',
    },
  },
  homework:
...
const lesson8: LessonPlan = {
  ...
  keywords: [
    'Petrarchan love', 'courtly love', 'unrequited', 'infatuation',
    'transcendent', 'destructive', 'familial love', 'fraternal love',
  ],
  starterActivity: {
    title: 'Types of Love',
    duration: '8 minutes',
    ...
    differentiation: {
      ...
      stretch: 'Students identify types of love that overlap or conflict (e.g., familial duty vs romantic love) and explain the tension.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide both extracts with key language pre-highlighted and a comparison table with one completed row.',
        core: 'Students complete the table independently and write a full comparative paragraph.',
        stretch: 'Students evaluate whether Shakespeare is criticising Petrarchan love poetry itself, and consider the metafictional implications.',
      },
      resources: ['Act 1 Rosaline quotations', 'Act 2 Juliet quotations', 'Comparison table', 'Petrarchan conventions reference'],
    },
    {
      ...
      differentiation: {
        ...
        stretch: 'Students evaluate whether Shakespeare presents love as a force that transcends death (the lovers are reunited) or one that is defeated by it.',
      },
      resources: ['Timeline template', 'Quotation cards (support tier)', 'Play text for quotation hunting'],
    },
  ],
  plenaryActivity: {
    title: 'Love on Trial',
    ...
    differentiation: {
      ...
      stretch: 'Students argue that the question itself is too simplistic and offer a more nuanced reading.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'How does Shakespeare differentiate between Romeo\'s love for Rosaline and his love for Juliet?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Evaluate whether Shakespeare presents love as a positive or destructive force in the play.',
      lines: 6,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  keywords: [
    'conflict', 'feud', 'vendetta', 'escalation',
    'toxic masculinity', 'internal conflict', 'civil disorder', 'consequence',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students argue that all three types of conflict are interconnected and explain how one leads to another.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-completed comparison table for one scene; students complete the second.',
        core: 'Students complete the comparison independently and write a full paragraph.',
        stretch: 'Students link the escalation of violence to Elizabethan anxieties about civil disorder and the breakdown of social order.',
      },
      resources: ['Act 1, Scene 1 extract', 'Act 3, Scene 1 extract', 'Comparison table', 'Prince\'s speeches extract'],
    },
    {
      ...
      differentiation: {
        support: 'Provide key quotations with annotations; students explain the internal conflict in their own words.',
        core: 'Students find their own quotations and write a full comparative paragraph.',
        stretch: 'Students evaluate which character\'s internal conflict is more complex and why, considering the role of gender expectations.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students evaluate whether the play\'s message about conflict is still relevant today and explain why.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'How does Shakespeare use Romeo\'s internal conflict in Act 3, Scene 1 to develop the tragedy?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'What is Shakespeare\'s authorial intention in presenting the consequences of conflict?',
      lines: 6,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  keywords: [
    'PEE/PEEL', 'embedded quotation', 'topic sentence', 'analytical verb',
    'assessment objectives', 'mark scheme', 'evaluation', 'authorial intention',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students identify which points will score the highest AO2 and AO3 marks and prioritise accordingly.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a paragraph frame for each section with sentence starters and a quotation bank.',
        core: 'Students write independently, using their own quotations and analysis.',
        stretch: 'Students aim to include a counter-argument or alternative interpretation in at least one paragraph.',
      },
      resources: ['Essay paper/exercise books', 'Planning template', 'Paragraph frame (support tier)', 'Quotation bank (support tier)', 'Timer displayed on board'],
    },
    {
      ...
      differentiation: {
        support: 'Provide example WWW and EBI statements as models; students adapt them to their partner\'s work.',
        core: 'Students assess independently using the mark-scheme grid.',
        stretch: 'Students write a short paragraph explaining which assessment objective their partner\'s essay is strongest on and which needs most development, with specific line references.',
      },
      resources: ['Simplified mark-scheme grid', 'WWW/EBI feedback sheet', 'Example feedback models (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students write a revised version of their weakest paragraph incorporating their improvement target.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Write an analytical paragraph responding to: "How does Shakespeare present fate in the Prologue?"',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Write an analytical paragraph responding to: "How does Shakespeare use Juliet\'s character to explore the theme of defiance?"',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Write an analytical paragraph responding to: "How does Shakespeare present violence as destructive in Act 3, Scene 1?"',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'List five key quotations from Romeo and Juliet that you could use in any essay, and briefly explain the significance of each.',
      lines: 10,
      modelAnswer:
