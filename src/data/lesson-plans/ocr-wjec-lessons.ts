...
export const ocrWjecLessons: LessonPlan[] = [
  ...
  // ── 1. OCR Language Component 1: Exploring Non-Fiction & Media Texts ────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide a purpose/audience matching grid with definitions of each purpose.',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students create their own example sentence for each term they cross off.',
      },
    },
    homework:
  ...
  // ── 3. OCR Literature: Poetry Across Time - Conflict Poems ─────────────
  {
    ...
    worksheetQuestions: [
      ...
      {
        question: "What is a 'volta' and how might a poet use it in a conflict poem?",
        lines: 3,
        modelAnswer:
  ...
  // ── 4. OCR Literature: 19th Century Novel Study Approaches ─────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: "Provide a brief glossary card explaining each statement's historical background.",
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: ['Novel events timeline (displayed/printed)', 'Prompt cards (support tier)'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students rewrite one paragraph incorporating the feedback before handing in.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Explain one feature of Victorian literary conventions evident in this extract.',
        lines: 4,
        modelAnswer:
  ...
  // ── 5. OCR Exam Technique: Maximising Marks Across All Components ──────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide a simplified OCR paper overview sheet to refer to during the quiz.',
      ...
      resources: ['Quiz slides', 'OCR paper overview sheet (support tier)', 'Mini-whiteboards'],
    },
    mainActivities: [
      {
        ...
        resources: ['Command words display slide', 'Cheat sheet template', 'AO reference card'],
      },
      {
  ...
  // ── 6. WJEC Language Component 1: 20th Century Literature Reading ──────
  {
    ...
    mainActivities: [
      {
        title: "The WJEC 'Tracking' Question - Reading Through the Extract",
        duration: '25 minutes',
        instructions:
  ...
  // ── 7. WJEC Language Component 2: Non-Fiction & Transactional Writing ──
  {
    ...
    starterActivity: {
      ...
      resources: ['Writing prompts slide', 'Format features reference card (support tier)'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Display simplified WJEC mark scheme criteria on the board for reference.',
    ...
    worksheetQuestions: [
      ...
      {
        question: 'How does WJEC Component 2 differ from Component 1 in terms of what is assessed?',
        lines: 4,
        modelAnswer:
  ...
  // ── 8. WJEC Literature Component 1: Shakespeare & Poetry ──────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students calculate a time plan for the paper and explain their reasoning.',
      },
      resources: ['Paper structure slide', 'Mini-whiteboards', 'Reference card (support tier)'],
    },
    mainActivities: [
      {
  ...
  // ── 9. WJEC Literature Component 2: Post-1914 Prose & Drama ───────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: ['Essay question slide', 'Planning template', 'Quotation bank (support tier)'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support: 'Provide the comparison table partially completed for students to finish.',
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Why are stage directions important when analysing a drama text?',
        lines: 4,
        modelAnswer:
  ...
  // ── 10. WJEC Exam Strategy: Understanding Welsh-Specific Requirements ──
  {
    ...
    worksheetQuestions: [
      {
        question: 'Explain three ways in which WJEC English exams differ from AQA or OCR exams.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'What is the difference between WJEC and Eduqas, and why does it matter?',
        lines: 4,
        modelAnswer:
