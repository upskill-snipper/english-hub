...
export const inspectorCallsLessonPlans: LessonPlan[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: [
        "Printed extract of opening stage directions",
        "Highlighters"
      ]
    },
    mainActivities: [
      ...
      },
      {
        ...
        resources: [
          ...
          "Success criteria checklist on board"
        ]
      }
    ],
    plenaryActivity: {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: [
          ...
          "Self-assessment checklist on board"
        ]
      }
    ],
    plenaryActivity: {
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: [
          "Five quotation cards",
          "Analysis frame worksheet",
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: "Allow students to prepare their argument in writing for 1 minute before speaking.",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: [
          "Quotation assignment cards",
          "Guided questions (support)"
        ]
      },
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: "Allow students to choose from a list of five suggested words rather than generating their own.",
    ...
    worksheetQuestions: [
      ...
      {
        question:
          "How does Priestley use Eric to critique the upper-middle class?",
        lines: 8,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: "Students follow along on their printed copy and identify the three most powerful moments.",
    ...
    mainActivities: [
      {
        ...
        resources: [
          "Side-by-side speech extract worksheet",
          "Comparison grid",
          "Highlighters"
        ]
      },
      ...
      },
      {
        ...
        resources: [
          "Sentence starters and quotation bank (support)",
          "Lined paper"
        ]
      }
    ],
  ...
  // ─────────────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: "Provide a sentence frame: 'Priestley's message about social responsibility is that...'",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          "Provide the pyramid template with two characters already placed as models.",
    ...
    mainActivities: [
      {
        ...
        resources: [
          "Four-quadrant analysis worksheet",
          "Quotation bank (support)"
        ]
      },
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: "Provide a sentence frame: 'This headline connects to the play because Priestley shows that...'",
