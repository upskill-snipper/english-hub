...
export const christmasCarolLessons: LessonPlan[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide three possible purpose statements - students select and improve the best one.',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: ['Stave 1 extract (counting house passage)', 'Two-column table template'],
      },
      {
    ...
    worksheetQuestions: [
      ...
      {
        question: "Explain the effect of the simile 'solitary as an oyster'.",
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide question prompts for the audience and response starters for the hot seat.',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Explain the significance of Tiny Tim in A Christmas Carol.',
        lines: 6,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    worksheetQuestions: [
      ...
      {
        question: "Why does Dickens include the scene with the thieves at Old Joe's shop?",
        lines: 6,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide three possible first actions - students rank them in order of likelihood.',
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide argument cards with evidence for each side. Students select and present.',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide the five themes in circles - students draw connecting lines and label them.',
    ...
    worksheetQuestions: [
      ...
      {
        question: 'How does Dickens present the theme of poverty in the novella?',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'What role does the theme of Christmas play in A Christmas Carol?',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Choose two themes and explain how they are connected in the novella.',
        lines: 6,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Gothic convention bingo cards', 'Extract cards (teacher reads aloud)'],
    },
    mainActivities: [
      {
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide three reasons with evidence - students select two and explain in their own words.',
    ...
    worksheetQuestions: [
      {
        question: "What is Marley's chain made of, and what does it symbolise?",
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Compare the appearance and effect of any two of the three Ghosts of Christmas.',
        lines: 8,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch: "Add a third column: 'Effect on reader' for each pair.",
      },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a checklist of Grade 8/9 features - students tick off which are present in each paragraph.',
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: ['Exam paper (printed)', 'Lined paper', 'Quotation bank (support tier only)'],
      },
      {
