...
const lesson1: LessonPlan = {
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students rank questions by difficulty and create a personal priority order with justification.',
      },
      resources: [
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students write two paragraphs and self-assess against the Level 3 descriptors from the mark scheme.',
      },
      resources: [
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students add a fourth element: one piece of advice they would give to a Year 9 student about Paper 1.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'List the five questions on Edexcel Language Paper 1 and state the mark allocation for each.',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'Identify two language features you might analyse in a Q2 response and explain why they are effective.',
      lines: 5,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students rank the formats by difficulty and explain which they find most challenging and why.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a model opening sentence for Q5 that demonstrates an explicit comparison structure.',
      },
      resources: [
    ...
    },
    {
      ...
      differentiation: {
        support:
          "Provide a format template with structural prompts (e.g. 'Dear...', headline, subheading).",
        core: 'Students choose their format and write independently, using a conventions checklist.',
        stretch:
          'Students write openings in both formats and evaluate which is more effective for the given purpose.',
      },
      resources: [
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Bonus questions requiring students to explain why a particular strategy works for a specific question.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'How does the structure of Paper 2 differ from Paper 1? Explain the key differences.',
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'List four conventions of a formal letter that you would need in a Paper 2 writing response.',
      lines: 4,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students rewrite one sentence from their paragraph to move it from Level 4 to Level 5.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        "What does the word 'If' at the start of Macbeth's soliloquy in Act 1, Scene 7 reveal about his state of mind?",
      lines: 4,
      modelAnswer:
    ...
    {
      question:
        'Explain why Shakespeare uses the soliloquy form in this extract. How does it affect the audience?',
      lines: 5,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students explain what Dickens is trying to teach the reader through this transformation and link to Victorian context.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students add a column evaluating how effective each character is as a vehicle for Dickens's message, ranking them with justification.",
      },
      resources: [
...
const lesson5: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students rank the 'Both' quotations by importance and explain which best encapsulates the play's central tension.",
    },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students write two questions testing different AOs and identify which AOs each question targets.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Why is Act 3, Scene 1 considered the turning point of the play? Explain in terms of love and conflict.',
      lines: 6,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students annotate the poems directly, identifying patterns and shifts in tone that the grid cannot capture.',
      },
      resources: [
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students write a second sentence that challenges or nuances their first comparison.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        "What does 'integrated comparison' mean and why is it important for achieving high marks on Edexcel?",
      lines: 4,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students identify how each poet's personal context (biography, culture, historical period) shapes their presentation of belonging.",
      },
      resources: [
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a second paragraph that takes the opposing view or explores a contrasting aspect, creating a more balanced response.',
      },
      resources: [
        'Sample question slide',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students read the same stanza in two different ways and the class discusses how interpretation changes.',
    },
  },
  homework:
...
const lesson8: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students annotate and then explain which single annotation would be most valuable in an exam response.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students write a full paragraph response to a question about the poem's theme, going beyond bullet points.",
      },
      resources: [
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students write three paragraphs: similarity in theme, difference in method, and an evaluative conclusion on which poem is more effective.',
      },
      resources: [
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Write a comparative sentence comparing how two poems use imagery to present a shared theme.',
      lines: 4,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students rank the three categories by importance for the Edexcel endorsement and justify their ranking.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a heavily scaffolded planning template with sentence starters for each section and a model plan to reference.',
        core: 'Students use the planning template independently, developing their own argument structure.',
        stretch:
          'Students plan without the template, create their own structure, and include at least two rhetorical devices and a genuine counter-argument.',
      },
      resources: [
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students present without notes and must handle a deliberately challenging counter-argument question from their group.',
      },
      resources: [
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'What are the key differences between a Merit and a Distinction in the Spoken Language Endorsement?',
      lines: 5,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students rank their bottom three areas by urgency and estimate how many additional marks they could gain by improving each one.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed strategy notes sheet with paper structures pre-filled; students add personal strategies and timing.',
        core: 'Students complete the full strategy notes sheet at each station, engaging with all materials.',
        stretch:
          "Students add a 'mark maximiser' section at each station, identifying specific techniques for gaining the highest-level marks on that paper's most challenging question.",
      },
      resources: [
    ...
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students create a timetable and a self-testing schedule, designing their own retrieval practice questions for each topic.',
      },
      resources: [
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students write three commitments (one for revision, one for exam technique, one for a specific paper) and explain how each will gain them additional marks.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        "Explain the concept of 'spaced repetition' and how you could apply it to your English revision.",
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        "What is 'interleaving' and why is it more effective than blocked practice for exam revision?",
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'What should you do in the first five minutes of each exam paper? Explain your strategy.',
      lines: 5,
      modelAnswer:
