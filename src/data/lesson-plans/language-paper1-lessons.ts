...
export const languagePaper1Lessons: LessonPlan[] = [
  ...
  {
    id: 'lp1-01-overview',
    title: 'Paper 1 Overview: Structure, Timing & Mark Allocation',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Allow 90 seconds and provide question number prompts (Q1, Q2, Q3, Q4, Q5) on the board.',
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Explain the difference between Section A and Section B on Paper 1.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 2: Question 1 - Information Retrieval ────────────────────────────
  {
    ...
    title: 'Question 1: Information Retrieval (4 marks, 5 minutes)',
    text: 'AQA English Language Paper 1',
    board: 'AQA',
    yearGroup: 'Year 10',
    duration: '60 minutes',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Checklist printed on the exit ticket itself. Line references highlighted on the extract.',
    ...
    worksheetQuestions: [
      {
        question: 'List four things you learn about the setting from lines 1-8 of the extract.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'List four things you learn about Daniel from lines 1-12 of the flood extract.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'Explain two common mistakes students make on Q1 and how to avoid them.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 3: Question 2 - Language Analysis ────────────────────────────────
  {
    ...
    title: 'Question 2: Language Analysis - How Does the Writer Use Language?',
    text: 'AQA English Language Paper 1',
    board: 'AQA',
    yearGroup: 'Year 10',
    duration: '60 minutes',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Students can submit a sentence from their paragraph frame work rather than composing a new one.',
  ...
  // ── Lesson 4: Question 3 - Structure Analysis ──────────────────────────────
  {
    ...
    title: 'Question 3: Structure Analysis - How Has the Writer Structured the Text?',
    text: 'AQA English Language Paper 1',
    board: 'AQA',
    yearGroup: 'Year 10',
    duration: '60 minutes',
    ...
    starterActivity: {
      ...
      resources: ['Film trailer (90 seconds) or written description', 'Storyboard template (LA)'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a bank of ten words to choose from (e.g. tension, calm, memory, conflict, revelation, isolation, warmth, threat, hope, decay).',
  ...
  // ── Lesson 5: Question 4 Part 1 - Evaluation ──────────────────────────────
  {
    ...
    title: 'Question 4: Evaluation - To What Extent Do You Agree? (Part 1)',
    text: 'AQA English Language Paper 1',
    board: 'AQA',
    yearGroup: 'Year 10',
    duration: '60 minutes',
    ...
    starterActivity: {
      ...
      resources: ['Statement slide', 'Continuum line labels (Strongly Agree / Strongly Disagree)'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide the sentence starter and allow verbal response to a partner before writing.',
  ...
  // ── Lesson 6: Question 4 Part 2 - Building a Convincing Argument ──────────
  {
    ...
    title: 'Question 4: Building a Convincing Argument (Part 2)',
    text: 'AQA English Language Paper 1',
    board: 'AQA',
    yearGroup: 'Year 10',
    duration: '60 minutes',
    ...
    starterActivity: {
      ...
      resources: ['Connective cards or projected list', 'Sorting grid'],
    },
    mainActivities: [
      {
  ...
  // ── Lesson 7: Question 5 - Descriptive Writing ────────────────────────────
  {
    ...
    title: 'Question 5: Creative Writing - Descriptive Writing Techniques',
    text: 'AQA English Language Paper 1',
    board: 'AQA',
    yearGroup: 'Year 10',
    duration: '60 minutes',
    ...
    starterActivity: {
      ...
      resources: ["Five 'telling' sentences (projected)", 'Word bank handout (LA)'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Students can select a sentence that uses the paragraph frame or a sentence starter - the point is that they recognise quality in their own work.',
    ...
    worksheetQuestions: [
      ...
      {
        question: "What is 'zooming in' in descriptive writing? Why is it an effective technique?",
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 8: Question 5 - Narrative Writing ──────────────────────────────
  {
    ...
    title: 'Question 5: Creative Writing - Narrative Writing Techniques',
    text: 'AQA English Language Paper 1',
    board: 'AQA',
    yearGroup: 'Year 10',
    duration: '60 minutes',
    ...
    starterActivity: {
      ...
      resources: ['Four short extracts (projected or printed)', 'Definitions sheet (LA)'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Write two alternative endings and explain which is more effective and why.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question: "What does 'in medias res' mean? Why is it an effective way to open a narrative?",
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 9: Full Paper Practice ─────────────────────────────────────────
  {
    ...
    title: 'Full Paper Practice: Working Through a Complete Paper 1',
    text: 'AQA English Language Paper 1',
    board: 'AQA',
    yearGroup: 'Year 10',
    duration: '60 minutes',
  ...
  // ── Lesson 10: Exam Technique Masterclass ─────────────────────────────────
  {
    ...
    title: 'Exam Technique Masterclass: Common Mistakes & How to Fix Them',
    text: 'AQA English Language Paper 1',
    board: 'AQA',
    yearGroup: 'Year 10',
    duration: '60 minutes',
    ...
    starterActivity: {
      ...
      resources: ['Five weak responses (projected)', 'Mini-whiteboards'],
    },
    mainActivities: [
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          "Provide sentence starters: 'One mistake I will never make again is... because... Instead, I will...'",
