...
export const poetryLessonPlans: LessonPlan[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support: 'Provide a sorting frame with theme headings and two poems already placed.',
          core: 'Blank sorting frame with theme headings only.',
          stretch: 'Create an additional category of their own and justify it in writing.',
        },
        resources: [
    ...
    worksheetQuestions: [
      {
        ...
        lines: 16,
        modelAnswer:
          'Ozymandias — Percy Bysshe Shelley; London — William Blake; Extract from The Prelude — William Wordsworth; My Last Duchess — Robert Browning; The Charge of the Light Brigade — Alfred, Lord Tennyson; Exposure — Wilfred Owen; Storm on the Island — Seamus Heaney; Bayonet Charge — Ted Hughes; Remains — Simon Armitage; Poppies — Jane Weir; War Photographer — Carol Ann Duffy; Tissue — Imtiaz Dharker; The Émigrée — Carol Rumens; Kamikaze — Beatrice Garland; Checking Out Me History — John Agard.',
        marks: 5,
      },
      {
        question:
      ...
      {
        question: 'Explain why comparison skills are important for the AQA Paper 2 poetry exam.',
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: "Provide sentence starter: 'These images suggest that power is...'",
      ...
      resources: ['Projected images of ancient ruins', 'Mini whiteboards (optional)'],
    },
    mainActivities: [
      {
        ...
        resources: ['Anthology copies or poem printout', 'Annotation guide sheet', 'Coloured pens'],
      },
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Include a reference to form or structure in the summary sentence.',
      },
    ...
    worksheetQuestions: [
      {
        question: 'What is the overall message of Ozymandias? Explain in your own words.',
        lines: 4,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Projected images: modern vs. 1790s London', 'Mini whiteboards (optional)'],
    },
    mainActivities: [
      {
        ...
        resources: ['Anthology copies or poem printout', 'Highlighters', 'Annotation guide'],
      },
      {
        ...
        resources: ['Four large sheets with image prompts', 'Marker pens', 'Timer for rotations'],
      },
    ],
    plenaryActivity: {
    ...
    worksheetQuestions: [
      ...
      {
        question: "How does Blake use the image of the 'black'ning Church' to criticise religion?",
        lines: 5,
        modelAnswer:
      ...
      {
        question: "How does the context of the 1790s help us understand Blake's message in London?",
        lines: 5,
        modelAnswer:
    ...
    teacherNotes: [
      ...
      'This poem pairs well with Checking Out Me History for a comparison on anger at institutional power, and with The Émigrée for contrasting views of a city.',
    ],
    targetedSkills: [
      'AO1 — Reading and understanding texts',
      'AO2 — Analysing language, form, and structure',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    worksheetQuestions: [
      {
        question: "What is the main 'enemy' in Exposure? How does Owen make this clear?",
        lines: 5,
        modelAnswer:
      ...
      {
        question: "Analyse the effect of the phrase 'merciless iced east winds that knive us'.",
        lines: 6,
        modelAnswer:
      ...
      {
        question: "Explain how Owen's own experiences in World War One shaped the poem Exposure.",
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: 'Provide a definition card for PTSD with three key symptoms listed.',
    ...
    mainActivities: [
      {
        ...
        duration: '18 minutes',
        instructions:
          "Teacher reads the poem in two distinct tones: the first half in a casual, conversational voice (reflecting the anecdotal opening) and the second half slower, quieter, more disturbed. Students note where they think the poem's tone shifts. Class discussion: the poem begins like a war story told in a pub ('On another occasion'), with colloquial language and a sense of distance. But the tone shifts sharply as the soldier begins to be haunted: 'his blood-shadow stays on the street'. Explore key features: the colloquial voice ('probably armed, possibly not'), the ambiguity of 'possibly not' (the soldier does not even know if the man was a threat), the graphic imagery ('I see broad daylight on the other side'), the repetition of the word 'remains', and the final image where the soldier is 'near to the knuckle' — an idiom meaning close to the uncomfortable truth. Discuss the irregular structure: no regular stanza length, frequent enjambment, suggesting the soldier's thoughts are disordered and spilling out uncontrollably.",
        differentiation: {
          support:
        ...
        resources: ['Anthology copies', 'Two-column tone sorting table (support version)'],
      },
      {
        ...
        differentiation: {
          support: 'Provide a paragraph frame with sentence starters and a technique word bank.',
    ...
    worksheetQuestions: [
      ...
      {
        question: "Analyse the effect of the phrase 'probably armed, possibly not'.",
        lines: 5,
        modelAnswer:
      ...
      {
        question: "How does the poem's structure reflect the soldier's psychological state?",
        lines: 6,
        modelAnswer:
      ...
      {
        question: "What is the significance of the title 'Remains'? Explain the multiple meanings.",
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Suggest a specific rewording of a sentence in the paragraph to improve its band.',
      },
    ...
    worksheetQuestions: [
      {
        question: 'What does the AQA Paper 2, Section B poetry question require you to do?',
        lines: 4,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    keywords: ['unseen', 'annotation', 'inference', 'tone', 'mood', 'imagery', 'volta', 'voice'],
    starterActivity: {
    ...
    worksheetQuestions: [
      ...
      {
        question: 'What three areas should you look for when annotating an unseen poem?',
        lines: 4,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Explain the SAME/DIFF strategy for approaching the comparison question.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'What should the structure of your comparison response look like for 8 marks?',
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      {
        ...
        resources: ['Planning frame (support version)', 'Exam question and named poem'],
      },
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'After assessing, rewrite their weakest paragraph to move it into a higher band.',
      },
      resources: [
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Why is it important to memorise quotations from the anthology poems?',
        lines: 4,
        modelAnswer:
