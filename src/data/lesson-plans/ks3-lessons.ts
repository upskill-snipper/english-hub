...
export const ks3Lessons: LessonPlan[] = [
  // ── Lesson 1: Introduction to Analytical Writing: PEE/PEEL Paragraphs ────
  {
    ...
    worksheetQuestions: [
      {
        question: 'What does PEE stand for? Write a brief definition of each component.',
        lines: 4,
        modelAnswer:
      ...
      {
        question: 'What is the difference between PEE and PEEL? Why is the extra "L" useful?',
        lines: 3,
        modelAnswer:
  ...
  // ── Lesson 3: Creative Writing: Show Don't Tell & Sensory Description ────
  {
    ...
    worksheetQuestions: [
      {
        question: 'Explain what "show don\'t tell" means in creative writing. Why is it important?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 4: Grammar Foundations: Sentence Types & Punctuation ───────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students add a specific punctuation mark to each version and explain its effect.',
      },
    },
    homework:
  ...
  // ── Lesson 5: Poetry Appreciation ────────────────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students explain any that could fit into more than one category and justify why.',
      },
    },
    homework:
  ...
  // ── Lesson 6: Persuasive Writing: Crafting Arguments & Using AFOREST ─────
  {
    ...
    worksheetQuestions: [
      {
        question: 'What does AFOREST stand for? Give a brief definition of each technique.',
        lines: 8,
        modelAnswer:
      ...
      {
        question: 'What is a counter-argument and why might a persuasive writer include one?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 7: Shakespeare Introduction ───────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a hint for each phrase (e.g. "This one is from a famous play about a prince").',
    ...
    worksheetQuestions: [
      {
        question: 'Translate the following into modern English: "Wherefore art thou Romeo?"',
        lines: 3,
        modelAnswer:
      ...
      {
        question: 'What is the difference between "thou" and "you" in Shakespeare\'s time?',
        lines: 3,
        modelAnswer:
      ...
      },
      {
        ...
        lines: 3,
        modelAnswer: '"Wherefore hast thou come hither? Thy father hath gone ere thou arrived."',
        marks: 3,
      },
      {
  ...
  // ── Lesson 8: Non-Fiction Reading: Identifying Bias, Fact & Opinion ──────
  {
    ...
    worksheetQuestions: [
      {
        question: 'Define "fact" and "opinion". Give two examples of each.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 9: Narrative Writing: Story Structure, Openings & Endings ─────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a word bank for describing effects: "intriguing", "mysterious", "exciting", "unusual".',
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Name three different types of story opening and give a brief example of each.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'What is "in medias res"? Why is it an effective way to start a story?',
        lines: 4,
        modelAnswer:
