...
export const poetryLoveRelationshipsLessons: LessonPlan[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a list of six types of love with definitions; students match and add examples.',
        core: 'Students brainstorm independently and provide real-world or literary examples for each type.',
        stretch:
          'Students rank the types by which they think will appear most in a poetry anthology and justify their order.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide pre-sorted colour-coded cards with two categories already filled in; students complete the remaining groups.',
          core: 'Students sort all fifteen cards independently and justify each placement with a sentence.',
          stretch:
            'Students identify poems that belong in multiple categories and write a sentence for each explaining the overlap.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            "Provide a writing frame: 'Both poems explore... However, in Sonnet 29 the poet... whereas in [poem] the poet...'",
          core: 'Students write three bullet-point connections independently, covering at least two AOs.',
          stretch:
            'Students write a full introductory comparison sentence and explain which AO each connection targets.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          "Add a fourth prompt: 'Which two poems do you think would make a strong comparison pair and why?'",
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          "Explain what is meant by 'romantic love' and 'familial love'. Give one poem example for each.",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'What does the AQA Paper 2, Section B exam question ask you to do? How many marks is it worth?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'What are the four Assessment Objectives for this question? Which do you think is most important and why?',
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide the stanza printed with three key words highlighted; students focus on these.',
        core: 'Students identify two language choices and explain their emotional effect.',
        stretch:
          'Students predict the rest of the poem based on the tone and imagery of the first stanza.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            "Provide a pre-annotated copy with key techniques labelled; students fill in the 'Effect' column only.",
          core: 'Students complete the full analysis table with four quotations.',
          stretch:
            "Students write a paragraph analysing how the circular structure mirrors the speaker's inability to move on.",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            "Students evaluate whether Shelley's argument is genuinely romantic or manipulative, using textual evidence.",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students write two paragraphs and include AO3 context (Romantic movement, biographical details).',
        },
        resources: [
    ...
    worksheetQuestions: [
      ...
      {
        question:
          "How does the circular structure of 'When We Two Parted' reflect the speaker's emotional state?",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "How does Shelley use personification of nature in 'Love's Philosophy'? What is its purpose?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "Identify the rhetorical question at the end of 'Love's Philosophy'. What effect does it have?",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'What contextual information about the Romantic period helps you understand these poems?',
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students identify the pathetic fallacy in the opening and predict how it foreshadows events.',
      },
      resources: [
        'Opening lines display slide',
        'Mini-whiteboards',
        'Dramatic monologue definition card',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students write about how Browning uses enjambment and the single stanza form to create a sense of obsessive, unstoppable momentum.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a simplified prose summary alongside the poem and three key quotations pre-highlighted.',
          core: 'Students annotate and complete the grid independently, selecting four quotations.',
          stretch:
            "Students analyse how the Duke's control of the conversation mirrors his desire to control the Duchess, linking form to meaning.",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students include AO3 Victorian context (women as property, coverture laws, patriarchal control).',
        },
        resources: [
          'Model paragraph display slide',
    ...
    plenaryActivity: {
      ...
      duration: '7 minutes',
      instructions:
        "Place signs at either end of the room: 'Porphyria's Lover is more dangerous' and 'The Duke is more dangerous'. Students stand on the continuum to show their opinion. Select students from different points to justify their position using textual evidence. Teacher summarises: Browning wrote 'Porphyria's Lover' (first published 1836) and 'My Last Duchess' (1842) within a few years of each other — what does this tell us about his fascination with extreme love?",
      differentiation: {
        ...
        stretch:
          "Students must respond to and challenge a classmate's argument before stating their own.",
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question:
          "How does the speaker in 'Porphyria's Lover' try to justify the murder? Is he convincing?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "What does the phrase 'I gave commands; / Then all smiles stopped together' reveal about the Duke?",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'How does Victorian context help us understand the power dynamics in these poems?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Which speaker do you find more disturbing and why? Support your answer with evidence.',
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a visual prompt with images of communication methods across different eras.',
        core: 'Students write their answer and rank methods by emotional depth.',
        stretch:
          'Students consider how the method of communication changes the nature of the connection (e.g. a letter vs a text).',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a prose paraphrase alongside the poem and pre-label the octave/sestet division.',
          core: 'Students identify the volta independently and complete the two-column table with quotations.',
          stretch:
            'Students analyse how Barrett Browning subverts the traditional Petrarchan form — the woman is the active speaker, not the passive beloved.',
        },
        resources: [
      ...
      },
      {
        ...
        duration: '17 minutes',
        instructions:
          "Read 'Letters from Yorkshire' aloud. Establish context: Maura Dooley's modern poem about two people living different lives — one rural, one urban — connected by letters. Students identify the central contrast: his physical world ('digging his garden, planting potatoes', 'his knuckles singing') vs her intellectual world ('feeding words onto a blank screen'). Focus on the key quotation: 'Is his life more real because he digs the earth?' Discuss: what does Dooley mean by 'real'? Annotate for: present tense (immediacy), sensory and synaesthetic imagery ('knuckles singing'), and the final image of letters as spiritual connection ('souls tap out messages across the icy miles'). Students complete analysis grid matching the Lesson 2 format.",
        differentiation: {
          support:
            'Provide a stanza-by-stanza summary and three pre-highlighted quotations with technique labels.',
          core: 'Students annotate independently and complete the full analysis grid.',
          stretch:
            "Students analyse the significance of 'souls tap out messages' in the final stanza — link to Morse-code imagery and the spiritual register of 'souls'.",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a completed Venn diagram with key points; students write the paragraph using a frame.',
          core: 'Students complete the Venn diagram and write a paragraph independently.',
          stretch:
            'Students write two paragraphs — one on similarity, one on contrast — and include AO3 context for both poets.',
        },
        resources: [
    ...
    worksheetQuestions: [
      {
        question:
          "What is a Petrarchan sonnet? How does Barrett Browning use this form in 'Sonnet 29'?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "Analyse the extended metaphor of the vine and tree in 'Sonnet 29'. What does it reveal?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "What is the central contrast in 'Letters from Yorkshire'? How does Dooley present it?",
        lines: 5,
        modelAnswer:
          "The central contrast is between his physical, rural life ('digging his garden, planting potatoes') and her intellectual, urban life ('feeding words onto a blank screen'). Dooley presents his world through sensory, natural imagery — 'the first lapwings return' and the synaesthetic 'knuckles singing' — making it seem vivid and alive. Her world is presented through technology and abstraction. The key question 'Is his life more real because he digs the earth?' challenges this binary, suggesting that the emotional connection in their letters makes both lives equally 'real'.",
        marks: 4,
      },
      {
        ...
        lines: 6,
        modelAnswer:
          "Both poems present love as primarily a mental and emotional experience rather than a physical one. Barrett Browning's speaker in 'Sonnet 29' is so consumed by thoughts of her beloved that he becomes present in her mind — 'my thoughts do twine and bud / About thee' — suggesting imagination can substitute for physical presence. Similarly, Dooley's speaker finds that letters create genuine connection: 'souls tap out messages across the icy miles'. However, Barrett Browning ultimately rejects imagination as insufficient ('Renew thy presence'), while Dooley seems to accept the letters as a valid form of intimacy, suggesting a more mature acceptance of distance.",
        marks: 5,
      },
      {
        question:
          "What is the effect of the phrase 'souls tap out messages across the icy miles' at the end of 'Letters from Yorkshire'?",
        lines: 4,
        modelAnswer:
          "Dooley elevates correspondence to something spiritual: it is not just hands that write but 'souls' that 'tap out' messages, evoking Morse code — urgent, essential signals across distance. The adjective 'icy' suggests the cold of physical separation, but the verb 'tap out' implies persistence and dedication. The image transforms an ordinary act (writing a letter) into something profound, suggesting that genuine love can bridge geographical and emotional distance.",
        marks: 4,
      },
      {
        question:
          "How does Barrett Browning's context as a Victorian woman poet affect your reading of 'Sonnet 29'?",
        lines: 4,
        modelAnswer:
    ...
    teacherNotes: [
      ...
      "The 'souls tap out messages' image is a productive point of debate; do not over-prescribe one interpretation.",
    ],
    targetedSkills: [
      'AO1: Personal response',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          "Provide three emotion words to choose from and a sentence starter: 'The parent might feel... because...'",
        core: "Students write a short paragraph exploring both the parent's and child's perspectives.",
        stretch:
          'Students predict what imagery a poet might use to describe this moment (e.g. bird leaving nest, boat sailing away).',
      },
    ...
    mainActivities: [
      {
        ...
        duration: '18 minutes',
        instructions:
          "Read 'Walking Away' aloud. Context: C. Day-Lewis (UK Poet Laureate 1968–72) published this poem in 'The Gate, and Other Poems' (1962). It is dedicated to his eldest son Sean Day-Lewis (the journalist) and recalls watching Sean walk away from him on his first day at a new school as a young boy — eighteen years before the poem's writing. (Note: Daniel Day-Lewis the actor is the poet's son from his second marriage and is not the subject of this poem.) Students annotate for: the natural similes ('like a winged seed loosened from its parent stem', 'like a satellite / Wrenched from its orbit'), the time structure (memory recalled 'eighteen years ago'), and the devastating final couplet: 'selfhood begins with a walking away, / And love is proved in the letting go.' Focus question: why does Day-Lewis compare his son to things in nature? How does this make the letting go feel? Students complete a quotation-analysis-effect grid.",
        differentiation: {
          support:
            "Provide the three key similes pre-identified with a writing frame: 'Day-Lewis compares his son to... This suggests...'",
          core: 'Students independently identify four key quotations and analyse technique and effect.',
          stretch:
            "Students analyse how the poem's structure — four regular stanzas — contrasts with the emotional turmoil, and what this restraint suggests about masculine grief.",
        },
        resources: [
          "Full text of 'Walking Away'",
          'Context card on C. Day-Lewis and his eldest son Sean',
          'Analysis grid worksheet',
        ],
      },
      {
        ...
        differentiation: {
          support:
            'Provide a stanza-by-stanza summary and highlight three key images for analysis.',
          core: 'Students annotate independently and complete the grid with four quotations.',
          stretch:
            "Students analyse the significance of the title 'Eden Rock' — linking to the Garden of Eden, innocence, and the idea of paradise before the Fall.",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a paragraph frame with the first sentence written and quotation options.',
          core: 'Students write independently using the T-chart and connective list.',
          stretch:
            "Students explore the reversal: in 'Walking Away' the parent watches the child leave; in 'Eden Rock' the child moves toward the parents. What does this reversal suggest about the cycle of love?",
        },
        resources: [
          'T-chart template',
    ...
    worksheetQuestions: [
      {
        question:
          "How does Day-Lewis use simile to convey the pain of letting go in 'Walking Away'?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "Why does Causley include such specific domestic details in 'Eden Rock'? What effect do they create?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "What is the significance of the title 'Eden Rock'? How does it connect to the poem's themes?",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Compare how both poems present the relationship between time and parent-child love.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          "Analyse the final line of 'Eden Rock': 'I had not thought that it would be like this.' What does it suggest?",
        lines: 4,
        modelAnswer:
    ...
    teacherNotes: [
      ...
      "Note: the dedicatee is Sean Day-Lewis (the eldest son, b.1931, journalist) — NOT Daniel Day-Lewis the actor. Daniel was the poet's youngest son and was not yet born when the poem was written in 1956. Avoid this common misattribution; the actor connection is to the poet's later life, not to this poem.",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students predict how a poet might structure a poem about changing relationships (e.g. chronological, then/now contrast, reversal).',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a stanza-by-stanza summary and highlight the key quotation for each stanza.',
          core: 'Students annotate independently and complete the grid with five quotations.',
          stretch:
            "Students analyse how Heaney's use of technical agricultural vocabulary ('sock', 'headrig', 'furrow') creates admiration and how its absence in the final stanza signals the father's decline.",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            "Students explore the ethical complexity: is the speaker's possessiveness loving or selfish? Compare to the possessiveness in 'Porphyria's Lover' — how is it different?",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a completed WHAT/HOW/WHY plan; students write the paragraph using a frame.',
          core: 'Students complete the plan and write independently.',
          stretch:
            'Students write two paragraphs and address how the structural shift in each poem creates a different emotional effect.',
        },
        resources: [
          'Comparison question slide',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write quotations plus explain which poem they find more emotionally effective and why.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          "How does Heaney present his father in the first four stanzas of 'Follower'? What techniques does he use?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "Analyse the effect of the final stanza of 'Follower'. How does the role reversal work?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "How does Duffy use the title 'Before You Were Mine' to establish the poem's themes?",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "How does Duffy's use of present tense affect the reader's experience of 'Before You Were Mine'?",
        lines: 4,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students try to write one that sounds like it could be from a poem — using imagery or figurative language.',
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a diagram showing the tape measure metaphor mapped onto the parent-child relationship.',
          core: "Students annotate and complete the grid independently, explaining the metaphor's development.",
          stretch:
            'Students analyse how the poem is a loose sonnet (roughly 14 lines) and why Armitage might adapt the love poem form for a mother-son relationship.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            "Students analyse how the poem challenges stereotypes about arranged marriages and South Asian masculinity, and how the form (no regular metre, free verse) mirrors the speaker's carefree attitude.",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students write a second paragraph exploring how cultural context shapes the presentation of love in each poem.',
        },
        resources: [
    ...
    worksheetQuestions: [
      {
        question:
          "Explain the extended metaphor of the tape measure in 'Mother, Any Distance'. What does it represent?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "What is the effect of the final image 'to fall or fly' in 'Mother, Any Distance'?",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "How does Nagra create a distinctive voice in 'Singh Song!'? What effect does this have?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Compare how both poems present the idea of leaving or moving on. Which is more optimistic?',
        lines: 6,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          "Students write a sentence of 'pathetic fallacy' for a relationship in crisis and one for a relationship healing.",
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a colour-coded version: blue for sadness/distance, green for hope/reunion. Students explain the shift.',
          core: 'Students annotate independently and complete the grid, identifying the volta.',
          stretch:
            "Students analyse how the shift from tercets (three-line stanzas, suggesting imbalance) to a final couplet (two lines, togetherness) mirrors the couple's reconciliation.",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a stanza-by-stanza paraphrase and three pre-selected quotations for analysis.',
          core: 'Students annotate and complete the grid independently with four quotations.',
          stretch:
            'Students analyse how the circular structure traps the speaker in the memory of the failed relationship — he cannot escape the pond, just as he cannot escape the pain.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a completed comparison grid; students write the paragraph using a frame.',
          core: 'Students complete the grid and write independently.',
          stretch:
            "Students include AO3 context (Hardy's biography, the Victorian crisis of faith reflected in 'chidden of God').",
        },
        resources: [
          'Comparison question slide',
    ...
    worksheetQuestions: [
      {
        question:
          "How does Sheers use the swans as a symbol in 'Winter Swans'? What do they represent?",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "Analyse the final image in 'Winter Swans': 'our hands... folded, one over the other, / like the wings of a bird settling after flight.'",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'Compare how nature functions in both poems. Which poet uses it more effectively?',
        lines: 6,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students rewrite the opening sentence of the band 3 paragraph to make it band 5/6 quality.',
      },
      resources: [
        'Band 3 and Band 6 sample paragraph display',
        'Mini-whiteboards',
        'Feature checklist (support tier)',
      ],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide the PEACE structure as a laminated bookmark with sentence starters for each stage.',
          core: 'Students copy the example and annotate the PEACE stages independently.',
          stretch:
            'Students evaluate the model paragraph — is there anything they would improve? Could the context feel more integrated?',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Gap-fill sentences with connective options provided; students select the best fit.',
          core: 'Students complete gap-fills and then write three original sentences using different connective types.',
          stretch:
            'Students write a paragraph using at least one connective from each category, demonstrating range and fluency.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a partially completed comparison grid and a PEACE paragraph frame with the Point and first Evidence sentence written.',
          core: 'Students complete the grid and write a full paragraph independently.',
          stretch:
            'Students write two PEACE paragraphs — one on similarity, one on difference — and include a short introduction that sets up the comparison.',
        },
        resources: [
    ...
    worksheetQuestions: [
      {
        question:
          "What is the difference between a 'bolt-on' comparison and an 'integrated' comparison? Give an example of each.",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'What does the PEACE structure stand for? Write a brief explanation of each stage.',
        lines: 6,
        modelAnswer:
      ...
      {
        question:
          "Rewrite this band 3 sentence as a band 5/6 sentence: 'Both poems are about love and use metaphors.'",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "Why is tentative language (e.g. 'perhaps', 'could suggest', 'arguably') valued by examiners?",
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'What are the four Assessment Objectives for Paper 2 Section B? How many marks is each worth (approximately)?',
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Students can use their revision posters or notes during the speed-dating (open-book warm-up).',
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a planning template with three boxes: Point 1 / Point 2 / Point 3, each with space for two quotations.',
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a structural guide: Introduction (3 mins) / Paragraph 1 (10 mins) / Paragraph 2 (10 mins) / Paragraph 3 (10 mins) / Conclusion (3 mins) with the PEACE prompts alongside each section.',
          core: 'Students write independently under timed conditions.',
          stretch:
            "Students aim for four paragraphs and include a conceptualised introduction that establishes a critical argument (e.g. 'Both Browning and Hardy suggest that intense emotion, whether passion or despair, traps the speaker in a moment from which they cannot escape').",
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          "Provide a tick-list version of the mark scheme: 'Did you... compare? quote from both poems? name techniques? include context?'",
        core: 'Students use the full simplified mark scheme and write a two-sentence self-assessment.',
        stretch:
          'Students identify their single weakest AO and write a specific improvement target with an example of what they would add.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question:
          'You have 45 minutes for this question in the exam. How should you divide your time? Create a time plan.',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          'What makes a good choice of second poem? What should you consider when selecting it?',
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          "Write a model introduction for the question: 'Compare how poets present intense emotions in \"Porphyria's Lover\" and one other poem.'",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'What is the most common mistake students make in comparative poetry essays? How can you avoid it?',
        lines: 4,
        modelAnswer:
      ...
      {
        question:
          "Write a model conclusion for a comparison of 'Porphyria's Lover' and a poem of your choice.",
        lines: 5,
        modelAnswer:
      ...
      {
        question:
          'Self-assessment: Look at the AQA mark scheme. Which band do you think your timed essay reached? What is one specific thing you could do to improve it?',
        lines: 5,
        modelAnswer:
