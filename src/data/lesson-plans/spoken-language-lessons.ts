...
const lesson1: LessonPlan = {
  ...
  keywords: [
    'endorsement', 'presentation', 'audience', 'register',
    'Standard English', 'discourse markers', 'topic sentence', 'thesis',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a simple observation grid with prompts: "The good speaker...", "The weaker speaker...".',
      core: 'Students identify differences independently and categorise them under content, structure, and delivery.',
      stretch: 'Students evaluate which quality matters most and justify their answer with reference to the clips.',
    },
    resources: ['Two contrasting speech clips', 'Observation grid (support tier)', 'Spoken Language endorsement criteria sheet'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a simplified version of the criteria with key phrases underlined and a glossary of assessment language.',
        core: 'Students annotate independently and identify what separates Merit from Distinction.',
        stretch: 'Students draft their own "top tips" checklist based on the Distinction criteria, written as actionable advice.',
      },
      resources: ['AQA Spoken Language criteria sheet', 'Model student presentation transcript', 'Highlighters'],
    },
    {
      ...
      differentiation: {
        ...
        stretch: 'Students refine their thesis to include a counter-argument acknowledgement (e.g., "Although some argue X, I believe Y because...").',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide a scaffolded planning template with sentence starters for each section and a completed model.',
        core: 'Students complete the template independently, adding at least one piece of evidence per body point.',
        stretch: 'Students plan two possible hooks and evaluate which is more effective, justifying their choice in writing.',
      },
      resources: ['Five-part planning framework slide', 'Planning template worksheet', 'Model completed plan (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Provide a sentence frame: "I am going to argue that... because... My audience should care because...".',
      core: 'Students deliver their pitch from memory with a clear thesis and one supporting reason.',
      stretch: 'Students deliver their pitch using a rhetorical question as their opening and a call to action as their close.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question: 'Explain why choosing the right topic is important for a successful presentation. What qualities should a good topic have?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'A student has chosen the topic "Social media." Explain why this needs refining and suggest an improved thesis statement.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Outline the five sections of an effective presentation plan and explain the purpose of each.',
      lines: 8,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  keywords: [
    'discourse markers', 'cohesion', 'signposting', 'transition',
    'circular structure', 'anaphora', 'topic sentence', 'rhetorical arc',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide six cards instead of eight, with the introduction and conclusion pre-identified.',
      core: 'Students arrange all eight cards and identify the discourse markers that signal the correct order.',
      stretch: 'Students identify where the original speech could be improved structurally and suggest a reordering with justification.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a pre-sorted reference sheet and ask students to select and place four markers into their plan.',
        core: 'Students categorise all twenty markers independently and integrate eight into their plan.',
        stretch: 'Students identify which category of marker is most important for their specific argument type and explain why.',
      },
      resources: ['Discourse markers categorisation worksheet', 'Reference sheet (support tier)', 'Students\' presentation plans from Lesson 1'],
    },
    {
      ...
      differentiation: {
        support: 'Provide sentence starters for each type of opening and closing, with a model for each.',
        core: 'Students draft two openings and one closing independently, selecting the most effective combination.',
        stretch: 'Students write a circular structure where the closing directly echoes or reframes the opening, and explain the effect on the audience.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Teacher assigns the most appropriate structural model to each student based on their topic.',
        core: 'Students evaluate all three models against their topic and justify their choice in writing.',
        stretch: 'Students consider how combining two structural models could strengthen their argument and redraft their plan accordingly.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Students annotate their own opening with the technique used, using a colour-coded key.',
      core: 'Students identify the specific technique in each volunteer\'s opening and explain its effect.',
      stretch: 'Students evaluate whether the opening would be equally effective in written form or whether it relies on spoken delivery.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain the difference between the following discourse markers and give an example of when you would use each: "however", "furthermore", "consequently".',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'A student opens their presentation by saying: "Today I am going to talk about climate change." Explain why this is a weak opening and rewrite it using two different techniques.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Describe the three structural models for organising the body of a speech. For each, suggest a topic that would suit that model.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Why is a circular structure considered an effective technique for speeches? Give an example of how a speaker might use one.',
      lines: 5,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  keywords: [
    'rhetoric', 'anaphora', 'tricolon', 'antithesis',
    'hyperbole', 'emotive language', 'direct address', 'imperative',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide the technique names alongside the quotations and ask students to match them.',
      core: 'Students identify the techniques independently before the reveal.',
      stretch: 'Students explain why each technique is more effective in spoken form, considering rhythm, emphasis, and audience response.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a partially completed toolkit card with definitions and examples filled in; students add their own examples only.',
        core: 'Students complete the full toolkit card independently, generating original examples for each technique.',
        stretch: 'Students rank the eight techniques in order of effectiveness for their specific topic and justify their top three choices.',
      },
      resources: ['Rhetorical techniques PowerPoint', 'Toolkit reference card template', 'Partially completed card (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide the transcript with four techniques pre-highlighted; students identify two more independently.',
        core: 'Students identify all techniques independently and evaluate the most and least effective.',
        stretch: 'Students rewrite one paragraph of the model speech, replacing the techniques used with alternative ones and comparing the effect.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide sentence starters that embed techniques (e.g., "Imagine a world where... Imagine a future where... Imagine a society where..." for anaphora).',
        core: 'Students draft independently, using at least three different techniques with purposeful placement.',
        stretch: 'Students draft two versions of the same section — one technique-heavy and one subtle — and evaluate which is more effective for a spoken context.',
      },
      resources: ['Students\' presentation plans', 'Rhetorical toolkit reference cards', 'Drafting paper or laptops'],
    },
  ],
  plenaryActivity: {
  ...
  worksheetQuestions: [
    {
      question: 'Define the following rhetorical techniques and give an original example of each: tricolon, anaphora, antithesis.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Explain why rhetorical techniques are often more effective in spoken language than in written text. Use specific examples in your answer.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Read the following extract from a student\'s speech: "Phones are bad for us. They make us unhappy. We use them too much. Someone should do something." Rewrite this extract using at least three rhetorical techniques to make it more persuasive.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'A student has used eight different rhetorical techniques in a single paragraph of their speech. Explain why this might be a problem and suggest how they could improve.',
      lines: 5,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  keywords: [
    'evidence', 'statistics', 'anecdote', 'case study',
    'credibility', 'testimony', 'citation', 'attribution',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a sentence starter for the ranking explanation: "I found claim X most convincing because...".',
      core: 'Students rank independently and justify their reasoning with reference to the type of evidence.',
      stretch: 'Students identify a scenario where each type of evidence would be the most effective choice.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a simplified grid with three evidence types and matched examples; students evaluate strengths and weaknesses.',
        core: 'Students complete the full grid for all six types and select the three most suitable for their topic.',
        stretch: 'Students explain how combining two types of evidence (e.g., a statistic followed by a personal anecdote) creates a more persuasive effect than either alone.',
      },
      resources: ['Evidence types handout', 'Evidence evaluation grid', 'Simplified grid (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide six spoken phrasing stems and a model conversion. Students complete three conversions with guidance.',
        core: 'Students convert three examples independently and draft their own evidence integration for their presentation.',
        stretch: 'Students practise delivering their evidence aloud and evaluate whether the phrasing sounds natural or still reads like an essay.',
      },
      resources: ['Clumsy vs fluent examples slide', 'Spoken phrasing stems handout', 'Students\' homework evidence notes'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a structured feedback card with the four criteria and sentence starters for suggestions.',
        core: 'Students assess and provide feedback independently using the four criteria.',
        stretch: 'Testers challenge the speaker with a counter-argument that undermines their evidence, and the speaker practises responding.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Students explain their highest bid with a sentence starter: "I bid most on this evidence because...".',
      core: 'Students justify both their highest and lowest bids with reasoning about credibility and relevance.',
      stretch: 'Students explain how they would combine their two highest-bid pieces of evidence in a single paragraph of a speech.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Name four types of evidence a speaker might use in a presentation and explain one strength and one limitation of each.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Rewrite the following clumsy evidence integration in a way that sounds natural for spoken delivery: "According to Smith, J. (2023) \'The Impact of Social Media on Adolescent Mental Health\', Journal of Psychology, Vol. 45, pp. 112-128, there is a correlation between screen time and anxiety."',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'A student\'s presentation includes the following evidence: "My friend told me that she feels stressed by homework." Evaluate this evidence and suggest how the student could strengthen it.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain why combining different types of evidence is more persuasive than relying on a single type. Give an example.',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  keywords: [
    'pace', 'pause', 'tone', 'inflection',
    'emphasis', 'projection', 'gesture', 'eye contact',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Students choose from three descriptions (boring, over the top, just right) and explain their choice.',
      core: 'Students identify specific vocal and physical techniques that made the third delivery effective.',
      stretch: 'Students explain how the wrong delivery could actually undermine a strong argument.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a delivery annotation key (symbols for pause, emphasis, slow down, etc.) and a pre-annotated model.',
        core: 'Students annotate their own section independently using the five techniques.',
        stretch: 'Students record themselves on a phone and listen back, identifying where their delivery could be more varied.',
      },
      resources: ['Vocal techniques handout with symbols', 'Students\' presentation drafts', 'Delivery annotation key (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a pre-completed Dos and Don\'ts table; students practise the three key principles with a partner who gives simple feedback.',
        core: 'Students complete the table independently and practise incorporating all three principles into their opening.',
        stretch: 'Students evaluate how different gestures change the meaning or emphasis of the same spoken sentence.',
      },
      resources: ['Body language video compilation or teacher demonstration notes', 'Dos and Don\'ts table template'],
    },
    {
      ...
      differentiation: {
        support: 'Students can use prompt cards and focus on just two delivery techniques (eye contact and pace).',
        core: 'Students deliver from minimal notes, incorporating at least three delivery techniques.',
        stretch: 'Students deliver entirely from memory and ask their partner to identify the single most impactful moment and explain why.',
      },
      resources: ['Structured feedback form', 'Students\' presentation drafts', 'Prompt cards (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students evaluate whether there is a point where too many techniques make the delivery feel unnatural.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain the difference between pace, pause, and emphasis as vocal techniques. Give an example of when a speaker might use each one.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Why is eye contact important in a spoken presentation? What common mistakes do students make with eye contact?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'A student delivers their presentation in a loud, fast monotone throughout. Explain the problems with this delivery and suggest three specific improvements.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Annotate the following sentence with delivery instructions, explaining your choices: "We cannot wait any longer — the time to act is now."',
      lines: 5,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  keywords: [
    'counter-argument', 'rebuttal', 'concession', 'bridging',
    'spontaneous', 'composure', 'elaboration', 'Standard English',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide question stems: "What about...?", "But don\'t you think...?", "How would you respond to someone who says...?".',
      core: 'Students generate questions independently, aiming for at least five.',
      stretch: 'Students categorise their questions (factual, challenging, clarifying, hostile) and discuss which type is hardest to answer.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide response sentence starters for each strategy and a model dialogue to follow.',
        core: 'Students practise all four strategies independently with a partner.',
        stretch: 'Students evaluate which strategy is most effective for different types of question (hostile, factual, clarifying) and justify their analysis.',
      },
      resources: ['Response strategies handout', 'Sentence starters (support tier)', 'Practice topics list'],
    },
    {
      ...
      differentiation: {
        support: 'Teacher provides two likely questions for the student\'s topic; the student drafts responses with guidance.',
        core: 'Students anticipate three questions and respond to two unexpected ones from a partner.',
        stretch: 'Students prepare responses to a deliberately hostile or unfair question and discuss how to maintain professionalism under pressure.',
      },
      resources: ['Students\' presentation plans', 'Question anticipation worksheet', 'Response drafting space'],
    },
    {
      ...
      differentiation: {
        support: 'Hot seat students can refer to their preparation notes. Questioners use the question stems provided.',
        core: 'Students respond without notes and questioners ask genuine, probing questions.',
        stretch: 'One questioner deliberately plays devil\'s advocate, and the speaker must concede a point while maintaining their overall argument.',
      },
  ...
  worksheetQuestions: [
    {
      question: 'Describe the four strategies for responding to questions taught in this lesson and give an example of each.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'Why is it important for a speaker to anticipate questions before their presentation? What could go wrong if they do not prepare?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'A student is asked: "But isn\'t your argument just based on your own opinion?" How should they respond? Write a model answer using one of the four strategies.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain the difference between conceding a point and losing your argument. Why is concession sometimes a sign of strength in a speaker?',
      lines: 5,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  keywords: [
    'Standard English', 'register', 'code-switching', 'formality',
    'dialect', 'slang', 'subject-verb agreement', 'received pronunciation',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide the two column headings and sort five pairs rather than ten individual utterances.',
      core: 'Students sort all ten independently and explain the non-standard feature in each informal example.',
      stretch: 'Students discuss whether there are ever situations where non-standard English might be deliberately used in a formal speech for effect.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a reference sheet of corrections and complete six sentences rather than twelve.',
        core: 'Students complete all twelve sentences independently.',
        stretch: 'Students identify non-standard features in their own presentation draft and correct them, explaining why each change is necessary.',
      },
      resources: ['Non-standard features handout', 'Correction exercise worksheet', 'Reference sheet (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide scripts for the informal version and sentence starters for the formal version.',
        core: 'Students improvise both versions and identify three specific changes they made.',
        stretch: 'Students analyse whether code-switching is a skill that advantages certain social groups and discuss the implications for fairness.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Teacher or teaching assistant supports the audit, highlighting areas for the student to correct.',
        core: 'Students complete the self-audit and peer audit independently.',
        stretch: 'Students consider whether any informal language could be retained deliberately for rhetorical effect (e.g., a colloquial phrase in an anecdote) and justify their decision.',
      },
      resources: ['Students\' presentation drafts', 'Coloured pens', 'Non-standard features checklist'],
    },
  ],
  plenaryActivity: {
  ...
  worksheetQuestions: [
    {
      question: 'Define Standard English. Why is it important for the GCSE Spoken Language endorsement?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Rewrite the following passage in Standard English: "Me and my mates was talking about it and we was like, basically, no one don\'t care about the environment no more. Everyone\'s just gonna ignore it cos it ain\'t affecting them right now, innit."',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Explain what code-switching is and give an example from everyday life. Why is code-switching a useful skill?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'A student says: "Using Standard English in my presentation will make me sound fake and not like myself." How would you respond to this concern?',
      lines: 5,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  keywords: [
    'active listening', 'evaluation', 'criteria', 'constructive feedback',
    'annotation', 'assessment', 'merit', 'distinction',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students answer the five questions and then summarise the passage\'s main argument in one sentence.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide the framework with pre-written questions in each column; students listen and tick or add notes.',
        core: 'Students formulate their own questions and complete the framework independently during the clip.',
        stretch: 'Students add a fourth column — "Questions I would ask this speaker" — and generate two probing questions.',
      },
      resources: ['Active listening framework template', 'Speech clip (60 seconds)', 'Pre-completed framework (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a simplified criteria sheet with key phrases highlighted. Students grade and justify with a sentence starter: "I would award this a... because the speaker...".',
        core: 'Students grade independently with detailed justification referencing at least two criteria strands.',
        stretch: 'Students write specific improvement targets for each presentation and explain how following these targets would move the speaker up one grade boundary.',
      },
      resources: ['Two model presentation recordings or scripts', 'AQA Spoken Language criteria sheet', 'Listening framework templates', 'Simplified criteria (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Provide a feedback sentence frame: "One strength was... because... To improve, you could... For example...".',
        core: 'Students write feedback independently using the strength-plus-target format.',
        stretch: 'Students write feedback that references the assessment criteria by name and suggests how the speaker could move from Merit to Distinction.',
      },
      resources: ['Feedback examples slide (helpful vs unhelpful)', 'Feedback writing frame (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain why being a good listener is as important a skill as being a good speaker, linking to professional and academic contexts.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'What is active listening and why is it important when evaluating a spoken presentation?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Using the Spoken Language criteria, explain the difference between a Pass-level and a Distinction-level presentation.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Write one piece of constructive feedback for a speaker whose presentation had strong content but weak delivery. Be specific and actionable.',
      lines: 5,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  keywords: [
    'proposition', 'opposition', 'rebuttal', 'motion',
    'point of information', 'summing up', 'counter-argument', 'substantive point',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students identify the strongest point made by the opposing side and explain why it is strong before offering their counter-argument.',
    },
  ...
  mainActivities: [
    {
      ...
      resources: ['Debate structure handout', 'Visual flowchart (support tier)', 'Model debate extract'],
    },
    {
      ...
      differentiation: {
        support: 'Provide an argument bank with four pre-written points for each side; teams select and develop three.',
        core: 'Teams generate their own arguments and prepare counter-arguments independently.',
        stretch: 'Teams prepare a "trap" — a point designed to lead the opposition into a position they can then dismantle in rebuttal.',
      },
      resources: ['Motion slide', 'Debate preparation worksheet', 'Argument bank (support tier)', 'Timer'],
    },
    {
      ...
      differentiation: {
        support: 'Debating students may use note cards. Observing students use a simplified evaluation grid.',
        core: 'Debating students use minimal notes. Observers evaluate using the full listening framework.',
        stretch: 'Observers write a paragraph evaluating the most effective moment in the debate and explaining why it was persuasive.',
      },
      resources: ['Timer', 'Debate evaluation framework', 'Simplified evaluation grid (support tier)', 'Voting slips'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Students complete sentence starters: "I learned that...", "I want to improve...", "I will use...".',
      core: 'Students write three reflections independently.',
      stretch: 'Students evaluate whether debate or presentation is the more challenging spoken language skill and justify their view.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain the structure of a formal debate. What are the roles of the proposition and opposition?',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'What is the difference between simply disagreeing with someone and making an effective rebuttal? Give an example.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why is it important to be able to argue a position you do not personally agree with? How does this skill relate to the Spoken Language endorsement?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'You are on the opposition team debating the motion: "This house believes that social media should be banned for under-16s." Write three arguments you would use to oppose this motion.',
      lines: 8,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  keywords: [
    'endorsement', 'presentation', 'Standard English', 'distinction',
    'fluency', 'spontaneous', 'evaluation', 'composure',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Students may use prompt cards with up to ten bullet points. Teacher reassures and provides a calm, supportive environment.',
      core: 'Students use minimal notes — a single card with five or fewer bullet points.',
      stretch: 'Students aim to deliver without any notes, using only their rehearsed memory and confidence.',
    },
    resources: ['Students\' presentation materials', 'Prompt card templates', 'Peer feedback pledges from Lesson 8', 'Timer'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Presenting students may use prompt cards. Teacher may ask a pre-arranged "friendly" question to build confidence. Audience members use a simplified feedback form.',
        ...
        stretch: 'Students present from memory and invite challenging questions. Audience write feedback that references the criteria by name.',
      },
      resources: ['Timer', 'AQA criteria grid for teacher assessment', 'Listening framework for audience', 'Feedback slips', 'Simplified feedback form (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Teacher may paraphrase a difficult question to help the speaker understand what is being asked.',
        core: 'Students respond to questions independently with developed answers.',
        stretch: 'Students demonstrate the ability to concede a point gracefully while maintaining their overall argument.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Provide a self-evaluation form with sentence starters and a tick-box criteria checklist.',
        core: 'Students complete the self-evaluation independently with written reflection.',
        stretch: 'Students write a detailed paragraph evaluating their own performance, referencing specific moments and the criteria.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students explain how the skills from this unit will help them beyond the classroom — in interviews, university, or professional life.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Reflect on your presentation (or preparation). What was your greatest strength and what would you do differently next time?',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Evaluate a presentation you observed today. Award it a grade (Pass, Merit, or Distinction) and justify your decision with reference to at least three specific criteria.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'What skills from this Spoken Language unit will be useful to you in the future? Identify at least three situations beyond the classroom where these skills apply.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Write three pieces of constructive feedback for a speaker whose presentation had strong delivery but weak content. Be specific and actionable.',
      lines: 8,
      modelAnswer:
