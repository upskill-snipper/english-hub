...
const lesson1: LessonPlanData = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Display the quotation with key words underlined (flint, solitary, oyster). Provide a word bank of descriptive adjectives: miserly, isolated, cold-hearted, bitter, hostile. Ask students to choose three words from the bank and explain their choices.',
      ...
      stretch:
        'Students analyse the two similes in the quotation (flint, oyster) in detail: what specific qualities of flint and oysters does Dickens transfer to Scrooge? Why are these natural objects effective choices?',
    },
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the extract with key phrases pre-highlighted in three colours: similes (yellow), cold imagery (blue), direct address (green). Include a glossary: simile, metaphor, semantic field, pathetic fallacy, foil, juxtaposition, accumulation.',
        ...
        stretch:
          "Students write a paragraph exploring why Dickens uses ACCUMULATION - piling up simile after simile - rather than a single, elegant description. What is the rhetorical effect of excess? Connect this to Dickens's background as a journalist and public speaker.",
      },
    },
    {
      ...
      differentiation: {
        support:
          "Provide the two-column table pre-printed with Scrooge's quotations in column 1. Supply sentence starters for column 2: 'This reveals that wealthy Victorians believed... / This echoes Malthus's argument that...' Include a context card explaining the Poor Law and Malthus in simple terms.",
        core: 'Students complete both columns independently and participate in the discussion with textual evidence.',
        stretch:
          'Students write a paragraph arguing that Dickens deliberately makes Scrooge voice Malthusian philosophy so that when Scrooge is redeemed, the philosophy itself is discredited. How does personal transformation become political argument?',
      },
    },
    {
      ...
      differentiation: {
        support:
          'Provide a PEEL frame: \'Dickens presents Scrooge as cold and isolated by... For example, he describes Scrooge as "..." The word/image ... suggests... Dickens does this because he wants Victorian readers to...\'',
        core: 'Write a full PEEL paragraph independently with embedded quotation and technique analysis.',
        stretch:
          'Write a PEEL paragraph and add a second sentence to the Explain section offering an alternative interpretation. For example: \'While "solitary as an oyster" suggests isolation, an oyster also contains a pearl - could Dickens be hinting that goodness is hidden inside Scrooge, waiting to be revealed?\'',
      },
    },
  ],
  plenary: {
    ...
    differentiation: {
      support:
        "Provide sentence starters: 'I think Scrooge can/cannot change because...' and 'Dickens introduces him this way because...'",
      core: 'Students respond independently with a reason and write the concluding sentence.',
      stretch:
        'Students consider a meta-literary question: Dickens published A Christmas Carol on 19 December 1843 and it sold 6,000 copies in five days. What does this tell us about how hungry Victorian readers were for a story about redemption? Why might this message have been so needed?',
    },
  },
  keyVocabulary: [
...
const lesson2: LessonPlanData = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        "Provide sentence starters: 'From my past, I would want to be shown... because... In the present, I would want to see... For my future, I would want to know...' Display a simple diagram of the three ghosts with labels.",
      ...
      stretch:
        'Students consider why Dickens chose THIS order (past → present → future). What would change if the ghosts visited in a different order? Why must fear of the future come last?',
    },
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          "Provide the three quotations on cards with guided questions printed beneath each: 'Who is speaking? What does Scrooge remember? How does he react? What word/phrase is most powerful and why?'",
        core: 'Students annotate all three quotations independently, identifying technique and effect for each.',
        stretch:
          "Students compare Fezziwig to Scrooge as employers. Write a paragraph: 'How does Dickens use Fezziwig as a moral contrast to Scrooge?' Consider Fezziwig's generosity as a model for the kind of employer Dickens wants his readers to become.",
      },
    },
    {
      ...
      differentiation: {
        support:
          "Provide a guided response frame: 'Tiny Tim represents... because... When the Ghost quotes Scrooge's own words, the effect is... because... The lesson the Ghost teaches is...'",
        core: 'Students answer all three questions independently and copy the key point.',
        stretch:
          "Students write a paragraph evaluating Dickens's use of Tiny Tim: is he a convincing character, or is he a sentimental device designed to manipulate the reader's emotions? Can both be true? Does sentimentality weaken or strengthen Dickens's social argument?",
      },
    },
    {
      ...
      differentiation: {
        support:
          "Provide a comparison table: Column 1 = Scrooge in Stave 1 (cold, miserly, isolated), Column 2 = Scrooge in Stave 5. Students complete Column 2 and write a paragraph using sentence starters: 'In Stave 1, Scrooge was... whereas by Stave 5, he has become... Dickens shows this change through...'",
        ...
        stretch:
          "Students evaluate: is Scrooge's transformation believable? Can a person really change overnight? Or is Dickens more interested in the symbolic/moral lesson than psychological realism? What does this tell us about the novella's genre (moral fable vs realistic fiction)?",
      },
    },
  ],
  plenary: {
    ...
    differentiation: {
      support:
        "Provide a cue card with one argument for each ghost's effectiveness. Students choose and explain using the stem: 'I think the Ghost of Christmas... is most effective because...'",
      core: 'Students vote, justify their choice with textual evidence, and write a concluding sentence.',
      stretch:
        'Students argue that the question is flawed - the ghosts work as a SYSTEM, not individually. Each one would fail without the others. What is the literary term for a structure where each part builds on the last? (cumulative structure / rising action)',
    },
  },
  keyVocabulary: [
...
const lesson3: LessonPlanData = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        "Provide a biography card with five key facts about Dickens's life in bullet-point form. Students highlight the fact they think most influenced A Christmas Carol and explain their choice.",
      core: "Students infer connections between Dickens's experiences and the novella independently, offering verbal explanations.",
      stretch:
        'Students consider why Dickens chose fiction rather than a political pamphlet or newspaper article. What can a story do that an argument cannot? Why is Scrooge more persuasive than a speech in Parliament?',
    },
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the passage with key phrases underlined and a glossary defining: allegory, Ignorance (lack of knowledge/education), Want (poverty/deprivation), Doom. Supply guided questions on a card.',
        ...
        stretch:
          'Students write a paragraph connecting Ignorance and Want to the wider context of Victorian education reform. Dickens was a campaigner for ragged schools - free schools for destitute children. How does this passage function as propaganda for education reform?',
      },
    },
    {
      ...
      differentiation: {
        support:
          "Provide a paragraph frame that models integration: 'Dickens uses [quotation] to [technique], which reflects the Victorian [context]. This suggests that Dickens wanted his readers to [purpose]...' Students follow the frame with their chosen context fact.",
        ...
        stretch:
          'Students write two paragraphs: one with deliberately bolted-on context and one with seamlessly integrated context. They then annotate both to explain why the second is more effective. This metacognitive exercise builds exam awareness.',
      },
    },
    {
  ...
  plenary: {
    ...
    differentiation: {
      support:
        "Provide prompts for each bullet point: 'The novella is still relevant because today we still see... / It might not be relevant because... / I was surprised that...'",
      core: 'Students write three bullet points independently and share verbally.',
      stretch:
        'Students write a short paragraph connecting A Christmas Carol to a modern issue (food banks, homelessness, cost-of-living crisis). How would Dickens respond? What would a modern Scrooge look like?',
    },
  },
  keyVocabulary: [
...
export const christmasCarolPptxLessons: LessonPlanData[] = [lesson1, lesson2, lesson3]
