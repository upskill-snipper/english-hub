...
export const y7Term2Lessons: LessonPlan[] = [
  ...
  // ── Lesson 1: What is Voice? ──────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: ['Writing frame (support tier)', 'Success criteria checklist for peer feedback'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide sentence starters for the justification: "I placed this extract here because...".',
  ...
  // ── Lesson 2: Language and Identity ───────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide the five greetings already printed with a matching exercise linking each to a speaker type.',
  ...
  // ── Lesson 3: Descriptive Writing - Show Don't Tell ───────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a simple table comparing what each version does, with some cells pre-filled.',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide sentence starters for feedback: "I liked how you..." and "You could improve by...".',
  ...
  // ── Lesson 4: Reflective Writing - Personal Narrative ─────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Highlight the reflective sentences in Version B in advance so students can focus on explaining their effect.',
  ...
  // ── Lesson 5: Crafting a Personal Narrative ───────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide definitions of chronological, in medias res, and flashback alongside the three openings.',
    ...
    mainActivities: [
      {
        ...
        resources: ['Narrative arc diagram template', 'Guided arc with questions (support tier)'],
      },
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Students can read to a partner first for confidence before sharing with the class.',
  ...
  // ── Lesson 6: Empathy Through Reading - Journey to Jo'burg ────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide question starters: "What is your daily life like?", "What do you wish for?", "What challenges do you face?".',
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: ['Writing frame (support tier)', 'Reflective response template'],
      },
    ],
    plenaryActivity: {
  ...
  // ── Lesson 7: Viewpoint and Perspective ───────────────────────────────────
  {
    ...
    mainActivities: [
      {
        ...
        resources: ['Two viewpoint extracts handout', 'Viewpoint comparison table', 'Highlighters'],
      },
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          "Provide three options for why a narrator might be unreliable (e.g. they are lying, they don't know the full story, they are biased) and students choose the most relevant.",
  ...
  // ── Lesson 8: Writing from Another's Perspective - Diary Entries ──────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a checklist of possible conventions for students to tick off as they find them.',
  ...
  // ── Lesson 9: Letters with Purpose - Transactional Bridge ─────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a sorting template with formal/informal columns and clue words highlighted.',
    ...
    worksheetQuestions: [
      {
        question: 'List the structural conventions of a formal letter in the correct order.',
        lines: 6,
        modelAnswer:
  ...
  // ── Lesson 10: Assessment - Creative Writing: Identity Piece ──────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a pre-printed toolkit card with each technique and a brief reminder of what it means, with tick boxes.',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide the self-assessment grid with sentence starters and examples of what green/amber/red looks like for each criterion.',
