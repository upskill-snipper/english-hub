...
export const y9FullLessons: LessonPlan[] = [
  ...
  // ── Lesson 1: Victorian Context and Dickens' Purpose ─────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a word bank: expose, criticise, persuade, educate, wealthy, responsibility.',
  ...
  // ── Lesson 3: Themes - Redemption and Responsibility ─────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide three film/book examples of redemption for students to discuss and compare.',
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: ['Essay question slide', 'PEEL planning frame', 'Peer assessment checklist'],
      },
    ],
    plenaryActivity: {
  ...
  // ── Lesson 4: Conceptual Interpretation ──────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a highlighted version of Response B showing which parts make it conceptual.',
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: ['Paragraph structure guide', 'Coloured highlighters', 'Peer review checklist'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide the sentence frame: "This suggests... which reflects Dickens\' belief that...".',
  ...
  // ── Lesson 6: Writing for Purpose - Articles and Speeches ────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a PAF table with the Form column pre-completed; students identify Purpose and Audience.',
    ...
    worksheetQuestions: [
      {
        question:
          'What does PAF stand for? Why is it important to identify PAF before you start writing?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 7: Argument and Persuasion ────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a definition card for each device with an example; students match rather than recall.',
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide counter-arguments already written; students write refutations using sentence starters.',
        ...
        resources: ['Counter-argument exercise sheet', 'Sentence starters for refutation'],
      },
      {
    ...
    worksheetQuestions: [
      {
        question:
          'Define "counter-argument" and "refutation". Why are they important in persuasive writing?',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 9: Descriptive Techniques - Imagery and Symbolism ─────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide sentence starters for each sense (e.g. "I could hear...", "The air tasted of...").',
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: 'Students offer alternative revisions and compare which is more effective.',
      },
    },
    homework:
  ...
  // ── Lesson 10: Assessment - Writing Portfolio ────────────────────────────
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a proofread checklist focusing on capital letters, full stops, and common spelling errors.',
  ...
  // ── Lesson 11: 1930s Context - The American Dream ────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a definition of the American Dream and guided questions for the photographs.',
      ...
      resources: [
        'American Dream definition slide',
        'Three historical photographs',
        'Mini-whiteboards',
      ],
    },
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support: 'Provide key quotations pre-selected and sentence starters for the paragraph.',
  ...
  // ── Lesson 13: Themes - Loneliness and Dreams ────────────────────────────
  {
    ...
    mainActivities: [
      {
        ...
        resources: ['Theme map template', 'Of Mice and Men text', 'Character quotation bank'],
      },
      {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a word bank: necessary, cruel, comforting, impossible, essential, deceptive.',
  ...
  // ── Lesson 15: Assessment - Timed Analytical Essay ───────────────────────
  {
    ...
    starterActivity: {
      ...
      resources: ['Essay question slide', 'Planning grid', 'Quotation bank (support tier)'],
    },
    mainActivities: [
      {
        title: 'Timed Essay Writing',
