...
const lesson1: LessonPlan = {
  ...
  keywords: [
    'in medias res', 'narrative hook', 'pathetic fallacy', 'foreshadowing',
    'direct address', 'anecdote', 'exposition', 'prolepsis',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students categorise all ten openings by technique type and identify which technique appears most frequently among published writers.',
    },
    resources: ['Printed opening lines (x10)', 'Sticky notes', 'Technique classification handout (stretch tier)'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Students receive a pre-annotated model and highlight the key features rather than annotating from scratch.',
        core: 'Students annotate each model independently, labelling techniques and effects.',
        stretch: 'Students also identify the limitations or risks of each technique (e.g., in medias res can confuse readers if context is never provided).',
      },
      resources: ['Opening techniques PowerPoint', 'Six model paragraphs handout', 'Annotation guide'],
    },
    {
      ...
      differentiation: {
        support: 'Students write two openings instead of three, using a scaffolded frame with the first sentence provided for each technique.',
        core: 'Students write three openings independently and provide written feedback to their partner.',
        stretch: 'Students write a fourth opening that deliberately combines two techniques, then evaluate whether blending techniques strengthens or weakens the hook.',
      },
      resources: ['Story scenario card', 'Lined writing paper or exercise books', 'Peer feedback frame'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students suggest one revision to the winning opening that would make it even more compelling.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Read the following opening: "The door was already open when I arrived. That was the first wrong thing." Identify the technique used and explain its effect on the reader.',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Write an in medias res opening for a story about a chase scene. Your opening should be 2-3 sentences.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Compare two opening techniques — direct address and atmospheric description. Which is more effective for a ghost story, and why?',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'A student writes: "Once upon a time there was a girl called Sarah and she lived in a house." Rewrite this opening using a more effective technique and explain your choice.',
      lines: 6,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  keywords: [
    'pathetic fallacy', 'sensory detail', 'connotation', 'figurative language',
    'personification', 'semantic field', 'atmosphere', 'imagery',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Students transform three of the five sentences, with a model transformation provided for the first one.',
      core: 'Students transform all five sentences independently, aiming for variety of technique.',
      stretch: 'Students transform all five and then write a rule explaining the difference between showing and telling in their own words.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Provide a word bank of sensory and figurative vocabulary organised by mood (threatening / hopeful / melancholy).',
        core: 'Students write independently using the annotated model as a reference.',
        stretch: 'Students write the beach description but subvert the expected mood — make the beach feel threatening or the forest feel safe — to demonstrate that technique, not subject, creates atmosphere.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Students write 100 words using a planning frame that prompts them to address each sense in turn.',
        core: 'Students write 150 words independently and respond thoughtfully to feedback.',
        stretch: 'Students write 150 words, then revise their piece in light of feedback, producing a second draft that addresses at least two suggestions.',
      },
      resources: ['Four setting photographs (printed or projected)', 'Feedback slips', 'Planning frame (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students write their summary sentence and include a self-target for their next piece of descriptive writing.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain the difference between "showing" and "telling" in creative writing. Use an example to illustrate your answer.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Write a "showing" description of a busy city street. Use at least two senses and one example of figurative language. (50-80 words)',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'What is "pathetic fallacy" and why is it useful for creating atmosphere in creative writing?',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Read this sentence: "The garden was beautiful and peaceful." Rewrite it using the "show don\'t tell" technique, then explain what you changed and why.',
      lines: 6,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  keywords: [
    'characterisation', 'indirect characterisation', 'archetype', 'motivation',
    'interiority', 'subtext', 'body language', 'mannerism',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Teacher provides guiding questions: "What does this person care about? Are they relaxed or anxious?"',
      core: 'Students infer at least three personality traits with textual evidence for each.',
      stretch: 'Students also predict how this character might react in a crisis, based on the details provided.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students create two characters who are connected (rivals, siblings, strangers who will meet) and ensure their Four Windows sheets create contrast.',
      },
      resources: ['SAID characterisation handout', 'Four Windows planning sheet', 'Published extract examples'],
    },
    {
      ...
      differentiation: {
        support: 'Students write 100-120 words, with sentence starters provided for each SAID method.',
        core: 'Students write 150-200 words following all three rules.',
        stretch: 'Students write 200 words and deliberately include subtext — a moment where the character says one thing but clearly means another.',
      },
      resources: ['Lined writing paper', 'Partner feedback form', 'Sentence starters (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students write two sentences about the same character — one that creates a positive impression and one that creates a negative impression, using different SAID methods.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain the difference between direct and indirect characterisation. Why do examiners reward indirect characterisation more highly?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'A character is described as "kind". Write a short paragraph (3-4 sentences) that shows this character\'s kindness through their actions without using the word "kind" or any synonym.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why might a writer give a character contradictory traits? Use an example to support your answer.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Read this extract: "Dave was tall and strong. He was brave. He had blue eyes and brown hair." Rewrite it using the SAID method to create a more engaging character introduction.',
      lines: 6,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  keywords: [
    'dialogue tag', 'action beat', 'direct speech', 'split speech',
    'subtext', 'idiolect', 'exposition', 'speech verb',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide the rules checklist first, then ask students to use it to find and fix errors.',
      core: 'Students correct all six sentences and articulate the rule each error violates.',
      stretch: 'Students correct all six, then write a seventh correctly punctuated sentence that includes split speech.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Students identify the purpose of each extract from a multiple-choice list and convert three dialogue tags.',
        core: 'Students analyse all three extracts with written explanations and convert all five dialogue tags.',
        stretch: 'Students also write an original two-line exchange that contains subtext — the characters discuss something mundane but the real conflict is beneath the surface.',
      },
      resources: ['Three dialogue extracts handout', 'Action beats vs dialogue tags guide', 'Conversion exercise sheet'],
    },
    {
      ...
      differentiation: {
        support: 'Students write 120-150 words, with a planning frame and a bank of action beats to choose from.',
        core: 'Students write 200-250 words following all four constraints.',
        stretch: 'Students write the scene and then add a paragraph of interior thought from one character, revealing what they are really feeling during the argument.',
      },
      resources: ['Planning frame', 'Action beat word bank (support tier)', 'Peer assessment checklist'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Students have the rules checklist from the starter available during the rapid fire.',
      core: 'Students respond from memory and explain corrections.',
      stretch: 'Students who finish early write the most complex correctly punctuated speech sentence they can.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Punctuate the following sentence correctly: Come here she whispered I need to tell you something',
      lines: 3,
      modelAnswer:
    ...
    {
      question: 'Explain the difference between a dialogue tag and an action beat. Give an example of each.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'What is "subtext" in dialogue? Write a two-line exchange between a parent and teenager where the subtext is different from the literal words.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'Why is it important to give characters distinct voices in dialogue? How can a writer achieve this?',
      lines: 5,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  keywords: [
    'syntax', 'simple sentence', 'compound sentence', 'complex sentence',
    'minor sentence', 'fragment', 'periodic sentence', 'cumulative sentence',
    'anaphora', 'tricolon',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Students identify which version they prefer and circle the short sentence, explaining its effect verbally.',
      core: 'Students explain in writing why the short sentence is effective, using terms like "emphasis", "pace", and "contrast".',
      stretch: 'Students write their own three-sentence sequence that moves from long to short, creating a moment of impact.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Students match sentence types from a provided list and explain three effects using sentence starters.',
        core: 'Students identify all ten types and explain effects independently.',
        stretch: 'Students rewrite three of the sentences using a different structure and evaluate how the effect changes.',
      },
      resources: ['Sentence structure toolkit handout', 'Matching exercise worksheet', 'Published examples sheet'],
    },
    {
      ...
      differentiation: {
        support: 'Students write 120 words using a scaffolded frame that provides the first sentence of each phase.',
        core: 'Students write 200 words independently, following the three-phase structure.',
        stretch: 'Students add a fourth phase — aftermath — using periodic sentences to create a reflective, uncertain tone.',
      },
      resources: ['Phase structure guide', 'Highlighters (three colours)', 'Scaffolded frame (support tier)'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students offer a specific revision suggestion to improve the rhythm of one passage.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain the difference between a periodic sentence and a cumulative sentence. Give an example of each.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why might a writer use a sentence fragment (e.g., "Gone.") in a piece of creative writing? Is it always effective?',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'Write a five-sentence paragraph that moves from slow pace to fast pace using deliberate sentence structure changes. Annotate each sentence.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'A student writes: "I walked into the room. I saw a table. I saw a chair. I looked at the window. It was dark outside." What is wrong with this writing and how could sentence variety improve it?',
      lines: 5,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  keywords: [
    'sensory detail', 'synaesthesia', 'onomatopoeia', 'tactile imagery',
    'olfactory imagery', 'gustatory imagery', 'auditory imagery', 'precise vocabulary',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Teacher prompts the volunteer with questions: "What does it feel like? Is it warm or cold? Does it have a smell?"',
      core: 'Students write down sensory details as the volunteer speaks and use them to make their guess.',
      stretch: 'Students write a two-sentence description of the mystery object based only on the non-visual clues, before the reveal.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Each station has a vocabulary prompt card with useful adjectives and verbs for that sense.',
        core: 'Students write original descriptions without prompts, aiming for precision over quantity.',
        stretch: 'Students include at least one example of synaesthesia at each station (e.g., describing a sound as "sharp" or a smell as "heavy").',
      },
      resources: ['Five station setups', 'Sensory vocabulary grid', 'Audio clip and speaker', 'Scent jar', 'Texture objects', 'Prompt cards (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Students write 120-150 words using a structured planning frame that allocates two sentences per sense.',
        core: 'Students write 200 words independently with balanced sensory coverage.',
        stretch: 'Students write 200 words and include at least two examples of synaesthesia, then write a sentence explaining why these unexpected sensory combinations are effective.',
      },
      resources: ['Three scenario cards', 'Sensory vocabulary grids (from stations)', 'Planning frame (support tier)', 'Highlighters for labelling'],
    },
  ],
  plenaryActivity: {
  ...
  worksheetQuestions: [
    {
      question: 'Why is it a weakness to rely only on visual description in creative writing? Explain with reference to the reader\'s experience.',
      lines: 4,
      modelAnswer:
    ...
    {
      question: 'What is "synaesthesia" in creative writing? Give two original examples and explain why this technique is effective.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Write a description of rain using four different senses (not just sight). Each sense should have at least one sentence.',
      lines: 6,
      modelAnswer:
    ...
    {
      question: 'A student writes: "The cake looked nice. It was brown with white icing on top." Improve this description using at least three senses.',
      lines: 5,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  keywords: [
    'suspense', 'tension', 'foreshadowing', 'red herring',
    'cliffhanger', 'pacing', 'withholding', 'dramatic irony',
    'zoom in', 'slow motion writing',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students also identify moments where tension dips and explain why the writer includes these "relief" moments.',
    },
    resources: ['Tense passage extract (printed or projected)', 'Tension graph template', 'Dimmer switch or lamps'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Students match techniques to examples using a guided grid with the first two completed.',
        core: 'Students match all eight and rank the top three for a given scenario.',
        stretch: 'Students also identify which techniques are most effective in combination and explain why.',
      },
    ...
    },
    {
      ...
      differentiation: {
        support: 'Students write 150 words using a scaffolded frame that provides the first sentence of each phase and a checklist of techniques to include.',
        core: 'Students write 250 words independently, labelling five techniques.',
        stretch: 'Students write 250 words and then add a final paragraph — the door opens — where the tension breaks in an unexpected way (not a jump scare, but something subtler and more unsettling).',
      },
      resources: ['Scenario card', 'Techniques checklist', 'Scaffolded frame (support tier)', 'Highlighters'],
    },
  ],
  plenaryActivity: {
  ...
  worksheetQuestions: [
    {
      question: 'Explain how "withholding information" creates tension in creative writing. Use an example to support your answer.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'What is the "zoom in" or "slow motion" technique? How does it affect pacing and why is it effective at moments of high tension?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Write three sentences that use foreshadowing to hint that something bad is about to happen. Do not state anything frightening directly.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why do writers include moments of "relief" or reduced tension in a suspenseful passage? Would constant high tension be more effective?',
      lines: 5,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  keywords: [
    ...
    'unreliable narrator', 'narrative voice', 'free indirect discourse', 'stream of consciousness',
  ],
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students write a fifth version in second person ("You reach for the glass and your elbow catches the vase...") and discuss its unusual effect.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support: 'Students complete a comparison table with key features of each perspective, using sentence starters.',
        core: 'Students complete the table independently and write a paragraph analysing the unreliable narrator extract.',
        stretch: 'Students evaluate which perspective is most effective for different genres (horror, romance, mystery) and justify their choices.',
      },
      resources: ['Perspective notes handout', 'Published extracts (x4)', 'Unreliable narrator extract', 'Comparison table'],
    },
    {
      ...
      differentiation: {
        support: 'Students write 100 words per version using a planning grid with prompts for thoughts, observations, and feelings for each perspective.',
        core: 'Students write 150 words per version independently, with clear annotation.',
        stretch: 'Students write a third version — an unreliable first-person account from the student who denies cheating but whose narrative contains clues that they are lying.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students identify a scenario where a deliberately unusual perspective choice (e.g., second person ghost story) would be effective and explain why.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain the difference between "third person limited" and "third person omniscient" narration. What are the advantages of each?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Write the opening two sentences of a story in first person that immediately suggests the narrator might be unreliable. Explain the clues you included.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why is it important to maintain a consistent narrative perspective throughout a piece of creative writing? What goes wrong when writers accidentally shift perspective?',
      lines: 5,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  keywords: [
    'resolution', 'denouement', 'circular narrative', 'ambiguous ending',
    'cliffhanger', 'epiphany', 'catharsis', 'anticlimax',
  ],
  starterActivity: {
    ...
    differentiation: {
      support: 'Students rank the five endings from worst to least worst and explain their bottom choice.',
      core: 'Students explain what makes each ending weak and identify the common flaw.',
      stretch: 'Students rewrite one of the weak endings to make it effective (e.g., making the "dream" ending genuinely ambiguous rather than a cop-out).',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students identify endings that blend two types and explain how the combination creates a richer effect.',
      },
      resources: ['Ending strategies handout', 'Ten final paragraphs worksheet', 'Reference card (support tier)'],
    },
    {
      ...
      differentiation: {
        support: 'Students write 100-120 words with a planning frame that provides the first sentence and prompts for each strategy.',
        core: 'Students write 150-200 words independently with a clear strategy choice.',
        stretch: 'Students write two different endings for the same story using two different strategies, then evaluate which is more effective and why.',
      },
      resources: ['Story opening and middle handout', 'Planning frame (support tier)', 'Peer assessment guide'],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch: 'Students write two final sentences — one that provides closure and one that creates ambiguity — and explain the different effects.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain what a "circular narrative" ending is and why it can be effective. Give an example.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Why is "It was all a dream" considered a weak ending? Under what circumstances could a dream ending actually work?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'Write an "image ending" for a story about a character who has just said goodbye to someone they love. Your ending should be 2-3 sentences that close with a visual image rather than a statement of emotion.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'What does it mean for an ending to feel "earned"? Why is this concept important in creative writing?',
      lines: 5,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  keywords: [
    'mark scheme', 'content and organisation', 'technical accuracy',
    'ambitious vocabulary', 'structural features', 'proofreading',
  ...
  starterActivity: {
    ...
    differentiation: {
      support: 'Provide a simplified version of the mark scheme with key words highlighted and a glossary.',
      core: 'Students compare both levels independently and identify upgrade points.',
      stretch: 'Students also read the Level 2 descriptors and identify the specific weaknesses that keep writing at that level.',
    },
    resources: ['AQA Paper 1 Q5 mark scheme (projected)', 'Simplified mark scheme (support tier)', 'Exercise books'],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch: 'Students plan quickly and use remaining time to draft their first sentence, ensuring a strong opening.',
      },
      resources: ['Exam question slide', 'Planning template (projected and printed for support tier)', 'Visible timer'],
    },
    {
      title: 'Timed Writing',
      duration: '35 minutes',
      ...
      differentiation: {
        support: 'Students aim for 300-350 words. Provide a discreet prompt card with five techniques to include (e.g., sensory detail, short sentence for effect, figurative language).',
        core: 'Students aim for 400-500 words under full exam conditions.',
        stretch: 'Students aim for 450-500 words and consciously deploy at least one technique from each lesson in this unit.',
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support: 'Teacher guides the proofreading with three specific checks displayed on the board. Self-assessment uses a simplified three-level grid (bronze/silver/gold).',
      core: 'Students proofread independently and self-assess against the full mark scheme descriptors.',
      stretch: 'Students proofread, self-assess, and then identify the single paragraph that is weakest, explaining what they would change in a redraft.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question: 'Explain how you would allocate 45 minutes for a creative writing exam question. Why is each stage important?',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'What is the difference between a Level 3 and a Level 4 response in AQA Paper 1 Q5? Identify two key differences.',
      lines: 5,
      modelAnswer:
    ...
    {
      question: 'List five techniques from this unit that you could use to improve a creative writing exam response. For each, explain briefly how it would help.',
      lines: 8,
      modelAnswer:
    ...
    {
      question: 'A student writes the following opening for a descriptive piece: "The beach was nice. The sun was shining and it was a good day. I could see the sea." Rewrite this opening using techniques from this unit to transform it into a Level 4 response. (60-80 words)',
      lines: 8,
      modelAnswer:
