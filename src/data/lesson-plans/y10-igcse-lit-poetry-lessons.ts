...
export const y10IgcseLitPoetryLessons: LessonPlan[] = [
  ...
  // ── Lesson 2: Close Reading a Single Poem (Annotation Method) ─────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a checklist: "Analysis includes: 1. A named technique. 2. A connotation or implication. 3. A link to theme or effect."',
        core: 'Students write their own definition of analysis in one sentence, using the displayed example as a model.',
        stretch:
          'Students rewrite Response A as a fully analytical comment, adding metalanguage, connotations, and a thematic link.',
      },
      resources: [
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a partially annotated poem with six annotations already completed across the four lenses. Students add five further annotations.',
          core: 'Students annotate the full poem using the Four-Lens framework, aiming for at least twelve annotations total.',
          stretch:
            'Students write a brief "annotation hierarchy" - ranking their three most significant annotations and justifying why those are the most analytically rich moments in the poem.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Teacher pre-marks three potentially ambiguous moments in the poem with a star. Students choose two of those three to explore.',
          core: 'Students independently identify and write up two ambiguous moments with two interpretations each.',
          stretch:
            'Students explore whether their two chosen ambiguities relate to each other thematically, and write a short paragraph arguing that the poem deliberately sustains both meanings throughout.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students add a fourth layer: "The ambiguity here means..." exploring what is left unresolved.',
      },
  ...
  // ── Lesson 3: Analysing Form and Structure ────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students consider: why might a poet choose a sonnet form for a poem about conflict rather than free verse? What effect does the constraint create?',
      },
      resources: ['Form sorting cards (laminated sets)', 'Form reference card (support)'],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a partially completed Form Analysis grid with the form already named and two features already identified.',
          core: 'Students complete the grid independently and write two analytical sentences linking form choices to meaning.',
          stretch:
            'Students compare the formal implications of both poems: "The structured form of [Poem A] suggests..., whereas the free verse of [Poem B] suggests..."',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Highlight all enjambments, caesuras, and voltas for students in advance; students write analytical labels for each one rather than locating them independently.',
          core: 'Students locate and annotate all three features independently and write a full analytical paragraph.',
          stretch:
            "Students explain how the structural choices interact with the poem's language to create a unified effect - writing two paragraphs, one on each technique, with a linking sentence.",
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write two linked sentences - one on form, one on structure - and explain how the two elements reinforce each other.',
      },
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Explain what a volta is and describe its effect in a poem you have studied.',
        lines: 4,
        modelAnswer:
  ...
  // ── Lesson 4: Imagery and Language Technique Analysis ─────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students analyse the entire line at all three pyramid levels before the class discussion.',
      },
      resources: [
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students compare two instances of the same device used in different parts of the poem, arguing how the second instance develops or subverts the first.',
        },
        resources: [
          'Selected anthology poem (printed)',
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Teacher pre-highlights the relevant words; students identify the shared concept and write the analytical statement.',
          core: 'Students independently locate the semantic field and write the full analytical statement.',
          stretch:
            "Students identify a second, contrasting semantic field in the same poem and write a paragraph arguing that the tension between the two fields is itself the poem's central meaning.",
        },
        resources: ['Second selected anthology poem (printed)', 'Semantic field analysis template'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Allow students to use their three-sentence analysis frame as a scaffold, selecting the strongest elements.',
        core: 'Students draft independently and refine after hearing peer examples.',
        stretch:
          'Students write two linked sentences - one identifying a technique and its connotations, the second exploring how the technique connects to a different poem in the same cluster.',
      },
  ...
  // ── Lesson 5: Comparing Two Poems from the Same Cluster ───────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a pre-drawn Venn diagram with six points already placed - three in the left circle, two in the centre, one in the right. Students add three more.',
        core: 'Students complete the Venn diagram independently and add one analytical comment to any two of their points.',
        stretch:
          'Students rank the three most analytically significant comparisons from their Venn diagram and explain why those comparisons are richer than the others.',
      },
      resources: ['Two poem stanzas displayed on projector', 'Pre-drawn Venn diagram template'],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide six pairs of single-poem sentences. Students choose three pairs and combine each using a connective from the provided list.',
          ...
          stretch:
            'Students write a full comparative paragraph (5-7 sentences) using the zoomed-in method, integrating quotations from both poems around a single thematic focus.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a PEAL grid with the thematic points already identified. Students supply evidence and analysis for each poem.',
          core: 'Students plan and write two paragraphs independently using the PEAL grid.',
          stretch:
            'Students write a third paragraph that explores the most significant difference between the two poems, arguing which poem they find more effective and why.',
        },
        resources: ['PEAL comparison grid template', 'Printed copies of both selected poems'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Students write a third piece of feedback: "A question this comparison raises that you haven\'t yet answered is..."',
      },
  ...
  // ── Lesson 6: Comparing Across Clusters ───────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide one connection as a model: e.g., "Both [Poem A from Cluster 1] and [Poem B from Cluster 2] use the imagery of water to represent [theme]."',
        core: 'Students generate two cross-cluster connections and write a sentence explaining each.',
        stretch:
          'Students predict what exam question might arise from the most interesting cross-cluster pairing they have identified.',
      },
      resources: ['Four poem titles displayed on projector', 'Connection model sentence (support)'],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            "Students write an analytical statement about whether the cross-cluster comparison reveals something about the anthology as a whole - what does the editor's curation suggest about the relationship between these themes?",
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide the evaluative sentence frame: "While both poets explore [theme], I find [Poem] more effective because [reason supported by evidence]."',
          core: 'Students write both paragraphs independently with an evaluative argument.',
          stretch:
            "Students challenge themselves to argue the opposite position in a third paragraph - playing devil's advocate - and then decide which argument is stronger.",
        },
        resources: ['Evaluative sentence frame (support)', 'Annotated poem copies'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Sentence frame: "The most interesting comparison I found today is between [Poem A] and [Poem B] because both [connection], yet [difference]."',
        core: 'Students write independently without a frame.',
        stretch:
          'Students consider: does the cross-cluster comparison reveal a limitation in the thematic cluster system? Could the anthology be organised differently?',
      },
      resources: [],
    },
    homework:
  ...
  // ── Lesson 7: Writing a Timed Poetry Comparison Paragraph ─────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a sentence frame for each example: "The [technique] of [quotation] suggests..."',
        core: 'Students rewrite all five independently before class correction.',
        stretch:
          'Students write three additional embedded quotation sentences independently, each using a different analytical verb (explores, implies, conveys).',
      },
      resources: [
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide a PEAL grid with the Point already written. Students supply evidence and analysis.',
          core: 'Students complete a full PEAL grid in three minutes independently.',
          stretch:
            'Students plan two paragraphs in five minutes, with the second paragraph including an evaluative comparative sentence.',
        },
        resources: ['PEAL comparison grid template', 'Modelled teacher plan on projector'],
      },
      {
        ...
        differentiation: {
          support:
            'In Part 1, allow students to use their PEAL grid as a sentence-by-sentence writing guide.',
          core: 'Students write independently, self-assess, and rewrite without additional support.',
          stretch:
            'Students write a second paragraph in the remaining time, focusing on a formal or structural contrast rather than a thematic connection.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          "Offer to share the teacher's own modelled improvement as one of the three examples if student volunteers are scarce.",
        core: 'Students participate in the class discussion and write down the three common improvements in their notes.',
        stretch:
          'Students write a personalised target card: "In my next timed paragraph I will specifically improve..."',
      },
  ...
  // ── Lesson 8: The Unseen Poem Question Technique ──────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a prompt: "Your three words should describe how the poem makes you feel OR the atmosphere it creates."',
        core: 'Students generate three independent reaction words and justify one of them with a brief reference to the poem.',
        stretch:
          'Students predict the theme of the poem from their first reactions alone, then articulate what specific features of the poem produced that prediction.',
      },
      resources: ['Unseen poem printed face-down (one per student)'],
    },
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students predict what an exam question about this poem might focus on, and plan a one-paragraph response to their predicted question.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide a three-paragraph frame with the opening sentence of each paragraph already drafted, so students can focus on analytical content.',
          core: 'Students write a full independent three-paragraph response in 20 minutes.',
          stretch:
            'Students aim for four paragraphs, including an evaluative concluding paragraph that reflects on the ambiguities in the poem and their effect.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Prompt students with: "Did you use any of the techniques from the Four-Lens framework today?"',
        core: 'Students identify three specific skills transferred from anthology to unseen.',
        stretch:
          'Students articulate which anthology skill was hardest to apply to an unseen poem and why, and suggest a practice strategy for strengthening it.',
      },
      resources: [],
    },
    homework:
  ...
  // ── Lesson 9: Exam Question Deconstruction and Planning ───────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide the four analytical expectations already written out; students match command words to expectations only.',
        core: 'Students match and then write one sentence explaining what the question is asking them to do in their own words.',
        stretch:
          'Students rank the five questions by difficulty and justify their ranking, identifying which require the most sophisticated analytical skill.',
      },
      resources: [
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide the four-step deconstruction framework as a printed guide with the first question already deconstructed.',
          core: 'Students deconstruct both questions independently using the four steps.',
          stretch:
            'Students write a question of their own in the style of an IGCSE question, then deconstruct it to verify it is answerable using the four-step framework.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide an essay plan template with all five sections labelled and one bullet point per section already filled in.',
          core: 'Students complete the full plan in eight minutes independently.',
          stretch:
            'Students add a fourth body paragraph (a cross-cluster comparison that brings in a third poem to support their argument) and a personal evaluative statement.',
        },
        resources: [
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a checklist of features to find in Plan B rather than generating them independently.',
  ...
  // ── Lesson 10: Full Timed Poetry Comparison Essay ─────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Provide a recall grid with the nine skill names and three prompts per skill (definitions, a technique, an example).',
        core: 'Students write one sentence per skill from memory.',
        stretch:
          "Students identify which three skills they will use most in today's essay and explain why in one sentence each.",
      },
      resources: [
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            'Students plan four body paragraphs and include a cross-cluster reference in the fourth.',
        },
        resources: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Students may keep their essay plan template and annotated poems visible. They may write three paragraphs rather than four.',
          core: 'Students write introduction + three body paragraphs + conclusion without support materials visible.',
          stretch:
            'Students aim for four body paragraphs + a conclusion that includes an evaluative judgement about which poem is more effective and why.',
        },
        resources: ['Countdown timer on projector', 'Annotated poem copies (support only)'],
      },
    ],
    plenaryActivity: {
      ...
      differentiation: {
        support:
          'Provide a mark scheme annotation guide: "This paragraph is in Band [X] because [evidence]."',
        core: 'Students self-assess independently against the full mark scheme.',
        stretch:
          'Students write a 50-word improvement note identifying one structural change (e.g., sequencing of paragraphs) and one analytical change (e.g., deeper connotation work) they would make on redrafting.',
      },
      resources: [
