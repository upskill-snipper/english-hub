...
export const jekyllHydeLessonPlans: LessonPlan[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      {
        ...
        resources: ['Four station cards', 'Context map handout', 'Key vocabulary definitions'],
      },
      {
    ...
    worksheetQuestions: [
      {
        question: 'Explain two features of Victorian society that are relevant to Jekyll and Hyde.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'What is the Gothic genre? List four conventions and explain one in detail.',
        lines: 6,
        modelAnswer:
      ...
      {
        question: 'Why is the Victorian setting of London important to the novella?',
        lines: 4,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    worksheetQuestions: [
      ...
      {
        question: "What does the term 'atavism' mean, and how does it relate to Hyde?",
        lines: 4,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Consider what the window itself symbolises - a frame through which hidden truths are glimpsed.',
      },
    },
    mainActivities: [
      {
    ...
    worksheetQuestions: [
      ...
      {
        question: "How does Stevenson present Jekyll's loss of control over his transformations?",
        lines: 6,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        resources: ['Chapter 10 extracts', 'Writing frame (support)', 'Key quotation bank'],
      },
      {
    ...
    worksheetQuestions: [
      ...
      {
        question: "How does Stevenson present Jekyll's hubris, and why is it significant?",
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'Can Jekyll be considered a tragic hero? Explain your reasoning.',
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'How does Stevenson use Jekyll to convey his message about human nature?',
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        ...
        stretch:
          "Explain the literary purpose of making Hyde 'indescribable' rather than specifically deformed.",
      },
    },
    mainActivities: [
      {
        ...
        differentiation: {
          support:
            'Provide quotations pre-gathered; students categorise and analyse with sentence starters.',
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Add a third paragraph evaluating which interpretation of Hyde is most convincing.',
        },
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Why is Hyde physically smaller than Jekyll? What might this symbolise?',
        lines: 4,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Provide guided worksheets for each group with quotations and analysis starters.',
      ...
      },
      {
        ...
        differentiation: {
          ...
          core: 'Write two paragraphs independently.',
          stretch:
            "Add a concluding sentence evaluating Stevenson's message: Can duality ever be resolved?",
        },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch:
          'Argue whether modern society handles duality better or worse than Victorian society.',
      },
    },
    homework:
    ...
    worksheetQuestions: [
      {
        question: "What is meant by 'duality' in the context of Jekyll and Hyde?",
        lines: 4,
        modelAnswer:
      ...
      {
        question: "How does Stevenson use the two doors of Jekyll's house to symbolise duality?",
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'How does the theme of duality connect to Victorian social context?',
        lines: 5,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    worksheetQuestions: [
      {
        question: "How does the theme of reputation influence Utterson's behaviour in the novella?",
        lines: 5,
        modelAnswer:
      ...
      {
        question: 'How does the theme of reputation connect to Victorian social context?',
        lines: 4,
        modelAnswer:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support:
          'Techniques are defined on the bingo card; students match quotations to definitions.',
    ...
    mainActivities: [
      ...
      },
      {
        ...
        differentiation: {
          support:
            'Match narrative methods to their effects from a provided list, then write with sentence starters.',
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch:
            'Write the paragraph and then annotate it, labelling where they address each AO.',
        },
    ...
    worksheetQuestions: [
      ...
      {
        question: 'Identify one example of foreshadowing in the novella and explain its effect.',
        lines: 4,
        modelAnswer:
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch:
            "Plan four paragraphs including an evaluative conclusion about Stevenson's message.",
        },
      ...
      },
      {
        ...
        differentiation: {
          ...
          stretch: 'Rewrite their weakest paragraph at a higher band, labelling the improvements.',
        },
