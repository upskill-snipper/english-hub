...
export const aqaLanguageLessonPlans: AQALessonPlan[] = [
...

  {
    ...
    starterActivity: {
      ...
      duration: '10 mins',
      resources: [
        'Q2 mark scheme (projected)',
        'Two example Q2 responses (5-mark and 6-mark)'
      ]
    },
    mainActivity: {
      description:
...

  {
    ...
    mainActivity: {
      ...
      differentiation: {
        support: 'Provide partially completed framework sheet. Highlight Task 1 and Task 2 format. Offer visual timeline showing 45 mins per task.',
        stretch: 'Compare Paper 1 Q5 (creative, 40 marks, one task) with Paper 2 Tasks 1&2 (40 each, two different tasks). Discuss advantages and challenges of switching between two tasks.'
      }
    },
    plenary: {
      description: 'Paper 2 in 90 Seconds: Students write everything they know about Paper 2. Swap with partner; partner ticks correct info and adds anything missing. Teacher calls on three students to share one fact each. Collect for formative assessment.',
      duration: '10 mins'
    },
    homework: 'Create a Paper 2 quick-reference card (A5 size). Include: Section A (two 40-mark writing tasks, 1hr 45mins), Section B (Spoken Language NEA, separate), what each task typically asks, personalised timing plan. Use this card in exam conditions.',
    resourcesNeeded: ['Venn diagram template', 'AQA Paper 2 specimen paper or example prompts', 'Paper 2 framework template', 'Example Task 1&2 prompts', 'Whiteboard/marker', 'Quick-reference card template'],
    assessmentOpportunities: ['Venn diagram completion', 'Framework sheet creation', '90-second recall', 'Quick-reference card'],
    keyVocabulary: ['Section A', 'Section B', 'writing task', 'purpose', 'audience', 'form', 'persuasive', 'narrative', 'NEA'],
    crossCurricular: ['Spoken communication', 'Public speaking', 'Audience awareness'],
    sendAdaptations: 'Provide pre-completed framework with info highlighted. Use large print. Simplify language. Read aloud. Pair with peer. Seat near teacher. Use visual timeline.'
  },

  {
    ...
    mainActivity: {
      ...
      differentiation: {
        support: 'Provide purpose/audience/form frame template. Offer persuasive techniques list with examples. Provide sentence starters. Allow shorter response (300–400 words).',
        stretch: 'Write discursive piece presenting both sides fairly before conclusion. Include counterargument and refutation. Compare with professional opinion article and adopt techniques.'
      }
    },
    plenary: {
      description: 'Purpose Sorting: Display five extracts (persuasive article, discursive essay, information leaflet, narrative, speech). Students identify purpose and explain reasoning. Discuss: What clues tell you the purpose?',
      duration: '10 mins'
    },
    homework: 'Write persuasive or discursive piece (400–500 words) in response to past paper prompt or teacher prompt. Spend 5 mins planning, 30 mins drafting, 5 mins checking. Annotate: highlight one persuasive technique, one audience awareness example, one piece of evidence.',
    resourcesNeeded: ['Purpose card deck', 'Purpose/audience/form chart', 'Persuasive techniques reference sheet', 'Form structure guides', 'Grade 6&8 model responses', 'Past paper prompts', 'Mark scheme'],
    assessmentOpportunities: ['Purpose Charades', 'Planned outline', 'Timed persuasive draft (self-assessed)', 'Homework annotated piece'],
    keyVocabulary: ['purpose', 'persuasive', 'discursive', 'informative', 'narrative', 'audience', 'form', 'tone', 'rhetorical question', 'emotive language'],
    crossCurricular: ['Persuasion & rhetoric', 'Debate & argumentation', 'Public speaking', 'Marketing & advertising'],
    sendAdaptations: 'Provide detailed purpose/audience/form frame. Offer persuasive techniques list with examples. Provide sentence starters. Allow word processor. Scribe if needed. Reduce word count (250–300). Pair with peer. Large print. Extra time.'
  },

  {
    ...
    mainActivity: {
      ...
      differentiation: {
        support: 'Provide definition cards with examples. Provide sentence starters showing how to use each device. Allow shorter response (80–100 words). Reduce number of devices (aim for 2 instead of 3).',
        stretch: 'Challenge: Use all six devices in single paragraph. Write two versions: one using devices, one using facts only. Compare persuasive power.'
      }
    },
    plenary: {
      description: 'Device Detective: Display short professional persuasive piece (Greenpeace article, political speech, charity letter). Students highlight/mark each rhetorical device. Discuss: How does professional author use devices strategically? What can we learn?',
      duration: '10 mins'
    },
    homework: 'Find persuasive text outside classroom (social media, advertisement, speech, article, letter). Identify at least THREE rhetorical devices. Bring text and annotation to next lesson. Be prepared to explain why each device was chosen and how effective it is.',
    resourcesNeeded: ['Five persuasive sentences (starter)', 'Device definition cards (with examples)', 'Six rhetorical devices reference sheet', 'Model persuasive paragraph (annotated)', 'Persuasive topic prompts', 'Professional persuasive text excerpt (plenary)', 'Annotation colours/markers'],
    assessmentOpportunities: ['Device Spotlight matching', 'Model paragraph annotation', 'Student persuasive paragraphs', 'Professional text annotation', 'Homework text analysis'],
    keyVocabulary: ['rhetorical device', 'rhetorical question', 'repetition', 'emotive language', 'direct address', 'tricolon', 'metaphor', 'persuasive', 'effect', 'impact'],
    crossCurricular: ['Persuasion & rhetoric', 'Marketing & advertising', 'Political speech analysis', 'Media literacy'],
    sendAdaptations: 'Provide large definition cards with visual examples. Colour-code each device consistently. Offer sentence starters. Reduce devices to identify/use (2 instead of 3). Pair with peer for drafting. Read professional text aloud. Allow extra time. Large-print resources.'
  },

  {
    ...
    resourcesNeeded: ['Form feature cards (sorting)', 'Three-column sorting template', 'Article structure guide + example', 'Letter structure guide + example', 'Speech structure guide + example', 'Same argument in all three forms', 'Form-specific templates (support)', 'Past paper prompts', 'Mark scheme'],
    assessmentOpportunities: ['Form feature sorting', 'Three versions identification', 'Student writing in chosen form', 'Homework annotated piece'],
    keyVocabulary: ['article', 'letter', 'speech', 'headline', 'subheading', 'greeting', 'closing', 'formal', 'direct address', 'hook', 'convention', 'form'],
    crossCurricular: ['Business communication', 'Journalism', 'Public speaking', 'Persuasion'],
    sendAdaptations: 'Provide pre-completed templates with structure marked. Simplify examples. Offer list of conventions to check. Reduce word count (250–300). Allow Letter or Article only (not Speech). Pair with peer. Large print. Extra time.'
  },

  {
    ...
    mainActivity: {
      ...
      differentiation: {
        support: 'Provide detailed planning template. Offer sentence starters. Allow 50 minutes instead of 45. Provide large-print prompt. Seat near teacher.',
        stretch: 'Aim for 500+ words. Use 4+ rhetorical devices. After finishing, self-assess against mark scheme and identify what would push from Grade 7 to Grade 8.'
      }
    },
    plenary: {
      description: 'Reflection & Observation (5 mins). Collect reflection sheets. Ask volunteers: "What did you find challenging? What was your approach?" Observe (without naming): Which rhetorical devices appeared? Did students use form-appropriate language? Address common challenges. Celebrate completion and effort.',
      duration: '5 mins'
    },
    ...
    resourcesNeeded: ['Past paper Task 1 prompt (lesson)', 'Prompt Decoder worksheet', 'Planning template', 'Countdown timer', 'Reflection sheet', 'Second Task 1 prompt (homework)', 'Detailed mark scheme'],
    assessmentOpportunities: ['Prompt Decoder identification', 'Planning notes', 'Timed Task 1 response (summative)', 'Reflection sheet', 'Homework self-assessment'],
    keyVocabulary: ['task', 'prompt', 'form', 'purpose', 'audience', 'planning', 'rhetorical device', 'persuasive technique'],
    crossCurricular: ['Exam technique', 'Time management', 'Self-assessment'],
    sendAdaptations: 'Provide detailed planning template and sentence starters. Allow 50 minutes. Seat near teacher. Large-print prompt. Quiet exam space. Reader/scribe if appropriate. 10-minute and 5-minute time warnings clearly. Word bank of useful vocabulary.'
  },

  {
    ...
    mainActivity: {
      ...
      differentiation: {
        support: 'Provide narrative/descriptive planning template. Offer sentence starters. Allow 50 minutes instead of 45. Reduce target word count. Seat near teacher. Large-print prompt.',
        stretch: 'Challenge: After finishing, self-assess against mark scheme. Identify one sentence you would strengthen and rewrite it. Calculate estimated mark.'
      }
    },
    plenary: {
      description: 'Task Comparison (5 mins): Students briefly share approach to Task 1 and Task 2. Discuss: "How different was your writing process? How did techniques change between tasks?" Celebrate the ability to switch modes — it is a sophisticated skill.',
      duration: '5 mins'
    },
    homework: 'Complete both Task 1 and Task 2 under full timed conditions (90 minutes: 45 mins Task 1 + 45 mins Task 2, with 5-minute break between). Self-assess both responses against detailed mark scheme. Compare: Which task felt more successful? Why?',
    resourcesNeeded: ['Past paper Task 2 prompt (lesson)', 'Planning template for narrative/descriptive', 'Countdown timer', 'Reflection sheet', 'Past paper Task 1 and Task 2 prompts (homework)', 'Detailed mark scheme'],
    assessmentOpportunities: ['Task 1 vs Task 2 comparison', 'Timed Task 2 response (summative)', 'Reflection', 'Homework full exam'],
    keyVocabulary: ['narrative', 'descriptive', 'character', 'setting', 'plot', 'sensory detail', 'figurative language', 'mood', 'technique', 'communication', 'organisation'],
    crossCurricular: ['Creative writing', 'Exam technique'],
    sendAdaptations: 'Provide detailed planning template for narrative/descriptive. Offer sentence starters. Allow 50 minutes. Seat near teacher. Large-print prompt. Quiet space. Reader/scribe if needed. Clear 10-minute and 5-minute time warnings. Reduce target word count.'
  },

  {
    ...
    starterActivity: {
      description: 'Presentation Autopsy: Show a 2-minute video of a professional speaker. Ask: What makes this person effective? Students note pace, volume, eye contact, pauses, gesture. This models what effective spoken language looks like.',
      duration: '10 mins',
      resources: ['Video clip of professional speaker (2 mins)', 'Effective speaking checklist']
    },
    mainActivity: {
      description: 'Teach NEA requirements and presentation planning. Requirements: Prepare a 3–5 minute presentation on a topic of personal interest. Delivery skills: Pace, Volume, Clarity, Eye contact, Gesture, Confidence. Model a 2–3 minute presentation. Students choose topic and plan: Choose topic → Identify 4–5 main points → Gather examples → Plan opening and closing.',
      duration: '35 mins',
      steps: [
      ...
      differentiation: {
        ...
        stretch: 'Plan a persuasive presentation or one requiring research. Include counterarguments.'
      }
    },
    plenary: {
    ...
    homework: 'Complete planning. Prepare speaker notes (bullet points). Practice delivery at home. Time yourself — aim for 3–5 minutes.',
    resourcesNeeded: ['Professional speaker video clip', 'Effective speaking checklist', 'Planning template', 'Topic options'],
    assessmentOpportunities: ['Planning sheet (topic + structure)', 'Peer feedback on topic choice'],
    ...
    sendAdaptations: 'Provide detailed planning template; offer topic suggestions; normalize presentation anxiety; pair with peer; allow practice run beforehand; clarify that accent/pronunciation are never marked.'
  },

  {
    ...
    starterActivity: {
      description: 'Nerves Normalization: Discuss presentation anxiety. Affirm: "Nervousness is normal. Good preparation helps." Outline what will happen: "You\'ll deliver your presentation. I\'ll ask 2–3 questions. Classmates will listen respectfully and give feedback."',
      duration: '5 mins',
      resources: ['Calm, supportive classroom tone']
    },
    mainActivity: {
      description: 'Students deliver prepared presentations (3–5 mins each). After each, teacher asks 2–3 follow-up questions. Class gives feedback. Assessment focus: Clarity, pace, eye contact, confidence, ability to respond to questions.',
      duration: '50 mins',
      steps: [
      ...
      differentiation: {
        support: 'Allow standing beside teacher if anxious. Provide sentence starters. Assure that answers do NOT need to be perfect.',
        stretch: 'Make eye contact with different audience members. Include rhetorical question or powerful closing statement.'
      }
    },
    plenary: {
      description: 'Celebration (5 mins). Discuss: "What went well? What delivery techniques did you notice? How did you feel?" Celebrate all speakers.',
      duration: '5 mins'
    },
    homework: 'Reflect on your presentation: (1) How confident did you feel? (2) What went well? (3) What would you improve? (4) How did you respond to follow-up questions? Write brief reflection.',
    resourcesNeeded: ['Classroom space', 'Stopwatch/timer', 'Assessment form', 'Listener feedback sheet'],
    assessmentOpportunities: ['Live presentation (assessed against rubric)', 'Spontaneous Q&A response', 'Peer feedback', 'Self-reflection'],
    ...
    sendAdaptations: 'Allow seated presentation if standing causes anxiety. Allow beside teacher. Provide practice beforehand. Simplify follow-up questions. Normalize anxiety and celebrate attempt. Seat in quiet space if distracted. Allow extra time. Clarify that accent/pronunciation not marked.'
  },

  {
    ...
    starterActivity: {
      description: 'Brief confidence check: "Today you\'re completing a full Paper 2 exam under authentic conditions. You\'ve practiced both tasks multiple times. You\'re ready. Work independently. No help will be given. Afterward, you\'ll receive feedback for final revision."',
      duration: '5 mins',
      resources: ['Full Paper 2 past paper']
    },
    mainActivity: {
      description: 'Deliver complete Paper 2 exam (90 mins: 45 Task 1 + 5-min break + 45 Task 2). Students work independently. Teacher circulates observing. Time announcements at intervals. After 90 mins, collect papers. Students complete reflection exit slip.',
      ...
      differentiation: {
        support: 'Provide planning templates; allow 105 mins; seat near teacher; use large-print paper; allow word processor or reader/scribe.',
        stretch: 'Challenge: Self-assess one response against mark scheme after finishing.'
      }
    },
    plenary: {
      description: 'Debrief (5 mins): "You\'ve completed a full mock exam. Excellent exam practice. Feedback comes next. Reflect on what went well and what was challenging."',
      duration: '5 mins'
    },
    homework: 'Self-reflect on your Paper 2 exam. Write: (1) How did you feel? (2) Did you finish both tasks? (3) Which task felt stronger? (4) What would you do differently in the real exam?',
    resourcesNeeded: ['Full Paper 2 past paper', 'Blank paper/exam booklet', 'Countdown timer', 'Exit slip template', 'Planning templates'],
    assessmentOpportunities: ['Complete Paper 2 exam (summative)', 'Exit slip reflection', 'Teacher observation of technique use'],
    keyVocabulary: ['mock exam', 'authentic conditions', 'time management'],
    crossCurricular: ['Exam technique', 'Resilience under pressure'],
    sendAdaptations: 'Provide planning templates; allow 105 mins; seat near teacher; large-print paper; word processor; reader/scribe; clear time announcements; affirm effort; celebrate completion.'
  },

  {
    ...
    starterActivity: {
      description: 'Progress Review: Display visual timeline showing journey from Lesson 1 to now. Affirm: "Look how far you\'ve come. You\'ve practiced every question type and improved. This final lesson helps you focus your last weeks of revision."',
      duration: '5 mins',
      resources: ['Progress tracker (visual timeline)']
    },
    mainActivity: {
      description: 'Deliver Paper 2 mock feedback. Hand out personalised feedback sheets. Students read. Pair discussion. Create revision focus cards identifying ONE area per paper. Create final revision checklist together: Paper 1 (Q1–Q5) and Paper 2 (Task 1, Task 2, Spoken Language). Students copy into revision book. Share cards in groups.',
      duration: '50 mins',
      steps: [
      ...
      differentiation: {
        support: 'Simplify feedback to ONE point per paper. Provide revision focus options. Offer one-to-one feedback.',
        stretch: 'Write 3–4 specific revision activities for focus area. Create accountability tracker.'
      }
    },
    plenary: {
      description: 'Celebration & Commitment (5 mins). Affirm: "You\'ve learned so much. Practiced every question type. Received feedback. Your revision focuses show where your effort will matter most. I\'m confident you\'re ready. Let\'s make these final weeks count."',
      duration: '5 mins'
    },
    homework: 'Begin targeted revision based on focus cards. For Paper 1 focus: Complete one question, self-assess. For Paper 2 focus: Complete one practice task, self-assess. For Spoken Language: Practise presentation delivery. Bring evidence of revision to next lesson.',
    resourcesNeeded: ['Personalised Paper 2 mock feedback sheets', 'Progress tracker', 'Revision focus card template', 'Revision checklist template', 'Past paper question banks'],
    assessmentOpportunities: ['Paper 2 mock feedback (summative)', 'Revision focus cards (identifies needs)', 'Revision checklist (planning tool)', 'Homework revision activities (formative)'],
    keyVocabulary: ['feedback', 'revision focus', 'targeted improvement', 'self-assessment', 'progress'],
    crossCurricular: ['Self-assessment', 'Study skills and time management'],
    sendAdaptations: 'Provide simplified feedback (one key point per paper). Offer pre-made revision options. Offer one-to-one feedback. Pair with peer. Use simple, clear language. Celebrate progress and effort. Affirm that revision is individual and personal.'
  }
]
