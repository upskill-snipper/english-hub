...
const lesson1: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a simplified definition of irony with two everyday examples before discussing the quotation.',
      core: 'Students annotate the sentence, identifying which words signal irony and explaining why.',
      stretch:
        'Students rewrite the sentence to express its true meaning without irony, then compare the effect of both versions.',
    },
    resources: [
      'Opening sentence displayed on board',
      'Irony definition card (support tier)',
      'Mini-whiteboards',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a partially completed comparison table with key quotations already identified; students analyse their effect.',
        core: 'Students complete the comparison table independently and select two quotations to analyse in detail.',
        stretch:
          'Students write a paragraph evaluating how Austen uses dialogue to characterise the Bennets without direct narrative description.',
      },
      resources: [
        'Chapter 1 printed extract',
        'Dual-column comparison table worksheet',
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide a glossary of Regency terms and simplified context cards with key facts highlighted.',
        core: 'Students answer all three questions with textual evidence and contextual references.',
        stretch:
          'Students evaluate whether Austen presents Mrs Bennet as foolish or as a rational woman responding to genuine economic danger.',
      },
      resources: [
        'Regency context information sheet',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Sentence starter provided: "Austen uses irony when she writes... This suggests that..."',
      core: 'Full written response with embedded quotation and contextual link.',
      stretch:
        "Students add a second sentence exploring Austen's authorial intention in adopting an ironic tone from the outset.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'How does Austen contrast Mr and Mrs Bennet in Chapter 1? What is the effect of this contrast?',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        'How does understanding Regency context change your interpretation of the opening chapter?',
      lines: 5,
      modelAnswer:
...
const lesson2: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students discuss how social class, wealth, and appearance might distort first impressions in Regency England compared to today.',
    },
    resources: [
      'Four images for first impressions activity',
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          "Provide a pre-annotated version of Darcy's key line with guiding questions for the paragraph.",
        core: 'Students annotate independently and write a full PEE paragraph with embedded quotation.',
        stretch:
          "Students compare the narrative voice's presentation of Darcy with Elizabeth's perception of him, noting any discrepancies.",
      },
      resources: [
        'Chapter 3 extract (annotated copies)',
        'PEE paragraph frame',
        'Annotation guide',
      ],
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students evaluate whether the Meryton community's judgement of Darcy is fair, considering his perspective as an outsider among strangers.",
      },
      resources: [
        'Venn diagram template',
        'Quotation bank for Bingley and Darcy',
        'Connectives of contrast list',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students identify moments where a character displays both pride and prejudice simultaneously.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Analyse the significance of Darcy\'s comment: "She is tolerable, but not handsome enough to tempt me."',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "How does Elizabeth respond to Darcy's slight, and what does this reveal about her character?",
      lines: 5,
      modelAnswer:
...
const lesson3: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        "Provide a recap sheet summarising key events from Chapters 1-34 to help students recall Elizabeth's beliefs.",
      core: 'Students contribute independently to both columns with specific references to earlier events.',
      stretch:
        "Students predict what the letter might reveal and what evidence might change Elizabeth's mind.",
    },
    resources: [
      'Two-column display on board',
      'Recap sheet (support tier)',
      'Sticky notes for contributions',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide the letter in simplified modern English alongside the original, with key revelations highlighted.',
        core: 'Students complete the Revelation Tracker independently with textual references.',
        stretch:
          "Students analyse Darcy's tone in the letter - does he sound apologetic, defensive, proud, or honest? What does this reveal about his character at this point?",
      },
      resources: [
        "Edited extract of Darcy's letter",
        'Revelation Tracker worksheet',
        'Simplified version (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students compare Elizabeth's moment of self-recognition with a similar moment in another text they have studied, evaluating Austen's handling of the convention.",
      },
      resources: [
        'Chapter 36 extract',
        'Anagnorisis definition card',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      support:
        'Students complete the "after" column using evidence gathered from the Revelation Tracker.',
      core: 'Students justify their vote with a specific textual reference.',
      stretch:
        'Students argue for or against the letter as the structural turning point, considering alternative candidates.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "What are the two main revelations in Darcy's letter, and how do they change Elizabeth's understanding?",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "Why does Austen choose a letter as the method for Darcy's revelations rather than a conversation?",
      lines: 5,
      modelAnswer:
...
const lesson4: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        "Provide a simple table listing Miss Bingley's criteria and space for students to note whether Elizabeth meets each one.",
      core: 'Students explain what Elizabeth values instead of traditional "accomplishments" and find textual evidence.',
      stretch:
        'Students consider why Austen gives the "accomplishments" speech to Miss Bingley specifically - what does this reveal about both characters?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students identify moments where Elizabeth's wit and prejudice overlap - where her cleverness actually reinforces her misjudgement.",
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          'Provide the key moments pre-identified on the graph with brief plot summaries for each.',
        core: 'Students complete the graph independently with textual justifications for each plot point.',
        stretch:
          "Students overlay Darcy's arc on the same graph and analyse how the two arcs mirror and complement each other.",
      },
      resources: [
        'Character arc graph template',
        'Plot summary cards (support tier)',
        'Coloured pens for overlay',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students consider whether the question itself is anachronistic - can we apply modern concepts to Regency fiction?',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "How does Austen use Elizabeth's wit to characterise her as an unconventional heroine?",
      lines: 6,
      modelAnswer:
...
const lesson5: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students analyse the power dynamics in each proposal - who is in control, and how has the balance shifted?',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          "Students distinguish between moments where Darcy genuinely changes and moments where the reader's perception of him changes - are they the same thing?",
      },
    ...
    },
    {
      ...
      differentiation: {
        support:
          "Provide a paragraph frame focusing on Mrs Reynolds's key comments with sentence starters.",
        core: "Students write a full analytical paragraph independently, linking the Pemberley visit to Darcy's characterisation.",
        stretch:
          "Students evaluate the problematic implication: does Elizabeth's change of heart owe more to Darcy's wealth (Pemberley) than his character? Is Austen being ironic?",
      },
      resources: [
        'Chapter 43 extract',
        'Paragraph frame (support tier)',
        'Image of a Regency estate for discussion',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students argue that Austen deliberately leaves this question ambiguous and explain why.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        'Evaluate: Does Darcy truly change, or does Elizabeth simply learn to see him differently?',
      lines: 6,
      modelAnswer:
...
const lesson6: LessonPlan = {
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a simplified analysis grid with quotations already identified and one model answer completed.',
        core: 'Students complete the analysis grid independently with textual evidence for each couple.',
        stretch:
          'Students identify what Austen is criticising through each flawed marriage and link to her broader social commentary.',
      },
      resources: [
        'Station cards with extracts (x5)',
    ...
    },
    {
      ...
      differentiation: {
        support:
          "Provide a for/against table on Charlotte's decision with some arguments pre-filled.",
        core: 'Students write an evaluative paragraph independently, considering multiple perspectives.',
        stretch:
          'Students consider whether Austen sympathises with Charlotte or judges her, using textual evidence to support their reading.',
      },
      resources: [
        'Chapter 22 extract',
        'For/against table (support tier)',
        "Contextual information on women's options",
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students explain why Austen presents this argument through multiple contrasting marriages rather than simply telling the reader.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "Compare the marriages of Mr and Mrs Bennet and Elizabeth and Darcy. What does each reveal about Austen's views on marriage?",
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "What does Lydia and Wickham's relationship represent in the novel's commentary on marriage?",
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'How does Austen use the variety of marriages in the novel to make her social commentary?',
      lines: 6,
      modelAnswer:
...
const lesson7: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        "Provide character cards with brief descriptions of each character's social position.",
      core: 'Students place characters and explain the criteria they used (birth, wealth, connections, behaviour).',
      stretch:
        'Students identify contradictions in the hierarchy - e.g., the Gardiners are more refined than Mrs Bennet despite being "in trade."',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        ...
        stretch:
          'Students compare Austen\'s treatment of women with Mary Wollstonecraft\'s arguments in "A Vindication of the Rights of Woman" (1792), published 21 years before Pride and Prejudice.',
      },
      resources: [
        'Case study cards (x4)',
        'Response frame (support tier)',
        'Wollstonecraft extract (stretch tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          "Pre-annotate Lady Catherine's most significant lines and provide a paragraph frame.",
        core: 'Students annotate independently and write a full analytical paragraph with embedded quotations.',
        stretch:
          "Students evaluate the irony that Lady Catherine's intervention actually brings Elizabeth and Darcy together - what is Austen saying about the self-defeating nature of class snobbery?",
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students consider whether Austen could have written a truly subversive ending and why she chose not to.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        "How does the Gardiners' characterisation challenge class assumptions in the novel?",
      lines: 5,
      modelAnswer:
    ...
    {
      question:
        'In what ways does Austen show the limited options available to women in Regency society?',
      lines: 6,
      modelAnswer:
    ...
    {
      question:
        "Does the novel's ending reinforce or challenge the class system? Explain your view.",
      lines: 6,
      modelAnswer:
...
const lesson8: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a definitions card for each type of irony with the everyday example included.',
      core: 'Students identify the type and explain why each example fits.',
      stretch:
        'Students find an additional example of each type from their knowledge of the novel.',
    },
    resources: [
      'Irony definitions display',
      'Three example quotations/scenarios',
      'Definitions card (support tier)',
    ],
  },
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a clear comparison table with the three techniques defined and colour-coded examples.',
        core: 'Students identify FID in all four passages and explain its effect on the reader.',
        stretch:
          'Students explain why FID is particularly suited to a novel about prejudice - it allows Austen to show a biased perspective without endorsing it.',
      },
      resources: [
        'Comparison extracts (direct/indirect/FID)',
        'Four passage extracts',
        'Technique comparison table (support tier)',
      ],
    },
    {
      ...
      differentiation: {
        support:
          'Reduce to four extracts with the type of irony pre-identified; students focus on explaining the effect.',
        core: 'Students analyse all six extracts and write one full analytical paragraph.',
        stretch:
          "Students compare Austen's ironic style with a modern satirist and evaluate which is more effective at social criticism.",
      },
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students explain why irony is a more effective form of social criticism than direct statement.',
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        "What is free indirect discourse and why is it important to Austen's narrative technique?",
      lines: 6,
      modelAnswer:
...
const lesson9: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      ...
      stretch:
        'Students consider the literary term "objective correlative" - when an external object reflects an internal state.',
    },
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide guided annotation questions beside each sentence of the extract and a paragraph frame.',
        core: 'Students annotate independently and write a full analytical paragraph.',
        stretch:
          "Students compare the description of Pemberley with the description of Rosings (Lady Catherine's estate) and analyse what the contrast reveals about each owner.",
      },
    ...
    },
    {
      ...
      resources: [
        ...
        'Highlighted extracts (support tier)',
      ],
    },
  ],
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students explain why Austen chose to reveal Darcy's character through his home rather than through further dialogue or action.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    ...
    {
      question:
        "Compare Austen's description of Pemberley with what we know of Rosings Park. What does the contrast reveal?",
      lines: 5,
      modelAnswer:
...
const lesson10: LessonPlan = {
  ...
  starterActivity: {
    ...
    differentiation: {
      support:
        'Provide a planning frame with paragraph topic headings pre-filled and a quotation bank.',
      core: 'Students plan independently in five minutes and self-assess against the model.',
      stretch:
        'Students plan a counter-argument paragraph that acknowledges an alternative interpretation.',
    },
    resources: [
  ...
  mainActivities: [
    {
      ...
      differentiation: {
        support:
          'Provide a paragraph-by-paragraph scaffold with sentence starters for each section, plus a keyword and quotation bank.',
        core: 'Students write independently with access to their own notes from previous lessons.',
        stretch:
          "Students aim for a sophisticated conclusion that evaluates Austen's overall message about pride and prejudice, considering whether the novel resolves these themes or leaves them in tension.",
      },
      resources: [
        'Essay scaffold (support tier)',
  ...
  plenaryActivity: {
    ...
    differentiation: {
      ...
      stretch:
        "Students identify the single most effective sentence in their partner's essay and explain why it works.",
    },
  },
  homework:
  ...
  worksheetQuestions: [
    {
      question:
        'Write a thesis statement for the essay question: "How does Austen use the characters of Elizabeth and Darcy to explore the themes of pride and prejudice?"',
      lines: 3,
      modelAnswer:
    ...
    {
      question:
        "Write an analytical paragraph exploring how Austen uses Darcy's first proposal to reveal his pride. Include an embedded quotation and an AO2 point about Austen's methods.",
      lines: 8,
      modelAnswer:
