...
const igcseGradeBoundaries: AssessmentRubric = {
  ...
  examBoard: 'Cambridge (CIE)',
  gradeBoundaries: [
    { grade: '9', percentageRange: '90-100%', descriptor: 'Exceptional achievement across all assessment objectives. Demonstrates sophisticated critical thinking, analytical precision, and assured technical control.' },
    { grade: '8', percentageRange: '80-89%', descriptor: 'High achievement. Confident and perceptive analysis. Well-developed arguments with effective use of evidence. Assured writing craft.' },
    { grade: '7', percentageRange: '70-79%', descriptor: 'Good achievement. Clear analysis with competent use of evidence. Writing is well organised with generally effective expression.' },
    { grade: '6', percentageRange: '60-69%', descriptor: 'Competent achievement. Sound understanding with relevant analysis. Writing communicates clearly with appropriate structure.' },
    { grade: '5', percentageRange: '50-59%', descriptor: 'Adequate achievement. Basic understanding with some relevant analysis. Writing is generally clear but may lack development.' },
    { grade: '4', percentageRange: '40-49%', descriptor: 'Basic achievement. Limited understanding with simple responses. Writing communicates meaning but with limited range and some inaccuracy.' },
    { grade: '3', percentageRange: '30-39%', descriptor: 'Below expectations. Partial understanding. Responses are incomplete or superficial. Significant weaknesses in expression.' },
    { grade: '2', percentageRange: '20-29%', descriptor: 'Minimal achievement. Very limited understanding demonstrated. Responses are fragmentary with major weaknesses in all areas.' },
    { grade: '1', percentageRange: '0-19%', descriptor: 'Ungraded. Insufficient quality for the award of a grade. Response is absent, irrelevant, or negligible.' },
  ],
};
...
const ialGradeDescriptors: AssessmentRubric = {
  ...
  examBoard: 'Pearson Edexcel',
  gradeBoundaries: [
    { grade: '9', percentageRange: '90-100%', ums: '270-300', descriptor: 'Exceptional critical engagement demonstrating originality, sophistication, and comprehensive textual knowledge. Analysis is forensic and conceptualised. Written expression is exemplary.' },
    { grade: '8', percentageRange: '80-89%', ums: '240-269', descriptor: 'Confident and perceptive critical analysis with detailed knowledge of texts. Arguments are well-crafted and convincingly supported. Strong contextual understanding.' },
    { grade: '7', percentageRange: '70-79%', ums: '210-239', descriptor: 'Competent analysis with sound textual knowledge. Arguments are clearly structured and supported. Good awareness of writer\'s methods and context.' },
    { grade: '6', percentageRange: '60-69%', ums: '180-209', descriptor: 'Clear engagement with texts and questions. Analysis is present and generally relevant. Some effective use of evidence and awareness of context.' },
    { grade: '5', percentageRange: '50-59%', ums: '150-179', descriptor: 'Basic engagement with texts. Some relevant analysis but responses may lack development or precision. Limited contextual understanding.' },
    { grade: '4', percentageRange: '40-49%', ums: '120-149', descriptor: 'Limited but adequate engagement. Basic understanding of texts with simple analysis. Written expression may be unclear or inaccurate.' },
    { grade: '1-3', percentageRange: '0-39%', ums: '0-119', descriptor: 'Insufficient quality for the award of a grade. Response demonstrates inadequate knowledge, understanding, or analytical skill.' },
  ],
};
