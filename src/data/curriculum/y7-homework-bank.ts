export interface HomeworkTask {
  ...
  yearGroup: 'Year 7';
  termUnit: string;
  type: 'reading-response' | 'extended-writing' | 'research' | 'creative' | 'revision' | 'vocabulary' | 'grammar-practice' | 'analysis';
  description: string;
  instructions: string[];
...
export const y7HomeworkBank: HomeworkTask[] = [
...

  {
    ...
    type: 'creative',
    description: 'Write a diary entry from the perspective of either Reema or Caylin after a key event in the opening chapters. Use first-person voice, thoughts, and feelings to bring your chosen character to life.',
    instructions: [
    ...
    parentGuidance: 'Ask your child which character they have chosen and what event they are writing about. Encourage them to refer back to the book rather than relying on memory alone.',
    differentiation: {
      support: 'Use the sentence starters provided on the revision mat. You may write one paragraph only.',
      core: 'Write two paragraphs covering the event and the character\'s emotional response.',
      stretch: 'Use structural techniques such as a cliffhanger ending or a shift in tone mid-entry to create effect.',
    },
  },

  {
    ...
    termUnit: 'T1: The Fox Girl and the White Gazelle',
    type: 'vocabulary',
    description: 'Learn and practise 10 key vocabulary words from the novel. Be prepared to use these words accurately in class discussion and written work.',
    instructions: [
    ...
    parentGuidance: 'Test your child on the spellings and meanings of the 10 words the evening before the lesson. You could cover the definitions and ask them to explain each word in their own words.',
    differentiation: {
      support: 'Focus on 6 of the 10 words and write a short phrase rather than a full sentence for each.',
      core: 'Write a full sentence for all 10 words.',
      stretch: 'Write a short paragraph (4-5 sentences) that uses at least 5 of the 10 words correctly in context.',
    },
  },

  {
    ...
    description: 'Re-read the assigned chapters and annotate your copy or the extract sheet with notes about character, language, and theme. Careful re-reading strengthens your analytical skills.',
    instructions: [
    ...
    parentGuidance: 'Encourage your child to read aloud if they find it easier to concentrate. Remind them that annotations are notes to themselves, so informal language is fine — the important thing is engagement with the text.',
    differentiation: {
      support: 'Focus on one chapter only and write 3 annotations. Use the sentence frame: "The word \'...\' suggests..."',
      core: 'Annotate both chapters with a minimum of 5 comments.',
      stretch: 'Write annotations that make connections between the chapters, noting how the writer develops ideas across the two sections.',
    },
  },

  {
    ...
    termUnit: 'T1: The Fox Girl and the White Gazelle',
    type: 'revision',
    description: 'Prepare for an in-class retrieval quiz by reviewing the plot, characters, and key events covered so far in the novel.',
    instructions: [
    ...
    parentGuidance: 'Quiz your child on key facts about the story. Ask questions like: Who are the two main characters? Where does the story take place? What problem does each character face? Even five minutes of verbal testing makes a significant difference.',
    differentiation: {
      support: 'Focus your revision on the characters and setting. A simple fact sheet is provided in your booklet.',
      core: 'Revise plot, character, and setting as described above.',
      stretch: 'Try to recall specific quotations or details from the text to support your answers in the quiz.',
    },
  },

  {
    ...
    termUnit: 'T1: The Fox Girl and the White Gazelle',
    type: 'analysis',
    description: 'Write a PEE (Point, Evidence, Explanation) paragraph in response to the question: "How does the writer present Reema as a determined character?"',
    instructions: [
    ...
    parentGuidance: 'Remind your child of the PEE structure: Point (what you want to say), Evidence (a quotation), Explanation (why the writer chose those words and what effect they have). Encourage them to read their paragraph aloud to check it flows.',
    differentiation: {
      support: 'Use the PEE sentence starters: "The writer presents Reema as... / For example... / This suggests..."',
      core: 'Write a full PEE paragraph independently using the structure above.',
      stretch: 'Write a PEE paragraph and add a further development sentence that links to theme or context.',
    },
  },

  {
    ...
    termUnit: 'T1: The Fox Girl and the White Gazelle',
    type: 'creative',
    description: 'Write a descriptive paragraph about one of the settings in the novel. Focus on using sensory language and specific details to bring the location to life for the reader.',
    instructions: [
    ...
    parentGuidance: 'Ask your child to read their description aloud to you. As a listener, tell them which image stood out most vividly and why. This oral feedback is a useful editing prompt.',
    differentiation: {
      support: 'Use the sensory vocabulary mat provided. Write one paragraph focusing on sight and sound only.',
      core: 'Write two paragraphs using three or more senses and both required techniques.',
      stretch: 'Vary your sentence lengths deliberately — mix short sentences for impact with longer, detailed ones to create rhythm and atmosphere.',
    },
  },

  {
    ...
    termUnit: 'T1: The Fox Girl and the White Gazelle',
    type: 'analysis',
    description: 'Complete a character comparison chart for Reema and Caylin, identifying similarities and differences in their backgrounds, personalities, and challenges.',
    instructions: [
    ...
    parentGuidance: 'Ask your child to explain who Reema and Caylin are and what makes them similar and different. If they struggle, encourage them to look back at the early chapters of the novel for clues.',
    differentiation: {
      support: 'A pre-drawn table is available in the booklet. Fill in the boxes with brief notes rather than full sentences.',
      core: 'Create and complete the full comparison chart as described.',
      stretch: 'After completing the chart, write a short paragraph explaining what the similarities between Reema and Caylin suggest about the novel\'s themes.',
    },
  },

  {
    ...
    termUnit: 'T1: The Fox Girl and the White Gazelle',
    type: 'analysis',
    description: 'Create a detailed mind map exploring the key themes in the novel so far. Connect themes to specific evidence from the text.',
    instructions: [
    ...
    parentGuidance: 'Mind maps are a highly effective revision tool. Encourage your child to use colour and to connect ideas across branches — for example, how the theme of identity connects to the theme of belonging.',
    differentiation: {
      support: 'Use the part-completed mind map template in your booklet. You need to add evidence only.',
      core: 'Create the full mind map independently with four themes.',
      stretch: 'Add connection lines between different themes on your mind map, with annotations explaining how the themes are linked.',
    },
  },

  {
    ...
    termUnit: 'T1: The Fox Girl and the White Gazelle',
    type: 'reading-response',
    description: 'Write an informal letter to the author, Victoria Williamson, explaining your response to the novel so far. Share what you have enjoyed, what has surprised you, and any questions you would like to ask her.',
    instructions: [
    ...
    parentGuidance: 'Encourage your child to think about their genuine response to the novel rather than writing what they think the teacher wants to hear. Personal, honest reactions are more interesting to read and more useful as a learning exercise.',
    differentiation: {
      support: 'Write two paragraphs only. Use the sentence starters provided: "I really enjoyed the part where... / I was surprised when... / One question I would like to ask you is..."',
      core: 'Write all three paragraphs in full letter format.',
      stretch: 'Include a paragraph analysing why you think the author made a specific narrative choice, connecting your personal response to craft and technique.',
    },
  },

  {
    ...
    termUnit: 'T1: The Fox Girl and the White Gazelle',
    type: 'analysis',
    description: 'Write a timed analysis paragraph (15 minutes) in response to the question: "How does the writer use language to present the theme of belonging in the novel?"',
    instructions: [
    ...
    parentGuidance: 'Time-pressured writing is a skill that needs regular practice. Encourage your child to trust their knowledge and write without stopping during the timed section — they can improve it afterwards. Reassure them that a short, focused paragraph is better than a long, unfocused one.',
    differentiation: {
      support: 'Use the quotation bank on the back of your booklet. Write your paragraph without a strict time limit on the first attempt.',
...

  {
    ...
    description: 'Write a personal narrative about a moment in your life that felt significant. Focus on crafting a clear narrative voice and using specific details to make the experience vivid for the reader.',
    instructions: [
    ...
    parentGuidance: 'Reassure your child that this task does not need to be about a dramatic event — small, everyday moments often make the best personal writing. Encourage them to write honestly and to trust their own voice.',
    differentiation: {
      support: 'Use the narrative planning frame provided to outline your beginning, middle, and end before you start writing.',
      core: 'Write 3-4 paragraphs with dialogue and sensory detail as described.',
      stretch: 'Experiment with non-linear structure — for example, begin in the middle of the action and use a flashback to provide context.',
    },
  },

  {
    ...
    termUnit: 'T2: Voice and Identity',
    type: 'research',
    description: 'Research the biography of an author whose work you are studying or have read independently. Identify key facts about their life and consider how their background may have influenced their writing.',
    instructions: [
    ...
    parentGuidance: 'Help your child identify a suitable author if they are unsure. Remind them to make notes first and then write in their own words — copying directly from a website is not research. Ask them to read their final biography aloud to check it makes sense.',
    differentiation: {
      support: 'A fact-finding sheet with sentence starters is available. You may write in bullet points for the notes section.',
      core: 'Complete the full biography task as described.',
      stretch: 'Write an extended paragraph evaluating how far the author\'s biography helps a reader understand their work, using specific examples.',
    },
  },

  {
    ...
    termUnit: 'T2: Voice and Identity',
    type: 'vocabulary',
    description: 'Study and learn the key vocabulary for the Voice and Identity unit. You will be tested in the next lesson.',
    instructions: [
    ...
    parentGuidance: 'Test your child on these words before the lesson. Cover the definitions and ask them to explain each word in their own words. These are analytical vocabulary words they will use throughout the year.',
    differentiation: {
      ...
      stretch: 'Write a single paragraph of 5-6 sentences that correctly uses at least 6 of the 10 words in context.',
    },
  },

  {
    ...
    termUnit: 'T2: Voice and Identity',
    type: 'creative',
    description: 'Write a descriptive piece about a place that holds personal significance for you. This task focuses on developing voice through the specific, personal details you choose to include.',
    instructions: [
    ...
    parentGuidance: 'Ask your child to tell you about the place they have chosen before they write about it. This oral rehearsal often helps them identify the most important details to include.',
    differentiation: {
      support: 'Use the descriptive writing frame provided. Focus on two senses and write one paragraph only.',
      core: 'Complete two full paragraphs as described.',
      stretch: 'Use structural contrast — open with a detailed, slow-paced description and close with a short, punchy sentence that shifts the mood.',
    },
  },

  {
    ...
    termUnit: 'T2: Voice and Identity',
    type: 'creative',
    description: 'Write the same event twice from two different perspectives. This task explores how voice, tone, and word choice shift depending on who is narrating.',
    instructions: [
    ...
    parentGuidance: 'Read both paragraphs aloud together and discuss: do they sound like different people? Would you know they were about the same event? This kind of conversation helps your child refine their sense of voice.',
    differentiation: {
      support: 'A scenario is provided for you. Use the word bank to help you choose perspective-appropriate vocabulary.',
      core: 'Choose your own scenario and write both perspectives independently.',
      stretch: 'Add a third paragraph from the perspective of a bystander who is neutral, showing how an outside view differs from both participants.',
    },
  },

  {
    ...
    termUnit: 'T2: Voice and Identity',
    type: 'creative',
    description: 'Write a letter from the point of view of a character studied this term. The letter should be addressed to another character or to the reader, and should reveal the character\'s inner world.',
    instructions: [
    ...
    parentGuidance: 'Ask your child which character they have chosen and why. Encourage them to think about what that character would NOT say as well as what they would — restraint in character voice is as important as expression.',
    differentiation: {
      support: 'A character voice guide is provided with sentence starters and key phrases based on how the character speaks in the text.',
      core: 'Write the full letter independently.',
      stretch: 'Write an unsent letter — one the character writes but decides not to send. Add a brief note (2-3 sentences) in the character\'s voice explaining why they chose not to send it.',
    },
  },

  {
    ...
    description: 'Practise identifying and writing the four sentence types: simple, compound, complex, and compound-complex. Understanding sentence types is essential for developing a varied and controlled writing style.',
    instructions: [
    ...
    parentGuidance: 'If your child is unsure about the difference between a compound sentence (two main clauses joined by a conjunction) and a complex sentence (a main clause with a subordinate clause), try looking up a short online explanation together.',
    differentiation: {
      support: 'Focus on simple and compound sentences only. Complete 6 of the 10 identification sentences.',
      core: 'Complete all four sentence types as described.',
      stretch: 'Write a paragraph that uses sentence types deliberately for effect — for example, using a series of short simple sentences to build tension, then a long complex sentence to resolve it.',
    },
  },

  {
    ...
    termUnit: 'T2: Voice and Identity',
    type: 'reading-response',
    description: 'Write a reading journal entry in response to a text read this term. A reading journal combines personal response with analytical observation.',
    instructions: [
    ...
    parentGuidance: 'A reading journal should sound like your child\'s own voice. It is not a formal essay. Encourage them to write as they speak about books — with opinion, curiosity, and personality.',
    differentiation: {
      support: 'Use the journal template provided. Write 3 sentences for each paragraph rather than 4-6.',
      core: 'Write all three paragraphs as described.',
      stretch: 'Add a fourth paragraph connecting this text to another text you have read, noting a similarity or contrast in how voice or identity is explored.',
    },
  },

  {
    ...
    termUnit: 'T2: Voice and Identity',
    type: 'analysis',
    description: 'Search through a text studied this term to find and analyse examples of figurative language. Identifying figurative language in context develops your ability to write analytically.',
    instructions: [
    ...
    parentGuidance: 'Ask your child to explain what each technique is and to read their favourite example aloud. Ask them: what picture does this create in your mind? This helps them develop the explanation part of their analysis.',
    differentiation: {
      support: 'Use the figurative language definitions sheet and find two techniques (simile and metaphor) only.',
      core: 'Find all four techniques and complete the table.',
      stretch: 'Write an extended analysis of the most effective example, explaining how the figurative language connects to the text\'s wider themes.',
    },
  },

  {
    ...
    termUnit: 'T2: Voice and Identity',
    type: 'extended-writing',
    description: 'Return to a piece of creative writing completed earlier this term and produce an improved redraft. Redrafting is a core skill — professional writers always revise their work.',
    instructions: [
    ...
    parentGuidance: 'Ask your child to show you both the original and the redraft and to explain one change they are proud of. This helps consolidate their awareness of craft decisions. Praise the effort of redrafting — many students find it harder than writing a first draft.',
    differentiation: {
      support: 'Make three specific improvements. Use the editing checklist provided to guide your changes.',
      core: 'Make five improvements and annotate as described.',
      stretch: 'In addition to the annotations, write a short reflective paragraph explaining which improvement made the biggest difference to the quality of your writing and why.',
    },
  },
...

  {
    ...
    type: 'creative',
    description: 'Retell a folk tale or traditional story from a different perspective or in a different setting. This task develops your understanding of narrative structure and voice.',
    instructions: [
    ...
    parentGuidance: 'If your child is unsure which folk tale to choose, discuss family stories or traditional tales from your own cultural background — these often make the richest material. Any folk tale from any culture is valid.',
    differentiation: {
      support: 'Use the provided folk tale structure template. Focus on retelling the story in a modern setting without changing the perspective.',
      core: 'Change either perspective or setting and write 3-4 paragraphs independently.',
      stretch: 'Use your retelling to comment on or subvert the original tale\'s moral lesson, making a clear thematic point through your narrative choices.',
    },
  },

  {
    ...
    termUnit: 'T3: Stories and Poetry — Shaping Meaning',
    type: 'analysis',
    description: 'Annotate a poem studied this term in detail, identifying and commenting on language techniques, structure, and theme.',
    instructions: [
    ...
    parentGuidance: 'Encourage your child to read the poem aloud more than once before annotating. Ask them: what feeling does this poem give you? What is the most interesting or unusual word? These are good starting points for annotation.',
    differentiation: {
      support: 'Annotate 4 of the 6 required sections. Use the annotation prompt questions provided.',
      core: 'Complete all 6 annotations as described.',
      stretch: 'Write a two-sentence annotation for each point, covering both technique identification and its connection to the poem\'s overall meaning or theme.',
    },
  },

  {
    ...
    termUnit: 'T3: Stories and Poetry — Shaping Meaning',
    type: 'revision',
    description: 'Revise and learn the key poetry vocabulary for this unit. You will be tested in the next lesson.',
    instructions: [
    ...
    parentGuidance: 'Test your child on the poetry terms verbally. Ask: "What is enjambment? Can you give me an example?" This verbal practice is more effective than silent reading of notes.',
    differentiation: {
      support: 'Focus on 6 terms: stanza, imagery, tone, alliteration, rhyme scheme, and volta.',
      core: 'Learn all 10 terms as described.',
      stretch: 'Write a short paragraph (4-5 sentences) about a poem using at least 6 of the 10 terms correctly.',
    },
  },

  {
    ...
    termUnit: 'T3: Stories and Poetry — Shaping Meaning',
    type: 'analysis',
    description: 'Write a comparative paragraph exploring how two poems studied this term present a similar theme. Comparison is a key analytical skill used throughout GCSE and beyond.',
    instructions: [
    ...
    parentGuidance: 'Comparative writing can feel challenging at first. Remind your child that they do not need to write about the poems separately — the goal is to move between them throughout the paragraph, constantly making comparisons.',
    differentiation: {
      support: 'Use the comparative writing frame: "In [Poem A], the poet uses... / Similarly, in [Poem B]... / However, while [Poem A]... [Poem B]..."',
      core: 'Write the full comparative paragraph independently.',
      stretch: 'Write a second comparative paragraph exploring a different aspect (e.g. structure or form rather than language).',
    },
  },

  {
    ...
    termUnit: 'T3: Stories and Poetry — Shaping Meaning',
    type: 'creative',
    description: 'Write an original poem inspired by a theme, form, or technique from the poetry studied this term. This task asks you to become a poet yourself, making deliberate craft decisions.',
    instructions: [
    ...
    parentGuidance: 'Encourage your child to draft freely first and then go back to improve — good poetry is usually the result of editing, not first-draft inspiration. Ask them to read their poem aloud to you to check the rhythm and sound.',
    differentiation: {
      support: 'Use the poetry writing scaffold provided. Aim for 8-10 lines and identify one technique in your poet\'s note.',
      core: 'Write a 12-20 line poem with two techniques and a poet\'s note.',
      stretch: 'Write a poem that uses a structural technique deliberately (e.g. a volta, a repeated refrain, or a contrasting final stanza) and explain its effect in your poet\'s note.',
    },
  },

  {
    ...
    termUnit: 'T3: Stories and Poetry — Shaping Meaning',
    type: 'analysis',
    description: 'Write a draft analytical response to a poetry question. This homework prepares you for written assessments by practising extended analysis in a low-pressure setting.',
    instructions: [
    ...
    parentGuidance: 'Remind your child that a draft does not need to be perfect — the goal is to practise the structure of analytical writing. Ask them: does each paragraph make a clear point? Is there a quotation? Is the quotation explained?',
    differentiation: {
      support: 'Write one paragraph only (language focus). Use the PEE scaffold frame.',
      core: 'Write both paragraphs as described.',
      stretch: 'Add a third paragraph evaluating whether the poet\'s technique is effective, giving a personal and justified response.',
    },
  },

  {
    ...
    termUnit: 'T3: Stories and Poetry — Shaping Meaning',
    type: 'reading-response',
    description: 'Complete a reading log entry for your current independent reading book. Regular independent reading is the single most effective way to improve your writing and vocabulary.',
    instructions: [
    ...
    parentGuidance: 'Ask your child about their independent reading book. Even a brief conversation about what they are reading — who the characters are, what is happening, whether they are enjoying it — greatly supports reading development. If they do not have a book, speak to their class teacher.',
    differentiation: {
      support: 'A reading log template is available. Write 3 sentences for the summary section rather than 4-6.',
      core: 'Complete the full reading log as described.',
      stretch: 'In addition to the standard log, write one sentence connecting a theme in your independent reading book to a theme in a text studied in class this term.',
    },
  },

  {
    ...
    termUnit: 'T3: Stories and Poetry — Shaping Meaning',
    type: 'research',
    description: 'Research the cultural or historical context of one poem or story studied this term. Understanding context enriches your ability to analyse and interpret a text.',
    instructions: [
    ...
    parentGuidance: 'Help your child think about which aspect of context would be most interesting to research. Remind them to take notes first and then write up — they should not copy text from a website. Ask them: how does knowing this change how you read the text?',
    differentiation: {
      ...
      stretch: 'Write an extended paragraph (150-200 words) explaining how context shapes a reader\'s interpretation of the text, using specific evidence from the text itself.',
    },
  },

  {
    ...
    termUnit: 'T3: Stories and Poetry — Shaping Meaning',
    type: 'revision',
    description: 'Complete an honest self-assessment of your learning this term and use it to create a targeted revision plan for your end-of-term assessment.',
    instructions: [
    ...
    parentGuidance: 'Self-assessment can be difficult for students who either over- or under-rate themselves. Ask your child to show you their traffic light ratings and discuss whether they match the feedback they have received in class. Help them create a realistic revision schedule.',
    differentiation: {
      support: 'A pre-populated list of topics is provided for you to rate. Focus on identifying two priority areas rather than three.',
      core: 'Complete the full self-assessment and revision plan.',
      stretch: 'For each Green area, add one stretch challenge you could set yourself to deepen your understanding further.',
    },
  },

  {
    ...
    termUnit: 'T3: Stories and Poetry — Shaping Meaning',
    type: 'extended-writing',
    description: 'Write an extended poetry analysis essay in response to the question: "How does the poet create a sense of [theme] in this poem?" This task consolidates the analytical writing skills developed across Year 7.',
    instructions: [
    ...
    differentiation: {
      support: 'Write one body paragraph only (language focus) using the PEE scaffold, plus a one-sentence introduction and conclusion. Aim for 150 words.',
      core: 'Write the full essay of 300-400 words as described.',
      stretch: 'Write an essay of 400-500 words that includes a paragraph evaluating whether the poet\'s choices are effective, supporting your judgement with specific evidence.',
    },
  },
