...
`,
    quiz: [
      {
        id: 'y7t3-m1-q1',
        question: 'What is a narrative convention?',
        options: [
          'A type of poem',
          'A commonly used technique or element in storytelling',
          'A grammar rule for writing stories',
          'A meeting where authors discuss their work',
        ],
        correct: 1,
        explanation:
          'A narrative convention is a recognised storytelling technique or element - such as plot, character, setting, conflict, and point of view - that writers use to shape their stories.',
      },
      {
        id: 'y7t3-m1-q2',
        question: "Which stage of Freytag's Pyramid represents the moment of highest tension?",
        options: ['Exposition', 'Rising action', 'Climax', 'Resolution'],
        correct: 2,
        explanation:
          'The climax is the turning point of the story where the central conflict reaches its peak intensity. It is the moment of highest tension.',
      },
      {
        id: 'y7t3-m1-q3',
        ...
        correct: 1,
        explanation:
          'In medias res is a Latin phrase meaning "in the middle of things." It describes a story that opens in the middle of the action rather than at the beginning.',
      },
      {
        id: 'y7t3-m1-q4',
        question:
          'A character struggling with their own guilt is an example of which type of conflict?',
        options: [
        ...
        correct: 3,
        explanation:
          'A character battling internal feelings like guilt, fear, or doubt is an example of Character vs. Self conflict - an internal struggle rather than an external one.',
      },
      {
        id: 'y7t3-m1-q5',
        question: 'What is the difference between plot and conflict?',
        options: [
          'They mean the same thing',
          'Plot is the sequence of events; conflict is the underlying struggle',
          'Conflict is the sequence of events; plot is the theme',
          'Plot only exists in novels, not short stories',
        ],
        correct: 1,
        explanation:
          'Plot is what happens - the sequence of events. Conflict is the underlying struggle that drives those events and gives them meaning. A plot without conflict would be a list of things that happen with no tension.',
      },
    ],
  },
...
`,
    quiz: [
      {
        id: 'y7t3-m2-q1',
        question: 'What is a moral theme?',
        options: [
          'The main character in a story',
          'The setting of a folk tale',
          'The underlying message or lesson a story conveys',
          'The climax of the plot',
        ],
        correct: 2,
        explanation:
          'A moral theme is the underlying message or lesson about human behaviour, values, or society that a story conveys. It answers the question: "What does this story want us to learn?"',
      },
      {
        id: 'y7t3-m2-q2',
        question: 'What is the main difference between a fable and a folk tale?',
        options: [
          'Fables are longer than folk tales',
          'Fables have an explicit moral stated at the end',
          'Folk tales never include animals',
          'There is no difference',
        ],
        correct: 1,
        explanation:
          'Fables are short stories (usually featuring animals) with a moral explicitly stated at the end. Folk tales are longer traditional stories where the moral is woven into the narrative.',
      },
      {
        id: 'y7t3-m2-q3',
        question:
          'In the West African folk tale extract, what theme does the spider story illustrate?',
        options: [
        ...
        correct: 2,
        explanation:
          'The spider succeeds in capturing much larger and more dangerous creatures through wit and resourcefulness rather than physical strength, illustrating the theme that cleverness defeats strength.',
      },
      {
        id: 'y7t3-m2-q4',
        question: 'How do writers typically communicate moral themes in folk tales?',
        options: [
          'Only through dialogue',
          'Through characterisation, consequences, symbolism, and pattern',
          'By writing the moral in the title',
          'Through footnotes at the bottom of the page',
        ],
        correct: 1,
        explanation:
          'Writers communicate moral themes through characterisation (good vs. bad characters), consequences (rewards and punishments), symbolism (objects representing ideas), and patterns like the rule of three.',
      },
      {
        id: 'y7t3-m2-q5',
        question: 'Why is simply stating "the moral is greed is bad" considered a weak response?',
        options: [
          'Because greed is not actually a theme in folk tales',
          'Because you should never mention morals in an essay',
          'Because it does not explain how the writer communicates the theme',
          'Because examiners prefer longer sentences',
        ],
        correct: 2,
        explanation:
          'A strong response explains HOW the writer communicates the moral theme using techniques such as characterisation, consequences, symbolism, or structural patterns. Simply stating the moral without analysis shows limited understanding.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        options: [
          'When a character speaks in riddles',
          'When an object or place represents an abstract idea',
          'When the writer uses long sentences',
          'When the narrator is unreliable',
        ],
        correct: 1,
        explanation:
          'Symbolism is the use of an object, place, colour, or element to represent a deeper abstract idea or concept. A dark forest, for example, might symbolise danger or the unknown.',
      },
      {
        id: 'y7t3-m3-q2',
        ...
        options: [
          ...
          'When weather or environment reflects human emotions',
          'When a story has a sad ending',
        ],
        correct: 2,
        explanation:
          'Pathetic fallacy is a literary technique where the weather or natural environment mirrors the emotions of a character or the mood of the narrative.',
      },
      {
        id: 'y7t3-m3-q3',
        question: 'In the text extract, what does the neglected garden symbolise?',
        options: [
        ...
        correct: 1,
        explanation:
          'The neglected garden with its weeds, rusted gate, and cracked path symbolises abandonment, decay, and lost direction. It reflects something once beautiful that has been left to ruin.',
      },
      {
        id: 'y7t3-m3-q4',
        question: 'Why is it a mistake to describe settings as "just a backdrop"?',
        options: [
          'Because backdrops are only used in theatre',
          'Because settings create mood, reflect characters, and carry symbolic meaning',
          'Because settings are always more important than characters',
          'Because examiners do not like the word "backdrop"',
        ],
        correct: 1,
        explanation:
          "In literature, settings are carefully chosen to create mood, reflect characters' emotions, and communicate deeper symbolic meanings. Treating them as just a backdrop misses these layers of meaning.",
      },
      {
        id: 'y7t3-m3-q5',
        question: 'What is the difference between pathetic fallacy and personification?',
        options: [
          'They are exactly the same technique',
          'Pathetic fallacy only uses weather/nature to reflect emotions; personification gives human qualities to anything non-human',
          'Personification only applies to animals',
          'Pathetic fallacy is used in poetry only',
        ],
        correct: 1,
        explanation:
          'Pathetic fallacy specifically uses weather or the natural environment to mirror human emotions. Personification is broader - it gives human qualities to any non-human thing, not necessarily linked to mood or emotion.',
      },
    ],
  },
...
`,
    quiz: [
      {
        id: 'y7t3-m4-q1',
        question: 'What does effective comparison require?',
        options: [
          'Writing about each text separately',
          'Identifying similarities and differences between texts',
          'Only focusing on one text at a time',
          'Copying quotations from both texts',
        ],
        correct: 1,
        explanation:
          'Effective comparison requires actively identifying similarities and differences between texts and explaining why those similarities and differences matter.',
      },
      {
        id: 'y7t3-m4-q2',
        question: 'Which is a stronger approach: the block method or the alternating method?',
        options: [
          'The block method',
          'The alternating method',
          'They are equally effective',
          'Neither - you should only write about one text',
        ],
        correct: 1,
        explanation:
          'The alternating method is stronger because it integrates both texts in every paragraph, showing direct comparison rather than leaving the reader to make connections themselves.',
      },
      {
        id: 'y7t3-m4-q3',
        question: 'Which connective would you use to introduce a difference between two texts?',
        options: ['Similarly', 'Both writers', 'In the same way', 'However'],
        correct: 3,
        explanation:
          '"However" introduces a contrast or difference between two texts. "Similarly," "Both writers," and "In the same way" all introduce similarities.',
      },
      {
        id: 'y7t3-m4-q4',
        question: 'What can you compare in two stories?',
        options: [
          'Only the characters',
          'Only the language',
          'Theme, character, setting, structure, language, and narrative voice',
          'Only the plot events',
        ],
        correct: 2,
        explanation:
          'You can compare any aspect of two stories: their themes, characters, settings, structural choices, language techniques, and narrative voice. The best comparisons focus on the areas that reveal the most interesting similarities or differences.',
      },
      {
        id: 'y7t3-m4-q5',
        question: 'In the text extracts, what is the key difference between the two settings?',
        options: [
          'Both are forests',
          'Extract A creates entrapment while Extract B creates liberation',
          'Extract B is set at night',
          'They are in the same location',
        ],
        correct: 1,
        explanation:
          'Extract A uses oppressive imagery ("closed like a fist," "suffocating dark") to create entrapment, while Extract B uses expansive imagery ("stretched out," "freedom") to create a sense of liberation and joy.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        options: [
          'Plot, Event, Explain, Language',
          'Point, Evidence, Explain, Link',
          'Paragraph, Example, Effect, List',
          'Purpose, Evidence, Evaluate, Learn',
        ],
        correct: 1,
        explanation:
          'PEEL stands for Point, Evidence, Explain, Link. It is a structure for writing analytical paragraphs that ensures every point is supported by evidence and analysis.',
      },
      {
        id: 'y7t3-m5-q2',
        ...
        options: [
          ...
          'A quotation placed at the end of an essay',
          'A quotation woven into your own sentence',
          'A quotation from the examiner',
        ],
        correct: 2,
        explanation:
          'An embedded quotation is woven into your own sentence so it reads fluently as part of your argument. It shows confidence and allows you to analyse specific words.',
      },
      {
        id: 'y7t3-m5-q3',
        question: 'What is "feature spotting"?',
        options: [
          'Finding hidden features in a text',
          'Naming a technique without explaining its effect',
          'Writing about every technique in the text',
          'Using a magnifying glass to read closely',
        ],
        correct: 1,
        explanation:
          'Feature spotting means identifying a technique (such as a metaphor or simile) without explaining what effect it has on the reader. It scores poorly because analysis requires explanation, not just identification.',
      },
      {
        id: 'y7t3-m5-q4',
        question: 'Which analytical phrase is more sophisticated than "this shows"?',
        options: ['This tells us', 'This means', 'This suggests / implies / conveys', 'This is'],
        correct: 2,
        explanation:
          '"This suggests," "implies," and "conveys" are more sophisticated alternatives to "this shows" because they indicate interpretation and analysis rather than simple description.',
      },
      {
        id: 'y7t3-m5-q5',
        question:
          'In the model answer, how does the writer of Extract B create a sense of control?',
        options: [
          'By using a cage metaphor',
          'By personifying the rules as shouting',
          'By describing a locked door',
          'By using first-person narration',
        ],
        correct: 1,
        explanation:
          'In Extract B, the rules are "written in capital letters that seemed to shout," which personifies the text as an authority figure. This suggests the children are controlled by rigid discipline rather than physical barriers.',
      },
    ],
  },
...
`,
    quiz: [
      {
        id: 'y7t3-m6-q1',
        question: 'What is the main difference between poetry and prose?',
        options: [
          'Poetry is always about nature',
          'Poetry uses line breaks, condensed language, and sound patterns',
          'Prose is always fictional',
          'Poetry must always rhyme',
        ],
        correct: 1,
        explanation:
          'Poetry is distinguished from prose by its use of line breaks, condensed language where every word carries extra weight, sound patterns like rhyme and rhythm, and deliberate structural choices.',
      },
      {
        id: 'y7t3-m6-q2',
        ...
        correct: 2,
        explanation:
          'A stanza is a group of lines in a poem, separated from other groups by a blank line. Stanzas are the poetic equivalent of paragraphs.',
      },
      {
        id: 'y7t3-m6-q3',
        ...
        correct: 2,
        explanation:
          'A sonnet has 14 lines. It is one of the most well-known fixed forms of poetry, often used to explore themes of love, beauty, or deep emotion.',
      },
      {
        id: 'y7t3-m6-q4',
        question: 'Why should you distinguish between the "poet" and the "speaker"?',
        options: [
          'Because they always disagree',
          'Because the speaker is a character created by the poet - they may not be the same person',
          'Because the poet never appears in the poem',
          'Because the speaker always lies',
        ],
        correct: 1,
        explanation:
          'The speaker of a poem is a character or voice created by the poet. They are not necessarily the same person. Distinguishing between them shows sophisticated understanding of how poetry works.',
      },
      {
        id: 'y7t3-m6-q5',
        question: 'What is free verse?',
        options: [
          'Poetry that is given away for free',
          'Poetry with no regular rhyme or metre',
          'Poetry written in a foreign language',
          'Poetry that must be performed on stage',
        ],
        correct: 1,
        explanation:
          'Free verse is poetry that does not follow a regular rhyme scheme or metrical pattern. The poet has complete freedom over line length and structure, using line breaks and imagery to create meaning.',
      },
    ],
  },
...
`,
    quiz: [
      {
        id: 'y7t3-m7-q1',
        question: 'What is a rhyme scheme?',
        options: [
          'A type of poem',
          'The pattern of rhymes at the end of each line, labelled with letters',
          'A plan for writing poetry',
          'The title of a poetry collection',
        ],
        correct: 1,
        explanation:
          'A rhyme scheme is the pattern of end rhymes in a poem, labelled with letters of the alphabet. ABAB means the first and third lines rhyme, and the second and fourth lines rhyme.',
      },
      {
        id: 'y7t3-m7-q2',
        question: 'What is iambic pentameter?',
        options: [
          'Five pairs of stressed/unstressed syllables per line',
          'Five pairs of unstressed/stressed syllables per line',
          'Ten lines in a stanza',
          'A type of rhyme',
        ],
        correct: 1,
        explanation:
          'Iambic pentameter consists of five iambs (da-DUM) per line - five pairs of an unstressed syllable followed by a stressed syllable. It is the most common metre in English poetry.',
      },
      {
        id: 'y7t3-m7-q3',
        ...
        correct: 1,
        explanation:
          'Enjambment occurs when a sentence or phrase continues past the end of a line and into the next line without any punctuation. It creates momentum and a sense of overflow.',
      },
      {
        id: 'y7t3-m7-q4',
        question: 'What effect does caesura typically create?',
        options: [
          'It speeds up the rhythm',
          'It makes the poem rhyme',
          'It creates a pause for reflection, emphasis, or dramatic tension',
          'It makes the poem longer',
        ],
        correct: 2,
        explanation:
          'Caesura is a pause in the middle of a line, usually created by punctuation. It breaks the flow and creates a moment of hesitation, reflection, or dramatic tension.',
      },
      {
        id: 'y7t3-m7-q5',
        ...
        options: [
          ...
          'Words that nearly rhyme but not quite',
          'A rhyme that only appears once',
        ],
        correct: 2,
        explanation:
          'Half rhyme (also called slant rhyme) occurs when words nearly rhyme but do not match perfectly - for example, "moon/mine" or "love/move." It creates a sense of unease or imperfection.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        options: [
          ...
          'A photograph inside a book',
          'The title of a poem',
        ],
        correct: 1,
        explanation:
          'Imagery is language that appeals to the five senses - sight, sound, smell, taste, and touch - to create vivid mental pictures. It helps the reader experience what is being described.',
      },
      {
        id: 'y7t3-m8-q2',
        ...
        options: [
          ...
          'There is no difference',
          'Metaphors only appear in poetry',
        ],
        correct: 1,
        explanation:
          'A simile makes a comparison using "like" or "as" (brave as a lion). A metaphor states that something IS something else directly (he was a lion). Metaphors are more direct and often more powerful.',
      },
      {
        id: 'y7t3-m8-q3',
        ...
        options: [
          ...
          "Using someone's real name in a poem",
          'Writing in first person',
        ],
        correct: 0,
        explanation:
          'Personification gives human qualities, emotions, or actions to non-human things. For example, "the wind howled" gives the human ability to howl to the wind.',
      },
      {
        id: 'y7t3-m8-q4',
        ...
        options: [
          ...
          'A type of rhyme',
          'A long pause in a poem',
        ],
        correct: 1,
        explanation:
          'Sibilance is the repetition of "s" sounds in words close together. It often creates a hissing, whispering, or sinister effect.',
      },
      {
        id: 'y7t3-m8-q5',
        question: 'In the fog poem extract, what type of figurative language is used?',
        options: ['Simile', 'Hyperbole', 'Extended metaphor', 'Oxymoron'],
        correct: 2,
        explanation:
          'The poem uses an extended metaphor, comparing fog to a cat throughout the entire poem. The fog comes on "little cat feet," "sits looking" on "silent haunches," and "moves on" - all qualities of a cat sustained across the whole piece.',
      },
    ],
  },
...
`,
    quiz: [
      {
        id: 'y7t3-m9-q1',
        question: 'How many times should you read a poem before beginning your analysis?',
        options: [
          'Once is enough',
          'At least three times',
          "It depends on the poem's length",
          'You should not read it - just skim it',
        ],
        correct: 1,
        explanation:
          'You should read a poem at least three times: first for the gist, second aloud for sound and rhythm, and third with annotation for detailed analysis.',
      },
      {
        id: 'y7t3-m9-q2',
        ...
        options: [
          ...
          'A type of rhyme',
          'A turning point where the tone or argument shifts',
          'The final word of a poem',
        ],
        correct: 2,
        explanation:
          'A volta is a turning point in a poem where the tone, mood, argument, or perspective shifts. Identifying the volta demonstrates sophisticated structural understanding.',
      },
      {
        id: 'y7t3-m9-q3',
        question: 'What is tone in poetry?',
        options: [
          'The volume at which you read the poem',
          "The attitude or emotion conveyed by the speaker's voice",
          'The number of syllables in a line',
          'The colour of the text',
        ],
        correct: 1,
        explanation:
          "Tone is the attitude or emotion conveyed by the speaker's voice - it tells the reader how the speaker feels about their subject. It works like tone of voice in speech.",
      },
      {
        id: 'y7t3-m9-q4',
        question: 'Why should you avoid analysing a poem line by line?',
        options: [
          'Because poems should be read backwards',
          'Because it leads to repetition and lack of focus',
          'Because examiners prefer short answers',
          'Because only the first and last lines matter',
        ],
        correct: 1,
        explanation:
          'Analysing line by line often leads to repetition and unfocused writing. It is better to organise your analysis by technique or theme, selecting the most powerful examples from across the poem.',
      },
      {
        id: 'y7t3-m9-q5',
        question:
          'In the text extract, what does "the dying of the light" metaphorically represent?',
        options: ['A sunset', 'A broken lamp', 'Death', 'Sleep'],
        correct: 2,
        explanation:
          'In this metaphor, "the dying of the light" represents death. Life is equated with light and brightness, and death is presented as the extinguishing of that light.',
      },
    ],
  },
...
`,
    quiz: [
      {
        id: 'y7t3-m10-q1',
        question: 'What is a thematic connection?',
        options: [
          'When two poems have the same title',
          'A link between texts based on the ideas they explore',
          'When two poems are written by the same poet',
          'When two poems are the same length',
        ],
        correct: 1,
        explanation:
          'A thematic connection is a link between two or more texts based on the ideas or themes they explore, rather than their surface content. Two poems about different subjects might share a theme like loss, power, or identity.',
      },
      {
        id: 'y7t3-m10-q2',
        question: 'What is the best way to structure a comparative poetry essay?',
        options: [
          'Write about Poem A first, then Poem B',
          'Discuss both poems in every paragraph using the alternating method',
          'Only write about the poem you prefer',
          'Write one sentence about each poem',
        ],
        correct: 1,
        explanation:
          'The alternating method is the most effective structure because it integrates both poems in every paragraph, showing direct comparison rather than separate descriptions.',
      },
      {
        id: 'y7t3-m10-q3',
        question: 'In the text extracts, how does Poem B present memory differently from Poem A?',
        options: [
          'Poem B presents memory as warm and comforting',
          'Poem B presents memory as involuntary and painful',
          'Both poems present memory the same way',
          'Poem B does not mention memory at all',
        ],
        correct: 1,
        explanation:
          'Poem B presents memory as involuntary and painful. The speaker denies thinking about the person, but their hands unconsciously write the name in the dust, suggesting the memory persists against their will.',
      },
      {
        id: 'y7t3-m10-q4',
        question: 'What does "evaluating effectiveness" mean in poetry comparison?',
        options: [
          'Deciding which poem is longer',
          'Making a judgement about which poem communicates its ideas more powerfully',
          'Counting the number of techniques in each poem',
          'Choosing the poem with better rhymes',
        ],
        correct: 1,
        explanation:
          'Evaluating effectiveness means making a judgement about which poem communicates its ideas more powerfully through its use of language, structure, and form. It is the highest level of comparative analysis.',
      },
      {
        id: 'y7t3-m10-q5',
        question: 'Why is "both poems use metaphors" a weak comparison?',
        options: [
          'Because metaphors are not important',
          'Because it is too vague - you need to explain what different effects the metaphors create',
          'Because only one poem can use metaphors',
          'Because comparisons should avoid mentioning techniques',
        ],
        correct: 1,
        explanation:
          'Simply stating that both poems use the same technique is too vague. A strong comparison explains HOW each poet uses metaphors differently and what different EFFECTS they create.',
      },
    ],
  },
...
`,
    quiz: [
      {
        id: 'y7t3-m11-q1',
        question: 'What is subject terminology?',
        options: [
          'The title of a poem',
          'Specialist vocabulary used to discuss literature and language',
          'The subject of a sentence',
          'A type of exam question',
        ],
        correct: 1,
        explanation:
          'Subject terminology is the specialist vocabulary used to discuss literary and linguistic techniques - terms like metaphor, enjambment, protagonist, and pathetic fallacy.',
      },
      {
        id: 'y7t3-m11-q2',
        ...
        options: [
          'A type of rhyme',
          'Repetition of a word or phrase at the start of consecutive lines',
          'A pause in the middle of a line',
          'A comparison using "like"',
        ],
        correct: 1,
        explanation:
          'Anaphora is the repetition of a word or phrase at the beginning of consecutive lines or sentences. It creates emphasis, rhythm, and a sense of building intensity.',
      },
      {
        id: 'y7t3-m11-q3',
        question: 'What is the difference between alliteration and sibilance?',
        options: [
          'They are the same thing',
          'Alliteration repeats any consonant sound at the start of words; sibilance specifically repeats "s" sounds',
          'Sibilance is louder than alliteration',
          'Alliteration only occurs in poetry',
        ],
        correct: 1,
        explanation:
          'Alliteration is the repetition of any consonant sound at the start of nearby words. Sibilance is a specific type that focuses on the repetition of "s" sounds, often creating a hissing or whispering effect.',
      },
      {
        id: 'y7t3-m11-q4',
        question: 'What is feature spotting?',
        options: [
          'Finding features in a landscape poem',
          'Naming techniques without explaining their effects',
          'A way to get top marks',
          'Reading a poem for the first time',
        ],
        correct: 1,
        explanation:
          'Feature spotting means identifying and naming techniques without explaining what effect they have on the reader. It scores poorly because analysis requires explanation, not just identification.',
      },
      {
        id: 'y7t3-m11-q5',
        ...
        options: [
          ...
          'A way of writing in paragraphs',
        ],
        correct: 1,
        explanation:
          'Juxtaposition is placing two contrasting ideas, images, or words side by side to highlight their differences and create a striking effect.',
      },
    ],
  },
    ...
    quiz: [
      {
        id: 'y7t3-m12-q1',
        question:
          'In the prose extract, what technique is used in "windows were like the eye sockets of a skull"?',
        options: ['Metaphor', 'Simile', 'Personification', 'Alliteration'],
        correct: 1,
        explanation:
          'This is a simile because it uses "like" to compare the dark windows to the eye sockets of a skull. It creates a macabre, death-like image of the abandoned house.',
      },
      {
        id: 'y7t3-m12-q2',
        question:
          "What type of figurative language does the poem use to describe the mother's hands?",
        options: ['Simile', 'Oxymoron', 'Extended metaphor', 'Hyperbole'],
        correct: 2,
        explanation:
          "The poem uses an extended metaphor, comparing the mother's hands to a landscape throughout both stanzas. Veins become rivers, knuckles become mountains, and wrinkles become contour lines on a map.",
      },
      {
        id: 'y7t3-m12-q3',
        question: 'How do the prose and poetry extracts differ in their presentation of time?',
        options: [
          'Both present time as destructive',
          'The prose presents time as destructive; the poem presents it as something to be read and cherished',
          'Both present time positively',
          'Neither text mentions time',
        ],
        correct: 1,
        explanation:
          "The prose presents time as a destructive force that reduces human spaces to decay and death. The poem presents time as something beautiful and meaningful - the mother's ageing is a landscape worth exploring.",
      },
      {
        id: 'y7t3-m12-q4',
        question: 'What is the most important thing to remember in a comparison?',
        options: [
          'Write about both texts in every paragraph',
          'Only write about the text you prefer',
          'Use as many long quotations as possible',
          'Retell the plot of both texts',
        ],
        correct: 0,
        explanation:
          'The most important thing in comparison is to discuss both texts in every paragraph, using connectives like "similarly," "however," and "whereas" to make the comparison explicit and integrated.',
      },
      {
        id: 'y7t3-m12-q5',
        question: 'Which of these is an example of feature spotting?',
        options: [
          '"The metaphor of the house as a skull creates a macabre atmosphere of death and decay"',
          '"The writer uses a metaphor and some personification"',
          '"The simile suggests the house is dead, reflecting the theme of loss"',
          '"The personification of the door as having given up conveys exhaustion and defeat"',
        ],
        correct: 1,
        explanation:
          '"The writer uses a metaphor and some personification" is feature spotting because it names techniques without explaining their effects. The other options all identify techniques AND analyse what effect they create.',
      },
    ],
  },
]
