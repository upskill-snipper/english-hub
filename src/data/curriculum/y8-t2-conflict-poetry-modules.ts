    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Anthology comes from the Greek "anthologia," meaning a gathering of flowers. It refers to a curated collection of literary works, usually grouped by theme.',
      },
      {
        id: 'y8t2-m1-q2',
        question: 'Why is historical context important when reading conflict poetry?',
        options: [
          'It tells you the rhyme scheme',
          'It helps you count syllables',
          'It shapes the language, form, and attitudes of the poem',
          'It reveals the number of stanzas',
        ],
        correct: 2,
        explanation:
          "Historical context tells you when, why, and by whom the poem was written. These factors directly shape the poet's language choices, attitudes to conflict, and the form they use.",
      },
      {
        id: 'y8t2-m1-q3',
        question: 'What should you do first when encountering a new conflict poem?',
        options: [
          'Count the stanzas',
          "Look up the poet's biography",
          'Read it aloud',
          'Identify the rhyme scheme',
        ],
        correct: 2,
        explanation:
          'Reading a poem aloud helps you hear its rhythm, pauses, and sounds. Poetry is a musical form, and hearing it reveals things that silent reading can miss.',
      },
      {
        id: 'y8t2-m1-q4',
        question: 'Which of the following is NOT a typical theme in conflict poetry?',
        options: [
          'Loss and grief',
        ...
        correct: 1,
        explanation:
          'While love can appear in conflict poetry, romantic love between characters is not a defining theme of the genre. The other options - grief, disillusionment, and power - are central recurring themes.',
      },
      {
        id: 'y8t2-m1-q5',
        question: 'What common mistake do students make when studying conflict poetry?',
        options: [
          'Quoting too much of the poem',
          'Assuming all conflict poetry is anti-war',
          'Writing in the present tense',
          'Ignoring the title',
        ],
        correct: 1,
        explanation:
          "Not all conflict poetry is anti-war. Some poets genuinely celebrate courage and sacrifice. You must read each poem on its own terms before deciding the poet's attitude.",
      },
    ],
  },
...
<div class="common-mistake"><strong>Common Mistake:</strong> Confusing simile and metaphor. If the comparison uses "like" or "as," it is a simile. If it states one thing <em>is</em> another without those words, it is a metaphor. This distinction matters when you use subject terminology.</div>`,
    quiz: [
      {
        id: 'y8t2-m2-q1',
        question: 'Which type of imagery appeals to the sense of hearing?',
        options: ['Visual imagery', 'Tactile imagery', 'Auditory imagery', 'Olfactory imagery'],
        correct: 2,
        explanation:
          'Auditory imagery appeals to hearing. In war poetry this might include sounds of gunfire, explosions, screams, or silence after battle.',
      },
      {
        id: 'y8t2-m2-q2',
        ...
        options: [
          ...
          'A metaphor is always about nature',
          'There is no difference',
        ],
        correct: 1,
        explanation:
          'A simile compares using "like" or "as" (e.g., "brave as a lion"), while a metaphor states one thing IS another without those connecting words (e.g., "he was a lion in battle").',
      },
      {
        id: 'y8t2-m2-q3',
        question: 'Why is imagery especially important in war poetry?',
        options: [
          'It makes the poem longer',
          'It helps with the rhyme scheme',
          "It bridges the gap between the poet's experience and the reader's imagination",
          'It is required by the exam board',
        ],
        correct: 2,
        explanation:
          "Most readers have never experienced combat. Imagery recreates the sights, sounds, and feelings of war so the reader can understand and feel the poet's experience.",
      },
      {
        id: 'y8t2-m2-q4',
        question: 'What does personification do in poetry?',
        options: [
          'Compares two things using "like"',
          'Gives human qualities to non-human things',
          'Creates a regular rhythm',
          'Repeats the first consonant sound',
        ],
        correct: 1,
        explanation:
          'Personification gives human qualities to non-human things. In war poetry, abstract concepts like Death or Nature are often personified to make them feel immediate and threatening.',
      },
      {
        id: 'y8t2-m2-q5',
        ...
        options: [
          'A very long poem',
          'A metaphor developed across several lines or an entire poem',
          'A comparison using "as if"',
          'Two similes placed side by side',
        ],
        correct: 1,
        explanation:
          'An extended metaphor is sustained across multiple lines or even the whole poem, building a deeper parallel between two ideas rather than making a single quick comparison.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        options: [
          ...
          'Tone is about rhythm; mood is about rhyme',
          "Mood is the poet's attitude; tone is the reader's feeling",
        ],
        correct: 1,
        explanation:
          "Tone is the poet's attitude towards their subject (their emotional stance), while mood is the atmosphere or emotional effect the poem creates in the reader.",
      },
      {
        id: 'y8t2-m3-q2',
        ...
        options: [
          ...
          'A turning point where the tone or mood shifts',
          'A Latin word for conflict',
          'The final line of a poem',
        ],
        correct: 1,
        explanation:
          'A volta is a turning point in a poem where the tone, mood, or argument shifts significantly. Recognising where the volta occurs is a key analytical skill.',
      },
      {
        id: 'y8t2-m3-q3',
        question: 'How is tone primarily created in a poem?',
        options: [
          'Through the number of stanzas',
          'Through the title',
          "Through diction - the poet's choice of words",
          'Through the length of the poem',
        ],
        correct: 2,
        explanation:
          'Tone is primarily created through diction - the specific words a poet chooses. Words like "bravely" create an admiring tone, while words like "stumbled blindly" create a bitter, accusatory tone.',
      },
      {
        id: 'y8t2-m3-q4',
        question: 'Which tone involves saying one thing but meaning the opposite?',
        options: ['Elegiac', 'Patriotic', 'Ironic', 'Compassionate'],
        correct: 2,
        explanation:
          'An ironic tone involves a contrast between what is said on the surface and what is actually meant. Poets use irony to expose hypocrisy or to make a point more forcefully through understatement.',
      },
      {
        id: 'y8t2-m3-q5',
        question: 'What common mistake do students make when discussing tone?',
        options: [
          'Using too many quotations',
          'Writing too much about mood',
          "Confusing the speaker's tone with the poet's tone",
          'Not mentioning the title',
        ],
        correct: 2,
        explanation:
          'Students often assume the speaker and the poet share the same attitude. But a poet might create a boastful speaker in order to criticise boastfulness through irony.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Enjambment occurs when a sentence or phrase carries over from one line into the next without any punctuation at the line break, pulling the reader forward.',
      },
      {
        id: 'y8t2-m4-q2',
        question: 'What does a caesura create in a line of poetry?',
        options: ['A rhyme', 'A simile', 'A pause in the middle of the line', 'An extra syllable'],
        correct: 2,
        explanation:
          'A caesura is a pause within a line, created by punctuation such as a full stop, dash, or comma. It can represent interruption, shock, or a moment of silence.',
      },
      {
        id: 'y8t2-m4-q3',
        question: 'What might irregular stanza lengths suggest in a conflict poem?',
        options: [
          'The poet is lazy',
          'Order, control, and discipline',
          'Instability, chaos, or emotional turbulence',
          'The poem is unfinished',
        ],
        correct: 2,
        explanation:
          "Irregular stanzas suggest disorder and instability, which can mirror the chaos of battle or the breakdown of a speaker's emotional composure.",
      },
      {
        id: 'y8t2-m4-q4',
        question: 'Which poetic form has exactly fourteen lines?',
        options: ['Ballad', 'Free verse', 'Sonnet', 'Dramatic monologue'],
        correct: 2,
        explanation:
          'A sonnet is a fourteen-line poem, usually written in iambic pentameter. It is a tightly controlled form often used for intense personal emotion, including grief and defiance in war poetry.',
      },
      {
        id: 'y8t2-m4-q5',
        question: 'Why is free verse often used in modern war poetry?',
        options: [
          'Because the poet cannot rhyme',
          'Because it mirrors the disorder and chaos of conflict',
          'Because it is easier to write',
          'Because it is the only modern form',
        ],
        correct: 1,
        explanation:
          'Free verse has no fixed metre or rhyme scheme. Its deliberate formlessness can reflect the chaos of modern warfare and the rejection of traditional, ordered structures.',
      },
    ],
  },
    ...
    quiz: [
      {
        id: 'y8t2-m5-q1',
        question:
          'What is the main difference between the alternating and block structures for comparison?',
        options: [
          'Alternating is shorter',
          'Alternating moves between both poems in each paragraph; block covers one poem at a time',
          'Block structure is always better',
          'There is no difference',
        ],
        correct: 1,
        explanation:
          'The alternating method discusses both poems within each paragraph, moving between them point by point. The block method covers one poem fully before moving to the second.',
      },
      {
        id: 'y8t2-m5-q2',
        question: 'Which of the following is a comparative connective for showing contrast?',
        options: ['Similarly', 'Both poets', 'Furthermore', 'Whereas'],
        correct: 3,
        explanation:
          '"Whereas" signals a contrast between two things. It is used to highlight differences: "Whereas Poet A uses violent imagery, Poet B takes a gentler approach."',
      },
      {
        id: 'y8t2-m5-q3',
        question: 'What should every paragraph in a comparative essay include?',
        options: [
          'A quotation from only one poem',
          'References to both poems',
          'A biographical fact about the poet',
          'At least three similes',
        ],
        correct: 1,
        explanation:
          'In a comparative essay, every paragraph should reference both texts. This ensures you are genuinely comparing rather than writing two separate analyses.',
      },
      {
        id: 'y8t2-m5-q4',
        question: 'Which four categories should you compare across two poems?',
        options: [
          'Plot, character, setting, dialogue',
          'Theme, language, structure, tone and mood',
          'Rhyme, rhythm, alliteration, onomatopoeia',
          'Title, date, length, author',
        ],
        correct: 1,
        explanation:
          'The four key areas for comparison are theme (what the poems are about), language (how they say it), structure (how they are shaped), and tone/mood (what attitudes and feelings they convey).',
      },
      {
        id: 'y8t2-m5-q5',
        question: 'What is the biggest mistake students make in comparative essays?',
        options: [
          'Using too many quotations',
          'Comparing the poems throughout rather than at the end',
          'Writing about one poem for most of the essay and only comparing at the end',
          'Using the alternating structure',
        ],
        correct: 2,
        explanation:
          'The most common error is writing about one poem for the whole essay and tacking on a comparison paragraph at the end. Comparison must run throughout every paragraph.',
      },
    ],
  },
...
<div class="common-mistake"><strong>Common Mistake:</strong> Spending too long on the introduction. Your introduction should be 3-5 sentences maximum. The marks are in the analytical body paragraphs, not in lengthy scene-setting.</div>`,
    quiz: [
      {
        id: 'y8t2-m6-q1',
        question: 'What three things should a comparative essay introduction include?',
        options: [
          'Three quotations from each poem',
          "The poems' names, shared theme, and a thesis statement",
          'Biographical details about both poets',
          'A summary of both poems',
        ],
        correct: 1,
        explanation:
          'A strong introduction names both poems and their poets, identifies the shared theme or subject, and states a thesis - a clear, arguable claim the essay will prove.',
      },
      {
        id: 'y8t2-m6-q2',
        question: 'What is the difference between a weak and strong thesis statement?',
        options: [
          'A strong thesis is longer',
          'A weak thesis describes; a strong thesis argues',
          'A strong thesis uses more quotations',
          'There is no real difference',
        ],
        correct: 1,
        explanation:
          'A weak thesis merely describes ("both poems are about war"). A strong thesis makes an arguable claim about HOW or WHY the poems approach the subject differently.',
      },
      {
        id: 'y8t2-m6-q3',
        question: 'What is "feature-spotting" and why should you avoid it?',
        options: [
          'It means finding quotations, which is good',
          'It means identifying techniques without explaining their effect, which earns few marks',
          'It means comparing two poems, which is the task',
          'It means planning your essay, which takes too long',
        ],
        correct: 1,
        explanation:
          'Feature-spotting means identifying a technique ("the poet uses alliteration") without explaining its effect on the reader. It earns minimal marks because there is no analysis.',
      },
      {
        id: 'y8t2-m6-q4',
        question: 'What should a comparative essay conclusion do?',
        options: [
          'Repeat the introduction word for word',
          'Introduce a new poem',
          'Summarise key points and offer a final evaluative judgement',
          'List all the techniques you found',
        ],
        correct: 2,
        explanation:
          'A conclusion summarises the key similarities and differences, offers a final evaluative judgement about which approach is more effective, and ends with a thought-provoking statement.',
      },
      {
        id: 'y8t2-m6-q5',
        question:
          'In the five-part paragraph structure, what comes between the Poem A analysis and the Poem B analysis?',
        options: [
          'A conclusion',
          'A quotation from a third poem',
          'A comparative connective linking the two',
          'A biographical fact',
        ],
        correct: 2,
        explanation:
          'A comparative connective (such as "Similarly," "In contrast," or "Whereas") links your analysis of Poem A to your analysis of Poem B, ensuring the paragraph genuinely compares.',
      },
    ],
  },
...
<div class="common-mistake"><strong>Common Mistake:</strong> Treating Shakespeare as a novel. <em>Macbeth</em> is a play - it was written to be performed. Always think about how lines would be spoken, what gestures an actor might use, and what the audience would see and feel in a theatre.</div>`,
    quiz: [
      {
        id: 'y8t2-m7-q1',
        question: 'When was Macbeth written and during whose reign?',
        options: [
          "1590, during Elizabeth I's reign",
          "1606, during James I's reign",
          "1623, during Charles I's reign",
          "1580, during Henry VIII's reign",
        ],
        correct: 1,
        explanation:
          "Macbeth was written around 1606, during the reign of King James I. James was particularly interested in witchcraft, which may have influenced Shakespeare's inclusion of the witches.",
      },
      {
        id: 'y8t2-m7-q2',
        ...
        options: [
          ...
          'A pattern of ten syllables per line alternating unstressed and stressed beats',
          'A type of stage direction',
          'A form of punctuation',
        ],
        correct: 1,
        explanation:
          'Iambic pentameter is a rhythmic pattern: five pairs of syllables (ten total), each pair going unstressed-stressed (da-DUM). Shakespeare uses it for high-status characters and emotionally significant moments.',
      },
      {
        id: 'y8t2-m7-q3',
        question: 'What does it signal when a character switches from verse to prose?',
        options: [
          'They are speaking to a servant',
          'There is an emotional or psychological change',
          'The scene is about to end',
          'They are telling a joke',
        ],
        correct: 1,
        explanation:
          "Switching from verse to prose signals a change in the character's mental or emotional state. Lady Macbeth's sleepwalking scene is in prose, mirroring her mental breakdown.",
      },
      {
        id: 'y8t2-m7-q4',
        ...
        options: [
          ...
          'A speech by a character alone on stage revealing private thoughts',
          'A letter read aloud',
        ],
        correct: 2,
        explanation:
          'A soliloquy is a speech delivered by a character who is alone on stage, revealing their innermost thoughts to the audience. It allows us to see what characters truly think and feel.',
      },
      {
        id: 'y8t2-m7-q5',
        question: 'What is the central question Macbeth explores?',
        options: [
          'Is love more powerful than hate?',
          'What happens when ambition overrides morality?',
          'Can poverty be overcome through hard work?',
          'Is fate more powerful than free will?',
        ],
        correct: 1,
        explanation:
          'Macbeth fundamentally asks what happens when ambition overrides morality. The answer the play provides is total destruction - of the individual, relationships, and the state.',
      },
    ],
  },
...
<div class="common-mistake"><strong>Common Mistake:</strong> Saying "Macbeth killed Duncan because Lady Macbeth told him to." This oversimplifies the psychology. Macbeth had already thought about murder before she spoke. She pushed him over the edge, but the desire was already there.</div>`,
    quiz: [
      {
        id: 'y8t2-m8-q1',
        question: "What is Macbeth's hamartia (fatal flaw)?",
        options: ['Cowardice', 'Jealousy', 'Vaulting ambition', 'Laziness'],
        correct: 2,
        explanation:
          'Macbeth\'s fatal flaw is his "vaulting ambition" - ambition so extreme it overreaches and destroys him. This is the driving force behind every terrible decision he makes.',
      },
      {
        id: 'y8t2-m8-q2',
        question: 'How does Lady Macbeth persuade Macbeth to kill Duncan?',
        options: [
          'She gives him logical arguments',
          'She attacks his masculinity and questions his love',
          'She threatens to leave him',
          'She bribes him with promises of wealth',
        ],
        correct: 1,
        explanation:
          'Lady Macbeth uses emotional manipulation: she attacks his manhood, questions his love for her, and uses shocking violent imagery to overwhelm his objections.',
      },
      {
        id: 'y8t2-m8-q3',
        question: 'What does the floating dagger in Act 2, Scene 1 represent?',
        options: [
          'A real weapon the witches sent',
          "Macbeth's tortured mental state - guilt, fear, and desire",
          'A message from Lady Macbeth',
          'A sign from God',
        ],
        correct: 1,
        explanation:
          "The dagger is a hallucination - a projection of Macbeth's guilt, fear, and desire. It externalises his internal conflict, making his psychological agony visible to the audience.",
      },
      {
        id: 'y8t2-m8-q4',
        question: 'Why is the banquet scene dramatically ironic?',
        options: [
          'Because the food is poisoned',
          "Because the audience knows Macbeth sees Banquo's ghost while the guests are bewildered",
          'Because Lady Macbeth is hiding behind the curtain',
          'Because Macduff arrives uninvited',
        ],
        correct: 1,
        explanation:
          'The audience knows Macbeth is seeing the ghost of the man he murdered, while the other characters see only a king having an inexplicable breakdown. This gap in knowledge creates powerful dramatic irony.',
      },
      {
        id: 'y8t2-m8-q5',
        question: "What happens to Macbeth's power as the play progresses?",
        options: [
          'It grows stronger and more secure',
          'It remains constant throughout',
          'It becomes a curse - each act of violence requires another, leading to isolation and destruction',
          'He voluntarily gives it up',
        ],
        correct: 2,
        explanation:
          'Each murder requires another to protect it, creating a chain reaction. Macbeth becomes increasingly isolated, paranoid, and tyrannical. The crown he killed for becomes a curse.',
      },
    ],
  },
...
<div class="common-mistake"><strong>Common Mistake:</strong> Referring to the "reader" when writing about a play. The correct term is "audience." Shakespeare wrote for people who would hear and see the play, not read it privately.</div>`,
    quiz: [
      {
        id: 'y8t2-m9-q1',
        question: 'What is the purpose of a soliloquy?',
        options: [
          'To advance the plot quickly',
          'To entertain the audience with comedy',
          "To reveal a character's private thoughts to the audience",
          'To summarise previous events',
        ],
        correct: 2,
        explanation:
          'A soliloquy allows a character, alone on stage, to share their innermost thoughts with the audience. It reveals what the character truly thinks and feels, beneath their public mask.',
      },
      {
        id: 'y8t2-m9-q2',
        question: 'What does the term "proxemics" refer to in stagecraft?',
        options: [
          "The volume of an actor's voice",
          'The physical distance between characters on stage',
          'The speed at which lines are delivered',
          'The colour of the set design',
        ],
        correct: 1,
        explanation:
          'Proxemics refers to how physical space is used between characters. Close proximity can suggest intimacy or conspiracy; distance can suggest fear or conflict.',
      },
      {
        id: 'y8t2-m9-q3',
        question: 'Why should you write "audience" rather than "reader" when discussing Macbeth?',
        options: [
          'Because it is a longer word',
          'Because Macbeth is a play written for performance, not private reading',
          'Because the examiner prefers it',
          'Because Shakespeare said so',
        ],
        correct: 1,
        explanation:
          'Macbeth is a play - it was written to be performed on stage and experienced by an audience. Using "audience" shows you understand it as a piece of theatre, not prose fiction.',
      },
      {
        id: 'y8t2-m9-q4',
        question: 'What does Macbeth\'s "Tomorrow, and tomorrow, and tomorrow" soliloquy express?',
        options: [
          'Hope for the future',
          'Excitement about being king',
          'Nihilism - life is meaningless',
          'Anger at Lady Macbeth',
        ],
        correct: 2,
        explanation:
          'This soliloquy, delivered after Lady Macbeth\'s death, expresses total nihilism. Macbeth concludes that life "signifies nothing" - he has gained everything and been left with emptiness.',
      },
      {
        id: 'y8t2-m9-q5',
        question: 'Which of the following is an example of foreshadowing in Macbeth?',
        options: [
          'Lady Macbeth washing her hands',
          "The witches' prophecies about Macbeth's future",
          'Macbeth hosting a banquet',
          'The porter opening the gate',
        ],
        correct: 1,
        explanation:
          "The witches' prophecies foreshadow the entire plot - they hint at what will happen (Macbeth becoming king, Banquo's descendants ruling) and create suspense about how these events will unfold.",
      },
    ],
  },
    ...
    quiz: [
      {
        id: 'y8t2-m10-q1',
        question:
          "What is the key difference between Macbeth's and Brutus's motivations for killing?",
        options: [
          'Macbeth is forced; Brutus chooses freely',
          'Macbeth kills for personal ambition; Brutus kills from political idealism',
          'Both are motivated by jealousy',
          'Brutus kills for money; Macbeth kills for love',
        ],
        correct: 1,
        explanation:
          'Macbeth kills Duncan to gain power for himself - personal ambition. Brutus kills Caesar to prevent tyranny and protect the Roman republic - political idealism. This fundamental difference shapes everything that follows.',
      },
      {
        id: 'y8t2-m10-q2',
        question: "How does Lady Macbeth's persuasion method differ from Cassius's?",
        options: [
          'Lady Macbeth uses logic; Cassius uses emotion',
          'Lady Macbeth uses emotional violence; Cassius uses intellectual argument',
          'Both use exactly the same method',
          'Lady Macbeth uses bribery; Cassius uses threats',
        ],
        correct: 1,
        explanation:
          "Lady Macbeth attacks Macbeth's masculinity and uses shocking imagery - emotional manipulation. Cassius appeals to Brutus's honour, pride, and sense of duty - intellectual persuasion.",
      },
      {
        id: 'y8t2-m10-q3',
        question: "How does Macbeth respond to Duncan's murder compared to Brutus after Caesar's?",
        options: [
          'Both are calm and collected',
          'Macbeth is overwhelmed by guilt; Brutus remains composed, believing the act was justified',
          'Macbeth celebrates; Brutus weeps',
          'Both flee the scene immediately',
        ],
        correct: 1,
        explanation:
          'Macbeth is immediately tormented by guilt - he hears voices and cannot sleep. Brutus remains composed because he genuinely believes killing Caesar was morally right and necessary for Rome.',
      },
      {
        id: 'y8t2-m10-q4',
        question: "What does Shakespeare suggest about moral certainty through Brutus's character?",
        options: [
          'That certainty is always correct',
          'That certainty can be as dangerous as guilt because it blinds you to consequences',
          'That guilt is unnecessary after killing',
          'That all politicians are corrupt',
        ],
        correct: 1,
        explanation:
          "Shakespeare suggests that Brutus's confidence in his own righteousness blinds him to the chaos his actions unleash. Certainty can be as dangerous as guilt because it prevents self-examination.",
      },
      {
        id: 'y8t2-m10-q5',
        question: 'When comparing two Shakespeare plays, what important fact should you remember?',
        options: [
          'They were written by different people',
          'One is always better than the other',
          'The same playwright wrote both, so differences are deliberate artistic choices',
          'You should only focus on the similarities',
        ],
        correct: 2,
        explanation:
          'Since Shakespeare wrote both plays, any differences in approach are deliberate artistic decisions, not accidents. This makes the comparison especially rich - you can ask why he chose to handle similar themes differently.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        options: [
          'Identifying techniques without analysing their effect - it earns few marks',
          'Using too many quotations in an essay',
          'Writing about the wrong poem',
          'Spending too long on planning',
        ],
        correct: 0,
        explanation:
          'Feature-spotting means identifying a technique ("the poet uses a metaphor") without explaining how it works or why the poet chose it. It demonstrates recognition but not understanding, which earns minimal marks.',
      },
      {
        id: 'y8t2-m11-q2',
        question: 'What does the analysis formula WHAT + WHERE + HOW + WHY require you to do?',
        options: [
          'Name the technique, quote it, explain how it works, and explain its effect',
          'Write the title, date, poet, and stanza number',
          'List four different techniques in each paragraph',
          'Write four paragraphs about the same point',
        ],
        correct: 0,
        explanation:
          'The formula requires you to name the technique (WHAT), quote an example (WHERE), explain the mechanics (HOW), and explain the effect on the reader/audience (WHY). This produces full, analytical writing.',
      },
      {
        id: 'y8t2-m11-q3',
        question: 'What effect do plosive sounds typically create in poetry?',
        options: [
          'A gentle, flowing rhythm',
          'A violent, percussive, forceful effect',
          'A whispering, secretive atmosphere',
          'A regular, musical pattern',
        ],
        correct: 1,
        explanation:
          'Plosive consonants (b, d, p, t, k) create hard, explosive sounds. In conflict poetry, they often mimic the violence and impact of combat, creating a forceful, aggressive rhythm.',
      },
      {
        id: 'y8t2-m11-q4',
        question: 'What should you do if you are unsure what a technical term means?',
        options: [
          'Use it anyway and hope for the best',
          'Describe the effect in plain English instead',
          'Skip the point entirely',
          'Make up a definition',
        ],
        correct: 1,
        explanation:
          'An accurate description in plain English always scores more than an incorrectly used technical term. Examiners reward understanding, not vocabulary for its own sake.',
      },
      {
        id: 'y8t2-m11-q5',
        question: 'What does it mean when iambic pentameter breaks down in a Shakespeare play?',
        options: [
          'The printer made an error',
          "It signals the character's loss of emotional or psychological control",
          'The scene is meant to be funny',
          'The character is speaking to a servant',
        ],
        correct: 1,
        explanation:
          "Iambic pentameter represents order and control. When the rhythm breaks down, it signals that the character's mental or emotional state is fracturing - a deliberate choice by Shakespeare to mirror inner turmoil.",
      },
    ],
  },
...
<div class="common-mistake"><strong>Common Mistake:</strong> Rushing through the assessment without planning. Five minutes of planning saves fifteen minutes of unfocused writing. Always plan before you write.</div>`,
    quiz: [
      {
        id: 'y8t2-m12-q1',
        question: 'How should you spend the first 3-4 minutes of a poetry comparison assessment?',
        options: [
          'Writing your introduction immediately',
          'Planning - identifying points of comparison, key quotations, and comparative links',
          'Reading the poems once quickly',
          'Writing your conclusion first',
        ],
        correct: 1,
        explanation:
          'Spending 3-4 minutes planning prevents you from losing direction mid-essay. Identify your points of comparison, note key quotations, and plan your comparative links before writing.',
      },
      {
        id: 'y8t2-m12-q2',
        question: 'What must every body paragraph in a poetry comparison contain?',
        options: [
          'Three quotations from the same poem',
          'References to and analysis of both poems',
          'A biographical fact about each poet',
          'A definition of a literary term',
        ],
        correct: 1,
        explanation:
          'Every body paragraph must discuss both poems with analysis and quotations from each. Writing about one poem at a time is not genuine comparison.',
      },
      {
        id: 'y8t2-m12-q3',
        question:
          'When analysing a Shakespeare extract, what should you consider beyond the language?',
        options: [
          'The font size of the text',
          'How the extract would be performed on stage - stagecraft, acting, audience response',
          'How many lines the extract contains',
          'The other plays Shakespeare wrote that year',
        ],
        correct: 1,
        explanation:
          "You should consider how the extract would look and sound in performance: the actor's delivery, movement, proxemics, lighting, and the audience's response. This shows you understand Macbeth as theatre.",
      },
      {
        id: 'y8t2-m12-q4',
        question: 'What is the difference between paraphrasing and analysing Shakespeare?',
        options: [
          'There is no difference',
          'Paraphrasing translates the meaning; analysis explains the effect of the language choices',
          'Analysis is shorter than paraphrasing',
          'Paraphrasing is more accurate',
        ],
        correct: 1,
        explanation:
          'Paraphrasing merely translates Shakespeare into modern English. Analysis goes further - it explains WHY Shakespeare chose those specific words, images, and structures, and what effect they have on the audience.',
      },
      {
        id: 'y8t2-m12-q5',
        question:
          'According to the self-assessment checklist, what should your thesis statement do?',
        options: [
          'Summarise both poems in detail',
          'Make an arguable claim, not just a description',
          'List all the techniques you will discuss',
          'Quote the first line of each poem',
        ],
        correct: 1,
        explanation:
          'A thesis must make an arguable claim - a specific point about how or why the poems approach the same theme differently. "Both poems are about war" is a description; a thesis argues something about that shared subject.',
      },
    ],
  },
]
