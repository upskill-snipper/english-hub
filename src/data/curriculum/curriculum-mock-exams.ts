...
const Y7_T3_POEM_A_SOURCE = 'Stephen Spender, "My Parents"'
...
const Y7_T3_POEM_B_SOURCE = 'John Agard, "Half-Caste" (extract)'
...
const Y9_T3_OMAM_EXTRACT_SOURCE = 'Adapted from John Steinbeck, Of Mice and Men (1937)'
...
const y7Assessments: CurriculumAssessment[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Perceptive, conceptualised analysis with sophisticated language use; assured creative writing with a distinctive voice and deliberate craft.', markRange: '33-40' },
      { grade: 'Expected', description: 'Clear, developed analysis with relevant textual support; effective creative writing with conscious use of techniques.', markRange: '24-32' },
      { grade: 'Working Towards', description: 'Some relevant comments with basic textual reference; narrative writing with some conscious choices.', markRange: '15-23' },
      { grade: 'Below Expected', description: 'Limited response with minimal textual engagement; simple narrative with limited technique.', markRange: '0-14' },
    ],
    modelAnswers: {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      {
        ...
        description: 'Complete the reflective writing task below. You will have 30 minutes for this section.',
        totalMarks: 25,
      ...
      },
      {
        ...
        description: 'Prepare and deliver a 2-3 minute spoken presentation based on your reflective writing. You will have 20 minutes to prepare, then present to your class.',
        totalMarks: 15,
        suggestedTimeMinutes: 20,
        questions: [
          {
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Assured, distinctive reflective voice with conceptual depth; confident, engaging spoken presentation with sophisticated rhetorical awareness.', markRange: '33-40' },
      { grade: 'Expected', description: 'Clear, personal reflective writing with effective language choices; competent spoken presentation with conscious engagement techniques.', markRange: '24-32' },
      { grade: 'Working Towards', description: 'Some personal reflection with basic detail; spoken presentation delivered with some confidence.', markRange: '15-23' },
      { grade: 'Below Expected', description: 'Limited reflection with minimal personal engagement; hesitant spoken delivery with little audience awareness.', markRange: '0-14' },
    ],
    modelAnswers: {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      {
        ...
        description: 'Choose ONE of the following tasks. You have 45 minutes including planning time.',
        totalMarks: 40,
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Assured, compelling writing with a distinctive voice; sophisticated control of language and structure; genuine moral complexity.', markRange: '33-40' },
      { grade: 'Expected', description: 'Effective creative writing with a clear character voice; conscious use of techniques and diary conventions; some depth of reflection.', markRange: '24-32' },
      { grade: 'Working Towards', description: 'Basic diary entry with some character voice; describes events with some personal response; limited range of techniques.', markRange: '15-23' },
      { grade: 'Below Expected', description: 'Simple recount with minimal diary conventions; limited character voice and basic vocabulary.', markRange: '0-14' },
    ],
    modelAnswers: {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      {
        ...
        description: 'Read the poem below. Prepare discussion notes that demonstrate your understanding of the poem and develop thoughtful discussion questions.',
        totalMarks: 15,
        suggestedTimeMinutes: 20,
        questions: [
          {
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Perceptive analysis with layered interpretations; sophisticated discussion questions that probe the poem\'s ambiguities.', markRange: '29-35' },
      { grade: 'Expected', description: 'Clear analysis with well-selected evidence; thoughtful discussion questions that go beyond surface meaning.', markRange: '21-28' },
      { grade: 'Working Towards', description: 'Some relevant analysis with basic evidence; discussion questions that address the poem\'s content.', markRange: '13-20' },
      { grade: 'Below Expected', description: 'Limited analysis with minimal evidence; simple or closed discussion questions.', markRange: '0-12' },
    ],
    modelAnswers: {
      'Overall Greater Depth': 'See individual section model answers at Greater Depth level.',
    },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
        ...
        questions: [
          {
            id: 'y7-t3-2-q1',
            questionNumber: 1,
            questionText: 'Compare how the poets present the theme of identity and belonging in "My Parents" by Stephen Spender and the extract from "Half-Caste" by John Agard.\n\nYou should compare:\n- the ideas and attitudes in each poem\n- the poets\' use of language and form\n- the effects on the reader.\n\nRemember to write about BOTH poems throughout your response.',
            marks: 40,
            suggestedTimeMinutes: 50,
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Perceptive, sustained comparison with sophisticated analysis of both poems; conceptualised understanding of how form and language create meaning.', markRange: '33-40' },
      { grade: 'Expected', description: 'Clear, comparative response with relevant analysis of both poems throughout; comments on language and form with some insight.', markRange: '24-32' },
      { grade: 'Working Towards', description: 'Some comparison between the poems with basic analysis; tends to write about poems separately rather than comparatively.', markRange: '15-23' },
      { grade: 'Below Expected', description: 'Limited comparison with minimal analysis; writes about one poem much more than the other.', markRange: '0-14' },
    ],
    modelAnswers: {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
        ...
        questions: [
          {
            id: 'y7-eoy-q1',
            questionNumber: 1,
            questionText: 'How does the writer use language to present Kofi\'s feelings about his new school?\n\nYou should consider the writer\'s choice of words, phrases, and language techniques.',
            marks: 15,
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Perceptive, conceptualised analysis across both reading questions; assured, distinctive creative or reflective writing.', markRange: '41-50' },
      { grade: 'Expected', description: 'Clear, developed analysis with well-selected evidence; effective writing with conscious craft.', markRange: '30-40' },
      { grade: 'Working Towards', description: 'Some relevant analysis with basic evidence; writing shows some awareness of technique.', markRange: '19-29' },
      { grade: 'Below Expected', description: 'Limited analysis with minimal evidence; basic writing with limited range.', markRange: '0-18' },
    ],
    modelAnswers: {
      'Overall Greater Depth': 'See individual section model answers at Greater Depth level.',
    },
...
const y8Assessments: CurriculumAssessment[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      {
        ...
        description: 'Read the extract below carefully, then write a full analytical essay in response to the question.',
        totalMarks: 40,
        suggestedTimeMinutes: 50,
        questions: [
          {
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Perceptive, conceptualised essay with sophisticated analysis of how power operates through language, structure, and social systems.', markRange: '33-40' },
      { grade: 'Expected', description: 'Clear, developed essay with relevant analysis and engagement with multiple forms of inequality.', markRange: '24-32' },
      { grade: 'Working Towards', description: 'Some relevant analysis with basic identification of power dynamics; essay structure attempted.', markRange: '15-23' },
      { grade: 'Below Expected', description: 'Limited response with minimal analysis; little engagement with the theme of power.', markRange: '0-14' },
    ],
    modelAnswers: {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      {
        ...
        description: 'Read both poems carefully, then write a comparative essay in response to the question below.',
        totalMarks: 40,
        suggestedTimeMinutes: 50,
        questions: [
          {
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Perceptive, conceptualised comparison with original argument; sophisticated analysis of how language and form create meaning in both poems.', markRange: '33-40' },
      { grade: 'Expected', description: 'Clear, sustained comparison with relevant analysis of both poems; comments on language and form with developing insight.', markRange: '24-32' },
      { grade: 'Working Towards', description: 'Some comparison with basic analysis; may discuss poems separately or unevenly.', markRange: '15-23' },
      { grade: 'Below Expected', description: 'Limited comparison; writes about one poem much more than the other; minimal analysis.', markRange: '0-14' },
    ],
    modelAnswers: {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      {
        ...
        description: 'Read the extract from The Tempest below, then answer the question that follows.',
        totalMarks: 40,
        suggestedTimeMinutes: 50,
        questions: [
          {
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Perceptive, conceptualised response with sophisticated language analysis and assured connection to the wider play; engages with context with originality.', markRange: '33-40' },
      { grade: 'Expected', description: 'Clear, developed response with relevant analysis of the extract and connections to the wider play; some contextual awareness.', markRange: '24-32' },
      { grade: 'Working Towards', description: 'Some relevant analysis of the extract with basic comments on the wider play; limited contextual engagement.', markRange: '15-23' },
      { grade: 'Below Expected', description: 'Limited analysis with minimal reference to the extract or wider play; descriptive rather than analytical.', markRange: '0-14' },
    ],
    modelAnswers: {
      'Greater Depth': 'See main question model answer at Greater Depth level.',
    },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: 'Deliver your speech to the class. You will be assessed on your spoken performance.',
        totalMarks: 15,
        suggestedTimeMinutes: 20,
        questions: [
          {
            id: 'y8-t3-1-q2',
            questionNumber: 2,
            questionText: 'Deliver your speech to the class (2-4 minutes).\n\nYou will be assessed on:\n- confidence and clarity of delivery\n- use of vocal techniques (pace, pause, emphasis, tone)\n- audience engagement (eye contact, gesture, responsiveness)\n- overall persuasive impact.',
            marks: 15,
            suggestedTimeMinutes: 20,
            questionType: 'spoken-presentation',
            modelAnswers: {
              'Working Towards': 'Delivers speech audibly with some confidence. Reads from notes for most of the delivery. Some variation in tone. Limited eye contact and gesture. Message is clear but delivery is hesitant.',
              'Expected': 'Delivers speech with sustained confidence and clear projection. Varies pace and tone deliberately — pauses for effect, emphasises key words. Makes regular eye contact with different audience members. Uses some gesture. Rarely refers to notes. Persuasive intent is clear and largely achieved.',
              'Greater Depth': 'Delivers with commanding confidence and natural authority. Vocal variety is sophisticated — uses pause, emphasis, pace changes, and tonal shifts to create genuine persuasive impact. Eye contact is sustained and inclusive. Gestures feel natural and reinforce meaning. Responds to audience reactions. The delivery enhances the written content, creating a performance that is more persuasive than the text alone.',
            },
            markScheme: [
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Compelling, sophisticated speech with assured rhetorical control; commanding delivery that enhances the written content.', markRange: '33-40' },
      { grade: 'Expected', description: 'Clear, persuasive speech with effective rhetorical techniques; confident delivery with some vocal variety.', markRange: '24-32' },
      { grade: 'Working Towards', description: 'Basic persuasive speech with some rhetorical awareness; audible delivery with limited vocal variety.', markRange: '15-23' },
      { grade: 'Below Expected', description: 'Limited persuasive writing with few rhetorical techniques; hesitant delivery with minimal audience engagement.', markRange: '0-14' },
    ],
    modelAnswers: {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      {
        ...
        description: 'You are creating a media campaign to raise awareness about an issue that matters to you. Complete the written components below.',
        totalMarks: 30,
        suggestedTimeMinutes: 45,
        questions: [
          {
        ...
        questions: [
          {
            id: 'y8-t3-2-q2',
            questionNumber: 2,
            questionText: 'Deliver a 2-minute pitch presenting your campaign concept to the class. Explain:\n- what issue your campaign addresses and why it matters\n- who your target audience is\n- what media formats you would use and why\n- what you want your audience to DO as a result of your campaign.',
            marks: 10,
            suggestedTimeMinutes: 15,
            questionType: 'spoken-presentation',
            modelAnswers: {
              'Working Towards': 'Presents campaign idea with some clarity. Identifies the issue and target audience. Limited explanation of media choices. Some audience engagement.',
              'Expected': 'Presents campaign with confidence and clarity. Clearly explains the issue, audience, and media strategy. Justifies choices with reasoning. Engages audience through eye contact and enthusiastic delivery. Demonstrates understanding of how different media formats reach different audiences.',
              'Greater Depth': 'Delivers a polished, professional pitch with commanding confidence. Demonstrates sophisticated understanding of media strategy and audience targeting. Justifies every creative decision with clear reasoning. Responds to questions with authority. The pitch itself demonstrates the persuasive skills the campaign would deploy.',
            },
            markScheme: [
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Sophisticated media awareness with compelling, original content across formats; polished pitch with professional delivery.', markRange: '33-40' },
      { grade: 'Expected', description: 'Effective campaign content adapted for different formats and audiences; confident pitch with clear reasoning.', markRange: '24-32' },
      { grade: 'Working Towards', description: 'Basic campaign content with some format awareness; pitch covers main points but limited justification.', markRange: '15-23' },
      { grade: 'Below Expected', description: 'Limited media awareness; content does not effectively adapt to format; hesitant pitch.', markRange: '0-14' },
    ],
    modelAnswers: {
      'Greater Depth': 'See individual section model answers at Greater Depth level.',
    },
...
const y9Assessments: CurriculumAssessment[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      {
        ...
        description: 'Read the extract from A Christmas Carol below, then answer the question that follows.',
        totalMarks: 40,
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Perceptive, conceptualised response with sophisticated language analysis; assured engagement with Victorian context; original interpretive argument.', markRange: '33-40' },
      { grade: 'Expected', description: 'Clear, developed response with relevant analysis of extract and wider text; some contextual understanding; academic register.', markRange: '24-32' },
      { grade: 'Working Towards', description: 'Some relevant analysis with basic textual references; limited connection to wider text; basic contextual awareness.', markRange: '15-23' },
      { grade: 'Below Expected', description: 'Limited response with minimal analysis; largely narrative or descriptive; little contextual engagement.', markRange: '0-14' },
    ],
    modelAnswers: {
      'Greater Depth': 'See main question model answer at Greater Depth level.',
    },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
        ...
        questions: [
          {
            id: 'y9-t2-q2',
            questionNumber: 2,
            questionText: 'In a 2-minute spoken presentation, explain and justify the creative choices you made in your writing.\n\nYou should discuss:\n- why you chose that particular task and what you were trying to achieve\n- specific language or structural choices you made and their intended effects\n- what writers or texts influenced your approach\n- what you would change or develop if you had more time.',
            marks: 10,
            suggestedTimeMinutes: 15,
            questionType: 'spoken-presentation',
            modelAnswers: {
              'Working Towards': 'Identifies some choices made in the writing. Limited explanation of intended effects. May focus on content rather than craft. Some confidence in delivery.',
              'Expected': 'Clearly explains specific creative choices with reference to intended effects. Identifies at least two language or structural decisions and explains why they were made. References at least one literary influence. Reflects honestly on strengths and areas for improvement. Delivered with confidence.',
              'Greater Depth': 'Articulates creative choices with sophisticated metalinguistic awareness. Explains how specific techniques create specific effects with precision. Draws meaningful connections to literary influences. Demonstrates genuine critical self-reflection — honest about what works and what does not. Delivery is natural, assured, and intellectually engaging.',
            },
            markScheme: [
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Assured, original creative writing with distinctive voice and sophisticated craft; articulate spoken justification with genuine critical self-awareness.', markRange: '41-50' },
      { grade: 'Expected', description: 'Effective creative writing with conscious technique and engaging content; clear spoken justification of choices.', markRange: '30-40' },
      { grade: 'Working Towards', description: 'Some creative writing with basic awareness of technique; limited spoken justification.', markRange: '19-29' },
      { grade: 'Below Expected', description: 'Simple narrative with limited technique; minimal spoken justification.', markRange: '0-18' },
    ],
    modelAnswers: {
      'Greater Depth': 'See individual section model answers at Greater Depth level.',
    },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Perceptive literature essay with sophisticated analysis and contextual engagement; compelling transactional writing with confident journalistic register.', markRange: '41-50' },
      { grade: 'Expected', description: 'Clear literature essay with relevant analysis and some context; effective transactional writing with appropriate register.', markRange: '30-40' },
      { grade: 'Working Towards', description: 'Some relevant literature analysis; basic transactional writing with limited register awareness.', markRange: '19-29' },
      { grade: 'Below Expected', description: 'Limited literature response; simple transactional writing with minimal persuasive technique.', markRange: '0-18' },
    ],
    modelAnswers: {
      'Greater Depth': 'See individual section model answers at Greater Depth level.',
    },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            id: 'y9-eoy-q2',
            questionNumber: 2,
            questionText: 'How does the writer structure the extract to develop the reader\'s understanding of Mary\'s situation?\n\nConsider how the focus shifts between paragraphs and the effect of the ending.',
            marks: 16,
            suggestedTimeMinutes: 20,
            questionType: 'analytical-response',
            extract: Y8_T1_EXTRACT,
    ...
    gradeDescriptors: [
      { grade: 'Greater Depth', description: 'Perceptive reading analysis with conceptualised argument; assured writing with distinctive voice, sophisticated craft, and technical precision.', markRange: '49-60' },
      { grade: 'Expected', description: 'Clear, developed reading analysis with relevant evidence; effective writing with conscious technique and mostly accurate spelling/punctuation.', markRange: '36-48' },
      { grade: 'Working Towards', description: 'Some relevant reading analysis with basic evidence; writing shows some awareness of technique with reasonable accuracy.', markRange: '23-35' },
      { grade: 'Below Expected', description: 'Limited reading response; basic writing with limited technique and frequent errors.', markRange: '0-22' },
    ],
    modelAnswers: {
      'Greater Depth': 'See individual section model answers at Greater Depth level.',
    },
