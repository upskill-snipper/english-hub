...
<p>Section A tests three Assessment Objectives across five questions of increasing difficulty and mark value:</p>

<table>
  <tr><th>Question</th><th>Task</th><th>Marks</th><th>AO</th><th>Suggested Time</th></tr>
  <tr><td>Q1</td><td>Select two words or phrases from specified lines</td><td>2</td><td>AO1</td><td>3 minutes</td></tr>
  <tr><td>Q2</td><td>Explain the writer's thoughts and feelings in your own words</td><td>4</td><td>AO1</td><td>5 minutes</td></tr>
  <tr><td>Q3</td><td>Describe a given topic using brief quotations</td><td>5</td><td>AO1</td><td>7 minutes</td></tr>
  <tr><td>Q4</td><td>Analyse how the writer uses language and structure for effect</td><td>12</td><td>AO2</td><td>15 minutes</td></tr>
  <tr><td>Q5</td><td>Compare how both writers present their ideas and perspectives</td><td>22</td><td>AO3</td><td>30 minutes</td></tr>
</table>

<p>Notice the steep escalation in marks: Questions 1 to 3 together total only 11 marks, while Question 5 alone is worth 22 marks. This is critical for your timing strategy. Many students spend too long on the early questions and then rush the comparison, which is where most marks are available.</p>

<div class="examiner-tip"><strong>Examiner Tip:</strong> The golden rule of Paper 1 timing is to spend time proportional to marks. Questions 1 to 3 should take no more than 15 minutes combined. Question 4 deserves about 15 minutes. Question 5 demands at least 30 minutes. That leaves approximately 60 minutes for Section B writing and 5 to 10 minutes for checking.</div>

<h3>Section B: Transactional Writing Mark Breakdown</h3>
...
<div class="common-mistake"><strong>Common Mistake:</strong> Students often treat Section B as an afterthought, spending 80 minutes on Section A and only 30 minutes on writing. Since both sections are worth 45 marks, this is a serious strategic error. You must protect at least 55 to 60 minutes for your transactional writing task, including 5 minutes for planning and 5 minutes for proofreading.</div>

<h3>Assessment Objectives for Paper 1</h3>
...
<p>The two unseen texts can be drawn from a wide pool. Edexcel has used the following types in past papers and specimen materials:</p>

<ul>
  <li>Newspaper and magazine articles (editorials, features, opinion pieces)</li>
  <li>Travel writing and exploration accounts</li>
  <li>Autobiography and memoir extracts</li>
  <li>Diary and journal entries</li>
  <li>Published letters (both formal and personal)</li>
  <li>Speech transcripts</li>
  <li>Essays and blog posts</li>
  <li>19th-century non-fiction (e.g. Darwin, Dickens, Nightingale)</li>
</ul>
...
<p>Here is a recommended minute-by-minute breakdown for the 135-minute paper:</p>

<ol>
  <li><strong>Minutes 0-5:</strong> Read both texts carefully, underlining key words and phrases. Do not rush this step. A thorough first reading saves time later.</li>
  <li><strong>Minutes 5-8:</strong> Answer Question 1 (2 marks). Select two precise words or phrases. No explanation needed.</li>
  <li><strong>Minutes 8-13:</strong> Answer Question 2 (4 marks). Explain the writer's thoughts and feelings in your own words.</li>
  <li><strong>Minutes 13-20:</strong> Answer Question 3 (5 marks). Describe the topic with brief supporting quotations.</li>
  <li><strong>Minutes 20-35:</strong> Answer Question 4 (12 marks). Analyse language and structure with embedded quotations and terminology.</li>
  <li><strong>Minutes 35-65:</strong> Answer Question 5 (22 marks). Write a sustained comparative response covering both texts.</li>
  <li><strong>Minutes 65-70:</strong> Plan your Section B writing response. Choose your task, decide your angle, plan your paragraphs.</li>
  <li><strong>Minutes 70-125:</strong> Write your Section B transactional piece (approximately 350 to 450 words).</li>
  <li><strong>Minutes 125-135:</strong> Proofread everything. Check spelling, punctuation, and that you have answered every part of every question.</li>
</ol>

<div class="examiner-tip"><strong>Examiner Tip:</strong> Examiners report that the most common reason students underperform on Paper 1 is poor time management. They spend too long on low-tariff questions and rush the high-tariff ones. Practise timed papers repeatedly until the timing plan becomes instinctive. In the real exam, wear a watch and monitor your progress at each stage.</div>

<h3>Grade Descriptors: What Does a Top-Band Response Look Like?</h3>

<p>For Section A, top-band responses demonstrate: precise selection of evidence, detailed and perceptive analysis using accurate terminology, a clear understanding of the writer's methods and their effects on the reader, and sustained comparison with fully integrated references to both texts. For Section B, top-band responses show: a convincing and compelling voice matched to the specified audience and purpose, a well-structured response with effective discourse markers and paragraphing, a wide range of ambitious vocabulary, varied and controlled sentence structures, and consistently accurate spelling and punctuation.</p>
`,
    quiz: [
      {
        id: 'y10-p1-m1-q1',
      ...
      {
        id: 'y10-p1-m1-q2',
        question: 'Which question in Section A carries the most marks?',
        options: [
          'Question 3 (5 marks)',
          'Question 4 (12 marks)',
          'Question 5 (22 marks)',
      ...
      {
        id: 'y10-p1-m1-q3',
        question: 'How are the 45 marks in Section B divided between Assessment Objectives?',
        options: [
          'AO1: 27 marks, AO2: 18 marks',
          'AO4: 27 marks, AO5: 18 marks',
          'AO4: 22 marks, AO5: 23 marks',
      ...
      {
        id: 'y10-p1-m1-q4',
        question: 'How many transactional writing tasks must you complete in Section B?',
        options: [
          'One task (chosen from two options)',
          'Two tasks (both compulsory)',
          'One task (no choice)',
...
<ul>
  ...
  <li>Copying too much text instead of selecting precise words or short phrases</li>
  <li>Selecting only one item when two are required</li>
  <li>Misreading the focus of the question (e.g. the question asks for words describing the setting, but the student selects words about a character)</li>
</ul>

<div class="examiner-tip"><strong>Examiner Tip:</strong> For Question 1, do not overthink it. Read the specified lines, identify exactly what the question is asking for, and copy the relevant words or phrases precisely. There is no need to write in full sentences. A bullet-point format works perfectly: one bullet for each selection.</div>
...
<h3>Practice: Question 2 Technique</h3>

<p>Imagine a text in which a Victorian explorer describes crossing a desert. The text says: <em>"The heat was insufferable, pressing down upon us like a physical weight. I found myself questioning the wisdom of our enterprise, yet the thought of the undiscovered territory ahead drove me onward with a stubborn, perhaps foolish, determination."</em></p>

<p>A strong Question 2 response would be:</p>
...
<p>Embedding quotations means weaving them into your own sentences rather than presenting them as standalone chunks. This is a crucial skill for Q3 and will also serve you well in Q4 and Q5. Compare these two approaches:</p>

<p><strong>Weak (standalone quotation):</strong> The writer describes the town. "The houses are tall, with their balconies painted in the gayest colours."</p>

<p><strong>Strong (embedded quotation):</strong> The writer presents the town as visually striking, noting that the houses are "tall" with balconies in "the gayest colours," which creates a sense of vibrancy and exoticism.</p>

<p>The embedded version integrates the quotation into the student's own sentence, demonstrating control and understanding. This technique will be essential throughout your exam.</p>

<h3>Inference vs. Retrieval</h3>

<p>While Questions 1 to 3 primarily test retrieval, some sub-parts may require simple inference. Understanding the difference is important:</p>

<ul>
  <li><strong>Retrieval:</strong> The information is explicitly stated. "The writer says the forest was dark." You can point to the exact words.</li>
  <li><strong>Inference:</strong> The information is implied. The text says "She clutched the letter to her chest and closed her eyes." You infer that she feels emotionally affected by its contents, even though the text does not state this directly.</li>
</ul>
...
<ul>
  <li><strong>Pitfall 1: Answering from the wrong text.</strong> The paper contains two texts. Make sure you read the question carefully to identify which text is being referenced. Questions 1 to 4 typically focus on individual texts, while Question 5 uses both.</li>
  <li><strong>Pitfall 2: Repeating the same point in different words.</strong> The examiner awards marks for distinct points. If your second point is a rephrasing of your first, you will only receive one mark.</li>
  <li><strong>Pitfall 3: Including analysis in Q1 to Q3.</strong> These questions do not reward analysis of language effects. Save your analytical skills for Q4. In Q1 to Q3, focus on what the writer says, not how they say it.</li>
  <li><strong>Pitfall 4: Not reading the line references.</strong> If the question says "from lines 5 to 12," your answer must come from those lines. Information from other parts of the text will not be credited.</li>
</ul>
`,
    quiz: [
      {
        id: 'y10-p1-m2-q1',
        question: 'What does AO1 primarily test?',
        options: [
      ...
      {
        id: 'y10-p1-m2-q2',
        question: 'Why is it important to use your own words in Question 2?',
        options: [
      ...
      {
        id: 'y10-p1-m2-q3',
        question: 'What is the best approach to quotations in Question 3?',
        options: [
          'Quote entire sentences to show thorough reading',
          'Avoid quotations entirely and paraphrase instead',
          'Use brief, embedded quotations of two to five words within your own sentences',
      ...
      },
      {
        ...
        options: [
          ...
          'The answer will not be credited because it comes from outside the specified lines',
...
<p>Question 4 typically takes the form: <em>"Analyse how the writer uses language and structure to [achieve a particular effect] in [specified lines]."</em> For example: "Analyse how the writer uses language and structure to convey the excitement of the journey in lines 8 to 24." The question always specifies the focus (what you should analyse) and the line range (where to look).</p>

<h3>The Three-Part Analytical Framework</h3>

<p>Every analytical paragraph in your Q4 response should follow this framework:</p>

<ol>
  <li><strong>Identify and Quote:</strong> Select a specific word, phrase, or technique from the text. Embed a brief quotation in your sentence.</li>
  <li><strong>Name the Technique:</strong> If applicable, identify the language technique using correct terminology (e.g. metaphor, simile, personification, sibilance, hyperbole, rhetorical question).</li>
  <li><strong>Explain the Effect:</strong> Analyse what effect this language choice has on the reader. Consider the connotations of individual words, the emotional impact, the imagery created, and how it serves the writer's purpose.</li>
</ol>

<p>This framework is sometimes called <strong>PEE</strong> (Point, Evidence, Explanation) or <strong>What-How-Why</strong>. Regardless of the label, the principle is the same: identify, quote, and explain the effect.</p>

<h3>Essential Language Techniques for Paper 1</h3>

<p>You must be able to identify and analyse the following techniques confidently. Each one frequently appears in non-fiction texts:</p>

<h4>Imagery Techniques</h4>
<ul>
  <li><strong>Simile:</strong> A comparison using "like" or "as." Creates a vivid picture by linking two things. E.g. "The fog crept in like a thief" suggests stealth and menace.</li>
  <li><strong>Metaphor:</strong> A direct comparison stating one thing is another. E.g. "The city was a furnace" implies extreme, oppressive heat without hedging.</li>
  <li><strong>Personification:</strong> Giving human qualities to non-human things. E.g. "The wind howled in protest" creates atmosphere and suggests hostility.</li>
  <li><strong>Sensory language:</strong> Words that appeal to the five senses (sight, sound, smell, taste, touch). Non-fiction writers use this to immerse the reader in the experience.</li>
</ul>

<h4>Sound and Rhythm Techniques</h4>
<ul>
...
<div class="examiner-tip"><strong>Examiner Tip:</strong> Technique-spotting alone does not earn high marks. The mark scheme distinguishes between students who merely identify techniques ("The writer uses a metaphor") and those who explain the effect ("The metaphor of the city as a 'furnace' implies that the heat is not merely uncomfortable but inescapable and oppressive, trapping the inhabitants"). Always prioritise explanation of effect over identification of technique.</div>

<h3>Analysing Word-Level Choices (Connotation)</h3>

<p>Some of the most perceptive analysis comes not from spotting named techniques but from exploring the connotations of individual word choices. Consider this sentence from a travel article: <em>"The mountain loomed above us, its shadow swallowing the valley."</em></p>

<p>A technique-spotting response might say: "The writer uses personification." A perceptive response would dig deeper:</p>

<div class="model-answer"><strong>Model Answer:</strong> The verb "loomed" suggests the mountain is not merely large but imposing and threatening, as the word carries connotations of something ominous encroaching on the observer. The verb "swallowing" extends the personification by implying the mountain is consuming the valley, creating a sense that nature is predatory and overwhelming. The combination of "loomed" and "swallowing" positions the travellers as small and vulnerable against a landscape presented as actively hostile.</div>

<p>This response analyses specific word choices, explains their connotations, and links them to the writer's overall purpose. This is the level of detail that earns marks in the top band.</p>

<h3>Analysing Structure in Question 4</h3>

<p>Many students focus exclusively on language in Q4 and forget that the question also asks about <strong>structure</strong>. Structural features to consider include:</p>

<ul>
  <li><strong>Sentence length variation:</strong> Short sentences for impact; long sentences for description or building tension.</li>
  <li><strong>Paragraph structure:</strong> Short paragraphs can create pace; longer paragraphs can build atmosphere.</li>
  <li><strong>Opening and closing:</strong> How does the writer begin and end the extract? Is there a shift in tone?</li>
  <li><strong>Focus shifts:</strong> Does the writer move from wide-angle description to close-up detail? From external observation to internal reflection?</li>
  <li><strong>Chronological or non-chronological organisation:</strong> Does the writer use flashback, foreshadowing, or cyclical structure?</li>
  <li><strong>Lists and accumulation:</strong> Listing details can create a sense of abundance, chaos, or overwhelming sensation.</li>
</ul>

<div class="common-mistake"><strong>Common Mistake:</strong> Students often write about structure in vague terms: "The writer uses short sentences for effect." This is too generic. Specify which short sentence, where it appears, and what specific effect it creates in that context. For example: "The single-word sentence 'Silence' at the end of the paragraph creates a dramatic pause after the chaos of the preceding description, forcing the reader to experience the sudden stillness alongside the writer."</div>

<h3>How Many Points Should You Make?</h3>

<p>For a 12-mark question with approximately 15 minutes of writing time, aim for <strong>three to four well-developed analytical paragraphs</strong>. Each paragraph should contain a quotation, identification of technique or word-level analysis, and a detailed explanation of effect. Three excellent paragraphs will score higher than six superficial ones. Depth always beats breadth in analytical questions.</p>
`,
    quiz: [
      {
        id: 'y10-p1-m3-q1',
        question: 'What is the key difference between AO1 (tested in Q1-3) and AO2 (tested in Q4)?',
        options: [
          'AO1 requires quotations; AO2 does not',
          'AO1 tests what the text says; AO2 tests how the text says it',
          'AO1 is for fiction; AO2 is for non-fiction',
      ...
      },
      {
        ...
        options: [
          ...
          'An explanation of the effect the metaphor has on the reader',
      ...
      {
        id: 'y10-p1-m3-q3',
        question: 'What does "connotation" mean in the context of language analysis?',
        options: [
          'The dictionary definition of a word',
          'The associations, implications, and emotional overtones a word carries beyond its literal meaning',
          'A type of figurative language similar to metaphor',
      ...
      },
      {
        ...
        options: [
          ...
          'The use of emotive vocabulary like "devastating"',
...
<p>Understanding what the examiner is looking for at each level helps you target the top band. The Q4 mark scheme broadly follows this structure:</p>

<ul>
  <li><strong>Band 1 (1-3 marks):</strong> Simple, limited comments. May identify a feature but with no explanation of effect. May paraphrase rather than analyse. Little or no use of terminology.</li>
  <li><strong>Band 2 (4-6 marks):</strong> Some relevant comments on language and/or structure. Attempts to explain effects but explanations may be generic or underdeveloped. Some appropriate use of terminology.</li>
  <li><strong>Band 3 (7-9 marks):</strong> Clear, relevant analysis of language and structure. Effects are explained with some detail and accuracy. Appropriate terminology used confidently. Quotations are well-selected.</li>
  <li><strong>Band 4 (10-12 marks):</strong> Perceptive, detailed analysis of both language and structure. Effects are explained convincingly with sophisticated understanding. Terminology is precise and integrated. Analysis explores layers of meaning and considers how choices contribute to the writer's overall purpose.</li>
</ul>

<h3>Moving from Band 2 to Band 4: The Effect Ladder</h3>

<p>Consider this extract from a non-fiction account of a storm at sea: <em>"The waves reared up like monstrous hands, clawing at the hull. Every timber groaned. The ship shuddered, and for a moment the whole world tilted sideways."</em></p>

<p>Here is how responses at different levels might analyse the simile:</p>

<p><strong>Band 2 response:</strong> "The writer uses a simile, 'like monstrous hands,' to describe the waves. This makes the waves sound scary."</p>
...
<p>Non-fiction writers carefully control their tone (the attitude conveyed through their writing) and register (the level of formality). Identifying shifts in tone is a high-level analytical skill that examiners reward. Consider these tonal qualities:</p>

<ul>
  <li><strong>Authoritative:</strong> Confident, assertive language that establishes the writer as knowledgeable. Creates trust in the reader.</li>
  <li><strong>Conversational:</strong> Informal, chatty language that creates a sense of intimacy or accessibility. Often uses contractions and direct address.</li>
  <li><strong>Sardonic or ironic:</strong> Saying the opposite of what is meant, or using understated humour to criticise. Creates a sense of intellectual superiority or detachment.</li>
  <li><strong>Emotive:</strong> Language designed to provoke strong feelings. Creates sympathy, outrage, or urgency in the reader.</li>
  <li><strong>Reflective:</strong> Thoughtful, contemplative language that considers experience in hindsight. Creates a sense of maturity and wisdom.</li>
</ul>

<h3>Analysing How Writers Build Atmosphere</h3>

<p>Non-fiction writers, particularly travel writers and memoirists, use language to create a strong sense of place. To analyse atmosphere effectively, consider how the writer uses:</p>

<ul>
  <li><strong>Sensory details:</strong> What can the reader see, hear, smell, taste, and feel? The more senses engaged, the more immersive the atmosphere.</li>
  <li><strong>Colour and light:</strong> Bright colours suggest energy or beauty; dark or muted colours suggest gloom, menace, or decay.</li>
  <li><strong>Pace:</strong> Long, flowing sentences create a slow, relaxed pace; short, abrupt sentences create tension or urgency.</li>
...
<p>After writing any analytical point, apply the "So what?" test. If your analysis could apply to any text in any context, it is too generic. Consider:</p>

<p><strong>Too generic:</strong> "The writer uses emotive language to make the reader feel sympathy." (This could apply to thousands of texts.)</p>

<p><strong>Specific and effective:</strong> "The noun 'orphans' immediately triggers the reader's protective instinct, as it implies not merely that the children are alone but that they have suffered an irreversible loss. By choosing 'orphans' rather than a neutral term such as 'children,' the writer ensures the reader sees them as victims deserving of compassion rather than as statistics in a news report."</p>

<p>The second version is anchored to the specific text, explains connotations, considers the writer's deliberate word choice, and articulates a precise effect. This is what Band 4 analysis looks like.</p>
...
<ul>
  ...
  <li>"By creating this image, the writer strengthens their case that..."</li>
  <li>"This tonal shift supports the writer's overall aim to..."</li>
</ul>

<div class="common-mistake"><strong>Common Mistake:</strong> Writing "This makes the reader want to read on" is one of the most overused and unhelpful phrases in student essays. It does not constitute genuine effect analysis. Instead, specify the effect: does the technique create tension, sympathy, admiration, disgust, curiosity, or something else entirely? Be precise about the emotional or intellectual impact.</div>
...
`,
    quiz: [
      {
        id: 'y10-p1-m4-q1',
        question: 'What is the main difference between a Band 2 and a Band 4 response in Q4?',
        options: [
          'Band 4 identifies more techniques than Band 2',
          'Band 4 uses longer quotations than Band 2',
          'Band 4 provides deeper, more precise analysis of effects with word-level exploration',
      ...
      },
      {
        ...
        options: [
          'A field of study related to grammar and syntax',
          'A group of words sharing a common theme or subject area',
          'The literal meaning of a word as found in a dictionary',
      ...
      },
      {
        ...
        options: [
          ...
          'It is too generic and does not demonstrate understanding of the specific effect',
      ...
      {
        id: 'y10-p1-m4-q5',
        question: 'What should you do after explaining the effect of a technique in Q4?',
        options: [
...
<p>The Q5 mark scheme rewards the following skills, with increasing sophistication at higher bands:</p>
...
<h3>Structuring a Q5 Response</h3>

<p>There are two effective structures for Q5, and you should practise both to see which works best for you:</p>

<h4>Structure 1: Alternating (Recommended)</h4>

<p>Each paragraph discusses both texts, alternating between them. This ensures sustained comparison:</p>

<ol>
  <li><strong>Paragraph 1:</strong> Compare the writers' overall attitudes to the topic. Writer A feels... whereas Writer B feels... Support with quotations from both texts.</li>
  <li><strong>Paragraph 2:</strong> Compare a specific aspect (e.g. how they describe the setting, how they portray people, their emotional responses). Writer A emphasises... while Writer B focuses on...</li>
  <li><strong>Paragraph 3:</strong> Compare another specific aspect. Both writers... however, Writer A takes a more... approach whereas Writer B...</li>
  <li><strong>Paragraph 4:</strong> Compare the writers' methods or tone. Writer A uses... to convey... whereas Writer B achieves a similar/different effect through...</li>
</ol>

<h4>Structure 2: Block</h4>

<p>Discuss one text fully, then the other, with explicit back-references. This is simpler but risks feeling like two separate answers:</p>

<ol>
  <li><strong>Paragraphs 1-2:</strong> Discuss Writer A's ideas, perspectives, and methods with quotations.</li>
  <li><strong>Paragraphs 3-4:</strong> Discuss Writer B, making explicit comparisons back to Writer A at every stage ("Unlike Writer A, who..." or "While Writer A focused on... Writer B instead...").</li>
</ol>

<div class="examiner-tip"><strong>Examiner Tip:</strong> The alternating structure is strongly recommended because it demonstrates sustained comparison throughout your response. Examiners report that block-structure answers often read as two separate mini-essays rather than a genuine comparison, especially when students forget to make back-references in the second half. The alternating structure forces comparison in every paragraph.</div>

<h3>Comparative Connectives and Phrases</h3>

<p>Strong comparative writing relies on a varied repertoire of linking phrases. Here are the most useful, organised by function:</p>

<h4>For Similarities</h4>
<ul>
  <li>Both writers suggest that...</li>
  <li>Similarly, Writer B also...</li>
  <li>Like Writer A, Writer B emphasises...</li>
  <li>This mirrors Writer A's view that...</li>
  <li>Writer B shares Writer A's conviction that...</li>
</ul>

<h4>For Differences</h4>
<ul>
  <li>In contrast, Writer B argues...</li>
  <li>Whereas Writer A presents X as..., Writer B portrays it as...</li>
  <li>However, Writer B takes a markedly different approach...</li>
  <li>While Writer A adopts a... tone, Writer B is more...</li>
  <li>Unlike Writer A, who focuses on..., Writer B instead emphasises...</li>
</ul>

<h4>For Nuanced Comparisons</h4>
<ul>
  <li>Although both writers acknowledge..., they differ in...</li>
  <li>Writer A and Writer B reach a similar conclusion, but through different means...</li>
  <li>On the surface, both writers agree..., yet Writer B's underlying attitude is more...</li>
</ul>

<h3>Incorporating Language Analysis into Q5</h3>
...
<h3>Dealing with 19th-Century Texts</h3>

<p>One of the two texts in Section A is often from the 19th century. Students sometimes struggle with older language, but the principles of comparison remain the same. Tips for handling 19th-century texts:</p>
...
`,
    quiz: [
      ...
      {
        id: 'y10-p1-m5-q2',
        question: 'Why is the alternating structure recommended over the block structure for Q5?',
        options: [
          'It is shorter and saves time',
          'It ensures sustained comparison throughout every paragraph',
      ...
      },
      {
        ...
        options: [
          ...
          'Discussing the historical background of both texts in detail',
      ...
      {
        id: 'y10-p1-m5-q4',
        question: 'Which comparative connective signals a contrast between two writers?',
        options: [
          '"Both writers suggest that..."',
          '"Similarly, Writer B also..."',
          '"Whereas Writer A presents X as..., Writer B portrays it as..."',
      ...
      {
        id: 'y10-p1-m5-q5',
        question: 'How should you handle unfamiliar vocabulary in a 19th-century text?',
        options: [
          'Skip the entire text and focus on the modern one',
          'Use context clues to work out meanings and focus on the surrounding language',
          'Write that you do not understand the text',
...
<h3>Crafting an Effective Headline</h3>

<p>Your headline is the first thing the examiner reads, and it sets the tone for your entire piece. Here are techniques for writing strong headlines:</p>

<ul>
  <li><strong>Alliteration:</strong> "Digital Danger: How Screens Are Sabotaging Sleep"</li>
  <li><strong>Rhetorical question:</strong> "Are We Raising a Generation of Screen Addicts?"</li>
  <li><strong>Bold statement:</strong> "Social Media Is the Biggest Threat to Teenage Mental Health"</li>
  <li><strong>Wordplay or pun:</strong> "Food for Thought: Why School Lunches Need a Revolution"</li>
  <li><strong>Imperative:</strong> "Stop Scrolling and Start Living"</li>
</ul>

<div class="examiner-tip"><strong>Examiner Tip:</strong> Do not spend more than one minute on your headline. A functional, clear headline is better than an elaborate one that wastes time. If you cannot think of something clever, a straightforward statement works fine: "The Case Against Homework" or "Why Young People Should Vote at Sixteen." The content of your article matters far more than the headline.</div>

<h3>Opening Strategies for Articles</h3>

<p>Your opening paragraph is crucial for establishing your voice and hooking the reader. Here are five proven opening strategies:</p>
...
<h3>Persuasive Techniques for Article Writing</h3>
...
<ul>
  ...
  <li><strong>Expert evidence or statistics:</strong> Even if invented for the exam (which is acceptable), these add authority: "Dr. Sarah Chen, a leading child psychologist, has warned that..."</li>
  <li><strong>Counter-argument and rebuttal:</strong> Acknowledging the opposing view and dismantling it shows intellectual maturity: "Some argue that... However, this ignores the fact that..."</li>
  <li><strong>Anecdote:</strong> A brief personal story or example to humanise your argument and make it relatable.</li>
</ul>

<div class="common-mistake"><strong>Common Mistake:</strong> Students sometimes overload their articles with persuasive devices at the expense of content. An article stuffed with rhetorical questions, emotive language, and hyperbole in every sentence reads as forced and inauthentic. The best articles balance persuasive techniques with genuine, developed arguments. Aim for two to three techniques per paragraph, integrated naturally.</div>

<h3>Discourse Markers and Paragraph Organisation</h3>

<p>Strong articles guide the reader through a logical sequence of ideas using discourse markers. These are words and phrases that signal the relationship between paragraphs and ideas:</p>

<ul>
  <li><strong>Addition:</strong> Furthermore, moreover, in addition, equally important</li>
  <li><strong>Contrast:</strong> However, on the other hand, nevertheless, conversely, yet</li>
  <li><strong>Cause and effect:</strong> Consequently, as a result, therefore, this leads to</li>
  <li><strong>Emphasis:</strong> Crucially, significantly, above all, most importantly</li>
  <li><strong>Concession:</strong> Admittedly, granted, while it is true that, of course</li>
</ul>

<h3>Model Article Plan</h3>
...
`,
    quiz: [
      {
        id: 'y10-p1-m6-q1',
        question: 'Which of the following is NOT a convention of article writing?',
        options: [
          'A headline',
          'An engaging opening paragraph',
          '"Dear Sir or Madam" as an opening salutation',
      ...
      {
        id: 'y10-p1-m6-q2',
        question: 'What is the purpose of a counter-argument in a persuasive article?',
        options: [
          'To show you agree with the opposing side',
          'To acknowledge the opposing view and then dismantle it, showing intellectual maturity',
      ...
      },
      {
        ...
        options: [
          ...
          'Articles should never reveal their topic in advance',
      ...
      {
        id: 'y10-p1-m6-q5',
        question: 'What is a "tricolon" and how is it used in persuasive writing?',
        options: [
          'A three-paragraph essay structure',
          'A list of three items or phrases used for rhythmic emphasis',
          'A technique where three rhetorical questions are asked in succession',
...
<h3>Key Rhetorical Devices for Speeches</h3>

<p>While articles can use persuasive techniques, speeches demand particular devices that exploit the oral medium. These are the most important ones to master:</p>

<h4>Anaphora (Repetition at the Start of Successive Sentences or Clauses)</h4>
<p>Repeating the same word or phrase at the beginning of successive sentences creates rhythm, builds momentum, and emphasises a key idea. This is one of the most powerful speech techniques.</p>
<p><strong>Example:</strong> "We deserve better. We deserve schools that inspire. We deserve teachers who are valued. We deserve a future worth believing in." The repetition of "We deserve" creates a cumulative, building effect that is deeply persuasive when spoken aloud.</p>
...
<p><strong>Example:</strong> "This policy is reckless, it is short-sighted, and it is wrong." The triple structure gives the statement a sense of completeness and finality.</p>

<h4>Inclusive Pronouns ("We," "Our," "Us")</h4>
<p>Using first-person plural pronouns creates unity between speaker and audience. It positions the speaker as part of the group rather than lecturing from above.</p>
<p><strong>Example:</strong> "Together, we can transform our school. This is our moment. Let us seize it." The inclusive language makes the audience feel ownership of the argument.</p>
...
<div class="common-mistake"><strong>Common Mistake 1:</strong> Writing an essay and labelling it a speech. If you remove the "Good morning, everyone" from the beginning and the response still reads like an essay, you have not written a speech. A genuine speech uses rhetorical devices, direct address, varied sentence lengths, and a conversational quality that an essay does not.</div>
    ...
    quiz: [
      {
        ...
        options: [
          ...
          'A three-part list for rhythmic emphasis',
      ...
      {
        id: 'y10-p1-m7-q2',
        question: 'What is the key difference between writing a speech and writing an article?',
        options: [
          'Speeches must be longer than articles',
          'Speeches are intended to be heard aloud and must use devices that work orally',
          'Articles use persuasive techniques but speeches do not',
      ...
      {
        id: 'y10-p1-m7-q3',
        question: 'Why should you use inclusive pronouns ("we," "our," "us") in a speech?',
        options: [
          'Because the mark scheme specifically awards marks for pronouns',
          'Because they create unity between speaker and audience, making listeners feel ownership of the argument',
          'Because they make the speech longer',
      ...
      },
      {
        ...
        options: [
          ...
          'Placing contrasting ideas side by side in a balanced grammatical structure',
      ...
      {
        id: 'y10-p1-m7-q5',
        question: 'How can you tell if your speech response is actually just an essay in disguise?',
        options: [
          'If it is longer than 400 words',
          'If it contains paragraphs',
          'If removing the opening salutation leaves a piece that reads identically to an essay, with no rhetorical devices, direct address, or conversational quality',
...
<p>If the task specifies a formal audience (editor, councillor, headteacher, MP), you must include:</p>

<ul>
  <li><strong>Your address (optional in an exam):</strong> You may write a brief address in the top-right corner, but this is not strictly necessary in an exam context and should not waste valuable time.</li>
  <li><strong>Date (optional):</strong> Again, a brief date can demonstrate form awareness but is not essential.</li>
  <li><strong>Salutation:</strong> "Dear Sir or Madam," (if you do not know the recipient's name) or "Dear Mr/Mrs/Ms [Name]," (if you do). Never use "Hey" or "Hi" in a formal letter.</li>
  <li><strong>A clear statement of purpose in the opening paragraph:</strong> "I am writing to express my concern about..." or "I am writing in response to your recent article regarding..."</li>
  <li><strong>Developed body paragraphs:</strong> Each paragraph presents a distinct point, supported by evidence or reasoning. Maintain a formal, measured tone throughout.</li>
  <li><strong>Sign-off:</strong> "Yours faithfully," (if you used "Dear Sir or Madam") or "Yours sincerely," (if you used a name). This is followed by your name.</li>
</ul>

<div class="examiner-tip"><strong>Examiner Tip:</strong> The "faithfully/sincerely" rule is simple but frequently broken. If you do not know the recipient's name (Dear Sir or Madam), sign off with "Yours faithfully." If you used their name (Dear Mr Thompson), sign off with "Yours sincerely." Getting this right demonstrates awareness of letter-writing conventions and impresses the examiner.</div>

<h3>Informal Letter Conventions</h3>

<p>If the task specifies an informal audience (a friend, a relative, a pen pal), conventions differ:</p>
...
<h3>Formal Letter: Tone and Language</h3>

<p>Formal letters require precise, measured language. Here are examples of how to adjust your expression:</p>

<table>
  <tr><th>Informal Version</th><th>Formal Version</th></tr>
  <tr><td>I think this is really unfair</td><td>I believe this decision is unjust and warrants reconsideration</td></tr>
  <tr><td>You guys need to sort this out</td><td>I urge the council to address this matter as a priority</td></tr>
  <tr><td>Everyone's fed up with it</td><td>There is widespread dissatisfaction among residents regarding this issue</td></tr>
  <tr><td>It's obvious that...</td><td>It is evident that...</td></tr>
  <tr><td>Kids are suffering because of this</td><td>Young people are being adversely affected by this policy</td></tr>
</table>

<p>In a formal letter, avoid contractions (write "I am" not "I'm," "do not" not "don't"), slang, colloquialisms, and emotional outbursts. Your power comes from reasoned argument, not passionate ranting.</p>

<h3>Structuring a Formal Letter</h3>

<p>A well-structured formal letter follows a logical progression:</p>

<ol>
  <li><strong>Opening paragraph:</strong> State your purpose clearly. Who are you, and why are you writing? Be direct and concise.</li>
  <li><strong>Paragraph 2:</strong> Present your first and strongest argument or concern, supported by evidence or reasoning.</li>
  <li><strong>Paragraph 3:</strong> Present your second argument, perhaps addressing a different aspect of the issue.</li>
  <li><strong>Paragraph 4:</strong> Acknowledge the counter-argument and rebut it. This shows balance and maturity.</li>
  <li><strong>Closing paragraph:</strong> Summarise your position and state what action you would like the recipient to take. End respectfully but firmly: "I look forward to your response on this matter."</li>
</ol>

<h3>Structuring an Informal Letter</h3>

<p>An informal letter can be more flexible in structure, but it should still feel purposeful:</p>

<ol>
  <li><strong>Opening:</strong> A warm greeting and brief personal connection ("Hope you're doing well! I've been meaning to write to you about something that's been on my mind...").</li>
  <li><strong>Body paragraphs:</strong> Share your thoughts, arguments, or advice in a natural, conversational way. Use personal anecdotes and questions to the recipient.</li>
  <li><strong>Closing:</strong> Wrap up with a personal touch ("Anyway, I'd love to hear what you think about all this. Let me know when you're free to catch up!").</li>
</ol>
...
`,
    quiz: [
      {
        id: 'y10-p1-m8-q1',
        question: 'When should you sign off a formal letter with "Yours faithfully"?',
        options: [
          'When the letter is addressed to a friend',
          'When you have used the recipient\'s name in the salutation (e.g. "Dear Mr Smith")',
          'When you do not know the recipient\'s name and have used "Dear Sir or Madam"',
      ...
      {
        id: 'y10-p1-m8-q2',
        question: 'What is the biggest risk when writing an informal letter in the exam?',
        options: [
          'Using too many paragraphs',
          'Being too formal for the audience',
          'Becoming too casual, losing structure, and abandoning correct SPAG',
      ...
      {
        id: 'y10-p1-m8-q3',
        question: 'Which of the following is appropriate in a formal letter?',
        options: [
          '"You guys need to sort this out ASAP"',
          '"I urge the council to address this matter as a priority"',
          '"Everyone\'s fed up and it\'s about time something changed"',
      ...
      {
        id: 'y10-p1-m8-q5',
        question: 'How do persuasive techniques differ between formal and informal letters?',
        options: [
...
<p>Reports are characterised by their formal, organised structure. Key conventions include:</p>

<ul>
  <li><strong>A clear title:</strong> State the subject of the report. E.g. "Report on the Proposed Changes to School Break Times" or "A Report into Student Wellbeing at Riverside Academy."</li>
  <li><strong>Subheadings:</strong> Reports use subheadings to divide content into logical sections. This is a distinctive feature that separates reports from essays or articles. Typical subheadings include: Introduction, Findings, Analysis, Recommendations, Conclusion.</li>
  <li><strong>Formal, impersonal tone:</strong> Reports tend to use the third person ("It was observed that..." "Students reported that...") rather than the first person. However, first person is acceptable if the task positions you as someone presenting your own findings.</li>
  <li><strong>Evidence-based content:</strong> Reports present evidence, data, and observations rather than purely personal opinions. Use phrases like "Research indicates that..." "It was found that..." "A survey of students revealed..."</li>
  <li><strong>Recommendations:</strong> Reports often conclude with specific, actionable recommendations. These should be practical and clearly stated: "It is recommended that the school extends break times by ten minutes" rather than vague suggestions.</li>
</ul>

<h3>Structuring a Report</h3>
...
<ol>
  ...
  <li><strong>Recommendations:</strong> Propose specific actions based on your analysis.</li>
  <li><strong>Conclusion:</strong> Summarise the key points and reinforce the importance of acting on the recommendations.</li>
</ol>

<div class="examiner-tip"><strong>Examiner Tip:</strong> The use of subheadings is the single most important form feature that distinguishes a report from a generic essay. If you are asked to write a report and do not include subheadings, you are missing a fundamental convention. Include at least three clear subheadings (e.g. Introduction, Key Findings, Recommendations) to demonstrate form awareness.</div>

<h3>Report Language and Register</h3>

<p>Reports use formal, objective language. Here are strategies for maintaining the right tone:</p>

<ul>
  <li><strong>Use passive voice where appropriate:</strong> "It was observed that..." "The policy has been criticised for..." Passive voice creates an impersonal, objective tone suited to reports.</li>
  <li><strong>Avoid emotive language:</strong> Reports should be measured and balanced. Instead of "The terrible state of the canteen is disgusting," write "The current condition of the canteen facilities falls below acceptable standards."</li>
  <li><strong>Use hedging language:</strong> "It appears that..." "Evidence suggests..." "It is likely that..." This shows academic caution and objectivity.</li>
...
<p>Reviews differ from reports in tone and purpose. Key conventions include:</p>
...
<ul>
  ...
  <li><strong>A clear verdict:</strong> The reader should finish knowing whether you recommend the thing being reviewed. End with a clear, confident judgement.</li>
</ul>

<h3>Review Language Strategies</h3>

<p>Reviews reward varied and precise vocabulary. Instead of repeatedly using "good" and "bad," employ a richer evaluative vocabulary:</p>

<table>
  <tr><th>Instead of "Good"</th><th>Instead of "Bad"</th></tr>
  <tr><td>Outstanding, exceptional, remarkable</td><td>Disappointing, underwhelming, lacklustre</td></tr>
  <tr><td>Compelling, gripping, absorbing</td><td>Tedious, uninspired, predictable</td></tr>
  <tr><td>Polished, sophisticated, accomplished</td><td>Clumsy, disjointed, underdeveloped</td></tr>
  <tr><td>Exhilarating, electrifying, breathtaking</td><td>Flat, lifeless, monotonous</td></tr>
</table>

<div class="common-mistake"><strong>Common Mistake:</strong> Students sometimes confuse reports and reviews. A report is formal, uses subheadings, presents evidence objectively, and makes recommendations. A review is evaluative, uses a personal voice, describes an experience, and gives a verdict. If the task says "Write a report," do not write a review, and vice versa. Read the task carefully and identify the exact form required.</div>

<h3>Structuring a Review</h3>
    ...
    quiz: [
      {
        ...
        options: [
          ...
          'Using subheadings to organise content into clear sections',
      ...
      {
        id: 'y10-p1-m9-q2',
        question: 'What tone should a report use?',
        options: [
      ...
      {
        id: 'y10-p1-m9-q3',
        question: 'How does a review differ from a report?',
        options: [
          'Reviews are always negative; reports are always positive',
          'Reviews use personal voice and evaluation; reports use objective analysis and recommendations',
          'Reviews are longer than reports',
      ...
      {
        id: 'y10-p1-m9-q4',
        question: 'Which of the following would be appropriate language for a report?',
        options: [
          '"The food was absolutely terrible and nobody should eat there"',
          '"Evidence suggests that the current catering provision falls below the standards expected by the student body"',
          '"I personally think the lunch menu needs a total overhaul"',
      ...
      {
        id: 'y10-p1-m9-q5',
        question: 'What should a review always include at the end?',
        options: [
...
<ul>
  ...
  <li><strong>Reference the previous paragraph:</strong> "While this argument has merit, it overlooks a more fundamental issue..."</li>
  <li><strong>Use a consistent thread:</strong> Return to your central argument or a key image throughout the piece. This creates a sense of unity.</li>
  <li><strong>Vary your paragraph openings:</strong> Do not start every paragraph with a discourse marker. Mix in questions, short statements, and topic sentences that emerge from the previous point.</li>
</ul>
...
<ol>
  <li><strong>Concede:</strong> "Some may argue that..." "Admittedly, there is a case for..." "Critics might suggest that..."</li>
  <li><strong>Present the opposing view fairly:</strong> Do not create a straw man. State the opposing argument genuinely.</li>
  <li><strong>Rebut:</strong> "However, this overlooks..." "Nevertheless, the evidence clearly shows..." "While this may be true in theory, in practice..."</li>
  <li><strong>Reassert your position:</strong> Return to your main argument with renewed force, showing that it withstands scrutiny.</li>
</ol>

<div class="common-mistake"><strong>Common Mistake:</strong> Students sometimes include a counter-argument but forget to rebut it. Simply stating "Some people think X" without explaining why X is wrong (or less convincing than your position) weakens your argument rather than strengthening it. Always follow a concession with a strong rebuttal.</div>

<h3>Opening Strategies That Work Across All Forms</h3>

<p>Regardless of whether you are writing an article, speech, letter, or report, certain opening techniques are universally effective:</p>

<ul>
  <li><strong>The provocative statement:</strong> Immediately establishes your position and grabs attention.</li>
  <li><strong>The anecdotal opening:</strong> A brief, vivid story that humanises your argument.</li>
  <li><strong>The statistical opening:</strong> A striking fact or figure that establishes urgency.</li>
  <li><strong>The question opening:</strong> A rhetorical question that forces the reader to engage.</li>
  <li><strong>The scene-setting opening:</strong> A descriptive moment that draws the reader into a situation.</li>
</ul>

<h3>Closing Strategies That Leave an Impact</h3>

<p>Your conclusion is the last thing the examiner reads, so make it count. Effective closing strategies include:</p>
...
`,
    quiz: [
      ...
      {
        id: 'y10-p1-m10-q2',
        question: 'What does PEEL stand for in paragraph structure?',
        options: [
          'Purpose, Evidence, Example, Language',
          'Point, Evidence, Explanation, Link',
          'Persuade, Engage, Elaborate, Lead',
      ...
      {
        id: 'y10-p1-m10-q3',
        question: 'What is the purpose of a counter-argument in transactional writing?',
        options: [
          'To show you have no opinion on the topic',
          'To confuse the examiner',
          'To demonstrate intellectual maturity by engaging with opposing views and then rebutting them',
      ...
      {
        id: 'y10-p1-m10-q4',
        question: 'What is a "circular structure" in transactional writing?',
        options: [
          'Writing in a circle around the page',
          'Repeating the same argument in every paragraph',
          'Returning to the opening image, idea, or anecdote in your conclusion',
...
<p>Understanding the mark scheme helps you target the top band:</p>

<ul>
  <li><strong>Band 1 (1-4 marks):</strong> Simple sentence structures with limited variety. Basic punctuation (full stops, capitals) used with some accuracy. Frequent spelling errors, including common words. Limited grammatical control.</li>
  <li><strong>Band 2 (5-8 marks):</strong> Some variety of sentence structures. Punctuation generally accurate with some range. Spelling mostly accurate on common words; errors on more ambitious vocabulary. Reasonable grammatical control with occasional lapses.</li>
  <li><strong>Band 3 (9-13 marks):</strong> A range of sentence structures used with control. Punctuation is varied and largely accurate, including commas, semicolons, and dashes. Spelling is accurate, including more ambitious words. Good grammatical control with few errors.</li>
  <li><strong>Band 4 (14-18 marks):</strong> A wide range of sentence structures deployed with confidence and accuracy. Punctuation is varied, precise, and used for effect (including colons, semicolons, parenthetical commas, and dashes). Spelling is consistently accurate, including ambitious and irregular vocabulary. Grammar is controlled and assured throughout.</li>
</ul>

<h3>Sentence Structures: Achieving Variety</h3>

<p>Using a range of sentence structures is one of the most important AO5 skills. Here are the key sentence types you should deploy:</p>

<h4>Simple Sentences</h4>
<p>One main clause, one idea. Effective for emphasis and impact.</p>
<p><strong>Example:</strong> "This must change." Used sparingly, simple sentences create dramatic pauses and drive home key points.</p>

<h4>Compound Sentences</h4>
<p>Two main clauses joined by a coordinating conjunction (and, but, or, nor, yet, so).</p>
<p><strong>Example:</strong> "The evidence is overwhelming, yet the government refuses to act."</p>

<h4>Complex Sentences</h4>
<p>A main clause with one or more subordinate clauses, joined by subordinating conjunctions (although, because, while, despite, unless, if, when).</p>
<p><strong>Example:</strong> "Although many parents welcome the proposal, teachers have expressed significant reservations about its practicality."</p>

<h4>Compound-Complex Sentences</h4>
<p>A combination of compound and complex structures.</p>
<p><strong>Example:</strong> "While the cost may seem prohibitive, the long-term benefits far outweigh the initial investment, and communities across the country have already demonstrated that this approach works."</p>
...
<p>To reach the top band, you must use punctuation beyond basic full stops and commas. Here are the marks of ambitious, controlled punctuation:</p>

<h4>Semicolons</h4>
<p>Use semicolons to join two closely related independent clauses without a conjunction.</p>
<p><strong>Correct:</strong> "The proposal has merit; however, its implementation would require significant investment."</p>
<p><strong>Incorrect:</strong> "The proposal has merit; because it addresses a genuine need." (The clause after the semicolon is not independent.)</p>

<h4>Colons</h4>
<p>Use colons to introduce an explanation, a list, or a quotation.</p>
<p><strong>Correct:</strong> "The choice is simple: act now or face the consequences."</p>
...
<p><strong>Correct:</strong> "The headteacher, who has served the school for fifteen years, announced her retirement."</p>
...
<p>Certain words are misspelled so frequently that examiners notice them immediately. Eliminate these errors through targeted practice:</p>

<ul>
  <li><strong>Homophones:</strong> their/there/they're, your/you're, its/it's, to/too/two, where/were/we're, affect/effect, whose/who's, practice/practise</li>
  <li><strong>Common misspellings:</strong> definitely (not "definately"), separate (not "seperate"), necessary (not "neccessary"), government (not "goverment"), environment (not "enviroment"), immediately (not "immediatly"), occurred (not "occured")</li>
  <li><strong>Double letters:</strong> accommodate, recommend, beginning, occurred, embarrass, disappoint, commitment</li>
  <li><strong>Silent letters:</strong> knowledge, psychology, Wednesday, February, business</li>
</ul>

<h3>Grammar: Key Rules for AO5</h3>
...
<h3>The Proofreading Strategy</h3>
...
`,
    quiz: [
      ...
      },
      {
        ...
        options: [
          ...
          'Joining two independent clauses with only a comma instead of a semicolon, conjunction, or full stop',
          'Placing a comma after every word',
  ...
  // ──────────────────────────────────────────────
  {
    ...
    duration: '60 min',
    content: `
<h2>Bringing It All Together: Exam Strategy and Self-Assessment</h2>
...
<p>By now you are familiar with the timing plan from Module 1. Here is the refined version, incorporating the skills from all subsequent modules:</p>
...
<h3>How to Conduct a Full Timed Practice</h3>

<p>To get the most benefit from practice papers, follow this protocol:</p>

<ol>
  <li><strong>Set up exam conditions:</strong> Find a quiet space, set a timer for 2 hours 15 minutes, put your phone away, and use only the materials you would have in the exam (pen, highlighter, the exam paper). No notes, no textbooks, no internet.</li>
  <li><strong>Complete the paper in one sitting:</strong> Do not pause the timer, take breaks, or look up answers. The goal is to simulate the real experience as closely as possible.</li>
  <li><strong>Write by hand:</strong> You will handwrite in the exam, so practise handwriting. Typing is faster and neater, but it does not build the stamina and speed you need for a written exam.</li>
  <li><strong>Track your timing:</strong> Note the time when you finish each question. After the practice, review whether you stuck to the timing plan or spent too long on certain sections.</li>
...
<p>After completing a practice paper, assess your Section A responses against these criteria:</p>

<h4>Questions 1-3 (AO1)</h4>
<ul>
  <li>Did I answer from the correct lines as specified in the question?</li>
  <li>Did I select precise words/phrases (Q1) or use brief, embedded quotations (Q3)?</li>
  <li>Did I paraphrase in my own words (Q2) rather than copying the text?</li>
  <li>Did I make enough distinct points for the marks available?</li>
  <li>Did I avoid including unnecessary analysis in Q1-3?</li>
</ul>

<h4>Question 4 (AO2)</h4>
<ul>
  <li>Did I analyse both language AND structure?</li>
  <li>Did I use embedded quotations (brief, precise phrases)?</li>
  <li>Did I identify techniques AND explain their effects?</li>
  <li>Did I explore connotations of individual word choices?</li>
  <li>Did I write three to four well-developed analytical paragraphs?</li>
  <li>Did I avoid generic phrases like "makes the reader want to read on"?</li>
</ul>

<h4>Question 5 (AO3)</h4>
<ul>
  <li>Did I compare BOTH texts throughout (not write two separate analyses)?</li>
  <li>Did I use comparative connectives (however, whereas, similarly, in contrast)?</li>
  <li>Did I include quotations from BOTH texts?</li>
  <li>Did I compare ideas/perspectives AND methods/language?</li>
  <li>Did I write four to five substantial comparative paragraphs?</li>
</ul>
...
<ul>
  ...
  <li>Did I take a clear, consistent position on the topic?</li>
  <li>Did I develop my arguments with evidence, examples, or reasoning?</li>
  <li>Did I include a counter-argument and rebuttal?</li>
  <li>Did I use persuasive techniques appropriately (not excessively)?</li>
  <li>Did I use discourse markers to guide the reader through my argument?</li>
  <li>Did I write a strong opening and a memorable conclusion?</li>
...
<ul>
  ...
  <li>Did I spell all common words correctly (definitely, separate, government)?</li>
  <li>Did I avoid homophone errors (their/there/they're, its/it's)?</li>
  <li>Did I maintain tense consistency throughout?</li>
  <li>Did I avoid comma splices?</li>
  <li>Did I proofread my work?</li>
</ul>

<h3>Identifying and Addressing Weaknesses</h3>

<p>After self-assessing, identify your two or three biggest weaknesses and focus your revision on those areas. Here is a guide to targeted practice:</p>

<ul>
  <li><strong>Weakness: Running out of time on Q5:</strong> Practise Q5 in isolation under timed conditions (30 minutes). Do this with different text pairs until your timing improves.</li>
  <li><strong>Weakness: Weak language analysis in Q4:</strong> Practise analysing short extracts (one paragraph at a time). For each extract, write three analytical paragraphs using the identify-quote-explain framework.</li>
  <li><strong>Weakness: Poor form awareness in Section B:</strong> Revisit Modules 6-9 and write practice responses in each form (article, speech, letter, report/review). Check each one against the form conventions checklist.</li>
  <li><strong>Weakness: SPAG errors:</strong> Create a personal spelling list of words you consistently misspell. Practise them daily. For punctuation, do targeted exercises on semicolons, colons, and commas.</li>
...
`,
    quiz: [
      ...
      {
        id: 'y10-p1-m12-q2',
        question: 'Why is self-assessment an essential part of exam preparation?',
        options: [
          'It saves time compared to asking a teacher to mark your work',
          'It identifies specific weaknesses you can target in revision and deepens your understanding of the mark scheme',
          'It is required by the exam board',
      ...
      {
        id: 'y10-p1-m12-q3',
        question: 'What should you do if you consistently run out of time on Question 5?',
        options: [
          'Write shorter answers for all other questions',
          'Skip Question 5 entirely in the exam',
          'Practise Q5 in isolation under timed conditions (30 minutes) with different text pairs',
      ...
      {
        id: 'y10-p1-m12-q4',
        question: 'On exam day, how should you choose between the two Section B tasks?',
        options: [
          'Always choose the first option',
          'Choose the topic that sounds more difficult to impress the examiner',
          'Choose the task where you feel most confident about the form and topic',
          'Choose randomly',
        ],
        correct: 2,
        explanation:
