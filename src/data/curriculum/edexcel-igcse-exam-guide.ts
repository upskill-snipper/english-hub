import type { BoardExamGuide, SetTextAnalysis, GenericOverview } from '../exam-guides/types'
...
export const ofMiceAndMenGuide: SetTextAnalysis = {
  ...
  quotations: [
    ...
    {
      quote:
        "\"I seen hundreds of men come by on the road an' on the ranches... an' every damn one of 'em's got a little piece of land in his head.\"",
      analysis:
...
export const edexcelIgcseExamGuide: BoardExamGuide = {
  ...
  // ─── Set Texts ───────────────────────────────────────────────────────────────
  setTexts: [ofMiceAndMenGuide, anInspectorCallsGuide, macbethGuide],
...
export { type BoardExamGuide, type SetTextAnalysis, type GenericOverview }
