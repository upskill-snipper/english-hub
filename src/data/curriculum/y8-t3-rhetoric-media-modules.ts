    ...
    quiz: [
      {
        ...
        options: [
          'A type of poetry from ancient Rome',
          'The art of effective and persuasive speaking and writing',
          'A scientific method for proving facts',
          'A form of creative writing used only in literature',
        ],
        correct: 1,
        explanation:
          'Rhetoric is the art of persuasion - choosing the right words, structure, and techniques to influence an audience. It applies to speaking and writing in all contexts, not just literature.',
      },
      {
        id: 'y8t3-m1-q2',
        question:
          'Which ancient Greek philosopher defined ethos, pathos, and logos as the three pillars of persuasion?',
        options: ['Plato', 'Socrates', 'Aristotle', 'Cicero'],
        correct: 2,
        explanation:
          'Aristotle identified ethos (credibility), pathos (emotion), and logos (logic) as the three fundamental modes of persuasion in his work "Rhetoric."',
      },
      {
        id: 'y8t3-m1-q3',
        question: 'Why was rhetoric considered a survival skill in ancient Athens?',
        options: [
          'Because soldiers needed it in battle',
          'Because citizens had to speak for themselves in court and in the assembly',
          'Because only rhetorical writers could earn money',
          'Because the gods demanded it',
        ],
        correct: 1,
        explanation:
          'In ancient Athens, there were no lawyers. Citizens had to defend themselves in court and argue for laws in the assembly, so the ability to speak persuasively was essential.',
      },
      {
        id: 'y8t3-m1-q4',
        question: 'Which of these is NOT one of the five key elements of a rhetorical situation?',
        options: ['Audience', 'Purpose', 'Rhyme scheme', 'Context'],
        correct: 2,
        explanation:
          'The five elements of a rhetorical situation are speaker/writer, audience, purpose, context, and message. Rhyme scheme is a poetic device, not a rhetorical element.',
      },
      {
        id: 'y8t3-m1-q5',
        question: "What was Plato's main concern about rhetoric?",
        options: [
          'That it was too difficult for ordinary citizens',
          'That it could be used to make weak arguments sound strong',
          'That it was only useful in writing, not speaking',
          'That it was not creative enough',
        ],
        correct: 1,
        explanation:
          'Plato warned that skilled speakers could use rhetoric to manipulate audiences, making bad arguments seem convincing. He believed rhetoric should only be used in the pursuit of truth.',
      },
    ],
  },
...
<div class="common-mistake"><strong>Common Mistake:</strong> When analysing speeches, students often simply list techniques without explaining their effect. Do not write "Malala uses a rhetorical question." Instead write: "Malala's rhetorical question forces the audience to confront their own inaction, creating a sense of personal responsibility that makes it harder to remain passive."</div>`,
    quiz: [
      {
        id: 'y8t3-m2-q1',
        question: 'Where did Malala deliver her famous 2013 speech?',
        options: [
        ...
        correct: 1,
        explanation:
          'Malala addressed the United Nations Youth Assembly on her sixteenth birthday, 12 July 2013, speaking to world leaders and young people about the right to education.',
      },
      {
        id: 'y8t3-m2-q2',
        question: 'Why is Malala\'s use of "we" instead of "I" an effective rhetorical technique?',
        options: [
          'It makes the speech shorter',
          'It hides the fact that she is speaking alone',
          'It includes the audience in the movement and makes them feel responsible',
          'It is grammatically more formal',
        ],
        correct: 2,
        explanation:
          'Using inclusive pronouns like "we" transforms Malala from a lone campaigner into the leader of a collective movement. It makes the audience feel they are part of the fight, not merely spectators.',
      },
      {
        id: 'y8t3-m2-q3',
        question: 'What is antithesis?',
        options: [
          'Repeating a word at the start of consecutive sentences',
          'Placing two contrasting ideas side by side for dramatic effect',
          'Exaggerating a claim to make it more persuasive',
          'Using questions that do not expect an answer',
        ],
        correct: 1,
        explanation:
          "Antithesis places opposites next to each other - light and dark, silence and voice - to sharpen the contrast and force the audience to see the speaker's position as the obviously right choice.",
      },
      {
        id: 'y8t3-m2-q4',
        question:
          'Why does Malala reference figures like Martin Luther King Jr. and Nelson Mandela?',
        options: [
          'Because they are from the same country as her',
          'To show off her historical knowledge',
          'To connect her cause to other great justice movements and give her argument moral weight',
          'Because the United Nations required her to mention them',
        ],
        correct: 2,
        explanation:
          'By referencing iconic figures in the struggle for justice, Malala places her own campaign within a grand historical tradition, giving her argument moral authority and suggesting that education rights are the civil rights issue of our time.',
      },
      {
        id: 'y8t3-m2-q5',
        question: "Why is Malala's ethos considered so powerful?",
        options: [
          'Because she is a talented actress',
          'Because she has personal experience of the injustice she describes',
          'Because she memorised her speech perfectly',
          'Because she is older than most speakers',
        ],
        correct: 1,
        explanation:
          'Malala was shot for going to school. Her personal experience of the injustice she campaigns against gives her an authenticity and moral authority that cannot be matched by someone speaking theoretically.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        options: [
          'A type of metaphor used in political speeches',
          'The deliberate repetition of a word or phrase at the start of successive sentences',
          'A technique where the speaker whispers for dramatic effect',
          'A method of organising paragraphs in an essay',
        ],
        correct: 1,
        explanation:
          'Anaphora is the repetition of a word or phrase at the beginning of consecutive clauses or sentences. It creates rhythm and emphasis, building intensity with each repetition.',
      },
      {
        id: 'y8t3-m3-q2',
        question: 'How does Greta\'s use of "you" differ from Malala\'s use of "we"?',
        options: [
          'They mean the same thing',
          'Greta uses "you" to accuse and assign blame, while Malala uses "we" to include and unite',
          'Greta uses "you" because her English is weaker',
          'Malala uses "we" because she was speaking to a smaller audience',
        ],
        correct: 1,
        explanation:
          'The pronoun choice reflects entirely different rhetorical strategies. "We" builds solidarity and shared responsibility, while "you" creates confrontation and places responsibility squarely on the audience.',
      },
      {
        id: 'y8t3-m3-q3',
        question: "Why is the combination of emotion and statistics effective in Greta's speech?",
        options: [
          'Because statistics are boring and need emotion to make them interesting',
          'Because emotion makes the audience care, and statistics prove they should',
          'Because the UN requires both in every speech',
          'Because Greta could not remember enough statistics alone',
        ],
        correct: 1,
        explanation:
          'Emotion without evidence can feel manipulative, and evidence without emotion can feel dry. Combining the two - pathos and logos - creates a persuasive argument that is both felt and verified.',
      },
      {
        id: 'y8t3-m3-q4',
        question: "What movement did Greta Thunberg's activism inspire?",
        options: [
        ...
        correct: 0,
        explanation:
          'Greta began protesting alone outside the Swedish Parliament every Friday. Her "School Strike for Climate" inspired Fridays for Future, a global movement of young people demanding climate action.',
      },
      {
        id: 'y8t3-m3-q5',
        question: 'Why does Greta deliberately break the formal register expected at a UN speech?',
        options: [
          'Because she does not understand formal language',
          'To signal that the situation is so urgent that normal conventions no longer apply',
          'Because her translators made errors',
          'To entertain the audience',
        ],
        correct: 1,
        explanation:
          "Greta's blunt, emotional language is a strategic choice. By refusing to follow diplomatic conventions, she communicates through her tone that the crisis is too severe for polite, measured language.",
      },
    ],
  },
    ...
    quiz: [
      {
        id: 'y8t3-m4-q1',
        question:
          "What is Sheikha Moza's primary rhetorical strategy when advocating for education?",
        options: [
          'Personal stories of suffering',
          'Angry confrontation with world leaders',
          'Framing education as an economic and strategic investment',
          'Using humour to engage her audience',
        ],
        correct: 2,
        explanation:
          'Sheikha Moza strategically frames education as an economic and development issue, speaking the language of investment and returns to appeal to decision-makers who respond more readily to strategic arguments than to purely moral ones.',
      },
      {
        id: 'y8t3-m4-q2',
        question: 'What is refutation?',
        options: [
          'Repeating your main argument three times',
          'Acknowledging an opposing argument and then disproving it',
          'Using emotional language to overwhelm the audience',
          'Refusing to engage with criticism',
        ],
        correct: 1,
        explanation:
          'Refutation means addressing counter-arguments directly and dismantling them. This shows the audience you have considered other viewpoints, which makes your own argument appear more thorough and credible.',
      },
      {
        id: 'y8t3-m4-q3',
        question: "How does Sheikha Moza's ethos differ from Malala's?",
        options: [
          'Sheikha Moza has no credibility',
          "Malala's comes from personal suffering, Sheikha Moza's from institutional achievement and leadership",
          'They have identical sources of credibility',
          "Sheikha Moza's ethos is based on being a teenager",
        ],
        correct: 1,
        explanation:
          'Malala draws authority from having survived an assassination attempt for seeking education. Sheikha Moza draws authority from decades of building educational institutions and leading global development initiatives. Both are powerful, but they come from very different sources.',
      },
      {
        id: 'y8t3-m4-q4',
        question:
          'Why does Sheikha Moza use consensus-building language like "our shared responsibility"?',
        options: [
          'Because she is not confident in her arguments',
          'Because it is required at all diplomatic events',
          'Because it builds partnership and makes the audience feel action is in their own interest',
          'Because she wants to avoid taking a position',
        ],
        correct: 2,
        explanation:
          'Consensus-building language is a diplomatic strategy. Instead of blaming or accusing, it frames the issue as a shared challenge, making the audience more likely to cooperate because they feel included rather than attacked.',
      },
      {
        id: 'y8t3-m4-q5',
        question: 'What key lesson about rhetoric emerges from comparing all three speakers?',
        options: [
          'Louder speeches are always more effective',
          'The best rhetorical approach depends on the speaker, audience, and context',
          'All persuasive speeches must include personal stories',
          'Statistics are more important than emotion in every speech',
        ],
        correct: 1,
        explanation:
          'The comparison shows that there is no single "correct" approach to persuasion. Malala, Greta, and Sheikha Moza each use different strategies that are perfectly suited to their individual identities, audiences, and purposes.',
      },
    ],
  },
    ...
    quiz: [
      {
        id: 'y8t3-m5-q1',
        question:
          'A charity advertisement shows images of children in need to make viewers feel sympathy. Which rhetorical appeal is this?',
        options: ['Ethos', 'Pathos', 'Logos', 'Anaphora'],
        correct: 1,
        explanation:
          'This is pathos - an appeal to emotion. The images are designed to provoke sympathy and compassion, which motivates donations. The emotional response is the primary driver of persuasion here.',
      },
      {
        id: 'y8t3-m5-q2',
        question:
          'A toothpaste advertisement says "recommended by 9 out of 10 dentists." Which TWO appeals does this use?',
        options: ['Pathos and logos', 'Ethos and logos', 'Pathos and ethos', 'Only logos'],
        correct: 1,
        explanation:
          'This uses ethos (dentists are experts, so their recommendation builds credibility) and logos (the statistic "9 out of 10" provides numerical evidence). The two appeals work together to make the claim seem both authoritative and evidence-based.',
      },
      {
        id: 'y8t3-m5-q3',
        question: 'What makes an argument "all pathos, no logos" problematic?',
        options: [
          'It is too short',
          'It makes the audience feel strongly but provides no evidence to support the claims',
          'It uses too many statistics',
          'It is delivered by someone without a university degree',
        ],
        correct: 1,
        explanation:
          'An argument that relies entirely on emotion without evidence can be manipulative. It makes you feel something without proving anything. Always ask whether there is evidence behind the emotional appeal.',
      },
      {
        id: 'y8t3-m5-q4',
        question: 'Which type of text would rely MOST heavily on logos?',
        options: [
          'A love poem',
        ...
        correct: 2,
        explanation:
          "A scientific research paper depends on evidence, data, logical reasoning, and verifiable findings. While it may also establish the researcher's credentials (ethos), logos is the dominant mode of persuasion.",
      },
      {
        id: 'y8t3-m5-q5',
        question:
          'A speaker says: "As a teacher of thirty years, I have seen first-hand how funding cuts damage children\'s futures." Which appeal is the phrase "as a teacher of thirty years" establishing?',
        options: ['Pathos', 'Logos', 'Ethos', 'Antithesis'],
        correct: 2,
        explanation:
          'By mentioning their thirty years of experience, the speaker is establishing ethos - their credibility and authority to speak on the topic. This makes the audience more likely to trust the claim that follows.',
      },
    ],
  },
...
<div class="common-mistake"><strong>Common Mistake:</strong> Writing a speech that sounds like an essay. Speeches need short sentences, direct address, rhetorical questions, and varied rhythm. If your speech does not sound natural when read aloud, rewrite it until it does.</div>`,
    quiz: [
      {
        id: 'y8t3-m6-q1',
        question: 'What is the most important thing the closing of a speech should include?',
        options: [
          'A summary of every point made',
          'A joke to end on a high note',
          'A clear and specific call to action',
          "An apology for taking up the audience's time",
        ],
        correct: 2,
        explanation:
          'The closing should tell the audience exactly what you want them to do next. A specific call to action gives the audience direction and makes your speech feel purposeful rather than abstract.',
      },
      {
        id: 'y8t3-m6-q2',
        question: 'Why should you read your speech aloud as you write it?',
        options: [
          'To memorise it faster',
          'Because speeches are written for the ear, and you need to check rhythm, clarity, and natural pauses',
          'To make sure it is long enough',
          'Because spelling mistakes are easier to hear',
        ],
        correct: 1,
        explanation:
          'A speech is designed to be heard, not read. Reading aloud helps you identify awkward phrasing, sentences that are too long to say in one breath, and places where the rhythm stumbles.',
      },
      {
        id: 'y8t3-m6-q3',
        question: 'Which of these is the WEAKEST way to open a speech?',
        options: [
          'A startling statistic about the topic',
        ...
        correct: 2,
        explanation:
          '"Today I am going to talk to you about..." is bland and gives the audience no reason to care. Effective openings grab attention immediately through surprise, emotion, or provocation.',
      },
      {
        id: 'y8t3-m6-q4',
        question: 'Where in a speech should the emotional peak usually be placed?',
        options: [
        ...
        correct: 1,
        explanation:
          'The emotional peak works best about two-thirds through the speech, after the logical argument has been established and before the call to action. This placement gives the emotion maximum impact because the audience already understands the issue.',
      },
      {
        id: 'y8t3-m6-q5',
        question:
          'Why does placing important words at the END of a sentence create more impact in a speech?',
        options: [
          'Because audiences only listen to the end of sentences',
          'Because the final position in a sentence naturally receives vocal emphasis',
          'Because it makes the speech shorter',
          'Because English grammar requires it',
        ],
        correct: 1,
        explanation:
          'In spoken English, the final word or phrase in a sentence naturally receives the most emphasis. Skilled speechwriters exploit this by placing their most powerful word at the end of the sentence, where it lands with maximum force.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        options: [
          'A type of camera filter used on social media',
          'When algorithms show you content that confirms your existing views, hiding opposing perspectives',
          'A way of protecting children from harmful content online',
          'A news website that only publishes positive stories',
        ],
        correct: 1,
        explanation:
          'A filter bubble occurs when social media algorithms learn your preferences and show you more of what you already agree with, creating a distorted view of reality where opposing perspectives are hidden from you.',
      },
      {
        id: 'y8t3-m7-q2',
        question: 'Which of these is a PRIMARY source?',
        options: [
          'A newspaper article about a scientific study',
          'A YouTube video summarising a historical event',
          'The original text of a government report',
          'A textbook chapter about climate change',
        ],
        correct: 2,
        explanation:
          'A primary source is the original document or first-hand account. The government report is the original - everything else interprets, summarises, or analyses it, making them secondary sources.',
      },
      {
        id: 'y8t3-m7-q3',
        question: 'Why is it important to ask "What is missing?" when analysing media?',
        options: [
          'Because media texts always contain spelling errors',
          'Because what is left out can reveal bias and shape understanding just as much as what is included',
          'Because missing information means the text is unreliable',
          'Because teachers will deduct marks if you do not mention it',
        ],
        correct: 1,
        explanation:
          'Every media text involves choices about what to include and exclude. A news story that interviews only one side of a debate, or an advert that omits the side effects of a product, shapes your understanding through what it leaves out as much as through what it includes.',
      },
      {
        id: 'y8t3-m7-q4',
        question: 'Why might the same news story be interpreted differently by different people?',
        options: [
          'Because some people cannot read properly',
          'Because people filter media through their own beliefs, experiences, and values',
          'Because news stories change their content based on who reads them',
          'Because only experts can understand the news',
        ],
        correct: 1,
        explanation:
          'Media does not exist in a vacuum. Each person interprets information through the lens of their own experiences, background, culture, and beliefs. This is why the same facts can lead to different conclusions.',
      },
      {
        id: 'y8t3-m7-q5',
        question: 'What is the purpose of media literacy?',
        options: [
          'To distrust all media completely',
          'To become a journalist',
          'To develop habits of critical thinking so you can evaluate media rather than accepting it at face value',
          'To avoid using social media',
        ],
        correct: 2,
        explanation:
          'Media literacy is not about distrusting everything - it is about thinking critically. It means asking questions about who created content, why, and how it might be shaping your understanding, so you can make informed judgements.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        options: [
          'Putting a photograph in a frame',
          'Presenting information in a way that encourages a particular interpretation',
          'Writing a story within a strict time limit',
          'Copying content from another news source',
        ],
        correct: 1,
        explanation:
          'Framing is the way media presents information to shape how audiences interpret it. Through word choice, image selection, and story angle, framing can make the same facts seem positive, negative, or neutral.',
      },
      {
        id: 'y8t3-m8-q2',
        question:
          'Three articles describe the same event as a "protest," a "riot," and a "demonstration." What does this illustrate?',
        options: [
          'That journalists cannot agree on English',
          'How word choice reveals and creates bias',
          'That the event happened three times',
          'That one article must be lying',
        ],
        correct: 1,
        explanation:
          'Each word carries different connotations: "protest" is neutral, "riot" implies violence and disorder, and "demonstration" suggests organised, principled action. The choice of word reveals the journalist\'s (or outlet\'s) perspective and shapes the reader\'s response.',
      },
      {
        id: 'y8t3-m8-q3',
        question: 'What is selection bias in news media?',
        options: [
          'Choosing to report certain stories while ignoring others, creating a distorted picture',
          'Selecting the best-qualified journalist for a story',
          'Choosing to publish only online instead of in print',
          'Selecting sources that are all from the same country',
        ],
        correct: 0,
        explanation:
          'Selection bias occurs when media outlets consistently choose to cover certain types of stories while ignoring others. Even if individual articles are accurate, the overall pattern of coverage can create a misleading impression of reality.',
      },
      {
        id: 'y8t3-m8-q4',
        question: 'Why is it important to read multiple sources on the same story?',
        options: [
          'Because individual articles are always factually wrong',
          'To find the longest and most detailed version',
          'To identify where sources agree (reliable facts) and disagree (potential bias)',
          'Because teachers require it for homework',
        ],
        correct: 2,
        explanation:
          'Comparing multiple sources helps you separate broadly agreed-upon facts from areas where framing and bias differ. Where sources agree, the facts are likely reliable. Where they differ, you can identify the bias at work and form a more balanced view.',
      },
      {
        id: 'y8t3-m8-q5',
        question: 'Is a biased news article necessarily false?',
        options: [
          'Yes, bias always means the article is lying',
          'No, bias is about emphasis and framing, not necessarily about factual accuracy',
          'Yes, biased articles should never be trusted',
          'No, but biased articles are always written intentionally to mislead',
        ],
        correct: 1,
        explanation:
          'Bias and falsehood are not the same thing. A biased article may present accurate facts but emphasise, frame, or select them in a way that encourages a particular interpretation. Understanding bias means analysing how true information can be presented in misleading ways.',
      },
    ],
  },
    ...
    quiz: [
      {
        id: 'y8t3-m9-q1',
        question:
          'Why do many banks and technology companies use the colour blue in their branding?',
        options: [
          'Because blue paint is cheaper',
          'Because blue is associated with trust, calm, and professionalism',
          'Because blue is the most popular colour among teenagers',
          'Because regulations require financial companies to use blue',
        ],
        correct: 1,
        explanation:
          'Blue carries cultural associations of trust, reliability, and professionalism. Banks and tech companies choose blue deliberately to make customers feel secure and confident in their services.',
      },
      {
        id: 'y8t3-m9-q2',
        question: 'What is "transference" in advertising?',
        options: [
          'Moving an advertisement from one platform to another',
          'When positive feelings about a celebrity are unconsciously transferred to the product they endorse',
          "Copying a competitor's advertising strategy",
          'Translating an advertisement into another language',
        ],
        correct: 1,
        explanation:
          "Transference is a psychological process where the audience's admiration for a celebrity is unconsciously attached to the product. The product becomes associated with the celebrity's qualities - attractiveness, success, coolness - even though the product did not create those qualities.",
      },
      {
        id: 'y8t3-m9-q3',
        question:
          'Why do luxury brands often use large amounts of white space in their advertisements?',
        options: [
          'Because they cannot afford to fill the space with content',
          'Because white space suggests elegance, exclusivity, and sophistication',
          'Because minimalism is a legal requirement for luxury goods',
          'Because their products are so small they do not fill the frame',
        ],
        correct: 1,
        explanation:
          'White space communicates luxury by suggesting that the brand does not need to crowd the viewer with information. The emptiness creates a sense of calm, exclusivity, and confidence - the opposite of the cluttered, information-heavy layouts used by budget brands.',
      },
      {
        id: 'y8t3-m9-q4',
        question: 'What does "aspirational imagery" in advertising create?',
        options: [
          'A sense of fear about not buying the product',
          'A factual comparison between two products',
          "A gap between the viewer's reality and an idealised life, with the product positioned as the solution",
          'An accurate representation of everyday life',
        ],
        correct: 2,
        explanation:
          'Aspirational imagery shows life as more beautiful, successful, or exciting than reality. This creates a gap between what the viewer has and what they want, and the product is positioned as the way to close that gap.',
      },
      {
        id: 'y8t3-m9-q5',
        question:
          'When analysing an advertisement, what should you do BEYOND simply describing what you see?',
        options: [
          'Count the number of words used',
          'Explain how the visual techniques are designed to make the audience think, feel, or act',
          'Compare it to at least three other advertisements',
          'Identify the exact cost of the product',
        ],
        correct: 1,
        explanation:
          'Description alone is not analysis. You must explain how each technique - colour, composition, endorsement, narrative - is designed to influence the audience. Always connect what you see to the intended effect on the viewer.',
      },
    ],
  },
    ...
    quiz: [
      {
        id: 'y8t3-m10-q1',
        question:
          'Why is it important to define your target audience before writing a persuasive text?',
        options: [
          'So you can use the most complicated vocabulary possible',
          'Because every text must be written for adults',
          'Because the audience determines your tone, vocabulary, examples, and approach',
          'Because your teacher needs to know who you are writing for',
        ],
        correct: 2,
        explanation:
          'Understanding your specific audience shapes every element of your text. The same message requires different language, evidence, tone, and platform depending on whether you are addressing teenagers, parents, politicians, or business owners.',
      },
      {
        id: 'y8t3-m10-q2',
        question:
          'What percentage of newspaper readers typically read only the headline without reading the full article?',
        options: ['20%', '50%', '65%', '80%'],
        correct: 3,
        explanation:
          'Approximately 80% of readers read only the headline. This makes the headline the most important sentence in any article - it must capture attention and communicate the core message even if the reader goes no further.',
      },
      {
        id: 'y8t3-m10-q3',
        question: 'Why should you address counter-arguments in your persuasive writing?',
        options: [
          'To confuse the reader with multiple viewpoints',
          'To show you have considered other perspectives, which builds your credibility',
          'Because you must agree with both sides of every issue',
          'To make your text longer and more impressive',
        ],
        correct: 1,
        explanation:
          'Addressing and refuting counter-arguments shows the reader that you have considered alternative viewpoints and found them unconvincing. This makes your own argument seem more thorough, balanced, and trustworthy.',
      },
      {
        id: 'y8t3-m10-q4',
        question: 'What is a "lead" (or "lede") in journalism?',
        options: [
          'The journalist who leads the investigation',
          'The opening paragraph that establishes the story and hooks the reader',
          'The final paragraph that summarises the article',
          'The headline of the article',
        ],
        correct: 1,
        explanation:
          "The lead (or lede) is the opening paragraph of a journalistic piece. It must deliver on the headline's promise, establish the topic and angle, and give the reader a compelling reason to continue.",
      },
      {
        id: 'y8t3-m10-q5',
        question: 'Which of these is the MOST effective purpose statement for a persuasive text?',
        options: [
          '"I want to write about the environment"',
          '"I want to persuade people"',
          '"I want parents at my school to sign a petition supporting meat-free Mondays in the canteen"',
          '"I want to get a good mark on this assignment"',
        ],
        correct: 2,
        explanation:
          'A specific, actionable purpose guides every writing decision. "Persuade parents to sign a petition for meat-free Mondays" tells you exactly who to target, what action you want, and what topic to focus on, making your writing focused and effective.',
      },
    ],
  },
...
<div class="common-mistake"><strong>Common Mistake:</strong> Using the same register for every writing task. Students who always write in the same style - whether always informal or always overly formal - miss easy marks. Practise shifting between registers until it feels natural.</div>`,
    quiz: [
      {
        id: 'y8t3-m11-q1',
        question: 'What three factors determine the appropriate register?',
        options: [
          'Spelling, grammar, and punctuation',
          'Audience, purpose, and context',
          'Length, vocabulary, and font size',
          'Introduction, body, and conclusion',
        ],
        correct: 1,
        explanation:
          'Register is determined by who you are communicating with (audience), what you are trying to achieve (purpose), and the situation in which the communication takes place (context). These three factors together tell you how formal or informal your language should be.',
      },
      {
        id: 'y8t3-m11-q2',
        question:
          'A student writes a formal letter of complaint using slang and abbreviations. What is the problem?',
        options: [
          'The letter is too short',
          "The register does not match the form, which undermines the writer's credibility",
          'Slang is always wrong in English',
          'The student should have written an email instead',
        ],
        correct: 1,
        explanation:
          "Using an informal register in a formal context undermines the writer's seriousness and credibility. The recipient is unlikely to take the complaint seriously if the language does not match the conventions of a formal letter.",
      },
      {
        id: 'y8t3-m11-q3',
        question: 'Which register would be most appropriate for an article in a teenage magazine?',
        options: ['Frozen/static', 'Formal academic', 'Consultative to casual', 'Legal'],
        correct: 2,
        explanation:
          'A teenage magazine requires engaging, relatable language that connects with young readers. A consultative to casual register uses direct address, rhetorical questions, and accessible vocabulary without being so informal that it loses credibility.',
      },
      {
        id: 'y8t3-m11-q4',
        question: 'Why is using simple language to explain a complex idea NOT "dumbing down"?',
        options: [
          'Because simple language is always better than complex language',
          'Because clear communication without losing accuracy is a sign of skill, not weakness',
          'Because complex ideas do not exist',
          'Because examiners prefer short words',
        ],
        correct: 1,
        explanation:
          'The ability to explain complex ideas in accessible language demonstrates deep understanding and communication skill. "Dumbing down" means losing accuracy or oversimplifying. Clear, simple language that maintains accuracy is effective communication.',
      },
      {
        id: 'y8t3-m11-q5',
        question:
          'If an exam task says "Write a speech for your year group assembly," what register should you use?',
        options: [
          'Frozen/static, with legal language',
          'Very casual, with lots of slang',
          'Consultative - direct, energetic, and engaging but still appropriate for school',
          'Formal academic, with complex vocabulary and long sentences',
        ],
        correct: 2,
        explanation:
          'A year group assembly speech requires a consultative register: direct, engaging, and energetic enough to hold students\' attention, but appropriate for a school setting. It should use "you," rhetorical questions, and a conversational but purposeful tone.',
      },
    ],
  },
    ...
    quiz: [
      {
        id: 'y8t3-m12-q1',
        question:
          'In the WHAT-HOW-WHY framework for speech analysis, what does the "WHY" step require you to do?',
        options: [
          'Explain what the technique is called',
          "Describe the audience's emotional reaction",
          "Connect the technique to the speaker's overall purpose and goal",
          'Provide a quotation from the speech',
        ],
        correct: 2,
        explanation:
          'The WHY step requires you to explain why the speaker chose this particular technique - how it serves their overall argument, purpose, or goal. This is what separates analysis from mere identification and shows deep understanding of rhetorical strategy.',
      },
      {
        id: 'y8t3-m12-q2',
        question: 'What is the main problem with "feature-spotting" in speech analysis?',
        options: [
          'It takes too long',
          'It identifies techniques without explaining their effects, which is description rather than analysis',
          'It uses too many technical terms',
          'It focuses on the wrong techniques',
        ],
        correct: 1,
        explanation:
          'Feature-spotting means naming techniques without explaining what they do or why they matter. Writing "the speaker uses alliteration" without analysing its effect is like saying "the painter used paint" - it is true but meaningless as analysis.',
      },
      {
        id: 'y8t3-m12-q3',
        question: 'How long should you spend planning before a timed persuasive writing task?',
        options: [
        ...
        correct: 1,
        explanation:
          'Five minutes of planning is the most productive time you can spend. It prevents you from writing without direction, ensures a balanced structure, and results in a stronger response than an unplanned piece that is written for the full time.',
      },
      {
        id: 'y8t3-m12-q4',
        question: 'Which of these statements demonstrates the strongest analytical writing?',
        options: [
          '"The speaker uses emotive language."',
          '"The speaker tries to make the audience sad."',
          '"The vivid imagery of empty classrooms forces the audience to confront the tangible consequences of underfunding."',
          '"The speaker uses lots of good techniques."',
        ],
        correct: 2,
        explanation:
          'This statement identifies a specific technique (vivid imagery), provides a concrete example (empty classrooms), explains the effect on the audience (forces them to confront consequences), and connects it to the broader argument (underfunding). This is the level of specificity and depth that earns the highest marks.',
      },
      {
        id: 'y8t3-m12-q5',
        question: 'What separates a "good" persuasive writing response from an "excellent" one?',
        options: [
          'Length - excellent responses are always longer',
          'Excellent responses use more complicated vocabulary',
          'Excellent responses consider how techniques work together and how context shapes meaning',
          'Excellent responses always include at least ten rhetorical devices',
        ],
        correct: 2,
        explanation:
          'Excellence in persuasive writing comes from sophistication: understanding how techniques combine, how context affects meaning, and how the same device could work differently in another situation. It is about depth of thinking, not length or complexity of vocabulary.',
      },
    ],
  },
]
