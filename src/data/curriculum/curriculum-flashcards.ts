...
const year7KeyQuotations: FlashcardDeck = {
  ...
  cards: [
    ...
    { id: 'y7kq-5', front: 'Which text: "Mr and Mrs Dursley, of number four, Privet Drive, were proud to say that they were perfectly normal"?', back: 'The opening of Harry Potter and the Philosopher\'s Stone by J.K. Rowling.\n\nEffect: Ironic tone immediately hints that things are about to become very abnormal.' },
