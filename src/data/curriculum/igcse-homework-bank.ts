...
export const igcseHomeworkBank: IGCSEHomeworkTask[] = [
...

  {
    ...
    examQuestion: 'Write a description of a place that was important to you in childhood.',
    taskDescription:
  ...
  },
  {
    ...
    subject: 'Language P2',
    type: 'extended-writing',
    examQuestion: 'Write a story that begins with the sentence: "No one was supposed to find it."',
    taskDescription:
...

  {
    ...
    type: 'close-reading',
    examQuestion: 'How does Shelley present the theme of power in "Ozymandias"?',
    taskDescription:
  ...
  },
  {
    ...
    subject: 'Literature - Poetry',
    type: 'close-reading',
    examQuestion: 'How does Browning present the character of the Duke in "My Last Duchess"?',
    taskDescription:
...

  {
    ...
    type: 'extended-writing',
    examQuestion: 'How does Steinbeck present the character of Lennie Small in "Of Mice and Men"?',
    taskDescription:
  ...
  },
  {
    ...
    subject: 'Literature - OMAM',
    type: 'extended-writing',
    examQuestion: 'How does Steinbeck explore the theme of loneliness in "Of Mice and Men"?',
    taskDescription:
  ...
  },
  {
    ...
    subject: 'Literature - Macbeth',
    type: 'extended-writing',
    examQuestion: 'How does Shakespeare explore the theme of ambition in "Macbeth"?',
    taskDescription:
  ...
  },
  {
    ...
    subject: 'Literature - Macbeth',
    type: 'essay-plan',
    examQuestion: "To what extent is Macbeth presented as a tragic hero in Shakespeare's play?",
    taskDescription:
