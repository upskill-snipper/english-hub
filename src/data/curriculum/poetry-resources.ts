    ...
    keyDevices: [
      {
        ...
        example:
          "'My love is like a red, red rose' -- the speaker compares their feeling to something vivid in nature",
      },
      {
        device: 'Metaphor',
        definition: "A direct comparison that states one thing is another, without 'like' or 'as'",
        example:
          "'Life is a journey' -- the poet merges two ideas to suggest movement, choices, and an eventual destination",
      },
      {
        device: 'Personification',
        definition: 'Giving human qualities to a non-human thing',
        example:
          "'The wind howled through the trees' -- the wind is given a voice and a feeling, making nature seem threatening",
      },
      {
        device: 'Alliteration',
        definition: 'Repetition of the same consonant sound at the start of nearby words',
        example:
          "'The fair breeze blew, the white foam flew' -- the repeated 'f' and 'b' sounds create a rushing, airy effect",
      },
      {
        device: 'Rhyme',
      ...
      },
      {
        ...
        example:
          'A fast, short-lined rhythm can mirror urgency or excitement; a slow, long-lined rhythm can feel solemn',
      },
    ],
    discussionQuestions: [
    ...
    keyDevices: [
      {
        device: 'Ballad form',
        definition:
          'A narrative poem often with a regular ABCB rhyme scheme and strong rhythm, rooted in oral tradition',
        example:
          'Many folk tale poems use ballad stanzas to give the feeling of a story passed down through generations',
      },
      {
        device: 'Refrain',
        definition: 'A line or group of lines repeated at regular intervals throughout a poem',
        example:
          "A repeated refrain such as 'And still the river rolls along' builds a sense of inevitability or warning",
      },
      {
        device: 'Archetype',
        definition: 'A character type or situation that appears across cultures and centuries',
        example:
          'The wise elder, the cunning trickster, and the brave hero are archetypes found in folk tale poems worldwide',
      },
      {
        device: 'Dialogue',
        definition:
          'Direct speech within the poem that reveals character and advances the narrative',
        example:
          "'Come, come,' the figure whispered, 'I know the road you seek' -- dialogue creates tension and characterisation",
      },
      {
        device: 'Imagery of the natural world',
        definition: 'Descriptions of landscape, weather, or animals that carry symbolic weight',
        example:
          'A dark forest, a crossroads, or a rising moon often signal danger or transformation in folk tale poems',
      },
      {
        device: 'Moral or lesson',
        definition: 'A message about human behaviour embedded in the story',
        example:
          'A character who acts out of greed might suffer a reversal of fortune, teaching a lesson without stating it directly',
      },
    ],
    discussionQuestions: [
    ...
    keyDevices: [
      {
        ...
        example:
          "'like old beggars under sacks' -- the soldiers are compared to destitute old men, stripping away any romantic notion of heroism",
      },
      {
        device: 'Sibilance',
        definition: "Repetition of 's' sounds, often creating a hissing or unsettling effect",
        example:
          "'Gas! GAS! Quick, boys!' -- the sudden consonants contrast with the slow sibilance of the gas itself",
      },
      {
        device: 'Visceral imagery',
        definition:
          'Graphic, bodily description designed to force the reader to confront physical reality',
        example:
          "'the white eyes writhing in his face' -- the image is deliberately difficult to look away from",
      },
      {
        device: 'Direct address',
        definition:
          "The poet speaks directly to 'you', implicating the reader in the poem's argument",
        example:
          "'you would not tell with such high zest / To children ardent for some desperate glory' -- the reader is challenged",
      },
      {
        device: 'Irony',
        definition: 'A contrast between what is said and what is meant, often to expose hypocrisy',
        example:
          "The Latin 'dulce et decorum est pro patria mori' (sweet and fitting it is to die for one's country) is labelled 'the old Lie'",
      },
      {
        device: 'Irregular structure',
        definition: 'Owen disrupts the expected sonnet-like form to mirror the chaos of war',
        example:
          "The poem's shifting stanza lengths reflect the unpredictability of the battlefield",
      },
    ],
    discussionQuestions: [
    ...
    keyDevices: [
      {
        ...
        example:
          "'Our brains ache, in the merciless iced east winds that knive us' -- the wind is an active, cruel attacker",
      },
      {
        device: 'Para-rhyme (half-rhyme)',
        definition:
          'End words that share consonants but differ in vowel sounds, creating a sense of dissonance',
        example:
          "'knive us / nervous' -- the near-rhyme feels unsatisfying and unsettled, reflecting the men's mental state. Teacher note: Owen's coinage -- cite exactly as printed; do not 'correct' to 'knife'.",
      },
      {
        device: 'Repetition',
        definition:
          'The return of a word, phrase, or structure to build emphasis or a sense of futility',
        example:
          "'But nothing happens' appears three times, each time undercutting any hope of action or relief",
      },
      {
      ...
      },
      {
        ...
        example:
          "'Is it that we are dying?' -- the question is both literal and philosophical, reflecting existential doubt",
      },
      {
        device: 'Sensory detail',
        definition: 'Precise descriptions of what can be felt, heard, seen, or touched',
        example:
          "'Pale flakes with fingering stealth come feeling for our faces' -- the snow is tactile and predatory",
      },
    ],
    discussionQuestions: [
    ...
    keyDevices: [
      {
        ...
        example:
          'A poem that opens with celebration and then shifts to grief contains a volta that is central to its meaning',
      },
      {
        device: 'Ambiguity',
        definition:
          'Language that can be read in more than one way, inviting multiple interpretations',
        example:
          "A word like 'still' can mean motionless or continuing -- poets often exploit such ambiguity deliberately",
      },
      {
        device: 'Tone',
        definition:
          "The poet's or speaker's attitude towards the subject, conveyed through word choice",
        example:
          'A poem about death might be elegiac, bitter, celebratory, or resigned -- tone shapes everything',
      },
      {
        device: 'Free verse',
        definition: 'Poetry without a regular rhyme scheme or metrical pattern',
        example:
          'Free verse can suggest freedom, chaos, or naturalistic speech, depending on the context',
      },
      {
        device: 'Enjambment',
        definition: 'When a sentence or clause runs on beyond the end of a line without pause',
        example:
          'Enjambment creates momentum and can place surprising emphasis on the first word of the next line',
      },
      {
        device: 'Caesura',
        definition: 'A strong pause within a line, often marked by punctuation',
        example:
          'A mid-line full stop creates a dramatic halt, forcing the reader to pause and reconsider',
      },
    ],
    discussionQuestions: [
    ...
    keyDevices: [
      {
        ...
        definition:
          'A group of words associated with the same topic or concept, creating a dominant impression',
        example:
          'A semantic field of violence (wound, scar, blade, bruise) colours an entire poem with menace even without explicit description',
      },
      {
        device: 'Juxtaposition',
        definition: 'Placing two contrasting ideas, images, or situations side by side for effect',
        example:
          'Juxtaposing beauty and destruction, or power and vulnerability, creates irony or complexity',
      },
      {
        device: 'Anaphora',
        definition:
        ...
        example:
          "Repeated 'I am' statements build a commanding, assertive voice; repeated 'We' creates collective solidarity",
      },
      {
        device: 'Symbolism',
        definition: 'An object, image, or event that represents a larger idea',
        example:
          'A crumbling statue can symbolise the decay of power; a river can symbolise the passage of time',
      },
      {
        device: 'Dramatic monologue',
        definition: 'A poem in the voice of a single speaker addressing a silent listener',
        example:
          'The form creates dramatic irony if the speaker unwittingly reveals more than they intend',
      },
      {
        device: 'Euphemism',
        definition: 'A mild or indirect word substituted for one considered harsh or blunt',
        example:
          "A poet using euphemism for death or violence can suggest the speaker's discomfort or self-deception",
      },
    ],
    discussionQuestions: [
    ...
    keyDevices: [
      {
        ...
        example:
          "'Look on my Works, ye Mighty, and despair!' is ironic: there are no works to look on, only ruins",
      },
      {
        device: 'Personification of the sculpture',
        definition:
          "The statue's 'sneer of cold command' gives it a personality that outlives its subject",
        example:
          "The sculptor has captured the king's arrogance in stone, making the expression immortal while the empire decays",
      },
      {
        device: 'Layered narration',
        definition:
          "The poem uses multiple narrators to create ironic distance between the tyrant's self-image and his reality",
        example:
          "Shelley -- the first-person speaker -- a traveller -- the king's inscription: each layer adds perspective",
      },
      {
        device: 'Oxymoron',
        definition: 'Two contradictory terms placed together',
        example:
          "'colossal Wreck' -- the grandeur of 'colossal' collides with the degradation of 'Wreck'",
      },
      {
        device: 'Imagery of decay and emptiness',
        definition:
          'Descriptions of sand, ruins, and vastness suggest the inevitable erosion of power',
        example:
          "'the lone and level sands stretch far away' -- the final image of infinite emptiness swallows all ambition",
      },
      {
        device: 'Sonnet form with disruptions',
        definition:
          'The poem loosely follows sonnet structure but does not resolve neatly, mirroring its refusal to celebrate power',
        example:
          "The lack of a neat resolution reflects the poem's argument that power does not lead to lasting order",
      },
    ],
    discussionQuestions: [
    ...
    keyDevices: [
      {
        device: 'Dramatic monologue',
        definition:
          'A poem in which a single speaker addresses a silent listener, unwittingly revealing their character',
        example:
          'The Duke believes he is in control of his narrative, but the reader sees his jealousy, pride, and implied violence',
      },
      {
      ...
      },
      {
        ...
        definition:
          'The conversational flow of iambic pentameter with enjambment creates a naturalistic, controlling voice',
        example:
          "The Duke's speech seems almost casual, masking the menace beneath -- the smoothness is itself unsettling",
      },
      {
        device: 'Euphemism and implication',
        definition:
          'The Duke never directly states what happened to the Duchess -- he implies it through indirect language',
        example:
          "'I gave commands; / Then all smiles stopped together' -- the euphemism makes the violence more chilling",
      },
      {
      ...
      },
      {
        ...
        definition:
          "Confining the Duchess to a painting represents the Duke's desire to control and silence her",
        example:
          'In the painting, he controls who sees her smile -- the exact thing he could not control in life',
      },
    ],
    discussionQuestions: [
    ...
    keyDevices: [
      {
        ...
        example:
          'Locating the volta helps you understand what the poem is building towards or moving away from',
      },
      {
        device: 'Speaker and voice',
        definition: "Who is speaking, and what is their relationship to the poem's subject?",
        example:
          'A first-person speaker creates intimacy; a third-person speaker can create distance or objectivity',
      },
      {
        device: 'Imagery patterns',
        definition: 'Recurring groups of images or metaphors that build a consistent impression',
        example:
          "If a poem consistently uses water imagery -- flood, tide, drowning -- this semantic field shapes the whole poem's meaning",
      },
      {
        device: 'Structural contrast',
        definition:
          'Using different stanza lengths, rhyme patterns, or line lengths to signal a contrast in ideas or emotions',
        example:
          'A long, flowing stanza followed by a single short line creates emphasis through contrast',
      },
      {
        device: 'Connotation',
        definition:
          'The associations and implications carried by a word beyond its literal meaning',
        example:
          "The word 'still' can mean silent, motionless, or continuing -- its connotations depend on context",
      },
      {
        device: 'Tone shift',
        definition: "A change in the speaker's attitude during the poem",
        example:
          'A poem that opens in hope and ends in resignation creates its meaning through that shift',
      },
    ],
    discussionQuestions: [
    ...
    keyDevices: [
      {
        device: 'Elegy',
        definition:
          'A poem of lamentation for the dead, often moving from grief towards consolation',
        example:
          'Some war poems function as elegies for individual soldiers; others are elegies for an entire generation',
      },
      {
        device: 'Propaganda subversion',
        definition:
          'Using or inverting the language of patriotic propaganda to expose its dishonesty',
        example:
          'Owen, Sassoon, and others deliberately echo recruitment rhetoric and then undercut it with brutal reality',
      },
      {
        device: 'Collective voice',
        definition: "Using 'we' to speak on behalf of a group, creating solidarity or shared fate",
        example:
          "The collective 'we' in 'Exposure' places the reader alongside the soldiers in the frozen trench",
      },
      {
        device: 'Understatement',
        definition:
          'Saying less than the full truth to create irony or to suggest the inadequacy of language before terrible events',
        example:
          "A poet might describe a man's death in a single flat sentence precisely because the reality cannot be fully expressed",
      },
      {
        device: 'Historical allusion',
        definition:
          'References to specific battles, places, or events that add factual weight to the poem',
        example:
          "The Charge of the Light Brigade is a historical event; Tennyson's poem transforms it into myth and elegy",
      },
      {
        device: 'Contrast of home and front',
        definition:
          'Juxtaposing the safety and normality of civilian life with the horror of the battlefield',
        example:
          'This contrast creates pathos and also implied criticism of those who stayed home and did not understand',
      },
    ],
    discussionQuestions: [
