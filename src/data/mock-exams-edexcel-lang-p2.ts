        ...
        questions: [
          {
            id: 'edexcel-p2-a-q1',
            questionNumber: 1,
            questionText: 'What is the writer\'s main concern about the farming industry in Extract 1?',
            marks: 4,
          ...
          },
          {
            id: 'edexcel-p2-a-q2',
            questionNumber: 2,
            questionText: 'How does the writer of Extract 2 present the relationship between the speaker and her grandmother through language and detail?',
            marks: 8,
          ...
          },
          {
            id: 'edexcel-p2-a-q3',
            questionNumber: 3,
            questionText: 'Compare how the two extracts present attitudes towards knowledge and skill. How are the attitudes similar or different?',
            marks: 8,
            suggestedTimeMinutes: 12,
          ...
          },
          {
            id: 'edexcel-p2-a-q4',
            questionNumber: 4,
            questionText: 'Evaluate how effectively the writer of Extract 1 uses evidence to support the argument. Consider both the strengths and limitations of the evidence provided.',
            marks: 20,
        ...
        questions: [
          {
            id: 'edexcel-p2-b-q1',
            questionNumber: 1,
            questionText: 'What do you understand about the writer\'s feelings towards moving her mother into a care home?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
          ...
          },
          {
            id: 'edexcel-p2-b-q2',
            questionNumber: 2,
            questionText: 'How does the writer of Extract 2 use language to convey her experience of the seaside?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
          ...
          },
          {
            id: 'edexcel-p2-b-q3',
            questionNumber: 3,
            questionText: 'How far do the two extracts present different perspectives on modern life?',
            marks: 28,
        ...
        questions: [
          {
            id: 'edexcel-p2-c-q1',
            questionNumber: 1,
            questionText: 'According to Extract 1, what is the main problem with the national curriculum?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
          ...
          },
          {
            id: 'edexcel-p2-c-q2',
            questionNumber: 2,
            questionText: 'Analyse how the writer of Extract 2 conveys her loss of professional identity through language.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
          ...
          },
          {
            id: 'edexcel-p2-c-q3',
            questionNumber: 3,
            questionText: 'Both extracts are critical of contemporary systems. Which writer presents a more convincing critique, and why? You should refer to specific details from both extracts.',
            marks: 28,
            suggestedTimeMinutes: 38,
            questionType: 'extended-response',
            extract: `${P2_SET_C_EXTRACT_1}\n\n---\n\n${P2_SET_C_EXTRACT_2}`,
        ...
        questions: [
          {
            id: 'edexcel-p2-c-w1',
            questionNumber: 4,
            questionText: 'Write an article for a broadsheet newspaper in which you argue that a particular system or institution in contemporary life needs to be reformed. You should persuade your reader of the need for change.',
            marks: 56,
            suggestedTimeMinutes: 70,
            questionType: 'extended-writing',
            modelAnswers: {
              'Grade 4-5': 'The article would identify a system (education, healthcare, social media, etc.) and explain what is wrong with it. The writer would provide evidence — statistics, examples, personal anecdotes — to support the argument. The tone would be serious and analytical, appropriate to a broadsheet newspaper. The article would be structured with a headline, opening paragraph that states the problem, body paragraphs that develop the argument with evidence, and a conclusion that calls for change. The language would be clear and persuasive, with some use of rhetorical devices (repetition, rhetorical questions, vivid examples). Spelling and grammar would be accurate. The writer would anticipate possible counterarguments and address them.',
        ...
        questions: [
          {
            id: 'edexcel-p2-d-q1',
            questionNumber: 1,
            questionText: 'What is the key distinction the writer makes in Extract 1 between understanding AI and responsibility for AI?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
          ...
          },
          {
            id: 'edexcel-p2-d-q2',
            questionNumber: 2,
            questionText: 'How does the writer of Extract 2 use personal recollection to explore attitudes towards reading and literacy?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
          ...
          },
          {
            id: 'edexcel-p2-d-q3',
            questionNumber: 3,
            questionText: 'Compare the ways the two extracts present responsibility for contemporary change. How similar or different are the writers\' arguments?',
            marks: 28,
            suggestedTimeMinutes: 38,
            questionType: 'extended-response',
            extract: `${P2_SET_D_EXTRACT_1}\n\n---\n\n${P2_SET_D_EXTRACT_2}`,
        ...
        questions: [
          {
            id: 'edexcel-p2-e-q1',
            questionNumber: 1,
            questionText: 'What is the writer\'s main argument about high street homogenisation in Extract 1?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
          ...
          },
          {
            id: 'edexcel-p2-e-q2',
            questionNumber: 2,
            questionText: 'Analyse how the writer of Extract 2 conveys her experience of working in healthcare through language and tone.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
          ...
          },
          {
            id: 'edexcel-p2-e-q3',
            questionNumber: 3,
            questionText: 'Both extracts discuss systems that produce unintended or undesirable consequences. How similar are the writers\' explanations of why these systems persist?',
            marks: 28,
            suggestedTimeMinutes: 38,
            questionType: 'extended-response',
            extract: `${P2_SET_E_EXTRACT_1}\n\n---\n\n${P2_SET_E_EXTRACT_2}`,
        ...
        questions: [
          {
            id: 'edexcel-p2-f-q1',
            questionNumber: 1,
            questionText: 'According to Extract 1, what does the writer discover about grief from her own experience of loss?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
          ...
          },
          {
            id: 'edexcel-p2-f-q2',
            questionNumber: 2,
            questionText: 'How does the writer of Extract 2 use contrasts to present her argument about cooking?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
          ...
          },
          {
            id: 'edexcel-p2-f-q3',
            questionNumber: 3,
            questionText: 'Both extracts explore what makes life valuable and meaningful. How do the writers\' perspectives on value differ?',
            marks: 28,
            suggestedTimeMinutes: 38,
            questionType: 'extended-response',
            extract: `${P2_SET_F_EXTRACT_1}\n\n---\n\n${P2_SET_F_EXTRACT_2}`,
