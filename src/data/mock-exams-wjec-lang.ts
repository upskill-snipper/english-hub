  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          questionNumber: 3,
          questionText:
            'How does the writer create suspense in the passage? Analyze specific techniques.',
          marks: 12,
  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          questionNumber: 2,
          questionText:
            "Analyze how the writer's presentation of James changes as the passage progresses.",
          marks: 8,
          suggestedTimeMinutes: 15,
          questionType: 'analysis',
          markScheme: [],
  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          questionNumber: 3,
          questionText:
            "Analyze the writer's use of specific details to develop the passage's themes.",
          marks: 12,
          suggestedTimeMinutes: 20,
          questionType: 'analysis',
          markScheme: [],
          ...
          modelAnswers: [
            {
              gradeRange: '4-5',
              answer:
                'A grade 4-5 response will: Tell a clear, focused story with recognizable beginning, middle, and end; Use paragraphing to organize ideas; Employ a variety of sentence types and lengths; Use vocabulary accurately and with some precision; Demonstrate mostly accurate spelling and punctuation; Create sense of voice or perspective; Fully address the chosen prompt.',
            },
            {
              gradeRange: '6-7',
              answer:
      ...
      questions: [
        {
          ...
          questionNumber: 5,
          questionText:
            'Write a formal letter to your local council proposing a community initiative to revitalize your town center and encourage people to visit local shops and gather spaces.',
          marks: 40,
          suggestedTimeMinutes: 45,
  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          questionNumber: 4,
          questionText:
            "Analyze the writers' language choices in one extract to show how they emphasize the seriousness of their argument.",
          marks: 15,
          suggestedTimeMinutes: 20,
          questionType: 'analysis',
          markScheme: [],
  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          questionNumber: 3,
          questionText:
            'Both extracts discuss what is being lost in contemporary society. Compare the nature and significance of these losses.',
          marks: 12,
          suggestedTimeMinutes: 20,
          questionType: 'analysis',
          markScheme: [],
