    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              'In the final paragraph, Mrs Chen walks toward the doctor with no fear. Analyse how the writer shows this emotional state through language and detail.',
            marks: 12,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'A clear narrative that engages with the concept of the box as a container of meaning. There is a sense of purpose and mystery. Characters and settings are established. The language creates atmosphere and builds toward a moment of revelation. Vocabulary is appropriate and varied. Sentences are mostly well-constructed. The piece shows understanding of the prompt and creates a satisfying conclusion.',
              'Grade 6-7':
        ...
        questions: [
          {
            ...
            modelAnswers: {
              'Grade 4-5':
                'Maya is travelling to a place called Mala Zdar, which is not officially on the train timetable. She has been given instructions by her aunt, who has died. Maya is sure about her journey even though the guard thinks it might be a mistake. She has the address and the letter that her aunt sent her. She seems determined and purposeful, though she is on a journey alone. Her aunt has left her a mystery to solve.',
              'Grade 6-7':
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              'Analyse the final paragraph of the extract. What is the emotional and narrative significance of the letter Maya finds?',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_3_EXTRACT,
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              'The final paragraph focuses on Diane holding both the letter and the list. Analyse the significance of this final image and what it suggests about forgiveness and closure.',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_5_EXTRACT,
    ...
    sections: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText:
              'The final paragraph describes Eleanor becoming "nearly invisible, nearly indistinguishable from the landscape itself." Analyse this image and its significance for understanding Eleanor\'s experience of grief.',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_6_EXTRACT,
        ...
        questions: [
          {
            ...
            modelAnswers: {
              ...
              'Grade 6-7':
                "A well-developed narrative in which walking becomes a vehicle for internal exploration. The piece uses landscape to externalize emotional experience. The character's journey is both physical and psychological. Language is precise and evocative. The narrative has thematic depth and originality.",
              'Grade 8-9':
