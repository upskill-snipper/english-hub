...
// Each paper: 1h 45min (105 mins), 64 marks
// Section A: Reading (source text analysis) - 32 marks
// Section B: Writing (creative/imaginative) - 32 marks
...
const EDEXCEL_P1_MOCK_1_SOURCE = 'Contemporary literary fiction, 2024'
...
const EDEXCEL_P1_MOCK_4_EXTRACT = `The painting had been missing for forty-three years. Its owner — a museum curator named Marcus — knew this the way other people knew the weather: as a constant, unchangeable fact that shaped the landscape of daily life. The painting was a Chagall, worth perhaps a quarter of a million pounds, and it had vanished from a travelling exhibition in Brussels in 1981. Since then, it had been a ghost in the museum's collection — listed on the inventory, referenced in academic papers, mourned in the way art institutions mourn their lost pieces.
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText: 'What do you understand from the extract about Mrs Chen\'s feelings towards her time spent in the waiting room?',
            marks: 4,
            ...
            modelAnswers: {
              'Grade 4-5': 'Mrs Chen has been coming to the waiting room for six months. She knows it very well because she has spent so much time there. She is not waiting for good news — the doctor has been clear about that. She seems familiar with waiting and accepts that she must wait for time to pass. She seems calm about the situation even though it is difficult.',
              'Grade 6-7': 'Mrs Chen\'s relationship with the waiting room is one of resigned familiarity. She has developed an intimate knowledge of its details — the radiator\'s schedule, the receptionist\'s patterns, the displaced plastic leaf — which suggests she has processed her anxiety through obsessive attention to the space\'s minutiae. This cataloguing represents a form of control in an uncontrollable situation. Her reflection that she is "not waiting for good news" signals her emotional preparation for the worst. The phrase "she had trained herself not to feel afraid" indicates a deliberate psychological strategy of emotional suppression. The waiting room has become her liminal space of suspension — not fully in life, not yet facing its conclusions.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText: 'Analyse how the writer presents the waiting room and its atmosphere. Comment on language choices and their effects.',
            marks: 8,
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText: 'The extract suggests that the waiting room is "some other dimension where the normal rules no longer applied." What does the writer mean by this and how is it suggested?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_1_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_1_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The writer means that time moves differently in the waiting room compared to the outside world. Instead of feeling normal passing time, it feels like time has slowed down. This is suggested by the image of time itself slowing down. The waiting room is described in ways that make it seem separate from normal life. People are waiting in a state of suspension — they are not really living their normal lives while they wait. The "mysterious" lamp that never switches off suggests that normal rules about day and night don\'t apply. Mrs Chen\'s detailed knowledge of the routine suggests she experiences time differently here — she can notice patterns that most people would miss.',
              'Grade 6-7': 'The writer constructs the waiting room as a liminal space where temporal and ontological certainties collapse. The phrase "as if time itself had slowed down" suggests that causality and forward momentum are suspended; the waiting room becomes a temporal bubble detached from linear progression. The suggestion that "the waiting room existed in some other dimension" literalises this temporal dislocation — it is not merely metaphorically separate but literally unmoored from reality. The writer suggests this through several techniques: the ritual of the radiator ("clanks at precisely 9:47") creates a sense of mechanical repetition, time measured not by meaningful events but by the recurrence of meaningless actions. The description of the other occupants — their defensive postures, their attempts at distraction — suggests people existing in a state of psychological suspension, neither in the past nor future but in an eternal present of waiting. The lamp that "never switches off, even in daylight" violates the natural temporal order, suggesting the waiting room exists outside the normal cycles of day and night, activity and rest. The phrase about the "normal rules no longer applied" explicitly acknowledges that institutional spaces operate according to a different temporal logic, one where personal agency and individual time are surrendered to institutional time.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText: 'In the final paragraph, Mrs Chen walks toward the doctor with no fear. Analyse how the writer shows this emotional state through language and detail.',
            marks: 12,
            ...
            extractSource: EDEXCEL_P1_MOCK_1_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The writer says Mrs Chen "had trained herself not to feel afraid," which shows she has deliberately prepared herself emotionally. She feels "nothing" and has an "artificial concern." The phrase "empty face" suggests she has shut down her emotions. She walks toward the door with no resistance. The contrast with the other occupants who watch her creates a sense that she is moving with purpose while others remain stuck. The verb choices are controlled and measured — she "stood and walked" — suggesting deliberation rather than panic. She is accepting rather than resisting what comes next.',
              'Grade 6-7': 'The writer employs a rhetoric of emotional anaesthetisation to convey Mrs Chen\'s psychological response to imminent news of mortality. The reflection "she had trained herself not to feel afraid" functions as a retrospective analysis of years of emotional labour — she has deliberately constructed an affective architecture designed to withstand the anticipated trauma. This self-consciousness ("she felt nothing") is not numbness as involuntary symptom but as deliberate achievement, even if the achievement is incomplete: she "felt the artificial concern of her own empty face," suggesting a consciousness of her own performance. The verb "trained" carries military or athletic connotations — fear is constructed as an adversary to be overcome through discipline. Paradoxically, this emotional suppression becomes a form of resistance and agency; by refusing to feel fear, she asserts control in a situation designed to deny control. The final image of her walking through the door, observed by the other waiting occupants, transforms her into an object of projected anxiety — they see in her movement a preview of their own imminent summons. The asymmetry is crucial: they remain trapped in waiting; she moves beyond it, achieving a kind of stoic grace.',
              'Grade 8-9': 'The writer\'s final paragraph enacts a complex negotiation between volition and inevitability, agency and surrender. The temporal structure — "had trained herself," retrospective — suggests that Mrs Chen\'s current composure is the product of deliberate, sustained psychological work extending across months or years. The phrase "she felt nothing" contains a productive paradox: one must feel absence in order to report it, suggesting a layering of consciousness (the observer self observing the emotionally deadened self). This metacognitive awareness complicates any reading of simple numbness; her emotional suppression is performative, possibly even therapeutic. The adjective "artificial" regarding her concern marks her awareness of the performance; she knows she is performing concern and knows she is doing so inadequately ("empty face"). The verbs "stood and walked" are monosyllabic, deliberate, suggesting action stripped of hesitation or emotional excess. Architecturally, the final image — the other occupants watching her passage — creates what might be called a narrative of contagion: her stoicism becomes a kind of mirror in which they must view their own inevitable summons. In this reading, Mrs Chen\'s emotional restraint functions not as denial but as a form of existential honesty, a refusal of the false comfort of fear and hope alike.',
            },
            markScheme: [
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText: 'Write a story with the title "The Waiting".\n\nYour story should explore someone waiting for news, for a person, for a moment, or for something to change.',
            marks: 32,
            suggestedTimeMinutes: 50,
            questionType: 'extended-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear narrative exploring the emotional experience of waiting. The piece establishes why the character is waiting and conveys their emotional state. There is some use of descriptive language to create atmosphere. The narrative has a clear structure and reaches a conclusion or moment of significance. Vocabulary is generally appropriate; sentences are mostly correct. The piece shows understanding of the emotional dimensions of the prompt.',
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText: 'What do you understand from the extract about the significance of the box and the letters it contains?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText: 'Analyse how the writer uses time and memory to create emotional impact in this extract.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_2_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_2_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The writer shows time working in many different ways. Thomas is opening a box from his grandfather on his twenty-first birthday, but the letters inside are dated for future birthdays. This creates a connection between past, present, and future. The first letter contains a memory from when Thomas was four years old — the detail about skipping stones shows how specific and unchanged that memory is. The writer uses the verb "tasted" to show how vivid and sensory the memory is. The phrase "something that had been waiting a long time to move" shows how the present moment has been waiting since the grandfather\'s death. Time is not linear but connected.',
              'Grade 6-7': 'The writer manipulates temporal layering to create emotional resonance. The narrative moves through multiple timeframes simultaneously: the present moment (Thomas at twenty-one opening the box), the recent past (his grandfather\'s death), the distant past (his childhood at four), and the future (implied by the undated letters awaiting him). This temporal complexity mirrors the essential experience of the inheritance: the grandfather speaks from beyond death through a carefully constructed temporal apparatus. The phrase "a memory Thomas himself had almost forgotten" suggests that memory is unreliable until externally verified; the grandfather\'s act of remembering resurrects the memory in Thomas, making the past literally present. The sensory intensity of the recovered memory — "the sharp cold of the water, the weight of the stone in his small hand" — creates a synesthetic collision of past and present. The metaphor "holding time itself, compressed" literalises this temporal disruption: the box collapses time, making presence and absence, life and death, immediate and distant, simultaneously real. The final phrase, "when the world became too loud and he needed to remember that he had once been known completely," projects into an imagined future, suggesting that this moment of reading is itself a preparation for other moments, other needs for connection.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText: 'How does the writer present the relationship between Thomas and his grandfather through the language used in this extract?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_2_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_2_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The grandfather is not present in the extract but his presence is felt throughout. The letter shows he cares deeply about Thomas by remembering specific details from the past. The grandfather says he will "engineer an inheritance that would unfold across his entire life," which shows he has thought carefully about Thomas and wanted to stay connected to him. The mother says "He remembered everything," which shows the grandfather\'s love and attention. The relationship is one of care and knowledge rather than presence — the grandfather showed love through remembering and planning.',
              'Grade 6-7': 'The relationship is constructed through absence and architecture. The grandfather is dead but linguistically present through the letter; he speaks in imperative ("Read one letter on each of your birthdays") and in reminiscence. The letter exhibits a form of radical attentiveness: the grandfather remembers details (the specific number of skips, the temperature of the water) that suggest he was a fully present observer during that encounter. The metaphor "engineer an inheritance" elevates the grandfather\'s action from gift-giving to architectural design: the inheritance is not passive but deliberately constructed to create a specific temporal experience. Crucially, the grandfather\'s love is demonstrated not through presence (he is dead) but through forethought and memory — he has anticipated what Thomas will need and when he will need it. The mother\'s statement "He remembered everything" suggests that the grandfather\'s essential characteristic was his capacity for attention and documentation. The relationship thus becomes one where death interrupts presence but not continuity; the grandfather extends himself into the future through meticulous construction of a temporal apparatus designed to connect with his grandson across time.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText: 'The final paragraph contains the phrase "the answer to a question he had not yet asked himself." Analyse this phrase and its significance in the extract.',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_2_EXTRACT,
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText: 'Write a story with the title "The Box".\n\nYour story could involve discovering a box, opening a box, being given a box, or a box revealing a secret.',
            marks: 32,
            suggestedTimeMinutes: 50,
            questionType: 'extended-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear narrative that engages with the concept of the box as a container of meaning. There is a sense of purpose and mystery. Characters and settings are established. The language creates atmosphere and builds toward a moment of revelation. Vocabulary is appropriate and varied. Sentences are mostly well-constructed. The piece shows understanding of the prompt and creates a satisfying conclusion.',
              'Grade 6-7': 'A well-crafted narrative that uses the box as a vehicle for exploring themes of discovery, inheritance, secrecy, or identity. The writing is precise and evocative, with careful control of pacing and reveal. Characters are developed through action and detail. The setting enhances the emotional tone. Imagery and symbolism are employed effectively. Sentences are varied and purposeful. The narrative has depth and resonance beyond the surface level.',
              'Grade 8-9': 'An accomplished narrative that transforms the prompt into a vehicle for sophisticated exploration of theme and meaning. The box functions as symbol, catalyst, and metaphor. The writing demonstrates mastery of narrative technique (foreshadowing, juxtaposition, structural irony). Language is precise and layered, with effective use of imagery and symbolic resonance. The piece has psychological depth and thematic complexity. It engages the reader intellectually and emotionally.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText: 'What do you understand about Maya\'s journey and her emotional state as she arrives at the station?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              'Grade 4-5': 'Maya is travelling to a place called Mala Zdar, which is not officially on the train timetable. She has been given instructions by her aunt, who has died. Maya is sure about her journey even though the guard thinks it might be a mistake. She has the address and the letter that her aunt sent her. She seems determined and purposeful, though she is on a journey alone. Her aunt has left her a mystery to solve.',
              'Grade 6-7': 'Maya\'s journey is constructed as a pilgrimage, explicitly compared to "a pilgrim following a map to a holy place." Her emotional state combines determination with a kind of pious acceptance; she is "sure" in a way that transcends rational justification — she has only a letter, an address, and the dead aunt\'s instructions. The guard\'s concern ("You\'re sure?") marks Maya as an anomaly, someone choosing to travel to places that the official world does not recognize. This suggests her journey is both literal (geographical) and metaphorical (a quest for understanding or connection with the dead). The description of the town as existing "in a state of permanent abandonment" suggests that her destination mirrors the emotional terrain she is navigating: a place suspended between life and death, presence and absence, where time operates according to different rules.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText: 'Analyse how the writer creates a sense of mystery and otherworldliness in the extract.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_3_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_3_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The writer creates mystery through the description of the place. The train "did not acknowledge the existence of Mala Zdar," which is strange and puzzling. The station is "abandoned" and looks neglected. The description of the town as "genuinely dark" — the kind of dark "before electricity" or "after it had left" — makes it seem separated from normal time. The streets have names but no signs, and the buildings have windows but no lights. This repetition creates a pattern of absence. The writer says the house has a "modern" key that is "out of place" — suggesting time works strangely here. All these details create an uncanny, ghostly atmosphere.',
              'Grade 6-7': 'The writer constructs an atmosphere of ontological displacement through repeated inversions and absences. The train\'s non-acknowledgment of the station — "this train did not acknowledge the existence of Mala Zdar as a destination" — suggests that official reality (the timetable) has declared the place non-existent, yet it materially persists. The station is described with accumulating details of dilapidation (platform cracked, shelter collapsed) that suggest abandonment and temporal dislocation. The crucial phrase — "as though she had travelled not just geographically but temporally" — explicitly articulates the shift from literal to metaphorical space. The town itself is constructed through absences and inversions: "streets had names, but no signs"; "buildings had windows, but no lights." These balanced negations create a kind of grammatical doubling that enacts the uncanny — we have the expected forms (streets, signs; buildings, lights) with the expected contents removed. The description of darkness as preceding or following electricity suggests time is non-linear, that the town exists outside the arc of modern civilization. The modern key "anachronistic," "as though hope itself was anachronistic" — makes an explicit comparison between temporal displacement and emotional register. The final image, the floral scent that "might have been her aunt, might have been the ghost of her aunt, might have been a memory," deliberately collapses categories of presence and absence, making the living ambiguous.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText: 'How does the writer use light and darkness in this extract to create meaning?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_3_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_3_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The darkness is very significant in the extract. The "single light bulb" at the station casts a "sickly yellow" light, which is unpleasant and unhealthy. The town is described as "genuinely dark," which is more than just nighttime darkness. The writer explains that this darkness is the kind that existed "before electricity had arrived, or after it had left." This suggests the place is primitive or abandoned, cut off from modern civilization. Maya uses her phone\'s torch to light the way, showing that modern light is the only source of illumination here. The light is used to show isolation and otherness — this place lacks normal electricity and light.',
              'Grade 6-7': 'Light functions as a marker of civilization, temporality, and presence; its absence signals the town\'s liminal status. The "single light bulb" producing "sickly yellow" light suggests light here is diseased or corrupted, not the wholesome illumination of normal spaces. The narrator\'s elaboration of darkness — "the kind of dark that existed in places before electricity had arrived, or after it had left" — is temporally ambiguous: it could be primitivity or post-civilizational decay. This uncertainty is productive, suggesting the town exists outside progressive temporal narratives. Maya\'s phone torch becomes the intrusion of modern consciousness into this space; its "beam cutting through darkness" enacts a kind of violence, the imposition of contemporary understanding onto something that resists it. The lack of lights in buildings signals absence of habitation or consciousness. The overall effect is to construct light not as presence but as an intruder, a temporary illumination of fundamentally dark spaces that cannot be domesticated by ordinary light. This supports the implicit suggestion that Maya\'s journey is into a space of death or deep interiority.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText: 'Analyse the final paragraph of the extract. What is the emotional and narrative significance of the letter Maya finds?',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_3_EXTRACT,
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText: 'Write a story with the title "The Journey".\n\nYour story could involve a physical journey, an emotional journey, a journey to an unexpected destination, or a journey that changes the character.',
            marks: 32,
            suggestedTimeMinutes: 50,
            questionType: 'extended-writing',
            modelAnswers: {
              'Grade 4-5': 'A clear narrative with a sense of progression and change. The journey is established and its purpose is understood. Setting details make the destination vivid. The character is affected by the journey, showing some transformation or understanding. Language is varied and appropriate. Sentences are mostly well-constructed. The piece shows understanding of the prompt and has narrative purpose.',
              'Grade 6-7': 'A well-developed narrative in which the journey serves as both literal and metaphorical structure. The destination is rendered through precise, selective detail. The character\'s internal experience is conveyed alongside external action. The journey enacts psychological or emotional transformation. Language is controlled and evocative. Pacing and structure serve the narrative. The piece has thematic depth and originality.',
              'Grade 8-9': 'An accomplished narrative in which journey becomes a vehicle for exploring identity, transformation, or understanding. The setting is rendered with poetic precision. The character\'s internal landscape mirrors external terrain. Language is sophisticated and layered, with effective use of symbolic resonance. The narrative structure enacts the journey\'s arc. The piece has philosophical depth and emotional authenticity.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText: 'What do you understand about Marcus\'s relationship to the painting and why its return is significant to him?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText: 'Analyse how the writer uses time and loss in this extract to create meaning.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_4_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_4_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'Time is very important in this extract. The painting has been missing for "forty-three years," which is a very long time. The specific number emphasizes how long Marcus has been affected by its loss. The text mentions "seven minutes" — the exact time the painting was stolen — showing that this short moment has defined the rest of Marcus\'s life. The phrase "haunted by the painting for forty-three years" suggests that loss operates across time and shapes the present. The restoration happens "too late" in the sense that Marcus cannot get back the time he spent grieving. But it happens at exactly the right moment for Marcus\'s emotional development.',
              'Grade 6-7': 'The writer structures the extract around temporal asymmetry: a seven-minute lapse in attention generates forty-three years of psychological consequence. The specificity of numbers — "forty-three," "seven," "twenty-two" — anchors abstract temporal experience in concrete measure, making loss quantifiable yet overwhelming. The phrase "for forty-three years" functions as refrain, emphasizing how profoundly a single moment can restructure a life. Paradoxically, the loss becomes simultaneously the most real and most impossible thing — real in its material consequence, impossible in its absence (the painting exists only as memory and loss). The metaphor "haunted by the painting" treats loss as spectral presence, as something that persists precisely through its absence. The writer emphasizes the belatedness of restoration: Marcus had "spent forty-three years thinking about it" before its return, meaning the internal work of mourning precedes and exceeds the external recovery. The final phrase — "finally let go" — suggests that closure arrives not when the lost object is recovered but when meaning can be reframed. The letter\'s statement, "it was not his fault," operates as a kind of temporal intervention, reaching backward through decades to modify the meaning of that original seven-minute failure.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText: 'How does the writer present the nature and significance of the painting itself?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_4_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_4_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The painting is small — just seventy centimeters square — but it is described as "far more valuable" than its monetary worth. It shows two figures flying through a starlit sky, with colors of red and blue, and a crescent moon. The writer emphasizes that it is "not Chagall\'s most famous work" and "Most people had never heard of it." This is significant because it shows that its value to Marcus is not about its fame or importance to the art world, but about personal significance and love. The painting is beautiful but not grand. Its significance is personal, not universal.',
              'Grade 6-7': 'The painting is presented as simultaneously modest and profound. Its small scale — "seventy centimetres square" — contradicts its enormous psychological weight, suggesting that significance is not proportional to physical magnitude. The writer emphasizes its obscurity: it is neither Chagall\'s most famous work nor widely known. This obscurity is crucial — if the painting were famous, its loss would be public and institutional; because it is obscure, its significance is purely personal and emotional. The imagery of the painting — "lovers in the night," bodies "intertwined," a "crescent moon hung like a promise" — suggests themes of connection, devotion, and hope. But the writer does not sentimentalize these details; instead, they remain slightly distant, observed rather than effused over. The painting\'s value is thus separated from its monetary worth or cultural importance and located entirely in its capacity to carry human meaning. The thief\'s statement that it is "the most beautiful thing I have ever owned" confirms this: the painting\'s beauty is not objective but relational, existing in the relationship between object and observer.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText: 'The letter from the thief expresses a philosophy about ownership and beauty. Analyse this philosophy and its importance to the extract.',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_4_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_4_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The thief says that he kept the painting because it was beautiful, but now he wants to "know what it\'s like to have something you love belong to everyone instead of just to you." This is a philosophy about sharing beauty and love. The thief suggests that private ownership of beautiful things might be selfish, and that beauty is meant to be shared. By returning the painting, the thief shows he has learned that love means letting go. This philosophy is important because it explains the thief\'s motivation and also shows that the painting can now belong to the public. It transforms the theft from a crime into a kind of gift.',
              'Grade 6-7': 'The thief\'s philosophy operates as a kind of corrective to both the institution (which mourns the loss as loss of cultural property) and to Marcus (who has internalized guilt). The thief articulates a paradox: that possessing beauty privately is a diminishment, while sharing it is a form of completion. The phrase "what it\'s like to have something you love belong to everyone instead of just to you" suggests that love and beauty increase through distribution rather than diminish. This inversion of typical capitalist logic — where exclusive possession increases value — is crucial. The thief\'s aging ("I am old") suggests wisdom gained through time, through having lived with the consequences of possession. The philosophy reframes theft as temporary stewardship, a form of care that ultimately releases the object. The thief\'s observation that he has "followed [Marcus\'s] career" transforms the dynamic: instead of victim and perpetrator, they are revealed as fellow sufferers, both trapped by the painting\'s absence. The return of the painting becomes a gift not from thief to institution but from one human to another — a communication across decades and moral boundaries.',
            },
            markScheme: [
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText: 'Write a story titled "The Letter".\n\nYour story could involve writing a letter, receiving a letter, or a letter revealing something important.',
            marks: 32,
            suggestedTimeMinutes: 50,
            questionType: 'extended-writing',
            modelAnswers: {
              'Grade 4-5': 'A narrative that uses a letter as a significant element. The letter\'s contents are meaningful and affect the character. There is a clear reason why the letter matters. The piece shows the emotional impact of written communication. Language is varied and appropriate. Sentences are mostly well-constructed. The piece engages clearly with the prompt.',
              'Grade 6-7': 'A sophisticated narrative in which the letter functions as more than plot device — as revelation, confession, or bridge between past and present. The writing explores the power of written communication. The piece shows how letters can change meaning or understanding. Language is precise and controlled. The narrative has emotional resonance and originality.',
              'Grade 8-9': 'An accomplished narrative that explores the unique power of written communication and its ability to bridge time, absence, and silence. The letter becomes a site of complex meaning-making. Language is sophisticated and serves multiple narrative purposes. The piece has philosophical depth and emotional authenticity.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText: 'What do you understand about the relationship between Diane and her brother Michael, and how the letter changes her understanding of this relationship?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              'Grade 4-5': 'Diane and Michael had not seen each other for fifteen years. Their separation was not caused by a dramatic fight but by a slow drift. After their parents died, Michael moved away and they gradually lost connection. The letter reveals that Michael was sorry about the distance and that he always thought of her as his sister. The letter changes Diane\'s understanding because she learns that Michael\'s distance was caused by fear, not rejection. She learns that he never stopped loving her, and that forgiveness is possible even though he is dead.',
              'Grade 6-7': 'The relationship is constructed as a tragically attenuated sibling bond that has been severed not by dramatic rupture but by the slow accumulation of unprocessed grief. Diane\'s reflection that "grief had looked different to each of them" — Michael\'s as distance, Diane\'s as compulsive speech — reveals how emotional responses can create isolation even when rooted in shared loss. The fifteen-year separation thus represents not rejection but the failure of emotional language to bridge divergent responses to trauma. The letter functions as retrospective translation: what Diane had interpreted as Michael\'s abandonment is reframed as Michael\'s wound, his inability to witness his sister\'s grief without experiencing psychological collapse. The crucial revelation is "I never stopped thinking of you," which transforms the temporal narrative: the fifteen years of absence are revealed to be simultaneously filled with an invisible presence of continued connection. The list of childhood dreams becomes the evidence that connection predates the separation and persists beneath it.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText: 'Analyse how the writer uses the childhood list to create emotional significance.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_5_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_5_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The list shows the dreams Diane and Michael had together when they were young. It includes things like sailing around the world, climbing a mountain, and learning to play the violin together. The writer mentions that Diane "had terrible handwriting even then," which makes the memory specific and real. The list is important because it represents a time when Diane and Michael were connected and believed they would always be together. The letter writer, Michael, has kept this list for forty years, which shows it meant a lot to him. The list makes Diane cry because it represents what they lost — the friendship and shared dreams.',
              'Grade 6-7': 'The list functions as a palimpsest of unfulfilled potential and as material evidence of a shared imagined future that the present has failed to realize. The children\'s aspirations — sailing, climbing, musical collaboration — are small but ambitious, and they share a common feature: they are collaborative activities, not individual achievements. The detail about Diane\'s "terrible handwriting even then" creates specificity and establishes memory\'s particularity; it is a small observation that only someone who had been paying careful attention could preserve. Michael\'s preservation of the list across forty years represents a form of active remembrance, a refusal to let the shared past disappear. The contrast between the list\'s optimism and the adult reality of separation becomes poignant: the children who made these plans have not sailed together, climbed mountains together, or played violin together. Yet the list\'s very existence, preserved and transmitted through Michael\'s letter, becomes a different kind of connection: the list becomes proof that connection once existed. Diane\'s tears represent the collision of what was promised (eternal friendship) with what transpired (fifteen years of separation), mediated by the revelation that Michael held the promise constant across those years.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText: 'How does the writer use Michael\'s voice and perspective in the letter to create emotional impact?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_5_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_5_SOURCE,
            modelAnswers: {
              'Grade 4-5': '"The letter is written in Michael\'s voice directly to Diane. He says "I don\'t know how to write this," which shows his difficulty and honesty. He uses simple, direct sentences when talking about death: "The prognosis is not good." This makes it very real and not sentimental. He apologizes directly and admits his failure: "I was a coward. I was a child, really, even when I was a man." This honesty is powerful. He also says "I am not afraid of death" which is brave and meaningful. The letter is deeply personal and sincere, which makes it emotionally powerful. Michael speaks directly to Diane with love and regret.',
              'Grade 6-7': 'Michael\'s voice in the letter is characterized by hard-won honesty and undefended vulnerability. The opening statement — "I don\'t know how to write this, so I\'m just going to write it" — enacts a deliberate rejection of protective rhetorical strategies; he performs his struggle rather than concealing it. The direct address ("Dear Diane") and second-person pronouns create intimacy across the temporal and geographical distance. Michael\'s analysis of his own emotional failure is remarkably clear-eyed: he does not excuse his behavior but explains it ("the way your grief frightened me so much that I had to turn away from it"). This explanation is not absolution — it is contextual understanding that stops short of excuse. The statement "I was a child, really, even when I was a man" suggests a form of emotional immaturity that he recognizes only in retrospect. The paradox "I was not afraid of death. But I am sad about this" separates existential acceptance from relational grief: what Michael fears is not death but the loss of connection, the years wasted. The letter\'s fundamental movement is from confession (I was wrong) to assertion (you will always be my sister) — the assertion that relationship is not contingent on presence or behavior but ontological, unchanging.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText: 'The final paragraph focuses on Diane holding both the letter and the list. Analyse the significance of this final image and what it suggests about forgiveness and closure.',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_5_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_5_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'Diane holds the letter in one hand and the list in the other. The letter is Michael\'s voice and his apology and love. The list is the physical evidence of their shared past. Together, they represent past and present, what was and what is. The phrase "his brother\'s voice — arriving too late, arriving just in time, arriving at the only moment it could have arrived" is important because it shows that the timing is paradoxical. The letter is late because Michael is already dead, but it arrives at exactly the right moment because Diane is finally ready to understand. Forgiveness is suggested because Diane is holding both objects with care and emotion. The final phrase "Even if he was already gone" suggests that forgiveness is possible across death.',
              'Grade 6-7': 'The final image — Diane holding the letter in one hand and the list in the other — creates a physical embodiment of temporal paradox. One hand holds the present (the letter, arriving now), the other holds the past (the list, preserved across forty years). Her body becomes a site where past and present, absence and presence, meet. The phrase "his brother\'s voice" is crucial: the letter is not merely paper but voice, presence, communication achieved across the boundary of death. The temporal paradox is expressed as "arriving too late, arriving just in time, arriving at the only moment it could have arrived" — Michael\'s letter is temporally impossible and yet perfectly timed. The phrase suggests a form of narrative inevitability: as if all the years of separation were necessary preconditions for understanding the letter\'s contents. Forgiveness is not explicitly addressed — the text says "if you find it in yourself to forgive me" — but Diane\'s emotional response (tears) and her careful holding of both objects suggest forgiveness is not only possible but already accomplished. The final clause, "Even if he was already gone," reframes death not as ending but as the condition that makes authentic communication possible. Something about Michael\'s absence enables the letter\'s honesty; the distance across death permits confession.',
            },
            markScheme: [
              'Identifies the dual image of letter and list',
              'Understands temporal paradox',
              'Analyses the significance of holding both',
              'Explains forgiveness across death',
              'Shows sophisticated interpretation',
            ],
          },
        ],
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText: 'Write a story titled "Forgiveness".\n\nYour story could explore forgiveness between people, forgiveness of oneself, or whether forgiveness is possible.',
            marks: 32,
            suggestedTimeMinutes: 50,
            questionType: 'extended-writing',
            modelAnswers: {
              'Grade 4-5': 'A narrative that explores the complexity of forgiveness. The piece establishes what needs forgiving and why. The emotional significance of forgiveness or its absence is clear. Characters respond authentically to forgiveness or its denial. Language conveys emotional complexity. Sentences are varied and mostly correct. The piece engages meaningfully with the prompt.',
              'Grade 6-7': 'A sophisticated narrative that explores forgiveness as both individual and relational process. The piece examines what forgiveness requires and what it enables. The emotional subtlety of forgiveness is rendered through precise detail. The narrative avoids sentimentality while maintaining emotional authenticity. Language is controlled and precise. The piece has thematic resonance.',
              'Grade 8-9': 'An accomplished narrative that examines forgiveness as both impossible and necessary. The piece explores the paradox that forgiveness changes the forgiver more than the forgiven. Language is sophisticated and layered. The narrative structure creates complexity of meaning. The piece has philosophical depth and emotional authenticity.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText: 'What do you understand from the opening of the extract about Eleanor\'s emotional state and her relationship with grief?',
            marks: 4,
            suggestedTimeMinutes: 5,
            questionType: 'short-answer',
            ...
            modelAnswers: {
              'Grade 4-5': 'Eleanor has not expected to still be grieving two years after her husband\'s death. She thought grief would follow a timeline with stages, but she has learned that grief does not follow timelines. It comes unexpectedly. She can forget to be sad on a morning, then suddenly remember and feel grief. The snow in the opening makes her remember her husband, and she puts on his coat. This shows she is still connected to him through objects. Grief is something she has to manage and live with, not something she can complete.',
              'Grade 6-7': 'Eleanor\'s relationship with grief is characterized by dissonance between theoretical understanding (the staged, processual model implied by therapy and self-help literature) and lived experience (grief\'s unpredictability, its return despite the passage of time). The opening establishes that she has internalized narratives of grief as something with determinate temporal structure — "You were supposed to move through the stages, arrive at acceptance, begin again" — but her actual experience reveals grief as temporally unmoored. The phrase "grief was worst indoors, where it could concentrate, could gather weight" suggests that she understands grief spatially and materially, not abstractly. The putting-on of her husband\'s coat is a deliberate choice to inhabit his presence; the coat retains "the faint smell of his aftershave," suggesting that sensory memory persists where temporal distance has not yet healed emotional wounds. Two years of elapsed time has not produced acceptance but a fragile equilibrium, temporarily disturbed by snow.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText: 'Analyse how the writer uses snow and winter imagery to create atmosphere and reflect Eleanor\'s emotional state.',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_6_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_6_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'The snow is described as falling "quietly" and "gently," which creates a peaceful atmosphere. However, the writer also says it "covered everything," which suggests that the snow is erasing or hiding the world. The landscape is described as "simplified" — all complications removed. This mirrors Eleanor\'s emotional state: the snow matches the simplicity she finds in grief. The image of footprints being "covered" by new snow is significant because it suggests that even evidence of Eleanor\'s presence is erased. This reflects how grief can make you feel invisible or like you don\'t exist. The cold and numbness are both physical and emotional.',
              'Grade 6-7': 'The writer establishes snow as simultaneously obliterating and consoling. The opening image — snow falling "quietly, the way heavy things sometimes do" — creates a gentle personification that suggests compassion from the natural world. The phrase "transformed into something that resembled peace though it was actually just the absence of sound" is crucial: it distinguishes apparent peace from actual numbness, suggesting that Eleanor\'s internal state is not resolution but psychological shutdown. The snow\'s action of "covering everything" functions as a visual correlate to emotional suppression: grief is not processed but buried under layers. The detail about footprints being "covered" creates a temporal paradox: Eleanor leaves traces of her passage, but the snow erases them, suggesting both the compulsion to mark presence and the futility of that marking. The frozen pond becomes a central symbol: it should be transparent (ice visible beneath surface), but snow occludes it, making the "pond hidden" and "the past buried." This spatial configuration externalizes Eleanor\'s internal predicament: the past is accessible but concealed, present but invisible.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 3,
            questionText: 'The extract contains a memory of Eleanor and her husband skating. How does the writer use this memory to create meaning?',
            marks: 8,
            suggestedTimeMinutes: 12,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_6_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_6_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'Eleanor remembers skating with her husband on the same frozen pond. He held her hand and helped her because she was not a good skater. They laughed together and nearly fell. The memory is "so vivid" that Eleanor "could almost feel the ice under her feet." But then she realizes that she is standing on snow, not ice. The ice is hidden beneath the snow. This is significant because the memory is vivid but inaccessible, like the past. The memory reminds Eleanor of her husband\'s presence and care, but it is also painful because he is no longer there.',
              'Grade 6-7': 'The memory of skating functions as the extract\'s emotional center. It is characterized by tactile vividness — Eleanor can "almost feel the ice under her feet" — which creates the illusion of temporal collapse: past and present threaten to merge. The memory of his "hand in hers," his steadying presence as she negotiated the uncertainty of ice, becomes the physical embodiment of the relationship\'s essential quality: mutual support, vulnerability made safe by presence. The temporal marker "years ago, when he was still alive" emphasizes the past\'s closure. But the crucial turn occurs in the present: Eleanor is standing on snow, believing she is on ice, only to realize that the two are distinct, that the surface has changed. This realization becomes metaphorical: the past is accessible in memory but occluded by time\'s accumulation (snow covering ice). What Eleanor wanted was not merely to remember but to inhabit the past, to feel the ice, to have his hand in hers. The collapse of memory and present, of desire and reality, generates the emotional crisis that follows.',
            },
            markScheme: [
              'Identifies the memory\'s emotional significance',
              'Understands the vividity and the collapse it suggests',
          ...
          },
          {
            ...
            questionNumber: 4,
            questionText: 'The final paragraph describes Eleanor becoming "nearly invisible, nearly indistinguishable from the landscape itself." Analyse this image and its significance for understanding Eleanor\'s experience of grief.',
            marks: 12,
            suggestedTimeMinutes: 15,
            questionType: 'analysis',
            extract: EDEXCEL_P1_MOCK_6_EXTRACT,
            extractSource: EDEXCEL_P1_MOCK_6_SOURCE,
            modelAnswers: {
              'Grade 4-5': 'Eleanor becomes so covered with snow that she is nearly invisible. The image suggests that grief is consuming her identity; she is merging with the landscape. However, the writer says she becomes "part of the snow itself," which is not entirely negative. The phrase "except inside her own body, inside the weight of memory" is important because it shows that even though Eleanor is invisible externally, internally she is still aware and still carrying the memory of her husband. The final image of her walking back toward the world shows she is still moving forward despite the grief. The frozen tears suggest both sadness and a kind of transformation or acceptance.',
              'Grade 6-7': 'The image of Eleanor becoming "nearly invisible, nearly indistinguishable from the landscape" represents a kind of dissolution of self into environment. The near-total merge with snow suggests not death but a form of unbeing, a surrender to the external landscape that matches her internal emptiness. The qualifying words "nearly" and "nearly" are crucial: the dissolution is incomplete, always on the verge but never fully realized. This captures the peculiar experience of profound grief: the self persists even when it wishes to dissolve, even when it feels unmade. The phrase "except inside her own body, inside the weight of memory" creates a crucial distinction: externally, Eleanor is indistinguishable from landscape; internally, she remains a repository of memory and sensation. This formulation suggests that grief operates as a form of internal amplification even as external presence diminishes. The image of her walking back "toward the world" — back toward the town, house, the next day — is not triumph but continuation. The final image of tears freezing on her face suggests a kind of crystallization: emotion becomes literal (crystallized water), integrated into the landscape not through erasure but through transformation.',
              'Grade 8-9': 'The image enacts a paradox: Eleanor becomes indistinguishable from landscape precisely at the moment of maximum emotional intensity (tears). This collapse of self into environment is not annihilation but a strange form of presence — she exists as trace, as mark that the landscape bears even as it covers her. The qualifying "nearly" is essential: it suggests that absolute dissolution is impossible, that consciousness and memory persist as remainder even when everything else seems to have dissolved. The phrase "inside the weight of memory" positions memory not as transcendent or ethereal but as physical, as weight that the body carries. The movement toward landscape is not passive but described as deliberate choice ("She stood up slowly," "She turned around," "she began walking"). This agency-in-dissolution complicates any simple reading of surrender or defeat. The final transformation — tears freezing to ice — completes a cycle: water (tears, emotion) becomes solid (ice), becomes indistinguishable from the landscape\'s own substance. Eleanor does not escape grief through walking back to the town; rather, she has been fundamentally transformed by her encounter with it. She returns not as the person who left but as someone who has been crystallized by the experience of loss.',
            },
            markScheme: [
        ...
        questions: [
          {
            ...
            questionNumber: 1,
            questionText: 'Write a story titled "The Walk".\n\nYour story could involve someone taking a significant journey on foot, discovering something through walking, or walking as a form of escape or processing.',
            marks: 32,
            suggestedTimeMinutes: 50,
            questionType: 'extended-writing',
            modelAnswers: {
              'Grade 4-5': 'A narrative that uses walking as a significant element. The piece shows why the walk is important to the character. The landscape is described vividly. The character\'s internal experience is conveyed. The language creates atmosphere. Sentences are varied and mostly correct. The piece engages clearly with the prompt.',
              'Grade 6-7': 'A well-developed narrative in which walking becomes a vehicle for internal exploration. The piece uses landscape to externalize emotional experience. The character\'s journey is both physical and psychological. Language is precise and evocative. The narrative has thematic depth and originality.',
              'Grade 8-9': 'An accomplished narrative that uses walking and landscape as metaphor for emotional or existential journey. The piece explores how movement through space correlates with movement through consciousness. Language is sophisticated and layered. The narrative has philosophical depth.',
            },
            markScheme: [
          ...
          },
          {
            ...
            questionNumber: 2,
            questionText: 'Write a story titled "The Absence".\n\nYour story could explore the presence of absence, loss, or how people live with what or who is gone.',
            marks: 32,
            suggestedTimeMinutes: 50,
            questionType: 'extended-writing',
            modelAnswers: {
              'Grade 4-5': 'A narrative that explores loss and absence meaningfully. The piece establishes what is absent and why it matters. The character\'s relationship to absence is shown through detail and action. The language conveys emotional significance. Sentences are varied and mostly correct. The piece engages clearly with the prompt.',
              'Grade 6-7': 'A sophisticated narrative in which absence becomes a presence, in which what is missing structures the narrative. The piece explores how people construct lives around emptiness. Sensory and emotional details render absence tangibly. The narrative has thematic complexity and originality.',
              'Grade 8-9': 'An accomplished narrative that examines absence as paradoxical presence, as something that shapes consciousness and experience. The piece explores how memory and imagination make absence persist. Language is sophisticated and layered. The narrative has philosophical depth.',
            },
            markScheme: [
