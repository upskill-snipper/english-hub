    ...
    quiz: [
      {
        ...
        correct: 2,
        explanation:
          'In the CAIE 0475/0992 specification, all four Assessment Objectives are equally weighted at 25% each. This means you must balance textual knowledge, contextual understanding, language/form/structure analysis, and personal response in every answer.',
      },
      {
        ...
        correct: 1,
        explanation:
          'Understanding the literal meaning - who is speaking, to whom, about what - provides the necessary foundation for all subsequent layers of analysis. Without surface comprehension, deeper analysis will be inaccurate.',
      },
      {
        id: 'caie-poetry-m1-q3',
        question:
          'Why does the Songs of Ourselves anthology include poets from across the English-speaking world?',
        options: [
        ...
        correct: 1,
        explanation:
          "CAIE deliberately includes voices from Britain, the Caribbean, Africa, South Asia, and Australasia to test candidates' ability to engage with diverse cultural perspectives and understand how context influences literary meaning.",
      },
      {
        ...
        correct: 2,
        explanation:
          "CAIE examiners reward context that is woven into your analysis - for example, explaining how a post-colonial poet's word choice reflects their cultural position. Bolt-on context paragraphs that read like history notes do not earn strong AO2 marks.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'A simile makes an explicit comparison using "like" or "as", while a metaphor asserts identity between two things. Metaphors are generally considered more powerful because they claim equivalence rather than mere resemblance.',
      },
      {
        ...
        correct: 2,
        explanation:
          'Enjambment occurs when a sentence or phrase continues past the end of a line without punctuation, creating momentum and urgency. It contrasts with end-stopping, where each line concludes with a natural pause.',
      },
      {
        ...
        correct: 1,
        explanation:
          'The volta is a "turn" - a shift in the poem\'s argument, tone, or perspective. In a Petrarchan sonnet it typically occurs between the octave and sestet (after line 8); in a Shakespearean sonnet, the couplet often provides the volta.',
      },
      {
        id: 'caie-poetry-m2-q4',
        question:
          'Why is it insufficient to simply identify a technique such as "the poet uses alliteration"?',
        options: [
        ...
        correct: 2,
        explanation:
          'Identifying (feature-spotting) without analysis earns no AO3 marks. You must explain what effect the technique creates and why the poet chose it. Analysis means exploring meaning and impact, not just labelling.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The integrated method, where each paragraph examines both poems around a shared point of comparison, is strongly preferred. It produces a genuinely comparative response rather than two separate mini-essays.',
      },
      {
        ...
        correct: 2,
        explanation:
          'Evaluation - judging which approach is more effective and explaining why - demonstrates critical engagement (AO4) and moves your essay beyond description into genuine analysis. Examiners reward this quality over quantity.',
      },
      {
        ...
        correct: 1,
        explanation:
          'While theme, tone, form, and structure are all meaningful dimensions for comparison, the raw word count of a poem is a superficial metric that does not yield analytical insight. Comparison should focus on meaning and effect.',
      },
      {
        ...
        correct: 1,
        explanation:
          'Exploring both similarities and differences creates a nuanced, balanced argument. An essay that only finds agreement (or only disagreement) will feel one-dimensional and miss opportunities for deeper analysis.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The first reading should establish basic comprehension: who is speaking, what the subject is, and the overall tone. Analytical annotation comes on the second reading, once you have a secure foundation of understanding.',
      },
      {
        ...
        correct: 2,
        explanation:
          'Poems often use fictional or dramatic speakers (personas) who are distinct from the poet. Assuming the speaker is the poet is a form of biographical fallacy. Using "the speaker" or "the persona" demonstrates critical awareness of this distinction.',
      },
      {
        ...
        correct: 2,
        explanation:
          'For unseen poetry, AO2 can be addressed through literary context - discussing the traditions, conventions, or movements the poem appears to draw on - and by making reasonable inferences about context from evidence within the poem itself.',
      },
      {
        ...
        correct: 1,
        explanation:
          "Paraphrase restates what the poem says in your own words, which demonstrates comprehension but not analytical skill. Analysis examines how the poet's specific word choices, techniques, and structural decisions create particular effects and meanings.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Having the text available means you can focus entirely on close reading rather than recalling quotations. However, examiners compensate by expecting more detailed and precise analysis - surface comments earn fewer marks when you have the text in front of you.',
      },
      {
        ...
        correct: 2,
        explanation:
          'A strong opening introduces your conceptualised argument - a clear interpretive claim about how the poem presents its theme. This gives your essay direction and coherence from the outset, and tells the examiner you are arguing, not just describing.',
      },
      {
        ...
        correct: 1,
        explanation:
          'Three to five minutes of planning is optimal. It is enough to organise your key points and quotations without eating into valuable writing time. Planning ensures your essay has structure and coherence rather than becoming a stream of consciousness.',
      },
      {
        ...
        correct: 2,
        explanation:
          'The highest levels reward critical engagement with the text, well-selected evidence, sophisticated understanding of how writers create effects, coherent sustained argument, and an original personal interpretive voice - not mere length or vocabulary display.',
      },
    ],
  },
]
...
const poetryAssessment: CourseQuiz[] = [
  {
    ...
    question:
      'A CAIE exam question asks you to "explore how the poet conveys a sense of loss". What should your essay primarily focus on?',
    options: [
    ...
    correct: 1,
    explanation:
      'The word "how" in the question directs you to the poet\'s methods. Your essay must analyse language, form, and structure - not just identify moments of loss or list devices. Method and effect are at the heart of a strong response.',
  },
  {
    id: 'caie-poetry-assess-q2',
    question:
      'Which of the following best demonstrates the integration of context into a poetry analysis?',
    options: [
    ...
    correct: 1,
    explanation:
      "This option integrates context directly into analysis of the poet's technique (fractured syntax), explaining how the historical/cultural situation shapes the writer's language choices. The other options either state context without connecting it to the text or are too vague.",
  },
  {
    ...
    correct: 2,
    explanation:
      'The integrated method - organising by comparative points rather than by poem - produces a genuinely comparative response. Each paragraph explores both poems, making connections and distinctions that reveal deeper insight than writing about each poem separately.',
  },
]
    ...
    quiz: [
      {
        id: 'caie-prose-m1-q1',
        question:
          'Why should your first reading of a prose set text be immersive rather than analytical?',
        options: [
        ...
        correct: 1,
        explanation:
          'Your genuine emotional responses - surprise, tension, sympathy - provide the foundation for AO4 (personal response). Experiencing the text as a reader before analysing it as a student gives you authentic material for critical engagement.',
      },
      {
        id: 'caie-prose-m1-q2',
        ...
        correct: 1,
        explanation:
          'An unreliable narrator provides an account that the reader learns to question. The unreliability - whether from naivety, bias, or dishonesty - is a deliberate choice by the writer to create a gap between the narrator\'s version and the "truth" the reader must construct.',
      },
      {
        id: 'caie-prose-m1-q3',
        ...
        correct: 1,
        explanation:
          'CAIE passage-based questions may present an extract from any chapter or section of the text. Students who have only studied the opening and climax will be unprepared for questions on transitional or less dramatic passages.',
      },
      {
        id: 'caie-prose-m1-q4',
        ...
        correct: 1,
        explanation:
          'Discussing narrative voice shows you understand how the writer has structured the reading experience - who tells the story, what perspective the reader has access to, and why the writer made that choice. This is sophisticated AO3 analysis.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Treating characters as constructs means recognising that every aspect of a character is a deliberate authorial choice. This shifts your analysis from "what does the character do?" to "why did the writer create this character in this way?" - which is what earns high marks.',
      },
      {
        id: 'caie-prose-m2-q2',
        question:
          'Which method of characterisation involves the gap between public behaviour and private reality?',
        options: [
          'Direct description',
          'Dialogue',
        ...
        correct: 2,
        explanation:
          "When narration reveals a character's thoughts through first person, free indirect discourse, or omniscient narration, we see the often revealing gap between what a character says/does publicly and what they think privately. This gap is rich material for analysis.",
      },
      {
        id: 'caie-prose-m2-q3',
        ...
        correct: 1,
        explanation:
          'A static character remains essentially the same throughout the text. This is often a deliberate choice by the writer - the static character may represent a fixed value or serve as a foil to highlight changes in dynamic characters around them.',
      },
      {
        id: 'caie-prose-m2-q4',
        question:
          'Why is the phrase "the writer presents [character] as..." valuable in an exam essay?',
        options: [
        ...
        correct: 1,
        explanation:
          "This phrasing foregrounds the writer's agency and signals to the examiner that you understand characters are constructs. It keeps your analysis focused on authorial method rather than slipping into narrative retelling.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The subject is the surface topic (e.g., a family during wartime), while the theme is the abstract idea explored through that topic (e.g., sacrifice, loyalty, or the corruption of power). Analysis must engage with themes, not just describe subjects.',
      },
      {
        id: 'caie-prose-m3-q2',
        ...
        correct: 1,
        explanation:
          "While all three elements matter, HOW is the analytical core because it examines the writer's specific methods - language, structure, symbolism - that create meaning. This is where your close reading skills and AO3 analysis come into play.",
      },
      {
        id: 'caie-prose-m3-q3',
        question:
          'Why should you avoid treating a theme as "simple" (e.g., just saying "the theme of love")?',
        options: [
        ...
        correct: 2,
        explanation:
          'Defining themes precisely demonstrates nuanced understanding and allows for more sophisticated analysis. "Possessive love as a form of control" is a far more productive analytical starting point than simply "the theme of love".',
      },
      {
        id: 'caie-prose-m3-q4',
        ...
        correct: 1,
        explanation:
          "Recurring motifs - such as repeated images of walls, darkness, or water - act as thematic signals. Their repetition draws the reader's attention to the abstract ideas the writer is exploring and creates a pattern of meaning across the text.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Reading the question first gives you a lens through which to read the extract. If the question asks about atmosphere, you will naturally notice sensory details and setting; if it asks about character, you will focus on dialogue and description. This focused reading produces more relevant analysis.',
      },
      {
        id: 'caie-prose-m4-q2',
        ...
        correct: 1,
        explanation:
          "Free indirect discourse is a narrative technique where the narrator's voice blends with a character's thoughts, presenting the character's perspective without the formal markers of direct speech or explicit \"she thought\" tags. It creates intimacy while maintaining narrative control.",
      },
      {
        id: 'caie-prose-m4-q3',
        ...
        correct: 1,
        explanation:
          "Brief, integrated references to the wider text demonstrate AO1 (textual knowledge) and show you understand the extract's significance within the whole novel. These should be concise connections woven into your analysis, not lengthy plot summaries.",
      },
      {
        id: 'caie-prose-m4-q4',
        ...
        correct: 1,
        explanation:
          "Sentence length is a deliberate structural choice by the writer. Short, punchy sentences create urgency, tension, or blunt impact; long, flowing sentences create contemplation or build momentum. Variation controls the reader's pace and emotional experience.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'A strong thesis is specific, complex, and acknowledges nuance. One-dimensional claims produce one-dimensional essays. By acknowledging that a theme has multiple facets (e.g., "simultaneously seductive and destructive"), you create space for a rich, layered argument.',
      },
      {
        id: 'caie-prose-m5-q2',
        ...
        correct: 1,
        explanation:
          'Context should be inseparable from your analysis - explaining why the writer makes specific language, character, or structural choices. Bolt-on context paragraphs that read like history lessons do not earn strong marks because they are not connected to literary analysis.',
      },
      {
        id: 'caie-prose-m5-q3',
        question:
          'If you cannot recall an exact quotation in a memory-based essay, what should you do?',
        options: [
        ...
        correct: 2,
        explanation:
          "A precise textual reference - describing the specific moment, chapter, and the writer's approach - still demonstrates detailed textual knowledge (AO1) even without the exact wording. This is far better than inventing a quotation or abandoning the point.",
      },
      {
        id: 'caie-prose-m5-q4',
        ...
        correct: 2,
        explanation:
          "A strong conclusion synthesises your argument and offers a final evaluative judgement - about the writer's overall achievement, the text's significance, or the implications of your interpretation. Simply repeating the introduction wastes an opportunity to end with impact.",
      },
    ],
  },
]
...
const proseAssessment: CourseQuiz[] = [
  {
    ...
    question:
      'A CAIE exam question asks: "How does the writer present the relationship between [Character A] and [Character B]?" What should your essay primarily analyse?',
    options: [
    ...
    correct: 1,
    explanation:
      'The word "how" directs you to the writer\'s methods. Your essay must analyse the techniques used to present the relationship - dialogue, narrative perspective, symbolic association, structural juxtaposition - not just describe the interactions.',
  },
  {
    id: 'caie-prose-assess-q2',
    question:
      'Which of the following is the strongest example of integrated context in a prose analysis?',
    options: [
    ...
    correct: 1,
    explanation:
      "This option integrates context into analysis of the writer's technique (use of dialect), explaining how historical social structures shape the writer's language choices and what effect this creates. The other options either state context without analysis or are too vague.",
  },
  {
    id: 'caie-prose-assess-q3',
    question:
      'What is the key difference between passage-based and essay questions for CAIE prose?',
    options: [
    ...
    correct: 2,
    explanation:
      'The fundamental difference is access to the text. Passage-based questions provide an extract for detailed close reading, while essay questions require you to recall quotations from memory and demonstrate broad knowledge of the whole text.',
  },
]
    ...
    quiz: [
      {
        id: 'caie-drama-m1-q1',
        question:
          'What is the fundamental difference between drama and prose in terms of narration?',
        options: [
        ...
        correct: 1,
        explanation:
          'In drama, there is no narrator to mediate between the audience and the story. Everything the audience learns comes through dialogue, action, stage directions, and visual/auditory cues. This fundamentally shapes how meaning is created and how you should analyse it.',
      },
      {
        id: 'caie-drama-m1-q2',
        question:
          'Why should you refer to "the audience" rather than "the reader" when writing about drama?',
        options: [
        ...
        correct: 1,
        explanation:
          'Drama is fundamentally a performed art. Using "the audience" demonstrates awareness of this and shows you understand that the playwright creates effects for spectators who see and hear the action directly, without narratorial mediation.',
      },
      {
        id: 'caie-drama-m1-q3',
        ...
        correct: 1,
        explanation:
          "Subtext is the unspoken meaning beneath dialogue - what characters imply, conceal, or avoid saying. Much of drama's power lies in subtext, and analysing it demonstrates sophisticated understanding of how playwrights create meaning through what is left unsaid.",
      },
      {
        id: 'caie-drama-m1-q4',
        ...
        correct: 1,
        explanation:
          "Dramatic irony occurs when the audience possesses knowledge that a character lacks. This creates powerful effects - tension (we know danger is coming), pathos (we understand a character's ignorance), or dark humour. It is uniquely powerful in drama because of the audience's direct relationship with the action.",
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Proxemics refers to the use of physical space and distance between characters on stage. Closeness can suggest intimacy or threat; distance can suggest alienation or formality. Analysing proxemics demonstrates awareness of how staging creates meaning beyond dialogue.',
      },
      {
        id: 'caie-drama-m2-q2',
        ...
        correct: 2,
        explanation:
          'Silence is a deliberate dramatic tool. Pauses create tension, convey overwhelming emotion, reveal subtext (what is left unsaid), and can demonstrate power (whoever controls the silence controls the scene). Analysing silence shows sophisticated understanding of performance.',
      },
      {
        id: 'caie-drama-m2-q3',
        ...
        correct: 1,
        explanation:
          'Stichomythia is a technique where characters exchange rapid, short lines of dialogue in quick succession. It creates tension, conflict, or sharp wit and is commonly found in Shakespeare and classical drama. It accelerates the pace and intensifies the dramatic moment.',
      },
      {
        id: 'caie-drama-m2-q4',
        ...
        correct: 2,
        explanation:
          'Stage directions are integral to the dramatic text. They reveal character relationships, emotional states, power dynamics, and atmosphere. A direction like "[He turns away from her]" can be analysed for its significance just as meaningfully as a line of dialogue.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'The verse/prose distinction is deliberate and meaningful. Verse (typically blank verse) signals elevated status, emotional intensity, or formality. Prose signals lower social status, comedy, directness, or moments where a character drops their public persona. The switch between them always carries significance.',
      },
      {
        id: 'caie-drama-m3-q2',
      ...
      },
      {
        ...
        correct: 2,
        explanation:
          "Act 3 is typically the climax - the turning point of the play where the central conflict reaches maximum intensity. In tragedy, the protagonist's fate is often sealed in Act 3. Understanding this structural pattern helps you discuss how Shakespeare builds and releases dramatic tension.",
      },
      {
        id: 'caie-drama-m3-q4',
        question:
          'If you do not understand a specific phrase in a Shakespeare passage, what should you do?',
        options: [
        ...
        correct: 2,
        explanation:
          'A detailed analysis of lines you genuinely understand is worth far more than vague commentary on an entire speech you have only partly grasped. Focus your close reading on the language you can engage with confidently, and demonstrate your analytical skills there.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'Naturalism seeks to replicate real life on stage through realistic dialogue, plausible characters, and recognisable settings. Pioneered by Ibsen and Chekhov, it remains the dominant mode of modern drama and shapes most CAIE set texts.',
      },
      {
        id: 'caie-drama-m4-q2',
        question:
          'Why do some modern playwrights confine their action to a single location and compressed time period?',
        options: [
        ...
        correct: 2,
        explanation:
          'Confining the action to one place and time creates claustrophobic intensity. Characters are forced to confront each other and the central conflict without escape. This is a deliberate dramatic choice that heightens tension and concentrates the thematic exploration.',
      },
      {
        id: 'caie-drama-m4-q3',
        ...
        correct: 1,
        explanation:
          'The "fourth wall" is the imaginary barrier between the stage and the audience. Breaking it - through direct address, narration, or acknowledgment of the audience - disrupts immersion and can force the audience to think critically about the action rather than simply feeling emotions.',
      },
      {
        id: 'caie-drama-m4-q4',
        ...
        correct: 2,
        explanation:
          'While social themes are important, the exam tests your ability to analyse HOW the playwright communicates meaning - through character, structure, dialogue, irony, staging, and symbolism. Reducing a play to its "message" ignores the dramatic craft that makes the message powerful.',
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        correct: 1,
        explanation:
          'An "open text" exam allows you to bring a clean, unannotated copy of the set text. You still need analytical skill - having the text available does not reduce expectations. If your component is "closed text", you must work entirely from memory.',
      },
      {
        id: 'caie-drama-m5-q2',
        ...
        correct: 1,
        explanation:
          'Visualising the stage - how characters are positioned, how they move, who enters and exits - helps you analyse the extract as drama rather than as a page of text. This stage awareness is what distinguishes strong drama analysis from generic literary criticism.',
      },
      {
        id: 'caie-drama-m5-q3',
        ...
        correct: 1,
        explanation:
          "Unless specifically invited, the exam tests your analysis of the playwright's textual choices - language, structure, stage directions, dramatic techniques. Your personal directorial vision is not being assessed; the playwright's craft is.",
      },
      {
        id: 'caie-drama-m5-q4',
        question:
          'When writing a drama essay, why should you cover moments from the beginning, middle, AND end of the play?',
        options: [
        ...
        correct: 1,
        explanation:
          "Covering the whole text demonstrates AO1 (detailed knowledge) and shows structural awareness - how themes, characters, and tensions develop from beginning to end. An essay that only discusses Act 1 suggests incomplete study and misses the play's development.",
      },
    ],
  },
]
...
const dramaAssessment: CourseQuiz[] = [
  {
    ...
    question:
      'A CAIE exam question asks: "How does the playwright create dramatic tension in this extract?" Which of the following openings best addresses this question?',
    options: [
    ...
    correct: 1,
    explanation:
      'This opening directly addresses "how" (method), identifies specific techniques (short dialogue, loaded pauses), names the effect (volatile atmosphere), and discusses audience response. It is analytical from the first sentence, setting up a sophisticated argument.',
  },
  {
    ...
    correct: 2,
    explanation:
      'Drama typically has no narrator. Meaning is communicated directly through dialogue, action, stage directions, and theatrical elements. Using "narrator" when discussing a play suggests you are treating it as prose rather than engaging with it as a dramatic form.',
  },
  {
    ...
    correct: 1,
    explanation:
      "Modern drama's commitment to realistic dialogue means characters often do not state their feelings directly. Meaning lies beneath the surface - in what is implied, avoided, or contradicted by action. Analysing subtext demonstrates sophisticated understanding of how modern drama creates meaning.",
  },
]
