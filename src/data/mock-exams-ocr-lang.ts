    ...
    tasks: [
      {
        taskNumber: 1,
        title: 'Summary Task',
        instruction: 'Write a summary of the key advantages and disadvantages of remote working mentioned in the article. Your answer should be approximately 150-200 words.',
        marks: 20,
      },
      {
        taskNumber: 2,
        title: 'Persuasive Writing',
        instruction: 'Write a persuasive article for a business magazine arguing that hybrid working is the ideal solution for modern organizations. Address at least three different audience concerns. Your answer should be approximately 250-300 words.',
        marks: 30,
      },
      {
        taskNumber: 3,
        title: 'Informative Writing',
        instruction: 'Create an informative guide for a company newsletter explaining how to maintain team communication and morale when working remotely. Use headings, bullet points, and clear organization. Your answer should be approximately 200-250 words.',
        marks: 30,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Identifies all main advantages (commute savings, satisfaction, productivity) and disadvantages (communication, isolation, onboarding). Award full marks for balanced coverage of both.',
            },
            {
              criterion: 'Appropriate vocabulary and clarity',
              marks: 5,
              details: 'Uses subject-specific terminology appropriately. Sentences are clear and concise.',
            },
            {
              criterion: 'Length and form',
              marks: 5,
              details: 'Approximately 150-200 words. Format as continuous prose or structured list.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Uses rhetorical questions, evidence-based arguments, inclusive language, and logical sequencing. Shows understanding of audience (business professionals).',
            },
            {
              criterion: 'Structure and organization',
              marks: 10,
              details: 'Clear introduction establishing position, three developed paragraphs addressing different concerns, conclusion reinforcing argument.',
            },
            {
              criterion: 'Language choices and register',
              marks: 8,
              details: 'Maintains formal, professional register throughout. Vocabulary is subject-specific and persuasive.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Provides practical, relevant advice about remote communication and morale. Information is clear and actionable.',
            },
            {
              criterion: 'Use of structural features',
              marks: 10,
              details: 'Effective use of headings (at least 3), bullet points where appropriate, clear organization of ideas.',
            },
            {
              criterion: 'Tone and accessibility',
              marks: 8,
              details: 'Maintains accessible, professional tone suitable for company newsletter. Language is clear and jargon is minimized or explained.',
            },
          ],
        },
      ],
    ...
    modelAnswers: [
      {
        ...
        marks: 18,
        feedback: 'Excellent balance of advantages and disadvantages. Candidates could include slightly more specific evidence from the text.',
      },
      {
        taskNumber: 2,
...
The evidence is clear: hybrid working represents the future of successful organizations. It balances flexibility with collaboration, cost savings with employee satisfaction. Organizations adopting this model now will lead their sectors tomorrow. The question isn't whether to implement hybrid working, but how quickly you can transition.`,
        marks: 28,
        feedback: 'Strong persuasive structure with clear addressing of counterarguments. Excellent use of rhetorical devices and inclusive language throughout.',
      },
      {
        taskNumber: 3,
...
Remote working succeeds through intentional communication and human connection. These strategies ensure your team remains engaged, connected, and productive.`,
        marks: 27,
        feedback: 'Well-organized with effective use of headings and bullet points. Content is practical and directly applicable to the challenge posed.',
      },
    ],
  },
  ...
  // COMPONENT 01: Communicating Information and Ideas - Mock Exam 2
  {
    ...
    description: 'Students respond to writing tasks based on the importance of parks and green spaces in cities.',
    ...
    tasks: [
      {
        ...
        instruction: 'Write an informative article for a local government website explaining the benefits of urban parks to different groups of people (residents, children, elderly people, businesses). Aim for approximately 250-300 words.',
        marks: 25,
      },
      {
        taskNumber: 2,
        title: 'Persuasive Campaign Text',
        instruction: 'Write a persuasive leaflet for a campaign to fund the restoration of a neglected local park. Your text should appeal to both residents and local business owners. Approximately 200-250 words.',
        marks: 25,
      },
      {
        taskNumber: 3,
        title: 'Advisory Guide',
        instruction: 'Create an advisory guide for new park users, covering safety, etiquette, and how to get the most from their park visit. Use formatting features appropriately. Approximately 200-250 words.',
        marks: 30,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Clearly explains benefits to multiple audience groups. Information is accurate and drawn from source material.',
            },
            {
              criterion: 'Organization and clarity',
              marks: 8,
              details: 'Logical progression through different beneficiary groups. Each benefit is clearly explained.',
            },
            {
              criterion: 'Appropriate tone and register',
              marks: 7,
              details: 'Maintains informative, neutral tone suitable for government website. Language is clear and accessible.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Uses evidence, appeals to different audience interests, rhetorical devices. Clear call to action.',
            },
            {
              criterion: 'Addressing multiple audiences',
              marks: 8,
              details: 'Effectively appeals to both residents (health, community) and business owners (economic benefit).',
            },
            {
              criterion: 'Structure and impact',
              marks: 7,
              details: 'Engaging opening, clear arguments, strong closing. Format appropriate for leaflet.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 12,
              details: 'Provides practical, relevant guidance. Information is clear and actionable for new users.',
            },
            {
              criterion: 'Use of formatting',
              marks: 10,
              details: 'Effective use of headings, sub-headings, bullet points, or other organizational features.',
            },
            {
              criterion: 'Tone and accessibility',
              marks: 8,
...
Quality parks represent essential investment in livable, healthy cities.`,
        marks: 23,
        feedback: 'Excellent organization across different audience groups with clear benefits for each. Could include slightly more specific examples.',
      },
      {
        taskNumber: 2,
...
Sign the petition. Attend the council meeting. Invest five minutes now to create a park our community deserves.`,
        marks: 24,
        feedback: 'Strong persuasive structure with compelling appeals to both audiences. Well-organized with clear formatting.',
      },
      {
        taskNumber: 3,
...
The park thrives through community support. Welcome—we're glad you're here.`,
        marks: 28,
        feedback: 'Excellent use of formatting with clear headings and bullets. Content is practical and welcoming. Well-structured guide.',
      },
    ],
  },
  ...
  // COMPONENT 01: Communicating Information and Ideas - Mock Exam 3
  {
    ...
    description: 'Students respond to writing tasks about misalignment between education and workplace skills.',
    ...
    tasks: [
      {
        ...
        instruction: 'Write an explanatory article for an educational journal explaining why there is a gap between what schools teach and what employers need. Your answer should be approximately 200-250 words.',
        marks: 25,
      },
      {
        taskNumber: 2,
        title: 'Formal Proposal',
        instruction: 'Write a formal proposal for a school senior leadership team, recommending three specific changes to how the school could better prepare students for employment. Explain the benefits of each change. Approximately 250-300 words.',
        marks: 28,
      },
      {
        taskNumber: 3,
        title: 'Persuasive Speech',
        instruction: 'Write a persuasive speech for a business conference arguing that companies should invest in education partnerships. Address potential business objections. Approximately 200-250 words.',
        marks: 27,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Clearly explains multiple causes of skills gap. Ideas are well-developed and logically sequenced.',
            },
            {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Three distinct, specific, and feasible recommendations. Each clearly explained.',
            },
            {
              criterion: 'Explanation of benefits',
              marks: 10,
              details: 'Benefits are clearly articulated for each proposal. Benefits are realistic and compelling.',
            },
            {
              criterion: 'Formality and structure',
              marks: 8,
              details: 'Maintains formal register appropriate for senior leadership. Clear structure with introduction, three proposals, conclusion.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              criterion: 'Persuasive techniques',
              marks: 10,
              details: 'Uses evidence, logical arguments, rhetorical devices. Appeals to business interests effectively.',
            },
            {
              criterion: 'Addressing objections',
              marks: 9,
              details: 'Acknowledges and refutes potential business concerns. Shows understanding of business perspective.',
            },
            {
              criterion: 'Speech structure and delivery',
              marks: 8,
              details: 'Strong opening, clear argument development, compelling conclusion. Appropriate for speech format.',
            },
          ],
        },
      ],
...
These solutions prove effective where implemented. Successful partnerships demonstrate that education can meet industry needs when stakeholders collaborate. The skills gap will not close overnight, but action is essential and achievable.`,
        marks: 24,
        feedback: 'Excellent explanation of causes with clear connections between concepts. Well-structured with appropriate register for educational journal.',
      },
      {
        taskNumber: 2,
...
These recommendations require modest resource investment while delivering significant employment outcomes improvement. Implementation across the next academic year will position our school as an employment-ready institution.`,
        marks: 27,
        feedback: 'Strong proposal format with clear, specific recommendations. Benefits are well-articulated and realistic. Excellent use of formal structure.',
      },
      {
        taskNumber: 3,
...
I encourage you to view education partnership not as charitable corporate responsibility, but as essential business strategy. Let's work together to bridge the skills gap. Your company, young people, and our economy will benefit.`,
        marks: 26,
        feedback: 'Excellent persuasive structure with strong objection handling. Clear business case articulated throughout. Effective speech delivery with strong opening and closing.',
      },
    ],
  },
  ...
  // COMPONENT 02: Exploring Effects and Impact - Mock Exam 1
  {
    ...
    description: 'Students analyze how language techniques create persuasive effects in climate change advertisements.',
    ...
    tasks: [
      {
        ...
        instruction: 'Choose one of the three advertisements. Identify and analyze three language techniques used to persuade the audience. For each technique, explain what it is, provide a quotation as evidence, and explain its persuasive effect. Approximately 250 words.',
        marks: 24,
      },
      {
        taskNumber: 2,
        title: 'Comparative Analysis',
        instruction: 'Compare how two of the three advertisements use different persuasive approaches to address the climate issue. What are the strengths and limitations of each approach? Approximately 300 words.',
        marks: 28,
      },
      {
        taskNumber: 3,
        title: 'Critical Evaluation',
        instruction: 'Evaluate the overall effectiveness of these advertisements in persuading young people to take climate action. Consider audience, tone, language choices, and potential limitations. Approximately 250 words.',
        marks: 28,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 8,
              details: 'Three distinct language techniques correctly identified (e.g., rhetorical questions, emotive language, direct address, repetition, imperatives).',
            },
            {
              criterion: 'Accurate quotation and evidence',
              marks: 8,
              details: 'Quotations accurately reflect text. Evidence clearly supports identified technique.',
            },
            {
              criterion: 'Explanation of persuasive effect',
              marks: 8,
              details: 'Persuasive effect clearly explained. Connection between technique and audience response is articulated.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Two distinct persuasive approaches identified and compared. Similarities and differences are clear.',
            },
            {
              criterion: 'Analysis of strengths and limitations',
              marks: 10,
              details: 'Strengths and limitations of each approach are articulated with supporting evidence.',
            },
            {
              criterion: 'Engagement with purpose and audience',
              marks: 8,
              details: 'Considers how each approach appeals to target audience. Discusses effectiveness for purpose.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Evaluates across multiple aspects: audience appropriateness, emotional appeal, logical argument, tone, likelihood of action.',
            },
            {
              criterion: 'Supported judgments',
              marks: 10,
              details: 'Judgments supported with specific textual evidence. Explanations are detailed.',
            },
            {
              criterion: 'Consideration of context and limitations',
              marks: 8,
              details: 'Acknowledges strengths while identifying limitations or potential weaknesses.',
            },
          ],
        },
      ],
...
These techniques work together to personalize climate action, emotionalize consequences, and demand immediate response.`,
        marks: 23,
        feedback: 'Excellent identification and analysis of techniques. Each technique is clearly explained with effective evidence. Could provide slightly more detail on audience psychology.',
      },
      {
        taskNumber: 2,
...
Combined evaluation: Advertisement 1 motivates through emotion and personal agency. It's likely effective with parents and individuals seeking hope. Advertisement 2 motivates through evidence and systemic concern. It appeals to analytically-minded individuals and those prioritizing urgency. Together, they employ complementary approaches—one motivating through feeling, one through thinking. Separately, each has limitations the other addresses.`,
        marks: 27,
        feedback: 'Excellent comparative analysis with clear articulation of different approaches. Strengths and limitations well-explained with supporting evidence.',
      },
      {
        taskNumber: 3,
...
Overall, the advertisements effectively communicate climate importance and personal relevance. Their effectiveness depends on whether young people transition from emotional engagement to sustained action—a significant challenge these texts alone may not overcome.`,
        marks: 27,
        feedback: 'Strong critical evaluation acknowledging multiple perspectives. Consideration of audience-specific factors is excellent. Balanced assessment of strengths and limitations.',
      },
    ],
  },
  ...
  // COMPONENT 02: Exploring Effects and Impact - Mock Exam 2
  {
    ...
    description: 'Students analyze how language creates effects and impacts in social media content.',
    ...
    tasks: [
      {
        ...
        instruction: 'Select two of the five posts. Analyze how language choices create specific effects on the audience. Consider tone, vocabulary, punctuation, visual elements (emojis, capitalization), and techniques. Approximately 280 words.',
        marks: 26,
      },
      {
        taskNumber: 2,
        title: 'Comparative Analysis of Persuasive Intent',
        instruction: 'Compare how Posts 1 and 2 use language to persuade audiences to make purchasing decisions. Analyze the strategies each uses, considering appeals to emotion, credibility, and social proof. Approximately 300 words.',
        marks: 27,
      },
      {
        taskNumber: 3,
        title: 'Critical Evaluation of Authenticity and Impact',
        instruction: 'Evaluate the impact of these different types of social media content on young audiences. Consider concepts of authenticity, manipulation, community, and wellbeing. How might young people be affected by exposure to these posts? Approximately 270 words.',
        marks: 27,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Two posts selected. Multiple language features identified and analyzed for each. Features appropriate and clearly explained.',
            },
            {
              criterion: 'Explanation of effects on audience',
              marks: 10,
              details: 'Effects on audience clearly explained. Connection between language choice and audience response articulated.',
            },
            {
              criterion: 'Use of textual evidence',
              marks: 6,
              details: 'Specific quotations and examples provided. Evidence effectively supports analysis.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Different persuasive strategies clearly identified in each post. Strategies compared effectively.',
            },
            {
              criterion: 'Engagement with emotional, credibility, and social appeals',
              marks: 10,
              details: 'All three appeal types addressed. How each post uses them is clearly explained.',
            },
            {
              criterion: 'Effectiveness assessment',
              marks: 7,
              details: 'Assessment of which strategy may be more effective and why. Considers audience and context.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Considers impact of varied content types. Acknowledges both positive and negative potential impacts.',
            },
            {
              criterion: 'Discussion of authenticity and manipulation',
              marks: 10,
              details: 'Engages with authenticity concept. Identifies manipulative elements. Discusses implications.',
            },
            {
              criterion: 'Critical consideration of young audience vulnerability',
              marks: 7,
              details: 'Considers age-specific vulnerabilities. Discusses wellbeing implications. Balanced perspective.',
            },
          ],
        },
      ],
...
Post 3 builds trust through honest vulnerability. Post 5 manipulates through false authority and artificial urgency.`,
        marks: 25,
        feedback: 'Strong analysis of language features with clear explanation of effects. Good use of specific evidence. Could expand slightly on audience psychology.',
      },
      {
        taskNumber: 2,
...
Both are persuasive but manipulatively so. Post 1 obscures that this is advertising despite #AD. Post 2 includes small-print caveats ("Results may vary," testimonial from friend) contradicting claims. Neither acknowledges limitations of their promises. Post 2 may be more manipulative because it combines transformation promise with false scientific authority and obscured limitations.`,
        marks: 26,
        feedback: 'Excellent comparative analysis of different persuasive strategies. Clear articulation of how each appeals to different audience motivations. Good critical assessment.',
      },
      {
        taskNumber: 3,
...
Posts 3 and 4 offer genuine community and information, supporting wellbeing. Posts 1, 2, and 5 undermine wellbeing through manipulation and false solutions. The challenge for young audiences is distinguishing between them, developing critical consumption of social media content.`,
        marks: 27,
        feedback: 'Excellent comprehensive evaluation acknowledging different content types and their varied impacts. Strong engagement with authenticity and manipulation concepts.',
      },
    ],
  },
  ...
  // COMPONENT 02: Exploring Effects and Impact - Mock Exam 3
  {
    ...
    description: 'Students analyze how language creates effects and impacts in political communication.',
    ...
    tasks: [
      {
        ...
        instruction: 'Choose one speech. Identify and analyze four different rhetorical techniques used to create persuasive effects. For each technique, provide evidence, explain what it is, and explain its effect on the audience. Approximately 300 words.',
        marks: 26,
      },
      {
        taskNumber: 2,
        title: 'Comparative Analysis of Tone and Register',
        instruction: 'Compare how Speeches 1 and 2 use different tones and registers (formal vs. informal language, emotional vs. logical appeals). How do these differences reflect their purposes and audiences? Approximately 300 words.',
        marks: 27,
      },
      {
        taskNumber: 3,
        title: 'Critical Evaluation of Rhetorical Power and Effect',
        instruction: 'Evaluate how each speech uses language to create power and influence. Which speech is most persuasive and why? Consider ethos, pathos, and logos. What are the implications of each rhetorical approach? Approximately 280 words.',
        marks: 27,
      },
    ],
    markScheme: {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Four distinct techniques correctly identified and named (e.g., repetition, anaphora, direct address, rhetorical questions, parallel structure, antithesis, emotive language, inclusive pronouns).',
            },
            {
              criterion: 'Accurate evidence and quotation',
              marks: 8,
              details: 'Quotations accurately represent techniques. Evidence clearly supports identification.',
            },
            {
              criterion: 'Explanation of effect',
              marks: 8,
              details: 'Effect on audience clearly explained. How technique creates persuasion is articulated.',
            },
          ],
        },
        {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'Different tones clearly identified (emotional vs. logical). Register differences articulated (formal vs. informal).',
            },
            {
              criterion: 'Connection to purpose and audience',
              marks: 10,
              details: 'How tone and register reflect purpose and target audience clearly explained.',
            },
            {
          ...
          criteriaWeighting: [
            {
              ...
              marks: 10,
              details: 'All three rhetorical appeals discussed. How each speech uses them is explained.',
            },
            {
              criterion: 'Judgment of persuasiveness',
              marks: 10,
              details: 'Clear judgment about which speech is most persuasive. Judgment is supported with reasoning.',
            },
            {
              criterion: 'Critical reflection on implications',
              marks: 7,
              details: 'Implications of rhetorical approaches discussed. Critical perspective is evident.',
            },
          ],
        },
      ],
...
These techniques work together to create emotional intensity, moral clarity, and audience participation. The speech doesn't argue logically; it persuades through emotional rhythm and inclusive participation. Audiences feel empowered, unified, and morally justified—powerful persuasive effects without requiring detailed policy analysis.`,
        marks: 25,
        feedback: 'Excellent identification and analysis of four distinct techniques. Effects are clearly explained. Could provide slightly more context about technique effectiveness.',
      },
      {
        taskNumber: 2,
...
These tonal differences reveal how speakers strategically construct authority—through emotional connection in one case, through technical expertise in the other. Both work, but they work through different psychological mechanisms.`,
        marks: 27,
        feedback: 'Strong comparative analysis with clear articulation of tone and register differences. Excellent connection to purpose and audience. Well-reasoned implications discussed.',
      },
      {
        taskNumber: 3,
...
Critical implication: Different rhetorical approaches create different types of power. Emotional rhetoric (Speech 1) mobilizes masses but risks simplification. Logical rhetoric (Speech 2) builds credibility but risks alienating those seeking connection. Balanced rhetoric (Speech 3) attempts both. None is inherently superior—each serves different purposes and audiences. Understanding these differences reveals how language creates power and how audiences respond to different persuasive mechanisms.`,
        marks: 27,
        feedback: 'Excellent critical evaluation using rhetorical framework. Clear judgment of persuasiveness with reasoning. Strong reflection on implications of different approaches.',
      },
    ],
  },
];
