  ...
  macbeth: {
        ...
        aoWeighting: [
          {
            ao: 'AO1',
            weight: '12 marks',
            description: 'Read, understand, respond; use textual references',
          },
          {
            ao: 'AO2',
            weight: '12 marks',
            description: 'Analyse language, form, structure; use subject terminology',
          },
          {
            ao: 'AO3',
            weight: '6 marks',
            description: 'Show understanding of the relationship between text and context',
          },
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        analysis:
          'Short, monosyllabic, broken into three clauses. Shakespeare marks the psychological rupture through sentence structure: Macbeth can no longer speak in the iambic pentameter that characterised his pre-murder speech.',
      },
      {
        quote: '"Out, damned spot! out, I say!"',
        source: 'Act 5 Scene 1, Lady Macbeth sleepwalking',
        analysis:
          'Repeated imperative + apostrophe. Lady Macbeth\'s psychological decay inverts her earlier control. Her "little water" (Act 2) cannot clean the stain that was never physical in the first place.',
      },
      {
  ...
  'aqa-love-relationships': {
        ...
        aoWeighting: [
          {
            ao: 'AO1',
            weight: '12 marks',
            description: 'Response to both poems, textual reference',
          },
          {
            ao: 'AO2',
            weight: '12 marks',
            description: 'Methods analysis (language, form, structure) in BOTH poems',
          },
          {
            ao: 'AO3',
            weight: '6 marks',
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        source: 'Walking Away, C. Day-Lewis',
        analysis:
      ...
      },
      {
        ...
        analysis:
          'Spatial separation + tonal slip. The farmer\'s pity ("poor maid") sits uncomfortably with his role in her isolation; Mew lets the dramatic monologue indict its own speaker.',
      },
    ],
    grade9Indicators: [
  ...
  'aqa-power-conflict': {
        ...
        aoWeighting: [
          {
            ao: 'AO1',
            weight: '12 marks',
            description: 'Response and textual support in both poems',
          },
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        analysis:
          'Repetition + Caribbean-inflected orthography. The colonial imposition of Eurocentric history is performed through the curriculum the speaker was taught, and resisted through the dialect the poem is written in.',
      },
      {
        ...
        aoWeighting: [
          {
            ao: 'AO1',
            weight: '12 marks',
            description: 'Read, understand and respond; textual references',
          },
    ...
    keyQuotes: [
      {
        ...
        analysis:
          "Onomatopoeic interjection + dismissal. Establishes Scrooge's moral register in his first scene: he does not merely disagree with Christmas, he refuses even to engage in the vocabulary of it.",
      },
      {
  ...
  'jekyll-hyde': {
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        source: 'Chapter 10, Jekyll',
        analysis:
          'Personification + present participle. The animal is named, located inside Jekyll, and given ongoing appetite. Darwinian anxiety made lexical.',
      },
    ],
    grade9Indicators: [
    ...
    keyQuotes: [
      {
        ...
        analysis:
          'Collective-noun metaphor + plural verb. The Inspector\'s sermon compresses New Testament vocabulary ("one body") into the 1945 case for the welfare state.',
      },
      {
        quote: '"Unsinkable, absolutely unsinkable"',
        source: 'Act 1, Mr Birling on the Titanic',
        analysis:
          "Repetition + dramatic irony. The 1945 audience knows the Titanic sank in April 1912. Priestley weaponises audience knowledge to discredit Birling's capitalist confidence before the play's moral argument even begins.",
      },
      {
      ...
      },
      {
        ...
        analysis:
          'Tricolon + biblical register. The Inspector prophesies the world wars; the 1945 audience is the fulfilment of the prophecy.',
      },
    ],
    grade9Indicators: [
    ...
    faqs: [
      {
        ...
        answer:
          'Yes. On AQA, Edexcel, OCR, and WJEC/Eduqas, Paper 1 and Paper 2 each contribute 50% of the total GCSE English Language grade.',
      },
    ],
  },
