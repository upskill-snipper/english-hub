    ...
    starter: [
      {
        ...
        duration: '10 min',
        detail:
          "Students discuss: 'What does ambition feel like?' Share examples from history or fiction. Bridge to Macbeth's context.",
      },
    ],
    main: [
      {
        ...
        duration: '20 min',
        detail:
          "Annotate Act 1 Scene 7 - 'vaulting ambition' soliloquy. Students identify language techniques and discuss effect on the audience.",
      },
      {
        phase: 'Structured Writing',
        duration: '20 min',
        detail:
          "Model PEEL paragraph on ambition. Students draft their own response to: 'How does Shakespeare present Macbeth's ambition?'",
      },
    ],
    homework:
      'Write a 250-word analytical paragraph comparing how power is presented in Act 1 Scene 3 and Act 1 Scene 7. Include at least two embedded quotations with analysis.',
    resources: [
    ...
    starter: [
      {
        ...
        duration: '8 min',
        detail:
          "Students position themselves on a scale from 'individual responsibility' to 'collective responsibility'. Justify their position.",
      },
    ],
    main: [
      {
        ...
        duration: '20 min',
        detail:
          "Group task: track Sheila's attitude before and after the Inspector's visit. Create an annotated timeline with textual evidence.",
      },
      {
        phase: 'Essay Planning',
        duration: '22 min',
        detail:
          "Scaffold an essay: 'How does Priestley use the Inspector to convey his message about responsibility?' Students plan and write an introduction.",
      },
    ],
    homework:
      "Read Act 3's final scene. Write a director's note explaining how you would stage the Inspector's exit for maximum dramatic impact. Consider lighting, sound, and character positioning.",
    resources: [
    ...
    starter: [
      {
        ...
        duration: '10 min',
        detail:
          'Students sort quotations showing Scrooge at different points in the novella. Order chronologically and label the shift in characterisation.',
      },
    ],
    main: [
      {
        ...
        duration: '20 min',
        detail:
          "Focus on Stave 1 - Scrooge's description. Analyse language choices: 'squeezing, wrenching, grasping, scraping'. What does each word reveal?",
      },
      {
        phase: 'Comparison Task',
        duration: '20 min',
        detail:
          'Compare Stave 1 Scrooge with Stave 5. How does Dickens signal his redemption? Students write a structured comparative paragraph.',
      },
    ],
    homework:
      "Choose any one of the three Spirits. Write an analytical paragraph explaining how Dickens uses this Spirit to change Scrooge's perspective. Use at least two quotations.",
    resources: [
  ...
  return (
    <div className="space-y-2">
      {lesson.objectives.map((obj, i) => (
        <div
          key={i}
          className="flex items-start gap-3 rounded-lg border border-white/[0.07] bg-white/[0.03] px-3 py-2.5"
        >
          {i === 0 ? (
          ...
          <p
            className={cn(
              ...
              i === 0 ? 'text-white/40 italic' : 'text-white/75',
            )}
          >
            {obj}
          </p>
