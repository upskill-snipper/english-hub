...
const NAV_ITEMS = [
  ...
  { label: "Users",           href: "/school/users",       icon: Users           },
  { label: "Import Users",    href: "/school/import",      icon: Upload          },
  { label: "Invite Teachers", href: "/school/invite",      icon: Mail            },
  ...
  { label: "Permissions",     href: "/school/permissions", icon: Shield          },
  { label: "Setup Guide",     href: "/school/guide",       icon: HelpCircle      },
...
export function SchoolSidebarNav({
  ...
  const founderLabel = accessUntil
    ? `FOUNDER - Active until ${accessUntil}`
    : "FOUNDER - Active until Aug 2026"
