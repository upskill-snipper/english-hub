...
import { NotOnProSeen, NotOnProUpgradeClick } from './NotOnProTracking'
...
export async function NotOnProCard({
  ...
  return (
    ...
    >
      ...
      {/* SF-7: the funnel read. Renders nothing; see NotOnProTracking. */}
      <NotOnProSeen kind={kind} />
      <div className="mt-3 flex flex-wrap items-center gap-2">
        <NotOnProUpgradeClick kind={kind}>
          <Link
