...
function getFallbackQuickLinks(board: ExamBoard): QuickLink[] {
  switch (board) {
    ...
    case 'edexcel-igcse-lang':
      return [
        { title: 'Edexcel IGCSE Hub', description: 'IGCSE English Language preparation', href: '/igcse/edexcel', icon: BookOpen, color: 'text-sky-400 bg-sky-500/10' },
        { title: 'Exam Technique', description: 'Paper structure, timing and band descriptors', href: '/revision/exam-technique', icon: GraduationCap, color: 'text-primary bg-primary/10' },
      ]
    case 'cambridge-0475':
      return [
        { title: 'Cambridge Literature Hub', description: 'IGCSE Literature in English (0475)', href: '/igcse/cambridge/0500', icon: BookOpen, color: 'text-purple-400 bg-purple-500/10' },
        { title: 'Exam Technique', description: 'Paper walkthroughs for Cambridge Literature', href: '/revision/exam-technique', icon: GraduationCap, color: 'text-primary bg-primary/10' },
      ]
    case 'ial-edexcel':
      return [
      ...
      >
        ...
        <div className={cn('px-6 py-6 sm:px-7 sm:py-7', c.bg)}>
          ...
          <div className="relative">
            ...
            {/* Paper name */}
            <h3 className={cn('font-serif text-xl sm:text-2xl font-bold tracking-tight leading-tight mb-1', c.text)}>
              {paper.name}
            </h3>
            <p className={cn('text-sm leading-relaxed mb-3', c.sub)}>
              {paper.subtitle}
            </p>

            {/* Section summary */}
            <p className={cn('text-xs font-mono leading-relaxed', c.sub)}>
              {sectionNames}
            </p>
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="mt-5 text-body-lg text-muted-foreground max-w-2xl leading-relaxed">
              {hasPapers
                ? <>Your exam is split into {papers.length} papers. Pick one to find every study guide, poem, practice question and mock exam you need.</>
