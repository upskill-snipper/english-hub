...
const STUDENT_FEATURES = [
  'First month FREE on monthly plans',
  '3 free uses per feature — try before you subscribe',
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-muted-foreground max-w-xl mx-auto text-body-lg">
            3 free uses per feature, then pick the plan that fits.
            First month FREE on monthly plans. Cancel anytime.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          <Card className="p-8 flex flex-col border-primary/30 relative">
            ...
            <Button variant="default" className="w-full shadow-lg shadow-primary/20" render={<Link href="/pricing" />}>
              View Pricing
            </Button>
          </Card>
          ...
          <Card className="p-8 flex flex-col border-purple-500/30 relative">
            ...
            <Button variant="default" className="w-full bg-purple-600 hover:bg-purple-700 shadow-lg shadow-purple-500/20" render={<Link href="/auth/teacher-register" />}>
              Start Free Trial
            </Button>
          </Card>
          ...
          <Card className="p-8 flex flex-col border-amber-500/40 relative bg-amber-500/5">
            ...
            <div className="mb-6 rounded-lg border border-amber-500/30 bg-amber-500/10 px-4 py-3">
              ...
              <p className="text-sm text-muted-foreground">
                Limited to 20 schools. Heavily discounted pricing with locked preferential rates for 2-3 years.
              </p>
            </div>
            <ul className="space-y-3 mb-8 flex-1">
        ...
        <div className="mt-12 rounded-2xl border border-amber-500/30 bg-amber-500/[0.06] px-7 py-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Be one of the first 20 schools to join. Heavily discounted pricing, early features, direct product input, and locked preferential rates.
            </p>
          </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-10 max-w-lg mx-auto">
          Every feature includes 3 free uses &mdash; no sign-up required.
          Monthly plans start with a free first month. Cancel anytime from your account settings &mdash; no questions asked.
        </p>
      </div>
    </section>
  )
