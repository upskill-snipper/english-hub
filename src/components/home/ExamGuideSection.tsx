...
const boards = [
  ...
  { id: 'ocr', board: 'OCR', color: 'border-orange-500/30 hover:border-orange-500/60', accent: 'text-clay-600', bg: 'bg-orange-500/10', desc: 'Paper structure, mark schemes, and expert tips.' },
