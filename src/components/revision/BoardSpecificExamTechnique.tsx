...
export const AQA_CONTENT: BoardExamTechniqueContent = {
      ...
      rows: [
        {
          ...
          detail:
            'Read the full extract once for understanding, then re-read sections referenced by each question. Underline key words.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          ...
          detail: 'Simple retrieval. Four clear, short statements, one per line.',
          marks: '4 marks',
          colour: 'reading',
        },
        {
          ...
          detail:
            "Pick 2-3 specific words or phrases. Identify technique, explain effect, link to writer's intention.",
          marks: '8 marks',
          colour: 'reading',
        },
        {
          ...
          detail:
            'Analyse opening, shifts in focus, narrative perspective, sentence and paragraph length.',
          marks: '8 marks',
          colour: 'reading',
        },
        {
          ...
          detail:
            'Take a clear position on a statement. Use 3 pieces of evidence with detailed analysis.',
          marks: '20 marks',
          colour: 'analysis',
        },
        {
          time: '0:56 - 1:01',
          label: 'Q5 — Plan creative writing',
          detail: 'Five minutes planning: hook, 3-4 sections, ending, deliberate techniques.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:01 - 1:40',
          label: 'Q5 — Write creative piece (40 marks)',
          detail: '24 marks AO5 + 16 marks AO6. 400-600 words. Vary sentences, deploy techniques.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '1:40 - 1:45',
          label: 'Proofread',
          detail: "Check spelling, full stops, homophones (there/their/they're).",
          marks: 'Check',
          colour: 'check',
        },
      ],
      ...
      rows: [
        {
          ...
          detail:
            'Source A and Source B fully. Note tone, purpose, audience, similarities and differences.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          ...
          detail: 'Shade four correct statements from Source A. Do not overthink.',
          marks: '4 marks',
          colour: 'reading',
        },
        {
          ...
          detail: 'Three clear differences across both sources with brief quotations.',
          marks: '8 marks',
          colour: 'reading',
        },
        {
          ...
          detail: 'One source. Aim for 3-4 detailed language points with subject terminology.',
          marks: '12 marks',
          colour: 'analysis',
        },
        {
          ...
          detail:
            'Compare how the writers convey different perspectives. Use both texts in every paragraph.',
          marks: '16 marks',
          colour: 'comparison',
        },
        {
          time: '0:55 - 1:00',
          label: 'Q5 — Plan transactional writing',
          detail:
            'Identify purpose, audience, form. Plan 3-4 key points with rhetorical techniques.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:00 - 1:40',
          label: 'Q5 — Write transactional piece (40 marks)',
          detail: '24 marks AO5 + 16 marks AO6. Match the form. Use persuasive techniques.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '1:40 - 1:45',
          label: 'Proofread',
          detail: 'Check spelling, punctuation, paragraphing, form conventions.',
          marks: 'Check',
          colour: 'check',
        },
      ],
      warning:
        'Q4 is the hardest reading question. Cap it at 16 minutes — partial comparison beats one-sided analysis.',
    },
    {
      ...
      rows: [
        {
          time: '0:00 - 0:05',
          label: 'Read Shakespeare extract and question',
          detail: 'Read twice. Underline key words. Identify focus.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:05 - 0:10',
          label: 'Plan Shakespeare essay',
          detail: 'Thesis + 3 paragraph topics (at least one beyond extract) + key quotations.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '0:10 - 0:50',
          label: 'Write Shakespeare essay (30 marks + 4 SPaG = 34 total)',
          detail:
            'Intro + 3 PEEL paragraphs + conclusion. At least one paragraph beyond the extract.',
          marks: '30+4',
          colour: 'creative',
        },
        {
          time: '0:50 - 0:55',
          label: 'Read 19th-century novel extract and question',
          detail: 'Read extract. Identify focus. Plan wider-text references.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:55 - 1:00',
          label: 'Plan novel essay',
          detail:
            'Thesis + 3 paragraph topics + quotations. At least one paragraph beyond extract.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:00 - 1:40',
          label: 'Write novel essay (30 marks)',
          detail: 'Intro + 3 paragraphs + conclusion. Integrate context naturally.',
          marks: '30 marks',
          colour: 'creative',
        },
        {
          ...
          detail: 'Skim. Fix errors. Add final contextual points if time.',
          marks: 'Check',
          colour: 'check',
        },
      ],
      ...
      rows: [
        {
          ...
          detail:
            '5 mins planning + 35 mins writing + 5 mins proofread. Quotations from memory. 30 + 4 SPaG = 34 total.',
          marks: '30+4',
          colour: 'creative',
        },
        {
          ...
          detail:
            'Compare a printed poem with one from the anthology. 5 mins planning + 35 mins writing + 5 mins proofread.',
          marks: '30 marks',
          colour: 'comparison',
        },
        {
          ...
          detail: 'Read 3 times. 5 mins planning + 15 mins writing. Language, structure, form.',
          marks: '24 marks',
          colour: 'reading',
        },
        {
          ...
          detail: '2-3 focused comparison paragraphs.',
          marks: '8 marks',
          colour: 'reading',
        },
      ],
  ...
  questionTypes: [
    {
      paper: 'Lang P1',
      question: 'Q1 — List four things',
      marks: '4',
      description: 'Simple retrieval from a specified section.',
      approach: 'Four clear sentences. One point per line. Do not over-explain.',
    },
    {
      paper: 'Lang P1',
      question: 'Q2 — Language analysis',
      marks: '8',
      description: 'How does the writer use language to describe X?',
      approach: "2-3 zoomed-in quotations. Technique → effect → writer's intention.",
    },
    {
      paper: 'Lang P1',
      question: 'Q3 — Structure analysis',
      marks: '8',
      description: 'How has the writer structured the text to interest the reader?',
      approach: 'Opening, shifts, perspective, sentence and paragraph length, ending.',
    },
    {
      paper: 'Lang P1',
      question: 'Q4 — Evaluation',
      marks: '20',
      description: 'To what extent do you agree with a statement?',
      approach: 'Clear position. 3 evidenced points. Use evaluative language.',
    },
    {
      paper: 'Lang P1',
      question: 'Q5 — Creative writing',
      marks: '40',
      description: 'Descriptive or narrative writing linked to a stimulus.',
      approach: 'Single moment or setting. Sensory detail. Varied sentences. 400-600 words.',
    },
    {
      paper: 'Lang P2',
      question: 'Q1 — True or false',
      marks: '4',
      description: 'Shade four correct statements from Source A.',
      approach: 'Quick retrieval. Maximum 4 minutes.',
    },
    {
      paper: 'Lang P2',
      question: 'Q2 — Summary of differences',
      marks: '8',
      description: 'Summary of differences across both sources on a topic.',
      approach: '3 differences with short embedded quotations from both sources.',
    },
    {
      paper: 'Lang P2',
      question: 'Q3 — Language analysis',
      marks: '12',
      description: 'How does the writer use language in one source?',
      approach: '3-4 detailed points with subject terminology. Deeper than P1 Q2.',
    },
    {
      paper: 'Lang P2',
      question: 'Q4 — Comparison',
      marks: '16',
      description: 'Compare how the writers convey their different perspectives.',
      approach: 'Both texts in every paragraph. Focus on methods, not just content.',
    },
    {
      paper: 'Lang P2',
      question: 'Q5 — Transactional writing',
      marks: '40',
      description: 'Letter, article, speech or leaflet on a viewpoint.',
      approach: 'Match the form. Persuasive techniques. Counter-arguments.',
    },
    {
      paper: 'Lit P1',
      question: 'Shakespeare extract essay',
      marks: '30+4',
      description:
        'Starting with the extract, explore how Shakespeare presents X. 30 marks AO1-AO3 + 4 marks AO4 SPaG.',
      approach: 'Start with extract. At least one paragraph from wider play. Context.',
    },
    {
      paper: 'Lit P1',
      question: '19th-century novel extract essay',
      marks: '30',
      description: 'Starting with the extract, explore how the writer presents X.',
      approach: 'Same structure as Shakespeare. Refer to extract and wider novel.',
    },
    {
      paper: 'Lit P2',
      question: 'Modern text essay (no extract)',
      marks: '30+4',
      description:
        'Choice of two questions on your studied modern text. 30 marks AO1-AO3 + 4 marks AO4 SPaG.',
      approach: 'Quotations from memory. Thematic argument across the whole text.',
    },
    {
      paper: 'Lit P2',
      question: 'Anthology poetry comparison',
      marks: '30',
      description: 'Compare a printed anthology poem with one of your choice.',
      approach: 'Pre-prepared pairings. Compare methods within paragraphs.',
    },
    {
      paper: 'Lit P2',
      question: 'Unseen poetry — single poem',
      marks: '24',
      description: 'How does the poet present X in this poem?',
      approach: 'Language, structure, form. No context required.',
    },
    {
      paper: 'Lit P2',
      question: 'Unseen poetry — comparison',
      marks: '8',
      description: 'Compare how the two poets present X.',
      approach: '2-3 focused comparison paragraphs on methods.',
    },
  ],
  essay: {
    intro:
...
export const EDEXCEL_CONTENT: BoardExamTechniqueContent = {
  ...
  papers: [
    {
      ...
      rows: [
        {
          time: '0:00 - 0:10',
          label: 'Read the source text',
          detail: 'Read fully. Mark sections referenced by each question.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:10 - 0:14',
          label: 'Q1 — Identify (1 mark)',
          detail: 'Quick retrieval. One sentence answer.',
          marks: '1 mark',
          colour: 'reading',
        },
        {
          time: '0:14 - 0:24',
          label: 'Q2 — Language analysis (4 marks)',
          detail: 'Quotation + technique + brief effect. Stay concise.',
          marks: '4 marks',
          colour: 'reading',
        },
        {
          time: '0:24 - 0:39',
          label: 'Q3 — Language and structure (15 marks)',
          detail:
            'Combined language and structure analysis. 4-5 detailed points with subject terminology.',
          marks: '15 marks',
          colour: 'analysis',
        },
        {
          time: '0:39 - 0:59',
          label: 'Q4 — Evaluation (20 marks)',
          detail: 'To what extent do you agree? Use 3-4 evidenced evaluative points.',
          marks: '20 marks',
          colour: 'analysis',
        },
        {
          time: '0:59 - 1:04',
          label: 'Q5/6 — Plan imaginative writing',
          detail: 'Choice of two prompts (often image-based). Plan opening, structure, ending.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:04 - 1:40',
          label: 'Q5/6 — Write imaginative piece (40 marks)',
          detail: '24 marks AO5 + 16 marks AO6. Single focused moment.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '1:40 - 1:45',
          label: 'Proofread',
          detail: 'Check spelling, punctuation, sentence variety.',
          marks: 'Check',
          colour: 'check',
        },
      ],
      ...
      rows: [
        {
          time: '0:00 - 0:15',
          label: 'Read both source texts',
          detail: 'Both texts fully. Note differences in tone, purpose, perspective.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:15 - 0:19',
          label: 'Q1 — Identify (1 mark)',
          detail: 'Quick retrieval from Text 1.',
          marks: '1 mark',
          colour: 'reading',
        },
        {
          time: '0:19 - 0:27',
          label: 'Q2 — Language and structure (6 marks)',
          detail: 'Brief analysis of methods in Text 1.',
          marks: '6 marks',
          colour: 'reading',
        },
        {
          time: '0:27 - 0:35',
          label: 'Q3 — Comprehension (2 marks)',
          detail: 'Short retrieval question on Text 2.',
          marks: '2 marks',
          colour: 'reading',
        },
        {
          time: '0:35 - 0:50',
          label: 'Q4 — Language analysis Text 2 (15 marks)',
          detail: 'Detailed methods analysis of Text 2 with subject terminology.',
          marks: '15 marks',
          colour: 'analysis',
        },
        {
          time: '0:50 - 1:10',
          label: 'Q5 — Synthesis (4 marks)',
          detail: 'Combine information from both texts on a given focus.',
          marks: '4 marks',
          colour: 'reading',
        },
        {
          time: '1:10 - 1:32',
          label: 'Q6 — Comparison (14 marks)',
          detail: "Compare writers' ideas and perspectives across both texts.",
          marks: '14 marks',
          colour: 'comparison',
        },
        {
          time: '1:32 - 1:37',
          label: 'Q7/8 — Plan transactional writing',
          detail: 'Choice of one task. Identify form, audience, purpose.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:37 - 2:00',
          label: 'Q7/8 — Write transactional piece (40 marks)',
          detail: '24 AO5 + 16 AO6. Match the form conventions.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '2:00 - 2:05',
          label: 'Proofread',
          detail: 'Check spelling, paragraphing, form.',
          marks: 'Check',
          colour: 'check',
        },
      ],
      warning:
        'Edexcel Lang P2 is 20 minutes longer than AQA. Use the extra time on Q6 (comparison) where it pays back the most marks.',
    },
    {
      ...
      rows: [
        {
          time: '0:00 - 0:05',
          label: 'Read Shakespeare extract and question (a)',
          detail: 'Read extract. Identify focus.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
        ...
        {
          time: '0:55 - 1:00',
          label: 'Plan Section B',
          detail: 'Post-1914 text essay. Thesis + 3 paragraph topics.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:00 - 1:40',
          label: 'Section B — Post-1914 essay (40 marks)',
          detail:
            'No extract. Choice of two questions. Quotations from memory. AO4 SPaG marked here.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '1:40 - 1:45',
          label: 'Proofread',
          detail: 'Skim both sections for errors.',
          marks: 'Check',
          colour: 'check',
        },
      ],
  ...
  questionTypes: [
    {
      paper: 'Lang P1',
      question: 'Q1 — Identify',
      marks: '1',
      description: 'Single fact retrieval.',
      approach: 'One sentence answer.',
    },
    {
      paper: 'Lang P1',
      question: 'Q2 — Language analysis',
      marks: '4',
      description: 'Brief language analysis.',
      approach: 'Quotation, technique, effect — be concise.',
    },
    {
      paper: 'Lang P1',
      question: 'Q3 — Language and structure',
      marks: '15',
      description: 'Combined language and structure analysis.',
      approach: '4-5 detailed points alternating language and structure.',
    },
    {
      paper: 'Lang P1',
      question: 'Q4 — Evaluation',
      marks: '20',
      description: "To what extent do you agree with a critic's statement?",
      approach: 'Clear position. 3-4 evaluative points with evidence.',
    },
    {
      paper: 'Lang P1',
      question: 'Q5/6 — Imaginative writing',
      marks: '40',
      description: 'Choice of two image-linked prompts.',
      approach: 'Single focused moment. Sensory detail. Varied sentences.',
    },
    {
      paper: 'Lang P2',
      question: 'Q1 — Identify',
      marks: '1',
      description: 'Quick retrieval from Text 1.',
      approach: 'One short answer.',
    },
    {
      paper: 'Lang P2',
      question: 'Q2 — Methods Text 1',
      marks: '6',
      description: 'Brief language and structure analysis.',
      approach: '2-3 short paragraphs.',
    },
    {
      paper: 'Lang P2',
      question: 'Q3 — Comprehension Text 2',
      marks: '2',
      description: 'Short retrieval from Text 2.',
      approach: 'Direct answer with evidence.',
    },
    {
      paper: 'Lang P2',
      question: 'Q4 — Language analysis Text 2',
      marks: '15',
      description: 'Detailed methods analysis.',
      approach: '4-5 detailed points with subject terminology.',
    },
    {
      paper: 'Lang P2',
      question: 'Q5 — Synthesis',
      marks: '4',
      description: 'Combine information across both texts.',
      approach: 'Use both texts. Brief.',
    },
    {
      paper: 'Lang P2',
      question: 'Q6 — Comparison',
      marks: '14',
      description: "Compare writers' ideas and perspectives.",
      approach: 'Both texts in every paragraph. Methods focus.',
    },
    {
      paper: 'Lang P2',
      question: 'Q7/8 — Transactional writing',
      marks: '40',
      description: 'Choice of one form-based task.',
      approach: 'Match form. Persuasive techniques. Counter-arguments.',
    },
    {
      paper: 'Lit P1',
      question: 'Shakespeare (a) extract',
      marks: '20',
      description: 'Close analysis of extract.',
      approach: 'Extract only. Language, structure, form.',
    },
    {
      paper: 'Lit P1',
      question: 'Shakespeare (b) wider play',
      marks: '20',
      description: 'Same focus across the wider play.',
      approach: 'Quotations from memory. Different scenes/acts.',
    },
    {
      paper: 'Lit P1',
      question: 'Post-1914 British text',
      marks: '40',
      description: 'Choice of two essay questions.',
      approach: 'No extract. Thesis + 4 paragraphs from memory. SPaG marked.',
    },
    {
      paper: 'Lit P2',
      question: '19th-century (a) extract',
      marks: '20',
      description: 'Close analysis of extract.',
      approach: 'Extract only.',
    },
    {
      paper: 'Lit P2',
    ...
    },
    {
      ...
      approach: 'Five-minute read. Methods + effects.',
    },
  ],
  essay: {
    intro:
  ...
  papers: [
      ...
      rows: [
        {
          time: '0:00 - 0:15',
          label: 'Read both source texts',
          detail: 'Read both fully. Note purpose and key ideas.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:15 - 0:25',
          label: 'Q1 — Information retrieval (8 marks)',
          detail: 'Identify and explain information from the texts.',
          marks: '8 marks',
          colour: 'reading',
        },
        {
          time: '0:25 - 0:40',
          label: 'Q2 — Language analysis (12 marks)',
          detail: 'How does the writer use language? Use subject terminology.',
          marks: '12 marks',
          colour: 'analysis',
        },
        {
          time: '0:40 - 1:00',
          label: 'Q3 — Comparison (12 marks)',
          detail: 'Compare ideas and perspectives across both texts.',
          marks: '12 marks',
          colour: 'comparison',
        },
        {
          time: '1:00 - 1:05',
          label: 'Q4 — Plan extended writing',
          detail: 'Plan structure for the writing task (16 + 24 marks).',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:05 - 1:55',
          label: 'Q4 — Write extended task (40 marks)',
          detail:
            '24 marks content/organisation + 16 marks technical accuracy. Match form, audience, purpose.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '1:55 - 2:00',
          label: 'Proofread',
          detail: 'Check spelling, sentence variety, form conventions.',
          marks: 'Check',
          colour: 'check',
        },
      ],
    },
    {
      ...
      rows: [
        {
          time: '0:00 - 0:15',
          label: 'Read both fiction extracts',
          detail: 'Read both fully. Note tone, voice, devices.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:15 - 0:25',
          label: 'Q1 — Information / inference (8 marks)',
          detail: 'Retrieval and inference from one extract.',
          marks: '8 marks',
          colour: 'reading',
        },
        {
          time: '0:25 - 0:40',
          label: 'Q2 — Language analysis (12 marks)',
          detail: 'How does the writer create an effect? Subject terminology.',
          marks: '12 marks',
          colour: 'analysis',
        },
        {
          time: '0:40 - 1:00',
          label: 'Q3 — Comparison (12 marks)',
          detail: 'Compare how the writers create effects across both extracts.',
          marks: '12 marks',
          colour: 'comparison',
        },
        {
          time: '1:00 - 1:05',
          label: 'Q4 — Plan creative writing',
          detail: 'Plan opening, development, ending. Note techniques.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:05 - 1:55',
          label: 'Q4 — Write creative piece (40 marks)',
          detail: '24 marks content/organisation + 16 marks technical accuracy.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '1:55 - 2:00',
          label: 'Proofread',
          detail: 'Check homophones, sentence variety.',
          marks: 'Check',
          colour: 'check',
        },
      ],
    ...
    },
    {
      ...
      rows: [
        {
          time: '0:00 - 0:05',
          label: 'Read modern text question',
          detail: 'Choose one of two questions. Underline focus.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:05 - 0:10',
          label: 'Plan modern text essay',
          detail: 'Thesis + 3-4 paragraph topics + quotations.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '0:10 - 0:55',
          label: 'Section A — Modern text essay (40 marks)',
          detail: 'Choice of two questions. Quotations from memory. AO4 SPaG marked.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '0:55 - 1:00',
          label: 'Read 19th-century extract and question',
          detail: 'Read extract. Identify focus.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '1:00 - 1:05',
          label: 'Plan 19th-century essay',
          detail: 'Thesis + extract + wider novel paragraphs.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:05 - 1:55',
          label: 'Section B — 19th-century essay (40 marks)',
          detail: 'Extract + wider novel. AO4 SPaG marked.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
    ...
    },
    {
      ...
      rows: [
        {
          time: '0:00 - 0:05',
          label: 'Read anthology poems and question',
          detail: 'Identify the named poem and choose your comparison poem.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:05 - 0:10',
          label: 'Plan anthology comparison',
          detail: 'Compare methods. Pre-prepared pairings help here.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '0:10 - 0:40',
          label: 'Section A — Anthology poetry comparison (20 marks)',
          detail: 'Compare two anthology poems on a given focus.',
          marks: '20 marks',
          colour: 'comparison',
        },
        {
          time: '0:40 - 0:50',
          label: 'Read unseen poem(s)',
          detail: 'Read 2-3 times. Annotate.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:50 - 1:20',
          label: 'Section B — Unseen poetry (20 marks)',
          detail: 'Analyse how the poet creates effects. Language, structure, form.',
          marks: '20 marks',
          colour: 'analysis',
        },
        {
        ...
        {
          time: '1:25 - 2:00',
          label: 'Section C — Shakespeare (40 marks)',
          detail: 'Extract + wider play. Quotations from memory. AO4 SPaG marked.',
          marks: '40 marks',
          colour: 'creative',
        },
      ],
      warning:
        'OCR Lit P2 has THREE sections to balance. Stick rigidly to your timings — running over on poetry will eat into your 40-mark Shakespeare essay.',
    },
  ],
  questionTypes: [
    {
      paper: 'Lang P1',
      question: 'Q1 — Information retrieval',
      marks: '8',
      description: 'Identify and explain information from non-fiction texts.',
      approach: 'Direct retrieval with brief explanation.',
    },
    {
      paper: 'Lang P1',
      question: 'Q2 — Language analysis',
      marks: '12',
      description: 'How does the writer use language?',
      approach: '3-4 detailed points with subject terminology.',
    },
    {
      paper: 'Lang P1',
      question: 'Q3 — Comparison',
      marks: '12',
      description: 'Compare ideas and perspectives across both texts.',
      approach: 'Both texts in every paragraph. Comparative connectives.',
    },
    {
      paper: 'Lang P1',
      question: 'Q4 — Extended writing',
      marks: '40',
      description: 'Non-fiction writing task (article, letter, speech).',
      approach: 'Match form. Persuasive techniques. Plan for 5 minutes.',
    },
    {
      paper: 'Lang P2',
      question: 'Q1 — Information / inference',
      marks: '8',
      description: 'Retrieval and inference from a fiction extract.',
      approach: 'Direct answers with brief explanation.',
    },
    {
      paper: 'Lang P2',
      question: 'Q2 — Language analysis',
      marks: '12',
      description: 'How does the writer create effects?',
      approach: 'Detailed methods analysis with subject terminology.',
    },
    {
      paper: 'Lang P2',
      question: 'Q3 — Comparison',
      marks: '12',
      description: 'Compare effects across both fiction extracts.',
      approach: 'Methods focus. Both extracts in every paragraph.',
    },
    {
      paper: 'Lang P2',
      question: 'Q4 — Creative writing',
      marks: '40',
      description: 'Narrative or descriptive writing task.',
      approach: 'Single focused moment. Sensory detail.',
    },
    {
      paper: 'Lit P1',
      question: 'Modern text essay',
      marks: '40',
      description: 'Choice of two questions on modern prose or drama.',
      approach: 'Thesis + 4 paragraphs from memory. SPaG marked.',
    },
    {
      paper: 'Lit P1',
      question: '19th-century prose essay',
      marks: '40',
      description: 'Extract + wider novel essay.',
      approach: 'Anchor in extract, then move to wider text. SPaG marked.',
    },
    {
      paper: 'Lit P2',
      question: 'Anthology poetry comparison',
      marks: '20',
      description: 'Compare two anthology poems on a given theme.',
      approach: 'Pre-prepared pairings. Methods in every paragraph.',
    },
    {
      paper: 'Lit P2',
      question: 'Unseen poetry',
      marks: '20',
      description: 'Analyse a single unseen poem.',
      approach: 'Language, structure, form. No context required.',
    },
    {
      paper: 'Lit P2',
      ...
      marks: '40',
      description: 'Extract + wider play essay.',
      approach: 'Anchor in extract, move outward. SPaG marked.',
    },
  ],
  essay: {
    intro:
  ...
  papers: [
    {
      ...
      rows: [
        ...
        {
          time: '0:10 - 0:15',
          label: 'A1 — Retrieval (5 marks)',
          detail: 'Quick retrieval question.',
          marks: '5 marks',
          colour: 'reading',
        },
        {
          time: '0:15 - 0:25',
          label: 'A2 — Language analysis (5 marks)',
          detail: 'Brief language analysis.',
          marks: '5 marks',
          colour: 'reading',
        },
        {
          time: '0:25 - 0:35',
          label: 'A3 — Methods (10 marks)',
          detail: 'Detailed language and structure analysis.',
          marks: '10 marks',
          colour: 'analysis',
        },
        {
          time: '0:35 - 0:45',
          label: 'A4 — Effect on reader (10 marks)',
          detail: 'How is the reader made to feel? Reference effects directly.',
          marks: '10 marks',
          colour: 'analysis',
        },
        {
          time: '0:45 - 1:00',
          label: 'A5 — Evaluation (10 marks)',
          detail: 'To what extent do you agree? Take a clear position.',
          marks: '10 marks',
          colour: 'analysis',
        },
        {
          time: '1:00 - 1:05',
          label: 'B — Plan creative writing',
          detail: 'Choice of four prompts. Plan opening, structure, ending.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:05 - 1:40',
          label: 'B — Write creative piece (40 marks)',
          detail: '24 marks AO5 + 16 marks AO6.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
      ...
      rows: [
        {
          time: '0:00 - 0:15',
          label: 'Read both source texts',
          detail: 'Read both fully. Note tone, audience, purpose.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:15 - 0:25',
          label: 'A1-A2 — Retrieval and language (10 marks)',
          detail: 'Two short questions on Text 1.',
          marks: '10 marks',
          colour: 'reading',
        },
        {
          time: '0:25 - 0:35',
          label: 'A3 — Inference (10 marks)',
          detail: 'Inference and impressions from Text 1.',
          marks: '10 marks',
          colour: 'reading',
        },
        {
          time: '0:35 - 0:45',
          label: 'A4 — Retrieval Text 2 (10 marks)',
          detail: 'Retrieval and inference from Text 2.',
          marks: '10 marks',
          colour: 'reading',
        },
        {
          time: '0:45 - 1:00',
          label: 'A5 — Comparison of attitudes (10 marks)',
          detail: "Compare writers' attitudes across both texts.",
          marks: '10 marks',
          colour: 'comparison',
        },
        {
          time: '1:00 - 1:05',
          label: 'B1 — Plan task 1 writing',
          detail: 'Identify form, audience, purpose.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:05 - 1:30',
          label: 'B1 — Writing task 1 (20 marks)',
          detail: 'Persuasive or transactional writing.',
          marks: '20 marks',
          colour: 'creative',
        },
        {
          time: '1:30 - 1:55',
          label: 'B2 — Writing task 2 (20 marks)',
          detail: 'Second persuasive or transactional task.',
          marks: '20 marks',
          colour: 'creative',
        },
        {
          time: '1:55 - 2:00',
          label: 'Proofread',
          detail: 'Check both writing tasks.',
          marks: 'Check',
          colour: 'check',
        },
      ],
      warning:
        'Eduqas Lang Component 2 has TWO writing tasks (20 marks each), not one big one. Both must be different forms. Plan both before starting.',
    },
    {
      ...
      rows: [
        ...
        {
          time: '0:05 - 0:55',
          label: 'Section A — Shakespeare (40 marks)',
          detail: 'Extract analysis + wider play essay. AO4 SPaG marked.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '0:55 - 1:00',
          label: 'Plan anthology comparison',
          detail: 'Choose comparison poem.',
          marks: 'Plan',
          colour: 'plan',
        },
        {
          time: '1:00 - 1:25',
          label: 'Section B Part 1 — Anthology comparison (20 marks)',
          detail: 'Compare a named anthology poem with one of your choice.',
          marks: '20 marks',
          colour: 'comparison',
        },
        {
          time: '1:25 - 2:00',
          label: 'Section B Part 2 — Named anthology poem (20 marks)',
          detail: 'Detailed analysis of a single anthology poem.',
          marks: '20 marks',
          colour: 'analysis',
        },
      ],
    ...
    },
    {
      ...
      badge: '2h 30m',
      description: 'Post-1914 prose/drama + 19th-century prose + Unseen poetry. Three sections.',
      rows: [
        {
          time: '0:00 - 0:05',
          label: 'Read post-1914 question',
          detail: 'Choose one of two questions. Underline focus.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:05 - 0:50',
          label: 'Section A — Post-1914 prose/drama (40 marks)',
          detail: 'No extract. Quotations from memory. AO4 SPaG marked.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '0:50 - 0:55',
          label: 'Read 19th-century extract',
          detail: 'Identify focus.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '0:55 - 1:40',
          label: 'Section B — 19th-century prose (40 marks)',
          detail: 'Extract + wider novel essay. AO4 SPaG marked.',
          marks: '40 marks',
          colour: 'creative',
        },
        {
          time: '1:40 - 1:50',
          label: 'Read unseen poems',
          detail: 'Two unseen poems. Annotate.',
          marks: 'Prep',
          colour: 'prep',
        },
        {
          time: '1:50 - 2:10',
          label: 'Section C Part 1 — Unseen poem (15 marks)',
          detail: 'Single unseen poem analysis.',
          marks: '15 marks',
          colour: 'analysis',
        },
        {
          time: '2:10 - 2:30',
          label: 'Section C Part 2 — Unseen comparison (25 marks)',
          detail: 'Compare both unseen poems.',
          marks: '25 marks',
          colour: 'comparison',
        },
      ],
      warning:
        'Eduqas Lit C2 is the longest paper at 2h 30m. Three sections, two 40-mark essays and unseen poetry. Stamina is essential — practise full papers under timed conditions.',
    },
  ],
  questionTypes: [
    {
      paper: 'Lang C1',
      question: 'A1 — Retrieval',
      marks: '5',
      description: 'List or identify from extract.',
      approach: 'Quick, focused retrieval. 5 minutes max.',
    },
    {
      paper: 'Lang C1',
      question: 'A2 — Language analysis',
      marks: '5',
      description: 'How does the writer use language?',
      approach: 'Two short language points.',
    },
    {
      paper: 'Lang C1',
      question: 'A3 — Methods',
      marks: '10',
      description: 'Detailed language and structure analysis.',
      approach: '3-4 points combining language and structure.',
    },
    {
      paper: 'Lang C1',
      question: 'A4 — Effect on reader',
      marks: '10',
      description: 'How is the reader made to feel?',
      approach: 'Trace effects across the extract with quotations.',
    },
    {
      paper: 'Lang C1',
      question: 'A5 — Evaluation',
      marks: '10',
      description: 'To what extent do you agree with a statement?',
      approach: 'Clear position. 3 evaluative points with evidence.',
    },
    {
      paper: 'Lang C1',
      question: 'B — Creative writing',
      marks: '40',
      description: 'Choice of four prompts (descriptive or narrative).',
      approach: 'Single focused moment. Sensory detail.',
    },
    {
      paper: 'Lang C2',
      question: 'A1-A2 — Retrieval and language',
      marks: '10',
      description: 'Two short questions on Text 1.',
      approach: 'Direct answers with brief explanation.',
    },
    {
      paper: 'Lang C2',
      question: 'A3 — Inference',
      marks: '10',
      description: 'Inference and impressions from Text 1.',
      approach: 'Quotation + inference + explanation.',
    },
    {
      paper: 'Lang C2',
      question: 'A4 — Retrieval Text 2',
      marks: '10',
      description: 'Retrieval and inference from Text 2.',
      approach: 'Direct answers with evidence.',
    },
    {
      paper: 'Lang C2',
      question: 'A5 — Comparison of attitudes',
      marks: '10',
      description: "Compare writers' attitudes.",
      approach: 'Both texts in every paragraph.',
    },
    {
      paper: 'Lang C2',
      question: 'B1 — Writing task 1',
      marks: '20',
      description: 'Persuasive or transactional writing.',
      approach: 'Match form. Persuasive techniques.',
    },
    {
      paper: 'Lang C2',
      question: 'B2 — Writing task 2',
      marks: '20',
      description: 'Second writing task in different form.',
      approach: 'Different form from B1. Match conventions.',
    },
    {
      paper: 'Lit C1',
      question: 'Shakespeare',
      marks: '40',
      description: 'Extract + wider play essay.',
      approach: 'Anchor in extract. AO4 SPaG marked.',
    },
    {
      paper: 'Lit C1',
      question: 'Anthology poetry comparison',
      marks: '20',
      description: 'Compare a named poem with one of your choice.',
      approach: 'Methods in every paragraph.',
    },
    {
      paper: 'Lit C1',
      question: 'Named anthology poem',
      marks: '20',
      description: 'Detailed analysis of a single named poem.',
      approach: 'Language, form, structure, context.',
    },
    {
      paper: 'Lit C2',
      question: 'Post-1914 prose/drama',
      marks: '40',
      description: 'Choice of two questions. No extract.',
      approach: 'Quotations from memory. SPaG marked.',
    },
    {
      paper: 'Lit C2',
      question: '19th-century prose',
      marks: '40',
      description: 'Extract + wider novel essay.',
      approach: 'Anchor in extract. SPaG marked.',
    },
    {
      paper: 'Lit C2',
      question: 'Unseen poem',
      marks: '15',
      description: 'Single unseen poem analysis.',
      approach: 'Language, structure, form, voice.',
    },
    {
      paper: 'Lit C2',
      question: 'Unseen poetry comparison',
      marks: '25',
      description: 'Compare both unseen poems.',
      approach: 'Methods in every paragraph.',
    },
  ],
  essay: {
