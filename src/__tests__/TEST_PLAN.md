...
**Last updated:** 2026-03-22. **Six months stale as of 19 September 2026, and
left dated rather than touched** (MAINT-5).

Re-dating it without re-reading it would be worse than leaving it: the date is
the only honest signal a reader has that its contents predate almost everything
in `src/__tests__/` today. The suite it describes has grown to over 3,000 tests
across 178 files; this document describes a much smaller one.

Treat it as a record of intent from March, not a description of what exists. For
what the suite actually covers, read the test files - most now open with a
docblock naming the defect they were written for.
