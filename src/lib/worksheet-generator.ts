  ...
  if (difficulty === 'foundation') {
    sections.push({
      ...
      questions: [
        {
          number: 1,
          question: 'Write out the quote in your own words. What is the character/speaker saying?',
          lines: 4,
        },
        {
          number: 2,
          question: `Who says this quote? When in ${textLabel} does it appear?`,
          lines: 3,
        },
        {
          number: 3,
          question: `What does this quote tell us about the theme of "${topicLabel}"?`,
          lines: 4,
        },
      ],
    })
    sections.push({
      ...
      questions: [
        {
          number: 4,
          question: 'Identify ONE interesting word or phrase from the quote. Write it here:',
          lines: 1,
        },
        {
          number: 5,
          question:
            'The word/phrase "___" suggests... (What does it make the reader think or feel?)',
          lines: 4,
        },
        {
          number: 6,
          question:
            'The writer may have chosen this word because... (Think about the effect on the reader)',
          lines: 4,
        },
      ],
    })
    sections.push({
      ...
      questions: [
        {
          number: 7,
          question: `What was happening in society when ${textLabel} was written that links to this quote?`,
          lines: 4,
        },
        {
          number: 8,
          question: 'How would the original audience have reacted to this quote? Why?',
          lines: 4,
        },
      ],
    })
    ...
    sections.push({
      ...
      questions: [
        {
          number: 1,
          question: 'Summarise the meaning of this quote in your own words.',
          lines: 4,
          marks: 2,
        },
        {
          number: 2,
          question: `Explain the significance of this quote in the context of ${textLabel}.`,
          lines: 5,
          marks: 4,
        },
      ],
      ...
      questions: [
        {
          number: 3,
          question:
            'Identify and analyse TWO language techniques used in this quote. Explain the effect of each on the reader.',
          lines: 8,
          marks: 6,
        },
        {
          number: 4,
          question:
            'How does the position/placement of this quote within the text contribute to its meaning?',
          lines: 5,
          marks: 4,
        },
      ],
    ...
    sections.push({
      ...
      questions: [
        {
          number: 5,
          question: 'How does this quote reflect the social or historical context of the time?',
          lines: 5,
          marks: 4,
        },
        {
          number: 6,
          question: `How does the writer use this quote to present ideas about "${topicLabel}"? Write a PEEL paragraph.`,
          lines: 10,
          marks: 8,
        },
      ],
      ...
      questions: [
        {
          number: 1,
          question:
            "Analyse the semantic field(s) present in this quote. How do they contribute to the writer's message?",
          lines: 7,
          marks: 6,
        },
        {
          number: 2,
          question:
            'Explore how the syntax and structure of this quote shapes meaning and reader response.',
          lines: 7,
          marks: 6,
        },
      ],
    ...
    sections.push({
      ...
      instructions:
        'Demonstrate sophisticated understanding of context as a lens for interpretation.',
      questions: [
        {
          number: 3,
          question: `How might a contemporary audience have interpreted this quote differently from a modern reader? Consider at least TWO contextual factors.`,
          lines: 8,
          marks: 8,
        },
        {
          number: 4,
          question:
            "Some critics argue this quote reveals the writer's ambivalence. To what extent do you agree?",
          lines: 8,
          marks: 8,
        },
      ],
    ...
    sections.push({
      ...
      questions: [
        {
          number: 5,
          question: `Starting from this quote, write a detailed analytical paragraph exploring how the writer presents "${topicLabel}" in ${textLabel}. You should analyse language, structure, and context.`,
          lines: 14,
          marks: 12,
        },
      ],
...
function generateComparisonFrame(config: WorksheetConfig): GeneratedWorksheet {
  ...
  if (difficulty === 'foundation') {
      ...
      questions: [
        {
          number: 5,
          question:
            'POINT: Both texts present... / While Text A..., Text B... (Write your comparison point)',
          lines: 4,
        },
        {
          number: 6,
          question:
            'EVIDENCE: In Text A, the writer uses "___" ... In Text B, the writer uses "___" ...',
          lines: 5,
        },
        {
          number: 7,
          question:
            'EXPLAIN: This suggests... / The effect of this is... / The reader might feel...',
          lines: 5,
        },
        {
          number: 8,
          question: 'LINK: Overall, this shows that... / This links to the idea of...',
          lines: 4,
        },
      ],
    })
      ...
      questions: [
        {
          number: 1,
          question:
            'Identify ONE similarity in how the two texts approach this theme. Support with a brief quotation from each.',
          lines: 6,
          marks: 4,
        },
        {
          number: 2,
          question: 'Identify ONE difference. Support with a brief quotation from each.',
          lines: 6,
          marks: 4,
        },
      ],
    ...
    sections.push({
      ...
      instructions:
        'Write TWO PEEL paragraphs comparing the texts. Use connectives: similarly, in contrast, whereas, however, likewise.',
      questions: [
        {
          number: 3,
          question: "PEEL Paragraph 1: Compare the writers' use of LANGUAGE to present this theme.",
          lines: 10,
          marks: 8,
        },
        {
          number: 4,
          question:
            "PEEL Paragraph 2: Compare the writers' use of STRUCTURE or FORM to present this theme.",
          lines: 10,
          marks: 8,
        },
      ],
      ...
      questions: [
        {
          number: 5,
          question:
            'Which text do you think presents this theme more effectively? Justify your answer.',
          lines: 7,
          marks: 6,
        },
      ],
    ...
    sections.push({
      ...
      instructions:
        "Move beyond surface-level comparison to explore the writers' intentions and methods.",
      questions: [
        {
          number: 1,
          question: `Both writers engage with "${topicLabel}" but adopt fundamentally different approaches. Analyse how each writer\'s method reflects their purpose, audience, and context.`,
          lines: 10,
          marks: 10,
        },
        {
          number: 2,
          question:
            'Compare how the writers use language to position the reader. Consider tone, register, and rhetorical strategies.',
          lines: 10,
          marks: 10,
        },
      ],
    ...
    sections.push({
      ...
      questions: [
        {
          number: 3,
          question: `Compare how the two writers present their ideas about "${topicLabel}". In your answer you should: compare their ideas and perspectives; compare the methods they use; support with quotations from both texts.`,
          lines: 20,
          marks: 16,
        },
      ],
      ...
      d === 'foundation'
        ? [
            {
              number: 1,
              question:
                'List THREE things you learn about the character/setting from this extract.',
              lines: 5,
              marks: 3,
            },
            {
              number: 2,
              question: 'What is the mood/atmosphere at the start of this extract?',
              lines: 4,
              marks: 2,
            },
          ]
        : d === 'core'
          ? [
              {
                number: 1,
                question: 'Summarise what happens in this extract in your own words.',
                lines: 4,
                marks: 2,
              },
              {
                number: 2,
                question:
                  'What impression does the reader get of the main character/speaker? Support your answer.',
                lines: 6,
                marks: 4,
              },
            ]
          : [
              {
                number: 1,
                question:
                  'How does the writer establish a narrative voice in this extract? What is its effect?',
                lines: 6,
                marks: 4,
              },
            ],
      ...
      d === 'foundation'
        ? [
            {
              number: 3,
              question:
                'Find ONE example of a simile, metaphor, or personification. Write it here:',
              lines: 3,
            },
            {
              number: 4,
              question:
                'What effect does this technique have on the reader? (It makes the reader feel... / It suggests...)',
              lines: 5,
              marks: 3,
            },
            {
              number: 5,
              question: 'Find ONE powerful verb or adjective. What does it suggest?',
              lines: 5,
              marks: 3,
            },
          ]
        : d === 'core'
          ? [
              {
                number: 3,
                question: `How does the writer use language to present "${topicLabel}" in this extract? Analyse TWO examples.`,
                lines: lines(d, 6),
                marks: 8,
              },
              {
                number: 4,
                question:
                  'How does the writer use structure to interest the reader? Consider beginnings, endings, shifts in focus.',
                lines: lines(d, 6),
                marks: 8,
              },
            ]
          : [
              {
                number: 2,
                question: `Analyse how the writer uses language and structure to present "${topicLabel}". You should consider: word choice, imagery, sentence forms, narrative perspective, and structural shifts.`,
                lines: 14,
                marks: 12,
              },
            ],
      ...
      d === 'foundation'
        ? [
            {
              number: 6,
              question:
                'Do you think the writer does a good job of making the reader feel a strong emotion? Explain why, using a quote.',
              lines: 7,
              marks: 4,
            },
          ]
        : d === 'core'
          ? [
              {
                number: 5,
                question: `"The writer successfully creates a sense of ${topicLabel.toLowerCase()} throughout this extract." To what extent do you agree? Use evidence to support your response.`,
                lines: 8,
                marks: 8,
              },
            ]
          : [
              {
                number: 3,
                question: `A critic has written: "In this extract, the writer masterfully manipulates the reader's sympathies." Evaluate this statement with detailed reference to the text. You may agree, disagree, or offer a nuanced response.`,
                lines: 14,
                marks: 12,
              },
            ],
        ...
        ? [
            {
              number: 1,
              question:
                'Setting: Where and when is your writing set? List 5 things you can SEE, HEAR, SMELL, TOUCH, or TASTE.',
              lines: 5,
            },
            {
              number: 2,
              question: 'Characters: Who is in your writing? Write 2-3 words to describe them.',
              lines: 3,
            },
            {
              number: 3,
              question: 'Structure: What happens at the beginning, middle, and end?',
              lines: 5,
            },
            {
              number: 4,
              question: 'Vocabulary: Write 5 ambitious words or phrases you could use.',
              lines: 3,
            },
          ]
        : d === 'core'
          ? [
              {
                number: 1,
                question:
                  'Opening: How will you hook the reader? (Consider starting with: dialogue, action, description, a question)',
                lines: 3,
              },
              {
                number: 2,
                question:
                  'Techniques to include: List at least 4 language/structural techniques you will use (e.g., metaphor, short sentence, cyclical structure, pathetic fallacy).',
                lines: 3,
              },
              {
                number: 3,
                question:
                  'Structural arc: Plan your 4-5 paragraph structure. Note the shift/turning point.',
                lines: 5,
              },
            ]
          : [
              {
                number: 1,
                question:
                  'Conceptual plan: What is the deeper meaning or theme you want to explore through this piece? How will form and structure serve this meaning?',
                lines: 4,
              },
              {
                number: 2,
                question:
                  'Narrative voice and perspective: Who is telling this story? Why? What are the limitations of their perspective?',
                lines: 3,
              },
              {
                number: 3,
                question:
                  'Structural design: Map your structural arc. Consider: time shifts, perspective changes, motifs, cyclical elements, and pacing.',
                lines: 4,
              },
            ],
  })
          ...
          ? [
              {
                number: 6,
                question:
                  'Check: Have you used a simile or metaphor? Have you used interesting adjectives? Have you used at least one short sentence for effect? Have you started sentences in different ways? Have you checked your spelling and punctuation?',
                lines: 3,
              },
            ]
          : [
              {
                number: 5,
                question:
                  'Check: Does your opening hook the reader? Have you used at least 4 language techniques? Is there a clear structural arc with a shift/turning point? Have you varied your sentence lengths deliberately? Is your vocabulary ambitious and precise? Have you proofread for SPAG?',
                lines: 4,
              },
            ],
    })
...
function generateVocabularyBuilder(config: WorksheetConfig): GeneratedWorksheet {
      ...
      d === 'foundation'
        ...
        : d === 'core'
          ? [
              {
                number: 1,
                question: 'Define Term 1 in your own words and provide an example from the text:',
                lines: 4,
                marks: 2,
              },
              {
                number: 2,
                question: 'Define Term 2 in your own words and provide an example from the text:',
                lines: 4,
                marks: 2,
              },
              {
                number: 3,
                question: 'Define Term 3 in your own words and provide an example from the text:',
                lines: 4,
                marks: 2,
              },
              {
                number: 4,
                question: 'Define Term 4 in your own words and provide an example from the text:',
                lines: 4,
                marks: 2,
              },
              {
                number: 5,
                question: 'Define Term 5 in your own words and provide an example from the text:',
                lines: 4,
                marks: 2,
              },
              {
                number: 6,
                question: 'Define Term 6 in your own words and provide an example from the text:',
                lines: 4,
                marks: 2,
              },
            ]
          : [
              {
                number: 1,
                question:
                  'Define each term, explain its connotations, and analyse why the writer chose it over a synonym:',
                lines: 4,
                marks: 3,
              },
  ...
  sections.push({
    ...
    questions: [
      {
        number: 7,
        question: 'The writer uses _____________ to create a sense of...',
        lines: lines(d, 2),
        marks: d === 'foundation' ? undefined : 2,
      },
      {
        number: 8,
        question: 'When the character _____________, this demonstrates...',
        lines: lines(d, 2),
        marks: d === 'foundation' ? undefined : 2,
      },
      {
        number: 9,
        question: 'The theme of _____________ is developed through...',
        lines: lines(d, 2),
        marks: d === 'foundation' ? undefined : 2,
      },
    ],
  ...
  if (d === 'foundation') {
    sections.push({
      ...
      questions: [
        ...
        {
          number: 3,
          question: 'Point 1: What is one way the writer presents this theme?',
          lines: 2,
        },
        { number: 4, question: 'Evidence 1: Write a quote that supports your point:', lines: 2 },
        {
          number: 5,
          question: 'Point 2: What is another way the writer presents this theme?',
          lines: 2,
        },
        { number: 6, question: 'Evidence 2: Write a quote that supports your point:', lines: 2 },
        {
          number: 7,
          question: 'Context: What was happening in society that links to this theme?',
          lines: 2,
        },
      ],
    })
    ...
    sections.push({
      ...
      instructions:
        'Plan at least 3 points with evidence and analysis. Consider language, structure, and context.',
      questions: [
        {
          number: 2,
          question: 'Plan your response here (bullet points, spider diagram, or table):',
          lines: 8,
        },
      ],
    })
    ...
    questions:
      d === 'foundation'
        ? [
            {
              number: 1,
              question: `Who is ${characterName}? Describe them in 2-3 sentences.`,
              lines: 4,
            },
            {
              number: 2,
              question: `What are ${characterName}'s main personality traits? List at least 3.`,
              lines: 3,
            },
            {
              number: 3,
              question: `How does ${characterName} change during the text? (Beginning vs. End)`,
              lines: 5,
            },
          ]
        : d === 'core'
          ? [
              {
                number: 1,
                question: `Summarise ${characterName}'s role and significance in ${textLabel}.`,
                lines: 4,
                marks: 4,
              },
              {
                number: 2,
                question: `Trace ${characterName}'s character arc. How and why do they change?`,
                lines: 5,
                marks: 6,
              },
            ]
          : [
              {
                number: 1,
                question: `Analyse ${characterName} as a vehicle for the writer's ideas. What do they represent?`,
                lines: 5,
                marks: 6,
              },
              {
                number: 2,
                question: `How does the writer use ${characterName} to challenge or reinforce the values of the time?`,
                lines: 5,
                marks: 6,
              },
            ],
      ...
      d === 'foundation'
        ...
        : d === 'core'
          ? [
              {
                number: 3,
                question:
                  'Quote 1: Analyse the language used. What does it reveal about the character?',
                lines: 6,
                marks: 4,
              },
              {
                number: 4,
                question: 'Quote 2: How does this quote show a change or development?',
                lines: 6,
                marks: 4,
              },
              {
                number: 5,
                question: 'Quote 3: How does this quote link to a key theme?',
                lines: 6,
                marks: 4,
              },
            ]
          : [
              {
                number: 3,
                question: `Select 3 quotations that chart ${characterName}'s arc. For each: analyse the language in detail, explore what it reveals about the writer's intentions, and explain how it connects to wider themes and context.`,
                lines: 12,
                marks: 12,
              },
            ],
    ...
    questions:
      d === 'foundation'
        ? [
            {
              number: 7,
              question: `What was happening in society when this text was written that relates to ${characterName}?`,
              lines: 5,
              marks: 3,
            },
            {
              number: 8,
              question: `If you had to write an essay about ${characterName}, what would your main argument be?`,
              lines: 5,
              marks: 3,
            },
          ]
        : d === 'core'
          ? [
              {
                number: 6,
                question: `How does ${characterName} reflect the social/historical context? Give specific examples.`,
                lines: 7,
                marks: 6,
              },
              {
                number: 7,
                question: `Write an essay-style PEEL paragraph about ${characterName} and a key theme.`,
                lines: 10,
                marks: 8,
              },
            ]
          : [
              {
                number: 4,
                question: `Write a thesis statement about ${characterName} that could anchor a full essay. Then write two supporting analytical paragraphs with integrated context.`,
                lines: 16,
                marks: 16,
              },
            ],
    ...
    questions:
      d === 'foundation'
        ? [
            {
              number: 1,
              question: `What does "${topicLabel}" mean? Write a definition in your own words.`,
              lines: 4,
            },
            {
              number: 2,
              question: `How is "${topicLabel}" shown in ${textLabel}? Give 2-3 examples from the story.`,
              lines: 6,
            },
          ]
        : d === 'core'
          ? [
              {
                number: 1,
                question: `Write a clear theme statement: "In ${textLabel}, the writer presents ${topicLabel.toLowerCase()} as..."`,
                lines: 4,
                marks: 3,
              },
              {
                number: 2,
                question: `How does the writer's presentation of this theme change across the text?`,
                lines: 7,
                marks: 5,
              },
            ]
          : [
              {
                number: 1,
                question: `Craft a conceptualised thesis statement about "${topicLabel}" in ${textLabel}. This should go beyond description to argue a specific interpretation.`,
                lines: 4,
                marks: 4,
              },
            ],
    ...
    questions:
      d === 'foundation'
        ? [
            {
              number: 3,
              question: 'Quote from the BEGINNING of the text: "___" - This shows...',
              lines: 5,
            },
            {
              number: 4,
              question: 'Quote from the MIDDLE of the text: "___" - This shows...',
              lines: 5,
            },
            {
              number: 5,
              question: 'Quote from the END of the text: "___" - This shows...',
              lines: 5,
            },
          ]
        : d === 'core'
          ? [
              {
                number: 3,
                question:
                  "Identify a key moment where this theme is introduced. Analyse the writer's language choices.",
                lines: 7,
                marks: 5,
              },
              {
                number: 4,
                question:
                  'Identify a moment where this theme develops or shifts. Analyse how the writer signals this change.',
                lines: 7,
                marks: 5,
              },
              {
                number: 5,
                question:
                  'Identify the climactic moment for this theme. How does the writer create impact?',
                lines: 7,
                marks: 5,
              },
            ]
          : [
              {
                number: 2,
                question: `Trace the trajectory of "${topicLabel}" across the text. Select 3-4 key moments and analyse how the writer's methods evolve. Consider: language, structure, symbolism, and narrative technique.`,
                lines: 12,
                marks: 12,
              },
            ],
    ...
    questions:
      d === 'foundation'
        ? [
            {
              number: 6,
              question: `Why do you think the writer wanted to write about "${topicLabel}"? What message are they trying to give?`,
              lines: 5,
              marks: 3,
            },
            {
              number: 7,
              question: 'What was happening in society at the time that links to this theme?',
              lines: 5,
              marks: 3,
            },
          ]
        : d === 'core'
          ? [
              {
                number: 6,
                question: `What is the writer's message about "${topicLabel}"? How does this reflect the values of the time?`,
                lines: 7,
                marks: 5,
              },
              {
                number: 7,
                question: `How might a modern reader respond to this theme differently from the original audience?`,
                lines: 7,
                marks: 5,
              },
            ]
          : [
              {
                number: 3,
                question: `Evaluate the writer's purpose in exploring "${topicLabel}". Consider: the writer as a social commentator, the political/cultural context, and how the text functions as a critique or endorsement of contemporary values.`,
                lines: 10,
                marks: 8,
              },
            ],
      ...
      questions:
        d === 'core'
          ? [
              {
                number: 8,
                question: `How does "${topicLabel}" in ${textLabel} compare to the same theme in another text you have studied?`,
                lines: 7,
                marks: 5,
              },
            ]
          : [
              {
                number: 4,
                question: `Write a comparative paragraph linking "${topicLabel}" in ${textLabel} to its treatment in another text. Explore how the different writers' contexts shape their approaches.`,
                lines: 10,
                marks: 10,
              },
            ],
