 ...
 */
export const B1_KS3_DICTIONARY: Record<string, { en: string; ar?: string; es?: string }> = {
  // ── KS3 hub page - stat boxes ──────────────────────────────────────────────
  'ks3.hub.stat.year_groups': { en: 'Year groups', ar: 'المجموعات السنوية', es: 'Cursos' },
  'ks3.hub.stat.terms_mapped': {
    en: 'Terms mapped',
    ar: 'الفصول المخططة',
    es: 'Trimestres planificados',
  },
  'ks3.hub.stat.skill_codes': {
    en: 'Skill codes',
    ar: 'رموز المهارات',
    es: 'Códigos de destrezas',
  },
  'ks3.hub.stat.rubric_rows': {
    en: 'Rubric rows',
    ar: 'صفوف معايير التصحيح',
    es: 'Filas de rúbrica',
  },
  ...
  'ks3.hub.ils.body': {
    ...
    es: 'El centro completo para el estudiante del examen {paperCode}: la especificación y el esquema de calificación, clases magistrales de destrezas para cada objetivo de lectura y escritura, guías de tipos de preguntas, seis exámenes de práctica originales completos, un cuestionario, laboratorio de gramática y plan de estudio.',
  },
  'ks3.hub.ils.cta': {
    en: 'Open the exam hub',
    ar: 'افتح مركز الامتحان',
    es: 'Abrir el centro de examen',
  },

  // ── KS3 hub page - reference & standards section ───────────────────────────
  'ks3.hub.reference.heading': {
    en: 'Reference & standards',
    ar: 'المراجع والمعايير',
    es: 'Referencia y estándares',
  },
  'ks3.hub.reference.explore': { en: 'Explore', ar: 'استكشف', es: 'Explorar' },
  'ks3.hub.reference.skills.desc': {
    ...
    es: 'La progresión de destrezas de KS3 mapeada código por código en Lectura, Escritura, Lengua y Expresión y Comprensión Oral; cada código muestra en qué se convierte al año siguiente.',
  },
  'ks3.hub.reference.rubrics.desc': {
    ...
    es: 'Rúbricas de calificación año por año con descriptores de nivel, de modo que cada producción independiente se evalúa según un estándar coherente y transparente.',
  },
  'ks3.hub.reference.endks3.desc': {
    ...
    es: 'El estándar esperado al final de KS3 en lectura, escritura, gramática, expresión oral y conocimiento literario; el listón que los estudiantes superan antes de GCSE.',
  },
  ...
  'ks3.hub.start.heading': {
    ...
    es: 'Empieza por el principio: {yearLabel}',
  },
  'ks3.hub.start.heading_prefix': {
    en: 'Start at the beginning:',
    ar: 'ابدأ من الأساس:',
    es: 'Empieza por el principio:',
  },
  'ks3.hub.start.body': {
    ...
    es: 'El curso de Fundamentos construye los reflejos básicos de lectura y escritura de los que depende el resto de KS3. Abre Year 7 para ver los planes trimestrales y los marcos de las lecciones semanales.',
  },
  ...
  'ks3.ils.nav.aria': {
    ...
    es: 'Secciones de iLowerSecondary English',
  },
  'ks3.ils.nav.header': {
  ...
  'ks3.ils.nav.overview': { en: 'Overview', ar: 'نظرة عامة', es: 'Visión general' },
  'ks3.ils.nav.specification': { en: 'Specification', ar: 'المواصفات', es: 'Especificación' },
  'ks3.ils.nav.exam_format': { en: 'Exam format', ar: 'شكل الامتحان', es: 'Formato del examen' },
  'ks3.ils.nav.mark_scheme': {
    en: 'Mark scheme',
    ar: 'مخطط الدرجات',
    es: 'Esquema de calificación',
  },
  'ks3.ils.nav.grade_targets': {
    en: 'Grade targets S1-S4',
    ar: 'أهداف الدرجات S1-S4',
    es: 'Notas objetivo S1-S4',
  },
  'ks3.ils.nav.reading_skills': {
    en: 'Reading skills',
    ar: 'مهارات القراءة',
    es: 'Destrezas de lectura',
  },
  'ks3.ils.nav.writing_skills': {
    en: 'Writing skills',
    ar: 'مهارات الكتابة',
    es: 'Destrezas de escritura',
  },
  'ks3.ils.nav.question_types': {
    en: 'Question types',
    ar: 'أنواع الأسئلة',
    es: 'Tipos de preguntas',
  },
  'ks3.ils.nav.text_types': { en: 'Text types', ar: 'أنواع النصوص', es: 'Tipos de textos' },
  'ks3.ils.nav.fiction': { en: 'Fiction', ar: 'الأدب', es: 'Ficción' },
  'ks3.ils.nav.practice': {
    en: 'Practice papers',
    ar: 'أوراق التدريب',
    es: 'Exámenes de práctica',
  },
  'ks3.ils.nav.quiz': { en: 'Quiz', ar: 'كويز', es: 'Cuestionario' },
  'ks3.ils.nav.grammar_lab': {
    en: 'Grammar lab',
    ar: 'مختبر القواعد',
    es: 'Laboratorio de gramática',
  },
  'ks3.ils.nav.vocabulary': { en: 'Vocabulary', ar: 'المفردات', es: 'Vocabulario' },

  // ── iLowerSecondary overview page - breadcrumb ─────────────────────────────
  'ks3.ils.breadcrumb.home': { en: 'Home', ar: 'الرئيسية', es: 'Inicio' },
  'ks3.ils.breadcrumb.ks3': {
    en: 'Key Stage 3',
    ar: 'المرحلة الرئيسية الثالثة KS3',
    es: 'Key Stage 3',
  },
  'ks3.ils.breadcrumb.ils': {
    en: 'iLowerSecondary English',
    ar: 'iLowerSecondary English',
    es: 'iLowerSecondary English',
  },
  ...
  'ks3.ils.overview.who_body': {
    ...
    es: 'Esta titulación la presentan estudiantes de Year 9 que siguen el Pearson Edexcel iLowerSecondary English Curriculum.',
  },
  'ks3.ils.overview.progression_heading': {
    en: 'Strong performance progresses naturally to:',
    ar: 'الأداء القوي يفضي بشكل طبيعي إلى:',
    es: 'Un buen rendimiento progresa de forma natural hacia:',
  },
  'ks3.ils.overview.glance_heading': {
    en: 'Exam at a glance',
    ar: 'الامتحان بنظرة سريعة',
    es: 'El examen de un vistazo',
  },
  'ks3.ils.overview.glance_assessment': { en: 'Assessment', ar: 'طريقة التقييم', es: 'Evaluación' },
  'ks3.ils.overview.glance_duration': { en: 'Duration', ar: 'المدة', es: 'Duración' },
  'ks3.ils.overview.glance_duration_detail': {
    ...
    es: 'Una sola sesión, sin descansos. No se permiten diccionarios.',
  },
  'ks3.ils.overview.glance_total_marks': {
    en: 'Total marks',
    ar: 'مجموع الدرجات',
    es: 'Puntuación total',
  },
  'ks3.ils.overview.glance_sections': { en: 'Sections', ar: 'الأقسام', es: 'Secciones' },
  'ks3.ils.overview.glance_grading': { en: 'Grading', ar: 'نظام التقدير', es: 'Calificación' },
  'ks3.ils.overview.glance_availability': {
    en: 'Availability',
    ar: 'مواعيد التوفر',
    es: 'Disponibilidad',
  },
  'ks3.ils.overview.ao_heading': {
    ...
    es: 'Los siete objetivos de evaluación',
  },
  'ks3.ils.overview.ao_intro': {
    ...
    es: 'Cada pregunta se dirige a uno de estos objetivos. Los porcentajes son la ponderación que tiene cada uno en el conjunto de la titulación.',
  },
  'ks3.ils.overview.start_here_heading': {
    en: 'Start here',
    ar: 'ابدأ من هنا',
    es: 'Empieza aquí',
  },
  ...
  'ks3.ils.start.specification.title': {
    en: 'Specification',
    ar: 'المواصفات',
    es: 'Especificación',
  },
  'ks3.ils.start.specification.blurb': {
    ...
    es: 'El desglose completo del contenido: qué se evalúa y por qué.',
  },
  'ks3.ils.start.exam_format.title': {
    en: 'Exam format',
    ar: 'شكل الامتحان',
  ...
  'ks3.ils.start.exam_format.blurb': {
    ...
    es: 'Lectura de la Section A, escritura de la Section B, tiempos y el cuadernillo de textos.',
  },
  'ks3.ils.start.mark_scheme.title': {
    en: 'Mark scheme',
    ar: 'مخطط الدرجات',
    es: 'Esquema de calificación',
  },
  'ks3.ils.start.mark_scheme.blurb': {
    ...
    es: 'Cómo otorgan las notas los examinadores, incluidas las cuadrículas de escritura por niveles.',
  },
  'ks3.ils.start.grade_targets.title': {
    en: 'Grade targets S1-S4',
    ar: 'أهداف الدرجات S1-S4',
    es: 'Notas objetivo S1-S4',
  },
  'ks3.ils.start.grade_targets.blurb': {
    ...
    es: 'Cómo es cada nota y cómo subir de nivel.',
  },
  'ks3.ils.start.reading_skills.title': {
    en: 'Reading skills',
    ar: 'مهارات القراءة',
    es: 'Destrezas de lectura',
  },
  'ks3.ils.start.reading_skills.blurb': {
    ...
    es: 'Recuperación, inferencia, estructura, lenguaje y comparación.',
  },
  'ks3.ils.start.writing_skills.title': {
    en: 'Writing skills',
    ar: 'مهارات الكتابة',
    es: 'Destrezas de escritura',
  },
  'ks3.ils.start.writing_skills.blurb': {
    ...
    es: 'Forma, público y propósito, estructura, gramática y corrección.',
  },
  'ks3.ils.start.question_types.title': {
    en: 'Question types',
    ar: 'أنواع الأسئلة',
    es: 'Tipos de preguntas',
  },
  'ks3.ils.start.question_types.blurb': {
    ...
    es: 'Cada estilo de pregunta con orientación sobre cómo responder.',
  },
  'ks3.ils.start.text_types.title': { en: 'Text types', ar: 'أنواع النصوص', es: 'Tipos de textos' },
  'ks3.ils.start.text_types.blurb': {
    ...
    es: 'Los textos de no ficción y de ficción que puedes encontrar.',
  },
  'ks3.ils.start.fiction.title': { en: 'Fiction', ar: 'الأدب', es: 'Ficción' },
  'ks3.ils.start.fiction.blurb': {
    ...
    es: 'Trabajar con el texto de ficción desconocido y sus géneros.',
  },
  'ks3.ils.start.practice.title': {
    en: 'Practice papers',
    ar: 'أوراق التدريب',
    es: 'Exámenes de práctica',
  },
  'ks3.ils.start.practice.blurb': {
    ...
    es: 'Exámenes originales con formato de examen escritos por The English Hub.',
  },
  'ks3.ils.start.quiz.title': { en: 'Quiz', ar: 'كويز', es: 'Cuestionario' },
  'ks3.ils.start.quiz.blurb': {
    en: 'Quick-fire questions to test your understanding.',
    ar: 'أسئلة سريعة لاختبار فهمك.',
    es: 'Preguntas rápidas para poner a prueba tu comprensión.',
  },
  'ks3.ils.start.grammar_lab.title': {
    en: 'Grammar lab',
    ar: 'مختبر القواعد',
    es: 'Laboratorio de gramática',
  },
  'ks3.ils.start.grammar_lab.blurb': {
    ...
    es: 'Ejercicios de oraciones, puntuación y terminología gramatical.',
  },
  'ks3.ils.start.vocabulary.title': { en: 'Vocabulary', ar: 'المفردات', es: 'Vocabulario' },
  'ks3.ils.start.vocabulary.blurb': {
    ...
    es: 'Construye elecciones de palabras precisas y ambiciosas para las mejores notas.',
  },

  // ── Shared breadcrumb labels (reused across section indexes) ───────────────
  'ks3.ils.breadcrumb.question_types': {
    en: 'Question types',
    ar: 'أنواع الأسئلة',
    es: 'Tipos de preguntas',
  },
  'ks3.ils.breadcrumb.text_types': { en: 'Text types', ar: 'أنواع النصوص', es: 'Tipos de textos' },
  'ks3.ils.breadcrumb.fiction': { en: 'Fiction', ar: 'الأدب', es: 'Ficción' },
  'ks3.ils.breadcrumb.practice': {
    en: 'Practice papers',
    ar: 'أوراق التدريب',
    es: 'Exámenes de práctica',
  },
  ...
  'ks3.ils.shared.home': { en: 'Home', ar: 'الرئيسية', es: 'Inicio' },

  // ── Question types index page ──────────────────────────────────────────────
  'ks3.ils.qt.h1': { en: 'Question types', ar: 'أنواع الأسئلة', es: 'Tipos de preguntas' },
  'ks3.ils.qt.lead': {
    ...
    es: 'Cada estilo de pregunta que aparece en el examen de lectura de la Section A tiene su propia clase magistral: cómo está formulado, exactamente cómo se otorgan las notas y ejemplos resueltos originales.',
  },
  'ks3.ils.qt.cross_link': {
    ...
    es: 'Míralos combinados en un {practice_link} completo y compáralos con {model_link} de la banda más alta.',
  },
  'ks3.ils.qt.practice_link_text': {
    en: 'practice paper',
    ar: 'ورقة تدريبية',
    es: 'examen de práctica',
  },
  'ks3.ils.qt.model_link_text': {
    en: 'model answers',
    ar: 'إجابات نموذجية',
  ...
  'ks3.ils.qt.synonyms.blurb': {
    ...
    es: 'Rodea/subraya el sinónimo; preguntas de opción múltiple de vocabulario en contexto.',
  },
  'ks3.ils.qt.short_answer.title': {
    en: 'Short answers',
    ar: 'الإجابات القصيرة',
  ...
  'ks3.ils.qt.short_answer.blurb': {
    ...
    es: 'Recuperación e inferencia de 1-2 puntos del tipo "¿Por qué…?" / "¿Cómo…?".',
  },
  'ks3.ils.qt.punctuation.title': {
    en: 'Punctuation effect',
    ar: 'تأثير علامات الترقيم',
  ...
  'ks3.ils.qt.punctuation.blurb': {
    ...
    es: 'Nombra el efecto de un signo y luego explícalo a partir del texto.',
  },
  'ks3.ils.qt.meaning_impact.title': {
    en: 'Meaning & impact',
    ar: 'المعنى والتأثير',
  ...
  'ks3.ils.qt.meaning_impact.blurb': {
    ...
    es: '"¿Qué quiso decir el escritor…?" y preguntas de 4 puntos del tipo "¿cómo…?".',
  },
  'ks3.ils.qt.tables.title': {
  ...
  'ks3.ils.qt.tables.blurb': {
    ...
    es: 'Tablas de marcar qué texto, preguntas de opción múltiple, subrayado, qué texto resulta más atractivo.',
  },
  'ks3.ils.qt.extended.title': {
    en: 'Extended comparison',
    ar: 'المقارنة الموسّعة',
    es: 'Comparación extensa',
  },
  'ks3.ils.qt.extended.blurb': {
    ...
    es: 'La comparación por niveles de 6 puntos (RAO2 + RAO4 + RAO5).',
  },

  // ── Text types index page ──────────────────────────────────────────────────
  'ks3.ils.tt.h1': {
    en: 'Non-fiction text types',
    ar: 'أنواع النصوص غير القصصية',
    es: 'Tipos de textos de no ficción',
  },
  'ks3.ils.tt.lead_pre': {
    ...
    es: 'La Section A siempre incluye dos textos de no ficción. La especificación espera experiencia con',
  },
  'ks3.ils.tt.lead_post': {
    ...
    es: 'tipos de textos escritos con cinco propósitos. Cada guía muestra cómo leerlo analíticamente y cómo escribirlo para la Section B.',
  },
  'ks3.ils.tt.fiction_link': {
    ...
    es: 'El tercer texto de la Section A siempre es ficción - consulta las {fiction_link}.',
  },
  'ks3.ils.tt.fiction_link_text': {
    en: 'fiction guides',
    ar: 'أدلة الأدب',
    es: 'guías de ficción',
  },
  ...
  'ks3.ils.tt.auto_bio.blurb': {
    ...
    es: 'Escritura sobre la vida en primera persona y relatos sobre otros.',
  },
  'ks3.ils.tt.blogs.title': {
    en: 'Blogs & journals',
    ar: 'المدونات والمذكرات',
    es: 'Blogs y diarios',
  },
  'ks3.ils.tt.blogs.blurb': {
    ...
    es: 'Voz personal, registro informal, entradas fechadas.',
  },
  ...
  'ks3.ils.tt.leaflets.blurb': {
    ...
    es: 'Títulos, apelación directa, elementos de diseño y su efecto.',
  },
  'ks3.ils.tt.articles.title': {
    en: 'Newspaper & magazine articles',
    ar: 'مقالات الصحف والمجلات',
    es: 'Artículos de prensa y revistas',
  },
  'ks3.ils.tt.articles.blurb': {
    ...
    es: 'Titular, entradilla, estructura de noticia frente a opinión.',
  },
  'ks3.ils.tt.instructions.title': { en: 'Instructions', ar: 'التعليمات', es: 'Instrucciones' },
  'ks3.ils.tt.instructions.blurb': {
    ...
    es: 'Verbos en imperativo y secuenciación: un foco habitual de RAO4.',
  },
  'ks3.ils.tt.recount.title': { en: 'Recount', ar: 'إعادة السرد', es: 'Relato de hechos' },
  'ks3.ils.tt.recount.blurb': {
    ...
    es: 'Cronológico, en pasado: un tipo de texto y una forma de escritura a la vez.',
  },
  'ks3.ils.tt.reports.title': { en: 'Reports', ar: 'التقارير', es: 'Informes' },
  'ks3.ils.tt.reports.blurb': {
    en: 'Objective, impersonal, classified information.',
    ar: 'موضوعية، غير شخصية، معلومات مصنّفة.',
    es: 'Información objetiva, impersonal y clasificada.',
  },
  'ks3.ils.tt.purposes.title': {
    en: 'The five purposes',
    ar: 'الأهداف الخمسة',
    es: 'Los cinco propósitos',
  },
  'ks3.ils.tt.purposes.blurb': {
    ...
    es: 'Argumentar, describir, explicar, informar, persuadir: cómo reconocer cada uno.',
  },

  // ── Fiction index page ─────────────────────────────────────────────────────
  'ks3.ils.fic.h1': {
    en: 'Fiction (Section A)',
    ar: 'الأدب (Section A)',
    es: 'Ficción (Section A)',
  },
  'ks3.ils.fic.lead': {
    ...
    es: 'Uno de los tres textos de la Section A siempre es ficción. Estas guías te enseñan a leerlo analíticamente: por género, por perspectiva narrativa y mediante un método completo de lectura guiada.',
  },
  'ks3.ils.fic.practice_link': {
    ...
    es: 'Luego aplícalo en condiciones de tiempo limitado en un {practice_link}.',
  },
  'ks3.ils.fic.practice_link_text': {
    en: 'practice paper',
    ar: 'ورقة تدريبية',
    es: 'examen de práctica',
  },
  ...
  'ks3.ils.fic.reading.title': { en: 'Reading fiction', ar: 'قراءة الأدب', es: 'Leer ficción' },
  'ks3.ils.fic.reading.blurb': {
    ...
    es: 'El método de lectura guiada: personajes, argumento/estructura, estilo, con un extracto resuelto completo.',
  },
  'ks3.ils.fic.genres.title': {
    en: 'Fiction genres',
    ar: 'الأجناس الأدبية',
  ...
  'ks3.ils.fic.genres.blurb_post': {
    ...
    es: '- con extractos originales de cada género.',
  },
  'ks3.ils.fic.perspective.title': {
  ...
  'ks3.ils.fic.perspective.blurb_post': {
    ...
    es: '- y el efecto que cada una tiene en el lector.',
  },

  // ── Practice papers index page ─────────────────────────────────────────────
  'ks3.ils.prac.h1': { en: 'Practice papers', ar: 'أوراق التدريب', es: 'Exámenes de práctica' },
  'ks3.ils.prac.lead_pre': {
    ...
    es: 'Seis exámenes de práctica originales y completos elaborados exactamente según el',
  },
  'ks3.ils.prac.lead_post': {
    ...
    es: 'format - {marks} puntos, {duration}, dos secciones. Cada texto fuente es una obra original escrita para The English Hub: no se reproduce nada de un examen real anterior.',
  },
  'ks3.ils.prac.choose_heading': { en: 'Choose a paper', ar: 'اختر ورقة', es: 'Elige un examen' },
  'ks3.ils.prac.paper_label': { en: 'Paper', ar: 'الورقة', es: 'Examen' },
  'ks3.ils.prac.open_paper': {
    en: 'Open Paper {n} →',
    ar: 'افتح الورقة {n} ←',
    es: 'Abrir el examen {n} →',
  },
  'ks3.ils.prac.more_writing_heading': {
    en: 'More writing practice',
    ar: 'تدريب كتابي إضافي',
    es: 'Más práctica de escritura',
  },
  'ks3.ils.prac.more_writing_body': {
    ...
    es: '¿Quieres practicar la Section B por separado? El {tasks_link} tiene un amplio conjunto de propuestas originales de escritura extensa vinculadas a cada forma, público y propósito de la especificación, cada una con una pauta de planificación y la banda que busca el examinador.',
  },
  'ks3.ils.prac.tasks_link_text': {
    en: 'writing task bank',
    ar: 'بنك مهام الكتابة',
    es: 'banco de tareas de escritura',
  },
  'ks3.ils.prac.how_to_heading': {
    en: 'How to use these papers',
    ar: 'شلون تستخدم هذه الأوراق',
    es: 'Cómo usar estos exámenes',
  },
  'ks3.ils.prac.how_1': {
    ...
    es: 'Realiza uno en una sola sesión de {duration} sin diccionario: así se imita el examen real.',
  },
  'ks3.ils.prac.how_2': {
    ...
    es: 'Dedica unos {secA_time} a la Section A y {secB_time} a la Section B.',
  },
  'ks3.ils.prac.how_3': {
    ...
    es: 'Corrígelo tú mismo usando el esquema de calificación oculto de cada examen y el {mark_scheme_link}.',
  },
  'ks3.ils.prac.mark_scheme_link_text': {
    en: 'mark-scheme guide',
    ar: 'دليل مخطط الدرجات',
    es: 'guía del esquema de calificación',
  },
  'ks3.ils.prac.how_4': {
    ...
    es: 'Diagnostica los tipos de preguntas débiles y luego vuelve a la {skill_link} correspondiente.',
  },
  'ks3.ils.prac.skill_link_text': {
    en: 'skill masterclass',
    ar: 'حصة إتقان المهارة',
    es: 'clase magistral de la destreza',
  },
}
