...
export const IELTS_DIAGNOSTIC_DICTIONARY: Record<string, { en: string; ar?: string; es?: string }> =
  {
    ...
    'ielts.diagnostic.usage.last_free_note': {
      ...
      en: `A plan adds 10 Writing and 30 Speaking AI checks a day, full per-criterion feedback and the mock exams.`,
      ar: `الخطة تعطيك 10 فحص كتابة و30 فحص محادثة بالذكاء الاصطناعي يومياً وتغذية راجعة كاملة لكل معيار مع الاختبارات التجريبية.`,
      es: `Un plan añade 10 comprobaciones de Writing y 30 de Speaking con IA al día, comentarios completos por criterio y los simulacros de examen.`,
    },
