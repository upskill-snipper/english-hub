...
// 2026-06-05: Arabic sweep tranche 2 - logged-in dashboard chrome (dash.*).
import { DASHBOARD_CHROME_DICTIONARY } from './dictionary-dashboard'
...
import { IELTS_GUIDE_DICTIONARY } from './dictionary-ielts-guide'
...
export const DICTIONARY: Dictionary = {
  ...
  'header.nav.demo': { en: 'Demo', ar: 'العرض التجريبي' },
  ...
  'header.nav.examiners': { en: 'Examiners & Markers', ar: 'الممتحنون والمصححون' },
  ...
  'footer.section.demos': { en: 'Try it', ar: 'جربه' },
  ...
  'footer.link.demo_hub': { en: 'Sample demos', ar: 'عيّنات تجريبية' },
  'footer.link.demo_school': { en: 'School dashboard', ar: 'لوحة المدرسة' },
  'footer.link.demo_teacher': { en: 'Teacher workspace', ar: 'مساحة المعلم' },
  'footer.link.demo_student': { en: 'Student experience', ar: 'تجربة الطالب' },
  ...
  'footer.link.examiners': { en: 'Examiners & Markers', ar: 'الممتحنون والمصححون' },
