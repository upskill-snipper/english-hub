...
export const QATAR_SENSITIVE_PATTERNS: FilterRule[] = [
  ...
  // LGBTQ+ content - not blocked, but flagged for careful academic framing
  {
    ...
    severity: 'warn',
    description: 'LGBTQ+ references - ensure academic framing in Qatar context',
  },
]
...
export const REPLACEMENT_MAP: Record<string, { find: RegExp; replace: string }[]> = {
...
export const CONTENT_WARNINGS: Record<string, ContentWarning> = {
  macbeth: {
    text: 'Macbeth',
    themes: ['violence', 'murder', 'supernatural elements', 'mental illness', 'suicide'],
  },
  'romeo and juliet': {
    text: 'Romeo and Juliet',
    themes: ['suicide', 'violence', 'underage marriage', 'family conflict', 'death'],
  },
  'an inspector calls': {
    text: 'An Inspector Calls',
    themes: ['suicide', 'exploitation', 'class inequality', 'pregnancy outside marriage'],
  },
  'a christmas carol': {
  ...
  'lord of the flies': {
    ...
    themes: ['violence', 'death', 'savagery', 'loss of innocence', 'mob mentality'],
  },
  'jekyll and hyde': {
    text: 'The Strange Case of Dr Jekyll and Mr Hyde',
    themes: ['violence', 'substance abuse', 'duality of human nature', 'murder'],
  },
  'animal farm': {
    text: 'Animal Farm',
    themes: ['political oppression', 'violence', 'propaganda', 'death', 'totalitarianism'],
  },
  'the sign of four': {
    text: 'The Sign of the Four',
    themes: ['substance abuse', 'violence', 'colonialism', 'murder', 'racial stereotypes'],
  },
  frankenstein: {
    text: 'Frankenstein',
    themes: ['death', 'murder', 'playing God', 'abandonment', 'execution', 'mental anguish'],
  },
  'great expectations': {
    text: 'Great Expectations',
    themes: ['class inequality', 'child abuse', 'criminality', 'death', 'violence'],
  },
  'pride and prejudice': {
  ...
  'the war of the worlds': {
    ...
    themes: ['mass death', 'invasion', 'violence', 'colonialism parallels', 'societal collapse'],
  },
  // Poetry anthologies
  'power and conflict': {
    text: 'Power and Conflict Poetry Anthology',
    themes: ['war', 'violence', 'death', 'PTSD', 'political power', 'colonialism'],
  },
  'love and relationships': {
    text: 'Love and Relationships Poetry Anthology',
    themes: ['romantic relationships', 'family conflict', 'loss', 'desire', 'identity'],
  },
}
