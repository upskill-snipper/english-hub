...
//   Persuasive Writing (2 hours, 80 marks)
// Based on the WJEC Eduqas C700 specification.
//
// Source: https://www.eduqas.co.uk/qualifications/english-language-gcse/
// ────────────────────────────────────────────────────────────────────────────
  ...
  bands: [
    {
      ...
      label: "Basic",
      descriptor:
        "Basic awareness of explicit meaning. Limited selection of textual detail.",
      indicators: [
    ...
    },
    {
      ...
      indicators: [
        "Some relevant selection of textual detail",
  ...
  bands: [
    {
      ...
      label: "Basic",
      descriptor:
        "Basic evaluative comment. Basic reference to the text.",
      indicators: [
  ...
  questions: [
    {
      ...
      assessmentObjectives: [
        { ...ao1Reading, maxMarks: 5, weighting: 1.0 },
      ],
      examinerNotes:
    ...
    },
    {
      ...
      totalMarks: 5,
      assessmentObjectives: [
        { ...ao1Reading, maxMarks: 5, weighting: 0.5 },
        { ...ao2Language, maxMarks: 5, weighting: 0.5 },
      ],
      examinerNotes:
    ...
    },
    {
      ...
      totalMarks: 10,
      assessmentObjectives: [
        { ...ao2Language, maxMarks: 10, weighting: 1.0 },
      ],
      examinerNotes:
    ...
    },
    {
      ...
      totalMarks: 10,
      assessmentObjectives: [
        { ...ao4Evaluation, maxMarks: 10, weighting: 1.0 },
      ],
      examinerNotes:
    ...
    },
    {
      ...
      totalMarks: 5,
      assessmentObjectives: [
        { ...ao6TechnicalAccuracy, maxMarks: 5, weighting: 1.0 },
      ],
      examinerNotes:
  ...
  questions: [
    {
      ...
      examinerNotes:
        "One mark per valid point. Accept explicit information only.",
    },
    {
      id: "A2",
    ...
    },
    {
      ...
      totalMarks: 10,
      assessmentObjectives: [
        { ...ao3LangReading, maxMarks: 10, weighting: 1.0 },
      ],
      examinerNotes:
    ...
    },
    {
      ...
      examinerNotes:
        "One mark per correctly identified and corrected error.",
    },
    {
      id: "B1",
      ...
      totalMarks: 20,
      assessmentObjectives: [
        { ...ao5Writing, maxMarks: 12, weighting: 12 / 20 },
        { ...ao6TechnicalAccuracy, maxMarks: 8, weighting: 8 / 20 },
      ],
      examinerNotes:
