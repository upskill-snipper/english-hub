...
const ao1Reading: AssessmentObjective = {
  ...
  bands: [
    ...
    },
    {
      ...
      indicators: [
        "Identifies some explicit details relevant to the question",
      ],
    },
    {
      band: "Level 3",
    ...
    },
    {
      ...
      indicators: [
        "Precise, well-chosen details that show perceptive reading",
      ],
    },
  ],
}
  ...
  bands: [
    {
      ...
      label: "Limited",
      descriptor:
        "Limited evaluative comment on the text. Limited reference to writer's methods.",
      indicators: [
  ...
  questions: [
    {
      ...
      taskDescription:
        "Identify explicit information from the source text.",
      totalMarks: 4,
  ...
  bands: [
    {
      ...
      indicators: [
        "Simple sentences dominate",
        "Frequent errors hinder meaning",
      ],
    },
    {
      band: "Level 2",
      ...
      indicators: [
        ...
        "Punctuation sometimes used for effect",
      ],
    },
    {
      band: "Level 3",
          ...
          bands: [
            {
              ...
              label: "Limited",
              descriptor:
                "Limited comparison of ideas and perspectives. Texts treated separately.",
              indicators: [
