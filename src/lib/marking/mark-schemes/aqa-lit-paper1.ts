  ...
  bands: [
    {
      ...
      descriptor:
        "Simple comments relevant to task. Simple references or textual details.",
      indicators: [
    ...
    },
    {
      ...
      descriptor:
        "Supported response to task. References used to support a range of comments.",
      indicators: [
  ...
  bands: [
    {
      ...
      descriptor:
        "Simple awareness of writer's methods with reference to subject terminology.",
      indicators: [
  ...
  bands: [
    {
      ...
      indicators: [
        "Mentions context as bolt-on facts",
        "No integration with the text",
      ],
    },
    {
      band: "Level 2",
