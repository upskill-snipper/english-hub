...
// Paper 1: Fiction and Imaginative Writing — 1 hour 45 minutes, 64 marks.
// Paper 2: Non-fiction and Transactional Writing — 2 hours 5 minutes, 96 marks.
...
//
// Source: https://qualifications.pearson.com/en/qualifications/edexcel-gcses/english-language-2015.html
// ────────────────────────────────────────────────────────────────────────────
...
const p1Ao1: AssessmentObjective = {
  ...
  bands: [
    ...
    },
    {
      ...
      label: "Some",
      descriptor:
        "Some relevant comments supported by some appropriate textual reference.",
    ...
    },
    {
      ...
      label: "Clear",
      descriptor:
        "Clear, relevant comments with clear and appropriate textual reference.",
  ...
  bands: [
    {
      ...
      label: "Simple",
      descriptor:
        "Simple awareness of structural features. Limited comment on their effect.",
      indicators: [
    ...
    },
    {
      ...
      indicators: [
        "Explains how pacing, openings, endings and perspective shifts shape meaning",
      ],
    },
    {
      band: "Level 4",
...
const p1Ao4Evaluation: AssessmentObjective = {
  ...
  bands: [
    ...
    },
    {
      ...
      indicators: [
        "Clear, considered personal response tied to analysis of method",
      ],
    },
    {
      band: "Level 4",
...
export const edexcelLangPaper1: MarkScheme = {
  ...
  questions: [
    ...
    },
    {
      ...
      taskDescription:
        "Analyse how the writer has structured the text to interest the reader.",
      totalMarks: 8,
  ...
  bands: [
    {
      ...
      label: "Simple",
      descriptor:
        "Simple, limited comment with little textual reference.",
    ...
    },
    {
      ...
      label: "Perceptive",
      descriptor:
        "Perceptive, detailed comments with precise textual reference.",
      indicators: ["Judicious, precise selection of evidence"],
    },
  ],
}
...
const p2Ao1Synthesis: AssessmentObjective = {
  ...
  bands: [
    ...
    },
    {
      ...
      label: "Some",
      descriptor:
        "Some summary attempted with some relevant quotation. Attempts inference.",
  ...
  questions: [
    {
      ...
      examinerNotes:
        "Award one mark per valid identification. Accept quotation or paraphrase.",
    },
    {
      id: "Q2",
    ...
    },
    {
      ...
      assessmentObjectives: [
        { ...p2Ao5Writing, maxMarks: 16, weighting: 16 / 28 },
        { ...p2Ao6Technical, maxMarks: 12, weighting: 12 / 28,
          bands: [
            {
              band: "Level 1",
              minMarks: 1,
