...
export const pearsonIgcseEnglishAPaper1: ExaminerPack = {
  ...
  provenance:
    'Grids, Q1-Q3 format and maxima, and the best-fit and positive-marking doctrines are verbatim from the published Nov 2023 mark scheme (4EA1_01_2311_MS). Gates, boundary triggers, anchors and the phrase bank quote the official exemplar and standardisation commentaries (Nov 2023 4WEA1/01 exemplars, 4EA1_01 OLS Practice ePACKs series 2606GQ, the Paper 1 writing exemplars booklet, and the Pearson 2026 exemplar responses). No 4XEA1-branded paper was available, so the structure is matched but unverified against an actual 4XEA1 paper. Indicative content is series-specific: always pair this pack with the published scheme for the series in front of you. Since 18 September 2026 the pack also carries a standardisation ladder: the marks Pearson examiners actually awarded to responses on this paper, with their own margin notes, from the June 2026 OLS standardisation packs (series 2606GQ) and the published Summer 2023 exemplar-response document for the Anthology text A Passage to Africa. Those anchors are in the marking prompt and are shown on the Grids and triggers tab. No candidate writing is stored or reproduced.',
  version: '2026-09',
