  ...
  return (
    <>
      ...
      <section className="mb-10">
        ...
        <p className="mb-3">
          We want The English Hub to be a great experience for everyone. If something goes wrong or
          you are unhappy with any part of our service, we want to hear about it so we can put
          things right.
        </p>
        <p>
          This procedure applies to all users, parents/guardians, schools, and anyone affected by
          our services. We treat every complaint seriously and fairly.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {[
            ...
            <div key={category.title} className="bg-muted rounded-lg p-3 text-sm">
      ...
      <section className="mb-10">
        ...
        <div className="space-y-6">
          <div className="border-l-4 border-primary pl-4">
            ...
            <ul className="list-disc pl-6 space-y-1 text-sm mt-2">
              ...
              <li>{_tr(`Assessment and assignment to the appropriate team`)}</li>
              <li>
                Named contact, unique reference number, and estimated timeline provided within{' '}
          ...
          <div className="border-l-4 border-primary pl-4">
            ...
            <ul className="list-disc pl-6 space-y-1 text-sm mt-2">
              ...
              <li>
                Written summary of findings within <strong>10 working days</strong>
              </li>
            </ul>
          </div>
        ...
        <div className="overflow-x-auto mt-6">
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              <tr>
                <td className="px-4 py-2 border-b">{_tr(`Stage 1: Initial Response`)}</td>
              ...
              <tr>
                <td className="px-4 py-2 border-b">{_tr(`Stage 3: Final Response`)}</td>
                <td className="px-4 py-2 border-b">20 working days</td>
              </tr>
              <tr>
                <td className="px-4 py-2 border-b">Safeguarding concerns</td>
                <td className="px-4 py-2 border-b">24 hours (immediate escalation)</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      {/* Section 5 */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4">5. External Escalation Options</h2>
        <div className="space-y-4">
          <div className="bg-muted rounded-lg p-4 text-sm">
            <p className="font-semibold">Information Commissioner&apos;s Office (ICO)</p>
            <p className="text-muted-foreground">For data protection and privacy complaints</p>
            <p>
          ...
          <div className="bg-muted rounded-lg p-4 text-sm">
            <p className="font-semibold">Advertising Standards Authority (ASA)</p>
            <p className="text-muted-foreground">For complaints about advertising or marketing</p>
            <p>
          ...
          <div className="bg-muted rounded-lg p-4 text-sm">
            <p className="font-semibold">Competition and Markets Authority (CMA)</p>
            <p className="text-muted-foreground">
              For consumer rights, unfair terms, or anti-competitive practices
            </p>
          </div>
          <div className="bg-muted rounded-lg p-4 text-sm">
            <p className="font-semibold">{_tr(`Trading Standards`)}</p>
            <p className="text-muted-foreground">
              For unfair trading practices, pricing, or consumer rights
            </p>
            <p>{_tr(`Citizens Advice Consumer Service: 0808 223 1133`)}</p>
          </div>
          <div className="bg-muted rounded-lg p-4 text-sm">
            <p className="font-semibold">Qatar National Cyber Security Agency (NCSA)</p>
            <p className="text-muted-foreground">
      ...
      {/* Section 7 */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4">6. Young Person Considerations</h2>
        <p className="mb-3">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Guidance:</strong> If you are unsure, we will help you put your complaint into
            words
          </li>
          <li>
          ...
          <li>
            <strong>{_tr(`Parent/guardian involvement:`)}</strong> You can ask a trusted adult to
            complain on your behalf
          </li>
          <li>
            <strong>{_tr(`Anonymous option:`)}</strong> Submit anonymously through the in-platform
            form. We may not be able to update you, but we will still investigate.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-4">
        <h2 className="text-2xl font-bold mb-4">7. Learning from Complaints</h2>
        <p className="mb-3">
          We believe complaints are valuable feedback. Every complaint is reviewed individually
          after closure and examined as part of quarterly trend analysis. Where complaints reveal
          issues, we take concrete action:
        </p>
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              <tr>
                <td className="px-4 py-2 border-b">{_tr(`Immediate fix`)}</td>
                <td className="px-4 py-2 border-b">Correcting a factual error in lesson content</td>
              </tr>
              <tr>
                <td className="px-4 py-2 border-b">Process change</td>
                <td className="px-4 py-2 border-b">
                  Updating the cancellation flow after repeated billing complaints
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td className="px-4 py-2 border-b">{_tr(`System update`)}</td>
                <td className="px-4 py-2 border-b">
      ...
      <p className="text-sm text-muted-foreground italic mt-8">
        ...
        <a href="mailto:complaints@theenglishhub.app">complaints@theenglishhub.app</a>.
      </p>
    </>
  )
}
