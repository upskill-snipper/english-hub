    ...
    <>
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mb-8 text-sm">
        <p>
          ...
          shall prevail in accordance with Qatari legal requirements.
        </p>
      </div>
      ...
      <section className="mb-10">
        ...
        <p>
          ...
          <strong>Upskill Energy Limited</strong>, a company incorporated in the
          United Kingdom. Upskill Energy Limited is the data controller
          responsible for the collection and processing of your personal data
          through The English Hub platform and services offered within the State
          of Qatar.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="mb-3">
          For data protection enquiries related to Qatar operations, contact our
          Qatar Data Protection Representative or Upskill Energy Limited&apos;s
          Data Protection Officer directly. Contact details are available through
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6 space-y-1 mb-3">
          ...
          <li>
            Voice recordings (where speech assessment is enabled, with explicit
            consent only)
          </li>
        </ul>

        <p className="text-sm">
          We do not knowingly collect sensitive personal data (religious beliefs,
          political opinions, health conditions, biometric data) unless strictly
      ...
      <section className="mb-10">
        ...
        <p className="mb-3">
          In accordance with Article 4 of the PDPPL, we process your personal
          data on the basis of your{" "}
          <strong>explicit, informed, and freely given consent</strong>. Before
          collection, we will clearly explain the purpose, inform you of the data
          types, and obtain consent through a clear affirmative action.
        </p>
        <p>
          Your consent is voluntary. You may withdraw at any time without
          ...
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-4 py-2 border-b">
                  Tests, certificates, and academic records
                </td>
              </tr>
              <tr>
                <td className="px-4 py-2 border-b font-medium">
                ...
                <td className="px-4 py-2 border-b">
                  Payments, invoices, and billing management
                </td>
              </tr>
              <tr>
                <td className="px-4 py-2 border-b font-medium">
              ...
              <tr>
                ...
                <td className="px-4 py-2 border-b">
                  Promotional communications (only with separate explicit
                  consent)
                </td>
              </tr>
            </tbody>
      ...
      <section className="mb-10">
        ...
        <p className="mb-3">
          ...
          <strong>
            will be transferred to and stored on servers in the United Kingdom
          </strong>
          . This is necessary for platform operation and service delivery.
        </p>
        <p className="mb-3">
          In accordance with the PDPPL, we require your{" "}
          <strong>explicit consent</strong> before transferring data outside
          Qatar.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>
            ...
            providing a recognised legal framework
          </li>
          <li>
        ...
        <p className="mt-3 text-sm">
          You have the right to withhold or withdraw consent for cross-border
          transfer. This may limit our ability to provide certain services.
        </p>
      </section>
          ...
          <table className="min-w-full text-sm border border-border">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-4 py-2 border-b">
                  12 months (anonymised thereafter)
                </td>
              </tr>
              <tr>
      ...
      <section className="mb-10">
        ...
        <ol className="list-decimal pl-6 space-y-1">
          ...
          <li>
            We will notify affected individuals <strong>within 72 hours</strong>{" "}
            where there is a high risk
          </li>
          <li>
            Notifications will include: the nature of the breach, approximate
            number affected, likely consequences, and measures taken
          </li>
        </ol>
      </section>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            For users aged 13-17, we require explicit parental or guardian
            consent
          </li>
          <li>
            Parents and guardians can access, review, and request deletion of
            their child&apos;s data at any time
          </li>
          <li>No targeted advertising served to minors</li>
          <li>
            AI features used by minors are subject to additional safeguards
      ...
      <section className="mb-10">
        ...
        <p>
          The English Hub respects the cultural heritage, Islamic traditions, and
          social values of the State of Qatar. All learning content and
          AI-generated outputs are reviewed for cultural appropriateness and
          respect for Islamic values. We do not collect or infer data relating to
          religious beliefs unless strictly necessary and with explicit consent.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <div className="bg-muted rounded-lg p-4 text-sm mb-4">
          ...
          <p>
            We will respond within <strong>30 days</strong>. Complex requests may
            be extended by a further 30 days with notice.
          </p>
        </div>
        <p className="mb-3">
        ...
        <div className="bg-muted rounded-lg p-4 text-sm">
          ...
          <p className="mt-2 text-xs">
            You also have the right to seek a judicial remedy through the
            competent courts of the State of Qatar.
          </p>
        </div>
      </section>
      ...
      <section className="mb-4">
        ...
        <p>
          This privacy notice is governed by the laws of the State of Qatar,
          including the Personal Data Privacy Protection Law (Law No. 13 of
          2016). Any disputes shall be subject to the exclusive jurisdiction of
          the competent courts of the State of Qatar.
        </p>
      </section>
