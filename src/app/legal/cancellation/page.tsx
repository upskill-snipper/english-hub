...
export default function CancellationPolicyPage() {
  ...
  return (
    <>
      ...
      <p className="mb-6">
        This policy explains your right to cancel your subscription, how to do it, and what happens
        next. It complies with the Consumer Contracts Regulations 2013 and the Digital Markets,
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4">1. Your 14-Day Cooling-Off Period</h2>
        <p className="mb-3">
          When you subscribe, you have a <strong>14-day cooling-off period</strong> starting on the
          date you complete your purchase. During this window, you can cancel for{' '}
      ...
      {/* Section 2 */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4">2. Refund Policy and Timeline</h2>
        ...
        <div className="bg-muted rounded-lg p-4 mt-4 text-sm">
          ...
          <p>
            ...
            &divide; 12 = &pound;5.67/month &times; 7 = <strong>&pound;46.69 refund</strong>.
          </p>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="mb-3">
          We offer <strong>two easy ways</strong> to cancel. Both are equally effective. You do not
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            After 30 days, we will anonymise or delete your personal data in line with our Privacy
            Policy and UK GDPR.
          </li>
          <li>
            Progress and achievement data will be retained in anonymised form for analytics only.
          </li>
          <li>
            You can request a copy of your data at any time before deletion by emailing{' '}
      ...
      <section className="mb-10">
        ...
        <p>
          If you are under 18, your parent or guardian may cancel on your behalf using any of the
          methods above. If you are aged 14 to 17 and manage your own account, you have exactly the
          same cancellation rights. If you are unsure about anything, email{' '}
          <a href="mailto:info@Upskillenergy.com">info@Upskillenergy.com</a> and we will help you.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p>
          Nothing in this policy affects your legal rights under the Consumer Contracts Regulations
          2013, the Consumer Rights Act 2015, or the Digital Markets, Competition and Consumers Act
          2024.
        </p>
      </section>
      ...
      <section className="mb-4">
        ...
        <div className="bg-muted rounded-lg p-6 text-sm border border-border">
          <p className="mb-4">
            <strong>To:</strong> Upskill Energy Limited, trading as The English Hub
            <br />
            <strong>Email:</strong>{' '}
            <a href="mailto:info@Upskillenergy.com">info@Upskillenergy.com</a>
          </p>
          <p className="mb-4">
            I hereby give notice that I cancel my subscription to The English Hub.
          </p>
          ...
          <p className="mt-4 text-xs text-muted-foreground italic">
            You have the right to cancel within 14 days without giving any reason. To meet the
            deadline, send this form before the 14-day period expires.
          </p>
        </div>
      </section>
    </>
