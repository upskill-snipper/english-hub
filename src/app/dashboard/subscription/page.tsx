      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-2xl mx-auto px-4 py-16">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 text-center">
            ...
            <Link
              href="/pricing"
              className="inline-block bg-[#1A5276] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#154360] transition-colors"
            >
              View Plans
            </Link>
          </div>
        ...
        <div className="space-y-4">
          ...
          {!isCancelled && (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <Link
                ...
                className="inline-block px-4 py-2 text-sm font-medium rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors"
              >
                Cancel Subscription
              </Link>
            </div>
          ...
          {isCancelled && (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 text-center">
              ...
              <Link
                href="/pricing"
                className="inline-block px-6 py-2 text-sm font-medium rounded-lg bg-[#1A5276] text-white hover:bg-[#154360] transition-colors"
              >
                View Plans
              </Link>
            </div>
