...
const LESSON_PLANS: Resource[] = [
  {
    ...
    description:
      'Complete scheme of work covering themes, characters, and exam-style questions. Includes starter activities and plenaries.',
    type: 'lesson-plan',
  ...
  },
  {
    ...
    description:
      'Structured lesson plans for teaching descriptive and narrative writing. Focus on sensory language and varied sentence structures.',
    type: 'lesson-plan',
  ...
  },
  {
    ...
    description:
      'Lesson-by-lesson guide to teaching the conflict poetry cluster. Includes comparative analysis templates.',
    type: 'lesson-plan',
  },
  {
    id: 'lp4',
    ...
    description:
      'Two-lesson plan covering rhetorical techniques, AFOREST, and timed practice with peer assessment.',
    type: 'lesson-plan',
  },
]
...
const ASSESSMENT_GUIDES: Resource[] = [
  {
    ...
    description:
      'Simplified marking guide breakdown for AO1-AO4. Includes student-friendly assessment criteria and example annotations.',
    type: 'assessment',
    examBoard: 'AQA',
  ...
  },
  {
    ...
    description:
      'Detailed rubric for Paper 1 and Paper 2 writing tasks. Includes band descriptors and marker commentary.',
    type: 'assessment',
    examBoard: 'Edexcel',
  },
  {
    ...
    description:
      'Practical strategies for PP, SEND, and EAL students. Includes differentiated tasks, questioning frameworks, and Ofsted-aligned approaches.',
    type: 'assessment',
  ...
  },
  {
    ...
    description:
      'Student-facing checklist to evaluate their own writing before submission. Covers structure, language, and accuracy.',
    type: 'assessment',
  },
]
...
const EXAM_BOARD_RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    description:
      'Paper structure, question types, and timing guidance for Edexcel English Language 1EN0.',
    type: 'exam-board',
    examBoard: 'Edexcel',
  },
  {
    ...
    description:
      'Complete list of set texts and poetry anthology for OCR J352. Includes suggested teaching order.',
    type: 'exam-board',
    examBoard: 'OCR',
  },
  {
...
const WORKSHEETS: Resource[] = [
  {
    ...
    description:
      'Printable grid for students to record key quotes with analysis columns: technique, effect, and link to theme.',
    type: 'worksheet',
  ...
  },
  {
    ...
    description:
      'A3-printable planning template for structuring persuasive writing with AFOREST technique boxes.',
    type: 'worksheet',
    downloadUrl: '#',
  },
  {
    ...
    description:
      'Table for tracking character development across acts/chapters. Suitable for any set text.',
    type: 'worksheet',
    downloadUrl: '#',
  },
  {
    ...
    description:
      'Mixed SPaG exercises with answer key. Three difficulty levels for differentiation.',
    type: 'worksheet',
    downloadUrl: '#',
  },
]
...
export default async function ResourcesPage() {
  const [
    ...
    'teacher.resources.download_pdf',
    'teacher.resources.view_details',
  ])
