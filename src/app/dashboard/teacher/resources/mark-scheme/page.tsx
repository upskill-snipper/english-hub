...
const COMMON_ERRORS = [
  {
    ...
    example: "Instead of 'Sheila gives the ring back', write 'Priestley uses Sheila's return of the ring as a symbolic rejection of her privileged lifestyle'",
  },
  {
    error: "Feature spotting without analysing effect",
    fix: "Use the 'So what?' test after every technique identification",
    example: "Instead of 'Priestley uses a metaphor here', write 'Priestley's metaphor of \"one body\" implies interconnectedness, suggesting that individual suffering has collective consequences'",
  },
  {
    ...
    example: "Instead of 'This was written in 1945 after WWII', write 'Writing for a post-war audience who had experienced collective sacrifice, Priestley uses the Inspector to argue that this spirit of shared responsibility must extend beyond wartime'",
  },
  {
      ...
      <section className="card">
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          ...
          <li className="flex gap-2">
            ...
            Use a &apos;best fit&apos; approach — if a response straddles two bands, consider which band best describes the majority.
          </li>
          <li className="flex gap-2">
          ...
          <li className="flex gap-2">
            ...
            AO1 and AO2 carry equal weight. A response strong on quotes but weak on analysis should not score higher than Level 4.
          </li>
          <li className="flex gap-2">
            <span className="text-primary font-bold">5.</span>
            Context (AO3) should be woven in, not bolted on. A paragraph-long history lesson at the start does not demonstrate understanding.
          </li>
        </ul>
      </section>
