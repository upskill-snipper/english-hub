...
const QUOTES = [
  {
    ...
    effect:
      "Establishes Mr Birling's capitalist philosophy. The repetition of possessive pronouns ('his own') reveals his selfishness. Priestley positions this speech before the Inspector's arrival to create dramatic irony - the audience knows his worldview is about to be challenged.",
  ...
  },
  {
    ...
    effect:
      "The Inspector's final speech directly contradicts Mr Birling's opening monologue. The shift from 'I' to 'we' mirrors the socialist message. The tricolon builds rhetorical power, echoing political oratory. 'Members of one body' has Christian undertones, giving moral authority to his socialist argument.",
  ...
  },
  {
    ...
    effect:
      "Sheila's recognition of Eva's humanity contrasts sharply with her parents' dehumanising language. The antithesis between 'cheap labour' and 'people' highlights the class divide. This moment marks the beginning of Sheila's moral awakening - she is the first Birling to accept responsibility.",
  ...
  },
  {
    ...
    effect:
      "Eric's use of 'that state' as a euphemism for drunkenness shows his inability to take direct ownership. The shift to third person ('a chap') distances himself from his actions. However, unlike his parents, Eric does ultimately accept guilt, suggesting the younger generation is capable of change.",
      ...
      <div className="card border-2 border-accent/30">
        ...
        <ol className="space-y-2 text-sm text-muted-foreground">
          <li className="flex gap-2">
            ...
            Gerald: &ldquo;Everything&apos;s all right now, Sheila. What about this ring?&rdquo;
            (Act 3)
          </li>
          <li className="flex gap-2">
            <span className="font-bold text-primary">2.</span>
            Sheila: &ldquo;You mustn&apos;t try to build up a kind of wall between us and that
            girl.&rdquo; (Act 2)
          </li>
          <li className="flex gap-2">
            <span className="font-bold text-primary">3.</span>
            Inspector: &ldquo;Public men, Mr Birling, have responsibilities as well as
            privileges.&rdquo; (Act 1)
          </li>
        </ol>
      </div>
