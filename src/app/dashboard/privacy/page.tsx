...
function RightsTab() {
  const rights = [
    ...
    },
    {
      ...
      href: "mailto:privacy@theenglishhub.co.uk?subject=Data%20Rectification%20Request",
    },
    {
      icon: "\u{1F5D1}\uFE0F",
    ...
    },
    {
      ...
      href: "mailto:privacy@theenglishhub.co.uk?subject=Data%20Restriction%20Request",
    },
    {
      icon: "\u{1F6D1}",
    ...
    <div>
      ...
      <div className="mt-6 rounded-xl bg-primary-50 border border-primary-200 p-4">
        <p className="text-sm text-primary-700">
          ...
          <a href="mailto:privacy@theenglishhub.co.uk" className="underline font-medium">
            privacy@theenglishhub.co.uk
          </a>{" "}
