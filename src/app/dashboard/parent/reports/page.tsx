    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-primary sm:text-3xl">
            {t('dashboard.parent_reports.title')}
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            {t('dashboard.parent_reports.subtitle')}
          </p>
        </div>
      ...
      {reports.length === 0 ? (
        <div className="card text-center py-12">
          ...
          <p className="mt-4 text-muted-foreground">{t('dashboard.parent_reports.no_reports')}</p>
          <p className="mt-1 text-sm text-muted-foreground">
            {t('dashboard.parent_reports.auto_generated')}
          </p>
        </div>
      ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">
                        {t('dashboard.parent_reports.week_of')}{' '}
                        {formatWeekRange(report.weekStart, report.weekEnd)}
                      </p>
                      <p className="mt-0.5 text-xs text-muted-foreground">
                        {report.essaysCompleted} essay{report.essaysCompleted !== 1 ? 's' : ''}{' '}
                        &middot; {formatTime(report.timeSpentMinutes)} &middot; Avg{' '}
                        {report.averageScore}%{' '}
                  ...
                  <div className="mt-6 space-y-6 border-t border-border pt-6">
                    ...
                    <div className="grid gap-4 sm:grid-cols-3">
                      <div className="rounded-lg bg-primary/10 px-4 py-3 text-center">
                        ...
                        <p className="text-xs text-primary">
                          {t('dashboard.parent_reports.essays_completed')}
                        </p>
                      </div>
                      <div className="rounded-lg bg-primary/10 px-4 py-3 text-center">
                        ...
                        <p className="text-xs text-primary">
                          {t('dashboard.parent_reports.time_on_platform')}
                        </p>
                      </div>
                      <div className="rounded-lg bg-success-50 px-4 py-3 text-center">
                        ...
                        <p className="text-xs text-success-600">
                          {t('dashboard.parent_reports.average_score')}{' '}
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-foreground">
                        {t('dashboard.parent_reports.grades_title')}
                      </h4>
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3">
                              <span className="text-xs text-muted-foreground">
                                {t('dashboard.parent_reports.working_at')}
                              </span>
                              <span className="font-bold text-primary">Grade {g.workingAt}</span>
                              <span className="text-xs text-muted-foreground">
                                {t('dashboard.parent_reports.predicted')}
                              </span>
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-foreground">
                        {t('dashboard.parent_reports.top_strengths')}
                      </h4>
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-foreground">
                        {t('dashboard.parent_reports.areas_improvement')}
                      </h4>
                      <ul className="mt-2 space-y-2">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-foreground">
                        {t('dashboard.parent_reports.recommended_steps')}
                      </h4>
                      <ul className="mt-2 space-y-2">
                    ...
                    <div className="flex justify-end border-t border-border pt-4">
                      ...
                      >
                        ...
                        {downloadingId === report.id
                          ? t('dashboard.parent_reports.generating')
                          : t('dashboard.parent_reports.download_pdf')}
                      </button>
                    </div>
                  </div>
                )}
