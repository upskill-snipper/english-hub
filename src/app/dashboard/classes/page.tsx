      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-3xl font-bold text-[#1A5276]">My Classes</h1>
          ...
          <button
            ...
            className="bg-[#2E86C1] text-white px-5 py-2.5 rounded-lg font-medium hover:bg-[#2474A8] transition-colors"
          >
            + Create Class
          </button>
        </div>
              ...
              <button
                ...
                className={`w-full text-left p-4 rounded-xl border transition-all ${
                  selectedClass === cls.id
                    ...
                    : "bg-white border-slate-200 hover:border-[#2E86C1]/40 hover:shadow-sm"
                }`}
              >
                <div className="flex items-center justify-between mb-1">
                  <h3 className="font-semibold text-[#1A5276]">{cls.name}</h3>
                  <span className="text-xs bg-[#2E86C1]/10 text-[#2E86C1] px-2 py-0.5 rounded-full font-medium">
                    {cls.examBoard}
                  </span>
                </div>
          ...
          <div className="lg:col-span-2">
            {activeClass ? (
              <div className="bg-white rounded-xl border border-slate-200 shadow-sm">
                ...
                <div className="p-6 border-b border-slate-100">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button className="text-sm bg-[#2E86C1]/10 text-[#2E86C1] px-3 py-1.5 rounded-lg hover:bg-[#2E86C1]/20 transition-colors">
                        + Add Student
                      </button>
                    </div>
                  </div>
                ...
                <div className="p-4 border-b border-slate-100">
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2E86C1]/30 focus:border-[#2E86C1]"
                  />
                </div>
                      ...
                      {(filteredStudents ?? []).map((student) => (
                        ...
                        >
                          <td className="px-6 py-3">
                            <p className="font-medium text-[#1A5276] text-sm">
                              {student.name}
                            </p>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
                ...
                <h3 className="text-lg font-semibold text-[#1A5276] mb-2">
                  Select a Class
                </h3>
        ...
        {showCreateModal && (
          <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
              <h3 className="text-xl font-bold text-[#1A5276] mb-4">
                Create New Class
              </h3>
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2E86C1]/30"
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2E86C1]/30">
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  onClick={() => setShowCreateModal(false)}
                  className="flex-1 px-4 py-2 bg-[#2E86C1] text-white rounded-lg text-sm font-medium hover:bg-[#2474A8] transition-colors"
                >
                  Create Class
                </button>
              </div>
