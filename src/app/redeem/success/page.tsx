    ...
    <div className="mx-auto max-w-2xl px-4 py-12">
      <header className="mb-8 space-y-3">
        ...
        <p className="text-muted-foreground">
          Your subscription is now active. If you use the English Hub
          mobile app, the new entitlement will appear automatically the
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <p className="text-sm text-muted-foreground">
          Tap the button below to return to the app. Your Premium access
          will be reflected in the app within a few seconds — no
