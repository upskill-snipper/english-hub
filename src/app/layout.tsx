...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'The English Hub – Master English. Ace Your Exams.',
    description: 'Expert GCSE & KS3 English courses, practice questions, and revision tools. AQA & Edexcel exam boards.',
  ...
  twitter: {
    ...
    title: 'The English Hub – Master English. Ace Your Exams.',
    description: 'Expert GCSE & KS3 English courses, practice questions, and revision tools.',
  },
}
