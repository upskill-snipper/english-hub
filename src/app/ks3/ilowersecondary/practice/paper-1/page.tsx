...
} from '@/data/ilowersecondary/practice-paper-1'

export const metadata: Metadata = {
  openGraph: {
    title: 'Paper 1: Survival',
    description:
      'A complete original practice achievement test modelled on LEH11/01, theme “Survival”: three original source texts, 22 Section A reading questions (40 marks), a 30-mark Section B writing task and a full Pearson-style mark scheme.',
  },
  title: 'Practice Paper 1: Survival - iLowerSecondary English',
  description:
    'A complete original practice achievement test modelled on LEH11/01, theme “Survival”: three original source texts, 22 Section A reading questions (40 marks), a 30-mark Section B writing task and a full Pearson-style mark scheme.',
  alternates: {
    canonical: 'https://theenglishhub.app/ks3/ilowersecondary/practice/paper-1',
  },
}

const paper = PRACTICE_PAPER_1
    ...
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Paper 1: Survival',
            url: 'https://theenglishhub.app/ks3/ilowersecondary/practice/paper-1',
          },
        ]}
      />
      ...
      <p className="lead">
        ...
        {QUALIFICATION.paperCode}. Theme: <strong>survival</strong>. All three source texts are
      ...
      {/* ── Source Booklet ───────────────────────────────────────── */}
      <section className="my-10">
        <h2>Source Booklet - three texts on the theme of survival</h2>
        <p>
        ...
        <p className="text-xs text-muted-foreground italic">
          ...
          Factual content in Text 1 is well-known biology; the charity in Text 2 (the DryLands
          Wildlife Trust) is fictional.
        </p>
      </section>
