...
} from '@/data/ilowersecondary/practice-paper-4'

export const metadata: Metadata = {
  openGraph: {
    title: 'Paper 4: Courage',
    description:
      'An original practice test on the theme of courage, modelled on LEH11/01: three source texts, 22 reading questions, a writing task and a mark scheme.',
    images: [
      {
        url: '/api/og?title=Paper+4%3A+Courage',
        width: 1200,
        height: 630,
        alt: 'Paper 4: Courage',
      },
  ...
  title: 'Practice Paper 4: Courage',
  description:
    'An original practice test on the theme of courage, modelled on LEH11/01: three source texts, 22 reading questions, a writing task and a mark scheme.',
  alternates: {
    canonical: 'https://theenglishhub.app/ks3/ilowersecondary/practice/paper-4',
  },
}

const paper = PRACTICE_PAPER_4
...
export default async function PracticePaper4Page() {
  return (
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Paper 4: Courage',
            url: 'https://theenglishhub.app/ks3/ilowersecondary/practice/paper-4',
          },
        ]}
      />
      ...
      <p className="font-mono text-[11px] tracking-[0.14em] uppercase text-muted-foreground">
        ...
        <span> · </span>
        <span>{await t('ks3.page.practice.paper_4.bc')}</span>
      </p>

      <h1>Practice Paper 4: Courage</h1>
      <p className="lead">
      ...
      <section className="my-10">
        ...
        <p className="text-xs text-muted-foreground italic">
          ...
          Factual content in Text 1 is well-known human physiology; the Speak Up Youth Project in
          Text 2 is fictional.
        </p>
      </section>
