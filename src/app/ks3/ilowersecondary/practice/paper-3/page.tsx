...
} from '@/data/ilowersecondary/practice-paper-3'
...
export default async function PracticePaper3Page() {
    ...
    <>
      <BreadcrumbJsonLd
        ...
        items={[
          ...
          {
            name: 'Paper 3: The Natural World',
            url: 'https://theenglishhub.app/ks3/ilowersecondary/practice/paper-3',
          },
        ]}
      />
      ...
      <p className="font-mono text-[11px] tracking-[0.14em] uppercase text-muted-foreground">
        ...
        <span> · </span>
        <span>{await t('ks3.page.practice.paper_3.bc')}</span>
      </p>

      <h1>Practice Paper 3: The Natural World</h1>
      <p className="lead">
        A complete original achievement test modelled exactly on the format of{' '}
        {QUALIFICATION.paperCode}. Theme: <strong>the natural world</strong>. All three source texts
        are original works written by The English Hub - they are not taken from any past paper. Work
      ...
      {/* ── Source Booklet ───────────────────────────────────────── */}
      <section className="my-10">
        <h2>Source Booklet - three texts on the natural world</h2>
        <p>
        ...
        <p className="text-xs text-muted-foreground italic">
          ...
          Factual content in Text 1 is well-known biology; the Greenway Community Woodland campaign
          in Text 2 is fictional.
        </p>
      </section>
