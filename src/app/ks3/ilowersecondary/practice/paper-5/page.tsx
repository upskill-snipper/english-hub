...
} from '@/data/ilowersecondary/practice-paper-5'

export const metadata: Metadata = {
  openGraph: {
    title: 'Paper 5: Change',
    description:
      'An original practice test on the theme of change, modelled on LEH11/01: three source texts, 22 reading questions, a writing task and a mark scheme.',
    images: [
      {
        url: '/api/og?title=Paper+5%3A+Change',
        width: 1200,
        height: 630,
        alt: 'Paper 5: Change',
      },
  ...
  title: 'Practice Paper 5: Change',
  description:
    'An original practice test on the theme of change, modelled on LEH11/01: three source texts, 22 reading questions, a writing task and a mark scheme.',
  alternates: {
    canonical: 'https://theenglishhub.app/ks3/ilowersecondary/practice/paper-5',
  },
}

const paper = PRACTICE_PAPER_5
...
export default async function PracticePaper5Page() {
    ...
    <>
      <BreadcrumbJsonLd
        ...
        items={[
          ...
          {
            name: 'Paper 5: Change',
            url: 'https://theenglishhub.app/ks3/ilowersecondary/practice/paper-5',
          },
        ]}
      />
      ...
      <p className="font-mono text-[11px] tracking-[0.14em] uppercase text-muted-foreground">
        ...
        <span> · </span>
        <span>{await t('ks3.page.practice.paper_5.bc')}</span>
      </p>

      <h1>Practice Paper 5: Change</h1>
      <p className="lead">
        A complete original achievement test modelled exactly on the format of{' '}
        {QUALIFICATION.paperCode}. Theme: <strong>change</strong>. All three source texts are
      ...
      {/* ── Source Booklet ───────────────────────────────────────── */}
      <section className="my-10">
        <h2>Source Booklet - three texts on the theme of change</h2>
        <p>
        ...
        <p className="text-xs text-muted-foreground italic">
          ...
          Factual content in Text 1 is well-known biology; the town in Text 2 (Marrowfield) is
          fictional.
        </p>
      </section>
