...
} from '@/data/ilowersecondary/practice-paper-6'

export const metadata: Metadata = {
  openGraph: {
    title: 'Paper 6: Discovery',
    description:
      'An original practice test on the theme of discovery, modelled on LEH11/01: three source texts, 22 reading questions, a writing task and a mark scheme.',
    images: [
      {
        url: '/api/og?title=Paper+6%3A+Discovery',
        width: 1200,
        height: 630,
        alt: 'Paper 6: Discovery',
      },
    ],
  },
  title: 'Practice Paper 6: Discovery',
  description:
    'An original practice test on the theme of discovery, modelled on LEH11/01: three source texts, 22 reading questions, a writing task and a mark scheme.',
  alternates: {
    canonical: 'https://theenglishhub.app/ks3/ilowersecondary/practice/paper-6',
  },
}

const paper = PRACTICE_PAPER_6
...
export default async function PracticePaper6Page() {
  // Next.js 15 dynamic API: headers() is async. Read the CSP nonce so
  // any inline JSON-LD is served under the page's content-security-policy.
  ...
  return (
    <>
      <p className="font-mono text-[11px] tracking-[0.14em] uppercase text-muted-foreground">
        ...
        <span> · </span>
        <span>{await t('ks3.page.practice.paper_6.bc')}</span>
      </p>

      <h1>Practice Paper 6: Discovery</h1>
      <p className="lead">
        A complete original achievement test modelled exactly on the format of{' '}
        {QUALIFICATION.paperCode}. Theme: <strong>discovery</strong>. All three source texts are
      ...
      {/* ── Source Booklet ───────────────────────────────────────── */}
      <section className="my-10">
        <h2>Source Booklet - three texts on the theme of discovery</h2>
        <p>
        ...
        <p className="text-xs text-muted-foreground italic">
          ...
          Factual content in Text 1 is well-known, verifiable history and science (the discovery of
          penicillin); the explorer Nadia Okafor and the cave expedition in Text 2 are fictional;
          Text 3 is original fiction.
        </p>
      </section>
