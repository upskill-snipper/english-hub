    ...
    <>
      ...
      <nav className="mx-auto max-w-5xl px-4 pt-6" aria-label="Breadcrumb">
        <ol className="flex flex-wrap items-center gap-2 text-sm text-gray-500">
          ...
          <li>/</li>
          <li className="font-medium text-[#1A5276]">Analytical Writing</li>
        </ol>
      </nav>
        ...
        <div className="lg:grid lg:grid-cols-[220px_1fr] lg:gap-10">
          ...
          <div className="space-y-16">
            ...
            <Section id="peel" title="1. PEEL Paragraphs Explained">
              ...
              <div className="grid gap-4 sm:grid-cols-2 mb-8">
                <div className="rounded-xl border-l-4 border-[#1A5276] bg-[#1A5276]/5 p-5">
                  <h4 className="font-bold text-[#1A5276] text-lg">P &mdash; Point</h4>
                  ...
                  <div className="mt-3 rounded-lg bg-white p-3 border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600 italic">&ldquo;Shakespeare uses metaphors in Macbeth.&rdquo;</p>
                    <p className="text-xs font-semibold text-green-700 mb-1 mt-2">Strong:</p>
                    <p className="text-sm text-gray-600 italic">&ldquo;Shakespeare presents Macbeth&apos;s growing guilt as an inescapable psychological torment through increasingly violent imagery.&rdquo;</p>
                  </div>
                </div>

                <div className="rounded-xl border-l-4 border-[#2E86C1] bg-[#2E86C1]/5 p-5">
                  <h4 className="font-bold text-[#2E86C1] text-lg">E &mdash; Evidence</h4>
                  <p className="mt-2 text-sm text-gray-700">
                  ...
                  <div className="mt-3 rounded-lg bg-white p-3 border border-gray-200">
                    <p className="text-xs font-semibold text-red-600 mb-1">Weak:</p>
                    <p className="text-sm text-gray-600 italic">&ldquo;Macbeth says &lsquo;Will all great Neptune&apos;s ocean wash this blood clean from my hand?&rsquo;&rdquo;</p>
                    <p className="text-xs font-semibold text-green-700 mb-1 mt-2">Strong:</p>
                    <p className="text-sm text-gray-600 italic">&ldquo;This is evident when Macbeth despairs that not even &lsquo;great Neptune&apos;s ocean&rsquo; could &lsquo;wash this blood clean&rsquo; from his hands.&rdquo;</p>
                  </div>
                </div>

                <div className="rounded-xl border-l-4 border-[#1A5276] bg-[#1A5276]/5 p-5">
                  <h4 className="font-bold text-[#1A5276] text-lg">E &mdash; Explain</h4>
                  <p className="mt-2 text-sm text-gray-700">
                ...
                <div className="rounded-xl border-l-4 border-[#2E86C1] bg-[#2E86C1]/5 p-5">
                  <h4 className="font-bold text-[#2E86C1] text-lg">L &mdash; Link</h4>
                  <p className="mt-2 text-sm text-gray-700">
              ...
              {/* Full PEEL example */}
              <h3 className="mb-4 text-lg font-bold text-gray-900">Full PEEL Paragraph in Action</h3>
            ...
            <Section id="quotations" title="2. How to Embed Quotations">
              ...
              <div className="mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-[#1A5276]">Mid-Sentence Embedding</h3>
                </div>
                ...
                <div className="space-y-3">
                  <div className="rounded-lg bg-red-50 p-3 border border-red-200">
                    ...
                    <p className="text-sm text-gray-700">Scrooge is presented as miserly. &ldquo;He was a tight-fisted hand at the grindstone.&rdquo;</p>
                  </div>
                  <div className="rounded-lg bg-green-50 p-3 border border-green-200">
                    <p className="text-xs font-semibold text-green-700 mb-1">Write:</p>
                    <p className="text-sm text-gray-700">Dickens presents Scrooge as a &ldquo;tight-fisted hand at the grindstone&rdquo;, immediately establishing his miserly and unfeeling nature.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-[#1A5276]">Single Word / Short Phrase Embedding</h3>
                </div>
                <p className="text-sm text-gray-700 mb-3">
              ...
              <div className="mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-[#1A5276]">Contextualised Introduction</h3>
                </div>
                <p className="text-sm text-gray-700 mb-3">
            ...
            <Section id="language-analysis" title="3. Language Analysis: Three Levels">
              ...
              <div className="mb-8">
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                  <p className="text-sm text-gray-500 font-semibold mb-2">Source text:</p>
                  <p className="text-sm text-gray-700 italic mb-4">
                    &ldquo;The creature <strong>dragged</strong> itself across the frozen earth.&rdquo;
                  </p>
                  <p className="text-sm text-gray-500 font-semibold mb-2">Analysis:</p>
                  <p className="text-sm text-gray-700">
              ...
              <div className="mb-8">
                <h3 className="mb-4 text-lg font-bold text-gray-900 flex items-center gap-2">
                  <span className="inline-block h-3 w-3 rounded-full bg-[#2E86C1]"></span>
                  Sentence Level
                </h3>
                <p className="mb-4 text-sm text-gray-700">
              ...
              <div className="mb-8">
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                  <p className="text-sm text-gray-500 font-semibold mb-2">Analysis example:</p>
                  <p className="text-sm text-gray-700">
            ...
            <Section id="structural-analysis" title="4. Structural Analysis: How to Write About Structure">
              ...
              <h3 className="mb-4 text-lg font-bold text-gray-900">What to Look For</h3>
              <div className="grid gap-4 sm:grid-cols-2 mb-8">
                {[
                  ...
                  <div key={item.term} className="rounded-lg bg-[#2E86C1]/5 border border-[#2E86C1]/20 p-4">
              ...
              <h3 className="mb-4 text-lg font-bold text-gray-900">Model Structural Analysis Paragraph</h3>
              <div className="rounded-xl border border-[#2E86C1]/30 bg-gradient-to-br from-[#2E86C1]/5 to-white p-6">
                <p className="text-gray-800 leading-relaxed">
              ...
              <div className="mt-6 rounded-lg bg-amber-50 border border-amber-200 p-4">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  {[
                    ...
                    <span key={phrase} className="rounded-full bg-[#1A5276]/10 px-3 py-1 text-xs font-medium text-[#1A5276]">
                      {phrase}
                    </span>
                  ))}
                </div>
            ...
            <Section id="evaluative-language" title="5. Evaluative Language">
              ...
              <h3 className="mb-4 text-lg font-bold text-gray-900">Evaluative Adverbs</h3>
              <p className="mb-4 text-sm text-gray-700">
              ...
              <div className="mb-8 flex flex-wrap gap-2">
                {[
                  ...
                  <span key={word} className="rounded-full bg-[#2E86C1]/10 px-3 py-1.5 text-sm font-medium text-[#1A5276]">
                    {word}
                  </span>
                ))}
              </div>

              <h3 className="mb-4 text-lg font-bold text-gray-900">Evaluative Sentence Starters</h3>
              <div className="grid gap-3 sm:grid-cols-2 mb-8">
                {[
                  ...
                  <div key={item.starter} className="rounded-lg border border-gray-200 bg-white p-4">
                    <p className="text-sm font-semibold text-[#1A5276]">{item.starter}</p>
                    <p className="mt-1 text-xs text-gray-500">{item.use}</p>
                  </div>
                ))}
              </div>

              <h3 className="mb-4 text-lg font-bold text-gray-900">Without vs. With Evaluative Language</h3>
            ...
            <Section id="context" title="6. Linking to Context Effectively">
              ...
              <h3 className="mb-4 text-lg font-bold text-gray-900">Three Rules for Context</h3>
              <div className="space-y-4 mb-8">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Never write a &ldquo;context paragraph&rdquo;</p>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Always connect context to the writer&apos;s purpose</p>
                    <p className="text-sm text-gray-600 mt-1">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Use context to deepen analysis, not replace it</p>
                    <p className="text-sm text-gray-600 mt-1">
              ...
              <h3 className="mb-4 text-lg font-bold text-gray-900">Weak vs. Strong Context Integration</h3>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-xl border border-red-200 bg-red-50 p-5">
            ...
            <Section id="model-literature" title="7. Model Literature Essay: Macbeth">
              ...
              <div className="rounded-xl border border-[#2E86C1]/30 bg-gradient-to-br from-[#2E86C1]/5 to-white p-6 space-y-6">
                {/* Introduction */}
                <div>
                  <p className="text-xs font-bold text-[#2E86C1] uppercase tracking-wider mb-2">Introduction</p>
                  <p className="text-gray-800 leading-relaxed">
                ...
                {/* Paragraph 1 */}
                <div>
                  <p className="text-xs font-bold text-[#2E86C1] uppercase tracking-wider mb-2">Paragraph 1 &mdash; Extract Analysis</p>
                  <p className="text-gray-800 leading-relaxed">
                ...
                {/* Paragraph 2 */}
                <div>
                  <p className="text-xs font-bold text-[#2E86C1] uppercase tracking-wider mb-2">Paragraph 2 &mdash; Wider Play</p>
                  <p className="text-gray-800 leading-relaxed">
                ...
                {/* Paragraph 3 */}
                <div>
                  <p className="text-xs font-bold text-[#2E86C1] uppercase tracking-wider mb-2">Paragraph 3 &mdash; Wider Play</p>
                  <p className="text-gray-800 leading-relaxed">
                ...
                {/* Conclusion */}
                <div>
                  <p className="text-xs font-bold text-[#2E86C1] uppercase tracking-wider mb-2">Conclusion</p>
                  <p className="text-gray-800 leading-relaxed">
            ...
            <Section id="model-language" title="8. Model Language Analysis Response">
              ...
              <div className="mb-4 rounded-lg bg-gray-50 border border-gray-200 p-4">
                <p className="text-sm font-semibold text-gray-600 mb-2">Source text (extract):</p>
              ...
              <div className="rounded-xl border border-[#2E86C1]/30 bg-gradient-to-br from-[#2E86C1]/5 to-white p-6 space-y-6">
                {/* Paragraph 1 */}
                <div>
                  <p className="text-xs font-bold text-[#2E86C1] uppercase tracking-wider mb-2">Paragraph 1 &mdash; Word Level</p>
                  <p className="text-gray-800 leading-relaxed">
                ...
                {/* Paragraph 2 */}
                <div>
                  <p className="text-xs font-bold text-[#2E86C1] uppercase tracking-wider mb-2">Paragraph 2 &mdash; Imagery and Figurative Language</p>
                  <p className="text-gray-800 leading-relaxed">
                ...
                {/* Paragraph 3 */}
                <div>
                  <p className="text-xs font-bold text-[#2E86C1] uppercase tracking-wider mb-2">Paragraph 3 &mdash; Sentence Level and Structure</p>
                  <p className="text-gray-800 leading-relaxed">
            ...
            <Section id="comparing-texts" title="9. Comparing Texts Technique">
              ...
              <h3 className="mb-4 text-lg font-bold text-gray-900">The Integrated Comparison Method</h3>
              <div className="mb-8 space-y-4">
                <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="font-semibold text-gray-900">Make a comparative point</p>
                  </div>
                  <p className="text-sm text-gray-700">
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="font-semibold text-gray-900">Analyse Text A with evidence</p>
                  </div>
                  <p className="text-sm text-gray-700">
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="font-semibold text-gray-900">Use a comparative connective to transition</p>
                  </div>
                  <p className="text-sm text-gray-700 mb-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span key={conn} className="rounded-full bg-[#1A5276]/10 px-3 py-1 text-xs font-medium text-[#1A5276]">
                        {conn}
                      </span>
                    ))}
                  </div>
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <p className="font-semibold text-gray-900">Analyse Text B with evidence</p>
                  </div>
                  <p className="text-sm text-gray-700">
              ...
              <h3 className="mb-4 text-lg font-bold text-gray-900">Model Comparison Paragraph</h3>
              <div className="rounded-xl border border-[#2E86C1]/30 bg-gradient-to-br from-[#2E86C1]/5 to-white p-6">
                <p className="text-gray-800 leading-relaxed">
            ...
            <Section id="grade-comparison" title="10. Grade 5 vs Grade 7 vs Grade 9 Response Comparison">
              ...
              {/* Summary table */}
              <h3 className="mb-4 text-lg font-bold text-gray-900">Key Differences at a Glance</h3>
                ...
                <table className="w-full text-sm border-collapse">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr className="bg-white">
                      ...
                      <td className="px-4 py-3 text-gray-600">Valid but simple</td>
                      <td className="px-4 py-3 text-gray-600">Arguable and specific</td>
                      <td className="px-4 py-3 text-gray-600">Conceptualised and original</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="px-4 py-3 font-medium text-gray-900">Evidence</td>
                      <td className="px-4 py-3 text-gray-600">Quotations used</td>
                      <td className="px-4 py-3 text-gray-600">Embedded and well-chosen</td>
                      <td className="px-4 py-3 text-gray-600">Precisely selected; single words isolated</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="px-4 py-3 font-medium text-gray-900">Analysis</td>
                      <td className="px-4 py-3 text-gray-600">Identifies technique and basic effect</td>
                      <td className="px-4 py-3 text-gray-600">Explores connotations and effects in detail</td>
                      <td className="px-4 py-3 text-gray-600">Multi-layered; word, sentence, and structural level</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="px-4 py-3 font-medium text-gray-900">Context</td>
                      <td className="px-4 py-3 text-gray-600">Mentioned separately</td>
                      <td className="px-4 py-3 text-gray-600">Integrated into analysis</td>
                      <td className="px-4 py-3 text-gray-600">Seamlessly woven; explains writer&apos;s choices</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="px-4 py-3 font-medium text-gray-900">Evaluation</td>
                      <td className="px-4 py-3 text-gray-600">&ldquo;This shows...&rdquo;</td>
                      <td className="px-4 py-3 text-gray-600">Some evaluative adverbs</td>
                      <td className="px-4 py-3 text-gray-600">Rich evaluative vocabulary; counter-arguments</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="px-4 py-3 font-medium text-gray-900">Whole text</td>
                      <td className="px-4 py-3 text-gray-600">Limited to the extract</td>
                      <td className="px-4 py-3 text-gray-600">Some links to wider text</td>
                      <td className="px-4 py-3 text-gray-600">Tracks ideas across the entire text</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4">
            <Link
              ...
              className="rounded-lg bg-white px-6 py-3 text-sm font-semibold text-[#1A5276] shadow-md hover:bg-gray-100 transition-colors"
            >
              All Writing Skills
            </Link>
            <Link
