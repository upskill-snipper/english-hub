            ...
            <Section id="descriptive" title="Descriptive Writing Techniques">
              ...
              <div className="mb-8 overflow-hidden rounded-xl border border-border">
                ...
                {[
                  ...
                  { tell: "She was happy.", show: "A laugh burst from her before she could catch it. She pressed both hands to her mouth, eyes gleaming, and spun on the spot." },
                  { tell: "It was cold.", show: "Her breath hung in the air like smoke. The puddles had turned to sheets of iron, and every blade of grass wore a crust of white." },
                  { tell: "The room was old.", show: "Wallpaper curled away from the corners like dead skin. A fine layer of dust coated every surface, undisturbed for years, and the floorboards groaned under even the lightest step." },
                  { tell: "He was angry.", show: "His jaw clenched. He slammed the door so hard the frame shuddered and the glass in the window rattled in its pane." },
                  { tell: "She was nervous.", show: "She checked her phone again -- nothing. Her knee bounced under the table. She folded and unfolded the napkin until the creases wore white." },
                  { tell: "The city was busy.", show: "Horns blared in overlapping waves. Pedestrians shouldered past without apology, their faces set, their coffee cups held high above the crush." },
                  { tell: "He was exhausted.", show: "He dropped into the chair and let his head fall back, eyes closed. His shoes were caked in mud. He did not take them off." },
              ...
              <div className="grid gap-4 sm:grid-cols-2 mb-8">
                ...
                <TechniqueCard
                  ...
                  example={'"The classroom was a zoo. In the back corner, the hyenas cackled and shoved. At the front, the owls blinked silently over their textbooks. And at the teacher\'s desk, the zookeeper surveyed the enclosure with weary resignation."'}
            ...
            <Section id="narrative" title="Narrative Writing Techniques">
              ...
              <div className="grid gap-4 sm:grid-cols-2 mb-8">
                <TechniqueCard
                  ...
                  example={'"The glass shattered before she even heard the scream. Instinctively, she dropped to the floor, pressing herself against the cold tiles." -- We learn who she is and why the glass broke later.'}
                ...
                {[
                  {
                    ...
                    explanation: "Every time a different character speaks, start a new paragraph. This makes it clear who is talking.",
                  },
                  {
                    rule: "Punctuation goes INSIDE the speech marks",
                    example: '"I can\'t believe it," she whispered.',
                    explanation: 'The comma after "it" goes inside the closing speech marks, not outside.',
                  },
                  {
                    rule: "Use a comma before the reporting clause",
                    example: '"We need to leave," he said.',
                    explanation: 'When the sentence continues after the speech (e.g., "he said"), use a comma -- not a full stop -- before the closing speech marks.',
                  },
                  {
                    rule: "Use a full stop if no reporting clause follows",
                    example: 'She turned to the window. "I never wanted this."',
                    explanation: "If the speech stands alone and nothing follows it (no 'she said'), end with a full stop inside the speech marks.",
                  },
                  {
                    rule: "Question marks and exclamation marks replace the comma",
                    example: '"Where are you going?" she demanded.\n"Stop!" he shouted.',
                    explanation: "Do not write a comma AND a question mark. The question mark or exclamation mark does the job alone.",
                  },
                  {
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    example: '"Don\'t open that door." His voice was barely a whisper, but she heard every word.',
                    why: "Creates instant intrigue. The reader wonders who is speaking, why, and what is behind the door.",
                  },
                  {
                    num: 4,
                    name: "Sensory Description",
                    example: '"The air tasted of salt and rust. Somewhere below, the sea dragged itself against the rocks with a low, exhausted moan."',
                  ...
                  },
                  {
                    ...
                    example: '"Have you ever stood at the edge of something and known -- really known -- that you were about to change?"',
                  ...
                  },
                  {
                    num: 7,
                    name: "Pathetic Fallacy",
                    example: '"The sky had been threatening all morning, dark clouds gathering like an audience waiting for a tragedy."',
                    why: "Sets the emotional tone of the piece and foreshadows events to come.",
                  },
                  {
                    num: 8,
                    name: "Zoom In (Cinematic Focus)",
                    example: '"A single drop of rain landed on the windowsill. Then another. Then the sky opened."',
                  ...
                  },
                  {
                    num: 10,
                    name: "Time Marker",
                    example: '"It was the summer everything changed. We didn\'t know it then, of course. We never do."',
                  ...
                  },
                  {
                    ...
                    example: '"Keys. Phone. Wallet. She checked each one twice, the way she always did. The way her mother had taught her."',
                    why: "Creates rhythm and reveals character through habitual detail. The list format is visually distinctive.",
                  },
                  {
                    num: 12,
                    name: "Withholding Information",
                    example: '"She had made a decision. She couldn\'t take it back. She didn\'t want to."',
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    example: '"She reached for the handle, paused, and let her hand fall. Whether she ever opened the door, I cannot say."',
                  ...
                  },
                  {
                    ...
                    example: '"The candle guttered once, twice, and went out. The smoke curled upward into nothing."',
                    why: "Ends on a visual image rather than a statement, letting the reader draw their own conclusions.",
                  },
                  {
                    num: 5,
                    name: "Reflection / Epiphany",
                    example: '"Standing there in the half-light, she understood something she had been running from for years: she was not afraid of the dark. She was afraid of what she might see in it."',
                    why: "Shows character development and emotional depth. The character has changed or realised something.",
                  },
                  {
                    num: 6,
                    name: "Twist Ending",
                    example: '"She smiled and slid the photograph back into the envelope. The woman in the picture smiled back -- the same smile, the same eyes. But that woman had been dead for thirty years."',
                  ...
                  },
                  {
                    ...
                    example: '"Are you coming?" he asked, already halfway down the path.\nShe looked back at the house one last time. "Yes," she said. "Yes, I think I am."',
                    why: "Feels natural and cinematic. The dialogue reveals the character's decision without narrating it.",
                  },
                  {
                    num: 8,
                    name: "Zoom Out",
                    example: '"She turned the corner and was gone. The street returned to its usual quiet. Above the rooftops, the clouds drifted on, indifferent, carrying the last of the daylight with them."',
                  ...
                  },
                  {
                    ...
                    example: '"She did not know what tomorrow would bring. But for the first time in a long time, she wanted to find out."',
                    why: "Ends with hope or anticipation without being sentimental. Implies growth and change.",
                  },
                  {
                    num: 10,
                    name: "Symbolic Ending",
                    example: '"She opened her hand and let the stone fall into the water. It sank without a ripple."',
            ...
            <Section id="structure" title="Structural Techniques">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <TechniqueCard
                  ...
                  example={'If the story opens with "The house had been empty for years," it might end with "The house was empty again" -- but now the reader understands what happened and why.'}
                ...
                <TechniqueCard
                  ...
                  example={'Stretching: "She reached for the door handle. The brass was cold. She counted her breaths. One. Two." Compressing: "Three years passed. The garden grew wild."'}
                ...
                <TechniqueCard
                  ...
                  example={'A clock is mentioned three times: first ticking normally, then slowing, then stopping. Each mention carries more weight.'}
            ...
            <Section id="vocabulary" title="Vocabulary Enhancement">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border-collapse">
                  ...
                  <tbody>
                    {[
                      { common: "Said", alternatives: "murmured, declared, conceded, snapped, whispered, insisted, muttered, remarked, stammered, urged" },
                      { common: "Walked", alternatives: "strode, trudged, shuffled, ambled, staggered, marched, crept, sauntered, stumbled, plodded" },
                      { common: "Nice", alternatives: "pleasant, agreeable, charming, delightful, gracious, amiable, genial, endearing, warm, considerate" },
                      { common: "Good", alternatives: "admirable, commendable, exemplary, accomplished, proficient, laudable, superb, exceptional, impressive, outstanding" },
                      { common: "Bad", alternatives: "dire, appalling, wretched, deplorable, grim, abysmal, dreadful, atrocious, dismal, lamentable" },
                      { common: "Happy", alternatives: "elated, buoyant, radiant, content, jubilant, euphoric, exhilarated, gleeful, blissful, overjoyed" },
                      { common: "Sad", alternatives: "melancholy, forlorn, despondent, bereft, wistful, sombre, crestfallen, desolate, mournful, disconsolate" },
                      { common: "Scared", alternatives: "apprehensive, petrified, unnerved, paralysed, stricken, rattled, horrified, panic-stricken, alarmed, dread-filled" },
                      { common: "Angry", alternatives: "incensed, seething, livid, indignant, resentful, irate, furious, enraged, bristling, exasperated" },
                      { common: "Big", alternatives: "imposing, vast, colossal, towering, sprawling, monumental, immense, formidable, cavernous, expansive" },
                      { common: "Small", alternatives: "diminutive, cramped, meagre, insignificant, compact, minute, microscopic, slight, slender, modest" },
                      { common: "Looked", alternatives: "gazed, glanced, peered, scrutinised, surveyed, glimpsed, examined, studied, squinted, stared" },
                      { common: "Dark", alternatives: "shadowy, murky, gloomy, obsidian, ink-black, impenetrable, dim, dusky, sombre, shrouded" },
                      { common: "Old", alternatives: "ancient, weathered, dilapidated, decrepit, timeworn, venerable, crumbling, faded, worn, aged" },
            ...
            <Section id="model-descriptive" title="Model Response: Descriptive Writing">
              ...
              <div className="rounded-xl border border-border bg-card p-6 sm:p-8 shadow-md space-y-5 text-[15px] leading-[1.9] text-foreground">
                <p>
                  ...
                  that clung to everything like a second skin. It was the{" "}
                  <Annotation note="Repetition of key word from opening reinforces the dominant mood.">stillness</Annotation>.
                  The kind that has weight. The kind that settles on your shoulders and presses down, gently
                  but insistently, until you find yourself{" "}
                  <Annotation note="Personification of silence -- giving it physical properties creates an unsettling, oppressive atmosphere.">holding your breath just to match it</Annotation>.
                </p>

                <p>
                  <Annotation note="Zoom-in technique: moves from wide room to specific detail (the chair). Mimics a camera.">The room
                  was large -- once grand, perhaps -- but the years had taken their toll.</Annotation> Wallpaper,
                  once cream or gold, had darkened to the colour of old teeth. It{" "}
                  <Annotation note="Personification: the wallpaper 'curling away' suggests the house is shedding its own skin. Adds to the decay imagery.">curled
                  away from the corners in long, slow strips, as though the walls themselves were trying to
                  undress.</Annotation> Beneath, the plaster was mapped with cracks -- tiny tributaries that
                  branched and forked and led, inevitably,{" "}
                  <Annotation note="Extended metaphor: cracks as rivers/tributaries. The word 'nowhere' subtly reinforces the theme of abandonment.">nowhere</Annotation>.
                </p>

                <p>
                  <Annotation note="Shift in focus from visual to auditory senses -- engaging a different sense to deepen immersion.">I
                  listened.</Annotation> Somewhere, a pipe ticked -- a{" "}
                  <Annotation note="Simile: the metronome comparison makes the sound feel measured, relentless, slightly eerie.">slow, metallic pulse, like a metronome
                  counting down to something no one would witness</Annotation>. Above me, the ceiling
                  sagged. A watermark spread across its surface like a bruise that had never healed, brown at
                  its edges, darker at its centre, as though the house were{" "}
                  <Annotation note="Personification combined with metaphor: the house 'bleeding inward' makes it feel alive but wounded.">bleeding slowly inward</Annotation>.
                </p>

                <p>
                  <Annotation note="Zoom in to a single object: the chair. This creates a narrative implication -- someone once sat here.">A
                  single armchair sat in the centre of the room</Annotation>, angled slightly towards the window
                  as though whoever had last sat there had been watching for something. Or someone.{" "}
                  <Annotation note="Short sentence fragment. The rhythm slows and the reader pauses. Creates a reflective, melancholy beat.">Waiting.</Annotation>{" "}
                  Its fabric was threadbare,{" "}
                  <Annotation note="Tactile (touch) sensory detail. The reader can almost feel the worn-thin fabric under their fingers.">worn smooth in the places where hands had rested and shifted and rested again</Annotation>,
                  and in the cushion was an indent -- a body&apos;s ghost, pressed into the foam by years of
                  sitting, thinking,{" "}
                  <Annotation note="Rule of three with a climactic final word. 'Disappearing' introduces the theme of absence and loss.">disappearing</Annotation>.
                </p>

                <p>
                  <Annotation note="Olfactory (smell) detail -- this is the sense students most often forget to include.">The
                  air tasted of endings.</Annotation>{" "}
                  <Annotation note="Synaesthesia: 'tasted' applied to a smell/atmosphere. Unusual sensory blending shows creative control.">Of
                  cold tea left too long</Annotation>, of newspapers turning yellow, of the{" "}
                  <Annotation note="Abstract concept made concrete through a striking metaphorical image.">particular
                  staleness that accompanies a life folded up and put away</Annotation>. I wanted to open a
                  window, but the frames had swollen shut, sealed by rain and neglect and time, and when I
                  pressed my palm against the glass,{" "}
                  ...
                  the cold bit through to the bone and left a cloud of condensation that faded almost before I
                  pulled my hand away</Annotation>.
                </p>

                <p>
                  <Annotation note="Circular structure: returns to the concept of 'stillness' from the opening. The piece ends where it began, but the reader now understands its full weight.">I
                  stood there for a long time, listening to the stillness, letting it settle around me like
                  dust.</Annotation>{" "}
                  ...
                  There was nothing left to see. Nothing left to hear. And yet the house felt full -- full of
                  all the things that had been taken from it, all the voices that had faded, all the breaths
                  that had been drawn and held and, finally, let go.</Annotation>
                </p>
              </div>
              ...
              <div className="mt-6 rounded-xl border-l-4 border-success bg-success/5 p-5">
                ...
                <ul className="mt-2 space-y-1 text-sm text-muted-foreground list-disc list-inside">
                  ...
                  <li>Figurative language is varied and purposeful: simile, metaphor, personification, synaesthesia</li>
                  <li>Structural control: zoom-in from room to chair to hand; shift from external observation to internal reflection</li>
                  <li>Circular structure: opens and closes with &ldquo;stillness&rdquo;</li>
                  <li>Vocabulary is precise, not showy: &ldquo;threadbare,&rdquo; &ldquo;tributaries,&rdquo; &ldquo;indent&rdquo;</li>
                  <li>Varied sentence lengths create rhythm and pace</li>
                </ul>
              </div>
            </Section>
            ...
            <Section id="model-narrative" title="Model Response: Narrative Writing">
              ...
              <div className="rounded-xl border border-border bg-card p-6 sm:p-8 shadow-md space-y-5 text-[15px] leading-[1.9] text-foreground">
                <p>
                  ...
                  slit along the top, as though whoever had opened it had taken their time.{" "}
                  <Annotation note="Short sentence creates a pause. The detail about 'no rush' is unsettling because it implies premeditation.">No rush.</Annotation>{" "}
                  No urgency. Just the quiet certainty of someone who already knew what was inside.
                </p>

                <p>
                  <Annotation note="Flashback signalled clearly with a time marker. Takes the reader back to provide context.">I
                  should go back. Three days earlier</Annotation>, the kitchen had smelled of coffee and
                  toast and the particular warmth that fills a house on a Sunday morning when no one has
                  anywhere to be. My mother was at the table, reading the paper with her glasses pushed
                  up onto her forehead -- a habit that drove my father mad, though{" "}
                  <Annotation note="Character development through small, habitual detail. This tiny observation says more about the family dynamic than a paragraph of exposition.">he
                  had long since stopped mentioning it</Annotation>.
                </p>

                <p>
                  &ldquo;Post&apos;s come,&rdquo; she said, without looking up.
                </p>
                <p>
                  <Annotation note="Dialogue is natural and reveals character. The mother's casual tone contrasts with the significance the narrator places on the letter.">I
                  picked up the stack from the mat. Bills. A catalogue. A white envelope with no return
                  address.</Annotation>
                </p>
                <p>
                  &ldquo;Anything interesting?&rdquo;
                </p>
                <p>
                  &ldquo;Just the usual.&rdquo; I put the white envelope at the bottom of the pile and carried
                  everything to the table.{" "}
                  <Annotation note="Foreshadowing: the narrator hides the envelope. This plants intrigue and signals that the letter matters.">I
                  did not mention the white envelope. I don&apos;t know why.</Annotation>
                </p>

                <p>
                  <Annotation note="Time skip: 'Three days later' returns us to the present. The gap creates suspense -- what happened in between?">Three
                  days later, I found it in her drawer.</Annotation> Not hidden exactly, but placed with care
                  between a stack of old photographs and a book I had never seen her read. I should not have
                  been looking. I knew that then, and I know it now. But{" "}
                  <Annotation note="Withholding information: the narrator describes looking but delays telling us what the letter said. Builds tension.">curiosity
                  is its own kind of gravity, and I had been falling towards that drawer since Sunday
                  morning</Annotation>.
                </p>

                <p>
                  <Annotation note="Pacing: slows right down. Short sentences create a careful, deliberate rhythm -- the reader slows down too.">I
                  unfolded the letter. Read it once. Read it again.</Annotation> The words were simple
                  enough -- no legal language, no formality, just a few lines in a handwriting I did not
                  recognise. But simple words can carry{" "}
                  <Annotation note="The narrator reflects on the power of language itself. This philosophical aside adds depth and maturity.">impossible
                  weight</Annotation>, and by the time I reached the signature at the bottom, the room had
                  changed. The light was the same. The curtains had not moved.{" "}
                  <Annotation note="Repetition of 'same' to emphasise that the change is internal, not external. Classic 'show don't tell.'">Everything
                  was the same. Except me.</Annotation>
                </p>

                <p>
                  <Annotation note="Deliberately withholds the letter's content. This is a structural choice: the story is about the IMPACT, not the information.">I
                  will not tell you what the letter said.</Annotation> That is not the point of this story. The
                  point is what happened next: I folded it back along its creases, placed it back between the
                  photographs and the unread book, and closed the drawer.{" "}
                  <Annotation note="The character's reaction is physical and precise. We understand the emotional weight through action, not explanation.">I
                  pressed the heels of my hands against my eyes until I saw colours.</Annotation> Then I went
                  downstairs and made a cup of tea.
                </p>

                <p>
                  <Annotation note="Dialogue ending: the conversation mirrors the earlier one, creating a circular structure. But the emotional weight has shifted completely.">My
                  mother was in the garden.</Annotation> &ldquo;Everything alright?&rdquo; she called, shielding
                  her eyes from the sun.
                </p>
                <p>
                  <Annotation note="Ambiguous ending: the reader knows the narrator is lying. The gap between what is said and what is felt creates powerful dramatic irony.">I
                  looked at her for a long moment -- longer than usual, long enough that she tilted her head
                  and almost asked again. &ldquo;Fine,&rdquo; I said. &ldquo;Just the usual.&rdquo;</Annotation>
                </p>
              </div>
              ...
              <div className="mt-6 rounded-xl border-l-4 border-success bg-success/5 p-5">
                ...
                <ul className="mt-2 space-y-1 text-sm text-muted-foreground list-disc list-inside">
                  ...
                  <li>Information is deliberately withheld -- the letter&apos;s content is never revealed</li>
                  <li>Dialogue is natural and serves multiple functions (character, pace, circular structure)</li>
                  <li>Pacing varies: slow reflective passages alternate with short, punchy sentences</li>
                  <li>Circular ending: &ldquo;Just the usual&rdquo; echoes the earlier conversation, but with entirely different meaning</li>
                  <li>Show, don&apos;t tell: the narrator&apos;s emotions are conveyed through actions (pressing hands against eyes, making tea) not labels</li>
                  <li>Mature narrative voice: reflective, controlled, and deliberately ambiguous</li>
                </ul>
              </div>
            </Section>
              ...
              <div className="mb-8 rounded-xl border border-border bg-card p-6 shadow-md">
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 w-full">
                    {[
                      { sense: "Sight", details: "Rusted Ferris wheel, faded signs, peeling paint, cracked mirrors", technique: "Simile, zoom in" },
                      { sense: "Sound", details: "Creaking metal, wind through gaps, silence, distant traffic", technique: "Onomatopoeia, personification" },
                      { sense: "Touch", details: "Cold metal railings, rough concrete, damp wood", technique: "Tactile imagery" },
                      { sense: "Smell", details: "Rust, damp, old popcorn, oil", technique: "Synaesthesia" },
                ...
                {[
                  {
                    num: 1,
                    title: "Opening / Hook",
                    description: "Grab the reader's attention. Use one of the 12 opening techniques above. Establish tone, setting, or character in a single paragraph. Do NOT start with backstory.",
                    questions: "What is the first image, sound, or line of dialogue? What mood do you want to create?",
                    length: "1 paragraph",
                  },
                  {
                    num: 2,
                    title: "Build-Up / Context",
                    description: "Slow down. Introduce the character, setting, or situation. Use sensory description and 'show don't tell.' Plant any foreshadowing here.",
                    questions: "Who is the character? Where are they? What is their emotional state? What details hint at what will come?",
                    length: "1-2 paragraphs",
                  },
                  {
                    num: 3,
                    title: "Turning Point / Climax",
                    description: "The moment everything shifts. This is the most important part of your story. Slow the pace right down. Use short sentences for impact, long sentences for tension. Every word counts here.",
                    questions: "What happens? How does the character react physically? What changes internally?",
                    length: "1-2 paragraphs",
                  },
                  {
                    num: 4,
                    title: "Aftermath / Falling Action",
                    description: "Show the consequences. The character processes what has happened. Use reflection, internal monologue, or a shift in how they perceive the world around them.",
                    questions: "How has the character changed? What do they notice now that they didn't before? What do they feel but not say?",
                    length: "1 paragraph",
                  },
                  {
                    num: 5,
                    title: "Ending / Resolution",
                    description: "Use one of the ending techniques above. Do NOT rush. Do NOT try to explain everything. Leave the reader with an image, a line of dialogue, or a thought that resonates.",
                    questions: "Does it echo the opening (circular)? Is it ambiguous? Does it end on an image or a line of dialogue?",
            ...
            <Section id="mistakes" title="Common Mistakes &amp; How to Avoid Them">
              ...
              <div className="space-y-4">
                ...
                <MistakeCard
                  ...
                  why={'Long stretches of "Hello, how are you? I\'m fine, thanks" dialogue slow the pace and reveal nothing about character.'}
                  fix={'Every line of dialogue should either reveal character, advance the plot, or create tension. If it does none of these, cut it. Use "said" bookisms sparingly.'}
                  exampleBad={'"Hi," she said. "How are you?" he asked. "I\'m fine," she replied. "Good," he said.'}
                  exampleGood={'"You\'re late." She didn\'t look up. "I know." He set the keys on the table, carefully, as though the sound might break something.'}
                />
                <MistakeCard
                  ...
                  fix={"Choose past or present tense and stick with it. If you use flashbacks, signal the shift clearly ('I remembered...') and return to your base tense afterwards."}
