      ...
      questions: [
        {
          ...
          marks: 4,
          time: '5 mins',
          notes: 'Simple retrieval -- be quick.',
        },
        {
          q: 'Q2: How does the writer use language?',
          marks: 8,
          time: '10 mins',
          notes: '2-3 detailed language points.',
        },
        {
          q: 'Q3: How has the writer structured the text?',
          marks: 8,
          time: '10 mins',
          notes: 'Focus on structural shifts.',
        },
        {
          q: 'Q4: To what extent do you agree?',
          marks: 20,
          time: '25 mins',
          notes: 'Evaluative -- needs a clear stance.',
        },
        {
          q: 'Q5: Creative writing',
          marks: 40,
          time: '45 mins',
          notes: 'Include 5 mins planning time.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          q: 'Q1: Choose 4 true statements',
          marks: 4,
          time: '5 mins',
          notes: 'Careful reading -- no rush.',
        },
        {
          q: 'Q2: Summarise differences/similarities',
          marks: 8,
          time: '10 mins',
          notes: 'Comparative -- both texts.',
        },
        {
          q: 'Q3: How does the writer use language?',
          marks: 12,
          time: '15 mins',
          notes: '3-4 language points.',
        },
        {
          q: 'Q4: Compare viewpoints',
          marks: 16,
          time: '20 mins',
          notes: 'Integrated comparison.',
        },
        {
          q: 'Q5: Writing for real purposes',
          marks: 40,
          time: '45 mins',
          notes: 'Include 5 mins planning.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          q: 'Shakespeare extract + essay',
          marks: 34,
          time: '55 mins',
          notes: '~30 marks + 4 SPaG. Plan for 5 mins.',
        },
        {
          q: '19th-century novel extract + essay',
          marks: 30,
          time: '50 mins',
          notes: 'Start with extract, widen to whole text.',
        },
      ],
    },
    {
      ...
      questions: [
        ...
        { q: 'Unseen poetry (single poem)', marks: 24, time: '25 mins', notes: 'Fresh analysis.' },
        {
          ...
          marks: 8,
          time: '20 mins',
          notes: 'Brief but focused comparison.',
        },
      ],
    },
  ],
  ...
  papers: [
    {
      ...
      questions: [
        {
          q: 'Q1-Q4: Short reading questions',
          marks: 12,
          time: '15 mins',
          notes: 'Quick comprehension responses.',
        },
        {
          q: 'Q5: Language analysis',
          marks: 12,
          time: '15 mins',
          notes: 'Close analysis of extract.',
        },
        {
          q: 'Q6: Extended reading response',
          marks: 16,
          time: '20 mins',
          notes: 'Sustained analytical writing.',
        },
        {
          q: 'Q7: Imaginative writing',
          marks: 24,
          time: '45 mins',
          notes: 'Include 5 mins planning.',
        },
      ...
      questions: [
        {
          ...
          marks: 12,
          time: '15 mins',
          notes: 'Comprehension and inference.',
        },
        {
          q: 'Q5: Language analysis',
          marks: 12,
          time: '15 mins',
          notes: "Focus on writer's methods.",
        },
        {
          q: 'Q6: Compare/contrast viewpoints',
          marks: 16,
          time: '20 mins',
          notes: 'Sustained comparison.',
        },
        {
          q: 'Q7: Writing for real purposes (Task A)',
          marks: 12,
          time: '25 mins',
          notes: 'Purpose, audience, form.',
        },
        {
          q: 'Q8: Writing for real purposes (Task B)',
          marks: 12,
          time: '30 mins',
          notes: 'Different form from Q7.',
        },
      ],
    },
    {
  ...
  papers: [
    {
      ...
      questions: [
        {
          q: 'Q1: Information retrieval & summary',
          marks: 15,
          time: '25 mins',
          notes: 'Select and summarise key points.',
        },
        {
          q: 'Q2: Extended response -- language analysis',
          marks: 25,
          time: '35 mins',
          notes: 'Analyse how language creates effects.',
        },
    ...
    },
    {
      ...
      questions: [
        {
          q: 'Q1: Directed writing',
          marks: 25,
          time: '45 mins',
          notes: 'Respond to source material in a given form.',
        },
        {
          q: 'Q2: Composition (choice of tasks)',
          marks: 25,
          time: '45 mins',
          notes: 'Descriptive or narrative writing.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        {
          q: 'Drama question (passage-based or essay)',
          marks: 25,
          time: '45 mins',
          notes: 'Close reference to text.',
        },
        {
          q: 'Drama question (second text)',
          marks: 25,
          time: '45 mins',
          notes: 'May be essay or passage-based.',
        },
      ],
    },
  ],
  ...
  papers: [
    {
      ...
      questions: [
        {
          q: 'Section A: Reading (multiple questions)',
          marks: 40,
          time: '60 mins',
          notes: 'Comprehension, inference, language analysis.',
        },
        {
          q: 'Section B: Writing (one task)',
          marks: 40,
          time: '50 mins',
          notes: 'Writing for real purposes task.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          marks: 40,
          time: '55 mins',
          notes: 'Analysis of literary and non-fiction texts.',
        },
        {
          q: 'Section B: Writing (one task)',
          marks: 40,
          time: '50 mins',
          notes: 'Creative or imaginative writing.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          marks: 40,
          time: '55 mins',
          notes: 'Start with extract, then wider text.',
        },
        {
          q: 'Poetry comparison (anthology + unseen)',
          marks: 40,
          time: '55 mins',
          notes: 'Compare anthology poem with unseen.',
        },
      ],
    },
  ],
...
export default async function TimeManagementPage() {
  ...
  return (
    <>
      <HowToJsonLd
        name="Time Management in English Exams"
        description="Paper-by-paper timing strategies for GCSE and IGCSE English. Learn how to divide time per question, plan your time allocation, and what to do if you run out of time."
        totalTime="PT15M"
        ...
        steps={[
          ...
          },
          {
            ...
            text: 'For any question worth 20+ marks, build in 3-5 minutes of planning. A quick bullet-point plan keeps your essay focused and prevents you going off on tangents.',
          },
          {
            name: 'Write target finish times on the paper',
            text: "At the start of the exam, jot down the time you should finish each question next to the question number. If the exam starts at 9:00 and Q1 should take 5 minutes, write '9:05' next to Q1.",
          },
          {
      ...
      <section className="mx-auto max-w-5xl px-4 py-10">
        <div className="rounded-xl border border-primary/20 bg-primary/10 p-6 sm:p-8">
          ...
          <p className="mt-3 text-muted-foreground leading-relaxed">
            ...
            question deserves about 8-10 minutes. Use this as your anchor, then adjust slightly to
            allow for reading time and planning.
          </p>
        </div>
      </section>
      ...
      {ALL_BOARDS.map((board) => (
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            >
              {board.board === 'Cambridge IGCSE' ? 'CIE' : board.board.toUpperCase().slice(0, 3)}
            </span>
            <h2
                    ...
                    <tbody className="divide-y divide-border">
                      {paper.questions.map((q) => (
                        <tr key={q.q} className="hover:bg-muted/50">
                          <td className="px-6 py-3 font-medium text-foreground">{q.q}</td>
                          <td className="px-6 py-3 text-muted-foreground">{q.marks}</td>
                          <td className="px-6 py-3">
                            <span className="rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold text-foreground">
                              {q.time}
                            </span>
                          </td>
                          <td className="px-6 py-3 text-muted-foreground">{q.notes}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-2">
            <div className="rounded-xl border border-border bg-card p-6 shadow-md">
              ...
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Divide total exam time (in minutes) by total marks. For most English papers, this
                gives you roughly 1 minute per mark. Example: AQA Language Paper 1 is 105 minutes
                for 80 marks = about 1.3 minutes per mark.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6 shadow-md">
              <h3 className="font-bold text-foreground">Step 2: Subtract reading time</h3>
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Allow 10-15 minutes at the start to read and annotate the source texts carefully.
                This is not wasted time -- it makes every answer faster and better. Deduct this from
                your total before dividing.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6 shadow-md">
              ...
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                For any question worth 20+ marks, build in 3-5 minutes of planning. A quick
                bullet-point plan keeps your essay focused and prevents you from going off on
                tangents.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6 shadow-md">
              <h3 className="font-bold text-foreground">Step 4: Write target times on the paper</h3>
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                At the start of the exam, jot down the time you should finish each question next to
                the question number. For example, if the exam starts at 9:00 and Q1 should take 5
                minutes, write &ldquo;9:05&rdquo; next to Q1.
              </p>
            </div>
          </div>
        </div>
