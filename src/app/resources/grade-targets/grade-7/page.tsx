...
const KEY_DIFFERENCES = [
  {
    ...
    grade7:
      'Explores why the writer made specific choices and examines multiple possible effects on the reader',
  },
  {
    area: 'Quotation use',
    grade56: 'Selects relevant quotations and comments on them',
    grade7:
      'Selects precise, often single-word quotations and analyses them in forensic detail, embedding them fluently',
  },
  {
    area: 'Vocabulary',
    grade56: 'Uses appropriate analytical vocabulary (suggests, implies, shows)',
    grade7:
      'Uses ambitious, precise vocabulary that demonstrates conceptual thinking (subverts, undermines, encapsulates, epitomises)',
  },
  {
    area: 'Structure awareness',
    grade56: 'Comments on structural features (short paragraph, shift in focus)',
    grade7:
      "Analyses how structural choices shape the reader's experience and contribute to meaning across the whole text",
  },
  {
    area: 'Context',
    grade56: 'Mentions relevant historical or social context',
    grade7:
      "Integrates context into analysis, showing how it shapes the writer's intentions and the reader's interpretation",
  },
  {
    area: 'Creative writing',
    grade56: 'Uses a range of techniques with a clear structure',
    grade7:
      'Writes with a distinctive voice, ambitious vocabulary, varied and deliberate sentence structures, and compelling imagery',
  },
]
    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Grade 7 is where competent becomes impressive. It requires perceptive analysis,
            ambitious writing, and the ability to think beyond the obvious.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-muted-foreground">
          The jump from 5/6 to 7 is not about knowing more -- it is about thinking more deeply and
          ...
          <table className="w-full min-w-[600px] border-collapse">
            ...
            <tbody>
              {KEY_DIFFERENCES.map((row, idx) => (
                <tr key={row.area} className={idx % 2 === 0 ? 'bg-muted' : 'bg-card'}>
      ...
      <section className="bg-muted px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-2xl font-bold text-foreground">Advanced skills for Grade 7</h2>
          <p className="mt-2 text-muted-foreground">
            These are the skills that examiners associate with top-band responses. Master them and
            you will consistently hit Grade 7.
          </p>
      ...
      {/* Example responses */}
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <h2 className="text-2xl font-bold text-foreground">Example Grade 7 Responses</h2>
        <p className="mt-2 text-muted-foreground">
          Study these carefully. Notice the depth of analysis, the precision of vocabulary, and how
          context is woven into the argument.
        </p>
