  ...
  return (
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Grade 9 places you in the top 2% of all candidates. It demands critical thinking,
            originality, and writing that is genuinely compelling. Here is what it takes.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <h2 className="text-2xl font-bold text-foreground">What makes Grade 9 exceptional?</h2>
        <p className="mt-2 text-muted-foreground">
          Grade 9 is not just &quot;Grade 7 but better.&quot; It represents a qualitative shift in
          how you think about and respond to texts. These are the four pillars of exceptional work.
        </p>
      ...
      <section className="bg-muted px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-2xl font-bold text-foreground">Perceptive and critical analysis</h2>
          <p className="mt-2 text-muted-foreground">
            These are the analytical moves that distinguish Grade 9 from Grade 7. They require you
            to think differently, not just more.
          </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <h2 className="text-2xl font-bold text-foreground">Originality and sophistication</h2>
        <p className="mt-2 text-muted-foreground">
          See how the same material can be approached at different levels. The difference is not
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-border">
                <div className="p-5">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-muted-foreground">{item.weak}</p>
                </div>
      ...
      <section className="bg-gradient-to-br from-primary/5 to-primary/10 px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-2xl font-bold text-foreground">Example Grade 9 Responses</h2>
          <p className="mt-2 text-muted-foreground">
            These responses demonstrate the level of thinking, analysis, and writing quality that
            characterises Grade 9 work. Study them not to memorise, but to understand how
            exceptional candidates think.
          </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-muted-foreground">
          Advice from examiners and top-achieving students on how to reach the highest grade
          consistently.
        </p>
