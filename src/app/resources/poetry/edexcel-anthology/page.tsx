...
const POEMS: Poem[] = [
  ...
  },
  {
    ...
    date: '1988',
    context:
      "Causley wrote this poem late in life, after both his parents had died. The poem imagines a reunion with them in an idealised landscape. Causley never married and remained deeply attached to his mother. 'Eden Rock' is an invented threshold place. Causley confirmed: 'I have no idea, I mean I made it up!' Some interpretations link it to the biblical Eden + Causley's Cornish landscape, but the place itself is fictional.",
    summary:
      "The speaker envisions his dead parents at Eden Rock, presented in vivid, specific domestic detail -- his mother's hair, the thermos, the tablecloth. They are young, as the speaker remembers them from childhood. They beckon him to cross a stream to join them, and the poem ends with the ambiguous line 'I had not thought that it would be like this.', suggesting the crossing represents death.",
    formAndStructure:
  ...
  },
  {
    ...
    quotes: [
      ...
      {
        text: "[Quotation from Nagra's 'Singh Song!' withheld pending source verification.]",
        technique: 'Metaphor / neologism',
        // VERIFY: both the displayed line and the analytical compound were affected by corruption. The image referenced is Nagra's celestial-domestic moon-as-seamstress motif from 'Singh Song!'; restore exact wording only against a verified Edexcel anthology / Faber edition of Look We Have Coming to Dover!.
        analysis:
          "Nagra coins a neologism in this passage that blends Punjabi-inflected English with poetic invention. The moon stitching light onto the bride's face is both beautiful and homely, connecting celestial imagery to the domestic world of sewing, suggesting love elevates the everyday to the sublime.",
      },
      {
