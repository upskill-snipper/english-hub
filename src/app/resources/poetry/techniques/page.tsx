...
const TECHNIQUES: Technique[] = [
  ...
  /* ── Sound Devices ───────────────────────────────────────────── */
  {
    ...
    example:
      "\"stuttering rifles' rapid rattle\" -- the repeated 'r' mimics gunfire",
  ...
  },
  {
    ...
    example:
      "\"no trees, no natural shelter\" -- repetition of the short 'o' and long 'ee' sounds",
  ...
  },
  {
    ...
    example:
      "\"smoothed down your shirt's\" -- the repeated 's' sounds create intimacy",
    poem: "Poppies by Jane Weir",
    effect:
  ...
  },
  {
    ...
    example:
      "\"crackled\" and \"threshing\" -- the words themselves sound like what they describe",
    poem: "Bayonet Charge by Ted Hughes",
    effect:
  ...
  },
  {
    ...
    example:
      "\"HALF a league, HALF a league, HALF a league ONward\" -- the galloping dactylic rhythm mimics horses charging",
    poem: "The Charge of the Light Brigade by Alfred, Lord Tennyson",
    effect:
      "The relentless dactylic rhythm mimics the thundering hooves of the cavalry charge. The unstoppable momentum reflects the soldiers' inability to turn back, driving both them and the reader inexorably forward.",
    sentenceStarter:
...
const TONE_VOCABULARY = [
  { word: "Elegiac", meaning: "Expressing sorrow or mourning, often with a sense of loss and reflection." },
  { word: "Melancholic", meaning: "Deeply sad and thoughtful; a sustained, quiet sadness rather than acute grief." },
  { word: "Wistful", meaning: "A gentle longing for something lost or unattainable; sad but not despairing." },
  { word: "Nostalgic", meaning: "A bittersweet longing for the past, often idealising what has been lost." },
  { word: "Defiant", meaning: "Bold resistance or challenge; refusing to submit to authority or convention." },
  { word: "Sardonic", meaning: "Mocking or cynical in a way that reveals contempt; darker than sarcasm." },
  { word: "Bitter", meaning: "Resentful and angry, often born from a sense of injustice or betrayal." },
  { word: "Reverent", meaning: "Showing deep respect, admiration, or awe; often used for sacred or elevated subjects." },
  { word: "Contemplative", meaning: "Quietly thoughtful and reflective; considering something deeply." },
  { word: "Ominous", meaning: "Creating a sense of threat or foreboding; suggesting that something bad is coming." },
  { word: "Plaintive", meaning: "Expressing suffering or sorrow in a way that evokes pity; a mournful quality." },
  { word: "Triumphant", meaning: "Expressing victory, pride, or celebration; a sense of achievement." },
  { word: "Ironic", meaning: "Conveying a meaning opposite to the literal words; revealing a gap between appearance and reality." },
  { word: "Sombre", meaning: "Dark, serious, and grave in tone; oppressively still or mournful." },
  { word: "Tender", meaning: "Gentle, caring, and emotionally vulnerable; expressing love or affection softly." },
  { word: "Vitriolic", meaning: "Filled with bitter, harsh criticism; aggressively hostile language." },
  { word: "Ambivalent", meaning: "Expressing conflicting or mixed feelings about a subject; uncertain rather than decisive." },
  { word: "Resolute", meaning: "Firm, determined, and unwavering; expressing conviction or certainty." },
  { word: "Despairing", meaning: "Expressing complete loss of hope; a tone of anguish without consolation." },
  { word: "Celebratory", meaning: "Expressing joy, pride, or praise; honouring and rejoicing in a subject." },
];
...
const PEEL_STEPS = [
  {
    letter: "P",
    label: "Point",
    description: "Make a clear analytical point that directly answers the question. This should be an argument, not a description.",
  ...
  },
  {
    letter: "E",
    label: "Evidence",
    description: "Embed a short, relevant quotation from the poem that supports your point. Integrate it grammatically into your sentence.",
    example: "This is conveyed through the 'shattered visage' that 'lies' half-buried in the desert, surrounded by 'nothing beside remains'.",
    tip: "Short quotes (2-5 words) are easier to embed and analyse than long block quotes.",
  },
  {
    letter: "E",
    label: "Explain",
    description: "Analyse HOW the language/technique creates meaning. Name the technique, explain its effect, and link back to your point.",
    example: "The past participle 'shattered' emphasises the violence of the statue's destruction, implying that power does not simply fade but is actively broken.",
    tip: "This is where the marks are. Go deeper than 'this shows...' -- explain WHY the poet chose this specific word/technique.",
  },
  {
    letter: "L",
    label: "Link",
    description: "Link your analysis to the wider themes, the poet's intentions, context, or the question. This elevates your answer from analysis to argument.",
    example: "Shelley, writing during the Romantic period's critique of tyranny, uses Ozymandias as a warning: no matter how absolute power seems, time will reduce it to ruins.",
...
export default function PoetryTechniquesPage() {
  ...
  const showToneVocab = filteredToneVocab.length > 0 && (activeCategory === "All" || activeCategory === "Tone & Mood");

  const totalResults = filteredForms.length + filteredTechniques.length + (showToneVocab ? filteredToneVocab.length : 0);
  ...
  return (
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            A complete guide to every poetic form, structural device, sound technique, and figurative language method you need for GCSE English Literature. Each technique includes a definition, a real example from a GCSE poem, its effect, and a sentence starter for your exam.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-border bg-card sticky top-0 z-20 shadow-md">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="flex gap-6 overflow-x-auto pb-3 text-sm font-medium">
            <a href="#form-types" className="whitespace-nowrap text-primary hover:text-accent transition-colors">
              Form Types
            </a>
            <a href="#structural-devices" className="whitespace-nowrap text-primary hover:text-accent transition-colors">
              Structural Devices
            </a>
            <a href="#sound-devices" className="whitespace-nowrap text-primary hover:text-accent transition-colors">
              Sound Devices
            </a>
            <a href="#figurative-language" className="whitespace-nowrap text-primary hover:text-accent transition-colors">
              Figurative Language
            </a>
            <a href="#tone-mood" className="whitespace-nowrap text-primary hover:text-accent transition-colors">
              Tone &amp; Mood
            </a>
            <a href="#form-structure-guide" className="whitespace-nowrap text-primary hover:text-accent transition-colors">
              Writing About Form
            </a>
            <a href="#comparing-poems" className="whitespace-nowrap text-primary hover:text-accent transition-colors">
              Comparing Poems
            </a>
            <a href="#peel-paragraphs" className="whitespace-nowrap text-primary hover:text-accent transition-colors">
              PEEL Paragraphs
            </a>
          </div>
        </div>
      ...
      {(["Structural Devices", "Sound Devices", "Figurative Language", "Tone & Mood"] as const).map(
        (sectionCategory) => {
          const sectionTechniques = filteredTechniques.filter(
            (t) => t.category === sectionCategory
          );
            ...
            <div className="mt-10 rounded-xl border-2 border-accent bg-card p-6 shadow-md">
              ...
              <div className="prose prose-sm max-w-none text-muted-foreground leading-relaxed">
                <p>
                  ...
                  <strong className="text-primary">[Explain]</strong> The past participle &lsquo;shattered&rsquo; emphasises the violence of the statue&rsquo;s destruction, implying that power does not simply fade but is actively broken. The verb &lsquo;lies&rsquo; personifies the ruined face, suggesting that the king&rsquo;s arrogant expression has been reduced to something prostrate and defeated. The declarative &lsquo;nothing beside remains&rsquo; is devastating in its simplicity, using the finality of the monosyllabic words to mirror the totality of Ozymandias&rsquo;s erasure.{" "}
                  <strong className="text-primary">[Link]</strong> Shelley, writing during the Romantic period&rsquo;s critique of tyranny, uses Ozymandias as a warning to contemporary rulers: no matter how absolute their power seems, time will reduce it to ruins.
                </p>
              </div>
            </div>
          </div>
