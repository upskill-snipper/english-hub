    ...
    cards: [
      {
        ...
        act: 'Act 1, Scene 1',
        analysis:
          'Establishes the theme of moral inversion from the very opening. The chiasmus creates a sense of the world turned upside down.',
      ...
      },
      {
        ...
        act: 'Act 1, Scene 4',
        analysis:
          "Macbeth's aside reveals his ambition is already forming before Lady Macbeth's influence. Light/dark imagery links to the play's moral framework.",
      ...
      },
      {
        ...
        act: 'Act 1, Scene 5',
        analysis:
          'Biblical allusion to the serpent in Eden positions Lady Macbeth as a tempter figure. The simile contrasts beauty with deadly intent.',
      ...
      },
      {
        ...
        act: 'Act 2, Scene 1',
        analysis:
          "The rhetorical question shows Macbeth's psychological torment. The dagger could be supernatural temptation or guilt-driven hallucination.",
      ...
      },
      {
        ...
        act: 'Act 2, Scene 2',
        analysis:
          'Hyperbolic imagery -- even the god of the ocean cannot cleanse his guilt. The blood symbolises the permanent moral stain of regicide.',
      ...
      },
      {
        ...
        act: 'Act 5, Scene 1',
        analysis:
          "Lady Macbeth's sleepwalking reveals her subconscious guilt. Ironic reversal of her earlier confidence about washing away the blood.",
      ...
      },
      {
        ...
        act: 'Act 3, Scene 4',
        analysis:
          "Extended metaphor of a river of blood shows Macbeth has reached the point of no return. 'Tedious' is chillingly casual.",
      ...
      },
      {
        ...
        act: 'Act 1, Scene 5',
        analysis:
          'Lady Macbeth invokes spirits to remove her femininity, equating womanhood with weakness. Challenges Jacobean gender norms.',
      ...
      },
      {
        ...
        act: 'Act 5, Scene 5',
        analysis:
          "Macbeth's nihilistic soliloquy after Lady Macbeth's death. The theatrical metaphor suggests life is meaningless performance.",
      ...
      },
      {
        ...
        act: 'Act 4, Scene 1',
        analysis:
          "The Witches now call Macbeth 'wicked' -- he has become more evil than the supernatural forces that tempted him.",
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        analysis:
          "Marley's desperate cry serves as the moral thesis of the novella. 'Business' is recontextualised from commerce to compassion.",
      ...
      },
      {
        ...
        character: 'Scrooge',
        analysis:
          "Scrooge's pledge marks his completed transformation. 'All the year' extends Christmas generosity beyond a single day.",
      ...
      },
      {
        ...
        analysis:
          "The allegorical children personify society's failings. Dickens warns that ignorance is more dangerous than want itself.",
      ...
      },
      {
        ...
        analysis:
          "Simile establishing Scrooge's self-imposed isolation. An oyster is hard-shelled but contains a pearl -- foreshadowing the goodness hidden within.",
      ...
      },
      {
        ...
        analysis:
          'Bob Cratchit carrying Tiny Tim shows paternal love despite poverty. Family love compensates for material lack.',
      ...
      },
      {
        ...
        analysis:
          'The blunt opening establishes a matter-of-fact narrative voice. Dickens then subverts expectations by making the dead character central.',
    ...
    cards: [
      {
        ...
        analysis:
          "The Inspector's final speech articulates Priestley's socialist message. 'One body' echoes Christian theology and socialist collectivism.",
      ...
      },
      {
        ...
        character: 'Inspector Goole',
        analysis:
          "Prophetic warning referencing both World Wars. 'Fire and blood and anguish' is a tricolon of destruction.",
      ...
      },
      {
        ...
        analysis:
          "Sheila's moral growth is shown as she recognises workers' humanity. She rejects her father's capitalist view of workers as commodities.",
      ...
      },
      {
        ...
        analysis:
          "Dramatic irony: the audience knows the Titanic sank. Birling's confident repetition establishes him as foolish and overconfident.",
      ...
      },
      {
        ...
        character: 'Sheila Birling',
        analysis:
          'Sheila asserts her maturity and independence, challenging the patriarchal family structure. Represents generational change.',
      ...
      },
      {
        ...
        character: 'Sheila',
        analysis:
          "Colloquial slang for drunk. Reveals Eric's alcoholism is an open secret the family ignores. The Birlings prioritise appearances over truth.",
      ...
      },
      {
        ...
        character: 'Mr Birling',
        analysis:
          "Birling's individualist philosophy is the antithesis of the Inspector's message. Priestley presents this capitalist self-interest as morally bankrupt.",
      ...
      },
      {
        ...
        character: 'Inspector Goole',
        analysis:
          "The metaphor of 'one body' implies society functions like a human body -- if one part suffers, all are affected.",
    ...
    cards: [
      {
        ...
        character: 'Dr Jekyll',
        analysis:
          "Jekyll's realisation encapsulates the novella's central theme: duality of human nature. 'Truly' repeated suggests a fundamental truth society refuses to acknowledge.",
      ...
      },
      {
        ...
        analysis:
          "The oxymoron 'trampled calmly' is deeply unsettling -- Hyde's violence is casual, not passionate. Stevenson shows evil as indifferent.",
      ...
      },
      {
        ...
        character: 'Utterson',
        analysis:
          "Religious imagery marks Hyde as diabolical. 'Signature' suggests the devil has claimed him. Reflects Victorian pseudoscience of physiognomy.",
      ...
      },
      {
        ...
        analysis:
          "Hyde's animalistic behaviour references Darwinian evolution -- he is a regression to a primitive state. Stevenson links moral degeneration to physical devolution.",
      ...
      },
      {
        ...
        character: 'Dr Jekyll',
        analysis:
          "'Commingled' means thoroughly mixed -- good and evil cannot be separated. The universal 'all human beings' makes this about humanity, not just Jekyll.",
      ...
      },
      {
        ...
        character: 'Dr Jekyll',
        analysis:
          "'Slowly' repeated shows the gradual, insidious nature of evil's encroachment. 'Incorporated' shows Hyde consuming Jekyll.",
    ...
    cards: [
      {
        ...
        act: 'Prologue',
        analysis:
          "The Prologue's spoiler establishes fate as a central force. 'Star-cross'd' blends astrology with destiny.",
      ...
      },
      {
        ...
        act: 'Act 1, Scene 5',
        analysis:
          "Romeo's first sight of Juliet uses light imagery -- she outshines artificial light. The personification elevates Juliet to something transcendent.",
      ...
      },
      {
        ...
        act: 'Act 1, Scene 5',
        analysis:
          "Antithesis of 'love' and 'hate' captures the central paradox. 'Only' repeated shows the absolute nature of both emotions.",
      ...
      },
      {
        ...
        act: 'Act 2, Scene 2',
        analysis:
          "Celestial imagery -- Juliet as 'the sun' makes her the centre of Romeo's universe, the source of light and life.",
      ...
      },
      {
        ...
        act: 'Act 2, Scene 6',
        analysis:
          "The Friar's warning foreshadows the tragedy. The repetition of 'violent' links passion directly to destruction.",
      ...
      },
      {
        ...
        act: 'Act 3, Scene 1',
        analysis:
          "Mercutio's dying curse blames both families equally. 'Plague' invokes disease and divine punishment. His death is the play's turning point.",
      ...
      },
      {
        ...
        act: 'Act 3, Scene 1',
        analysis:
          "After killing Tybalt, Romeo sees himself as a puppet of fate. 'Fortune's fool' uses alliteration and personification to blame destiny.",
      ...
      },
      {
        ...
        act: 'Act 5, Scene 3',
        analysis:
          'Dramatic irony: Juliet is not actually dead. Death is personified as a lover, jealously guarding Juliet.',
      ...
      },
      {
        ...
        act: 'Act 5, Scene 3',
        analysis:
          "The Prince's closing couplet provides formal closure. 'Her Romeo' shows possession in death -- they finally belong to each other.",
...
function createBlank(quote: string): { blanked: string; answer: string } {
  ...
  const blanked = [...words.slice(0, start), '___________', ...words.slice(start + blankLen)].join(
    ' ',
  )
  return { blanked, answer }
}

function generateWrongCompletions(
  correctAnswer: string,
  sourceSet: TextSet,
  allSets: TextSet[],
): string[] {
...
export default function QuoteTesterPage() {
  ...
  /* ── Loading state ── */
  // The heading block is the setup screen's own, repeated here on purpose: this
  // branch is the entire server-rendered HTML, and returning a bare spinner left
  // /resources/study-tools/tester with no <h1> for anything that does not run JS.
  if (!mounted) {
    return (
      <>
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            {t('resources.study_tools.tester.title')}
          </h1>
          <p className="mt-3 max-w-3xl text-lg text-muted-foreground leading-relaxed">
            {t('resources.study_tools.tester.subtitle')}
          </p>
        </div>
  ...
  if (quizFinished && !showReview) {
    ...
    return (
      <>
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            {t('resources.study_tools.tester.complete')}
          </h1>
        </div>
        ...
        <div className="mx-auto max-w-lg rounded-2xl border border-border bg-card p-8 text-center shadow-md">
          <div
            className={`text-6xl font-black ${gcseGradeColor(percentageToGCSEGrade(percentage))}`}
          >
            {percentageToGCSEGradeLabel(percentage)}
          </div>
              ...
              <div className="px-5 py-4 space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">
                    ...
                    {result.chosenAnswer ?? (
                      <em className="text-muted-foreground">Time expired -- no answer</em>
                    )}
                  </span>
                </div>
                <div className="flex items-start gap-2">
    ...
    return (
      <>
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div>
            <span className="text-sm font-semibold text-primary">{MODE_LABELS[selectedMode]}</span>
            ...
            {timerEnabled && !answerLocked && (
              <span
                className={`inline-flex items-center gap-1 rounded-full px-3 py-1 text-sm font-bold ${
                  timeLeft <= 10 ? 'bg-red-500/10 text-red-500' : 'bg-muted text-muted-foreground'
                }`}
              >
                <svg
                  className="h-4 w-4"
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-border bg-card p-5 shadow-md">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Select one or more texts to be tested on.
            </p>
                ...
                >
                  <div
                    className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full border-2 transition ${
                      selectedMode === mode ? 'border-primary bg-primary' : 'border-border'
                    }`}
                  >
                    {selectedMode === mode && <div className="h-2 w-2 rounded-full bg-card" />}
                  </div>
                  <div>
                    <div className="text-sm font-semibold text-foreground">{MODE_LABELS[mode]}</div>
          ...
          <div className="rounded-xl border border-primary/20 bg-primary/5 p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Start with one text</strong> and work through all three modes before
                  mixing texts together.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                <span>
                  <strong>Use the timer</strong> to simulate exam pressure. In the real exam, you
                  need to recall quotes quickly.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                <span>
                  <strong>Review wrong answers carefully.</strong> Read the explanations and then
                  try the quiz again.
                </span>
              </li>
              <li className="flex items-start gap-2">
