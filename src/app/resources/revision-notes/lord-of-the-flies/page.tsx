...
const essayQuestions = [
  ...
  {
    question:
      "'The beast is not an external threat but a reflection of the boys themselves.' How far do you agree?",
    points: [
  ...
  return (
    <div className="space-y-6">
      ...
      <Section id="exam-questions" title="Exam-Style Questions with Model Answer Outlines">
        ...
        <div className="space-y-6">
          {[
            ...
            {
              question:
                "'Piggy is the most important character in Lord of the Flies.' How far do you agree?",
              outline: [
            ...
            {
              question:
                'How does Golding use the island setting to explore ideas about human nature?',
              outline: [
      ...
      <footer className="mt-8 text-center text-xs text-muted-foreground">
        <p>
          <em>Lord of the Flies</em> &copy; The Estate of William Golding. Short quotations are used
