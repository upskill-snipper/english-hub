      ...
      <div className="space-y-4" id="plot-summary">
        ...
        <div id="characters">
          <Section id="characters" title="Character Profiles" badge="8 Characters" colour="bg-purple-600">
            <div className="space-y-8">
              {/* Othello */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Othello</h3>
              ...
              {/* Iago */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Iago</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Desdemona */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Desdemona</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Cassio */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Cassio</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Emilia */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Emilia</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Roderigo */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Roderigo</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Brabantio */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Brabantio</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Bianca */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Bianca</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
        ...
        <div id="context">
          <Section id="context" title="Historical and Social Context" badge="4 Areas" colour="bg-teal-600">
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Venice and Cyprus</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Moors in Elizabethan England</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Military Honour and Service</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Women&apos;s Roles in Elizabethan/Jacobean Society</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                  <h4 className="font-bold text-gray-900 text-sm">1. Reputation as &ldquo;Honest Iago&rdquo;</h4>
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                  <h4 className="font-bold text-gray-900 text-sm">2. Insinuation, Not Accusation</h4>
                  <p className="mt-2 text-sm text-gray-700">
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                  <h4 className="font-bold text-gray-900 text-sm">3. Exploiting Insecurities</h4>
                  <p className="mt-2 text-sm text-gray-700">
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                  <h4 className="font-bold text-gray-900 text-sm">4. Manufacturing Evidence</h4>
                  <p className="mt-2 text-sm text-gray-700">
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                  <h4 className="font-bold text-gray-900 text-sm">5. Weaponising Virtue</h4>
                  <p className="mt-2 text-sm text-gray-700">
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                  <h4 className="font-bold text-gray-900 text-sm">6. Different Masks for Different People</h4>
                  <p className="mt-2 text-sm text-gray-700">
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                  <h4 className="font-bold text-gray-900 text-sm">7. Controlling the Narrative</h4>
                  <p className="mt-2 text-sm text-gray-700">
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                  <h4 className="font-bold text-gray-900 text-sm">8. Isolating Othello</h4>
                  <p className="mt-2 text-sm text-gray-700">
        ...
        <div id="essay-planning">
          <Section id="essays" title="Essay Planning" badge="Exam Skills" colour="bg-indigo-600">
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Essay Structure: PEEL Paragraphs</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
                ...
                <div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                  <div className="rounded-lg bg-primary/5 p-3 border border-primary/20">
                    ...
                    <p className="mt-1 text-xs text-gray-600">Make a clear argument that directly answers the question.</p>
                  </div>
                  <div className="rounded-lg bg-primary/5 p-3 border border-primary/20">
                    <p className="font-bold text-primary text-sm">E &mdash; Evidence</p>
                    <p className="mt-1 text-xs text-gray-600">A short, embedded quotation from the text to support your point.</p>
                  </div>
                  <div className="rounded-lg bg-primary/5 p-3 border border-primary/20">
                    <p className="font-bold text-primary text-sm">E &mdash; Explain</p>
                    <p className="mt-1 text-xs text-gray-600">Analyse language, structure, or form. What does the quotation suggest? How does it work?</p>
                  </div>
                  <div className="rounded-lg bg-primary/5 p-3 border border-primary/20">
                    <p className="font-bold text-primary text-sm">L &mdash; Link</p>
                    <p className="mt-1 text-xs text-gray-600">Link to context, the wider text, another interpretation, or the writer&apos;s purpose.</p>
                  </div>
                </div>
              </div>

              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Sample Essay Plans</h3>
                <div className="space-y-4 mt-3">
                  {/* Essay 1 */}
                  <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                    <h4 className="font-bold text-gray-900 text-sm">&ldquo;How does Shakespeare present jealousy in Othello?&rdquo;</h4>
                    <div className="mt-3 space-y-2">
                      <div className="flex gap-2">
                        ...
                        <p className="text-sm text-gray-700"><strong>Iago as the origin:</strong> &ldquo;green-eyed monster&rdquo; &mdash; he names jealousy while creating it. Link to the Vice figure tradition. His own professional jealousy is the play&apos;s catalyst.</p>
                      </div>
                      <div className="flex gap-2">
                        ...
                        <p className="text-sm text-gray-700"><strong>Othello&apos;s transformation:</strong> Track his language from controlled verse to fragmented, bestial imagery. &ldquo;Farewell the tranquil mind&rdquo; &mdash; jealousy destroys his identity. Link to his insecurity as an outsider.</p>
                      </div>
                      <div className="flex gap-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <p className="text-sm text-gray-700"><strong>Jealousy as self-destruction:</strong> &ldquo;It is the cause&rdquo; &mdash; Othello murders love itself. His suicide shows jealousy destroys the jealous person most of all. Shakespeare&apos;s wider purpose: warning against the dangers of passion overriding reason.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Essay 2 */}
                  <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                    <h4 className="font-bold text-gray-900 text-sm">&ldquo;How does Shakespeare present the theme of race in Othello?&rdquo;</h4>
                    <div className="mt-3 space-y-2">
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">1</span>
                        <p className="text-sm text-gray-700"><strong>Racist language from others:</strong> &ldquo;old black ram,&rdquo; &ldquo;thick-lips,&rdquo; &ldquo;the devil&rdquo; &mdash; Iago and Brabantio reduce Othello to racial stereotypes. Shakespeare exposes how racism dehumanises through language. Context: Moors in Elizabethan England.</p>
                      </div>
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">2</span>
                        <p className="text-sm text-gray-700"><strong>Othello&apos;s dignity vs prejudice:</strong> &ldquo;Keep up your bright swords&rdquo; and the Senate speech show Othello transcending racial prejudice through eloquence and authority. He is valued for his service but never fully accepted &mdash; Venice&apos;s tolerance has limits.</p>
                      </div>
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">3</span>
                        <p className="text-sm text-gray-700"><strong>Internalised racism:</strong> &ldquo;Haply, for I am black&rdquo; &mdash; Othello begins to see himself through racist eyes. Iago succeeds because he exploits an insecurity that Venetian society created. This is the play&apos;s most psychologically devastating insight.</p>
                      </div>
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">4</span>
                        <p className="text-sm text-gray-700"><strong>Shakespeare&apos;s purpose:</strong> By making his tragic hero a Moor, Shakespeare forces the audience to empathise across racial lines. The tragedy is not that Othello is different but that society cannot accept his difference. Link to James I&apos;s court and racial anxieties of the period.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Essay 3 */}
                  <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                    <h4 className="font-bold text-gray-900 text-sm">&ldquo;How does Shakespeare present Iago as a villain?&rdquo;</h4>
                    <div className="mt-3 space-y-2">
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">1</span>
                        <p className="text-sm text-gray-700"><strong>Soliloquies and dramatic irony:</strong> &ldquo;I am not what I am&rdquo; &mdash; an inversion of God&apos;s words, aligning Iago with the devil. His soliloquies let the audience see behind the mask. Link to the Vice figure in medieval morality plays.</p>
                      </div>
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">2</span>
                        <p className="text-sm text-gray-700"><strong>Manipulation techniques:</strong> He never directly lies but uses insinuation, questions, and planted evidence. &ldquo;Ha! I like not that&rdquo; &mdash; the exclamation plants suspicion while appearing innocent. He makes Othello the author of his own destruction.</p>
                      </div>
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">3</span>
                        <p className="text-sm text-gray-700"><strong>Motiveless malignity:</strong> Iago offers multiple motives (promotion, Emilia, racism) but none is sufficient. Coleridge&apos;s phrase &ldquo;motiveless malignity&rdquo; captures the sense that evil needs no reason. This makes Iago more terrifying &mdash; and more universal.</p>
                      </div>
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">4</span>
                        <p className="text-sm text-gray-700"><strong>Final silence:</strong> &ldquo;Demand me nothing; what you know, you know.&rdquo; His refusal to explain denies closure and asserts control even in defeat. Shakespeare leaves the audience, like Othello, unable to fully understand evil. Context: Jacobean anxieties about hidden enemies and religious hypocrisy.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Essay 4 */}
                  <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                    <h4 className="font-bold text-gray-900 text-sm">&ldquo;How does Shakespeare present women in Othello?&rdquo;</h4>
                    <div className="mt-3 space-y-2">
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">1</span>
                        <p className="text-sm text-gray-700"><strong>Desdemona&apos;s agency and its limits:</strong> She defies her father and speaks in the Senate, yet is gradually silenced by Othello&apos;s jealousy. Her dying words (&ldquo;Nobody; I myself&rdquo;) can be read as devotion or as the tragic internalisation of a system that teaches women to protect men.</p>
                      </div>
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">2</span>
                        <p className="text-sm text-gray-700"><strong>Emilia&apos;s defiance:</strong> Her Act 4 speech challenges the sexual double standard. &ldquo;I will not charm my tongue&rdquo; in Act 5 shows her choosing truth over obedience. She dies for speaking out &mdash; Shakespeare shows the lethal cost of female resistance in a patriarchal world.</p>
                      </div>
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">3</span>
                        <p className="text-sm text-gray-700"><strong>Bianca as mirror:</strong> Despite being a courtesan, Bianca shows genuine love and jealousy. She is dismissed as a &ldquo;strumpet&rdquo; &mdash; the same word used against Desdemona. Shakespeare suggests that in a misogynistic society, any woman can be reduced to this accusation.</p>
                      </div>
                      <div className="flex gap-2">
                        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-[10px] font-bold text-white">4</span>
                        <p className="text-sm text-gray-700"><strong>Male control and violence:</strong> All three women are controlled, accused, or killed by men. Context: Jacobean women were legally their husbands&apos; property. Shakespeare critiques this system by showing its fatal consequences &mdash; the play&apos;s tragedy is fundamentally about what happens when men treat women as possessions.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Top Exam Tips</h3>
                <div className="mt-3 grid gap-3 sm:grid-cols-2">
