...
function Quote({ text, speaker, act, analysis }: { text: string; speaker: string; act: string; analysis: string }) {
  return (
    <div className="rounded-lg border-l-4 border-[#2E86C1] bg-[#2E86C1]/5 p-4">
    ...
    <>
      ...
      <div className="mb-8">
        <div className="flex flex-wrap items-center gap-3 mb-2">
          <span className="rounded-full bg-[#1A5276]/10 px-3 py-1 text-xs font-bold text-[#1A5276] uppercase tracking-wider">J.B. Priestley</span>
          <span className="rounded-full bg-[#2E86C1]/10 px-3 py-1 text-xs font-semibold text-[#2E86C1]">AQA</span>
          <span className="rounded-full bg-[#2E86C1]/10 px-3 py-1 text-xs font-semibold text-[#2E86C1]">Edexcel</span>
          <span className="rounded-full bg-[#2E86C1]/10 px-3 py-1 text-xs font-semibold text-[#2E86C1]">WJEC</span>
          <span className="rounded-full bg-[#2E86C1]/10 px-3 py-1 text-xs font-semibold text-[#2E86C1]">OCR</span>
        </div>
      ...
      <div className="mb-8 rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
        ...
        <div className="flex flex-wrap gap-2">
          {["Plot Summary", "Characters", "Themes", "Key Quotations", "Context", "Dramatic Devices", "Essay Planning", "Exam Board Tips"].map((s) => (
            <a
              key={s}
      ...
      <div className="space-y-4">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900 flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[#1A5276]/10 text-xs font-bold text-[#1A5276]">1</span>
                ...
                <div className="mt-3 rounded-lg bg-gray-50 p-3">
                  <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Key Moments &amp; Stage Directions</p>
              ...
              <div>
                <h3 className="font-bold text-gray-900 flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[#1A5276]/10 text-xs font-bold text-[#1A5276]">2</span>
              ...
              <div>
                <h3 className="font-bold text-gray-900 flex items-center gap-2">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[#1A5276]/10 text-xs font-bold text-[#1A5276]">3</span>
        ...
        <div id="characters">
          <Section id="characters" title="Character Profiles" badge="8 Characters" colour="bg-purple-600">
            <div className="space-y-8">
              ...
              {/* Inspector Goole */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Inspector Goole</h3>
              ...
              {/* Arthur Birling */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Arthur Birling</h3>
                <div className="mt-2 flex flex-wrap gap-2">
              ...
              {/* Sybil Birling */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Sybil Birling</h3>
                <div className="mt-2 flex flex-wrap gap-2">
              ...
              {/* Sheila Birling */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Sheila Birling</h3>
                <div className="mt-2 flex flex-wrap gap-2">
              ...
              {/* Eric Birling */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Eric Birling</h3>
                <div className="mt-2 flex flex-wrap gap-2">
                  <span className="rounded-full bg-green-100 px-2.5 py-0.5 text-xs font-semibold text-green-700">Transforms</span>
              ...
              {/* Gerald Croft */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Gerald Croft</h3>
                <div className="mt-2 flex flex-wrap gap-2">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Eva Smith / Daisy Renton</h3>
                <div className="mt-2 flex flex-wrap gap-2">
                  <span className="rounded-full bg-[#1A5276]/10 px-2.5 py-0.5 text-xs font-semibold text-[#1A5276]">Symbolic</span>
                  <span className="rounded-full bg-[#1A5276]/10 px-2.5 py-0.5 text-xs font-semibold text-[#1A5276]">Everyman Figure</span>
                  <span className="rounded-full bg-[#1A5276]/10 px-2.5 py-0.5 text-xs font-semibold text-[#1A5276]">Absent Presence</span>
                </div>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Edna */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Edna</h3>
                <div className="mt-2 flex flex-wrap gap-2">
                  <span className="rounded-full bg-gray-200 px-2.5 py-0.5 text-xs font-semibold text-gray-600">Minor Role</span>
                  <span className="rounded-full bg-gray-200 px-2.5 py-0.5 text-xs font-semibold text-gray-600">Symbolic</span>
                </div>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
        ...
        <div id="key-quotations">
          <Section id="quotations" title="Key Quotations with Analysis" badge="27 Quotes" colour="bg-[#2E86C1]">
            <p className="text-sm text-gray-600 mb-4">Essential quotations organised by character. Learn these for your exam &mdash; short quotations embedded in analytical sentences score highest.</p>

            <div className="space-y-6">
              {/* Inspector */}
              <div>
                <h3 className="text-base font-bold text-[#1A5276] mb-3">Inspector Goole</h3>
              ...
              {/* Mr Birling */}
              <div>
                <h3 className="text-base font-bold text-[#1A5276] mb-3">Arthur Birling</h3>
                <div className="grid gap-3 sm:grid-cols-2">
              ...
              {/* Mrs Birling */}
              <div>
                <h3 className="text-base font-bold text-[#1A5276] mb-3">Sybil Birling</h3>
                <div className="grid gap-3 sm:grid-cols-2">
              ...
              {/* Sheila */}
              <div>
                <h3 className="text-base font-bold text-[#1A5276] mb-3">Sheila Birling</h3>
                <div className="grid gap-3 sm:grid-cols-2">
              ...
              {/* Eric */}
              <div>
                <h3 className="text-base font-bold text-[#1A5276] mb-3">Eric Birling</h3>
                <div className="grid gap-3 sm:grid-cols-2">
              ...
              {/* Gerald */}
              <div>
                <h3 className="text-base font-bold text-[#1A5276] mb-3">Gerald Croft</h3>
                <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                <h3 className="text-base font-bold text-[#1A5276] mb-3">About Eva / Key Stage Directions</h3>
                <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Section id="context" title="Historical &amp; Social Context" badge="Essential" colour="bg-teal-600">
            <div className="space-y-6">
              ...
              <div className="rounded-lg bg-[#1A5276]/5 p-4">
                <h3 className="font-bold text-[#1A5276]">When was it written vs when is it set?</h3>
                <div className="mt-3 grid gap-4 sm:grid-cols-2">
                  <div className="rounded-lg bg-white p-4 shadow-sm">
                    <p className="text-xs font-bold text-[#2E86C1] uppercase tracking-wider">Set: 1912</p>
                  ...
                  <div className="rounded-lg bg-white p-4 shadow-sm">
                    <p className="text-xs font-bold text-[#2E86C1] uppercase tracking-wider">Written/Performed: 1945</p>
                    <ul className="mt-2 space-y-1 text-sm text-gray-700">
              ...
              <div>
                <h3 className="font-bold text-gray-900">J.B. Priestley&apos;s Socialism</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">The Titanic</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">World War I (1914-1918) and World War II (1939-1945)</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">The Edwardian Class System</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
        ...
        <div id="dramatic-devices">
          <Section id="dramatic-devices" title="Dramatic Devices" badge="6 Devices" colour="bg-indigo-600">
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Dramatic Irony</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">The Three Unities</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">The Well-Made Play</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">The Cliff-Hanger Ending</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Lighting Changes</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">The Photograph Technique</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
          ...
          <Section id="essay-planning" title="Essay Planning for Common Questions" badge="6 Questions" colour="bg-rose-600">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <h3 className="font-bold text-gray-900">1. How does Priestley present the theme of responsibility?</h3>
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <h3 className="font-bold text-gray-900">2. How does Priestley present the character of Inspector Goole?</h3>
                <div className="mt-3 space-y-2 text-sm text-gray-700">
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <h3 className="font-bold text-gray-900">3. How does Priestley present the character of Sheila Birling?</h3>
                <div className="mt-3 space-y-2 text-sm text-gray-700">
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <h3 className="font-bold text-gray-900">4. How does Priestley explore ideas about class?</h3>
                <div className="mt-3 space-y-2 text-sm text-gray-700">
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <h3 className="font-bold text-gray-900">5. How does Priestley use the character of Mr Birling to present ideas about capitalism?</h3>
                <div className="mt-3 space-y-2 text-sm text-gray-700">
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <h3 className="font-bold text-gray-900">6. How does Priestley use the ending to convey his message?</h3>
                <div className="mt-3 space-y-2 text-sm text-gray-700">
        ...
        <div id="exam-board-tips">
          <Section id="exam-boards" title="Exam Board Comparison" badge="4 Boards" colour="bg-gray-600">
            <div className="space-y-4">
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <h3 className="font-bold text-[#1A5276]">AQA English Literature (Paper 2, Section A)</h3>
                <ul className="mt-2 space-y-1 text-sm text-gray-700">
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <h3 className="font-bold text-[#1A5276]">Edexcel English Literature (Paper 1, Section B)</h3>
                <ul className="mt-2 space-y-1 text-sm text-gray-700">
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <h3 className="font-bold text-[#1A5276]">WJEC Eduqas English Literature (Component 2, Section A)</h3>
                <ul className="mt-2 space-y-1 text-sm text-gray-700">
                  <li>&bull; <strong>Closed book</strong></li>
              ...
              <div className="rounded-lg border border-gray-200 p-4">
                <h3 className="font-bold text-[#1A5276]">OCR English Literature (Paper 1 or 2 depending on specification)</h3>
                <ul className="mt-2 space-y-1 text-sm text-gray-700">
                  <li>&bull; <strong>Closed book</strong></li>
              ...
              <div className="mt-4 rounded-lg bg-[#1A5276]/5 p-4">
                <h3 className="font-bold text-[#1A5276]">Universal Exam Tips</h3>
                <ul className="mt-2 space-y-1 text-sm text-gray-700">
