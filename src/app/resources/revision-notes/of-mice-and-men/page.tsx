...
const characters = [
  ...
  },
  {
    name: 'Slim',
    analysis:
      "Slim is the 'jerkline skinner', the most skilled and respected man on the ranch. Steinbeck introduces him with a face described as 'ageless' and says he 'moves with a majesty only achieved by royalty and master craftsmen', calling him 'the prince of the ranch'. We are told 'his authority was so great that his word was taken on any subject'. Slim is the novel's moral compass. He understands George and Lennie's relationship without judgement, recognises the mercy in George's final act, and is the only character who offers genuine empathy. He represents an ideal of quiet dignity and moral clarity, but his powerlessness to change the system suggests that individual goodness is insufficient against structural injustice.",
  },
]
  ...
  return (
    <div className="space-y-6">
      ...
      <Section id="exam-questions" title="Exam-Style Questions with Model Answer Outlines">
        ...
        <div className="space-y-6">
          {[
            {
              question:
                'How does Steinbeck present Crooks as a victim of racial prejudice in Of Mice and Men?',
              outline: [
            ...
            {
              question:
                'How does Steinbeck use the ending of Of Mice and Men to explore the theme of friendship?',
              outline: [
            ...
            {
              question:
                "'Steinbeck presents all of his characters as victims.' How far do you agree?",
              outline: [
      ...
      <footer className="mt-8 text-center text-xs text-muted-foreground">
        <p>
          <em>Of Mice and Men</em> &copy; The Estate of John Steinbeck. Short quotations are used
