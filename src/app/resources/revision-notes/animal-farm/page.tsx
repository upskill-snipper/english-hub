...
const keyQuotes = [
  ...
  {
    quote: "The Seven Commandments: Whatever goes upon two legs is an enemy. Whatever goes upon four legs, or has wings, is a friend. No animal shall wear clothes. No animal shall sleep in a bed. No animal shall drink alcohol. No animal shall kill another animal. All animals are equal.",
    chapter: "Chapter 2",
    analysis:
      "The foundation of Animalism, painted on the barn wall. Each commandment is systematically violated and altered by the pigs. The commandments' simplicity makes their corruption all the more visible. Orwell uses them as a measure of the revolution's decay: each alteration marks a further betrayal of the original ideals.",
  },
  {
  ...
  {
    quote: "He would say that God had given him a tail to keep the flies off, but that he would sooner have had no tail and no flies.",
    chapter: "Chapter 3",
  ...
  },
  {
    ...
    analysis:
      "Clover's reflection after the show trials is the novel's most poignant expression of betrayed idealism. The description of her original vision echoes Marxist principles ('each working according to his capacity'). The gap between this gentle vision and the reality of executions and terror measures the full extent of the revolution's corruption.",
  },
  {
  ...
  {
    quote: "He had seemed to oppose the windmill, simply as a manoeuvre to get rid of Snowball, who was a dangerous character and a bad influence.",
    chapter: "Chapter 5",
    speaker: "Squealer",
    analysis:
      "Squealer rewrites history so that Napoleon's opposition to the windmill becomes a clever tactic. The double-think required (Napoleon opposed it but really supported it) is a hallmark of totalitarian propaganda. The speed with which the narrative is reversed shows how easily history can be rewritten when the population lacks independent records.",
  },
  {
  ...
  {
    quote: "They had come to a time when no one dared speak his mind, when fierce, growling dogs roamed everywhere, and when you had to watch your comrades torn to pieces after confessing to shocking crimes.",
    chapter: "Chapter 7",
    analysis:
      "This sentence summarises the conditions of terror under Napoleon's rule. The tricolon (silence, surveillance, public execution) mirrors the mechanisms of Stalinist repression. The passive construction ('watch your comrades torn to pieces') conveys the animals' helplessness. 'Confessing to shocking crimes' echoes the Soviet show trials of the 1930s.",
  },
  {
    quote: "Twelve voices were shouting in anger, and they were all alike. No question, now, what had happened to the faces of the pigs.",
    chapter: "Chapter 10",
    analysis:
  ...
  {
    quote: "The distinguishing mark of Man is the hand, the instrument with which he does all his mischief.",
    chapter: "Chapter 1",
    speaker: "Old Major",
    analysis:
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-gradient-to-br from-[#1A5276] to-[#2E86C1] px-6 py-10 text-white sm:py-14">
        ...
        <p className="mt-3 max-w-2xl text-lg text-white/90">
          ...
          themes, allegory mapping, 25+ key quotations, the Seven Commandments, context, and essay planning.
        </p>
      </div>
