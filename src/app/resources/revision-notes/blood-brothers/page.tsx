  ...
  return (
    <div className="space-y-6">
      ...
      <Section id="exam-questions" title={t('study.revnotes.common.exam_questions_outlines')}>
        ...
        <div className="space-y-6">
          {[
            ...
            {
              question:
                "'Blood Brothers shows that the class system is the real villain.' How far do you agree?",
              outline: [
            ...
            {
              question:
                'How does Russell use the character of Linda to explore the effects of class inequality?',
              outline: [
      ...
      <footer className="mt-8 text-center text-xs text-muted-foreground">
        <p>
          <strong>Rights notice:</strong> &copy; Methuen Drama / Bloomsbury on behalf of Willy
          Russell (b. 1947). Quotations are short fair-dealing extracts under CDPA 1988 &sect;30
