...
const keyQuotes = [
  ...
  {
    quote:
      "Miss Havisham's intentions towards me, all a mere dream; Estella not designed for me; I only suffered in Satis House as a convenience.",
    chapter: 'Chapter 39',
    speaker: 'Pip (narrator)',
    analysis:
...
const essayQuestions = [
  ...
  {
    question:
      'How does Dickens use the character of Miss Havisham to explore the theme of revenge?',
    points: [
  ...
  return (
    <div className="space-y-6">
      ...
      <footer className="mt-8 text-center text-xs text-muted-foreground">
        <p>
          <em>Great Expectations</em> by Charles Dickens (first published 1861) is in the public
