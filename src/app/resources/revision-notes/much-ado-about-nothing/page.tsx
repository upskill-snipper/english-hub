...
const keyQuotes = [
  ...
  {
    quote:
      "You seem to me as Dian in her orb, / As chaste as is the bud ere it be blown; / But you are more intemperate in your blood / Than Venus, or those pamper'd animals / That rage in savage sensuality",
    speaker: 'Claudio',
    act: 'Act 4, Scene 1',
    analysis:
...
const examQuestions = [
  ...
  {
    type: 'Essay Question',
    question: 'How does Shakespeare use deception in Much Ado About Nothing?',
    guidance: [
  ...
  {
    type: 'Essay Question',
    question: 'How does Shakespeare present attitudes towards women in Much Ado About Nothing?',
    guidance: [
  ...
  {
    type: 'Essay Question',
    question: 'Is Much Ado About Nothing a celebration of love or a critique of it?',
    guidance: [
  ...
  return (
    <>
      ...
      <section className="rounded-xl border bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Scene-by-scene summary, 8 character analyses, 5 key themes, 20+ quotations with detailed
            analysis, historical context, and essay planning.
          </p>
        </div>
      </section>
      ...
      <footer className="mt-8 text-center text-xs text-muted-foreground">
        <p>
          <em>Much Ado About Nothing</em> by William Shakespeare is in the public domain. All
