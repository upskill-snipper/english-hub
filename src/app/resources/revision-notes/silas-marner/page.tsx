      ...
      <div className="space-y-4" id="plot-summary">
        ...
        <div id="characters">
          <Section id="characters" title="Character Profiles" badge="8 Characters" colour="bg-purple-600">
            <div className="space-y-8">
              {/* Silas */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Silas Marner</h3>
              ...
              {/* Eppie */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Eppie</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Godfrey */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Godfrey Cass</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Dunstan */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Dunstan (Dunsey) Cass</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Nancy */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Nancy Lammeter</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Dolly Winthrop */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Dolly Winthrop</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* William Dane */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">William Dane</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Squire Cass */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Squire Cass</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
        ...
        <div id="key-quotations">
          <Section id="quotations" title="Key Quotations" badge="20+ Quotes" colour="bg-amber-600">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900 mb-3">Silas Marner</h3>
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-3">Godfrey Cass</h3>
                <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-3">Eppie and Others</h3>
                <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div id="context">
          <Section id="context" title="Historical Context" colour="bg-cyan-600">
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900">George Eliot (Mary Ann Evans)</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">The Industrial Revolution</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Class and Social Hierarchy</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Religion in the Victorian Period</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
          ...
          <Section id="exam-tips" title="Exam Tips" colour="bg-primary">
            <div className="space-y-6">
              <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-4">
                <h3 className="font-bold text-gray-900">General Tips for Silas Marner</h3>
        ...
        <div id="practice-questions">
          <Section id="practice" title="Practice Questions" badge="3 Questions" colour="bg-orange-600">
            <div className="space-y-8">
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Question 1</h3>
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Question 2</h3>
                <p className="text-sm text-gray-700 mb-3">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Question 3</h3>
                <p className="text-sm text-gray-700 mb-3">
