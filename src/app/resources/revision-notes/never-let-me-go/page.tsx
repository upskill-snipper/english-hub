...
const keyQuotes = [
  {
    quote: "We all know it. We're modelled from trash. Junkies, prostitutes, winos, tramps. Convicts, maybe, just so long as they aren't psychos.",
    chapter: "Chapter 13",
    speaker: "Ruth",
    analysis:
  ...
  {
    quote: "She was weeping... and what I saw was a new kind of sadness, a sadness I hadn't come across before. It was a sadness about something she'd lost or was losing. Something she was afraid of losing.",
    chapter: "Chapter 9",
  ...
  {
    quote: "I keep thinking about this river somewhere, with the water moving really fast. And these two people in the water, trying to hold onto each other, holding on as hard as they can, but in the end it's just too much. The current's too strong. They've got to let go, drift apart.",
    chapter: "Chapter 20",
    speaker: "Kathy",
    analysis:
  ...
  {
    quote: "How can you ask a world that has come to regard cancer as curable, how can you ask such a world to put away that cure, to go back to the dark days?",
    chapter: "Chapter 22",
    speaker: "Miss Emily",
    analysis:
  ...
  {
    quote: "I half closed my eyes and imagined this was the spot where everything I'd ever lost since my childhood had washed up, and I was now standing here in front of it.",
    chapter: "Chapter 23",
    speaker: "Kathy",
    analysis:
  ...
  {
    quote: "She'd have been told about the donations and all that. But she wouldn't have understood. Not really.",
    chapter: "Chapter 5",
    speaker: "Kathy",
    analysis:
  ...
  {
    quote: "If I were a student at Hailsham, I'd want to know the truth about my future. But you see, the students aren't like that. They don't want to know.",
    chapter: "Chapter 7",
  ...
  {
    quote: "Tommy's face was right up against the mesh, and he was sort of shaking the wire. And he let out this bellowing sound.",
    chapter: "Chapter 2",
    speaker: "Kathy",
    analysis:
  ...
  {
    quote: "None of you will go to America, none of you will be film stars. And none of you will be working in supermarkets as I heard some of you planning the other day.",
    chapter: "Chapter 7",
    speaker: "Miss Lucy",
    analysis:
  ...
  {
    quote: "I was thinking about the rubbish, the flapping plastic in the branches, the shore-Loss of things.",
    chapter: "Chapter 23",
    speaker: "Kathy",
    analysis:
  ...
  {
    quote: "What he wanted was not just to hear about Hailsham, but to remember Hailsham, just like it was his own memory.",
    chapter: "Chapter 1",
  ...
  {
    quote: "She gave me the same look as she'd given me at the roundabout, a look that was sort of querying and kind at the same time.",
    chapter: "Chapter 19",
  ...
  {
    quote: "It's something for me to go with, even though I know now it won't bring Tommy back or anything like that. But it does give me a lot of strength.",
    chapter: "Chapter 23",
    speaker: "Kathy",
    analysis:
  ...
  {
    quote: "I didn't want to be friends with anyone. I just wanted to be left alone, to go on doing my work.",
    chapter: "Chapter 17",
    speaker: "Kathy",
    analysis:
  ...
  {
    quote: "He opened his arms and shouted into the wind... and I could see his whole body was shaking.",
    chapter: "Chapter 22",
...
const essayQuestions = [
  ...
  {
    question: "'Never Let Me Go is not really about cloning. It is about what it means to be human.' How far do you agree?",
    points: [
  ...
  {
    question: "How does Ishiguro use the setting of Hailsham to explore ideas about control and freedom?",
    points: [
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-gradient-to-br from-[#1A5276] to-[#2E86C1] px-6 py-10 text-white sm:py-14">
        ...
        <p className="mt-3 max-w-2xl text-lg text-white/90">
          ...
          themes, {keyQuotes.length} key quotations with analysis, historical and literary context, and essay planning.
        </p>
      </div>
      ...
      <Section id="part-summaries" title="Part-by-Part Summary" defaultOpen>
        <div className="space-y-6">
          {parts.map((part) => (
            <div key={part.part}>
              <h3 className="mb-3 text-lg font-semibold text-[#2E86C1]">{part.part}</h3>
              <div className="space-y-3">
                {part.chapters.map((ch) => (
                  <div key={ch.chapter} className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                    <h4 className="font-semibold text-[#1A5276]">{ch.chapter}</h4>
