      ...
      <div className="space-y-4" id="plot-summary">
        ...
        <div id="characters">
          <Section id="characters" title="Character Profiles" badge="6 Characters" colour="bg-purple-600">
            <div className="space-y-8">
              {/* Eddie */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Eddie Carbone</h3>
              ...
              {/* Catherine */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Catherine</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Rodolpho */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Rodolpho</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Marco */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Marco</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Alfieri */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Alfieri</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
        ...
        <div id="key-quotations">
          <Section id="quotations" title="Key Quotations" badge="20+ Quotes" colour="bg-amber-600">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900 mb-3">Eddie Carbone</h3>
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-3">Alfieri</h3>
                <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div id="context">
          <Section id="context" title="Historical Context" colour="bg-cyan-600">
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900">Arthur Miller and McCarthyism</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Italian Immigration to America</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Greek Tragedy and &ldquo;Tragedy and the Common Man&rdquo;</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">1950s Gender Roles</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
          ...
          <Section id="exam-tips" title="Exam Tips" colour="bg-primary">
            <div className="space-y-6">
              <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-4">
                <h3 className="font-bold text-gray-900">General Tips for A View from the Bridge</h3>
