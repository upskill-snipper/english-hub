    ...
    <>
      ...
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-3xl text-muted-foreground leading-relaxed">
          ...
          realism, and a fierce first-person narrative that shocked and captivated its original audience.
        </p>
      </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  locked in the red room &mdash; the chamber where her uncle died.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  fear and distress. This traumatic episode establishes the Gothic atmosphere and Jane&apos;s
                  status as an imprisoned, voiceless child.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  and interrogates Jane about her character. Mrs Reed tells him Jane is deceitful. Jane
                  leaves Gateshead, asserting her first act of independence.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  Jane to Christian stoicism, offering an alternative to Jane&apos;s fierce resistance.
                  Miss Temple, the kind superintendent, provides a model of dignified female authority.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  hypocrisy is exposed: he preaches austerity for the girls while his own wife and
                  daughters arrive in furs and silks. Bront&euml; satirises Evangelical hypocrisy through him.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  Helen&apos;s patience and self-control but never fully adopts her passive acceptance.
                  The epidemic leads to an investigation and reform of the school.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  Before leaving, she is visited by Bessie, the former Gateshead servant, who tells
                  her that a paternal uncle (John Eyre) came looking for her.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  paces the third-floor corridor, reflecting on women&apos;s need for action and
                  intellectual stimulation &mdash; a key feminist passage.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  Ad&egrave;le&apos;s mother, C&eacute;line Varens, a French opera dancer who betrayed him.
                  One night, Jane saves Rochester&apos;s life when his bed curtains catch fire &mdash;
                  set alight by the mysterious third-storey occupant.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  mercenary, and cruel &mdash; she mocks governesses openly. Rochester appears to court
                  Blanche but shows no genuine affection. A mysterious stranger, Mr Mason, arrives from
                  the West Indies.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  dawn, begging Jane to trust him. The violence and secrecy deepen the Gothic mystery
                  of Thornfield.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  and Rochester hints at his feelings during a moonlit garden conversation. The chapter
                  establishes Jane&apos;s capacity for forgiveness and her growing emotional bond with Rochester.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  A lightning bolt strikes the chestnut tree, splitting it in two &mdash; a Gothic omen
                  of the fractured relationship to come.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  wedding, Jane has disturbing dreams and wakes to find a terrifying figure in her room,
                  ripping her wedding veil in two. Rochester dismisses it as a dream, but Jane knows
                  what she saw.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  that his marriage was arranged by his father for money and that Bertha&apos;s madness
                  makes his marriage void. He begs Jane to live with him as his mistress in the south
                  of France. Jane refuses &mdash; despite her love, she will not compromise her moral
                  principles or self-respect. She leaves Thornfield in the dead of night.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  clearly loves but refuses to pursue because she would distract him from his missionary
                  calling. Jane begins to rebuild her life through honest work and self-reliance.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  ways. St John asks Jane to marry him and accompany him as a missionary to India. His
                  proposal is cold and dutiful &mdash; he does not love Jane but considers her useful.
                  Jane recognises that marriage to St John would destroy her spirit.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  over her. Jane resolves to return to Thornfield and discover what has become of Rochester.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  Ferndean, a remote manor house. He is blind, scarred, and broken &mdash; physically
                  diminished but morally humbled.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  at exactly that moment. After two years, Rochester partially regains his sight, enough
                  to see their first child. The novel ends with Jane&apos;s famous declaration: &ldquo;Reader,
                  I married him.&rdquo; St John&apos;s letter from India, where he is dying in missionary
                  service, closes the novel, contrasting his self-denying path with Jane&apos;s fulfilment.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="rounded-lg bg-muted p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              ...
              marriage (until the Married Women&apos;s Property Act, 1882), or attend university. Jane&apos;s
              insistence on equality, independence, and the right to feel passion directly challenged
              these conventions. Contemporary reviewers called the novel &ldquo;anti-Christian&rdquo; and
          ...
          <div className="rounded-lg bg-muted p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              ...
              and hated the experience, writing to her sister Emily of feeling &ldquo;wretched&rdquo; and
              &ldquo;isolated.&rdquo; Jane&apos;s refusal to accept this marginalisation &mdash; her insistence
              on being seen and heard &mdash; was radical for its time. The &ldquo;governess novel&rdquo;
          ...
          <div className="rounded-lg bg-muted p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              ...
              &ldquo;madness&rdquo; and her racialised description (&ldquo;dark&rdquo; features, animalistic
              behaviour) have been critiqued by postcolonial scholars as reflecting Victorian racism.
              St John&apos;s missionary zeal to &ldquo;save&rdquo; India represents the paternalistic
              imperialism of the period. Jean Rhys&apos;s <em>Wide Sargasso Sea</em> (1966) retells
          ...
          <div className="rounded-lg bg-muted p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              ...
              Heights</em> and Anne&apos;s <em>Agnes Grey</em>. The sisters grew up in Haworth parsonage,
              Yorkshire, and many elements of <em>Jane Eyre</em> are autobiographical: the Clergy
              Daughters&apos; School at Cowan Bridge (the model for Lowood), where Charlotte&apos;s sisters
              Maria and Elizabeth died; Charlotte&apos;s experience as a governess; and her intense,
          ...
          <div className="rounded-lg bg-muted p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              ...
              Calvinist rigour &mdash; a demanding, self-denying faith that leaves no room for human
              warmth. Jane&apos;s own faith is personal and intuitive: she believes in God but refuses
              to accept religious authority that contradicts her conscience. This was considered
          ...
          <div className="rounded-lg bg-muted p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              ...
              and endurance), Thornfield (passion and temptation), Moor House (independence and
              self-discovery), Ferndean (fulfilment and equality). The form was more commonly used
              for male protagonists &mdash; Bront&euml;&apos;s innovation was to apply it to a woman&apos;s
              inner life, insisting that women&apos;s intellectual and moral development was as worthy of
              novelistic attention as men&apos;s.
            </p>
          </div>
        </div>
      </Section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg bg-muted p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              ...
              <strong> direct address to the reader</strong>, <strong>Byronic hero</strong> (for
              Rochester), <strong>pathetic fallacy</strong>, and <strong>Gothic conventions</strong>.
          ...
          <div className="rounded-lg bg-muted p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              ...
              this scene? What does she want the reader to think or feel? How does this connect to
          ...
          <div className="rounded-lg bg-muted p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              ...
              Gothic elements &rarr; female confinement and the &ldquo;madwoman in the attic.&rdquo;
              Colonialism &rarr; the source of Rochester&apos;s wealth and Bertha&apos;s Creole identity.
          ...
          <div className="rounded-lg bg-muted p-4">
            ...
            <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
              ...
              pairings allow you to explore themes through contrast and demonstrate a sophisticated
              understanding of the novel&apos;s structure.
            </p>
          </div>
        </div>
      </Section>
