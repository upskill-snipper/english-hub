...
function Quote({ text, speaker, chapter, analysis }: { text: string; speaker: string; chapter: string; analysis: string }) {
  return (
    <div className="rounded-lg border-l-4 border-accent bg-accent-50/40 p-4">
      ...
      <p className="mt-1 text-xs text-gray-500">{speaker} &mdash; {chapter}</p>
      ...
      <div className="space-y-4" id="plot-summary">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-bold text-gray-900 flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-xs font-bold text-gray-700">1</span>
            ...
            <div>
              <h3 className="font-bold text-gray-900 flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-xs font-bold text-gray-700">2</span>
                A London Particular
              </h3>
              <p className="mt-2 text-sm text-gray-700 leading-relaxed">
            ...
            <div>
              <h3 className="font-bold text-gray-900 flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-xs font-bold text-gray-700">3</span>
                The Journey North
              </h3>
              <p className="mt-2 text-sm text-gray-700 leading-relaxed">
            ...
            <div>
              <h3 className="font-bold text-gray-900 flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-xs font-bold text-gray-700">4</span>
            ...
            <div>
              <h3 className="font-bold text-gray-900 flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-xs font-bold text-gray-700">5</span>
            ...
            <div>
              <h3 className="font-bold text-gray-900 flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-xs font-bold text-gray-700">6</span>
            ...
            <div>
              <h3 className="font-bold text-gray-900 flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-xs font-bold text-gray-700">7</span>
                The Nursery / Spider
              </h3>
              <p className="mt-2 text-sm text-gray-700 leading-relaxed">
            ...
            <div>
              <h3 className="font-bold text-gray-900 flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-xs font-bold text-gray-700">8</span>
            ...
            <div>
              <h3 className="font-bold text-gray-900 flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-xs font-bold text-gray-700">9</span>
                The Ending
              </h3>
              <p className="mt-2 text-sm text-gray-700 leading-relaxed">
        ...
        <div id="characters">
          <Section id="characters" title="Character Profiles" badge="6 Characters" colour="bg-purple-600">
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Arthur Kipps (Narrator)</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">The Woman in Black (Jennet Humfrye)</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Mr Samuel Daily</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Mrs Alice Drablow</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Keckwick</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Spider (the Dog)</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
        ...
        <div id="key-quotations">
          <Section id="quotations" title="Key Quotations" badge="20+ Quotes" colour="bg-amber-600">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900 mb-3">Isolation and Setting</h3>
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-3">Fear and the Supernatural</h3>
                <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-3">Grief and Revenge</h3>
                <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-3">Arthur&apos;s Transformation</h3>
                <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div id="context">
          <Section id="context" title="Context" colour="bg-cyan-600">
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900">The Gothic Tradition</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Victorian Attitudes to Unmarried Mothers</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">The Role of Women</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Rationalism vs the Supernatural</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Susan Hill and the Modern Ghost Story</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
          ...
          <Section id="exam-tips" title="Exam Tips" colour="bg-primary">
            <div className="space-y-6">
              <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-4">
                <h3 className="font-bold text-gray-900">Structure Your Essay</h3>
              ...
              <div className="rounded-lg border border-green-200 bg-green-50/50 p-4">
                <h3 className="font-bold text-gray-900">Key Techniques to Discuss</h3>
                <ul className="mt-3 space-y-2 text-sm text-gray-700">
              ...
              <div className="rounded-lg border border-amber-200 bg-amber-50/50 p-4">
                <h3 className="font-bold text-gray-900">Common Mistakes to Avoid</h3>
                <ul className="mt-3 space-y-2 text-sm text-gray-700">
