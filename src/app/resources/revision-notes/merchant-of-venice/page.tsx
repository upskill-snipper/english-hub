      ...
      <div className="space-y-4" id="plot-summary">
        ...
        <div id="characters">
          <Section id="characters" title="Character Profiles" badge="9 Characters" colour="bg-purple-600">
            <div className="space-y-8">
              {/* Portia */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Portia</h3>
              ...
              {/* Shylock */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Shylock</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Bassanio */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Bassanio</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Jessica */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Jessica</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Lorenzo */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Lorenzo</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Nerissa */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Nerissa</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Gratiano */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Gratiano</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Lancelot Gobbo */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Lancelot Gobbo</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
        ...
        <div id="themes">
          <Section id="themes" title="Themes" badge="6 Themes" colour="bg-emerald-600">
            <div className="space-y-8">
              {/* Justice vs Mercy */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Justice vs Mercy</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Prejudice and Anti-Semitism</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Love and Friendship */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Love and Friendship</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Appearance vs Reality</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Wealth */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Wealth and Commerce</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Gender */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Gender and Disguise</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
        ...
        <div id="key-quotations">
          <Section id="quotes" title="Key Quotations with Analysis" badge="22 Quotes" colour="bg-amber-600">
            <div className="space-y-4">
              ...
              <h3 className="font-bold text-gray-900 mt-6 mb-3">Shylock</h3>
              ...
              <h3 className="font-bold text-gray-900 mt-6 mb-3">Portia</h3>
              <div className="grid gap-3 sm:grid-cols-2">
                <Quote
              ...
              <h3 className="font-bold text-gray-900 mt-6 mb-3">Antonio</h3>
              <div className="grid gap-3 sm:grid-cols-2">
                <Quote
                  text="In sooth, I know not why I am so sad"
                  speaker="Antonio"
              ...
              <h3 className="font-bold text-gray-900 mt-6 mb-3">Bassanio and Others</h3>
              <div className="grid gap-3 sm:grid-cols-2">
                <Quote
        ...
        <div id="context">
          <Section id="context" title="Historical and Social Context" badge="Essential" colour="bg-teal-600">
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Elizabethan Attitudes to Jews</h3>
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Usury and Moneylending</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Venice as a Setting</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Marriage and the Law</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Religious Conversion</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
        ...
        <div id="the-trial-scene">
          <Section id="trial" title="The Trial Scene &mdash; Detailed Analysis" badge="Act 4, Scene 1" colour="bg-red-600">
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Structure of the Scene</h3>
                <div className="overflow-x-auto">
                  <table className="min-w-full text-sm text-left border border-gray-200 rounded-lg overflow-hidden">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="px-4 py-2 font-semibold text-gray-700 border-b">Stage</th>
                        <th className="px-4 py-2 font-semibold text-gray-700 border-b">What Happens</th>
                        <th className="px-4 py-2 font-semibold text-gray-700 border-b">Key Techniques</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                      <tr>
                        <td className="px-4 py-2 font-medium text-gray-900">Opening</td>
                        <td className="px-4 py-2 text-gray-700">The Duke appeals to Shylock for mercy. Shylock refuses, citing the law and his &ldquo;humour.&rdquo;</td>
                        <td className="px-4 py-2 text-gray-600">Shylock&apos;s animal imagery (rats, pigs) dehumanises his own position. The Duke&apos;s bias is clear.</td>
                      </tr>
                      <tr>
                        <td className="px-4 py-2 font-medium text-gray-900">Bassanio&apos;s offer</td>
                        <td className="px-4 py-2 text-gray-700">Bassanio offers twice and then three times the sum. Shylock refuses all money.</td>
                        <td className="px-4 py-2 text-gray-600">The escalating offers show desperation. Shylock&apos;s refusal proves this is about principle (revenge), not profit.</td>
                      </tr>
                      <tr>
                        <td className="px-4 py-2 font-medium text-gray-900">Portia&apos;s mercy speech</td>
                        <td className="px-4 py-2 text-gray-700">Disguised as Balthazar, Portia delivers the &ldquo;quality of mercy&rdquo; speech.</td>
                        <td className="px-4 py-2 text-gray-600">Religious imagery, natural imagery (rain). Rhetorical persuasion. Dramatic irony: the audience knows this is Portia.</td>
                      </tr>
                      <tr>
                        <td className="px-4 py-2 font-medium text-gray-900">The trap</td>
                        <td className="px-4 py-2 text-gray-700">Portia seems to rule for Shylock, then reveals the technicality: flesh but no blood, exactly one pound.</td>
                        <td className="px-4 py-2 text-gray-600">Peripeteia (reversal of fortune). Legal wordplay. Portia mirrors Shylock&apos;s own insistence on the letter of the law.</td>
                      </tr>
                      <tr>
                        <td className="px-4 py-2 font-medium text-gray-900">Shylock&apos;s defeat</td>
                        <td className="px-4 py-2 text-gray-700">Shylock tries to take the money instead. Portia refuses &mdash; he has already chosen justice. His wealth is forfeit under Venetian law.</td>
                        <td className="px-4 py-2 text-gray-600">Ironic reversal: the law Shylock championed now destroys him. Pathos as he loses everything.</td>
                      </tr>
                      <tr>
                        <td className="px-4 py-2 font-medium text-gray-900">The &ldquo;mercy&rdquo;</td>
                        <td className="px-4 py-2 text-gray-700">Antonio &ldquo;mercifully&rdquo; allows Shylock to keep half his wealth if he converts to Christianity and leaves his estate to Jessica.</td>
                        <td className="px-4 py-2 text-gray-600">Deeply ironic &ldquo;mercy.&rdquo; The forced conversion strips Shylock of his identity. His final line: &ldquo;I am not well.&rdquo;</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Key Arguments About the Trial</h3>
                <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Exam-Ready Analysis Points</h3>
        ...
        <div id="essay-planning">
          <Section id="essay" title="Essay Planning and Exam Technique" badge="Grade 7-9" colour="bg-primary">
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900 mb-2">How to Structure a Literature Essay (PEEL)</h3>
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                  <div className="rounded-lg bg-[#1A5276]/10 border border-[#1A5276]/20 p-4 text-center">
                    <p className="text-2xl font-bold text-[#1A5276]">P</p>
                    <p className="text-sm font-semibold text-gray-800 mt-1">Point</p>
                    <p className="text-xs text-gray-600 mt-1">A clear argument that answers the question directly</p>
                  </div>
                  <div className="rounded-lg bg-[#2E86C1]/10 border border-[#2E86C1]/20 p-4 text-center">
                    <p className="text-2xl font-bold text-[#2E86C1]">E</p>
                    <p className="text-sm font-semibold text-gray-800 mt-1">Evidence</p>
                    <p className="text-xs text-gray-600 mt-1">A short, embedded quotation from the text</p>
                  </div>
                  <div className="rounded-lg bg-[#1A5276]/10 border border-[#1A5276]/20 p-4 text-center">
                    <p className="text-2xl font-bold text-[#1A5276]">E</p>
                    <p className="text-sm font-semibold text-gray-800 mt-1">Explain</p>
                    <p className="text-xs text-gray-600 mt-1">Analyse language, structure, form. Use subject terminology</p>
                  </div>
                  <div className="rounded-lg bg-[#2E86C1]/10 border border-[#2E86C1]/20 p-4 text-center">
                    <p className="text-2xl font-bold text-[#2E86C1]">L</p>
                    <p className="text-sm font-semibold text-gray-800 mt-1">Link</p>
                    <p className="text-xs text-gray-600 mt-1">Connect to context, audience, wider themes, or the question</p>
                  </div>
                </div>
              </div>

              <div>
                <h3 className="font-bold text-gray-900 mb-2">Sample Essay Plans</h3>
                <div className="space-y-4">
                  {/* Essay 1 */}
                  <div className="rounded-lg border border-gray-200 p-4">
                    <p className="text-sm font-bold text-[#1A5276] mb-2">&ldquo;How does Shakespeare present Shylock as both villain and victim?&rdquo;</p>
                  ...
                  {/* Essay 2 */}
                  <div className="rounded-lg border border-gray-200 p-4">
                    <p className="text-sm font-bold text-[#1A5276] mb-2">&ldquo;How does Shakespeare explore the theme of mercy in The Merchant of Venice?&rdquo;</p>
                    <div className="space-y-2 text-sm text-gray-700">
                  ...
                  {/* Essay 3 */}
                  <div className="rounded-lg border border-gray-200 p-4">
                    <p className="text-sm font-bold text-[#1A5276] mb-2">&ldquo;How does Shakespeare present Portia as a powerful female character?&rdquo;</p>
                    <div className="space-y-2 text-sm text-gray-700">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2">Top Tips for Grade 7-9</h3>
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-lg bg-gray-50 p-4">
                    <p className="text-sm font-semibold text-gray-800 mb-1">Use subject terminology precisely</p>
                    <p className="text-xs text-gray-600">Metaphor, simile, rhetorical question, dramatic irony, soliloquy, aside, prose vs verse, peripeteia, pathos, motif, juxtaposition, parallel structure.</p>
                  </div>
                  <div className="rounded-lg bg-gray-50 p-4">
                    <p className="text-sm font-semibold text-gray-800 mb-1">Embed short quotations</p>
                    <p className="text-xs text-gray-600">Use 2-5 word quotations woven into your sentences rather than long block quotes. E.g., &ldquo;Shylock&apos;s plea that Jews have &lsquo;hands, organs, dimensions&rsquo; asserts shared humanity.&rdquo;</p>
                  </div>
                  <div className="rounded-lg bg-gray-50 p-4">
                    <p className="text-sm font-semibold text-gray-800 mb-1">Consider alternative interpretations</p>
                    <p className="text-xs text-gray-600">Use phrases like &ldquo;Some critics argue...&rdquo; or &ldquo;An Elizabethan audience might have...&rdquo; or &ldquo;However, this could alternatively suggest...&rdquo;</p>
                  </div>
                  <div className="rounded-lg bg-gray-50 p-4">
                    <p className="text-sm font-semibold text-gray-800 mb-1">Integrate context naturally</p>
                    <p className="text-xs text-gray-600">Don&apos;t bolt on context as a separate paragraph. Weave it into your analysis: &ldquo;In Elizabethan England, usury was considered sinful, which makes Antonio&apos;s hatred of Shylock not merely personal but ideological.&rdquo;</p>
                  </div>
                  <div className="rounded-lg bg-gray-50 p-4">
                    <p className="text-sm font-semibold text-gray-800 mb-1">Analyse Shakespeare&apos;s methods</p>
                    <p className="text-xs text-gray-600">Focus on what Shakespeare <em>does</em> as a writer: &ldquo;Shakespeare uses the casket test as an allegory for...&rdquo; or &ldquo;Shakespeare juxtaposes Venice and Belmont to...&rdquo;</p>
                  </div>
                  <div className="rounded-lg bg-gray-50 p-4">
                    <p className="text-sm font-semibold text-gray-800 mb-1">Track character across the play</p>
                    <p className="text-xs text-gray-600">Show how characters change. Shylock moves from resigned patience to vengeful fury. Portia moves from obedient daughter to courtroom authority. Track the arc, don&apos;t just describe a snapshot.</p>
                  </div>
                </div>
              </div>
            </div>
