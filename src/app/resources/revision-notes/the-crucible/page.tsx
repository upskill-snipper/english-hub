      ...
      <div className="space-y-4" id="plot-summary">
        ...
        <div id="characters">
          <Section id="characters" title="Character Profiles" badge="8 Characters" colour="bg-purple-600">
            <div className="space-y-8">
              {/* John Proctor */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">John Proctor</h3>
              ...
              {/* Abigail Williams */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Abigail Williams</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Elizabeth Proctor */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Elizabeth Proctor</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Reverend Hale */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Reverend Hale</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Danforth */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Deputy Governor Danforth</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Reverend Parris */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Reverend Parris</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Rebecca Nurse */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Rebecca Nurse</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              {/* Giles Corey */}
              <div>
                <h3 className="text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">Giles Corey</h3>
                <p className="mt-3 text-sm text-gray-700 leading-relaxed">
        ...
        <div id="key-quotations">
          <Section id="quotations" title="Key Quotations" badge="20+ Quotes" colour="bg-amber-600">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900 mb-3">John Proctor</h3>
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-3">Abigail Williams</h3>
                <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div id="context">
          <Section id="context" title="Historical Context" colour="bg-cyan-600">
            <div className="space-y-6">
              <div>
                <h3 className="font-bold text-gray-900">McCarthyism and the Red Scare (1950s)</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">The Salem Witch Trials (1692)</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Puritanism and Theocracy</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
              ...
              <div>
                <h3 className="font-bold text-gray-900">The Title: &ldquo;The Crucible&rdquo;</h3>
                <p className="mt-2 text-sm text-gray-700 leading-relaxed">
          ...
          <Section id="exam-tips" title="Exam Tips" colour="bg-primary">
            <div className="space-y-6">
              <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-4">
                <h3 className="font-bold text-gray-900">General Tips for The Crucible</h3>
