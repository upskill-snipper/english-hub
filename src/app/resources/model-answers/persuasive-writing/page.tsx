...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://theenglishhub.app/resources/model-answers/persuasive-writing",
  },
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Model articles, speeches, and letters at grade 3, 5, 7, and 9 with
            annotations showing you how to deploy rhetorical devices, structure
            an argument, and write with purpose and flair.
          </p>
        </div>
      </section>
          ...
          <div className="space-y-16">
            ...
            <Section id="article" title="Model Article">
              <div className="mb-6 rounded-xl border border-border bg-card p-6 shadow-md">
                ...
                <p className="font-medium text-foreground">
                  &lsquo;Young people spend too much time on their
                  phones.&rsquo; Write an article for a broadsheet newspaper in
                  which you argue for or against this view.
                </p>
              </div>
                ...
                {{
                  9: (
                    <>
                      ...
                      <AnswerCard>
                        ...
                        <p className="text-sm italic text-muted-foreground">
                          <Annotation note="Subheading establishes the article's stance clearly. This is a key convention of broadsheet journalism.">
                            Far from destroying communication, smartphones have
                            transformed it &mdash; and it is time we stopped blaming
                            young people for adapting.
                          </Annotation>
                        </p>
                        <p>
                          ...
                          At the corner table, a teenager scrolls through her phone
                          while her parents exchange weary glances. The scene is
                          familiar, almost cliched &mdash; and it is precisely this
                          familiarity that should make us suspicious of it. Because
                          what the hand-wringing commentators never mention is what
                          she is actually <em>doing</em> on that phone:
                          <Annotation note="Rule of three (tricolon) with increasing significance — moves from personal to political.">
                            organising a fundraiser for her school&apos;s food bank,
                            responding to a friend in crisis, reading an article
                        ...
                        <p>
                          <Annotation note="Topic sentence that clearly signals the paragraph's argument.">
                            The charge that young people are &ldquo;addicted&rdquo;
                            to their phones collapses under scrutiny.
                          </Annotation>{" "}
                          Research from the Oxford Internet Institute found that the
                          effect of screen time on wellbeing is roughly equivalent to
                          that of eating potatoes.
                        ...
                        <p>
                          ...
                          Social media can amplify anxiety; cyberbullying is real and
                          devastating. But to blame the phone is to
                        ...
                        <p>
                          <Annotation note="Strong concluding paragraph that returns to the opening image (circular structure).">
                            So the next time you see a teenager on their phone in a
                            restaurant, resist the urge to tut. Ask them what they
                            are doing. You might be surprised. You might even learn
                            something.
                          </Annotation>
                        </p>
                      </AnswerCard>
                      <ExaminerComment>
                        <p>
                          An accomplished article that demonstrates all the
                          conventions of broadsheet journalism: a compelling headline,
                          a clear subheading, a concrete opening scenario, and a
                          sustained argument with evidence and counter-argument. The
                          tone is confident and assured. The circular structure is
                          satisfying. Full marks: 40/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                  ...
                  7: (
                    <>
                      ...
                      <AnswerCard>
                        ...
                        <p>
                          <Annotation note="Effective opening with a statistic. However, it is less engaging than the grade 9 scenario-based opening.">
                            According to a recent survey, the average teenager
                            spends four hours a day on their phone. For many adults,
                            this is alarming. But is it really as bad as it sounds?
                          </Annotation>
                        </p>
                        <p>
                          The truth is, phones are not the enemy. Young people use
                          them to
                          <Annotation note="Good use of a list to counter the opposing view. However, the examples are somewhat generic.">
                            stay in touch with friends, research homework, follow the
                            news, and even run small businesses
                          </Annotation>
                          . The idea that all screen time is wasted time is simply
                          outdated.
                        </p>
                        <p>
                          <Annotation note="Counter-argument is acknowledged, which shows balance. However, the rebuttal is less sharp than at grade 9.">
                            Of course, there are risks. Too much social media can
                            affect mental health, and some apps are designed to be
                            addictive. But rather than banning phones, we should be
                            teaching young people how to use them responsibly.
                          </Annotation>
                        </p>
                        <p>
                          <Annotation note="A clear call to action, though the ending lacks the punchy, memorable quality of the grade 9 close.">
                            Instead of criticising teenagers, perhaps we should be
                            asking ourselves: when was the last time you put your own
                            phone down?
                          </Annotation>
                        </p>
                      </AnswerCard>
                      <ExaminerComment>
                        <p>
                          A well-structured article with a clear argument, evidence,
                          and counter-argument. The tone is appropriate and the
                          rhetorical question ending is effective. To reach grade 9,
                          the student should use a more engaging opening scenario, add
                          a subheading, deploy more varied rhetorical devices, and
                          craft a more memorable headline. Marks: 33/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                      ...
                      <AnswerCard>
                        ...
                        <p>
                          <Annotation note="The opening addresses the question directly but is quite flat. It tells the reader the argument rather than drawing them in.">
                            I think that young people do not spend too much time on
                            their phones. Phones are a useful tool and they help us
                            in many ways.
                          </Annotation>
                        </p>
                        <p>
                          <Annotation note="A valid point but presented as a list without development. Each point could be expanded with evidence or examples.">
                            Firstly, phones help us with our schoolwork because we
                            can look things up. Secondly, they help us stay in touch
                            with friends. Thirdly, they can be used for reading the
                            news.
                          </Annotation>
                        </p>
                        <p>
                          <Annotation note="Acknowledges the counter-argument, which is good. However, the response to it is weak — 'they should just be more careful' is vague.">
                            Some people say phones are bad for your mental health.
                            This might be true but I think if people are careful they
                            will be fine. They should just be more careful about what
                            they look at.
                          </Annotation>
                        </p>
                        <p>
                          <Annotation note="The conclusion restates the opening without adding anything new. There is no memorable closing line or call to action.">
                            In conclusion, I think phones are not the problem and
                            people should stop blaming young people for using them.
                          </Annotation>
                        </p>
                      </AnswerCard>
                      <ExaminerComment>
                        <p>
                          A clear response that addresses the question and makes
                          relevant points. However, the argument is underdeveloped,
                          the tone is too informal for a broadsheet article, and
                          rhetorical devices are absent. The &ldquo;firstly,
                          secondly, thirdly&rdquo; structure is mechanical. To
                          improve, the student should develop points with evidence,
                          use rhetorical techniques, and match the register to the
                          audience. Marks: 26/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                  ...
                  3: (
                    <>
                      ...
                      <AnswerCard>
                        <p>
                          <Annotation note="No headline, no subheading — key article conventions are missing entirely.">
                            I dont think young people spend too much time on there
                            phones.
                          </Annotation>{" "}
                          Phones are good because you can talk to people and play
                          games.
                        ...
                        <p>
                          <Annotation note="An assertion without any supporting evidence. The piece reads as a series of opinions rather than a structured argument.">
                            I think its unfair to say young people are on there
                            phones too much because adults are on them too.
                          </Annotation>{" "}
                        ...
                        <p>
                          <Annotation note="Abrupt ending with no conclusion, call to action, or memorable closing. The piece simply stops.">
                            Phones are part of life now and people should just accept
                            it.
                          </Annotation>
                        </p>
                      </AnswerCard>
                      <ExaminerComment>
                        <p>
                          This response shows a basic awareness of the question but
                          does not demonstrate any article conventions (no headline, no
                          subheading, no formal register). The argument is a series of
                          opinions without evidence. Spelling and grammar errors
                          (&ldquo;there&rdquo; for &ldquo;their,&rdquo;
                          &ldquo;dont&rdquo;) are frequent. To improve, the student
                          should include a headline, use paragraphs with topic
                          sentences, and support points with evidence. Marks: 16/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
            ...
            <Section id="speech" title="Model Speech">
              <div className="mb-6 rounded-xl border border-border bg-card p-6 shadow-md">
                ...
                <p className="font-medium text-foreground">
                  Write a speech to deliver to your year group persuading them
                  that volunteering should be a compulsory part of the school
                  curriculum.
                </p>
              </div>
                ...
                {{
                  9: (
                    <>
                      ...
                      <AnswerCard>
                        <p>
                          <Annotation note="Direct address to the audience. Using 'we' establishes rapport.">
                            We have all sat through assemblies where someone tells us
                            to &ldquo;give back to the community.&rdquo;
                          </Annotation>{" "}
                        ...
                        <p>
                          ...
                          <Annotation note="Metacommentary — the speaker acknowledges the genre and subverts it.">
                            I am here to argue that volunteering should not be
                            optional &mdash; not because it looks good on a
                            university application, not because adults say so, but
                            because it is the single most effective way of
                            understanding a world that extends beyond these school
                            gates.
                          </Annotation>
                        </p>
                        <p>
                          ...
                          I did not want to go. My parents made me. For the first
                          three days, I counted the hours. By the end of the first
                          week, I had stopped counting. A woman called Margaret told
                          me about growing up during the war. In two weeks, I learned
                          more about resilience, loss, and joy than I had in five
                          years of PSHE lessons.
                        </p>
                        <p>
                          <Annotation note="Counter-argument addressed directly with a statistic for maximum impact.">
                            Now, I know what some of you are thinking: &ldquo;I
                            already have enough homework.&rdquo;
                          </Annotation>{" "}
                          And that is a fair point. But consider this: a 2024 study
                          found that students who volunteer regularly report higher
                          confidence and lower anxiety. Volunteering does not add to
                          your burden. It
                        ...
                        <p>
                          <Annotation note="Call to action — essential in any speech. The shift from 'I' to 'we' to 'you' creates shared purpose.">
                            So here is what I am asking. Not that you sign up
                            tomorrow. Just that you consider it.
                          </Annotation>{" "}
                          Because the world outside these walls is messy,
                          complicated, and sometimes heartbreaking &mdash; and it
                          needs people who have looked it in the eye and chosen to
                          help anyway.
                      ...
                      <ExaminerComment>
                        <p>
                          An engaging, well-structured speech with clear awareness of
                          audience and purpose. The anecdote is specific and moving.
                          The counter-argument is addressed directly. The call to
                          action is measured rather than aggressive. Rhetorical
                          devices are used throughout but never feel forced.
                          Marks: 38/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                      ...
                      <AnswerCard>
                        <p>
                          <Annotation note="Good direct address that engages the audience. The rhetorical question is effective.">
                            How many of you have ever volunteered? And I don&apos;t
                            mean being forced to pick up litter on a school trip. I
                            mean genuinely choosing to help someone.
                          </Annotation>
                        </p>
                        <p>
                          I believe volunteering should be part of the curriculum
                          because it teaches us things that lessons cannot. When you
                          volunteer, you
                          <Annotation note="Good use of a list, though the points could be developed more. Each item is stated rather than explored.">
                            meet people from different backgrounds, develop empathy,
                            and learn practical skills that employers value
                          </Annotation>
                          .
                        </p>
                        <p>
                          <Annotation note="Personal experience used well, though the detail could be more specific. 'A soup kitchen' is less vivid than naming a person or place.">
                            Last year I helped at a soup kitchen. It was hard work
                            but it changed how I think about homelessness.
                          </Annotation>{" "}
                          Before, I used to walk past people without thinking. Now I
                          understand that anyone can end up in that situation.
                        </p>
                        <p>
                          <Annotation note="Counter-argument acknowledged but the rebuttal could be stronger. 'Only a few hours a week' is vague.">
                            I know some of you will say you don&apos;t have time. But
                            it would only be a few hours a week, and the benefits far
                            outweigh the cost.
                          </Annotation>{" "}
                          So I urge you to think about it seriously. You might
                          surprise yourself.
                        </p>
                      </AnswerCard>
                      <ExaminerComment>
                        <p>
                          A clear, engaging speech with good awareness of audience.
                          The personal experience adds credibility. However, points
                          could be developed more fully, the counter-argument rebuttal
                          is weak, and the ending lacks the power of the grade 9
                          close. Marks: 32/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
            ...
            <Section id="techniques" title="Key Persuasive Techniques">
              <p className="mb-6 leading-relaxed text-muted-foreground">
                Master these techniques to elevate your transactional writing
