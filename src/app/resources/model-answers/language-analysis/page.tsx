            ...
            <Section id="question" title={secQuestion}>
              <div className="rounded-xl border border-border bg-card p-6 shadow-md">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  You could include the writer&apos;s choice of words and phrases, language features
                  and techniques, and sentence forms.
                </p>
                <div className="mt-4 rounded-lg bg-muted p-4">
                  ...
                  <p className="text-sm italic leading-relaxed text-muted-foreground">
                    ...
                    blacks that swallowed the last traces of daylight. Wind tore through the narrow
                    streets like a living thing, rattling shutters, upending bins, sending
                    newspapers spiralling into the air like startled birds. Rain came not in drops
                    but in sheets, hammering against the pavement with a relentless, percussive fury
                    that drowned out every other sound. The old oak at the corner of Marsh Lane
                    groaned under the assault, its branches clawing at the sky as though begging for
                    mercy. Somewhere in the distance, thunder rolled &mdash; a low, ominous growl
                    that seemed to come from the earth itself.&rdquo;
                  </p>
                </div>
              </div>
            </Section>
                  ...
                  9: !hasAccess ? (
                    ...
                    <>
                      ...
                      <AnswerCard>
                        <p>
                          <Annotation note="Conceptualised opening: immediately frames an overarching interpretation rather than diving into technique-spotting.">
                            The writer constructs the storm not merely as a weather event but as an
                            elemental antagonist, deploying a sustained pattern of personification
                            and violent imagery that strips humanity of its authority over the
                            natural world.
                          </Annotation>
                        </p>
                        <p className="mt-4">
                          The extract opens with a metaphor of physical trauma: the sky has
                          &ldquo;turned the colour of a bruise.&rdquo; The passive construction here
                          is significant &mdash;
                          <Annotation note="Excellent: analyses the grammatical choice (passive voice) and links it to a wider interpretation about human helplessness.">
                            the sky has not changed but has been changed, as though acted upon by a
                            force beyond comprehension
                          </Annotation>
                          . The verb &ldquo;bleeding&rdquo; extends this corporeal metaphor, while
                          the phrase &ldquo;swallowed the last traces of daylight&rdquo; introduces
                          a predatory quality:
                          <Annotation note="Perceptive analysis of how the writer shifts between semantic fields to build a layered portrayal of the storm.">
                            the storm is not simply dark but actively consuming the light, shifting
                            from victim (&ldquo;bruise&rdquo;) to predator (&ldquo;swallowed&rdquo;)
                            within a single sentence
                          </Annotation>
                          .
                        </p>
                        <p className="mt-4">
                          The wind is characterised as &ldquo;a living thing,&rdquo; and the writer
                          sustains this personification through a
                          <Annotation note="Analyses the rhythm and structure of the sentence, not just the content. This is a hallmark of a top-band response.">
                            breathless asyndetic list &mdash; &ldquo;rattling shutters, upending
                            bins, sending newspapers&rdquo; &mdash; whose accumulative rhythm
                            mirrors the relentless, escalating force of the gale
                          </Annotation>
                          . The simile &ldquo;like startled birds&rdquo; is a momentary shift in
                          register: amid the violence, the newspapers become almost graceful, yet
                          the word &ldquo;startled&rdquo; ensures that even this image is
                        ...
                        <p className="mt-4">
                          Perhaps most powerful is the pathetic fallacy of the oak tree, whose
                          branches are described as &ldquo;clawing at the sky as though begging for
                          mercy.&rdquo;
                          <Annotation note="Outstanding: explores the reversal of the natural order and connects it to the writer's broader thematic purpose.">
                            The reversal is complete: a tree, traditionally a symbol of strength and
                            endurance, is reduced to a supplicant, and the sky it reaches towards
                            has itself been &ldquo;bruised&rdquo; and &ldquo;swallowed.&rdquo; There
                            is no refuge in this landscape
                          </Annotation>
                          . The final image of thunder as &ldquo;a low, ominous growl that seemed to
                          come from the earth itself&rdquo; closes the trap: the threat is above,
                          around, and now beneath, leaving the reader with a visceral sense of
                      ...
                      <ExaminerComment label={examinerLabel}>
                        ...
                        and tracks the shifting semantic field across the extract. The analysis is
                  ...
                  7: !hasAccess ? (
                    ...
                    <>
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        <span className="text-sm text-muted-foreground">6&ndash;7 / 8</span>
                      </div>
                      <AnswerCard>
                        <p>
                          The writer presents the storm as an overwhelming, almost violent force
                          through carefully chosen language. The opening metaphor &ldquo;the colour
                          of a bruise&rdquo; is striking because it
                          <Annotation note="Good: moves beyond identification to explore the specific connotations of 'bruise' and links to the semantic field of violence.">
                            draws on the semantic field of injury, implying the sky itself has been
                            wounded by the storm
                          </Annotation>
                          . The progression from &ldquo;deep purples&rdquo; to &ldquo;blacks&rdquo;
                          suggests a
                          ...
                          , while the verb &ldquo;bleeding&rdquo; reinforces the sense of damage and
                          creates an unsettling, almost visceral image.
                        </p>
                        <p className="mt-4">
                          The personification of the wind as &ldquo;a living thing&rdquo; is
                          developed through a
                          <Annotation note="Strong point: identifies how a list of verbs builds an effect rather than just naming the technique.">
                            tricolon of violent verbs &mdash; &ldquo;rattling,&rdquo;
                            &ldquo;upending,&rdquo; &ldquo;sending&rdquo;
                          </Annotation>{' '}
                          &mdash; which creates a breathless sense of chaos. The simile &ldquo;like
                          startled birds&rdquo; briefly introduces a sense of panic into the scene,
                          as though even inanimate objects are afraid of the storm&apos;s power.
                        </p>
                        <p className="mt-4">
                          The{' '}
                          ...
                          create an auditory quality that mirrors the rain&apos;s aggressive impact.
                          The verb &ldquo;hammering&rdquo; suggests relentless, mechanical force,
                          reducing the rain to a weapon that &ldquo;drowned out every other
                      ...
                      <ExaminerComment label={examinerLabel}>
                        ...
                        reach grade 9, the response could engage more with grammatical and
                        structural choices, and open with a conceptualised interpretation. Marks:
                        7/8.
                      </ExaminerComment>
                      <GradeSummary
                  ...
                  5: !hasAccess ? (
                    ...
                    <>
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        <span className="text-sm text-muted-foreground">5&ndash;6 / 8</span>
                      </div>
                      <AnswerCard>
                        <p>
                          The writer uses language to describe the storm as scary and powerful. The
                          sky is described as &ldquo;
                          <Annotation note="Identifies the metaphor but does not fully explore its connotations.">
                            the colour of a bruise
                          </Annotation>
                          &rdquo; which is a metaphor that suggests the sky looks damaged and hurt,
                          like it has been injured. This makes the reader think the storm is
                          violent.
                        </p>
                        <p className="mt-4">
                          The writer also uses a simile when they say the wind went through the
                          streets &ldquo;
                          <Annotation note="Identifies the technique but the analysis is surface-level.">
                            like a living thing
                          </Annotation>
                          .&rdquo; This makes the wind seem alive and dangerous. The verb
                          &ldquo;rattling&rdquo; shows that the wind is strong and noisy.
                        </p>
                        <p className="mt-4">
                      ...
                      <ExaminerComment label={examinerLabel}>
                        ...
                        explain rather than analyse. To move to grade 7, the student needs to
                  ...
                  3: (
                    <>
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        <span className="text-sm text-muted-foreground">3&ndash;4 / 8</span>
                      </div>
                      <AnswerCard>
                        <p>
                          <Annotation note="Retells the content rather than analysing the language. The student describes what happens in the extract rather than how the writer creates effects.">
                            The writer describes a really bad storm. The sky is dark and it is
                            really windy. The rain is very heavy and loud.
                          </Annotation>
                        </p>
                        <p className="mt-4">
                          The writer says the sky is &ldquo;the colour of a bruise&rdquo; which
                          means it is
                      ...
                      <ExaminerComment label={examinerLabel}>
                        ...
                        are not named, and the analysis does not go beyond the surface. To improve,
                        the student should name techniques, use the word &ldquo;suggests&rdquo; or
                        &ldquo;implies&rdquo; rather than &ldquo;shows,&rdquo; and explain how the
                        writer makes the reader feel. Marks: 3/8.
                      </ExaminerComment>
                      <GradeSummary
            ...
            <Section id="comparison" title={secComparison}>
                ...
                <table className="w-full border-collapse text-sm">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-border p-3 text-muted-foreground">
                        Embeds identification within analysis; does not &ldquo;spot&rdquo;
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-border p-3 font-medium text-foreground">
                      ...
                      <td className="border border-border p-3 text-muted-foreground">
                        Precise, evaluative analysis of how and why effects are created
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-border p-3 font-medium text-foreground">
                      ...
                      <td className="border border-border p-3 text-muted-foreground">
                        Basic but accurate (&ldquo;metaphor,&rdquo; &ldquo;simile&rdquo;)
                      </td>
                      <td className="border border-border p-3 text-muted-foreground">
                        Wider range (&ldquo;semantic field,&rdquo; &ldquo;plosive&rdquo;)
                      </td>
                      <td className="border border-border p-3 text-muted-foreground">
                        Integrated and precise (&ldquo;asyndetic,&rdquo; &ldquo;dissonance,&rdquo;
                    ...
                    <tr>
                      ...
                      <td className="border border-border p-3 text-muted-foreground">
                        Single words and phrases embedded fluently within sentences
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-xl border-2 border-border bg-card p-5">
                  <h3 className="font-bold text-red-600">Grade 3 &rarr; 5</h3>
                  <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                    <li>&bull; Name the technique you spot</li>
                    <li>&bull; Use &ldquo;suggests&rdquo; instead of &ldquo;shows&rdquo;</li>
                ...
                <div className="rounded-xl border-2 border-border bg-card p-5">
                  ...
                  <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                    ...
                    <li>&bull; Use &ldquo;perhaps&rdquo; to explore alternative interpretations</li>
