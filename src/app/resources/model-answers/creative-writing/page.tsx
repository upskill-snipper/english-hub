          ...
          <div className="space-y-16">
                    ...
                    <>
                      ...
                      <AnswerCard>
                        ...
                        <p>
                          <Annotation note="Shift to visual. The zoom-in structure (wide shot to close-up) mirrors how a person would actually perceive the scene.">
                            Canvas awnings stretched overhead in patchwork strips of rust-orange and
                            faded blue
                          </Annotation>
                          , their edges fraying where the wind had worried at them season after
                          season. Beneath them, the stalls were
                          <Annotation note="Extended metaphor of the stalls as geological features gives weight and permanence to the scene.">
                            geological: great slabs of fruit arranged in terraces, pyramids of
                            clementines bright as traffic lights, crates of apples tilting at
                            precarious angles
                          </Annotation>
                          ...
                          <Annotation note="Precise, cinematic detail. 'Presided' elevates her role; the verb 'rearranging' suggests constant, practiced motion.">
                            never still, always rearranging, always angling a peach to catch the
                            light
                          </Annotation>
                          .
                        </p>
                        <p>
                          ...
                          , her face split by a grin so wide it seemed borrowed from someone twice
                          her size.
                        </p>
                        <p>
                          ...
                          <Annotation note="Circular structure: returns to sound, creating a satisfying sense of wholeness. The final sentence is deliberately calm amid the chaos.">
                            persistent bell of a cash register &mdash; there was a quieter rhythm:
                            the steady, unhurried heartbeat of a place that had been doing this for
                            a hundred years and fully intended to do it for a hundred more
                          </Annotation>
                          .
                        </p>
                      </AnswerCard>
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          paragraph, uses varied and sophisticated sentence structures throughout,
                          and deploys figurative language with precision. The circular structure
                          &mdash; opening and closing with sound &mdash; shows structural awareness.
                          Vocabulary is ambitious but never overwrought. Full marks: 40/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                    ...
                    <>
                      ...
                      <AnswerCard>
                        ...
                        <p>
                          ...
                          . &ldquo;Two for a pound, love! You won&apos;t find better!&rdquo; He
                          tossed an apple from hand to hand while he waited for customers, never
                          quite looking at the fruit, as though his hands knew the routine without
                          him.
                        </p>
                        <p>
                          ...
                          <Annotation note="Attempts to vary sentence rhythm with a list. Effective but not as controlled as the grade 9 minor sentences.">
                            squeezed past each other, paused at displays, craned their necks to read
                            menus
                          </Annotation>
                          . Children weaved between legs at knee height. Somewhere behind me, a
                          musician was playing a guitar, the melody rising and falling beneath the
                          chatter like a
                        ...
                        <p>
                          By the time I left, the sun had dipped behind the rooftops and the
                          stall-holders were beginning to pack up, folding their awnings like
                          closing books.
                          <Annotation note="A thoughtful closing image that gives the piece a sense of finality. The simile is effective.">
                            The market was winding down, but its warmth stayed with me.
                          </Annotation>
                        </p>
                      </AnswerCard>
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          at grade 9. To reach grade 9, the student should use more sophisticated
                          structural techniques (circular structure, zoom effects) and develop
                          extended metaphors rather than single similes. Marks: 33/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                    ...
                    <>
                      ...
                      <AnswerCard>
                        ...
                        <p>
                          ...
                          shouted about her prices. &ldquo;Two pounds a bowl! Get your soup
                          here!&rdquo; she yelled. Her voice was loud and carried over the noise of
                          the crowd. Next to her, a man was selling watches laid out on a
                      ...
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          literal and sometimes tells rather than shows. Sentence structures are
                          mostly simple or compound with limited variety. Marks: 28/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                  ...
                  3: (
                    <>
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        <span className="text-sm text-muted-foreground">18/40</span>
                      </div>
                      <AnswerCard>
                        <p>
                          ...
                          There were lots of people there and they were all walking around looking
                          at things. There were stalls everywhere selling different things.
                        </p>
                        <p>
                      ...
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          lacks any figurative language. Sentence structures are entirely simple
                          with no variety. To improve, the student should practise using sensory
                          details and attempt similes or metaphors. Marks: 18/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
            ...
            <Section id="narrative" title={secNarrative}>
              <div className="mb-6 rounded-xl border border-border bg-card p-6 shadow-md">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  You may wish to write about your own experiences or create a fictional narrative.
                </p>
              </div>
                    ...
                    <>
                      ...
                      <AnswerCard>
                        ...
                        <p>
                          ...
                          <Annotation note="The rule of three establishes routine, making the disruption that follows more powerful.">
                            same mug, same chair, same radio station murmuring beneath the tick of
                            the kitchen clock
                          </Annotation>
                        ...
                        <p>
                          I do not remember the exact words she used. I remember the clock. I
                          remember the
                          <Annotation note="Anaphoric repetition ('I remember') combined with sensory fragments creates a fragmented, trauma-like memory.">
                            way the light fell through the kitchen blind in thin, surgical lines
                            across the table. I remember the sound of next door&apos;s dog barking,
                            indifferent, absurdly normal
                          </Annotation>
                          . The world outside continued. Inside, something had quietly and
                          irreversibly broken.
                        </p>
                        <p>
                          <Annotation note="Time shift handled elegantly. The paragraph break signals the passage of time without needing to state it.">
                            Three weeks later, I stood at the end of the street with a rucksack on
                            my back and a suitcase that pulled to the left.
                          </Annotation>{' '}
                          ...
                          <Annotation note="Powerful restraint. The absence of dialogue says more than words could.">
                            the two of us at Whitby last July, sand in our hair, squinting against
                            the sun. I folded it carefully and put it in my coat pocket, where it
                            would bend, I knew, into the shape of my body
                          </Annotation>
                          .
                        </p>
                        <p>
                          ...
                          <Annotation note="Active verb choice: the houses 'peel away' rather than the narrator leaving them. This shifts agency.">
                            peel away like layers of something I had not known was mine until it was
                            taken
                          </Annotation>
                          .
                        </p>
                        <p>
                          <Annotation note="Circular structure: returns to the mug motif. The final image is deliberately small and domestic, reinforcing the theme that change lives in the ordinary.">
                            The new house smelled of paint and someone else&apos;s cooking. In the
                            kitchen, there were mugs already in the cupboard, left by the previous
                            owners. I chose one at random. It did not matter which. None of them
                            were hers.
                          </Annotation>
                        </p>
                      </AnswerCard>
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          mug motif is sustained throughout to create a satisfying circular
                          structure. The writer shows extraordinary restraint. Full marks: 40/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                        level={GRADE_LEVELS[0]}
                    ...
                    <>
                      ...
                      <AnswerCard>
                        <p>
                          <Annotation note="Opens with a clear attempt at atmosphere. The simile is original, though the opening is more conventional than the grade 9 in medias res.">
                            The letter sat on the kitchen table like an uninvited guest.
                          </Annotation>{' '}
                          My mother stood by the window, her back to me, her fingers laced together
                          as though she were holding herself in place. I knew, before she spoke,
                          that something had shifted.
                        </p>
                        <p>
                          &ldquo;We need to talk,&rdquo; she said, and her voice was careful,
                          ...
                          . She told me about the job. About Manchester. About how it was an
                          opportunity she could not turn down. Each sentence landed with a kind of
                          finality, as though she had rehearsed them.
                        </p>
                        <p>
                          <Annotation note="Effective use of internal response. However, 'my stomach dropped' is a common expression rather than an original image.">
                            My stomach dropped. I wanted to argue, to shout, but nothing came out.
                          </Annotation>{' '}
                          I thought about my friends, my room, the park at the end of the road where
                          Jake and I had spent every summer since we were ten.
                          <Annotation note="The list of memories is effective and specific. It shows what the character stands to lose.">
                            All of it, suddenly, felt like something I was already losing.
                          </Annotation>
                        </p>
                        <p>
                        ...
                        <p>
                          <Annotation note="The ending attempts reflection but is slightly rushed. A stronger close would use a specific image rather than a general statement.">
                            The new house was smaller and smelled of fresh paint. It did not feel
                            like home. But then, I thought, home was never really about the
                            building.
                          </Annotation>
                        </p>
                      </AnswerCard>
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          rushed. To reach grade 9, the student should develop a sustained motif and
                          use more original imagery throughout. Marks: 32/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                        level={GRADE_LEVELS[1]}
                    ...
                    <>
                      ...
                      <AnswerCard>
                        <p>
                          ...
                          I woke up, got dressed and went downstairs for breakfast like I always
                          did. My mum was in the kitchen making toast. Everything seemed normal.
                        </p>
                        <p>
                          Then{' '}
                          ...
                          we were moving to a different city because of her new job. I was
                          ...
                          . I didn&apos;t want to leave my friends or my school. I went to my room
                          and
                        ...
                        <p>
                          Over the next few weeks, I had to say goodbye to everyone. My best friend
                          Jake gave me a
                          ...
                          . I tried not to cry but it was really hard. On the day we left, I looked
                          out of the car window and watched my street get smaller and smaller until
                          it disappeared.
                        </p>
                        <p>
                          <Annotation note="The resolution is rushed. A stronger response would develop the emotional complexity of the ending.">
                            When we arrived at the new house, it didn&apos;t feel like home. But I
                      ...
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          than showing emotion. Marks: 26/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                        level={GRADE_LEVELS[2]}
                    ...
                    <>
                      ...
                      <AnswerCard>
                        <p>
                          ...
                          I was really sad because I didn&apos;t want to go. I liked my school and I
                        ...
                        <p>
                          ...
                          It took ages and I was bored. My friend came round to say bye and we were
                      ...
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          language and no sentence variety. Key emotional moments are rushed or
                          skipped. Marks: 16/40.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
