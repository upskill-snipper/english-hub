    ...
    <>
      ...
      <nav className="mx-auto max-w-5xl px-4 pt-6" aria-label="Breadcrumb">
        <ol className="flex flex-wrap items-center gap-2 text-sm text-gray-500">
          ...
          <li>/</li>
          <li className="font-medium text-[#1A5276]">Model Answers</li>
        </ol>
      </nav>
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-6 sm:grid-cols-2">
          {QUESTION_TYPES.map((type) => (
            <Link
              ...
              className="group rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-[#2E86C1]/40 hover:shadow-md"
            >
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 rounded-lg bg-[#2E86C1]/10 p-3">
                  {type.icon}
                </div>
                <div className="flex-1">
                  <h2 className="text-lg font-bold text-[#1A5276] group-hover:text-[#2E86C1] transition-colors">
                    {type.title}
                  </h2>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {type.grades.map((grade) => (
                      <span
                        key={grade}
                        className="rounded-full bg-[#2E86C1]/10 px-3 py-0.5 text-xs font-semibold text-[#1A5276]"
                      >
                        {grade}
                      </span>
                    ))}
        ...
        {/* How to Use section */}
        <div className="mt-12 rounded-xl border border-[#2E86C1]/20 bg-[#2E86C1]/5 p-6 sm:p-8">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-[#1A5276]">Read Actively</h3>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-[#1A5276]">Compare Grades</h3>
                <p className="mt-1 text-sm text-gray-600">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-[#1A5276]">Practise</h3>
                <p className="mt-1 text-sm text-gray-600">
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-4">
          {[
            ...
            >
              <p className="text-2xl font-bold text-[#2E86C1]">{item.stat}</p>
