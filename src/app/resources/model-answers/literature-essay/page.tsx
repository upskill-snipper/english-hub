      ...
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-[220px_1fr] lg:gap-10">
          ...
          <div className="space-y-16">
            ...
            <Section id="macbeth" title="Macbeth &mdash; Ambition">
              <div className="mb-6 rounded-xl border border-border bg-card p-6 shadow-md">
                ...
                <p className="font-medium text-foreground">
                  Starting with this extract, how does Shakespeare present the theme of ambition in{' '}
                  <em>Macbeth</em>?
                </p>
                  ...
                  9: !hasAccess ? (
                    ...
                    <>
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        <span className="text-sm text-muted-foreground">34/34</span>
                      </div>
                      <AnswerCard>
                        <p>
                          <Annotation note="Conceptualised opening: immediately establishes an argument about ambition as a destructive force, not just a character trait.">
                            Shakespeare presents ambition not as a noble aspiration but as a
                            corrosive, self-consuming force that dismantles the moral and political
                            order of the play.
                          </Annotation>{' '}
                          Through Macbeth&apos;s trajectory from &ldquo;valiant cousin&rdquo; to
                          &ldquo;dead butcher,&rdquo; Shakespeare dramatises the Jacobean anxiety
                          that unchecked ambition could destabilise the divinely ordained hierarchy
                          &mdash;
                          <Annotation note="Contextual integration from the outset. This is not a bolted-on context paragraph but woven into the argument.">
                            a fear acutely relevant to a king who had survived the Gunpowder Plot
                            just a year before the play&apos;s first performance
                          </Annotation>
                          .
                        </p>
                        <p>
                          In the extract, Macbeth&apos;s soliloquy reveals ambition as an internal
                          torment. His admission that he has &ldquo;no spur / To prick the sides of
                          my intent, but only /
                          <Annotation note="Close language analysis of the metaphor. The student explores the specific connotations of 'vaulting' and connects it to the idea of over-reaching.">
                            Vaulting ambition, which o&apos;erleaps itself&rdquo; employs an
                            equestrian metaphor in which ambition is figured as a rider who, in
                            attempting to mount the horse, falls on the other side
                          </Annotation>
                          . The prefix &ldquo;o&apos;er&rdquo; emphasises excess &mdash; ambition
                          does not simply leap but
                          <Annotation note="Precise analysis of a single word. This level of close reading is characteristic of top-band responses.">
                            over-leaps, transgressing the natural boundary of what is achievable or
                            permissible
                          </Annotation>
                          .
                        </p>
                        <p>
                          ...
                          Macbeth&apos;s ambition but
                          <Annotation note="Evaluative interpretation: the student is arguing a specific reading of the witches' role.">
                            catalyse what already exists, raising the troubling question of whether
                            ambition is innate or externally provoked
                          </Annotation>
                          .
                        </p>
                      </AnswerCard>
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          moving from the extract to the wider play with fluency. Context is
                          integrated naturally into the analysis. Close language analysis is
                          combined with whole-text awareness. Marks: 34/34.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                  ...
                  7: !hasAccess ? (
                    ...
                    <>
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        <span className="text-sm text-muted-foreground">26&ndash;28/34</span>
                      </div>
                      <AnswerCard>
                        <p>
                          <Annotation note="A clear opening that signals the argument, though not as conceptualised as grade 9. The student identifies ambition as destructive but doesn't yet frame it in terms of Shakespeare's broader purpose.">
                            Shakespeare presents ambition as a powerful but ultimately destructive
                            force in Macbeth. Through Macbeth&apos;s actions and language, the
                            audience sees how ambition can corrupt even a brave and loyal soldier.
                          </Annotation>
                        </p>
                        <p>
                          In the extract, Macbeth describes his ambition as &ldquo;vaulting
                          ambition, which o&apos;erleaps itself.&rdquo;
                          <Annotation note="Good quotation selection and the analysis explores the metaphor. However, it doesn't push as far as grade 9 in exploring the significance of 'o'er'.">
                            This metaphor compares ambition to a horse rider who jumps too far and
                            falls. This suggests that Macbeth knows his ambition is dangerous and
                            could lead to his downfall
                          </Annotation>
                          , yet he continues to pursue it. The word &ldquo;vaulting&rdquo; suggests
                          something energetic and uncontrollable.
                        </p>
                        <p>
                          In the wider play, Lady Macbeth also shows the destructive nature of
                          ambition. She calls on &ldquo;spirits&rdquo; to &ldquo;unsex&rdquo; her,
                          showing she is willing to
                          <Annotation note="Relevant wider play knowledge. Context is mentioned but feels slightly separate from the textual analysis.">
                            give up her femininity to achieve power. In Jacobean society, this would
                            have been seen as deeply unnatural and sinful, as women were expected to
                      ...
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          Macbeth&apos;s character. Context is relevant but feels slightly bolted on
                          rather than integrated. To reach grade 9, the student should open with a
                          more conceptualised argument and analyse individual words with greater
                  ...
                  5: !hasAccess ? (
                    ...
                    <>
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        <span className="text-sm text-muted-foreground">19&ndash;22/34</span>
                      </div>
                      <AnswerCard>
                        <p>
                          <Annotation note="A basic opening that addresses the question but does not offer an argument or interpretation. The student describes rather than argues.">
                            Shakespeare presents ambition in Macbeth through the main character.
                            Macbeth is ambitious because he wants to become king.
                          </Annotation>
                        </p>
                        <p>
                          In the extract, Macbeth talks about his &ldquo;vaulting ambition.&rdquo;
                          <Annotation note="Identifies the quotation and makes a basic comment, but the analysis does not go beyond paraphrasing. What does 'vaulting' specifically suggest?">
                            This shows that his ambition is very strong and he cannot control it. He
                            knows it might cause problems but he carries on anyway
                          </Annotation>
                          .
                        </p>
                        <p>
                          Lady Macbeth is also ambitious. She persuades Macbeth to kill King Duncan
                          by
                          <Annotation note="Retells the plot rather than analysing language or technique. A stronger response would focus on what the language reveals rather than what happens.">
                            questioning his manhood and calling him a coward. This shows she is
                            determined to become queen. In the end, her ambition makes her go mad
                        ...
                        <p>
                          <Annotation note="Context is relevant but feels like a separate add-on rather than part of the analysis.">
                            In Shakespeare&apos;s time, people believed in the Divine Right of
                            Kings, so killing a king would have been seen as a terrible sin. This
                            makes Macbeth&apos;s ambition seem even worse.
                          </Annotation>
                        </p>
                      </AnswerCard>
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          context into the analysis. Marks: 20/34.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                  ...
                  3: (
                    <>
                      <div className="mb-4 flex items-center gap-3">
                        ...
                        <span className="text-sm text-muted-foreground">10&ndash;14/34</span>
                      </div>
                      <AnswerCard>
                        <p>
                          <Annotation note="The opening does not address the question about how Shakespeare presents ambition. It simply states what Macbeth does.">
                            Macbeth is a play about a man who kills the king because he wants to be
                            king himself. He is very ambitious.
                          </Annotation>
                        </p>
                        <p>
                          <Annotation note="Plot retelling with no analysis of language. The student describes events but does not examine how Shakespeare uses language to present ambition.">
                            In the play, Macbeth meets three witches who tell him he will be king.
                            This makes him want to kill Duncan. His wife helps him and they kill
                            Duncan in his sleep.
                          </Annotation>
                        </p>
                        <p>
                          <Annotation note="A basic moral judgement rather than literary analysis. There is no quotation and no engagement with Shakespeare's techniques.">
                            Macbeth&apos;s ambition is bad because it makes him do terrible things.
                            He kills his friend Banquo and tries to kill Banquo&apos;s son. In the
                            end he gets killed by Macduff. This shows that ambition is dangerous.
                          </Annotation>
                        </p>
                      </AnswerCard>
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          quotations, no analysis of language or technique, and no context. The
                          response reads as a plot summary with a moral conclusion. To improve, the
                          student must include quotations, name techniques, and focus on how rather
                          than what. Marks: 12/34.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
            ...
            <Section
              id="christmas-carol"
              title="A Christmas Carol &mdash; Scrooge's Transformation"
            >
              <div className="mb-6 rounded-xl border border-border bg-card p-6 shadow-md">
                <p className="mb-2 text-xs font-bold uppercase tracking-wider text-primary">
                  Question
                ...
                {{
                  7: (
                    <>
                      ...
                      <AnswerCard>
                        <p>
                          Dickens presents Scrooge&apos;s transformation through the visits of the
                          three spirits. At the start, Scrooge is described as &ldquo;
                          ...
                          .&rdquo; The list of adjectives creates a sense of relentless greed and
                          suggests Scrooge is defined entirely by his desire for money. The word
                          &ldquo;sinner&rdquo; has religious connotations and implies that his
                          behaviour is morally wrong.
                        </p>
                        <p>
                          By the end of the novella, Scrooge has completely changed. He is described
                          as &ldquo;
                          ...
                          .&rdquo; The repetition of &ldquo;good&rdquo; emphasises how much he has
                          changed. Dickens uses this transformation to show Victorian readers that
                          <Annotation note="Context is relevant but separated from the textual analysis.">
                            generosity is more important than wealth, which was an important message
                            in Victorian society where there was a big gap between rich and poor
                          </Annotation>
                          .
                        </p>
                      </AnswerCard>
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          To reach grade 9, the student should analyse grammatical form and
                          integrate context more seamlessly.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                        level={GRADE_LEVELS[1]}
                    ...
                    <>
                      ...
                      <AnswerCard>
                        <p>
                          <Annotation note="Opens with an argument, not a description. The student frames the transformation in terms of Dickens's didactic purpose.">
                            Dickens constructs Scrooge&apos;s transformation as a moral parable
                            designed to agitate the conscience of his middle-class readership.
                          </Annotation>{' '}
                          The opening catalogue of participial adjectives &mdash; &ldquo;squeezing,
                          wrenching, grasping, scraping, clutching&rdquo; &mdash;
                          <Annotation note="Analyses the grammatical form (participles) and their effect, not just the content of the words.">
                            ...
                            suggesting continuous, habitual greed rather than a single instance of
                            meanness
                          </Annotation>
                          . The cumulative effect is almost comic in its excess, yet Dickens
                          immediately undercuts this with &ldquo;covetous old sinner&rdquo; &mdash;
                          a term that
                          <Annotation note="Links a single word to the Ten Commandments and Dickens's moral framework.">
                            invokes the Tenth Commandment and positions Scrooge&apos;s avarice as a
                            spiritual crime, not merely a social failing
                          </Annotation>
                          .
                        </p>
                        <p>
                          ...
                          &mdash; Tiny Tim&apos;s empty chair, his own neglected grave.
                          Dickens&apos;s strategy is one of
                          <Annotation note="Evaluative vocabulary: 'strategic discomfort' shows the student thinking about Dickens as a craftsman with a purpose.">
                            strategic discomfort: by making his protagonist witness the consequences
                            of indifference, he simultaneously confronts the reader
                          </Annotation>
                          . In a society where the 1834 Poor Law had institutionalised the idea that
                          poverty was a moral failing of the poor, Dickens radically inverts this
                      ...
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          seamlessly, and evaluates Dickens&apos;s structural choices. The key
                          difference from grade 7 is writing about Dickens as a writer with a
                          deliberate strategy, not just describing what happens. Marks: 34/34.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                        level={GRADE_LEVELS[0]}
                      ...
                      <AnswerCard>
                        <p>
                          <Annotation note="Thesis-driven opening. The student does not begin with 'Priestley presents responsibility as...' but offers an original argument about the play's structure.">
                            Priestley weaponises the detective genre to dismantle the Birlings&apos;
                            moral complacency, transforming a drawing-room mystery into a socialist
                            polemic in which the real crime is not Eva Smith&apos;s death but the
                        ...
                        <p>
                          ...
                          . The generational divide is central. Sheila&apos;s transformation
                          represents
                          <Annotation note="Contextualises the generational divide in relation to Priestley's post-war audience.">
                            Priestley&apos;s hope that the post-war generation would build a more
                            equitable society
                          </Annotation>
                          .
                          <Annotation note="Analyses how Priestley uses a single word differently for different characters to expose hypocrisy.">
                            Priestley thus exposes the word &ldquo;responsibility&rdquo; itself as
                            contested terrain: for Birling, it means protecting the family name; for
                            the Inspector, it means recognising our shared humanity
                          </Annotation>
                          .
                        </p>
                        <p>
                          The final telephone call &mdash; &ldquo;a girl has just died&rdquo;
                          &mdash; is Priestley&apos;s masterstroke.
                          <Annotation note="Analyses the ending as a structural and ideological choice.">
                            It shatters the Birlings&apos; relief and the audience&apos;s
                            complacency simultaneously, suggesting that responsibility is a
                            perpetual moral obligation
                          </Annotation>
                          . Written in 1945 but set in 1912, the play&apos;s temporal duality allows
                          Priestley to dramatise the cost of ignoring responsibility: the audience
                          knows that two world wars followed the Birlings&apos; Edwardian
                          complacency.
                        </p>
                      </AnswerCard>
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          vehicle, language as contested territory, and the dual time setting.
                          Context is precisely integrated, not appended. Marks: 34/34.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
                        level={GRADE_LEVELS[0]}
            ...
            <Section id="poetry" title="Poetry Comparison &mdash; Power of Nature">
              <div className="mb-6 rounded-xl border border-border bg-card p-6 shadow-md">
                ...
                <p className="font-medium text-foreground">
                  Compare how the poets present the power of nature in &lsquo;Storm on the
                  Island&rsquo; (Heaney) and one other poem from the anthology.
                </p>
                <p className="mt-1 text-sm text-muted-foreground">
                ...
                {{
                  9: !hasAccess ? (
                    ...
                    <>
                      <div className="mb-4 flex items-center gap-3">
                        <GradeBadge grade="Grade 9 (Exceptional)" color="bg-primary" />
                        <span className="text-sm text-muted-foreground">30/30</span>
                      </div>
                      <AnswerCard>
                        <p>
                          <Annotation note="Comparative thesis from the outset. Both poems are introduced within a single conceptualised argument.">
                            Both Heaney and Owen present nature as an adversary that exposes human
                            vulnerability, yet while Heaney&apos;s storm is an immediate, tangible
                            assault, Owen&apos;s weather is an insidious, slow-burning force that
                            kills through attrition rather than violence.
                          </Annotation>
                        </p>
                        <p>
                          ...
                          &ldquo;pummels&rdquo; and &ldquo;strafes,&rdquo; the latter
                          <Annotation note="Connects Heaney's word choice to the political context of Northern Ireland.">
                            drawn specifically from aerial warfare, creating an unsettling overlap
                            between natural and military violence that invites an allegorical
                            reading of the Troubles
                          </Annotation>
                          .
                        </p>
                        <p>
                          Owen, by contrast, strips nature of agency. The repeated refrain
                          &ldquo;But nothing happens&rdquo; is devastating in its understatement:
                          <Annotation note="Analyses the structural effect of the refrain across the whole poem.">
                            each repetition drains the poem of forward momentum, trapping the
                      ...
                      <ExaminerComment label={examinerLabel}>
                        <p>
                          ...
                          structure, and the contextual readings are precisely integrated. Full
                          marks: 30/30.
                        </p>
                      </ExaminerComment>
                      <GradeSummary
