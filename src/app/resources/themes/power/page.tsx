    ...
    quotes: [
      {
        ...
        analysis:
          'The metaphor of horse-riding suggests ambition without moral justification -- Macbeth knows his desire for power lacks legitimate cause.',
      },
      {
        text: '"Will all great Neptune\'s ocean wash this blood clean from my hand?"',
        analysis:
          'Hyperbole reveals that seizing power through murder leaves an indelible stain on the conscience.',
      },
      {
        text: '"Out, damned spot! Out, I say!"',
        analysis:
          "Lady Macbeth's sleepwalking shows power gained through violence leads to psychological destruction.",
      },
    ],
  },
  {
    ...
    quotes: [
      {
        ...
        analysis:
          "Birling's dismissive tone reveals how the powerful dehumanise workers, reducing them to a collective threat rather than individuals.",
      },
      {
        text: '"We are members of one body. We are responsible for each other"',
        analysis:
          "The Inspector's collective pronoun challenges the individualism of the powerful, insisting on shared accountability.",
      },
      {
        text: '"But these girls aren\'t cheap labour -- they\'re people"',
        analysis:
          "Sheila's awakening demonstrates that recognising the humanity of the powerless is essential to moral growth.",
      },
    ],
  },
  {
    ...
    quotes: [
      {
        ...
        analysis:
          'The paradox exposes how those in power manipulate language to justify inequality while maintaining the illusion of fairness.',
      },
      {
        text: '"Napoleon is always right"',
        analysis:
          "Boxer's blind loyalty shows how the powerful exploit the trust of the uneducated to maintain control.",
      },
      {
        text: '"...looked from pig to man, and from man to pig..."',
        analysis:
          "Orwell's closing image (Ch. 10): the watching animals can no longer tell pig from man. The cyclical ending suggests that revolutions against power often recreate the very tyranny they sought to overthrow.",
      },
    ],
  },
  {
    ...
    quotes: [
      {
        ...
        analysis:
          "Dramatic irony: the boastful command now invites despair not at Ozymandias' greatness, but at the inevitable destruction of all human power.",
      },
      {
        text: '"Nothing beside remains"',
        analysis:
          'The blunt caesura emphasises total obliteration -- all traces of power have been erased by time.',
      },
      {
        text: '"The lone and level sands stretch far away"',
        analysis:
          "Sibilance and the vast imagery of the desert underscore nature's indifference to human authority.",
      },
    ],
  },
  {
    ...
    quotes: [
      {
        ...
        analysis:
          'The chilling euphemism implies murder, revealing the extreme lengths to which the powerful will go to maintain control.',
      },
      {
        text: '"She had a heart -- how shall I say? -- too soon made glad"',
        analysis:
          "The Duke frames his wife's kindness as a flaw, exposing how power distorts perception of generosity.",
      },
      {
        text: '"since none puts by the curtain I have drawn for you, but I"',
        analysis:
          "The curtain symbolises the Duke's absolute control -- even in death, the Duchess exists only at his pleasure.",
      },
    ],
  },
]
    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Power</h1>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            How writers present power, ambition, authority, and control across your GCSE set texts.
            Includes key quotes, analysis, and comparison essay planning.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-muted-foreground">
          Each text explores power from a different angle. Click into any section for key quotes and
          analysis you can use in your essays.
        </p>
      ...
      <section className="bg-muted px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-2xl font-bold text-foreground">Comparison essay planning</h2>
          <p className="mt-2 text-muted-foreground">
            Use these comparison points as paragraph starters for a thematic comparison essay on
            power.
          </p>
