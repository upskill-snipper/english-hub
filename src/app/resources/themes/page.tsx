    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Explore the major themes that run across your GCSE set texts. Compare how different
            writers tackle the same ideas -- perfect for comparison essays and cross-text revision.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-muted-foreground">
          Select a theme to see how it appears across your set texts, with key quotes and comparison
          essay ideas.
        </p>
      ...
      <section className="bg-muted px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-center text-muted-foreground">
            Cross-text comparison is one of the highest-value skills at GCSE. Follow these steps to
            structure a strong thematic comparison.
          </p>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={tip.step} className="rounded-xl border border-border bg-card p-6 shadow-md">
