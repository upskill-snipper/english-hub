    ...
    quotes: [
      {
        ...
        analysis:
          "Romeo's immediate rejection of his previous 'love' for Rosaline raises the question of whether this new passion is equally superficial -- or genuinely different.",
      },
      {
        text: '"My only love sprung from my only hate! Too early seen unknown, and known too late!"',
        analysis:
          "Juliet's antithesis captures the play's central paradox: love and hate are born from the same source, and the timing of recognition is tragically wrong.",
      },
      {
        text: '"These violent delights have violent ends"',
        analysis:
          "Friar Lawrence's warning foreshadows the tragedy and suggests that passionate, impulsive love contains the seeds of its own destruction.",
      },
    ],
  },
  {
    ...
    quotes: [
      {
        ...
        analysis:
          "Barrett Browning's extended metaphor of growing vines presents love as a natural, living force that grows uncontrollably from thought and imagination.",
      },
      {
        text: '"Mother Any Distance: \'You at the zero-end, me with the spool of tape\'"',
        analysis:
          'Armitage uses the measuring tape as an extended metaphor for the parent-child bond: love stretches but must eventually break to allow independence.',
      },
      {
        text: '"Winter Swans: \'They mate for life, said the guide\'"',
        analysis:
          'Sheers uses the swans as a symbol of enduring love, offering quiet hope that damaged relationships can heal through shared experience.',
      },
    ],
  },
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        analysis:
          "Austen's ironic opening sentence exposes society's equation of love with economics, setting up the novel's exploration of whether love can transcend material concerns.",
      },
    ],
  },
]
    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Love</h1>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            How writers present romantic, familial, and unrequited love across your GCSE set texts.
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-muted-foreground">
          From star-crossed tragedy to slow-burn romance to the complexity of family bonds -- love
          takes many forms across the GCSE canon.
        </p>
      ...
      <section className="bg-muted px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-2 text-muted-foreground">
            Use these as starting points for thematic comparison paragraphs on love.
          </p>
