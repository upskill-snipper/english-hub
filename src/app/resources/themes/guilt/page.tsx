    ...
    quotes: [
      {
        ...
        analysis:
          'The hyperbole suggests guilt is permanent and all-consuming -- no external force can remove the internal stain of murder.',
      },
      {
        text: '"Out, damned spot! Out, I say!"',
        analysis:
          "The imagined bloodstain externalises Lady Macbeth's guilt. The imperative verbs show her desperate, futile attempts to rid herself of responsibility.",
      },
      {
        text: '"Macbeth shall sleep no more"',
        analysis:
          'Sleep represents innocence and a clear conscience. Shakespeare suggests that guilt permanently destroys inner peace.',
      },
    ],
  },
  {
    ...
    quotes: [
      {
        ...
        analysis:
          "The Inspector's final speech redefines guilt as a social concept: failing to care for others is as morally culpable as direct harm.",
      },
      {
        text: '"They will be taught it in fire and blood and anguish"',
        analysis:
          'The biblical imagery elevates guilt from personal emotion to prophetic warning -- collective irresponsibility leads to collective suffering (the World Wars).',
      },
      {
        text: '"I behaved badly too. I know I did. I\'m ashamed of it"',
        analysis:
          "Sheila's acceptance of guilt represents the moral transformation Priestley wants his audience to undergo.",
      },
    ],
  },
  {
    ...
    quotes: [
      {
        ...
        analysis:
          "The dual meaning of 'bloody' (literal blood and the expletive) captures both the physical reality and the emotional weight of guilt.",
      },
      {
        text: '"he\'s here in my head when I close my eyes"',
        analysis:
          "The present tense and intimate 'my head' show guilt as a permanent, internal haunting -- the dead man has become part of the soldier's consciousness.",
      },
      {
        text: '"I blink and he bursts again through the doors of the bank"',
        analysis:
          "The violent verb 'bursts' and the cyclical structure show that guilt forces the traumatic moment to repeat endlessly.",
      },
    ],
  },
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        analysis:
          "Scrooge's redemption shows that guilt, when properly confronted, can be a catalyst for genuine moral transformation.",
      },
      {
        text: '"The common welfare was my business... charity, mercy, forbearance, and benevolence"',
        analysis:
          "Marley's ghost redefines guilt in social terms -- neglecting others is as damning as active cruelty.",
      },
    ],
  },
]
    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Guilt</h1>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            How writers present guilt, remorse, and moral responsibility across your GCSE set texts.
            Includes key quotes, analysis, and comparison ideas.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-muted-foreground">
          Each text presents guilt differently -- as psychological torment, social critique, or a
          catalyst for change.
        </p>
