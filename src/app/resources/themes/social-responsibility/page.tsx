    ...
    quotes: [
      {
        ...
        analysis:
          "The organic metaphor of 'one body' presents society as interconnected -- harm to one part damages the whole. This is Priestley's central thesis.",
      },
      {
        text: '"A man has to mind his own business and look after himself and his own"',
        analysis:
          "Birling's individualist philosophy is positioned early in the play so the audience can watch it be systematically dismantled.",
      },
      {
        text: '"They will be taught it in fire and blood and anguish"',
        analysis:
          "The prophetic warning gains dramatic irony from the 1912/1945 time gap -- the audience knows the 'fire and blood' of two World Wars proved the Inspector right.",
      },
    ],
  },
  {
    ...
    quotes: [
      {
        ...
        analysis:
          'Scrooge echoes the callous rhetoric of the Victorian establishment. Dickens forces his middle-class readers to hear their own indifference spoken aloud.',
      },
      {
        text: '"This boy is Ignorance. This girl is Want. Beware them both... but most of all beware this boy"',
        analysis:
          'The Ghost of Christmas Present warns that ignorance of poverty is more dangerous than poverty itself -- it prevents the compassion needed for social change.',
      },
      {
        text: '"Mankind was my business. The common welfare was my business"',
        analysis:
          "Marley's ghost redefines 'business' from commercial profit to social obligation, directly challenging the capitalist values of Dickens' audience.",
      },
    ],
  },
  {
    ...
    quotes: [
      {
        ...
        analysis:
          "The repetition of 'charter'd' suggests everything -- even the river -- has been commodified and controlled by the powerful, stripping ordinary people of freedom.",
      },
      {
        text: '"The mind-forg\'d manacles I hear"',
        analysis:
          "The metaphor suggests oppression is both external (institutional) and internal (psychological). Society's failures have imprisoned people's very thoughts.",
      },
      {
        text: '"How the chimney-sweeper\'s cry / Every black\'ning church appalls"',
        analysis:
          "The Church is literally and metaphorically 'blackened' by its failure to protect child labourers -- a direct accusation of institutional hypocrisy.",
      },
    ],
  },
]
  ...
  return (
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            How writers challenge their audiences to consider their duty to society. Includes key
            quotes, analysis, and comparison ideas.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <h2 className="text-2xl font-bold text-foreground">Social responsibility across texts</h2>
        <p className="mt-2 text-muted-foreground">
          Three writers from different centuries, all asking the same question: what do we owe each
          other?
        </p>
      ...
      <section className="bg-muted px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-2 text-muted-foreground">
            Use these as starting points for thematic comparison paragraphs on social
            responsibility.
          </p>
