...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    colour: 'text-primary',
    borderColour: 'border-primary/40',
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Over 30 topic ideas for your Spoken Language endorsement, organised by category. Each
            includes a brief outline, key points to cover, and potential audience questions to
            prepare for.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
                ...
                {cat.topics.map((topic, i) => (
                  ...
                  >
                    ...
                    <div className="mt-5 grid gap-5 lg:grid-cols-2">
                      ...
                      <div>
                        <h4
                          className={`text-sm font-semibold uppercase tracking-wider ${cat.colour}`}
                        >
                          Key Points to Cover
                        </h4>
        ...
        <div className="mt-16 rounded-lg border border-primary/20 bg-primary/5 p-6">
          ...
          <div className="mt-4 space-y-3 text-sm text-muted-foreground leading-relaxed">
            ...
            <ul className="ml-4 list-disc space-y-2">
              ...
              <li>
                <strong>It allows you to present an argument or viewpoint</strong> &mdash;
                persuasive topics give you the chance to use rhetorical devices and demonstrate
                higher-level speaking skills.
              </li>
              <li>
                <strong>It has enough depth</strong> &mdash; you need to speak for 3&ndash;5 minutes
                and then answer questions, so your topic must have substance.
              </li>
              <li>
                <strong>You can find evidence and examples</strong> &mdash; statistics, expert
                opinions, and real-world cases will strengthen your presentation.
              </li>
              <li>
                <strong>It is appropriate for a formal setting</strong> &mdash; remember, this is
                assessed in a formal context by your teacher.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 rounded-lg border bg-gradient-to-b from-primary/[0.06] to-transparent p-8 text-center">
          ...
          <p className="mx-auto mt-2 max-w-lg text-muted-foreground">
            Head back to our full Spoken Language guide for detailed advice on planning, delivery,
            answering questions, and hitting every assessment criterion.
          </p>
          <Link
            href="/resources/spoken-language"
