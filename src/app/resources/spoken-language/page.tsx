    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Everything you need to achieve a Distinction in your GCSE English Language Spoken
            Language endorsement. Plan, practise, and deliver a presentation with confidence.
          </p>
      ...
      <nav className="mx-auto max-w-5xl px-4 pt-6" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li className="font-medium text-foreground">{tr(`Spoken Language`)}</li>
        </ol>
      </nav>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section aria-labelledby="what-heading">
          <h2 id="what-heading" className="text-2xl font-bold text-foreground">
            1. What Is the Spoken Language Endorsement?
          </h2>
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              The Spoken Language endorsement is a <strong>compulsory component</strong> of GCSE
              English Language. Every student must complete it, but it is reported{' '}
              <strong>separately</strong> from your main 9&ndash;1 GCSE grade. It does not affect
              your English Language grade &mdash; instead, it appears on your certificate as its own
              result.
            </p>
            <p>
              The endorsement requires you to deliver a{' '}
              <strong>formal presentation or speech</strong> on a topic of your choice, respond to
              questions and feedback from the audience, and use spoken Standard English throughout.
              It is designed to assess your ability to communicate effectively in a formal spoken
              context &mdash; a skill valued by employers, colleges, and universities.
            </p>
            <div className="rounded-lg border border-primary/20 bg-primary/5 p-5">
              ...
              <ul className="ml-4 mt-2 list-disc space-y-1 text-sm text-muted-foreground">
                ...
                <li>{tr(`Assessed by your teacher, moderated by your exam board`)}</li>
                <li>{tr(`You deliver a presentation, then answer questions`)}</li>
                <li>{tr(`Standard English must be used throughout`)}</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section aria-labelledby="assessment-heading">
          <h2 id="assessment-heading" className="text-2xl font-bold text-foreground">
            2. How Is It Assessed?
          </h2>
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Your teacher assesses your spoken language performance against three assessment
              strands. The result is graded as one of four outcomes:
            </p>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border-2 border-primary bg-primary/10 p-4 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  {tr(`Outstanding performance across all three strands`)}
                </p>
              </div>
              <div className="rounded-lg border-2 border-primary/60 bg-primary/5 p-4 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  {tr(`Competent and clear across all strands`)}
                </p>
              </div>
              <div className="rounded-lg border-2 border-border bg-muted p-4 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  {tr(`Basic competence demonstrated`)}
                </p>
              </div>
              <div className="rounded-lg border-2 border-border bg-muted p-4 text-center">
                <p className="text-lg font-bold text-muted-foreground">{tr(`Not Classified`)}</p>
                <p className="mt-1 text-xs text-muted-foreground">{tr(`Requirements not met`)}</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  ...
                  structure your talk logically. You may use brief notes or cue cards but should not
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  ...
                  classmates. You must listen carefully, understand each question, and respond
                  thoughtfully and in full. This demonstrates your ability to engage in formal
                  spoken exchange.
                </p>
              </div>
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  ...
                  answering questions. This means formal grammar, avoiding slang, and speaking in
                  complete, well-formed sentences appropriate to a formal context.
                </p>
              </div>
            </div>
          </div>
        ...
        <section aria-labelledby="topics-heading">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Choose a topic you are genuinely interested in. The best presentations come from
              speakers who are passionate about their subject. Here are {TOPIC_IDEAS.length} ideas
              to get you started:
            </p>
            ...
            <div className="mt-4 rounded-lg border border-primary/20 bg-primary/5 p-5">
              <p className="text-sm text-muted-foreground">
                <strong>{tr(`Want more ideas?`)}</strong> We have 30+ topics with full outlines, key
                points, and potential questions.{' '}
                <Link
                  href="/resources/spoken-language/topics"
        ...
        <section id="planning" aria-labelledby="planning-heading">
          <h2 id="planning-heading" className="text-2xl font-bold text-foreground">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            ...
            <ol className="ml-6 list-decimal space-y-4">
              <li>
                ...
                sustained speaking and follow-up questions.
              </li>
              <li>
                <strong>{tr(`Research thoroughly`)}</strong> &mdash; Gather facts, statistics,
                expert opinions, and real-world examples. The stronger your evidence, the more
                convincing your presentation.
              </li>
              <li>
                <strong>{tr(`Decide your angle`)}</strong> &mdash; Are you arguing for or against
                something? Informing? Persuading? Your angle shapes your entire structure.
              </li>
              <li>
                <strong>{tr(`Structure your content`)}</strong> &mdash; Use the framework below to
                organise your material into a clear, logical flow.
              </li>
              <li>
                <strong>{tr(`Create cue cards`)}</strong> &mdash; Write key words and short phrases
                on numbered cards. Never write full sentences &mdash; you should speak naturally,
                not read aloud.
              </li>
              <li>
                <strong>{tr(`Anticipate questions`)}</strong> &mdash; Think about what your audience
                might ask and prepare thoughtful responses.
              </li>
              <li>
                <strong>{tr(`Practise aloud`)}</strong> &mdash; Rehearse at least three times. Time
                yourself. Practise in front of a friend or family member for feedback.
              </li>
            </ol>
            ...
            <div className="mt-3 space-y-3">
              <div className="rounded-lg border-l-4 border-[primary] bg-muted p-4">
                ...
                <p className="mt-1 text-sm">
                  ...
                  statistic, a powerful quotation, or a bold statement. State your topic and your
              ...
              <div className="rounded-lg border-l-4 border-amber-500 bg-muted p-4">
                ...
                <p className="mt-1 text-sm">
                  ...
                  demonstrates maturity and critical thinking: &ldquo;Some may argue that&hellip;
              ...
              <div className="rounded-lg border-l-4 border-emerald-500 bg-muted p-4">
                ...
                <p className="mt-1 text-sm">
                  ...
                  line or call to action. Circle back to your opening hook for a satisfying circular
                  structure.
                </p>
              </div>
            </div>

            <h3 className="mt-8 text-lg font-semibold text-foreground">Notes and Cue Cards</h3>
            <p>
            ...
            <ul className="ml-6 list-disc space-y-2">
              ...
              <li>{tr(`One main point per card for easy navigation`)}</li>
            </ul>
          </div>
        </section>
        ...
        <section aria-labelledby="delivery-heading">
          <h2 id="delivery-heading" className="text-2xl font-bold text-foreground">
            5. How to Deliver Effectively
          </h2>
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Delivery is just as important as content. A well-researched presentation can fall flat
              with poor delivery, while confident delivery can elevate even a straightforward topic.
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-lg border border-border bg-muted p-5">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-semibold text-foreground">{tr(`Eye Contact`)}</h3>
                </div>
                <p className="mt-3 text-sm">
                  Look at your audience, not at the floor, ceiling, or your notes. Scan different
                  parts of the room to engage everyone. If direct eye contact feels difficult, look
                  at foreheads. Eye contact builds confidence and credibility.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-3 text-sm">
                  Speak at a measured pace. Nerves often cause people to rush &mdash; consciously
                  slow down. Use deliberate pauses after key points for emphasis. A well-timed pause
                  can be more powerful than any word.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-semibold text-foreground">{tr(`Volume and Clarity`)}</h3>
                </div>
                <p className="mt-3 text-sm">
                  Ensure everyone in the room can hear you clearly. Project your voice without
                  shouting. Enunciate words properly &mdash; avoid mumbling. Vary your volume for
                  effect: a quieter moment can draw the audience in.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-semibold text-foreground">{tr(`Tone and Expression`)}</h3>
                </div>
                <p className="mt-3 text-sm">
                  Avoid speaking in a monotone. Vary your intonation to express enthusiasm, concern,
                  humour, or urgency. Your voice should reflect the content &mdash; let your passion
                  for the topic come through naturally.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-semibold text-foreground">{tr(`Body Language`)}</h3>
                </div>
                <p className="mt-3 text-sm">
                  Stand up straight with feet shoulder-width apart. Use open, confident body
                  language. Avoid fidgeting, crossing your arms, or swaying. Use hand gestures
                  naturally to emphasise points, but do not overdo it.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-semibold text-foreground">{tr(`Rhetorical Techniques`)}</h3>
                </div>
                <p className="mt-3 text-sm">
                  Use rhetorical questions, tricolon (rule of three), anaphora (repetition at the
                  start of sentences), emotive language, and direct address to engage your audience.
                  These are the hallmarks of an effective speaker.
                </p>
              </div>
            </div>
          </div>
        ...
        <section aria-labelledby="questions-heading">
          <h2 id="questions-heading" className="text-2xl font-bold text-foreground">
            6. Responding to Questions
          </h2>
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
            ...
            <ul className="ml-6 list-disc space-y-3">
              ...
              <li>
                <strong>{tr(`Take a moment to think`)}</strong> &mdash; it is perfectly acceptable
                to pause briefly before responding. A thoughtful answer is always better than a
                rushed one.
              </li>
              <li>
                <strong>{tr(`Answer in full sentences`)}</strong> using Standard English. Avoid
                one-word answers or informal language.
              </li>
              <li>
                <strong>{tr(`Develop your answers`)}</strong> &mdash; use phrases such as &ldquo;To
                elaborate on that&hellip;&rdquo;, &ldquo;Building on my earlier
                point&hellip;&rdquo;, or &ldquo;An example of this would be&hellip;&rdquo;
              </li>
              <li>
                <strong>{tr(`If you do not know the answer`)}</strong>, say so honestly and offer
                what you can: &ldquo;That is an excellent question. I have not researched that
                specific aspect, but based on what I do know, I would suggest&hellip;&rdquo;
              </li>
              <li>
                <strong>{tr(`Refer back to your presentation`)}</strong> where relevant: &ldquo;As I
                mentioned earlier&hellip;&rdquo;
              </li>
              <li>
                <strong>{tr(`Engage with challenging questions`)}</strong> &mdash; these are
                opportunities to demonstrate critical thinking and depth of knowledge, not threats.
              </li>
              <li>
                <strong>Stay calm and composed</strong> &mdash; maintain your formal register even
            ...
            <div className="rounded-lg border border-primary/20 bg-primary/5 p-5">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                When preparing your presentation, write down 5&ndash;10 questions your audience
                might ask and practise answering them aloud. This is the single most effective way
                to prepare for the Q&amp;A section.
              </p>
            </div>
          </div>
        </section>
        ...
        <section aria-labelledby="standard-english-heading">
          <h2 id="standard-english-heading" className="text-2xl font-bold text-foreground">
            7. Using Standard English
          </h2>
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Standard English is the formal variety of English used in professional and academic
              contexts. For the Spoken Language endorsement, you must demonstrate that you can use
              Standard English consistently throughout your presentation and when answering
              questions.
            </p>
                ...
                <tbody className="divide-y divide-border">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-2">
                      &ldquo;I did it&rdquo; / &ldquo;I have done it&rdquo;
                    </td>
                  </tr>
                  <tr className="bg-muted/50">
                    <td className="px-4 py-2">&ldquo;They ain&rsquo;t&rdquo;</td>
                    <td className="px-4 py-2">
                      &ldquo;They are not&rdquo; / &ldquo;They have not&rdquo;
                    </td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">&ldquo;Like, basically&hellip;&rdquo;</td>
                    <td className="px-4 py-2">
                      &ldquo;Essentially&hellip;&rdquo; / &ldquo;In summary&hellip;&rdquo;
                    </td>
                  </tr>
                  <tr className="bg-muted/50">
        ...
        <section aria-labelledby="mistakes-heading">
          <h2 id="mistakes-heading" className="text-2xl font-bold text-foreground">
        ...
        <section aria-labelledby="examples-heading">
          <h2 id="examples-heading" className="text-2xl font-bold text-foreground">
            9. Example Presentation Plans
          </h2>
              ...
              <div className="mt-4 space-y-3">
                <div className="rounded border-l-4 border-[primary] bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    ...
                    independence referendum. They proved they were ready. So why are we still
                ...
                <div className="rounded border-l-4 border-primary bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    16-year-olds can work and pay tax. The principle of &ldquo;no taxation without
                ...
                <div className="rounded border-l-4 border-primary bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    At 16, you can join the army, get married, and leave school. If you can make
                ...
                <div className="rounded border-l-4 border-primary bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    Research shows that voting early creates lifelong habits of civic participation.
                ...
                <div className="rounded border-l-4 border-amber-500 bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    ...
                    vote responsibly. However, maturity varies at any age, and education, not age,
                ...
                <div className="rounded border-l-4 border-emerald-500 bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    Summarise key points. Circular ending: &ldquo;If 75% of 16-year-olds can turn
                    out in Scotland, imagine what they could do for the whole country. It is time to
                    let them be heard.&rdquo;
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="mt-4 space-y-3">
                <div className="rounded border-l-4 border-[primary] bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    ...
                    what is that doing to their minds?&rdquo; State angle: exploring the negative
                ...
                <div className="rounded border-l-4 border-primary bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    Filtered images and curated lives lead to unhealthy comparisons. Studies link
                ...
                <div className="rounded border-l-4 border-primary bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    Social media provides a platform for anonymous harassment. 1 in 5 young people
                ...
                <div className="rounded border-l-4 border-primary bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    Blue light and notification cycles disrupt sleep patterns. The &ldquo;fear of
                    missing out&rdquo; (FOMO) creates persistent anxiety and compulsive checking
                    behaviour.
                  </p>
                </div>
                <div className="rounded border-l-4 border-amber-500 bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    ...
                    communities, raising awareness, and supporting those who feel isolated. This is
                ...
                <div className="rounded border-l-4 border-emerald-500 bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    Call to action: &ldquo;We need better regulation, better education, and better
                    awareness. Seven hours a day is not just screen time &mdash; it is time that
                    shapes who our young people become.&rdquo;
                  </p>
                </div>
              </div>
            </div>
        ...
        <section aria-labelledby="criteria-heading">
          <h2 id="criteria-heading" className="text-2xl font-bold text-foreground">
            10. Teacher Assessment Criteria
          </h2>
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Your teacher will assess your performance against the following criteria for each
              grade. Understanding what your teacher is looking for helps you target the highest
              grade.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg border-2 border-primary bg-primary/10 p-5">
                ...
                <ul className="ml-4 mt-3 list-disc space-y-2 text-sm text-muted-foreground">
                  <li>
                    ...
                    well-researched, and compelling. A wide range of rhetorical and presentational
                  ...
                  <li>
                    <strong>{tr(`Standard English:`)}</strong> Standard English is used fluently,
                    consistently, and with precision throughout both the presentation and the
                    Q&amp;A. Vocabulary is ambitious, varied, and appropriate to the formal context.
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-lg border-2 border-primary/60 bg-primary/5 p-5">
                ...
                <ul className="ml-4 mt-3 list-disc space-y-2 text-sm text-muted-foreground">
                  <li>
                    ...
                    and supported with evidence. Rhetorical and presentational techniques are used
                    with success.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    consistently, with only occasional minor errors. Vocabulary is appropriate and
                    sometimes ambitious.
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-lg border-2 border-border bg-muted p-5">
                ...
                <ul className="ml-4 mt-3 list-disc space-y-2 text-sm text-muted-foreground">
                  <li>
                    ...
                    depth or sustained development. Some attempt is made to use presentational
                    techniques.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>{tr(`Standard English:`)}</strong> Standard English is used with some
                    consistency, though there may be noticeable lapses into non-standard forms.
                  </li>
                </ul>
              </div>
              ...
              {/* Not Classified */}
              <div className="rounded-lg border-2 border-border bg-muted p-5">
                <h3 className="text-lg font-bold text-muted-foreground">{tr(`Not Classified`)}</h3>
                <p className="mt-2 text-sm text-muted-foreground">
                  The student has not met the minimum requirements for a Pass. The presentation may
                  be incomplete, incoherent, or delivered without any formal structure. Standard
                  English is not sustained, and responses to questions are absent or inadequate.
                </p>
              </div>
            </div>
          </div>
        ...
        <section aria-labelledby="checklist-heading">
          <h2 id="checklist-heading" className="text-2xl font-bold text-foreground">
            Your Preparation Checklist
          </h2>
          <div className="mt-4 space-y-2 text-muted-foreground">
            <p>{tr(`Use this checklist to make sure you are fully prepared:`)}</p>
        ...
        <div className="mt-12 rounded-lg border bg-gradient-to-b from-primary/[0.06] to-transparent p-8 text-center">
          <h2 className="text-2xl font-bold">{tr(`Need a Topic?`)}</h2>
          <p className="mx-auto mt-2 max-w-lg text-muted-foreground">
            Browse our collection of 30+ presentation topic ideas, each with a full outline, key
            points to cover, and potential audience questions.
          </p>
          <Link
            href="/resources/spoken-language/topics"
