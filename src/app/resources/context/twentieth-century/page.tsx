      ...
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="mb-8">
          <div className="flex flex-wrap items-center gap-3 mb-2">
            <span className="rounded-full bg-muted px-3 py-1 text-xs font-bold text-foreground uppercase tracking-wider">
              1900 -- 1999
            </span>
        ...
        <Section id="timeline" title={tr(`Key Timeline`)} badge="1900-1999" defaultOpen>
          <div className="grid gap-0 sm:grid-cols-2">
            <div>
              <TimelineEvent
                year="1912"
                event="The Titanic sinks. Priestley sets An Inspector Calls in this year of Edwardian confidence."
              />
              <TimelineEvent
                year="1914"
                event="World War I begins. 17 million will die. The old class certainties begin to crack."
              />
              <TimelineEvent
                year="1917"
                event="The Russian Revolution. The Tsar is overthrown; communism takes hold in Russia."
              />
              <TimelineEvent
                year="1918"
                event="WWI ends. Women over 30 gain the vote. The old social order is permanently changed."
              />
              <TimelineEvent
                year="1928"
                event="All women over 21 gain the vote. Full universal suffrage in Britain."
              />
              <TimelineEvent
                year="1939"
                event="World War II begins. Britain faces existential threat from Nazi Germany."
              />
              <TimelineEvent
                year="1943"
                event="Orwell begins writing Animal Farm, a satire of the Russian Revolution and Stalin's betrayal."
              />
            </div>
            <div>
              <TimelineEvent
                year="1945"
                event="WWII ends. Labour wins a landslide. Priestley writes An Inspector Calls. The welfare state is born."
              />
              <TimelineEvent
                year="1948"
                event="The NHS is established. The welfare state promises care 'from cradle to grave.'"
              />
              <TimelineEvent
                year="1954"
                event="Golding publishes Lord of the Flies, reflecting post-war disillusionment with human nature."
              />
              <TimelineEvent
                year="1979"
                event="Margaret Thatcher becomes PM. A radical programme of privatisation and individualism begins."
              />
              <TimelineEvent
                year="1981"
                event="Toxteth and Brixton riots. High unemployment devastates working-class communities."
              />
              <TimelineEvent
                year="1983"
                event="Willy Russell's Blood Brothers opens in the West End, exploring class division in Thatcher's Britain."
              />
              <TimelineEvent
                year="1989"
                event="The Berlin Wall falls. The Cold War effectively ends."
              />
            </div>
          </div>
        </Section>
        ...
        <div className="mt-5 space-y-5">
          ...
          <Section id="class" title={tr(`The Changing Class System`)} colour="bg-primary">
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
              <p>
                ...
                major role: soldiers from different backgrounds fought side by side, and women
          ...
          <Section id="socialism" title={tr(`Socialism vs Capitalism`)} colour="bg-primary">
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
              <p>
                ...
                <strong> capitalism</strong> (private ownership, free markets, individual
                enterprise) and
                <strong> socialism</strong> (collective ownership, state intervention, equality).
              </p>
              <p>
                <strong>J.B. Priestley</strong> was a committed socialist. In An Inspector Calls,
                the Birling family represents capitalism at its worst: exploitation of workers,
                refusal of responsibility, obsession with profit and status. The Inspector
                represents Priestley&apos;s socialist message -- that &ldquo;we are members of one
          ...
          <Section id="eighties" title="1980s Britain & Thatcherism" colour="bg-primary">
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
              ...
              <p>
                ...
                direct contradiction of Priestley&apos;s message. She argued that people should look
                after themselves and their families, not depend on the state.
              </p>
              <p>
                The impact on working-class communities was devastating. The{' '}
                <strong>miners&apos; strike (1984-85)</strong> became a defining conflict. Pit
                closures, factory shutdowns, and mass unemployment ravaged northern England,
                Scotland, and Wales. Crime, poverty, and social deprivation increased in these
                areas.
              </p>
              <p>
          ...
          <Section id="postwar" title={tr(`Post-War Disillusionment`)} colour="bg-muted">
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
              <p>
                ...
                Holocaust, the dropping of atomic bombs on Hiroshima and Nagasaki, and the onset of
                the Cold War created deep anxiety about human nature.
              </p>
              <p>
                The civilised nations of Europe had committed -- or allowed -- unimaginable
                atrocities. The idea that humanity was inherently good, or that civilisation was a
          ...
          >
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
              <p>
                Remember: context is not a bolt-on paragraph. It should be{' '}
              ...
              <div className="mt-6 rounded-xl border border-primary/20 bg-primary/10 p-5">
                ...
                <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      &ldquo;Writing in [year], [author] would have been acutely aware
                      that...&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-accent" />
                    <span>
                      &ldquo;Priestley/Golding/Orwell/Russell uses [character/event] to
                      critique...&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-accent" />
                    <span>
                      &ldquo;The [year] audience would have recognised this as a reference
                      to...&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-accent" />
                    <span>
                      &ldquo;This reflects the post-war/Thatcher-era belief that...&rdquo;
                    </span>
                  </li>
                </ul>
              </div>
