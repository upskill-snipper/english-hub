      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-3 max-w-2xl text-muted-foreground">
            A comprehensive guide to every writing skill you need for the Cambridge IGCSE English
            Language examination, with format templates, worked examples, and marker-approved
            techniques.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16">
        ...
        <section id="directed" className="scroll-mt-16" aria-labelledby="directed-heading">
          ...
          <p className="mt-3 text-muted-foreground leading-relaxed">
            In directed writing, you must write in a specific format using ideas from a provided
            passage <strong>and</strong> your own ideas. Getting the format right is the foundation
            &mdash; markers will immediately notice if you use the wrong conventions.
          </p>
          ...
          <div className="mt-8 rounded-lg border border-border bg-card p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              Used when writing to someone you do not know, or in a professional or official
              capacity (e.g. to a headteacher, local council, editor of a newspaper, or company).
            </p>
            ...
            <div className="mt-4 rounded bg-muted p-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground font-mono">
                ...
                <p className="italic text-muted-foreground">
                  [Middle paragraphs: develop your points with detail and evidence]
                </p>
                <p className="italic text-muted-foreground">
                  [Closing paragraph: summarise and state what action you expect]
                </p>
                <p className="mt-4">
                  Yours sincerely,
                  <br />
            ...
            <div className="mt-4 rounded bg-accent/5 border border-accent/20 p-4">
              ...
              <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                <li>
                  &bull; Use &ldquo;Yours sincerely&rdquo; when you know the name; &ldquo;Yours
                  faithfully&rdquo; when you wrote &ldquo;Dear Sir/Madam&rdquo;
                </li>
                <li>
                  &bull; Formal register throughout &mdash; no slang, no contractions
                  (&ldquo;don&rsquo;t&rdquo; &rarr; &ldquo;do not&rdquo;)
                </li>
          ...
          <div className="mt-6 rounded-lg border border-border bg-card p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              Used when writing to a friend, family member, or someone you have a close relationship
              with.
            </p>
            ...
            <div className="mt-4 rounded bg-muted p-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground font-mono">
                ...
                <p className="italic text-muted-foreground">
                  [Body: share your thoughts, advice, news &mdash; conversational tone]
                </p>
                <p className="italic text-muted-foreground">
                  [Closing: look forward to hearing from them]
                </p>
                <p className="mt-4">
            ...
            <div className="mt-4 rounded bg-accent/5 border border-accent/20 p-4">
              ...
              <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                <li>
                  &bull; Warm, friendly tone &mdash; contractions, rhetorical questions, and
                ...
                <li>
                  &bull; Do NOT be so informal that your writing becomes sloppy &mdash; you are
                  still being assessed on language quality
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-lg border border-border bg-card p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              A factual, structured document presenting findings and recommendations to a specific
              audience (e.g. a headteacher, committee, or council).
            </p>
            ...
            <div className="mt-4 rounded bg-muted p-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground font-mono">
                ...
                <p className="italic text-muted-foreground">
                  [Present your evidence and observations under clear subheadings]
                </p>
            ...
            <div className="mt-4 rounded bg-accent/5 border border-accent/20 p-4">
              ...
              <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                <li>
                  &bull; Formal, impersonal tone &mdash; third person preferred (&ldquo;It was found
                  that&hellip;&rdquo;)
                </li>
                <li>
                  &bull; Use subheadings to organise &mdash; this is expected in report format
                </li>
          ...
          <div className="mt-6 rounded-lg border border-border bg-card p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              An engaging piece for a general readership, typically for a school or community
              publication.
            </p>
            ...
            <div className="mt-4 rounded bg-muted p-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground font-mono">
                ...
                <p className="italic text-muted-foreground">
                  [Body paragraphs: present information, opinions, expert views]
                </p>
                <p className="italic text-muted-foreground">
                  [Concluding paragraph: strong final statement or call to action]
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 rounded bg-accent/5 border border-accent/20 p-4">
              ...
              <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                <li>
                  &bull; Headline should be short, punchy, and engaging (alliteration, puns, or
                  wordplay can work well)
                </li>
                <li>
                  &bull; Engage the reader from the first sentence &mdash; a question, statistic, or
                  surprising statement
                </li>
                <li>&bull; Balance facts and opinions</li>
                <li>
                  &bull; Can include &ldquo;expert quotes&rdquo; or viewpoints from different
                  perspectives
                </li>
                <li>
                  &bull; Relatively formal but accessible language &mdash; write for a broad
                  audience
                </li>
              </ul>
            </div>
          ...
          <div className="mt-6 rounded-lg border border-border bg-card p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              Written to be delivered aloud to a specific audience. Must feel natural when spoken
              and use persuasive techniques.
            </p>
            ...
            <div className="mt-4 rounded bg-muted p-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground font-mono">
                ...
                <p className="italic text-muted-foreground">
                  [Body: develop 3&ndash;4 key arguments. Use rhetorical questions, tricolon,
                  anecdotes.]
                </p>
                <p className="italic text-muted-foreground">
            ...
            <div className="mt-4 rounded bg-accent/5 border border-accent/20 p-4">
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 sm:grid-cols-3">
                <span className="rounded bg-card px-2 py-1 text-xs text-muted-foreground shadow-md">
                ...
                <span className="rounded bg-card px-2 py-1 text-xs text-muted-foreground shadow-md">
                  Direct address (&ldquo;you&rdquo;, &ldquo;we&rdquo;)
                </span>
                <span className="rounded bg-card px-2 py-1 text-xs text-muted-foreground shadow-md">
                  Emotive language
                </span>
          ...
          <div className="mt-6 rounded-lg border border-border bg-card p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              A personal, reflective piece written from a character&rsquo;s perspective. The most
              personal of all the directed writing formats.
            </p>
            ...
            <div className="mt-4 rounded bg-muted p-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground font-mono">
                <p>[Date]</p>
                <p className="italic text-muted-foreground mt-2">
                  [Opening: set the scene or reflect on what has happened]
                </p>
                <p className="italic text-muted-foreground">
                  [Body: explore thoughts, feelings, and reactions in detail]
                </p>
                <p className="italic text-muted-foreground">
                  [Closing: look ahead, express hopes or fears, or reflect on lessons learned]
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 rounded bg-accent/5 border border-accent/20 p-4">
              ...
              <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                <li>
                  &bull; First person throughout &mdash; &ldquo;I&rdquo;, &ldquo;my&rdquo;,
                  &ldquo;me&rdquo;
                </li>
                <li>&bull; Deeply reflective &mdash; share honest thoughts and feelings</li>
                <li>
                  &bull; Can use informal language, incomplete sentences, and stream of
                  consciousness
                </li>
                <li>
                  &bull; Show emotional responses to events &mdash; not just what happened, but how
                  it felt
                </li>
                <li>
                  &bull; Still needs to be well-written and engaging despite the informal format
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-lg border border-border bg-card p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              Less common but sometimes appears. You write both the questions and the answers,
              typically for a magazine or newspaper feature.
            </p>
            ...
            <div className="mt-4 rounded bg-muted p-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground font-mono">
                ...
                <p className="mt-2">
                  <strong>Q:</strong> [Question from interviewer]
                </p>
                <p>
                  <strong>A:</strong> [Detailed answer from interviewee]
                </p>
                <p className="mt-2">
                  <strong>Q:</strong> [Follow-up question]
                </p>
                <p>
                  <strong>A:</strong> [Response with detail and personality]
                </p>
                <p className="italic text-muted-foreground mt-2">
                  [Continue for 5&ndash;7 questions]
                </p>
              </div>
            </div>
        ...
        <section id="summary" className="scroll-mt-16" aria-labelledby="summary-heading">
          ...
          <p className="mt-3 text-muted-foreground leading-relaxed">
            Summary writing is a core skill for the Cambridge IGCSE reading paper. You must
            demonstrate the ability to identify relevant information, select key points, and
            organise them into fluent, concise prose in your own words.
          </p>
            ...
            <div className="mt-6 space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
                    Read the question carefully. What exactly are you being asked to summarise?
                    Underline the focus words. Then go through the passage and underline or
                    highlight every piece of information that is relevant to that specific focus.
                  </p>
                  <div className="mt-2 rounded bg-card p-3 text-xs text-muted-foreground">
                    <strong>Tip:</strong> Number each relevant point as you find it. Aim for
                    12&ndash;15 points. More points = more content marks.
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                    ...
                    <li>
                      &bull; Examples or illustrations (you want the main idea, not the example)
                    </li>
                    <li>&bull; Only loosely relevant to the question focus</li>
                  </ul>
                  <div className="mt-2 rounded bg-card p-3 text-xs text-muted-foreground">
                    <strong>Tip:</strong> If two points are very similar, combine them into one
                    concise point.
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
                    Group related points together and decide on a logical order. Then write your
                    summary in <strong>continuous prose</strong>
                    (not bullet points), using your own words. Link your points with appropriate
                    connectives:
                  </p>
        ...
        <section id="narrative" className="scroll-mt-16" aria-labelledby="narrative-heading">
          ...
          <p className="mt-3 text-muted-foreground leading-relaxed">
            Narrative writing tells a story. For Cambridge IGCSE, you need to demonstrate control of
            plot, character, setting, and language to create an engaging piece of creative writing.
          </p>
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-xs italic text-muted-foreground">
                &ldquo;The glass shattered. Before I could move, a hand grabbed my shoulder.&rdquo;
              </p>
            </div>
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-xs italic text-muted-foreground">
                &ldquo;The mist clung to the river like a shroud, thick and unrelenting, swallowing
                the last traces of daylight.&rdquo;
              </p>
            </div>
            <div className="rounded-lg border border-border p-4">
              <p className="text-sm font-semibold text-primary">Dialogue</p>
              <p className="mt-1 text-xs text-muted-foreground">
                Open with a piece of speech that immediately reveals character or creates intrigue.
              </p>
              <p className="mt-2 text-xs italic text-muted-foreground">
                &ldquo;&lsquo;Whatever you do,&rsquo; she whispered, &lsquo;don&rsquo;t look behind
                you.&rsquo;&rdquo;
              </p>
            </div>
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-xs italic text-muted-foreground">
                &ldquo;If I had known what that single phone call would lead to, I would never have
                answered.&rdquo;
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
                Drop subtle hints about what will happen later. This creates suspense and shows
                sophistication in your planning.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
                ...
                realisation or change; an ambiguous ending that leaves the reader thinking; or a
                single powerful image that lingers.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="descriptive" className="scroll-mt-16" aria-labelledby="descriptive-heading">
          ...
          <p className="mt-3 text-muted-foreground leading-relaxed">
            Descriptive writing is about creating a vivid, immersive experience for the reader.
            There is <strong>no plot</strong> &mdash; the entire focus is on using language to bring
            a scene, person, or place to life.
          </p>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Even without a plot, your description needs structure. Try one of these approaches:
          </p>
          ...
          <div className="mt-4 rounded-lg border border-border bg-card p-5">
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded border border-accent text-xs text-accent">
                  &#10003;
                </span>
