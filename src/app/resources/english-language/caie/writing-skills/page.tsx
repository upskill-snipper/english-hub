    ...
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16">
        ...
        <section id="directed" className="scroll-mt-16" aria-labelledby="directed-heading">
          ...
          <div className="mt-8 rounded-lg border border-gray-200 bg-white p-6">
            ...
            <div className="mt-4 rounded bg-gray-50 p-4">
              <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-3">Template</p>
              <div className="space-y-2 text-sm text-gray-700 font-mono">
                ...
                <p className="italic text-gray-400 mt-2">[Subject line &mdash; optional but useful]</p>
                <p className="italic text-gray-400 mt-2">[Opening paragraph: state your purpose clearly]</p>
                <p className="italic text-gray-400">[Middle paragraphs: develop your points with detail and evidence]</p>
                <p className="italic text-gray-400">[Closing paragraph: summarise and state what action you expect]</p>
          ...
          <div className="mt-6 rounded-lg border border-gray-200 bg-white p-6">
            ...
            <div className="mt-4 rounded bg-gray-50 p-4">
              ...
              <div className="space-y-2 text-sm text-gray-700 font-mono">
                ...
                <p className="italic text-gray-400 mt-2">[Opening: reference to shared experience or reason for writing]</p>
                <p className="italic text-gray-400">[Body: share your thoughts, advice, news &mdash; conversational tone]</p>
                <p className="italic text-gray-400">[Closing: look forward to hearing from them]</p>
          ...
          <div className="mt-6 rounded-lg border border-gray-200 bg-white p-6">
            ...
            <div className="mt-4 rounded bg-gray-50 p-4">
              ...
              <div className="space-y-2 text-sm text-gray-700 font-mono">
                ...
                <p className="italic text-gray-400">[State the purpose of the report]</p>
                <p className="mt-2 font-bold">2. Findings</p>
                <p className="italic text-gray-400">[Present your evidence and observations under clear subheadings]</p>
                <p className="mt-2 font-bold">3. Recommendations</p>
                <p className="italic text-gray-400">[Suggest actions based on your findings]</p>
                <p className="mt-2 font-bold">4. Conclusion</p>
                <p className="italic text-gray-400">[Brief summary of key points]</p>
              </div>
            </div>
          ...
          <div className="mt-6 rounded-lg border border-gray-200 bg-white p-6">
            ...
            <div className="mt-4 rounded bg-gray-50 p-4">
              ...
              <div className="space-y-2 text-sm text-gray-700 font-mono">
                ...
                <p>By [Your name]</p>
                <p className="italic text-gray-400 mt-2">[Hook opening &mdash; grab the reader&rsquo;s attention immediately]</p>
                <p className="italic text-gray-400">[Body paragraphs: present information, opinions, expert views]</p>
                <p className="italic text-gray-400">[Concluding paragraph: strong final statement or call to action]</p>
              </div>
            </div>
          ...
          <div className="mt-6 rounded-lg border border-gray-200 bg-white p-6">
            ...
            <div className="mt-4 rounded bg-gray-50 p-4">
              ...
              <div className="space-y-2 text-sm text-gray-700 font-mono">
                ...
                <p className="italic text-gray-400 mt-2">[Opening: introduce yourself and your topic. Hook the audience.]</p>
                <p className="italic text-gray-400">[Body: develop 3&ndash;4 key arguments. Use rhetorical questions, tricolon, anecdotes.]</p>
                <p className="italic text-gray-400">[Conclusion: powerful closing statement or call to action.]</p>
            ...
            <div className="mt-4 rounded bg-accent/5 border border-accent/20 p-4">
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 sm:grid-cols-3">
                <span className="rounded bg-white px-2 py-1 text-xs text-gray-700 shadow-sm">Rhetorical questions</span>
                <span className="rounded bg-white px-2 py-1 text-xs text-gray-700 shadow-sm">Rule of three (tricolon)</span>
                <span className="rounded bg-white px-2 py-1 text-xs text-gray-700 shadow-sm">Repetition / Anaphora</span>
                <span className="rounded bg-white px-2 py-1 text-xs text-gray-700 shadow-sm">Direct address (&ldquo;you&rdquo;, &ldquo;we&rdquo;)</span>
                <span className="rounded bg-white px-2 py-1 text-xs text-gray-700 shadow-sm">Emotive language</span>
                <span className="rounded bg-white px-2 py-1 text-xs text-gray-700 shadow-sm">Personal anecdotes</span>
                <span className="rounded bg-white px-2 py-1 text-xs text-gray-700 shadow-sm">Imperatives</span>
                <span className="rounded bg-white px-2 py-1 text-xs text-gray-700 shadow-sm">Statistics / facts</span>
                <span className="rounded bg-white px-2 py-1 text-xs text-gray-700 shadow-sm">Inclusive pronouns</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-lg border border-gray-200 bg-white p-6">
            ...
            <div className="mt-4 rounded bg-gray-50 p-4">
              ...
              <div className="space-y-2 text-sm text-gray-700 font-mono">
                <p>[Date]</p>
                <p className="italic text-gray-400 mt-2">[Opening: set the scene or reflect on what has happened]</p>
                <p className="italic text-gray-400">[Body: explore thoughts, feelings, and reactions in detail]</p>
                <p className="italic text-gray-400">[Closing: look ahead, express hopes or fears, or reflect on lessons learned]</p>
              </div>
            </div>
          ...
          <div className="mt-6 rounded-lg border border-gray-200 bg-white p-6">
            ...
            <div className="mt-4 rounded bg-gray-50 p-4">
              ...
              <div className="space-y-2 text-sm text-gray-700 font-mono">
                ...
                <p className="italic text-gray-400 mt-2">[Continue for 5&ndash;7 questions]</p>
              </div>
            </div>
        ...
        <section id="summary" className="scroll-mt-16" aria-labelledby="summary-heading">
          <h2 id="summary-heading" className="text-2xl font-bold text-gray-900">
          ...
          <div className="mt-8 rounded-lg border-2 border-primary/20 bg-primary/5 p-6">
            ...
            <div className="mt-6 space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">Identify</h4>
                  ...
                  <div className="mt-2 rounded bg-white p-3 text-xs text-gray-600">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">Select</h4>
                  <p className="mt-1 text-sm text-gray-700 leading-relaxed">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">Organise</h4>
                  <p className="mt-1 text-sm text-gray-700 leading-relaxed">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-gray-200 bg-white p-5">
              ...
              <p className="text-sm font-semibold text-gray-900">Content Marks</p>
              <p className="mt-2 text-sm text-gray-700 leading-relaxed">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-5">
              ...
              <p className="text-sm font-semibold text-gray-900">Writing Quality Marks</p>
              <p className="mt-2 text-sm text-gray-700 leading-relaxed">
        ...
        <section id="narrative" className="scroll-mt-16" aria-labelledby="narrative-heading">
          <h2 id="narrative-heading" className="text-2xl font-bold text-gray-900">
            Narrative Writing
          </h2>
          <p className="mt-3 text-gray-700 leading-relaxed">
            ...
            <div className="rounded-lg border border-gray-200 p-4">
              ...
              <div className="mt-2 grid gap-2 sm:grid-cols-2">
                <div className="rounded bg-warn-50 p-2">
                  ...
                  <p className="text-xs text-gray-600">&ldquo;He was nervous.&rdquo;</p>
                </div>
                <div className="rounded bg-success-50 p-2">
                  <p className="text-xs font-semibold text-success-700">Showing (strong)</p>
                  <p className="text-xs text-gray-600">&ldquo;His fingers drummed against the desk. He checked his watch for the fifth time.&rdquo;</p>
                </div>
              </div>
            </div>
        ...
        <section id="descriptive" className="scroll-mt-16" aria-labelledby="descriptive-heading">
          <h2 id="descriptive-heading" className="text-2xl font-bold text-gray-900">
            Descriptive Writing
          </h2>
          <p className="mt-3 text-gray-700 leading-relaxed">
