        ...
        <div className="mt-10 rounded-xl border border-border bg-card p-6 sm:p-8">
          ...
          <ul className="mt-4 space-y-3 text-muted-foreground">
            <li className="flex gap-3">
              ...
              <span>
                <strong>Read widely.</strong> The best way to improve both your
                reading analysis and your writing is to read fiction and
                non-fiction regularly. Pay attention to how professional writers
                use language.
              </span>
            </li>
            <li className="flex gap-3">
              ...
              <span>
                <strong>Practise under timed conditions.</strong> Time management
                is one of the biggest reasons students underperform. Use the
                recommended timings on each question and stick to them.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary/15 text-xs font-bold text-primary">
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong>Build a toolkit of techniques.</strong> You do not need
                to use every technique in every response, but you should be
                confident identifying and using at least 15-20 language devices.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary/15 text-xs font-bold text-primary">
              ...
              <span>
                <strong>Focus on analysis, not feature-spotting.</strong>{" "}
                Identifying a metaphor earns minimal credit. Explaining{" "}
                <em>why</em> the writer chose that metaphor and{" "}
