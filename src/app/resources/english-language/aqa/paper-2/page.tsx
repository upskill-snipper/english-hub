      ...
      <div className="mx-auto max-w-5xl px-4 py-10 space-y-6">
        ...
        <div className="rounded-xl border border-primary/20 bg-primary/10 p-6 sm:p-8">
          ...
          <p className="mt-3 text-muted-foreground">
            Paper 2 tests your ability to <strong>read and compare</strong> two non-fiction texts
            (one from the 19th century and one from the 21st century, or one from the 20th century
            and one from the 21st century) and to produce a piece of{' '}
            <strong>writing for real purposes</strong>. The texts will be linked by theme.
          </p>
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-primary/20 bg-card p-4">
              <h3 className="font-bold text-primary">{tr(`Section A: Reading`)}</h3>
              <p className="mt-1 text-sm text-muted-foreground">
                4 questions on two linked non-fiction texts &middot; 40 marks &middot; recommended 1
                hour
              </p>
            </div>
            <div className="rounded-lg border border-primary/20 bg-card p-4">
        ...
        {/* Q1 */}
        <Section title={tr(`Question 1: Choose four true statements (4 marks)`)}>
          <h3 className="font-bold text-primary">{tr(`What the question asks`)}</h3>
          <p>
            You are given eight statements about <strong>Source A</strong> (one of the two texts,
            usually the 21st-century one). You must shade the boxes next to the{' '}
            <strong>four</strong> statements that are true according to the text.
          </p>
          ...
          <ul className="ml-5 list-disc space-y-2">
            ...
            <li>
              Go through each statement one at a time and check it against the text. Be precise
              &mdash; a statement might be <em>almost</em> true but contain a subtle inaccuracy.
            </li>
            <li>
              {tr(
                `If you shade more than four boxes, you will receive zero marks. Make sure you only select exactly four.`,
              )}
            </li>
            <li>
              This is the easiest question on the paper. Do not overthink it, but do not rush
              through it carelessly either.
            </li>
          </ul>
        ...
        {/* Q2 */}
        <Section title={tr(`Question 2: Summary and synthesis (8 marks)`)}>
          <h3 className="font-bold text-primary">{tr(`What the question asks`)}</h3>
          <p>
            You must write a <strong>summary</strong> of the differences (or similarities) between
            the two sources on a given topic. For example: &ldquo;Use details from both sources.
            Write a summary of the differences between the children&rsquo;s experiences of
            school.&rdquo;
          </p>
          <p className="mt-2">
            This assesses <strong>{tr(`Reading and retrieval (AO1)`)}</strong>: Identify and
            interpret explicit and implicit information and ideas. Select and synthesise evidence
          ...
          <ul className="ml-5 list-disc space-y-2">
            ...
            <li>
              Use connectives of comparison: &ldquo;In contrast,&rdquo; &ldquo;Similarly,&rdquo;
              &ldquo;Whereas,&rdquo; &ldquo;On the other hand,&rdquo; &ldquo;Both writers suggest
              that&hellip;&rdquo;
            </li>
            <li>
              <strong>{tr(`Infer, do not just describe.`)}</strong> The difference between Level 2
              and Level 4 is inference. Do not just say what each text says; explain what this{' '}
              <em>suggests</em> about the writers&rsquo; experiences or attitudes.
            </li>
            <li>
              You do not need to analyse language here &mdash; that is Q3. Focus on{' '}
              <strong>what</strong> is said, not <strong>how</strong> it is said.
            </li>
          </ul>
          ...
          <div className="rounded-lg bg-muted p-4 text-sm">
            <p>
              Both writers present differing attitudes to city life. In Source A, the writer
              describes London as &ldquo;suffocating&rdquo; and recalls feeling &ldquo;trapped by
              the noise and the crowds,&rdquo; suggesting that urban living was an oppressive,
              overwhelming experience. In contrast, the writer of Source B celebrates the
              &ldquo;electric energy&rdquo; of the city and explains that &ldquo;every corner
              offered a new possibility,&rdquo; implying that the city represented opportunity and
              excitement rather than confinement.
            </p>
          </div>
        </Section>

        {/* Q3 */}
        <Section title={tr(`Question 3: How does the writer use language...? (12 marks)`)}>
          <h3 className="font-bold text-primary">{tr(`What the question asks`)}</h3>
          <p>
            This is similar to Paper 1 Question 2, but it is worth <strong>12 marks</strong> (not 8)
            and focuses on <strong>one source only</strong> (usually Source B, the older text). You
            are asked how the writer uses language to achieve a specific effect (e.g., to describe a
            place, to convey their feelings).
          </p>
          <p className="mt-2">
            This assesses <strong>{tr(`Language and structure analysis (AO2)`)}</strong>: Explain,
            comment on and analyse how writers use language and structure to achieve effects and
            influence readers.
          </p>
          ...
          <ul className="ml-5 list-disc space-y-2 mt-2">
            ...
            <li>
              ...
              archaic quality of the language contributes to the tone.
            </li>
          </ul>
          ...
          <ul className="ml-5 list-disc space-y-2 mt-2">
            ...
            <li>
              {tr(
                `Look for rhetorical devices common in Victorian non-fiction: tricolon (lists of three), direct address, emotive language, religious references, appeals to morality.`,
              )}
            </li>
            <li>
              Consider the social and historical context. A 19th-century text about poverty, for
              example, was written in a society with very different attitudes to social welfare.
            </li>
            <li>
              Comment on the formality of the register and what this tells us about the
              writer&rsquo;s purpose and intended audience.
            </li>
          </ul>
        </Section>
        ...
        {/* Q4 */}
        <Section
          title={tr(`Question 4: Compare how the two writers convey their perspectives (16 marks)`)}
        >
          <h3 className="font-bold text-primary">{tr(`What the question asks`)}</h3>
          <p>
            You must compare the <strong>methods</strong> (language and structural techniques) that
            the two writers use to convey their viewpoints or perspectives on a shared topic. You
            need to refer to both sources and comment on both{' '}
            <strong>similarities and differences</strong>.
          </p>
          <p className="mt-2">
            This assesses <strong>{tr(`Comparing writers (AO3)`)}</strong>: Compare writers&rsquo;
          ...
          <h3 className="mt-4 font-bold text-primary">{tr(`How to structure your answer`)}</h3>
          <p>
            You can use either an <strong>alternating</strong> or a <strong>block</strong>{' '}
            structure. The alternating structure (comparing within each paragraph) is generally more
            effective:
          </p>

          <div className="mt-3 rounded-lg border border-border p-4">
            <h4 className="font-bold text-accent">{tr(`Alternating structure (recommended)`)}</h4>
            ...
            <ul className="mt-2 ml-5 list-disc space-y-1 text-sm">
              <li>
                ...
                analysis &rarr; Comment on overall effect of the difference/similarity
              </li>
            </ul>
          </div>

          <h3 className="mt-4 font-bold text-primary">{tr(`Comparison connectives`)}</h3>
          <div className="grid gap-4 mt-2 sm:grid-cols-2">
            <div>
              ...
              <p className="mt-1 text-sm">
                {tr(
                  `Similarly, Likewise, In the same way, Both writers, Equally, This is echoed by`,
                )}
              </p>
            </div>
            <div>
              ...
              <p className="mt-1 text-sm">
                {tr(
                  `In contrast, However, Whereas, On the other hand, Conversely, Unlike Source A`,
                )}
              </p>
            </div>
          </div>

          <h3 className="mt-4 font-bold text-primary">{tr(`Critical difference from Q2`)}</h3>
          <p>
            Q2 asks you to compare <strong>what</strong> the writers say (content/ideas). Q4 asks
            you to compare <strong>how</strong> they say it (methods/techniques). In Q4 you must
            analyse language, structure, and tone, not simply summarise the content.
          </p>
          ...
          <ul className="ml-5 list-disc space-y-2">
            ...
            <li>
              {tr(
                `Only comparing one aspect (e.g., only language) and ignoring structure, tone, and purpose.`,
              )}
            </li>
        ...
        {/* Q5 */}
        <Section title={tr(`Question 5: Persuasive / argumentative writing (40 marks)`)}>
          <h3 className="font-bold text-primary">{tr(`What the question asks`)}</h3>
          <p>
            You are given a statement related to the theme of the reading texts and asked to write
            your own text expressing your viewpoint. The task will specify a <strong>form</strong>{' '}
            (e.g., article, letter, speech, essay, leaflet) and a <strong>purpose</strong> (e.g., to
            argue, to persuade, to advise).
          </p>
          <p className="mt-2">
            This assesses <strong>{tr(`Content and organisation (AO5)`)}</strong> (24 marks: content
            and organisation) and <strong>{tr(`Technical accuracy (AO6)`)}</strong> (16 marks:
            technical accuracy). The marking guide is the same as Paper 1 Q5 but the writing genre
            is different.
          </p>

          <h3 className="mt-4 font-bold text-primary">{tr(`Understanding different forms`)}</h3>
          <div className="space-y-3 mt-2">
            <div className="rounded-lg border border-border p-4">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-1 text-sm">
                ...
                <li>{tr(`Can use a slightly more informal, journalistic tone`)}</li>
                <li>{tr(`Paragraphs tend to be shorter than in an essay`)}</li>
                <li>{tr(`May address the reader directly`)}</li>
              </ul>
            </div>
            <div className="rounded-lg border border-border p-4">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-1 text-sm">
                ...
                <li>
                  &ldquo;Yours faithfully&rdquo; (if you used Sir/Madam) or &ldquo;Yours
                  sincerely&rdquo; (if you used a name)
                </li>
                <li>{tr(`Formal register throughout`)}</li>
                <li>{tr(`State the purpose of your letter in the opening paragraph`)}</li>
              </ul>
            </div>
            <div className="rounded-lg border border-border p-4">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-1 text-sm">
                ...
                <li>
                  {tr(
                    `Consider the spoken quality: vary sentence length, use pauses (short sentences/paragraphs), build to a powerful conclusion`,
                  )}
                </li>
                <li>{tr(`End with a call to action or a memorable final statement`)}</li>
              </ul>
            </div>
            <div className="rounded-lg border border-border p-4">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-1 text-sm">
                ...
                <li>{tr(`Conclusion that summarises and reinforces your main argument`)}</li>
              </ul>
            </div>
          </div>

          <h3 className="mt-4 font-bold text-primary">{tr(`Persuasive techniques to use`)}</h3>
          <p>
          ...
          <ul className="ml-5 list-disc space-y-2 mt-2">
            ...
            <li>
              <strong>F &mdash; Facts (or statistics):</strong> &ldquo;According to recent research,
              73% of teenagers report feeling stressed about exams.&rdquo; (You can make these up in
              the exam.)
            </li>
            <li>
              <strong>O &mdash; Opinions (presented as facts):</strong> &ldquo;It is undeniable
              that&hellip;&rdquo;
            </li>
            <li>
              <strong>R &mdash; Rhetorical questions:</strong> &ldquo;How can we, as a society,
              continue to ignore this?&rdquo;
            </li>
            <li>
              <strong>E &mdash; Emotive language:</strong> &ldquo;Innocent children are being failed
              by a system that has abandoned them.&rdquo;
            </li>
            <li>
              <strong>S &mdash; Statistics:</strong> See Facts above.
            </li>
            <li>
              <strong>T &mdash; Tricolon (rule of three):</strong> &ldquo;We need action,
              accountability, and ambition.&rdquo;
            </li>
            <li>
              <strong>Anecdote:</strong> A brief personal story to make your argument relatable.
            </li>
            <li>
              <strong>{tr(`Direct address:`)}</strong> &ldquo;You know this is wrong.&rdquo;
            </li>
            <li>
              <strong>Counter-argument:</strong> &ldquo;Some may argue that&hellip;
              However,&hellip;&rdquo;
            </li>
            <li>
              <strong>Hyperbole:</strong> Deliberate exaggeration for emphasis.
            </li>
            <li>
              <strong>{tr(`Imperative verbs:`)}</strong> &ldquo;Consider this.&rdquo; &ldquo;Imagine
              a world where&hellip;&rdquo;
            </li>
          </ul>
          ...
          <ol className="ml-5 list-decimal space-y-2 mt-2">
            ...
            <li>
              Plan a strong opening (hook) and a powerful conclusion (call to action or memorable
              statement).
            </li>
          ...
          <h3 className="mt-4 font-bold text-primary">
            {tr(`Example opening (article, Grade 8-9)`)}
          </h3>
          <div className="rounded-lg bg-muted p-4 text-sm">
            <p className="font-bold text-foreground">
              Screen time is rotting our children&rsquo;s brains &mdash; and we are handing them the
              device
            </p>
            <p className="mt-2 italic">
              Picture this: a family sitting around the dinner table. Nobody is talking. Four faces,
              four screens, four separate worlds colliding in silence. Sound familiar? If it does,
              you are not alone &mdash; and that, frankly, is the problem. We have sleepwalked into
              a digital dependency so profound that the average British teenager now spends more
              time staring at a phone than they spend in the classroom. The question is no longer
              whether screen time is harmful. The question is whether we have the courage to do
              anything about it.
            </p>
          </div>
          ...
          <ul className="ml-5 list-disc space-y-2">
            ...
            <li>
              {tr(
                `Not taking a clear position. Sitting on the fence earns fewer marks than a well-argued viewpoint.`,
              )}
            </li>
            <li>
              {tr(`Overusing one technique (e.g., rhetorical questions in every paragraph).`)}
            </li>
            <li>
              {tr(
        ...
        <Section title={tr(`Key differences between Paper 1 and Paper 2`)}>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border text-left text-muted-foreground">
