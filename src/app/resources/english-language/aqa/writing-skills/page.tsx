    ...
    <>
      ...
      <section className="bg-gradient-to-br from-primary to-primary-600 px-4 py-16 text-white sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/90">
            Everything you need to craft high-quality writing in both Paper 1
            and Paper 2. Sentence structures, paragraph techniques, vocabulary,
            punctuation, and complete checklists.
          </p>
        </div>
      </section>
      ...
      <nav className="mx-auto max-w-5xl px-4 pt-6" aria-label="Breadcrumb">
        <ol className="flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li className="text-primary font-medium">Writing Skills</li>
        </ol>
      </nav>
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 space-y-6">
        ...
        <Section title="Sentence structures" defaultOpen>
          ...
          <div className="mt-4 space-y-4">
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-sm">
                <strong>When to use:</strong> For impact, emphasis, or dramatic
                effect. A short simple sentence after several long ones creates
                a sudden pause. Particularly effective for moments of tension,
                revelation, or finality.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-sm">
                <strong>When to use:</strong> To connect two equally important
                ideas. Useful for building a scene or showing cause and effect.
                Be careful not to over-rely on &ldquo;and&rdquo; &mdash; vary
                your conjunctions.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-1 text-sm">
                ...
                (which cannot stand alone as a sentence). Subordinate clauses
              ...
              <p className="mt-2 text-sm">
                <strong>When to use:</strong> To show the relationship between
                ideas (cause, contrast, time, condition). Placing the
                subordinate clause first creates a sense of anticipation.
                Complex sentences demonstrate sophistication and control.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-sm">
                <strong>When to use:</strong> For dramatic impact, to slow the
                pace, or to create emphasis. One-word sentences (&ldquo;Gone.&rdquo;
                &ldquo;Nothing.&rdquo; &ldquo;Darkness.&rdquo;) are particularly
                powerful at turning points in a narrative or description. Use
                sparingly &mdash; if every other sentence is a fragment, the
                effect is lost.
              </p>
            </div>
          </div>
          ...
          <h3 className="mt-6 font-bold text-primary">
            Sentence openers to vary your writing
          </h3>
          <p className="mt-2">
            Starting every sentence with &ldquo;The&rdquo; or &ldquo;I&rdquo;
            makes writing feel monotonous. Here are different ways to open a
            sentence:
          </p>
          <div className="overflow-x-auto mt-3">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                ...
                <tr><td className="py-2 pr-4 font-semibold">Prepositional phrase</td><td className="py-2 pr-4 italic">&ldquo;Beyond the rusted gate, the garden lay in ruins.&rdquo;</td></tr>
                <tr><td className="py-2 pr-4 font-semibold">Subordinate clause</td><td className="py-2 pr-4 italic">&ldquo;Although he smiled, his eyes betrayed nothing.&rdquo;</td></tr>
                <tr><td className="py-2 pr-4 font-semibold">Simile / comparison</td><td className="py-2 pr-4 italic">&ldquo;Like a caged animal, she paced the room.&rdquo;</td></tr>
                <tr><td className="py-2 pr-4 font-semibold">Time connective</td><td className="py-2 pr-4 italic">&ldquo;Moments later, the sky erupted with colour.&rdquo;</td></tr>
                <tr><td className="py-2 pr-4 font-semibold">Pronoun</td><td className="py-2 pr-4 italic">&ldquo;It was the kind of silence that pressed against your skin.&rdquo;</td></tr>
              </tbody>
            </table>
          </div>
        </Section>
        ...
        <Section title="Paragraph structures">
          <h3 className="font-bold text-primary">PEEL paragraphs (for analytical writing)</h3>
          <p className="mt-2">
            When writing about texts in the reading section, PEEL is a useful
            framework:
          </p>
          <ul className="mt-2 ml-5 list-disc space-y-2">
            <li><strong>P &mdash; Point:</strong> Make a clear point that answers the question.</li>
            <li><strong>E &mdash; Evidence:</strong> Provide a quotation or reference from the text.</li>
            <li><strong>E &mdash; Explain:</strong> Analyse the evidence. What technique is used? What are the connotations? What effect does it create?</li>
            <li><strong>L &mdash; Link:</strong> Link back to the question or to a wider theme.</li>
          </ul>

          <h3 className="mt-6 font-bold text-primary">Topic sentences</h3>
          <p className="mt-2">
            Every paragraph should open with a <strong>topic sentence</strong>{" "}
            that tells the reader what the paragraph is about. In creative
            writing, this can be more subtle (e.g., signalling a shift in time,
          ...
          <h3 className="mt-6 font-bold text-primary">Paragraph techniques for creative writing</h3>
          <ul className="mt-2 ml-5 list-disc space-y-2">
            <li>
              <strong>Shift paragraphs:</strong> Use a new paragraph to signal a
              change in time (&ldquo;Three hours later&hellip;&rdquo;), location
              (&ldquo;Downstairs,&hellip;&rdquo;), focus (from external
              description to internal thought), or mood.
            </li>
            <li>
              <strong>Single-sentence paragraphs:</strong> A paragraph
              containing just one sentence creates enormous emphasis. Use it for
              a moment of revelation, shock, or emotional weight.
            </li>
            <li>
              <strong>Discourse markers:</strong> Words and phrases that guide
              the reader through your writing: &ldquo;Meanwhile,&rdquo;
              &ldquo;In contrast,&rdquo; &ldquo;Despite this,&rdquo;
              &ldquo;As if in response,&rdquo; &ldquo;What followed was
              unexpected.&rdquo;
            </li>
            <li>
              <strong>Cyclical / circular structure:</strong> End your piece
              with an echo of the opening &mdash; the same image, phrase, or
              setting, but with a shift in meaning. This creates a satisfying
              sense of closure and structural sophistication.
            </li>
          </ul>
        </Section>
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-1 text-sm">
                ...
                compelled, reluctant, inevitable, conveyed, juxtaposed,
            ...
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-1 text-sm">
                ...
                dilapidated (not &ldquo;old&rdquo;), cacophony (not
                &ldquo;noise&rdquo;), languid (not &ldquo;slow&rdquo;),
                visceral (not &ldquo;strong&rdquo;), ephemeral (not
                &ldquo;short-lived&rdquo;). These demonstrate a sophisticated
                vocabulary but should be used naturally, not forced.
              </p>
            </div>
          </div>

          <h3 className="mt-6 font-bold text-primary">Vocabulary upgrade examples</h3>
          <div className="overflow-x-auto mt-3">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border text-left text-muted-foreground">
              ...
              <tbody className="divide-y divide-border">
                ...
                <tr><td className="py-2 pr-4">big</td><td className="py-2 pr-4">vast, imposing, sprawling, cavernous</td><td className="py-2 pr-4">Creates a more specific visual impression</td></tr>
                <tr><td className="py-2 pr-4">small</td><td className="py-2 pr-4">cramped, diminutive, narrow, confined</td><td className="py-2 pr-4">Suggests not just size but feeling and atmosphere</td></tr>
                <tr><td className="py-2 pr-4">scary</td><td className="py-2 pr-4">unnerving, sinister, foreboding, menacing</td><td className="py-2 pr-4">More specific shade of fear</td></tr>
                <tr><td className="py-2 pr-4">nice</td><td className="py-2 pr-4">pleasant, charming, idyllic, serene</td><td className="py-2 pr-4">Much more descriptive and precise</td></tr>
                <tr><td className="py-2 pr-4">old</td><td className="py-2 pr-4">weathered, ancient, dilapidated, decrepit</td><td className="py-2 pr-4">Implies condition, not just age</td></tr>
              </tbody>
            </table>
          </div>

          <div className="mt-4 rounded-lg border-l-4 border-warn-400 bg-warn-50 p-4 text-sm">
            <p className="font-bold text-warn-700">Warning: do not overdo it</p>
        ...
        <Section title="Opening techniques">
          ...
          <div className="mt-4 space-y-4">
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-sm">
                Drop the reader into the middle of the action. Creates immediate
                tension and curiosity. The reader wants to know what happened
            ...
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-sm">
                Immerses the reader in the world before introducing character or
            ...
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-sm">
                Creates immediate intrigue. The reader is thrown into a
                conversation without context, generating questions that propel
                them forward.
              </p>
            </div>
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-sm">
                Bold and dramatic. The isolation of a single word gives it
                enormous weight. Follow it with a longer sentence that expands
                on the idea.
              </p>
            </div>
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-sm">
                Engages the reader directly. The second person (&ldquo;you&rdquo;)
                creates intimacy. Works well for both creative and persuasive
                writing.
              </p>
            </div>
            <div className="rounded-lg border border-border p-4">
              ...
              <p className="mt-2 text-sm">
                Surprises the reader and subverts expectations. The unexpected
                combination of ideas creates intrigue and signals a unique,
                personal voice.
              </p>
            </div>
          </div>
        ...
        <Section title="Descriptive writing checklist (Paper 1 Q5)">
          <p>
            Use this checklist before and after writing your descriptive piece
            to make sure you have covered all the bases:
          </p>

          <div className="mt-4 space-y-3">
            <h3 className="font-bold text-primary">Content and organisation</h3>
        ...
        <Section title="Narrative writing checklist (Paper 1 Q5)">
          <p>
            If you choose the narrative option, use this checklist:
          </p>
