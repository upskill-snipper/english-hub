...
const HERO_STATS = [
  {
    labelKey: 'resources.eng_lang.stat.boards',
    value: '5',
    subKey: 'resources.eng_lang.stat.boards_sub',
  },
  {
    labelKey: 'resources.eng_lang.stat.papers',
    value: '10+',
    subKey: 'resources.eng_lang.stat.papers_sub',
  },
  {
    labelKey: 'resources.eng_lang.stat.marks',
    value: '740+',
    subKey: 'resources.eng_lang.stat.marks_sub',
  },
  {
    labelKey: 'resources.eng_lang.stat.skills',
    value: '6',
    subKey: 'resources.eng_lang.stat.skills_sub',
  },
]
...
const RESOURCE_LINKS = [
  {
    ...
    description:
      'Master creative, persuasive, and analytical writing techniques with step-by-step guides.',
  ...
  },
  {
    ...
    description:
      'Learn every language device from metaphor to anaphora with clear examples and effects.',
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          <p className="text-sm font-semibold uppercase tracking-widest text-primary">
            {t('resources.eng_lang.hub.eyebrow')}
          </p>
          <h1 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
            {t('resources.eng_lang.hub.h1')}
          </h1>
          {boardConfig && (
            <div className="mt-4 flex justify-center">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-semibold text-primary">
                {t('resources.eng_lang.hub.for_board')} {boardConfig.shortName}
              </span>
            </div>
          )}
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            {t('resources.eng_lang.hub.subtitle')}
          </p>
          ...
          <div className="mx-auto mt-10 grid max-w-3xl grid-cols-2 gap-4 sm:grid-cols-4">
            {HERO_STATS.map((stat) => (
              <div key={stat.labelKey} className="rounded-xl border bg-card px-4 py-4">
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">{t(stat.subKey)}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            ...
            >
              {t('resources.eng_lang.choose_board')}
            </a>
          </div>
        </div>
      </section>
