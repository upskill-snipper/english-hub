    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Everything you need to ace your Edexcel English Language GCSE. Two papers, full
            marking-guide breakdowns, 30+ techniques, writing masterclasses, and grade boundary data
              ...
              <tbody className="divide-y divide-border">
                <tr className="hover:bg-muted">
                  <td className="px-4 py-3 font-medium text-foreground">
                    Paper 1 &mdash; Fiction &amp; Imaginative Writing
                  </td>
                ...
                <tr className="hover:bg-muted">
                  <td className="px-4 py-3 font-medium text-foreground">
                    Paper 2 &mdash; Non-Fiction &amp; Writing for Real Purposes
                  </td>
      ...
      <section className="px-4 py-14 sm:py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mx-auto mt-3 max-w-xl text-center text-muted-foreground">
            Click any section below to access full study notes, marking guides, example responses,
            and exam tips.
          </p>
      ...
      <section className="bg-muted px-4 py-14">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mx-auto mt-3 max-w-xl text-center text-muted-foreground">
            Every question tests specific skills (called Assessment Objectives, or AOs, in the
            specification). Understanding them helps you know exactly what markers want.
          </p>
