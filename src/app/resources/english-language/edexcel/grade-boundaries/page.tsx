      ...
      <div className="mx-auto max-w-5xl px-4 py-10 space-y-6">
            ...
            <div className="rounded-lg border-l-4 border-success-500 bg-success-50/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                ...
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Judicious, precisely selected quotations seamlessly embedded in analysis.`,
                    )}
                  </li>
                  <li>
                  ...
                  <li>
                    {tr(
                      `Consistently engages with connotations, nuance, and the subtleties of language and structure.`,
                    )}
                  </li>
                  <li>
                    Synthesis of ideas across texts (Paper 2) is insightful and well-sustained.
                  </li>
                </ul>
                <p className="mt-3">
                ...
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Varied, inventive structural choices that shape meaning (e.g., cyclical structure, deliberate shifts in pace or focus).`,
                    )}
                  </li>
                  <li>A distinctive, authentic voice that feels crafted, not formulaic.</li>
                  <li>
                    A full range of punctuation used accurately and for deliberate effect
                    (semicolons, colons, ellipsis, dashes).
                  </li>
                  <li>
            ...
            <div className="rounded-lg border-l-4 border-primary/50 bg-primary/10/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                ...
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(`Some exploration of alternative interpretations and layers of meaning.`)}
                  </li>
                </ul>
                <p className="mt-3">
                  <strong>Writing:</strong>
                ...
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Effective structural features that contribute to the overall effect and guide the reader.`,
                    )}
                  </li>
                  <li>{tr(`Wide range of sentence structures used deliberately for effect.`)}</li>
                  <li>
                    {tr(
                      `Mostly accurate spelling and punctuation with only minor, infrequent errors.`,
                    )}
                  </li>
                </ul>
              </div>
            ...
            <div className="rounded-lg border-l-4 border-primary bg-primary/10/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                ...
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>{tr(`Relevant quotations selected and commented on with some analysis.`)}</li>
                  <li>Subject terminology used, mostly accurately.</li>
                  <li>
                    A clear response to evaluation tasks with some personal engagement and
                    reasoning.
                  </li>
                  <li>
                    {tr(
                ...
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Paragraphs are used effectively with some structural awareness and deliberate organisation.`,
                    )}
                  </li>
                  <li>
                    {tr(
                      `Some variety in sentence structures, including compound and complex sentences.`,
                    )}
                  </li>
                  <li>
                    {tr(
            ...
            <div className="rounded-lg border-l-4 border-yellow-400 bg-yellow-500/10/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                ...
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Some appropriate references to the text, though not always well-chosen or fully explored.`,
                    )}
                  </li>
                  <li>
                    {tr(`Some subject terminology, not always accurate or used effectively.`)}
                  </li>
                  <li>
                    {tr(
                      `Some response to evaluation tasks, though may lack detail or sustained argument.`,
                    )}
                  </li>
                  <li>
                    {tr(
                      `May feature-spot (identify techniques without explaining their effect on the reader).`,
                    )}
                  </li>
                </ul>
                <p className="mt-3">
                ...
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>{tr(`Basic structural features (paragraphs, some variety in openings).`)}</li>
                  <li>
                    {tr(
            ...
            <div className="rounded-lg border-l-4 border-border bg-muted/50 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                ...
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Simple sentence forms; frequent errors in spelling and punctuation that hinder communication.`,
                    )}
                  </li>
                </ul>
              </div>
        ...
        <Section title="How to push your grade higher">
          <p>
            ...
            Edexcel English Language specification:
          </p>
            ...
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  ...
                  writing tasks in full. An unfinished Section B response is the most common reason
                  students miss a Grade 5.
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  ...
                  semicolons, colons, and dashes for deliberate effect.
                </li>
                <li>
                  <strong>Structure:</strong> Plan your creative writing. A clear structural journey
                  (e.g., calm &rarr; tension &rarr; climax &rarr; resolution) with deliberate
                  paragraph breaks shows organisation and control.
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-2 text-sm">
                <li>
                  ...
                  purpose and the text&rsquo;s context where relevant.
                </li>
                <li>
                  <strong>Paper 2 Q8 (language analysis):</strong> This 12-mark question rewards
                  depth. Analyse word-level choices, sentence-level patterns, and the cumulative
                  effect of the writer&rsquo;s language across the extract.
                </li>
                <li>
                ...
                <li>
                  ...
                  non-fiction builds a larger vocabulary, a better sense of style, and more
        ...
        <Section title={tr(`Marks per question at a glance`)}>
          <p>
            Understanding the mark allocation helps you plan your time and focus your revision. The
            Edexcel specification splits each paper into Section A (reading) and Section B
            (writing).
          </p>

          <div className="overflow-x-auto mt-4">
            <h3 className="font-bold text-primary mb-3">
              {tr(`Paper 1: Fiction and Imaginative Writing (1h 45m)`)}
            </h3>
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border text-left text-muted-foreground">
          ...
          <div className="overflow-x-auto mt-6">
            <h3 className="font-bold text-accent mb-3">
              {tr(`Paper 2: Non-Fiction and Writing for Real Purposes (2h 05m)`)}
            </h3>
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border text-left text-muted-foreground">
        ...
        {/* ── Key takeaways ─────────────────────────────────────────── */}
        <Section title={tr(`Key takeaways and quick targets`)}>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-border p-5">
              <h3 className="font-bold text-primary">{tr(`For a Grade 5 (Strong Pass)`)}</h3>
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                  Focus on getting full marks on the short-response questions, solid marks on Q4/Q8,
                  and a competent writing response
                </li>
              </ul>
            </div>
            <div className="rounded-lg border border-border p-5">
              <h3 className="font-bold text-accent">{tr(`For a Grade 7+`)}</h3>
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-accent" />
                  You need strong language analysis, a well-sustained evaluation on Paper 1, and
                  engaging, well-organised writing
                </li>
              </ul>
            </div>
            <div className="rounded-lg border border-border p-5">
              <h3 className="font-bold text-success">{tr(`For a Grade 9`)}</h3>
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-success" />
                  Top marks across all questions. Perceptive analysis, sophisticated writing,
            ...
            <div className="rounded-lg border border-warn-200 bg-warn-50 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  Grade boundaries change every year &mdash; aim <strong>above</strong> the boundary
                  to be safe
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-warn" />
        ...
        <div className="pt-4">
          ...
          >
            ...
            {t('study.lang.edexcel.back_long')}
          </Link>
        </div>
      </div>
