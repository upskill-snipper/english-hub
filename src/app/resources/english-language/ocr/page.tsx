        ...
        <section aria-labelledby="overview-heading">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              ...
              writing tasks. The qualification is assessed through two examined
              components, each worth 50% of the GCSE, plus a separately
              endorsed spoken language component.
            </p>
