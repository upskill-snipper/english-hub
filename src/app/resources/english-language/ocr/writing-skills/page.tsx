    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
            OCR-specific guidance for both transactional and creative writing. Learn what markers
            are looking for and how to hit the top band.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section aria-labelledby="markscheme-heading">
          <h2 id="markscheme-heading" className="text-2xl font-bold text-foreground">
            Understanding the OCR Writing Marking Guide
          </h2>
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              OCR assesses writing through two assessment objectives. Both are assessed in Paper 1
              (writing for real purposes) and Paper 2 (creative writing):
            </p>
        ...
        <section aria-labelledby="topband-heading">
          <h2 id="topband-heading" className="text-2xl font-bold text-foreground">
            What Does a Top-Band Response Look Like?
          </h2>
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Understanding the top-band descriptors tells you exactly what the marker is rewarding.
              Here is what separates a grade 8&ndash;9 response:
            </p>
        ...
        <section aria-labelledby="transactional-heading">
          <h2 id="transactional-heading" className="text-2xl font-bold text-foreground">
            Writing for Real Purposes (Paper 1, Section B)
          </h2>

          <div className="mt-6 space-y-6 text-muted-foreground leading-relaxed">
            <p>
              Writing for real purposes means writing for a real-world purpose and audience. You are
              communicating ideas, information, or a viewpoint in a specific form. The key to
              success is matching your writing precisely to the task requirements.
            </p>
              ...
              <div className="mt-4 space-y-3">
                <div className="rounded-lg border border-border bg-muted p-4">
                  ...
                  <p className="mt-1 text-sm italic text-muted-foreground">
                    &ldquo;Social media is the defining crisis of our generation &mdash; and we are
                    sleepwalking into disaster.&rdquo;
                  </p>
                </div>
                <div className="rounded-lg border border-border bg-muted p-4">
                  <p className="font-semibold text-foreground">2. Rhetorical question</p>
                  <p className="mt-1 text-sm italic text-muted-foreground">
                    &ldquo;When was the last time you looked up from your phone and truly noticed
                    the world around you?&rdquo;
                  </p>
                </div>
                <div className="rounded-lg border border-border bg-muted p-4">
                  <p className="font-semibold text-foreground">3. Anecdote</p>
                  <p className="mt-1 text-sm italic text-muted-foreground">
                    &ldquo;Last Tuesday, I watched a group of teenagers sitting together in a cafe.
                    Not one of them spoke. Every face was lit by a screen.&rdquo;
                  </p>
                </div>
                <div className="rounded-lg border border-border bg-muted p-4">
                  <p className="font-semibold text-foreground">4. Shocking statistic</p>
                  <p className="mt-1 text-sm italic text-muted-foreground">
                    &ldquo;According to recent research, the average teenager spends seven hours a
                    day on their phone. Seven hours. Almost a full working day.&rdquo;
                  </p>
                </div>
                <div className="rounded-lg border border-border bg-muted p-4">
                  <p className="font-semibold text-foreground">5. Contrast</p>
                  <p className="mt-1 text-sm italic text-muted-foreground">
                    &ldquo;Fifty years ago, children played in the streets until dark. Today, they
                    sit in their bedrooms, scrolling through a digital world that promises
                    connection but delivers isolation.&rdquo;
                  </p>
                </div>
                <div className="rounded-lg border border-border bg-muted p-4">
                  <p className="font-semibold text-foreground">6. Direct address</p>
                  <p className="mt-1 text-sm italic text-muted-foreground">
                    &ldquo;Imagine waking up tomorrow and your phone has disappeared. No
                    notifications. No messages. No feed to scroll. How would you feel?&rdquo;
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="rounded border border-border bg-muted p-3">
                  ...
                  <p className="mt-1 text-sm">
                    However, Conversely, On the other hand, Nevertheless
                  </p>
                </div>
                <div className="rounded border border-border bg-muted p-3">
                  <p className="text-xs font-semibold uppercase text-muted-foreground">
            ...
            <div>
              ...
              <ol className="ml-6 mt-3 list-decimal space-y-2">
                ...
                <li>
                  <strong>Concede</strong> a partial point if appropriate: &ldquo;While there is
                  some merit in this view&hellip;&rdquo;
                </li>
                <li>
                  <strong>Rebut</strong> with a stronger argument: &ldquo;However, this fails to
                  account for&hellip;&rdquo;
                </li>
              </ol>
              <div className="mt-3 rounded border border-accent/20 bg-primary/10 p-4">
                ...
                <p className="mt-2 text-sm italic text-primary">
                  &ldquo;Of course, some would argue that technology has enhanced communication,
                  allowing us to stay connected with loved ones across the globe. There is
                  undeniable truth in this. However, what we have gained in quantity of
                  communication, we have lost in quality. A quick text message will never replicate
                  the warmth of a face-to-face conversation, the nuance of a handwritten letter, or
                  the simple joy of sitting together in comfortable silence.&rdquo;
                </p>
              </div>
            </div>
          </div>
        ...
        <section aria-labelledby="creative-heading">
          ...
          <div className="mt-6 space-y-6 text-muted-foreground leading-relaxed">
            <p>
              Creative writing on Paper 2 tests your ability to write imaginatively. The marker is
              looking for crafted, deliberate writing that demonstrates control over language,
              structure, and tone.
            </p>
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                dialogue, sensory detail, and body language.
              </p>
              ...
              <div className="mt-4 space-y-4">
                <div className="rounded-lg border border-border bg-muted p-5">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Fronted adverbials add variety and can set the tone for the sentence.
                  </p>
                </div>

                <div className="rounded-lg border border-border bg-muted p-5">
                  <h4 className="font-semibold text-foreground">
                    Start with a present participle (-ing)
                  </h4>
                  <p className="mt-2 text-sm italic text-muted-foreground">
                ...
                <div className="rounded-lg border border-border bg-muted p-5">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Creates contrast and sophistication within a single sentence.
                  </p>
                </div>

                <div className="rounded-lg border border-border bg-muted p-5">
                  <h4 className="font-semibold text-foreground">
                    Use a one-word or short sentence for impact
                  </h4>
                  <p className="mt-2 text-sm italic text-muted-foreground">
                    &ldquo;Silence.&rdquo; / &ldquo;She ran.&rdquo; / &ldquo;Nothing.&rdquo;
                  </p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    After a long, descriptive sentence, a sudden short sentence creates dramatic
                    impact.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-border bg-muted p-5">
                  <h4 className="font-semibold text-foreground">
                    Use a colon to extend or explain
                  </h4>
                  <p className="mt-2 text-sm italic text-muted-foreground">
                    &ldquo;There was only one thing left to do: run.&rdquo;
                  </p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    A colon creates anticipation and delivers a punch at the end of the sentence.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-border bg-muted p-5">
                  ...
                  <p className="mt-2 text-sm italic text-muted-foreground">
                    &ldquo;The house was empty; the silence confirmed what she already knew.&rdquo;
                  </p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    Demonstrates sophisticated punctuation and creates a balanced, connected pair of
                    clauses.
                  </p>
                </div>
              </div>
            ...
            {/* Punctuation guide */}
            <div>
              <h3 className="text-xl font-semibold text-foreground">Punctuation for Effect</h3>
              <p className="mt-2">
                Accurate, varied punctuation is essential for technical accuracy. Here is how to use
                each mark correctly:
              </p>
              <div className="mt-3 space-y-3">
                ...
                <div className="rounded-lg border border-border bg-muted p-4">
                  ...
                  <p className="mt-1 text-sm">
                    Use sparingly. One well-placed exclamation mark is effective; five in a
                    paragraph is not. Reserve for genuine surprise, urgency, or emotion.
                  </p>
                </div>
                <div className="rounded-lg border border-border bg-muted p-4">
        ...
        <section aria-labelledby="proofread-heading">
          <h2 id="proofread-heading" className="text-2xl font-bold text-foreground">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            ...
            <ul className="ml-6 list-disc space-y-2">
              ...
              <li>
                Commas used correctly (not comma splices &mdash; two full sentences joined only by a
                comma)
              </li>
              <li>
                Homophones: their/there/they&rsquo;re, your/you&rsquo;re, its/it&rsquo;s,
                to/too/two, where/were/we&rsquo;re
              </li>
              <li>
                Subject-verb agreement: &ldquo;The group of students <em>was</em>&rdquo; not
                &ldquo;were&rdquo;
              </li>
              <li>
