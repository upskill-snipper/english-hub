...
const characters = [
  ...
  },
  {
    ...
    keyQuotes: ["'I've been afraid for about a week... and I can bear it no more'"],
  },
]
...
const keyQuotations = [
  ...
  {
    quote: 'I stood already committed to a profound duplicity of life',
    speaker: 'Jekyll (Chapter 10)',
    analysis:
...
const essayQuestions = [
  ...
  {
    question: 'How does Stevenson present Hyde as a frightening outsider?',
    plan: [
  ...
  {
    question: 'How does Stevenson explore the importance of reputation in the novella?',
    plan: [
    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Robert Louis Stevenson &middot; Published 1886 &middot; Gothic Novella
          </p>
        </div>
      </section>
      ...
      <section className="bg-amber-500/10 border-b border-amber-500/30 px-4 py-6">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-lg font-bold text-amber-800">AQA Exam Format: {examInfo.paper}</h2>
          <div className="mt-3 grid gap-4 sm:grid-cols-3">
            <div className="rounded-lg bg-card p-4 border border-amber-500/30">
              <p className="text-xs font-semibold uppercase tracking-wider text-amber-700">
                Section &amp; Marks
              </p>
              <p className="mt-1 text-sm font-bold text-foreground">{examInfo.section}</p>
          ...
          <div className="mt-4">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {examInfo.assessmentObjectives.map((ao) => (
                <div key={ao.code} className="rounded-lg bg-card p-4 border border-amber-500/30">
                  <div className="flex items-baseline gap-2">
                    <span className="text-sm font-bold text-primary">{ao.code}</span>
                    <span className="text-xs font-medium text-amber-700">{ao.marks}</span>
                  </div>
                  <p className="mt-1 text-sm text-muted-foreground">{ao.description}</p>
                  <p className="mt-2 text-xs text-muted-foreground italic">Tip: {ao.tip}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="plot" className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        <h2 className="text-2xl font-bold text-foreground">Plot Summary: Chapter by Chapter</h2>
        <p className="mt-2 text-muted-foreground">
          The novella is structured as a mystery, with the truth about Jekyll and Hyde concealed
          until the final two chapters. Stevenson uses multiple narrators and delayed revelation to
          mirror the theme of secrecy.
        </p>

        <div className="mt-8 space-y-4">
          {chapterSummaries.map((ch) => (
            <div key={ch.chapter} className="rounded-lg border border-border p-4">
              <p className="text-xs font-semibold text-accent uppercase tracking-wider">
                {ch.chapter}
              </p>
              <h3 className="mt-1 text-sm font-bold text-primary">{ch.title}</h3>
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">{ch.summary}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="characters" className="bg-muted px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-2 text-muted-foreground">
            Understanding characters as constructs - Stevenson made deliberate choices about how to
            present each character to convey meaning.
          </p>
      ...
      <section id="themes" className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        <h2 className="text-2xl font-bold text-foreground">Key Themes (AQA Focus)</h2>
        <p className="mt-2 text-muted-foreground">
          Themes are the big ideas Stevenson explores through plot, characters, and language. AQA
          questions will always focus on one of these themes.
        </p>
        ...
        <div className="mt-8 space-y-8">
          {themes.map((theme) => (
            <div key={theme.title} className={`rounded-xl border p-6 ${theme.colour}`}>
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed">{theme.analysis}</p>
              <div className="mt-4">
      ...
      <section id="quotations" className="bg-primary/10 px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-2 text-muted-foreground">
            Learn these quotations and their analysis. In the exam (no extract provided), you must
            quote from memory - embed short phrases rather than long passages.
          </p>
      ...
      <section id="context" className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <p className="mt-2 text-muted-foreground">
          Context is worth 6 marks. Integrate it into your analysis rather than writing separate
          &quot;context paragraphs.&quot; The best responses use context to deepen their
          interpretation of language and themes.
        </p>
      ...
      <section id="essays" className="bg-muted px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-2xl font-bold text-foreground">Essay Planning: Common Questions</h2>
          <p className="mt-2 text-muted-foreground">
            Practise planning essays in 5 minutes. Remember: no extract is provided for this
            question, so you must refer to the whole novella from memory. These are the most
