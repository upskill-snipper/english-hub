...
const modernTexts = [
  {
    ...
    keyThemes: ['Social Responsibility', 'Class', 'Gender', 'Age and Generation', 'Power'],
    examTip:
  ...
  },
  {
    ...
    keyThemes: ['Civilisation vs Savagery', 'Power', 'Fear', 'Loss of Innocence', 'Violence'],
    examTip:
  ...
  },
  {
    ...
    keyThemes: ['Power and Corruption', 'Propaganda', 'Class', 'Education', 'Revolution'],
    examTip:
  ...
  },
  {
    ...
    keyThemes: ['Social Class', 'Nature vs Nurture', 'Superstition', 'Fate', 'Motherhood'],
    examTip:
  ...
  },
  {
    ...
    keyThemes: ['Education', 'History and Truth', 'Sexuality', 'Class', 'Growing Up'],
    examTip:
  ...
  },
  {
    ...
    keyThemes: ['Class', 'Race', 'Gender', 'Motherhood', 'Identity'],
    examTip:
  ...
  },
  {
    ...
    keyThemes: ['Innocence', 'Violence', 'Immigration', 'Identity', 'Community'],
    examTip:
...
const poems = [
  ...
  { title: 'The Émigrée', author: 'Carol Rumens' },
  ...
  return (
    <>
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-3">
          <div className="rounded-xl border border-border p-6">
            ...
            <ul className="mt-3 space-y-2 text-xs text-muted-foreground">
              ...
              <li>
                Understanding the text (12), Analysing language and structure (12), Relating to
                context (6), Comparing texts (4 SPaG)
              </li>
            </ul>
          </div>
          <div className="rounded-xl border border-border p-6">
          ...
          <div className="rounded-xl border border-border p-6">
            ...
            <ul className="mt-3 space-y-2 text-xs text-muted-foreground">
              ...
              <li>
                Understanding the text (12), Analysing language and structure (12) for Part 1;
                Analysing language and structure (8) for Part 2
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="mt-8 space-y-6">
            {modernTexts.map((text) => (
              ...
              >
                <div className="flex flex-wrap items-center gap-3">
                  <h3 className="text-lg font-bold text-foreground">
                    {text.href.startsWith('/') ? (
                      <Link href={text.href} className="hover:text-accent transition">
                        {text.title}
                      </Link>
                    ) : (
                      text.title
                ...
                <p className="mt-2 text-sm text-muted-foreground leading-relaxed">{text.summary}</p>
                ...
                <p className="mt-3 text-sm text-primary bg-primary/10 rounded-lg p-3">
                  <span className="font-semibold">Exam tip:</span> {text.examTip}
                </p>
              </div>
            ))}
          </div>
      ...
      <section className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <p className="mt-2 text-muted-foreground">
          You must know all 15 poems. One will be printed in the exam; you choose a second to
          compare it with.
        </p>
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {poems.map((poem, i) => (
            ...
            >
              ...
              <div>
                <p className="text-sm font-semibold text-foreground">{poem.title}</p>
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            {[
              ...
              },
              {
                ...
                poems: ['Exposure + Bayonet Charge', 'Remains + War Photographer'],
              },
              {
                theme: 'Memory and Loss',
                poems: ['Poppies + Remains', 'Kamikaze + The Émigrée'],
              },
              {
                theme: 'Abuse of Power',
                poems: ['My Last Duchess + Ozymandias', 'London + Checking Out Me History'],
              },
              {
                theme: 'Identity and Place',
                poems: ['The Émigrée + Checking Out Me History', 'Tissue + London'],
              },
              {
              ...
              <div key={pair.theme} className="rounded-lg border border-border p-4">
                <p className="text-sm font-semibold text-primary">{pair.theme}</p>
      ...
      <section className="bg-primary/10 px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-2xl font-bold text-foreground">Section C: Unseen Poetry Technique</h2>
          <p className="mt-2 text-muted-foreground">
            You will see two poems you have never read before. Part 1 asks you to analyse one poem
            (24 marks, ~30 minutes). Part 2 asks you to compare it with a second poem (8 marks, ~15
            minutes).
          </p>
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            <div className="rounded-xl bg-card p-6 shadow-md border border-border">
              ...
              <ol className="mt-4 space-y-3 text-sm text-muted-foreground list-decimal pl-5">
                ...
                <li>
                  <span className="font-semibold">Consider the effect on the reader.</span> Every
                  analytical point should explain <em>why</em> the poet made that choice and what
                  response it creates.
                </li>
                <li>
              ...
              <div className="mt-4 space-y-3 text-sm text-muted-foreground">
                ...
                <div className="rounded-lg bg-primary/10 border border-primary/20 p-4 mt-4">
                  ...
                  <ul className="mt-2 space-y-1 text-xs text-muted-foreground italic">
                    <li>&quot;Both poems explore [theme], yet they differ in...&quot;</li>
                    <li>
                      &quot;While the first poet uses [technique] to convey..., the second poet
                      instead employs...&quot;
                    </li>
                    <li>
                      &quot;The tone of the second poem contrasts sharply with the first
                      because...&quot;
                    </li>
                    <li>
                      &quot;Similarly, [Poet B] presents [theme] through the use of..., which
                      creates...&quot;
                    </li>
                  </ul>
                </div>
