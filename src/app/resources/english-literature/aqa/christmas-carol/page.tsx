...
const essayQuestions = [
  {
    question: "Starting with this extract, how does Dickens present Scrooge's transformation?",
    plan: [
  ...
  {
    question: 'How does Dickens present the theme of social responsibility?',
    plan: [
  ...
  {
    question: 'How does Dickens use the character of Tiny Tim?',
    plan: [
...
export default async function ChristmasCarolPage() {
  return (
    <>
      {/* Hero */}
      ...
      <section id="plot" className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        <h2 className="text-2xl font-bold text-foreground">Plot Summary: Stave by Stave</h2>
        <p className="mt-2 text-muted-foreground">
          Dickens called the five chapters &quot;staves&quot; (musical term for sections of a song),
          reinforcing the idea of Christmas carol and harmony.
        </p>
          ...
          {staveSummaries.map((stave) => (
            <div key={stave.stave}>
              ...
              <p className="mt-3 text-sm text-primary bg-primary/10 rounded-lg p-3">
                <span className="font-semibold">Key moments:</span> {stave.keyMoments}
              </p>
            </div>
          ))}
        </div>
      ...
      <section id="characters" className="bg-muted px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-2 text-muted-foreground">
            Remember: characters are constructs. Discuss what Dickens is trying to show through each
            character, not what they &quot;feel.&quot;
          </p>
