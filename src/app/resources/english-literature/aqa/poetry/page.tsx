...
function PoemRow({ poem, clusterPath }: { poem: PoemEntry; clusterPath: string }) {
  return (
    <Link
    ...
    >
      <div>
        <h3 className="text-lg font-bold text-foreground group-hover:text-primary">{poem.title}</h3>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <section className="mt-14">
          ...
          <div className="mt-4 rounded-xl bg-muted p-6 text-sm text-muted-foreground leading-relaxed space-y-3">
            ...
            <p>
              The question will ask you to compare how the poets present a particular theme, idea,
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <div className="rounded-xl border border-border p-5 shadow-md">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Read, understand, and respond to texts. Use textual references (including
                quotations) to support and illustrate interpretations. Make{' '}
                <strong>critical comparisons</strong> across texts.
              </p>
              <p className="mt-2 text-xs font-medium text-primary">
                Tip: Use comparative connectives throughout. Embed short quotations. Every paragraph
                should discuss both poems.
              </p>
            </div>
            <div className="rounded-xl border border-border p-5 shadow-md">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary text-sm font-bold text-white">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Analyse the language, form, and structure used by the writer to create meanings and
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <ul className="mt-2 space-y-1.5">
                  <li className="flex gap-2">
                    ...
                    <span>
                      Read the printed poem carefully. Annotate it. Choose your comparison poem.
                    </span>
                  </li>
                  <li className="flex gap-2">
                    <span className="font-semibold text-foreground">5 mins</span>
                  ...
                  <li className="flex gap-2">
                    <span className="font-semibold text-foreground">5 mins</span>
                    <span>
                      Check your spelling, punctuation, and that you have compared throughout.
                    </span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="mt-2 space-y-1.5">
                  ...
                  <li>
                    Use a <strong>point-by-point</strong> structure (both poems in every paragraph),
                    not a block structure (all of poem A then all of poem B).
                  </li>
                  <li>
                    Open with a strong thesis that identifies an overarching similarity or
                    difference.
                  </li>
                </ul>
              </div>
        ...
        <section className="mt-14">
          ...
          <p className="mt-2 text-muted-foreground">
            ...
            complexities of human relationships across time. Click any poem to read the full
            detailed analysis.
          </p>
