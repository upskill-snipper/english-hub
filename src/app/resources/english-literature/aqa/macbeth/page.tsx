...
const essayQuestions = [
  {
    question: 'Starting with this extract, how does Shakespeare present ambition in Macbeth?',
    plan: [
    ...
    <>
      ...
      <section id="plot" className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <p className="mt-2 text-muted-foreground">
          Macbeth is Shakespeare&apos;s shortest tragedy, but its pace is relentless. The action
          moves rapidly from prophecy to murder to tyranny to downfall.
        </p>
            ...
            <div key={act.act}>
              ...
              <div className="mt-4 space-y-3">
                {act.scenes.map((scene) => (
                  <div key={scene.scene} className="rounded-lg border border-border p-4">
      ...
      <section id="characters" className="bg-muted px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-2 text-muted-foreground">
            Understanding characters as constructs - Shakespeare made deliberate choices about how
            to present each character to convey meaning.
          </p>
      ...
      <section id="context" className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <p className="mt-2 text-muted-foreground">
          Relating to context (what markers look for) is worth 6 marks per question. Integrate it
          into your analysis rather than writing separate &quot;context paragraphs.&quot;
        </p>
      ...
      <section id="essays" className="bg-muted px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-2 text-muted-foreground">
            Practise planning essays in 5 minutes. These are the most commonly examined topics.
          </p>
