...
function Section({
  ...
  return (
    ...
    >
      <summary className="flex w-full cursor-pointer items-center justify-between gap-4 px-6 py-5 text-start font-bold text-foreground hover:bg-muted transition-colors list-none [&::-webkit-details-marker]:hidden">
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 space-y-6">
        ...
        <Section title={tr(`Overall grade boundaries (combined Paper 1 + Paper 2)`)} defaultOpen>
          <p>
            ...
            (Shakespeare and the 19th-century novel) is worth 40% (64 marks) and Paper 2 (Modern
            texts, Poetry anthology, and Unseen poetry) is worth 60% (96 marks). Your raw marks from
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border text-start text-muted-foreground">
                  ...
                  <th className="py-2 pe-4">{tr(`Approx. mark (/160)`)}</th>
        ...
        <Section title={tr(`What each grade looks like in practice`)}>
          <p>
            Understanding what each grade looks like helps you see exactly what markers expect at
            each level. Here is what typical work looks like at the key grade boundaries:
          </p>
            ...
            <div className="rounded-lg border-s-4 border-success-500 bg-success-50/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ms-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Convincing, critical analysis and exploration in the Shakespeare extract and wider play.`,
                    )}
                  </li>
                  <li>
                    {tr(
                      `Sophisticated comparison of poems from the AQA anthology with a clear personal response.`,
                    )}
                  </li>
                </ul>
              </div>
            ...
            <div className="rounded-lg border-s-4 border-primary bg-blue-500/10/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ms-5 list-disc space-y-1">
                  ...
                  <li>
                    Detailed analysis of the Shakespeare extract linked convincingly to the wider
                    play.
                  </li>
                  <li>
                    Confident analysis of unseen poetry exploring form, structure, and language
                    choices.
                  </li>
                </ul>
              </div>
            ...
            <div className="rounded-lg border-s-4 border-primary bg-blue-500/10/20 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ms-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Clear response to the 19th-century novel with relevant textual references.`,
                    )}
                  </li>
                  <li>
                    {tr(
            ...
            <div className="rounded-lg border-s-4 border-yellow-400 bg-yellow-500/10/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ms-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Some response to the modern text with basic understanding of themes and characters.`,
                    )}
                  </li>
                  <li>
            ...
            <div className="rounded-lg border-s-4 border-border bg-muted/50 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ms-5 list-disc space-y-1">
                  ...
                  <li>{tr(`Limited engagement with the poetry anthology or unseen poetry.`)}</li>
            ...
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ms-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  ...
                  unseen poetry comparison or the poetry anthology question is the most common
            ...
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ms-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  ...
                  uses this to reflect the Jacobean belief that&hellip;&rdquo;
                </li>
                <li>
                  <strong>{tr(`Poetry anthology:`)}</strong> Know all 15 poems in your chosen
                  cluster well enough to compare any two. Practise linking poems by theme, tone, and
                  method rather than memorising a fixed pairing.
                </li>
                <li>
            ...
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ms-5 list-disc space-y-2 text-sm">
                <li>
                  ...
                  argument or interpretation. A Grade 9 response has a thesis &mdash; a thread that
                  runs through every paragraph, not a series of disconnected points.
                </li>
                <li>
        ...
        <Section title={tr(`Paper breakdown at a glance`)}>
          <p className="mb-4">
            AQA GCSE English Literature (8702) is split into two papers. Paper 1 (Shakespeare and
            the 19th-century novel) is worth 40% and Paper 2 (Modern texts, Poetry anthology, and
            Unseen poetry) is worth 60%.
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                <tr>
                  ...
                  <td className="py-2 pe-4">30 marks + 4 SPaG</td>
                  <td className="py-2 pe-4">{tr(`Shakespeare play (extract-based essay)`)}</td>
                </tr>
                <tr>
                  <td className="py-2 pe-4 font-semibold">B &mdash; 19th-century novel</td>
                  <td className="py-2 pe-4">{tr(`Extract + essay`)}</td>
                  <td className="py-2 pe-4">30 marks</td>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                <tr>
                  <td className="py-2 pe-4 font-semibold">A &mdash; Modern texts</td>
                  <td className="py-2 pe-4">{tr(`Essay question`)}</td>
                  <td className="py-2 pe-4">34 marks + 4 SPaG</td>
                  <td className="py-2 pe-4">
                    {tr(`Modern prose or drama (essay from choice of two)`)}
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="py-2 pe-4">30 marks</td>
                  <td className="py-2 pe-4">
                    {tr(`One named poem compared with one of your choice`)}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="py-2 pe-4">{tr(`Comparison of two unseen poems`)}</td>
                </tr>
                <tr className="font-bold">
                  <td className="py-2 pe-4" colSpan={2}>
                    {tr(`Paper 2 Total`)}
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Paper 2 carries more weight and includes both the poetry anthology and unseen poetry
            sections. Knowing your anthology poems inside out and practising unseen poetry under
            timed conditions are two of the most effective ways to improve your overall Literature
            grade.
          </p>
        </Section>
