...
const essayQuestions = [
  ...
  {
    question: 'How does Priestley use the character of Sheila to convey his ideas?',
    plan: [
  ...
  {
    question: 'How does Priestley explore the theme of class in An Inspector Calls?',
    plan: [
    ...
    <>
      ...
      <section id="plot" className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <p className="mt-2 text-muted-foreground">
          The play takes place in real time over a single evening. The Inspector arrives and
          systematically reveals each character&apos;s connection to Eva Smith&apos;s death.
        </p>
