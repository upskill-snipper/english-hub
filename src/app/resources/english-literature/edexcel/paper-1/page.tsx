          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="rounded-xl border border-gray-200 p-6 shadow-sm">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <h3 className="text-xl font-bold text-gray-900">Macbeth</h3>
                <Link
        ...
        <section className="mt-14">
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="rounded-xl bg-gray-50 p-6">
              ...
              <ol className="mt-4 space-y-3 text-sm text-gray-700">
                <li className="flex gap-3">
                  <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-[#2E86C1] text-xs font-bold text-white">
                    1
                  </span>
                  <span>
            ...
            <div className="rounded-xl border-2 border-[#2E86C1] bg-blue-50 p-6">
              ...
              <div className="mt-4 rounded-lg bg-white p-4 text-sm text-gray-700 leading-relaxed">
                <p>
                  <strong className="text-[#1A5276]">Point:</strong>{" "}
                  Shakespeare presents Macbeth as consumed by guilt after
                  murdering Duncan.
                </p>
                <p className="mt-2">
                  <strong className="text-[#1A5276]">Evidence:</strong>{" "}
                  Immediately after the murder, Macbeth asks, &quot;Will all
                  great Neptune&apos;s ocean wash this blood clean from my
                  hand?&quot;
                </p>
                <p className="mt-2">
                  <strong className="text-[#1A5276]">Analysis:</strong> The
                ...
                <p className="mt-2">
                  <strong className="text-[#1A5276]">Context:</strong>{" "}
