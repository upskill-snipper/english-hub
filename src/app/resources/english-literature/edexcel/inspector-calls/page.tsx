...
const KEY_QUOTES = [
  ...
  },
  {
    ...
    significance:
      'Sheila recognises that the evening has changed everything. She will not go back to ignorance.',
  },
  {
  ...
  },
  {
    ...
    speaker: 'Mrs Birling (Act 2)',
    significance:
      'Complete refusal of responsibility. Mrs Birling is the most morally rigid character.',
  },
  {
  ...
  },
  {
    ...
    speaker: 'Eric (Act 3)',
    significance:
      "Eric exposes the dysfunction beneath the Birlings' respectable surface. Birling has failed as a father.",
  },
  {
  ...
  },
  {
    ...
    speaker: 'Inspector (Act 1)',
    significance:
      'Workers have a right to demand fair treatment rather than having their labour exploited by the wealthy.',
  },
  {
    quote: '"One person and one line of inquiry at a time"',
    speaker: 'Inspector (Act 1)',
    significance:
      'The Inspector controls the pace. His methodical approach ensures each person faces their guilt individually.',
  },
  {
  ...
  },
  {
    ...
    speaker: 'Gerald (Act 3)',
    significance:
      'Gerald wants to return to normal. The ring symbolises the superficial values Sheila now rejects.',
  },
  {
    quote: '"a hard-headed, practical man of business"',
    speaker: 'Birling (Act 1)',
    significance:
  ...
  },
  {
    ...
    speaker: 'Eric (Act 3)',
    significance: "Eric's final condemnation of his parents. The generational split is complete.",
  },
]
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <section id="plot" className="mt-14 scroll-mt-20">
          ...
          <p className="mt-2 text-muted-foreground">
            The entire play takes place in one evening, in the Birlings&apos; dining room. This
            unity of time, place, and action intensifies the dramatic tension.
          </p>
        ...
        <section id="quotes" className="mt-14 scroll-mt-20">
          ...
          <p className="mt-2 text-muted-foreground">
            The Edexcel exam is closed-book. Learn these quotes and practise embedding them into
            your paragraphs.
          </p>
            ...
            <div className="rounded-xl bg-muted p-6">
              ...
              <ol className="mt-4 space-y-3 text-sm text-muted-foreground">
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    <strong>4-5 analytical paragraphs</strong> tracking across the play. Use
                    &quot;Priestley presents/suggests/conveys...&quot; to show awareness of the
                    writer&apos;s craft.
                  </span>
                </li>
                <li className="flex gap-3">
