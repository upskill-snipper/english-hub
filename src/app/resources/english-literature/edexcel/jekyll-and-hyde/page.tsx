...
const KEY_QUOTES = [
  ...
  {
    quote: '"I make it a rule of mine: the more it looks like Queer Street, the less I ask"',
  ...
  {
    quote: '"I let my brother go to the devil in his own way"',
  ...
  {
    quote: '"the temptation of a discovery so singular and profound"',
    speaker: 'Jekyll (Ch. 10)',
    significance:
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="rounded-xl bg-muted p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                  <strong>Closed-book:</strong> You cannot take the text into the exam. Memorise
                  short, versatile quotes that work across multiple themes.
                </li>
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
            ...
            <div className="rounded-xl border-2 border-primary bg-blue-500/10 p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                  Use Stevenson&apos;s name - &quot;Stevenson presents...&quot; or &quot;Stevenson
                  uses...&quot; shows awareness of authorial intent (analysis of methods).
                </li>
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                ...
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                  Use literary terminology: novella, Gothic, doppelganger, pathetic fallacy,
                  symbolism, foreshadowing, unreliable narrator, epistolary structure.
                </li>
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                  Consider alternative interpretations: &quot;While a Victorian audience might read
                  Hyde as purely monstrous, a modern Freudian reading suggests he represents the
                  repressed id that exists within everyone.&quot;
                </li>
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                ...
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                  Call it a &quot;novella&quot; not a &quot;novel&quot; - this shows you understand
                  the form and will impress markers.
                </li>
              </ul>
            </div>
          </div>
