...
const KEY_QUOTES = [
  ...
  },
  {
    ...
    speaker: 'The Sheep (Chapter 3)',
    significance:
      'Animalism reduced to a mindless slogan. The sheep repeat it to drown out debate. Orwell shows how propaganda simplifies complex ideas into tools of control.',
  },
  {
    quote: '"Four legs good, two legs better"',
    speaker: 'The Sheep (Chapter 10)',
    significance:
      'The reversal of the original slogan when the pigs walk upright. The sheep adapt instantly, showing how propaganda can make people accept the exact opposite of what they once believed.',
  },
  {
    quote: '"I will work harder"',
    speaker: 'Boxer (throughout)',
    significance:
      "Boxer's first motto. His response to every problem is more labour, never questioning the system. Orwell shows the tragedy of the loyal worker who is exploited precisely because of his devotion.",
  },
  {
  ...
  },
  {
    ...
    speaker: 'Narrator about Squealer (Chapter 2)',
    significance:
      "Orwell's description of Squealer's persuasive power. Foreshadows how Squealer will rewrite history and make the animals accept obvious lies.",
  },
  {
  ...
  },
  {
    ...
    significance:
      'The immediate emergence of a new ruling class. The pigs exploit their intelligence to avoid labour and claim superiority, mirroring the behaviour of the Communist Party elite.',
  },
  {
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <section id="plot" className="mt-14 scroll-mt-20">
          ...
          <div className="mt-6 space-y-6">
            {PLOT_SUMMARY.map((ch) => (
              <div key={ch.chapter} className="rounded-xl border border-border p-6 shadow-md">
                ...
                <p className="mt-3 text-sm text-muted-foreground leading-relaxed">{ch.summary}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="allegory" className="mt-14 scroll-mt-20">
          ...
          <div className="mt-6 space-y-4">
            {ALLEGORY_POINTS.map((a) => (
              <div key={a.element} className="rounded-xl border border-border p-5 shadow-md">
                <div className="flex flex-wrap items-center gap-3">
                  <h3 className="font-bold text-foreground">{a.element}</h3>
                  <span className="text-sm font-medium text-primary">&rarr; {a.represents}</span>
                </div>
