...
interface PoemAnalysis {
  ...
  /** Optional rights notice for poets whose work is in copyright (e.g. estates). */
  rightsNotice?: string
}
...
const RELATIONSHIPS_POEMS: PoemAnalysis[] = [
  {
    ...
    summary:
      "A passionate declaration of love. The speaker lists the many ways she loves her beloved, comparing her love to everyday necessities and spiritual ideals. Written during Barrett Browning's secret courtship with Robert Browning.",
    themes: 'Romantic love, devotion, spirituality, the inadequacy of language to express love',
    language:
      "Anaphora ('I love thee') creates an incantatory, overwhelming effect. Religious language ('Grace,' 'soul') elevates love to a spiritual plane. Abstract concepts ('depth and breadth and height') suggest love transcends physical measurement.",
    structure:
      "Petrarchan sonnet with an octave and sestet. The traditional love sonnet form reinforces the poem's sincerity. Iambic pentameter gives a steady, heartfelt rhythm. Enjambment creates a breathless, flowing quality.",
    keyQuotes: [
  ...
  },
  {
    ...
    summary:
      'A dramatic monologue in which the Duke of Ferrara shows a visitor a portrait of his late wife. He reveals that he had her killed because she smiled at others and did not show him enough exclusive devotion. A chilling study of power, jealousy, and control.',
  ...
  },
  {
    ...
    poet: 'John Keats',
    summary:
      "A medieval ballad about a knight who meets a beautiful, supernatural woman. She enchants him, but when he wakes, he finds himself alone on a cold hillside, 'palely loitering.' The woman has drained him of life. Love is presented as dangerous and destructive.",
  ...
  },
  {
    ...
    comparisonLinks:
      "Compare with 'Sonnet 43' (admiration and love), 'My Last Duchess' (how men view women), or 'Valentine' (unconventional beauty).",
  },
  {
  ...
  },
  {
    ...
    comparisonLinks:
      "Compare with 'Sonnet 43' (traditional vs unconventional love), 'Love\'s Dog' (honest portrayal of love), or 'My Last Duchess' (love and possession).",
    rightsNotice:
      "Rights notice: © Picador / Pan Macmillan and Rogers Coleridge & White on behalf of Carol Ann Duffy (b. 1955). Quotations are short fair-dealing extracts under CDPA 1988 §30 (criticism, review, quotation). For full text, students should consult the board-licensed Edexcel anthology or Duffy's collection Mean Time (1993).",
  },
  {
    title: 'One Flesh',
...
const CONFLICT_POEMS: PoemAnalysis[] = [
  {
    ...
    comparisonLinks:
      "Compare with 'Exposure' (suffering in war), 'The Destruction of Sennacherib' (battle imagery), or 'Poppies' (aftermath of war).",
  },
  {
    title: 'Exposure',
    poet: 'Wilfred Owen',
    ...
    comparisonLinks:
      "Compare with 'The Charge of the Light Brigade' (contrasting attitudes to war), 'War Photographer' (witnessing suffering), or 'What Were They Like?' (war's destruction).",
  },
  {
    title: 'Catrin',
    poet: 'Gillian Clarke',
  ...
  },
  {
    ...
    poet: 'Lord Byron',
    summary:
      "Byron retells the biblical story (2 Kings 19) of the Assyrian King Sennacherib's army being destroyed by God's angel as they attack Jerusalem. The poem celebrates divine power and the fall of a tyrant.",
  ...
  },
  {
    ...
    comparisonLinks:
      "Compare with 'Exposure' (the reality of war), 'War Photographer' (reflecting on conflict), or 'The Charge of the Light Brigade' (duty in war).",
  },
  {
    title: 'Cousin Kate',
  ...
  },
  {
    ...
    comparisonLinks:
      "Compare with 'Half-caste' (prejudice based on identity), 'No Problem' (defiance against discrimination), or 'Cousin Kate' (class and power).",
    rightsNotice:
      'Rights notice: © Mary Casey / Pearson Education. Quotations are short fair-dealing extracts under CDPA 1988 §30 (criticism, review, quotation). For full text, students should consult the board-licensed Edexcel anthology.',
  },
  {
    title: 'Poppies',
    poet: 'Jane Weir',
...
function PoemCard({ poem }: { poem: PoemAnalysis }) {
  return (
    <div className="rounded-xl border border-border p-6 shadow-md">
      ...
      <p className="mt-3 text-sm text-muted-foreground leading-relaxed">{poem.summary}</p>

      <div className="mt-4 space-y-4">
        <div>
          <h4 className="text-xs font-semibold uppercase tracking-wide text-primary">Themes</h4>
        ...
        <div>
          <h4 className="text-xs font-semibold uppercase tracking-wide text-primary">Key Quotes</h4>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <section className="mt-14">
          ...
          <div className="mt-4 rounded-xl bg-muted p-6 text-sm text-muted-foreground leading-relaxed space-y-3">
            ...
            <p>
              ...
              never caught out by the named poem.
            </p>
          </div>
        </section>
        ...
        <section className="mt-14">
          ...
          <p className="mt-2 text-muted-foreground">
            ...
            desire, loss, and the complexities of human connection.
          </p>
