    ...
    <>
      ...
      <nav className="mx-auto max-w-5xl px-4 pt-6" aria-label="Breadcrumb">
        <ol className="flex flex-wrap items-center gap-2 text-sm text-gray-500">
          ...
          <li>/</li>
          <li>
            <Link href="/resources/english-literature/edexcel" className="hover:text-[#1A5276] transition-colors">
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 space-y-6">
        ...
        <Section title="Marks per question at a glance">
          ...
          <h3 className="font-bold text-[#1A5276] mb-2">Paper 1 &mdash; Shakespeare and Post-1914 Literature (50%)</h3>
          <p className="text-sm text-gray-500 mb-3">80 marks &bull; 1 hour 45 minutes</p>
          ...
          <h3 className="font-bold text-[#1A5276] mt-6 mb-2">Paper 2 &mdash; 19th-Century Novel, Poetry Anthology &amp; Unseen Poetry (50%)</h3>
          <p className="text-sm text-gray-500 mb-3">80 marks &bull; 2 hours 15 minutes</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 text-left text-gray-500">
