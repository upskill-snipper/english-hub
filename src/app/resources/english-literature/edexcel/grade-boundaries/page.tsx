      ...
      <div className="mx-auto max-w-5xl px-4 py-10 space-y-6">
        ...
        <Section title={tr(`Overall grade boundaries (combined Paper 1 + Paper 2)`)} defaultOpen>
          <p>
            ...
            (Shakespeare and Post-1914 Literature) is worth 50% (80 marks) and Paper 2 (19th-Century
            Novel, Poetry Anthology, and Unseen Poetry) is worth 50% (80 marks). Your raw marks from
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            ...
            data. The &ldquo;Approx. %&rdquo; column shows roughly what percentage of the total 160
            marks you need.
          </p>
        </Section>
            ...
            <div className="rounded-lg border-l-4 border-success-500 bg-success-50/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>
                    Perceptive understanding of the relationship between texts and their contexts.
                  </li>
                  <li>
                    {tr(
            ...
            <div className="rounded-lg border-l-4 border-primary bg-blue-500/10/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(`Confident analysis of how context shapes meaning across different texts.`)}
                  </li>
                  <li>
                    {tr(
            ...
            <div className="rounded-lg border-l-4 border-primary bg-blue-500/10/20 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(`Clear understanding of context with some relevant connections made.`)}
                  </li>
                  <li>
                    {tr(
            ...
            <div className="rounded-lg border-l-4 border-yellow-400 bg-yellow-500/10/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>{tr(`Some awareness of how context influences meaning.`)}</li>
                  <li>
          ...
          <div className="mt-4 space-y-5">
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  ...
                  unseen poetry or the 19th-century novel question is the most common reason
            ...
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  <strong>{tr(`Poetry anthology:`)}</strong> Know your poems inside out. Revise the
                  key themes, techniques, and context of each poem so you can compare confidently
            ...
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  <strong>Alternative interpretations:</strong> Explore how a text could be read
                  differently: &ldquo;A feminist reading might suggest&hellip;&rdquo; or
        ...
        <Section title={tr(`Marks per question at a glance`)}>
          <p className="mb-4">
            Edexcel English Literature is split into two papers of equal weight. Paper 1
            (Shakespeare and Post-1914 Literature) is worth 50% and Paper 2 (19th-Century Novel,
            Poetry Anthology, and Unseen Poetry) is worth 50%.
          </p>

          <h3 className="font-bold text-foreground mb-2">
            {tr(`Paper 1 &mdash; Shakespeare and Post-1914 Literature (50%)`)}
          </h3>
          ...
          <h3 className="font-bold text-foreground mt-6 mb-2">
            {tr(`Paper 2 &mdash; 19th-Century Novel, Poetry Anthology &amp; Unseen Poetry (50%)`)}
          </h3>
