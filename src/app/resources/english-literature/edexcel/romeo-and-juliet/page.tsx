...
const KEY_QUOTES = [
  { quote: '"Two households, both alike in dignity, in fair Verona, where we lay our scene"', speaker: "Prologue", significance: "The Prologue establishes the setting, the feud, and foreshadows the lovers' deaths. 'Both alike in dignity' suggests neither family is morally superior — both share blame." },
  { quote: '"A pair of star-crossed lovers take their life"', speaker: "Prologue", significance: "Introduces the theme of fate. 'Star-crossed' means opposed by the stars (destiny). The audience knows the ending from the start — dramatic irony pervades the entire play." },
  { quote: '"Did my heart love till now? Forswear it, sight! For I ne\'er saw true beauty till this night"', speaker: "Romeo (1.5)", significance: "Romeo's instant love for Juliet. The rhyming couplet suggests the intensity of his feelings. However, his rapid switch from Rosaline questions whether this is true love or infatuation." },
  { quote: '"My only love sprung from my only hate! Too early seen unknown, and known too late!"', speaker: "Juliet (1.5)", significance: "Juliet discovers Romeo is a Montague. The oxymoron of 'love/hate' captures the central paradox of the play. The rhyming couplet gives a sense of finality — their fate is sealed." },
  { quote: '"But soft, what light through yonder window breaks? It is the east, and Juliet is the sun"', speaker: "Romeo (2.2)", significance: "The famous balcony speech. Romeo uses celestial imagery to elevate Juliet above the ordinary world. The metaphor of the sun suggests warmth, life, and centrality — she is his universe." },
  { quote: '"What\'s in a name? That which we call a rose by any other name would smell as sweet"', speaker: "Juliet (2.2)", significance: "Juliet argues that names are arbitrary labels. She challenges the feud's logic — Romeo's identity as a Montague should not define him. A philosophical challenge to the social order." },
  { quote: '"My bounty is as boundless as the sea, my love as deep; the more I give to thee, the more I have, for both are infinite"', speaker: "Juliet (2.2)", significance: "Juliet's love is presented as limitless and paradoxical — giving love increases it. The sea imagery suggests depth, power, and vastness. Juliet is the more eloquent and daring of the two." },
  { quote: '"These violent delights have violent ends"', speaker: "Friar Lawrence (2.6)", significance: "The Friar foreshadows the tragedy, warning that extreme passion is self-destructive. 'Violent' carries dual meaning — intense and aggressive. This line encapsulates the play's central message." },
  { quote: '"Wisely and slow. They stumble that run fast"', speaker: "Friar Lawrence (2.3)", significance: "The Friar counsels caution. Ironic because he himself acts hastily (the marriage, the potion plan). The proverb-like structure gives it weight, but no one in the play heeds it." },
  { quote: '"A plague o\' both your houses!"', speaker: "Mercutio (3.1)", significance: "Mercutio's dying curse. Repeated three times for emphasis, it condemns both families. As a character outside the feud, his death shows that the violence destroys everyone, not just the families involved." },
  { quote: '"O, I am fortune\'s fool!"', speaker: "Romeo (3.1)", significance: "After killing Tybalt, Romeo sees himself as a victim of fate. 'Fortune's fool' suggests he is a plaything of destiny. Yet it was his own impulsive choice to fight — the line captures the tension between fate and free will." },
  { quote: '"Gallop apace, you fiery-footed steeds"', speaker: "Juliet (3.2)", significance: "Juliet's epithalamium (wedding-night speech) shows her sexual desire and impatience. The classical allusion to Phoebus's horses demonstrates her intelligence. She is no passive maiden." },
  { quote: '"Hang thee, young baggage! Disobedient wretch!"', speaker: "Lord Capulet (3.5)", significance: "Capulet's violent rage at Juliet's refusal to marry Paris reveals patriarchal tyranny. The dehumanising language ('baggage') reduces Juliet to property. Shows the limited agency of women." },
  { quote: '"An you be mine, I\'ll give you to my friend; and you be not, hang, beg, starve, die in the streets"', speaker: "Lord Capulet (3.5)", significance: "Capulet threatens to disown Juliet. The list structure ('hang, beg, starve, die') builds to a brutal climax. Reveals that a daughter's value lies only in her obedience." },
  { quote: '"Give me my Romeo; and, when I shall die, take him and cut him out in little stars, and he will make the face of heaven so fine"', speaker: "Juliet (3.2)", significance: "Juliet transforms Romeo into a constellation — their love is eternal and heavenly. The imagery elevates their love beyond the mortal world. Foreshadows their deaths making them immortal." },
  { quote: '"Then I defy you, stars!"', speaker: "Romeo (5.1)", significance: "Romeo's response to news of Juliet's death. He actively rebels against fate — a heroic but futile gesture. The short, explosive sentence contrasts with his earlier poetic speeches, showing raw desperation." },
  { quote: '"Here\'s to my love! ... Thus with a kiss I die"', speaker: "Romeo (5.3)", significance: "Romeo's final words. Love and death are united in a single action. 'With a kiss I die' is a rhyming couplet that provides a sense of closure. Echoes their first meeting, when they shared a kiss." },
  { quote: '"O happy dagger! This is thy sheath. There rust, and let me die"', speaker: "Juliet (5.3)", significance: "Juliet's death is swift and decisive — unlike Romeo's poetic farewell. The oxymoron 'happy dagger' links joy and death. The sexual connotation of 'sheath' unites love and death (Eros and Thanatos)." },
  { quote: '"All are punished"', speaker: "Prince Escalus (5.3)", significance: "The Prince's final judgement. The universal 'all' spreads blame across both families and the wider community. The feud's consequences are collective — no one escapes responsibility." },
  { quote: '"For never was a story of more woe than this of Juliet and her Romeo"', speaker: "Prince Escalus (5.3)", significance: "The closing couplet. Romeo belongs to Juliet ('her Romeo'), suggesting their love transcends the feud. The rhyme provides closure and elevates their story to legend." },
];
