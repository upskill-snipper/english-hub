...
const CHARACTERS = [
  ...
  },
  {
    ...
    key_quotes: ['"This dead butcher and his fiend-like queen"'],
  },
]
...
const KEY_QUOTES = [
  {
    ...
    speaker: 'Witches (1.1)',
    significance:
      "Establishes the theme of appearance vs reality and moral inversion. The play's world is one where nothing can be trusted.",
  },
  {
    quote: '"Stars, hide your fires; let not light see my black and deep desires"',
    speaker: 'Macbeth (1.4)',
    significance:
      "Macbeth's first aside reveals his ambition and awareness that his desires are sinful. Light/dark imagery links to good/evil.",
  },
  {
    quote: '"Come, you spirits that tend on mortal thoughts, unsex me here"',
    speaker: 'Lady Macbeth (1.5)',
    significance:
      'She calls on supernatural evil to strip her of feminine compassion. Challenges Jacobean gender norms.',
  },
  {
    quote: '"Look like the innocent flower, but be the serpent under\'t"',
    speaker: 'Lady Macbeth (1.5)',
    significance:
      "Biblical allusion to the serpent in Eden. Deception is central to the Macbeths' plan.",
  },
  {
  ...
  },
  {
    ...
    speaker: 'Macbeth (2.2)',
    significance:
      'Hyperbole expressing overwhelming guilt. The ocean cannot remove the stain of regicide.',
  },
  {
  ...
  },
  {
    ...
    speaker: 'Witches (4.1)',
    significance:
      'Incantation creating an atmosphere of evil and chaos. Rhyming couplets suggest ritualistic, unnatural magic.',
  },
  {
  ...
  },
  {
    ...
    significance:
      'Sleepwalking scene. The blood she once dismissed now haunts her. Guilt has overwhelmed her rational mind.',
  },
  {
  ...
  },
  {
    ...
    speaker: 'Macbeth (3.2)',
    significance:
      'Metaphor revealing paranoia and torment. The scorpion suggests dangerous, self-destructive thoughts.',
  },
]
    ...
    <>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <section id="exam" className="mt-14 scroll-mt-20">
          <h2 className="text-2xl font-bold text-foreground">Edexcel Exam Technique for Macbeth</h2>
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="rounded-xl border-2 border-primary bg-blue-500/10 p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                ...
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                  Use literary terminology: soliloquy, dramatic irony, tragic hero, hamartia,
                  pathetic fallacy, juxtaposition, foreshadowing.
                </li>
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                  Consider alternative interpretations: &quot;While some critics read Lady Macbeth
                  as purely villainous, others argue she is a victim of patriarchal
                  expectations...&quot;
                </li>
                <li className="flex gap-2">
                  <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
