...
const CHARACTERS = [
  ...
  },
  {
    ...
    key_quotes: ['"They were savages it was true; but they were human"'],
  },
]
...
const KEY_QUOTES = [
  ...
  },
  {
    ...
    speaker: 'Ralph (Ch. 5)',
    significance:
      "Ralph's desperate appeal to order. Rules are the last barrier against savagery. Shows his understanding that without rules, society collapses.",
  },
  {
  ...
  },
  {
    ...
    significance:
      "The novel's emotional and thematic climax. Ralph now understands what Simon knew: evil is within all people. Innocence cannot be recovered.",
  },
  {
  ...
  },
  {
    ...
    speaker: 'The Lord of the Flies (Ch. 8)',
    significance:
      "Mocks the boys' attempts to externalise evil. You cannot destroy the beast because it is human nature itself.",
  },
  {
  ...
  },
  {
    ...
    speaker: 'Narrator (about Jack, Ch. 4)',
    significance:
      "Jack's transformation from schoolboy to predator. 'Bloodthirsty snarling' reduces him to an animal, showing how thin the veneer of civilisation is.",
  },
  {
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <section id="plot" className="mt-14 scroll-mt-20">
          ...
          <p className="mt-2 text-muted-foreground">
            The novel follows a group of British schoolboys stranded on an uninhabited island after
            a plane crash during a nuclear war. Their attempt to govern themselves descends into
            savagery and murder.
          </p>
          <div className="mt-6 space-y-6">
            {PLOT_SUMMARY.map((section) => (
              <div key={section.chapter} className="rounded-xl border border-border p-6 shadow-md">
        ...
        <section id="symbolism" className="mt-14 scroll-mt-20">
          ...
          <p className="mt-2 text-muted-foreground">
            Golding uses symbolism extensively. Understanding these symbols is essential for
            achieving top marks on the Edexcel exam.
          </p>
          <div className="mt-6 space-y-4">
            {SYMBOLISM.map((s) => (
              <div key={s.symbol} className="rounded-xl border border-border p-5 shadow-md">
                <h3 className="font-bold text-foreground">{s.symbol}</h3>
                <p className="mt-2 text-sm text-muted-foreground leading-relaxed">{s.meaning}</p>
              </div>
            ))}
          </div>
        </section>
