    ...
    <>
      ...
      <nav className="mx-auto max-w-5xl px-4 pt-6" aria-label="Breadcrumb">
        <ol className="flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
          ...
          <li>
            <Link
              href="/resources/english-literature/wjec"
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 space-y-6">
        ...
        <div className="rounded-xl border border-warn-200 bg-warn-50 p-6">
          ...
          <p className="mt-2 text-sm text-warn-700">
            ...
            <a
              href="https://www.eduqas.co.uk/qualifications/english-literature-gcse/"
              target="_blank"
        ...
        <Section title={tr(`Overall grade boundaries (combined Paper 1 + Paper 2)`)} defaultOpen>
          <p>
            The total number of marks across both papers is <strong>160</strong>. Paper 1
            (Shakespeare and Poetry) is worth 40% (64 marks) and Paper 2 (Post-1914 Prose/Drama and
            Unseen Poetry) is worth 60% (96 marks). Your raw marks from both papers are combined to
            produce your overall grade. Below are the approximate boundaries from recent exam
            series:
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                ...
                <tr className="bg-success-50/50">
                  ...
                  <td className="py-2 pe-4">106</td>
                  <td className="py-2 pe-4">108</td>
                  <td className="py-2 pe-4">109</td>
                  <td className="py-2 pe-4">~68%</td>
                </tr>
                <tr>
                  <td className="py-2 pe-4 font-bold text-primary">7</td>
                  <td className="py-2 pe-4">95</td>
                  <td className="py-2 pe-4">97</td>
                  <td className="py-2 pe-4">98</td>
                  <td className="py-2 pe-4">~61%</td>
                </tr>
                <tr>
                  <td className="py-2 pe-4 font-bold text-primary">6</td>
                  <td className="py-2 pe-4">81</td>
                  <td className="py-2 pe-4">83</td>
                  <td className="py-2 pe-4">84</td>
                  <td className="py-2 pe-4">~52%</td>
                </tr>
                <tr>
                  <td className="py-2 pe-4 font-bold text-foreground">5</td>
                  <td className="py-2 pe-4">67</td>
                  <td className="py-2 pe-4">69</td>
                ...
                <tr>
                  ...
                  <td className="py-2 pe-4">22</td>
                  <td className="py-2 pe-4">23</td>
                  <td className="py-2 pe-4">24</td>
                  <td className="py-2 pe-4">~15%</td>
                </tr>
                <tr>
            ...
            <div className="rounded-lg border-s-4 border-success-500 bg-success-50/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ms-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Perceptive, detailed comparison of texts (where required) with analysis of connections.`,
                    )}
                  </li>
                  <li>
                    {tr(
                      `Sophisticated exploration of unseen poetry, considering form, structure, and language with originality.`,
                    )}
                  </li>
                </ul>
              </div>
            ...
            <div className="rounded-lg border-s-4 border-primary bg-blue-500/10/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ms-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Detailed comparison of texts with clear analysis of connections and contrasts.`,
                    )}
                  </li>
                  <li>
                    {tr(
                      `Confident analysis of unseen poetry exploring form, structure, and language choices.`,
                    )}
                  </li>
                </ul>
              </div>
            ...
            <div className="rounded-lg border-s-4 border-primary bg-blue-500/10/20 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ms-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(`Clear comparison of texts with some relevant connections identified.`)}
                  </li>
                  <li>
                    {tr(
            ...
            <div className="rounded-lg border-s-4 border-yellow-400 bg-yellow-500/10/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ms-5 list-disc space-y-1">
                  ...
                  <li>
                    {tr(
                      `Some comparison of texts, though connections may be simple or undeveloped.`,
                    )}
                  </li>
                  <li>
            ...
            <div className="rounded-lg border-s-4 border-border bg-muted/50 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ms-5 list-disc space-y-1">
                  ...
                  <li>{tr(`Limited or no comparison of texts.`)}</li>
          ...
          <div className="mt-4 space-y-5">
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ms-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  <strong>Completeness:</strong> Attempt every question in full. Leaving out the
                  unseen poetry or the comparison question is the most common reason students miss a
                  Grade 5.
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ms-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  <strong>Comparison:</strong> In Paper 1 poetry comparison, use comparative
                  connectives throughout (&ldquo;Similarly,&rdquo; &ldquo;In contrast,&rdquo;
                  &ldquo;While both poets&hellip;&rdquo;) rather than writing about each poem
                  separately.
                </li>
                <li>
                  <strong>{tr(`Unseen poetry:`)}</strong> Practise reading poems you have never seen
                  before. Build a toolkit for approaching unfamiliar texts: start with subject, then
                  move to tone, imagery, form, and structure.
                </li>
              </ul>
            </div>
        ...
        <Section title={tr(`Marks per question at a glance`)}>
          <p className="mb-4">
            WJEC Eduqas English Literature is split into two papers. Paper 1 (Shakespeare and
            Poetry) is worth 40% and Paper 2 (Post-1914 Prose/Drama and Unseen Poetry) is worth 60%.
          </p>

          <h3 className="font-bold text-foreground mb-2">
            {tr(`Paper 1 &mdash; Shakespeare and Poetry (40%)`)}
          </h3>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                <tr>
                  ...
                  <td className="py-2 pe-4">A1 (extract + essay)</td>
                  <td className="py-2 pe-4">32 marks</td>
                  <td className="py-2 pe-4">{tr(`Shakespeare play (extract-based essay)`)}</td>
                </tr>
                <tr>
                  <td className="py-2 pe-4 font-semibold">B &mdash; Poetry</td>
                  <td className="py-2 pe-4">B1 (comparison)</td>
                  <td className="py-2 pe-4">32 marks</td>
          ...
          <h3 className="font-bold text-foreground mt-6 mb-2">
            Paper 2 &mdash; Post-1914 Prose/Drama and Unseen Poetry (60%)
          </h3>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
              ...
              <tbody className="divide-y divide-border">
                <tr>
                  <td className="py-2 pe-4 font-semibold">A &mdash; Prose/Drama</td>
                  <td className="py-2 pe-4">A1 (extract + essay)</td>
                  <td className="py-2 pe-4">40 marks</td>
                  <td className="py-2 pe-4">
                    {tr(`Post-1914 prose or drama (extract-based essay)`)}
                  </td>
                </tr>
                <tr>
                  <td className="py-2 pe-4 font-semibold" rowSpan={2}>
                    B &mdash; Unseen Poetry
                  </td>
                  <td className="py-2 pe-4">B1</td>
                  <td className="py-2 pe-4">32 marks</td>
                  <td className="py-2 pe-4">{tr(`Analysis of unseen poem`)}</td>
                </tr>
                <tr>
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Paper 2 carries more weight and includes unseen poetry, which many students find
            challenging. Practising with unfamiliar poems under timed conditions is one of the most
            effective ways to improve your overall Literature grade.
          </p>
        </Section>
