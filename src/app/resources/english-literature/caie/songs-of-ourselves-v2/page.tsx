...
const poems = [
  ...
  },
  {
    ...
    quotations: [
      ...
      {
        quote: "In glamorous restaurants and expensive cafes / You can tell at once that this is not a world / Where men are colourful",
        analysis:
    ...
    <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <section className="mt-10">
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              The Part 3 selection encompasses poems that explore borders and belonging,
              urban alienation, conflict, journey, social privilege, and mortality. The
      ...
      <section className="mt-12">
        ...
        <p className="mt-3 text-muted-foreground leading-relaxed">
          Effective comparison is not about listing similarities and differences
          mechanically. The strongest responses identify a shared concern — a theme, a
          technique, a structural choice — and then explore how each poet approaches it
          differently, and why those differences matter. Below are productive pairings from
          the Part 3 cluster.
        </p>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="list-disc space-y-3 pl-5 text-muted-foreground leading-relaxed">
              <li>
                <strong className="text-foreground">Read the poem at least twice</strong>{" "}
                before you begin writing. The first reading gives you the overall tone and
                subject; the second reveals the details of language and structure that will
                form the substance of your analysis.
              </li>
              <li>
                <strong className="text-foreground">
                  Embed quotations into your sentences
                </strong>{" "}
                rather than presenting them as standalone blocks. This demonstrates fluency
                and allows you to analyse individual words within the flow of your argument.
              </li>
              <li>
                <strong className="text-foreground">
                  Analyse specific word choices, not just themes
                </strong>
                . Saying a poem is &ldquo;about identity&rdquo; is description; explaining
                how Dharker&apos;s use of the imperative &ldquo;Don&apos;t look at me like
                that&rdquo; conveys defensive vulnerability is analysis.
              </li>
              <li>
                <strong className="text-foreground">
                  Address form and structure explicitly
                </strong>
                . Discuss why Auden chose a sonnet, why Kolatkar uses free verse, why
                Smith&apos;s nursery-rhyme metre is significant. Form is not decoration — it
                is meaning.
              </li>
              <li>
                <strong className="text-foreground">
                ...
                . Do not write about Poem A for three paragraphs then Poem B for three
                paragraphs. Instead, identify shared points of comparison and discuss both
                poems within each paragraph, noting where they converge and diverge.
              </li>
              <li>
                <strong className="text-foreground">
                  Use context to illuminate, not to fill space
                </strong>
                . A sentence on Daryush&apos;s privileged background that explains why her
                critique carries ironic weight is valuable. A paragraph of biographical
                detail unconnected to the poem is not.
              </li>
            </ul>
          </CardContent>
        </Card>
