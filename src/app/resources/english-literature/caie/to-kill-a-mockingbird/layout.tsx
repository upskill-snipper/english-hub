...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://theenglishhub.app/resources/english-literature/caie/to-kill-a-mockingbird',
  },
  openGraph: {
    ...
    images: [
      {
        url: '/api/og?title=To+Kill+a+Mockingbird+-+CAIE+IGCSE+-+The+English+Hub',
        width: 1200,
        height: 630,
        alt: 'To Kill a Mockingbird - CAIE IGCSE - The English Hub',
      },
    ],
  },
}
