  ...
  return (
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            ...
            analysis, narrative techniques, context, and Cambridge-specific exam technique.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        {/* ── Navigation ──────────────────────────────────────────── */}
        <nav className="mb-10 flex flex-wrap gap-2 text-sm" aria-label={tr(`Page sections`)}>
          {[
            'Chapter Events',
            'Characters',
            'Themes',
        ...
        <section id="key-quotes" aria-labelledby="quotes-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Each quote includes the speaker, chapter, and detailed analysis suitable for Cambridge
            IGCSE responses.
          </p>
        ...
        <section id="narrative-techniques" aria-labelledby="techniques-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Lee&rsquo;s narrative methods are essential for Writer's Methods (analysis of language,
            form, and structure). Markers reward responses that discuss <em>how</em> Lee shapes
            meaning, not just <em>what</em> happens.
          </p>
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            {narrativeTechniques.map((d) => (
              <div key={d.name} className="rounded-lg border border-border bg-card p-5 shadow-md">
        ...
        <section id="context" aria-labelledby="context-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            ...
            markers expect you to discuss both the fictional setting and the context of publication,
            and to integrate context into your analysis rather than treating it as a bolt-on.
          </p>
          <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              <h3 className="font-semibold text-foreground">{tr(`The Jim Crow South`)}</h3>
              <p className="mt-2">
                The novel is set in Alabama during the 1930s, under the Jim Crow laws that enforced
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              <h3 className="font-semibold text-foreground">{tr(`The Great Depression`)}</h3>
              <p className="mt-2">
                Maycomb in the 1930s is a town crippled by poverty. The Cunninghams cannot pay in
                cash and barter with crops instead. Professional families like the Finches are
                relatively comfortable, but even they feel the economic strain. The Depression
                intensified class tensions and racial scapegoating, as poor whites competed with
                Black workers for scarce resources. Lee&rsquo;s depiction of Maycomb&rsquo;s poverty
                provides the economic context for the social hierarchies that drive the plot.
              </p>
            </div>
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              <h3 className="font-semibold text-foreground">{tr(`The Scottsboro Boys (1931)`)}</h3>
              <p className="mt-2">
                Nine Black teenagers were falsely accused of raping two white women on a train in
                Alabama. Despite contradictory evidence and one accuser recanting, all-white juries
                convicted the defendants repeatedly. The case drew national and international
                attention to Southern racial injustice. Harper Lee, growing up in Monroeville,
                Alabama, would have been aware of this case, and Tom Robinson&rsquo;s trial shares
                clear parallels: a false accusation, an all-white jury, and a verdict determined by
                race rather than evidence.
              </p>
            </div>
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              <h3 className="font-semibold text-foreground">
                {tr(`The Civil Rights Movement (1950s-60s)`)}
              </h3>
              <p className="mt-2">
                Lee published the novel in 1960, during a period of intense civil rights activism.
                The Montgomery Bus Boycott (1955), the Brown v. Board of Education ruling (1954),
                and the sit-in movements were challenging segregation. By setting her novel in the
                1930s and publishing it during the civil rights era, Lee drew a line between past
                injustice and present struggle, arguing that the racism of the Depression-era South
                had not been overcome. The novel became a key text of the movement, widely read in
                American schools as a moral education tool.
              </p>
            </div>
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              <h3 className="font-semibold text-foreground">
              ...
              <p className="mt-2">
                ...
                Lee&rsquo;s background helps explain the novel&rsquo;s autobiographical tone and its
                intimate knowledge of the community it depicts.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="exam-questions" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cambridge IGCSE To Kill a Mockingbird questions appear in the Prose section. You will
            choose between a passage-based (a) question and an essay (b) question. Below are
            examples of both types with guidance and a model paragraph.
          </p>
          ...
          <div className="mt-6 space-y-6">
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-3 text-sm font-medium text-foreground">
                Re-read the passage in Chapter 21 from &ldquo;I shut my eyes&rdquo; to &ldquo;Your
                father&rsquo;s passin&rsquo;.&rdquo; How does Lee make this such a powerful and
                moving moment in the novel?
              </p>
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  <li>
                    &bull; Work through the passage line by line, identifying key language choices
                  </li>
                  <li>
                    &bull; Analyse the contrast between the verdict and the community&rsquo;s
                    response
                  </li>
                  <li>
                    &bull; Discuss the effect of the child narrator: Scout&rsquo;s sensory detail
                    and confusion heighten pathos
                  </li>
                  <li>
                    &bull; Consider the structural placement: immediately after the guilty verdict
                  </li>
                  <li>
                    &bull; Link to context: the Black community&rsquo;s standing ovation inverts the
                    racial hierarchy
                  </li>
            ...
            <div className="rounded-lg border-2 border-primary/40 bg-card p-5 shadow-md">
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                <p className="text-xs font-semibold text-foreground">
                  {tr(`Skills demonstrated:`)}
                </p>
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  <li>
                    &bull; <strong>{tr(`Textual Knowledge:`)}</strong> Detailed knowledge of the
                    passage and its significance in the novel
                  </li>
                  <li>
                    &bull; <strong>{tr(`Writer's Methods:`)}</strong> Analysis of Lee&rsquo;s
                    language (&lsquo;passin&rsquo;&rsquo;), structure (juxtaposition of verdict and
                    honour), and narrative perspective
                  </li>
                  <li>
                    &bull; <strong>Interpretation:</strong> Contextual awareness of racial hierarchy
                    and the Black community&rsquo;s position
                  </li>
                  <li>
                    &bull; <strong>{tr(`Personal Response:`)}</strong> Clear, analytical writing
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  ...
                  <li>
                    &bull; Discuss racial prejudice (Tom&rsquo;s trial), social prejudice (the class
                    hierarchy), and personal prejudice (the children&rsquo;s fear of Boo Radley)
                  </li>
                  <li>
                    &bull; Analyse Lee&rsquo;s methods: the child narrator exposes hypocrisy; the
                    mockingbird symbol condemns the destruction of innocence
                  </li>
                  <li>
                    &bull; Reference context: Jim Crow laws, the Scottsboro case, the Civil Rights
                    Movement
                  </li>
                  <li>
                    &bull; Show how different characters embody or challenge prejudice (Atticus vs.
                    Bob Ewell; Scout&rsquo;s growth vs. the jury&rsquo;s failure)
                  </li>
                  <li>
                    &bull; Conclude with Lee&rsquo;s wider message: that empathy is the antidote to
                    prejudice
                  </li>
                </ul>
              </div>
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-3 text-sm font-medium text-foreground">
                How does Lee use the character of Atticus Finch to convey her ideas about courage
                and morality?
              </p>
              <div className="mt-3 rounded bg-primary/5 p-3">
                <p className="text-xs font-semibold text-foreground">{tr(`How to approach:`)}</p>
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  <li>
                    &bull; Structure around key moments: the mad dog scene, the jail confrontation,
                    the trial, the response to Bob Ewell&rsquo;s spitting
                  </li>
                  <li>
                    &bull; Contrast physical courage (shooting the dog) with moral courage
                    (defending Tom)
                  </li>
                  <li>
                  ...
                  <li>
                    &bull; Analyse Lee&rsquo;s presentation: Atticus is seen through Scout&rsquo;s
                    adoring but gradually maturing eyes
                  </li>
                  <li>
                    &bull; Link to context: Atticus represents the liberal Southern ideal during the
                    Civil Rights era
                  </li>
                  <li>
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-3 text-sm font-medium text-foreground">
                Re-read the passage in Chapter 31 from &ldquo;I led him to the front porch&rdquo; to
                the end of the chapter. How does Lee use this moment to bring the novel to a
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  ...
                  <li>
                    &bull; Discuss the retrospective narration: Scout sees the neighbourhood from
                    Boo&rsquo;s perspective across the entire novel
                  </li>
                  <li>
                    &bull; Note the circular structure: the novel ends where it began, but Scout has
                    been transformed
                  </li>
                  <li>
                  ...
                  <li>
                    &bull; Discuss the mockingbird motif: Scout&rsquo;s protection of Boo echoes
                    Atticus&rsquo;s defence of Tom
                  </li>
                  <li>
                    &bull; Link to context: Lee&rsquo;s message that empathy and understanding can
            ...
            <div className="rounded-lg border-2 border-primary/30 bg-primary/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                <li>
                  <strong className="text-foreground">{tr(`Passage-based (a) questions:`)}</strong>{' '}
                  Work through the extract methodically. Use short, embedded quotations from the
                  passage. Analyse language, form, and structure (Writer's Methods). Then connect
                  outward to the rest of the novel and relevant context. Always discuss Lee&rsquo;s
                  use of the child narrator and how it shapes the reader&rsquo;s response.
                </li>
                <li>
                  <strong className="text-foreground">{tr(`Essay (b) questions:`)}</strong> Plan
                  before you write. Select 3&ndash;4 key moments from across the novel with
                  quotations. Focus on Lee&rsquo;s methods and purpose, not just what happens.
                  Integrate context rather than adding it as a separate paragraph. Show awareness of
                ...
                <li>
                  <strong className="text-foreground">
                    {tr(`The 1930s setting and 1960 publication:`)}
                  </strong>{' '}
                ...
                <li>
                  ...
                  Boo&rsquo;s porch? Always ask: what is Lee trying to make the reader think or
                  feel?
                </li>
              </ul>
            </div>
