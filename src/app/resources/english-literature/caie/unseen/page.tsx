      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section aria-labelledby="intro-heading">
          ...
          <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground">
            <p>
              ...
              cannot revise the specific text, but you <em>can</em> revise the skills
              needed to analyse any text effectively.
            </p>
            <p>
              The unseen component may appear as part of Paper 1 (0992) or as a separate
              component depending on your syllabus variant. You will be given a poem or
              a prose extract and asked to write about how the writer creates effects
              through language, form, and structure.
            </p>
            <p>
              This page provides a systematic approach to unseen analysis that works for
        ...
        <section aria-labelledby="worked-poetry-heading">
          ...
          <div className="mt-4 rounded-lg border-l-4 border-primary bg-card p-5 shadow-md">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              ...
              &lsquo;flung&rsquo; are forceful and deliberate, suggesting the storm
              acts with intent rather than randomness. The simile &lsquo;like a playing
              card&rsquo; reduces the solid, heavy roof to something flimsy and
              weightless, emphasising the disparity between human construction and
              natural force. The effect on the reader is one of awe and helplessness:
              if a roof is a &lsquo;playing card&rsquo;, then human beings are even
              more insignificant. This sense of human vulnerability is central to the
              poem&rsquo;s exploration of nature&rsquo;s indifference.
            </p>
          </div>
        ...
        <section aria-labelledby="worked-prose-heading">
          ...
          <div className="mt-4 rounded-lg border-l-4 border-primary bg-card p-5 shadow-md">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              ...
              that &ldquo;not one face turned towards her&rdquo;. The juxtaposition of
              physical proximity and emotional distance is striking: the crowd becomes
              a mass of indifference rather than a source of connection. The writer&rsquo;s
              choice of the word &lsquo;thick&rsquo; to describe the crowd is
              significant &mdash; it suggests something oppressive and impenetrable,
              as though the people form a barrier rather than a community. The short
              sentence that follows &mdash; &ldquo;She stopped walking.&rdquo; &mdash;
              creates a moment of stillness that interrupts the bustling pace of the
              previous paragraph, mirroring the character&rsquo;s sense of being out
              of step with the world around her.
            </p>
          </div>
          ...
          <div className="mt-4 rounded-lg border border-primary/20 bg-primary/5 p-5">
            ...
            <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
              ...
              <li>&bull; Does not retell the story; focuses entirely on HOW the writer creates the effect</li>
            </ul>
          </div>
        </section>
        ...
        <section aria-labelledby="toolkit-heading">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            {[
              { term: "Metaphor", def: "Describing something as if it is something else. Creates vivid imagery and invites comparison." },
              { term: "Simile", def: "Comparison using 'like' or 'as'. Makes abstract ideas concrete and accessible." },
              { term: "Personification", def: "Giving human qualities to non-human things. Creates atmosphere and emotional connection." },
              { term: "Alliteration", def: "Repetition of initial consonant sounds. Can create rhythm, emphasis, or mimic sounds." },
              { term: "Sibilance", def: "Repetition of 's' sounds. Often creates a sinister, whispering, or soothing effect." },
              { term: "Onomatopoeia", def: "Words that imitate sounds ('crash', 'whisper'). Creates a sensory, immersive experience." },
              { term: "Enjambment", def: "A sentence running over a line break. Creates momentum, urgency, or a sense of overflow." },
              { term: "Caesura", def: "A pause within a line (often a full stop or comma). Creates emphasis, hesitation, or a shift in thought." },
              { term: "Oxymoron", def: "Two contradictory words together ('bitter sweet'). Creates tension and complexity." },
              { term: "Juxtaposition", def: "Placing contrasting ideas side by side. Highlights differences and creates meaning through contrast." },
              { term: "Pathetic fallacy", def: "Weather or setting reflecting mood. Externalises characters' emotions through the environment." },
              { term: "Symbolism", def: "An object or image representing a deeper meaning. Adds layers of significance beyond the literal." },
              { term: "Tone", def: "The writer's attitude towards the subject. Can be ironic, tender, angry, reflective, etc." },
              { term: "Volta", def: "A turning point in a poem, especially a sonnet. Signals a shift in argument, mood, or perspective." },
              { term: "Anaphora", def: "Repetition of a word or phrase at the start of successive lines. Creates emphasis and rhythm." },
              { term: "Semantic field", def: "A group of words related to the same topic (e.g., war, religion). Creates a sustained atmosphere." },
            ].map((t) => (
              <div
                key={t.term}
