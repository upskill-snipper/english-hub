      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Characters, themes, part-by-part summary with key quotations, Achebe&rsquo;s narrative
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section id="narrative-techniques" aria-labelledby="techniques-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Achebe&rsquo;s techniques are essential for Writer's Methods (analysis of language,
            form, and structure). Markers reward responses that discuss <em>how</em> Achebe creates
              ...
              <Card key={ao.code}>
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-base">{ao.description}</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-sm leading-relaxed text-muted-foreground">{ao.guidance}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <section id="exam-guidance" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cambridge IGCSE Things Fall Apart questions appear in Paper 2 (Prose). You will choose
            between a passage-based (a) question and an essay (b) question. Below are examples of
            both types with guidance.
          </p>
          ...
          <div className="mt-6 space-y-6">
            <Card>
              ...
              <CardContent>
                <p className="text-sm font-medium text-foreground">
                  Re-read the passage in Chapter 24 from &ldquo;Okonkwo stood looking at the dead
                  man&rdquo; to the end of the chapter. How does Achebe make this such a powerful
                  and significant moment in the novel?
                </p>
                <div className="mt-3 rounded bg-primary/5 p-3">
                  ...
                  <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                    <li>
                      &bull; Work through the passage closely, identifying key language choices and
                      their effects
                    </li>
                    <li>
                      &bull; Analyse the shift from Okonkwo&rsquo;s decisive action to the
                      clan&rsquo;s paralysis
                    </li>
                    <li>
                      &bull; Discuss how Achebe uses the moment to reveal Okonkwo&rsquo;s isolation
                      from his community
                    </li>
                    <li>
                      &bull; Consider structural significance: this is the climactic action that
                      leads to Okonkwo&rsquo;s suicide
                    </li>
                    <li>&bull; Link to the theme of individual will vs communal decision-making</li>
                    <li>
                      &bull; Use terminology: dramatic irony, narrative perspective, foreshadowing,
                      tragic climax
                    </li>
                  </ul>
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm font-medium text-foreground">
                  How does Achebe present the effects of colonialism on Igbo society in Things Fall
                  Apart?
                </p>
                <div className="mt-3 rounded bg-primary/5 p-3">
                  <p className="text-xs font-semibold text-foreground">How to approach:</p>
                  <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                    ...
                    <li>
                      &bull; Contrast Parts 1&ndash;2 (Igbo society intact) with Part 3 (society
                      disintegrating)
                    </li>
                    <li>
                      &bull; Track the escalation: Mr Brown&rsquo;s compromise &rarr; Reverend
                      Smith&rsquo;s intolerance &rarr; the District Commissioner&rsquo;s force
                    </li>
                    <li>
                      &bull; Discuss Achebe&rsquo;s methods: structural irony of the final chapter,
                      Igbo proverbs contrasted with colonial language, the three-part structure
                    </li>
                    <li>
                      &bull; Reference context: Achebe writing against colonial narratives (Conrad,
                      the Commissioner&rsquo;s book)
                    </li>
                    <li>
                      &bull; Show awareness of how colonialism affects individuals (Okonkwo, Nwoye)
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm font-medium text-foreground">
                  How does Achebe use the character of Okonkwo to explore ideas about masculinity
                  and identity?
                </p>
                <div className="mt-3 rounded bg-primary/5 p-3">
                  <p className="text-xs font-semibold text-foreground">How to approach:</p>
                  <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                    <li>
                      &bull; Establish Okonkwo&rsquo;s fear of his father as the psychological
                      foundation
                    </li>
                    <li>
                      &bull; Track how this fear drives his actions: the killing of Ikemefuna, his
                      treatment of Nwoye, his attitude to Ezinma
                    </li>
                    <li>
                      &bull; Contrast Okonkwo&rsquo;s rigid masculinity with Obierika&rsquo;s
                      flexibility
                    </li>
                    <li>
                      &bull; Discuss the irony of his suicide: the ultimate &lsquo;unmanly&rsquo;
                      act by his own standards
                    </li>
                    <li>
                      &bull; Link masculinity to colonialism: both impose rigid categories that deny
                      complexity
                    </li>
                    <li>
                      &bull; Discuss Achebe&rsquo;s purpose: not to condemn Okonkwo but to show how
                      cultural pressures distort identity
                    </li>
                  </ul>
                </div>
              </CardContent>
              ...
              <CardContent className="pt-5">
                ...
                <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                  <li>
                    ...
                    outward to the rest of the novel and relevant context.
                  </li>
                  <li>
                    <strong className="text-foreground">Essay (b) questions:</strong> Plan before
                    you write. Select 3&ndash;4 key moments from across the novel with quotations.
                    Focus on Achebe&rsquo;s methods and purpose, not just what happens. Integrate
                  ...
                  <li>
                    ...
                    Write &ldquo;Achebe presents...&rdquo; or &ldquo;Achebe uses...&rdquo; rather
                    than &ldquo;the novel shows...&rdquo;. This demonstrates awareness of authorial
                    intent and helps you discuss methods (Writer's Methods).
                  </li>
                  <li>
                    <strong className="text-foreground">Igbo cultural context:</strong> Show
                    understanding of Igbo customs, beliefs, and social structures. Explain terms
                    like chi, egwugwu, and osu when you use them. This demonstrates Textual
                    Knowledge and Interpretation contextual understanding.
                  </li>
                  <li>
                    <strong className="text-foreground">Postcolonial context:</strong> Achebe wrote
                    this novel in 1958, two years before Nigerian independence, as a deliberate
                    response to European representations of Africa. This context is essential for
                    every answer.
                  </li>
                  <li>
                    <strong className="text-foreground">Quote precisely:</strong> Short, embedded
                    quotations (&lsquo;a knife on the things that held us together&rsquo;) are more
                    effective than long block quotes. Aim for at least one quotation per paragraph.
                  </li>
                </ul>
              </CardContent>
            </Card>
          ...
          <Card className="mt-6">
            <CardHeader>
              <CardTitle className="text-base">
                Question: How does Achebe present the impact of colonialism on Igbo culture in the
                final chapters of Things Fall Apart?
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="rounded bg-primary/5 p-4">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Achebe presents colonialism&rsquo;s most devastating impact not through violence
                  but through narrative erasure.{' '}
                  <strong className="text-foreground">[Textual Knowledge]</strong> In the
                  novel&rsquo;s final paragraphs, the District Commissioner reflects that
                  Okonkwo&rsquo;s story &lsquo;would make interesting reading&rsquo; and might merit
                  &lsquo;not a whole chapter but a reasonable paragraph&rsquo; in his planned book,{' '}
                  <em>The Pacification of the Primitive Tribes of the Lower Niger</em>.{' '}
                  <strong className="text-foreground">[Writer's Methods]</strong> Achebe uses a
                  sudden, jarring shift in narrative perspective from the intimate, Igbo-centred
                  voice that has governed the entire novel to the cold, detached viewpoint of the
                  colonial administrator. The diminishing scale &mdash; from &lsquo;chapter&rsquo;
                  to &lsquo;paragraph&rsquo; &mdash; structurally enacts the process of cultural
                  reduction, while the Commissioner&rsquo;s title, with its dehumanising word
                  &lsquo;Primitive&rsquo;, reveals the ideology that underpins colonial power.{' '}
                  <strong className="text-foreground">[Interpretation]</strong> Writing in 1958, two
                  years before Nigerian independence, Achebe was responding to a tradition of
                  European literature &mdash; including Joseph Conrad&rsquo;s{' '}
                  <em>Heart of Darkness</em> &mdash; that represented Africa as a place without
                  history or civilisation. By spending the entire novel building the richness and
                  complexity of Igbo culture, only to show it dismissed in a single sentence, Achebe
                  forces the reader to recognise the violence inherent in colonial storytelling.{' '}
                  <strong className="text-foreground">[Personal Response]</strong> The structural
                  irony of this ending &mdash; the Commissioner plans to write about Africa, but
                  Achebe has already written the book that exposes the inadequacy of such accounts
                  &mdash; transforms the act of reading <em>Things Fall Apart</em> itself into an
                  act of resistance against colonial erasure.
                </p>
              </div>
            </CardContent>
          </Card>
