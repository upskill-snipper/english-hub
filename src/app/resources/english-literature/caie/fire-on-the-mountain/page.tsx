    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Anita Desai&rsquo;s haunting novella of isolation, illusion, and destruction. Character
            analysis, themes, chapter summaries with key quotations, narrative techniques, context,
            and Cambridge exam guidance.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section id="chapter-summary" aria-labelledby="chapter-heading">
          <h2 id="chapter-heading" className="text-2xl font-bold text-foreground">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {ch.quotes.map((q, i) => (
                      <div
                        key={i}
                        className="rounded-lg border-s-4 border-red-700 bg-primary/5 p-4"
                      >
          ...
          <div className="mt-6 space-y-4">
            {contextItems.map((ctx) => (
              <Card key={ctx.title}>
                ...
                <CardContent>
                  <p className="text-sm leading-relaxed text-muted-foreground">{ctx.detail}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <section id="exam-guidance" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            <em>Fire on the Mountain</em> appears as a prose text in Cambridge IGCSE English
            Literature. You will choose between a passage-based (a) question and a discursive essay
            (b) question.
          </p>
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    &bull; You will be given a printed extract and asked how Desai creates a
                    particular effect (e.g. tension, sympathy, atmosphere).
                  </li>
                  <li>
                    &bull; Work through the passage <strong>sequentially</strong>, identifying
                    specific words and phrases.
                  </li>
                  <li>
                    &bull; Analyse <strong>language</strong> (imagery, word choice, sentence
                    structure) and <strong>narrative method</strong> (point of view, free indirect
                    discourse, pace).
                  </li>
                  <li>
                    &bull; Comment on how the passage connects to the <strong>wider novel</strong>{' '}
                    &mdash; what comes before and after.
                  </li>
                  <li>
                    &bull; Embed short, precise quotations from the extract and analyse them
                    closely.
                  </li>
                </ul>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    &bull; These ask you to discuss a theme, character, or technique across the{' '}
                    <strong>whole novel</strong>.
                  </li>
                  <li>
                    &bull; Plan 3&ndash;4 key points, each supported by{' '}
                    <strong>precise quotations</strong> from different parts of the text.
                  </li>
                  <li>
                    &bull; Always discuss Desai&rsquo;s <strong>methods</strong> (how she writes),
                    not just what happens (plot).
                  </li>
                  <li>
                    &bull; Show awareness of the novel&rsquo;s <strong>structure</strong>: how the
                    opening and ending relate, how tension builds, how parallel narratives converge.
                  </li>
                  <li>
                    &bull; Where relevant, reference <strong>context</strong> (postcolonial India,
                    gender, the hill-station setting) to deepen your analysis.
                  </li>
                </ul>
              </CardContent>
            </Card>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-lg bg-primary/5 p-3">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    Show detailed knowledge of the text. Use accurate, well-selected quotations and
                    references to support every point.
                  </p>
                </div>
                <div className="rounded-lg bg-primary/5 p-3">
                  <p className="text-xs font-semibold text-foreground">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    Analyse how Desai uses language (imagery, diction, syntax), form (novella,
                    stream of consciousness), and structure (foreshadowing, parallel narratives, the
                    climactic ending).
                  </p>
                </div>
                <div className="rounded-lg bg-primary/5 p-3">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    Compare characters (Nanda vs Raka, Nanda vs Ila Das), contrasting their
                    responses to isolation, truth, and violence.
                  </p>
                </div>
                <div className="rounded-lg bg-primary/5 p-3">
                  <p className="text-xs font-semibold text-foreground">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    Reference postcolonial India, patriarchal social structures, the hill-station as
                    a colonial legacy, and the constraints on women&rsquo;s independence.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="mt-6">
            <CardHeader>
              ...
              <CardDescription className="mt-2 text-sm font-medium text-foreground">
                How does Desai present the theme of isolation in <em>Fire on the Mountain</em>?
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="rounded-lg border border-border bg-primary/5 p-5">
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  ...
                  isolation in the novel&rsquo;s opening pages through the stark declaration that
                  &ldquo;she wanted nothing. She wanted no one&rdquo;, a line whose blunt repetition
                  and negation convey not peace but a willed erasure of human connection.{' '}
                  <strong>[Writer's Methods]</strong> The short, declarative syntax mirrors
                  Nanda&rsquo;s desire for a simplified, emptied existence, while the anaphoric
                  repetition of &ldquo;she wanted&rdquo; ironically reveals that her withdrawal is
                  itself a form of intense wanting &mdash; a craving for absence. Desai reinforces
                  this through the novella&rsquo;s structure: Nanda&rsquo;s solitude is
                  systematically disrupted, first by Raka&rsquo;s arrival, then by Ila Das&rsquo;s
                  visit, and finally by the phone call announcing Ila Das&rsquo;s murder. Each
                  intrusion strips away another layer of Nanda&rsquo;s carefully constructed
                  detachment, so that the narrative arc itself enacts the impossibility of true
                  isolation. <strong>[Interpretation]</strong> Desai draws a pointed contrast
                  between Nanda&rsquo;s performed isolation and Raka&rsquo;s instinctive withdrawal.
                  Where Nanda tells stories about her past to win Raka&rsquo;s attention &mdash;
                  revealing that she still craves an audience &mdash; Raka &ldquo;did not
                  listen&rdquo; and moves instead to &ldquo;the edge of the ridge&rdquo;, drawn to
                  the gorge and the wild. Raka&rsquo;s isolation needs no justification or
                  narrative; it simply is. <strong>[Personal Response]</strong> Contextually,
                  Nanda&rsquo;s withdrawal must be read against the limited roles available to women
                  in postcolonial India: having spent a lifetime defined entirely by her function as
                  wife, mother, and hostess in the Vice-Chancellor &rsquo;s household, her
                  retirement to Carignano &mdash; a crumbling former colonial hill-station house
                  &mdash; represents an attempt to reclaim an identity that was never truly her own.
                  Desai suggests, however, that this reclamation comes too late: Nanda has no
                  authentic self left to inhabit, only the illusions she has constructed to survive.
                </p>
              </div>
            </CardContent>
          </Card>
