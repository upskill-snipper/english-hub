...
export const metadata: Metadata = {
  openGraph: {
    ...
    description:
      'Wind by Ted Hughes (1957) for Cambridge IGCSE 0475, Songs of Ourselves Volume 1: the poet, themes, form, structure and notes for study.',
    images: [
      {
        url: '/api/og?title=Wind+-+Ted+Hughes+%7C+Cambridge+IGCSE+0475',
        width: 1200,
        height: 630,
        alt: 'Wind - Ted Hughes | Cambridge IGCSE 0475',
      },
    ],
  },
  title: 'Wind - Ted Hughes | Cambridge IGCSE 0475',
