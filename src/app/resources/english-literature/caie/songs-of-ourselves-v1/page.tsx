...
const poems: PoemData[] = [
  ...
  },
  {
    ...
    keyQuotations: [
      {
        quote: "When my mother died I was very young, / And my father sold me while yet my tongue / Could scarcely cry 'weep! 'weep! 'weep! 'weep!",
        analysis:
      ...
      {
        quote: "There's little Tom Dacre, who cried when his head, / That curled like a lamb's back, was shaved",
        analysis:
  ...
  },
  {
    ...
    keyQuotations: [
      ...
      {
        quote: "Every tree is sacred / ... You must learn how to turn the pages gently / without offending the tree",
        analysis:
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-primary to-primary px-4 py-16 text-white sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/90">
            A comprehensive guide to the CAIE poetry anthology. Detailed analysis of six
            key poems with context, quotations, comparison techniques, and assessment
            objective guidance for Paper 1.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section aria-labelledby="overview-heading">
          ...
          <Card className="mt-6">
            <CardHeader>
              ...
              <CardDescription>
                Cambridge International Poetry Anthology
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 text-sm text-muted-foreground">
              <p>
                <strong className="text-foreground">Songs of Ourselves Volume 1</strong>{" "}
                is the set poetry anthology for Cambridge IGCSE English Literature
                (0475) and Cambridge O Level Literature in English (2010). It contains
                poems spanning six centuries, from Shakespeare to contemporary poets,
              ...
              <p>
                ...
                poet&rsquo;s methods, and personal engagement with the text.
              </p>
              <div className="rounded-lg border border-border bg-muted/50 p-4">
                ...
                <ul className="mt-2 space-y-1">
                  <li>
                    &bull; You will study a selection of poems from the anthology, not
                    all of them
                  </li>
                  <li>
                    &bull; Questions may focus on a single poem or ask you to compare
                    two poems
                  </li>
                  <li>
                    &bull; The poems are <strong>not</strong> provided in the exam
                    &mdash; you must know them from memory
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    narrative &mdash; focus on how and why, not what happens
                  </li>
                </ul>
              </div>
            </CardContent>
        ...
        <section aria-labelledby="poems-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Each analysis covers context, form &amp; structure, key quotations with
            commentary, detailed analysis points, and exam tips. These six poems
            represent the range of periods, cultures, and themes in the anthology.
          </p>
        ...
        <section aria-labelledby="comparison-heading">
          ...
          <Card className="mt-6">
            <CardHeader>
              ...
              <CardDescription>
                Cambridge rewards sustained, woven comparison &mdash; not
                &ldquo;Poem A then Poem B&rdquo;
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 text-sm text-muted-foreground">
              <div className="rounded-lg border border-border bg-muted/50 p-4">
                ...
                <ol className="mt-2 list-inside list-decimal space-y-1">
                  <li>
                    Open with a thesis that identifies the key similarity or
                    difference between the two poems
                  </li>
                  <li>
                    Analyse a technique or theme in Poem A, then immediately
                    compare it with the equivalent in Poem B
                  </li>
                  <li>
                    Use comparative connectives throughout: &ldquo;Similarly&rdquo;,
                    &ldquo;In contrast&rdquo;, &ldquo;While... [Poet A]... [Poet
                    B]...&rdquo;, &ldquo;Both poets... however...&rdquo;
                  </li>
                  <li>
                    Conclude by evaluating which poem is more effective or how
                ...
                <div className="mt-2 grid gap-2 sm:grid-cols-2">
                  {[
                    ...
                    },
                    {
                      label: "Tone & mood",
                      detail:
                        "Is the tone celebratory, elegiac, angry, reflective, ironic?",
                    },
                    {
        ...
        <p className="mt-8 rounded-lg border border-border bg-muted/50 p-4 text-xs text-muted-foreground">
          <strong className="text-foreground">Disclaimer:</strong> This resource
          is an independent study aid and is not endorsed by or affiliated with
          Cambridge Assessment International Education (CAIE). All poem
          references are for educational analysis purposes. Exam board
