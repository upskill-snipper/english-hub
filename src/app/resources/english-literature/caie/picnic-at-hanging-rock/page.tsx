  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <nav className="mb-6 text-sm text-muted-foreground">
        ...
        {' / '}
        <span className="text-foreground">{tr(`Picnic at Hanging Rock`)}</span>
      </nav>
      ...
      <div className="space-y-12">
        {/* ───────────────────────── CONTEXT ───────────────────────── */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">Context</h2>

          <div className="grid gap-4 sm:grid-cols-2">
            <Card>
              <CardHeader>
                <CardTitle>{tr(`Historical Setting`)}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                ...
                <p>
                  Lindsay published the novel in 1967 but deliberately presented it as though it
                  were a factual account, blurring the boundary between fiction and reality. The
                  famous prefatory note &mdash; &ldquo;Whether{' '}
                  <em>{tr(`Picnic at Hanging Rock`)}</em> is fact or fiction, my readers must decide
                  for themselves&rdquo; &mdash; has fuelled decades of speculation.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{tr(`Australian Colonial Society`)}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  Turn-of-the-century Australia was still heavily shaped by British cultural
                  expectations. Appleyard College, with its rigid dress codes, French lessons, and
                  emphasis on deportment, represents the transplantation of{' '}
                  <strong className="text-foreground">{tr(`European values`)}</strong> onto an
                  ancient, indifferent landscape.
                </p>
                <p>
                  The collision between the ordered Victorian world and the wild Australian bush is
                  central to the novel&rsquo;s meaning. Lindsay suggests the land itself resists
            ...
            <Card className="sm:col-span-2">
              <CardHeader>
                <CardTitle>{tr(`Boarding School Life`)}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  Appleyard College is a private girls&rsquo; boarding school run by the
                  authoritarian Mrs Appleyard. The school imposes strict routines &mdash; corseted
                  uniforms, surveillance, and a curriculum designed to produce
                  &ldquo;accomplished&rdquo; young women suitable for marriage. This environment of
                  repression intensifies the novel&rsquo;s themes of sexuality, freedom, and escape.
                  The girls who vanish on the Rock can be read as escaping the constraints placed
                  upon them by patriarchal Victorian society.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        {/* ───────────────────────── CHARACTERS ───────────────────────── */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">Character Analysis</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  otherworldly. She is repeatedly compared to a &ldquo;
                  <strong className="text-foreground">{tr(`Botticelli angel`)}</strong>&rdquo; and
                  associated with nature and light. Her calm acceptance of the Rock &mdash;
                  &ldquo;Everything begins and ends at exactly the right time and place&rdquo;
                  &mdash; suggests she is attuned to forces beyond rational understanding.
                </p>
                <p>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  Irma is the only one of the missing party to be found alive, yet she has no memory
                  of what happened. Her survival deepens the mystery rather than resolving it. She
                  is associated with wealth and sensuality &mdash; her &ldquo;little gold
                  watch&rdquo; and expensive clothes symbolise the material world.
                </p>
                <p>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{tr(`Marion Quade`)}</CardTitle>
                <CardDescription>{tr(`The rational mind`)}</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  Miss McCraw is the school&rsquo;s mathematics mistress: austere, logical, and
                  physically ungainly. She is the only adult to vanish. Her disappearance is
                  particularly unsettling because she represents adult authority and scientific
                  rationality &mdash; if she cannot resist the Rock&rsquo;s pull, nobody can.
                </p>
                <p>
                  She is last seen striding purposefully up the Rock without her skirt, a disturbing
                  image that suggests the stripping away of civilised propriety. Her fascination
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  Sara is a vulnerable orphan whose intense, devoted attachment to Miranda gives her
                  emotional life its only anchor. She is forbidden from attending the picnic as
                  punishment, and this exclusion becomes the defining trauma of her short life. Her
                  poetry and emotional sensitivity set her apart from the school&rsquo;s conformist
                  culture.
                </p>
                <p>
                  Sara&rsquo;s eventual death &mdash; which Mrs Appleyard attempts to disguise
                  &mdash; exposes the cruelty beneath the College&rsquo;s respectable facade. She is
            ...
            <Card>
              <CardHeader>
                <CardTitle>{tr(`Mrs Appleyard`)}</CardTitle>
                <CardDescription>
                  The headmistress &mdash; authority, hypocrisy, and collapse
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  Mrs Appleyard is the authoritarian headmistress whose rigid control over the
                  school mirrors the broader colonial project of imposing order on chaos. She is
                  physically imposing, emotionally cold, and increasingly reliant on alcohol as the
                  crisis deepens.
                </p>
                <p>
                  Her background is deliberately obscure &mdash; &ldquo;nobody knew where she came
                  from&rdquo; &mdash; which undermines her claims to respectability. As the school
                  disintegrates, so does she, culminating in Sara&rsquo;s death and her own demise
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  Michael is a young English aristocrat visiting his uncle&rsquo;s property at Lake
                  View. He glimpses the girls at the Rock and becomes obsessed with finding Miranda,
                  whom he romanticises as a vision of unattainable beauty.
                </p>
                <p>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  Albert is the young coachman at Colonel Fitzhubert&rsquo;s estate. Unlike the
                  upper-class characters, Albert is practical, unpretentious, and physically
                  capable. He assists Michael in the search and it is Albert who actually discovers
                  Irma on the Rock.
                </p>
                <p>
                  Albert provides a working-class perspective that contrasts with both the
                  College&rsquo;s gentility and Michael&rsquo;s aristocratic background. His
                  connection to Sara &mdash; later revealed to be his long-lost sister &mdash; adds
        ...
        {/* ───────────────────────── THEMES ───────────────────────── */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">Key Themes</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  The novel&rsquo;s central mystery &mdash; what happened to the girls and Miss
                  McCraw &mdash; is never resolved. Lindsay deliberately withholds explanation,
                  suggesting that some things lie beyond human comprehension. This refusal to
                  provide closure challenges the reader&rsquo;s desire for rational answers and
            ...
            <Card>
              <CardHeader>
                <CardTitle>{tr(`Nature vs Civilisation`)}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  primordial rock formation &mdash; dramatises the fragility of European
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  The Valentine&rsquo;s Day setting foregrounds desire and romance. The girls are
                  presented as sexually awakening figures &mdash; their beauty is observed and
                  desired by Michael, while their close physical bonds (Miranda and Sara, the girls
                  sleeping together) hint at homoerotic attachment. The school&rsquo;s repressive
                  environment intensifies these undercurrents. The Rock itself is described in terms
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  multiple responses to loss: Michael&rsquo;s romantic obsession, Sara&rsquo;s
                  silent despair, Mrs Appleyard&rsquo;s institutional panic, and the town&rsquo;s
                  morbid curiosity. The absence of bodies means grief cannot follow its normal
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  The Rock is implicitly sacred Indigenous land, yet Lindsay&rsquo;s characters
                  never acknowledge Aboriginal presence or history. This silence is itself
                  significant: the colonists&rsquo; ignorance of the land&rsquo;s deep history
                  leaves them unprepared for its power. The novel can be read as an allegory of
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                ...
                <p>
                  The famous &ldquo;Chapter 18&rdquo; (the final chapter that Lindsay originally
                  wrote but was persuaded to remove) was published posthumously, but even it
                  provides no definitive resolution.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{tr(`Unreliable Narration`)}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  limited, unreliable perspectives of Edith and distant observers. Gaps in knowledge
                  are built into the novel&rsquo;s structure.
                </p>
                <p>
                  Lindsay also uses reported speech and newspaper accounts within the narrative,
                  layering unreliable sources to create an epistemological crisis: nobody &mdash;
                  narrator, characters, or readers &mdash; truly knows what happened.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{tr(`Gothic Atmosphere`)}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                  Lindsay draws on the tradition of the{' '}
                  <strong className="text-foreground">Australian Gothic</strong>: the bush as a
                  place of terror rather than pastoral beauty. She uses dreamlike, hypnotic prose to
                  create a sense of mounting unease. Sensory details &mdash; the oppressive heat,
                  the buzzing of insects, the strange silence &mdash; build an atmosphere where the
                  boundary between the ordinary and the uncanny dissolves.
                </p>
                <p>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{tr(`Australian Landscape as Character`)}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
            ...
            <Card className="sm:col-span-2">
              <CardHeader>
                <CardTitle>{tr(`The Unresolved Ending`)}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                <p>
                ...
                <p>
                  ...
                  (Interpretation): Lindsay <em>chooses</em> not to resolve the mystery because
                  resolution would undermine the novel&rsquo;s philosophical and thematic concerns.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        {/* ──────────────── CAIE EXAM GUIDANCE ──────────────── */}
        <section>
          <h2 className="text-2xl font-semibold text-foreground mb-4">CAIE Exam Guidance</h2>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                ...
                <ul className="list-disc space-y-1.5 pl-5">
                  ...
                  <li>
                    <strong className="text-foreground">Structure:</strong> sentence length and
                    rhythm, paragraph breaks, shifts in perspective, use of dialogue vs narration.
                  </li>
                  <li>
                    <strong className="text-foreground">{tr(`Narrative perspective:`)}</strong>{' '}
                    whose viewpoint is presented? What is withheld? How does Lindsay control reader
                    access to information?
                  </li>
                  <li>
                    <strong className="text-foreground">Atmosphere:</strong> how do language and
                    structure combine to create mood (dreamlike, threatening, elegiac,
                    claustrophobic)?
                  </li>
                </ul>
                <p className="mt-2 font-medium text-foreground">
                  Always embed short quotations from the extract and analyse individual word
                  choices. Avoid feature-spotting &mdash; link every technique to its effect on the
                  reader.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-muted-foreground leading-relaxed">
                ...
                <ul className="list-disc space-y-1.5 pl-5">
                  ...
                  <li>
                    <strong className="text-foreground">Range across the text:</strong> refer to
                    events and quotations from different parts of the novel.
                  </li>
                  <li>
                    <strong className="text-foreground">{tr(`Analyse language:`)}</strong> even in
                    essay questions, close analysis of quotations is expected.
                  </li>
                  <li>
                    <strong className="text-foreground">Consider context:</strong> link your points
                    to the novel&rsquo;s historical and social context (colonial Australia, 1900,
                    gender norms).
                  </li>
                  <li>
                    <strong className="text-foreground">{tr(`Address authorial intent:`)}</strong>{' '}
                    discuss <em>why</em> Lindsay presents characters, events, or themes in
                    particular ways.
                  </li>
                </ul>
                <p className="mt-2 font-medium text-foreground">
                  The best answers integrate all four Assessment Objectives fluidly rather than
          ...
          <Card className="mt-4">
            <CardHeader>
              <CardTitle>{tr(`CAIE Assessment Objectives`)}</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <table className="w-full text-sm text-muted-foreground">
                  ...
                  <tbody className="divide-y divide-border/40">
                    ...
                    <tr>
                      ...
                      <td className="py-2.5">
                        Analyse the ways in which writers use language, structure, and form to
            ...
            <CardContent className="space-y-5 text-muted-foreground leading-relaxed">
              <div className="rounded-lg bg-muted/50 p-4 border border-border/40">
                <p className="font-medium text-foreground">
                  &ldquo;Hanging Rock is the most important character in the novel.&rdquo; How far
              ...
              <div>
                ...
                <div className="rounded-lg bg-muted/30 p-4 border border-border/40 space-y-3">
                  ...
                  <p>
                    ...
                    1967, Lindsay drew on growing Australian anxieties about the relationship
                  ...
                  <p>
                    However, while the Rock is undoubtedly a powerful presence, calling it
                    &ldquo;the most important character&rdquo; risks diminishing the human tragedy
                    at the novel&rsquo;s heart. Sara&rsquo;s death, Mrs Appleyard&rsquo;s
                    psychological disintegration, and Michael&rsquo;s obsessive grief are driven by
