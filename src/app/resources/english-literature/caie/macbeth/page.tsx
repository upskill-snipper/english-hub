...
const plotSummary = [
  {
    ...
    keyQuotations: [
      ...
      {
        quote: 'Stars, hide your fires; / Let not light see my black and deep desires',
        context: 'Macbeth - ambition emerges',
      },
  ...
  },
  {
    ...
    keyQuotations: [
      {
        quote: 'Is this a dagger which I see before me, / The handle toward my hand?',
        context: 'Macbeth - hallucination, guilt',
      },
      {
        quote: "Will all great Neptune's ocean wash this blood / Clean from my hand?",
        context: 'Macbeth - permanence of guilt',
      },
      {
        quote: 'A little water clears us of this deed',
        context: 'Lady Macbeth - pragmatic dismissal (ironic in hindsight)',
      },
    ],
  },
  {
    ...
    scenes: [
      ...
      },
      {
        scene: 'Scene 3',
        summary:
          "The murderers kill Banquo but Fleance escapes, preserving the witches' prophecy about Banquo's line.",
      },
      {
        scene: 'Scene 4',
        summary:
    ...
    keyQuotations: [
      {
        quote: 'O, full of scorpions is my mind, dear wife!',
        context: 'Macbeth - paranoia, deteriorating relationship',
      },
  ...
  },
  {
    ...
    keyQuotations: [
      ...
      {
        quote: 'He has no children. All my pretty ones?',
        context: 'Macduff - raw grief, human cost of tyranny',
      },
    ],
  },
  {
    ...
    scenes: [
      ...
      },
      {
        scene: 'Scene 2',
        summary:
          "Scottish lords join Malcolm's forces, describing Macbeth's rule as a disease afflicting Scotland.",
      },
      {
        scene: 'Scene 3',
        summary:
      ...
      },
      {
        scene: 'Scene 4',
        summary:
          'Malcolm orders soldiers to cut branches from Birnam Wood for camouflage, fulfilling the prophecy literally.',
      },
      {
        scene: 'Scene 5',
        summary:
    ...
    keyQuotations: [
      {
        quote: 'Out, damned spot! Out, I say!',
        context: 'Lady Macbeth - guilt, psychological collapse',
      },
      {
        quote: 'Tomorrow, and tomorrow, and tomorrow',
        context: 'Macbeth - nihilism, life is meaningless',
      },
      { quote: 'Turn, hell-hound, turn!', context: 'Macduff - retribution' },
      {
        quote: 'This dead butcher and his fiend-like queen',
        context: 'Malcolm - reductive political label',
      },
    ],
  },
]
...
const assessmentObjectives = [
  ...
  },
  {
    ...
    description: 'Develop a personal and informed response to the text.',
    howToMeet:
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Comprehensive CAIE-specific revision: act-by-act analysis, character studies, thematic
            exploration, 23 key quotations with analysis, language and structural techniques, and
            full exam guidance covering passage-based and essay questions with all four Assessment
            Objectives.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        {activeTab === 'plot' && (
          <section aria-labelledby="plot-heading">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Each act includes a scene-by-scene breakdown and key quotations for revision.
            </p>
              ...
              {plotSummary.map((act) => (
                ...
                >
                  <div className="space-y-3">
                    {act.scenes.map((s) => (
                      <div key={s.scene}>
                        <h4 className="text-sm font-semibold text-foreground">{s.scene}</h4>
        ...
        {activeTab === 'characters' && (
          <section aria-labelledby="characters-heading">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              In-depth analysis of each major character with key quotations, character arcs, and
              exam tips.
            </p>
              ...
              {characters.map((c) => (
                <Card key={c.name}>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-foreground">Character Arc</h4>
                      <p className="mt-1 text-sm leading-relaxed text-muted-foreground">{c.arc}</p>
                    </div>
                    <div>
        ...
        {activeTab === 'themes' && (
          <section aria-labelledby="themes-heading">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Each theme includes detailed analysis, key moments, and related quotations you can use
              in exam responses.
            </p>
            <div className="mt-6 space-y-5">
              {themes.map((t) => (
        ...
        {activeTab === 'quotes' && (
          <section aria-labelledby="quotes-heading">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              ...
              Cambridge IGCSE responses. These quotations cover every act and all major themes.
            </p>
            <div className="mt-6 space-y-5">
              {keyQuotes.map((q, i) => (
        ...
        {activeTab === 'language' && (
          <section aria-labelledby="language-heading">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Detailed analysis of Shakespeare&rsquo;s key techniques in Macbeth. This section
              directly supports Interpretation (language, structure, and form).
            </p>
            <div className="mt-6 space-y-5">
        ...
        {activeTab === 'context' && (
          <section aria-labelledby="context-heading">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Context supports Writer's Methods. Always connect context to meaning - do not simply
              list facts. Explain how context shapes the audience&rsquo;s response to the play.
            </p>
        ...
        {activeTab === 'exam' && (
          <section aria-labelledby="exam-heading">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              ...
              <strong>Paper 2 (Drama)</strong>. You choose between a passage-based question{' '}
              <strong>(a)</strong> and an essay question <strong>(b)</strong>. Both are worth{' '}
              <strong>25 marks</strong>. Below is detailed guidance on approaching each type,
              followed by a sample question with a model paragraph.
            </p>
            ...
            <div className="mt-8 space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Passage-Based Questions (a)</CardTitle>
                  <CardDescription>
                    You are given a printed extract and asked how Shakespeare creates a particular
                ...
                <CardContent className="space-y-4">
                    ...
                    <ul className="mt-2 space-y-2 text-sm text-muted-foreground">
                      ...
                      <li className="flex">
                        ...
                        <span>
                          ...
                          rhetorical questions, alliteration, sibilance, caesura, enjambment. Name
                      ...
                      <li className="flex">
                        ...
                        <span>
                          ...
                          lines shared between characters? Is there a shift in tone or register?
                        </span>
                      </li>
                      <li className="flex">
                        ...
                        <span>
                          ...
                          or later events? This shows Textual Knowledge but keep it concise - the
                          passage is the focus.
                        </span>
                      </li>
                      <li className="flex">
                  ...
                  <div className="rounded-lg bg-primary/5 p-4">
                    ...
                    <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                      <li>
                        &bull; Narrating what happens instead of analysing how Shakespeare creates
                        effects
                      </li>
                      <li>&bull; Ignoring large sections of the extract</li>
                      <li>
                        &bull; Identifying techniques without explaining their effect
                        (&ldquo;Shakespeare uses a metaphor&rdquo; is not analysis)
                      </li>
                      <li>
                        &bull; Writing about context at length without connecting it to the passage
                      </li>
                    </ul>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    You write about the whole play in response to a question about a character,
                ...
                <CardContent className="space-y-4">
                    ...
                    <ul className="mt-2 space-y-2 text-sm text-muted-foreground">
                      ...
                      <li className="flex">
                        ...
                        <span>
                          ...
                          Short, embedded quotations are more effective than long block quotes.
                          Always explain why the quotation is significant - what does the language
                          reveal?
                        </span>
                      </li>
                      <li className="flex">
                        ...
                        <span>
                          ...
                          answers that demonstrate awareness of the whole text.
                        </span>
                      </li>
                      <li className="flex">
                        <span className="mr-2 font-bold text-primary">6.</span>
                        <span>
                          ...
                          &ldquo;Shakespeare powerfully suggests&rdquo;. Consider alternative
                          readings.
                        </span>
                      </li>
                    </ul>
                  ...
                  <div className="rounded-lg bg-primary/5 p-4">
                    ...
                    <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                      <li>&bull; Every paragraph directly addresses the question</li>
                      <li>
                        &bull; At least 4&ndash;5 embedded quotations, each analysed for language
                        effect
                      </li>
                      <li>&bull; Awareness of the whole play (beginning, middle, and end)</li>
                      <li>&bull; Context integrated naturally (not bolted on)</li>
                      <li>&bull; Personal response with evaluative language</li>
                      <li>
                        &bull; A conclusion that offers a developed judgement, not just a summary
                      </li>
                    </ul>
                  </div>
                </CardContent>
              ...
              {/* Sample questions */}
              <div>
                <h3 className="text-xl font-bold text-foreground">Sample Exam Questions</h3>
                <div className="mt-4 space-y-4">
                  {[
                    ...
                    <div key={i} className="rounded-lg border border-border bg-card p-5 shadow-md">
                      ...
                      <p className="mt-3 text-sm font-medium text-foreground">{q.question}</p>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Sample Question with Model Paragraph</CardTitle>
                  <CardDescription>
                    Demonstrating how to write a top-band paragraph that addresses all four
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-2 rounded-lg border border-border bg-muted/20 p-4 text-sm leading-relaxed text-muted-foreground">
                      <p>
                        Shakespeare presents guilt as an inescapable and consuming force through the
                        recurring motif of blood. Immediately after Duncan&rsquo;s murder, Macbeth
                        asks, &ldquo;Will all great Neptune&rsquo;s ocean wash this blood / Clean
                        from my hand?&rdquo; (2.2). The hyperbolic reference to
                        &ldquo;Neptune&rsquo;s ocean&rdquo; suggests that Macbeth already recognises
                        the permanence of his crime; the classical allusion elevates his guilt from
                        a personal emotion to a cosmic transgression, reflecting the Jacobean belief
                        that regicide violated the Divine Right of Kings and therefore offended God
                        Himself{' '}
                        <span className="font-semibold text-primary">
                          [Writer's Methods - context]
                        </span>
                        . The rhetorical question form{' '}
                        <span className="font-semibold text-primary">[Interpretation - form]</span>{' '}
                        reveals that this is not a genuine inquiry but a despairing acknowledgement
                        that no amount of cleansing can undo murder. This is powerfully contrasted
                        with Lady Macbeth&rsquo;s dismissive response, &ldquo;A little water clears
                        us of this deed&rdquo; (2.2), where the understatement &ldquo;a little
                        water&rdquo;{' '}
                        <span className="font-semibold text-primary">
                          [Interpretation - language]
                        </span>{' '}
                        reveals her pragmatic refusal to engage with guilt. However, Shakespeare
                        arguably uses this contrast to foreshadow Lady Macbeth&rsquo;s later
                        collapse{' '}
                        <span className="font-semibold text-primary">
                          [Personal Response - personal response]
                        </span>
                        : by Act 5, she is obsessively washing her hands and crying &ldquo;Out,
                        damned spot!&rdquo; (5.1), the very blood she once dismissed now consuming
                        her. The dramatic irony is devastating{' '}
                        <span className="font-semibold text-primary">
                          [Interpretation - structure]
                        </span>
                        : the audience remembers her earlier confidence, making her disintegration
                        all the more powerful. Shakespeare thus suggests that guilt, once incurred
                        through acts of profound moral transgression, cannot be suppressed
                        indefinitely - it will surface, whether as hallucination, madness, or
                        despair{' '}
                        <span className="font-semibold text-primary">
                  ...
                  <div className="rounded-lg bg-primary/5 p-4">
                    ...
                    <ul className="mt-2 space-y-2 text-sm text-muted-foreground">
                      <li>
                        <strong>Textual Knowledge:</strong> Accurate quotations from multiple points
                        in the play, embedded fluently within sentences
                      </li>
                      <li>
                        <strong>Writer's Methods:</strong> Context (Divine Right of Kings)
                        integrated naturally and connected to meaning, not bolted on
                      </li>
                      <li>
                        <strong>Interpretation:</strong> Multiple techniques identified (hyperbole,
                        classical allusion, rhetorical question, understatement, dramatic irony)
                        with effects explained
                      </li>
                      <li>
                        <strong>Personal Response:</strong> Personal response through evaluative
                        language (&ldquo;arguably&rdquo;, &ldquo;powerfully&rdquo;,
                        &ldquo;devastating&rdquo;) and interpretive engagement (&ldquo;Shakespeare
                        thus suggests&rdquo;)
                      </li>
                    </ul>
                  </div>
        ...
        {activeTab === 'aos' && (
          <section aria-labelledby="aos-heading">
            <h2 id="aos-heading" className="text-2xl font-bold text-foreground">
              Assessment Objectives
            </h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Cambridge IGCSE English Literature assesses four skills. Understanding what each one
              requires - and how to demonstrate it - is essential for top-band responses.
            </p>
            <div className="mt-6 space-y-5">
