      ...
      <section className="bg-gradient-to-br from-[#1A5276] to-[#2E86C1] px-4 py-16 text-white sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/90">
            ...
            {keyQuotes.length} key quotes with analysis, Victorian context,
            assessment objectives, and Cambridge-specific exam technique.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section id="context" aria-labelledby="context-heading">
          ...
          <div className="mt-6 space-y-4 text-sm leading-relaxed text-gray-700">
            <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2">
                A Christmas Carol was published in 1843, at the height of the
                Industrial Revolution. Rapid industrialisation had created vast
                wealth for factory owners but appalling conditions for workers:
                overcrowded slums, child labour, and dangerous workplaces.
                Dickens witnessed this inequality first-hand in London and used
                the novella to argue that the wealthy bore a moral
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2">
                The New Poor Law established workhouses as the primary form of
                relief for the destitute. Conditions were deliberately harsh to
                discourage applications: families were separated, diets were
                minimal, and inmates performed monotonous labour. Scrooge&rsquo;s
                reference to &lsquo;prisons&rsquo; and &lsquo;workhouses&rsquo;
                in Stave One directly echoes the language of the Poor Law.
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2">
                The economist Thomas Malthus argued that population growth would
                always outstrip food supply, and that poverty was a natural
                corrective. Scrooge&rsquo;s phrase &lsquo;decrease the surplus
                population&rsquo; directly echoes Malthusian thinking. Dickens
                found this philosophy morally repugnant and used Scrooge to
                expose its inhumanity, particularly when the Ghost of Christmas
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2">
                When Dickens was twelve, his father was imprisoned in the
                Marshalsea debtors&rsquo; prison, and the young Charles was
                sent to work in Warren&rsquo;s Blacking Factory. This
                traumatic experience gave him a lifelong empathy with the poor
                and a horror of destitution. The novella&rsquo;s emotional
                intensity comes partly from personal conviction: Dickens
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2">
                By the 1840s, many older Christmas traditions (communal feasting,
                charity to the poor) were fading. A Christmas Carol is widely
                credited with reviving the cultural importance of Christmas and
                redefining it as a time for family, generosity, and social
                conscience. The novella was an immediate bestseller and has never
                been out of print.
              </p>
            </div>
            <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2">
                Dickens chose the novella form deliberately: it is short enough
                to be read in one sitting (reinforcing its parable-like quality)
                and was priced at five shillings, affordable for the middle
                class. The five-stave structure mirrors a musical composition,
                with the title &lsquo;A Christmas Carol&rsquo; framing the text
                as a song of celebration. The compressed timeframe (Christmas Eve
                to Christmas Day) creates urgency and dramatic intensity.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="exam-questions" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-gray-600">
            ...
            <strong>essay question</strong>. Both carry equal marks (25). Below
            are examples of each type with guidance on how to approach them.
          </p>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <div className="mt-3 rounded bg-[#2E86C1]/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-gray-700">
                  ...
                  <li>
                    &bull; Analyse the cumulative effect of the participle list:
                    &lsquo;squeezing, wrenching, grasping, scraping,
                    clutching&rsquo;
                  </li>
                  <li>
                    &bull; Discuss the narrator&rsquo;s tone: exclamatory,
                    conversational, almost theatrical &mdash; link to the oral
                    storytelling tradition
                  </li>
                  <li>
                    &bull; Explore Dickens&rsquo;s use of weather and
                    temperature imagery to externalise Scrooge&rsquo;s inner
                    coldness
                  </li>
                  <li>
                    &bull; Connect outward: how does this opening characterisation
                    make his transformation in Stave Five more powerful?
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="mt-3 rounded bg-[#2E86C1]/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-gray-700">
                  <li>
                    ...
                    Cratchit family, Ignorance and Want, Scrooge&rsquo;s
                    reformed actions
                  </li>
                  <li>
                    &bull; Analyse Dickens&rsquo;s methods: contrast between
                    Scrooge and the Cratchits, the allegorical children, the
                    transformation structure
                  </li>
                  <li>
                    &bull; Link to context: the 1834 Poor Law, Malthusian
                    economics, Dickens&rsquo;s personal experience of poverty
                  </li>
                  <li>
                    &bull; Consider Dickens&rsquo;s purpose: the novella as
                    social campaigning, aimed at a middle-class readership
                  </li>
                  <li>
                    &bull; Evaluate: does Dickens suggest that social change
                    comes from individual moral transformation or systemic
                    reform?
                  </li>
                </ul>
              </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <div className="mt-3 rounded bg-[#2E86C1]/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-gray-700">
                  ...
                  <li>
                    &bull; Discuss Tiny Tim as a symbol: his disability,
                    innocence, and Christian piety
                  </li>
                  <li>
                    &bull; Note the narrator&rsquo;s tone: warm, admiring, and
                    subtly didactic
                  </li>
                  <li>
                    &bull; Examine how Scrooge&rsquo;s reaction to the scene
                    shows his developing empathy
                  </li>
                  <li>
                    &bull; Connect outward: link to Stave Four (Tiny Tim&rsquo;s
                    death in the unchanged future) and Stave Five (his survival
                    in the reformed timeline)
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <div className="mt-3 rounded bg-[#2E86C1]/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-gray-700">
                  ...
                  <li>
                    &bull; Ghost of Christmas Past: self-knowledge through memory
                    (regret, sympathy for his younger self)
                  </li>
                  <li>
                    &bull; Ghost of Christmas Present: social awareness through
                    observation (the Cratchits, Ignorance and Want)
                  </li>
                  <li>
                    &bull; Ghost of Christmas Yet to Come: moral urgency through
                    fear (his own death, Tiny Tim&rsquo;s death)
                  </li>
                  <li>
                    &bull; Analyse Dickens&rsquo;s methods: the escalating
                    supernatural atmosphere, the contrast between the spirits&rsquo;
                    appearances, the use of silence (the third spirit)
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="rounded-lg border-2 border-[#2E86C1]/30 bg-[#2E86C1]/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-gray-700">
                <li>
                  ...
                  words and phrases. Then connect outward to the rest of the
                  novella. Do not spend more than a paragraph on material outside
                  the extract.
                </li>
                <li>
                  <strong>Essay questions:</strong> Plan before you write.
                  Choose 3&ndash;4 key moments from across the novella and
                  analyse them in detail. Avoid retelling the plot; instead,
                  focus on how Dickens presents ideas through language, form, and
                  structure.
                </li>
                <li>
                  <strong>Embed quotations:</strong> Weave short quotations into
                  your sentences rather than copying long passages. For example:
                  &lsquo;Dickens describes Scrooge as &ldquo;hard and sharp as
                  flint&rdquo;, using a simile to suggest...&rsquo;
                </li>
                <li>
                  <strong>Use context purposefully:</strong> Do not write a
                  paragraph of context at the start. Instead, integrate
                  contextual knowledge into your analysis: &lsquo;Scrooge&rsquo;s
                  reference to the &ldquo;surplus population&rdquo; echoes
                  Malthusian economics, which Dickens found morally
                  repugnant...&rsquo;
                </li>
                <li>
                  <strong>Address &lsquo;how&rsquo; not just &lsquo;what&rsquo;:</strong>{" "}
                  Cambridge questions almost always ask how Dickens presents,
                  creates, or explores something. This means you must discuss
                  methods (imagery, contrast, narrative voice, structure) rather
                  than simply describing what happens.
                </li>
                <li>
