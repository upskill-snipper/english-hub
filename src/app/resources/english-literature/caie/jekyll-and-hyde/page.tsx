...
export const metadata: Metadata = {
  alternates: { canonical: 'https://theenglishhub.app/resources/english-literature/caie/jekyll-and-hyde' },
  title:
    "Jekyll and Hyde Study Guide - Cambridge IGCSE English Literature",
  description:
...
const keyQuotes = [
  ...
  {
    quote:
      "He was trampling calmly over the child's body and left her screaming on the ground",
    speaker: "Mr Enfield",
    location: "Chapter 1 (Story of the Door)",
    analysis:
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Plot, characters, themes, {keyQuotes.length} key quotes with analysis, Victorian context,
            Gothic conventions, and Cambridge-specific exam technique.
          </p>
        </div>
      </section>
        ...
        <section id="context" aria-labelledby="context-heading">
          ...
          <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-2">
                The novella was published in 1886, during the height of the
                Victorian era. Society placed enormous emphasis on outward
                respectability, moral propriety, and self-control. Gentlemen
                were expected to suppress any desires that did not conform to
                strict moral codes. Stevenson exposes the hypocrisy of this
                system: Jekyll&rsquo;s double life is only possible because
                Victorian society does not look too closely at what its
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-2">
                ...
                and <em>The Descent of Man</em> (1871) challenged the idea that
                humans were fundamentally different from animals. Hyde&rsquo;s
                animalistic descriptions (&lsquo;ape-like&rsquo;,
                &lsquo;troglodytic&rsquo;) reflect Victorian anxieties about
                degeneration: the fear that civilised humans might revert to a
                primitive, bestial state. Hyde can be read as an embodiment of
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-2">
                Stevenson draws on the Gothic literary tradition, which
                originated with Horace Walpole&rsquo;s{" "}
                <em>The Castle of Otranto</em> (1764) and includes Mary
                Shelley&rsquo;s <em>Frankenstein</em> (1818). Gothic
                conventions in the novella include: the Doppelganger (the
                monstrous double), transformation, nighttime settings, locked
                doors and concealed documents, the urban landscape as a source
                of horror, and the transgressive scientist whose experiments
                breach moral boundaries. However, Stevenson modernises the
                Gothic by locating horror not in a remote castle but in the
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-2">
                By the 1880s, London was the world&rsquo;s largest city,
                characterised by extremes of wealth and poverty existing side by
                side. The geography of the novella reflects this: Jekyll&rsquo;s
                handsome house faces a respectable square, but its laboratory
                backs onto a squalid lane. Fog, gaslight, and labyrinthine
                streets create an atmosphere of concealment and menace,
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-2">
                The late Victorian period saw rapid scientific and technological
                progress, which generated both excitement and anxiety.
                Vivisection (animal experimentation) was hotly debated. The
                novella reflects fears about science overreaching moral
                boundaries. Jekyll, like Frankenstein before him, is a
                scientist whose ambition to master nature leads to his
                destruction. Stevenson questions whether scientific progress is
                always beneficial and whether some knowledge is too dangerous to
                pursue.
              </p>
            </div>
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-2">
                The novella&rsquo;s structure is itself thematically
                significant. The story is told through multiple perspectives
                (Utterson&rsquo;s third-person narrative, Lanyon&rsquo;s
                letter, Jekyll&rsquo;s confession), withholding the full truth
                until the final two chapters. This mirrors the novella&rsquo;s
                themes of concealment and revelation. The reader, like
                Utterson, must piece together fragments to understand the whole
                picture, replicating the experience of living in a society
                built on surfaces and secrets.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  ...
                  <li>
                    &bull; Analyse the contrast between &lsquo;plod&rsquo; and
                    &lsquo;spring&rsquo; &mdash; repression versus freedom
                  </li>
                  <li>
                    &bull; Discuss the metaphor of &lsquo;lendings&rsquo;:
                    respectability as borrowed clothing, not genuine identity
                  </li>
                  <li>
                    &bull; Consider tone: Jekyll sounds excited, even boastful
                    &mdash; what does this reveal about his character?
                  </li>
                  <li>
                    &bull; Link outward: connect to the theme of Victorian
                    hypocrisy and the idea of the performed self
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  ...
                  <li>
                    &bull; Consider duality on multiple levels: character
                    (Jekyll/Hyde), setting (front door/back door), narrative
                    structure (surface story/hidden truth)
                  </li>
                  <li>
                    &bull; Analyse Stevenson&rsquo;s methods: symbolism (the
                    door, the mirror), imagery (light/dark, animal/human),
                    narrative form (delayed revelation)
                  </li>
                  <li>
                    &bull; Discuss the philosophical implications: &lsquo;Man is
                    not truly one, but truly two&rsquo;
                  </li>
                  <li>
                    &bull; Reference context: Victorian repression, Darwinian
                    anxiety, the Gothic Doppelganger tradition
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  ...
                  <li>
                    &bull; Discuss the simile &lsquo;ape-like fury&rsquo;:
                    Darwinian regression, loss of civilised restraint
                  </li>
                  <li>
                    &bull; Note the maid&rsquo;s perspective: she faints,
                    creating a gap in the narrative that heightens horror
                  </li>
                  <li>
                    &bull; Examine sound imagery: &lsquo;bones were audibly
                    shattered&rsquo; makes violence visceral and sensory
                  </li>
                  <li>
                    &bull; Connect to the wider novella: this murder marks
                    Hyde&rsquo;s escalation and makes Jekyll&rsquo;s loss of
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  ...
                  <li>
                    &bull; Analyse London fog and gaslight as pathetic fallacy:
                    moral confusion, concealment, danger
                  </li>
                  <li>
                    &bull; Contrast the ordered interiors (Utterson&rsquo;s
                    rooms, Jekyll&rsquo;s dining hall) with the chaotic
                    laboratory
                  </li>
                  <li>
                    &bull; Reference Gothic conventions: the urban Gothic,
                    nighttime settings, labyrinthine streets
                  </li>
                  <li>
                    &bull; Link setting to context: Victorian London&rsquo;s
                    juxtaposition of wealth and poverty mirrors Jekyll&rsquo;s
                    divided self
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  <li>
                    ...
                    clear personal conclusion
                  </li>
                  <li>
                    &bull; For: Jekyll describes Hyde&rsquo;s pleasures as his
                    own; Hyde is &lsquo;natural and human&rsquo;; Jekyll is the
                    disguise
                  </li>
                  <li>
                    &bull; Against: Jekyll has genuine goodness; Hyde is a
                    reduction, lacking &lsquo;balancing instincts&rsquo;;
                    Jekyll feels remorse, Hyde does not
                  </li>
                  <li>
                    &bull; Analyse Stevenson&rsquo;s methods: the title places
                    Jekyll first; Hyde means &lsquo;to hide&rsquo;; the
                    narrative structure prioritises Jekyll&rsquo;s confession
                  </li>
                  <li>
                    &bull; Conclude with a nuanced argument: neither is the
                    &lsquo;real&rsquo; self &mdash; both are aspects of one
                    person, which is Stevenson&rsquo;s central point
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mt-8 rounded-lg border-2 border-primary/30 bg-primary/5 p-5">
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li>
                ...
                but always link outward to the rest of the novella. Focus on
                Stevenson&rsquo;s language choices: individual words, imagery,
              ...
              <li>
                ...
                analyse <em>how</em> Stevenson presents ideas, not just{" "}
                <em>what</em> happens.
              </li>
              <li>
                <strong className="text-foreground">
                ...
                metaphor, simile, symbolism, pathetic fallacy, narrative
                perspective, Doppelganger, Gothic conventions, foreshadowing,
              ...
              <li>
                ...
                writing a separate paragraph. For example: &ldquo;Hyde&rsquo;s
                &lsquo;ape-like fury&rsquo; would have been particularly
                unsettling for Victorian readers familiar with Darwin&rsquo;s
                theory of evolution, which suggested that humans were not as
              ...
              <li>
                ...
                will score higher than a rushed response covering many points
                superficially.
              </li>
            </ul>
          </div>
