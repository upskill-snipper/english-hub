...
const keyQuotes = [
  ...
  {
    quote: "You're a cruel woman, Helen. You've had your life ruined by men but you won't let me have mine.",
    speaker: "Jo",
    act: "Act 1",
    analysis:
  ...
  {
    quote: "I used to try to hold my mother's hands but she always pushed me away. She had me but she didn't want me.",
    speaker: "Jo",
    act: "Act 2",
    analysis:
...
export default function ATasteOfHoneyStudyGuide() {
  return (
    <>
      {/* ── Hero ────────────────────────────────────────────────── */}
      <section className="bg-gradient-to-br from-[#6B2D5B] to-[#A0522D] px-4 py-16 text-white sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/90">
            Characters, themes, {keyQuotes.length}+ key quotes with analysis,
            dramatic techniques, 1950s context, and Cambridge-specific exam
            technique for Shelagh Delaney&rsquo;s groundbreaking play.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section id="context" aria-labelledby="context-heading">
          ...
          <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
            <Card>
              ...
              <CardContent>
                <p>
                  Shelagh Delaney grew up in Salford, a working-class industrial
                  city near Manchester. In the 1950s, Salford was characterised by
                  terraced housing, factory work, poverty, and close-knit but
                  economically deprived communities. The play&rsquo;s setting — a
                  cold, comfortless flat — reflects the real living conditions
                  Delaney knew. Housing was often damp, overcrowded, and lacking
                  basic amenities. Delaney draws directly on this environment to
                  ground her drama in material reality.
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <p>
                  A Taste of Honey belongs to the wave of &lsquo;kitchen sink
                  realism&rsquo; that transformed British theatre and cinema in
                  the late 1950s. John Osborne&rsquo;s Look Back in Anger (1956)
                  is often cited as the movement&rsquo;s starting point, but
                  Delaney&rsquo;s play — written when she was just eighteen —
                  brought a distinctively female, northern, working-class voice to
                  the stage. The movement rejected the polished drawing-room
                  conventions of the theatrical establishment, insisting that
                  ordinary lives deserved serious dramatic treatment.
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <p>
                  The arrival of the Empire Windrush in 1948 marked the beginning
                  of large-scale Caribbean immigration to Britain. By the late
                  1950s, racial tensions were visible: the 1958 Notting Hill race
                  riots occurred the same year A Taste of Honey was first
                  performed. Delaney&rsquo;s sympathetic, non-judgmental portrayal
                  of an interracial relationship was genuinely radical. Jimmy is
                  presented as a warm, romantic figure, and the play locates
                  prejudice firmly in the attitudes of other characters (Peter,
            ...
            <Card>
              ...
              <CardContent>
                <p>
                  In the 1950s, women were expected to marry, keep house, and
                  raise children. Unmarried motherhood carried severe social
                  stigma. Homosexuality was illegal in England and Wales until
                  1967 (the Sexual Offences Act). Delaney&rsquo;s decision to
                  place a pregnant unmarried teenager and a gay man at the centre
                  of her play was a deliberate provocation. She treats both
                  characters with compassion and dignity, presenting their
                  situations as ordinary human experiences rather than moral
                  failings.
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <p>
                  The play was first produced by Joan Littlewood&rsquo;s Theatre
                  Workshop at the Theatre Royal, Stratford East, in May 1958.
                  Littlewood was a pioneering director committed to working-class
                  theatre. Her collaborative approach shaped the final production
                  significantly: she added the jazz trio, encouraged improvisation,
                  and enhanced the play&rsquo;s Brechtian elements. The Theatre
                  Workshop&rsquo;s ethos — accessible, politically engaged,
                  formally experimental — was integral to the play&rsquo;s impact.
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <p>
                  Delaney wrote A Taste of Honey at the age of eighteen, allegedly
                  after seeing a play she thought she could improve upon. As a
                  working-class woman from Salford with no university education,
                  she was an outsider in the theatrical world. Her youth, gender,
                  and class made her debut all the more remarkable. The play drew
                  on her own experiences of growing up in poverty, and its
                  authenticity was immediately recognised by critics and audiences.
                  Delaney gave a voice to people who had been largely invisible on
                  the British stage.
                </p>
              </CardContent>
            </Card>
              ...
              <Card key={ao.code}>
                <CardContent className="pt-5">
                  <div className="flex items-center gap-2">
                    <span className="inline-block rounded-full bg-[#6B2D5B] px-2.5 py-0.5 text-xs font-bold text-white">
                      {ao.code}
                    </span>
        ...
        <section id="exam-questions" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cambridge IGCSE questions on set drama texts typically offer a choice
            between a passage-based question (a) and an essay question (b). Below
            are examples of both types with guidance on how to approach them.
          </p>
          ...
          <div className="mt-6 space-y-6">
            ...
            <Card>
              <CardContent className="pt-5">
                <span className="inline-block rounded-full bg-[#6B2D5B]/10 px-2.5 py-0.5 text-xs font-semibold text-foreground">
                  (a) Passage-Based
                </span>
                <p className="mt-3 text-sm font-medium text-foreground">
                  Re-read the passage in Act 2 where Geof prepares for the
                  baby&rsquo;s arrival and proposes marriage to Jo. How does
                  Delaney make this such a significant moment in the play?
                </p>
                <div className="mt-3 rounded bg-primary/5 p-3">
                  ...
                  <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                    <li>
                      &bull; Analyse Geof&rsquo;s gentle, tentative language:
                      &lsquo;Would you like to marry me?&rsquo; — contrast with
                      Jimmy&rsquo;s romantic declarations
                    </li>
                    <li>
                      &bull; Discuss Geof&rsquo;s domestic actions (cooking,
                      cleaning, preparing baby clothes) as a reversal of 1950s
                      gender roles
                    </li>
                    <li>
                      &bull; Consider Jo&rsquo;s refusal: she values honesty over
                      social convention
                    </li>
                    <li>
                      &bull; Link to context: homosexuality was illegal; Geof
                      offers a marriage of convenience that challenges social norms
                    </li>
                    <li>
                      &bull; Analyse the dramatic irony: the audience knows Helen
                      will return and destroy this fragile domestic arrangement
                    </li>
                    <li>
                      &bull; Use terminology: naturalistic dialogue, stage
                      directions, subtext, juxtaposition
                    </li>
                  </ul>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="pt-5">
                ...
                <p className="mt-3 text-sm font-medium text-foreground">
                  How does Delaney present the relationship between Jo and Helen
                  in A Taste of Honey?
                </p>
                <div className="mt-3 rounded bg-primary/5 p-3">
                  <p className="text-xs font-semibold text-foreground">
                  ...
                  <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                    ...
                    <li>
                      &bull; Track the relationship across both acts: combative
                      closeness in Act 1, separation and painful reunion in Act 2
                    </li>
                    <li>
                      &bull; Analyse the dialogue: rapid exchanges, dark humour,
                      mutual cruelty masked as affection
                    </li>
                    <li>
                      &bull; Discuss the cycle of neglect: Jo fears becoming Helen,
                      but her circumstances push her towards the same pattern
                    </li>
                    <li>
                      &bull; Reference context: limited options for working-class
                      women, absent fathers, the social stigma of unmarried
                      motherhood
                    </li>
                    <li>
                      &bull; Consider Delaney&rsquo;s purpose: she refuses to
                      idealise motherhood, presenting it as shaped by material
                      conditions
                    </li>
                  </ul>
                </div>
            ...
            <Card>
              <CardContent className="pt-5">
                ...
                <p className="mt-3 text-sm font-medium text-foreground">
                  How does Delaney use the character of Geof to challenge social
                  conventions in A Taste of Honey?
                </p>
                <div className="mt-3 rounded bg-primary/5 p-3">
                  <p className="text-xs font-semibold text-foreground">
                    How to approach:
                  ...
                  <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                    <li>
                      &bull; Discuss Geof&rsquo;s implied homosexuality and the
                      legal/social context (homosexuality illegal until 1967)
                    </li>
                    <li>
                      &bull; Analyse his domestic, caring role as a reversal of
                      1950s masculinity
                    </li>
                    <li>
                      &bull; Contrast Geof with Peter and Jimmy: he is the most
                      nurturing figure in the play
                    </li>
                    <li>
                      &bull; Consider Delaney&rsquo;s presentation of an
                      alternative family model: care-based rather than
                      convention-based
                    </li>
                    <li>
                      &bull; Discuss Helen&rsquo;s hostility towards Geof and what
                      it reveals about societal attitudes
                    </li>
                    <li>
                      &bull; Link to Delaney&rsquo;s broader purpose: normalising
                      marginalised identities on the British stage
                    </li>
                  </ul>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="pt-5">
                ...
                <p className="mt-3 text-sm font-medium text-foreground">
                  Re-read the opening of the play, from Jo and Helen&rsquo;s
                  arrival at the flat to Helen&rsquo;s first mention of Peter.
                  How does Delaney use this section to establish character and
                  setting?
                </p>
                <div className="mt-3 rounded bg-primary/5 p-3">
                  <p className="text-xs font-semibold text-foreground">
                  ...
                  <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                    <li>
                      &bull; Analyse stage directions: the flat&rsquo;s poverty
                      (cold, dark, sparse) establishes kitchen sink realism
                    </li>
                    <li>
                      &bull; Discuss the dialogue: Jo and Helen&rsquo;s rapid,
                      combative exchanges establish their relationship dynamic
                    </li>
                    <li>
                      &bull; Note Helen&rsquo;s ironic humour as a defence
                      mechanism against their circumstances
                    </li>
                    <li>
                      &bull; Identify Jo&rsquo;s intelligence and independence
                      from her first lines
                    </li>
                    <li>
                      &bull; Consider the audience&rsquo;s response: Delaney
                      immediately confronts them with working-class reality
                    </li>
                    <li>
                      &bull; Link to context: 1950s Salford housing conditions,
            ...
            <Card className="border-2 border-[#6B2D5B]/30">
              <CardHeader>
                <CardTitle className="text-lg">
                  Sample Question &amp; Model Paragraph
                </CardTitle>
                <CardDescription>
                  Demonstrating all four Assessment Objectives in a single
                  paragraph
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm font-medium text-foreground">
                  <em>
                    How does Delaney present the theme of motherhood in A Taste
                    of Honey?
                  </em>
                </p>
            ...
            <div className="rounded-lg border-2 border-[#A0522D]/30 bg-primary/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  ...
                  Plan before you write. Select 3&ndash;4 key moments from across
                  the play with quotations. Focus on Delaney&rsquo;s methods and
                  purpose, not just what happens. Integrate context rather than
                  adding it as a separate paragraph.
                </li>
                <li>
                  <strong className="text-foreground">
                ...
                <li>
                  <strong className="text-foreground">
                    Connect to context purposefully:
                  </strong>{" "}
                  Reference 1950s Salford, attitudes to race and sexuality, the
                  kitchen sink movement, and gender expectations — but always
                  link context to the specific point you are making. Avoid
                  generic context paragraphs.
                </li>
                <li>
                  <strong className="text-foreground">Quote precisely:</strong>{" "}
                  Short, embedded quotations (&lsquo;pushed me away&rsquo;) are
                  more effective than long block quotes. Aim for at least one
                ...
                <li>
                  ...
                  The strongest answers connect analysis to Delaney&rsquo;s
                  intentions. Why does she make Geof the most caring character?
                  Why does Helen return at the end? Why is the ending
                  unresolved? Always ask: what is Delaney trying to make the
