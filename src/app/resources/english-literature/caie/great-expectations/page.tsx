    ...
    keyQuotations: [
      {
        ...
        analysis:
          "The novel's opening establishes Pip's identity as constructed through memory and experience. 'Identity of things' suggests that selfhood is not innate but gradually assembled. The retrospective voice ('seems to me') signals that this is a story about the unreliability of self-understanding.",
      },
      {
        quote:
  ...
  },
  {
    ...
    keyQuotations: [
      ...
      },
      {
        ...
        analysis:
          "Pip's visceral horror at discovering Magwitch is his benefactor reveals his snobbery at its most naked. The tricolon of negative nouns ('abhorrence', 'dread', 'repugnance') shows Pip recoiling not from danger but from the destruction of his class fantasy. The animal simile ('terrible beast') is cruelly ironic: Pip dehumanises the man whose generosity made him 'human' in society's eyes.",
      },
    ],
  },
  {
    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Part-by-part summaries with key quotations, full character analysis, themes, narrative
            techniques, assessment objectives, and Cambridge-specific exam guidance for
            Dickens&rsquo;s <em>Great Expectations</em>.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section id="part-summary" aria-labelledby="part-heading">
          <h2 id="part-heading" className="text-2xl font-bold text-foreground">
            Part-by-Part Summary
          </h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Dickens published <em>Great Expectations</em> in weekly instalments (1860&ndash;61) but
            structured it in three distinct &lsquo;stages&rsquo; of Pip&rsquo;s life, each
            corresponding to a phase of his moral development.
          </p>
          <div className="mt-6 space-y-6">
            {partSummary.map((p) => (
              <Card key={p.part}>
                ...
                <CardContent>
                  <h4 className="mb-3 text-sm font-semibold text-foreground">Key Quotations</h4>
        ...
        <section id="characters" aria-labelledby="characters-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Eight key characters with detailed analysis suitable for Cambridge IGCSE responses.
            Focus on how Dickens uses each character to explore the novel&rsquo;s central themes.
          </p>
        ...
        <section id="narrative-techniques" aria-labelledby="techniques-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Understanding how Dickens constructs meaning through form, structure, and language is
            essential for Writer's Methods.
          </p>
          <div className="mt-6 space-y-5">
            {narrativeTechniques.map((nt) => (
              <Card key={nt.technique}>
                ...
                <CardContent>
                  <p className="text-sm leading-relaxed text-muted-foreground">{nt.detail}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <section id="what-markers-look-for" aria-labelledby="ao-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            ...
            what the marker rewards will help you structure stronger responses on Great
            Expectations.
          </p>
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            {assessmentObjectives.map((ao) => (
              <Card key={ao.code}>
                ...
                <CardContent>
                  <p className="text-sm leading-relaxed text-muted-foreground">{ao.detail}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <section id="exam-guidance" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Great Expectations appears in <strong>Paper 1 (Prose)</strong> for Cambridge IGCSE
            English Literature. You will choose between a{' '}
            <strong>passage-based question (a)</strong> and an <strong>essay question (b)</strong>.
            Both carry equal marks (25).
          </p>
          ...
          <div className="mt-6 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="mt-1">How to approach the passage question</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    <strong>Stay anchored in the extract.</strong> Work through it systematically,
                    selecting specific words, phrases, and literary devices for close analysis. The
                    majority of your response should address the given passage.
                  </li>
                  <li>
                    <strong>Zoom in on language.</strong> Identify imagery, symbolism, sentence
                    structure, narrative voice, and tone. For Great Expectations, pay particular
                    attention to Pip&rsquo;s retrospective commentary and the gap between his
                    younger and older selves.
                  </li>
                  <li>
                    <strong>Connect outward briefly.</strong> After analysing the passage, link to
                    the wider novel (one or two paragraphs maximum). Show how the passage connects
                    to key themes, character development, or structural turning points.
                  </li>
                  <li>
                    <strong>Embed quotations.</strong> Weave short phrases from the extract into
                    your sentences:&nbsp;
                    <em>
                      &lsquo;Pip describes Magwitch with &ldquo;abhorrence&rdquo; and
                      &ldquo;repugnance&rdquo;, a tricolon of revulsion that reveals...&rsquo;
                    </em>
                  </li>
                </ul>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="mt-1">How to approach the essay question</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    <strong>Plan before you write.</strong> Select 3&ndash;4 key moments from across
                    the novel that address the question. Ensure you cover different parts of the
                    text (the marshes, London, the resolution) to show breadth of knowledge.
                  </li>
                  <li>
                    <strong>Focus on &lsquo;how&rsquo;.</strong> Cambridge questions almost always
                    ask how Dickens presents, explores, or makes something significant. Discuss
                    methods (narration, symbolism, contrast, structure) rather than simply
                    describing what happens.
                  </li>
                  <li>
                    <strong>Integrate context.</strong> Do not write a separate context paragraph.
                    Instead, weave contextual knowledge into your analysis:&nbsp;
                    <em>
                      &lsquo;Magwitch&rsquo;s heavier sentence reflects the class bias of Victorian
                      criminal justice, which Dickens consistently attacked...&rsquo;
                    </em>
                  </li>
                  <li>
                    <strong>Develop a personal response.</strong> Evaluate and interpret rather than
                    describe. Consider alternative readings and show awareness of complexity.
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <div className="rounded-lg border-2 border-purple-600/30 bg-primary/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <strong>Quotation length:</strong> Keep quotations short (single words or short
                  phrases are most effective). Great Expectations is a long novel; precise,
                  selective reference demonstrates stronger knowledge than lengthy quotation.
                </li>
                <li>
                  <strong>Structure your response:</strong> Use a clear analytical structure (point,
                  evidence, analysis, context/link). Each paragraph should address a distinct aspect
                  of the question.
                </li>
                <li>
                  <strong>Address all four skills:</strong> The strongest responses combine textual
                  knowledge (Textual Knowledge), analysis of methods (Writer's Methods), contextual
                  understanding (Interpretation), and personal interpretation (Personal Response) in
                  every paragraph.
                </li>
              </ul>
            </div>
          ...
          <Card className="mt-6">
            <CardHeader>
              ...
              <CardTitle className="mt-1">
                How does Dickens use the character of Magwitch to challenge Victorian ideas about
            ...
            <CardContent>
              <div className="rounded-lg border border-border bg-primary/5 p-4">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Dickens challenges Victorian assumptions about criminality most powerfully through
                  Pip&rsquo;s evolving perception of Magwitch. When Magwitch reveals himself as
                  Pip&rsquo;s benefactor, Pip describes his reaction with a tricolon of revulsion
                  &mdash; &ldquo;the abhorrence in which I held the man, the dread I had of him, the
                  repugnance with which I shrank from him&rdquo; &mdash; each noun escalating his
                  disgust <strong>(Textual Knowledge: precise embedded quotation)</strong>. The
                  retrospective narration is crucial here: the older Pip records these feelings
                  without excusing them, allowing the reader to recognise what the younger Pip
                  cannot &mdash; that his horror is rooted in class prejudice, not moral judgement{' '}
                  <strong>
                    (Writer's Methods: analysis of first-person retrospective technique)
                  </strong>
                  . In Victorian England, a convict who had been transported to Australia was
                  considered permanently degraded; returning illegally, as Magwitch does, carried
                  the death penalty. Dickens inverts this hierarchy by making the convict the most
                  generous and loyal character in the novel, while the &lsquo;gentleman&rsquo;
                  Compeyson &mdash; well-spoken and well-dressed &mdash; is exposed as the true
                  criminal{' '}
                  <strong>
                    (Interpretation: context of transportation and class-biased justice)
                  </strong>
                  . Yet Dickens does not sentimentalise Magwitch: his desire to &lsquo;make a
                  gentleman&rsquo; of Pip is itself a form of class worship, suggesting that even
                  victims of the system internalise its values. This complicates any simple reading
                  of Magwitch as a noble outsider and invites the reader to question whether the
                  class system can ever be truly escaped{' '}
                  <strong>
