...
const assessmentObjectives = [
  ...
  },
  {
    ...
    description:
      'Understand how meanings are shaped by the contexts in which texts are written and received',
    guidance:
  ...
  },
  {
    code: 'Interpretation',
    description:
      'Analyse how writers use language, structure, and form to create meanings and effects',
    guidance:
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Characters, themes, act-by-act summary with key quotations, dramatic techniques,
            historical context, and Cambridge-specific exam guidance.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section id="dramatic-techniques" aria-labelledby="techniques-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cleage&rsquo;s use of dramatic techniques is essential for Interpretation (language,
            structure, and form). Markers reward responses that discuss <em>how</em> Cleage shapes
        ...
        <section id="context" aria-labelledby="context-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cambridge markers expect you to integrate context into your analysis (Writer's Methods),
            showing how historical and social factors shape the characters&rsquo; choices and the
            play&rsquo;s meaning.
          </p>
          <div className="mt-6 space-y-4">
            {contextSections.map((ctx) => (
              <Card key={ctx.title}>
                ...
                <CardContent>
                  <p className="text-sm leading-relaxed text-muted-foreground">{ctx.content}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <section id="exam-guidance" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cambridge IGCSE Literature drama questions offer a choice between a passage-based (a)
            question and an essay (b) question. Below is guidance for both.
          </p>
          ...
          <div className="mt-6 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>{examGuidance.passageBased.description}</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>{examGuidance.essayBased.description}</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <div className="rounded-lg border-2 border-primary/30 bg-primary/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                <li>
                  ...
                  Write &ldquo;Cleage presents...&rdquo; or &ldquo;Cleage uses...&rdquo; rather than
                  &ldquo;the play shows...&rdquo;. This demonstrates awareness of authorial intent
                  and helps you discuss methods (Interpretation).
                </li>
                <li>
                  <strong className="text-foreground">Quote precisely and briefly:</strong> Short,
                  embedded quotations (&lsquo;the best friend I ever had&rsquo;) are more effective
                  than long block quotes. Aim for at least one quotation per paragraph.
                </li>
                <li>
                  <strong className="text-foreground">Integrate context (Writer's Methods):</strong>{' '}
                  Do not write a separate &ldquo;context paragraph&rdquo;. Instead, weave historical
                  references into your analysis: explain how the Depression shapes Angel&rsquo;s
                  choices, or how the Renaissance&rsquo;s decline gives Guy&rsquo;s Paris dream
                  urgency.
                </li>
                <li>
                  <strong className="text-foreground">
                  ...
                  Discuss Cleage&rsquo;s dramatic techniques: how dialogue reveals character, how
                  the four-act structure builds tension, how setting functions symbolically. The
                  strongest answers explain <em>how</em> effects are achieved.
                </li>
                <li>
                  <strong className="text-foreground">
                    Offer a personal response (Personal Response):
                  </strong>{' '}
                  Phrases such as &ldquo;I find this particularly effective...&rdquo; or &ldquo;This
                  moment is significant because...&rdquo; signal personal engagement. Avoid vague
                ...
                <li>
                  ...
                  Ask yourself: why does Cleage make Leland kill Guy? Why does Delia persist with
                  the clinic? Why is the play set in 1930, not 1925? The best answers connect
                  analysis to the playwright&rsquo;s intentions and effects.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section id="sample-question" aria-labelledby="sample-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            This model paragraph demonstrates how to address all four assessment objectives in a
            single, sustained response.
          </p>
          ...
          <div className="mt-6 space-y-6">
            <Card>
              ...
              <CardContent>
                <p className="text-sm font-medium text-foreground">{sampleQuestion.question}</p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>How this paragraph addresses each skill</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {sampleQuestion.aoBreakdown.map((ao) => (
                    <div key={ao.code} className="flex gap-3">
                      <span className="inline-block h-fit shrink-0 rounded-full bg-primary px-2.5 py-0.5 text-xs font-bold text-primary-foreground">
                        {ao.code}
                      </span>
