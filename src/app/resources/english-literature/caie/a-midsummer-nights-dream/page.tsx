      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        >
          {[
            ...
            <a
              ...
              className="rounded-full border border-[#048A81]/30 px-3 py-1 text-foreground transition hover:bg-primary/10"
            >
              {s}
            </a>
          ))}
                ...
                <CardContent>
                  ...
                  <div className="space-y-4">
                    {act.quotes.map((q, i) => (
                      <div
                        key={i}
                        className="rounded-lg border-l-4 border-[#048A81] bg-primary/5 p-4"
                      >
        ...
        <section id="exam-guidance" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cambridge IGCSE English Literature questions on set texts offer two
            options: a passage-based part (a) and an essay-based part (b). Below
          ...
          <Card className="mt-6">
            <CardHeader>
              <CardTitle className="text-base">
                <span className="mr-2 inline-block rounded-full bg-[#2E4057]/10 px-2.5 py-0.5 text-xs font-semibold">
                  Essay Question
                </span>
              </CardTitle>
