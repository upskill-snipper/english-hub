...
const examQuestions = {
  ...
  essay: [
    ...
    {
      question: 'How does Williams use symbolism to convey meaning in A Streetcar Named Desire?',
      guidance: [
    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Characters, themes, scene-by-scene summary with key quotations, Williams&rsquo; dramatic
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section id="scene-summaries" aria-labelledby="scenes-heading">
          <h2 id="scenes-heading" className="text-2xl font-bold text-foreground">
            Scene-by-Scene Summary
          </h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Each scene includes a summary, key quotations with analysis, and notable stage
            directions.
          </p>
        ...
        <section id="dramatic-techniques" aria-labelledby="techniques-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Williams&rsquo; concept of &lsquo;plastic theatre&rsquo; &mdash; using lighting, sound,
            set design, and staging expressively &mdash; is essential for Analysis of Writer's
            Methods. Markers reward responses that analyse <em>how</em> Williams creates meaning,
            not just <em>what</em> happens.
          </p>
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
        ...
        <section id="exam-questions" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cambridge IGCSE drama questions offer a choice between a passage-based (a) question and
            an essay (b) question. Below are examples of both types with guidance on how to approach
            them.
          </p>

          <div className="mt-6 space-y-6">
            <h3 className="text-lg font-semibold text-foreground">(a) Passage-Based Questions</h3>
            ...
            <h3 className="text-lg font-semibold text-foreground">(b) Essay Questions</h3>
            ...
            <div className="rounded-lg border-2 border-purple-600/30 bg-primary/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                <li>
                  <strong className="text-foreground">Passage-based questions (a):</strong> Work
                  through the extract methodically. Use short, embedded quotations from the passage.
                  Analyse Williams&rsquo; language, stage directions, and dramatic effects (Writer's
                  Methods). Then connect outward to the rest of the play and relevant context.
                </li>
                <li>
                  <strong className="text-foreground">Essay questions (b):</strong> Plan before you
                  write. Select 3&ndash;4 key moments from across the play with quotations. Focus on
                  Williams&rsquo; methods and purpose, not just what happens. Integrate context
                  rather than adding it as a separate paragraph.
                </li>
                <li>
                  <strong className="text-foreground">Always use the author&rsquo;s name:</strong>{' '}
                  Write &ldquo;Williams presents...&rdquo; or &ldquo;Williams uses...&rdquo; rather
                ...
                <li>
                  ...
                  Williams coined this term for drama that uses all theatrical elements &mdash;
                  lighting, sound, set design, music &mdash; expressively. Referencing this concept
                  demonstrates sophisticated understanding of his dramatic method.
                </li>
                <li>
                  <strong className="text-foreground">Quote precisely:</strong> Short, embedded
                  quotations (&lsquo;I don&rsquo;t want realism. I want magic!&rsquo;) are more
                ...
                <li>
                  ...
                  The strongest answers connect analysis to Williams&rsquo; broader concerns: the
                  destructive consequences of rigid gender roles, the tension between compassion and
                  brutality, and the human need for illusion in an unforgiving world.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section id="model-paragraph" aria-labelledby="model-heading">
          <h2 id="model-heading" className="text-2xl font-bold text-foreground">
            Sample Question &amp; Model Paragraph
          </h2>
          <p className="mt-2 text-sm text-muted-foreground">
            The following model paragraph demonstrates how to address all four assessment objectives
            in a single, sustained analytical response.
          </p>
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="rounded-lg border-2 border-purple-600/30 bg-primary/5 p-5">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">{modelParagraph}</p>
              <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-4">
                {[
                  ...
                  >
                    <span className="block text-xs font-bold text-foreground">{ao.code}</span>
                    <span className="block text-[10px] text-muted-foreground">{ao.label}</span>
                  </div>
                ))}
              </div>
            </div>
