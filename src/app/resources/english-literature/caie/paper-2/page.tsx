...
const dramaticTechniques = [
  {
    technique: 'Soliloquy',
    definition:
      'A speech delivered by a character alone on stage, revealing inner thoughts to the audience.',
    example:
      "Macbeth's 'Is this a dagger which I see before me' reveals his psychological torment.",
    howToWrite:
  ...
  },
  {
    ...
    example:
      'In Macbeth, Duncan praises the castle as pleasant while the audience knows he will be murdered there.',
    howToWrite:
  ...
  },
  {
    ...
    example:
      "Miller's detailed stage directions in A View from the Bridge reveal Eddie's body language when words fail him.",
    howToWrite:
  ...
  },
  {
    ...
    example:
      "The witches' opening in Macbeth ('Fair is foul, and foul is fair') foreshadows the moral chaos to come.",
    howToWrite:
  ...
  },
  {
    ...
    example:
      "Blood in Macbeth symbolises guilt. Lady Macbeth's obsessive hand-washing shows she cannot escape her conscience.",
    howToWrite:
  ...
  },
  {
    ...
    example:
      "In An Inspector Calls, Sheila's growing remorse is juxtaposed with her parents' refusal to accept responsibility.",
    howToWrite:
  ...
  },
  {
    ...
    example:
      "Iago's asides in Othello allow the audience to see his true manipulative nature while other characters remain deceived.",
    howToWrite:
  ...
  },
  {
    ...
    example:
      "The storm in Macbeth on the night of Duncan's murder reflects the disruption of the natural order.",
    howToWrite:
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            1 hour 30 minutes &middot; 50 marks &middot; Two sections: Shakespeare and other drama.
            Focus on dramatic technique, stagecraft, and performance.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <div className="mb-10 rounded-lg border border-amber-500/30 bg-amber-500/10 p-5 text-sm text-foreground">
          ...
          <p className="mt-2 text-muted-foreground leading-relaxed">
            ...
            before relying on this list for the current exam window. Drama options:{' '}
            <em>A Taste of Honey</em> (Delaney) / <em>A Midsummer Night&rsquo;s Dream</em> /{' '}
            <em>Antony and Cleopatra</em>. The Shakespeare and other-drama lists below are legacy
            reference selections &mdash; cross-check the syllabus PDF for the current exam window.
          </p>
          <p className="mt-3 text-muted-foreground leading-relaxed">
            <strong className="text-foreground">Cluster rights:</strong> Four poems in the companion
            poetry clusters are in copyright (Atwood, Auden, Hughes&nbsp;&times;3). Quotations on
            linked poetry pages are short fair-dealing extracts. Anthology publisher: Cambridge
            University Press (
            <a
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <ul className="mt-3 space-y-1 text-sm text-muted-foreground">
                <li>
                  &bull; Answer <strong>one</strong> question on your set Shakespeare play
                </li>
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <ul className="mt-3 space-y-1 text-sm text-muted-foreground">
                <li>
                  &bull; Answer <strong>one</strong> question on your other set drama text
                </li>
                <li>&bull; Same choice: passage-based or essay</li>
                <li>
                  &bull; Must demonstrate awareness of the text as a piece of drama, not just a
                  story
                </li>
        ...
        <section aria-labelledby="shakespeare-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Your school will study one Shakespeare play. Below are the commonly set texts with a
            summary of key themes and typical Cambridge exam focuses.
          </p>

          <div className="mt-6 space-y-5">
            {shakespearePlays.map((p) => (
              <div key={p.title} className="rounded-lg border border-border bg-card p-5 shadow-md">
        ...
        <section aria-labelledby="other-drama-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Section B of Paper 2 covers a non-Shakespeare drama text. Below are commonly set texts
            with key dramatic techniques to discuss.
          </p>
        ...
        <section aria-labelledby="techniques-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cambridge markers reward responses that treat the text as drama, not just as a story.
            Below are key dramatic techniques with definitions, examples, and advice on how to write
          ...
          <div className="mt-8 rounded-lg border border-primary/20 bg-primary/5 p-5">
            <h3 className="font-semibold text-foreground">Key Phrases for Writing About Drama</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              Use these phrases in your responses to show you are thinking about the text as a piece
              of theatre, not just a novel:
            </p>
