      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Plot, characters, themes, {keyQuotes.length}+ key quotes with analysis, dramatic
            devices, 1912/1945 context, and Cambridge-specific exam technique.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section id="plot-summary" aria-labelledby="plot-heading">
          ...
          <div className="mt-6 space-y-4">
            {plotSummary.map((act) => (
              <div key={act.act} className="rounded-lg border border-border bg-card p-5 shadow-md">
        ...
        <section id="dramatic-devices" aria-labelledby="devices-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Priestley&rsquo;s use of dramatic techniques is essential for Analysis of Writer's
            Methods (analysis of form and structure). Markers reward responses that discuss{' '}
            <em>how</em> Priestley shapes meaning, not just <em>what</em> happens.
          </p>
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
        ...
        <section id="context" aria-labelledby="context-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The dual time frame (set in 1912, performed in 1945) is fundamental to the play&rsquo;s
            meaning. Cambridge markers expect you to discuss both contexts and explain how the gap
            between them creates dramatic irony.
          </p>
          <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-2">
                ...
                Titanic. Britain was marked by extreme class divisions: the wealthy industrial class
                (like the Birlings) enjoyed enormous privilege, while the working class had no
                welfare state, no NHS, and limited rights. Women could not vote, and working-class
                women like Eva Smith were especially vulnerable. The rigid social hierarchy meant
                that the upper classes felt little obligation towards the poor.
              </p>
            </div>
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              <h3 className="font-semibold text-foreground">1945: The Post-War Audience</h3>
              <p className="mt-2">
                The play was first performed in 1945, just as the Second World War was ending. The
                war had created a sense of national solidarity: people from all classes had fought
                and suffered together. There was widespread appetite for social reform, leading to
                the election of Clement Attlee&rsquo;s Labour government, which established the
                welfare state and the NHS. Priestley&rsquo;s play spoke directly to this moment,
                arguing that the pre-war attitudes of the Birling class must never return.
              </p>
            </div>
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-2">
                ...
                social equality. During the war, his BBC radio broadcasts (the <em>Postscripts</em>)
                reached millions and advocated for a fairer society. He co-founded the Common Wealth
                Party. An Inspector Calls is his most famous dramatic expression of these beliefs:
                the Inspector is Priestley&rsquo;s mouthpiece, delivering the socialist message
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-2">
                In 1912, there was no state safety net for the poor. Charitable organisations (like
                Mrs Birling&rsquo;s committee) were the only source of help, and they could refuse
                assistance at will. The Beveridge Report of 1942 proposed a comprehensive welfare
                state to combat poverty, disease, ignorance, squalor, and idleness.
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-2">
                ...
                Representation of the People Act (1918) gave some women the vote, and full suffrage
                came in 1928. Eva&rsquo;s vulnerability stems partly from her gender: she is
                exploited sexually by Gerald and Eric, judged morally by Mrs Birling, and has no
                institutional protection. Sheila&rsquo;s transformation suggests that women of the
                next generation might exercise moral authority more responsibly.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="exam-questions" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cambridge IGCSE An Inspector Calls questions appear in Paper 2 (Drama). You will choose
            between a passage-based question and an essay question. Below are examples of both types
          ...
          <div className="mt-6 space-y-6">
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <p className="mt-3 text-sm font-medium text-foreground">
                ...
                this&rdquo; to the end of his dialogue. How does Priestley make this such a powerful
                and significant moment in the play?
              </p>
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  ...
                  <li>
                    &bull; Analyse the shift from individual to collective pronouns
                    (&lsquo;you&rsquo; to &lsquo;we&rsquo;)
                  </li>
                  <li>
                    &bull; Discuss the prophetic, biblical tone: &lsquo;fire and blood and
                    anguish&rsquo;
                  </li>
                  <li>
                    &bull; Consider the dramatic context: this is the Inspector&rsquo;s exit speech,
                    his final judgement
                  </li>
                  <li>
                    &bull; Link to context: the 1945 audience has lived through the &lsquo;fire and
                    blood&rsquo; he predicts
                  </li>
                  <li>
                    &bull; Use terminology: tricolon, imperative, dramatic irony, Priestley&rsquo;s
                    mouthpiece
                  </li>
                </ul>
              </div>
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  ...
                  <li>
                    &bull; Contrast Birling&rsquo;s individualism with the Inspector&rsquo;s
                    collectivism
                  </li>
                  <li>
                    &bull; Track how each character responds to the idea of responsibility
                    (accepting or denying)
                  </li>
                  <li>
                    &bull; Discuss Priestley&rsquo;s methods: dramatic irony, the chain-of-events
                    structure, the final phone call
                  </li>
                  <li>
                    &bull; Reference context: Priestley&rsquo;s socialism, the 1945 welfare state
                    movement
                  </li>
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  <li>
                    &bull; Structure chronologically to show Sheila&rsquo;s moral arc across the
                    play
                  </li>
                  <li>
                    &bull; Act 1: shallow and materialistic (&lsquo;Oh - it&rsquo;s
                    wonderful!&rsquo; about the ring)
                  </li>
                  <li>
                    &bull; Mid-play: accepts guilt quickly, shows empathy, becomes the
                    Inspector&rsquo;s ally
                  </li>
                  <li>
                    &bull; Act 3: refuses to go back to how things were; rejects Gerald&rsquo;s ring
                  </li>
                  <li>&bull; Contrast with her parents to highlight the generational divide</li>
                  <li>
                    &bull; Discuss Priestley&rsquo;s purpose: Sheila represents the audience he
                    hopes to create
                  </li>
                </ul>
              </div>
            ...
            <div className="rounded-lg border border-border bg-card p-5 shadow-md">
              ...
              <div className="mt-3 rounded bg-primary/5 p-3">
                ...
                <ul className="mt-1 space-y-1 text-xs text-muted-foreground">
                  <li>
                    &bull; Analyse the stage directions: &lsquo;pink and intimate&rsquo; lighting
                    symbolises comfortable illusion
                  </li>
                  <li>
                    &bull; Discuss Birling&rsquo;s speeches: dramatic irony in his predictions
                    establishes him as unreliable
                  </li>
                  <li>
                    &bull; Note the celebration context: the engagement dinner creates a sense of
                    surface harmony
                  </li>
                  <li>
                    &bull; Identify foreshadowing: Eric&rsquo;s unease, Gerald&rsquo;s evasiveness,
                    Sheila&rsquo;s suspicion
                  </li>
                  <li>
                    &bull; Consider the dramatic impact of the Inspector&rsquo;s arrival: the
                    doorbell interrupts Birling mid-speech
                  </li>
                  <li>
                    &bull; Link to context: the 1912 setting and its significance for a 1945
                    audience
                  </li>
                </ul>
              </div>
            ...
            <div className="rounded-lg border-2 border-primary/30 bg-primary/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                <li>
                  ...
                  the extract methodically. Use short, embedded quotations from the passage. Analyse
                  language, form, and structure (Writer's Methods). Then connect outward to the rest
                  of the play and relevant context.
                </li>
                <li>
                  ...
                  Priestley&rsquo;s methods and purpose, not just what happens. Integrate context
                  rather than adding it as a separate paragraph.
                </li>
                <li>
                  <strong className="text-foreground">Always use the author&rsquo;s name:</strong>{' '}
                  Write &ldquo;Priestley presents...&rdquo; or &ldquo;Priestley uses...&rdquo;
                  rather than &ldquo;the play shows...&rdquo;. This demonstrates awareness of
                  authorial intent and helps you discuss methods (Writer's Methods).
                </li>
                <li>
                ...
                <li>
                  ...
                  quotations (&lsquo;fire and blood and anguish&rsquo;) are more effective than long
                  block quotes. Aim for at least one quotation per paragraph.
                </li>
                <li>
                  <strong className="text-foreground">
                    Link everything to Priestley&rsquo;s purpose:
                  </strong>{' '}
                  The strongest answers connect analysis to Priestley&rsquo;s socialist message. Why
                  does he make Birling wrong about the Titanic? Why does Sheila change but Mrs
                  Birling does not? Always ask: what is Priestley trying to make the audience think
                  or feel?
                </li>
              </ul>
            </div>
