...
const chapterSummary = [
  ...
  },
  {
    ...
    quotations: [
      {
        quote: 'I am Mrs de Winter now, I am Mrs de Winter. I would repeat it over and over again',
        analysis:
  ...
  },
  {
    ...
    quotations: [
      ...
      {
        quote: 'She\u2019s still mistress here, even if she is dead',
        analysis:
  ...
  },
  {
    ...
    quotations: [
      {
        quote: 'You thought I loved Rebecca? You thought I killed her loving her? I hated her',
        analysis:
  ...
  },
  {
    ...
    quotations: [
      ...
      {
        quote: 'The ashes blew towards us with the salt wind from the sea',
        analysis:
    ...
    <>
      ...
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Characters, themes, chapter summaries with key quotations, du Maurier&rsquo;s narrative
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section id="exam-guidance" aria-labelledby="exam-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cambridge IGCSE Rebecca questions appear in <strong>Paper 1 (Prose)</strong>. You will
            choose between a passage-based (a) question and an essay (b) question.
          </p>
          ...
          <div className="mt-6 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="mt-2">How to Approach Passage-Based Questions</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    &bull; Read the extract carefully at least twice before writing. Underline key
                    words, images, and techniques.
                  </li>
                  <li>
                    &bull; Work through the passage systematically, selecting specific words and
                    phrases for close analysis.
                  </li>
                  <li>
                    &bull; Always analyse <em>how</em> du Maurier creates effects, not just{' '}
                    <em>what</em> is described. Use precise literary terminology: imagery,
                    symbolism, pathetic fallacy, foreshadowing, narrative voice.
                  </li>
                  <li>
                    &bull; Link outward from the passage to the rest of the novel: how does this
                    moment connect to wider themes, character development, or the novel&rsquo;s
                    structure?
                  </li>
                  <li>
                    &bull; Comment on the narrator&rsquo;s perspective: what does she notice, what
                    does she miss, and what does this reveal about her psychology?
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="mt-2">How to Approach Essay Questions</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    &bull; Plan 3&ndash;4 key points before writing. Each point should be supported
                    by quotations from different parts of the novel.
                  </li>
                  <li>
                    &bull; Structure your response with a clear argument that runs through the
                    essay. Avoid simply retelling the plot.
                  </li>
                  <li>
                    &bull; Focus on du Maurier&rsquo;s methods: how she uses language, structure,
                    narrative perspective, Gothic conventions, and symbolism to shape meaning.
                  </li>
                  <li>
                    &bull; Integrate context naturally. For example: &ldquo;The narrator&rsquo;s
                    anxiety about performing the role of hostess reflects 1930s expectations of
                    upper-class women, whose worth was measured by social competence rather than
                    personal qualities.&rdquo;
                  </li>
                  <li>
                    &bull; Consider alternative readings where appropriate: is Maxim a romantic hero
                    or a controlling figure? Is Rebecca&rsquo;s destruction of her marriage
                    justified?
                  </li>
                </ul>
              </CardContent>
            ...
            <div className="rounded-lg border-2 border-purple-600/30 bg-primary/5 p-5">
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                <li>
                  <strong className="text-foreground">Time management:</strong> You have
                  approximately 45 minutes per question. Spend 5 minutes planning, 35 minutes
                  writing, and 5 minutes checking.
                </li>
                <li>
                  <strong className="text-foreground">Use of terminology:</strong> Cambridge rewards
                  precise literary terminology used naturally: first-person narration, unreliable
                  narrator, Gothic conventions, foreshadowing, pathetic fallacy, symbolism, dramatic
                  irony, juxtaposition, motif.
                </li>
                <li>
                  <strong className="text-foreground">Quality over quantity:</strong> A
                  well-structured response with fewer points analysed in depth will score higher
                  than a rushed response covering many points superficially.
                </li>
                <li>
                  <strong className="text-foreground">The &lsquo;how&rsquo; question:</strong>{' '}
                  Nearly every Cambridge question asks <em>how</em> du Maurier achieves something.
                  Your response must go beyond plot summary to analyse methods and their effects on
                  the reader.
                </li>
              </ul>
            </div>
          ...
          <Card className="mt-6">
            <CardHeader>
              ...
              <CardTitle className="mt-2">
                How does du Maurier present the power of the past in <em>Rebecca</em>?
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="rounded-lg border border-border bg-primary/5 p-5">
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  Du Maurier presents the power of the past most vividly through the
                  narrator&rsquo;s obsessive encounter with Rebecca&rsquo;s monogram, describing how
                  &ldquo;a white slim hand was writing, writing, the tall sloping letters &mdash; R
                  de W &mdash; R de W&rdquo;{' '}
                  <span className="font-semibold text-foreground">
                    [Textual Knowledge: precise quotation]
                  </span>
                  . The disembodied hand, detached from any living body, functions as a Gothic image
                  of haunting: Rebecca is dead, yet her handwriting continues to &lsquo;write&rsquo;
                  itself into the present, as though her will persists beyond the grave{' '}
                  <span className="font-semibold text-foreground">
                    [Writer's Methods: analysis of Gothic imagery and present tense]
                  </span>
                  . The repetition of the initials mimics the narrator&rsquo;s compulsive thoughts,
                  suggesting that the past does not merely linger but actively replays, trapping her
                  in a cycle she cannot escape. A reader might interpret this passage as revealing
                  less about Rebecca&rsquo;s power than about the narrator&rsquo;s psychology: it is
                  her insecurity, not Rebecca&rsquo;s ghost, that animates the dead woman&rsquo;s
                  handwriting{' '}
                  <span className="font-semibold text-foreground">
                    [Interpretation: alternative interpretation]
                  </span>
                  . Du Maurier, writing in 1938, draws on a culture in which a woman&rsquo;s
                  identity was subsumed by her husband&rsquo;s name; the monogram &lsquo;R de
                  W&rsquo; is not Rebecca&rsquo;s own name but her married title, suggesting that
                  even Rebecca&rsquo;s seemingly invincible identity was a construction of
                  patriarchal convention rather than an authentic self{' '}
                  <span className="font-semibold text-foreground">
              ...
              <div className="mt-4 rounded bg-muted/50 p-4">
                <p className="text-xs font-semibold text-foreground">Why this paragraph works:</p>
                <ul className="mt-2 space-y-1 text-xs text-muted-foreground">
                  <li>
                    &bull; Opens with a clear topic sentence that addresses the question directly
                  </li>
                  <li>&bull; Embeds a precise, well-selected quotation (Textual Knowledge)</li>
                  <li>
                    &bull; Analyses du Maurier&rsquo;s techniques &mdash; Gothic imagery,
                    repetition, narrative perspective (Writer's Methods)
                  </li>
                  <li>&bull; Offers an alternative reading of the passage (Interpretation)</li>
                  <li>
                    &bull; Integrates context naturally into the analysis rather than bolting it on
                    (Personal Response)
                  </li>
                  <li>
                    &bull; Maintains analytical focus throughout without lapsing into plot summary
                  </li>
                </ul>
              </div>
            </CardContent>
