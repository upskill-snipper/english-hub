    ...
    <>
      ...
      <nav className="mx-auto max-w-5xl px-4 pt-6" aria-label="Breadcrumb">
        <ol className="flex flex-wrap items-center gap-2 text-sm text-gray-500">
          ...
          <li>/</li>
          <li>
            <Link href="/resources/english-literature/ocr" className="hover:text-[#1A5276] transition-colors">
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 space-y-6">
        ...
        <Section title="Marks per question at a glance">
          ...
          <h3 className="font-bold text-[#1A5276] mb-2">Paper 1 &mdash; Exploring Modern and Literary Heritage Texts (50%)</h3>
          ...
          <h3 className="font-bold text-[#1A5276] mt-6 mb-2">Paper 2 &mdash; Exploring Poetry and Shakespeare (50%)</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 text-left text-gray-500">
