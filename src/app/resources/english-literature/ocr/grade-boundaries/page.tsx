    ...
    <>
      ...
      <nav className="mx-auto max-w-5xl px-4 pt-6" aria-label="Breadcrumb">
        <ol className="flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
          ...
          <li>/</li>
          <li>
            <Link href="/resources/english-literature/ocr" className="hover:text-foreground transition-colors">
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 space-y-6">
        ...
        <Section title="Overall grade boundaries (combined Paper 1 + Paper 2)" defaultOpen>
          <p>
            ...
            Paper 1 (Exploring Modern and Literary Heritage Texts) is worth 80
            marks and Paper 2 (Exploring Poetry and Shakespeare) is worth 80
            marks. Each paper contributes 50% of the qualification. Your raw
            marks from both papers are combined to produce your overall grade.
            Below are the approximate boundaries from recent exam series:
          </p>
        ...
        <Section title="What each grade looks like in practice">
          ...
          <div className="mt-4 space-y-6">
            <div className="rounded-lg border-l-4 border-success-500 bg-success-50/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ml-5 list-disc space-y-1">
                  <li>Critical, exploratory, conceptualised response to texts with a sustained personal interpretation.</li>
                  <li>Judicious use of precise references to support a convincing argument.</li>
                  <li>Sophisticated analysis of the writer&rsquo;s methods with subject terminology used judiciously.</li>
                  <li>Perceptive exploration of the effects of language, form, and structure on the reader.</li>
                  <li>Exploration of ideas, perspectives, and contextual factors woven seamlessly throughout.</li>
                  <li>Confident, original response to unseen poetry showing mature critical engagement.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="rounded-lg border-l-4 border-primary bg-blue-50/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ml-5 list-disc space-y-1">
                  ...
                  <li>Apt references integrated into interpretations to build a coherent argument.</li>
                  <li>Detailed examination of the writer&rsquo;s methods with subject terminology used effectively.</li>
                  <li>Clear understanding of the effects of the writer&rsquo;s choices on the reader.</li>
                  <li>Thoughtful consideration of ideas, perspectives, and contextual factors.</li>
                  <li>Confident analysis of unseen poetry exploring language, form, and structure.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="rounded-lg border-l-4 border-primary bg-blue-50/20 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ml-5 list-disc space-y-1">
                  <li>Clear, explained response to texts with relevant ideas and some development.</li>
                  ...
                  <li>Understanding of some effects of the writer&rsquo;s methods on the reader.</li>
            ...
            <div className="rounded-lg border-l-4 border-yellow-400 bg-yellow-50/30 p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <ul className="ml-5 list-disc space-y-1">
                  <li>Some explained response to texts, though may lack consistency or development.</li>
                  ...
                  <li>Some awareness of contextual factors, though may be superficial or bolted on.</li>
          ...
          <div className="mt-4 space-y-5">
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  ...
                  Leaving sections blank &mdash; especially Shakespeare or
                  the poetry comparison &mdash; is the most common reason
            ...
            <div className="rounded-lg border border-border p-5">
              ...
              <ul className="mt-2 ml-5 list-disc space-y-2 text-sm">
                ...
                <li>
                  <strong>Structure:</strong> Pay attention to how texts are
                  structured. Comment on openings, endings, shifts in tone,
                  juxtaposition, and how the writer controls pacing and tension.
                </li>
                <li>
                  <strong>Poetry comparison:</strong> Use comparative
                  connectives throughout (&ldquo;Similarly,&rdquo;
        ...
        <Section title="Marks per question at a glance">
          <p className="mb-4">
            OCR GCSE English Literature (J352) is split into two papers, each
            worth 50% of the qualification. Both papers are 2 hours long and
            carry 80 marks each, giving a total of 160 marks.
          </p>

          <h3 className="font-bold text-foreground mb-2">Paper 1 &mdash; Exploring Modern and Literary Heritage Texts (50%)</h3>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                <tr>
                  ...
                  <td className="py-2 pr-4">Response to a modern prose or drama text</td>
                </tr>
                <tr>
                  <td className="py-2 pr-4 font-semibold">B &mdash; Literary heritage prose or drama</td>
                  <td className="py-2 pr-4">Extract + essay</td>
                  <td className="py-2 pr-4">40 marks</td>
                  <td className="py-2 pr-4">Response to a 19th-century or literary heritage text</td>
                </tr>
          ...
          <h3 className="font-bold text-foreground mt-6 mb-2">Paper 2 &mdash; Exploring Poetry and Shakespeare (50%)</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border text-left text-muted-foreground">
              ...
              <tbody className="divide-y divide-border">
                <tr>
                  ...
                  <td className="py-2 pr-4">Comparison essay</td>
                  <td className="py-2 pr-4">40 marks</td>
                  <td className="py-2 pr-4">Anthology poetry comparison (two poems linked by theme)</td>
                </tr>
                <tr>
                  <td className="py-2 pr-4 font-semibold">B &mdash; Unseen poetry</td>
                  <td className="py-2 pr-4">Analysis + comparison</td>
                  <td className="py-2 pr-4">16 marks</td>
                  <td className="py-2 pr-4">Response to unseen poem(s)</td>
                </tr>
                <tr>
                  <td className="py-2 pr-4 font-semibold">C &mdash; Shakespeare</td>
                  <td className="py-2 pr-4">Extract + essay</td>
                  <td className="py-2 pr-4">24 marks</td>
                  <td className="py-2 pr-4">Response to a Shakespeare play</td>
                </tr>
                <tr className="font-bold">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Both papers carry equal weight, so it is important to prepare
            thoroughly for all sections. The poetry comparison and Shakespeare
            extract questions often determine whether students cross into
            the higher grade bands.
          </p>
        </Section>
