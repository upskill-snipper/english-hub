    ...
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          { name: 'OCR', url: 'https://theenglishhub.app/resources/english-literature/ocr' },
        ]}
      />
      {/* ── Hero banner ─────────────────────────────────────────── */}
      <section className="border-b bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
            Everything you need to revise for OCR GCSE English Literature. Two examined papers
            covering modern texts, literary heritage, poetry, and Shakespeare.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <section aria-labelledby="overview-heading">
          ...
          <p className="mt-3 text-muted-foreground leading-relaxed">
            The OCR GCSE English Literature specification (J352) is assessed through two examined
            papers, each worth 50% of the final grade. There is no coursework or controlled
            assessment.
          </p>
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2">
            ...
            <div className="rounded-xl border-l-4 border-primary bg-card p-6 shadow-md">
              ...
              <div className="mt-4 flex gap-4 text-xs text-muted-foreground">
                <span className="rounded-full bg-muted px-3 py-1 font-medium">50% of GCSE</span>
                <span className="rounded-full bg-muted px-3 py-1 font-medium">2 hours</span>
              </div>
            </div>
        ...
        <section aria-labelledby="papers-heading">
          <h2 id="papers-heading" className="text-2xl font-bold text-foreground">
            Exam Papers
          </h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Detailed breakdowns of each paper, including question types, mark allocations, and
            timing advice.
          </p>
          <div className="mt-6 grid gap-6 sm:grid-cols-2">
            {examPapers.map((s) => (
              ...
              >
                <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-lg bg-primary text-primary-foreground transition">
                  {s.icon}
                </div>
        ...
        <section aria-labelledby="guides-heading">
          <h2 id="guides-heading" className="text-2xl font-bold text-foreground">
            Text Study Guides
          </h2>
          <p className="mt-2 text-sm text-muted-foreground">
            In-depth revision guides for each set text, covering characters, themes, key quotations,
        ...
        <section aria-labelledby="ao-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            All questions are marked against these four assessment objectives. Understanding them
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-xl border-l-4 border-primary bg-card p-5 shadow-md">
              ...
              <p className="mt-1.5 text-sm text-muted-foreground leading-relaxed">
                ...
                informed personal response. Use textual references, including quotations, to support
            ...
            <div className="rounded-xl border-l-4 border-primary bg-card p-5 shadow-md">
              ...
              <p className="mt-1.5 text-sm text-muted-foreground leading-relaxed">
                ...
                with accurate spelling and punctuation. (Only assessed in the Shakespeare section of
                Paper 2.)
              </p>
            </div>
          </div>
        ...
        <section aria-labelledby="skills-heading">
          <h2 id="skills-heading" className="text-2xl font-bold text-foreground">
            Key Skills for English Literature
          </h2>
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-xl border border-border bg-card p-5 shadow-md">
              <h3 className="font-semibold text-primary">Close Language Analysis</h3>
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Zoom into individual words and phrases. Explore connotations, the effect of
                techniques, and what specific language choices reveal about characters, themes, and
                the writer&rsquo;s intentions.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-5 shadow-md">
              <h3 className="font-semibold text-primary">Contextual Understanding</h3>
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Link your analysis to the historical, social, and cultural context in which the text
                was written. Context should enhance your analysis, not replace it.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-5 shadow-md">
              <h3 className="font-semibold text-primary">Thematic Analysis</h3>
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Track how themes develop across a whole text. Consider how themes connect to the
                writer&rsquo;s message and how they relate to the context of the period.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-5 shadow-md">
              <h3 className="font-semibold text-primary">Comparative Skills</h3>
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                For the poetry comparison, you must compare poems effectively &mdash; exploring
                similarities and differences in themes, methods, and effects.
              </p>
            </div>
          </div>
        </section>
        ...
        <section aria-labelledby="grades-heading">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Check the latest OCR GCSE English Literature grade boundaries, see what each grade looks
            like, and plan how to push your marks higher.
          </p>
          <div className="mt-4">
            <Link
