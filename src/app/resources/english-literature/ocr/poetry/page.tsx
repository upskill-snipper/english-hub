...
export const metadata: Metadata = {
  openGraph: {
    title: 'OCR GCSE Poetry Anthology Analysis - The English Hub',
    description:
    ...
    images: [
      {
        url: '/api/og?title=OCR+GCSE+Poetry+Anthology+Analysis+-+The+English+Hub',
        width: 1200,
        height: 630,
        alt: 'OCR GCSE Poetry Anthology Analysis - The English Hub',
      },
    ],
  },
  alternates: { canonical: 'https://theenglishhub.app/resources/english-literature/ocr/poetry' },
  title: 'OCR GCSE Poetry Anthology Analysis',
  description:
    'Detailed analysis of poems from the OCR GCSE English Literature poetry anthology. Themes, techniques, comparison strategies, and key quotations.',
}
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:py-16 lg:py-20">
        ...
        <section aria-labelledby="overview-heading">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              Regardless of which cluster you study, the analytical skills and comparison techniques
              are the same. This guide covers everything you need.
            </p>
          </div>
        </section>
        ...
        <section aria-labelledby="analysis-heading">
          ...
          <div className="mt-4 space-y-6 text-muted-foreground leading-relaxed">
            <p>
              When approaching any poem from the anthology, work through these layers of analysis:
            </p>

            {/* Layer 1: Meaning */}
            <div className="rounded-lg border border-border bg-muted p-5">
              <h3 className="font-semibold text-foreground">1. Subject and Meaning</h3>
              <p className="mt-2 text-sm">
                What is the poem about on the surface? What deeper themes or ideas does it explore?
                Is there a narrative, or is it more reflective? What is the poet&rsquo;s message or
            ...
            <div className="rounded-lg border border-border bg-muted p-5">
              <h3 className="font-semibold text-foreground">2. Voice and Tone</h3>
              <p className="mt-2 text-sm">
                Who is the speaker (persona)? Is it the poet themselves, or a fictional character?
                What is the tone &mdash; bitter, nostalgic, angry, celebratory, mournful, ironic,
            ...
            {/* Layer 3: Language */}
            <div className="rounded-lg border border-border bg-muted p-5">
              <h3 className="font-semibold text-foreground">3. Language and Imagery</h3>
              <p className="mt-2 text-sm">
            ...
            <div className="rounded-lg border border-border bg-muted p-5">
              <h3 className="font-semibold text-foreground">4. Form and Structure</h3>
              <p className="mt-2 text-sm">
              ...
              <ul className="ms-4 mt-2 list-disc space-y-1 text-sm">
                ...
                <li>
                  ...
                  flow, urgency, or a sense of something uncontainable.
                </li>
                <li>
                  <strong>Caesura</strong> &mdash; A pause in the middle of a line. Creates a
                  dramatic break, shift, or moment of reflection.
                </li>
                <li>
                  <strong>Volta</strong> &mdash; A turn or shift in the poem&rsquo;s argument, mood,
            ...
            {/* Layer 5: Context */}
            <div className="rounded-lg border border-border bg-muted p-5">
              <h3 className="font-semibold text-foreground">5. Context</h3>
              <p className="mt-2 text-sm">
            ...
            <div>
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-lg border border-primary/20 bg-primary/10 p-4">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    How do the poets structure their poems? Regular vs irregular form? Different use
                    of enjambment, stanzas, or line length?
                  </p>
                </div>
                <div className="rounded-lg border border-primary/20 bg-primary/10 p-4">
                ...
                <div className="rounded-lg border border-primary/20 bg-primary/10 p-4">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    How does the historical or personal context of each poet shape their treatment
                    of the theme?
                  </p>
                </div>
              </div>
        ...
        <section aria-labelledby="themes-heading">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Regardless of which cluster you study, these broad themes frequently appear. Mapping
              poems to themes helps you prepare comparison pairs in advance:
            </p>
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm">
                  ...
                  Consider how the poet uses form and structure to mirror or subvert power dynamics.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm">
                  ...
                  nostalgic, bitter, accepting, or angry? Consider how time is represented: linear,
                  fragmented, circular?
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm">
                  ...
                  family, place, and language in shaping identity.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm">
                  Is nature presented as beautiful, destructive, indifferent, or spiritual? Is it
                  used literally or symbolically? How does the poet contrast the natural world with
                  the human world? Consider pathetic fallacy and how landscape reflects inner
                  emotion.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm">
                  ...
                  there a resolution, or does the conflict remain unresolved? Consider the
                  perspectives of perpetrators, victims, and witnesses.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm">
                  ...
                  anticipate the future? Consider how the poem&rsquo;s structure mirrors its
                  treatment of time.
                </p>
              </div>
            </div>
        ...
        <section aria-labelledby="frameworks-heading">
          <h2 id="frameworks-heading" className="text-2xl font-bold text-foreground">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
            ...
            <div className="mt-3 space-y-3">
              <div className="rounded-lg border border-border bg-card p-4 shadow-md">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  State the point of comparison: &ldquo;Both poets present conflict as destructive,
                  but through contrasting methods.&rdquo;
                </p>
              </div>
              <div className="rounded-lg border border-border bg-card p-4 shadow-md">
                <p className="font-semibold text-primary">2. Analyse the printed poem</p>
                <p className="mt-1 text-sm text-muted-foreground">
                  Quote directly from the poem on the paper. Analyse specific word choices,
              ...
              <div className="rounded-lg border border-border bg-card p-4 shadow-md">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Use a comparative connective. Quote from memory (even short phrases). Analyse the
                  language and explain the comparison.
                </p>
              </div>
              <div className="rounded-lg border border-border bg-card p-4 shadow-md">
                <p className="font-semibold text-primary">4. Evaluate the effect</p>
                <p className="mt-1 text-sm text-muted-foreground">
                  What does this comparison reveal? Which approach is more effective and why?
                  Consider the reader&rsquo;s response.
                </p>
              </div>
            </div>
            ...
            <div className="mt-3 rounded-lg border border-border bg-card p-5 shadow-md">
              <p className="text-sm italic text-muted-foreground">
                &ldquo;Both poets explore the theme of lost love, yet their tones are markedly
                different. In [Poem A], the poet uses the metaphor of &lsquo;embers dying in the
                grate&rsquo; to suggest that love has not vanished entirely but has faded to a
                faint, weakening warmth. The verb &lsquo;dying&rsquo; implies a gradual, painful
                process, suggesting that the speaker cannot bring themselves to accept the
                relationship is over. In contrast, [Poem B] presents lost love through the stark
                image of a &lsquo;slammed door,&rsquo; using the forceful, plosive verb
                &lsquo;slammed&rsquo; to convey anger and finality. Where [Poem A] lingers in
                melancholy, [Poem B] embraces fury. This contrast suggests that loss is experienced
                differently by different individuals &mdash; some retreat into sadness, while others
                channel their pain into defiance.&rdquo;
              </p>
            </div>
          </div>
        </section>
        ...
        <section aria-labelledby="revision-heading">
          <h2 id="revision-heading" className="text-2xl font-bold text-foreground">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm">
                  ...
                  flashcards and test yourself daily.
                </p>
              </div>
              <div className="rounded-lg border border-border bg-muted p-5">
              ...
              <div className="rounded-lg border border-border bg-muted p-5">
                ...
                <p className="mt-2 text-sm">
                  Prepare comparison notes for multiple pairings. Any poem could appear in the exam,
                  so you need to be able to compare any poem with at least 2&ndash;3 others on
                  different themes.
                </p>
              </div>
            </div>
