      ...
      <section className="border-b border-border bg-card">
        <div className="mx-auto max-w-4xl px-6 py-12">
          ...
          <p className="mt-3 text-lg text-muted-foreground">
            A scaffolded worksheet that walks students through Point, Evidence,
            Explain. Students practise writing an analytical paragraph step
            by step using sentence starters and a worked example.
          </p>
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <section className="mb-10">
          ...
          <p className="mt-3 text-foreground">
            An analytical paragraph has three parts. Use this sheet to build
            your paragraph step by step. Read the extract, then follow the
            prompts in order. Your finished paragraph should flow as a
        ...
        <section className="mb-10">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            What is the main idea of your paragraph? Answer the question
            directly in one clear sentence.
          </p>
        ...
        <section className="mb-10">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Choose a short quotation from the extract that proves your point.
            Keep it short — a phrase or single sentence is enough. Embed it
        ...
        <section className="mb-10">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            This is the most important part. Zoom in on a specific word or
            technique in your evidence. What method has the writer used? What
            effect does it create? Why has the writer made that choice?
          </p>
          <div className="mt-4 rounded-2xl border border-border bg-card p-5">
            <h3 className="text-sm font-semibold text-foreground">
              Explain prompts
            ...
            <ul className="mt-2 space-y-1.5 text-sm text-muted-foreground">
              ...
              <li>
                • The writer&apos;s use of [metaphor / personification /
                verb choice] creates...
              </li>
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 rounded-2xl border border-border bg-card p-6">
            <p className="text-foreground">
              <strong>Question:</strong> How does Dickens present Scrooge in
              the opening of A Christmas Carol?
            </p>
            <p className="mt-4 text-foreground">
              <strong>Point:</strong> Dickens presents Scrooge as emotionally
              closed off from the world around him.
            </p>
            <p className="mt-4 text-foreground">
              <strong>Evidence:</strong> This is shown when Dickens describes
              him as &quot;solitary as an oyster&quot;.
            </p>
            <p className="mt-4 text-foreground">
              <strong>Explain:</strong> The simile suggests that Scrooge is
              hard on the outside and almost impossible to open, just like
              an oyster. The adjective &quot;solitary&quot; reinforces his
              isolation, making the reader feel a mix of pity and dislike.
              Perhaps Dickens wants us to question whether anyone could ever
              reach Scrooge — a question the rest of the novella sets out
              to answer.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-border bg-card p-5">
              ...
              <ul className="mt-2 space-y-1.5 text-sm text-muted-foreground">
                <li>
                  • Add a second Evidence &amp; Explain to make a PEEEL
                </li>
        ...
        <section className="mb-10">
          ...
          <ul className="mt-4 space-y-2 text-foreground">
            <li>
              <strong>Read the example first:</strong> Walk through the
              worked example together before students start their own.
            </li>
            <li>
              <strong>Live model:</strong> Build a fresh example on the
              board in real time so students see the thinking, not just the
              finished product.
            </li>
            <li>
              <strong>Keep Point short:</strong> Students often over-write
              the Point. One sentence is the target.
            </li>
            <li>
              <strong>Push Explain:</strong> Most low-grade paragraphs die
              in the Explain stage. Ask &quot;so what?&quot; twice.
            </li>
          </ul>
        </section>
      </article>
