...
const DEVICES: { term: string; definition: string }[] = [
  ...
  {
    term: 'Alliteration',
    definition: 'Repetition of the same consonant sound at the start of words.',
  },
      ...
      <section className="border-b border-border bg-card">
        <div className="mx-auto max-w-4xl px-6 py-12">
          ...
          <p className="mt-3 text-lg text-muted-foreground">
            A fast, print-and-play bingo activity with 24 essential language devices. Use as a
            5-minute starter, a recap at the end of a unit, or a homework quiz.
          </p>
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <section className="mb-10">
          ...
          <ol className="mt-4 list-decimal space-y-2 pl-6 text-foreground">
            ...
            <li>
              Read out the definitions in random order. Students tick off the device if they have
              it.
            </li>
            <li>
              First to get three in a row shouts BINGO! First to tick off all nine wins the full
              house.
            </li>
            <li>
              Quick-fire recap at the end: ask three students to give an example from the set text
              for one of the devices on their card.
            </li>
          </ol>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 overflow-hidden rounded-2xl border border-border bg-card">
            <table className="w-full text-sm">
              ...
              <tbody>
                {DEVICES.map((d) => (
                  <tr key={d.term} className="border-t border-border text-foreground">
                    <td className="px-4 py-3 font-semibold">{d.term}</td>
                    <td className="px-4 py-3 text-muted-foreground">{d.definition}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-border bg-card p-5">
              ...
              <ul className="mt-2 space-y-1.5 text-sm text-muted-foreground">
                <li>• Ask winners to give an original example of the device</li>
                <li>• Add rarer devices (polysyndeton, asyndeton, litotes)</li>
                <li>• Run a second round where students write the definitions themselves</li>
                <li>• Link each device to a quotation from the current text</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="mt-4 space-y-2 text-foreground">
            ...
            <li>
              <strong>Reuse cards:</strong> Laminate for reuse across classes.
            </li>
            <li>
            ...
            <li>
              ...
              of the devices from their card. Keeps stretch going.
            </li>
          </ul>
        </section>
      </article>
