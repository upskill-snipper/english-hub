...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://theenglishhub.app/resources/teacher-library/mark-schemes",
  },
};
...
const MARK_SCHEMES = [
  ...
  },
  {
    ...
    description:
      "Non-fiction and transactional writing. Synthesis and comparison AOs explained.",
    examBoard: "Edexcel",
  },
  {
    title: "Edexcel English Literature Paper 1",
    description:
      "Shakespeare and post-1914 literature. Level descriptors and AO weighting.",
    examBoard: "Edexcel",
  },
  {
  ...
  },
  {
    ...
    description:
      "Communicating information and ideas. Key AOs and descriptors at levels 1–6.",
    examBoard: "OCR",
  },
  {
    title: "OCR English Language Component 02",
    description:
      "Exploring effects and impact. AO breakdown and common examiner feedback.",
    examBoard: "OCR",
  },
  {
    title: "OCR English Literature Component 01",
    description:
      "Exploring modern and literary heritage texts. AOs, levels, and grade boundaries.",
    examBoard: "OCR",
  },
  {
    title: "OCR English Literature Component 02",
    description:
      "Exploring poetry and Shakespeare. Comparison and AO3 (context) expectations.",
    examBoard: "OCR",
  },
  {
  ...
  },
  {
    ...
    description:
      "19th- and 21st-century non-fiction and transactional writing. Level descriptors.",
    examBoard: "Eduqas",
  },
  {
    title: "Eduqas English Literature Component 1",
    description:
      "Shakespeare and poetry. Level descriptors and weighting of AOs.",
    examBoard: "Eduqas",
  },
  {
      ...
      <section className="border-b border-border bg-card">
        <div className="mx-auto max-w-6xl px-6 py-12">
          ...
          <p className="mt-3 max-w-2xl text-lg text-muted-foreground">
            Quick-reference mark scheme cards for every major GCSE English
            exam board. Grade descriptors, AO weightings, and common examiner
            comments at your fingertips.
          </p>
          <p className="mt-4 text-sm text-muted-foreground">
            These are summary reference cards written by teachers. For the
            official mark schemes, visit the awarding body websites.
          </p>
        </div>
      </section>
