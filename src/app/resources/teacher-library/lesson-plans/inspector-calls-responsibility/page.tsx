...
export default function InspectorCallsLessonPlan() {
  return (
    <main className="min-h-screen bg-background">
      <section className="border-b border-border bg-card">
        <div className="mx-auto max-w-4xl px-6 py-12">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground">Inspector Calls: Responsibility</span>
          </div>
          ...
          <h1 className="mt-4 text-4xl font-bold tracking-tight text-foreground">
            An Inspector Calls: Social Responsibility (Act 1)
          </h1>
          <p className="mt-3 text-lg text-muted-foreground">
            A 60-minute lesson examining how Priestley introduces the theme
            of responsibility through Mr Birling&apos;s birthday speech and
            the Inspector&apos;s arrival. Includes a guided close reading
            and a structured essay paragraph.
          </p>
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <section className="mb-10">
          ...
          <ul className="mt-4 space-y-2 text-foreground">
            <li className="flex gap-3">
              ...
              Explain how Priestley uses Mr Birling&apos;s speech to
              introduce the theme of social responsibility through dramatic
              irony.
            </li>
            <li className="flex gap-3">
              <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              Analyse how the Inspector&apos;s arrival shifts the tone and
              message of the play (AO2).
            </li>
            <li className="flex gap-3">
              <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
            ...
            <li className="flex gap-3">
              <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              Write a developed analytical paragraph using the What–How–Why
              structure.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="mt-4 space-y-2 text-foreground">
            <li>• Copies of Mr Birling&apos;s Act 1 speech (&quot;a man has to make his own way&quot;)</li>
          ...
          <div className="mt-6 space-y-6">
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="mt-3 text-foreground">
                Display the question: &quot;Are we responsible for the
                wellbeing of strangers?&quot; Students vote yes / no / it
                depends with sticky notes on the board. Use three quick
              ...
              <div className="mt-3 space-y-4 text-foreground">
                <div>
                  <h4 className="font-semibold">
                    Part 1: Context bridge (5 min)
                  </h4>
                  <p className="mt-1 text-sm leading-relaxed">
                    Show the 1912 vs 1945 timeline. Briefly explain that
                    Priestley is writing in 1945 but setting the play in
                    1912 — a deliberate choice.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold">
                    Part 2: Modelled reading (10 min)
                  </h4>
                  <p className="mt-1 text-sm leading-relaxed">
                    Read Mr Birling&apos;s speech aloud. Model how to spot
                    the dramatic irony (Titanic, war, Russian revolution).
                    Discuss what Priestley wants a 1945 audience to think
                    of Birling.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold">
                    Part 3: Guided analysis (10 min)
                  </h4>
                  <p className="mt-1 text-sm leading-relaxed">
                    In pairs, students complete a What–How–Why grid on one
                    quotation from the speech. Collect answers on the
                    board to build a shared model.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold">
                    Part 4: Independent writing (15 min)
                  </h4>
                  <p className="mt-1 text-sm leading-relaxed">
            ...
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="mt-3 text-foreground">
                Students swap books with a partner. Using a checklist
                (quotation, method, effect, context), they identify one
                strength and one target. Volunteers share their target for
                next lesson&apos;s improvement task.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="mt-3 text-foreground">
                Re-read Mr Birling&apos;s speech and learn three quotations.
                Write a 150-word paragraph explaining how a 1945 audience
                would react differently to a 1912 audience. Bring for quiz.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="mt-4 space-y-2 text-foreground">
            <li>
              <strong>Dramatic irony:</strong> Don&apos;t assume students know
              the term. Define it on the board and return to it twice in the
              lesson.
            </li>
            <li>
              <strong>Context first:</strong> Students need the 1912 vs 1945
              difference clear before they can interpret the speech. Don&apos;t
              skip the timeline.
            </li>
            <li>
              <strong>Read it well:</strong> Mr Birling&apos;s pomposity is
              half the effect. Don&apos;t read the speech flatly — ham it up.
            </li>
          </ul>
        </section>
