      ...
      <section className="border-b border-border bg-card">
        <div className="mx-auto max-w-4xl px-6 py-12">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <Link href="/resources/teacher-library/revision-packs" className="hover:text-primary">
              Revision Packs
            </Link>
            <span>/</span>
          ...
          <p className="mt-3 text-lg text-muted-foreground">
            ...
            <em>The Strange Case of Dr Jekyll and Mr Hyde</em>. Hand it out as mock revision, set as
            homework, or use as a final-week classroom resource.
          </p>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-3">
            ...
            <div className="rounded-lg border border-border bg-background p-3">
              ...
              <div className="mt-1 text-sm font-semibold text-foreground">Mock revision</div>
            </div>
          </div>
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-border bg-card p-5">
              <h3 className="font-semibold text-foreground">Science vs Religion</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Victorian anxiety about unchecked science. Jekyll&apos;s transgressive chemistry
                plays God, and his downfall echoes warnings about tampering with nature.
              </p>
            </div>
            <div className="rounded-2xl border border-border bg-card p-5">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                A society obsessed with appearances. Jekyll&apos;s desperate need to protect his
                reputation drives him to create Hyde in the first place.
              </p>
            </div>
            <div className="rounded-2xl border border-border bg-card p-5">
              <h3 className="font-semibold text-foreground">Secrecy &amp; Repression</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Locked doors, sealed letters, private rooms. The novella is built on Victorian
                repression and the violence that erupts when desires are denied.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Characters */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-foreground">Key Characters</h2>
          <div className="mt-4 space-y-4">
            <div className="rounded-2xl border border-border bg-card p-5">
              <h3 className="font-semibold text-foreground">Dr Henry Jekyll</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                A respected scientist with a hidden double life. Stevenson uses him as a warning
                about the danger of repressing one&apos;s darker impulses. His arc is a slow loss of
                control.
              </p>
            </div>
            <div className="rounded-2xl border border-border bg-card p-5">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                The embodiment of Jekyll&apos;s evil. Described in animalistic, deformed terms.
                Represents Victorian fears of degeneration and the primal beneath the civilised.
              </p>
            </div>
            <div className="rounded-2xl border border-border bg-card p-5">
            ...
            <div className="rounded-2xl border border-border bg-card p-5">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Jekyll&apos;s scientific foil. His death after witnessing the transformation shows
                the physical cost of confronting the truth about human nature.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Quote bank */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-foreground">Quote Bank</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Ten essential quotations to learn by heart. Each is followed by a one-line analytical
            hook.
          </p>
        ...
        <section className="mb-10">
          ...
          <ul className="mt-4 space-y-3 text-foreground">
            <li>
              <strong>Darwin (1859):</strong> <em>On the Origin of Species</em> unsettled Victorian
              certainty about human superiority. Hyde as &quot;ape-like&quot; taps into fears of
              evolution in reverse.
            </li>
            <li>
              <strong>Jack the Ripper (1888):</strong> The novella predates the Whitechapel murders
              by two years but reflects the same fears of unseen evil in London streets.
            </li>
            <li>
        ...
        {/* Essay plans */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-foreground">Graded Essay Plans</h2>
          <div className="mt-4 space-y-4">
            <div className="rounded-2xl border border-border bg-card p-5">
              <h3 className="font-semibold text-foreground">
            ...
            <div className="rounded-2xl border border-border bg-card p-5">
              ...
              <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-muted-foreground">
                ...
                <li>Para 2: Utterson suppresses information to protect friends.</li>
                <li>Para 3: Victorian society itself is the culprit.</li>
                <li>
                  Conclusion: Stevenson critiques a culture that forces people to hide their
                  humanity.
                </li>
              </ol>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="mt-4 space-y-2 text-foreground">
            <li>
              ...
              per week leading into the mock.
            </li>
            <li>
              <strong>Test the quotes:</strong> Low-stakes quizzing beats silent reading. Five-a-day
              quote quizzes for a week.
            </li>
            <li>
              <strong>Essay plan first:</strong> Plan, don&apos;t just write. Students who can plan
              in 3 minutes beat students who dive in.
            </li>
          </ul>
        </section>
