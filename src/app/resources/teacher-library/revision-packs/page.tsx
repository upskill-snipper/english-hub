...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://theenglishhub.app/resources/teacher-library/revision-packs",
  },
};
      ...
      <section className="border-b border-border bg-card">
        <div className="mx-auto max-w-6xl px-6 py-12">
          ...
          <p className="mt-3 max-w-2xl text-lg text-muted-foreground">
            Ready-to-print revision booklets for every major GCSE set text.
            Hand them out as homework, mock-revision packs, or self-study
            resources.
          </p>
        </div>
      </section>
