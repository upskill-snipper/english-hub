      ...
      <section className="border-b border-border bg-card">
        <div className="mx-auto max-w-4xl px-6 py-12">
          ...
          <p className="mt-3 text-lg text-muted-foreground">
            A 5-minute quick-fire starter. 10 literary devices, 10 snappy
            clues — students shout out the answer or write it on a
            mini-whiteboard. No prep, no printing.
          </p>
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <section className="mb-10">
          ...
          <ol className="mt-4 list-decimal space-y-2 pl-6 text-foreground">
            <li>
              Project the title and a short instruction: &quot;10 devices, 10
              clues, 5 minutes.&quot;
            </li>
            <li>
              Read clue 1 aloud. Give 10 seconds of thinking time. Students
              write on a mini-whiteboard or shout out.
            </li>
            <li>Reveal the answer on the board. Keep the pace brisk.</li>
            <li>Repeat for all 10 clues.</li>
            <li>
              Finish with a 30-second recap: students share one device
              they got right and one they want to remember.
            </li>
          </ol>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-border bg-card p-5">
              ...
              <ul className="mt-2 space-y-1.5 text-sm text-muted-foreground">
                <li>
                  • After each answer, the student who got it gives a
                  quotation example
                </li>
                <li>
                  • Swap to rarer devices (zeugma, anaphora, litotes)
                </li>
                <li>• Add a bonus round of trickier devices</li>
                <li>
                  • Challenge: use three of the devices in a single
                  sentence
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="mt-4 space-y-2 text-foreground">
            <li>
              <strong>Keep the pace:</strong> The magic of a speed round is
              momentum. Don&apos;t over-explain between clues.
            </li>
            <li>
              <strong>Use mini-whiteboards:</strong> Shouting out can
              leave quieter students behind. Whiteboards keep everyone in.
            </li>
            <li>
              <strong>Celebrate:</strong> A quick cheer or a high-five for
              the first to get each answer keeps energy high.
            </li>
            <li>
              <strong>Link to the lesson:</strong> Choose your 10 devices
              so at least two will appear in the main activity.
            </li>
          </ul>
        </section>
      </article>
