...
const STARTERS = [
  ...
  },
  {
    ...
    description:
      'Introduce a Tier 2 vocabulary word, define it, and challenge students to use it in a sentence.',
    tag: 'Coming soon',
  },
  {
    id: 'quote-scramble',
    title: 'Quote Scramble',
    description:
      'Students unscramble a jumbled key quotation and identify the speaker and context.',
    tag: 'Coming soon',
  },
  {
  ...
  {
    id: 'last-lesson-retrieval',
    title: 'Last Lesson Retrieval',
    description: 'Five questions from the previous lesson, one from last week, one from last term.',
    tag: 'Coming soon',
  },
  {
    id: 'image-as-opening',
    title: 'Image as Opening',
    description:
      'Project a striking image. Students write the first line of a story inspired by it.',
    tag: 'Coming soon',
  },
  {
    id: 'guess-the-character',
    title: 'Guess the Character',
    description: 'Read three clues about a character from a set text. Students guess and justify.',
    tag: 'Coming soon',
  },
  {
    id: 'odd-one-out',
  ...
  {
    id: 'theme-speed-write',
    title: 'Theme Speed-Write',
    description: '2 minutes to write everything they know about a theme. Pair, share, add.',
    tag: 'Coming soon',
  },
  {
    id: 'quote-of-the-day',
    title: 'Quote of the Day',
    description: 'A single quotation on the board. Students annotate methods in 3 minutes.',
    tag: 'Coming soon',
  },
  {
    id: 'find-the-error',
    title: 'Find the Error',
    description: 'A SPaG paragraph riddled with mistakes. Students find and correct them.',
    tag: 'Coming soon',
  },
  {
    id: 'synonym-ladder',
    ...
    description:
      "Start with a basic word (e.g. 'sad'). Students build a ladder of increasingly sophisticated synonyms.",
    tag: 'Coming soon',
  },
  {
  ...
  },
  {
    ...
    description:
      'A historical fact on the board. Students link it to a set text or a specific quotation.',
    tag: 'Coming soon',
  },
  {
    id: 'opening-line-analysis',
    title: 'Opening Line Analysis',
    description: 'A famous opening line. Students write one sentence on what makes it effective.',
    tag: 'Coming soon',
  },
  {
    id: 'character-ranking',
    title: 'Character Ranking',
    description:
      'Rank a set of characters by power, morality, or sympathy. Justify your ranking to a partner.',
    tag: 'Coming soon',
  },
  {
    ...
    description:
      'Five images on the board. Students label each with a precise, sophisticated adjective.',
    tag: 'Coming soon',
  },
  {
  ...
  },
  {
    ...
    description: 'A simple 4-word sentence. Students expand it into a 20-word complex sentence.',
    tag: 'Coming soon',
  },
  {
    id: 'true-or-false',
    title: 'True or False: Set Text',
    description: 'Ten statements about the current set text. Students vote true or false.',
    tag: 'Coming soon',
  },
]
      ...
      <section className="border-b border-border bg-card">
        <div className="mx-auto max-w-6xl px-6 py-12">
          ...
          <p className="mt-3 max-w-2xl text-lg text-muted-foreground">
            20 quick, classroom-ready starters to hook your class. Retrieval practice, vocabulary,
            analysis, and creative writing warm-ups that need no printing.
          </p>
        </div>
      </section>
