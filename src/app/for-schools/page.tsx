  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden pt-24 pb-28 sm:pt-32 sm:pb-36">
        ...
        <div className="absolute top-1/4 end-1/4 w-[500px] h-[500px] bg-blue-500/[0.03] rounded-full blur-[140px] pointer-events-none" />
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      <div key={row.label} className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-semibold text-foreground w-8 text-end">
                          {row.pct}%
                        </span>
                      </div>
                    ))}
            ...
            <div className="rounded-lg border border-border/40 overflow-hidden text-xs">
              <div className="grid grid-cols-4 bg-muted/40 text-muted-foreground font-semibold">
                {[
                  ...
                  <div key={h} className="px-3 py-2 border-e border-border/30 last:border-e-0">
                    {h}
                  </div>
                ))}
              </div>
              {[
                ...
                >
                  {row.map((cell, j) => (
                    <div key={j} className="px-3 py-2 border-e border-border/30 last:border-e-0">
                      {cell}
                    </div>
                  ))}
                </div>
            ...
            {howItWorks.map((step, i) => (
              <div key={step.title} className="relative flex flex-col items-start">
                {i < HOW_IT_WORKS.length - 1 && (
                  <div className="hidden md:block absolute top-5 start-[calc(100%-1rem)] w-8 h-px bg-border/60" />
                )}
                <div
                  className={cn(
                ...
                <div className="text-5xl font-black text-foreground/[0.05] absolute top-0 end-0 leading-none">
                  {step.step}
                </div>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="rounded-2xl border border-border/40 overflow-hidden">
            <div className="grid grid-cols-3 bg-card text-sm font-semibold">
              <div className="px-5 py-4 text-foreground border-e border-border/40">
                {await t('mkt.schools.fs.compare.col.feature')}
              </div>
              <div className="px-5 py-4 text-primary text-center border-e border-border/40">
            ...
            {comparisonRows.map((row, i) => (
              ...
              >
                <div className="px-5 py-3.5 text-foreground/80 border-e border-border/40">
                  {row.feature}
                </div>
                <div className="px-5 py-3.5 flex items-center justify-center border-e border-border/40">
                  {row.school ? (
