...
export const metadata: Metadata = {
  ...
  description: "Join the Founding Schools Programme. Full platform access for all students and teachers. 5-8 hours saved per teacher per week. Ofsted-ready reporting. Only 10 places.",
  alternates: { canonical: "https://theenglishhub.app/for-schools" },
  openGraph: {
    title: "English Hub for Schools | Founding Schools Programme 2026",
    description: "Founding Schools Programme: unlimited students and teachers, all courses, analytics dashboard, priority onboarding. Only 10 places for 2026.",
