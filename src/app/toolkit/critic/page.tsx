...
import { ArrowLeft, ArrowRight, Brain, GraduationCap, MessageSquare, Sparkles, Target } from 'lucide-react'
    ...
    <div className="mx-auto max-w-4xl space-y-8 px-4 py-8 pb-16 sm:px-6 lg:px-8">
      ...
      <section className="rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-cyan-500/[0.04] p-6 sm:p-8">
        ...
        <p className="mt-3 max-w-2xl text-body-md text-muted-foreground">
          ...
          follow up with three pushback questions, and give you a skeleton for a strong AO5
          defence. Use this to practise the rhythm of critic → concede → reframe → sharpen
          before you hit a real Unit 3 or Unit 4 essay.
        </p>
        ...
        <section className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Draft a response in your head (or on paper). When ready, reveal the next pushback
