  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-4">
      <div className="bg-card border border-border rounded-xl max-w-md w-full text-center space-y-4 p-8">
        ...
        <h2 className="text-xl font-bold text-foreground">Failed to load school</h2>
        <p className="text-muted-foreground">We had trouble loading the school page. Please try again.</p>
        <div className="flex gap-3 justify-center">
          <Link href="/school" className="inline-flex items-center justify-center px-5 py-2.5 border border-border text-foreground font-medium rounded-lg hover:bg-accent transition-colors">
            Back to School
          </Link>
