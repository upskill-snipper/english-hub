            ...
            <Card className="border-border bg-card/60">
              ...
              <CardContent>
                <p className="mb-4 text-sm text-muted-foreground">
                  Student grade data (Working At Grade, Predicted Grade, Target Grade) is
                  populated as students complete assessments on the platform. The more
                  assessments completed, the richer the data becomes.
                </p>
                ...
                <div className="mt-4 rounded-lg border border-blue-500/20 bg-blue-500/5 p-3">
                  <p className="text-xs text-blue-300">
                    ...
                    identification will appear here as assessment data is collected. Assign
                    mock exams, quizzes, and essays to start building student profiles.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-border bg-card/60">
              ...
              <CardContent>
                <p className="mb-3 text-sm text-muted-foreground">
                  ...
                  Assessment. Assign the assessment to your classes to generate
                  reading age, decoding age, and fluency age data for each student.
                </p>
                <Button
                  variant="outline"
                  size="sm"
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 px-3 py-2.5">
                    ...
                    <p className="mt-0.5 text-[11px] text-muted-foreground">
                      A student is "on track" when their predicted grade meets or
                      exceeds their target grade.
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <Card className="border-border bg-card/60">
            ...
            <CardContent>
              <p className="mb-3 text-xs text-muted-foreground">
                View the interactive demo dashboard with sample student data to see
                grade distributions, on-track analysis, and student intervention lists.
              </p>
              <Button
                variant="outline"
                size="sm"
