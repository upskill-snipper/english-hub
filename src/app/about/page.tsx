...
export const metadata: Metadata = {
  ...
  title: 'About us - GCSE & IGCSE English revision',
  description:
    'How The English Hub works, who built it and why it focuses on GCSE and IGCSE English revision, including the exam boards and schools it serves.',
