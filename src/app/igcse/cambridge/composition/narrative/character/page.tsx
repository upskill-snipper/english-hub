...
export const metadata: Metadata = {
  ...
  description:
    'Build rounded characters fast in a Cambridge IGCSE short story. Show-don’t-tell, the iceberg principle, contradictions and the two-sentence sketch.',
  alternates: {
    canonical: 'https://theenglishhub.app/igcse/cambridge/composition/narrative/character',
  },
}
  ...
  return (
    <div className="space-y-10 pb-16">
      ...
      >
        ...
        {await t('igcse.page.back_to_narrative')}
      </Button>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-heading-sm font-heading">The iceberg principle</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3 text-body-sm text-muted-foreground">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              <strong className="text-foreground">What do they want in this scene?</strong>
            </li>
            <li>
              <strong className="text-foreground">What are they hiding?</strong>
            </li>
            <li>
              <strong className="text-foreground">What one object belongs to them?</strong>
            </li>
          </ul>
          <p>
            You will probably use only the object in the finished story. The other two steer every
            choice they make on the page.
          </p>
        </CardContent>
      </Card>
            ...
            <Card key={i}>
              <CardContent className="grid gap-4 p-5 sm:grid-cols-2">
                <div className="rounded-lg border border-border/60 bg-destructive/5 p-4">
                  ...
                  <p className="mt-2 text-body-sm italic text-foreground">“{e.tell}”</p>
                </div>
                <div className="rounded-lg border border-border/60 bg-primary/5 p-4">
                  ...
                  <p className="mt-2 text-body-sm italic text-foreground">“{e.show}”</p>
                </div>
              </CardContent>
            </Card>
          ))}
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-heading-sm font-heading">Give them a contradiction</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3 text-body-sm text-muted-foreground">
          <p>
            A flat character wants one thing. A rounded character wants two things that cannot both
            be true at once. A girl who wants to be brave but is afraid of her grandmother. A man
            who loves his dog but hates being touched. The story lives in the gap between the two
            halves.
          </p>
          <div className="rounded-lg border border-border/60 bg-primary/5 p-4">
            <p className="text-body-xs font-semibold uppercase tracking-wide text-primary">
            ...
            <p className="mt-2 text-body-sm italic text-foreground">
              “He said he hated surprises, but he checked the window every time a car slowed down.”
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-heading-sm font-heading">Interior monologue</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3 text-body-sm text-muted-foreground">
          <p>
            Thoughts on the page can be italicised, direct, or indirect. Pick one method and stick
            to it. A single sentence of interior thought in the right place is worth five sentences
            of description.
          </p>
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-lg border border-border/60 bg-muted/40 p-3">
              <p className="text-body-xs font-semibold text-foreground">Italicised</p>
              <p className="mt-1 text-body-xs italic text-muted-foreground">
                <em>Not today. Please not today.</em>
              </p>
            </div>
            <div className="rounded-lg border border-border/60 bg-muted/40 p-3">
              <p className="text-body-xs font-semibold text-foreground">Direct</p>
              <p className="mt-1 text-body-xs italic text-muted-foreground">
                She thought: I can still turn around.
              </p>
            </div>
            <div className="rounded-lg border border-border/60 bg-muted/40 p-3">
              <p className="text-body-xs font-semibold text-foreground">Indirect (free)</p>
              <p className="mt-1 text-body-xs italic text-muted-foreground">
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        <h2 className="text-heading-md font-heading text-foreground">The two-sentence sketch</h2>
        <p className="mt-3 text-body-sm text-muted-foreground">
          A useful rehearsal. Introduce a character in exactly two sentences. The first gives a
          physical detail that implies personality. The second gives an action that contradicts,
          extends or confirms it.
        </p>
