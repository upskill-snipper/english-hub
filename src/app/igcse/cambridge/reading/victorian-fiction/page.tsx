...
export const metadata: Metadata = {
  openGraph: {
    ...
    images: [
      {
        url: '/api/og?title=Approaching+Victorian+Fiction+-+Reading+Practice+Framework+-+The+English+Hub',
        width: 1200,
        height: 630,
        alt: 'Approaching Victorian Fiction - Reading Practice Framework - The English Hub',
      },
    ],
  },
  ...
  description:
    'Cambridge IGCSE Paper 1 reading practice on Victorian fiction. Comprehension, language analysis, summary and self-assessment using free Project Gutenberg texts.',
  alternates: {
    canonical: 'https://theenglishhub.app/igcse/cambridge/reading/victorian-fiction',
  },
}
    ...
    <div className="space-y-8 pb-16">
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-body-sm text-foreground">
            Victorian passages test your syntactic stamina, your vocabulary in context and your
            sensitivity to register. Paper 1 regularly uses nineteenth-century extracts, so learning
            to read them confidently is one of the highest-return skills you can develop.
          </p>
        </CardContent>
      </Card>
      ...
      <section>
        ...
        <p className="mb-4 text-body-sm text-muted-foreground">
          Three Victorian novels that give you a cross-section of the period. Dip into any chapter.
        </p>
        ...
        <Card className="border-primary/30 bg-primary/5">
          <CardContent className="pt-6">
            <p className="text-body-md italic text-foreground">
              &ldquo;How does the writer use language to create a distinctly Victorian sense of
              world and voice?&rdquo;
            </p>
            <p className="mt-4 text-body-sm text-muted-foreground">
              Write roughly 150 words. Quote three phrases and comment on syntax, register and
              period detail.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6 space-y-3 text-body-sm text-foreground">
            ...
            <ul className="list-disc space-y-2 ps-5">
              <li>
                <strong>Sentence 1:</strong> Who and where the passage is about.
              </li>
              <li>
              ...
              <li>
                <strong>Sentence 5:</strong> The attitude the narrator seems to take towards the
                scene.
              </li>
            </ul>
          </CardContent>
