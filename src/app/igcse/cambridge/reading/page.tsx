...
export const metadata: Metadata = {
  openGraph: {
    ...
    description:
      'Ten reading frameworks for Cambridge IGCSE First Language English Paper 1. Each teaches how to approach one passage type and sets tasks on public-domain texts.',
    images: [
      {
