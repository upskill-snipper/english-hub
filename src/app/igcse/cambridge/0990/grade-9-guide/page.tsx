...
export const metadata: Metadata = {
  ...
  description:
    'Grade 9 guide for Cambridge IGCSE 0990 First Language English. Writing techniques, analytical depth and structural sophistication needed to reach the top grade.',
