    ...
    <div className="space-y-10 pb-16">
      ...
      <section>
        ...
        <div className="overflow-hidden rounded-2xl border border-border/60 bg-card">
          <ul className="divide-y divide-border/40">
            {sameRows.map((r) => (
              <li key={r.label} className="flex flex-col gap-1 p-5 sm:flex-row sm:items-start sm:gap-6">
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        ...
        <ul className="mt-4 space-y-3 text-body-sm text-muted-foreground">
          ...
          <li className="flex items-start gap-3">
            <CheckCircle2 className="mt-0.5 size-4 shrink-0 text-primary" />
            <span>
              <strong className="text-foreground">Target by grade, not by letter.</strong>{' '}
              Use our{' '}
              <Link
              ...
              to translate any A*-G advice into the grade you&apos;re aiming
              for.
            </span>
          </li>
          <li className="flex items-start gap-3">
            <CheckCircle2 className="mt-0.5 size-4 shrink-0 text-primary" />
            <span>
              <strong className="text-foreground">Grade 9 is harder than A*.</strong>{' '}
              On the 9-1 scale the top grade is more selective. If you were
              aiming for A*, aim now for a strong 8 or 9 — read our{' '}
              <Link
      ...
      <section className="rounded-2xl border border-primary/20 bg-primary/5 p-6 sm:p-8">
        ...
        <p className="mt-2 text-body-sm text-muted-foreground">
          Dig into the detail of the syllabus, the papers or how to target a
          specific grade.
        </p>
