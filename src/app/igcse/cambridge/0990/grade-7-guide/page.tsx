...
export default function Grade7GuidePage() {
  return (
    <div className="space-y-10 pb-16">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-primary/[0.06] p-6 sm:p-8 lg:p-10">
        <div className="relative">
          ...
          <p className="mt-3 max-w-3xl text-body-lg text-muted-foreground">
            Grade 7 is the new A. It shows a confident grasp of both reading
            and writing — you understand what the question wants, you
            analyse clearly, and you write accurately. This guide gives you
            the habits, checks and common mistakes that separate 7s from 5s.
          </p>
        </div>
      </section>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-body-sm italic text-muted-foreground leading-relaxed">
              The writer uses a striking metaphor when he calls the market
              &ldquo;a beating heart&rdquo;. This suggests that the market is
              alive and pulsing with energy, which makes the reader imagine
              constant movement and noise. The verb &ldquo;beating&rdquo;
              implies rhythm and life, as if the whole community depends on
              this single place for its survival. The writer&apos;s choice
              helps the reader picture the stalls as essential, not just
              commercial.
            </p>
            <div className="rounded-lg border border-primary/20 bg-primary/5 p-3">
              <p className="text-body-xs text-foreground">
                <strong>Why it works:</strong> clear quotation, identified
                technique, effect explained on the reader, accurate writing
                throughout. To push into Grade 9, add a second layer of
                interpretation and a comment on context.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        ...
        <p className="mt-2 text-body-sm text-muted-foreground">
          If you can tick all seven of these honestly, you&apos;re on track
          for Grade 7.
        </p>
