...
export const metadata: Metadata = {
  ...
  description:
    '1930s Alabama, Jim Crow, the Scottsboro Boys, Harper Lee\u2019s Monroeville childhood and the Civil Rights Movement context for To Kill a Mockingbird.',
  alternates: {
    canonical: 'https://theenglishhub.app/igcse/edexcel/prose/to-kill-a-mockingbird/context',
  },
}
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Context',
            url: 'https://theenglishhub.app/igcse/edexcel/prose/to-kill-a-mockingbird/context',
          },
        ]}
      />
      <div>
