...
const themeGroups = [
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        analysis:
          'Atticus directly challenges the jury\u2019s racial generalisations in legal register.',
      },
      {
        text: 'You\u2019ll see white men cheat black men every day of your life.',
        speaker: 'Atticus',
        analysis:
          'A bleak acknowledgement that complicates readings of Atticus as naively optimistic.',
      },
      {
    ...
    quotes: [
      {
        ...
        analysis:
          'The novel\u2019s working definition of courage: principled action despite certain failure.',
      },
      {
        text: 'Simply because we were licked a hundred years before we started.',
        speaker: 'Atticus',
        analysis:
          'Places the trial in a long history of racial injustice; courage lies in trying regardless.',
      },
      {
        text: 'She was the bravest person I ever knew.',
        speaker: 'Atticus (on Mrs Dubose)',
        analysis:
          'Superlative praise for an unlikely figure separates courage from moral perfection.',
      },
      {
  ...
  },
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        speaker: 'Jem',
        analysis:
          'Marks Jem\u2019s loss of innocence: he now reads Maycomb as something to retreat from.',
      },
      {
        text: 'It was just him I couldn\u2019t stand.',
        speaker: 'Dill (on Mr Gilmer)',
        analysis:
          'Dill\u2019s emotional reaction voices the reader\u2019s moral outrage at the trial.',
      },
      {
  ...
  },
  {
    ...
    quotes: [
      ...
      },
      {
        ...
        analysis:
          'Physical perspective shift embodies the novel\u2019s moral argument about empathy.',
      },
      {
        text: 'A mob\u2019s always made up of people.',
        speaker: 'Atticus',
        analysis:
          'Rehumanises the lynch mob, insisting on individual conscience within collective action.',
      },
    ],
  },
  {
    ...
    quotes: [
      {
        ...
        analysis:
          'The title symbol introduced: destroying harmless innocence is the novel\u2019s cardinal sin.',
      },
      {
      ...
      },
      {
        ...
        analysis:
          'Makes the Tom Robinson\u2013mockingbird connection explicit through the editorial.',
      },
      {
        text: 'It\u2019d be sort of like shootin\u2019 a mockingbird, wouldn\u2019t it?',
        speaker: 'Scout',
        analysis:
          'Scout applies the symbol independently to Boo, showing she has internalised the lesson.',
      },
    ],
  },
]
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Key Quotations',
            url: 'https://theenglishhub.app/igcse/edexcel/prose/to-kill-a-mockingbird/key-quotes',
          },
        ]}
      />
      <div>
