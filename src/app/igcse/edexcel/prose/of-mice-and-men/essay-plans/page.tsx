...
const essayPlans = [
  {
    ...
    paragraphs: [
      {
        point:
          'The Dream is introduced as a ritual between George and Lennie, repeated rather than planned.',
        evidence: '"An\u2019 live off the fatta the lan\u2019."',
        explanation:
          'The phrase is Lennie\u2019s refrain, learned by heart. Steinbeck presents the Dream as a verbal ritual \u2014 a story told for comfort rather than a realistic ambition. Its repetition sustains the men emotionally.',
      ...
      {
        point:
          'Candy\u2019s investment makes the Dream briefly concrete, which paradoxically signals its death.',
        evidence: '"Le\u2019s get that place now."',
        explanation:
          'The moment the Dream becomes financially possible is, in Steinbeck\u2019s fatalistic structure, the moment it begins to collapse. Candy\u2019s urgency is driven by the loss of his dog \u2014 he needs a reason to live.',
      ...
      {
        point:
          'Curley\u2019s wife\u2019s Hollywood dream is a gendered variant of the same illusion.',
        evidence: '"I coulda made somethin\u2019 of myself. Maybe I will yet."',
        explanation:
          'Her dream is no less unrealistic than George\u2019s farm. Steinbeck shows that the American Dream fails women as thoroughly as it fails men, but through different mechanisms \u2014 marriage rather than employment traps her.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      {
        point:
          'Candy\u2019s loss of his dog removes his only companion and drives him towards the Dream.',
        evidence: '"I ought to of shot that dog myself, George."',
        explanation:
          'The line is functional and structural: it prepares George\u2019s final decision. But it is also about loneliness \u2014 Candy\u2019s regret is that a stranger ended his most important relationship.',
        link: 'Link to the ending: George shoots Lennie himself, having learned from Candy\u2019s mistake.',
      },
      {
        point:
          'Curley\u2019s wife\u2019s loneliness is gendered: she is isolated by marriage, not by work.',
        evidence: '"I coulda made somethin\u2019 of myself."',
        explanation:
          'She is the only woman on the ranch, unnamed by Steinbeck to signal her social erasure. Her loneliness drives her to seek conversation from the men, which the narrative frames as dangerous.',
  ...
  },
  {
    ...
    paragraphs: [
      {
        point:
          'In her introduction Curley\u2019s wife is defined entirely by her appearance and the men\u2019s reaction.',
        evidence: '"She had full, rouged lips and wide-spaced eyes, heavily made up."',
        explanation:
          'Steinbeck filters her through visual description and male suspicion. She has no name, no interiority, and is labelled "jailbait" and a "tart" by the other characters. The technique reproduces the ranch\u2019s sexism.',
      ...
      },
      {
        ...
        evidence: '"I coulda made somethin\u2019 of myself. Maybe I will yet."',
        explanation:
          'Steinbeck delays her interiority until Chapter 5, giving her a dream that mirrors George\u2019s. The "maybe I will yet" is heartbreaking in retrospect: she is about to die.',
      ...
      },
      {
        ...
        explanation:
          'The narrator\u2019s register shifts from suspicion to tenderness. "Sweet and young" is language the narrative withheld while she was alive, implying that the ranch\u2019s misogyny shaped how we saw her too.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      {
        point:
          'George\u2019s private confession to Slim reveals the relationship\u2019s complexity: love mixed with resentment.',
        evidence: '"Guys like us, that work on ranches, are the loneliest guys in the world."',
        explanation:
          'George knows the dream is a fiction but performs it anyway because it sustains both of them. His resentment surfaces in unguarded moments, which makes the relationship feel real rather than sentimental.',
      ...
      {
        point:
          'The ending transforms the relationship from one of protection to one of mercy killing.',
        evidence: '"I ain\u2019t mad. I never been mad, an\u2019 I ain\u2019t now."',
        explanation:
          'George\u2019s final words are spoken in the same gentle, conversational register as the dream speech. The killing is an act of love \u2014 more humane than the lynch mob \u2014 but it ends the relationship that defined him.',
  ...
  },
  {
    ...
    paragraphs: [
      {
        point:
          'The opening pool is presented as a natural paradise that exists apart from the ranch.',
        evidence: '"The deep green pool of the Salinas River was still in the late afternoon."',
        explanation:
          'Steinbeck\u2019s descriptive language is Edenic: still water, sycamores, rabbits. The pastoral beauty contrasts with the human violence that will intrude. Nature is indifferent and beautiful.',
        link: 'The pool\u2019s return in Chapter 6 transforms the pastoral from paradise to execution site.',
      },
      {
        point:
          'The bunkhouse and barn are progressively more enclosed, reflecting the novella\u2019s tightening structure.',
        evidence: '"The bunk house was a long, rectangular building."',
        explanation:
          'Steinbeck\u2019s stage-direction prose strips the interiors to bare surfaces. Each interior space is more confined: bunkhouse, then Crooks\u2019s tiny room, then the barn. The claustrophobia mirrors the characters\u2019 shrinking options.',
        link: 'Steinbeck originally titled the novella "Something That Happened" \u2014 the settings are stages in a predetermined plot.',
      },
      {
        point:
          'The return to the pool in Chapter 6 transforms the opening setting into a site of tragedy.',
        evidence: '"A silent head and beak lanced down and plucked it out by the head."',
        explanation:
          'The heron eating the water snake replaces the opening\u2019s tranquillity with predation. Nature is no longer a refuge but a mirror of the violence about to occur. The cyclical structure makes the ending feel inevitable.',
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Essay Plans',
            url: 'https://theenglishhub.app/igcse/edexcel/prose/of-mice-and-men/essay-plans',
          },
        ]}
      />
      <div>
        ...
        >
          ...
          {await t('igcse.page.back_to')} Of Mice and Men
        </Button>
      </div>
