...
const characters = [
  ...
  },
  {
    ...
    quote: '\u201cCome on, ya big son-of-a-bitch.\u201d',
  },
  {
    name: 'Curley\u2019s wife',
  ...
  },
  {
    ...
    quote: '\u201cI said what stake you got in this guy?\u201d',
  },
]
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Characters',
            url: 'https://theenglishhub.app/igcse/edexcel/prose/of-mice-and-men/characters',
          },
        ]}
      />
      <div>
        ...
        >
          ...
          {tr('igcse.page.back_to')} Of Mice and Men
        </Button>
      </div>

      <StudyTools textName="Of Mice and Men" textType="novel" examBoard="IGCSE Edexcel" />
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-primary/[0.04] p-6 sm:p-8 lg:p-10">
        <div className="relative">
          ...
          <p className="mt-3 max-w-2xl text-body-lg text-muted-foreground">
            Analytical profiles of George, Lennie, Candy, Curley, Curley&rsquo;s wife, Crooks, Slim
            and the ranch workers &mdash; with key quotations.
          </p>
        </div>
      </section>
      ...
      <p className="text-xs text-muted-foreground mt-8 border-t border-border/60 pt-4">
        Of Mice and Men &copy; The Estate of John Steinbeck. Short quotations reproduced under the
