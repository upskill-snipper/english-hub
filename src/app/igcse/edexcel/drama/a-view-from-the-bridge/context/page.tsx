...
export const metadata: Metadata = {
  ...
  description:
    'Context for A View from the Bridge: 1950s Red Hook Brooklyn, Italian-American immigration, McCarthyism, Arthur Miller\u2019s background and Greek tragic form.',
  alternates: {
    canonical: 'https://theenglishhub.app/igcse/edexcel/drama/a-view-from-the-bridge/context',
  },
}
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Context',
            url: 'https://theenglishhub.app/igcse/edexcel/drama/a-view-from-the-bridge/context',
          },
        ]}
      />
      <div>
        ...
        >
          ...
          {await t('igcse.page.back_to')} A View from the Bridge
        </Button>
      </div>
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-primary/[0.04] p-6 sm:p-8 lg:p-10">
        <div className="relative">
          <div className="mb-4 flex flex-wrap items-center gap-2">
            ...
            <Badge variant="secondary">{await t('anth_text.section.context')}</Badge>
          </div>
          <h1 className="text-display-sm font-heading text-foreground sm:text-display">
            A View from the Bridge: Context
          </h1>
          <p className="mt-3 max-w-2xl text-body-lg text-muted-foreground">
            Historical, biographical and dramatic context for Miller's play &mdash; essential for
            responses on social, cultural and historical context.
          </p>
        </div>
      </section>
