...
export const metadata: Metadata = {
  title: 'A View from the Bridge Themes — Edexcel IGCSE IGCSE Literature',
  description:
  ...
  alternates: {
    canonical:
      'https://theenglishhub.app/igcse/edexcel/drama/a-view-from-the-bridge/themes',
  },
}
...
const themes = [
  ...
  },
  {
    ...
    moments:
      'The boxing scene; the Act Two kiss; Beatrice\u2019s accusation; the final fight.',
    quote:
      '“He give me the look… it comes out queer, like, that\u2019s what I mean.” — Eddie',
  },
  {
    ...
    quote:
      '“The law is very specific. The law does not… even recognise this.” — Alfieri',
  },
  {
    ...
    quote:
      '“My wife is dying of starvation… they\u2019re hungry.” — Marco',
  },
  {
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Themes", url: "https://theenglishhub.app/igcse/edexcel/drama/a-view-from-the-bridge/themes" },
        ]}
      />
      <div>
        <Button
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-primary/[0.04] p-6 sm:p-8 lg:p-10">
        <div className="relative">
          ...
          <p className="mt-3 max-w-2xl text-body-lg text-muted-foreground">
            Analytical routes through Miller’s play — honour, masculinity,
            law vs justice, family, immigration and tragic form.
          </p>
        </div>
      </section>
