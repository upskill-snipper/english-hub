...
export const metadata: Metadata = {
  title: 'Curious Incident Themes — Edexcel IGCSE IGCSE Literature',
  description:
  ...
  alternates: {
    canonical:
      'https://theenglishhub.app/igcse/edexcel/drama/curious-incident/themes',
  },
}
...
const themes = [
  {
    ...
    quote:
      '“I find people confusing.” — Christopher',
  },
  {
    ...
    quote:
      '“I love Christopher more than anything in the whole wide world.” — Ed',
  },
  {
  ...
  },
  {
    ...
    quote:
      '“You have to do things even if they scare you.” — Christopher',
  },
  {
  ...
  },
  {
    ...
    quote:
      '“I think I\u2019m going to write a book.” — Christopher, early in Act One',
  },
]
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Themes", url: "https://theenglishhub.app/igcse/edexcel/drama/curious-incident/themes" },
        ]}
      />
      <div>
        <Button
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-primary/[0.04] p-6 sm:p-8 lg:p-10">
        <div className="relative">
          ...
          <p className="mt-3 max-w-2xl text-body-lg text-muted-foreground">
            Analytical routes through Stephens and Haddon’s play —
            neurodivergence, family, truth, independence, order and form.
          </p>
        </div>
      </section>
