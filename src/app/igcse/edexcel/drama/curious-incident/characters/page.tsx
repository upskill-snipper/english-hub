...
const characters = [
  ...
  },
  {
    ...
    quote: '"Maybe you should ask your father about this."',
  },
  {
    ...
    quote: '"He can stay for a few days."',
  },
  {
    ...
    quote: '"Well, when I say heaven, I don\u2019t necessarily mean somewhere above."',
  },
]
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Characters',
            url: 'https://theenglishhub.app/igcse/edexcel/drama/curious-incident/characters',
          },
        ]}
      />
      <div>
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-primary/[0.04] p-6 sm:p-8 lg:p-10">
        <div className="relative">
          ...
          <p className="mt-3 max-w-2xl text-body-lg text-muted-foreground">
            Character profiles for Stephens and Haddon&rsquo;s play &mdash; Christopher, Ed, Judy,
            Siobhan and the Swindon neighbours.
          </p>
        </div>
      </section>
