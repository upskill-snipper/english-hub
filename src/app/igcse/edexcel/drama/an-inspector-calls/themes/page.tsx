...
export const metadata: Metadata = {
  title: 'An Inspector Calls Themes — Edexcel IGCSE IGCSE Literature',
  description:
    'Themes in An Inspector Calls: social responsibility, class, gender, age versus youth, morality, power and dramatic form.',
  alternates: {
    canonical:
      'https://theenglishhub.app/igcse/edexcel/drama/an-inspector-calls/themes',
  },
}
...
const themes = [
  ...
  },
  {
    ...
    quote:
      '“Probably a socialist or some sort of crank.” — Arthur Birling on the Inspector',
  },
  {
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Themes", url: "https://theenglishhub.app/igcse/edexcel/drama/an-inspector-calls/themes" },
        ]}
      />
      <div>
        <Button
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-primary/[0.04] p-6 sm:p-8 lg:p-10">
        <div className="relative">
          ...
          <p className="mt-3 max-w-2xl text-body-lg text-muted-foreground">
            Analytical routes through Priestley’s play — social
            responsibility, class, gender, age versus youth, morality and
            dramatic form.
          </p>
        </div>
      </section>
