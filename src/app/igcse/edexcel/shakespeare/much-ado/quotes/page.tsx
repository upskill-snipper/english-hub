    ...
    <main className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Key Quotations',
            url: 'https://theenglishhub.app/igcse/edexcel/shakespeare/much-ado/quotes',
          },
        ]}
      />
      {/* ── Hero ─────────────────────────────────────────────── */}
      <section className="border-b border-border bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            &larr; {await t('igcse.page.much_ado_hub')}
          </Link>
        ...
        <div className="rounded-xl bg-muted p-6">
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            <li className="flex gap-2">
              ...
              Learn short fragments (3&ndash;6 words) that you can drop inside a sentence.
            </li>
            <li className="flex gap-2">
              <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
              Pair quotes: every comic line has a darker echo later in the play, and vice versa.
            </li>
            <li className="flex gap-2">
              <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
              Mark which quotes are in <strong>verse</strong> and which in <strong>prose</strong>{' '}
              &mdash; the switch is often meaningful.
            </li>
          </ul>
        </div>
