...
const characters = [
  ...
  },
  {
    ...
    quote: '\u201cI will in the interim undertake one of Hercules\u2019 labours.\u201d',
  },
  {
    name: 'Don John',
  ...
  },
  {
    ...
    quote: '\u201cO villain! thou wilt be condemned into everlasting redemption.\u201d',
  },
  {
    name: 'Borachio',
  ...
  },
  {
    ...
    quote: '\u201cWill you then write me a sonnet in praise of my beauty?\u201d',
  },
]
    ...
    <div className="space-y-10 pb-16">
      ...
      <div>
        ...
        >
          ...
          {tr('igcse.page.back_to')} Much Ado About Nothing
        </Button>
      </div>

      <StudyTools textName="Much Ado About Nothing" textType="play" examBoard="IGCSE Edexcel" />
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-primary/[0.04] p-6 sm:p-8 lg:p-10">
        <div className="relative">
          ...
          <p className="mt-3 max-w-2xl text-body-lg text-muted-foreground">
            Character profiles for Shakespeare&rsquo;s comedy &mdash; Beatrice, Benedick, Claudio,
            Hero, Don Pedro, Don John and the Watch.
          </p>
        </div>
      </section>
        ...
        <div className="flex gap-3">
          ...
          <div className="space-y-1">
            <h2 className="text-body-sm font-semibold text-foreground">
              {tr('igcse.page.public_domain_heading')}
            </h2>
