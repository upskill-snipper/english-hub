  ...
  },
  {
    ...
    scenes: [
      ...
      },
      {
        scene: "3.3",
        summary:
          "The murderers kill Banquo in an ambush. Fleance escapes into the dark.",
      },
      {
        scene: "3.4",
        summary:
  ...
  },
  {
    ...
    scenes: [
      ...
      },
      {
        scene: "5.6",
        summary:
          "Malcolm's army reveals itself at Dunsinane and prepares to attack.",
      },
      {
        scene: "5.7",
        summary:
    ...
    <main className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Plot Summary", url: "https://theenglishhub.app/igcse/edexcel/shakespeare/macbeth/plot" },
        ]}
      />
      {/* ── Hero ─────────────────────────────────────────────── */}
      <section className="border-b border-border bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
            A detailed act-by-act and scene-by-scene walkthrough of
            Shakespeare&rsquo;s shortest tragedy.
          </p>
        </div>
      </section>
