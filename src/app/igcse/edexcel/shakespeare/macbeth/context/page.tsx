    ...
    <main className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Context", url: "https://theenglishhub.app/igcse/edexcel/shakespeare/macbeth/context" },
        ]}
      />
      {/* ── Hero ─────────────────────────────────────────────── */}
      <section className="border-b border-border bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
            Jacobean England, James I, witchcraft, the Gunpowder Plot and the
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        <div className="rounded-xl bg-muted p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
            ...
            a Jacobean audience&rsquo;s reaction to a specific moment.
          </p>
        </div>
        ...
        <section className="mt-12 rounded-2xl border-2 border-primary/40 bg-primary/5 p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            ...
            in Jacobean England&hellip;&rdquo; Instead, fold context directly
            into analysis of a quotation. For example:
          </p>
          <div className="mt-4 rounded-lg border border-primary/30 bg-card p-4">
            <p className="text-sm text-muted-foreground italic leading-relaxed">
              &ldquo;When Lady Macbeth begs spirits to &lsquo;unsex&rsquo;
              her, a Jacobean audience &mdash; for whom James I&rsquo;s{" "}
              <em>Daemonologie</em> was recent memory &mdash; would have heard
              a genuine demonic invocation. The verb &lsquo;unsex&rsquo; not
              only rejects femininity but pulls her out of the Great Chain of
              Being altogether.&rdquo;
            </p>
          </div>
          <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
            That&rsquo;s one sentence of context doing the work of a whole
            paragraph &mdash; exactly what IGCSE examiners reward.
          </p>
        </section>
      </div>
