...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://theenglishhub.app/igcse/edexcel/shakespeare/macbeth/essay-plans",
  },
  title: "Macbeth Essay Plans — Edexcel IGCSE IGCSE Literature",
  description:
    "Five model essay plans for Macbeth with paragraph-by-paragraph structure, key quotations and context for Edexcel IGCSE English Literature IGCSE Literature.",
};
...
const ESSAY_PLANS = [
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        key_quote: '"Life\'s but a walking shadow, a poor player that struts and frets his hour upon the stage" (5.5)',
        context:
      ...
      },
      {
        ...
        key_quote: '"Oftentimes to win us to our harm, the instruments of darkness tell us truths" (1.3)',
        context:
  ...
  },
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        key_quote: '"By the clock \'tis day, and yet dark night strangles the travelling lamp" (2.4)',
        context:
  ...
  },
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        key_quote: '"I have given suck, and know how tender \'tis to love the babe that milks me; I would, while it was smiling in my face, have plucked my nipple from his boneless gums and dashed the brains out" (1.7)',
        context:
      ...
      },
      {
        ...
        key_quote: '"Be innocent of the knowledge, dearest chuck, till thou applaud the deed" (3.2)',
        context:
  ...
  },
  {
    id: "kingship",
    question:
      "How does Shakespeare explore ideas about kingship in Macbeth?",
    introduction:
    ...
    paragraphs: [
      {
        ...
        key_quote: '"This castle hath a pleasant seat; the air nimbly and sweetly recommends itself to our gentle senses" (1.6)',
        context:
      ...
      },
      {
        ...
        key_quote: '"I am in blood stepped in so far that, should I wade no more, returning were as tedious as go o\'er" (3.4)',
        context:
      ...
      },
      {
        ...
        key_quote: '"A falcon, towering in her pride of place, was by a mousing owl hawked at and killed" (2.4)',
        context:
      ...
      },
      {
        ...
        key_quote: '"I am yet unknown to woman, never was forsworn, scarcely have coveted what was mine own" (4.3)',
        context:
    ...
    <main className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Essay Plans", url: "https://theenglishhub.app/igcse/edexcel/shakespeare/macbeth/essay-plans" },
        ]}
      />
      {/* -- Hero ------------------------------------------------- */}
      <section className="border-b border-border bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
            Five model essay plans with paragraph structure, key quotations
            and context &mdash; ready to adapt for the IGCSE Shakespeare
            question.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <div className="rounded-xl bg-muted p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
            Each plan gives you a thesis, five analytical paragraphs and a
            conclusion. Every paragraph has a topic sentence, an argument, a
            key quote and a context point. In the exam, adapt the structure to
            the specific question &mdash; don&rsquo;t reproduce plans from
            memory, but use the paragraph logic and quotation pairings as
            building blocks.
          </p>
        </div>
              ...
              <div className="rounded-2xl border border-border bg-card p-6 shadow-md sm:p-8">
                ...
                <div className="mt-6 space-y-6">
                  {plan.paragraphs.map((para, i) => (
                    <div
                      key={i}
                      className="rounded-lg border border-border bg-muted p-4 sm:p-5"
                    >
