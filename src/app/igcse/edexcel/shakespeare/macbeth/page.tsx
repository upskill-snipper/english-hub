      ...
      <section className="border-b border-border bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Shakespeare&rsquo;s shortest and bleakest tragedy &mdash; the
            story of how ambition, once unchained, consumes everything it
            touches.
          </p>
        </div>
      </section>
        ...
        <section className="mt-14">
          ...
          <div className="mt-6 space-y-3">
            {KEY_QUOTES_PREVIEW.map((q) => (
              ...
              >
                <p className="text-sm italic font-semibold text-foreground">
                  {q.quote}
                </p>
        ...
        <section className="mt-14 rounded-2xl border-2 border-primary/40 bg-primary/5 p-6 sm:p-8">
          ...
          <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
            <li className="flex gap-3">
              ...
              <span>
                <strong>Extract analysis</strong> &mdash; you&rsquo;re given a
                printed passage and asked to explore how Shakespeare presents a
                character, mood or idea. Focus on language, structure and
                dramatic method within the extract itself.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-primary text-xs font-bold text-white">
              ...
              <span>
                <strong>Whole-play essay</strong> &mdash; you then explore the
                same idea across the rest of the play, bringing in{" "}
                <em>your own</em> memorised quotations. The extract is{" "}
                <em>not</em> reprinted, so you must carry a mental map of the
                whole play into the exam.
              </span>
            </li>
          </ul>
          <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
            By contrast, most GCSE boards give you a single essay tied to one
            extract. IGCSE demands both close reading{" "}
            <em>and</em> a longer, comparison-style whole-play response &mdash;
            so revision must cover <strong>every act</strong>, not just set
            scenes.
          </p>
          <div className="mt-4 rounded-lg border border-primary/30 bg-card p-4">
            ...
            <ul className="mt-2 space-y-1.5 text-sm text-muted-foreground">
              <li className="flex gap-2">
                ...
                Memorise 15&ndash;20 short, embeddable quotes spread across
                all five acts.
              </li>
              <li className="flex gap-2">
                <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                Practise writing about the same moment at two depths: line by
                line <em>and</em> across the whole play.
              </li>
              <li className="flex gap-2">
                <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
                Know Jacobean context well enough to weave it in briefly,
                without derailing analysis.
              </li>
            </ul>
          </div>
        </section>
