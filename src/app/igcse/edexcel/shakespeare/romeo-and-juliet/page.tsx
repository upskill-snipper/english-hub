      ...
      <section className="border-b border-border bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Shakespeare&rsquo;s most famous tragedy: two teenagers, a poisonous feud, and a love
            that burns too hot to survive.
          </p>
        </div>
      </section>

      <div className="mx-auto max-w-5xl px-4 pt-8">
        <StudyTools textName="Romeo and Juliet" textType="play" examBoard="Edexcel" />
      </div>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
          ...
          <div className="mt-6 space-y-4">
            {PLOT.map((act) => (
              ...
              >
                ...
                <p className="mt-3 text-sm text-muted-foreground leading-relaxed">{act.text}</p>
              </article>
            ))}
          </div>
        </section>
        ...
        <section className="mt-14">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            {CHARACTERS.map((c) => (
              <div key={c.name} className="rounded-xl border border-border bg-card p-5 shadow-md">
        ...
        <section className="mt-14">
          <div className="flex items-center justify-between gap-4">
            <h2 className="text-2xl font-bold text-foreground">Themes overview</h2>
            <Link
        ...
        <section className="mt-14 grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
              Love, fate, conflict, youth vs age and honour &mdash; with key quotations for each.
            </p>
          ...
          >
            ...
            <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
              20 essential quotations with speaker, scene reference and detailed analysis.
            </p>
            <span className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-primary group-hover:underline">
