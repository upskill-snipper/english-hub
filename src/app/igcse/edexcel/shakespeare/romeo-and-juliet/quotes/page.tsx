...
export default async function RomeoAndJulietQuotesPage() {
        ...
        <div className="rounded-xl bg-muted p-6">
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            <li className="flex gap-2">
              ...
              Learn short fragments you can embed inside a sentence of analysis.
            </li>
            <li className="flex gap-2">
              <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
              Tag each quote with <strong>at least two themes</strong> so you can redeploy it
              flexibly.
            </li>
            <li className="flex gap-2">
              <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary" />
