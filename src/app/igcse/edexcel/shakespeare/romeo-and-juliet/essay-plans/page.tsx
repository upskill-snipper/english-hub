...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://theenglishhub.app/igcse/edexcel/shakespeare/romeo-and-juliet/essay-plans",
  },
  title: "Romeo and Juliet Essay Plans — Edexcel IGCSE IGCSE Literature",
  description:
    "Five model essay plans for Romeo and Juliet with paragraph-by-paragraph structure, key quotations and context for Edexcel IGCSE English Literature IGCSE Literature.",
};
...
const ESSAY_PLANS = [
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        key_quote: '"If I profane with my unworthiest hand this holy shrine, the gentle sin is this: my lips, two blushing pilgrims, ready stand to smooth that rough touch with a tender kiss" (1.5)',
        context:
      ...
      },
      {
        ...
        key_quote: '"What\'s in a name? That which we call a rose by any other word would smell as sweet" (2.2)',
        context:
  ...
  },
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        key_quote: '"Some consequence yet hanging in the stars shall bitterly begin his fearful date with this night\'s revels" (1.4)',
        context:
      ...
      },
      {
        ...
        key_quote: '"Unhappy fortune! The letter was not nice but full of charge, of dear import" (5.2)',
        context:
  ...
  },
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        key_quote: '"What, drawn, and talk of peace? I hate the word, as I hate hell, all Montagues, and thee" (1.1)',
        context:
      ...
      },
      {
        ...
        key_quote: '"A plague o\u2019 both your houses! They have made worms\u2019 meat of me" (3.1)',
        context:
  ...
  },
  {
    id: "juliet",
    question:
      "How does Shakespeare present Juliet as a strong character?",
    introduction:
    ...
    paragraphs: [
      ...
      },
      {
        ...
        key_quote: '"My husband lives, that Tybalt would have slain, and Tybalt\'s dead, that would have slain my husband. All this is comfort. Wherefore weep I then?" (3.2)',
        context:
    ...
    <main className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Essay Plans", url: "https://theenglishhub.app/igcse/edexcel/shakespeare/romeo-and-juliet/essay-plans" },
        ]}
      />
      {/* -- Hero ------------------------------------------------- */}
