...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://theenglishhub.app/igcse/edexcel/shakespeare/romeo-and-juliet/characters",
  },
  title: "Romeo and Juliet Characters — Edexcel IGCSE IGCSE Literature",
  description:
    "Character analysis for Romeo, Juliet, Friar Lawrence, the Nurse, Mercutio, Tybalt, Lord Capulet and Paris for Edexcel IGCSE English Literature IGCSE Literature.",
};
    ...
    <main className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Characters", url: "https://theenglishhub.app/igcse/edexcel/shakespeare/romeo-and-juliet/characters" },
        ]}
      />
      {/* -- Hero ------------------------------------------------- */}
