...
export const metadata: Metadata = {
  alternates: {
    canonical:
      "https://theenglishhub.app/igcse/edexcel/shakespeare/romeo-and-juliet/context",
  },
  title: "Romeo and Juliet Context — Edexcel IGCSE IGCSE Literature",
  description:
    "Elizabethan context for Romeo and Juliet: patriarchal society, arranged marriages, honour culture, the Italian setting and Petrarchan love poetry. For Edexcel IGCSE IGCSE Literature.",
};
      ...
      <section className="border-b border-border bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
            Elizabethan society, patriarchy, honour culture, the Italian
            setting and Petrarchan love poetry.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        <div className="rounded-xl bg-muted p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
            ...
            an Elizabethan audience&rsquo;s reaction to a specific moment.
          </p>
        </div>
        ...
        <section className="mt-12 rounded-2xl border-2 border-primary/40 bg-primary/5 p-6 sm:p-8">
          <h2 className="text-xl font-bold text-foreground">
            How to embed context in an answer
          </h2>
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            Don&rsquo;t open a paragraph with &ldquo;Shakespeare was writing
            in Elizabethan England&hellip;&rdquo; Instead, fold context directly
            into analysis of a quotation. For example:
          </p>
          <div className="mt-4 rounded-lg border border-primary/30 bg-card p-4">
            <p className="text-sm text-muted-foreground italic leading-relaxed">
              &ldquo;When Capulet rages &lsquo;Hang thee, young baggage!
              disobedient wretch!&rsquo; at his thirteen-year-old daughter,
              an Elizabethan audience might not have condemned him outright
              &mdash; in a patriarchal society where daughters were expected
              to obey, Juliet&rsquo;s refusal is as transgressive as his
              fury. Shakespeare forces us to feel the injustice from
              Juliet&rsquo;s side even while showing us why Capulet thinks
              he is right.&rdquo;
            </p>
          </div>
          <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
            That&rsquo;s context working <em>inside</em> an analytical
            argument &mdash; exactly what IGCSE examiners reward.
          </p>
        </section>
      </div>
