      ...
      <section className="border-b border-border bg-gradient-to-b from-primary/[0.06] to-transparent px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Edexcel IGCSE English Literature offers three Shakespeare set
            texts. You only study <strong>one</strong> — use the guides below
            to revise the play your school is teaching.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
        ...
        <section className="rounded-2xl border border-border bg-card p-6 shadow-md sm:p-8">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            ...
            the play as a whole. The exam is{" "}
            <strong>closed book</strong> — you must memorise your own quotes
            for part (b).
          </p>
        ...
        <section className="mt-14">
          ...
          <p className="mt-2 text-muted-foreground">
            Students study one of the three plays below. Pick the one your
        ...
        <section className="mt-14 rounded-2xl border-2 border-primary/40 bg-primary/5 p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            ...
            you need both forensic close reading <em>and</em> a strong mental
            map of the whole play &mdash; not just your favourite scenes.
          </p>
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            Every play hub below includes a dedicated{" "}
            <strong>Study tip</strong> section explaining how to prepare for
            the two-part question and how it differs from GCSE.
          </p>
        </section>
      </div>
