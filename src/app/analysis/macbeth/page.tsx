...
const quotePages = [
  ...
  { slug: 'is-this-a-dagger-which-i-see-before-me', title: '"Is this a dagger which I see before me?"' },
  ...
  { slug: 'screw-your-courage-to-the-sticking-place', title: '"Screw your courage to the sticking-place"' },
  ...
  { slug: 'look-like-the-innocent-flower', title: '"Look like the innocent flower, but be the serpent under\'t"' },
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
        ...
        you can drop straight into your own writing.
      </p>

      <div className="mt-8 rounded-xl border border-border bg-card p-6 shadow-sm">
        <h2 className="text-xl font-semibold text-foreground">How to use this hub</h2>
        <p className="mt-2 text-muted-foreground leading-relaxed">
          Start with a quote you need to unpack, then move to the related theme page to see
          how it fits into the wider argument of the play. Finish with the character analysis
          for the person speaking the line so you can trace their development across the five
          acts. Every page links back here, and every page links onward to the main Macbeth
          revision notes so you can zoom out whenever you need the plot and context.
        </p>
        <div className="mt-4">
          <Link
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 text-muted-foreground">
          Line-by-line analysis of the most-searched Macbeth quotes. Each page includes
          meaning, literary devices, context, and how to use the quote in an essay.
        </p>
      ...
      <section className="mt-12">
        ...
        <p className="mt-2 text-muted-foreground">
          Deep-dive analyses of every major theme, the three key characters, and a Grade 9
          essay walkthrough.
        </p>
        <ul className="mt-5 grid gap-3 sm:grid-cols-2">
          {themePages.map((t) => (
      ...
      <section className="mt-12 rounded-xl border border-border bg-muted/40 p-6">
        ...
        <p className="mt-2 text-muted-foreground leading-relaxed">
          ...
          preparing for a closed-book exam, start there and use the analysis pages to sharpen
          the quotations you plan to memorise.
        </p>
        <div className="mt-4">
          <Link
            href="/resources/revision-notes/macbeth"
