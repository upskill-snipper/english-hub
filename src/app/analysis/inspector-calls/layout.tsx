...
/**
 * Segment layout for /analysis/inspector-calls.
 *
 ...
 * to readers whose chosen exam board does not study An Inspector Calls.
 *
 ...
 */
export default function InspectorCallsLayout({ children }: { children: React.ReactNode }) {
