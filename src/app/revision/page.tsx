...
function paperBadgeClasses(papers: RevisionSection['papers']): string {
  ...
  if (hasLit) return 'bg-blue-500/10 text-blue-700 dark:text-blue-300 ring-blue-500/30'
  if (hasLang) return 'bg-violet-500/10 text-violet-700 dark:text-violet-300 ring-violet-500/30'
  return ''
}
