...
const CONTEXT_SECTIONS: ContextSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Priestley\u2019s play was written in the last winter of the war, 1944-45, and first performed in 1945 in the Soviet Union; its London premiere followed in 1946. The audience would have understood the Inspector\u2019s final speech as a direct endorsement of the reforms being implemented around them. The play is not set in a political vacuum - it is a weapon in a specific political argument about the kind of society Britain should build after the war.',
    ],
    keyPoint:
  ...
  },
  {
    ...
    body: [
      'The general election of July 1945 produced one of the most dramatic results in British political history. Despite Winston Churchill\u2019s enormous popularity as a war leader, the Labour Party under Clement Attlee won a landslide victory with 393 seats to the Conservatives\u2019 197. The swing was driven by a widespread desire for social change: voters did not want to return to the poverty, unemployment, and inequality of the pre-war years.',
  ...
  return (
    <div className="min-h-screen bg-background font-heading">
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        {/* Hero */}
        <section className="mt-8 rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-clay-500/[0.06] p-6 sm:p-8 lg:p-10">
          <Link
        ...
        {CONTEXT_SECTIONS.map((section, idx) => (
          <section key={section.title} className="mt-12">
            ...
            {/* Body paragraphs */}
            <div className="mt-4 rounded-xl border border-border/60 bg-muted p-5 space-y-3">
            ...
            {/* Exam link */}
            <div className="mt-3 rounded-xl border border-clay-500/20 bg-clay-500/10 p-4">
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border/60">
                <tr className="bg-card">
                  <td className="px-4 py-3 font-medium text-foreground">Voting rights</td>
                  <td className="px-4 py-3 text-muted-foreground">
                    No women could vote; limited male suffrage
                  </td>
                  <td className="px-4 py-3 text-muted-foreground">
                    Universal adult suffrage since 1928
                  </td>
                </tr>
                <tr className="bg-muted/40">
                  <td className="px-4 py-3 font-medium text-foreground">Welfare</td>
                  <td className="px-4 py-3 text-muted-foreground">
                ...
                <tr className="bg-card">
                  <td className="px-4 py-3 font-medium text-foreground">Class system</td>
                  <td className="px-4 py-3 text-muted-foreground">
                ...
                <tr className="bg-card">
                  <td className="px-4 py-3 font-medium text-foreground">Women</td>
                  <td className="px-4 py-3 text-muted-foreground">
                ...
                <tr className="bg-muted/40">
                  <td className="px-4 py-3 font-medium text-foreground">Birling\u2019s world</td>
                  <td className="px-4 py-3 text-muted-foreground">
