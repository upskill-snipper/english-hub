...
const QUOTES: QuoteEntry[] = [
  {
    ...
    chapter: 'Chapter 2',
    context:
      'The Seventh Commandment, painted on the barn wall after the Rebellion as the foundational principle of Animalism.',
    analysis:
    ...
    examTip:
      'Always quote the original alongside its altered version. The comparison is Orwell\u2019s most powerful structural device.',
  },
  {
    id: 2,
    ...
    examTip:
      'This is the novel\u2019s most quotable line. Analyse the oxymoron "more equal" and explain how it encapsulates the entire arc of the allegory.',
  },
  {
    id: 3,
    ...
    chapter: 'Chapter 3',
    context:
      'Snowball reduces the Seven Commandments to a single slogan for the less intelligent animals.',
    analysis:
    ...
    examTip:
      'Track the evolution of this slogan across the novel. Its change from "bad" to "better" mirrors the pigs\u2019 transformation from revolutionaries to oppressors.',
  },
  {
    id: 4,
    ...
    chapter: 'Chapter 10',
    context:
      'The sheep chant the new version as the pigs emerge from the farmhouse walking on their hind legs.',
    analysis:
    ...
    examTip:
      'Pair this with the original version for a devastating paragraph on how propaganda works. The two slogans together tell the entire story of the novel.',
  },
  {
    id: 5,
    ...
    chapter: 'Chapter 5',
    context:
      'Boxer adopts this as his second personal maxim after Snowball\u2019s expulsion, alongside "I will work harder."',
    analysis:
    ...
    examTip:
      'Analyse the word "always." It makes Napoleon\u2019s authority absolute, beyond question or evidence. This is how personality cults function.',
  },
  {
    id: 6,
    ...
    context:
      'Boxer\u2019s personal motto, his response to every difficulty and setback on the farm.',
    analysis:
    ...
    examTip:
      'Track every repetition of this maxim. Its meaning shifts from inspiring to heartbreaking as the novel progresses. This is strong evidence of Orwell\u2019s structural craft.',
  },
  {
    id: 7,
    quote:
    ...
    examTip:
      'This should appear in almost every Animal Farm essay. Analyse the circular structure and explain how the final image makes Orwell\u2019s argument visual and undeniable.',
  },
  {
    id: 8,
    ...
    themes: ['Language & Propaganda', 'Power & Corruption'],
    examTip:
      'Analyse the specific addition ("with sheets") and explain how it works rhetorically. The qualification appears reasonable, which is precisely how propaganda operates \u2014 by making the unacceptable seem logical.',
  },
  {
    id: 9,
    ...
    chapter: 'Chapter 1',
    context:
      'Old Major\u2019s speech to the assembled animals, outlining the Marxist case for revolution.',
    analysis:
    ...
    themes: ['Revolution & Betrayal', 'Class & Inequality'],
    examTip:
      'Quote this alongside evidence of the pigs\u2019 later consumption (milk, apples, whisky, sleeping in beds) to show how the revolution betrayed its own principles.',
  },
  {
    id: 10,
    quote:
    ...
    chapter: 'Chapter 5',
    context:
      'Benjamin\u2019s response when asked his opinion on the windmill debate between Napoleon and Snowball.',
    analysis:
    ...
    examTip:
      'Compare Benjamin with Boxer: one has understanding without courage, the other has courage without understanding. Neither saves the farm. This comparison makes a strong analytical paragraph.',
  },
  {
    id: 11,
    ...
    chapter: 'Chapter 6',
    context:
      'Description of the animals\u2019 labour during the first construction of the windmill.',
    analysis:
    ...
    themes: ['Revolution & Betrayal', 'Class & Inequality'],
    examTip:
      'The single word "slaves" carries enormous analytical weight. In one simile, Orwell collapses the distance between liberation and oppression.',
  },
  {
    id: 12,
    ...
    context:
      'Squealer\u2019s standard response whenever the animals question the pigs\u2019 growing privileges.',
    analysis:
    ...
    themes: ['Language & Propaganda', 'Power & Corruption'],
    examTip:
      'Note that Squealer never answers the actual complaint. He changes the subject to fear. This is a classic propaganda technique worth naming in your essay.',
  },
  {
    id: 13,
    quote:
    ...
    examTip:
      'Analyse the contradictions within the titles. "Terror" and "Friend" in the same list reveals the absurdity that propaganda normalises. This is strong AO2 material.',
  },
  {
    id: 14,
    ...
    examTip:
      'This is the emotional peak of the novel. Use it in essays about Boxer\u2019s exploitation, Benjamin\u2019s complicity, or the role of education. It serves all three arguments.',
  },
  {
    id: 15,
    ...
    themes: ['Revolution & Betrayal', 'Class & Inequality'],
    examTip:
      'This quote works beautifully as a contrast paragraph. Pair Clover\u2019s dream with the reality of Napoleon\u2019s farm to show the full scale of the revolution\u2019s betrayal.',
  },
  {
    id: 16,
    ...
    themes: ['Power & Corruption', 'Language & Propaganda', 'Class & Inequality'],
    examTip:
      'Use this as your example of how corruption begins. Orwell\u2019s structural choice to place it in Chapter 3 shows that the revolution was compromised almost immediately.',
  },
  {
    id: 17,
  ...
  },
  {
    ...
    chapter: 'Chapter 1',
    context:
      'Old Major teaches the animals the anthem that will inspire the Rebellion and sustain their hope.',
    analysis:
    ...
    examTip:
      'The banning of "Beasts of England" is often overlooked. Use it to show how totalitarian regimes suppress their own revolutionary origins when those origins become inconvenient.',
  },
  {
    id: 19,
    ...
    themes: ['Power & Corruption', 'Revolution & Betrayal'],
    examTip:
      'Name the historical parallel: Stalin adopted Trotsky\u2019s Five Year Plan after exiling him. This earns AO3 marks for contextual knowledge.',
  },
  {
    id: 20,
    ...
    chapter: 'Chapter 10',
    context:
      'The pigs and human farmers quarrel over a card game in the final scene, observed by the other animals through the window.',
    analysis:
    ...
    themes: ['Power & Corruption', 'Revolution & Betrayal'],
    examTip:
      'Use this alongside the "pig to man" quote for a devastating final paragraph. Together they provide Orwell\u2019s complete thesis: unchecked power produces identical tyranny regardless of the ideology that justifies it.',
  },
]
    ...
    <div className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Key Quotations',
            url: 'https://theenglishhub.app/revision/texts/animal-farm/key-quotes',
          },
        ]}
      />
