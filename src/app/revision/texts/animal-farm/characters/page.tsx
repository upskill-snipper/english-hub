...
const characters: CharacterData[] = [
  {
    ...
    allegorical: 'Represents Joseph Stalin. Like Stalin, Napoleon is patient, calculating and ruthless. He has no interest in debate or ideas -- only in power. He eliminates rivals, rewrites history and builds a personality cult.',
    description:
    ...
    keyQuotes: [
      { text: '"Napoleon is always right"', context: 'Boxer\'s maxim -- shows how blind loyalty enables tyranny' },
      { text: '"Comrade Napoleon... is a terrible and magnificent boar"', context: 'Minimus\'s poem -- satirises personality cults' },
      { text: '"All animals are equal, but some are more equal"', context: 'Final commandment -- Napoleon\'s regime in a single line' },
    ],
    examTips: [
  ...
  },
  {
    ...
    allegorical: 'Represents Leon Trotsky. Like Trotsky, Snowball is energetic, intellectually gifted and genuinely invested in improving the lives of the workers. He is outmanoeuvred and driven into exile, then turned into a scapegoat for everything that goes wrong.',
    description:
    ...
    keyQuotes: [
      { text: '"Four legs good, two legs bad"', context: 'Snowball\'s simplification -- sows the seeds of intellectual decline' },
      { text: '"The only good human being is a dead one"', context: 'Battle of the Cowshed -- zealous revolutionary rhetoric' },
    ],
    examTips: [
  ...
  },
  {
    ...
    allegorical: 'Represents the Soviet propaganda machine, especially the newspaper Pravda. Squealer shows how language can be weaponised to control a population. He is the mechanism by which Napoleon\'s lies become accepted truth.',
    description:
    ...
    keyQuotes: [
      { text: '"Surely you do not want Jones back?"', context: 'His go-to threat -- deflects criticism with fear' },
      { text: '"Discipline, comrades, iron discipline!"', context: 'After Snowball\'s expulsion -- replaces debate with obedience' },
    ],
    examTips: [
  ...
  },
  {
    ...
    allegorical: 'Represents the loyal, exploited working class -- the proletariat who gave everything to the revolution and received nothing in return. His two maxims capture the tragedy: "I will work harder" (selfless devotion) and "Napoleon is always right" (uncritical obedience).',
    description:
    ...
    keyQuotes: [
      { text: '"I will work harder"', context: 'His personal motto -- devotion exploited until death' },
      { text: '"Napoleon is always right"', context: 'His second maxim -- shows how loyalty becomes complicity' },
      { text: '"I have no wish to take life"', context: 'Battle of the Cowshed -- reveals his gentle nature' },
    ],
    examTips: [
  ...
  },
  {
    ...
    allegorical: 'Represents Karl Marx (the theorist of communism) and Vladimir Lenin (the revolutionary leader). Like Marx, Old Major provides the vision; like Lenin, he dies before seeing how the vision will be corrupted.',
    description:
    ...
    keyQuotes: [
      { text: '"Man is the only creature that consumes without producing"', context: 'Identifies human exploitation -- the ideological seed' },
      { text: '"All men are enemies. All animals are comrades"', context: 'Binary worldview -- noble but dangerously simplistic' },
    ],
    examTips: [
  ...
  },
  {
    ...
    allegorical: 'Represents the weary, disillusioned intellectual class who see clearly what is happening but refuse to act until it is too late. He may also represent Orwell himself -- the writer who understands tyranny but feels powerless to stop it.',
    description:
    ...
    keyQuotes: [
      { text: '"Fools! Do you not see what is written?"', context: 'The knacker\'s van -- the cost of waiting too long to speak' },
      { text: '"Life would go on as it had always gone on"', context: 'His fatalistic worldview -- intelligent but paralysing' },
    ],
    examTips: [
  ...
  },
  {
    ...
    allegorical: 'Represents the Russian bourgeoisie and aristocracy who fled after the Revolution, unwilling to sacrifice comfort and luxury for the collective good. She cares more about sugar and ribbons than about equality.',
    description:
    ...
    keyQuotes: [
      { text: '"Will there still be sugar after the Rebellion?"', context: 'Her only concern -- luxury over liberation' },
    ],
    examTips: [
  ...
  },
  {
    ...
    allegorical: 'Represents the decent, compassionate working class who sense the revolution has been betrayed but lack the education or confidence to articulate their feelings. She is the reader\'s emotional surrogate.',
    description:
    ...
    keyQuotes: [
      { text: '"These scenes of terror were not what they had looked forward to"', context: 'Chapter 7 -- the inarticulate grief of the betrayed' },
    ],
    examTips: [
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Characters", url: "https://theenglishhub.app/revision/texts/animal-farm/characters" },
        ]}
      />
      {/* Hero */}
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-emerald-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            Eight key characters analysed in depth: role, allegorical significance, character
            arc, key quotations and exam tips. Each character is a lens through which Orwell
            examines power, loyalty and betrayal.
          </p>
        </div>
      </section>
