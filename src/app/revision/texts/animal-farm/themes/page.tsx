...
const themes: ThemeData[] = [
  {
    ...
    relevantQuotes: [
      ...
      { text: '"All animals are equal, but some are more equal"', context: 'The corrupted commandment -- the reality' },
      { text: '"Napoleon is always right"', context: 'Boxer -- how the powerless enable the powerful' },
    ],
    examLinks: [
  ...
  },
  {
    ...
    relevantQuotes: [
      ...
      { text: '"Surely you do not want Jones back?"', context: 'Squealer -- class anxiety weaponised as propaganda' },
      { text: '"The creatures outside looked from pig to man"', context: 'The new ruling class is identical to the old' },
    ],
    examLinks: [
  ...
  },
  {
    ...
    relevantQuotes: [
      { text: '"Squealer could turn black into white"', context: 'Narrator -- the power of propaganda distilled' },
      { text: '"Four legs good, two legs bad"', context: 'The slogan that replaces thought' },
      { text: '"No animal shall sleep in a bed with sheets"', context: 'Altered commandment -- language bent to serve power' },
    ],
    examLinks: [
  ...
  },
  {
    ...
    relevantQuotes: [
      { text: '"These scenes of terror were not what they had looked forward to"', context: 'Clover -- the betrayal felt but not articulated' },
      { text: '"The creatures outside looked from pig to man"', context: 'The revolution has come full circle' },
    ],
    examLinks: [
  ...
  },
  {
    ...
    relevantQuotes: [
      { text: '"Four legs good, two legs bad"', context: 'Education reduced to a slogan -- thought replaced by repetition' },
      { text: '"Fools! Do you not see what is written?"', context: 'Benjamin -- literacy without action is futile' },
    ],
    examLinks: [
  ...
  },
  {
    ...
    relevantQuotes: [
      ...
      { text: '"Napoleon is always right"', context: 'Loyalty as obedience -- dangerous and enabling' },
      { text: '"These scenes of terror were not what they had looked forward to"', context: 'Clover -- loyalty to the ideal, grief at its betrayal' },
    ],
    examLinks: [
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-amber-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            Six major themes explored in depth: overview, key points, how Orwell presents
            each theme through literary methods, relevant quotations and links to exam
            questions.
          </p>
        </div>
      </section>
