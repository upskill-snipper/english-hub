...
const essayPlans: EssayPlan[] = [
  ...
  },
  {
    number: 2,
    question:
      'How does Orwell present the theme of language and propaganda in Animal Farm?',
    thesisStatement:
    ...
    paragraphs: [
      {
        ...
        evidence: '"Surely you do not want Jones back?" -- Squealer\'s repeated rhetorical question.',
        analysis:
  ...
  },
  {
    number: 3,
    question:
      'How does Orwell use Boxer to present ideas about loyalty and exploitation?',
    thesisStatement:
    ...
    paragraphs: [
      ...
      },
      {
        ...
        evidence: '"Fools! Do you not see what is written?" -- Benjamin, reading the knacker\'s van.',
        analysis:
    ...
    paragraphs: [
      {
        ...
        evidence: 'The Rebellion in Chapter 2 and the first harvest in Chapter 3 -- the revolution\'s high point.',
        analysis:
    ...
    paragraphs: [
      {
        ...
        evidence: 'The Seven Commandments are painted on the barn wall -- but only the pigs can read them fluently.',
        analysis:
      ...
      },
      {
        ...
        evidence: '"Fools! Do you not see what is written?" -- Benjamin, too late, at the knacker\'s van.',
        analysis:
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-violet-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            Five structured essay plans covering the most common GCSE exam questions on
            Animal Farm. Each plan includes a thesis statement, paragraph-level guidance with
            evidence and analysis, a conclusion and an exam tip.
          </p>
        </div>
      </section>
