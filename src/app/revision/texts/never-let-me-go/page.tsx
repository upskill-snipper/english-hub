...
export const metadata: Metadata = {
  ...
  title: 'Never Let Me Go GCSE revision - themes, characters, quotes',
  description:
    "Never Let Me Go GCSE revision - Kazuo Ishiguro's 2005 dystopian novel with plot, characters, themes, context and key quotes. OCR GCSE, Edexcel A level and IAL.",
  alternates: {
...
const data: TextGuideData = {
  ...
  plotSummary: [
    ...
    'The students absorb their situation in fragments. Miss Lucy, a sympathetic guardian, tries to tell them plainly that they have been created to donate their vital organs as adults and will never lead ordinary lives; she is quietly dismissed soon afterwards. Miss Emily, the headmistress, and the other guardians prefer an approach that Miss Lucy describes as leaving the students \u2018told and not told\u2019: the truth is given in pieces too small to absorb but too present to claim ignorance. In adolescence Ruth and Tommy become a couple, though Kathy has loved Tommy for years, and the emotional triangle between the three drives the novel. Kathy\u2019s own early sexual feelings, her secret playing of a cassette called \u2018Songs After Dark\u2019 with the track \u2018Never Let Me Go\u2019 on it, and her loss of that tape all become the recurring fixed points of a childhood she cannot stop turning over.',
    'In the middle section the students leave Hailsham for the Cottages, a transitional group home for older teenagers with no guardians, visited two or three times a week by a grumbling old man called Keffers. Here the ex-Hailsham students meet \u2018veterans\u2019 from other institutions and try, awkwardly, to imitate adult life through television and second-hand novels. Ruth and Tommy\u2019s relationship turns cruel; Ruth humiliates Tommy in front of the veterans and tries, briefly, to attach herself to the idea of a \u2018possible\u2019 (the original person a clone might have been modelled from) after a sighting in Cromer, on the north Norfolk coast. The trip to Norfolk to find Ruth\u2019s possible is a disaster, and afterwards Kathy and Tommy begin to drift closer, though not close enough. Kathy leaves the Cottages early to begin training as a carer. Years pass. She becomes known as an unusually good carer, travelling alone between donation centres along flat English motorways, and loses touch with both Ruth and Tommy.',
    'The final section draws the three together again. Kathy becomes Ruth\u2019s carer after Ruth\u2019s first donation has gone badly. On a trip to see a boat stranded in marshland near the Kingsfield, Tommy\u2019s recovery centre, Ruth apologises for keeping Kathy and Tommy apart and urges them to seek a rumoured \u2018deferral\u2019: a belief among Hailsham students that couples who can prove they are truly in love will be granted extra years before donating. Ruth gives Kathy Madame\u2019s address. After Ruth \u2018completes\u2019 following her second donation, Kathy becomes Tommy\u2019s carer and they become lovers. Together they visit Madame, only to be confronted by Miss Emily, now elderly, who tells them that there are no deferrals and never were. Hailsham, she explains, was an experiment to prove that clones had souls; the artwork collected for the \u2018Gallery\u2019 was evidence offered to a doubting public. Most of society preferred not to look, and Hailsham has now closed. Tommy rages one last time in a dark field by the roadside, then goes quiet. He completes on his fourth donation. The novel ends with Kathy, alone, standing in a Norfolk field among the debris caught in a fence, imagining Tommy appearing on the horizon, before turning back to her car and driving to wherever she is supposed to be.',
  ],
  characters: [
    {
      name: 'Kathy H.',
  ...
  themes: [
    ...
    },
    {
      ...
      body: 'The triangle between Kathy, Ruth and Tommy is drawn with agonising ordinariness. It contains the usual jealousies of any teenage friendship group, and Ishiguro\u2019s point is that those ordinary feelings are exactly what prove the clones\u2019 humanity. Love in the novel is also an instrument of cruelty: the rumour of a deferral for true couples turns the most intimate feeling into an administrative claim, and the discovery that there is no deferral confirms that love cannot save them. Kathy\u2019s final image of the Norfolk fence, where she imagines everything she has lost washed up, is the novel\u2019s definition of grief.',
    },
    {
      title: 'Education, institutions and indoctrination',
      body: 'Hailsham is modelled on the English boarding-school tradition and on the post-war welfare state\u2019s mix of comfort and quiet control. It is genuinely kind: the students are fed, taught, praised, and protected from the worst knowledge of themselves. That kindness is the point of Ishiguro\u2019s critique. The students have been \u2018told and not told\u2019 \u2014 taught just enough to dimly know their futures but never enough to revolt \u2014 and the novel shows how an institution can perform care and destruction simultaneously. Hailsham\u2019s closure late in the book, and the implication that other clones are now raised in far worse conditions, refuses the reader the comfort of thinking the kinder version was enough.',
    },
    {
      title: 'Ethics of biotechnology',
      body: 'The novel was written during the early-2000s debate over stem-cell research and therapeutic cloning, but Ishiguro is not interested in taking sides on the science. He keeps the technology vague and offscreen to force the ethical question into the social and emotional foreground: who pays for progress, and who gets to look away? Madame\u2019s phrase, \u2018a new world coming rapidly\u2019, is the language of progress, which she at once calls harsh and cruel, and the novel\u2019s quiet indictment is of a society that accepts life-saving medicine without asking whose life has been converted into whose medicine.',
    },
  ],
  historicalContext: [
    'Kazuo Ishiguro was born in Nagasaki in 1954 and moved to England at the age of five when his oceanographer father took a post in Surrey. He grew up bilingual and culturally double, and his fiction has consistently explored memory, regret and the quiet complicity of ordinary people inside larger systems \u2014 the theme at the heart of The Remains of the Day (1989), for which he won the Booker Prize, and of An Artist of the Floating World (1986). Never Let Me Go was published in 2005 after more than a decade of false starts, shortlisted for the Booker, and Time named it the best novel of that year. Ishiguro was awarded the Nobel Prize in Literature in 2017; the citation described him as a writer who, in novels of \u2018great emotional force\u2019, had \u2018uncovered the abyss beneath our illusory sense of connection with the world\u2019.',
  ...
  quotations: [
    ...
    },
    {
      ...
      analysis:
        'The banal language of progress (\u2018scientific\u2019, \u2018efficient\u2019) is conceded here, then outweighed by \u2018harsh\u2019 and \u2018cruel\u2019. Ishiguro lets the defender of Hailsham condemn the wider society without ever defending her own participation in it, and the reader is left to weigh how much kinder her experiment really was.',
    },
    {
    ...
    {
      quote: '"It never occurred to me that our lives, ... could unravel and separate ..."',
    ...
    {
      quote: '"The memories I value most, I don\'t see them ever fading."',
...
export default async function NeverLetMeGoPage() {
  ...
  return (
    <>
      ...
      <StudyTools textName="Never Let Me Go" textType="novel" examBoard="OCR" />
