...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  { id: 'jh-1', question: 'Who is the main narrator figure through whose perspective we experience the mystery?', type: 'multiple-choice', options: ['Dr Jekyll', 'Mr Hyde', 'Mr Utterson', 'Dr Lanyon'], correctIndex: 2, explanation: 'Mr Utterson, the lawyer, is the lens through which the reader experiences the mystery. His rational, measured perspective makes the Gothic horror more unsettling by contrast.', topic: 'Characters', difficulty: 'foundation' },
  { id: 'jh-2', question: 'What does Hyde do to the young girl in the opening chapter?', type: 'multiple-choice', options: ['He kidnaps her', 'He tramples her', 'He speaks rudely to her', 'He steals from her'], correctIndex: 1, explanation: 'Hyde tramples a young girl in the street and shows no remorse. This first act of violence establishes Hyde\'s cruelty and introduces the mystery of his connection to Jekyll.', topic: 'Plot', difficulty: 'foundation' },
  { id: 'jh-3', question: 'Who does Hyde murder in the novella?', type: 'multiple-choice', options: ['Mr Utterson', 'Dr Lanyon', 'Sir Danvers Carew', 'Richard Enfield'], correctIndex: 2, explanation: 'Hyde brutally murders Sir Danvers Carew, a respected MP, beating him to death with a heavy cane. This escalation from trampling a child to frenzied murder shows Hyde\'s violence growing more extreme.', topic: 'Plot', difficulty: 'foundation' },
  { id: 'jh-4', question: 'What is the central theme of the novella?', type: 'multiple-choice', options: ['The importance of friendship', 'The duality of human nature', 'The dangers of travel', 'The value of education'], correctIndex: 1, explanation: 'Jekyll states that "man is not truly one, but truly two." The novella\'s central theme is that every human being contains both good and evil impulses, and attempting to separate them is dangerous.', topic: 'Themes', difficulty: 'foundation' },
  { id: 'jh-5', question: 'When was Jekyll and Hyde published?', type: 'multiple-choice', options: ['1818', ' 1847', '1886', '1897'], correctIndex: 2, explanation: 'Published in 1886, during the late Victorian era. The novella reflects anxieties about respectability, repression, and the scientific discoveries (especially Darwinism) that were challenging traditional views of human nature.', topic: 'Context', difficulty: 'foundation' },
  { id: 'jh-6', question: 'How do characters describe their reaction to meeting Hyde?', type: 'multiple-choice', options: ['They find him charming', 'They feel instinctive revulsion they cannot explain', 'They are indifferent', 'They find him handsome but rude'], correctIndex: 1, explanation: 'Every character who meets Hyde feels inexplicable revulsion. Enfield calls it "something downright detestable" and Utterson describes "Satan\'s signature upon a face." Evil resists rational categorisation.', topic: 'Characters', difficulty: 'foundation' },
  { id: 'jh-7', question: 'What happens to Dr Lanyon after witnessing Hyde\'s transformation?', type: 'multiple-choice', options: ['He becomes Hyde\'s ally', 'He dies from the shock within weeks', 'He reports Jekyll to the police', 'He creates his own potion'], correctIndex: 1, explanation: 'The shock of witnessing Hyde transform into Jekyll kills Lanyon within weeks. He represents the limits of Victorian rational science: he cannot accept what he has seen and it destroys him.', topic: 'Plot', difficulty: 'foundation' },
  { id: 'jh-8', question: 'What does Jekyll mean when he says "man is not truly one, but truly two"?', type: 'multiple-choice', options: ['People have twin siblings', 'Every person contains both good and evil impulses that cannot be separated', 'People should live double lives', 'Science can create two versions of a person'], correctIndex: 1, explanation: 'This is the novella\'s thesis: human nature contains a fundamental duality of good and evil. Jekyll\'s experiment attempts to separate these, but Stevenson shows this separation is impossible and dangerous.', topic: 'Themes', difficulty: 'higher' },
  { id: 'jh-9', question: 'How does Stevenson use the setting of London to reinforce the novella\'s themes?', type: 'multiple-choice', options: ['London is bright and cheerful throughout', 'The fog-shrouded streets mirror the culture of concealment and moral blindness', 'London is used only as a neutral backdrop', 'The setting is in the countryside'], correctIndex: 1, explanation: '"The fog still slept on the wing above the drowned city." Stevenson uses fog, darkness, and the contrast between respectable front doors and sinister back entrances to create a Gothic atmosphere that mirrors the characters\' hidden lives and moral blindness.', topic: 'Writer\'s Methods', difficulty: 'higher' },
  { id: 'jh-10', question: 'Why is Hyde described with ape-like imagery?', type: 'multiple-choice', options: ['He looks like an ape', 'It connects to Darwinian fears of evolutionary regression — the beast lurking beneath civilisation', 'Stevenson liked animal descriptions', 'It was a common insult'], correctIndex: 1, explanation: 'Hyde is described as "ape-like" with "extraordinary quickness," reflecting Victorian anxieties about Darwin\'s theory of evolution. These descriptions suggest that beneath the civilised surface lurks something primitive and bestial that can resurface at any time.', topic: 'Context', difficulty: 'higher' },
  { id: 'jh-11', question: 'What is the significance of the mysterious back door in the opening chapter?', type: 'multiple-choice', options: ['It is just an entrance', 'It symbolises the hidden, disreputable side of a respectable life', 'It belongs to a different house', 'It represents escape'], correctIndex: 1, explanation: 'The "blistered and distained" back door to Jekyll\'s laboratory symbolises the hidden, shameful side of respectability. While Jekyll\'s front door is grand and proper, the back door (which Hyde uses) represents the secret life concealed behind Victorian propriety.', topic: 'Writer\'s Methods', difficulty: 'higher' },
  { id: 'jh-12', question: 'What does Jekyll mean by "I felt younger, lighter, happier in body" when describing becoming Hyde?', type: 'multiple-choice', options: ['He is exercising more', 'The initial transformation feels pleasurable, mirroring the seductive appeal of transgression', 'He has taken medicine', 'He is dreaming'], correctIndex: 1, explanation: 'The positive language ("younger, lighter, happier") makes Hyde\'s liberation genuinely attractive, which is precisely why it is so dangerous. It mirrors the seductive appeal of giving in to impulse without moral consequence — an appeal that becomes addictive.', topic: 'Themes', difficulty: 'higher' },
  { id: 'jh-13', question: 'How does Stevenson use the narrative structure to reinforce the theme of secrecy?', type: 'multiple-choice', options: ['The story is told chronologically', 'The truth is withheld until the final chapters through sealed letters and multiple narrators', 'There is only one narrator', 'The structure is simple and straightforward'], correctIndex: 1, explanation: 'The novella is structured around secrets: locked doors, sealed letters, wills, and confessions read only after death. The central revelation is withheld until the final pages, mirroring Victorian society\'s obsessive concealment.', topic: 'Writer\'s Methods', difficulty: 'higher' },
  { id: 'jh-14', question: 'What does "It was Hyde, after all, and Hyde alone, that was guilty" reveal about Jekyll?', type: 'multiple-choice', options: ['Jekyll is telling the truth', 'Jekyll is engaging in self-deception by externalising blame, when they are the same person', 'Hyde acted independently', 'Jekyll was not involved'], correctIndex: 1, explanation: 'Jekyll tries to absolve himself by blaming Hyde, but this is self-deception. The novella\'s moral force depends on the reader understanding that Jekyll and Hyde are the same person — separating guilt from the self is impossible.', topic: 'Characters', difficulty: 'higher' },
  { id: 'jh-15', question: 'How does the theme of repression connect to Victorian society?', type: 'multiple-choice', options: ['Victorians were not repressed', 'The demand for respectability drove people towards secret transgression rather than honest self-knowledge', 'Repression only affected the lower classes', 'The novella does not discuss repression'], correctIndex: 1, explanation: 'Almost every character suppresses knowledge, desire, or scandal. Stevenson portrays a society where reputation matters more than truth, and the pressure to appear morally spotless creates the conditions for secret vice. Jekyll\'s potion is a chemical version of the double life many Victorians already led.', topic: 'Context', difficulty: 'higher' },
  { id: 'jh-16', question: 'What is significant about Hyde having no social identity, birth certificate, or history?', type: 'multiple-choice', options: ['He is a ghost', 'He exists outside all legal and social frameworks, making him literally unaccountable', 'It is a plot hole', 'He destroyed his records'], correctIndex: 1, explanation: 'Hyde has no social identity — "Think of it — I did not even exist!" He exists outside the legal and social frameworks that govern Victorian life, making him a walking embodiment of the freedom from consequence that Jekyll craves.', topic: 'Themes', difficulty: 'grade-9' },
  { id: 'jh-17', question: 'How does Stevenson anticipate Freud\'s theories of the unconscious mind?', type: 'multiple-choice', options: ['He read Freud\'s work', 'Jekyll\'s experiment can be read as separating the id (instinct) from the superego (conscience), decades before Freud published', 'He does not', 'The connection is coincidental'], correctIndex: 1, explanation: 'Though Freud\'s theories came later, Stevenson anticipates the concept of the id (Hyde\'s instinctual desire) separated from the superego (Jekyll\'s social conscience). The idea that the psyche contains warring elements was gaining traction in the 1880s, and Stevenson gave it its most memorable literary form.', topic: 'Context', difficulty: 'grade-9' },
  { id: 'jh-18', question: 'What does the phrase "Satan\'s signature upon a face" suggest about Victorian attitudes to evil?', type: 'multiple-choice', options: ['It is just a metaphor', 'It reflects the Victorian belief in physiognomy — that evil is inscribed on the body', 'It means Hyde wears a mask', 'It is a reference to a painting'], correctIndex: 1, explanation: 'Utterson\'s description reflects physiognomy, the Victorian pseudo-science that believed moral character was readable in facial features. The metaphor of a "signature" implies evil is inscribed on the body — a common Victorian belief that Stevenson both uses and critiques.', topic: 'Writer\'s Methods', difficulty: 'grade-9' },
  { id: 'jh-19', question: 'Why does Hyde grow physically larger as the novella progresses?', type: 'multiple-choice', options: ['He is eating more', 'It suggests that evil, once indulged, becomes increasingly dominant and harder to control', 'It is a mistake by Stevenson', 'He is taking more potion'], correctIndex: 1, explanation: 'Hyde starts smaller than Jekyll but grows larger, suggesting that evil, once unleashed, becomes increasingly dominant. This physical growth mirrors the psychological reality: the more Jekyll indulges his dark side, the harder it becomes to control.', topic: 'Writer\'s Methods', difficulty: 'grade-9' },
  { id: 'jh-20', question: 'How does the novella function as a critique of Victorian gentlemanly culture?', type: 'multiple-choice', options: ['It celebrates Victorian values', 'It exposes how a society obsessed with reputation produces monsters by forcing desire underground', 'It ignores Victorian culture', 'It suggests all Victorians were criminals'], correctIndex: 1, explanation: 'Every gentleman in the story prioritises discretion over truth. Stevenson argues that a society obsessed with reputation inevitably produces monsters, because the things people refuse to acknowledge do not disappear — they grow stronger in the dark. Jekyll\'s tragedy is caused as much by Victorian repression as by his experiment.', topic: 'Themes', difficulty: 'foundation' },
]

const REVISION_TOPICS = [
  { topic: 'Duality of Human Nature', summary: 'The central theme: every person contains both good and evil, and they cannot be separated.', keyPoints: ['"Man is not truly one, but truly two"', 'Jekyll\'s experiment attempts to divide good from evil but fails', 'Hyde grows stronger over time, suggesting evil is not easily controlled', 'Utterson\'s wisdom: good and evil are "commingled" and cannot be neatly separated', 'The horror is not Hyde\'s existence but Jekyll\'s belief he can divide the self'] },
  { topic: 'Victorian Repression and Hypocrisy', summary: 'The novella exposes how the pressure to appear respectable drives people towards secret transgression.', keyPoints: ['Every character suppresses knowledge: Utterson, Enfield, Jekyll', 'Jekyll\'s potion is a chemical version of the double life many Victorians led', 'Reputation matters more than truth in this world', 'The locked doors, sealed letters, and back entrances symbolise concealment', 'The demand for respectability creates the conditions for secret vice'] },
  { topic: 'Science and Transgression', summary: 'Jekyll\'s experiment represents science trespassing into territory belonging to God.', keyPoints: ['Lanyon condemns it as "unscientific balderdash"', 'The real danger is moral overreach, not bad method', 'Written in the wake of Darwin\'s Origin of Species (1859)', 'Hyde\'s ape-like appearance invokes fears of evolutionary regression', 'The novella asks: what happens when knowledge outstrips moral responsibility?'] },
  { topic: 'Secrecy and the Gothic', summary: 'The novella is structured around secrets and uses Gothic conventions to create horror.', keyPoints: ['Locked doors, sealed letters, wills, confessions read only after death', 'The fog-shrouded London setting mirrors concealment', 'Urban Gothic: horror relocated from remote castles to respectable London', 'The revelation is withheld until the final chapters', 'The mysterious back door symbolises the hidden, disreputable side of respectability'] },
  { topic: 'Good vs Evil', summary: 'Hyde embodies pure evil, but Stevenson complicates simple moral readings.', keyPoints: ['Hyde tramples, murders, and feels no remorse', 'But Jekyll is not purely good — he enjoyed the freedom Hyde gave him', 'Goodness maintained only by repression may not be genuine', 'Evil lives within every apparently respectable person', 'Jekyll\'s attempts to blame Hyde alone are self-deception'] },
]
