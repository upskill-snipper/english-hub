...
const CHUNKS: Chunk[] = [
  ...
  },
  {
    ...
    say: 'Stevenson stages a sacrificial tableau: an adult male crushes a female child whose only fault is to be "running as hard as she was able" - that is, to be alive and in motion. The adverb "calmly" is the most damning word in the sentence; it tells us Hyde acts without affect, without conscience, without the moral interrupt that a normally socialised human carries inside them. "Screaming on the ground" leaves her at floor-level, dehumanised by Hyde\'s indifference.',
    zoomOut:
