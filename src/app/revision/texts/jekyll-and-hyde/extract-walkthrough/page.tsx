...
const CHUNKS: Chunk[] = [
  {
    id: 'chunk-1',
    text: '"It was a black winter morning, and my way lay through a part of town where there was literally nothing to be seen but lamps. Street after street, and all the folks asleep — street after street, all lighted up as if for a procession and all as empty as a church — till at last I got into that state of mind when a man listens and listens and begins to long for the sight of a policeman."',
    notice:
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <header className="mb-10 border-b border-border/60 pb-8">
          ...
          <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
            ...
            <em>"It was a black winter morning…"</em> to <em>"…like some damned Juggernaut."</em>{' '}
            Each chunk is unpacked in three layers: <strong>Notice</strong> what the language does,{' '}
            <strong>Say</strong> what it means, then <strong>Zoom Out</strong> to context and theme.
            A grade-9 model paragraph follows.
          </p>
        </header>
