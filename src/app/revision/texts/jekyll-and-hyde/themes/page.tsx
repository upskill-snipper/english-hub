...
const THEMES: ThemeStudy[] = [
  {
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        speaker: 'Jekyll -- Chapter 10',
        analysis:
          'The word "primitive" makes duality primal and ancient -- it predates civilisation and cannot be civilised away. "Thorough" means complete: there is no aspect of human nature untouched by this division. Critics often apply a Freudian lens here retrospectively, though Freud\'s theories were not formulated until decades after Stevenson.',
      },
      {
        quote:
  ...
  },
  {
    ...
    keyQuotes: [
      {
        quote:
          'I concealed my pleasures; and... when I reached years of reflection... I stood already committed to a profound duplicity of life.',
        speaker: 'Jekyll -- Chapter 10',
        analysis:
    ...
    <div className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Themes',
            url: 'https://theenglishhub.app/revision/texts/jekyll-and-hyde/themes',
          },
        ]}
      />
        ...
        <section className="relative mt-8 overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-amber-500/[0.04] p-6 sm:p-8 lg:p-10">
          ...
          <div className="relative">
            ...
            <h1 className="text-display-sm font-heading text-foreground sm:text-display">
              {tr('rev.texts2.jh.themes.title')}
            </h1>
            <p className="mt-2 text-body-lg text-muted-foreground">
              Strange Case of Dr Jekyll and Mr Hyde by Robert Louis Stevenson
            </p>
            <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
              {tr('rev.texts2.jh.themes.intro')}
            </p>
          </div>
        </section>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-heading-md font-heading">
                      {tr('rev.texts.common.detailed_analysis')}
                    </CardTitle>
                  </CardHeader>
                  ...
                  <CardContent className="p-5">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-sm font-semibold text-foreground">
                        {tr('rev.texts2.common.context_link')}
                      </p>
                    </div>
