...
export const metadata: Metadata = {
  ...
  description:
    'In-depth character analysis for Pride and Prejudice by Jane Austen: Elizabeth Bennet, Darcy, Jane, Bingley, Wickham, Mr & Mrs Bennet, Lydia and Lady Catherine.',
  alternates: {
    canonical: 'https://theenglishhub.app/revision/texts/pride-and-prejudice/characters',
  },
}
...
const CHARACTERS: CharacterProfile[] = [
  ...
  },
  {
    ...
    keyQuotes: [
      {
        quote:
          '"A woman of mean understanding, little information, and uncertain temper. When she was discontented she fancied herself nervous. The business of her life was to get her daughters married."',
        analysis:
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Characters',
            url: 'https://theenglishhub.app/revision/texts/pride-and-prejudice/characters',
          },
        ]}
      />
      {/* ── Hero ─────────────────────────────────────────────────────── */}
