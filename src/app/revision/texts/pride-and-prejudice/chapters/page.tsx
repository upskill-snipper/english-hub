...
export const metadata: Metadata = {
  ...
  description:
    'Volume-by-volume and chapter-by-chapter analysis of Pride and Prejudice by Jane Austen with key quotations and exam-ready commentary.',
  alternates: {
    canonical: 'https://theenglishhub.app/revision/texts/pride-and-prejudice/chapters',
  },
}
      ...
      <BreadcrumbJsonLd
        items={[
          ...
          },
          {
            ...
            url: 'https://theenglishhub.app/revision/texts/pride-and-prejudice/chapters',
          },
        ]}
      />
      {/* ── Hero ─────────────────────────────────────────────────────── */}
        ...
        {CHAPTERS.map((ch) => (
          <Card key={ch.chapter}>
            <CardHeader>
              ...
              <CardTitle className="text-heading-md font-heading">{ch.title}</CardTitle>
            </CardHeader>
