...
export const metadata: Metadata = {
  openGraph: {
    ...
    description:
      'Historical context for Of Mice and Men: the Great Depression, migrant labour, racial segregation in 1930s America and attitudes to disability.',
    images: [
      {
        url: '/api/og?title=Of+Mice+and+Men+-+Historical+Context+%7C+The+English+Hub',
        width: 1200,
        height: 630,
        alt: 'Of Mice and Men - Historical Context | The English Hub',
      },
    ],
  },
  ...
  description:
    'Historical context for Of Mice and Men: the Great Depression, migrant labour, racial segregation in 1930s America and attitudes to disability.',
  alternates: {
    canonical: 'https://theenglishhub.app/revision/texts/of-mice-and-men/context',
  },
}
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Context',
            url: 'https://theenglishhub.app/revision/texts/of-mice-and-men/context',
          },
        ]}
      />
      {/* Hero */}
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-blue-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            {await t('rev.texts2.omam.context.intro')}
          </p>
        </div>
      </section>
