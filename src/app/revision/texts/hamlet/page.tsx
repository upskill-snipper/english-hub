...
import { guide as studyGuide } from '@/data/study-guides/hamlet'
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Hamlet - Study Guide | The English Hub',
      },
    ],
  },
      ...
      <TextStudyHub
        ...
        subPages={[
          ...
          },
          {
            ...
            description: await t('rev.texts.subpage.essays.desc_alevel'),
          },
        ]}
