...
const data: TextGuideData = {
  ...
  quotations: [
    ...
    {
      quote: '"Cesario, come\u2014 / For so you shall be while you are a man; / But when in other habits you are seen, / Orsino\'s mistress and his fancy\'s queen."',
    ...
    {
      quote: '"O mistress mine, where are you roaming? / O stay and hear, your true-love\'s coming, / That can sing both high and low."',
      who: 'Feste \u2014 Act 2, Scene 3',
      analysis:
...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  { id: 'tn-1', question: 'Where is Twelfth Night set?', type: 'multiple-choice', options: ['Verona', 'Illyria', 'Venice', 'Athens'], correctIndex: 1, explanation: 'The play is set in Illyria, an imagined Mediterranean court rather than a realistic location. The exotic-sounding name gave Shakespeare freedom to create a dreamlike world.', topic: 'Plot', difficulty: 'foundation' },
  { id: 'tn-2', question: 'What name does Viola take when she disguises herself as a young man?', type: 'multiple-choice', options: ['Sebastian', 'Cesario', 'Fabian', 'Valentine'], correctIndex: 1, explanation: 'Viola adopts the name Cesario to enter Orsino\u2019s court. The disguise drives the central romantic confusion of the play.', topic: 'Characters', difficulty: 'foundation' },
  { id: 'tn-3', question: 'Who speaks the famous opening line \u201cIf music be the food of love, play on\u201d?', type: 'multiple-choice', options: ['Feste', 'Sir Toby', 'Orsino', 'Sebastian'], correctIndex: 2, explanation: 'Orsino opens the play indulging his lovesick melancholy. The line establishes him as a character in love with the idea of being in love.', topic: 'Characters', difficulty: 'foundation' },
  { id: 'tn-4', question: 'Who forges the letter that tricks Malvolio?', type: 'multiple-choice', options: ['Olivia', 'Maria', 'Feste', 'Viola'], correctIndex: 1, explanation: 'Maria, Olivia\u2019s sharp-witted servingwoman, forges the letter in Olivia\u2019s handwriting. Her wit is later rewarded when she marries Sir Toby.', topic: 'Plot', difficulty: 'foundation' },
  { id: 'tn-5', question: 'What costume does Malvolio put on because he believes the letter tells him to?', type: 'multiple-choice', options: ['A clown\u2019s motley', 'Yellow stockings, cross-gartered', 'A friar\u2019s robe', 'Black mourning clothes'], correctIndex: 1, explanation: 'The forged letter instructs Malvolio to appear in yellow stockings cross-gartered and to smile constantly. The absurd costume makes Olivia think he has gone mad.', topic: 'Plot', difficulty: 'foundation' },
  { id: 'tn-6', question: 'Who is Viola\u2019s twin brother?', type: 'multiple-choice', options: ['Antonio', 'Sebastian', 'Orsino', 'Sir Andrew'], correctIndex: 1, explanation: 'Sebastian is Viola\u2019s twin brother. Both survive the shipwreck independently, and their identical appearance drives much of the final-act confusion.', topic: 'Characters', difficulty: 'foundation' },
  { id: 'tn-7', question: 'What role does Feste play in Olivia\u2019s household?', type: 'multiple-choice', options: ['The steward', 'The clown / licensed fool', 'The butler', 'The chaplain'], correctIndex: 1, explanation: 'Feste is Olivia\u2019s clown, a \u201clicensed fool\u201d whose role is to speak wittily and sometimes cuttingly to his betters. He moves freely between Olivia\u2019s and Orsino\u2019s households.', topic: 'Characters', difficulty: 'foundation' },
  { id: 'tn-8', question: 'Who says \u201cSome are born great, some achieve greatness, and some have greatness thrust upon \u2019em\u201d?', type: 'multiple-choice', options: ['Orsino', 'Sir Toby', 'Malvolio (reading the forged letter)', 'Feste'], correctIndex: 2, explanation: 'Malvolio reads the line from Maria\u2019s forged letter in Act 2 Scene 5. The line feeds his class ambition and sets up the cruel comedy of his gulling.', topic: 'Themes', difficulty: 'foundation' },
  { id: 'tn-9', question: 'What does Viola mean when she says \u201cI am not what I am\u201d?', type: 'multiple-choice', options: ['She is lying about her age', 'She hints at her true female identity beneath the Cesario disguise', 'She is quoting a song', 'She denies loving Orsino'], correctIndex: 1, explanation: 'The line hints to Olivia that Cesario is not what he appears. It captures the play\u2019s central paradox of disguise and echoes God\u2019s \u201cI am that I am\u201d in inverted form.', topic: 'Writer\u2019s Methods', difficulty: 'higher' },
  { id: 'tn-10', question: 'Who is part of the conspiracy against Malvolio?', type: 'multiple-choice', options: ['Viola, Sebastian, Feste, Toby', 'Maria, Sir Toby, Sir Andrew, Fabian', 'Orsino, Olivia, Antonio, Feste', 'Only Maria and Feste'], correctIndex: 1, explanation: 'Maria plans the prank, and she is joined by Sir Toby, Sir Andrew and Fabian. Feste is drawn in later to impersonate the curate Sir Topas in the dark-room scene.', topic: 'Plot', difficulty: 'higher' },
  { id: 'tn-11', question: 'How does Shakespeare use Feste\u2019s songs in the play?', type: 'multiple-choice', options: ['Purely for comic distraction', 'To reinforce the festive atmosphere with no deeper meaning', 'To introduce a melancholy counter-current that complicates the comedy', 'To summarise the plot for the audience'], correctIndex: 2, explanation: 'Feste\u2019s songs insist on the brevity of youth (\u201cyouth\u2019s a stuff will not endure\u201d) and close the play with a weary vision of rain. They give the comedy its melancholy undertow.', topic: 'Writer\u2019s Methods', difficulty: 'higher' },
  { id: 'tn-12', question: 'How does the ending complicate the comedy\u2019s happy resolution?', type: 'multiple-choice', options: ['All characters are paired off happily with no reservations', 'Malvolio vows revenge, Antonio is left alone, and Feste\u2019s closing song is about wind and rain', 'Orsino refuses to marry Viola', 'Sebastian dies before the final scene'], correctIndex: 1, explanation: 'The play ends with Malvolio\u2019s \u201cI\u2019ll be revenged on the whole pack of you,\u201d Antonio\u2019s devotion quietly set aside, and Feste alone on stage singing \u201cthe rain it raineth every day.\u201d The comic resolution is shadowed throughout.', topic: 'Themes', difficulty: 'higher' },
  { id: 'tn-13', question: 'What does Sir Toby mean by \u201cDost thou think, because thou art virtuous, there shall be no more cakes and ale\u201d?', type: 'multiple-choice', options: ['He is planning a feast', 'He defends festive revelry against Malvolio\u2019s puritan disapproval', 'He is mocking Feste', 'He is apologising to Olivia'], correctIndex: 1, explanation: 'Toby\u2019s retort crystallises the play\u2019s opposition between festive misrule and puritan order. Cakes and ale stand for the life of the body that Malvolio would suppress.', topic: 'Themes', difficulty: 'higher' },
  { id: 'tn-14', question: 'What is the significance of Viola\u2019s speech about \u201cpatience on a monument\u201d and the sister who \u201cnever told her love\u201d?', type: 'multiple-choice', options: ['She is gossiping about a relative', 'She describes her own hidden love for Orsino in the third person, capturing the pain of silent devotion', 'She is warning Orsino about Olivia', 'She is trying to change the subject'], correctIndex: 1, explanation: 'Viola invents an imaginary \u201csister\u201d who loved in silence so that she can describe her own feelings to Orsino without breaking her disguise. The passage is one of the most moving in the play.', topic: 'Characters', difficulty: 'higher' },
  { id: 'tn-15', question: 'Why does Shakespeare give the play the title \u201cTwelfth Night, or What You Will\u201d?', type: 'multiple-choice', options: ['It was written on 6 January', 'It refers to the festival of misrule at the end of the Christmas holidays, in which hierarchies were inverted for a night of revelry', 'It means \u201cthe twelfth play he wrote\u201d', 'It is a reference to an Italian folk song'], correctIndex: 1, explanation: 'Twelfth Night (5\u20136 January, eve of Epiphany) was the climax of the Elizabethan Christmas holidays, marked by a \u201cLord of Misrule\u201d who inverted social hierarchies for a night. The subtitle \u201cWhat You Will\u201d extends the mood of holiday licence.', topic: 'Context', difficulty: 'higher' },
  { id: 'tn-16', question: 'How is the Elizabethan convention of boy-actors significant in Twelfth Night?', type: 'multiple-choice', options: ['It has no bearing on the play\u2019s meaning', 'A boy actor plays Viola playing Cesario, layering the gender play and making the line between male and female deliberately unstable', 'It means female characters speak less', 'It explains why the play was banned'], correctIndex: 1, explanation: 'Because women were forbidden from the stage, a boy actor played Viola playing a young man. This theatrical convention is fully absorbed into the play\u2019s exploration of gender and desire and is implicit in Orsino\u2019s decision to keep calling Viola \u201cCesario\u201d at the end.', topic: 'Context', difficulty: 'grade-9' },
  { id: 'tn-17', question: 'What does Orsino\u2019s closing line \u201cCesario, come \u2014 for so you shall be while you are a man\u201d suggest about desire in the play?', type: 'multiple-choice', options: ['Orsino is confused and cannot remember her name', 'Orsino\u2019s desire was attached to Cesario, the male persona, and does not simply re-gender itself once Viola is revealed', 'It is a printing error in the First Folio', 'He rejects her and loves Olivia after all'], correctIndex: 1, explanation: 'By continuing to address Viola as Cesario, Orsino implies that the intimate bond he formed with his page persists. Shakespeare leaves the play\u2019s supposedly heterosexual resolution deliberately unstable.', topic: 'Themes', difficulty: 'grade-9' },
  { id: 'tn-18', question: 'How does the gulling of Malvolio complicate the play\u2019s status as a comedy?', type: 'multiple-choice', options: ['It is entirely light-hearted', 'The dark-room scene and Malvolio\u2019s final vow of revenge push the cruelty too far for a purely festive ending, leaving audiences uneasy', 'Malvolio laughs along with the joke', 'Malvolio dies offstage'], correctIndex: 1, explanation: 'The imprisonment of Malvolio in a dark room and Feste\u2019s impersonation of Sir Topas drive the prank into genuine cruelty. Malvolio\u2019s \u201cI\u2019ll be revenged on the whole pack of you\u201d refuses the comic resolution, giving the play a famously bitter aftertaste.', topic: 'Writer\u2019s Methods', difficulty: 'grade-9' },
  { id: 'tn-19', question: 'What Italian source is Twelfth Night partly based on?', type: 'multiple-choice', options: ['Dante\u2019s Inferno', 'Gl\u2019Ingannati (\u201cThe Deceived\u201d, 1531), an Italian commedia play featuring separated twins and a disguised heroine', 'A commedia dell\u2019arte opera', 'A poem by Petrarch'], correctIndex: 1, explanation: 'Shakespeare drew on the Italian comedy Gl\u2019Ingannati, which features separated twins, a disguised heroine who falls in love with her employer, and a mistaken-identity resolution. Italian commedia provided the structural scaffolding for the play.', topic: 'Context', difficulty: 'grade-9' },
  { id: 'tn-20', question: 'How does Shakespeare use Feste\u2019s closing song \u201cThe rain it raineth every day\u201d?', type: 'multiple-choice', options: ['As a triumphant wedding song', 'To shift the play out of festival time and into ordinary, weather-beaten life, leaving the comedy with a melancholy close', 'To introduce a new plot', 'To mock the audience'], correctIndex: 1, explanation: 'Instead of the expected wedding dance, the play ends with Feste alone on stage singing a weary ballad about wind and rain. The song moves the play from holiday licence back into everyday life and gives the comedy its famously melancholy close.', topic: 'Writer\u2019s Methods', difficulty: 'grade-9' },
]

const REVISION_TOPICS = [
  { topic: 'Love and Self-Deception', summary: 'Almost every character in Illyria mistakes their own feelings, and Shakespeare exposes love as often a projection rather than a response.', keyPoints: ['Orsino is in love with being in love, not with Olivia', 'Olivia\u2019s seven-year mourning collapses within one scene of meeting Cesario', 'Malvolio is gulled into believing Olivia secretly adores him', 'Viola\u2019s silent love for Orsino is the only constant love in the play', 'The final pairings are happy but founded on very little knowledge'] },
  { topic: 'Gender Identity and Disguise', summary: 'Viola\u2019s disguise as Cesario lets Shakespeare explore the instability of gender and desire more radically than in any other comedy.', keyPoints: ['Viola\u2019s line \u201cI am not what I am\u201d captures the doubleness of her role', 'Olivia falls in love with Cesario, a woman in male disguise', 'Orsino forms an intimate bond with Cesario before the reveal', 'Elizabethan boy-actors add another layer to the gender play', 'Orsino closes the play still addressing Viola as \u201cCesario\u201d'] },
  { topic: 'Order vs Misrule', summary: 'The play\u2019s festive title points to a night of licensed inversion; its plot sets revellers against a puritan steward.', keyPoints: ['Sir Toby and friends embody the Lord of Misrule spirit', 'Malvolio represents puritan order: sober, judgemental, ambitious', '\u201cCakes and ale\u201d stands for the life of the body Malvolio would suppress', 'Maria\u2019s forged letter is the festival\u2019s inversion pushed to cruelty', 'The final act tries to restore order but the resolution is uneasy'] },
  { topic: 'Melancholy and Mortality', summary: 'For a comedy, Twelfth Night is unusually shadowed by loss, and Feste\u2019s songs keep reminding the audience that time is short.', keyPoints: ['Viola and Olivia both mourn brothers believed dead', 'Orsino\u2019s love is laced with melancholy from the opening line', 'Feste\u2019s refrain \u201cyouth\u2019s a stuff will not endure\u201d haunts the revellers', 'The gulling of Malvolio ends with a vow of revenge, not laughter', 'The closing song \u201cthe rain it raineth every day\u201d gives the comedy a dying fall'] },
  { topic: 'Class and Ambition', summary: 'The play is fascinated by characters who try to move above their social station, and rewards them unevenly.', keyPoints: ['Malvolio fantasises about becoming \u201cCount Malvolio\u201d', '\u201cSome are born great, some achieve greatness\u2026\u201d feeds his class ambition', 'Maria, a gentlewoman servant, wins Sir Toby through wit', 'Sir Andrew\u2019s wealth buys him status but no real welcome', 'The difference between Maria\u2019s rise and Malvolio\u2019s fall exposes the narrowness of the Elizabethan order'] },
]
  ...
  return (
    <>
      ...
      <TextStudyHub
        ...
        subPages={[
          { id: 'read', href: '/revision/texts/twelfth-night/read', icon: 'read' as const, title: 'Read Full Text', description: 'With annotations' },
          { id: 'acts', href: '/revision/texts/twelfth-night/acts', icon: 'acts' as const, title: 'Act-by-Act Analysis', description: 'Key moments & quotes' },
          { id: 'characters', href: '/revision/texts/twelfth-night/characters', icon: 'characters' as const, title: 'Characters', description: 'Full character guide' },
          { id: 'themes', href: '/revision/texts/twelfth-night/themes', icon: 'themes' as const, title: 'Themes', description: 'Theme analysis' },
          { id: 'quotes', href: '/revision/texts/twelfth-night/key-quotes', icon: 'quotes' as const, title: 'Key Quotes', description: 'Quotes with analysis' },
          { id: 'context', href: '/revision/texts/twelfth-night/context', icon: 'context' as const, title: 'Context', description: 'Historical context' },
          { id: 'essays', href: '/revision/texts/twelfth-night/essay-plans', icon: 'essays' as const, title: 'Essay Plans', description: 'GCSE essay plans' },
        ]}
