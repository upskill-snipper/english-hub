...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    ...
    correctIndex: 2,
    explanation:
      'Okonkwo is a proud Igbo warrior whose rigid masculinity and world are shattered by colonialism. He is both a tragic hero and a deeply flawed man.',
    topic: 'Characters',
  ...
  },
  {
    ...
    type: 'multiple-choice',
    options: ['Kenya', 'South Africa', 'Umuofia, Igboland (Nigeria)', 'Ghana'],
    correctIndex: 2,
    explanation:
      'The novel is set in the nine Igbo villages of Umuofia in pre-colonial Nigeria. Achebe devotes the first part to showing the rich fabric of Igbo daily life before colonial contact.',
    topic: 'Plot',
    difficulty: 'foundation',
  },
  {
    id: 'tfa-3',
    question: 'Why is Okonkwo so determined to be different from his father Unoka?',
    type: 'multiple-choice',
    options: [
      'Unoka was cruel',
      'Unoka was a gentle, lazy debtor who shamed Okonkwo',
      'Unoka was wealthy',
      'Unoka was a warrior',
    ],
    correctIndex: 1,
    explanation:
      'Unoka was a gentle, music-loving debtor who never took a title. Okonkwo is terrified of resembling him and overcompensates with aggression and relentless hard work. This fear of weakness drives his entire character.',
    topic: 'Characters',
    difficulty: 'foundation',
  },
  {
    ...
    options: [
      "Okonkwo's brother",
      'A boy given to Umuofia as reparation who becomes like a son to Okonkwo',
      'A missionary',
      "Okonkwo's rival",
    ],
    correctIndex: 1,
    explanation:
      "Ikemefuna is a young boy given to Umuofia by a neighbouring village. He lives with Okonkwo's family for three years, becoming like a son. When the Oracle decrees his death, Okonkwo participates in the killing to avoid appearing weak.",
    topic: 'Characters',
    difficulty: 'foundation',
  },
  {
    id: 'tfa-5',
    question: 'Why is Okonkwo exiled from Umuofia?',
    type: 'multiple-choice',
    options: [
      'He committed murder intentionally',
      'His gun accidentally kills a clansman during a funeral',
      'He insulted the Oracle',
      'He refused to fight',
    ],
    correctIndex: 1,
    explanation:
      "Okonkwo's gun accidentally explodes and kills a young clansman during a funeral. He is exiled to his mother's village of Mbanta for seven years. While he is away, missionaries and colonial administrators arrive.",
    topic: 'Plot',
    difficulty: 'foundation',
  },
  {
    id: 'tfa-6',
    question: "What does Okonkwo's son Nwoye do that shocks his father?",
    type: 'multiple-choice',
    options: [
      'He becomes a warrior',
      'He converts to Christianity and takes the name Isaac',
      'He runs away from home',
      'He challenges Okonkwo to a fight',
    ],
    correctIndex: 1,
    explanation:
      "Nwoye, alienated by his father's violence and the killing of Ikemefuna, converts to Christianity. His new name Isaac echoes the biblical story of Abraham and Isaac, symbolising the generational rupture colonialism exploits.",
    topic: 'Plot',
    difficulty: 'foundation',
  },
  {
    id: 'tfa-7',
    question: 'How does Okonkwo die?',
    type: 'multiple-choice',
    options: [
      'He is killed by the colonists',
      'He dies in battle',
      'He hangs himself',
      'He dies of illness',
    ],
    correctIndex: 2,
    explanation:
      'After killing a colonial messenger and realising his clan will not fight, Okonkwo hangs himself. Suicide is an abomination in Igbo culture, meaning his clansmen cannot even bury him. His death represents the total destruction of his world.',
    topic: 'Plot',
    difficulty: 'foundation',
  },
  {
    id: 'tfa-8',
    question: 'When was the novel published?',
    type: 'multiple-choice',
    options: ['1945', '1958', '1965', '1970'],
    correctIndex: 1,
    explanation:
      "Published in 1958, two years before Nigerian independence. Achebe wrote it specifically to answer European novels like Conrad's Heart of Darkness that depicted Africa as a blank, savage backdrop.",
    topic: 'Context',
    difficulty: 'foundation',
  },
  {
    id: 'tfa-9',
    question:
      'What does the proverb "proverbs are the palm-oil with which words are eaten" reveal about Igbo culture?',
    type: 'multiple-choice',
    options: [
      'The Igbo eat palm oil',
      'It establishes the sophistication and richness of Igbo oral culture before any colonial contact',
      'It is a cooking reference',
      'It has no deeper meaning',
    ],
    correctIndex: 1,
    explanation:
      'This narrator\'s observation in Chapter 1 immediately establishes the Igbo as a people who value eloquence, wisdom, and artful speech. Achebe deliberately counters the colonial narrative of "primitive" Africa by showing a complex, articulate society.',
    topic: "Writer's Methods",
    difficulty: 'higher',
  },
  {
    id: 'tfa-10',
    question: "What is the significance of the novel's title, taken from Yeats's poem?",
    type: 'multiple-choice',
    options: [
      'It is just a title',
      'It places an Igbo tragedy inside the European literary canon, insisting it belongs there',
      'Yeats wrote about Nigeria',
      'It describes the weather',
    ],
    correctIndex: 1,
    explanation:
      'The title comes from W.B. Yeats\'s "The Second Coming" ("Things fall apart; the centre cannot hold"). Achebe deliberately plants his Igbo tragedy inside the European literary canon, quietly insisting that it belongs there and demanding equal recognition.',
    topic: 'Context',
    difficulty: 'higher',
  },
  {
    id: 'tfa-11',
    question: 'How does Achebe present the killing of Ikemefuna as a moral turning point?',
    type: 'multiple-choice',
    options: [
      'It is a minor event',
      'Okonkwo participates despite being warned not to, revealing that his fear of weakness overrides his love',
      'Okonkwo refuses to participate',
      'It brings the clan together',
    ],
    correctIndex: 1,
    explanation:
      "Okonkwo is advised by Ogbuefi Ezeudu not to take part in Ikemefuna's killing, but he does so anyway because he is afraid of appearing weak. This act haunts him and marks the first step in his decline, exposing the cost of his rigid code.",
    topic: 'Plot',
    difficulty: 'higher',
  },
  {
    id: 'tfa-12',
    question: 'What is the difference between Mr Brown and Reverend Smith?',
    type: 'multiple-choice',
    options: [
      'They are the same',
      'Brown is patient and respectful while Smith is zealous and provocative, showing the range of colonial intrusion',
      'Smith is kind and Brown is cruel',
      'They represent the same approach',
    ],
    correctIndex: 1,
    explanation:
      'Achebe contrasts the two missionaries: Mr Brown builds relationships and respects Igbo culture, while Reverend Smith is rigid, zealous, and provocative. This prevents a simple good-versus-evil reading and shows the range of colonial behaviour.',
    topic: 'Characters',
    difficulty: 'higher',
  },
  {
    id: 'tfa-13',
    question: "What does the District Commissioner's planned book title reveal about colonialism?",
    type: 'multiple-choice',
    options: [
      'He is a good writer',
      'Calling it "The Pacification of the Primitive Tribes of the Lower Niger" reduces Okonkwo\'s life to a colonial footnote, showing the violence of colonial narrative',
      'He is sympathetic',
      'He wants to help',
    ],
    correctIndex: 1,
  ...
  {
    id: 'tfa-14',
    question: 'How does Obierika function in the novel?',
    type: 'multiple-choice',
    options: [
      'He is a villain',
      "He is thoughtful and questioning where Okonkwo is rigid, articulating the reader's doubts",
      "He is Okonkwo's enemy",
      'He is unimportant',
    ],
    correctIndex: 1,
    explanation:
      "Obierika is Okonkwo's closest friend but his opposite: thoughtful, willing to question traditions, and emotionally flexible. He articulates the reader's doubts about customs like abandoning twins and delivers the novel's most moving closing eulogy.",
    topic: 'Characters',
    difficulty: 'higher',
  },
  {
    id: 'tfa-15',
    question:
      'What does "He was afraid of being thought weak" tell us about Okonkwo\'s psychology?',
    type: 'multiple-choice',
    options: [
      'He is a coward',
  ...
  {
    id: 'tfa-16',
    question: 'How does colonialism exploit existing divisions within Igbo society?',
    type: 'multiple-choice',
    options: [
      'It does not',
      'Missionaries target the outcasts, twins, and those dissatisfied with traditions, converting them and splitting the community',
      'Everyone converts willingly',
      'Only the leaders convert',
    ],
    correctIndex: 1,
    explanation:
  ...
  {
    id: 'tfa-17',
    question: 'How does Achebe use the novel to counter European narratives about Africa?',
    type: 'multiple-choice',
    options: [
      'He ignores European narratives',
      "By spending the first half establishing a complex, functioning Igbo society before colonialism destroys it, he directly answers Conrad's Heart of Darkness",
      'He praises European colonialism',
      'He writes from a European perspective',
    ],
    correctIndex: 1,
    explanation:
  ...
  {
    id: 'tfa-18',
    question: 'What does the concept of chi (personal spirit) add to the novel?',
    type: 'multiple-choice',
    options: [
  ...
  {
    id: 'tfa-19',
    question: 'Why does Achebe write the novel in English rather than Igbo?',
    type: 'multiple-choice',
    options: [
      'He could not write in Igbo',
      "He deliberately uses the coloniser's language to reach the widest audience and prove African literature belongs in the world canon",
      'It was required by publishers',
      'He preferred English',
    ],
    correctIndex: 1,
    explanation:
      "Achebe chose English deliberately, using the coloniser's own language to challenge colonial narratives. By weaving in Igbo proverbs and untranslated words, he creates a distinctly African English that insists African stories belong in the world literary canon.",
    topic: "Writer's Methods",
    difficulty: 'grade-9',
  },
  {
    id: 'tfa-20',
    question: 'How does Achebe suggest that toxic masculinity is itself a form of vulnerability?',
    type: 'multiple-choice',
    options: [
...
const REVISION_TOPICS = [
  {
    topic: 'Colonialism and Cultural Collision',
    summary: 'Achebe shows a complex, functioning society destroyed by colonial power.',
    keyPoints: [
      'The first half establishes rich Igbo culture before colonial contact',
      'Missionaries target outcasts and dissatisfied youth',
      '"He has won our brothers, and our clan can no longer act like one"',
      "The District Commissioner reduces Okonkwo's life to a paragraph",
      "Achebe directly answers Conrad's Heart of Darkness",
    ],
  },
  {
    ...
    keyPoints: [
      ...
      'Achebe suggests toxic masculinity is itself a vulnerability',
    ],
  },
  {
    ...
    keyPoints: [
      ...
      "Nwoye's conversion reflects genuine dissatisfaction with some traditions",
      'Mr Brown vs Reverend Smith: different colonial approaches',
      'The novel refuses to idealise pre-colonial society completely',
    ],
  },
  {
    topic: 'Language and Storytelling',
    summary: 'Achebe uses language itself as a weapon against colonial narrative.',
    keyPoints: [
      '"Proverbs are the palm-oil with which words are eaten"',
      'Igbo proverbs and songs woven throughout the text',
      'Written in English to reach the widest audience',
      'The title from Yeats insists the novel belongs in the world canon',
      "The District Commissioner's book title shows the violence of colonial storytelling",
    ],
  },
  {
    topic: 'Fate and Personal Chi',
    summary:
      'The Igbo concept of chi runs throughout, questioning whether Okonkwo could have escaped his fate.',
    keyPoints: [
