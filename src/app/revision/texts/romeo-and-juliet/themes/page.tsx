    ...
    <div className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Themes',
            url: 'https://theenglishhub.app/revision/texts/romeo-and-juliet/themes',
          },
        ]}
      />
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="relative mt-8 overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-amber-500/[0.04] p-6 sm:p-8 lg:p-10">
          ...
          <div className="relative">
            ...
            >
              ...
              {tr('rev.texts.common.back_to_text').replace('{text}', 'Romeo and Juliet')}
            </Button>
            ...
            <h1 className="text-display-sm font-heading text-foreground sm:text-display">
              {tr('rev.texts.rj.themes.h1')}
            </h1>
            <p className="mt-2 text-body-lg text-muted-foreground">{tr('rev.texts.rj.byline')}</p>
            <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
              {tr('rev.texts.rj.themes.intro')}
            </p>
          </div>
        </section>
                  ...
                  <CardContent className="p-5">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-sm font-semibold text-foreground">
                        {tr('rev.texts.common.context_link')}
                      </p>
                    </div>
        ...
        <p className="text-xs text-muted-foreground mt-8 border-t border-border/60 pt-4">
          {tr('rev.texts.rj.public_domain_note')}
        </p>
      </div>
    </div>
  )
