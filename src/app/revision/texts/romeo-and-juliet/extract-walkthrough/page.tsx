...
const PROLOGUE_LINES: { number: string; line: string; analysis: string }[] = [
  ...
  },
  {
    ...
    analysis:
      'The line\'s power comes from a pun on the word "civil," which Shakespeare uses with brutal ambiguity. "Civil" first means citizens of the same city, then suggests civility (the very thing the feud destroys), and finally implies civil war - Veronese killing Veronese. The balanced repetition ("civil blood... civil hands") makes the violence feel mathematically inevitable. "Unclean" carries Biblical weight, hinting at moral and religious pollution that only sacrifice can wash away.',
  },
  {
    number: '5-6',
...
const FORM_NOTES: { title: string; body: string }[] = [
  ...
  {
    title: 'The pun on "civil"',
    body: '"Civil blood makes civil hands unclean" is the prologue\'s most quoted line because of how Shakespeare loads the word "civil" with three simultaneous meanings: of the same city, civilised, and civil-war. The pun turns a single adjective into a moral indictment. The Veronese are killing their fellow citizens (civil blood), violating the very civilisation they claim to embody (civil hands), and turning the city into a war zone (civil war).',
  },
  {
