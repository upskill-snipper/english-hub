...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      'https://theenglishhub.app/revision/texts/great-expectations/themes',
  },
}
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-amber-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            Six major themes analysed in detail, with linked quotations, key
            moments and exam-focused guidance for AQA English Literature.
          </p>
        </div>
      </section>
            ...
            <CardContent className="space-y-6 p-6 sm:p-8">
              ...
              <div className="space-y-3">
                ...
                {theme.linkedQuotes.map((q, i) => (
                  ...
                  >
                    <p className="mb-1 text-body-sm font-medium italic text-foreground">
                      {q.text}
                    </p>
