...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      'https://theenglishhub.app/revision/texts/great-expectations/characters',
  },
}
    ...
    keyQuotes: [
      {
        ...
        context: 'After his first visit to Satis House — Pip begins to see himself through Estella\'s eyes and internalises class shame.',
      },
      {
        text: '"It is a most miserable thing to feel ashamed of home."',
        context: 'Pip\'s retrospective honesty: the adult narrator judges his younger self, showing that self-awareness is the first step to moral recovery.',
      },
    ],
    examFocus:
    ...
    keyQuotes: [
      {
        ...
        context: 'Estella\'s self-awareness is itself tragic: she knows she has been damaged but cannot undo the damage.',
      },
      {
        ...
        context: 'The revised ending — Estella acknowledges her transformation through pain, mirroring Pip\'s own moral education.',
      },
    ],
    examFocus:
    ...
    keyQuotes: [
      {
        ...
        context: 'Miss Havisham\'s instruction to Estella reveals her as a manipulator who has weaponised a child.',
      },
      {
        text: '"What have I done! What have I done!"',
        context: 'Her moment of agonised self-recognition when she realises she has destroyed Estella\'s capacity for love.',
      },
    ],
    examFocus:
    ...
    keyQuotes: [
      {
        ...
        context: 'The revelation scene — Magwitch\'s pride and non-standard grammar expose the arbitrary nature of class distinctions.',
      },
      {
        ...
        context: 'Magwitch treats Pip as a living trophy, revealing both his devotion and the problematic nature of his project.',
      },
    ],
    examFocus:
    ...
    keyQuotes: [
      {
        ...
        context: 'Joe uses the language of his trade to express a profound truth about social division, accepting it without bitterness.',
      },
      {
        text: '"Which I meantersay, Pip, as I would in preference have carried you there."',
        context: 'After nursing Pip back to health, Joe\'s quiet devotion — he would have carried Pip bodily — demonstrates love without conditions.',
      },
    ],
    examFocus:
    ...
    keyQuotes: [
      {
        ...
        context: 'Herbert\'s gentle concern for Pip after the revelation about Magwitch — his friendship is constant regardless of Pip\'s changing circumstances.',
      },
      {
        text: '"A gentleman must not be too ready with his fists."',
        context: 'Herbert teaches Pip social graces without condescension — a genuine act of friendship that contrasts with Estella\'s humiliation.',
      },
    ],
    examFocus:
    ...
    keyQuotes: [
      {
        ...
        context: 'Jaggers\'s philosophy of life — rational, evidence-based, emotionally detached — reflects his role as a man who has seen too much human weakness to trust appearances.',
      },
      {
        ...
        context: 'Jaggers obliquely describes Magwitch\'s world and justifies his decision to place Estella with Miss Havisham — a rare moment of compassion disguised as legal hypothetical.',
      },
    ],
    examFocus:
    ...
    keyQuotes: [
      {
        ...
        context: 'Wemmick\'s defining principle — the enforced separation of public and private selves that Dickens sees as a symptom of modern life.',
      },
      {
        text: '"Walworth sentiments. Get hold of portable property."',
        context: 'Wemmick\'s practical advice — his "Walworth sentiments" are always more humane than his office pronouncements.',
      },
    ],
    examFocus:
    ...
    keyQuotes: [
      {
        ...
        context: 'Biddy cuts to the heart of Pip\'s motivation with one question, exposing that his ambition is driven by Estella rather than genuine self-improvement.',
      },
      {
        text: '"I am not angry, but I am hurt."',
        context: 'When Pip condescends to her, Biddy responds with quiet dignity that shames him more than anger would.',
      },
    ],
    examFocus:
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-emerald-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            Detailed profiles of nine key characters covering their role,
            development, key quotations and exam focus points.
          </p>
        </div>
      </section>
