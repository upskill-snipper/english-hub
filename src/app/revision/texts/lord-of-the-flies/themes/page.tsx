    ...
    keyQuotes: [
      {
        ...
        speaker: 'Jack -- Ch. 1',
        relevance: 'Jack\'s claim rests on institutional rank, which becomes meaningless on the island.',
      },
      {
        text: '"Which is better -- law and rescue, or hunting and breaking things up?"',
        speaker: 'Piggy -- Ch. 11',
        relevance: 'Piggy frames the central political question, but reason cannot compete with force.',
      },
      {
  ...
  },
  {
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        relevance: 'Cruelty begins as play; the "taboo of the old life" is the only thing preventing worse.',
      },
      {
        text: '"Kill the beast! Cut his throat! Spill his blood!"',
        speaker: 'The boys -- Ch. 9',
        relevance: 'The chant that accompanies Simon\'s murder, where play-acting becomes real killing.',
      },
    ],
    writersMethods: [
  ...
  },
  {
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        relevance: 'The pig\'s head confirms Simon\'s insight: the beast cannot be destroyed because it lives inside them.',
      },
      {
    ...
    <div className="space-y-10 pb-16">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-amber-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            ...
            innocence and fear -- plus the four central symbols: the conch, the signal fire,
      ...
      <section>
        ...
        <p className="mb-6 text-body-sm text-muted-foreground max-w-2xl">
          Golding threads four central symbols through the novel. Each evolves across the
          twelve chapters, gaining and losing meaning as civilisation rises and falls.
        </p>
      </section>
        ...
        <section key={sym.name} id={sym.name.toLowerCase().replace(/[^a-z0-9]+/g, '-')}>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-2 text-body-sm text-muted-foreground">
                <p className="text-sm font-semibold text-foreground mb-2">Development through the novel</p>
