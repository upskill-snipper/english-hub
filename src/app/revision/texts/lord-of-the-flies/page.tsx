...
export const metadata: Metadata = {
  openGraph: {
    ...
    images: [
      {
        url: '/api/og?title=Lord+of+the+Flies+revision+guide+-+themes%2C+characters%2C+key+quotes+-+The+English+Hub',
        width: 1200,
        height: 630,
        alt: 'Lord of the Flies revision guide - themes, characters, key quotes - The English Hub',
      },
    ],
  },
  ...
  return (
    <>
      ...
      <LearningResourceJsonLd
        name="Lord of the Flies revision guide"
        description="GCSE-aligned study guide for Golding's Lord of the Flies, covering plot, characters, themes, key quotations, historical context and exam essay plans."
