...
export const metadata: Metadata = {
  openGraph: {
    ...
    images: [
      {
        url: '/api/og?title=The+Tempest+revision+guide+-+themes%2C+characters%2C+key+quotes+-+The+English+Hub',
        width: 1200,
        height: 630,
        alt: 'The Tempest revision guide - themes, characters, key quotes - The English Hub',
      },
    ],
  },
