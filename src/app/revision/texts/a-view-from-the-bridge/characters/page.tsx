...
export const metadata: Metadata = {
  ...
  description:
    'In-depth character analysis for A View from the Bridge by Arthur Miller: Eddie Carbone, Beatrice, Catherine, Marco, Rodolpho and Alfieri.',
  alternates: {
    canonical: 'https://theenglishhub.app/revision/texts/a-view-from-the-bridge/characters',
  },
}
...
const CHARACTERS: CharacterProfile[] = [
  ...
  },
  {
    ...
    keyQuotes: [
      ...
      {
        text: '"That one! He killed my children!"',
        context: 'Act 2 - public accusation of Eddie',
        analysis:
          'Marco publicly names Eddie as the informer who destroyed his family. Miller frames the line as a formal denunciation within the Sicilian honour code, turning private grievance into communal verdict.',
      },
    ],
    examTip:
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Characters',
            url: 'https://theenglishhub.app/revision/texts/a-view-from-the-bridge/characters',
          },
        ]}
      />
