...
const chapters: ChapterAnalysis[] = [
  ...
  },
  {
    ...
    keyQuotes: [
      ...
      {
        quote: '"Laws and principles are not for the times when there is no temptation... they have a worth -- so I have always believed; and if I cannot believe it now, it is because I am insane -- quite insane."',
        analysis:
  ...
  },
  {
    ...
    keyQuotes: [
      {
        quote: '"I was no longer the same individual: I had become another person... I felt myself another woman."',
        analysis:
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-emerald-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            Detailed analysis of the most important chapters for your GCSE exam.
            Each entry covers significance, key events, quotations with analysis,
            and an exam-focused study tip.
          </p>
        </div>
      </section>
