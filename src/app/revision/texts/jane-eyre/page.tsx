...
export const metadata: Metadata = {
  openGraph: {
    ...
    images: [
      {
        url: '/api/og?title=Jane+Eyre+revision+guide+-+themes%2C+characters%2C+key+quotes',
        width: 1200,
        height: 630,
        alt: 'Jane Eyre revision guide - themes, characters, key quotes',
      },
    ],
  },
  title: 'Jane Eyre revision guide - themes, characters, key quotes',
    ...
    <>
      ...
      <p className="text-xs text-muted-foreground mt-8 border-t border-border/60 pt-4">
        {(await t('rev.textgrp4.common.public_domain'))
          ...
          .replace('{author}', 'Charlotte Brontë')
          .replace('{year}', '1847')}
      </p>
    </>
  )
