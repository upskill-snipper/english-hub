  ...
  quotations: [
    {
      ...
      analysis: "The novel\u2019s unsettling first line. Harri\u2019s flat, almost clinical tone is both childlike and already traumatised, and the short declarative sentences set the register for the whole book.",
    },
    {
      quote: '"Asweh, it was brutal."',
      who: 'Harri \u2014 recurring',
      analysis: "\u2018Asweh\u2019 (I swear) is Harri\u2019s signature Ghanaian interjection and anchors his voice throughout the novel. Paired with the street-English \u2018brutal\u2019 it shows how his vocabulary is constantly code-switching between home and London.",
    },
    {
      quote: '"Hutious means scary, in case you didn\'t know."',
      who: 'Harri \u2014 passim',
      analysis: "Kelman lets Harri define his own slang on the page, turning the reader into a pupil. Vocabulary becomes an act of identity and a small assertion of power over a world that keeps trying to define him.",
    },
    {
      quote: '"The dead boy\'s mother wouldn\'t stop crying."',
      who: 'Harri \u2014 early chapters',
      analysis: "The victim is never named, only \u2018the dead boy\u2019. Calling his mother into the sentence gives the murder its adult weight while keeping the child narrator\u2019s perspective intact.",
    },
    {
      quote: '"I just wanted to help."',
      who: 'Harri \u2014 throughout',
      analysis: "Harri\u2019s motivation, stated simply and repeatedly. Kelman insists on honouring it rather than mocking it, and the line acquires a tragic weight by the final chapters.",
    },
    {
      quote: '"I\'m not even scared, I promise."',
      who: 'Harri \u2014 late in the novel',
      analysis: "A reassurance Harri offers himself more than the reader. The repetition has the opposite of its intended effect, intensifying the reader\u2019s sense of his vulnerability.",
    },
    {
      quote: '"I love everybody in my family, even the ones I don\'t know yet."',
      who: 'Harri \u2014 middle chapters',
      analysis: "The moral centre of the novel. Harri\u2019s capacity for love extends to his unborn siblings and distant relatives, and the reader\u2019s grief at the ending is grounded in lines like this.",
    },
    {
      quote: '"Me and Dean are blood brothers now."',
      who: 'Harri \u2014 on the \u2018blood brothers\u2019 ritual',
      analysis: "The boys\u2019 childish ceremony of mingling blood to seal their friendship acquires a darker significance in a book where blood is always also the sign of violence.",
    },
    {
      quote: '"You have to pick a side. That\'s the rules."',
      who: 'Dell Farm Crew member \u2014 reported by Harri',
      analysis: "The estate\u2019s logic in a single line. The Crew\u2019s \u2018rules\u2019 mimic the playground but carry adult consequences, and Harri\u2019s attempt to stay outside them is ultimately what endangers him.",
    },
    {
      quote: '"Mamma prays louder than anybody."',
      who: 'Harri \u2014 on his mother',
      analysis: "Captures Mamma\u2019s evangelical faith and the family\u2019s moral vocabulary. Prayer in the novel is both comfort and performance, and Harri records it with affectionate precision.",
    },
    {
      quote: '"The pigeon was watching me. He knew everything."',
      who: 'Harri \u2014 balcony scene',
      analysis: "Harri\u2019s tendency to give the pigeon an inner life prepares the reader for the italicised pigeon interludes and deepens the novel\u2019s gentle suggestion that the bird is more than a bird.",
    },
    {
      quote: '"Advantage!"',
      who: 'Harri \u2014 recurring exclamation',
      analysis: "Harri\u2019s word for anything good or lucky. It functions almost as a charm: saying it is a small ritual of hope in a world that keeps offering him its opposite.",
    },
    {
      quote: '"Lydia said I had to stop asking questions."',
      who: 'Harri \u2014 after a warning from his sister',
      analysis: "Lydia\u2019s protectiveness surfaces whenever Harri\u2019s investigation edges too close to real danger. Her frustration with him is a form of love and a marker of how much more she understands.",
    },
    {
      quote: '"In Ghana we don\'t do it like that."',
      who: 'Harri \u2014 recurring',
      analysis: "Harri\u2019s running comparisons between Ghana and London keep the diaspora alive in the text. The line is never nostalgic; it is a child\u2019s attempt to triangulate a new world against a remembered one.",
    },
    {
      quote: '"I ran as fast as I could. I\'m the fastest in Year 7."',
      who: 'Harri \u2014 throughout',
      analysis: "Speed is Harri\u2019s defining pride and one of his few forms of power. Kelman uses running as both a literal event and a motif, and the motif takes on a painful weight in the final chapters.",
    },
    {
      quote: '"They said if you grass you\'re dead."',
      who: 'Harri \u2014 reporting playground lore',
      analysis: "The Crew\u2019s code of silence, filtered through Harri\u2019s matter-of-fact reporting. The gap between the flatness of the delivery and the enormity of the threat is characteristic of the whole novel.",
    },
    {
      quote: '"The wind picked me up and I flew."',
      who: 'The pigeon \u2014 closing interlude',
      analysis: "The pigeon\u2019s italicised voice offers a cool, elevated counterpoint to Harri\u2019s breathless narration. Readers variously read the bird as witness, soul or guardian, and the ambiguity is deliberate.",
    },
    {
      quote: '"He was my friend, even if he didn\'t know it yet."',
      who: 'Harri \u2014 on a classmate',
      analysis: "Harri\u2019s generosity of feeling extends even to children who have not yet agreed to be his friends. Lines like this build the ethical pressure of the ending.",
    },
  ],
}
