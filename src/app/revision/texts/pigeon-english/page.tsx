...
export const metadata: Metadata = {
  openGraph: {
    title: 'Pigeon English GCSE revision - themes, characters, quotes',
    description: 'Pigeon English GCSE revision - Stephen Kelman',
    images: [
      {
        url: '/api/og?title=Pigeon+English+GCSE+revision+-+themes%2C+characters%2C+quotes',
        width: 1200,
        height: 630,
        alt: 'Pigeon English GCSE revision - themes, characters, quotes',
      },
    ],
  },
  title: 'Pigeon English GCSE revision - themes, characters, quotes',
