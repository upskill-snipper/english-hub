...
export const metadata: Metadata = {
  ...
  description:
    'In-depth study guide for The Curious Incident of the Dog in the Night-Time by Mark Haddon (2003): plot, characters, themes, context and key quotations for Edexcel IGCSE and other boards.',
  alternates: {
...
const data: TextGuideData = {
  ...
  quotations: [
    {
      quote: '"It was 7 minutes after midnight. The dog was lying on the grass in the middle of the lawn in front of Mrs Shears\u2019 house."',
      who: 'Christopher — Chapter 2 (opening)',
      analysis: "The novel\u2019s opening sentence establishes Christopher\u2019s precision with time, his noticing of exact detail and the flat, affectless tone that the book will sustain. It is also a sly opening for a detective novel: a body on a lawn.",
    },
    {
      quote: '"I find people confusing."',
      who: 'Christopher — early chapters',
      analysis: "A quietly devastating thesis statement. Christopher states his central difficulty in one sentence and the novel then spends 226 chapters showing what living that difficulty actually means.",
    },
    {
      quote: '"I do not tell lies."',
      who: 'Christopher',
      analysis: "Christopher\u2019s absolute honesty is both a moral stance and a plot device: it means every lie he uncovers in other people will count. It also makes his running away from his father an unusually serious decision.",
    },
    {
      ...
      who: 'Christopher',
      analysis: "Christopher\u2019s defence of the prime-numbered chapters and of his own way of thinking. The sentence explains both a formal feature of the book and the theme of order-within-chaos.",
    },
    {
      quote: '"Mother had died 2 years ago."',
      who: 'Christopher',
      analysis: "A flat, declarative line whose later falsification is the hinge of the novel. Haddon uses Christopher\u2019s plain style to deliver the central lie without commentary.",
    },
    {
      quote: '"I like dogs. You always know what a dog is thinking."',
      who: 'Christopher',
      analysis: "Sets up the moral logic behind Christopher\u2019s preference for animals over people and foreshadows the grief of Wellington\u2019s death.",
    },
    {
      quote: '"I see everything."',
      who: 'Christopher',
      analysis: "Christopher\u2019s claim that he notices more than other people do, illustrated by a long list of details from a field. The novel reframes difference as a kind of perceptual power rather than a deficit.",
    },
    {
      quote: '"This will not be a funny book. I cannot tell jokes because I do not understand them."',
      who: 'Christopher',
      analysis: "A meta-comment on the book\u2019s own tone and on Christopher\u2019s relationship to language. In practice the novel is often funny, but only because Christopher\u2019s literal readings of the adult world keep exposing its absurdities.",
    },
    {
      quote: '"Your mother was not a very good mother, Christopher."',
      who: 'Ed',
      analysis: "Part of Ed\u2019s attempt to justify the years of silence about Judy. The line is both a lie (by omission) and a symptom of the hurt that produced the larger lie that she was dead.",
    },
    {
      quote: '"I killed Wellington, Christopher."',
      who: 'Ed',
      analysis: "The confession that breaks the novel in half. Everything after this point is about what Christopher does with a truth he cannot accept.",
    },
    {
      quote: '"Dad had murdered Wellington. That meant he could murder me."',
      who: 'Christopher',
      analysis: "Christopher\u2019s logic is watertight and terrifying. Haddon uses this line to show that strict honesty, applied without nuance, can lead to decisions that an adult would soften \u2014 but also that Christopher\u2019s fear is not irrational.",
    },
    {
      quote: '"I was going to have to go and live with Mother."',
      who: 'Christopher',
      analysis: "The decision to run to London, stated with the same flatness as every other fact in the book. Haddon lets the emotional weight come from the reader rather than from Christopher\u2019s prose.",
    },
    {
      quote: '"Being frightened is like when you suddenly wake up in the dark and you think that there is someone in the room with you."',
      who: 'Christopher — during the London journey',
      analysis: "One of the rare moments when Christopher attempts a simile for an emotion. Its clumsiness is moving, and it marks how hard he is working to describe his own fear on the train.",
    },
    {
      quote: '"I hadn\u2019t been on the underground before."',
      who: 'Christopher',
      analysis: "Understatement doing a lot of work. The Underground sequence \u2014 sensory overload, lost rat, near-fall onto the tracks \u2014 is one of the most tense passages in the book, and Haddon introduces it with a sentence a child might write.",
    },
    {
      quote: '"She put her arms round me and said, \u2018Christopher, Christopher, Christopher\u2019."',
      who: 'Judy — arrival in Willesden',
      analysis: "The repetition of the name carries the reunion; Christopher, who cannot bear being touched, accepts the embrace. Haddon trusts the scene without sentimentalising it.",
    },
    {
      quote: '"I got an A grade."',
      who: 'Christopher — A Level Maths result',
      analysis: "The short, declarative sentence lands with extraordinary force. Christopher has wanted to prove that he is not stupid, and he has done it. The book\u2019s quietest triumph.",
    },
    {
      ...
      analysis: "The novel\u2019s last sentence. Haddon ends on a conditional triumph: Christopher states what his achievements mean to him without the narrative confirming or denying the claim. The conditional hope is part of the book\u2019s honesty.",
    },
    {
      quote: '"Dad said, \u2018Christopher, do you understand that I love you?\u2019"',
      who: 'Ed — late in the novel',
      analysis: "A sentence that would be unremarkable in another novel is extraordinary here, because it is a direct question from a father who is trying to rebuild trust through language Christopher can parse.",
    },
  ],
}
...
export default async function CuriousIncidentPage() {
  ...
  return (
    <>
      ...
      <StudyTools textName="The Curious Incident of the Dog in the Night-Time" textType="novel" examBoard="Edexcel IGCSE" />
      <TextGuide data={data} />
