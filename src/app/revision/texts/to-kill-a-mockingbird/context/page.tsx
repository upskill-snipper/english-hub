...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      'https://theenglishhub.app/revision/texts/to-kill-a-mockingbird/context',
  },
}
...
const SECTIONS: ContextSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Lee includes a lynch mob scene (Chapter 15) and a lynching threat (Curley\'s wife-style, from Mayella\'s world to Tom\'s). The mob that gathers outside the jail is dispersed only by Scout\'s innocent conversation with Mr Cunningham. Lee uses this scene to show that ordinary, decent people can participate in collective violence — and that breaking the anonymity of the mob is the only way to stop them.',
    ],
    keyLink:
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Context", url: "https://theenglishhub.app/revision/texts/to-kill-a-mockingbird/context" },
        ]}
      />
      {/* Hero */}
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-blue-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            The essential background you need for the exam: 1930s Alabama, Jim Crow laws,
            the Great Depression, Harper Lee&apos;s life and the Scottsboro Boys trial.
          </p>
        </div>
      </section>
