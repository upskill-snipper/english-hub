...
export const metadata: Metadata = {
  ...
  description:
    'In-depth character analysis for To Kill a Mockingbird by Harper Lee: Scout, Atticus, Jem, Boo Radley, Tom Robinson, Bob Ewell, Calpurnia, Miss Maudie and Dill.',
  alternates: {
    canonical: 'https://theenglishhub.app/revision/texts/to-kill-a-mockingbird/characters',
  },
}
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Characters',
            url: 'https://theenglishhub.app/revision/texts/to-kill-a-mockingbird/characters',
          },
        ]}
      />
      {/* Hero */}
