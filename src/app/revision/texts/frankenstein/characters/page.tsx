...
const CHARACTERS: CharacterStudy[] = [
  ...
  },
  {
    ...
    keyQuotes: [
      ...
      {
        quote: 'Of my creation and creator I was absolutely ignorant, but I knew that I possessed no money, no friends, no kind of property. I was, besides, endued with a figure hideously deformed and loathsome.',
  ...
  },
  {
    ...
    keyQuotes: [
      {
        quote: 'He was a boy of singular talent and fancy... deeply read in books of chivalry and romance... he composed heroic songs and began to write many a tale of enchantment and knightly adventure.',
  ...
  },
  {
    ...
    keyQuotes: [
      {
        quote: 'The more I saw of them, the greater became my desire to claim their protection and kindness; my heart yearned to be known and loved by these amiable creatures.',
      ...
      {
        quote: 'Felix darted forward, and with supernatural force tore me from his father, to whose knees I clung; in a transport of fury, he dashed me to the ground and struck me violently with a stick.',
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Characters", url: "https://theenglishhub.app/revision/texts/frankenstein/characters" },
        ]}
      />
      {/* Hero */}
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-emerald-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            Detailed analysis of every major character with key quotations, contextual
            links, and exam tips for top-grade responses.
          </p>
        </div>
      </section>
