...
export const metadata: Metadata = {
  openGraph: {
    ...
    images: [
      {
        url: '/api/og?title=Frankenstein+revision+guide+-+themes%2C+characters%2C+key+quotes+-+The+English+Hub',
        width: 1200,
        height: 630,
        alt: 'Frankenstein revision guide - themes, characters, key quotes - The English Hub',
      },
    ],
  },
...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    id: 'fr-1',
    question: 'Who is the frame narrator of Frankenstein?',
    type: 'multiple-choice',
    options: ['Victor Frankenstein', 'The Creature', 'Robert Walton', 'Henry Clerval'],
    correctIndex: 2,
    explanation:
      'Captain Robert Walton writes letters to his sister from a ship trapped in Arctic ice. He rescues Victor and records his story, providing the frame narrative that contains the entire novel.',
    topic: 'Characters',
    difficulty: 'foundation',
  },
  {
    id: 'fr-2',
    question: 'Where does Victor create the Creature?',
    type: 'multiple-choice',
    options: ['Geneva', 'London', 'The University of Ingolstadt', 'The Arctic'],
    correctIndex: 2,
    explanation:
      'Victor creates the Creature while studying at the University of Ingolstadt in Germany, working alone in his laboratory, isolating himself from family and friends.',
    topic: 'Plot',
    difficulty: 'foundation',
  },
  {
  ...
  {
    id: 'fr-4',
    question: 'Who is the first person the Creature kills?',
    type: 'multiple-choice',
    options: ['Henry Clerval', 'Elizabeth', 'William Frankenstein', 'Justine Moritz'],
    correctIndex: 2,
    explanation:
      "The Creature murders Victor's younger brother William. The innocent servant Justine Moritz is then wrongly convicted and executed for the crime, doubling the injustice.",
    topic: 'Plot',
    difficulty: 'foundation',
  },
  {
    id: 'fr-5',
    question: 'What does the Creature demand that Victor create for him?',
    type: 'multiple-choice',
  ...
  {
    id: 'fr-6',
    question: "What is the novel's subtitle?",
    type: 'multiple-choice',
    options: ['The Gothic Horror', 'The Modern Prometheus', 'The Last Man', 'The Fallen Angel'],
    correctIndex: 1,
    explanation:
      'The subtitle "The Modern Prometheus" connects Victor to the Greek Titan who stole fire from the gods and was punished for eternity. It frames scientific ambition as divine transgression with terrible consequences.',
    topic: 'Context',
    difficulty: 'foundation',
  },
  {
    ...
    type: 'multiple-choice',
    options: ['Fifteen', 'Eighteen', 'Twenty-five', 'Thirty'],
    correctIndex: 1,
    explanation:
      'Shelley was just eighteen when she wrote Frankenstein during the famous 1816 "ghost story" competition at the Villa Diodati near Lake Geneva. It was published anonymously in 1818.',
    topic: 'Context',
    difficulty: 'foundation',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "The Creature uses Milton's Paradise Lost to articulate his abandonment. He should have been loved as a first creation (like Adam) but has been cast out and rejected like Satan.",
    topic: 'Characters',
    difficulty: 'foundation',
  },
  {
    id: 'fr-9',
    question:
      'What is the Creature\'s key argument in "I was benevolent and good; misery made me a fiend"?',
    type: 'multiple-choice',
    options: [
      'He was always evil',
    ...
    correctIndex: 1,
    explanation:
      "This single sentence articulates the novel's nature-versus-nurture argument. The Creature was born innocent and became violent only after repeated rejection, arguing that environment, not innate character, shapes moral development.",
    topic: 'Themes',
    difficulty: 'higher',
  },
  {
    id: 'fr-10',
    question: 'How does Victor mirror Robert Walton?',
    type: 'multiple-choice',
    options: [
      'They look similar',
  ...
  {
    id: 'fr-11',
    question: "What role do the De Lacey family play in the Creature's story?",
    type: 'multiple-choice',
    options: [
      'They adopt the Creature',
      'He secretly observes them, learning language and humanity, but they reject him when he reveals himself',
      'They help him find Victor',
      'They are villains',
    ],
    correctIndex: 1,
    explanation:
      'The Creature educates himself by observing the De Laceys, learning to speak and read. When he reveals himself to the blind father, the sighted family members are horrified and drive him away, crushing his last hope for acceptance.',
    topic: 'Plot',
    difficulty: 'higher',
  },
  {
    id: 'fr-12',
    question: "What happens on Victor's wedding night?",
    type: 'multiple-choice',
    options: [
      'Victor and Elizabeth escape',
      'The Creature murders Elizabeth, fulfilling his threat',
      'The Creature forgives Victor',
  ...
  {
    id: 'fr-13',
    question: "How does Shelley use the novel's nested narrative structure?",
    type: 'multiple-choice',
    options: [
      'It is confusing and unnecessary',
      'Three narrators (Walton, Victor, Creature) create layers that force the reader to judge reliability and empathy',
      'There is only one narrator',
      'Each narrator tells the same story',
    ],
    correctIndex: 1,
    explanation:
      "The nested structure (Walton frames Victor's story, which contains the Creature's story) creates layers of perspective. The reader must judge each narrator's reliability, and placing the Creature's sympathetic account at the centre forces engagement with his humanity.",
    topic: "Writer's Methods",
    difficulty: 'higher',
  },
  {
    id: 'fr-14',
    question: "What scientific context influenced Shelley's novel?",
    type: 'multiple-choice',
    options: [
      'Space exploration',
      "Luigi Galvani's experiments with electricity on dead tissue and debates about reanimation",
      'Nuclear physics',
      'The telephone',
    ],
    correctIndex: 1,
    explanation:
      'The novel was influenced by Galvani\'s work on "animal electricity" and public demonstrations of applying electrical current to corpses. These experiments raised genuine questions about the nature of life and whether science could reanimate the dead.',
    topic: 'Context',
    difficulty: 'higher',
  },
  {
    id: 'fr-15',
    question: 'Why does Victor refuse to complete the female creature?',
    type: 'multiple-choice',
    options: [
    ...
    correctIndex: 1,
    explanation:
      "Victor fears the female creature might breed, creating a race of monsters, or that she might reject the male Creature. His decision to destroy her triggers the Creature's final vengeance, but also reflects genuine ethical concern about uncontrolled creation.",
    topic: 'Plot',
    difficulty: 'higher',
  },
  {
    id: 'fr-16',
    question: 'What does the Creature mean by "If I cannot inspire love, I will cause fear"?',
    type: 'multiple-choice',
    options: [
      'He wants to be a leader',
      'Denied all affection, he turns to terror as the only form of power available to him',
      'He is joking',
      'He wants to act in horror plays',
    ],
    correctIndex: 1,
    explanation:
      'The Creature turns to terror as the only form of power available to someone denied all affection. This line captures the tragic trajectory from innocent being to vengeful monster, showing how rejection creates the very monster society feared.',
    topic: 'Themes',
    difficulty: 'higher',
  },
  {
    id: 'fr-17',
    question: 'How does Frankenstein critique the Romantic ideal of the solitary genius?',
    type: 'multiple-choice',
    options: [
      'It celebrates it',
      "Victor's isolation in pursuit of knowledge leads to catastrophe, showing that the solitary genius is reckless, not heroic",
      'It does not address Romanticism',
      'It presents solitude as ideal',
    ],
    correctIndex: 1,
    explanation:
      'Victor embodies the Romantic ideal of the solitary genius pursuing sublime knowledge, but Shelley shows this isolation as reckless and destructive. By cutting himself off from family and ethical guidance, Victor creates a disaster. The novel critiques both Romantic individualism and Enlightenment faith in pure reason.',
    topic: 'Context',
    difficulty: 'grade-9',
  },
  {
    id: 'fr-18',
    question: "How does Shelley use the Arctic setting to reinforce the novel's themes?",
    type: 'multiple-choice',
    options: [
      'It is just a backdrop',
      "The frozen, desolate landscape mirrors both Victor's and Walton's dangerous isolation and ambition pushed to its extremes",
      'It provides a warm setting',
      'It represents hope',
    ],
    correctIndex: 1,
    explanation:
  ...
  {
    id: 'fr-19',
    question: 'Who is the true "monster" in the novel?',
    type: 'multiple-choice',
    options: [
      'The Creature alone',
      'Victor alone',
    ...
    correctIndex: 2,
    explanation:
      'Shelley deliberately blurs the line between creator and creation. Victor calls the Creature a "wretch" and "monster," but Victor\'s own abandonment, irresponsibility, and obsession are arguably more monstrous. The novel forces the reader to question assumptions about who deserves the label.',
    topic: 'Themes',
    difficulty: 'grade-9',
  },
  {
    id: 'fr-20',
    question: 'What is the significance of the Creature reading Paradise Lost?',
    type: 'multiple-choice',
    options: [
      'It shows he can read',
      'It provides a framework for understanding his relationship with Victor as a failed God-Adam relationship',
      'It is just a detail',
      'It inspires him to be good',
    ],
    correctIndex: 1,
    explanation:
      "Milton's Paradise Lost gives the Creature a framework for his existence. He identifies with Adam (abandoned by his creator) and Satan (cast out and driven to evil). This literary allusion elevates the Creature's suffering to a mythic, theological level and deepens the novel's exploration of creation and responsibility.",
    topic: "Writer's Methods",
    difficulty: 'grade-9',
  },
]
...
const REVISION_TOPICS = [
  {
    topic: 'Ambition and Hubris',
    summary:
      "Victor's relentless pursuit of forbidden knowledge leads to catastrophe, echoing the Prometheus myth.",
    keyPoints: [
  ...
  {
    topic: 'Creation and Responsibility',
    summary: 'The central moral question: does a creator owe duties to their creation?',
    keyPoints: [
      'Victor abandons the Creature at birth',
      'Every subsequent tragedy flows from that act of irresponsibility',
      "The Creature's plea for a companion is a request for basic care",
      'Victor destroys the female creature, breaking his promise',
      'Shelley argues that creating life carries absolute obligation',
    ],
  },
  {
    topic: 'Isolation and Loneliness',
    summary:
      'Both Victor and the Creature suffer from profound isolation that drives them towards destruction.',
    keyPoints: [
      'Victor cuts himself off from family to pursue his work',
      'The Creature is denied any human connection at all',
      'Loneliness is shown as morally corrosive',
      "The De Laceys' rejection is the Creature's last hope",
      'The Arctic setting mirrors their emotional desolation',
    ],
  },
  {
    topic: 'Nature vs Nurture',
    summary: 'The Creature is born innocent and becomes violent only after repeated rejection.',
    keyPoints: [
      '"I was benevolent and good; misery made me a fiend"',
      'The Creature educates himself through observation',
      'His eloquence challenges the idea that he is a mere brute',
      "Society's rejection creates the monster it fears",
      'Shelley argues environment shapes moral development',
    ],
  },
  {
    topic: 'Science and Ethics',
    summary:
      'The novel asks what happens when scientific knowledge outstrips moral responsibility.',
    keyPoints: [
      "Influenced by Galvani's experiments with electricity",
      'Victor never pauses to consider ethical implications',
      'Science without conscience is presented as monstrous',
      'The novel anticipates modern debates about genetic engineering and AI',
      'Shelley wrote during the Romantic critique of pure Enlightenment rationalism',
    ],
  },
]
