...
const ESSAY_PLANS: EssayPlan[] = [
  {
    question:
      'How does Shelley present the theme of creation and responsibility in Frankenstein?',
    introduction:
    ...
    paragraphs: [
      {
        pointLabel: 'Paragraph 1',
        point:
          'The Creature is born innocent, undermining the idea that monstrosity is inherent.',
        quote:
      ...
      },
      {
        ...
        quoteSource: 'Victor -- Chapter 24',
        analysis:
          'Victor describes himself in language that is indistinguishable from the Creature\'s: excess, despair, the suppression of feeling. The verb "riot" suggests uncontrolled, self-destructive behaviour. Shelley uses the technique of mirroring to show that monstrosity is relational, not fixed: Victor and the Creature have made each other monstrous through the cycle of abandonment, rejection, and revenge. The reader can no longer identify which one is "the monster."',
        contextLink:
  ...
  {
    question:
      'How does Shelley present isolation in Frankenstein?',
    introduction:
    ...
    paragraphs: [
      {
        pointLabel: 'Paragraph 1',
        point:
          'Victor\'s self-imposed isolation during the creation destroys his moral compass.',
        quote:
  ...
  {
    question:
      'How does Shelley present ambition as dangerous in Frankenstein?',
    introduction:
    ...
    paragraphs: [
      ...
      },
      {
        pointLabel: 'Paragraph 2',
        point:
          'Ambition isolates Victor from the people who could have tempered his obsession.',
        quote:
  ...
  {
    question:
      'To what extent is the Creature presented as a sympathetic figure in Frankenstein?',
    introduction:
    ...
    paragraphs: [
      ...
      },
      {
        ...
        quoteSource: 'The Creature -- Chapter 20',
        analysis:
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Essay Plans", url: "https://theenglishhub.app/revision/texts/frankenstein/essay-plans" },
        ]}
      />
      {/* Hero */}
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-blue-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            Five exam-ready essay plans with introductions, three-paragraph structures,
            embedded quotations, analysis, context, and conclusions.
          </p>
        </div>
      </section>
          ...
          <CardContent className="p-6">
            ...
            <ul className="space-y-2 text-body-sm text-muted-foreground">
              <li className="flex gap-2">
                ...
                <span>
                  Use short, embedded quotations rather than long block quotes. Weave them into
                  your sentences so they feel like natural evidence, not add-ons.
                </span>
              </li>
              <li className="flex gap-2">
                <span className="mt-1.5 block size-1.5 shrink-0 rounded-full bg-amber-400" />
                <span>
                  ...
                  uses,&rdquo; not &ldquo;the book says.&rdquo; This shows awareness of
                  authorial intent.
                </span>
              </li>
              <li className="flex gap-2">
                <span className="mt-1.5 block size-1.5 shrink-0 rounded-full bg-amber-400" />
                <span>
                  Context should support your argument, not replace it. A brief sentence
                  linking a quotation to Shelley&apos;s life or the Romantic period is more
                  effective than a paragraph of background information.
                </span>
              </li>
              <li className="flex gap-2">
                <span className="mt-1.5 block size-1.5 shrink-0 rounded-full bg-amber-400" />
