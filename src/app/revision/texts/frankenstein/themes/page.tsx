...
const THEMES: ThemeStudy[] = [
  ...
  },
  {
    ...
    overview:
      'Is the Creature born evil or made evil? Shelley argues powerfully for nurture.',
    detailed:
  ...
  },
  {
    ...
    keyQuotes: [
      ...
      {
        quote: 'So much has been done, exclaimed the soul of Frankenstein -- more, far more, will I achieve.',
    ...
    keyQuotes: [
      {
        ...
        speaker: 'The Creature -- Chapter 16',
        analysis:
          'The word "abortion" -- something that should never have been born -- is the most extreme expression of the Creature\'s internalised self-hatred. He has absorbed society\'s judgement so completely that he denies his own right to exist. The passive verbs ("spurned," "kicked," "trampled") emphasise his powerlessness.',
      },
      {
        quote: 'I had cast off all feeling, subdued all anguish, to riot in the excess of my despair.',
        speaker: 'Victor -- Chapter 24',
        analysis:
          'Victor describes himself in language typically reserved for the Creature: excess, despair, the suppression of feeling. By the final chapters, Shelley has collapsed the distinction between creator and creation. Both are "monsters" in the sense that both have been dehumanised by the cycle of creation, abandonment, and revenge.',
      },
      {
