    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Frankenstein Key Chapters Analysed | The English Hub',
      },
    ],
  },
...
const CHAPTERS: ChapterAnalysis[] = [
  ...
  },
  {
    ...
    keyQuotes: [
      ...
      {
        quote:
          '"I saw the dull yellow eye of the creature open; it breathed hard, and a convulsive motion agitated its limbs... I had desired it with an ardour that far exceeded moderation; but now that I had finished, the beauty of the dream vanished, and breathless horror and disgust filled my heart."',
        analysis:
  ...
  },
  {
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        analysis:
          "The Creature's ultimatum captures the tragic logic of his transformation. Denied affection, he will seize the only kind of power that remains available to him. Shelley shows that rejection does not extinguish the desire for connection -- it warps it into a hunger for terror.",
      },
    ],
    writersMethods: [
      ...
      <BreadcrumbJsonLd
        items={[
          ...
          { name: 'Frankenstein', url: 'https://theenglishhub.app/revision/texts/frankenstein' },
          {
            ...
            url: 'https://theenglishhub.app/revision/texts/frankenstein/chapters',
          },
        ]}
      />
      {/* Hero */}
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-emerald-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <h1 className="text-display-sm font-heading text-foreground sm:text-display">
            {await t('rev.texts.common.key_chapters_analysed')}
          </h1>
          <p className="mt-2 text-body-lg text-muted-foreground">
            {await t('rev.texts.fr.byline')}
          </p>
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            {await t('rev.texts.fr.chapters.intro')}
          </p>
        </div>
      </section>
      ...
      {CHAPTERS.map((ch, idx) => (
        <section key={idx}>
          ...
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-heading-md font-heading">{tSummaryAnalysis}</CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-heading-md font-heading">{tWritersMethods}</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
