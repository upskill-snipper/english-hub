...
const CONTEXT_TOPICS: ContextTopic[] = [
  ...
  },
  {
    ...
    relevantQuote: {
      quote: 'Some I see / That twofold balls and treble sceptres carry.',
      speaker: 'Macbeth (describing the vision)',
      actScene: 'Act 4, Scene 1',
      whyItMatters:
        'The "twofold balls" refer to the double coronation (England and Scotland) and "treble sceptres" to the three kingdoms James ruled. The show of kings is a direct tribute to James I, transforming a supernatural scene into royal flattery. Shakespeare literally projects his patron\'s dynasty into the play.',
    },
    keyTerms: [
      "King's Men",
