...
const CONTEXT_TOPICS: ContextTopic[] = [
  {
    ...
    relevantQuote: {
      ...
      whyItMatters:
        'This prophecy about Banquo\'s descendants becoming kings is a direct compliment to James I, who traced his lineage to Banquo. Shakespeare flatters his royal patron by presenting James\'s ancestor as a man of moral integrity whose line is divinely ordained to rule.',
    },
    keyTerms: ['Union of Crowns', 'King\'s Men', 'Holinshed\'s Chronicles', 'Stuart dynasty', 'Banquo\'s line'],
  },
  {
    ...
    keyTerms: ['Daemonologie', 'North Berwick trials', 'Witchcraft Act 1604', 'familiar spirits', 'demonology'],
  },
  {
    ...
    keyTerms: ['Gunpowder Plot', 'Guy Fawkes', 'Robert Catesby', 'Henry Garnet', 'equivocation', 'regicide'],
  },
  {
    ...
    keyTerms: ['Divine Right of Kings', 'God\'s lieutenant', 'divine order', 'legitimate succession', 'political theology'],
  },
  {
    ...
    keyTerms: ['Great Chain of Being', 'cosmic hierarchy', 'natural order', 'correspondence theory', 'macrocosm and microcosm'],
  },
  {
    ...
    keyTerms: ['regicide', 'treason', 'sacrilege', 'anointed monarch', 'hanging, drawing and quartering'],
  },
  {
    ...
    linksToPlay:
      'The Scottish setting, the witchcraft themes, the celebration of Banquo\'s line (James\'s ancestors), and the endorsement of the Divine Right of Kings are all designed to please Shakespeare\'s royal patron. The play\'s brevity may be a practical adaptation for court performance.',
    relevantQuote: {
    ...
    keyTerms: ['King\'s Men', 'Lord Chamberlain\'s Men', 'royal patent', 'court performance', 'patronage'],
  },
  {
    ...
    keyTerms: ['Globe Theatre', 'Bankside', 'Blackfriars Theatre', 'trapdoor', 'open-air amphitheatre', 'verbal scene-setting'],
  },
]
      ...
      <div className="mx-auto max-w-4xl space-y-10 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-blue-500/[0.04] p-6 sm:p-8 lg:p-10">
          ...
          <div className="relative">
            ...
            <div className="mb-4 flex flex-wrap items-center gap-2">
              <Badge variant="secondary"><ScrollText className="mr-1 size-3 text-blue-400" />Historical Context</Badge>
              <Badge variant="outline">8 topics</Badge>
            </div>
            <h1 className="text-2xl font-bold tracking-tight sm:text-3xl lg:text-4xl">Macbeth — Historical Context</h1>
            <p className="mt-3 max-w-2xl text-muted-foreground">
              Essential Jacobean context for Macbeth: James I, witchcraft, the Gunpowder Plot, the Divine Right of Kings, and the theatrical world Shakespeare wrote for. Understanding context is worth up to 6 marks in AQA GCSE Literature.
            </p>
          </div>
        </section>
        ...
        <div className="rounded-lg border border-amber-500/20 bg-amber-500/[0.04] p-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Context should support your argument, not replace it. The strongest approach is to embed context within your analysis: &ldquo;Shakespeare uses [technique] to [effect], which would have resonated with a Jacobean audience because [contextual reason].&rdquo; Avoid &ldquo;bolt-on&rdquo; context paragraphs that feel disconnected from your textual analysis.
          </p>
        </div>
          ...
          <Card key={topic.title} id={topic.title.toLowerCase().replace(/[^a-z0-9]+/g, '-')}>
            ...
            <CardContent className="space-y-5">
              ...
              <div className="rounded-lg border border-border/60 p-4 space-y-2">
                ...
                <p className="text-lg font-medium leading-snug">&ldquo;{topic.relevantQuote.quote}&rdquo;</p>
        ...
        <div className="rounded-lg border border-blue-500/20 bg-blue-500/[0.04] p-4 space-y-3">
          <h4 className="font-semibold text-blue-600 dark:text-blue-400">How Context Earns AO3 Marks</h4>
          <p className="text-sm text-muted-foreground leading-relaxed">
            AQA Assessment Objective 3 (AO3) asks you to &ldquo;show understanding of the relationships between texts and the contexts in which they were written.&rdquo; This is worth up to 6 marks on the Macbeth question. The key word is &ldquo;relationships&rdquo; -- you must connect context to the text, not bolt it on.
          </p>
          <div className="space-y-2">
            <div className="flex gap-2 text-sm">
              <Badge variant="outline" className="mt-0.5 shrink-0 text-xs">Level 1-2</Badge>
              <span className="text-muted-foreground">Simple awareness: &ldquo;Shakespeare wrote this in the Jacobean period.&rdquo;</span>
            </div>
            <div className="flex gap-2 text-sm">
              <Badge variant="outline" className="mt-0.5 shrink-0 text-xs">Level 3-4</Badge>
              <span className="text-muted-foreground">Clear connection: &ldquo;The witches reflect James I&apos;s interest in witchcraft, as shown in Daemonologie.&rdquo;</span>
            </div>
            <div className="flex gap-2 text-sm">
              <Badge variant="outline" className="mt-0.5 shrink-0 text-xs">Level 5-6</Badge>
              <span className="text-muted-foreground">Embedded and analytical: &ldquo;Shakespeare&apos;s use of equivocating prophecies mirrors the Jesuit doctrine exposed during Garnet&apos;s trial, making the witches resonate with the national anxiety surrounding the Gunpowder Plot.&rdquo;</span>
            </div>
          </div>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                {
                  mistake: 'Writing a separate "context paragraph" disconnected from textual analysis',
                  correction:
                ...
                {
                  mistake: 'Saying Shakespeare "was trying to please James I" as if that is the only reason the play exists',
                  correction:
                ...
                {
                  mistake: 'Treating the witches as proof that "people in those days believed in magic"',
                  correction:
                ...
                {
                  mistake: 'Confusing the historical Macbeth (an 11th-century Scottish king) with Shakespeare\'s character',
                  correction:
                    'Shakespeare\'s Macbeth is based on Holinshed\'s Chronicles, not on historical fact. The real Macbeth ruled for 17 relatively stable years. Shakespeare condensed and dramatised events for theatrical effect.',
                },
                {
                  mistake: 'Saying "In Shakespeare\'s time, women had no power" as a blanket statement',
                  correction:
                ...
                <div key={i} className="rounded-lg border border-red-500/15 bg-red-500/[0.03] p-3 space-y-1.5">
                  <p className="text-sm font-medium text-red-600 dark:text-red-400">
                    Mistake: {item.mistake}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    <span className="font-medium text-emerald-600 dark:text-emerald-400">Better: </span>
                    {item.correction}
                  </p>
                </div>
              ))}
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                { year: '1590', event: 'North Berwick witch trials -- James VI personally interrogates accused witches' },
                { year: '1597', event: 'James publishes Daemonologie, his treatise on witchcraft' },
                { year: '1603', event: 'James VI of Scotland becomes James I of England (Union of Crowns)' },
                { year: '1603', event: 'Shakespeare\'s company renamed the King\'s Men under royal patronage' },
                { year: '1604', event: 'Witchcraft Act makes communing with evil spirits a capital offence' },
                { year: '1605', event: 'Gunpowder Plot discovered (5 November) -- Catholic conspiracy to kill James' },
                { year: '1606', event: 'Trial and execution of Jesuit Henry Garnet for equivocation' },
                { year: '1606', event: 'Macbeth written and likely first performed at court for James I' },
                { year: '1623', event: 'Macbeth published in the First Folio (the play\'s only early text)' },
              ].map((item, i) => (
                <div key={i} className="flex gap-3 text-sm">
                  <Badge variant="outline" className="mt-0.5 shrink-0 font-mono text-xs">{item.year}</Badge>
