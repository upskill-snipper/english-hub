...
const ESSAY_PLANS: EssayPlan[] = [
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        point:
          "Macbeth's increasing ease with violence shows how ambition progressively destroys moral feeling.",
        quote:
  ...
  {
    question:
      'How does Shakespeare present Lady Macbeth as a powerful but ultimately tragic figure?',
    type: 'Character',
    introduction:
    ...
    paragraphs: [
      {
        ...
        point:
          "Macbeth's guilt manifests instantly through hallucination and sensory disturbance, showing that conscience cannot be overridden by willpower.",
        quote:
  ...
  {
    question:
      'How does Shakespeare use the supernatural to drive the plot and explore moral ideas in Macbeth?',
    type: 'Theme',
    introduction:
    ...
    paragraphs: [
      {
        ...
        point:
          "The witches provide the initial temptation but do not compel action, preserving Macbeth's moral agency.",
      ...
      },
      {
        ...
        point:
          "The witches' prophecies exploit equivocation, making the supernatural a source of deception rather than truth.",
      ...
      },
      {
        ...
        point:
          'Shakespeare deliberately blurs the line between supernatural events and psychological projections, creating productive ambiguity.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        point:
          "Macduff provides the play's most positive model of masculinity by insisting that genuine manhood includes emotional depth.",
  ...
  {
    question:
      'How does Shakespeare present the relationship between ambition and moral decline in Macbeth?',
    type: 'Theme',
    introduction:
    ...
    paragraphs: [
      ...
      },
      {
        ...
        point:
          "After Duncan's murder, ambition transforms from a desire for the crown to a paranoid need to secure it, producing escalating violence.",
      ...
      },
      {
        ...
        point:
          "Macbeth's nihilistic despair in Act 5 represents the final stage of ambition: the complete destruction of meaning.",
  ...
  {
    question:
      'How does Shakespeare use imagery of blood and darkness to convey meaning in Macbeth?',
    ...
    paragraphs: [
      {
        ...
        point:
          "Blood shifts from heroic to guilty across Acts 1-2, marking Macbeth's transformation.",
        quote:
          "Will all great Neptune's ocean wash this blood / Clean from my hand? No, this my hand will rather / The multitudinous seas incarnadine.",
        quoteSource: 'Macbeth -- Act 2, Scene 2',
        analysis:
  ...
  {
    question:
      'Starting with this extract, explore how Shakespeare presents the theme of kingship in Macbeth.',
    type: 'Extract/Theme',
    introduction:
    ...
    paragraphs: [
      {
        ...
        point:
          'Duncan represents divinely sanctioned kingship, and his murder is presented as a crime against the natural order.',
        quote:
    ...
    <div className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Essay Plans',
            url: 'https://theenglishhub.app/revision/texts/macbeth/essay-plans',
          },
        ]}
      />
      <div className="mx-auto max-w-4xl space-y-10 px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="mb-4 flex flex-wrap items-center gap-2">
              <Badge variant="secondary">
                <FileText className="me-1 size-3 text-rose-400" />
        ...
        <div className="rounded-lg border border-amber-500/20 bg-amber-500/[0.04] p-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            the exam, adapt the plan to the specific extract and question rather than reproducing it
            from memory. Practise writing one paragraph from each plan under timed conditions (12
            minutes per paragraph) to build speed and confidence.
          </p>
        </div>
        ...
        <div className="flex justify-between items-center pt-4 pb-8">
          ...
          <Button variant="outline" render={<Link href="/revision/texts/macbeth/characters" />}>
            {t('rev.texts.common.characters')} <Quote className="size-4 ms-1" />
          </Button>
        </div>
      </div>
    </div>
