...
export const metadata = {
  openGraph: {
    ...
    images: [
      {
        url: '/api/og?title=Macbeth+Act+2+-+Scene-by-Scene+Analysis+%7C+The+English+Hub',
        width: 1200,
        height: 630,
        alt: 'Macbeth Act 2 - Scene-by-Scene Analysis | The English Hub',
      },
    ],
  },
...
export default async function MacbethAct2Page() {
  ...
  return (
    <div className="space-y-10 pb-16">
      ...
      {/* The key scenes of Act 2, animated. See scripts/mount-story-visuals.mjs. */}
      <StoryVisuals guide={studyGuide} part="Act 2" />
