...
const THEMES: ThemeStudy[] = [
  {
    title: 'Ambition',
    overview:
      'The driving force of the entire tragedy -- unchecked ambition detached from moral restraint.',
    detailed:
  ...
  },
  {
    ...
    overview:
      "Guilt pervades the play from the moment of Duncan's murder, manifesting through hallucinations, insomnia, and madness.",
    detailed:
  ...
  },
  {
    ...
    overview:
      "Witchcraft, prophecy, and the question of whether Macbeth's downfall is fated or freely chosen.",
    detailed:
  ...
  },
  {
    ...
    overview:
      "Competing definitions of manhood drive the play's violence and shape its most destructive relationships.",
    detailed:
  ...
  },
  {
    ...
    overview:
      "The play opens with a traitor's execution and closes with a tyrant's overthrow -- loyalty defines the moral order.",
    detailed:
  ...
  },
  {
    ...
    overview:
      "Three models of rule -- Duncan's trusting virtue, Macbeth's paranoid tyranny, and Malcolm's shrewd justice.",
    detailed:
  ...
  },
  {
    ...
    overview:
      'Blood saturates the play as both literal reality and symbolic marker of guilt, violence, and moral contamination.',
    detailed:
  ...
  },
  {
    ...
    overview:
      "The natural world reacts to Macbeth's crimes -- when the moral order is violated, nature itself rebels.",
    detailed:
    ...
    <div className="min-h-screen bg-background">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: 'Themes', url: 'https://theenglishhub.app/revision/texts/macbeth/themes' },
        ]}
      />
