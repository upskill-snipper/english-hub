...
const data: TextGuideData = {
  ...
  quotations: [
    ...
    },
    {
      ...
      who: 'Belle — Stave Two',
      analysis:
        'Belle identifies money as Scrooge\'s false god. The word "idol" carries religious weight — Scrooge has committed a kind of spiritual idolatry by worshipping wealth instead of love.',
    },
    {
      quote:
    ...
    },
    {
      ...
      analysis:
        'The conditional "if" is crucial: Tiny Tim\'s death is not inevitable but depends on whether society — represented by Scrooge — will act. Dickens places moral responsibility directly on the reader.',
    },
    {
      quote:
      ...
      who: 'Ghost of Christmas Present — Stave Three',
      analysis:
        'Dickens\'s most explicitly political passage. Ignorance and Want are allegorical children — products of society\'s neglect. The warning that ignorance leads to "Doom" is aimed directly at the Victorian ruling class.',
    },
    {
      quote:
    ...
    },
    {
      ...
      who: 'Scrooge — Stave Four',
      analysis:
        'Scrooge\'s vow is not just about the festive season but about maintaining compassion and generosity as a permanent way of life. The word "try" adds humility — change is a daily effort, not a single dramatic gesture.',
    },
    {
      quote:
      ...
      analysis:
        'Dickens uses the triple structure — friend, master, man — to show that Scrooge\'s transformation is complete in every sphere of life: personal, professional and moral. The repetition of "good" reinforces the totality of his change.',
    },
    {
      quote:
      ...
      who: 'Narrator — Stave Five',
      analysis:
        'A rare moment of Dickensian humour at the close. The pun on "spirits" (ghosts and alcohol) lightens the tone and reassures the reader that Scrooge\'s transformation is joyful, not grim.',
    },
    {
    ...
    },
    {
      ...
      who: 'Narrator — Stave One',
      analysis:
        "Dickens uses pathetic fallacy to make Scrooge's inner coldness visible on his body. The cold is both literal (he is too mean to pay for heating) and metaphorical (he has frozen out all human warmth).",
    },
    {
      quote:
    ...
    },
    {
      ...
      who: 'Fred — Stave One',
      analysis:
        'Fred\'s defence of Christmas defines the festival not as religious ritual but as a moment of collective empathy. The metaphor of "shut-up hearts" echoes the imagery of Scrooge\'s locked counting-house and closed-off life.',
    },
    {
      quote: '"Darkness is cheap, and Scrooge liked it."',
      who: 'Narrator — Stave One',
      analysis:
        "A brilliantly compressed sentence. On the surface it describes Scrooge's refusal to pay for candles, but symbolically it captures his preference for moral darkness — ignorance, isolation and the absence of enlightenment.",
    },
  ],
}
...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    ...
    correctIndex: 2,
    explanation:
      'The novella has five staves — Dickens chose the musical term "stave" instead of "chapter" because the word links to Christmas carols and songs, reinforcing the novella\'s joyful moral message.',
    topic: 'Plot',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      '"Marley was dead: to begin with." Dickens establishes the death of Scrooge\'s business partner immediately. This is essential because Marley\'s ghost must return as a warning, and the reader needs to know he is truly dead for the supernatural events to have impact.',
    topic: 'Plot',
    difficulty: 'foundation',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Dickens heaps adjectives upon Scrooge to make his coldness overwhelming. The accumulation of negative descriptors creates a portrait of total moral deficiency that makes his eventual transformation all the more dramatic.',
    topic: 'Characters',
    difficulty: 'foundation',
  },
  {
    ...
    type: 'multiple-choice',
    options: [
      'A silent, hooded phantom',
      'A flickering, ethereal figure',
      'A jolly giant robed in green seated on a throne of food',
      'A small, cheerful child',
    ],
    correctIndex: 2,
    explanation:
      'The Ghost of Christmas Present is a generous giant surrounded by abundance, embodying the warmth of the season. But he also reveals suffering: he shows Scrooge the hidden children Ignorance and Want beneath his robes.',
    topic: 'Characters',
    difficulty: 'foundation',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Tiny Tim speaks this famous line, which serves as the novella's moral conclusion. His words embody Christian charity, generosity, and inclusivity — the values Dickens wants the reader to embrace.",
    topic: 'Characters',
    difficulty: 'foundation',
  },
  {
    ...
    options: [
      'A crown of thorns',
      'Heavy chains forged from his own greed',
      'A blindfold',
      'Torn and ragged clothing',
    ],
    correctIndex: 1,
    explanation:
      'Marley wears the chain "I forged in life," made "link by link, and yard by yard." Each link represents a selfish act. Marley warns that Scrooge\'s own chain was already as heavy seven years ago and has grown since.',
    topic: 'Characters',
    difficulty: 'foundation',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'The novella was published on 19 December 1843 by Chapman & Hall, during the Victorian era. Dickens wrote it partly as a response to the harsh conditions created by the 1834 New Poor Law (Poor Law Amendment Act), which forced the destitute into workhouses.',
    topic: 'Context',
    difficulty: 'foundation',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Scrooge dismisses the charity collectors by saying the poor should go to prisons and workhouses. This echoes the cruel provisions of the 1834 Poor Law, which Dickens despised. Scrooge's callousness is meant to shock the reader.",
    topic: 'Plot',
    difficulty: 'foundation',
  },
  {
    ...
    options: [
      ...
      'Scrooge insults her family',
      'His love of money has replaced his love for her',
      'Her father forbids the marriage',
    ],
    correctIndex: 2,
    explanation:
      'Belle tells young Scrooge that "another idol has displaced me... a golden one." She releases him from their engagement because his obsession with wealth has replaced his capacity for love. This moment marks when Scrooge chose money over human connection.',
    topic: 'Plot',
    difficulty: 'higher',
  },
  {
  ...
  },
  {
    ...
    type: 'multiple-choice',
    options: [
      'Past, Present, Future — matching three random moments',
      "Regret, empathy, then fear — designed to break through Scrooge's defences",
      'Joy, sadness, then joy again',
      'Warning, punishment, then reward',
    ],
    correctIndex: 1,
    explanation:
      "The ghosts form a structured moral education: Christmas Past produces regret, Christmas Present produces empathy for others' suffering, and Christmas Yet to Come produces fear of the consequences of an unchanged life. Each stage breaks down another layer of Scrooge's defences.",
  ...
  },
  {
    id: 'acc-12',
    question:
      'What is the significance of Dickens calling the chapters "staves" rather than chapters?',
    type: 'multiple-choice',
    options: [
      'It was a printing error',
      'A stave is a section of a song, linking the novella to music and Christmas carols',
      'It was a common Victorian convention',
      'It sounds more formal',
    ],
    correctIndex: 1,
    explanation:
      'A stave is a verse or section of a song. By using this musical term, Dickens connects his novella to the tradition of Christmas carols, reinforcing its message of joy, generosity, and communal celebration.',
    topic: "Writer's Methods",
    difficulty: 'higher',
  },
  {
    ...
    options: [
      ...
      'He realises his true duty was caring for other people, not accumulating wealth',
      'He wants to return to his job',
      'He blames mankind for his death',
    ],
    correctIndex: 1,
    explanation:
      "Marley's cry expresses the novella's central moral: the true business of life is caring for other people, not making money. He ignored this duty while alive and is now condemned to wander in chains. This is the lesson Scrooge must learn.",
    topic: 'Themes',
    difficulty: 'higher',
  },
  {
    ...
    options: [
      ...
      "As the emotional lever that cracks Scrooge's selfishness and represents the thousands of poor Victorian children who died",
      'As a minor background character',
      'To show the Cratchits are irresponsible parents',
    ],
    correctIndex: 1,
    explanation:
      "Tiny Tim's potential death is the emotional lever that cracks Scrooge's selfishness. He represents the thousands of poor Victorian children who died because society would not care for them. The ghost's warning that \"the child will die\" directly links Scrooge's miserliness to real human consequences.",
    topic: 'Characters',
    difficulty: 'higher',
  },
  {
    ...
    options: [
      'It is a coincidence',
      'Christmas represents rebirth and redemption, mirroring Christian ideas of salvation',
      'It was the only day Scrooge was not working',
      'The ghosts could only appear at Christmas',
    ],
    correctIndex: 1,
    explanation:
      'Christmas morning symbolises rebirth and new beginnings, mirroring Christian ideas of redemption and salvation. Scrooge waking transformed on Christmas Day suggests that change is always possible and that generosity should be practised year-round.',
    topic: 'Themes',
    difficulty: 'higher',
  },
  {
    ...
    type: 'multiple-choice',
    options: [
      'It inspired the ghost scenes',
      "It created harsh workhouses for the poor, which Dickens attacks through Scrooge's callous attitudes",
      'It banned Christmas celebrations',
      'It improved conditions for workers',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    id: 'acc-17',
    question:
      'How does Dickens use the contrast between light and darkness throughout the novella?',
    type: 'multiple-choice',
    options: [
      'To describe the weather',
      'Light represents warmth, generosity and redemption; darkness represents isolation and moral blindness',
      'To show the time of day',
      'There is no consistent pattern',
    ],
    correctIndex: 1,
    explanation:
      "Dickens consistently associates light with warmth and generosity (the Cratchits' firelight, Christmas candles) and darkness with Scrooge's cold isolation. Scrooge's transformation is marked by a movement from darkness into light, reflecting his moral awakening.",
    topic: "Writer's Methods",
    difficulty: 'grade-9',
  },
  {
    ...
    type: 'multiple-choice',
    options: [
      'To provide a happy ending for children',
      'To argue that no one is beyond redemption and to model the generosity he wants Victorian society to embrace',
      'Because it was fashionable at the time',
      'To make the novella longer',
    ],
    correctIndex: 1,
    explanation:
      "The exaggerated joy of Scrooge's transformation is Dickens's argument that change is possible for anyone. By making Scrooge's generosity so complete and infectious, Dickens models the behaviour he wants his readers — particularly wealthy Victorian readers — to adopt.",
    topic: "Writer's Methods",
    difficulty: 'grade-9',
  },
  {
    ...
    options: [
      'It is friendlier',
      "It is a silent, hooded phantom representing death, designed to produce fear as the final stage of Scrooge's moral education",
      'It speaks the most',
      'It shows Scrooge happy memories',
    ],
    correctIndex: 1,
    explanation:
      'The final ghost is a dark, silent phantom — the most frightening of the three. Its silence forces Scrooge to interpret what he sees without guidance. It represents death and the consequences of an unchanged life, completing the sequence of regret (Past), empathy (Present), and fear (Future).',
    topic: 'Characters',
    difficulty: 'grade-9',
  },
  {
    ...
    type: 'multiple-choice',
    options: [
      'He is a minor character with no importance',
      'He represents the generous employer Scrooge could have been, proving that wealth and kindness are compatible',
      "He is Scrooge's enemy",
      'He taught Scrooge to value money',
    ],
    correctIndex: 1,
    explanation:
      "Mr Fezziwig represents the kind, generous employer who uses his wealth to create happiness. His warmth contrasts sharply with Scrooge's miserliness and proves that being a good employer is a choice. Scrooge's recognition of this during the Past vision is a key step in his transformation.",
    topic: 'Characters',
    difficulty: 'foundation',
  },
]
...
const REVISION_TOPICS = [
  {
    ...
    summary:
      "Scrooge's transformation from miser to generous benefactor is the entire arc of the novella.",
    keyPoints: [
  ...
  },
  {
    ...
    summary:
      "Dickens contrasts Scrooge's isolation with the warmth of families like the Cratchits.",
    keyPoints: [
  ...
  },
  {
    ...
    summary:
      'The novella presents greed as a destructive force and generosity as the path to happiness.',
    keyPoints: [
  ...
  },
  {
    ...
    summary:
      'Dickens uses ghosts as a dramatic device to force Scrooge to confront truths he has been avoiding.',
    keyPoints: [
