        ...
        <div className="relative">
          ...
          <div className="mb-4 flex flex-wrap items-center gap-2">
            <Badge variant="secondary">
              <Users className="me-1 size-3 text-blue-400" />
          ...
          <h1 className="text-display-sm font-heading text-foreground sm:text-display">
            {t('rev.texts.acc.characters.title')}
          </h1>
          <p className="mt-2 text-body-lg text-muted-foreground">
            {t('rev.texts.acc.themes.byline')}
          </p>
          <p className="mt-4 max-w-2xl text-body-md text-muted-foreground">
            {t('rev.texts.acc.characters.intro')}
          </p>
        </div>
      </section>
        ...
        <Card>
          <CardContent className="p-4 sm:p-6">
            <h2 className="mb-4 text-heading-md font-heading text-foreground">
              {t('rev.texts.common.jump_to_character')}
            </h2>
            ...
            <CardContent className="space-y-5 text-body-sm text-muted-foreground">
              ...
              <div>
                <h3 className="mb-1 text-sm font-semibold text-foreground">
                  {t('rev.texts.common.role_in_novella')}
                </h3>
                <p>{ch.description}</p>
              </div>
              ...
              <div>
                <h3 className="mb-1 text-sm font-semibold text-foreground">
                  {t('rev.texts.common.what_they_represent')}
                </h3>
                <p>{ch.represents}</p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {ch.keyQuotes.map((q, i) => (
                    <div
                      key={i}
                      className="rounded-lg border-s-4 border-s-primary/40 bg-muted/30 p-4"
                    >
                      <p className="font-medium italic text-foreground">{q.text}</p>
                      <p className="mt-1 text-xs font-mono text-primary">{q.stave}</p>
              ...
              <div>
                <h3 className="mb-2 text-sm font-semibold text-foreground">
                  {t('rev.texts.common.links_to_themes')}
                </h3>
                <ul className="list-disc space-y-2 ps-4">
                  {ch.themeLinks.map((link, i) => (
                    <li key={i}>{link}</li>
                  ))}
                </ul>
              </div>
