...
import { ArrowLeft, BookOpen, Quote, Lightbulb, Sparkles } from 'lucide-react'
...
const quotes: KeyQuote[] = [
  {
    ...
    examTip:
      'Use this as an opening quote in any essay about narrative voice or the supernatural. The direct address establishes the novella as a spoken story.',
  },
  {
    id: 2,
    quote:
    ...
    examTip:
      'This is the definitive characterisation quote. Analyse the listing technique and the violent connotations of each verb. Compare with the positive adjectives of Stave 5.',
  },
  {
    id: 3,
    quote:
    ...
    examTip:
      'A brilliant example of pathetic fallacy. Use it to discuss how Dickens makes internal character traits visible through physical description.',
  },
  {
    id: 4,
    ...
    examTip:
      "Perfect for discussing symbolism and Dickens's economy of language. One sentence contains both literal and metaphorical meaning.",
  },
  {
    id: 5,
    quote:
    ...
    examTip:
      "Learn this quote -- it is the novella's definition of Christmas spirit. Use it as a thesis statement in any essay about the meaning of Christmas in the text.",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    themes: ['Social Responsibility', 'Greed and Capitalism'],
    examTip:
      "Always analyse the Malthusian allusion. The structural echo in Stave 3 is one of the most powerful moments in the novella -- discuss it in essays about Dickens's technique.",
  },
  {
    id: 8,
    ...
    examTip:
      "The single most important symbol. Analyse its components and the craftsmanship language. Compare with Scrooge's liberation in Stave 5.",
  },
  {
    id: 9,
    quote:
    ...
    examTip:
      'This is Dickens\'s thesis statement. Use it in ANY essay about social responsibility. The redefinition of "business" is the moral argument in a single word.',
  },
  {
    id: 10,
    ...
    examTip:
      "This quote explains Scrooge's psychology. Use it to argue that Dickens generates sympathy before demanding change -- understanding the past is the first step.",
  },
  {
    id: 11,
    ...
    examTip:
      "A deceptively important line. Use it to discuss how Dickens explains Scrooge's character through family history -- the cycle of emotional coldness.",
  },
  {
    id: 12,
    quote:
    ...
    examTip:
      'One of the most important quotes for essays about employers and social responsibility. Scrooge already knows the truth -- his moral failure is choosing to ignore it.',
  },
  {
    id: 13,
    ...
    themes: ['Greed and Capitalism', 'Isolation'],
    examTip:
      "The biblical allusion elevates this from personal observation to spiritual judgement. Use it in essays about greed or Scrooge's character.",
  },
  {
    id: 14,
    quote:
    ...
    examTip:
      'This quote gives Scrooge psychological complexity. Use it to argue that Dickens explains greed through fear, not just selfishness.',
  },
  {
    id: 15,
  ...
  },
  {
    ...
    examTip:
      'Focus on the conditional language. The word "if" turns prophecy into warning and gives Scrooge (and the reader) agency.',
  },
  {
    id: 18,
    quote:
    ...
    themes: ['Social Responsibility', 'Greed and Capitalism'],
    examTip:
      'The political heart of the novella. Link to the 1843 context -- ragged schools, child labour, the Poor Law. This passage was inspired by real conditions.',
  },
  {
    id: 19,
    ...
    examTip:
      "Useful for comparing the three Ghosts. This one's warmth contrasts with the Past's gentle firmness and the Future's terrifying silence.",
  },
  {
    id: 20,
    quote:
    ...
    stave: 'Stave 4',
    context:
      'Scrooge begs the Ghost of Christmas Yet to Come to tell him whether the future is fixed.',
    analysis:
    ...
    examTip:
      'Analyse the modal verbs "will" and "may" closely. This question contains the entire philosophy of the novella in a single sentence.',
  },
  {
    id: 21,
    ...
    examTip:
      "Shows Scrooge's growing self-awareness before the climactic gravestone scene. Track his understanding through Stave 4.",
  },
  {
    id: 22,
  ...
  },
  {
    ...
    examTip:
      'The climactic vow. Link it back to Fred\'s Stave 1 speech to show structural unity. The word "try" is worth close analysis.',
  },
  {
    id: 24,
    quote:
  ...
  },
  {
    ...
    themes: ['Social Responsibility', 'Redemption'],
    examTip:
      'Use this to show that Dickens insists spiritual change must produce material change. Redemption is not just feeling better -- it is DOING better.',
  },
  {
    id: 26,
    quote:
    ...
    examTip:
      "The definitive statement of Scrooge's change. Analyse the triple structure and link each element (friend/master/man) to specific evidence.",
  },
  {
    id: 27,
    quote:
    ...
    themes: ['Redemption'],
    examTip:
      "Use this to discuss Dickens's narrative voice and his use of humour to close the novella on a warm, reassuring note.",
  },
  {
    id: 28,
    quote:
    ...
    examTip:
      "Fred's constancy is key. He does not change -- he waits for Scrooge to change. Discuss what this says about Dickens's view of patience and forgiveness.",
  },
]
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Key Quotations',
            url: 'https://theenglishhub.app/revision/texts/a-christmas-carol/key-quotes',
          },
        ]}
      />
      {/* Study Tools */}
        ...
        <Card>
          <CardContent className="p-4 sm:p-6">
            <h2 className="mb-4 text-heading-md font-heading text-foreground">
              {t('rev.texts.common.jump_to_stave')}
            </h2>
        ...
        return (
          ...
          >
            <div className="flex items-center gap-4 border-b border-border/60 pb-4">
              ...
              <h2 className="text-heading-lg font-heading text-foreground">{stave}</h2>
            </div>
              ...
              {staveQuotes.map((q) => (
                <Card key={q.id}>
                  <CardContent className="space-y-4 p-5 sm:p-6">
                    ...
                    <div>
                      <h4 className="mb-1 text-xs font-mono font-medium uppercase tracking-wider text-muted-foreground">
                        {t('rev.texts.common.language_analysis')}
                      </h4>
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-body-sm text-muted-foreground">{q.examTip}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
