...
import { ArrowLeft, BookOpen, FileText, Lightbulb, Sparkles, Quote } from 'lucide-react'
...
const essayPlans: EssayPlan[] = [
  ...
  {
    number: 2,
    question: 'How does Dickens use the ghosts to present his message about social responsibility?',
    type: 'Character',
    thesisStatement:
  ...
  {
    number: 3,
    question: 'How does Dickens present the theme of poverty in A Christmas Carol?',
    type: 'Theme',
    thesisStatement:
  ...
  {
    number: 5,
    question: 'How does Dickens use structure in A Christmas Carol to convey his message?',
  ...
  {
    number: 6,
    question: 'How does Dickens use symbolism in A Christmas Carol?',
    type: "Writer's Methods",
    thesisStatement:
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Essay Plans',
            url: 'https://theenglishhub.app/revision/texts/a-christmas-carol/essay-plans',
          },
        ]}
      />
      {/* Study Tools */}
        ...
        <Card>
          <CardContent className="p-4 sm:p-6">
            <h2 className="mb-4 text-heading-md font-heading text-foreground">
              {t('rev.texts.common.jump_to_plan')}
            </h2>
      ...
      {/* Essay plans */}
      {essayPlans.map((plan) => (
        <section key={plan.number} id={`plan-${plan.number}`} className="scroll-mt-8 space-y-5">
          {/* Plan header */}
          <div className="flex items-start gap-4 border-b border-border/60 pb-4">
            ...
            <div>
              ...
              <h2 className="text-heading-lg font-heading text-foreground">{plan.question}</h2>
            </div>
          </div>
          ...
          <Card className="bg-primary/[0.03] border-primary/10">
            <CardContent className="p-5">
              ...
              <p className="text-body-sm font-medium text-foreground">{plan.thesisStatement}</p>
            </CardContent>
          </Card>
            ...
            <Card key={i}>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-heading-md font-heading">
                  ...
                  {t('rev.texts.common.paragraph_n').replace('{n}', String(i + 1))}
                </CardTitle>
              </CardHeader>
          ...
          <Card className="bg-amber-500/[0.03] border-amber-500/10">
            <CardContent className="p-5">
              <h4 className="mb-2 text-sm font-semibold text-foreground flex items-center gap-2">
                ...
                {t('rev.texts.common.exam_technique_tip')}
              </h4>
