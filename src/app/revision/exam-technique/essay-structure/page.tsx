    ...
    <div className="space-y-6 pb-16">
      ...
      <div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-heading-lg font-heading text-foreground">Essay Structure</h1>
            <p className="text-body-sm text-muted-foreground">
              Build paragraphs, introductions, and conclusions that hit every mark
            </p>
          </div>
        </div>
      </div>
      ...
      {/* ── PEEL Paragraphs ───────────────────────────────────── */}
      <Section title="PEEL Paragraphs" badge="Core Skill" defaultOpen>
        <p className="text-body-sm text-muted-foreground leading-relaxed">
          PEEL is the backbone of analytical writing in GCSE English. Every body paragraph
          should follow this structure to ensure you are demonstrating understanding,
          using evidence, and analysing the writer&apos;s craft.
        </p>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {[
            ...
            },
            {
              ...
              example: 'The rhetorical question reveals Macbeth\'s psychological torment. The hyperbole of "all great Neptune\'s ocean" suggests that no force in nature can undo his crime, implying his guilt is permanent and inescapable.',
            },
            {
              letter: 'L',
              name: 'Link',
              ...
              example: 'Shakespeare may be using Macbeth\'s guilt to warn a Jacobean audience about the divine consequences of regicide, reinforcing the Great Chain of Being.',
            },
          ].map((item) => (
        ...
        >
          ...
          is not simply murder but an offence against God&apos;s natural order, carrying
          consequences that no human act can undo.
        </ModelParagraph>
      </Section>
      ...
      <Section title="Introduction Techniques">
        <p className="text-body-sm text-muted-foreground leading-relaxed">
          A strong introduction sets the direction for your entire response. It should be
          concise (3--5 sentences), address the question directly, and outline your argument.
        </p>
      ...
      <Section title="Linking Paragraphs">
        <p className="text-body-sm text-muted-foreground leading-relaxed">
          Examiners reward &ldquo;sustained&rdquo; and &ldquo;cohesive&rdquo; responses.
          Your paragraphs should flow logically from one to the next, building an argument
          rather than listing separate points.
        </p>
      ...
      <Section title="Conclusions That Impress">
        ...
        <ModelParagraph label="Model conclusion -- Macbeth and ambition">
          ...
          to those consumed by it is permanent and irreversible. In this way, the play
          serves as both a political warning to James I and a timeless meditation on the
          fragility of the moral self.
        </ModelParagraph>
      ...
      <Section title="Full Model Essay Structures">
        <Tabs defaultValue="literature">
          ...
          <TabsContent value="literature">
            <div className="space-y-4">
              <p className="text-body-sm text-muted-foreground leading-relaxed">
                A typical Literature essay (e.g. AQA Paper 1 Shakespeare, 45 minutes)
                should follow this structure. Aim for 3 analytical paragraphs plus an
              ...
              <div className="space-y-3">
                {[
                  ...
                  {
                    part: 'Paragraph 2 -- Wider text (before/after extract)',
                    time: '10 mins',
          ...
          <TabsContent value="language">
            <div className="space-y-4">
              <p className="text-body-sm text-muted-foreground leading-relaxed">
                A Language Paper 2 Question 5 essay (creative or transactional writing,
                45 minutes) requires a different approach. Structure is about craft and
              ...
              <div className="space-y-3">
                {[
                  ...
                  },
                  {
                    ...
                    time: '25 mins',
                    detail: 'Vary sentence structures (short for impact, complex for detail). Use paragraphs to control pace. Deploy at least 3 deliberate language techniques (e.g. metaphor, listing, direct address). Use varied punctuation (semicolons, dashes, ellipsis).',
                    ao: 'AO5, AO6',
                  },
                  {
      ...
      <Section title="Grade 5 vs Grade 9 Comparison">
        <p className="text-body-sm text-muted-foreground leading-relaxed mb-2">
          The difference between a Grade 5 and Grade 9 is rarely about knowing more
          quotations -- it is about depth of analysis, precision of expression, and
        ...
        <div className="space-y-5">
          ...
          <GradeComparison
            ...
            grade9="The metonymic use of 'blood' transcends the literal: while Duncan's blood can be physically removed, its symbolic weight -- representing moral transgression, violated loyalty, and divine law -- cannot. Shakespeare embeds guilt into the very fabric of the play's imagery, so that 'blood' becomes less a substance and more a state of being."
          />
