...
import { ArrowLeft, ArrowRight, Swords, Sparkles, BookOpen, Lock, CheckCircle2 } from 'lucide-react'
    ...
    <div className="space-y-10 pb-16">
      <BreadcrumbJsonLd
        items={[
          ...
          {
            name: 'Conflict',
            url: 'https://theenglishhub.app/revision/poetry/ocr/conflict',
          },
        ]}
      />
      <div>
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-red-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="pointer-events-none absolute -bottom-16 -start-16 h-48 w-48 rounded-full bg-orange-500/5 blur-3xl" />
