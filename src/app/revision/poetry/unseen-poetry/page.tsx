...
export const metadata: Metadata = {
  title: 'Unseen Poetry Guide — Revision Hub | The English Hub',
  description:
    'A comprehensive guide to unseen poetry for GCSE English Literature. Step-by-step method, 20 poetic techniques, structure and language analysis, 5 practice poems with model responses, comparison technique, and common mistakes.',
  alternates: {
...
const TECHNIQUES = [
  {
    ...
    effect: 'Creates rhythm, draws attention to a phrase, or mimics a sound. Harsh consonants (b, d, k) can feel aggressive; soft ones (l, m, s) can feel gentle.',
  },
  {
    name: 'Assonance',
    definition: 'Repetition of vowel sounds within nearby words.',
    example: '"the rain in Spain stays mainly on the plain"',
    effect: 'Creates internal harmony and musicality. Long vowel sounds (oo, ee, ay) can slow the pace and create a mournful or reflective tone.',
  },
  {
    name: 'Sibilance',
    definition: 'Repetition of "s", "sh", "z", or soft "c" sounds.',
    example: '"the lone and level sands stretch far away"',
    effect: 'Can create a whispering, sinister, or soothing effect depending on context. Often mimics natural sounds like wind or water.',
  },
  {
    name: 'Onomatopoeia',
    definition: 'A word that imitates the sound it describes.',
    example: '"buzz", "crash", "gargling", "guttering"',
    effect: 'Makes descriptions more vivid and sensory by letting the reader hear the sound. Often used in war poetry for impact.',
  },
  {
    name: 'Metaphor',
    definition: 'An implicit comparison where one thing is said to be another.',
    example: '"Life\'s but a walking shadow" (Macbeth)',
    effect: 'Creates a strong, direct comparison that shapes how the reader sees the subject. Encourages the reader to transfer qualities from one thing to another.',
  },
  {
    ...
    effect: 'Builds a detailed, layered comparison. Allows the poet to explore multiple aspects of an idea through a single image.',
  },
  {
    name: 'Simile',
    definition: 'A comparison using "like" or "as".',
    example: '"My love is like a red, red rose" (Burns)',
    effect: 'Creates a clear, visual comparison. Unlike a metaphor, the simile keeps both things separate, so the reader can consider the gap between them.',
  },
  {
    name: 'Personification',
    definition: 'Giving human qualities to something non-human.',
    example: '"the wind whispered through the trees"',
    effect: 'Makes abstract ideas or natural forces feel alive and relatable. Can create empathy, menace, or beauty depending on context.',
  },
  {
    name: 'Imagery',
    definition: 'Language that creates a vivid sensory picture (visual, auditory, tactile, olfactory, gustatory).',
    example: '"a green light at the end of the dock"',
    effect: 'Helps the reader see, hear, or feel the scene. Engages the senses and makes abstract ideas concrete.',
  },
  {
    name: 'Symbolism',
    ...
    effect: 'Adds layers of meaning beyond the literal. Allows the poet to communicate complex ideas concisely.',
  },
  {
    name: 'Caesura',
    definition: 'A pause in the middle of a line, created by punctuation.',
    example: '"Nothing beside remains. Round the decay" (Shelley)',
    effect: 'Creates emphasis, forces the reader to pause and reflect, or mimics a moment of hesitation or shock. Often marks a shift in thought.',
  },
  {
    name: 'Enjambment',
    definition: 'A sentence or phrase that runs over from one line to the next without punctuation.',
    example: '"I wandered lonely as a cloud / That floats on high o\'er vales and hills" (Wordsworth)',
    effect: 'Creates momentum and flow, pulls the reader forward, or can create surprise when the meaning shifts at the line break.',
  },
  {
    ...
    effect: 'Creates a sense of completeness, control, or finality. Can slow the pace and give weight to each line.',
  },
  {
    name: 'Rhyme (full, half, internal)',
    definition: 'Matching sounds at the end of lines (full rhyme), near-matching sounds (half/slant rhyme), or rhyme within a line (internal rhyme).',
    example: 'Full: "bright/night"; Half: "eyes/light"; Internal: "once upon a midnight dreary"',
    effect: 'Full rhyme creates order and satisfaction. Half rhyme creates unease or instability. Internal rhyme adds pace and musicality.',
  },
  {
    name: 'Repetition',
    ...
    effect: 'Creates emphasis, rhythm, or an obsessive quality. Can reinforce a theme or mirror the speaker\'s emotional state.',
  },
  {
    name: 'Juxtaposition',
    ...
    effect: 'Highlights contrast and forces the reader to consider the difference between two things. Creates irony or shock.',
  },
  {
    name: 'Oxymoron',
    definition: 'Two contradictory words placed together.',
    example: '"bitter sweet", "living death", "cold fire"',
    effect: 'Creates tension, paradox, or complexity. Suggests that an experience contains conflicting emotions or ideas.',
  },
  {
    ...
    effect: 'Externalises internal emotions, making them visible and dramatic. Creates atmosphere and reinforces mood.',
  },
  {
    name: 'Tone and register',
    definition: 'The attitude or feeling conveyed by the poet\'s word choices (formal, colloquial, angry, tender, ironic).',
    example: 'Owen\'s bitter, sarcastic tone in "Dulce et Decorum Est".',
    effect: 'Shapes the reader\'s emotional response. A shift in tone often signals a turning point in the poem.',
  },
  {
    ...
    effect: 'Creates intimacy, urgency, or confrontation. Commands can be authoritative or desperate depending on context.',
  },
]
...
const STRUCTURE_POINTS = [
  {
    term: 'Stanza form',
    guidance: 'Count the stanzas and the lines per stanza. Regular stanzas (e.g. quatrains, tercets) suggest order and control. Irregular stanzas may reflect chaos, freedom, or shifting emotions. A single-stanza poem can feel relentless or claustrophobic.',
  },
  {
    term: 'Rhyme scheme',
    guidance: 'Label the end sounds with letters (ABAB, ABBA, etc.). A regular scheme creates harmony and predictability. An irregular or broken scheme can mirror disorder. Note where the rhyme breaks down -- it often coincides with a shift in meaning.',
  },
  {
    term: 'Volta (turning point)',
    guidance: 'Look for a shift in tone, subject, or perspective -- often at the start of a new stanza or after a caesura. The volta is where the poem changes direction. In a sonnet, it traditionally appears at line 9 (Petrarchan) or the final couplet (Shakespearean).',
  },
  {
    term: 'Line length and rhythm',
    guidance: 'Long lines can feel expansive, flowing, or breathless. Short lines create emphasis, tension, or abruptness. A sudden change in line length signals a shift in emotion. You do not need to name the metre (iambic pentameter, etc.) unless you are confident -- describing the effect of rhythm is more important.',
  },
  {
    term: 'Enjambment and end-stopping',
    guidance: 'Enjambment pulls the reader forward and can create urgency, uncertainty, or a sense of overflow. End-stopped lines create pauses and a measured, controlled pace. Notice where the poet switches between them -- the contrast is often meaningful.',
  },
  {
    term: 'Beginning, middle, and end',
    guidance: 'How does the poem open -- in the middle of action, with a question, with a declaration? How does it end -- with resolution, ambiguity, a return to the beginning, or a final twist? The relationship between opening and closing lines often reveals the poem\'s argument.',
  },
]
...
const COMPARISON_STEPS = [
  {
    ...
    detail: 'Before you write, identify one clear theme that both poems share (e.g. power, loss, nature, conflict). State this in your opening sentence. Everything you write should connect back to this theme.',
  },
  {
    step: 'Use a point-by-point structure',
    detail: 'Do NOT write about Poem A for half your answer and then Poem B. Instead, make a point about both poems in each paragraph. For example: "Both poets explore the destructive nature of power, but while Shelley presents power as ultimately futile, Blake presents it as corrupting."',
  },
  {
    step: 'Compare methods, not just ideas',
    detail: 'The examiner rewards comparison of HOW poets write, not just WHAT they write about. Compare specific techniques: "Shelley uses dramatic irony to undermine power, whereas Blake uses repetition to emphasise its oppressive nature."',
  },
  {
    step: 'Use comparison connectives',
    detail: 'Link poems with: similarly, likewise, in contrast, whereas, on the other hand, however, both poets, while Poet A...Poet B, unlike. Aim for at least one comparison connective per paragraph.',
  },
  {
    step: 'Comment on different effects',
    detail: 'Even when poets use similar techniques, they often create different effects. Note this: "Both poets use enjambment, but Wordsworth uses it to create a sense of freedom and overflow, while Owen uses it to convey breathless panic."',
  },
]
  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-violet-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-3 max-w-2xl text-body-lg text-muted-foreground">
            Everything you need to approach, analyse, and write about a poem you
            have never seen before. A five-step method, twenty key techniques,
            five practice poems with model responses, and the most common
            mistakes to avoid.
          </p>
        </div>
      </section>
      ...
      <section id="techniques">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-body-sm text-muted-foreground">
              Twenty poetic techniques you should be able to identify and analyse
              in any unseen poem.
            </p>
          </div>
        </div>
      ...
      <section id="structure">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-body-sm text-muted-foreground">
              Structure is not just &ldquo;how the poem looks on the page.&rdquo;
              It is how the poet organises meaning. Here are the structural
              features to look for and how to discuss them.
            </p>
          </div>
        </div>
          ...
          <CardContent className="p-5 sm:p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-body-sm text-muted-foreground leading-relaxed">
                  A strong structural point often earns more marks than a
                  language point because fewer students attempt them. Even a
                  simple observation like &ldquo;The poem is a single stanza
                  with no breaks, which creates a relentless, claustrophobic
                  effect that mirrors the speaker&rsquo;s inability to
                  escape&rdquo; can be very effective.
                </p>
              </div>
            </div>
          </CardContent>
      ...
      <section id="language">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-body-sm text-muted-foreground">
              Use the What-How-Why framework to turn feature-spotting into
              genuine analysis.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <Card className="border-emerald-500/20 bg-emerald-500/[0.03]">
            ...
            <CardContent>
              <p className="text-body-sm text-muted-foreground leading-relaxed">
                What does the poet do? Identify the technique and embed a short
                quotation. Be specific: not just &ldquo;imagery&rdquo; but
                &ldquo;visual imagery of decay&rdquo; or &ldquo;violent
                metaphor.&rdquo;
              </p>
              <p className="mt-3 rounded-lg border border-border/40 bg-background/40 px-3 py-2 text-xs italic text-muted-foreground">
                &ldquo;Owen uses the simile &lsquo;like old beggars under
                sacks&rsquo; to describe the soldiers.&rdquo;
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-emerald-500/20 bg-emerald-500/[0.03]">
            ...
            <CardContent>
              <p className="text-body-sm text-muted-foreground leading-relaxed">
                How does the technique work? Explain the mechanics: what does the
                comparison suggest? What associations does the word carry? How
                does the sound or rhythm create an effect?
              </p>
              <p className="mt-3 rounded-lg border border-border/40 bg-background/40 px-3 py-2 text-xs italic text-muted-foreground">
                &ldquo;Beggars are associated with poverty, age, and suffering
                &mdash; the opposite of the strong, heroic soldier image that
                propaganda promoted.&rdquo;
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-emerald-500/20 bg-emerald-500/[0.03]">
            ...
            <CardContent>
              <p className="text-body-sm text-muted-foreground leading-relaxed">
                Why does the poet use this technique here? Link to the poem&rsquo;s
                theme, the speaker&rsquo;s feelings, or the reader&rsquo;s
                response. This is where you show understanding of meaning.
              </p>
              <p className="mt-3 rounded-lg border border-border/40 bg-background/40 px-3 py-2 text-xs italic text-muted-foreground">
                &ldquo;Owen strips the soldiers of dignity to challenge the
                reader&rsquo;s assumptions about war and expose the reality
                behind patriotic rhetoric.&rdquo;
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="mt-4">
          <CardContent className="p-5 sm:p-6">
            ...
            <blockquote className="border-l-2 border-emerald-500/40 pl-4 text-body-sm text-muted-foreground leading-relaxed">
              Owen uses the simile &ldquo;like old beggars under sacks&rdquo; to
              describe soldiers returning from the front line. Beggars are
              associated with poverty, exhaustion, and social rejection &mdash;
              the complete opposite of the heroic, upright soldier celebrated in
              wartime propaganda. By comparing young soldiers to elderly, broken
              figures, Owen strips them of the dignity and glory that
              pro-war rhetoric had promised. This forces the reader to confront
              the physical and emotional destruction that war inflicts, setting
              up the poem&rsquo;s central argument that the Latin motto
      ...
      <section id="practice-poems">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-body-sm text-muted-foreground">
              Five public domain poems with guided analysis questions. Try to
              answer the questions yourself before revealing the model response.
            </p>
          </div>
        </div>
      ...
      <section id="comparison">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-body-sm text-muted-foreground">
              Many exam boards include a comparison question. Follow these five
              steps to structure a strong comparative response.
            </p>
          </div>
        </div>
        ...
        <Card className="mt-4">
          <CardContent className="p-5 sm:p-6">
            ...
            <blockquote className="border-l-2 border-cyan-500/40 pl-4 text-body-sm text-muted-foreground leading-relaxed">
              Both Shelley and Owen explore the destructive consequences of
              power, but they focus on different types of destruction. In
              &ldquo;Ozymandias,&rdquo; Shelley uses dramatic irony to show how
              political power is destroyed by time: the boastful inscription
              &ldquo;Look on my Works, ye Mighty, and despair!&rdquo; is
              undercut by the image of &ldquo;lone and level sands&rdquo;
              stretching endlessly around the ruined statue. The destruction is
              quiet and gradual &mdash; nature has simply erased the king.
              In contrast, Owen presents the destruction of power through its
              effect on individual human bodies. The simile &ldquo;like old
              beggars under sacks&rdquo; shows soldiers physically broken by the
              power of the state that sent them to war. While Shelley&rsquo;s
              tone is detached and ironic, Owen&rsquo;s is angry and urgent,
              addressing the reader directly with &ldquo;My friend, you would
              not tell...the old Lie.&rdquo; Both poets ultimately argue that
              power built on suffering or arrogance cannot endure, but Owen
              makes the human cost viscerally present in a way that
      ...
      <section id="common-mistakes">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-body-sm text-muted-foreground">
              These are the errors examiners see most often. Avoiding them will
              immediately improve your grade.
            </p>
          </div>
        </div>
      ...
      <p className="text-xs text-muted-foreground border-t border-border/60 pt-4">
        All poems on this page are in the public domain. &ldquo;Ozymandias&rdquo;
        by Percy Bysshe Shelley (1818), &ldquo;I Wandered Lonely as a
        Cloud&rdquo; by William Wordsworth (1807), &ldquo;Sonnet 18&rdquo; by
        William Shakespeare (c.&nbsp;1609), &ldquo;The Tyger&rdquo; by William
        Blake (1794), and &ldquo;Dulce et Decorum Est&rdquo; by Wilfred Owen
        (1920, posthumous). Quotations are reproduced freely for educational
        purposes.
      </p>
    </div>
  )
