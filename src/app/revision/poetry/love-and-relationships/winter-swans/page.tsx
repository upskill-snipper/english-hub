...
const winterSwansPoem: PoemData = {
  ...
  // from the poem's sense; on 26 September 2026 they were checked line by line against the
  // text AQA prints, by permission, in its sample anthology
  // (filestore.aqa.org.uk/resources/english/AQA-8702-TG-POEMS.PDF).
  //
  // Also fixed on 26 September 2026: the notes were under the limit, but the rest of the
  // page was not. Key quotations, device examples, summaries, the Arabic strings, the quiz
  // and the revision cards between them quoted 99 distinct words of this 130-word poem,
  // three quarters of it, and two quotations misread it (a present tense for two past-tense
  // verbs). Six device lineRefs pointed at a blank stanza break or the wrong line, and one
  // device said the closing lines reuse words first used of the swans, which they do not.
  // The page now quotes 19 distinct words, the cap no-poem-quoted-beyond-fair-dealing.test.ts
  // sets for a poem of this length, and points to line numbers for everything else.
  lines: [
    // Stanza 1 (tercet 1)
    {
      ...
      annotations: [
        {
          ...
          note: 'The poem opens just after heavy rain, and the weather reflects the emotional state of the couple. "Given their all" personifies the clouds as exhausted, suggesting an argument has drained both partners.',
          color: '#10b981',
        },
      ],
    },
    ...
    // Stanza 4 (tercet 4)
    {
      ...
      annotations: [
        {
          type: 'Imagery',
          note: 'The swans seem to cut themselves in two as they dip: head submerged, body above. The split image quietly mirrors the divided couple watching them.',
          color: '#ef4444',
        },
      ],
    },
    ...
    // Stanza 6 (tercet 6)
    {
      ...
      annotations: [
        {
          type: 'Pace',
          note: 'The compound verb for their walking in line 16 enacts a quiet, careful pace. The texture of the pebbly shore underfoot is tactile and grounding: the couple are coming back to their bodies and to each other.',
          color: '#3b82f6',
        },
      ],
    },
    {
      ...
      annotations: [
        {
          type: 'Understatement',
          note: 'The speaker simply noticing is wonderfully understated: the hands have moved towards each other without conscious decision. He cannot say how it happened, which preserves the mystery; reconciliation feels almost involuntary, instinctive.',
          color: '#ec4899',
        },
      ],
    },
    ...
    // Final couplet
    {
      ...
      annotations: [
        {
          type: 'Verb echo',
          note: 'The hands folding over each other prepare for the simile that follows, the way wings fold against the body when at rest. Human hands and swan wings are aligned in one image.',
          color: '#ef4444',
        },
      ],
    },
  ...
  context:
    ...
    '<p><strong>Winter Swans</strong> was published in <em>Skirrid Hill</em> (2005). The name <em>Skirrid</em> is linked to the Welsh word <em>ysgariad</em>, meaning divorce or separation. The collection explores relationships that are strained, broken, or healing.</p>' +
  ...
  summary:
    ...
    'Stanzas 3–4 (tercets, lines 7–12): The swans arrive and stop the couple, dipping their heads under the water in perfect "unison". Each seems to split in half beneath the surface, like "icebergs" of feather, and then comes back upright like a boat steadying itself in a storm (line 12).\n\n' +
    'Stanza 5 (tercet, lines 13–15): As the swans leave, the partner remarks that they "mate for life"; the speaker does not reply, but the couple walk on into the brighter afternoon, the distance between them silently closing.\n\n' +
    'Stanzas 6–7 (tercet + final couplet, lines 16–20): Walking slowly along the shore, the speaker notices that their hands have "swum" across the gap between them and folded together, like a "pair of wings settling" as a bird lands. The relationship is repaired wordlessly.',
  ...
  summaryAr:
    ...
    'المقاطع 3–4 (tercets، الأبيات 7–12): البجع (swans) يوصلون ويوقّفون الزوجين، ويغطسون روسهم تحت المي بتزامن تام ("unison"). كل بجعة كأنها تنقسم نصّين تحت سطح المي، مثل "icebergs" من الريش، وبعدين ترجع تعتدل مثل قارب يتوازن وسط الموج (البيت 12).\n\n' +
    'المقطع 5 (tercet، الأبيات 13–15): والبجع طالعين، الشريك يقول إنهم "mate for life"؛ المتكلّم ما يردّ، بس الزوجين يكمّلون مشيهم في نور العصر، والمسافة بينهم بهدوء تتقلّص.\n\n' +
    'المقاطع 6–7 (tercet + couplet ختامي، الأبيات 16–20): وهم يمشون شوي شوي على الحصى، المتكلّم ينتبه إن إيديهم "swum" المسافة اللي بينهم، وانطبقت مع بعض مثل "pair of wings settling" لمّا الطير ينزل. العلاقة تنرمّم بدون كلام.',
  ...
  formAndStructure:
    ...
    'Volta: The partner\'s remark in line 13, that swans "mate for life", is the emotional pivot. The partner\'s words about the swans are unmistakably also about the couple, and from that point the poem moves towards reconnection.\n\n' +
    ...
    'Direct speech and silence: The only spoken words belong to the partner (line 13), and the speaker says nothing in reply (line 14). Reconciliation happens not through more words but through the hands, which have "swum" across the gap between them without either of them deciding it (lines 17 to 18).',
  ...
  formAndStructureAr:
    ...
    'Volta: ملاحظة الشريك في البيت 13، إن البجع "mate for life"، هي نقطة التحوّل العاطفيّة. كلمات الشريك عن البجع هي بشكل ما تخفى عن أحد كلمات عن العلاقة نفسها، ومن هذي اللحظة القصيدة تتجه للوصل.\n\n' +
    ...
    'الكلام المباشر والصمت: الكلام الوحيد المنطوق يرجع للشريك (البيت 13)، والمتكلّم ما يردّ (البيت 14). المصالحة ما تحصل بكلام أكثر، تحصل عبر الإيدين اللي "swum" المسافة بينهم بدون ما أحد منهم يقرّر (الأبيات 17–18).',

  keyQuotes: [
    {
      quote: 'given their all',
      analysis:
    ...
    },
    {
      quote: 'gulping',
      analysis:
        "The earth in lines 4 to 5 is personified as drowning, gasping for air. This mirrors the couple's own suffocation within their conflict: they too need space to breathe.",
    ...
    },
    {
      quote: 'unison',
      analysis:
        'The swans dip beneath the water together, perfectly synchronised. The word "unison" pointedly contrasts with the couple, who are "silent and apart"; nature shows them what partnership looks like.',
      themes: ['Nature', 'Unity', 'Reconciliation'],
      analysisAr:
        'البجع يغطس تحت سطح المي بتزامن تام. كلمة "unison" تتناقض بشكل واضح مع وصف الزوجين "silent and apart"؛ الطبيعة تورّيهم كيف تكون الشراكة.',
      themesAr: [
        '\u0627\u0644\u0637\u0628\u064a\u0639\u0629',
        '\u0627\u0644\u0648\u062d\u062f\u0629',
        '\u0627\u0644\u0645\u0635\u0627\u0644\u062d\u0629',
    ...
    },
    {
      quote: 'icebergs',
      analysis:
        'In line 11 the swans are compared to icebergs: most of their substance is hidden beneath the surface. This mirrors both the hidden depths of the relationship and the calm surface that conceals emotional turmoil.',
    ...
    },
    {
      quote: 'mate for life',
      analysis:
        "The only spoken words in the poem, in line 13, belong to the partner, not the speaker. The observation about swans is unmistakably also a statement about the couple, a quiet, indirect plea or affirmation. The speaker does not reply, but the line works as the poem's emotional volta.",
    ...
    },
    {
      quote: 'swum',
      analysis:
        '"Swum", in line 18, picks up the lake and the swans, casting the hands as creatures that have crossed the emotional water on their own. The speaker cannot say how it happened, which preserves the mystery: reconciliation feels almost involuntary, instinctive, beneath conscious decision.',
      themes: ['Love', 'Reconciliation', 'Connection'],
      analysisAr:
        'الفعل "swum" يلتقط البحيرة والبجع، ويصوّر الإيدين كأنها مخلوقات قطعت المي العاطفي بنفسها. والمتكلّم ما يقدر يقول كيف صار هذا، فيبقى الغموض: المصالحة تحسّ بأنها لاإراديّة، غريزيّة، أعمق من القرار الواعي.',
      themesAr: [
        '\u0627\u0644\u062d\u0628',
        '\u0627\u0644\u0645\u0635\u0627\u0644\u062d\u0629',
        '\u0627\u0644\u062a\u0631\u0627\u0628\u0637',
    ...
    {
      quote: 'pair of wings settling',
      analysis:
        'The closing simile, in line 20, fuses the couple with the swans. The folded hands become wings at rest against the body, and "settling" works literally (a bird coming down to land) and metaphorically (turmoil ending). The relationship is at peace.',
      themes: ['Love', 'Unity', 'Nature', 'Peace'],
      analysisAr:
        'الـsimile الختامي يدمج الزوجين مع البجع. الإيدين المطبوقة تصير مثل جناحين مرتاحين على الجسم؛ وكلمة "settling" تشتغل حرفياً (طير ينزل ويرتاح) ومجازياً (الاضطراب انتهى). العلاقة وصلت لحالة سلام.',
      themesAr: [
        '\u0627\u0644\u062d\u0628',
        '\u0627\u0644\u0648\u062d\u062f\u0629',
        '\u0627\u0644\u0637\u0628\u064a\u0639\u0629',
  ...
  languageDevices: [
    {
      ...
      lineRef: 0,
      effectAr:
        '\u0627\u0644\u0637\u0642\u0633 \u064a\u0639\u0643\u0633 \u0627\u0644\u062d\u0627\u0644\u0629 \u0627\u0644\u0639\u0627\u0637\u0641\u064a\u0629 \u0644\u0644\u0639\u0644\u0627\u0642\u0629 \u0637\u0648\u0644 \u0627\u0644\u0642\u0635\u064a\u062f\u0629. \u0627\u0644\u0645\u0637\u0631 \u064a\u0645\u062b\u0651\u0644 \u0627\u0644\u062e\u0644\u0627\u0641\u061b \u0648\u0627\u0644\u0640break \u064a\u0645\u062b\u0651\u0644 \u0625\u0645\u0643\u0627\u0646\u064a\u0651\u0629 \u0627\u0644\u0634\u0641\u0627\u0621. \u0627\u0644\u0637\u0628\u064a\u0639\u0629 \u0648\u0627\u0644\u0639\u0627\u0637\u0641\u0629 \u0645\u0627 \u064a\u0646\u0641\u0635\u0644\u0648\u0646.',
    },
    {
    ...
    {
      device: 'Simile',
      example: 'pair of wings settling',
      effect:
    ...
    },
    {
      ...
      example: 'unison',
      effect:
        'Swans mate for life and move in unison, making them a traditional symbol of fidelity. Their synchronised dipping silently models for the couple what partnership looks like.',
      lineRef: 9,
      effectAr:
        'البجع يقترن لمدى الحياة (mate for life) ويتحرّك بتزامن، فيصير رمز تقليدي للوفاء. الغطس المتزامن يعرض للزوجين بصمت كيف تكون شكل الشراكة.',
    },
    {
      device: 'Metaphor',
      example: 'icebergs',
    ...
    },
    {
      ...
      example: '[Lines 19 to 20] a closing couplet after six tercets',
      effect:
    ...
    },
    {
      ...
      example: 'swum',
      effect:
        "The hands are said to have swum across the gap, as the swans swim, and in the last line they fold like wings: the closing lines borrow the swans' movements for the human hands, fusing couple and birds. The reconciliation is presented as continuous with nature, not separate from it.",
      lineRef: 22,
      effectAr:
        'الإيدين "swum" المسافة مثل ما البجع يسبح، وفي البيت الأخير تنطبق مثل الجناحين: الأبيات الأخيرة تستعير حركات البجع لإيدين البشر، وتدمج الزوجين مع الطيور في الـcouplet الختامي. المصالحة تتقدّم كأنها امتداد للطبيعة، مو منفصلة عنها.',
    },
  ],
}
...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Swans mate for life, making them a perfect symbol for committed love. The partner\'s remark that they "mate for life" prompts the couple to reconnect - nature teaches them about lasting partnership.',
    topic: 'Language',
    difficulty: 'foundation',
  },
  {
    id: 'ws-3',
    question:
      'What does the image of the earth "gulping" for air in lines 4 to 5 suggest about the relationship?',
    type: 'multiple-choice',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      'Their hands have "swum" across the gap between them and folded together like a "pair of wings settling" - reconciliation',
      'They argue again',
      'They watch more birds',
    ],
    correctIndex: 1,
    explanation:
      "The speaker notices their hands have 'swum' across the gap between them and folded over each other, like a 'pair of wings settling' (lines 17 to 20). The reconciliation mirrors the swans' behaviour - nature has shown them the way back to each other.",
    topic: 'Meaning',
    difficulty: 'foundation',
  },
  {
  ...
  {
    id: 'ws-7',
    question: 'What does the remark that swans "mate for life" achieve in the poem?',
    type: 'multiple-choice',
    options: [
      'It is a nature fact',
...
const REVISION_TOPICS = [
  {
    ...
    keyPoints: [
      ...
      'Nature as teacher - the swans model lifelong partnership by dipping in "unison"',
  ...
  },
  {
    ...
    keyPoints: [
      'Swans as symbol - "mate for life" (line 13) mirrors the relationship',
      'Water imagery - rain/waterlogged earth (conflict) vs stilling lake (calm)',
      'The earth "gulping" for air (lines 4 to 5) - pathetic fallacy for the relationship',
      'Hands folded like a "pair of wings settling" (lines 19 to 20) - reconciliation through natural imagery',
    ],
  },
  {
    ...
    keyPoints: [
      ...
      'Volta at line 13, the remark that swans "mate for life" - the emotional pivot',
...
export default function WinterSwansPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Copyright notice - Winter Swans is in copyright (Owen Sheers 2005, published by Seren). The viewer below
      ...
      <footer className="rounded-lg border border-border/40 bg-muted/30 px-4 py-3 text-[11px] leading-relaxed text-muted-foreground space-y-2">
        <p>
          <strong>Rights notice:</strong> <em>Winter Swans</em> &copy; Owen Sheers (b. 1974), 2005.
