...
const beforeYouWereMinePOem: PoemData = {
  ...
  lines: [
    // Stanza 1
    {
      ...
      annotations: [
        { type: 'Time shift', note: 'The speaker projects herself back in time to ten years before her own birth, imagining her mother\'s youth. This creates a possessive, controlling perspective over the past.', color: '#8b5cf6' },
      ],
    },
    {
      text: 'with your pals, Maggie McGeeney and Jean Duff.',
      annotations: [
        { type: 'Detail', note: 'Naming real friends grounds the poem in autobiographical specificity. These are real people from Duffy\'s mother\'s life, giving the poem documentary authenticity.', color: '#3b82f6' },
      ],
    },
    {
      text: 'The three of you bend from the waist, holding',
      annotations: [
        { type: 'Visual imagery', note: 'The image of three young women doubled over with laughter is vivid and joyful. The mother is carefree, young, and full of life \u2014 before motherhood changed everything.', color: '#10b981' },
      ],
    },
    {
      text: 'each other, or your knees, and shriek at the pavement.',
      annotations: [
        { type: 'Verb choice', note: '"Shriek" conveys uninhibited, wild laughter. The mother was loud, free, and unself-conscious \u2014 qualities the speaker associates with her pre-motherhood identity.', color: '#3b82f6' },
      ],
    },
    {
      text: 'Your polka-dot dress blows round your legs. Marilyn.',
      annotations: [
        { type: 'Allusion', note: '"Marilyn" references Marilyn Monroe\'s iconic scene of her dress blowing up. The mother is glamorous and sexy \u2014 an image that clashes with her later identity as "Mum".', color: '#ef4444' },
        { type: 'Caesura', note: 'The full stop before "Marilyn" isolates the word, making it land with dramatic impact \u2014 a single-word sentence that transforms the mother into a movie star.', color: '#8b5cf6' },
      ],
    },
    // Stanza break
    { text: '' },
    // Stanza 2
    {
      ...
      annotations: [
        { type: 'Possessive tone', note: 'The speaker is almost jealous of this time when her mother existed without her. "The thought of me doesn\'t occur" emphasises the mother\'s total freedom from parental responsibility.', color: '#ec4899' },
      ],
    },
    {
      text: 'in the ballroom with the thousand eyes, the fizzy, movie tomorrows',
      annotations: [
        { type: 'Imagery', note: '"Thousand eyes" evokes a glittering dancehall \u2014 disco balls, admiring gazes. "Fizzy" suggests excitement, champagne, effervescence. The mother\'s youth is intoxicating.', color: '#10b981' },
        { type: 'Metaphor', note: '"Movie tomorrows" suggests her future seemed glamorous and full of possibility, like a film. Motherhood was not the script she imagined.', color: '#ef4444' },
      ],
    },
    {
      text: 'the right walk home could bring. I\u2019m the spark',
      annotations: [
        { type: 'Enjambment', note: '"I\'m the spark" runs across the stanza, connecting the mother\'s romantic youth to the speaker\'s own conception. The line break creates a momentary shock.', color: '#8b5cf6' },
      ],
    },
    {
      text: 'that changed your life. Not the angel you\u2019d think of',
      annotations: [
        { type: 'Self-awareness', note: 'The speaker acknowledges she "changed" her mother\'s life \u2014 not necessarily for the better. She rejects the sentimental image of a baby as an "angel".', color: '#f59e0b' },
      ],
    },
    {
      text: 'if you\u2019d looked up from your arms\u2019 content.',
      annotations: [
        { type: 'Ambiguity', note: '"Arms\' content" could mean the content of her arms (a baby) or the contentment her arms feel. Either way, the mother is absorbed in caring for the child, looking down rather than outward.', color: '#f59e0b' },
      ],
    },
    // Stanza break
    { text: '' },
    // Stanza 3
    {
      ...
      annotations: [
        { type: 'Possessive language', note: '"I wanted" is controlling and acquisitive. The speaker claims desire for a version of her mother that existed before her \u2014 as though the mother belongs to her in every era.', color: '#ec4899' },
      ],
    },
    {
      text: 'somewhere in Italy, with a handful of paper roses.',
      annotations: [
        { type: 'Imagery', note: '"Paper roses" are artificial \u2014 beautiful but not real. This hints that the speaker\'s vision of her mother\'s past may be romanticised and constructed from imagination rather than memory.', color: '#10b981' },
      ],
    },
    {
      text: 'The street you\u2019re walking with the confidence of a woman',
      annotations: [
        { type: 'Characterisation', note: 'The mother walks with "confidence" \u2014 she is self-assured, independent, and free. This is a woman who has not yet been defined by motherhood.', color: '#3b82f6' },
      ],
    },
    {
      text: 'should be under my feet. I\u2019d like to be there.',
      annotations: [
        { type: 'Possessive language', note: '"Under my feet" and "I\'d like to be there" express a desire to own, occupy, and control her mother\'s past. The speaker wants to be present in every moment of her mother\'s life.', color: '#ec4899' },
      ],
    },
    // Stanza break
    { text: '' },
    // Stanza 4
    {
      ...
      annotations: [
        { type: 'Colloquial tone', note: '"Reckon" is informal and conversational, suggesting a real mother-daughter exchange. The tone shifts to warmth and intimacy.', color: '#3b82f6' },
      ],
    },
    {
      text: 'you\u2019d dress up in for the walk from the station.',
      annotations: [
        { type: 'Detail', note: 'The mother puts on a special dress just for the short walk from the station \u2014 she takes pride in her appearance, in being seen. Fashion is her self-expression.', color: '#10b981' },
      ],
    },
    {
      text: 'I\u2019m her. I\u2019m the cha-cha-cha on the marble stair.',
      annotations: [
        { type: 'Identification', note: '"I\'m her" \u2014 the speaker identifies completely with her mother, claiming her identity. The cha-cha-cha is a dance of joy and freedom that the mother taught the speaker.', color: '#ec4899' },
        { type: 'Sound', note: '"Cha-cha-cha" is onomatopoeic and rhythmic, evoking the sound of heels on marble stairs. It brings the memory alive through sound.', color: '#f59e0b' },
      ],
    },
    {
      text: 'You sparkle and waltz and laugh and clatter and blow.',
      annotations: [
        { type: 'Polysyndeton', note: 'The repeated "and" creates a breathless, excited list. Each verb captures a different facet of the mother\'s vitality \u2014 she is dazzling, joyful, and alive.', color: '#f59e0b' },
      ],
    },
    {
      text: 'I stamped my feet on that glamorous street.',
      annotations: [
        { type: 'Possessive language', note: '"Stamped my feet" suggests a child\'s tantrum \u2014 demanding attention, demanding ownership. The speaker claims her mother\'s glamorous past as her own territory.', color: '#ec4899' },
        { type: 'Rhyme', note: '"Feet" and "street" create an internal rhyme that ties the speaker physically to her mother\'s world, anchoring her in the glamorous past.', color: '#8b5cf6' },
      ],
    },
    {
      text: 'I\u2019m her. Your ghost. The one who changed your life.',
      annotations: [
        { type: 'Role reversal', note: 'The speaker calls herself her mother\'s "ghost" \u2014 reversing expectations. Usually it is the dead who haunt the living, but here the unborn child haunts the mother\'s past. Motherhood is framed as a kind of death of the mother\'s former self.', color: '#ef4444' },
        { type: 'Repetition', note: '"I\'m her" and "changed your life" are repeated from earlier, creating a cyclical structure. The poem ends where it conceptually began \u2014 with possession and transformation.', color: '#f59e0b' },
      ],
    },
  ],
...
const comparePoems = [
  {
    ...
    reason: 'Both explore the mother-child bond. Duffy looks back possessively at her mother\'s past; Armitage looks forward to the moment of separation.',
  ...
  },
  {
    ...
    reason: 'Both idealise parents in a past setting. Causley places his parents in a heavenly picnic; Duffy places her mother in a glamorous 1950s world.',
  ...
  },
  {
    ...
    reason: 'Both explore connection across distance. Duffy bridges time; Dooley bridges physical distance. Both find intimacy through imagination.',
    ...
    <div className="space-y-8">
      ...
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Before You Were Mine", url: "https://theenglishhub.app/revision/poetry/love-and-relationships/before-you-were-mine" },
        ]}
      />
      {/* ── Back navigation ──────────────────────────────────────── */}
      <div>
      ...
      <div className="flex flex-wrap gap-2">
        {['Love', 'Family', 'Possession', 'Nostalgia', 'Identity', 'Youth'].map(
          (theme) => (
