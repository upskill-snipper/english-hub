...
const followerPoem: PoemData = {
  ...
  lines: [
    // Stanza 1
    {
      ...
      annotations: [
        {
          type: 'Setting',
          note: 'Opens with manual, pre-industrial farming. The horse-plough places this in a traditional Irish rural world that is already passing.',
          color: '#3b82f6',
        },
      ],
    },
    {
      ...
      annotations: [
        {
          type: 'Simile',
          note: 'Nautical imagery presents the father as powerful and commanding, his shoulders billowing like sails. It elevates manual labour to something heroic.',
          color: '#10b981',
        },
      ],
    },
    ...
    // Stanza 2
    {
      ...
      annotations: [
        {
          type: 'Fragment',
          note: "The blunt, two-word sentence is emphatic and definitive. Its brevity mirrors the father's no-nonsense, practical character.",
          color: '#f59e0b',
        },
      ],
    },
    ...
    { text: 'Narrowed and angled at the ground,' },
    {
      ...
      annotations: [
        {
          type: 'Precision',
          note: '"Mapping" elevates ploughing to an intellectual skill. "Exactly" reinforces the father\'s perfectionism and mastery of his craft.',
          color: '#3b82f6',
        },
      ],
    },
    ...
    { text: 'All I ever did was follow' },
    {
      ...
      annotations: [
        {
          type: 'Metaphor',
          note: 'The father\'s "broad shadow" represents both his physical dominance and his overwhelming influence on the child\'s identity. The child is literally overshadowed.',
          color: '#10b981',
        },
      ],
    },
  ...
  keyQuotes: [
    ...
    },
    {
      quote: 'An expert',
      analysis:
        "The blunt, two-word sentence fragment is emphatic and definitive. Its brevity mirrors the father's no-nonsense, practical character.",
      themes: ['Skill', 'Admiration', 'Father'],
      analysisAr:
        '\u0627\u0644\u0640sentence fragment \u0645\u0646 \u0643\u0644\u0645\u062a\u064a\u0646\u060c \u062d\u0627\u062f\u0651 \u0648\u0642\u0627\u0637\u0639. \u0627\u062e\u062a\u0635\u0627\u0631\u0647 \u064a\u0639\u0643\u0633 \u0634\u062e\u0635\u064a\u0629 \u0627\u0644\u0623\u0628 \u0627\u0644\u0639\u0645\u0644\u064a\u0629 \u0627\u0644\u0644\u064a \u0645\u0627 \u062a\u0637\u0648\u0651\u0644 \u0628\u0627\u0644\u0643\u0644\u0627\u0645.',
      themesAr: [
        '\u0627\u0644\u0645\u0647\u0627\u0631\u0629',
        '\u0627\u0644\u0625\u0639\u062c\u0627\u0628',
        '\u0627\u0644\u0623\u0628',
  ...
  languageDevices: [
    {
      ...
      lineRef: 1,
      effectAr:
        'مقارنة الأب بسفينة ترفعه إلى مرتبة شي قوي وآمر. والولد يتبع "wake" أبوه (أثره في الماء) مثل سفينة صغيرة تجرّها سفينة كبيرة.',
    },
    {
    ...
    },
    {
      ...
      lineRef: 8,
      effectAr:
        'كسر السطر يحاكي حركة جذب الـreins (اللجام) الحادّة، ويخلّي القارئ يحسّ جسدياً بدورة فريق الحرث.',
    },
    {
      device: 'Volta',
    ...
    {
      device: 'Ambiguity',
      example: 'will not go away',
      effect:
        "The final phrase resists simple interpretation: is it irritation, love, guilt, or the inescapable presence of family? The ambiguity is the poem's emotional power.",
      lineRef: 28,
      effectAr:
        'العبارة الأخيرة ترفض القراءة البسيطة: هل هو ضيق، أو حب، أو إحساس بالذنب، أو حضور العائلة اللي ما يقدر أحد يهرب منه؟ هذا الـambiguity هو سرّ القوة العاطفية في القصيدة.',
    },
  ],
}
...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    ...
    options: [
      'A boy following his friend to school',
      "A son's admiration for his father's farming skill, and the role reversal as the father ages",
      'A farmer describing his daily routine',
      'A teacher and student',
    ],
    correctIndex: 1,
    explanation:
      'The speaker recalls following his father as a child, admiring his ploughing skill. The poem ends with a reversal: now the aged father follows the adult son, "stumbling" behind.',
    topic: 'Meaning',
  ...
  {
    id: 'fol-3',
    question: 'What is the effect of the role reversal in the final stanza?',
    type: 'multiple-choice',
    options: [
      'It is humorous',
  ...
  },
  {
    ...
    type: 'multiple-choice',
    options: ['Free verse', 'Six quatrains with a half-rhyme scheme', 'A sonnet', 'Blank verse'],
    correctIndex: 1,
    explanation:
      "Six regular quatrains with a consistent half-rhyme pattern. The neat, controlled form mirrors the father's precise, expert ploughing.",
    topic: 'Structure',
    difficulty: 'foundation',
  },
  {
    id: 'fol-5',
    question: "Who is Seamus Heaney and what is the poem's context?",
    type: 'multiple-choice',
    options: [
      'An English war poet',
    ...
    correctIndex: 1,
    explanation:
      'Seamus Heaney (1939-2013) grew up on a farm in Northern Ireland. Follower draws on real memories of watching his father plough, combining personal experience with universal themes of ageing and admiration.',
    topic: 'Context',
    difficulty: 'higher',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      '"Stumbled" contrasts with the father\'s expert movement. The child tries to follow but falls short, emphasising both his admiration and his inability to match his father\'s mastery.',
    topic: 'Language',
    difficulty: 'higher',
  },
  {
    id: 'fol-7',
    question: 'What is significant about the word "nuisance" in the final stanza?',
    type: 'multiple-choice',
    options: [
      'It is affectionate',
  ...
  {
    id: 'fol-8',
    question: 'How does Heaney use technical farming vocabulary?',
    type: 'multiple-choice',
    options: [
  ...
  {
    id: 'fol-9',
    question: 'What does the shift from past to present tense achieve?',
    type: 'multiple-choice',
    options: [
      'Nothing particular',
    ...
    correctIndex: 1,
    explanation:
      'The shift from past tense (childhood memories) to present tense (the father following now) makes the role reversal immediate and emotionally confronting. The past is nostalgic; the present is uncomfortable.',
    topic: 'Structure',
    difficulty: 'grade-9',
  },
  {
    id: 'fol-10',
    question: 'Which poem pairs best with Follower?',
    type: 'multiple-choice',
    options: [
      "Porphyria's Lover",
    ...
    correctIndex: 1,
    explanation:
      "Both Follower and Walking Away explore parent-child relationships across time. Follower is from the child's perspective looking up at a father; Walking Away is from the parent's perspective letting go.",
    topic: 'Comparison',
    difficulty: 'grade-9',
  },
]
...
const comparePoems = [
  ...
  },
  {
    ...
    reason:
      "Both use rural farming settings and dialect to establish voice. Heaney's speaker admires his father's skill; Mew's farmer reveals possessiveness through his rural dialect.",
