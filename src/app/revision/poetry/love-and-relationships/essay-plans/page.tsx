...
const ESSAY_PLANS: EssayPlan[] = [
  ...
  {
    id: 5,
    question: 'Compare how poets use nature to explore love in "Winter Swans" and one other poem.',
    poemA: 'Winter Swans',
    poemB: "Love's Philosophy",
    thesis:
    ...
    paragraphs: [
      {
        ...
        poemAPoint:
          'Sheers presents the swans as a wordless lesson in reconciliation -- their movements demonstrate how couples can recover balance naturally.',
        poemAQuote: '"porcelain over the stilling water"',
        poemBPoint:
    ...
    paragraphs: [
      {
        ...
        poemAQuote: '"We caught her, fetched her home"',
        poemBPoint:
      ...
      },
      {
        ...
        poemBQuote: '"I do not think of thee"',
    ...
    paragraphs: [
      {
        ...
        poemAPoint:
          'Dooley uses physical, sensory detail of the man\'s outdoor work -- "in February, digging his garden" -- to make his world felt through the page, collapsing distance.',
        ...
        <div className="flex gap-3">
          ...
          <div className="space-y-1">
            ...
            <p className="text-body-xs text-muted-foreground leading-relaxed">
              ...
              Always read and annotate the complete texts in your AQA anthology.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-border/40 bg-background/50 p-4">
            ...
            <p className="text-body-sm text-muted-foreground leading-relaxed">
              These plans model how to build a comparative argument. Learn the pattern -- thesis,
              point-by-point paragraphs, linking sentence -- then apply it to any pairing.
            </p>
          </div>
          <div className="rounded-xl border border-border/40 bg-background/50 p-4">
            <div className="mb-2 flex items-center gap-2">
            ...
            <p className="text-body-sm text-muted-foreground leading-relaxed">
              ...
              practise picking strong pairings and shaping a thesis around the specific question
              wording.
            </p>
          </div>
          <div className="rounded-xl border border-border/40 bg-background/50 p-4">
            ...
            <p className="text-body-sm text-muted-foreground leading-relaxed">
              ...
              cap your mark. Instead, internalise the thesis-building and paragraph-framing skills
              demonstrated here.
            </p>
          </div>
          <div className="rounded-xl border border-border/40 bg-background/50 p-4">
            ...
            <p className="text-body-sm text-muted-foreground leading-relaxed">
              ...
              point-by-point method -- it scores comparison marks in every paragraph, not just at
              the end.
            </p>
          </div>
        </div>
        ...
        {ESSAY_PLANS.map((plan) => (
          ...
          >
            ...
            <div className="border-b border-border/40 bg-gradient-to-r from-rose-500/[0.06] to-transparent p-5 sm:p-6">
              ...
              <h3 className="text-heading-md font-heading text-foreground">{plan.question}</h3>
            </div>
