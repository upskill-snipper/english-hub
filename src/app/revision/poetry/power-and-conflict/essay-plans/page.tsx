...
const ESSAY_PLANS: EssayPlan[] = [
  // ────────────────────────────────────────── 1
  {
    id: 1,
    question:
      'Compare how power is presented in Ozymandias and one other poem from the anthology.',
    poemA: 'Ozymandias',
    poetA: 'Shelley',
    ...
    paragraphs: [
      ...
      {
        point:
          'Both poets use form and structure to reflect the nature of power they describe.',
  ...
  // ────────────────────────────────────────── 2
  {
    ...
    paragraphs: [
      ...
      {
        point:
          'Both poets challenge romanticised views of war by foregrounding its human cost.',
        evidence1: '"his blood-Loss MY blood-shadow"',
        evidence1poem: 'Remains',
        analysis1:
    ...
    paragraphs: [
      {
        ...
        evidence2: '"the world had tilted"',
      ...
      {
        point:
          'Both poems end with a sense of helplessness and unresolved grief.',
  ...
  // ────────────────────────────────────────── 5
  {
    ...
    introduction:
      'Both Agard and Rumens explore how identity is shaped by history and belonging. Checking Out Me History is an angry challenge to a colonial education system that erased Black history, while The Emigree presents a speaker who clings to memories of a homeland she can never return to. Both poets present identity as something worth fighting for.',
    paragraphs: [
      {
        point:
          'Both poets present identity as being threatened by powerful external forces.',
        ...
        evidence2: '"They blocked the sunlight in my city of words"',
        evidence2poem: 'The Emigree',
        analysis2:
          'Rumens uses the pronoun "They" to represent unnamed oppressive forces -- political regimes, borders, or hostile attitudes -- that threaten the speaker\'s connection to her homeland. The metaphor of blocking "sunlight" suggests these forces try to darken and destroy the idealized memories that sustain her identity. The "city of words" represents identity constructed through language and memory.',
      ...
      {
        point:
          'Both poets use contrasting imagery to highlight what has been lost or suppressed.',
        ...
        evidence2: '"my city takes me dancing through the city of walls"',
        evidence2poem: 'The Emigree',
        analysis2:
          'Rumens contrasts the speaker\'s remembered "city" (light, warmth, freedom) with the present "city of walls" (barriers, confinement, hostility). The personification of memory "dancing" suggests joy and defiance -- the remembered homeland is so powerful it can overcome present-day oppression. Identity rooted in memory proves stronger than political reality.',
    ...
    grade5approach:
      'Identify that both poems are about identity being threatened. Quote "blind me" and "city of walls" and explain the imagery. State: "Both speakers fight for their identity."',
    grade9approach:
    ...
    paragraphs: [
      {
        ...
        analysis2:
          'Tennyson\'s driving dactylic rhythm mimics the thundering hooves of cavalry. The repetition creates momentum and a sense of unstoppable forward movement. Unlike Hughes\'s chaos, this rhythm is ordered and purposeful -- it glorifies the charge as collective heroism. The regularity of the metre reflects the disciplined obedience of the soldiers.',
      ...
      },
      {
        ...
        evidence1poem: 'Bayonet Charge',
        analysis1:
          'Hughes dismisses patriotic ideals with the devastatingly dismissive "etcetera" -- noble concepts are reduced to an afterthought. The simile "dropped like luxuries" suggests that in the moment of real violence, abstract values are worthless burdens the soldier cannot afford to carry. Hughes argues that battlefield reality strips away all ideology.',
      ...
      },
      {
        ...
        evidence1: '"his foot hung like a survey of the field"',
        evidence1poem: 'Bayonet Charge',
        analysis1:
  ...
  // ────────────────────────────────────────── 7
  {
    id: 7,
    question:
      'Compare how poets present memory and guilt in Remains and one other poem.',
    poemA: 'Remains',
    poetA: 'Armitage',
    ...
    paragraphs: [
      {
        point:
          'Both poets show how memory transforms from manageable to overwhelming.',
  ...
  // ────────────────────────────────────────── 8
  {
    id: 8,
    question:
      'Compare how poets present the abuse of power in London and one other poem.',
    poemA: 'London',
    poetA: 'Blake',
    ...
    paragraphs: [
      ...
      {
        point:
          'Both poets use powerful imagery to show the damage caused by institutional power.',
  ...
  // ────────────────────────────────────────── 9
  {
    ...
    paragraphs: [
      {
        point:
          'Both poets use central symbols to represent the impermanence of human achievement.',
      ...
      {
        point:
          'Both poets critique the human desire to build lasting monuments to power.',
        ...
        evidence2: '"Fine slips from grocery shops / that drift through fingertips"',
        evidence2poem: 'Tissue',
        analysis2:
          'Dharker presents the records of daily commerce -- receipts, lists -- as ephemeral. They "drift through fingertips", refusing to be held permanently. This is presented not as loss but as natural, organic movement. Dharker implies that the human structures built on paper (borders, money, identity) are less substantial than we believe.',
      ...
      },
      {
        ...
        evidence2: '"turned into your own skin"',
        evidence2poem: 'Tissue',
        analysis2:
          'Dharker\'s final stanza shifts from paper to skin -- the most personal, organic material. The poem suggests that our true identity is not found in the structures we build but in our own bodies, our own humanity. This is both a celebration of human fragility and a rejection of the artificial power structures (borders, money) that paper represents.',
  ...
  // ────────────────────────────────────────── 10
  {
    ...
    paragraphs: [
      {
        point:
          'Both poets present duty as a powerful force that overrides individual choice.',
      ...
      },
      {
        ...
        evidence2: '"which was the better way to die"',
        evidence2poem: 'Kamikaze',
        analysis2:
    ...
    <div className="space-y-10 pb-16">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-card via-card to-amber-500/[0.04] p-6 sm:p-8 lg:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-3 max-w-2xl text-body-lg text-muted-foreground">
            Ten ready-made essay plans for the most common AQA Power &amp;
            Conflict comparison questions. Each plan includes a full
            introduction, three PEEL comparison paragraphs, and a conclusion
            &mdash; with Grade&nbsp;5 and Grade&nbsp;9 approaches so you can see
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-border/40 bg-background/50 p-4">
            ...
            <p className="text-body-sm text-muted-foreground leading-relaxed">
              Each plan answers a real AQA-style comparison question. In the
              exam, the named poem is printed for you; the second poem is your
              choice.
            </p>
          </div>
          <div className="rounded-xl border border-border/40 bg-background/50 p-4">
            ...
            <p className="text-body-sm text-muted-foreground leading-relaxed">
              Each paragraph follows Point &rarr; Evidence &rarr; Explain &rarr;
              Link. Notice how Grade&nbsp;9 responses go beyond meaning to
              analyse methods and context.
            </p>
          </div>
          <div className="rounded-xl border border-border/40 bg-background/50 p-4">
            <p className="mb-1 text-sm font-semibold text-foreground">
            ...
            <p className="text-body-sm text-muted-foreground leading-relaxed">
              Use these plans as models, then practise with different poem
              pairings. The more plans you write, the faster you&apos;ll work in
              the exam.
            </p>
          </div>
        </div>
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8 text-center">
        ...
        <p className="mx-auto mt-2 max-w-lg text-body-sm text-muted-foreground">
          Read our comparison guide for step-by-step techniques, or explore
          themes to find the best poem pairings.
        </p>
      ...
      <p className="text-xs text-muted-foreground mt-4 border-t border-border/60 pt-4">
        Quotations from Shelley, Blake, Wordsworth, Browning, Tennyson, and Owen
        are in the public domain. Short quotations from copyrighted poems are
        used for the purpose of criticism and review.
      </p>
    </div>
  )
}
