  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <Section title="Inference and Deduction" icon={Eye} colour="text-violet-400">
        <div className="space-y-4">
          <p className="text-body-sm text-muted-foreground leading-relaxed">
            ...
            logical conclusions. Both are essential for AQA Q2, Q3, and Q4.
          </p>
      ...
      <Section title="Comparison Techniques" icon={BarChart3} colour="text-cyan-400">
        <div className="space-y-4">
          <p className="text-body-sm text-muted-foreground leading-relaxed">
            Paper 2 Question 4 (or its equivalent) always asks you to compare how two writers
            present their ideas. This is worth the most marks on the reading section, so a
            strong comparison technique is essential.
          </p>
