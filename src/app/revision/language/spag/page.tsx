...
export default function SpagPage() {
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="rounded-xl border border-amber-500/20 bg-amber-500/[0.04] p-4 flex items-start gap-3">
        ...
        <p className="text-body-sm text-muted-foreground leading-relaxed">
          SPaG marks are available on every writing question across both papers.
          On AQA, up to 16 marks (out of 40 for each writing question) are
          awarded for &ldquo;technical accuracy&rdquo; -- that means spelling,
          punctuation, grammar, and sentence control. Getting these basics right
          is one of the fastest ways to boost your grade.
        </p>
      </div>
