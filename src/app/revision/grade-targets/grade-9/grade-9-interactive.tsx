  ...
  return (
    <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
      ...
      <p className="text-body-sm text-muted-foreground mb-5">
        Both responses analyse the same moment from {exampleTitle} by {exampleAuthor}. The{' '}
        {higherLabel} response does not just analyse more - it thinks differently.
      </p>
      ...
      {show && (
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-amber-500/20 bg-amber-500/[0.03] p-5">
            <Badge className="mb-3 bg-amber-500/20 text-clay-600 border-amber-500/30">
              {higherLabel}
            </Badge>
