...
export const metadata: Metadata = {
  title: 'How to Get a Grade 9 in GCSE English',
  description:
    'Aim for a Grade 9 in GCSE English with conceptualised, critical and original analysis: what separates the very top answers from strong Grade 7 work.',
  alternates: { canonical: 'https://theenglishhub.app/revision/grade-targets/grade-9' },
}
    ...
    <div className="space-y-10 pb-16">
      ...
      {isLetterSystem && (
        <div className="rounded-xl border border-primary/20 bg-primary/[0.04] p-4 flex items-start gap-3">
          ...
          <div className="text-xs text-muted-foreground leading-relaxed">
            ...
            For Cambridge IGCSE, a <span className="font-semibold text-foreground">Grade A*</span>{' '}
            is the equivalent of the top of the{' '}
            <span className="font-semibold text-foreground">9-1 scale (Grade 8-9)</span>. The advice
            below describes that top-band thinking.
          </div>
        </div>
      )}
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        ...
        <p className="text-body-sm text-muted-foreground mb-5 max-w-3xl">
          {displayGradeLabel} is the top grade, achieved by a small percentage of students. Markers
          describe this level of work as &quot;exploratory&quot;, &quot;critical&quot;, and
          &quot;conceptualised.&quot; The key distinction from the grade below is not more analysis
        ...
        {boardConfig && boundary.percent !== null && (
          <div className="mb-5 rounded-xl border border-primary/20 bg-primary/[0.04] p-4">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              to reach {boundary.label} in {boardConfig.shortName}. This is the top grade - roughly
              3-5% of students achieve it.
              {boundary.systemNote && (
                <>
                  {' '}
        ...
        <div className="mt-5 flex items-start gap-2.5 rounded-lg border border-amber-500/20 bg-amber-500/[0.04] p-4">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            {displayGradeLabel} is not about writing more. Many top-grade essays are the same length
            as mid-band ones. The difference is in the quality and originality of the thinking, not
            the quantity.
          </p>
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-heading-md font-heading text-foreground">
            What &quot;Conceptualised&quot; Actually Means
          </h2>
        </div>

        <p className="text-body-sm text-muted-foreground mb-5 max-w-3xl">
          This is the most important word in the top-grade marking guide and the most misunderstood.
          A conceptualised response is not just detailed analysis - it is analysis organised around
          a big idea that runs through your whole essay.
        </p>

        <div className="space-y-5">
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            <h3 className="text-sm font-semibold text-foreground mb-2">
              A non-conceptualised essay:
            </h3>
            <p className="text-xs text-muted-foreground leading-relaxed">
              Analyses the text point by point, quote by quote. Each paragraph is a separate
              observation. The essay is a list of good points, but they do not connect to each
              other.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Is driven by one central argument or concept that every paragraph develops,
              complicates, or refines. The essay has a thesis - a controlling idea that evolves
              across the response.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-primary/20 bg-primary/[0.04] p-5">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-xs text-muted-foreground">
                  &quot;The writer presents guilt as a destructive force that torments the
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-xs text-muted-foreground">
                  &quot;Guilt is presented not as a consequence of sin but as proof of humanity -
                  the tragedy is that guilt reveals the protagonist was never truly a villain, but a
                  person who destroyed themselves by betraying their own nature.&quot;
                </p>
              </div>
            </div>
          </div>
      ...
      {/* ── Iceberg analysis & authorial methods ────────────── */}
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        <div className="flex items-center gap-3 mb-5">
          <div className="flex size-9 items-center justify-center rounded-lg bg-cyan-500/10">
            <Eye className="size-4.5 text-cyan-400" />
          </div>
          <h2 className="text-heading-md font-heading text-foreground">
            Iceberg Analysis and Authorial Methods
          </h2>
        </div>

        <p className="text-body-sm text-muted-foreground mb-5 max-w-3xl">
          Two related habits separate top-band thinking from competent analysis: looking beneath the
          surface (iceberg analysis) and treating every textual feature as a deliberate authorial
          choice.
        </p>

        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            <h3 className="text-sm font-semibold text-foreground mb-2">Iceberg analysis</h3>
            <p className="text-xs text-muted-foreground leading-relaxed mb-3">
              Mid-band responses analyse what the text explicitly says. Top-band responses analyse
              what the text <span className="italic">implies</span> - the meaning beneath the
              surface. Ask yourself: what is the writer choosing <span className="italic">not</span>{' '}
              to say? What is hinted at, repressed, or left ambiguous?
            </p>
            <p className="text-xs text-muted-foreground leading-relaxed italic">
              Example: a character&apos;s silence in a scene can be more revealing than their
              dialogue - silence can encode shame, complicity, or resistance the writer refuses to
              spell out.
            </p>
          </div>

          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            <h3 className="text-sm font-semibold text-foreground mb-2">Authorial methods</h3>
            <p className="text-xs text-muted-foreground leading-relaxed mb-3">
              At the top of the mark scheme, every analytical sentence treats the writer as a
              deliberate maker of choices. Replace &quot;this shows&quot; with &quot;Shakespeare
              chooses X to&hellip;&quot; or &quot;Dickens constructs Y in order to&hellip;&quot;.
            </p>
            <p className="text-xs text-muted-foreground leading-relaxed italic">
              The shift is from describing what is in the text to interrogating why the writer
              crafted it that way - and what alternatives they consciously rejected.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        ...
        <p className="text-body-sm text-muted-foreground mb-5 max-w-3xl">
          Top responses show awareness that texts can be read in multiple ways. You do not need to
          name literary critics - but you do need to show that you can hold two (or more)
          interpretations at once and evaluate which is more convincing.
        </p>

        <div className="space-y-4">
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            <h3 className="text-sm font-semibold text-foreground mb-2">
              Reading through different lenses
            </h3>
            <div className="grid gap-3 sm:grid-cols-2 mt-3">
              {[
                {
                  lens: 'Feminist reading',
                  example: 'How does the text present gender roles? Whose voice is silenced?',
                },
                {
                  lens: 'Marxist reading',
                  example:
                    'How does the text present class? Who has power? Is wealth deserved or exploitative?',
                },
                {
                  lens: 'Post-colonial reading',
                  example: 'Whose perspective is centred? Are other cultures othered?',
                },
                {
                  lens: 'Psychoanalytic reading',
                  example:
                    'What drives the character beneath the surface? What are they repressing?',
                },
                {
                  lens: 'Ecocritical reading',
                  example:
                    'How is the natural world presented? Is it a backdrop, a victim, or a moral force?',
                },
              ].map((item) => (
          ...
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            <h3 className="text-sm font-semibold text-foreground mb-2">
              Phrases for offering alternative readings
            </h3>
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        ...
        <p className="text-body-sm text-muted-foreground mb-5 max-w-3xl">
          Top-grade writing does not use big words for the sake of it. The vocabulary is precise -
          ...
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            ...
            <div className="flex flex-wrap gap-1.5">
              {[
                ...
                <span
                  key={word}
                  className="rounded-md bg-violet-500/10 px-2 py-1 text-[11px] font-medium text-violet-400"
                >
                  {word}
                </span>
              ))}
          ...
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            ...
            <div className="flex flex-wrap gap-1.5">
              {[
                ...
                <span
                  key={word}
                  className="rounded-md bg-amber-500/10 px-2 py-1 text-[11px] font-medium text-clay-600"
                >
                  {word}
                </span>
              ))}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-center sm:text-left">
            ...
            <p className="text-body-sm text-muted-foreground max-w-md">
              Top-grade skills build on earlier techniques. Make sure those foundations are solid
              before pushing for the top.
            </p>
          </div>
