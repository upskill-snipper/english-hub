    ...
    <div className="space-y-10 pb-16">
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        ...
        {boardConfig && boundary.percent !== null && (
          <div className="mb-5 rounded-xl border border-primary/20 bg-primary/[0.04] p-4">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              You need approximately <span className="font-semibold text-primary">{boundary.percent}%</span> of total marks to reach {boundary.label} in {boardConfig.shortName}.
        ...
        <div className="mt-5 flex items-start gap-2.5 rounded-lg border border-emerald-500/20 bg-emerald-500/[0.04] p-4">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            {displayGradeLabel} responses do not just explain what a technique does — they consider why the writer chose it, what alternatives existed, and how it connects to the bigger picture.
          </p>
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-heading-md font-heading text-foreground">Upgrading to the Top Band</h2>
        </div>
        <p className="text-body-sm text-muted-foreground mb-5 max-w-3xl">
          If you are consistently getting mid-band grades, you already have the foundations. Here are the specific shifts that take you into the top band:
        </p>
      ...
      <section className="rounded-2xl border border-border/60 bg-card p-6 sm:p-8">
        ...
        <div className="space-y-5">
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Analyse a single word in microscopic detail, then zoom out to show how it connects to a bigger theme or idea. This creates analytical depth.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Rather than analysing one technique, identify a pattern of related words (a semantic field) and explain what it cumulatively creates. This is much more impressive than analysing each word separately.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Top students notice what the writer chooses not to include — silences, gaps, omissions. Commenting on absence shows sophisticated thinking.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Do not just say &quot;the poem has 6 stanzas.&quot; Explain what the structural choices do. Does the text shift tone halfway through? Does the ending mirror or subvert the opening? Structural comments should explain how form contributes to meaning.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border/40 bg-background/50 p-5">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              In your essay, show how an idea develops, shifts, or intensifies across the text. This shows you understand the text as a whole, not just isolated moments.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-border/60 bg-gradient-to-r from-primary/[0.06] via-card to-amber-500/[0.04] p-6 sm:p-8 text-center">
        ...
        <p className="text-body-sm text-muted-foreground mb-5 max-w-lg mx-auto">
          The very top grades are distinguished by conceptualised thinking, critical engagement, and sophisticated expression. See what the very top looks like.
        </p>
