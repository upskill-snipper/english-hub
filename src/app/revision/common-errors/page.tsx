...
const ERROR_GROUPS: ErrorGroup[] = [
  {
    ...
    errors: [
      {
        number: 1,
        text: 'Ozymandias — "Look ON my Works"',
        wrong: '"Look UPON my works, ye Mighty, and despair!"',
        right: '"Look ON my Works, ye Mighty, and despair!"',
        why: 'Shelley wrote "on" — not "upon". This is one of the single most-misquoted lines in GCSE Literature. Cite it exactly: "Look on my Works, ye Mighty, and despair!"',
      },
      {
        number: 2,
        text: 'The Charge of the Light Brigade — "Theirs not to REASON why"',
        wrong: '"Theirs not to question why,"',
        right: '"Theirs not to reason why, / Theirs but to do and die"',
        why: 'Tennyson\'s line is "reason", not "question". The misquote is so widespread that even some teaching materials get it wrong — always check against the original.',
      },
      {
        number: 3,
        text: 'Bayonet Charge — "etcetera"',
        wrong: '"etc." or doubled to "etcetera etcetera"',
        right: '"King, honour, human dignity, etcetera"',
        why: 'Hughes writes "etcetera" once — cite exactly as printed; do not abbreviate to "etc.", and don\'t double the word. The single, dragged-out word mimics the soldier\'s exhaustion and the cliché of patriotic rhetoric reduced to throwaway filler.',
      },
      {
        number: 4,
        text: 'Tissue (Dharker) — final line stands ALONE',
        ...
        why: 'The structural isolation of the closing line is a deliberate choice by Dharker. Quoting it inside another stanza misrepresents the form. Always note that the final line is structurally separate.',
      },
      {
        number: 5,
        text: 'Exposure (Owen) — "knive" is NOT a typo',
        ...
        why: 'Owen uses "knive" as a verb to make the wind itself a violent agent. Editing or "correcting" it removes the writer\'s craft. Quote it exactly as published.',
      },
    ],
  },
  {
    ...
    errors: [
      {
        number: 6,
        text: 'Drummer Hodge — Second Boer War, NOT WWI',
        ...
        why: 'Hardy died in 1928 but the poem predates WWI. Treating it as a WWI poem fundamentally misreads the imperial context (British soldiers fighting in South Africa, the unfamiliar Southern Hemisphere stars, the colonial setting).',
      },
      {
        number: 7,
        text: 'Bayonet Charge — Hughes did NOT fight in WWI',
        ...
        why: "Hughes was a child during WWII, not a soldier in WWI. The imagined nature of the experience is part of the poem's power — it shows war trauma transmitted across generations.",
      },
      {
        number: 8,
        text: 'Remains (Armitage) — Armitage never served',
        ...
        why: 'The poem is researched and imagined, not autobiographical. Linking PTSD in the poem to the writer\'s "own experience" is factually wrong and undermines your AO3 mark.',
      },
    ],
  },
  {
    ...
    errors: [
      {
        number: 9,
        text: 'Blessing (Imtiaz Dharker) — set in INDIA',
        ...
        why: 'The setting is essential context. Misplacing the poem to a different continent makes any contextual point about colonialism, geography, or culture inaccurate.',
      },
      {
        number: 10,
        text: 'Eden Rock (Causley) — the place is INVENTED',
        ...
        why: "The invented setting matters — it allows Eden Rock to function as a symbolic threshold between life and death rather than a literal Cornish landscape. Don't pin it to a real map.",
      },
      {
        number: 11,
        text: 'The Émigrée — the city is UNNAMED on purpose',
        ...
        why: "The anonymity is the point: the poem is about every exile, every lost home. Specifying a city collapses Rumens's deliberately universal frame into one particular conflict.",
      },
    ],
  },
  {
    ...
    errors: [
      ...
      {
        number: 16,
        text: 'Funeral Blues (Auden) — use 1940 REVISED version',
        ...
        why: 'The 1936 version differs in wording and tone. The 1940 revision is the version most anthologies (and most readers) know — quote that one.',
      },
      {
        number: 17,
  ...
  },
  {
    ...
    errors: [
      {
        number: 19,
        text: 'C. Day-Lewis — surname is HYPHENATED',
        wrong: '"C. Day Lewis" or "Cecil Day Lewis"',
        right: '"C. Day-Lewis" — the surname is hyphenated.',
        why: 'It\'s "Day-Lewis", not "Day Lewis". Misspelling the writer\'s name in an essay signals you don\'t know the text well.',
      },
      {
        number: 20,
        text: "The Émigrée — accents on BOTH final e's",
        wrong: '"The Emigree"',
        right: '"The Émigrée" — accents required on both é\'s.',
        why: "The French spelling is part of the title. Dropping the accents changes the word's meaning and origin (it specifically signals a female exile, in French). Use É and é.",
      },
      {
        number: 21,
        text: 'Walking Away — dedicated to SEAN, not Daniel',
        ...
        why: "The poem describes watching Sean walk away to school for the first time. Naming the wrong son not only is factually wrong but undermines the personal context that's central to the poem.",
      },
    ],
  },
  {
    ...
    errors: [
      {
        number: 22,
        text: 'Frankenstein — "It\'s alive!" is FILM ONLY',
        ...
        why: 'Citing a film line as a novel quotation in an essay is an instant credibility loss — the examiner knows the text and will deduct accordingly.',
      },
      {
        number: 23,
        text: 'Animal Farm — restricted (Orwell estate)',
        ...
        why: "This affects what we can publish, not what you write. Quote freely in your own exam answer — this flag is for the platform's rights handling.",
      },
      {
        number: 24,
        text: 'Robert Frost — UK copyright until 2033/34',
        ...
        why: 'Affects platform hosting, not exam answers. You can still quote and analyse Frost in any exam essay.',
      },
      {
        number: 25,
        text: 'Theme for English B (Hughes) — UK copyright until 2038',
        ...
        why: 'Platform rights flag. In exam essays, quote and analyse Hughes as you would any anthologised poet.',
      },
      {
        number: 26,
        text: 'Zephaniah and Alagiah — estates now hold rights',
        wrong:
        ...
        why: 'Affects rights handling and biographical context (when discussing the writer in present tense versus past tense). Both writers are anthologised and remain examinable.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    errors: [
      {
        number: 29,
        text: 'Cambridge IGCSE 2026-27 — set texts not yet confirmed',
        wrong: 'Assuming current Cambridge IGCSE set texts will continue unchanged.',
        right:
          'Cambridge IGCSE 2026-27 set texts are not yet confirmed. Flag as pending and check the latest Cambridge specification.',
        why: 'Set texts can rotate. Always confirm with the current Cambridge specification document before locking in your revision plan.',
      },
      {
        number: 30,
        text: 'Decomposition (Ghose) — low public documentation',
        ...
        why: 'Less-anthologised poems often have unreliable online write-ups. Always work from the printed anthology text where possible.',
      },
    ],
  },
]
