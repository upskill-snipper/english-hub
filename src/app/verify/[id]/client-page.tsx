...
export default function VerifyPage() {
  ...
  async function verifyCertificate() {
    ...
    // P1-SEC-3: call the minimum-field SECURITY DEFINER RPC rather than
    // `select * from certificates`, which (while gated on a known-UUID)
    // exposes user_id and assessment_attempt_id to any anon caller. The
    ...
    setFound(true)
    setStudentName(cert.student_name || 'Student')
    setLoading(false)
  }
      ...
      <div className="max-w-lg w-full">
        ...
        <div className="bg-card border border-primary/30 rounded-2xl overflow-hidden">
          ...
          <div className="bg-primary/10 border-b border-primary/20 px-6 py-4 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-primary">Certificate Verified</h1>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground font-semibold">{certificate.grade}</p>
                </div>
              </div>
