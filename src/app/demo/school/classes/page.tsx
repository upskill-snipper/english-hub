    ...
    <div>
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full rounded-lg border border-border bg-card ps-10 pe-10 py-2.5 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
        />
        {search && (
          <button
            onClick={() => setSearch('')}
