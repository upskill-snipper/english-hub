    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-light text-white/80 mb-2">Teacher not found</h1>
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start gap-4 mb-8">
          <div className="h-14 w-14 shrink-0 rounded-full bg-gradient-to-br from-cyan-500/20 to-emerald-500/20 border border-white/10 flex items-center justify-center text-lg font-light text-white/70">
            {teacher.name
              .split(" ")
              .map((n) => n[0])
              .join("")
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-neutral-500 mb-1">{teacher.email}</p>
          ...
          <div className="rounded-xl border border-white/5 bg-white/[0.02] p-5">
            ...
            <p
              className={`text-3xl font-light tabular-nums ${
                atRiskCount > 0 ? "text-red-400" : "text-emerald-400"
              }`}
            >
              {atRiskCount}
            </p>
        ...
        {/* Classes grid */}
        <div className="mb-10">
          <h2 className="text-lg font-light text-white/80 mb-4">
                ...
                >
                  ...
                  <div className="mb-2">
                    <div className="flex items-center justify-between text-[11px] mb-1">
                      <span className="text-neutral-500">Avg progress</span>
              ...
              return (
                ...
                >
                  <div className="px-5 py-3 border-b border-white/5 flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-white/80">{cls.name}</p>
                      <p className="text-[11px] text-neutral-600">
                  ...
                  {students.map((student) => (
                    <Link
                      ...
                      className="group flex items-center justify-between gap-4 px-5 py-3 border-b border-white/[0.03] last:border-0 hover:bg-white/[0.02] transition-colors"
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        <div
                          className={`h-2 w-2 shrink-0 rounded-full ${
                            student.atRisk ? "bg-red-400" : "bg-emerald-400/60"
                          }`}
                        />
        ...
        {reportClass && (
          <div className="rounded-xl border border-white/5 bg-white/[0.02] overflow-hidden mb-10">
            <div className="px-5 py-4 border-b border-white/5 bg-gradient-to-r from-cyan-500/5 to-transparent">
            ...
            <div className="p-5 space-y-6">
              ...
              <div>
                <h3 className="text-[10px] uppercase tracking-[0.2em] text-neutral-500 mb-3">
                  Performance Summary
                </h3>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <div>
                    <p className="text-[11px] text-neutral-600 mb-0.5">Students</p>
                    <p className="text-xl font-light text-white/70 tabular-nums">
                      {reportClassStudents.length > 0 ? reportClassStudents.length : reportClass.studentCount}
                    </p>
                  </div>
                  <div>
                    <p className="text-[11px] text-neutral-600 mb-0.5">At-Risk</p>
                    <p
                      className={`text-xl font-light tabular-nums ${
                        reportAtRisk > 0 ? "text-red-400" : "text-emerald-400"
                      }`}
                    >
                      {reportAtRisk}
                    </p>
                  ...
                  <div>
                    <p className="text-[11px] text-neutral-600 mb-0.5">Completion</p>
                    <p className="text-xl font-light text-white/70 tabular-nums">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                    <span className="text-emerald-400 mt-0.5 shrink-0">&uarr;</span>
                  ...
                  <div className="rounded-lg border border-white/5 bg-white/[0.015] overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.03]">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm text-white/80">{reportClass.name}</p>
                        <span className="text-[10px] text-neutral-600">(this class)</span>
                      </div>
                    ...
                    {sameYearClasses.map((c) => (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <p className="text-sm text-neutral-400">{c.name}</p>
                          <span className="text-[11px] text-neutral-600">{c.teacher}</span>
                        </div>
        ...
        {/* Footer */}
        <p className="text-center text-[10px] uppercase tracking-[0.3em] text-neutral-600">
