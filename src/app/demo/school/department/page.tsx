...
const DEPT_TEACHERS: DeptTeacher[] = [
  ...DEMO_TEACHERS.map((t) => {
    ...
    const avgScore =
      tc.length > 0
        ? Math.round(tc.reduce((a, c) => a + c.avgScore, 0) / tc.length)
        : 0
  ...
  { id: "t10", name: "Mr. Henderson", classes: 2, students: 27, avgScore: 73, completionRate: 71, atRisk: 2 },
  { id: "t11", name: "Ms. Reeves", classes: 2, students: 30, avgScore: 66, completionRate: 63, atRisk: 4 },
  { id: "t12", name: "Mrs. Gallagher", classes: 2, students: 25, avgScore: 70, completionRate: 69, atRisk: 3 },
  { id: "t13", name: "Mr. Okonkwo", classes: 1, students: 28, avgScore: 75, completionRate: 74, atRisk: 1 },
  { id: "t14", name: "Dr. Mahmood", classes: 2, students: 26, avgScore: 64, completionRate: 60, atRisk: 5 },
  { id: "t15", name: "Ms. Fletcher", classes: 1, students: 24, avgScore: 71, completionRate: 72, atRisk: 2 },
  { id: "t16", name: "Mr. Grant", classes: 2, students: 29, avgScore: 67, completionRate: 65, atRisk: 3 },
  { id: "t17", name: "Mrs. Sullivan", classes: 1, students: 22, avgScore: 79, completionRate: 80, atRisk: 1 },
  { id: "t18", name: "Ms. Ingram", classes: 2, students: 31, avgScore: 63, completionRate: 57, atRisk: 5 },
]
...
const ALL_CLASSES: DeptClass[] = [
  ...
  { id: "dc10", name: "10C English Lang", teacher: "Mr. Henderson", yearGroup: "Year 10", avgScore: 74 },
  ...
  { id: "dc14", name: "10D English Lit", teacher: "Mrs. Gallagher", yearGroup: "Year 10", avgScore: 70 },
  { id: "dc15", name: "11C English Lit", teacher: "Mrs. Gallagher", yearGroup: "Year 11", avgScore: 69 },
  { id: "dc16", name: "10E English Lang", teacher: "Mr. Okonkwo", yearGroup: "Year 10", avgScore: 75 },
  ...
  { id: "dc19", name: "11D English Lang", teacher: "Ms. Fletcher", yearGroup: "Year 11", avgScore: 71 },
  ...
  { id: "dc22", name: "11E English Lang", teacher: "Mrs. Sullivan", yearGroup: "Year 11", avgScore: 79 },
...
const CPD_RECOMMENDATIONS: CpdRecommendation[] = [
  ...
  { teacher: "Ms. Reeves", recommendation: "Focus on differentiated writing frames for lower-attaining Year 9 students" },
  { teacher: "Dr. Mahmood", recommendation: "Introduce retrieval practice starters to boost Year 9 retention rates" },
  { teacher: "Ms. Ingram", recommendation: "Consider collaborative planning for Year 7 creative writing with Mr. Grant" },
  { teacher: "Mr. Grant", recommendation: "Attend KS3 literacy conference to develop Year 7 reading comprehension strategies" },
]
