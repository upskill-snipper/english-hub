...
const LESSON_PLANS: LessonPlan[] = [
  // 1 -- An Inspector Calls / AQA / Reading Analysis
  {
    ...
    plenaryActivity: {
      ...
      differentiation: {
        support: "Choose from a list of five suggested words and explain your choice in one sentence.",
  ...
  // 2 -- Macbeth / AQA / Reading Analysis
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: "Provide a sentence starter: 'I would risk everything to...' and one follow-up prompt: 'The danger of this ambition is...'",
        core: "Students write their response and consider whether their ambition could lead to negative consequences.",
        stretch: "Students consider whether ambition is inherently destructive or whether it depends on the moral framework of the individual.",
      },
    ...
    plenaryActivity: {
      ...
      differentiation: {
        ...
        stretch: "Predict how your position might shift and explain what Shakespeare would need to show you to change your mind.",
      },
    },
    homework:
    ...
    worksheetQuestions: [
      ...
      {
        question: "Analyse the image of 'vaulting ambition, which o'erleaps itself / And falls on the other'. What does this reveal about Macbeth's self-awareness?",
        lines: 5,
        modelAnswer:
      ...
      {
        question: "How does Shakespeare use religious imagery in the soliloquy to create a sense of moral horror?",
        lines: 5,
        modelAnswer:
      ...
      {
        question: "Why is Macbeth's use of the word 'if' significant in the opening line of the soliloquy?",
        lines: 4,
        modelAnswer:
      ...
      {
        question: "How would a Jacobean audience have responded differently to this soliloquy compared with a modern audience? Use your knowledge of context to explain.",
        lines: 6,
        modelAnswer:
  ...
  // 3 -- A Christmas Carol / AQA / Reading Analysis
  {
    ...
    starterActivity: {
      ...
      differentiation: {
        support: "Provide the extract with key words underlined; students categorise them into 'cold', 'dark', and 'alone'.",
        core: "Students independently identify words and explain the pattern they create.",
        stretch: "Students consider why Dickens opens with death ('Marley was dead') and how this frames the entire novella as a story about mortality and moral reckoning.",
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support: "Each extract comes with the technique pre-labelled and a sentence stem for the effect.",
          core: "Students identify techniques independently and write effect sentences.",
          stretch: "Students rank the four techniques by effectiveness and justify their choice in a paragraph.",
        },
        resources: ["Four extract cards with technique focus", "Annotation pens", "Model combined paragraph on projector"],
      },
      {
        ...
        differentiation: {
          support: "Provide a planning grid with columns for quotation, technique, effect, and context, plus two pre-selected quotations.",
          core: "Students plan and write independently using the text.",
          stretch: "Students include a counter-argument: is Dickens presenting Scrooge as purely villainous, or does the hyperbolic description contain humour that complicates our response?",
        },
        resources: ["Exam question on projector", "Planning grid (support)", "Novella copies", "AO highlighting pens (three colours)"],
      },
    ],
    plenaryActivity: {
    ...
    worksheetQuestions: [
      {
        question: "What is a semantic field? Identify the dominant semantic field in the opening description of Scrooge and explain its effect.",
        lines: 5,
        modelAnswer: "A semantic field is a group of words related to the same theme or concept. In the opening description of Scrooge, Dickens uses a semantic field of cold and winter: 'cold', 'froze', 'icy', 'nipped'. This creates the impression that Scrooge is emotionally frozen -- incapable of warmth, compassion, or human connection.",
        marks: 4,
      },
      {
        question: "Analyse the simile 'hard and sharp as flint'. What does this reveal about Scrooge's character?",
        lines: 5,
        modelAnswer: "The simile compares Scrooge to flint, a stone that is both hard and capable of producing sparks when struck. 'Hard' suggests emotional rigidity and a refusal to feel compassion, while 'sharp' implies he is cutting and unpleasant. However, the fact that flint produces fire when struck could foreshadow Scrooge's capacity for transformation -- he needs the right catalyst to ignite change.",
        marks: 4,
      },
      {
        question: "How does Dickens use Scrooge's dialogue with the charity collectors to criticise Victorian attitudes towards poverty?",
        lines: 6,
        modelAnswer: "When the charity collectors ask Scrooge for a donation, he responds by asking whether prisons and workhouses still operate, implying these institutions are sufficient provision for the poor. His suggestion that the poor should 'die' and 'decrease the surplus population' echoes the Malthusian economic theory that the poor were a burden. Dickens uses this exchange to satirise and condemn the callous attitudes of the wealthy Victorian middle class.",
        marks: 5,
      },
      {
        question: "Why did Dickens choose to write A Christmas Carol as a novella rather than a pamphlet or political speech?",
        lines: 4,
        modelAnswer: "Dickens understood that fiction could reach a wider audience and create an emotional response that a political pamphlet could not. By telling a story of personal transformation, he made his social message accessible and engaging. The novella form allowed him to combine entertainment with moral instruction.",
        marks: 3,
      },
      {
        question: "How does Dickens use the weather and setting in Stave 1 to reflect Scrooge's character? Use specific examples.",
        lines: 5,
        modelAnswer: "Dickens uses pathetic fallacy to mirror Scrooge's emotional state: the 'cold, bleak, biting weather' outside his counting-house reflects his cold inner world. While the fog 'came pouring in at every chink', suggesting the outside world is trying to reach Scrooge, he remains sealed in his frigid office. The contrast emphasises his self-imposed separation from humanity.",
        marks: 4,
      },
    ],
    teacherNotes: [
  ...
  // 4 -- Of Mice and Men / AQA / Reading Analysis
  {
    ...
    keywords: ["American Dream", "aspiration", "futility", "itinerant", "marginalisation", "social realism", "symbolism", "Great Depression", "cyclical structure", "foreshadowing"],
    starterActivity: {
      title: "Dream Board: What Does Success Look Like?",
      duration: "7 minutes",
      instructions: "Students write or draw their personal vision of 'success' on a card in 90 seconds. Teacher collects and displays a selection. Discuss: do all of these dreams require the same resources? Are some people's dreams harder to achieve than others, and why? Bridge to the novel: in 1930s America, the American Dream promised that anyone could succeed through hard work -- Steinbeck questions whether this was ever true.",
      differentiation: {
        support: "Provide a prompt list: 'Success could mean: a home, a job, freedom, family, money, safety, respect.'",
        core: "Students create their own vision independently and link it to a character from the novel.",
        stretch: "Students consider whether the concept of 'success' is culturally constructed and how definitions would differ across 1930s American society.",
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support: "Provide page references for key quotations and a partially completed grid with one character filled in.",
          core: "Students complete the grid independently using the text.",
          stretch: "Students add a fifth row for Slim and consider whether his lack of an explicit dream makes him the most realistic character in the novel.",
        },
        resources: ["Character dream grid worksheet", "Novel copies", "Page reference sheet (support)"],
      },
      {
        title: "Analytical Writing: The Dream as Illusion",
        duration: "20 minutes",
        instructions: "Students respond to: 'How does Steinbeck present the American Dream as an illusion in Of Mice and Men?' They write one PEEL paragraph focusing on George and Lennie's dream, integrating a quotation, technique identification, and AO3 context about the Great Depression. Teacher models the opening sentence: 'Steinbeck presents the American Dream as a necessary fiction that sustains the dispossessed even as it guarantees their disappointment.'",
        differentiation: {
          support: "Provide a paragraph frame with sentence starters and a pre-selected quotation with the technique identified.",
          core: "Students write independently, selecting their own quotation.",
          stretch: "Students write a second paragraph arguing the opposite position: that Steinbeck values the dream precisely because it represents human resilience.",
        },
        resources: ["Model sentence on board", "PEEL frame (support)", "AO checklist for peer assessment"],
      },
    ],
    plenaryActivity: {
      title: "Verdict: Hope or Cruelty?",
      duration: "6 minutes",
      instructions: "Students stand. Teacher reads three statements about the American Dream in the novel; students move to 'Agree', 'Disagree', or 'Unsure' corners. For each statement, one student from each corner justifies their position. Teacher synthesises: Steinbeck's genius lies in holding both positions simultaneously.",
      differentiation: {
        ...
        stretch: "Respond to someone in an opposing corner with a counter-argument rooted in context.",
      },
    },
    homework: "Choose one character whose dream you find the most tragic. Write 150 words explaining why their dream is doomed and what Steinbeck is saying about American society through their failure. Include at least one quotation.",
    worksheetQuestions: [
      {
        question: "What is the American Dream and why was it particularly significant during the Great Depression?",
        lines: 5,
        modelAnswer: "The American Dream is the belief that anyone in America can achieve success through hard work, regardless of their social background. During the Great Depression, this dream became both more important and more unreachable: millions of displaced workers clung to the hope of land ownership even as mass unemployment made such aspirations almost impossible.",
        marks: 4,
      },
      {
        question: "How does Steinbeck use George and Lennie's dream of the farm to create emotional impact?",
        lines: 5,
        modelAnswer: "Steinbeck uses the repeated telling of the dream as a ritual between George and Lennie, building emotional investment in both the characters and the reader. The dream is described in sensory detail -- rabbits, a garden, living 'off the fatta the lan'' -- making it feel tangible. By making the dream so vivid and then destroying it, Steinbeck maximises the emotional devastation.",
        marks: 5,
      },
      {
        question: "Compare the dreams of Curley's wife and Crooks. What do their dreams reveal about 1930s American society?",
        lines: 6,
        modelAnswer: "Curley's wife dreamed of becoming a Hollywood actress, while Crooks once dreamed of playing with white children as an equal. Both dreams were destroyed by the social structures of 1930s America: Curley's wife was trapped by patriarchal expectations, while Crooks was crushed by racial segregation. Together, their failed dreams expose the American Dream as a lie that excluded women and Black Americans by design.",
        marks: 5,
      },
      {
        question: "Why does Steinbeck give the novel a cyclical structure, ending where it began by the river?",
        lines: 4,
        modelAnswer: "The cyclical structure reinforces the theme of futility: despite all their effort and hope, George and Lennie end up exactly where they started, suggesting that the dream was always doomed. The peaceful natural setting contrasts devastatingly with the violence of the ending.",
        marks: 4,
      },
      {
        question: "Is Steinbeck criticising the American Dream itself, or the society that makes it impossible? Justify your answer.",
        lines: 6,
        modelAnswer: "Steinbeck appears to critique the society rather than the dream itself. The dream of the farm is presented as genuinely beautiful and humanising -- it gives George and Lennie purpose, companionship, and hope. What destroys it is not the dream's inherent impossibility but the economic structures of the Great Depression and the violence of men like Curley.",
        marks: 6,
      },
    ],
    teacherNotes: [
  ...
  // 5 -- Poetry Anthology / AQA / Reading Analysis
  {
    ...
    keywords: ["dramatic monologue", "sonnet", "tyranny", "hubris", "enjambment", "caesura", "volta", "objectification", "patriarchy", "impermanence"],
    starterActivity: {
      title: "Power Portraits: What Does a Tyrant Look Like?",
      duration: "7 minutes",
      instructions: "Students sketch or describe in three bullet points what a powerful but corrupt leader looks like, acts like, and sounds like. Share in pairs, then as a class. Teacher displays descriptions of the Duke and Ozymandias side by side. Discuss: both are powerful men, but how do the poets want us to feel about them?",
      differentiation: {
        ...
        stretch: "Students consider whether power is inherently corrupting or whether these poems present specific types of power abuse.",
      },
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          support: "Provide a pre-annotated first stanza of each poem and a colour-coded key showing what to look for.",
          core: "Students annotate independently using the focus questions as a guide.",
          stretch: "Students identify how both poems use art (sculpture, painting) as a symbol and write a sentence explaining what this shared motif suggests about power and legacy.",
        },
        resources: ["A3 dual-poem annotation sheet", "Coloured pens (green and red)", "Focus questions displayed on board"],
      },
      {
        title: "Comparative Paragraph Writing",
        duration: "18 minutes",
        instructions: "Students write one comparison paragraph responding to: 'Compare how the poets present the abuse of power.' Teacher models the comparative framework: 'Both poets... However, while Shelley..., Browning..., which suggests...' Students use this framework, embedding quotations from both poems.",
        differentiation: {
          support: "Provide the framework with the first comparison point completed and a choice of two quotation pairs.",
          core: "Students write independently using the framework.",
          stretch: "Students write a second paragraph that considers how the form of each poem contributes to its message about power.",
        },
    ...
    plenaryActivity: {
      ...
      duration: "5 minutes",
      instructions: "Class debate: who is the more dangerous figure -- Ozymandias or the Duke? Students vote with hands, then three students from each side give a 20-second argument. Teacher concludes: Shelley shows us power destroyed by time; Browning shows us power that continues to destroy.",
      differentiation: {
    ...
    homework: "Write a 200-word comparison paragraph on how Shelley and Browning use imagery to present power. Include at least one quotation from each poem.",
    worksheetQuestions: [
      {
        question: "How does Shelley use the ruined statue in 'Ozymandias' to comment on the impermanence of power?",
        lines: 5,
        modelAnswer: "Shelley describes the statue as broken and half-buried in sand, with the 'shattered visage' symbolising the decay of once-great power. The irony of the inscription beside 'nothing beside remains' exposes the futility of Ozymandias's arrogance. Time is the ultimate equaliser.",
        marks: 5,
      },
      {
        question: "How does Browning reveal the Duke's character through what he says about the Duchess?",
        lines: 5,
        modelAnswer: "Browning uses the dramatic monologue to let the Duke unknowingly reveal his cruelty. His complaints about the Duchess expose his possessiveness and need for absolute control. The chilling line 'I gave commands; then all smiles stopped' implies murder, yet his calm tone suggests he sees nothing wrong.",
        marks: 5,
      },
      {
        question: "Compare how the form of each poem contributes to its message about power.",
        lines: 6,
        modelAnswer: "Shelley's disrupted sonnet form mirrors the destruction of Ozymandias's ordered empire. Browning's unbroken dramatic monologue, with relentless enjambment, mirrors the Duke's controlling personality -- he never pauses or allows interruption. Both poets use form to embody their theme.",
        marks: 6,
      },
      {
        question: "What is the significance of art (the statue and the painting) in both poems?",
        lines: 5,
        modelAnswer: "Both poems use art as a symbol of power's attempt to outlast mortality. Ozymandias's statue now lies in ruins; the Duke keeps his wife's painting behind a curtain he controls. Art becomes an instrument of dominance, but ultimately reveals the tyrant's flaws rather than concealing them.",
        marks: 5,
      },
      {
        question: "Which poem do you find more disturbing? Explain with reference to both poems.",
        lines: 6,
        modelAnswer: "A strong answer might argue 'My Last Duchess' is more disturbing because the Duke's power is ongoing rather than ancient. While Ozymandias's cruelty has been neutralised by time, the Duke is actively negotiating his next marriage. Shelley offers comfort that tyrants fall; Browning offers no such reassurance.",
        marks: 6,
      },
    ],
    teacherNotes: [
  ...
  // 6 -- Macbeth / AQA / Exam Practice
  {
    ...
    keywords: ["extract question", "mark scheme", "AO weighting", "topic sentence", "embedded quotation", "perceptive analysis", "conceptualised response", "counter-argument", "time management", "self-assessment"],
    starterActivity: {
      title: "Exam Myths: True or False?",
      duration: "5 minutes",
      instructions: "Display five common exam myths. Students vote true or false; teacher clarifies each, emphasising that quality of analysis beats quantity, and that context should be woven in, not bolted on.",
      differentiation: {
        ...
        stretch: "Students write their own 'myth' based on a mistake they have made in previous essays.",
      },
    ...
    mainActivities: [
      {
        ...
        duration: "35 minutes",
        instructions: "Students receive the extract and the question: 'How does Shakespeare present Lady Macbeth as a powerful and ambitious character in this extract and in the play as a whole?' Students spend 5 minutes planning, then write for 30 minutes. Teacher provides time checks at 10 and 20 minutes. Exam-like conditions.",
        differentiation: {
          support: "Provide a planning template with three suggested paragraph focuses: supernatural imagery, gender subversion, and her relationship with Macbeth.",
          core: "Students plan and write independently.",
          stretch: "Students include a paragraph contrasting Lady Macbeth's power in Act 1 with her breakdown in Act 5.",
        },
        resources: ["Extract: Act 1 Scene 5 (printed)", "Exam question on board", "Planning template (support)", "Lined paper", "Timer displayed"],
      },
    ],
    plenaryActivity: {
      title: "Self-Assessment Against the Mark Scheme",
      duration: "5 minutes",
      instructions: "Teacher displays simplified mark scheme bands. Students re-read their essay and highlight: one moment of strong AO2 analysis (green), one moment of effective AO3 context (blue), and one area for improvement (orange). Students write a one-sentence target.",
      differentiation: {
    ...
    homework: "Rewrite your weakest paragraph from today's essay, improving it based on your self-assessment target. Bring both the original and the rewrite to next lesson.",
    worksheetQuestions: [
      {
        question: "What does Lady Macbeth mean when she says 'unsex me here'? How does this relate to Jacobean gender expectations?",
        lines: 5,
        modelAnswer: "Lady Macbeth is asking supernatural spirits to strip away her femininity so she can carry out the murder without compassion. In Jacobean society, women were expected to be obedient and nurturing. Her request is deeply transgressive -- Shakespeare presents her as willing to reject her own nature to achieve power.",
        marks: 5,
      },
      {
        question: "How does Shakespeare use imperative verbs in Lady Macbeth's soliloquy to convey her determination?",
        lines: 4,
        modelAnswer: "Shakespeare fills the soliloquy with imperatives -- 'Come', 'unsex', 'fill', 'stop up', 'take' -- creating a commanding, ritualistic tone. These contrast sharply with Macbeth's uncertain conditional language, establishing her as the more decisive partner at this stage.",
        marks: 4,
      },
      {
        question: "Explain one way in which Lady Macbeth's language in Act 1 foreshadows her later breakdown in Act 5.",
        lines: 5,
        modelAnswer: "When Lady Macbeth asks the spirits to 'make thick my blood' and prevent 'compunctious visitings of nature', she is suppressing her humanity. This foreshadows her breakdown in Act 5, where the guilt she blocked returns as sleepwalking and obsessive hand-washing. Shakespeare suggests the suppression was never sustainable.",
        marks: 5,
      },
      {
        question: "Write a topic sentence for a paragraph about Lady Macbeth's power that would earn marks for AO1, AO2, and AO3.",
        lines: 3,
      ...
      {
        question: "Why is it important to discuss the whole play, not just the extract, when the question says 'and in the play as a whole'?",
        lines: 4,
        modelAnswer: "The 'whole play' instruction requires students to demonstrate knowledge beyond the given extract, showing they understand character development across the entire text. Students who only discuss the extract will be limited to lower mark bands.",
        marks: 3,
      },
    ],
    teacherNotes: [
  ...
  // 7 -- A Christmas Carol / AQA / Writing Skills
  {
    ...
    keywords: ["atmosphere", "sensory language", "pathetic fallacy", "juxtaposition", "one-sentence paragraph", "complex sentence", "sibilance", "semantic field", "pacing", "reader positioning"],
    starterActivity: {
      title: "Atmosphere in Five Senses",
      duration: "5 minutes",
      instructions: "Teacher reads aloud a 100-word Dickens passage. Students listen with eyes closed, then write one thing they saw, heard, felt, smelled, and tasted in their imagination. Share in pairs. Establish that great descriptive writing activates all the senses, not just sight.",
      differentiation: {
    ...
    mainActivities: [
      ...
      },
      {
        ...
        duration: "20 minutes",
        instructions: "Students write 150-200 words in response to: 'Describe a place that fills you with unease.' They must include at least two of Dickens's techniques. Teacher provides quiet writing environment. After 15 minutes, students swap with a partner for peer feedback using a checklist.",
        differentiation: {
          support: "Provide a planning frame with four paragraph prompts: arrival, what you see, what you hear/feel, the moment of dread.",
          core: "Students plan and write independently.",
          stretch: "Students write a second version of their opening paragraph, experimenting with a different sentence structure.",
        },
        resources: ["Writing prompt on board", "Planning frame (support)", "Peer feedback checklist"],
      },
    ],
    plenaryActivity: {
      title: "Best Line Share",
      duration: "5 minutes",
      instructions: "Each student underlines their single best sentence and reads it aloud. No explanation needed -- just the sentence. Teacher notes effective examples and explains what makes them work.",
      differentiation: {
    ...
    homework: "Rewrite and polish your descriptive passage to exactly 200 words. Focus on making every word count. Bring a clean copy to next lesson.",
    worksheetQuestions: [
      {
        question: "What is pathetic fallacy? Give an example from A Christmas Carol and explain its effect.",
        lines: 4,
        modelAnswer: "Pathetic fallacy is when the environment reflects a character's emotions. The 'cold, bleak, biting weather' outside Scrooge's counting-house mirrors his cold nature. The effect is to make the reader associate Scrooge with discomfort before he even speaks.",
        marks: 3,
      },
      {
        question: "Why might a writer use a one-sentence paragraph? Write an example of your own.",
        lines: 4,
        modelAnswer: "A one-sentence paragraph creates a dramatic pause, forcing the reader to absorb its impact. Surrounded by longer paragraphs, it gains maximum weight. Example: 'The door opened.'",
        marks: 3,
      },
      {
        question: "Identify two techniques in: 'The cold within him froze his old features, nipped his pointed nose, shrivelled his cheek, stiffened his gait.'",
        lines: 5,
        modelAnswer: "Dickens uses listing (froze, nipped, shrivelled, stiffened) to create cumulative effect. He also uses the metaphor 'the cold within him' to suggest Scrooge's coldness is internal rather than external -- it comes from his character, not the weather.",
        marks: 4,
      },
      {
        question: "Write a sentence using sensory language to describe a hot summer's day. Identify the senses you included.",
        lines: 3,
        modelAnswer: "The tarmac shimmered in waves of heat, the sweet smell of melting ice cream drifting from the park gates while somewhere distant a lawnmower droned its lazy afternoon song. Senses: sight, smell, sound.",
        marks: 3,
      },
      {
        question: "Explain the difference between 'The room was scary' and using techniques to show the room is frightening.",
        lines: 5,
        modelAnswer: "'The room was scary' tells the reader how to feel without evidence. Using techniques -- sensory details, metaphor, varied sentences -- shows the reader the room and lets them feel the fear themselves. 'Show, don't tell' creates an immersive experience.",
        marks: 4,
      },
    ],
    teacherNotes: [
  ...
  // 8 -- An Inspector Calls / AQA / Speaking & Listening
  {
    ...
    keywords: ["hot-seating", "role-play", "register", "characterisation", "inference", "dramatic empathy", "motivation", "sustained performance", "evaluation", "assessment criteria"],
    starterActivity: {
      title: "Character Warm-Up: In Their Shoes",
      duration: "8 minutes",
      instructions: "Each student is assigned a Birling family member or the Inspector. They write five key facts and three 'rules' for how that character would speak. Students practise introducing themselves in character to a partner for 30 seconds each.",
      differentiation: {
        support: "Provide a character fact sheet with five pre-written facts and two 'speech rules'.",
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          stretch: "Students ask follow-up questions that challenge the character's justification and force them to confront responsibility.",
        },
    ...
    plenaryActivity: {
      ...
      duration: "10 minutes",
      instructions: "Students write a brief self-assessment: (1) What went well? (2) What would I do differently? (3) What did I learn about my character that I had not considered before? Three volunteers share reflections.",
      differentiation: {
        support: "Use sentence starters: 'My strongest moment was... Next time I would... I discovered that my character...'",
        core: "Students write a full three-part reflection independently.",
        stretch: "Students evaluate whether the hot-seating changed their interpretation of a character.",
      },
    },
    homework: "Write a 200-word diary entry in character as the person you played. Set it on the evening after the Inspector's visit. Reveal the character's private thoughts about what happened.",
    worksheetQuestions: [
      {
        question: "What is hot-seating and how does it develop understanding of character?",
        lines: 4,
        modelAnswer: "Hot-seating is a drama technique where a student takes on a character's role and answers questions from the audience. It develops understanding because it forces students to think from inside the character's perspective, considering not just what they do but why.",
        marks: 3,
      },
      {
        question: "Write three questions you would ask Mr Birling. Explain what each is designed to reveal.",
        lines: 6,
        modelAnswer: "(1) 'Do you believe Eva Smith's death was your fault?' -- reveals whether he accepts responsibility. (2) 'If Eva came today, would you re-employ her?' -- tests whether the Inspector changed his attitude. (3) 'What would Sheila say about your behaviour?' -- forces him to confront how his actions appear to someone who has accepted responsibility.",
        marks: 5,
      },
      {
        question: "How should a student sustain character voice during hot-seating? Give two strategies.",
        lines: 4,
        modelAnswer: "First, maintain the character's register throughout -- if playing Mr Birling, use formal, self-important language. Second, respond to unexpected questions by asking 'What would this character genuinely think?' rather than breaking character.",
        marks: 4,
      },
      {
        question: "Why might Sheila respond differently from her father when asked about responsibility?",
        lines: 5,
        modelAnswer: "Sheila has demonstrated genuine remorse, recognising that her jealousy led her to abuse her social power. Unlike her father, she understands the moral weight of what happened. She would likely accept responsibility openly, reflecting Priestley's positioning of the younger generation as capable of growth.",
        marks: 4,
      },
      {
        question: "Evaluate your own or a classmate's hot-seating performance. What was effective and what could be improved?",
        lines: 5,
        modelAnswer: "A strong answer identifies specific moments of success and specific targets. The best evaluations reference the assessment criteria: accuracy, conviction, and register.",
        marks: 4,
      },
    ],
    teacherNotes: [
  ...
  // 9 -- Of Mice and Men / AQA / Exam Practice
  {
    ...
    keywords: ["extract question", "Steinbeck's methods", "narrative voice", "third-person omniscient", "foreshadowing", "symbolism", "mark scheme", "band descriptors", "embedded quotation", "topic sentence"],
    starterActivity: {
      title: "Speed Annotation Challenge",
      duration: "5 minutes",
      instructions: "Display a short extract. Students have exactly three minutes to annotate as many methods as they can identify. After three minutes, take a poll: who found 3? 5? 7? Discuss: quality matters more than quantity, but speed matters too.",
      differentiation: {
    ...
    mainActivities: [
      {
        ...
        differentiation: {
          ...
          core: "Students plan and write independently.",
          stretch: "Students include a paragraph on Steinbeck's structural choices -- why is Crooks's chapter placed where it is?",
        },
        resources: ["Printed extract: Crooks's room", "Exam question on board", "Planning template (support)", "Lined paper", "Timer"],
      },
    ],
    plenaryActivity: {
      title: "Mark Scheme Self-Assessment",
      duration: "8 minutes",
      instructions: "Teacher displays simplified mark scheme bands. Students identify one strength (green) and one weakness (orange). Write a target sentence at the end of the essay.",
      differentiation: {
    ...
    homework: "Rewrite your weakest paragraph. Write the original and improved version side by side to see the progress.",
    worksheetQuestions: [
      {
        question: "How does Steinbeck use Crooks's room to symbolise his isolation?",
        lines: 5,
        modelAnswer: "Steinbeck describes Crooks's room as separate from the bunkhouse, physically isolating him. The room is filled with personal items suggesting long tenure but no acceptance. The 'mauled copy of the California civil code' reveals he knows his legal rights but cannot enforce them. Every detail speaks to exclusion.",
        marks: 5,
      },
      {
        question: "Why does Steinbeck use a third-person omniscient narrator? How does this affect the reader's understanding of loneliness?",
        lines: 5,
        modelAnswer: "The omniscient narrator allows Steinbeck to show the isolation of multiple characters without being limited to one perspective. The reader sees the full picture of loneliness while individual characters remain trapped in their own worlds. This creates dramatic irony.",
        marks: 5,
      },
      {
        question: "What is the difference between analysing the extract and discussing 'the novel as a whole'?",
        lines: 4,
        modelAnswer: "Extract analysis requires close reading of specific language choices. 'The novel as a whole' requires connecting the extract to broader themes and structural patterns. The combination tests whether students can zoom in on detail and zoom out to thematic understanding.",
        marks: 3,
      },
      {
        question: "Write a strong topic sentence for a paragraph about Curley's wife and loneliness.",
        lines: 3,
        modelAnswer: "Steinbeck presents Curley's wife as the loneliest figure on the ranch, using her namelessness as a structural device to demonstrate how patriarchal society erases women's individual identity, trapping them in roles defined entirely by their relationship to men.",
        marks: 3,
      },
      {
        question: "Explain why embedded quotations are more effective than block quotations. Write an example.",
        lines: 5,
        modelAnswer: "Embedded quotations create a fluent analytical voice. Block quotations disrupt the flow. Example: Steinbeck reveals Crooks's isolation through his bitter observation that 'a guy gets too lonely an' he gets sick', suggesting loneliness is a form of psychological illness.",
        marks: 4,
      },
    ],
    teacherNotes: [
  ...
  // 10 -- Poetry Anthology / AQA / Writing Skills
  {
    ...
    keywords: ["poetic voice", "persona", "extended metaphor", "enjambment", "caesura", "stanza", "tone shift", "sensory imagery", "conflict", "resolution"],
    starterActivity: {
      title: "Conflict in Six Words",
      duration: "6 minutes",
      instructions: "Challenge: write a six-word story about conflict. Examples: 'Shook hands. Walked away. Came back.' Students write three attempts, choose their best, and share. Teacher establishes that economy of language, surprise, and emotional weight are qualities shared by the best poetry.",
      differentiation: {
    ...
    mainActivities: [
      {
        ...
        duration: "20 minutes",
        instructions: "Students choose one anthology poem about conflict as their 'mentor text'. They identify three techniques and write one sentence explaining each. Teacher models with one poem. Students then plan their own poem: choose a type of conflict, select a voice, and decide on a structure.",
        differentiation: {
          ...
          stretch: "Students plan a poem that uses two different voices or perspectives on the same conflict.",
        },
      ...
      },
      {
        ...
        duration: "25 minutes",
        instructions: "Students write a poem of at least 12 lines. Quiet writing environment for the first 15 minutes. After 15 minutes, students may consult a partner. In the final five minutes, students make one deliberate revision. Teacher circulates offering encouragement and technique-specific suggestions.",
        differentiation: {
          ...
          stretch: "Students write at least 20 lines and include a structural feature (volta, refrain, or circular ending).",
        },
        resources: ["Lined paper or poetry notebooks", "Line scaffold (support)", "Quiet background music (optional)"],
      },
    ],
    plenaryActivity: {
      title: "Poetry Slam: Share and Celebrate",
      duration: "7 minutes",
      instructions: "Five volunteers read their poem aloud. After each reading, the class identifies one technique they heard and one image that stayed with them. Teacher celebrates effort, creativity, and technical ambition.",
      differentiation: {
    ...
    homework: "Type up a polished version of your conflict poem. Make at least three deliberate changes from your draft, annotating in the margin why you made each change.",
    worksheetQuestions: [
      {
        question: "Choose one technique from your mentor poem and explain how the poet uses it to explore conflict.",
        lines: 5,
        modelAnswer: "Answers will vary. A strong response identifies a specific technique, provides a quotation, and explains how it contributes to the poem's exploration of conflict.",
        marks: 4,
      },
      {
        question: "What is enjambment and how can it create tension in a conflict poem?",
        lines: 4,
        modelAnswer: "Enjambment is when a sentence runs over from one line to the next without punctuation. In a conflict poem, it can create tension by making the reader rush forward, mirroring chaos or urgency. It can also create surprise by placing an unexpected word at the start of the next line.",
        marks: 3,
      },
      {
        question: "Why is choosing a specific voice (persona) important when writing about conflict?",
        lines: 4,
        modelAnswer: "The voice determines how the reader experiences the conflict. A first-person soldier's voice creates immediacy; a detached observer creates irony; a child's voice creates innocence and pathos. The choice shapes vocabulary, tone, and the reader's relationship with the subject.",
        marks: 3,
      },
      {
        question: "Write an opening stanza (4 lines) for a poem about a personal conflict. Use at least one technique.",
        lines: 5,
        modelAnswer: "Example: 'I held the words like stones, / heavy in my fist, / knowing that to throw them / would shatter something I could not rebuild.' Techniques: simile, enjambment, metaphor.",
        marks: 4,
      },
      {
        question: "Explain the difference between free verse and a structured form. When might a poet choose one over the other?",
        lines: 5,
        modelAnswer: "Free verse has no set rhyme or metre, allowing the poet to mirror chaos. Structured forms impose order, which can contrast with chaotic subject matter. A poet might choose free verse for raw immediacy and structured form for ironic tension or the suggestion of imposed discipline.",
        marks: 4,
      },
    ],
    teacherNotes: [
  ...
  // 11 -- A Christmas Carol / AQA / Exam Practice
  {
    ...
    keywords: ["redemption", "transformation", "allegory", "didactic", "moral fable", "Christian values", "social reform", "tonal shift", "juxtaposition", "Victorian philanthropy"],
    starterActivity: {
      title: "Before and After: Scrooge Word Cloud",
      duration: "6 minutes",
      instructions: "Students create two quick word clouds on mini-whiteboards: one for Stave 1 Scrooge and one for Stave 5. Compare as a class. Teacher highlights the most dramatic contrasts. Ask: is this change believable? Does it matter?",
      differentiation: {
        support: "Provide a word bank for each stave.",
        core: "Students generate their own words independently from memory.",
        stretch: "Students identify which words from Stave 1 Dickens deliberately inverts in Stave 5.",
      },
    ...
    mainActivities: [
      {
        ...
        duration: "22 minutes",
        instructions: "Students receive the opening of Stave 5. In pairs, they annotate for exclamatory sentences, dynamic verbs, sensory imagery, and humour. Teacher models one annotation. Students write their own commentary for two further features. Class maps the tonal shift from Stave 1.",
        differentiation: {
          ...
          stretch: "Students compare the opening of Stave 5 with the opening of Stave 1, writing a paragraph on how Dickens structures the novella to maximise the transformation's impact.",
        },
      ...
      },
      {
        ...
        duration: "22 minutes",
        instructions: "Students respond to: 'Some readers argue that Scrooge's transformation is too sudden and unrealistic. How far do you agree?' They write two paragraphs: one arguing the transformation is effective, one arguing it undermines realism. Teacher emphasises evaluation means weighing both sides.",
        differentiation: {
          support: "Provide paragraph frames for both sides with sentence starters.",
          core: "Students write both paragraphs independently.",
          stretch: "Students write a third paragraph considering whether the ending works better as a fairy tale than as realism.",
        },
    ...
    plenaryActivity: {
      ...
      duration: "5 minutes",
      instructions: "Students write: 'The ending works because...' or 'The ending fails because...' on a slip of paper. Teacher reads three anonymously and discusses.",
      differentiation: {
    ...
    homework: "Read the final two pages of Stave 5 and write five annotations focusing on how Dickens uses language to reinforce that generosity and connection are the antidotes to misery.",
    worksheetQuestions: [
      {
        question: "How does the language of Stave 5 contrast with Stave 1? Give two specific examples.",
        lines: 5,
        modelAnswer: "In Stave 1, Dickens uses cold and darkness: 'cold', 'froze', 'solitary as an oyster'. In Stave 5, the language shifts to warmth and energy: 'glowing', 'Golden sunlight', 'merry'. Exclamatory sentences replace clipped dismissals. The linguistic transformation mirrors Scrooge's moral rebirth.",
        marks: 5,
      },
      {
        question: "Why does Dickens choose to redeem Scrooge rather than punish him?",
        lines: 5,
        modelAnswer: "Dickens's purpose is didactic rather than punitive. If Scrooge were punished, the message would be merely a warning. By transforming him, Dickens offers hope: even the worst of us can choose generosity. This aligns with the Christian message of redemption and Dickens's belief in individual moral change.",
        marks: 5,
      },
      {
        question: "Do you think Scrooge's transformation is realistic? Explain your view.",
        lines: 6,
        modelAnswer: "The transformation is psychologically unrealistic -- a lifetime of misanthropy reversed in one night. However, Dickens is writing a moral fable, not a psychological novel. The rapid change is deliberate: it shows that goodness exists within everyone, needing only the right catalyst. The supernatural framework signals fairy tale logic, not realism.",
        marks: 6,
      },
      {
        question: "What role does Christmas play in the transformation?",
        lines: 4,
        modelAnswer: "Christmas symbolises generosity, community, and moral renewal. Dickens sets the story at Christmas because the season already carried associations of charity, making Scrooge's refusal to celebrate feel especially transgressive. The Christian narrative of rebirth reinforces the allegory.",
        marks: 4,
      },
      {
        question: "How does Dickens use humour in Stave 5 to make the transformation appealing rather than preachy?",
        lines: 5,
        modelAnswer: "Dickens injects physical comedy: Scrooge dresses in a rush, laughs uncontrollably, nearly falls over. His childlike joy makes him endearing rather than saintly. The humour prevents the transformation from feeling like a lecture. Dickens shows that goodness is joyful, not solemn.",
        marks: 5,
      },
    ],
    teacherNotes: [
...
function findBestMatch(
  ...
  for (const plan of LESSON_PLANS) {
    ...
    if (focusLower === "reading analysis" && plan.targetedSkills.some((s) => s.toLowerCase().includes("analysis"))) score += 4;
    if (focusLower === "writing skills" && plan.targetedSkills.some((s) => s.toLowerCase().includes("writing"))) score += 4;
    if (focusLower === "speaking & listening" && plan.targetedSkills.some((s) => s.toLowerCase().includes("speaking"))) score += 4;
    if (focusLower === "exam practice" && plan.targetedSkills.some((s) => s.toLowerCase().includes("exam"))) score += 4;
          ...
          <>
            <div className="rounded-2xl border border-ink-200 bg-white overflow-hidden mb-6">
              ...
              <div className="px-6 sm:px-8 py-6 space-y-8">
                ...
                <ActivityBlock label="Starter Activity" activity={generatedPlan.starterActivity} color="amber" />
                {generatedPlan.mainActivities.map((act, i) => (
                  <ActivityBlock key={i} label={`Main Activity ${i + 1}`} activity={act} color="emerald" />
                ))}
                <ActivityBlock label="Plenary" activity={generatedPlan.plenaryActivity} color="violet" />
