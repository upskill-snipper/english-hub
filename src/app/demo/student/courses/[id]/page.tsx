    ...
    modules: [
      {
        ...
        quiz: [
          ...
          {
            question: 'Which of these is NOT a text type you might encounter?',
            options: ['Article', 'Speech', 'Algebra equation', 'Diary entry'],
            answer: 2,
          },
          {
            question: "What does 'implicit meaning' refer to?",
            options: [
              'Meaning stated directly',
          ...
          {
            question: 'Why should you pay attention to structural choices?',
            options: [
              'They are always tested',
              "They reveal the writer's craft",
      ...
      },
      {
        ...
        quiz: [
          ...
          {
            question: 'Should you copy directly from the passage?',
            options: [
              'Yes, always',
          ...
          {
            question: 'What format should your summary take?',
            options: ['Bullet points', 'Continuous prose', 'A diagram', 'A table'],
            answer: 1,
          },
          {
            question: 'What should you do after writing your summary?',
            options: [
          ...
          {
            question: 'Which is a common mistake in summary writing?',
            options: [
              'Being concise',
              'Using own words',
              'Including irrelevant details',
      ...
      },
      {
        ...
        quiz: [
          ...
          {
            question: 'What is appropriate for a formal letter?',
            options: [
          ...
          {
            question: 'You are marked on which two areas?',
            options: [
              'Speed and neatness',
          ...
          {
            question: 'Where does the content for directed writing come from?',
            options: [
      ...
      },
      {
        ...
        quiz: [
          ...
          {
            question: 'Which word is good to use in language analysis?',
            options: ['Nice', 'Good', 'Suggests', 'Interesting'],
            answer: 2,
          },
          {
            question: 'What should you avoid in analysis?',
            options: [
              'Using quotations',
              'Explaining effects',
              "Saying a word is just 'effective'",
              'Using PEE structure',
            ],
            answer: 2,
          },
          {
            question: 'What must you always explain about word choices?',
            options: [
              'How to spell them',
              'Why they were chosen and their effect',
              'What dictionary they come from',
              'How long they are',
            ],
            answer: 1,
          },
      ...
      },
      {
        ...
        quiz: [
          ...
          },
          {
            ...
            options: ['Three paragraphs', 'A list of three', 'Three essays', 'Three exams'],
            answer: 1,
          },
          {
            question: 'What effect does a short sentence after a long one create?',
            options: ['Nothing special', 'A dramatic pause', 'Confusion', 'A spelling mistake'],
            answer: 1,
          },
          {
            question: 'Long, complex sentences can create what feeling?',
            options: ['Boredom only', 'A breathless, overwhelming feeling', 'Anger', 'Sleepiness'],
            answer: 1,
          },
        ],
      },
      {
        ...
        quiz: [
          ...
          {
            question: "In the example, what can we infer from 'knuckles white'?",
            options: [
              'The character is relaxed',
              'The character feels strong emotion',
              'The table is cold',
              'The character is painting',
            ],
            answer: 1,
          },
          {
            question: 'What should you look at for hidden feelings?',
            options: [
              'Page numbers',
          ...
          {
            question: 'Inference requires understanding meaning that is...',
            options: ['Stated directly', 'Not stated directly', 'In the title', 'In the glossary'],
            answer: 1,
          },
        ],
      },
      {
        ...
        quiz: [
          ...
          {
            question: 'What should you do after identifying a technique?',
            options: [
          ...
          },
          {
            ...
            options: ['Beautiful', 'Crash', 'However', 'Meanwhile'],
            answer: 1,
          },
          {
            question: 'What does descriptive writing aim to create?',
            options: ['Boredom', 'Vivid imagery and atmosphere', 'Confusion', 'Lists of facts'],
            answer: 1,
          },
        ],
      },
      {
        ...
        revisionNeeded: true,
        revisionTip:
          'Revise narrative structure: opening, rising action, climax, and resolution. Practise identifying each in short stories.',
        lessonContent:
          'Narrative writing tells a story. When analysing it, pay attention to plot structure, character development, and narrative perspective.\n\nKey elements to analyse:\n- Opening: How does the writer hook the reader?\n- Rising action: How does tension build?\n- Climax: What is the turning point?\n- Resolution: How are conflicts resolved?\n- Narrative voice: First person? Third person? Reliable narrator?\n\nAlso consider pacing. Writers speed up action with short sentences and slow it down with detailed description. Flashbacks and foreshadowing add layers of meaning.',
        quiz: [
          {
            question: 'What does narrative writing do?',
            options: ['Lists facts', 'Tells a story', 'Defines words', 'Solves problems'],
            answer: 1,
          },
          {
            question: 'What is the climax of a story?',
            options: ['The beginning', 'The turning point', 'The end', 'The title'],
            answer: 1,
          },
          {
            question: 'How do writers speed up action?',
            options: ['Long paragraphs', 'Short sentences', 'Footnotes', 'Subheadings'],
            answer: 1,
          },
          {
          ...
          {
            question: 'Which is a narrative perspective?',
            options: ['Second paragraph', 'First person', 'Last page', 'Middle section'],
            answer: 1,
          },
        ],
      },
      {
        ...
        revisionNeeded: true,
        revisionTip:
          "Use comparative connectives like 'whereas', 'similarly', 'in contrast'. Always address both texts in each paragraph rather than writing about them separately.",
        lessonContent:
          "Some questions ask you to compare how two texts present a similar theme or topic. You need to identify similarities AND differences.\n\nStructure your comparison:\n- Address both texts in each paragraph (do not write about Text A then Text B separately)\n- Use comparative connectives: 'similarly', 'in contrast', 'whereas', 'on the other hand'\n- Compare specific techniques, not just general ideas\n- Show which text is more effective and why\n\nA good comparison paragraph:\n1. Make a point about Text A with evidence\n2. Compare with a related point about Text B with evidence\n3. Analyse the difference or similarity in effect",
        quiz: [
          {
            question: 'How should you structure a comparison?',
            options: [
              'Text A then Text B separately',
              'Address both texts in each paragraph',
              'Only write about one text',
              'Ignore one text',
            ],
            answer: 1,
          },
          {
            question: 'Which is a comparative connective?',
            options: ['Because', 'Whereas', 'And', 'The'],
            answer: 1,
          },
          {
            question: 'What should you compare?',
            options: ['Only general ideas', 'Specific techniques', 'Page numbers', 'Word counts'],
            answer: 1,
          },
          {
            question: 'What makes a comparison effective?',
            options: [
              'Being very long',
              'Showing which text is more effective and why',
              'Avoiding quotations',
              'Only listing similarities',
            ],
            answer: 1,
          },
          {
            question: 'Should you address differences as well as similarities?',
            options: ['No, only similarities', 'No, only differences', 'Yes, both', 'Neither'],
            answer: 2,
          },
        ],
      },
      {
        ...
        quiz: [
          ...
          {
            question: 'Where should you spend LESS time?',
            options: [
              'High-mark questions',
              'Low-mark questions',
          ...
          {
            question: 'How should you support your points?',
            options: [
              'With opinions only',
              'With quotations',
              'With drawings',
          ...
          {
            question: 'What format should answers generally be in?',
            options: ['Bullet points', 'Full sentences', 'Single words', 'Diagrams'],
            answer: 1,
          },
        ],
      },
      {
        id: 'm11',
        title: 'Vocabulary Building for Comprehension',
        completed: false,
        quizScore: null,
        quizMaxScore: 5,
        lessonContent:
        ...
        quiz: [
          {
            ...
            options: [
              ...
              'Associations a word carries beyond its definition',
          ...
          {
            question: "What does 'register' mean in language?",
            options: [
          ...
          {
            question: 'How can you work out unfamiliar words?',
            options: ['Skip them', 'Use context clues', 'Guess randomly', 'Ask the examiner'],
            answer: 1,
          },
          {
          ...
          {
            question: 'Which strategy helps build vocabulary?',
            options: [
      ...
      },
      {
        ...
        quiz: [
          ...
          {
            question: "A text 'to persuade' aims to...",
            options: ['Make you laugh', 'Change your mind', 'Teach grammar', 'Tell a story'],
            answer: 1,
          },
          {
            question: 'How does audience affect language?',
            options: [
              "It doesn't",
              'It determines formality and references',
              'It changes the topic',
              'It affects the page count',
            ],
            answer: 1,
          },
          {
            question: 'What register would a text for professionals use?',
            options: ['Slang', 'Formal and technical', 'Text speak', 'Baby talk'],
            answer: 1,
          },
          {
            question: 'Which three questions should you always ask?',
            options: ['Who, why, how', 'What, where, when', 'Can, should, will', 'Is, was, has'],
            answer: 0,
          },
        ],
      },
      {
        ...
        quiz: [
          ...
          {
            question: 'What effect do short paragraphs create?',
            options: ['Boredom', 'Pace and urgency', 'Confusion', 'Formality'],
            answer: 1,
          },
          {
            question: 'What is a circular structure?',
            options: [
              'Writing in circles',
          ...
          {
            question: 'What must you always explain about structural choices?',
            options: [
              'The page number',
              'Why the writer made them',
              'The word count',
          ...
          {
            question: 'What is a shift in focus?',
            options: [
              'Moving to a new desk',
              'The writer moving from one idea to another',
              'Changing pens',
              'A type of lens',
            ],
            answer: 1,
      ...
      },
      {
        ...
        quiz: [
          ...
          {
            question: 'How can you identify tone?',
            options: [
              'By counting pages',
              'By looking at word choices and connotations',
          ...
          {
            question: 'What does a sarcastic tone involve?',
            options: [
          ...
          {
            question: 'What must you use to support your identification of tone?',
            options: [
              'Your opinion only',
          ...
          {
            question: 'What is the difference between tone and atmosphere?',
            options: [
              'They are the same thing',
              "Tone is the writer's attitude; atmosphere is the mood created",
              'Tone is longer',
              'Atmosphere is about weather only',
            ],
            answer: 1,
          },
        ],
      },
      {
        ...
        quiz: [
          ...
          {
            question: 'How many times should you read the passage?',
            options: ['Zero', 'Once', 'Twice', 'Five times'],
            answer: 2,
          },
          {
            question: 'What structure should language analysis use?',
            options: ['Bullet points', 'PEE paragraphs', 'Mind maps', 'Tables'],
            answer: 1,
          },
          {
            question: 'What format should summaries be in?',
            options: ['Bullet points', 'Continuous prose', 'Diagrams', 'Lists'],
            answer: 1,
          },
          {
            question: 'What is the most important skill in exam conditions?',
            options: ['Neat handwriting', 'Time management', 'Using a ruler', 'Coloured pens'],
            answer: 1,
          },
        ],
      },
...
function getGenericCourse(id: string): CourseData {
  const lookup: Record<
    string,
    { title: string; description: string; progress: number; moduleCount: number }
  > = {
    'aqa-lang-p2': {
  ...
  const modules: Module[] = Array.from({ length: info.moduleCount }, (_, i) => {
    ...
    return {
      ...
      quiz: [
        {
          question: `Sample question 1 for Module ${i + 1}`,
          options: ['Option A', 'Option B', 'Option C', 'Option D'],
          answer: 1,
        },
        {
          question: `Sample question 2 for Module ${i + 1}`,
          options: ['Option A', 'Option B', 'Option C', 'Option D'],
          answer: 2,
        },
        {
          question: `Sample question 3 for Module ${i + 1}`,
          options: ['Option A', 'Option B', 'Option C', 'Option D'],
          answer: 0,
        },
        {
          question: `Sample question 4 for Module ${i + 1}`,
          options: ['Option A', 'Option B', 'Option C', 'Option D'],
          answer: 3,
        },
        {
          question: `Sample question 5 for Module ${i + 1}`,
          options: ['Option A', 'Option B', 'Option C', 'Option D'],
          answer: 1,
        },
      ],
...
export default function CourseDetailPage(props: { params: Promise<{ id: string }> }) {
  ...
  if (activeModule === null) {
    ...
    const avgQuizScore = (() => {
      ...
      const total = attempted.reduce(
        (sum, m) => sum + (m.quizScore! / (m.quizMaxScore || 5)) * 100,
        0,
      )
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <div className="space-y-2">
            {course.modules.map((mod, idx) => {
              const quizPct =
                mod.quizScore != null && mod.quizMaxScore
  ...
  // Module content view
  const quizPct =
    activeModule.quizScore != null && activeModule.quizMaxScore
