    ...
    annotations: [
      {
        ...
        kind: 'strength',
        comment: 'Confident conceptual language that signals a developed thesis.',
      },
      {
        id: 'g7-a2',
        paragraphIndex: 1,
        ...
        kind: 'technique',
        comment: 'Precise AO2 terminology. Could push further into the symbolism of the fall.',
      },
      {
        id: 'g7-a3',
        paragraphIndex: 2,
    ...
    annotations: [
      {
        ...
        kind: 'strength',
        comment: 'Conceptualised verb choice signals a perceptive thesis from the first line.',
      },
      {
        id: 'g9-a2',
        paragraphIndex: 1,
...
export default function SampleMarkingPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      {/* ── Grade tabs ────────────────────────────────────── */}
      <div role="tablist" aria-label="Sample grade" className="mb-6 flex flex-wrap gap-2">
        {SAMPLES.map((s) => {
          ...
          return (
            ...
            >
              <span className="font-heading text-base font-extrabold">{s.grade}</span>
      ...
      <Card className="mb-6 border-primary/30 bg-primary/5">
        ...
        <CardContent>
          <p className="text-sm leading-relaxed text-foreground">{active.commentary}</p>
        </CardContent>
      </Card>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1fr]">
        <GradePredictionCard
          grade={active.grade}
          scorePercent={active.scorePercent}
      ...
      {/* ── Annotated sample ──────────────────────────────── */}
      <div className="mt-6">
        <AnnotatedEssay paragraphs={active.paragraphs} annotations={active.annotations} />
      </div>
      ...
      <section className="mt-10 rounded-xl border border-border bg-muted/30 p-5">
        ...
        <p className="mb-4 text-xs text-muted-foreground">
          Full model essays at multiple grades with paragraph-level marker annotations.
        </p>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                5 essays &middot; Lady Macbeth &amp; Guilt &middot; Grades 5, 7 &amp; 9
              </p>
            </div>
          </Link>
        </div>
