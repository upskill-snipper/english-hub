...
const ESSAYS: ModelEssay[] = [
  // ── 1. Lady Macbeth Power — Grade 5 ────────────────────────
  {
    ...
    grade: 5,
    question:
      "How does Shakespeare present Lady Macbeth as powerful?",
    ...
    annotations: [
      {
        ...
        aoAddressed: ["AO1 — clear response with textual reference", "AO2 — some word-level analysis"],
      },
      {
        paragraphIndex: 1,
        strengths: [
    ...
    annotations: [
      {
        ...
        aoAddressed: ["AO1 — thoughtful, developed thesis", "AO2 — precise analysis of imperative verbs", "AO3 — integrated Jacobean context"],
      },
      {
        paragraphIndex: 1,
        strengths: [
        ...
        aoAddressed: ["AO2 — detailed language and form analysis", "AO3 — gender context integrated"],
      },
      {
        paragraphIndex: 2,
        strengths: [
    ...
    annotations: [
      {
        ...
        aoAddressed: ["AO1 — perceptive, conceptualised thesis", "AO2 — word-level analysis of 'unsex', 'fill', spatial metaphor", "AO3 — patriarchal framework integrated"],
      },
      {
        paragraphIndex: 1,
        strengths: [
        ...
        aoAddressed: ["AO1 — original argument", "AO2 — syntax and form analysis", "AO3 — gender and power structures"],
      },
      {
        paragraphIndex: 2,
        strengths: [
        ...
        aoAddressed: ["AO2 — structure (verse to prose), language (inversion of earlier image)", "AO1 — sustained critical argument"],
      },
      {
        paragraphIndex: 3,
        strengths: [
  ...
  // ── 4. Guilt Theme — Grade 5 ──────────────────────────────
  {
    ...
    annotations: [
      ...
      },
      {
        ...
        aoAddressed: ["AO3 — relevant but bolted-on context", "AO1 — concluding overview attempted"],
      },
    ],
    aos: [
      { code: "AO1", label: "Read, understand, respond", score: 7, max: 12 },
  ...
  // ── 5. Guilt Theme — Grade 9 ──────────────────────────────
  {
    ...
    annotations: [
      ...
      },
      {
        ...
        improvements: [
          "No significant improvements. This is exemplary Grade 9 analysis.",
        ],
        aoAddressed: ["AO2 — register, diction, rhetorical structure", "AO1 — sustained critical argument"],
      },
      {
        paragraphIndex: 2,
        strengths: [
        ...
        aoAddressed: ["AO2 — language tracking across the text", "AO1 — sustained structural argument"],
      },
      {
        paragraphIndex: 3,
        strengths: [
        ...
        {essay.paragraphs.map((para, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Essay text */}
              <p className="mb-4 text-[0.9375rem] leading-relaxed text-foreground">
                {para}
              </p>
