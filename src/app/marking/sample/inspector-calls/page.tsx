...
const ESSAYS: ModelEssay[] = [
   ...
   * ============================================================ */
  {
    ...
    paragraphs: [
      ...
      "Mr Birling says he is not responsible because Eva was just 'a girl of that sort'. This phrase shows that he looks down on working-class people and does not see them as equal. Priestley uses Birling to represent selfish capitalists who only care about profit. The audience would dislike Birling because he does not care about Eva at all.",
    ...
    annotations: [
      ...
      },
      {
        ...
        kind: "technique",
        comment:
          "Relevant quotation. Analyse the demonstrative 'that' — it distances Birling from Eva and reduces her to a type rather than a person. This would lift AO2.",
      },
      {
        id: "r5-a3",
        paragraphIndex: 2,
   ...
   * ============================================================ */
  {
    ...
    paragraphs: [
      ...
      "The Birlings' evasion of responsibility is dramatised through language that reveals rather than conceals. Mr Birling's insistence that he bears no blame because Eva was merely 'a girl of that sort' exposes the ideological scaffolding of class: the demonstrative 'that' performs an act of distancing, converting a human being into a category. Mrs Birling echoes this linguistic erasure when she dismisses Eva as a girl of 'that class'. Priestley's repetition of the demonstrative across both characters is structural rather than accidental — it reveals that their irresponsibility is not personal failure but systemic ideology, reproduced within the family unit as naturally as table manners.",
    ...
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="space-y-16">
        {ESSAYS.map((essay) => (
          <section
            key={essay.id}
            id={essay.id}
            aria-labelledby={`heading-${essay.id}`}
          >
            {/* Title bar */}
            ...
            {essay.id !== ESSAYS[ESSAYS.length - 1].id && (
      ...
      <footer className="mt-16 rounded-lg border border-border bg-muted/20 px-5 py-4">
        <p className="text-xs leading-relaxed text-muted-foreground">
          <strong>Fair dealing notice.</strong> Short quotations from{" "}
          <em>An Inspector Calls</em> by J. B. Priestley are reproduced under
          the fair dealing provisions of the Copyright, Designs and Patents Act
          1988 (UK), section 30, for the purpose of criticism, review and
          educational use. All quotations are kept to the minimum necessary for
          analytical commentary (no quotation exceeds fifteen words). No
          quotation is intended to substitute for the original work. Students and
          teachers are encouraged to consult the full text alongside these model
          responses.
        </p>
      </footer>
