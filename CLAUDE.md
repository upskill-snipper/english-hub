...
Read **[docs/HANDOVER.md](docs/HANDOVER.md)** before your first change. It has the
detail this file summarises, and the current state of play.
...
| Need                                       | Go to                                                                    |
| ------------------------------------------ | ------------------------------------------------------------------------ |
| Current state, open items, who is affected | `docs/HANDOVER.md`                                                       |
| Identity, age bands, consent               | `src/lib/identity/`, `src/lib/consent-check.ts`                          |
| Entitlements                               | `src/lib/course-access.ts` (web), `src/lib/entitlements.ts` (mobile API) |
| Billing                                    | `src/lib/billing/`, `src/app/api/stripe/webhook/route.ts`                |
| Rate limiting                              | `src/lib/rate-limit.ts`                                                  |
| i18n                                       | `src/lib/i18n/` — shards are hand-written, `generated/` is not           |
