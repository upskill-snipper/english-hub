...
| Free trial          | 30 days, no card                             | **7 days.** Two separate offers: account signup = 7-day trial, NO card. Paid plan at checkout = first 7 days free, WITH card. Never merge them.                                           |
| Free-no-card option | none                                         | **WITHDRAWN 2026-08-23 - the "3 free uses" mechanic never existed on the web. Do not quote it.** Free AI use is capped by a fair-use allowance; check the live number before quoting one. |
