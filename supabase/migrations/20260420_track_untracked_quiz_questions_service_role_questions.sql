...
DROP POLICY IF EXISTS "Service role questions" ON public.quiz_questions;

CREATE POLICY "Service role questions" ON public.quiz_questions
  AS PERMISSIVE
  FOR ALL
  TO public
