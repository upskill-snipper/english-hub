...
-- Policy: "Service role enrolments"
--
...
DROP POLICY IF EXISTS "Service role enrolments" ON public.enrolments;

CREATE POLICY "Service role enrolments" ON public.enrolments
  AS PERMISSIVE
  FOR ALL
  TO public
