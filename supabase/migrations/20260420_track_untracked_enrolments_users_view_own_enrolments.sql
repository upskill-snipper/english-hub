...
-- Policy: "Users view own enrolments"
--
...
DROP POLICY IF EXISTS "Users view own enrolments" ON public.enrolments;

CREATE POLICY "Users view own enrolments" ON public.enrolments
  AS PERMISSIVE
  FOR SELECT
  TO public
