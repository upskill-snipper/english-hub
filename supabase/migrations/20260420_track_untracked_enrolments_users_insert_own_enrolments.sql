...
-- Policy: "Users insert own enrolments"
--
...
DROP POLICY IF EXISTS "Users insert own enrolments" ON public.enrolments;

CREATE POLICY "Users insert own enrolments" ON public.enrolments
  AS PERMISSIVE
  FOR INSERT
  TO public
