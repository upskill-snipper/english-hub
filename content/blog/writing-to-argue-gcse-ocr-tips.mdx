...
Before you write a single word, understand what OCR is actually marking. The Writing to Argue task is assessed across two objectives.
...
*'Social media is clearly damaging'* is an assertion. *'Social media is damaging: [FACT-CHECK: insert verified statistic on social media and teenage mental health, e.g. from NHS Digital or a peer-reviewed source] found that...'* is the beginning of an argument. Every claim needs evidence; every piece of evidence needs analysis.
...
In the OCR English Language exam, the Writing to Argue task forms part of a timed paper. A 45-minute allocation breaks down as follows:

- **Planning (5 minutes):** Write your thesis and label your three pillars. Note one piece of evidence per pillar. Decide which two rhetorical devices you will use deliberately.
- **Drafting (35 minutes):** Write one paragraph per pillar, plus your counterargument paragraph and conclusion. Aim for roughly 500–600 words — quality over quantity.
- **Revision (5 minutes):** Read back through and check: does each paragraph have claim, evidence, and analysis? Have you integrated evidence smoothly? Are your rhetorical devices purposeful?
